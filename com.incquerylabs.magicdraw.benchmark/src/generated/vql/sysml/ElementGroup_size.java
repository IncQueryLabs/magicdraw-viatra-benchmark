...
public final class ElementGroup_size extends BaseGeneratedEMFQuerySpecification<ElementGroup_size.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ElementGroup_size pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.ElementGroup_size";
    }
    
    @Override
    public List<String> parameterNames() {
      return ElementGroup_size.Match.parameterNames;
    }
    ...
    @Override
    public ElementGroup_size specification() {
     ...
     * 
     */
    public static ElementGroup_size.Match newEmptyMatch() {
  ...
  /**
   * Generated pattern matcher API of the sysml.ElementGroup_size pattern,
   ...
   * 
   * @see Match
   * @see ElementGroup_size
   * 
   */
  public static class Matcher extends BaseMatcher<ElementGroup_size.Match> {
    /**
     ...
     * 
     */
    public static ElementGroup_size.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ElementGroup_size.Matcher create() {
      return new Matcher();
    }
     ...
     * 
     */
    public static IQuerySpecification<ElementGroup_size.Matcher> querySpecification() {
      return ElementGroup_size.instance();
    }
  }
  
  private ElementGroup_size() {
   ...
   * 
   */
  public static ElementGroup_size instance() {
    try{
  ...
  @Override
  protected ElementGroup_size.Matcher instantiate(final ViatraQueryEngine engine) {
    return ElementGroup_size.Matcher.on(engine);
  }
  
  @Override
  public ElementGroup_size.Matcher instantiate() {
    return ElementGroup_size.Matcher.create();
  }
  
  @Override
  public ElementGroup_size.Match newEmptyMatch() {
    return ElementGroup_size.Match.newEmptyMatch();
  }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ElementGroup_size (visibility: PUBLIC, simpleName: ElementGroup_size, identifier: sysml.ElementGroup_size, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ElementGroup_size (visibility: PUBLIC, simpleName: ElementGroup_size, identifier: sysml.ElementGroup_size, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ElementGroup_size INSTANCE = new ElementGroup_size();
