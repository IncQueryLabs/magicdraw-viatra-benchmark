...
public final class Optical extends BaseGeneratedEMFQuerySpecification<Optical.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Optical pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Optical";
    }
    
    @Override
    public List<String> parameterNames() {
      return Optical.Match.parameterNames;
    }
    ...
    @Override
    public Optical.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Optical.Match)) {
          Optical.Match other = (Optical.Match) obj;
     ...
     * 
     */
    public static Optical.Match newEmptyMatch() {
     ...
     * 
     */
    public static Optical.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Optical.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Optical.Match {
    ...
    private static final class Immutable extends Optical.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Optical pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Optical.Match> {
    /**
     ...
     * 
     */
    public static Optical.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Optical.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Optical.Matcher.class);
     ...
     * 
     */
    public Collection<Optical.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Optical.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Optical.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Optical.Match> processor) {
     ...
     * 
     */
    public Optical.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Optical.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final Optical.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final Optical.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Optical.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Optical.Match partialMatch) {
    ...
    @Override
    protected Optical.Match tupleToMatch(final Tuple t) {
      try {
          return Optical.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Optical.Match arrayToMatch(final Object[] match) {
      try {
          return Optical.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Optical.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Optical.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Optical.Matcher> querySpecification() {
      return Optical.instance();
    }
  }
  ...
  @Override
  protected Optical.Matcher instantiate(final ViatraQueryEngine engine) {
    return Optical.Matcher.on(engine);
  }
  
  @Override
  public Optical.Matcher instantiate() {
    return Optical.Matcher.create();
  }
  
  @Override
  public Optical.Match newEmptyMatch() {
    return Optical.Match.newEmptyMatch();
  }
  
  @Override
  public Optical.Match newMatch(final Object... parameters) {
    return Optical.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Optical (visibility: PUBLIC, simpleName: Optical, identifier: sysml.Optical, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Optical (visibility: PUBLIC, simpleName: Optical, identifier: sysml.Optical, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Optical INSTANCE = new Optical();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Optical.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Optical");
