...
public final class Normal_mean extends BaseGeneratedEMFQuerySpecification<Normal_mean.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Normal_mean pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Normal_mean.Match newMutableMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public static Normal_mean.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the sysml.Normal_mean pattern,
  ...
  public static class Matcher extends BaseMatcher<Normal_mean.Match> {
     ...
     * 
     */
    public Collection<Normal_mean.Match> getAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Stream<Normal_mean.Match> streamAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Optional<Normal_mean.Match> getOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec, final Consumer<? super Normal_mean.Match> processor) {
     ...
     * 
     */
    public Normal_mean.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return Normal_mean.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<LiteralReal> streamAllValuesOfvaluespec(final Normal_mean.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralReal> getAllValuesOfvaluespec(final Normal_mean.Match partialMatch) {
    ...
    protected Normal_mean.Match tupleToMatch(final Tuple t) {
      try {
          return Normal_mean.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralReal) t.get(POSITION_VALUESPEC));
    ...
    protected Normal_mean.Match arrayToMatch(final Object[] match) {
      try {
          return Normal_mean.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected Normal_mean.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Normal_mean.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Normal_mean.Match newMatch(final Object... parameters) {
    return Normal_mean.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralReal) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Normal_mean (visibility: PUBLIC, simpleName: Normal_mean, identifier: sysml.Normal_mean, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Normal_mean (visibility: PUBLIC, simpleName: Normal_mean, identifier: sysml.Normal_mean, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
