...
public final class DesignConstraint_TracedTo extends BaseGeneratedEMFQuerySpecification<DesignConstraint_TracedTo.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.designConstraint_TracedTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.designConstraint_TracedTo";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.designConstraint_TracedTo pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DesignConstraint_TracedTo (visibility: PUBLIC, simpleName: DesignConstraint_TracedTo, identifier: sysml.DesignConstraint_TracedTo, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DesignConstraint_TracedTo (visibility: PUBLIC, simpleName: DesignConstraint_TracedTo, identifier: sysml.DesignConstraint_TracedTo, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
