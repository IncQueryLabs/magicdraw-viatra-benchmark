...
public final class Mechanical extends BaseGeneratedEMFQuerySpecification<Mechanical.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Mechanical pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Mechanical";
    }
    
    @Override
    public List<String> parameterNames() {
      return Mechanical.Match.parameterNames;
    }
    ...
    @Override
    public Mechanical.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Mechanical.Match)) {
          Mechanical.Match other = (Mechanical.Match) obj;
    ...
    @Override
    public Mechanical specification() {
     ...
     * 
     */
    public static Mechanical.Match newEmptyMatch() {
     ...
     * 
     */
    public static Mechanical.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Mechanical.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Mechanical.Match {
    ...
    private static final class Immutable extends Mechanical.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Mechanical pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Mechanical.Match> {
    /**
     ...
     * 
     */
    public static Mechanical.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Mechanical.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Mechanical.Matcher.class);
     ...
     * 
     */
    public Collection<Mechanical.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Mechanical.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Mechanical.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Mechanical.Match> processor) {
     ...
     * 
     */
    public Mechanical.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Mechanical.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final Mechanical.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final Mechanical.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Mechanical.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Mechanical.Match partialMatch) {
    ...
    @Override
    protected Mechanical.Match tupleToMatch(final Tuple t) {
      try {
          return Mechanical.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Mechanical.Match arrayToMatch(final Object[] match) {
      try {
          return Mechanical.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Mechanical.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Mechanical.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Mechanical.Matcher> querySpecification() {
      return Mechanical.instance();
    }
  }
  ...
  @Override
  protected Mechanical.Matcher instantiate(final ViatraQueryEngine engine) {
    return Mechanical.Matcher.on(engine);
  }
  
  @Override
  public Mechanical.Matcher instantiate() {
    return Mechanical.Matcher.create();
  }
  
  @Override
  public Mechanical.Match newEmptyMatch() {
    return Mechanical.Match.newEmptyMatch();
  }
  
  @Override
  public Mechanical.Match newMatch(final Object... parameters) {
    return Mechanical.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Mechanical (visibility: PUBLIC, simpleName: Mechanical, identifier: sysml.Mechanical, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Mechanical (visibility: PUBLIC, simpleName: Mechanical, identifier: sysml.Mechanical, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Mechanical INSTANCE = new Mechanical();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Mechanical.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Mechanical");
