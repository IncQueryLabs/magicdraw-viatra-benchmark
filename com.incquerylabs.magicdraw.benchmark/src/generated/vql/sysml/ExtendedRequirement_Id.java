...
public final class ExtendedRequirement_Id extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_Id.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement_Id.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement_Id specification() {
     ...
     * 
     */
    public static ExtendedRequirement_Id.Match newEmptyMatch() {
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement_Id pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement_Id
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement_Id.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement_Id.Matcher create() {
      return new Matcher();
    }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement_Id.Matcher> querySpecification() {
      return ExtendedRequirement_Id.instance();
    }
  }
  
  private ExtendedRequirement_Id() {
   ...
   * 
   */
  public static ExtendedRequirement_Id instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement_Id.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement_Id.Matcher instantiate() {
    return ExtendedRequirement_Id.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement_Id.Match newEmptyMatch() {
    return ExtendedRequirement_Id.Match.newEmptyMatch();
  }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ExtendedRequirement_Id (visibility: PUBLIC, simpleName: ExtendedRequirement_Id, identifier: sysml.ExtendedRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ExtendedRequirement_Id (visibility: PUBLIC, simpleName: ExtendedRequirement_Id, identifier: sysml.ExtendedRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement_Id INSTANCE = new ExtendedRequirement_Id();
