...
public final class DeriveReqt_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<DeriveReqt_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.DeriveReqt_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.DeriveReqt_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return DeriveReqt_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public DeriveReqt_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DeriveReqt_sourcePropertyPath.Match)) {
          DeriveReqt_sourcePropertyPath.Match other = (DeriveReqt_sourcePropertyPath.Match) obj;
    ...
    @Override
    public DeriveReqt_sourcePropertyPath specification() {
     ...
     * 
     */
    public static DeriveReqt_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static DeriveReqt_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static DeriveReqt_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DeriveReqt_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends DeriveReqt_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.DeriveReqt_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see DeriveReqt_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<DeriveReqt_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static DeriveReqt_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DeriveReqt_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DeriveReqt_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<DeriveReqt_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<DeriveReqt_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<DeriveReqt_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super DeriveReqt_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public DeriveReqt_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return DeriveReqt_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final DeriveReqt_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final DeriveReqt_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final DeriveReqt_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final DeriveReqt_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected DeriveReqt_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return DeriveReqt_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected DeriveReqt_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return DeriveReqt_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DeriveReqt_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeriveReqt_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DeriveReqt_sourcePropertyPath.Matcher> querySpecification() {
      return DeriveReqt_sourcePropertyPath.instance();
    }
  }
  
  private DeriveReqt_sourcePropertyPath() {
   ...
   * 
   */
  public static DeriveReqt_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected DeriveReqt_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return DeriveReqt_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public DeriveReqt_sourcePropertyPath.Matcher instantiate() {
    return DeriveReqt_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public DeriveReqt_sourcePropertyPath.Match newEmptyMatch() {
    return DeriveReqt_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public DeriveReqt_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return DeriveReqt_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DeriveReqt_sourcePropertyPath (visibility: PUBLIC, simpleName: DeriveReqt_sourcePropertyPath, identifier: sysml.DeriveReqt_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DeriveReqt_sourcePropertyPath (visibility: PUBLIC, simpleName: DeriveReqt_sourcePropertyPath, identifier: sysml.DeriveReqt_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DeriveReqt_sourcePropertyPath INSTANCE = new DeriveReqt_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DeriveReqt_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
