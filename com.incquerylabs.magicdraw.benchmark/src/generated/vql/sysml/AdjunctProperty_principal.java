...
public final class AdjunctProperty_principal extends BaseGeneratedEMFQuerySpecification<AdjunctProperty_principal.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.AdjunctProperty_principal pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.AdjunctProperty_principal";
    }
    
    @Override
    public List<String> parameterNames() {
      return AdjunctProperty_principal.Match.parameterNames;
    }
    ...
    @Override
    public AdjunctProperty_principal.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof AdjunctProperty_principal.Match)) {
          AdjunctProperty_principal.Match other = (AdjunctProperty_principal.Match) obj;
    ...
    @Override
    public AdjunctProperty_principal specification() {
     ...
     * 
     */
    public static AdjunctProperty_principal.Match newEmptyMatch() {
  ...
  /**
   * Generated pattern matcher API of the sysml.AdjunctProperty_principal pattern,
   ...
   * 
   * @see Match
   * @see AdjunctProperty_principal
   * 
   */
  public static class Matcher extends BaseMatcher<AdjunctProperty_principal.Match> {
    /**
     ...
     * 
     */
    public static AdjunctProperty_principal.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static AdjunctProperty_principal.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(AdjunctProperty_principal.Matcher.class);
     ...
     * 
     */
    public static IQuerySpecification<AdjunctProperty_principal.Matcher> querySpecification() {
      return AdjunctProperty_principal.instance();
    }
  }
  
  private AdjunctProperty_principal() {
   ...
   * 
   */
  public static AdjunctProperty_principal instance() {
    try{
  ...
  @Override
  protected AdjunctProperty_principal.Matcher instantiate(final ViatraQueryEngine engine) {
    return AdjunctProperty_principal.Matcher.on(engine);
  }
  
  @Override
  public AdjunctProperty_principal.Matcher instantiate() {
    return AdjunctProperty_principal.Matcher.create();
  }
  
  @Override
  public AdjunctProperty_principal.Match newEmptyMatch() {
    return AdjunctProperty_principal.Match.newEmptyMatch();
  }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.AdjunctProperty_principal (visibility: PUBLIC, simpleName: AdjunctProperty_principal, identifier: sysml.AdjunctProperty_principal, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.AdjunctProperty_principal (visibility: PUBLIC, simpleName: AdjunctProperty_principal, identifier: sysml.AdjunctProperty_principal, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final AdjunctProperty_principal INSTANCE = new AdjunctProperty_principal();
