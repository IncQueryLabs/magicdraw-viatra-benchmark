...
public final class RequirementRelated_Refines extends BaseGeneratedEMFQuerySpecification<RequirementRelated_Refines.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.RequirementRelated_Refines (visibility: PUBLIC, simpleName: RequirementRelated_Refines, identifier: sysml.RequirementRelated_Refines, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.RequirementRelated_Refines (visibility: PUBLIC, simpleName: RequirementRelated_Refines, identifier: sysml.RequirementRelated_Refines, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
