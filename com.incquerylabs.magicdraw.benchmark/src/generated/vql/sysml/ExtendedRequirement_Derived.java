...
public final class ExtendedRequirement_Derived extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement_Derived";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement_Derived pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ExtendedRequirement_Derived (visibility: PUBLIC, simpleName: ExtendedRequirement_Derived, identifier: sysml.ExtendedRequirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ExtendedRequirement_Derived (visibility: PUBLIC, simpleName: ExtendedRequirement_Derived, identifier: sysml.ExtendedRequirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
