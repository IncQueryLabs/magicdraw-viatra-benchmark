...
public final class DeriveReqt_targetContext extends BaseGeneratedEMFQuerySpecification<DeriveReqt_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.DeriveReqt_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.DeriveReqt_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return DeriveReqt_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public DeriveReqt_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DeriveReqt_targetContext.Match)) {
          DeriveReqt_targetContext.Match other = (DeriveReqt_targetContext.Match) obj;
    ...
    @Override
    public DeriveReqt_targetContext specification() {
     ...
     * 
     */
    public static DeriveReqt_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static DeriveReqt_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static DeriveReqt_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DeriveReqt_targetContext.Match {
    ...
    private static final class Immutable extends DeriveReqt_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.DeriveReqt_targetContext pattern,
   ...
   * 
   * @see Match
   * @see DeriveReqt_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<DeriveReqt_targetContext.Match> {
    /**
     ...
     * 
     */
    public static DeriveReqt_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DeriveReqt_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DeriveReqt_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<DeriveReqt_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<DeriveReqt_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<DeriveReqt_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super DeriveReqt_targetContext.Match> processor) {
     ...
     * 
     */
    public DeriveReqt_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return DeriveReqt_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final DeriveReqt_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final DeriveReqt_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final DeriveReqt_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final DeriveReqt_targetContext.Match partialMatch) {
    ...
    @Override
    protected DeriveReqt_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return DeriveReqt_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected DeriveReqt_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return DeriveReqt_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DeriveReqt_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeriveReqt_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DeriveReqt_targetContext.Matcher> querySpecification() {
      return DeriveReqt_targetContext.instance();
    }
  }
  
  private DeriveReqt_targetContext() {
   ...
   * 
   */
  public static DeriveReqt_targetContext instance() {
    try{
  ...
  @Override
  protected DeriveReqt_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return DeriveReqt_targetContext.Matcher.on(engine);
  }
  
  @Override
  public DeriveReqt_targetContext.Matcher instantiate() {
    return DeriveReqt_targetContext.Matcher.create();
  }
  
  @Override
  public DeriveReqt_targetContext.Match newEmptyMatch() {
    return DeriveReqt_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public DeriveReqt_targetContext.Match newMatch(final Object... parameters) {
    return DeriveReqt_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DeriveReqt_targetContext (visibility: PUBLIC, simpleName: DeriveReqt_targetContext, identifier: sysml.DeriveReqt_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DeriveReqt_targetContext (visibility: PUBLIC, simpleName: DeriveReqt_targetContext, identifier: sysml.DeriveReqt_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DeriveReqt_targetContext INSTANCE = new DeriveReqt_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DeriveReqt_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
