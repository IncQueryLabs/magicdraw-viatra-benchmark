...
public final class Moe extends BaseGeneratedEMFQuerySpecification<Moe.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.moe pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public List<String> parameterNames() {
      return Moe.Match.parameterNames;
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Moe.Match)) {
          Moe.Match other = (Moe.Match) obj;
     ...
     * 
     */
    public static Moe.Match newEmptyMatch() {
     ...
     * 
     */
    public static Moe.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Moe.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Moe.Match {
    ...
    private static final class Immutable extends Moe.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.moe pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Moe.Match> {
    /**
     ...
     * 
     */
    public static Moe.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Moe.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Moe.Matcher.class);
     ...
     * 
     */
    public Collection<Moe.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Moe.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Moe.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Moe.Match> processor) {
     ...
     * 
     */
    public Moe.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Moe.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Moe.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Moe.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Moe.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Moe.Match partialMatch) {
    ...
    @Override
    protected Moe.Match tupleToMatch(final Tuple t) {
      try {
          return Moe.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Moe.Match arrayToMatch(final Object[] match) {
      try {
          return Moe.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Moe.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Moe.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Moe.Matcher> querySpecification() {
      return Moe.instance();
    }
  }
  ...
  @Override
  protected Moe.Matcher instantiate(final ViatraQueryEngine engine) {
    return Moe.Matcher.on(engine);
  }
  
  @Override
  public Moe.Matcher instantiate() {
    return Moe.Matcher.create();
  }
  
  @Override
  public Moe.Match newEmptyMatch() {
    return Moe.Match.newEmptyMatch();
  }
  
  @Override
  public Moe.Match newMatch(final Object... parameters) {
    return Moe.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Moe (visibility: PUBLIC, simpleName: Moe, identifier: sysml.Moe, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Moe (visibility: PUBLIC, simpleName: Moe, identifier: sysml.Moe, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Moe INSTANCE = new Moe();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Moe.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "moe");
