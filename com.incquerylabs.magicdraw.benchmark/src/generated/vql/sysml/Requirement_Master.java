...
public final class Requirement_Master extends BaseGeneratedEMFQuerySpecification<Requirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Requirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Requirement_Master";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.Requirement_Master pattern,
