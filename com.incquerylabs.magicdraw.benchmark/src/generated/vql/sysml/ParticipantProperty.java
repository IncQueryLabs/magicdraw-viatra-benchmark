...
public final class ParticipantProperty extends BaseGeneratedEMFQuerySpecification<ParticipantProperty.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ParticipantProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public List<String> parameterNames() {
      return ParticipantProperty.Match.parameterNames;
    }
    ...
    @Override
    public ParticipantProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ParticipantProperty.Match)) {
          ParticipantProperty.Match other = (ParticipantProperty.Match) obj;
    ...
    @Override
    public ParticipantProperty specification() {
     ...
     * 
     */
    public static ParticipantProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static ParticipantProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ParticipantProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ParticipantProperty.Match {
    ...
    private static final class Immutable extends ParticipantProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.ParticipantProperty pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ParticipantProperty.Match> {
    /**
     ...
     * 
     */
    public static ParticipantProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ParticipantProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ParticipantProperty.Matcher.class);
     ...
     * 
     */
    public Collection<ParticipantProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ParticipantProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ParticipantProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ParticipantProperty.Match> processor) {
     ...
     * 
     */
    public ParticipantProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ParticipantProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ParticipantProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ParticipantProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ParticipantProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ParticipantProperty.Match partialMatch) {
    ...
    @Override
    protected ParticipantProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ParticipantProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ParticipantProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ParticipantProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ParticipantProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ParticipantProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ParticipantProperty.Matcher> querySpecification() {
      return ParticipantProperty.instance();
    }
  }
  
  private ParticipantProperty() {
   ...
   * 
   */
  public static ParticipantProperty instance() {
    try{
  ...
  @Override
  protected ParticipantProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return ParticipantProperty.Matcher.on(engine);
  }
  
  @Override
  public ParticipantProperty.Matcher instantiate() {
    return ParticipantProperty.Matcher.create();
  }
  
  @Override
  public ParticipantProperty.Match newEmptyMatch() {
    return ParticipantProperty.Match.newEmptyMatch();
  }
  
  @Override
  public ParticipantProperty.Match newMatch(final Object... parameters) {
    return ParticipantProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ParticipantProperty (visibility: PUBLIC, simpleName: ParticipantProperty, identifier: sysml.ParticipantProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ParticipantProperty (visibility: PUBLIC, simpleName: ParticipantProperty, identifier: sysml.ParticipantProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ParticipantProperty INSTANCE = new ParticipantProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ParticipantProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ParticipantProperty");
