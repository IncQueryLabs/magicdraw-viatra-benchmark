...
public final class BasicInterval_max extends BaseGeneratedEMFQuerySpecification<BasicInterval_max.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.BasicInterval_max pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.BasicInterval_max";
    }
    
    @Override
    public List<String> parameterNames() {
      return BasicInterval_max.Match.parameterNames;
    }
    ...
    @Override
    public BasicInterval_max.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BasicInterval_max.Match)) {
          BasicInterval_max.Match other = (BasicInterval_max.Match) obj;
    ...
    @Override
    public BasicInterval_max specification() {
     ...
     * 
     */
    public static BasicInterval_max.Match newEmptyMatch() {
     ...
     * 
     */
    public static BasicInterval_max.Match newMutableMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public static BasicInterval_max.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends BasicInterval_max.Match {
    ...
    private static final class Immutable extends BasicInterval_max.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.BasicInterval_max pattern,
   ...
   * 
   * @see Match
   * @see BasicInterval_max
   * 
   */
  public static class Matcher extends BaseMatcher<BasicInterval_max.Match> {
    /**
     ...
     * 
     */
    public static BasicInterval_max.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BasicInterval_max.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BasicInterval_max.Matcher.class);
     ...
     * 
     */
    public Collection<BasicInterval_max.Match> getAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Stream<BasicInterval_max.Match> streamAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Optional<BasicInterval_max.Match> getOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec, final Consumer<? super BasicInterval_max.Match> processor) {
     ...
     * 
     */
    public BasicInterval_max.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return BasicInterval_max.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final BasicInterval_max.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final BasicInterval_max.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralReal> streamAllValuesOfvaluespec(final BasicInterval_max.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralReal> getAllValuesOfvaluespec(final BasicInterval_max.Match partialMatch) {
    ...
    @Override
    protected BasicInterval_max.Match tupleToMatch(final Tuple t) {
      try {
          return BasicInterval_max.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralReal) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected BasicInterval_max.Match arrayToMatch(final Object[] match) {
      try {
          return BasicInterval_max.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BasicInterval_max.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BasicInterval_max.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BasicInterval_max.Matcher> querySpecification() {
      return BasicInterval_max.instance();
    }
  }
  
  private BasicInterval_max() {
   ...
   * 
   */
  public static BasicInterval_max instance() {
    try{
  ...
  @Override
  protected BasicInterval_max.Matcher instantiate(final ViatraQueryEngine engine) {
    return BasicInterval_max.Matcher.on(engine);
  }
  
  @Override
  public BasicInterval_max.Matcher instantiate() {
    return BasicInterval_max.Matcher.create();
  }
  
  @Override
  public BasicInterval_max.Match newEmptyMatch() {
    return BasicInterval_max.Match.newEmptyMatch();
  }
  
  @Override
  public BasicInterval_max.Match newMatch(final Object... parameters) {
    return BasicInterval_max.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralReal) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BasicInterval_max (visibility: PUBLIC, simpleName: BasicInterval_max, identifier: sysml.BasicInterval_max, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BasicInterval_max (visibility: PUBLIC, simpleName: BasicInterval_max, identifier: sysml.BasicInterval_max, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BasicInterval_max INSTANCE = new BasicInterval_max();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BasicInterval_max.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "max");
