...
public final class SwimLaneDiagram extends BaseGeneratedEMFQuerySpecification<SwimLaneDiagram.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.SwimLaneDiagram pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.SwimLaneDiagram";
    }
    
    @Override
    public List<String> parameterNames() {
      return SwimLaneDiagram.Match.parameterNames;
    }
    ...
    @Override
    public SwimLaneDiagram.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SwimLaneDiagram.Match)) {
          SwimLaneDiagram.Match other = (SwimLaneDiagram.Match) obj;
    ...
    @Override
    public SwimLaneDiagram specification() {
     ...
     * 
     */
    public static SwimLaneDiagram.Match newEmptyMatch() {
     ...
     * 
     */
    public static SwimLaneDiagram.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SwimLaneDiagram.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SwimLaneDiagram.Match {
    ...
    private static final class Immutable extends SwimLaneDiagram.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.SwimLaneDiagram pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<SwimLaneDiagram.Match> {
    /**
     ...
     * 
     */
    public static SwimLaneDiagram.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SwimLaneDiagram.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SwimLaneDiagram.Matcher.class);
     ...
     * 
     */
    public Collection<SwimLaneDiagram.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SwimLaneDiagram.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SwimLaneDiagram.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SwimLaneDiagram.Match> processor) {
     ...
     * 
     */
    public SwimLaneDiagram.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SwimLaneDiagram.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final SwimLaneDiagram.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final SwimLaneDiagram.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SwimLaneDiagram.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SwimLaneDiagram.Match partialMatch) {
    ...
    @Override
    protected SwimLaneDiagram.Match tupleToMatch(final Tuple t) {
      try {
          return SwimLaneDiagram.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SwimLaneDiagram.Match arrayToMatch(final Object[] match) {
      try {
          return SwimLaneDiagram.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SwimLaneDiagram.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SwimLaneDiagram.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SwimLaneDiagram.Matcher> querySpecification() {
      return SwimLaneDiagram.instance();
    }
  }
  
  private SwimLaneDiagram() {
   ...
   * 
   */
  public static SwimLaneDiagram instance() {
    try{
  ...
  @Override
  protected SwimLaneDiagram.Matcher instantiate(final ViatraQueryEngine engine) {
    return SwimLaneDiagram.Matcher.on(engine);
  }
  
  @Override
  public SwimLaneDiagram.Matcher instantiate() {
    return SwimLaneDiagram.Matcher.create();
  }
  
  @Override
  public SwimLaneDiagram.Match newEmptyMatch() {
    return SwimLaneDiagram.Match.newEmptyMatch();
  }
  
  @Override
  public SwimLaneDiagram.Match newMatch(final Object... parameters) {
    return SwimLaneDiagram.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.SwimLaneDiagram (visibility: PUBLIC, simpleName: SwimLaneDiagram, identifier: sysml.SwimLaneDiagram, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.SwimLaneDiagram (visibility: PUBLIC, simpleName: SwimLaneDiagram, identifier: sysml.SwimLaneDiagram, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SwimLaneDiagram INSTANCE = new SwimLaneDiagram();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SwimLaneDiagram.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "SwimLaneDiagram");
