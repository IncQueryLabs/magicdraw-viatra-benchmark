...
public final class RequirementRelated_Satisfies extends BaseGeneratedEMFQuerySpecification<RequirementRelated_Satisfies.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.RequirementRelated_Satisfies pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.RequirementRelated_Satisfies";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.RequirementRelated_Satisfies pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.RequirementRelated_Satisfies (visibility: PUBLIC, simpleName: RequirementRelated_Satisfies, identifier: sysml.RequirementRelated_Satisfies, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.RequirementRelated_Satisfies (visibility: PUBLIC, simpleName: RequirementRelated_Satisfies, identifier: sysml.RequirementRelated_Satisfies, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
