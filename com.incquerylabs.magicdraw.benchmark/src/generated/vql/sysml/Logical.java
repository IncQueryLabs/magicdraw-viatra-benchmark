...
public final class Logical extends BaseGeneratedEMFQuerySpecification<Logical.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Logical pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Logical";
    }
    
    @Override
    public List<String> parameterNames() {
      return Logical.Match.parameterNames;
    }
     ...
     * 
     */
    public static Logical.Match newEmptyMatch() {
  ...
  /**
   * Generated pattern matcher API of the sysml.Logical pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Logical.Match> {
    /**
     ...
     * 
     */
    public static Logical.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Logical.Matcher create() {
      return new Matcher();
    }
     ...
     * 
     */
    public static IQuerySpecification<Logical.Matcher> querySpecification() {
      return Logical.instance();
    }
  }
  ...
  @Override
  protected Logical.Matcher instantiate(final ViatraQueryEngine engine) {
    return Logical.Matcher.on(engine);
  }
  
  @Override
  public Logical.Matcher instantiate() {
    return Logical.Matcher.create();
  }
  
  @Override
  public Logical.Match newEmptyMatch() {
    return Logical.Match.newEmptyMatch();
  }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Logical (visibility: PUBLIC, simpleName: Logical, identifier: sysml.Logical, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Logical (visibility: PUBLIC, simpleName: Logical, identifier: sysml.Logical, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Logical INSTANCE = new Logical();
