...
public final class QuantityKind_symbol extends BaseGeneratedEMFQuerySpecification<QuantityKind_symbol.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.QuantityKind_symbol pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.QuantityKind_symbol";
    }
    
    @Override
    public List<String> parameterNames() {
      return QuantityKind_symbol.Match.parameterNames;
    }
    ...
    @Override
    public QuantityKind_symbol.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof QuantityKind_symbol.Match)) {
          QuantityKind_symbol.Match other = (QuantityKind_symbol.Match) obj;
    ...
    @Override
    public QuantityKind_symbol specification() {
     ...
     * 
     */
    public static QuantityKind_symbol.Match newEmptyMatch() {
     ...
     * 
     */
    public static QuantityKind_symbol.Match newMutableMatch(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static QuantityKind_symbol.Match newMatch(final PackageableElement pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends QuantityKind_symbol.Match {
    ...
    private static final class Immutable extends QuantityKind_symbol.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.QuantityKind_symbol pattern,
   ...
   * 
   * @see Match
   * @see QuantityKind_symbol
   * 
   */
  public static class Matcher extends BaseMatcher<QuantityKind_symbol.Match> {
    /**
     ...
     * 
     */
    public static QuantityKind_symbol.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static QuantityKind_symbol.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(QuantityKind_symbol.Matcher.class);
     ...
     * 
     */
    public Collection<QuantityKind_symbol.Match> getAllMatches(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<QuantityKind_symbol.Match> streamAllMatches(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<QuantityKind_symbol.Match> getOneArbitraryMatch(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final LiteralString pValuespec, final Consumer<? super QuantityKind_symbol.Match> processor) {
     ...
     * 
     */
    public QuantityKind_symbol.Match newMatch(final PackageableElement pElement, final LiteralString pValuespec) {
      return QuantityKind_symbol.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<PackageableElement> streamAllValuesOfelement(final QuantityKind_symbol.Match partialMatch) {
     ...
     * 
     */
    public Set<PackageableElement> getAllValuesOfelement(final QuantityKind_symbol.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final QuantityKind_symbol.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final QuantityKind_symbol.Match partialMatch) {
    ...
    @Override
    protected QuantityKind_symbol.Match tupleToMatch(final Tuple t) {
      try {
          return QuantityKind_symbol.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected QuantityKind_symbol.Match arrayToMatch(final Object[] match) {
      try {
          return QuantityKind_symbol.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected QuantityKind_symbol.Match arrayToMatchMutable(final Object[] match) {
      try {
          return QuantityKind_symbol.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<QuantityKind_symbol.Matcher> querySpecification() {
      return QuantityKind_symbol.instance();
    }
  }
  
  private QuantityKind_symbol() {
   ...
   * 
   */
  public static QuantityKind_symbol instance() {
    try{
  ...
  @Override
  protected QuantityKind_symbol.Matcher instantiate(final ViatraQueryEngine engine) {
    return QuantityKind_symbol.Matcher.on(engine);
  }
  
  @Override
  public QuantityKind_symbol.Matcher instantiate() {
    return QuantityKind_symbol.Matcher.create();
  }
  
  @Override
  public QuantityKind_symbol.Match newEmptyMatch() {
    return QuantityKind_symbol.Match.newEmptyMatch();
  }
  
  @Override
  public QuantityKind_symbol.Match newMatch(final Object... parameters) {
    return QuantityKind_symbol.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.QuantityKind_symbol (visibility: PUBLIC, simpleName: QuantityKind_symbol, identifier: sysml.QuantityKind_symbol, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.QuantityKind_symbol (visibility: PUBLIC, simpleName: QuantityKind_symbol, identifier: sysml.QuantityKind_symbol, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final QuantityKind_symbol INSTANCE = new QuantityKind_symbol();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final QuantityKind_symbol.GeneratedPQuery INSTANCE = new GeneratedPQuery();
