...
public final class Unit_description extends BaseGeneratedEMFQuerySpecification<Unit_description.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Unit_description pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Unit_description";
    }
    
    @Override
    public List<String> parameterNames() {
      return Unit_description.Match.parameterNames;
    }
    ...
    @Override
    public Unit_description.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Unit_description.Match)) {
          Unit_description.Match other = (Unit_description.Match) obj;
    ...
    @Override
    public Unit_description specification() {
     ...
     * 
     */
    public static Unit_description.Match newEmptyMatch() {
     ...
     * 
     */
    public static Unit_description.Match newMutableMatch(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Unit_description.Match newMatch(final PackageableElement pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Unit_description.Match {
    ...
    private static final class Immutable extends Unit_description.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Unit_description pattern,
   ...
   * 
   * @see Match
   * @see Unit_description
   * 
   */
  public static class Matcher extends BaseMatcher<Unit_description.Match> {
    /**
     ...
     * 
     */
    public static Unit_description.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Unit_description.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Unit_description.Matcher.class);
     ...
     * 
     */
    public Collection<Unit_description.Match> getAllMatches(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Unit_description.Match> streamAllMatches(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Unit_description.Match> getOneArbitraryMatch(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final LiteralString pValuespec, final Consumer<? super Unit_description.Match> processor) {
     ...
     * 
     */
    public Unit_description.Match newMatch(final PackageableElement pElement, final LiteralString pValuespec) {
      return Unit_description.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<PackageableElement> streamAllValuesOfelement(final Unit_description.Match partialMatch) {
     ...
     * 
     */
    public Set<PackageableElement> getAllValuesOfelement(final Unit_description.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Unit_description.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Unit_description.Match partialMatch) {
    ...
    @Override
    protected Unit_description.Match tupleToMatch(final Tuple t) {
      try {
          return Unit_description.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Unit_description.Match arrayToMatch(final Object[] match) {
      try {
          return Unit_description.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Unit_description.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unit_description.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Unit_description.Matcher> querySpecification() {
      return Unit_description.instance();
    }
  }
   ...
   * 
   */
  public static Unit_description instance() {
    try{
  ...
  @Override
  protected Unit_description.Matcher instantiate(final ViatraQueryEngine engine) {
    return Unit_description.Matcher.on(engine);
  }
  
  @Override
  public Unit_description.Matcher instantiate() {
    return Unit_description.Matcher.create();
  }
  
  @Override
  public Unit_description.Match newEmptyMatch() {
    return Unit_description.Match.newEmptyMatch();
  }
  
  @Override
  public Unit_description.Match newMatch(final Object... parameters) {
    return Unit_description.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Unit_description (visibility: PUBLIC, simpleName: Unit_description, identifier: sysml.Unit_description, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Unit_description (visibility: PUBLIC, simpleName: Unit_description, identifier: sysml.Unit_description, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Unit_description INSTANCE = new Unit_description();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Unit_description.GeneratedPQuery INSTANCE = new GeneratedPQuery();
