...
public final class DiagramDescription extends BaseGeneratedEMFQuerySpecification<DiagramDescription.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.DiagramDescription pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.DiagramDescription";
    }
    
    @Override
    public List<String> parameterNames() {
      return DiagramDescription.Match.parameterNames;
    }
    ...
    @Override
    public DiagramDescription.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DiagramDescription.Match)) {
          DiagramDescription.Match other = (DiagramDescription.Match) obj;
    ...
    @Override
    public DiagramDescription specification() {
     ...
     * 
     */
    public static DiagramDescription.Match newEmptyMatch() {
     ...
     * 
     */
    public static DiagramDescription.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static DiagramDescription.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends DiagramDescription.Match {
    ...
    private static final class Immutable extends DiagramDescription.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.DiagramDescription pattern,
   ...
   * 
   * @see Match
   * @see DiagramDescription
   * 
   */
  public static class Matcher extends BaseMatcher<DiagramDescription.Match> {
    /**
     ...
     * 
     */
    public static DiagramDescription.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DiagramDescription.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DiagramDescription.Matcher.class);
     ...
     * 
     */
    public Collection<DiagramDescription.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<DiagramDescription.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<DiagramDescription.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super DiagramDescription.Match> processor) {
     ...
     * 
     */
    public DiagramDescription.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return DiagramDescription.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final DiagramDescription.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final DiagramDescription.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final DiagramDescription.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final DiagramDescription.Match partialMatch) {
    ...
    @Override
    protected DiagramDescription.Match tupleToMatch(final Tuple t) {
      try {
          return DiagramDescription.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected DiagramDescription.Match arrayToMatch(final Object[] match) {
      try {
          return DiagramDescription.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DiagramDescription.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DiagramDescription.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DiagramDescription.Matcher> querySpecification() {
      return DiagramDescription.instance();
    }
  }
   ...
   * 
   */
  public static DiagramDescription instance() {
    try{
  ...
  @Override
  protected DiagramDescription.Matcher instantiate(final ViatraQueryEngine engine) {
    return DiagramDescription.Matcher.on(engine);
  }
  
  @Override
  public DiagramDescription.Matcher instantiate() {
    return DiagramDescription.Matcher.create();
  }
  
  @Override
  public DiagramDescription.Match newEmptyMatch() {
    return DiagramDescription.Match.newEmptyMatch();
  }
  
  @Override
  public DiagramDescription.Match newMatch(final Object... parameters) {
    return DiagramDescription.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DiagramDescription (visibility: PUBLIC, simpleName: DiagramDescription, identifier: sysml.DiagramDescription, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DiagramDescription (visibility: PUBLIC, simpleName: DiagramDescription, identifier: sysml.DiagramDescription, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DiagramDescription INSTANCE = new DiagramDescription();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DiagramDescription.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Diagram Description");
