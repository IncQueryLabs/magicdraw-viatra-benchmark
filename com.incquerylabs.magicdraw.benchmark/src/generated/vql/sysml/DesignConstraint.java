...
public final class DesignConstraint extends BaseGeneratedEMFQuerySpecification<DesignConstraint.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.designConstraint pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.designConstraint";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint.Match)) {
          DesignConstraint.Match other = (DesignConstraint.Match) obj;
    ...
    @Override
    public DesignConstraint specification() {
     ...
     * 
     */
    public static DesignConstraint.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static DesignConstraint.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends DesignConstraint.Match {
    ...
    private static final class Immutable extends DesignConstraint.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.designConstraint pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<DesignConstraint.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<DesignConstraint.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super DesignConstraint.Match> processor) {
     ...
     * 
     */
    public DesignConstraint.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return DesignConstraint.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DesignConstraint.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DesignConstraint.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final DesignConstraint.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final DesignConstraint.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected DesignConstraint.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint.Matcher> querySpecification() {
      return DesignConstraint.instance();
    }
  }
  
  private DesignConstraint() {
   ...
   * 
   */
  public static DesignConstraint instance() {
    try{
  ...
  @Override
  protected DesignConstraint.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint.Matcher instantiate() {
    return DesignConstraint.Matcher.create();
  }
  
  @Override
  public DesignConstraint.Match newEmptyMatch() {
    return DesignConstraint.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint.Match newMatch(final Object... parameters) {
    return DesignConstraint.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DesignConstraint (visibility: PUBLIC, simpleName: DesignConstraint, identifier: sysml.DesignConstraint, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DesignConstraint (visibility: PUBLIC, simpleName: DesignConstraint, identifier: sysml.DesignConstraint, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesignConstraint INSTANCE = new DesignConstraint();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "designConstraint");
