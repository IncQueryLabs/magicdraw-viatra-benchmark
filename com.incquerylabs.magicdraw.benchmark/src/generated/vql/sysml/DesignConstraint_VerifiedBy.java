...
public final class DesignConstraint_VerifiedBy extends BaseGeneratedEMFQuerySpecification<DesignConstraint_VerifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.designConstraint_VerifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.designConstraint_VerifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint_VerifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint_VerifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint_VerifiedBy.Match)) {
          DesignConstraint_VerifiedBy.Match other = (DesignConstraint_VerifiedBy.Match) obj;
    ...
    @Override
    public DesignConstraint_VerifiedBy specification() {
     ...
     * 
     */
    public static DesignConstraint_VerifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint_VerifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static DesignConstraint_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DesignConstraint_VerifiedBy.Match {
    ...
    private static final class Immutable extends DesignConstraint_VerifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.designConstraint_VerifiedBy pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint_VerifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint_VerifiedBy.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint_VerifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint_VerifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint_VerifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint_VerifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<DesignConstraint_VerifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<DesignConstraint_VerifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super DesignConstraint_VerifiedBy.Match> processor) {
     ...
     * 
     */
    public DesignConstraint_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return DesignConstraint_VerifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DesignConstraint_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DesignConstraint_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final DesignConstraint_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final DesignConstraint_VerifiedBy.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint_VerifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected DesignConstraint_VerifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint_VerifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint_VerifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint_VerifiedBy.Matcher> querySpecification() {
      return DesignConstraint_VerifiedBy.instance();
    }
  }
  
  private DesignConstraint_VerifiedBy() {
   ...
   * 
   */
  public static DesignConstraint_VerifiedBy instance() {
    try{
  ...
  @Override
  protected DesignConstraint_VerifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint_VerifiedBy.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint_VerifiedBy.Matcher instantiate() {
    return DesignConstraint_VerifiedBy.Matcher.create();
  }
  
  @Override
  public DesignConstraint_VerifiedBy.Match newEmptyMatch() {
    return DesignConstraint_VerifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint_VerifiedBy.Match newMatch(final Object... parameters) {
    return DesignConstraint_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DesignConstraint_VerifiedBy (visibility: PUBLIC, simpleName: DesignConstraint_VerifiedBy, identifier: sysml.DesignConstraint_VerifiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DesignConstraint_VerifiedBy (visibility: PUBLIC, simpleName: DesignConstraint_VerifiedBy, identifier: sysml.DesignConstraint_VerifiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesignConstraint_VerifiedBy INSTANCE = new DesignConstraint_VerifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint_VerifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
