...
public final class Refine_sourceContext extends BaseGeneratedEMFQuerySpecification<Refine_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Refine_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Refine_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Refine_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public Refine_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Refine_sourceContext.Match)) {
          Refine_sourceContext.Match other = (Refine_sourceContext.Match) obj;
    ...
    @Override
    public Refine_sourceContext specification() {
     ...
     * 
     */
    public static Refine_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Refine_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Refine_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Refine_sourceContext.Match {
    ...
    private static final class Immutable extends Refine_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Refine_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see Refine_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<Refine_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static Refine_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Refine_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Refine_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<Refine_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Refine_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Refine_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Refine_sourceContext.Match> processor) {
     ...
     * 
     */
    public Refine_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Refine_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Refine_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Refine_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Refine_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Refine_sourceContext.Match partialMatch) {
    ...
    @Override
    protected Refine_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return Refine_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Refine_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return Refine_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Refine_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Refine_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Refine_sourceContext.Matcher> querySpecification() {
      return Refine_sourceContext.instance();
    }
  }
  
  private Refine_sourceContext() {
   ...
   * 
   */
  public static Refine_sourceContext instance() {
    try{
  ...
  @Override
  protected Refine_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Refine_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public Refine_sourceContext.Matcher instantiate() {
    return Refine_sourceContext.Matcher.create();
  }
  
  @Override
  public Refine_sourceContext.Match newEmptyMatch() {
    return Refine_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public Refine_sourceContext.Match newMatch(final Object... parameters) {
    return Refine_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Refine_sourceContext (visibility: PUBLIC, simpleName: Refine_sourceContext, identifier: sysml.Refine_sourceContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Refine_sourceContext (visibility: PUBLIC, simpleName: Refine_sourceContext, identifier: sysml.Refine_sourceContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Refine_sourceContext INSTANCE = new Refine_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Refine_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
