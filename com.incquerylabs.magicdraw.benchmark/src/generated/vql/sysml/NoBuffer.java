...
public final class NoBuffer extends BaseGeneratedEMFQuerySpecification<NoBuffer.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.NoBuffer (visibility: PUBLIC, simpleName: NoBuffer, identifier: sysml.NoBuffer, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.NoBuffer (visibility: PUBLIC, simpleName: NoBuffer, identifier: sysml.NoBuffer, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
