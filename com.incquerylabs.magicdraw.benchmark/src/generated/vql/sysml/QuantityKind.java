...
public final class QuantityKind extends BaseGeneratedEMFQuerySpecification<QuantityKind.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.QuantityKind pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    public List<String> parameterNames() {
      return QuantityKind.Match.parameterNames;
    }
    ...
    @Override
    public QuantityKind.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof QuantityKind.Match)) {
          QuantityKind.Match other = (QuantityKind.Match) obj;
    ...
    @Override
    public QuantityKind specification() {
     ...
     * 
     */
    public static QuantityKind.Match newEmptyMatch() {
     ...
     * 
     */
    public static QuantityKind.Match newMutableMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static QuantityKind.Match newMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends QuantityKind.Match {
      Mutable(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    private static final class Immutable extends QuantityKind.Match {
      Immutable(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
        super(pElement, pDomainStereotypeInstance);
      }
  ...
  /**
   * Generated pattern matcher API of the sysml.QuantityKind pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<QuantityKind.Match> {
    /**
     ...
     * 
     */
    public static QuantityKind.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static QuantityKind.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(QuantityKind.Matcher.class);
     ...
     * 
     */
    public Collection<QuantityKind.Match> getAllMatches(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<QuantityKind.Match> streamAllMatches(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<QuantityKind.Match> getOneArbitraryMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean hasMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public int countMatches(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super QuantityKind.Match> processor) {
     ...
     * 
     */
    public QuantityKind.Match newMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return QuantityKind.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<PackageableElement> streamAllValuesOfelement(final QuantityKind.Match partialMatch) {
     ...
     * 
     */
    public Stream<PackageableElement> streamAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Set<PackageableElement> getAllValuesOfelement(final QuantityKind.Match partialMatch) {
     ...
     * 
     */
    public Set<PackageableElement> getAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final QuantityKind.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final PackageableElement pElement) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final QuantityKind.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final PackageableElement pElement) {
      return rawStreamAllValuesOfdomainStereotypeInstance(new Object[]{pElement, null}).collect(Collectors.toSet());
    }
    
    @Override
    protected QuantityKind.Match tupleToMatch(final Tuple t) {
      try {
          return QuantityKind.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected QuantityKind.Match arrayToMatch(final Object[] match) {
      try {
          return QuantityKind.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected QuantityKind.Match arrayToMatchMutable(final Object[] match) {
      try {
          return QuantityKind.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<QuantityKind.Matcher> querySpecification() {
      return QuantityKind.instance();
    }
  }
  
  private QuantityKind() {
   ...
   * 
   */
  public static QuantityKind instance() {
    try{
  ...
  @Override
  protected QuantityKind.Matcher instantiate(final ViatraQueryEngine engine) {
    return QuantityKind.Matcher.on(engine);
  }
  
  @Override
  public QuantityKind.Matcher instantiate() {
    return QuantityKind.Matcher.create();
  }
  
  @Override
  public QuantityKind.Match newEmptyMatch() {
    return QuantityKind.Match.newEmptyMatch();
  }
  
  @Override
  public QuantityKind.Match newMatch(final Object... parameters) {
    return QuantityKind.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.QuantityKind (visibility: PUBLIC, simpleName: QuantityKind, identifier: sysml.QuantityKind, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.QuantityKind (visibility: PUBLIC, simpleName: QuantityKind, identifier: sysml.QuantityKind, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final QuantityKind INSTANCE = new QuantityKind();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final QuantityKind.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "QuantityKind");
