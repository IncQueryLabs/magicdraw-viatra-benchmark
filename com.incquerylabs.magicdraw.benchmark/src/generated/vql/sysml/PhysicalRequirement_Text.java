...
public final class PhysicalRequirement_Text extends BaseGeneratedEMFQuerySpecification<PhysicalRequirement_Text.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.physicalRequirement_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.physicalRequirement_Text";
    }
     ...
     * 
     */
    public static PhysicalRequirement_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static PhysicalRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the sysml.physicalRequirement_Text pattern,
  ...
  public static class Matcher extends BaseMatcher<PhysicalRequirement_Text.Match> {
     ...
     * 
     */
    public Collection<PhysicalRequirement_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<PhysicalRequirement_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<PhysicalRequirement_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super PhysicalRequirement_Text.Match> processor) {
     ...
     * 
     */
    public PhysicalRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return PhysicalRequirement_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final PhysicalRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final PhysicalRequirement_Text.Match partialMatch) {
    ...
    protected PhysicalRequirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    protected PhysicalRequirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected PhysicalRequirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalRequirement_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public PhysicalRequirement_Text.Match newMatch(final Object... parameters) {
    return PhysicalRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PhysicalRequirement_Text (visibility: PUBLIC, simpleName: PhysicalRequirement_Text, identifier: sysml.PhysicalRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PhysicalRequirement_Text (visibility: PUBLIC, simpleName: PhysicalRequirement_Text, identifier: sysml.PhysicalRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
