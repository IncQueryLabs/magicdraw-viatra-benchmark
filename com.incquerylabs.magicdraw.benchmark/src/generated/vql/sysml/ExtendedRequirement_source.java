...
public final class ExtendedRequirement_source extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_source.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement_source pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement_source";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement_source.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement_source.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtendedRequirement_source.Match)) {
          ExtendedRequirement_source.Match other = (ExtendedRequirement_source.Match) obj;
    ...
    @Override
    public ExtendedRequirement_source specification() {
     ...
     * 
     */
    public static ExtendedRequirement_source.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtendedRequirement_source.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ExtendedRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ExtendedRequirement_source.Match {
    ...
    private static final class Immutable extends ExtendedRequirement_source.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement_source pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement_source
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement_source.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement_source.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement_source.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtendedRequirement_source.Matcher.class);
     ...
     * 
     */
    public Collection<ExtendedRequirement_source.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ExtendedRequirement_source.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ExtendedRequirement_source.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ExtendedRequirement_source.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ExtendedRequirement_source.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExtendedRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExtendedRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ExtendedRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ExtendedRequirement_source.Match partialMatch) {
    ...
    @Override
    protected ExtendedRequirement_source.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ExtendedRequirement_source.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExtendedRequirement_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement_source.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement_source.Matcher> querySpecification() {
      return ExtendedRequirement_source.instance();
    }
  }
  
  private ExtendedRequirement_source() {
   ...
   * 
   */
  public static ExtendedRequirement_source instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement_source.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement_source.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement_source.Matcher instantiate() {
    return ExtendedRequirement_source.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement_source.Match newEmptyMatch() {
    return ExtendedRequirement_source.Match.newEmptyMatch();
  }
  
  @Override
  public ExtendedRequirement_source.Match newMatch(final Object... parameters) {
    return ExtendedRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ExtendedRequirement_source (visibility: PUBLIC, simpleName: ExtendedRequirement_source, identifier: sysml.ExtendedRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ExtendedRequirement_source (visibility: PUBLIC, simpleName: ExtendedRequirement_source, identifier: sysml.ExtendedRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement_source INSTANCE = new ExtendedRequirement_source();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExtendedRequirement_source.GeneratedPQuery INSTANCE = new GeneratedPQuery();
