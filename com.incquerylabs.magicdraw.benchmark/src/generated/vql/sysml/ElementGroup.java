...
public final class ElementGroup extends BaseGeneratedEMFQuerySpecification<ElementGroup.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ElementGroup pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.ElementGroup";
    }
    
    @Override
    public List<String> parameterNames() {
      return ElementGroup.Match.parameterNames;
    }
    ...
    @Override
    public ElementGroup.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ElementGroup.Match)) {
          ElementGroup.Match other = (ElementGroup.Match) obj;
    ...
    @Override
    public ElementGroup specification() {
     ...
     * 
     */
    public static ElementGroup.Match newEmptyMatch() {
     ...
     * 
     */
    public static ElementGroup.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ElementGroup.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ElementGroup.Match {
    ...
    private static final class Immutable extends ElementGroup.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.ElementGroup pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ElementGroup.Match> {
    /**
     ...
     * 
     */
    public static ElementGroup.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ElementGroup.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ElementGroup.Matcher.class);
     ...
     * 
     */
    public Collection<ElementGroup.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ElementGroup.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ElementGroup.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ElementGroup.Match> processor) {
     ...
     * 
     */
    public ElementGroup.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ElementGroup.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final ElementGroup.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final ElementGroup.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ElementGroup.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ElementGroup.Match partialMatch) {
    ...
    @Override
    protected ElementGroup.Match tupleToMatch(final Tuple t) {
      try {
          return ElementGroup.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ElementGroup.Match arrayToMatch(final Object[] match) {
      try {
          return ElementGroup.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ElementGroup.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ElementGroup.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ElementGroup.Matcher> querySpecification() {
      return ElementGroup.instance();
    }
  }
   ...
   * 
   */
  public static ElementGroup instance() {
    try{
  ...
  @Override
  protected ElementGroup.Matcher instantiate(final ViatraQueryEngine engine) {
    return ElementGroup.Matcher.on(engine);
  }
  
  @Override
  public ElementGroup.Matcher instantiate() {
    return ElementGroup.Matcher.create();
  }
  
  @Override
  public ElementGroup.Match newEmptyMatch() {
    return ElementGroup.Match.newEmptyMatch();
  }
  
  @Override
  public ElementGroup.Match newMatch(final Object... parameters) {
    return ElementGroup.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ElementGroup (visibility: PUBLIC, simpleName: ElementGroup, identifier: sysml.ElementGroup, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ElementGroup (visibility: PUBLIC, simpleName: ElementGroup, identifier: sysml.ElementGroup, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ElementGroup INSTANCE = new ElementGroup();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ElementGroup.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ElementGroup");
