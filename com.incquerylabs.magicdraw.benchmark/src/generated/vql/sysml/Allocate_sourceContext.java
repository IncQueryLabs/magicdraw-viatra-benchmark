...
public final class Allocate_sourceContext extends BaseGeneratedEMFQuerySpecification<Allocate_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Allocate_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Allocate_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Allocate_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public Allocate_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Allocate_sourceContext.Match)) {
          Allocate_sourceContext.Match other = (Allocate_sourceContext.Match) obj;
    ...
    @Override
    public Allocate_sourceContext specification() {
     ...
     * 
     */
    public static Allocate_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Allocate_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Allocate_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Allocate_sourceContext.Match {
    ...
    private static final class Immutable extends Allocate_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Allocate_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see Allocate_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<Allocate_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static Allocate_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Allocate_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Allocate_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<Allocate_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Allocate_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Allocate_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Allocate_sourceContext.Match> processor) {
     ...
     * 
     */
    public Allocate_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Allocate_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Allocate_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Allocate_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Allocate_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Allocate_sourceContext.Match partialMatch) {
    ...
    @Override
    protected Allocate_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return Allocate_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Allocate_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return Allocate_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Allocate_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Allocate_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Allocate_sourceContext.Matcher> querySpecification() {
      return Allocate_sourceContext.instance();
    }
  }
  
  private Allocate_sourceContext() {
   ...
   * 
   */
  public static Allocate_sourceContext instance() {
    try{
  ...
  @Override
  protected Allocate_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Allocate_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public Allocate_sourceContext.Matcher instantiate() {
    return Allocate_sourceContext.Matcher.create();
  }
  
  @Override
  public Allocate_sourceContext.Match newEmptyMatch() {
    return Allocate_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public Allocate_sourceContext.Match newMatch(final Object... parameters) {
    return Allocate_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Allocate_sourceContext (visibility: PUBLIC, simpleName: Allocate_sourceContext, identifier: sysml.Allocate_sourceContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Allocate_sourceContext (visibility: PUBLIC, simpleName: Allocate_sourceContext, identifier: sysml.Allocate_sourceContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Allocate_sourceContext INSTANCE = new Allocate_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Allocate_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
