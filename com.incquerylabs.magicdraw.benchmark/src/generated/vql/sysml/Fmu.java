...
public final class Fmu extends BaseGeneratedEMFQuerySpecification<Fmu.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.fmu pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Fmu.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Fmu.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the sysml.fmu pattern,
  ...
  public static class Matcher extends BaseMatcher<Fmu.Match> {
     ...
     * 
     */
    public Collection<Fmu.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Fmu.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Fmu.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Fmu.Match> processor) {
     ...
     * 
     */
    public Fmu.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Fmu.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Fmu.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Fmu.Match partialMatch) {
    ...
    protected Fmu.Match tupleToMatch(final Tuple t) {
      try {
          return Fmu.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected Fmu.Match arrayToMatch(final Object[] match) {
      try {
          return Fmu.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected Fmu.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Fmu.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Fmu.Match newMatch(final Object... parameters) {
    return Fmu.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Fmu (visibility: PUBLIC, simpleName: Fmu, identifier: sysml.Fmu, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Fmu (visibility: PUBLIC, simpleName: Fmu, identifier: sysml.Fmu, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
