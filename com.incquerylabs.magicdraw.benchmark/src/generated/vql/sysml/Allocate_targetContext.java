...
public final class Allocate_targetContext extends BaseGeneratedEMFQuerySpecification<Allocate_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Allocate_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Allocate_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Allocate_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Allocate_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Allocate_targetContext.Match)) {
          Allocate_targetContext.Match other = (Allocate_targetContext.Match) obj;
    ...
    @Override
    public Allocate_targetContext specification() {
     ...
     * 
     */
    public static Allocate_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Allocate_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Allocate_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Allocate_targetContext.Match {
    ...
    private static final class Immutable extends Allocate_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Allocate_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Allocate_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Allocate_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Allocate_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Allocate_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Allocate_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Allocate_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Allocate_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Allocate_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Allocate_targetContext.Match> processor) {
     ...
     * 
     */
    public Allocate_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Allocate_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Allocate_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Allocate_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Allocate_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Allocate_targetContext.Match partialMatch) {
    ...
    @Override
    protected Allocate_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Allocate_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Allocate_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Allocate_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Allocate_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Allocate_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Allocate_targetContext.Matcher> querySpecification() {
      return Allocate_targetContext.instance();
    }
  }
  
  private Allocate_targetContext() {
   ...
   * 
   */
  public static Allocate_targetContext instance() {
    try{
  ...
  @Override
  protected Allocate_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Allocate_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Allocate_targetContext.Matcher instantiate() {
    return Allocate_targetContext.Matcher.create();
  }
  
  @Override
  public Allocate_targetContext.Match newEmptyMatch() {
    return Allocate_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Allocate_targetContext.Match newMatch(final Object... parameters) {
    return Allocate_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Allocate_targetContext (visibility: PUBLIC, simpleName: Allocate_targetContext, identifier: sysml.Allocate_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Allocate_targetContext (visibility: PUBLIC, simpleName: Allocate_targetContext, identifier: sysml.Allocate_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Allocate_targetContext INSTANCE = new Allocate_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Allocate_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
