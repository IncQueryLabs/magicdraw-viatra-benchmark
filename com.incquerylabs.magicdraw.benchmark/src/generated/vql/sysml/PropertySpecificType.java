...
public final class PropertySpecificType extends BaseGeneratedEMFQuerySpecification<PropertySpecificType.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.PropertySpecificType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public List<String> parameterNames() {
      return PropertySpecificType.Match.parameterNames;
    }
    ...
    @Override
    public PropertySpecificType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PropertySpecificType.Match)) {
          PropertySpecificType.Match other = (PropertySpecificType.Match) obj;
    ...
    @Override
    public PropertySpecificType specification() {
     ...
     * 
     */
    public static PropertySpecificType.Match newEmptyMatch() {
     ...
     * 
     */
    public static PropertySpecificType.Match newMutableMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static PropertySpecificType.Match newMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends PropertySpecificType.Match {
    ...
    private static final class Immutable extends PropertySpecificType.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.PropertySpecificType pattern,
   ...
   * 
   * @see Match
   * @see PropertySpecificType
   * 
   */
  public static class Matcher extends BaseMatcher<PropertySpecificType.Match> {
    /**
     ...
     * 
     */
    public static PropertySpecificType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PropertySpecificType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PropertySpecificType.Matcher.class);
     ...
     * 
     */
    public Collection<PropertySpecificType.Match> getAllMatches(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<PropertySpecificType.Match> streamAllMatches(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<PropertySpecificType.Match> getOneArbitraryMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super PropertySpecificType.Match> processor) {
     ...
     * 
     */
    public PropertySpecificType.Match newMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return PropertySpecificType.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfelement(final PropertySpecificType.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfelement(final PropertySpecificType.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final PropertySpecificType.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final PropertySpecificType.Match partialMatch) {
    ...
    @Override
    protected PropertySpecificType.Match tupleToMatch(final Tuple t) {
      try {
          return PropertySpecificType.Match.newMatch((Classifier) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected PropertySpecificType.Match arrayToMatch(final Object[] match) {
      try {
          return PropertySpecificType.Match.newMatch((Classifier) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PropertySpecificType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PropertySpecificType.Match.newMutableMatch((Classifier) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PropertySpecificType.Matcher> querySpecification() {
      return PropertySpecificType.instance();
    }
  }
  
  private PropertySpecificType() {
   ...
   * 
   */
  public static PropertySpecificType instance() {
    try{
  ...
  @Override
  protected PropertySpecificType.Matcher instantiate(final ViatraQueryEngine engine) {
    return PropertySpecificType.Matcher.on(engine);
  }
  
  @Override
  public PropertySpecificType.Matcher instantiate() {
    return PropertySpecificType.Matcher.create();
  }
  
  @Override
  public PropertySpecificType.Match newEmptyMatch() {
    return PropertySpecificType.Match.newEmptyMatch();
  }
  
  @Override
  public PropertySpecificType.Match newMatch(final Object... parameters) {
    return PropertySpecificType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PropertySpecificType (visibility: PUBLIC, simpleName: PropertySpecificType, identifier: sysml.PropertySpecificType, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PropertySpecificType (visibility: PUBLIC, simpleName: PropertySpecificType, identifier: sysml.PropertySpecificType, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PropertySpecificType INSTANCE = new PropertySpecificType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PropertySpecificType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "PropertySpecificType");
