...
public final class View extends BaseGeneratedEMFQuerySpecification<View.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.View pattern,
  ...
  /**
   * Generated pattern matcher API of the sysml.View pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.View (visibility: PUBLIC, simpleName: View, identifier: sysml.View, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.View (visibility: PUBLIC, simpleName: View, identifier: sysml.View, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
