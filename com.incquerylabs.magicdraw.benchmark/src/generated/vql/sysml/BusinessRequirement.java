...
public final class BusinessRequirement extends BaseGeneratedEMFQuerySpecification<BusinessRequirement.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.businessRequirement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.businessRequirement";
    }
    
    @Override
    public List<String> parameterNames() {
      return BusinessRequirement.Match.parameterNames;
    }
    ...
    @Override
    public BusinessRequirement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BusinessRequirement.Match)) {
          BusinessRequirement.Match other = (BusinessRequirement.Match) obj;
    ...
    @Override
    public BusinessRequirement specification() {
     ...
     * 
     */
    public static BusinessRequirement.Match newEmptyMatch() {
     ...
     * 
     */
    public static BusinessRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static BusinessRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends BusinessRequirement.Match {
    ...
    private static final class Immutable extends BusinessRequirement.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.businessRequirement pattern,
   ...
   * 
   * @see Match
   * @see BusinessRequirement
   * 
   */
  public static class Matcher extends BaseMatcher<BusinessRequirement.Match> {
    /**
     ...
     * 
     */
    public static BusinessRequirement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BusinessRequirement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BusinessRequirement.Matcher.class);
     ...
     * 
     */
    public Collection<BusinessRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<BusinessRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<BusinessRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super BusinessRequirement.Match> processor) {
     ...
     * 
     */
    public BusinessRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return BusinessRequirement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final BusinessRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final BusinessRequirement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final BusinessRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final BusinessRequirement.Match partialMatch) {
    ...
    @Override
    protected BusinessRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return BusinessRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected BusinessRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return BusinessRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BusinessRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BusinessRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BusinessRequirement.Matcher> querySpecification() {
      return BusinessRequirement.instance();
    }
  }
  
  private BusinessRequirement() {
   ...
   * 
   */
  public static BusinessRequirement instance() {
    try{
  ...
  @Override
  protected BusinessRequirement.Matcher instantiate(final ViatraQueryEngine engine) {
    return BusinessRequirement.Matcher.on(engine);
  }
  
  @Override
  public BusinessRequirement.Matcher instantiate() {
    return BusinessRequirement.Matcher.create();
  }
  
  @Override
  public BusinessRequirement.Match newEmptyMatch() {
    return BusinessRequirement.Match.newEmptyMatch();
  }
  
  @Override
  public BusinessRequirement.Match newMatch(final Object... parameters) {
    return BusinessRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BusinessRequirement (visibility: PUBLIC, simpleName: BusinessRequirement, identifier: sysml.BusinessRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BusinessRequirement (visibility: PUBLIC, simpleName: BusinessRequirement, identifier: sysml.BusinessRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BusinessRequirement INSTANCE = new BusinessRequirement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BusinessRequirement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "businessRequirement");
