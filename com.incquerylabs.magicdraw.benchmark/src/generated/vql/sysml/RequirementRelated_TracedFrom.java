...
public final class RequirementRelated_TracedFrom extends BaseGeneratedEMFQuerySpecification<RequirementRelated_TracedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.RequirementRelated_TracedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.RequirementRelated_TracedFrom";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.RequirementRelated_TracedFrom pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.RequirementRelated_TracedFrom (visibility: PUBLIC, simpleName: RequirementRelated_TracedFrom, identifier: sysml.RequirementRelated_TracedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.RequirementRelated_TracedFrom (visibility: PUBLIC, simpleName: RequirementRelated_TracedFrom, identifier: sysml.RequirementRelated_TracedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
