...
public final class FunctionalRequirement_source extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement_source.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.functionalRequirement_source pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.functionalRequirement_source";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalRequirement_source.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalRequirement_source.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalRequirement_source.Match)) {
          FunctionalRequirement_source.Match other = (FunctionalRequirement_source.Match) obj;
    ...
    @Override
    public FunctionalRequirement_source specification() {
     ...
     * 
     */
    public static FunctionalRequirement_source.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalRequirement_source.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static FunctionalRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends FunctionalRequirement_source.Match {
    ...
    private static final class Immutable extends FunctionalRequirement_source.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.functionalRequirement_source pattern,
   ...
   * 
   * @see Match
   * @see FunctionalRequirement_source
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalRequirement_source.Match> {
    /**
     ...
     * 
     */
    public static FunctionalRequirement_source.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalRequirement_source.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalRequirement_source.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalRequirement_source.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<FunctionalRequirement_source.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<FunctionalRequirement_source.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super FunctionalRequirement_source.Match> processor) {
     ...
     * 
     */
    public FunctionalRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return FunctionalRequirement_source.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final FunctionalRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final FunctionalRequirement_source.Match partialMatch) {
    ...
    @Override
    protected FunctionalRequirement_source.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected FunctionalRequirement_source.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalRequirement_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalRequirement_source.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalRequirement_source.Matcher> querySpecification() {
      return FunctionalRequirement_source.instance();
    }
  }
  
  private FunctionalRequirement_source() {
   ...
   * 
   */
  public static FunctionalRequirement_source instance() {
    try{
  ...
  @Override
  protected FunctionalRequirement_source.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalRequirement_source.Matcher.on(engine);
  }
  
  @Override
  public FunctionalRequirement_source.Matcher instantiate() {
    return FunctionalRequirement_source.Matcher.create();
  }
  
  @Override
  public FunctionalRequirement_source.Match newEmptyMatch() {
    return FunctionalRequirement_source.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalRequirement_source.Match newMatch(final Object... parameters) {
    return FunctionalRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FunctionalRequirement_source (visibility: PUBLIC, simpleName: FunctionalRequirement_source, identifier: sysml.FunctionalRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FunctionalRequirement_source (visibility: PUBLIC, simpleName: FunctionalRequirement_source, identifier: sysml.FunctionalRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalRequirement_source INSTANCE = new FunctionalRequirement_source();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalRequirement_source.GeneratedPQuery INSTANCE = new GeneratedPQuery();
