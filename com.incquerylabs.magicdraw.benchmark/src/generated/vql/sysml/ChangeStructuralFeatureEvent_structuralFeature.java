...
public final class ChangeStructuralFeatureEvent_structuralFeature extends BaseGeneratedEMFQuerySpecification<ChangeStructuralFeatureEvent_structuralFeature.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ChangeStructuralFeatureEvent_structuralFeature (visibility: PUBLIC, simpleName: ChangeStructuralFeatureEvent_structuralFeature, identifier: sysml.ChangeStructuralFeatureEvent_structuralFeature, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ChangeStructuralFeatureEvent_structuralFeature (visibility: PUBLIC, simpleName: ChangeStructuralFeatureEvent_structuralFeature, identifier: sysml.ChangeStructuralFeatureEvent_structuralFeature, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
