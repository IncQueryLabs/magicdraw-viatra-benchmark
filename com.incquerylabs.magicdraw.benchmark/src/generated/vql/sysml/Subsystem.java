...
public final class Subsystem extends BaseGeneratedEMFQuerySpecification<Subsystem.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Subsystem pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Subsystem";
    }
    
    @Override
    public List<String> parameterNames() {
      return Subsystem.Match.parameterNames;
    }
    ...
    @Override
    public Subsystem.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Subsystem.Match)) {
          Subsystem.Match other = (Subsystem.Match) obj;
    ...
    @Override
    public Subsystem specification() {
     ...
     * 
     */
    public static Subsystem.Match newEmptyMatch() {
     ...
     * 
     */
    public static Subsystem.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Subsystem.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Subsystem.Match {
    ...
    private static final class Immutable extends Subsystem.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Subsystem pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Subsystem.Match> {
    /**
     ...
     * 
     */
    public static Subsystem.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Subsystem.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Subsystem.Matcher.class);
     ...
     * 
     */
    public Collection<Subsystem.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Subsystem.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Subsystem.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Subsystem.Match> processor) {
     ...
     * 
     */
    public Subsystem.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Subsystem.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Subsystem.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Subsystem.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Subsystem.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Subsystem.Match partialMatch) {
    ...
    @Override
    protected Subsystem.Match tupleToMatch(final Tuple t) {
      try {
          return Subsystem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Subsystem.Match arrayToMatch(final Object[] match) {
      try {
          return Subsystem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Subsystem.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Subsystem.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Subsystem.Matcher> querySpecification() {
      return Subsystem.instance();
    }
  }
  ...
  @Override
  protected Subsystem.Matcher instantiate(final ViatraQueryEngine engine) {
    return Subsystem.Matcher.on(engine);
  }
  
  @Override
  public Subsystem.Matcher instantiate() {
    return Subsystem.Matcher.create();
  }
  
  @Override
  public Subsystem.Match newEmptyMatch() {
    return Subsystem.Match.newEmptyMatch();
  }
  
  @Override
  public Subsystem.Match newMatch(final Object... parameters) {
    return Subsystem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Subsystem (visibility: PUBLIC, simpleName: Subsystem, identifier: sysml.Subsystem, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Subsystem (visibility: PUBLIC, simpleName: Subsystem, identifier: sysml.Subsystem, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Subsystem INSTANCE = new Subsystem();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Subsystem.GeneratedPQuery INSTANCE = new GeneratedPQuery();
