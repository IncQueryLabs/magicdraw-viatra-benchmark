...
public final class Requirement_VerifiedBy extends BaseGeneratedEMFQuerySpecification<Requirement_VerifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Requirement_VerifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Requirement_VerifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return Requirement_VerifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public Requirement_VerifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Requirement_VerifiedBy.Match)) {
          Requirement_VerifiedBy.Match other = (Requirement_VerifiedBy.Match) obj;
    ...
    @Override
    public Requirement_VerifiedBy specification() {
     ...
     * 
     */
    public static Requirement_VerifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static Requirement_VerifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static Requirement_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Requirement_VerifiedBy.Match {
    ...
    private static final class Immutable extends Requirement_VerifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Requirement_VerifiedBy pattern,
   ...
   * 
   * @see Match
   * @see Requirement_VerifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<Requirement_VerifiedBy.Match> {
    /**
     ...
     * 
     */
    public static Requirement_VerifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Requirement_VerifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Requirement_VerifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<Requirement_VerifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<Requirement_VerifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<Requirement_VerifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super Requirement_VerifiedBy.Match> processor) {
     ...
     * 
     */
    public Requirement_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return Requirement_VerifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Requirement_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Requirement_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final Requirement_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final Requirement_VerifiedBy.Match partialMatch) {
    ...
    @Override
    protected Requirement_VerifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return Requirement_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected Requirement_VerifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return Requirement_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Requirement_VerifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Requirement_VerifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Requirement_VerifiedBy.Matcher> querySpecification() {
      return Requirement_VerifiedBy.instance();
    }
  }
  
  private Requirement_VerifiedBy() {
   ...
   * 
   */
  public static Requirement_VerifiedBy instance() {
    try{
  ...
  @Override
  protected Requirement_VerifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return Requirement_VerifiedBy.Matcher.on(engine);
  }
  
  @Override
  public Requirement_VerifiedBy.Matcher instantiate() {
    return Requirement_VerifiedBy.Matcher.create();
  }
  
  @Override
  public Requirement_VerifiedBy.Match newEmptyMatch() {
    return Requirement_VerifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public Requirement_VerifiedBy.Match newMatch(final Object... parameters) {
    return Requirement_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Requirement_VerifiedBy (visibility: PUBLIC, simpleName: Requirement_VerifiedBy, identifier: sysml.Requirement_VerifiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Requirement_VerifiedBy (visibility: PUBLIC, simpleName: Requirement_VerifiedBy, identifier: sysml.Requirement_VerifiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Requirement_VerifiedBy INSTANCE = new Requirement_VerifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Requirement_VerifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
