...
public final class FunctionalRequirement_Derived extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.functionalRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.functionalRequirement_Derived";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.functionalRequirement_Derived pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FunctionalRequirement_Derived (visibility: PUBLIC, simpleName: FunctionalRequirement_Derived, identifier: sysml.FunctionalRequirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FunctionalRequirement_Derived (visibility: PUBLIC, simpleName: FunctionalRequirement_Derived, identifier: sysml.FunctionalRequirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
