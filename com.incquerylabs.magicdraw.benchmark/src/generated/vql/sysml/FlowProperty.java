...
public final class FlowProperty extends BaseGeneratedEMFQuerySpecification<FlowProperty.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.FlowProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public List<String> parameterNames() {
      return FlowProperty.Match.parameterNames;
    }
    ...
    @Override
    public FlowProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FlowProperty.Match)) {
          FlowProperty.Match other = (FlowProperty.Match) obj;
    ...
    @Override
    public FlowProperty specification() {
     ...
     * 
     */
    public static FlowProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static FlowProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FlowProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends FlowProperty.Match {
    ...
    private static final class Immutable extends FlowProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.FlowProperty pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<FlowProperty.Match> {
    /**
     ...
     * 
     */
    public static FlowProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FlowProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FlowProperty.Matcher.class);
     ...
     * 
     */
    public Collection<FlowProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FlowProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FlowProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FlowProperty.Match> processor) {
     ...
     * 
     */
    public FlowProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FlowProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final FlowProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final FlowProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FlowProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FlowProperty.Match partialMatch) {
    ...
    @Override
    protected FlowProperty.Match tupleToMatch(final Tuple t) {
      try {
          return FlowProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected FlowProperty.Match arrayToMatch(final Object[] match) {
      try {
          return FlowProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FlowProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FlowProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FlowProperty.Matcher> querySpecification() {
      return FlowProperty.instance();
    }
  }
   ...
   * 
   */
  public static FlowProperty instance() {
    try{
  ...
  @Override
  protected FlowProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return FlowProperty.Matcher.on(engine);
  }
  
  @Override
  public FlowProperty.Matcher instantiate() {
    return FlowProperty.Matcher.create();
  }
  
  @Override
  public FlowProperty.Match newEmptyMatch() {
    return FlowProperty.Match.newEmptyMatch();
  }
  
  @Override
  public FlowProperty.Match newMatch(final Object... parameters) {
    return FlowProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FlowProperty (visibility: PUBLIC, simpleName: FlowProperty, identifier: sysml.FlowProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FlowProperty (visibility: PUBLIC, simpleName: FlowProperty, identifier: sysml.FlowProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FlowProperty INSTANCE = new FlowProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FlowProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "FlowProperty");
