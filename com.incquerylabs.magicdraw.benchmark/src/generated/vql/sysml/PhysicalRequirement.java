...
public final class PhysicalRequirement extends BaseGeneratedEMFQuerySpecification<PhysicalRequirement.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.physicalRequirement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.physicalRequirement";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalRequirement.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalRequirement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalRequirement.Match)) {
          PhysicalRequirement.Match other = (PhysicalRequirement.Match) obj;
    ...
    @Override
    public PhysicalRequirement specification() {
     ...
     * 
     */
    public static PhysicalRequirement.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static PhysicalRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends PhysicalRequirement.Match {
    ...
    private static final class Immutable extends PhysicalRequirement.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.physicalRequirement pattern,
   ...
   * 
   * @see Match
   * @see PhysicalRequirement
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalRequirement.Match> {
    /**
     ...
     * 
     */
    public static PhysicalRequirement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalRequirement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalRequirement.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<PhysicalRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<PhysicalRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super PhysicalRequirement.Match> processor) {
     ...
     * 
     */
    public PhysicalRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return PhysicalRequirement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalRequirement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final PhysicalRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final PhysicalRequirement.Match partialMatch) {
    ...
    @Override
    protected PhysicalRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected PhysicalRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalRequirement.Matcher> querySpecification() {
      return PhysicalRequirement.instance();
    }
  }
   ...
   * 
   */
  public static PhysicalRequirement instance() {
    try{
  ...
  @Override
  protected PhysicalRequirement.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalRequirement.Matcher.on(engine);
  }
  
  @Override
  public PhysicalRequirement.Matcher instantiate() {
    return PhysicalRequirement.Matcher.create();
  }
  
  @Override
  public PhysicalRequirement.Match newEmptyMatch() {
    return PhysicalRequirement.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalRequirement.Match newMatch(final Object... parameters) {
    return PhysicalRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PhysicalRequirement (visibility: PUBLIC, simpleName: PhysicalRequirement, identifier: sysml.PhysicalRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PhysicalRequirement (visibility: PUBLIC, simpleName: PhysicalRequirement, identifier: sysml.PhysicalRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalRequirement INSTANCE = new PhysicalRequirement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalRequirement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "physicalRequirement");
