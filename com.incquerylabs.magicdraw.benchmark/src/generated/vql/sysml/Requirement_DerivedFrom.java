...
public final class Requirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<Requirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Requirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Requirement_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return Requirement_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public Requirement_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Requirement_DerivedFrom.Match)) {
          Requirement_DerivedFrom.Match other = (Requirement_DerivedFrom.Match) obj;
    ...
    @Override
    public Requirement_DerivedFrom specification() {
     ...
     * 
     */
    public static Requirement_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static Requirement_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static Requirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Requirement_DerivedFrom.Match {
    ...
    private static final class Immutable extends Requirement_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Requirement_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see Requirement_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<Requirement_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static Requirement_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Requirement_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Requirement_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<Requirement_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<Requirement_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<Requirement_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super Requirement_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public Requirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return Requirement_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Requirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Requirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final Requirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final Requirement_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected Requirement_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return Requirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected Requirement_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return Requirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Requirement_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Requirement_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Requirement_DerivedFrom.Matcher> querySpecification() {
      return Requirement_DerivedFrom.instance();
    }
  }
  
  private Requirement_DerivedFrom() {
   ...
   * 
   */
  public static Requirement_DerivedFrom instance() {
    try{
  ...
  @Override
  protected Requirement_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return Requirement_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public Requirement_DerivedFrom.Matcher instantiate() {
    return Requirement_DerivedFrom.Matcher.create();
  }
  
  @Override
  public Requirement_DerivedFrom.Match newEmptyMatch() {
    return Requirement_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public Requirement_DerivedFrom.Match newMatch(final Object... parameters) {
    return Requirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Requirement_DerivedFrom (visibility: PUBLIC, simpleName: Requirement_DerivedFrom, identifier: sysml.Requirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Requirement_DerivedFrom (visibility: PUBLIC, simpleName: Requirement_DerivedFrom, identifier: sysml.Requirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Requirement_DerivedFrom INSTANCE = new Requirement_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Requirement_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Requirement(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Requirement.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "DerivedFrom", valuespec)
