...
public final class Verify_sourceContext extends BaseGeneratedEMFQuerySpecification<Verify_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Verify_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Verify_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Verify_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public Verify_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Verify_sourceContext.Match)) {
          Verify_sourceContext.Match other = (Verify_sourceContext.Match) obj;
    ...
    @Override
    public Verify_sourceContext specification() {
     ...
     * 
     */
    public static Verify_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Verify_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Verify_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Verify_sourceContext.Match {
    ...
    private static final class Immutable extends Verify_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Verify_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see Verify_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<Verify_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static Verify_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Verify_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Verify_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<Verify_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Verify_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Verify_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Verify_sourceContext.Match> processor) {
     ...
     * 
     */
    public Verify_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Verify_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Verify_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Verify_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Verify_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Verify_sourceContext.Match partialMatch) {
    ...
    @Override
    protected Verify_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return Verify_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Verify_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return Verify_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Verify_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Verify_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Verify_sourceContext.Matcher> querySpecification() {
      return Verify_sourceContext.instance();
    }
  }
  
  private Verify_sourceContext() {
   ...
   * 
   */
  public static Verify_sourceContext instance() {
    try{
  ...
  @Override
  protected Verify_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Verify_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public Verify_sourceContext.Matcher instantiate() {
    return Verify_sourceContext.Matcher.create();
  }
  
  @Override
  public Verify_sourceContext.Match newEmptyMatch() {
    return Verify_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public Verify_sourceContext.Match newMatch(final Object... parameters) {
    return Verify_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Verify_sourceContext (visibility: PUBLIC, simpleName: Verify_sourceContext, identifier: sysml.Verify_sourceContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Verify_sourceContext (visibility: PUBLIC, simpleName: Verify_sourceContext, identifier: sysml.Verify_sourceContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Verify_sourceContext INSTANCE = new Verify_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Verify_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
