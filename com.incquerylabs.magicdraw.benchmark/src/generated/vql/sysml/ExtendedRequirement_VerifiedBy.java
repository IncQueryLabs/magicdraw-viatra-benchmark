...
public final class ExtendedRequirement_VerifiedBy extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_VerifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement_VerifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement_VerifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement_VerifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement_VerifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtendedRequirement_VerifiedBy.Match)) {
          ExtendedRequirement_VerifiedBy.Match other = (ExtendedRequirement_VerifiedBy.Match) obj;
    ...
    @Override
    public ExtendedRequirement_VerifiedBy specification() {
     ...
     * 
     */
    public static ExtendedRequirement_VerifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtendedRequirement_VerifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static ExtendedRequirement_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExtendedRequirement_VerifiedBy.Match {
    ...
    private static final class Immutable extends ExtendedRequirement_VerifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement_VerifiedBy pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement_VerifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement_VerifiedBy.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement_VerifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement_VerifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtendedRequirement_VerifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<ExtendedRequirement_VerifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<ExtendedRequirement_VerifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<ExtendedRequirement_VerifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super ExtendedRequirement_VerifiedBy.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return ExtendedRequirement_VerifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExtendedRequirement_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExtendedRequirement_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final ExtendedRequirement_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final ExtendedRequirement_VerifiedBy.Match partialMatch) {
    ...
    @Override
    protected ExtendedRequirement_VerifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExtendedRequirement_VerifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExtendedRequirement_VerifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement_VerifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement_VerifiedBy.Matcher> querySpecification() {
      return ExtendedRequirement_VerifiedBy.instance();
    }
  }
  
  private ExtendedRequirement_VerifiedBy() {
   ...
   * 
   */
  public static ExtendedRequirement_VerifiedBy instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement_VerifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement_VerifiedBy.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement_VerifiedBy.Matcher instantiate() {
    return ExtendedRequirement_VerifiedBy.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement_VerifiedBy.Match newEmptyMatch() {
    return ExtendedRequirement_VerifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public ExtendedRequirement_VerifiedBy.Match newMatch(final Object... parameters) {
    return ExtendedRequirement_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ExtendedRequirement_VerifiedBy (visibility: PUBLIC, simpleName: ExtendedRequirement_VerifiedBy, identifier: sysml.ExtendedRequirement_VerifiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ExtendedRequirement_VerifiedBy (visibility: PUBLIC, simpleName: ExtendedRequirement_VerifiedBy, identifier: sysml.ExtendedRequirement_VerifiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement_VerifiedBy INSTANCE = new ExtendedRequirement_VerifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExtendedRequirement_VerifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
