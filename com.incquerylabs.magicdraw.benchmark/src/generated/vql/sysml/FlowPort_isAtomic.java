...
public final class FlowPort_isAtomic extends BaseGeneratedEMFQuerySpecification<FlowPort_isAtomic.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FlowPort_isAtomic (visibility: PUBLIC, simpleName: FlowPort_isAtomic, identifier: sysml.FlowPort_isAtomic, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FlowPort_isAtomic (visibility: PUBLIC, simpleName: FlowPort_isAtomic, identifier: sysml.FlowPort_isAtomic, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
