...
public final class Copy_targetContext extends BaseGeneratedEMFQuerySpecification<Copy_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Copy_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Copy_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Copy_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Copy_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Copy_targetContext.Match)) {
          Copy_targetContext.Match other = (Copy_targetContext.Match) obj;
    ...
    @Override
    public Copy_targetContext specification() {
     ...
     * 
     */
    public static Copy_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Copy_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Copy_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Copy_targetContext.Match {
    ...
    private static final class Immutable extends Copy_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Copy_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Copy_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Copy_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Copy_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Copy_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Copy_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Copy_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Copy_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Copy_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Copy_targetContext.Match> processor) {
     ...
     * 
     */
    public Copy_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Copy_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Copy_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Copy_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Copy_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Copy_targetContext.Match partialMatch) {
    ...
    @Override
    protected Copy_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Copy_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Copy_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Copy_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Copy_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Copy_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Copy_targetContext.Matcher> querySpecification() {
      return Copy_targetContext.instance();
    }
  }
  
  private Copy_targetContext() {
   ...
   * 
   */
  public static Copy_targetContext instance() {
    try{
  ...
  @Override
  protected Copy_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Copy_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Copy_targetContext.Matcher instantiate() {
    return Copy_targetContext.Matcher.create();
  }
  
  @Override
  public Copy_targetContext.Match newEmptyMatch() {
    return Copy_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Copy_targetContext.Match newMatch(final Object... parameters) {
    return Copy_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Copy_targetContext (visibility: PUBLIC, simpleName: Copy_targetContext, identifier: sysml.Copy_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Copy_targetContext (visibility: PUBLIC, simpleName: Copy_targetContext, identifier: sysml.Copy_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Copy_targetContext INSTANCE = new Copy_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Copy_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
