...
public final class Probability_probability extends BaseGeneratedEMFQuerySpecification<Probability_probability.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Probability_probability pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Probability_probability";
    }
    
    @Override
    public List<String> parameterNames() {
      return Probability_probability.Match.parameterNames;
    }
    ...
    @Override
    public Probability_probability.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Probability_probability.Match)) {
          Probability_probability.Match other = (Probability_probability.Match) obj;
    ...
    @Override
    public Probability_probability specification() {
     ...
     * 
     */
    public static Probability_probability.Match newEmptyMatch() {
     ...
     * 
     */
    public static Probability_probability.Match newMutableMatch(final NamedElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Probability_probability.Match newMatch(final NamedElement pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Probability_probability.Match {
    ...
    private static final class Immutable extends Probability_probability.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Probability_probability pattern,
   ...
   * 
   * @see Match
   * @see Probability_probability
   * 
   */
  public static class Matcher extends BaseMatcher<Probability_probability.Match> {
    /**
     ...
     * 
     */
    public static Probability_probability.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Probability_probability.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Probability_probability.Matcher.class);
     ...
     * 
     */
    public Collection<Probability_probability.Match> getAllMatches(final NamedElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Probability_probability.Match> streamAllMatches(final NamedElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Probability_probability.Match> getOneArbitraryMatch(final NamedElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final LiteralString pValuespec, final Consumer<? super Probability_probability.Match> processor) {
     ...
     * 
     */
    public Probability_probability.Match newMatch(final NamedElement pElement, final LiteralString pValuespec) {
      return Probability_probability.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfelement(final Probability_probability.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfelement(final Probability_probability.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Probability_probability.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Probability_probability.Match partialMatch) {
    ...
    @Override
    protected Probability_probability.Match tupleToMatch(final Tuple t) {
      try {
          return Probability_probability.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Probability_probability.Match arrayToMatch(final Object[] match) {
      try {
          return Probability_probability.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Probability_probability.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Probability_probability.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Probability_probability.Matcher> querySpecification() {
      return Probability_probability.instance();
    }
  }
  
  private Probability_probability() {
   ...
   * 
   */
  public static Probability_probability instance() {
    try{
  ...
  @Override
  protected Probability_probability.Matcher instantiate(final ViatraQueryEngine engine) {
    return Probability_probability.Matcher.on(engine);
  }
  
  @Override
  public Probability_probability.Matcher instantiate() {
    return Probability_probability.Matcher.create();
  }
  
  @Override
  public Probability_probability.Match newEmptyMatch() {
    return Probability_probability.Match.newEmptyMatch();
  }
  
  @Override
  public Probability_probability.Match newMatch(final Object... parameters) {
    return Probability_probability.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Probability_probability (visibility: PUBLIC, simpleName: Probability_probability, identifier: sysml.Probability_probability, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Probability_probability (visibility: PUBLIC, simpleName: Probability_probability, identifier: sysml.Probability_probability, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Probability_probability INSTANCE = new Probability_probability();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Probability_probability.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Probability(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Probability.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "probability", valuespec)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "probability");
