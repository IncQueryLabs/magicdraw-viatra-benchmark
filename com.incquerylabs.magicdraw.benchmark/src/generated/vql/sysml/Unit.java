...
public final class Unit extends BaseGeneratedEMFQuerySpecification<Unit.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Unit pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public List<String> parameterNames() {
      return Unit.Match.parameterNames;
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Unit.Match)) {
          Unit.Match other = (Unit.Match) obj;
     ...
     * 
     */
    public static Unit.Match newEmptyMatch() {
     ...
     * 
     */
    public static Unit.Match newMutableMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Unit.Match newMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Unit.Match {
    ...
    private static final class Immutable extends Unit.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Unit pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Unit.Match> {
    /**
     ...
     * 
     */
    public static Unit.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Unit.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Unit.Matcher.class);
     ...
     * 
     */
    public Collection<Unit.Match> getAllMatches(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Unit.Match> streamAllMatches(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Unit.Match> getOneArbitraryMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Unit.Match> processor) {
     ...
     * 
     */
    public Unit.Match newMatch(final PackageableElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Unit.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<PackageableElement> streamAllValuesOfelement(final Unit.Match partialMatch) {
     ...
     * 
     */
    public Set<PackageableElement> getAllValuesOfelement(final Unit.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Unit.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Unit.Match partialMatch) {
    ...
    @Override
    protected Unit.Match tupleToMatch(final Tuple t) {
      try {
          return Unit.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Unit.Match arrayToMatch(final Object[] match) {
      try {
          return Unit.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Unit.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unit.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Unit.Matcher> querySpecification() {
      return Unit.instance();
    }
  }
  ...
  @Override
  protected Unit.Matcher instantiate(final ViatraQueryEngine engine) {
    return Unit.Matcher.on(engine);
  }
  
  @Override
  public Unit.Matcher instantiate() {
    return Unit.Matcher.create();
  }
  
  @Override
  public Unit.Match newEmptyMatch() {
    return Unit.Match.newEmptyMatch();
  }
  
  @Override
  public Unit.Match newMatch(final Object... parameters) {
    return Unit.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Unit (visibility: PUBLIC, simpleName: Unit, identifier: sysml.Unit, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Unit (visibility: PUBLIC, simpleName: Unit, identifier: sysml.Unit, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Unit.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Unit");
