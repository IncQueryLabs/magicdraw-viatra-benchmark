...
public final class ContextSpecificValuesHolder_instances extends BaseGeneratedEMFQuerySpecification<ContextSpecificValuesHolder_instances.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ContextSpecificValuesHolder_instances (visibility: PUBLIC, simpleName: ContextSpecificValuesHolder_instances, identifier: sysml.ContextSpecificValuesHolder_instances, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ContextSpecificValuesHolder_instances (visibility: PUBLIC, simpleName: ContextSpecificValuesHolder_instances, identifier: sysml.ContextSpecificValuesHolder_instances, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
