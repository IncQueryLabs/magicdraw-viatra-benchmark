...
public final class View_stakeholder extends BaseGeneratedEMFQuerySpecification<View_stakeholder.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.View_stakeholder pattern,
  ...
  /**
   * Generated pattern matcher API of the sysml.View_stakeholder pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.View_stakeholder (visibility: PUBLIC, simpleName: View_stakeholder, identifier: sysml.View_stakeholder, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.View_stakeholder (visibility: PUBLIC, simpleName: View_stakeholder, identifier: sysml.View_stakeholder, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
