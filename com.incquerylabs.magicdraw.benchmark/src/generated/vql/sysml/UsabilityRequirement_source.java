...
public final class UsabilityRequirement_source extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement_source.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.usabilityRequirement_source pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.usabilityRequirement_source";
    }
    
    @Override
    public List<String> parameterNames() {
      return UsabilityRequirement_source.Match.parameterNames;
    }
    ...
    @Override
    public UsabilityRequirement_source.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof UsabilityRequirement_source.Match)) {
          UsabilityRequirement_source.Match other = (UsabilityRequirement_source.Match) obj;
    ...
    @Override
    public UsabilityRequirement_source specification() {
     ...
     * 
     */
    public static UsabilityRequirement_source.Match newEmptyMatch() {
     ...
     * 
     */
    public static UsabilityRequirement_source.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static UsabilityRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends UsabilityRequirement_source.Match {
    ...
    private static final class Immutable extends UsabilityRequirement_source.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.usabilityRequirement_source pattern,
   ...
   * 
   * @see Match
   * @see UsabilityRequirement_source
   * 
   */
  public static class Matcher extends BaseMatcher<UsabilityRequirement_source.Match> {
    /**
     ...
     * 
     */
    public static UsabilityRequirement_source.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static UsabilityRequirement_source.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(UsabilityRequirement_source.Matcher.class);
     ...
     * 
     */
    public Collection<UsabilityRequirement_source.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<UsabilityRequirement_source.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<UsabilityRequirement_source.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super UsabilityRequirement_source.Match> processor) {
     ...
     * 
     */
    public UsabilityRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return UsabilityRequirement_source.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final UsabilityRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final UsabilityRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final UsabilityRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final UsabilityRequirement_source.Match partialMatch) {
    ...
    @Override
    protected UsabilityRequirement_source.Match tupleToMatch(final Tuple t) {
      try {
          return UsabilityRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected UsabilityRequirement_source.Match arrayToMatch(final Object[] match) {
      try {
          return UsabilityRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected UsabilityRequirement_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return UsabilityRequirement_source.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<UsabilityRequirement_source.Matcher> querySpecification() {
      return UsabilityRequirement_source.instance();
    }
  }
  
  private UsabilityRequirement_source() {
   ...
   * 
   */
  public static UsabilityRequirement_source instance() {
    try{
  ...
  @Override
  protected UsabilityRequirement_source.Matcher instantiate(final ViatraQueryEngine engine) {
    return UsabilityRequirement_source.Matcher.on(engine);
  }
  
  @Override
  public UsabilityRequirement_source.Matcher instantiate() {
    return UsabilityRequirement_source.Matcher.create();
  }
  
  @Override
  public UsabilityRequirement_source.Match newEmptyMatch() {
    return UsabilityRequirement_source.Match.newEmptyMatch();
  }
  
  @Override
  public UsabilityRequirement_source.Match newMatch(final Object... parameters) {
    return UsabilityRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.UsabilityRequirement_source (visibility: PUBLIC, simpleName: UsabilityRequirement_source, identifier: sysml.UsabilityRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.UsabilityRequirement_source (visibility: PUBLIC, simpleName: UsabilityRequirement_source, identifier: sysml.UsabilityRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final UsabilityRequirement_source INSTANCE = new UsabilityRequirement_source();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final UsabilityRequirement_source.GeneratedPQuery INSTANCE = new GeneratedPQuery();
