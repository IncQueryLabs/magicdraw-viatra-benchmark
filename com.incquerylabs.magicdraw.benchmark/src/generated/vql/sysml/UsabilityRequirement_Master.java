...
public final class UsabilityRequirement_Master extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.usabilityRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.usabilityRequirement_Master";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.usabilityRequirement_Master pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.UsabilityRequirement_Master (visibility: PUBLIC, simpleName: UsabilityRequirement_Master, identifier: sysml.UsabilityRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.UsabilityRequirement_Master (visibility: PUBLIC, simpleName: UsabilityRequirement_Master, identifier: sysml.UsabilityRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
