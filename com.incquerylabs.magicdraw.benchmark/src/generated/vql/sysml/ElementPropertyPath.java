...
public final class ElementPropertyPath extends BaseGeneratedEMFQuerySpecification<ElementPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ElementPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.ElementPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return ElementPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public ElementPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ElementPropertyPath.Match)) {
          ElementPropertyPath.Match other = (ElementPropertyPath.Match) obj;
    ...
    @Override
    public ElementPropertyPath specification() {
     ...
     * 
     */
    public static ElementPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static ElementPropertyPath.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ElementPropertyPath.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ElementPropertyPath.Match {
    ...
    private static final class Immutable extends ElementPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.ElementPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see ElementPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<ElementPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static ElementPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ElementPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ElementPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<ElementPropertyPath.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ElementPropertyPath.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ElementPropertyPath.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ElementPropertyPath.Match> processor) {
     ...
     * 
     */
    public ElementPropertyPath.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ElementPropertyPath.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final ElementPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final ElementPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ElementPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ElementPropertyPath.Match partialMatch) {
    ...
    @Override
    protected ElementPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return ElementPropertyPath.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ElementPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return ElementPropertyPath.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ElementPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ElementPropertyPath.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ElementPropertyPath.Matcher> querySpecification() {
      return ElementPropertyPath.instance();
    }
  }
  
  private ElementPropertyPath() {
   ...
   * 
   */
  public static ElementPropertyPath instance() {
    try{
  ...
  @Override
  protected ElementPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return ElementPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public ElementPropertyPath.Matcher instantiate() {
    return ElementPropertyPath.Matcher.create();
  }
  
  @Override
  public ElementPropertyPath.Match newEmptyMatch() {
    return ElementPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public ElementPropertyPath.Match newMatch(final Object... parameters) {
    return ElementPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ElementPropertyPath (visibility: PUBLIC, simpleName: ElementPropertyPath, identifier: sysml.ElementPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ElementPropertyPath (visibility: PUBLIC, simpleName: ElementPropertyPath, identifier: sysml.ElementPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ElementPropertyPath INSTANCE = new ElementPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ElementPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ElementPropertyPath");
