...
public final class Refine_targetContext extends BaseGeneratedEMFQuerySpecification<Refine_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Refine_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Refine_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Refine_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Refine_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Refine_targetContext.Match)) {
          Refine_targetContext.Match other = (Refine_targetContext.Match) obj;
    ...
    @Override
    public Refine_targetContext specification() {
     ...
     * 
     */
    public static Refine_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Refine_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Refine_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Refine_targetContext.Match {
    ...
    private static final class Immutable extends Refine_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Refine_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Refine_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Refine_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Refine_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Refine_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Refine_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Refine_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Refine_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Refine_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Refine_targetContext.Match> processor) {
     ...
     * 
     */
    public Refine_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Refine_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Refine_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Refine_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Refine_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Refine_targetContext.Match partialMatch) {
    ...
    @Override
    protected Refine_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Refine_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Refine_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Refine_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Refine_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Refine_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Refine_targetContext.Matcher> querySpecification() {
      return Refine_targetContext.instance();
    }
  }
  
  private Refine_targetContext() {
   ...
   * 
   */
  public static Refine_targetContext instance() {
    try{
  ...
  @Override
  protected Refine_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Refine_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Refine_targetContext.Matcher instantiate() {
    return Refine_targetContext.Matcher.create();
  }
  
  @Override
  public Refine_targetContext.Match newEmptyMatch() {
    return Refine_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Refine_targetContext.Match newMatch(final Object... parameters) {
    return Refine_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Refine_targetContext (visibility: PUBLIC, simpleName: Refine_targetContext, identifier: sysml.Refine_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Refine_targetContext (visibility: PUBLIC, simpleName: Refine_targetContext, identifier: sysml.Refine_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Refine_targetContext INSTANCE = new Refine_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Refine_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
