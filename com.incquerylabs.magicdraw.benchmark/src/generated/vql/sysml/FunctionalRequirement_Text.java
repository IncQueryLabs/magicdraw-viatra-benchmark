...
public final class FunctionalRequirement_Text extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement_Text.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.functionalRequirement_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.functionalRequirement_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalRequirement_Text.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalRequirement_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalRequirement_Text.Match)) {
          FunctionalRequirement_Text.Match other = (FunctionalRequirement_Text.Match) obj;
    ...
    @Override
    public FunctionalRequirement_Text specification() {
     ...
     * 
     */
    public static FunctionalRequirement_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalRequirement_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static FunctionalRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends FunctionalRequirement_Text.Match {
    ...
    private static final class Immutable extends FunctionalRequirement_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.functionalRequirement_Text pattern,
   ...
   * 
   * @see Match
   * @see FunctionalRequirement_Text
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalRequirement_Text.Match> {
    /**
     ...
     * 
     */
    public static FunctionalRequirement_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalRequirement_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalRequirement_Text.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalRequirement_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<FunctionalRequirement_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<FunctionalRequirement_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super FunctionalRequirement_Text.Match> processor) {
     ...
     * 
     */
    public FunctionalRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return FunctionalRequirement_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final FunctionalRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final FunctionalRequirement_Text.Match partialMatch) {
    ...
    @Override
    protected FunctionalRequirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected FunctionalRequirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalRequirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalRequirement_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalRequirement_Text.Matcher> querySpecification() {
      return FunctionalRequirement_Text.instance();
    }
  }
  
  private FunctionalRequirement_Text() {
   ...
   * 
   */
  public static FunctionalRequirement_Text instance() {
    try{
  ...
  @Override
  protected FunctionalRequirement_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalRequirement_Text.Matcher.on(engine);
  }
  
  @Override
  public FunctionalRequirement_Text.Matcher instantiate() {
    return FunctionalRequirement_Text.Matcher.create();
  }
  
  @Override
  public FunctionalRequirement_Text.Match newEmptyMatch() {
    return FunctionalRequirement_Text.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalRequirement_Text.Match newMatch(final Object... parameters) {
    return FunctionalRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FunctionalRequirement_Text (visibility: PUBLIC, simpleName: FunctionalRequirement_Text, identifier: sysml.FunctionalRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FunctionalRequirement_Text (visibility: PUBLIC, simpleName: FunctionalRequirement_Text, identifier: sysml.FunctionalRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalRequirement_Text INSTANCE = new FunctionalRequirement_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalRequirement_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
