...
public final class UsabilityRequirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.usabilityRequirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.usabilityRequirement_DerivedFrom";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.usabilityRequirement_DerivedFrom pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.UsabilityRequirement_DerivedFrom (visibility: PUBLIC, simpleName: UsabilityRequirement_DerivedFrom, identifier: sysml.UsabilityRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.UsabilityRequirement_DerivedFrom (visibility: PUBLIC, simpleName: UsabilityRequirement_DerivedFrom, identifier: sysml.UsabilityRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
