...
public final class ParticipantProperty_end extends BaseGeneratedEMFQuerySpecification<ParticipantProperty_end.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ParticipantProperty_end pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.ParticipantProperty_end";
    }
    
    @Override
    public List<String> parameterNames() {
      return ParticipantProperty_end.Match.parameterNames;
    }
    ...
    @Override
    public ParticipantProperty_end.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ParticipantProperty_end.Match)) {
          ParticipantProperty_end.Match other = (ParticipantProperty_end.Match) obj;
    ...
    @Override
    public ParticipantProperty_end specification() {
     ...
     * 
     */
    public static ParticipantProperty_end.Match newEmptyMatch() {
     ...
     * 
     */
    public static ParticipantProperty_end.Match newMutableMatch(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public static ParticipantProperty_end.Match newMatch(final Property pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ParticipantProperty_end.Match {
    ...
    private static final class Immutable extends ParticipantProperty_end.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.ParticipantProperty_end pattern,
   ...
   * 
   * @see Match
   * @see ParticipantProperty_end
   * 
   */
  public static class Matcher extends BaseMatcher<ParticipantProperty_end.Match> {
    /**
     ...
     * 
     */
    public static ParticipantProperty_end.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ParticipantProperty_end.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ParticipantProperty_end.Matcher.class);
     ...
     * 
     */
    public Collection<ParticipantProperty_end.Match> getAllMatches(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<ParticipantProperty_end.Match> streamAllMatches(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<ParticipantProperty_end.Match> getOneArbitraryMatch(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Property pValue, final Consumer<? super ParticipantProperty_end.Match> processor) {
     ...
     * 
     */
    public ParticipantProperty_end.Match newMatch(final Property pElement, final Property pValue) {
      return ParticipantProperty_end.Match.newMatch(pElement, pValue);
    }
    ...
    @Override
    protected ParticipantProperty_end.Match tupleToMatch(final Tuple t) {
      try {
          return ParticipantProperty_end.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected ParticipantProperty_end.Match arrayToMatch(final Object[] match) {
      try {
          return ParticipantProperty_end.Match.newMatch((Property) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ParticipantProperty_end.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ParticipantProperty_end.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ParticipantProperty_end.Matcher> querySpecification() {
      return ParticipantProperty_end.instance();
    }
  }
  
  private ParticipantProperty_end() {
   ...
   * 
   */
  public static ParticipantProperty_end instance() {
    try{
  ...
  @Override
  protected ParticipantProperty_end.Matcher instantiate(final ViatraQueryEngine engine) {
    return ParticipantProperty_end.Matcher.on(engine);
  }
  
  @Override
  public ParticipantProperty_end.Matcher instantiate() {
    return ParticipantProperty_end.Matcher.create();
  }
  
  @Override
  public ParticipantProperty_end.Match newEmptyMatch() {
    return ParticipantProperty_end.Match.newEmptyMatch();
  }
  
  @Override
  public ParticipantProperty_end.Match newMatch(final Object... parameters) {
    return ParticipantProperty_end.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ParticipantProperty_end (visibility: PUBLIC, simpleName: ParticipantProperty_end, identifier: sysml.ParticipantProperty_end, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ParticipantProperty_end (visibility: PUBLIC, simpleName: ParticipantProperty_end, identifier: sysml.ParticipantProperty_end, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ParticipantProperty_end INSTANCE = new ParticipantProperty_end();
