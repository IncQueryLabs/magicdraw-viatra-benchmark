...
public final class ElementGroup_member extends BaseGeneratedEMFQuerySpecification<ElementGroup_member.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ElementGroup_member pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.ElementGroup_member";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.ElementGroup_member pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ElementGroup_member (visibility: PUBLIC, simpleName: ElementGroup_member, identifier: sysml.ElementGroup_member, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ElementGroup_member (visibility: PUBLIC, simpleName: ElementGroup_member, identifier: sysml.ElementGroup_member, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
