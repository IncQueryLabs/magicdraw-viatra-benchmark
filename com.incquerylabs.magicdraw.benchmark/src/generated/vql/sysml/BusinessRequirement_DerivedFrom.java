...
public final class BusinessRequirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<BusinessRequirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.businessRequirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.businessRequirement_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return BusinessRequirement_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public BusinessRequirement_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BusinessRequirement_DerivedFrom.Match)) {
          BusinessRequirement_DerivedFrom.Match other = (BusinessRequirement_DerivedFrom.Match) obj;
    ...
    @Override
    public BusinessRequirement_DerivedFrom specification() {
     ...
     * 
     */
    public static BusinessRequirement_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static BusinessRequirement_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static BusinessRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends BusinessRequirement_DerivedFrom.Match {
    ...
    private static final class Immutable extends BusinessRequirement_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.businessRequirement_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see BusinessRequirement_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<BusinessRequirement_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static BusinessRequirement_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BusinessRequirement_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BusinessRequirement_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<BusinessRequirement_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<BusinessRequirement_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<BusinessRequirement_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super BusinessRequirement_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public BusinessRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return BusinessRequirement_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final BusinessRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final BusinessRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final BusinessRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final BusinessRequirement_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected BusinessRequirement_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return BusinessRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected BusinessRequirement_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return BusinessRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BusinessRequirement_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BusinessRequirement_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BusinessRequirement_DerivedFrom.Matcher> querySpecification() {
      return BusinessRequirement_DerivedFrom.instance();
    }
  }
  
  private BusinessRequirement_DerivedFrom() {
   ...
   * 
   */
  public static BusinessRequirement_DerivedFrom instance() {
    try{
  ...
  @Override
  protected BusinessRequirement_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return BusinessRequirement_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public BusinessRequirement_DerivedFrom.Matcher instantiate() {
    return BusinessRequirement_DerivedFrom.Matcher.create();
  }
  
  @Override
  public BusinessRequirement_DerivedFrom.Match newEmptyMatch() {
    return BusinessRequirement_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public BusinessRequirement_DerivedFrom.Match newMatch(final Object... parameters) {
    return BusinessRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BusinessRequirement_DerivedFrom (visibility: PUBLIC, simpleName: BusinessRequirement_DerivedFrom, identifier: sysml.BusinessRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BusinessRequirement_DerivedFrom (visibility: PUBLIC, simpleName: BusinessRequirement_DerivedFrom, identifier: sysml.BusinessRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BusinessRequirement_DerivedFrom INSTANCE = new BusinessRequirement_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BusinessRequirement_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
