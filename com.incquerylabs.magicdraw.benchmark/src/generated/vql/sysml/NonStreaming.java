...
public final class NonStreaming extends BaseGeneratedEMFQuerySpecification<NonStreaming.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.nonStreaming pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static NonStreaming.Match newMutableMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static NonStreaming.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the sysml.nonStreaming pattern,
  ...
  public static class Matcher extends BaseMatcher<NonStreaming.Match> {
     ...
     * 
     */
    public Collection<NonStreaming.Match> getAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<NonStreaming.Match> streamAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<NonStreaming.Match> getOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super NonStreaming.Match> processor) {
     ...
     * 
     */
    public NonStreaming.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return NonStreaming.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final NonStreaming.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final NonStreaming.Match partialMatch) {
    ...
    protected NonStreaming.Match tupleToMatch(final Tuple t) {
      try {
          return NonStreaming.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected NonStreaming.Match arrayToMatch(final Object[] match) {
      try {
          return NonStreaming.Match.newMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected NonStreaming.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NonStreaming.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public NonStreaming.Match newMatch(final Object... parameters) {
    return NonStreaming.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.NonStreaming (visibility: PUBLIC, simpleName: NonStreaming, identifier: sysml.NonStreaming, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.NonStreaming (visibility: PUBLIC, simpleName: NonStreaming, identifier: sysml.NonStreaming, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
