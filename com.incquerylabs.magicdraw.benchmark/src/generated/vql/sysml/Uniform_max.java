...
public final class Uniform_max extends BaseGeneratedEMFQuerySpecification<Uniform_max.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Uniform_max pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Uniform_max";
    }
    
    @Override
    public List<String> parameterNames() {
      return Uniform_max.Match.parameterNames;
    }
    ...
    @Override
    public Uniform_max.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Uniform_max.Match)) {
          Uniform_max.Match other = (Uniform_max.Match) obj;
    ...
    @Override
    public Uniform_max specification() {
     ...
     * 
     */
    public static Uniform_max.Match newEmptyMatch() {
     ...
     * 
     */
    public static Uniform_max.Match newMutableMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public static Uniform_max.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Uniform_max.Match {
    ...
    private static final class Immutable extends Uniform_max.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Uniform_max pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Uniform_max.Match> {
    /**
     ...
     * 
     */
    public static Uniform_max.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Uniform_max.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Uniform_max.Matcher.class);
     ...
     * 
     */
    public Collection<Uniform_max.Match> getAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Stream<Uniform_max.Match> streamAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Optional<Uniform_max.Match> getOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec, final Consumer<? super Uniform_max.Match> processor) {
     ...
     * 
     */
    public Uniform_max.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return Uniform_max.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Uniform_max.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Uniform_max.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralReal> streamAllValuesOfvaluespec(final Uniform_max.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralReal> getAllValuesOfvaluespec(final Uniform_max.Match partialMatch) {
    ...
    @Override
    protected Uniform_max.Match tupleToMatch(final Tuple t) {
      try {
          return Uniform_max.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralReal) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Uniform_max.Match arrayToMatch(final Object[] match) {
      try {
          return Uniform_max.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Uniform_max.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Uniform_max.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Uniform_max.Matcher> querySpecification() {
      return Uniform_max.instance();
    }
  }
   ...
   * 
   */
  public static Uniform_max instance() {
    try{
  ...
  @Override
  protected Uniform_max.Matcher instantiate(final ViatraQueryEngine engine) {
    return Uniform_max.Matcher.on(engine);
  }
  
  @Override
  public Uniform_max.Matcher instantiate() {
    return Uniform_max.Matcher.create();
  }
  
  @Override
  public Uniform_max.Match newEmptyMatch() {
    return Uniform_max.Match.newEmptyMatch();
  }
  
  @Override
  public Uniform_max.Match newMatch(final Object... parameters) {
    return Uniform_max.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralReal) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Uniform_max (visibility: PUBLIC, simpleName: Uniform_max, identifier: sysml.Uniform_max, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Uniform_max (visibility: PUBLIC, simpleName: Uniform_max, identifier: sysml.Uniform_max, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Uniform_max INSTANCE = new Uniform_max();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Uniform_max.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Uniform(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Uniform.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "max", valuespec)
