...
public final class Interval_max extends BaseGeneratedEMFQuerySpecification<Interval_max.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Interval_max pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Interval_max";
    }
    
    @Override
    public List<String> parameterNames() {
      return Interval_max.Match.parameterNames;
    }
    ...
    @Override
    public Interval_max.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Interval_max.Match)) {
          Interval_max.Match other = (Interval_max.Match) obj;
    ...
    @Override
    public Interval_max specification() {
     ...
     * 
     */
    public static Interval_max.Match newEmptyMatch() {
     ...
     * 
     */
    public static Interval_max.Match newMutableMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public static Interval_max.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Interval_max.Match {
    ...
    private static final class Immutable extends Interval_max.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Interval_max pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Interval_max.Match> {
    /**
     ...
     * 
     */
    public static Interval_max.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Interval_max.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Interval_max.Matcher.class);
     ...
     * 
     */
    public Collection<Interval_max.Match> getAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Stream<Interval_max.Match> streamAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Optional<Interval_max.Match> getOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec, final Consumer<? super Interval_max.Match> processor) {
     ...
     * 
     */
    public Interval_max.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return Interval_max.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Interval_max.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Interval_max.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralReal> streamAllValuesOfvaluespec(final Interval_max.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralReal> getAllValuesOfvaluespec(final Interval_max.Match partialMatch) {
    ...
    @Override
    protected Interval_max.Match tupleToMatch(final Tuple t) {
      try {
          return Interval_max.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralReal) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Interval_max.Match arrayToMatch(final Object[] match) {
      try {
          return Interval_max.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Interval_max.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Interval_max.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Interval_max.Matcher> querySpecification() {
      return Interval_max.instance();
    }
  }
  
  private Interval_max() {
   ...
   * 
   */
  public static Interval_max instance() {
    try{
  ...
  @Override
  protected Interval_max.Matcher instantiate(final ViatraQueryEngine engine) {
    return Interval_max.Matcher.on(engine);
  }
  
  @Override
  public Interval_max.Matcher instantiate() {
    return Interval_max.Matcher.create();
  }
  
  @Override
  public Interval_max.Match newEmptyMatch() {
    return Interval_max.Match.newEmptyMatch();
  }
  
  @Override
  public Interval_max.Match newMatch(final Object... parameters) {
    return Interval_max.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralReal) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Interval_max (visibility: PUBLIC, simpleName: Interval_max, identifier: sysml.Interval_max, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Interval_max (visibility: PUBLIC, simpleName: Interval_max, identifier: sysml.Interval_max, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Interval_max INSTANCE = new Interval_max();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Interval_max.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Interval(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Interval.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "max", valuespec)
