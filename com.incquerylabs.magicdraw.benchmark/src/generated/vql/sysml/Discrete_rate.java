...
public final class Discrete_rate extends BaseGeneratedEMFQuerySpecification<Discrete_rate.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Discrete_rate pattern,
  ...
  /**
   * Generated pattern matcher API of the sysml.Discrete_rate pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Discrete_rate (visibility: PUBLIC, simpleName: Discrete_rate, identifier: sysml.Discrete_rate, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Discrete_rate (visibility: PUBLIC, simpleName: Discrete_rate, identifier: sysml.Discrete_rate, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Discrete(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Discrete.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "rate", valuespec)
