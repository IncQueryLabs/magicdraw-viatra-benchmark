...
public final class Subsystem_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Subsystem_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Subsystem_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Subsystem_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Subsystem_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Subsystem_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Subsystem_isEncapsulated.Match)) {
          Subsystem_isEncapsulated.Match other = (Subsystem_isEncapsulated.Match) obj;
    ...
    @Override
    public Subsystem_isEncapsulated specification() {
     ...
     * 
     */
    public static Subsystem_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Subsystem_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Subsystem_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Subsystem_isEncapsulated.Match {
    ...
    private static final class Immutable extends Subsystem_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Subsystem_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Subsystem_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Subsystem_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Subsystem_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Subsystem_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Subsystem_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Subsystem_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Subsystem_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Subsystem_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Subsystem_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Subsystem_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Subsystem_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Subsystem_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Subsystem_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Subsystem_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Subsystem_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Subsystem_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Subsystem_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Subsystem_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Subsystem_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Subsystem_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Subsystem_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Subsystem_isEncapsulated.Matcher> querySpecification() {
      return Subsystem_isEncapsulated.instance();
    }
  }
  
  private Subsystem_isEncapsulated() {
   ...
   * 
   */
  public static Subsystem_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Subsystem_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Subsystem_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Subsystem_isEncapsulated.Matcher instantiate() {
    return Subsystem_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Subsystem_isEncapsulated.Match newEmptyMatch() {
    return Subsystem_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Subsystem_isEncapsulated.Match newMatch(final Object... parameters) {
    return Subsystem_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Subsystem_isEncapsulated (visibility: PUBLIC, simpleName: Subsystem_isEncapsulated, identifier: sysml.Subsystem_isEncapsulated, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Subsystem_isEncapsulated (visibility: PUBLIC, simpleName: Subsystem_isEncapsulated, identifier: sysml.Subsystem_isEncapsulated, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Subsystem_isEncapsulated INSTANCE = new Subsystem_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Subsystem_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Subsystem(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Subsystem.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
