...
public final class BoundReference_lower extends BaseGeneratedEMFQuerySpecification<BoundReference_lower.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.BoundReference_lower pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.BoundReference_lower";
    }
     ...
     * 
     */
    public static BoundReference_lower.Match newMutableMatch(final Property pElement, final LiteralInteger pValuespec) {
     ...
     * 
     */
    public static BoundReference_lower.Match newMatch(final Property pElement, final LiteralInteger pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the sysml.BoundReference_lower pattern,
  ...
  public static class Matcher extends BaseMatcher<BoundReference_lower.Match> {
     ...
     * 
     */
    public Collection<BoundReference_lower.Match> getAllMatches(final Property pElement, final LiteralInteger pValuespec) {
     ...
     * 
     */
    public Stream<BoundReference_lower.Match> streamAllMatches(final Property pElement, final LiteralInteger pValuespec) {
     ...
     * 
     */
    public Optional<BoundReference_lower.Match> getOneArbitraryMatch(final Property pElement, final LiteralInteger pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralInteger pValuespec, final Consumer<? super BoundReference_lower.Match> processor) {
     ...
     * 
     */
    public BoundReference_lower.Match newMatch(final Property pElement, final LiteralInteger pValuespec) {
      return BoundReference_lower.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<LiteralInteger> streamAllValuesOfvaluespec(final BoundReference_lower.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralInteger> getAllValuesOfvaluespec(final BoundReference_lower.Match partialMatch) {
    ...
    protected BoundReference_lower.Match tupleToMatch(final Tuple t) {
      try {
          return BoundReference_lower.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralInteger) t.get(POSITION_VALUESPEC));
    ...
    protected BoundReference_lower.Match arrayToMatch(final Object[] match) {
      try {
          return BoundReference_lower.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralInteger) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected BoundReference_lower.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BoundReference_lower.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralInteger) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public BoundReference_lower.Match newMatch(final Object... parameters) {
    return BoundReference_lower.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralInteger) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BoundReference_lower (visibility: PUBLIC, simpleName: BoundReference_lower, identifier: sysml.BoundReference_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BoundReference_lower (visibility: PUBLIC, simpleName: BoundReference_lower, identifier: sysml.BoundReference_lower, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
