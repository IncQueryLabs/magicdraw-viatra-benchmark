...
public final class Requirement_Derived extends BaseGeneratedEMFQuerySpecification<Requirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Requirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Requirement_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return Requirement_Derived.Match.parameterNames;
    }
    ...
    @Override
    public Requirement_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Requirement_Derived.Match)) {
          Requirement_Derived.Match other = (Requirement_Derived.Match) obj;
    ...
    @Override
    public Requirement_Derived specification() {
     ...
     * 
     */
    public static Requirement_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static Requirement_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static Requirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Requirement_Derived.Match {
    ...
    private static final class Immutable extends Requirement_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Requirement_Derived pattern,
   ...
   * 
   * @see Match
   * @see Requirement_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<Requirement_Derived.Match> {
    /**
     ...
     * 
     */
    public static Requirement_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Requirement_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Requirement_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<Requirement_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<Requirement_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<Requirement_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super Requirement_Derived.Match> processor) {
     ...
     * 
     */
    public Requirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return Requirement_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Requirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Requirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final Requirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final Requirement_Derived.Match partialMatch) {
    ...
    @Override
    protected Requirement_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return Requirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected Requirement_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return Requirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Requirement_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Requirement_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Requirement_Derived.Matcher> querySpecification() {
      return Requirement_Derived.instance();
    }
  }
  
  private Requirement_Derived() {
   ...
   * 
   */
  public static Requirement_Derived instance() {
    try{
  ...
  @Override
  protected Requirement_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return Requirement_Derived.Matcher.on(engine);
  }
  
  @Override
  public Requirement_Derived.Matcher instantiate() {
    return Requirement_Derived.Matcher.create();
  }
  
  @Override
  public Requirement_Derived.Match newEmptyMatch() {
    return Requirement_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public Requirement_Derived.Match newMatch(final Object... parameters) {
    return Requirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Requirement_Derived (visibility: PUBLIC, simpleName: Requirement_Derived, identifier: sysml.Requirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Requirement_Derived (visibility: PUBLIC, simpleName: Requirement_Derived, identifier: sysml.Requirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Requirement_Derived INSTANCE = new Requirement_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Requirement_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
