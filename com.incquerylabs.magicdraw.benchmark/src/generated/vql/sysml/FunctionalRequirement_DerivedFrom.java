...
public final class FunctionalRequirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.functionalRequirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.functionalRequirement_DerivedFrom";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.functionalRequirement_DerivedFrom pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FunctionalRequirement_DerivedFrom (visibility: PUBLIC, simpleName: FunctionalRequirement_DerivedFrom, identifier: sysml.FunctionalRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FunctionalRequirement_DerivedFrom (visibility: PUBLIC, simpleName: FunctionalRequirement_DerivedFrom, identifier: sysml.FunctionalRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
