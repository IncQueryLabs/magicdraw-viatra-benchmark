...
public final class ConnectorProperty extends BaseGeneratedEMFQuerySpecification<ConnectorProperty.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ConnectorProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ConnectorProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ConnectorProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the sysml.ConnectorProperty pattern,
  ...
  public static class Matcher extends BaseMatcher<ConnectorProperty.Match> {
     ...
     * 
     */
    public Collection<ConnectorProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ConnectorProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ConnectorProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ConnectorProperty.Match> processor) {
     ...
     * 
     */
    public ConnectorProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ConnectorProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ConnectorProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ConnectorProperty.Match partialMatch) {
    ...
    protected ConnectorProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ConnectorProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected ConnectorProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ConnectorProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected ConnectorProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConnectorProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ConnectorProperty.Match newMatch(final Object... parameters) {
    return ConnectorProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ConnectorProperty (visibility: PUBLIC, simpleName: ConnectorProperty, identifier: sysml.ConnectorProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ConnectorProperty (visibility: PUBLIC, simpleName: ConnectorProperty, identifier: sysml.ConnectorProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
