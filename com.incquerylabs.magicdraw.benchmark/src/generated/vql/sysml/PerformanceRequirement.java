...
public final class PerformanceRequirement extends BaseGeneratedEMFQuerySpecification<PerformanceRequirement.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.performanceRequirement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.performanceRequirement";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformanceRequirement.Match.parameterNames;
    }
    ...
    @Override
    public PerformanceRequirement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformanceRequirement.Match)) {
          PerformanceRequirement.Match other = (PerformanceRequirement.Match) obj;
    ...
    @Override
    public PerformanceRequirement specification() {
     ...
     * 
     */
    public static PerformanceRequirement.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformanceRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static PerformanceRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends PerformanceRequirement.Match {
    ...
    private static final class Immutable extends PerformanceRequirement.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.performanceRequirement pattern,
   ...
   * 
   * @see Match
   * @see PerformanceRequirement
   * 
   */
  public static class Matcher extends BaseMatcher<PerformanceRequirement.Match> {
    /**
     ...
     * 
     */
    public static PerformanceRequirement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformanceRequirement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformanceRequirement.Matcher.class);
     ...
     * 
     */
    public Collection<PerformanceRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<PerformanceRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<PerformanceRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super PerformanceRequirement.Match> processor) {
     ...
     * 
     */
    public PerformanceRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return PerformanceRequirement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PerformanceRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PerformanceRequirement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final PerformanceRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final PerformanceRequirement.Match partialMatch) {
    ...
    @Override
    protected PerformanceRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return PerformanceRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected PerformanceRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return PerformanceRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformanceRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformanceRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformanceRequirement.Matcher> querySpecification() {
      return PerformanceRequirement.instance();
    }
  }
  
  private PerformanceRequirement() {
   ...
   * 
   */
  public static PerformanceRequirement instance() {
    try{
  ...
  @Override
  protected PerformanceRequirement.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformanceRequirement.Matcher.on(engine);
  }
  
  @Override
  public PerformanceRequirement.Matcher instantiate() {
    return PerformanceRequirement.Matcher.create();
  }
  
  @Override
  public PerformanceRequirement.Match newEmptyMatch() {
    return PerformanceRequirement.Match.newEmptyMatch();
  }
  
  @Override
  public PerformanceRequirement.Match newMatch(final Object... parameters) {
    return PerformanceRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PerformanceRequirement (visibility: PUBLIC, simpleName: PerformanceRequirement, identifier: sysml.PerformanceRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PerformanceRequirement (visibility: PUBLIC, simpleName: PerformanceRequirement, identifier: sysml.PerformanceRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformanceRequirement INSTANCE = new PerformanceRequirement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformanceRequirement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "performanceRequirement");
