...
public final class ValueProperty extends BaseGeneratedEMFQuerySpecification<ValueProperty.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ValueProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.ValueProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return ValueProperty.Match.parameterNames;
    }
    ...
    @Override
    public ValueProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ValueProperty.Match)) {
          ValueProperty.Match other = (ValueProperty.Match) obj;
    ...
    @Override
    public ValueProperty specification() {
     ...
     * 
     */
    public static ValueProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static ValueProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ValueProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ValueProperty.Match {
    ...
    private static final class Immutable extends ValueProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.ValueProperty pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ValueProperty.Match> {
    /**
     ...
     * 
     */
    public static ValueProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ValueProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ValueProperty.Matcher.class);
     ...
     * 
     */
    public Collection<ValueProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ValueProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ValueProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ValueProperty.Match> processor) {
     ...
     * 
     */
    public ValueProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ValueProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ValueProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ValueProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ValueProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ValueProperty.Match partialMatch) {
    ...
    @Override
    protected ValueProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ValueProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ValueProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ValueProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ValueProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ValueProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ValueProperty.Matcher> querySpecification() {
      return ValueProperty.instance();
    }
  }
   ...
   * 
   */
  public static ValueProperty instance() {
    try{
  ...
  @Override
  protected ValueProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return ValueProperty.Matcher.on(engine);
  }
  
  @Override
  public ValueProperty.Matcher instantiate() {
    return ValueProperty.Matcher.create();
  }
  
  @Override
  public ValueProperty.Match newEmptyMatch() {
    return ValueProperty.Match.newEmptyMatch();
  }
  
  @Override
  public ValueProperty.Match newMatch(final Object... parameters) {
    return ValueProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ValueProperty (visibility: PUBLIC, simpleName: ValueProperty, identifier: sysml.ValueProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ValueProperty (visibility: PUBLIC, simpleName: ValueProperty, identifier: sysml.ValueProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ValueProperty INSTANCE = new ValueProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ValueProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ValueProperty");
