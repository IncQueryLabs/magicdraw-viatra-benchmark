...
public final class Viewpoint_presentation extends BaseGeneratedEMFQuerySpecification<Viewpoint_presentation.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Viewpoint_presentation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Viewpoint_presentation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Viewpoint_presentation.Match.parameterNames;
    }
    ...
    @Override
    public Viewpoint_presentation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Viewpoint_presentation.Match)) {
          Viewpoint_presentation.Match other = (Viewpoint_presentation.Match) obj;
    ...
    @Override
    public Viewpoint_presentation specification() {
     ...
     * 
     */
    public static Viewpoint_presentation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Viewpoint_presentation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Viewpoint_presentation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Viewpoint_presentation.Match {
    ...
    private static final class Immutable extends Viewpoint_presentation.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Viewpoint_presentation pattern,
   ...
   * 
   * @see Match
   * @see Viewpoint_presentation
   * 
   */
  public static class Matcher extends BaseMatcher<Viewpoint_presentation.Match> {
    /**
     ...
     * 
     */
    public static Viewpoint_presentation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Viewpoint_presentation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Viewpoint_presentation.Matcher.class);
     ...
     * 
     */
    public Collection<Viewpoint_presentation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Viewpoint_presentation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Viewpoint_presentation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Viewpoint_presentation.Match> processor) {
     ...
     * 
     */
    public Viewpoint_presentation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Viewpoint_presentation.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Viewpoint_presentation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Viewpoint_presentation.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Viewpoint_presentation.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Viewpoint_presentation.Match partialMatch) {
    ...
    @Override
    protected Viewpoint_presentation.Match tupleToMatch(final Tuple t) {
      try {
          return Viewpoint_presentation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Viewpoint_presentation.Match arrayToMatch(final Object[] match) {
      try {
          return Viewpoint_presentation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Viewpoint_presentation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Viewpoint_presentation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Viewpoint_presentation.Matcher> querySpecification() {
      return Viewpoint_presentation.instance();
    }
  }
  
  private Viewpoint_presentation() {
   ...
   * 
   */
  public static Viewpoint_presentation instance() {
    try{
  ...
  @Override
  protected Viewpoint_presentation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Viewpoint_presentation.Matcher.on(engine);
  }
  
  @Override
  public Viewpoint_presentation.Matcher instantiate() {
    return Viewpoint_presentation.Matcher.create();
  }
  
  @Override
  public Viewpoint_presentation.Match newEmptyMatch() {
    return Viewpoint_presentation.Match.newEmptyMatch();
  }
  
  @Override
  public Viewpoint_presentation.Match newMatch(final Object... parameters) {
    return Viewpoint_presentation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Viewpoint_presentation (visibility: PUBLIC, simpleName: Viewpoint_presentation, identifier: sysml.Viewpoint_presentation, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Viewpoint_presentation (visibility: PUBLIC, simpleName: Viewpoint_presentation, identifier: sysml.Viewpoint_presentation, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Viewpoint_presentation INSTANCE = new Viewpoint_presentation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Viewpoint_presentation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "presentation");
