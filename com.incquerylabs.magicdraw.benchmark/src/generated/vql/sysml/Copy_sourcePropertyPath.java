...
public final class Copy_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<Copy_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Copy_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Copy_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Copy_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Copy_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Copy_sourcePropertyPath.Match)) {
          Copy_sourcePropertyPath.Match other = (Copy_sourcePropertyPath.Match) obj;
    ...
    @Override
    public Copy_sourcePropertyPath specification() {
     ...
     * 
     */
    public static Copy_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Copy_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Copy_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Copy_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends Copy_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Copy_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Copy_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Copy_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Copy_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Copy_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Copy_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Copy_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Copy_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Copy_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Copy_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public Copy_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Copy_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Copy_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Copy_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Copy_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Copy_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected Copy_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Copy_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Copy_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Copy_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Copy_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Copy_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Copy_sourcePropertyPath.Matcher> querySpecification() {
      return Copy_sourcePropertyPath.instance();
    }
  }
  
  private Copy_sourcePropertyPath() {
   ...
   * 
   */
  public static Copy_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected Copy_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Copy_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Copy_sourcePropertyPath.Matcher instantiate() {
    return Copy_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public Copy_sourcePropertyPath.Match newEmptyMatch() {
    return Copy_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Copy_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return Copy_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Copy_sourcePropertyPath (visibility: PUBLIC, simpleName: Copy_sourcePropertyPath, identifier: sysml.Copy_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Copy_sourcePropertyPath (visibility: PUBLIC, simpleName: Copy_sourcePropertyPath, identifier: sysml.Copy_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Copy_sourcePropertyPath INSTANCE = new Copy_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Copy_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
