...
public final class PhysicalRequirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<PhysicalRequirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.physicalRequirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.physicalRequirement_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalRequirement_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalRequirement_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalRequirement_DerivedFrom.Match)) {
          PhysicalRequirement_DerivedFrom.Match other = (PhysicalRequirement_DerivedFrom.Match) obj;
    ...
    @Override
    public PhysicalRequirement_DerivedFrom specification() {
     ...
     * 
     */
    public static PhysicalRequirement_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalRequirement_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalRequirement_DerivedFrom.Match {
    ...
    private static final class Immutable extends PhysicalRequirement_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.physicalRequirement_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see PhysicalRequirement_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalRequirement_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static PhysicalRequirement_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalRequirement_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalRequirement_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalRequirement_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalRequirement_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalRequirement_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalRequirement_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public PhysicalRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalRequirement_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalRequirement_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected PhysicalRequirement_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalRequirement_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalRequirement_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalRequirement_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalRequirement_DerivedFrom.Matcher> querySpecification() {
      return PhysicalRequirement_DerivedFrom.instance();
    }
  }
  
  private PhysicalRequirement_DerivedFrom() {
   ...
   * 
   */
  public static PhysicalRequirement_DerivedFrom instance() {
    try{
  ...
  @Override
  protected PhysicalRequirement_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalRequirement_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public PhysicalRequirement_DerivedFrom.Matcher instantiate() {
    return PhysicalRequirement_DerivedFrom.Matcher.create();
  }
  
  @Override
  public PhysicalRequirement_DerivedFrom.Match newEmptyMatch() {
    return PhysicalRequirement_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalRequirement_DerivedFrom.Match newMatch(final Object... parameters) {
    return PhysicalRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PhysicalRequirement_DerivedFrom (visibility: PUBLIC, simpleName: PhysicalRequirement_DerivedFrom, identifier: sysml.PhysicalRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PhysicalRequirement_DerivedFrom (visibility: PUBLIC, simpleName: PhysicalRequirement_DerivedFrom, identifier: sysml.PhysicalRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalRequirement_DerivedFrom INSTANCE = new PhysicalRequirement_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalRequirement_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
