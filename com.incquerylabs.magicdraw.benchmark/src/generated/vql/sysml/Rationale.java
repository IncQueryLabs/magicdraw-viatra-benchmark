...
public final class Rationale extends BaseGeneratedEMFQuerySpecification<Rationale.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Rationale pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Rationale";
    }
    
    @Override
    public List<String> parameterNames() {
      return Rationale.Match.parameterNames;
    }
    ...
    @Override
    public Rationale.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Rationale.Match)) {
          Rationale.Match other = (Rationale.Match) obj;
    ...
    @Override
    public Rationale specification() {
     ...
     * 
     */
    public static Rationale.Match newEmptyMatch() {
     ...
     * 
     */
    public static Rationale.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Rationale.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Rationale.Match {
    ...
    private static final class Immutable extends Rationale.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Rationale pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Rationale.Match> {
    /**
     ...
     * 
     */
    public static Rationale.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Rationale.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Rationale.Matcher.class);
     ...
     * 
     */
    public Collection<Rationale.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Rationale.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Rationale.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Rationale.Match> processor) {
     ...
     * 
     */
    public Rationale.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Rationale.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Rationale.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Rationale.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Rationale.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Rationale.Match partialMatch) {
    ...
    @Override
    protected Rationale.Match tupleToMatch(final Tuple t) {
      try {
          return Rationale.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Rationale.Match arrayToMatch(final Object[] match) {
      try {
          return Rationale.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Rationale.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rationale.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Rationale.Matcher> querySpecification() {
      return Rationale.instance();
    }
  }
   ...
   * 
   */
  public static Rationale instance() {
    try{
  ...
  @Override
  protected Rationale.Matcher instantiate(final ViatraQueryEngine engine) {
    return Rationale.Matcher.on(engine);
  }
  
  @Override
  public Rationale.Matcher instantiate() {
    return Rationale.Matcher.create();
  }
  
  @Override
  public Rationale.Match newEmptyMatch() {
    return Rationale.Match.newEmptyMatch();
  }
  
  @Override
  public Rationale.Match newMatch(final Object... parameters) {
    return Rationale.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Rationale (visibility: PUBLIC, simpleName: Rationale, identifier: sysml.Rationale, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Rationale (visibility: PUBLIC, simpleName: Rationale, identifier: sysml.Rationale, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Rationale INSTANCE = new Rationale();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Rationale.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Rationale");
