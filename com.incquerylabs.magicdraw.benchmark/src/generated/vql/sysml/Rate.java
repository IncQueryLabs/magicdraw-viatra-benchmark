...
public final class Rate extends BaseGeneratedEMFQuerySpecification<Rate.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Rate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Rate.Match newMutableMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Rate.Match newMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the sysml.Rate pattern,
  ...
  public static class Matcher extends BaseMatcher<Rate.Match> {
     ...
     * 
     */
    public Collection<Rate.Match> getAllMatches(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Rate.Match> streamAllMatches(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Rate.Match> getOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Rate.Match> processor) {
     ...
     * 
     */
    public Rate.Match newMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Rate.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Rate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Rate.Match partialMatch) {
    ...
    protected Rate.Match tupleToMatch(final Tuple t) {
      try {
          return Rate.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected Rate.Match arrayToMatch(final Object[] match) {
      try {
          return Rate.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected Rate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rate.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Rate.Match newMatch(final Object... parameters) {
    return Rate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Rate (visibility: PUBLIC, simpleName: Rate, identifier: sysml.Rate, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Rate (visibility: PUBLIC, simpleName: Rate, identifier: sysml.Rate, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
