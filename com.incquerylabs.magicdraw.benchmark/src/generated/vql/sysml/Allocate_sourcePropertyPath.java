...
public final class Allocate_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<Allocate_sourcePropertyPath.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Allocate_sourcePropertyPath (visibility: PUBLIC, simpleName: Allocate_sourcePropertyPath, identifier: sysml.Allocate_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Allocate_sourcePropertyPath (visibility: PUBLIC, simpleName: Allocate_sourcePropertyPath, identifier: sysml.Allocate_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
