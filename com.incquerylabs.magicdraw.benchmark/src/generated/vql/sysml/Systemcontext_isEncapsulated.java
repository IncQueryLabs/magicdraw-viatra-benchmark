...
public final class Systemcontext_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Systemcontext_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Systemcontext_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Systemcontext_isEncapsulated";
    }
     ...
     * 
     */
    public static Systemcontext_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Systemcontext_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the sysml.Systemcontext_isEncapsulated pattern,
  ...
  public static class Matcher extends BaseMatcher<Systemcontext_isEncapsulated.Match> {
     ...
     * 
     */
    public Collection<Systemcontext_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Systemcontext_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Systemcontext_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Systemcontext_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Systemcontext_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Systemcontext_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Systemcontext_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Systemcontext_isEncapsulated.Match partialMatch) {
    ...
    protected Systemcontext_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Systemcontext_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    protected Systemcontext_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Systemcontext_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected Systemcontext_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Systemcontext_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Systemcontext_isEncapsulated.Match newMatch(final Object... parameters) {
    return Systemcontext_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Systemcontext_isEncapsulated (visibility: PUBLIC, simpleName: Systemcontext_isEncapsulated, identifier: sysml.Systemcontext_isEncapsulated, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Systemcontext_isEncapsulated (visibility: PUBLIC, simpleName: Systemcontext_isEncapsulated, identifier: sysml.Systemcontext_isEncapsulated, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Systemcontext(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Systemcontext.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
