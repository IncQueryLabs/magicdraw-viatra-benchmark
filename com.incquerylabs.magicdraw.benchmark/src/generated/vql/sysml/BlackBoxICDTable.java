...
public final class BlackBoxICDTable extends BaseGeneratedEMFQuerySpecification<BlackBoxICDTable.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.BlackBoxICDTable pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.BlackBoxICDTable";
    }
    
    @Override
    public List<String> parameterNames() {
      return BlackBoxICDTable.Match.parameterNames;
    }
    ...
    @Override
    public BlackBoxICDTable.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BlackBoxICDTable.Match)) {
          BlackBoxICDTable.Match other = (BlackBoxICDTable.Match) obj;
    ...
    @Override
    public BlackBoxICDTable specification() {
     ...
     * 
     */
    public static BlackBoxICDTable.Match newEmptyMatch() {
     ...
     * 
     */
    public static BlackBoxICDTable.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static BlackBoxICDTable.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends BlackBoxICDTable.Match {
    ...
    private static final class Immutable extends BlackBoxICDTable.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.BlackBoxICDTable pattern,
   ...
   * 
   * @see Match
   * @see BlackBoxICDTable
   * 
   */
  public static class Matcher extends BaseMatcher<BlackBoxICDTable.Match> {
    /**
     ...
     * 
     */
    public static BlackBoxICDTable.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BlackBoxICDTable.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BlackBoxICDTable.Matcher.class);
     ...
     * 
     */
    public Collection<BlackBoxICDTable.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<BlackBoxICDTable.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<BlackBoxICDTable.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super BlackBoxICDTable.Match> processor) {
     ...
     * 
     */
    public BlackBoxICDTable.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return BlackBoxICDTable.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final BlackBoxICDTable.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final BlackBoxICDTable.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final BlackBoxICDTable.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final BlackBoxICDTable.Match partialMatch) {
    ...
    @Override
    protected BlackBoxICDTable.Match tupleToMatch(final Tuple t) {
      try {
          return BlackBoxICDTable.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected BlackBoxICDTable.Match arrayToMatch(final Object[] match) {
      try {
          return BlackBoxICDTable.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BlackBoxICDTable.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BlackBoxICDTable.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BlackBoxICDTable.Matcher> querySpecification() {
      return BlackBoxICDTable.instance();
    }
  }
  
  private BlackBoxICDTable() {
   ...
   * 
   */
  public static BlackBoxICDTable instance() {
    try{
  ...
  @Override
  protected BlackBoxICDTable.Matcher instantiate(final ViatraQueryEngine engine) {
    return BlackBoxICDTable.Matcher.on(engine);
  }
  
  @Override
  public BlackBoxICDTable.Matcher instantiate() {
    return BlackBoxICDTable.Matcher.create();
  }
  
  @Override
  public BlackBoxICDTable.Match newEmptyMatch() {
    return BlackBoxICDTable.Match.newEmptyMatch();
  }
  
  @Override
  public BlackBoxICDTable.Match newMatch(final Object... parameters) {
    return BlackBoxICDTable.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BlackBoxICDTable (visibility: PUBLIC, simpleName: BlackBoxICDTable, identifier: sysml.BlackBoxICDTable, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BlackBoxICDTable (visibility: PUBLIC, simpleName: BlackBoxICDTable, identifier: sysml.BlackBoxICDTable, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BlackBoxICDTable INSTANCE = new BlackBoxICDTable();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BlackBoxICDTable.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "BlackBoxICDTable");
