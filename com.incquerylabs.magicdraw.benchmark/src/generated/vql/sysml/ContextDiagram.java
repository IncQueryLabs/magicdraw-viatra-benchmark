...
public final class ContextDiagram extends BaseGeneratedEMFQuerySpecification<ContextDiagram.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ContextDiagram pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.ContextDiagram";
    }
    
    @Override
    public List<String> parameterNames() {
      return ContextDiagram.Match.parameterNames;
    }
    ...
    @Override
    public ContextDiagram.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ContextDiagram.Match)) {
          ContextDiagram.Match other = (ContextDiagram.Match) obj;
    ...
    @Override
    public ContextDiagram specification() {
     ...
     * 
     */
    public static ContextDiagram.Match newEmptyMatch() {
     ...
     * 
     */
    public static ContextDiagram.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ContextDiagram.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ContextDiagram.Match {
    ...
    private static final class Immutable extends ContextDiagram.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.ContextDiagram pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ContextDiagram.Match> {
    /**
     ...
     * 
     */
    public static ContextDiagram.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ContextDiagram.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ContextDiagram.Matcher.class);
     ...
     * 
     */
    public Collection<ContextDiagram.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ContextDiagram.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ContextDiagram.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ContextDiagram.Match> processor) {
     ...
     * 
     */
    public ContextDiagram.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ContextDiagram.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final ContextDiagram.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final ContextDiagram.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ContextDiagram.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ContextDiagram.Match partialMatch) {
    ...
    @Override
    protected ContextDiagram.Match tupleToMatch(final Tuple t) {
      try {
          return ContextDiagram.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ContextDiagram.Match arrayToMatch(final Object[] match) {
      try {
          return ContextDiagram.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ContextDiagram.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ContextDiagram.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ContextDiagram.Matcher> querySpecification() {
      return ContextDiagram.instance();
    }
  }
  
  private ContextDiagram() {
   ...
   * 
   */
  public static ContextDiagram instance() {
    try{
  ...
  @Override
  protected ContextDiagram.Matcher instantiate(final ViatraQueryEngine engine) {
    return ContextDiagram.Matcher.on(engine);
  }
  
  @Override
  public ContextDiagram.Matcher instantiate() {
    return ContextDiagram.Matcher.create();
  }
  
  @Override
  public ContextDiagram.Match newEmptyMatch() {
    return ContextDiagram.Match.newEmptyMatch();
  }
  
  @Override
  public ContextDiagram.Match newMatch(final Object... parameters) {
    return ContextDiagram.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ContextDiagram (visibility: PUBLIC, simpleName: ContextDiagram, identifier: sysml.ContextDiagram, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ContextDiagram (visibility: PUBLIC, simpleName: ContextDiagram, identifier: sysml.ContextDiagram, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ContextDiagram INSTANCE = new ContextDiagram();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ContextDiagram.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ContextDiagram");
