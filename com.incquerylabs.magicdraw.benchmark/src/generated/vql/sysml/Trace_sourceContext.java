...
public final class Trace_sourceContext extends BaseGeneratedEMFQuerySpecification<Trace_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Trace_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Trace_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Trace_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public Trace_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Trace_sourceContext.Match)) {
          Trace_sourceContext.Match other = (Trace_sourceContext.Match) obj;
    ...
    @Override
    public Trace_sourceContext specification() {
     ...
     * 
     */
    public static Trace_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Trace_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Trace_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Trace_sourceContext.Match {
    ...
    private static final class Immutable extends Trace_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Trace_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see Trace_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<Trace_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static Trace_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Trace_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Trace_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<Trace_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Trace_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Trace_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Trace_sourceContext.Match> processor) {
     ...
     * 
     */
    public Trace_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Trace_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Trace_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Trace_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Trace_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Trace_sourceContext.Match partialMatch) {
    ...
    @Override
    protected Trace_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return Trace_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Trace_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return Trace_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Trace_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Trace_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Trace_sourceContext.Matcher> querySpecification() {
      return Trace_sourceContext.instance();
    }
  }
  
  private Trace_sourceContext() {
   ...
   * 
   */
  public static Trace_sourceContext instance() {
    try{
  ...
  @Override
  protected Trace_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Trace_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public Trace_sourceContext.Matcher instantiate() {
    return Trace_sourceContext.Matcher.create();
  }
  
  @Override
  public Trace_sourceContext.Match newEmptyMatch() {
    return Trace_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public Trace_sourceContext.Match newMatch(final Object... parameters) {
    return Trace_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Trace_sourceContext (visibility: PUBLIC, simpleName: Trace_sourceContext, identifier: sysml.Trace_sourceContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Trace_sourceContext (visibility: PUBLIC, simpleName: Trace_sourceContext, identifier: sysml.Trace_sourceContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Trace_sourceContext INSTANCE = new Trace_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Trace_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
