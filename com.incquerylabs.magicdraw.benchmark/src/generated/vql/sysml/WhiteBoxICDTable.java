...
public final class WhiteBoxICDTable extends BaseGeneratedEMFQuerySpecification<WhiteBoxICDTable.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.WhiteBoxICDTable pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.WhiteBoxICDTable";
    }
    
    @Override
    public List<String> parameterNames() {
      return WhiteBoxICDTable.Match.parameterNames;
    }
    ...
    @Override
    public WhiteBoxICDTable.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WhiteBoxICDTable.Match)) {
          WhiteBoxICDTable.Match other = (WhiteBoxICDTable.Match) obj;
    ...
    @Override
    public WhiteBoxICDTable specification() {
     ...
     * 
     */
    public static WhiteBoxICDTable.Match newEmptyMatch() {
     ...
     * 
     */
    public static WhiteBoxICDTable.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static WhiteBoxICDTable.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends WhiteBoxICDTable.Match {
    ...
    private static final class Immutable extends WhiteBoxICDTable.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.WhiteBoxICDTable pattern,
   ...
   * 
   * @see Match
   * @see WhiteBoxICDTable
   * 
   */
  public static class Matcher extends BaseMatcher<WhiteBoxICDTable.Match> {
    /**
     ...
     * 
     */
    public static WhiteBoxICDTable.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WhiteBoxICDTable.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WhiteBoxICDTable.Matcher.class);
     ...
     * 
     */
    public Collection<WhiteBoxICDTable.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<WhiteBoxICDTable.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<WhiteBoxICDTable.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super WhiteBoxICDTable.Match> processor) {
     ...
     * 
     */
    public WhiteBoxICDTable.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return WhiteBoxICDTable.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final WhiteBoxICDTable.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final WhiteBoxICDTable.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final WhiteBoxICDTable.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final WhiteBoxICDTable.Match partialMatch) {
    ...
    @Override
    protected WhiteBoxICDTable.Match tupleToMatch(final Tuple t) {
      try {
          return WhiteBoxICDTable.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected WhiteBoxICDTable.Match arrayToMatch(final Object[] match) {
      try {
          return WhiteBoxICDTable.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WhiteBoxICDTable.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WhiteBoxICDTable.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WhiteBoxICDTable.Matcher> querySpecification() {
      return WhiteBoxICDTable.instance();
    }
  }
  
  private WhiteBoxICDTable() {
   ...
   * 
   */
  public static WhiteBoxICDTable instance() {
    try{
  ...
  @Override
  protected WhiteBoxICDTable.Matcher instantiate(final ViatraQueryEngine engine) {
    return WhiteBoxICDTable.Matcher.on(engine);
  }
  
  @Override
  public WhiteBoxICDTable.Matcher instantiate() {
    return WhiteBoxICDTable.Matcher.create();
  }
  
  @Override
  public WhiteBoxICDTable.Match newEmptyMatch() {
    return WhiteBoxICDTable.Match.newEmptyMatch();
  }
  
  @Override
  public WhiteBoxICDTable.Match newMatch(final Object... parameters) {
    return WhiteBoxICDTable.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.WhiteBoxICDTable (visibility: PUBLIC, simpleName: WhiteBoxICDTable, identifier: sysml.WhiteBoxICDTable, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.WhiteBoxICDTable (visibility: PUBLIC, simpleName: WhiteBoxICDTable, identifier: sysml.WhiteBoxICDTable, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WhiteBoxICDTable INSTANCE = new WhiteBoxICDTable();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WhiteBoxICDTable.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "WhiteBoxICDTable");
