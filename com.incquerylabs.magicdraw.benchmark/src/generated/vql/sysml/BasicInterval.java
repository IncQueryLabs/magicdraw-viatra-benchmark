...
public final class BasicInterval extends BaseGeneratedEMFQuerySpecification<BasicInterval.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.BasicInterval pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.BasicInterval";
    }
    
    @Override
    public List<String> parameterNames() {
      return BasicInterval.Match.parameterNames;
    }
    ...
    @Override
    public BasicInterval.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BasicInterval.Match)) {
          BasicInterval.Match other = (BasicInterval.Match) obj;
    ...
    @Override
    public BasicInterval specification() {
     ...
     * 
     */
    public static BasicInterval.Match newEmptyMatch() {
     ...
     * 
     */
    public static BasicInterval.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static BasicInterval.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends BasicInterval.Match {
    ...
    private static final class Immutable extends BasicInterval.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.BasicInterval pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<BasicInterval.Match> {
    /**
     ...
     * 
     */
    public static BasicInterval.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BasicInterval.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BasicInterval.Matcher.class);
     ...
     * 
     */
    public Collection<BasicInterval.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<BasicInterval.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<BasicInterval.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super BasicInterval.Match> processor) {
     ...
     * 
     */
    public BasicInterval.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return BasicInterval.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final BasicInterval.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final BasicInterval.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final BasicInterval.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final BasicInterval.Match partialMatch) {
    ...
    @Override
    protected BasicInterval.Match tupleToMatch(final Tuple t) {
      try {
          return BasicInterval.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected BasicInterval.Match arrayToMatch(final Object[] match) {
      try {
          return BasicInterval.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BasicInterval.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BasicInterval.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BasicInterval.Matcher> querySpecification() {
      return BasicInterval.instance();
    }
  }
  
  private BasicInterval() {
   ...
   * 
   */
  public static BasicInterval instance() {
    try{
  ...
  @Override
  protected BasicInterval.Matcher instantiate(final ViatraQueryEngine engine) {
    return BasicInterval.Matcher.on(engine);
  }
  
  @Override
  public BasicInterval.Matcher instantiate() {
    return BasicInterval.Matcher.create();
  }
  
  @Override
  public BasicInterval.Match newEmptyMatch() {
    return BasicInterval.Match.newEmptyMatch();
  }
  
  @Override
  public BasicInterval.Match newMatch(final Object... parameters) {
    return BasicInterval.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BasicInterval (visibility: PUBLIC, simpleName: BasicInterval, identifier: sysml.BasicInterval, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BasicInterval (visibility: PUBLIC, simpleName: BasicInterval, identifier: sysml.BasicInterval, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BasicInterval INSTANCE = new BasicInterval();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BasicInterval.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "BasicInterval");
