...
public final class ConnectorProperty_connector extends BaseGeneratedEMFQuerySpecification<ConnectorProperty_connector.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ConnectorProperty_connector (visibility: PUBLIC, simpleName: ConnectorProperty_connector, identifier: sysml.ConnectorProperty_connector, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ConnectorProperty_connector (visibility: PUBLIC, simpleName: ConnectorProperty_connector, identifier: sysml.ConnectorProperty_connector, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
