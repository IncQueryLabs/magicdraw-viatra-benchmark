...
public final class ExtendedRequirement_SatisfiedBy extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_SatisfiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement_SatisfiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement_SatisfiedBy";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement_SatisfiedBy pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ExtendedRequirement_SatisfiedBy (visibility: PUBLIC, simpleName: ExtendedRequirement_SatisfiedBy, identifier: sysml.ExtendedRequirement_SatisfiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ExtendedRequirement_SatisfiedBy (visibility: PUBLIC, simpleName: ExtendedRequirement_SatisfiedBy, identifier: sysml.ExtendedRequirement_SatisfiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
