...
public final class AbstractRequirement extends BaseGeneratedEMFQuerySpecification<AbstractRequirement.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.AbstractRequirement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.AbstractRequirement";
    }
    
    @Override
    public List<String> parameterNames() {
      return AbstractRequirement.Match.parameterNames;
    }
    ...
    @Override
    public AbstractRequirement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof AbstractRequirement.Match)) {
          AbstractRequirement.Match other = (AbstractRequirement.Match) obj;
    ...
    @Override
    public AbstractRequirement specification() {
     ...
     * 
     */
    public static AbstractRequirement.Match newEmptyMatch() {
     ...
     * 
     */
    public static AbstractRequirement.Match newMutableMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static AbstractRequirement.Match newMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends AbstractRequirement.Match {
    ...
    private static final class Immutable extends AbstractRequirement.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.AbstractRequirement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<AbstractRequirement.Match> {
    /**
     ...
     * 
     */
    public static AbstractRequirement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static AbstractRequirement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(AbstractRequirement.Matcher.class);
     ...
     * 
     */
    public Collection<AbstractRequirement.Match> getAllMatches(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<AbstractRequirement.Match> streamAllMatches(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<AbstractRequirement.Match> getOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super AbstractRequirement.Match> processor) {
     ...
     * 
     */
    public AbstractRequirement.Match newMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return AbstractRequirement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfelement(final AbstractRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfelement(final AbstractRequirement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final AbstractRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final AbstractRequirement.Match partialMatch) {
    ...
    @Override
    protected AbstractRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return AbstractRequirement.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected AbstractRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return AbstractRequirement.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected AbstractRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AbstractRequirement.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<AbstractRequirement.Matcher> querySpecification() {
      return AbstractRequirement.instance();
    }
  }
   ...
   * 
   */
  public static AbstractRequirement instance() {
    try{
  ...
  @Override
  protected AbstractRequirement.Matcher instantiate(final ViatraQueryEngine engine) {
    return AbstractRequirement.Matcher.on(engine);
  }
  
  @Override
  public AbstractRequirement.Matcher instantiate() {
    return AbstractRequirement.Matcher.create();
  }
  
  @Override
  public AbstractRequirement.Match newEmptyMatch() {
    return AbstractRequirement.Match.newEmptyMatch();
  }
  
  @Override
  public AbstractRequirement.Match newMatch(final Object... parameters) {
    return AbstractRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.AbstractRequirement (visibility: PUBLIC, simpleName: AbstractRequirement, identifier: sysml.AbstractRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.AbstractRequirement (visibility: PUBLIC, simpleName: AbstractRequirement, identifier: sysml.AbstractRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final AbstractRequirement INSTANCE = new AbstractRequirement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final AbstractRequirement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "AbstractRequirement");
