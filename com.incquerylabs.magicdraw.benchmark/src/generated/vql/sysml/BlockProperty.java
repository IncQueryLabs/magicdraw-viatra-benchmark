...
public final class BlockProperty extends BaseGeneratedEMFQuerySpecification<BlockProperty.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.BlockProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.BlockProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return BlockProperty.Match.parameterNames;
    }
    ...
    @Override
    public BlockProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BlockProperty.Match)) {
          BlockProperty.Match other = (BlockProperty.Match) obj;
    ...
    @Override
    public BlockProperty specification() {
     ...
     * 
     */
    public static BlockProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static BlockProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static BlockProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends BlockProperty.Match {
    ...
    private static final class Immutable extends BlockProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.BlockProperty pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<BlockProperty.Match> {
    /**
     ...
     * 
     */
    public static BlockProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BlockProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BlockProperty.Matcher.class);
     ...
     * 
     */
    public Collection<BlockProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<BlockProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<BlockProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super BlockProperty.Match> processor) {
     ...
     * 
     */
    public BlockProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return BlockProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final BlockProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final BlockProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final BlockProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final BlockProperty.Match partialMatch) {
    ...
    @Override
    protected BlockProperty.Match tupleToMatch(final Tuple t) {
      try {
          return BlockProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected BlockProperty.Match arrayToMatch(final Object[] match) {
      try {
          return BlockProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BlockProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BlockProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BlockProperty.Matcher> querySpecification() {
      return BlockProperty.instance();
    }
  }
  ...
  @Override
  protected BlockProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return BlockProperty.Matcher.on(engine);
  }
  
  @Override
  public BlockProperty.Matcher instantiate() {
    return BlockProperty.Matcher.create();
  }
  
  @Override
  public BlockProperty.Match newEmptyMatch() {
    return BlockProperty.Match.newEmptyMatch();
  }
  
  @Override
  public BlockProperty.Match newMatch(final Object... parameters) {
    return BlockProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BlockProperty (visibility: PUBLIC, simpleName: BlockProperty, identifier: sysml.BlockProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BlockProperty (visibility: PUBLIC, simpleName: BlockProperty, identifier: sysml.BlockProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BlockProperty INSTANCE = new BlockProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BlockProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "BlockProperty");
