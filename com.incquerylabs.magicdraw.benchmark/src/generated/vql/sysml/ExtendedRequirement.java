...
public final class ExtendedRequirement extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtendedRequirement.Match)) {
          ExtendedRequirement.Match other = (ExtendedRequirement.Match) obj;
    ...
    @Override
    public ExtendedRequirement specification() {
     ...
     * 
     */
    public static ExtendedRequirement.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtendedRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ExtendedRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ExtendedRequirement.Match {
    ...
    private static final class Immutable extends ExtendedRequirement.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtendedRequirement.Matcher.class);
     ...
     * 
     */
    public Collection<ExtendedRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ExtendedRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ExtendedRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ExtendedRequirement.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ExtendedRequirement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExtendedRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExtendedRequirement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ExtendedRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ExtendedRequirement.Match partialMatch) {
    ...
    @Override
    protected ExtendedRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ExtendedRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExtendedRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement.Matcher> querySpecification() {
      return ExtendedRequirement.instance();
    }
  }
  
  private ExtendedRequirement() {
   ...
   * 
   */
  public static ExtendedRequirement instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement.Matcher instantiate() {
    return ExtendedRequirement.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement.Match newEmptyMatch() {
    return ExtendedRequirement.Match.newEmptyMatch();
  }
  
  @Override
  public ExtendedRequirement.Match newMatch(final Object... parameters) {
    return ExtendedRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ExtendedRequirement (visibility: PUBLIC, simpleName: ExtendedRequirement, identifier: sysml.ExtendedRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ExtendedRequirement (visibility: PUBLIC, simpleName: ExtendedRequirement, identifier: sysml.ExtendedRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement INSTANCE = new ExtendedRequirement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExtendedRequirement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "extendedRequirement");
