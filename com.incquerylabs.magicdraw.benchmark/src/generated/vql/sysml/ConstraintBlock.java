...
public final class ConstraintBlock extends BaseGeneratedEMFQuerySpecification<ConstraintBlock.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ConstraintBlock pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public List<String> parameterNames() {
      return ConstraintBlock.Match.parameterNames;
    }
    ...
    @Override
    public ConstraintBlock.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConstraintBlock.Match)) {
          ConstraintBlock.Match other = (ConstraintBlock.Match) obj;
    ...
    @Override
    public ConstraintBlock specification() {
     ...
     * 
     */
    public static ConstraintBlock.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConstraintBlock.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ConstraintBlock.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ConstraintBlock.Match {
    ...
    private static final class Immutable extends ConstraintBlock.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.ConstraintBlock pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ConstraintBlock.Match> {
    /**
     ...
     * 
     */
    public static ConstraintBlock.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConstraintBlock.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConstraintBlock.Matcher.class);
     ...
     * 
     */
    public Collection<ConstraintBlock.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ConstraintBlock.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ConstraintBlock.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ConstraintBlock.Match> processor) {
     ...
     * 
     */
    public ConstraintBlock.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ConstraintBlock.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ConstraintBlock.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ConstraintBlock.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ConstraintBlock.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ConstraintBlock.Match partialMatch) {
    ...
    @Override
    protected ConstraintBlock.Match tupleToMatch(final Tuple t) {
      try {
          return ConstraintBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ConstraintBlock.Match arrayToMatch(final Object[] match) {
      try {
          return ConstraintBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConstraintBlock.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConstraintBlock.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConstraintBlock.Matcher> querySpecification() {
      return ConstraintBlock.instance();
    }
  }
  
  private ConstraintBlock() {
   ...
   * 
   */
  public static ConstraintBlock instance() {
    try{
  ...
  @Override
  protected ConstraintBlock.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConstraintBlock.Matcher.on(engine);
  }
  
  @Override
  public ConstraintBlock.Matcher instantiate() {
    return ConstraintBlock.Matcher.create();
  }
  
  @Override
  public ConstraintBlock.Match newEmptyMatch() {
    return ConstraintBlock.Match.newEmptyMatch();
  }
  
  @Override
  public ConstraintBlock.Match newMatch(final Object... parameters) {
    return ConstraintBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ConstraintBlock (visibility: PUBLIC, simpleName: ConstraintBlock, identifier: sysml.ConstraintBlock, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ConstraintBlock (visibility: PUBLIC, simpleName: ConstraintBlock, identifier: sysml.ConstraintBlock, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConstraintBlock INSTANCE = new ConstraintBlock();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConstraintBlock.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ConstraintBlock");
