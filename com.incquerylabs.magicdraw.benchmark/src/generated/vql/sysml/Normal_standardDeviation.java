...
public final class Normal_standardDeviation extends BaseGeneratedEMFQuerySpecification<Normal_standardDeviation.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Normal_standardDeviation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Normal_standardDeviation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Normal_standardDeviation.Match.parameterNames;
    }
    ...
    @Override
    public Normal_standardDeviation specification() {
     ...
     * 
     */
    public static Normal_standardDeviation.Match newEmptyMatch() {
  ...
  /**
   * Generated pattern matcher API of the sysml.Normal_standardDeviation pattern,
   ...
   * 
   * @see Match
   * @see Normal_standardDeviation
   * 
   */
  public static class Matcher extends BaseMatcher<Normal_standardDeviation.Match> {
    /**
     ...
     * 
     */
    public static Normal_standardDeviation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Normal_standardDeviation.Matcher create() {
      return new Matcher();
    }
     ...
     * 
     */
    public static IQuerySpecification<Normal_standardDeviation.Matcher> querySpecification() {
      return Normal_standardDeviation.instance();
    }
  }
  
  private Normal_standardDeviation() {
   ...
   * 
   */
  public static Normal_standardDeviation instance() {
    try{
  ...
  @Override
  protected Normal_standardDeviation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Normal_standardDeviation.Matcher.on(engine);
  }
  
  @Override
  public Normal_standardDeviation.Matcher instantiate() {
    return Normal_standardDeviation.Matcher.create();
  }
  
  @Override
  public Normal_standardDeviation.Match newEmptyMatch() {
    return Normal_standardDeviation.Match.newEmptyMatch();
  }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Normal_standardDeviation (visibility: PUBLIC, simpleName: Normal_standardDeviation, identifier: sysml.Normal_standardDeviation, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Normal_standardDeviation (visibility: PUBLIC, simpleName: Normal_standardDeviation, identifier: sysml.Normal_standardDeviation, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Normal_standardDeviation INSTANCE = new Normal_standardDeviation();
