...
public final class AcceptChangeStructuralFeatureEventAction extends BaseGeneratedEMFQuerySpecification<AcceptChangeStructuralFeatureEventAction.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.AcceptChangeStructuralFeatureEventAction pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    public String patternName() {
      return "sysml.AcceptChangeStructuralFeatureEventAction";
    }
     ...
     * 
     */
    public static AcceptChangeStructuralFeatureEventAction.Match newMutableMatch(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static AcceptChangeStructuralFeatureEventAction.Match newMatch(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    private static final class Mutable extends AcceptChangeStructuralFeatureEventAction.Match {
      Mutable(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    private static final class Immutable extends AcceptChangeStructuralFeatureEventAction.Match {
      Immutable(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
        super(pElement, pDomainStereotypeInstance);
      }
  ...
  /**
   * Generated pattern matcher API of the sysml.AcceptChangeStructuralFeatureEventAction pattern,
  ...
  public static class Matcher extends BaseMatcher<AcceptChangeStructuralFeatureEventAction.Match> {
     ...
     * 
     */
    public Collection<AcceptChangeStructuralFeatureEventAction.Match> getAllMatches(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<AcceptChangeStructuralFeatureEventAction.Match> streamAllMatches(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<AcceptChangeStructuralFeatureEventAction.Match> getOneArbitraryMatch(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean hasMatch(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public int countMatches(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super AcceptChangeStructuralFeatureEventAction.Match> processor) {
     ...
     * 
     */
    public AcceptChangeStructuralFeatureEventAction.Match newMatch(final AcceptEventAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return AcceptChangeStructuralFeatureEventAction.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<AcceptEventAction> streamAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Set<AcceptEventAction> getAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final AcceptChangeStructuralFeatureEventAction.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final AcceptEventAction pElement) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final AcceptChangeStructuralFeatureEventAction.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final AcceptEventAction pElement) {
    ...
    protected AcceptChangeStructuralFeatureEventAction.Match tupleToMatch(final Tuple t) {
      try {
          return AcceptChangeStructuralFeatureEventAction.Match.newMatch((AcceptEventAction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected AcceptChangeStructuralFeatureEventAction.Match arrayToMatch(final Object[] match) {
      try {
          return AcceptChangeStructuralFeatureEventAction.Match.newMatch((AcceptEventAction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected AcceptChangeStructuralFeatureEventAction.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AcceptChangeStructuralFeatureEventAction.Match.newMutableMatch((AcceptEventAction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public AcceptChangeStructuralFeatureEventAction.Match newMatch(final Object... parameters) {
    return AcceptChangeStructuralFeatureEventAction.Match.newMatch((com.nomagic.uml2.ext.magicdraw.actions.mdcompleteactions.AcceptEventAction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.AcceptChangeStructuralFeatureEventAction (visibility: PUBLIC, simpleName: AcceptChangeStructuralFeatureEventAction, identifier: sysml.AcceptChangeStructuralFeatureEventAction, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.AcceptChangeStructuralFeatureEventAction (visibility: PUBLIC, simpleName: AcceptChangeStructuralFeatureEventAction, identifier: sysml.AcceptChangeStructuralFeatureEventAction, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_element = new PParameter("element", "com.nomagic.uml2.ext.magicdraw.actions.mdcompleteactions.AcceptEventAction", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.nomagic.com/magicdraw/UML/2.5.1", "AcceptEventAction")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_element), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "AcceptEventAction")));
