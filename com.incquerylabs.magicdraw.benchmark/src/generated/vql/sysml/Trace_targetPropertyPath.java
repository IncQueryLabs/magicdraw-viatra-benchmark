...
public final class Trace_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Trace_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Trace_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Trace_targetPropertyPath";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.Trace_targetPropertyPath pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Trace_targetPropertyPath (visibility: PUBLIC, simpleName: Trace_targetPropertyPath, identifier: sysml.Trace_targetPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Trace_targetPropertyPath (visibility: PUBLIC, simpleName: Trace_targetPropertyPath, identifier: sysml.Trace_targetPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
