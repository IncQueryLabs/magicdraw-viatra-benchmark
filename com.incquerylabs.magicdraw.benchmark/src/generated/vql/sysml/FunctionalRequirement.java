...
public final class FunctionalRequirement extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.functionalRequirement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.functionalRequirement";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalRequirement.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalRequirement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalRequirement.Match)) {
          FunctionalRequirement.Match other = (FunctionalRequirement.Match) obj;
    ...
    @Override
    public FunctionalRequirement specification() {
     ...
     * 
     */
    public static FunctionalRequirement.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FunctionalRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends FunctionalRequirement.Match {
    ...
    private static final class Immutable extends FunctionalRequirement.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.functionalRequirement pattern,
   ...
   * 
   * @see Match
   * @see FunctionalRequirement
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalRequirement.Match> {
    /**
     ...
     * 
     */
    public static FunctionalRequirement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalRequirement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalRequirement.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FunctionalRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FunctionalRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FunctionalRequirement.Match> processor) {
     ...
     * 
     */
    public FunctionalRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FunctionalRequirement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalRequirement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FunctionalRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FunctionalRequirement.Match partialMatch) {
    ...
    @Override
    protected FunctionalRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected FunctionalRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalRequirement.Matcher> querySpecification() {
      return FunctionalRequirement.instance();
    }
  }
   ...
   * 
   */
  public static FunctionalRequirement instance() {
    try{
  ...
  @Override
  protected FunctionalRequirement.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalRequirement.Matcher.on(engine);
  }
  
  @Override
  public FunctionalRequirement.Matcher instantiate() {
    return FunctionalRequirement.Matcher.create();
  }
  
  @Override
  public FunctionalRequirement.Match newEmptyMatch() {
    return FunctionalRequirement.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalRequirement.Match newMatch(final Object... parameters) {
    return FunctionalRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FunctionalRequirement (visibility: PUBLIC, simpleName: FunctionalRequirement, identifier: sysml.FunctionalRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FunctionalRequirement (visibility: PUBLIC, simpleName: FunctionalRequirement, identifier: sysml.FunctionalRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalRequirement INSTANCE = new FunctionalRequirement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalRequirement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "functionalRequirement");
