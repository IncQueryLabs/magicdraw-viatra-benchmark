...
public final class Copy_sourceContext extends BaseGeneratedEMFQuerySpecification<Copy_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Copy_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Copy_sourceContext";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.Copy_sourceContext pattern,
