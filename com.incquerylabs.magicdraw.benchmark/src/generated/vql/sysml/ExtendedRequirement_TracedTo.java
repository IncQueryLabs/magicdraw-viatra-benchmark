...
public final class ExtendedRequirement_TracedTo extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_TracedTo.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement_TracedTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement_TracedTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement_TracedTo.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement_TracedTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtendedRequirement_TracedTo.Match)) {
          ExtendedRequirement_TracedTo.Match other = (ExtendedRequirement_TracedTo.Match) obj;
    ...
    @Override
    public ExtendedRequirement_TracedTo specification() {
     ...
     * 
     */
    public static ExtendedRequirement_TracedTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtendedRequirement_TracedTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static ExtendedRequirement_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExtendedRequirement_TracedTo.Match {
    ...
    private static final class Immutable extends ExtendedRequirement_TracedTo.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement_TracedTo pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement_TracedTo
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement_TracedTo.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement_TracedTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement_TracedTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtendedRequirement_TracedTo.Matcher.class);
     ...
     * 
     */
    public Collection<ExtendedRequirement_TracedTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<ExtendedRequirement_TracedTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<ExtendedRequirement_TracedTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super ExtendedRequirement_TracedTo.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return ExtendedRequirement_TracedTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExtendedRequirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExtendedRequirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final ExtendedRequirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final ExtendedRequirement_TracedTo.Match partialMatch) {
    ...
    @Override
    protected ExtendedRequirement_TracedTo.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExtendedRequirement_TracedTo.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExtendedRequirement_TracedTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement_TracedTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement_TracedTo.Matcher> querySpecification() {
      return ExtendedRequirement_TracedTo.instance();
    }
  }
  
  private ExtendedRequirement_TracedTo() {
   ...
   * 
   */
  public static ExtendedRequirement_TracedTo instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement_TracedTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement_TracedTo.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement_TracedTo.Matcher instantiate() {
    return ExtendedRequirement_TracedTo.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement_TracedTo.Match newEmptyMatch() {
    return ExtendedRequirement_TracedTo.Match.newEmptyMatch();
  }
  
  @Override
  public ExtendedRequirement_TracedTo.Match newMatch(final Object... parameters) {
    return ExtendedRequirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ExtendedRequirement_TracedTo (visibility: PUBLIC, simpleName: ExtendedRequirement_TracedTo, identifier: sysml.ExtendedRequirement_TracedTo, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ExtendedRequirement_TracedTo (visibility: PUBLIC, simpleName: ExtendedRequirement_TracedTo, identifier: sysml.ExtendedRequirement_TracedTo, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement_TracedTo INSTANCE = new ExtendedRequirement_TracedTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExtendedRequirement_TracedTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
