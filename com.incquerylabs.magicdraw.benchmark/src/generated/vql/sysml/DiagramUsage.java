...
public final class DiagramUsage extends BaseGeneratedEMFQuerySpecification<DiagramUsage.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.diagramUsage pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.diagramUsage";
    }
    
    @Override
    public List<String> parameterNames() {
      return DiagramUsage.Match.parameterNames;
    }
    ...
    @Override
    public DiagramUsage.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DiagramUsage.Match)) {
          DiagramUsage.Match other = (DiagramUsage.Match) obj;
    ...
    @Override
    public DiagramUsage specification() {
     ...
     * 
     */
    public static DiagramUsage.Match newEmptyMatch() {
     ...
     * 
     */
    public static DiagramUsage.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static DiagramUsage.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends DiagramUsage.Match {
    ...
    private static final class Immutable extends DiagramUsage.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.diagramUsage pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<DiagramUsage.Match> {
    /**
     ...
     * 
     */
    public static DiagramUsage.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DiagramUsage.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DiagramUsage.Matcher.class);
     ...
     * 
     */
    public Collection<DiagramUsage.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<DiagramUsage.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<DiagramUsage.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super DiagramUsage.Match> processor) {
     ...
     * 
     */
    public DiagramUsage.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return DiagramUsage.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final DiagramUsage.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final DiagramUsage.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final DiagramUsage.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final DiagramUsage.Match partialMatch) {
    ...
    @Override
    protected DiagramUsage.Match tupleToMatch(final Tuple t) {
      try {
          return DiagramUsage.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected DiagramUsage.Match arrayToMatch(final Object[] match) {
      try {
          return DiagramUsage.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DiagramUsage.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DiagramUsage.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DiagramUsage.Matcher> querySpecification() {
      return DiagramUsage.instance();
    }
  }
  
  private DiagramUsage() {
   ...
   * 
   */
  public static DiagramUsage instance() {
    try{
  ...
  @Override
  protected DiagramUsage.Matcher instantiate(final ViatraQueryEngine engine) {
    return DiagramUsage.Matcher.on(engine);
  }
  
  @Override
  public DiagramUsage.Matcher instantiate() {
    return DiagramUsage.Matcher.create();
  }
  
  @Override
  public DiagramUsage.Match newEmptyMatch() {
    return DiagramUsage.Match.newEmptyMatch();
  }
  
  @Override
  public DiagramUsage.Match newMatch(final Object... parameters) {
    return DiagramUsage.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DiagramUsage (visibility: PUBLIC, simpleName: DiagramUsage, identifier: sysml.DiagramUsage, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DiagramUsage (visibility: PUBLIC, simpleName: DiagramUsage, identifier: sysml.DiagramUsage, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DiagramUsage INSTANCE = new DiagramUsage();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DiagramUsage.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "diagramUsage");
