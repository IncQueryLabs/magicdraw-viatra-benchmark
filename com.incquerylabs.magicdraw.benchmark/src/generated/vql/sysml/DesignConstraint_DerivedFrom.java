...
public final class DesignConstraint_DerivedFrom extends BaseGeneratedEMFQuerySpecification<DesignConstraint_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.designConstraint_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.designConstraint_DerivedFrom";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.designConstraint_DerivedFrom pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DesignConstraint_DerivedFrom (visibility: PUBLIC, simpleName: DesignConstraint_DerivedFrom, identifier: sysml.DesignConstraint_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DesignConstraint_DerivedFrom (visibility: PUBLIC, simpleName: DesignConstraint_DerivedFrom, identifier: sysml.DesignConstraint_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
