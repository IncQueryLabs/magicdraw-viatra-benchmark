...
public final class Viewpoint_concern extends BaseGeneratedEMFQuerySpecification<Viewpoint_concern.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Viewpoint_concern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Viewpoint_concern";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.Viewpoint_concern pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Viewpoint_concern (visibility: PUBLIC, simpleName: Viewpoint_concern, identifier: sysml.Viewpoint_concern, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Viewpoint_concern (visibility: PUBLIC, simpleName: Viewpoint_concern, identifier: sysml.Viewpoint_concern, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
