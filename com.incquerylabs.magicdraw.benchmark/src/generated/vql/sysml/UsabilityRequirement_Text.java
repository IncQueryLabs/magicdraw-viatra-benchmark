...
public final class UsabilityRequirement_Text extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement_Text.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.usabilityRequirement_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.usabilityRequirement_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return UsabilityRequirement_Text.Match.parameterNames;
    }
    ...
    @Override
    public UsabilityRequirement_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof UsabilityRequirement_Text.Match)) {
          UsabilityRequirement_Text.Match other = (UsabilityRequirement_Text.Match) obj;
    ...
    @Override
    public UsabilityRequirement_Text specification() {
     ...
     * 
     */
    public static UsabilityRequirement_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static UsabilityRequirement_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static UsabilityRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends UsabilityRequirement_Text.Match {
    ...
    private static final class Immutable extends UsabilityRequirement_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.usabilityRequirement_Text pattern,
   ...
   * 
   * @see Match
   * @see UsabilityRequirement_Text
   * 
   */
  public static class Matcher extends BaseMatcher<UsabilityRequirement_Text.Match> {
    /**
     ...
     * 
     */
    public static UsabilityRequirement_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static UsabilityRequirement_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(UsabilityRequirement_Text.Matcher.class);
     ...
     * 
     */
    public Collection<UsabilityRequirement_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<UsabilityRequirement_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<UsabilityRequirement_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super UsabilityRequirement_Text.Match> processor) {
     ...
     * 
     */
    public UsabilityRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return UsabilityRequirement_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final UsabilityRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final UsabilityRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final UsabilityRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final UsabilityRequirement_Text.Match partialMatch) {
    ...
    @Override
    protected UsabilityRequirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return UsabilityRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected UsabilityRequirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return UsabilityRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected UsabilityRequirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return UsabilityRequirement_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<UsabilityRequirement_Text.Matcher> querySpecification() {
      return UsabilityRequirement_Text.instance();
    }
  }
  
  private UsabilityRequirement_Text() {
   ...
   * 
   */
  public static UsabilityRequirement_Text instance() {
    try{
  ...
  @Override
  protected UsabilityRequirement_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return UsabilityRequirement_Text.Matcher.on(engine);
  }
  
  @Override
  public UsabilityRequirement_Text.Matcher instantiate() {
    return UsabilityRequirement_Text.Matcher.create();
  }
  
  @Override
  public UsabilityRequirement_Text.Match newEmptyMatch() {
    return UsabilityRequirement_Text.Match.newEmptyMatch();
  }
  
  @Override
  public UsabilityRequirement_Text.Match newMatch(final Object... parameters) {
    return UsabilityRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.UsabilityRequirement_Text (visibility: PUBLIC, simpleName: UsabilityRequirement_Text, identifier: sysml.UsabilityRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.UsabilityRequirement_Text (visibility: PUBLIC, simpleName: UsabilityRequirement_Text, identifier: sysml.UsabilityRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final UsabilityRequirement_Text INSTANCE = new UsabilityRequirement_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final UsabilityRequirement_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
