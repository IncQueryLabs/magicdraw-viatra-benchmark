...
public final class Requirement_Id extends BaseGeneratedEMFQuerySpecification<Requirement_Id.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Requirement_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Requirement_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return Requirement_Id.Match.parameterNames;
    }
    ...
    @Override
    public Requirement_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Requirement_Id.Match)) {
          Requirement_Id.Match other = (Requirement_Id.Match) obj;
    ...
    @Override
    public Requirement_Id specification() {
     ...
     * 
     */
    public static Requirement_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static Requirement_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Requirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Requirement_Id.Match {
    ...
    private static final class Immutable extends Requirement_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Requirement_Id pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Requirement_Id.Match> {
    /**
     ...
     * 
     */
    public static Requirement_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Requirement_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Requirement_Id.Matcher.class);
     ...
     * 
     */
    public Collection<Requirement_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Requirement_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Requirement_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Requirement_Id.Match> processor) {
     ...
     * 
     */
    public Requirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Requirement_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Requirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Requirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Requirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Requirement_Id.Match partialMatch) {
    ...
    @Override
    protected Requirement_Id.Match tupleToMatch(final Tuple t) {
      try {
          return Requirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Requirement_Id.Match arrayToMatch(final Object[] match) {
      try {
          return Requirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Requirement_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Requirement_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Requirement_Id.Matcher> querySpecification() {
      return Requirement_Id.instance();
    }
  }
   ...
   * 
   */
  public static Requirement_Id instance() {
    try{
  ...
  @Override
  protected Requirement_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return Requirement_Id.Matcher.on(engine);
  }
  
  @Override
  public Requirement_Id.Matcher instantiate() {
    return Requirement_Id.Matcher.create();
  }
  
  @Override
  public Requirement_Id.Match newEmptyMatch() {
    return Requirement_Id.Match.newEmptyMatch();
  }
  
  @Override
  public Requirement_Id.Match newMatch(final Object... parameters) {
    return Requirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Requirement_Id (visibility: PUBLIC, simpleName: Requirement_Id, identifier: sysml.Requirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Requirement_Id (visibility: PUBLIC, simpleName: Requirement_Id, identifier: sysml.Requirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Requirement_Id INSTANCE = new Requirement_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Requirement_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
