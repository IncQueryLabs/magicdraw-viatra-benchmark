...
public final class InterfaceRequirement_source extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_source.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.interfaceRequirement_source pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.interfaceRequirement_source";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceRequirement_source.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceRequirement_source.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceRequirement_source.Match)) {
          InterfaceRequirement_source.Match other = (InterfaceRequirement_source.Match) obj;
    ...
    @Override
    public InterfaceRequirement_source specification() {
     ...
     * 
     */
    public static InterfaceRequirement_source.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceRequirement_source.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static InterfaceRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends InterfaceRequirement_source.Match {
    ...
    private static final class Immutable extends InterfaceRequirement_source.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.interfaceRequirement_source pattern,
   ...
   * 
   * @see Match
   * @see InterfaceRequirement_source
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceRequirement_source.Match> {
    /**
     ...
     * 
     */
    public static InterfaceRequirement_source.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceRequirement_source.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceRequirement_source.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceRequirement_source.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<InterfaceRequirement_source.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<InterfaceRequirement_source.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super InterfaceRequirement_source.Match> processor) {
     ...
     * 
     */
    public InterfaceRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return InterfaceRequirement_source.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InterfaceRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InterfaceRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final InterfaceRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final InterfaceRequirement_source.Match partialMatch) {
    ...
    @Override
    protected InterfaceRequirement_source.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected InterfaceRequirement_source.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceRequirement_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceRequirement_source.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceRequirement_source.Matcher> querySpecification() {
      return InterfaceRequirement_source.instance();
    }
  }
  
  private InterfaceRequirement_source() {
   ...
   * 
   */
  public static InterfaceRequirement_source instance() {
    try{
  ...
  @Override
  protected InterfaceRequirement_source.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceRequirement_source.Matcher.on(engine);
  }
  
  @Override
  public InterfaceRequirement_source.Matcher instantiate() {
    return InterfaceRequirement_source.Matcher.create();
  }
  
  @Override
  public InterfaceRequirement_source.Match newEmptyMatch() {
    return InterfaceRequirement_source.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceRequirement_source.Match newMatch(final Object... parameters) {
    return InterfaceRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.InterfaceRequirement_source (visibility: PUBLIC, simpleName: InterfaceRequirement_source, identifier: sysml.InterfaceRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.InterfaceRequirement_source (visibility: PUBLIC, simpleName: InterfaceRequirement_source, identifier: sysml.InterfaceRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceRequirement_source INSTANCE = new InterfaceRequirement_source();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceRequirement_source.GeneratedPQuery INSTANCE = new GeneratedPQuery();
