...
public final class Requirement_SatisfiedBy extends BaseGeneratedEMFQuerySpecification<Requirement_SatisfiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Requirement_SatisfiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Requirement_SatisfiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return Requirement_SatisfiedBy.Match.parameterNames;
    }
    ...
    @Override
    public Requirement_SatisfiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Requirement_SatisfiedBy.Match)) {
          Requirement_SatisfiedBy.Match other = (Requirement_SatisfiedBy.Match) obj;
    ...
    @Override
    public Requirement_SatisfiedBy specification() {
     ...
     * 
     */
    public static Requirement_SatisfiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static Requirement_SatisfiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static Requirement_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Requirement_SatisfiedBy.Match {
    ...
    private static final class Immutable extends Requirement_SatisfiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Requirement_SatisfiedBy pattern,
   ...
   * 
   * @see Match
   * @see Requirement_SatisfiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<Requirement_SatisfiedBy.Match> {
    /**
     ...
     * 
     */
    public static Requirement_SatisfiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Requirement_SatisfiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Requirement_SatisfiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<Requirement_SatisfiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<Requirement_SatisfiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<Requirement_SatisfiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super Requirement_SatisfiedBy.Match> processor) {
     ...
     * 
     */
    public Requirement_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return Requirement_SatisfiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Requirement_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Requirement_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final Requirement_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final Requirement_SatisfiedBy.Match partialMatch) {
    ...
    @Override
    protected Requirement_SatisfiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return Requirement_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected Requirement_SatisfiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return Requirement_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Requirement_SatisfiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Requirement_SatisfiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Requirement_SatisfiedBy.Matcher> querySpecification() {
      return Requirement_SatisfiedBy.instance();
    }
  }
  
  private Requirement_SatisfiedBy() {
   ...
   * 
   */
  public static Requirement_SatisfiedBy instance() {
    try{
  ...
  @Override
  protected Requirement_SatisfiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return Requirement_SatisfiedBy.Matcher.on(engine);
  }
  
  @Override
  public Requirement_SatisfiedBy.Matcher instantiate() {
    return Requirement_SatisfiedBy.Matcher.create();
  }
  
  @Override
  public Requirement_SatisfiedBy.Match newEmptyMatch() {
    return Requirement_SatisfiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public Requirement_SatisfiedBy.Match newMatch(final Object... parameters) {
    return Requirement_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Requirement_SatisfiedBy (visibility: PUBLIC, simpleName: Requirement_SatisfiedBy, identifier: sysml.Requirement_SatisfiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Requirement_SatisfiedBy (visibility: PUBLIC, simpleName: Requirement_SatisfiedBy, identifier: sysml.Requirement_SatisfiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Requirement_SatisfiedBy INSTANCE = new Requirement_SatisfiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Requirement_SatisfiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
