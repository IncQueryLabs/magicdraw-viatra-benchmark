...
public final class UsabilityRequirement_Derived extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.usabilityRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.usabilityRequirement_Derived";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.usabilityRequirement_Derived pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.UsabilityRequirement_Derived (visibility: PUBLIC, simpleName: UsabilityRequirement_Derived, identifier: sysml.UsabilityRequirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.UsabilityRequirement_Derived (visibility: PUBLIC, simpleName: UsabilityRequirement_Derived, identifier: sysml.UsabilityRequirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
