...
public final class Uniform_min extends BaseGeneratedEMFQuerySpecification<Uniform_min.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Uniform_min pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Uniform_min";
    }
    
    @Override
    public List<String> parameterNames() {
      return Uniform_min.Match.parameterNames;
    }
    ...
    @Override
    public Uniform_min.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Uniform_min.Match)) {
          Uniform_min.Match other = (Uniform_min.Match) obj;
    ...
    @Override
    public Uniform_min specification() {
     ...
     * 
     */
    public static Uniform_min.Match newEmptyMatch() {
     ...
     * 
     */
    public static Uniform_min.Match newMutableMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public static Uniform_min.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Uniform_min.Match {
    ...
    private static final class Immutable extends Uniform_min.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Uniform_min pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Uniform_min.Match> {
    /**
     ...
     * 
     */
    public static Uniform_min.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Uniform_min.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Uniform_min.Matcher.class);
     ...
     * 
     */
    public Collection<Uniform_min.Match> getAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Stream<Uniform_min.Match> streamAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Optional<Uniform_min.Match> getOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec, final Consumer<? super Uniform_min.Match> processor) {
     ...
     * 
     */
    public Uniform_min.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return Uniform_min.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Uniform_min.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Uniform_min.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralReal> streamAllValuesOfvaluespec(final Uniform_min.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralReal> getAllValuesOfvaluespec(final Uniform_min.Match partialMatch) {
    ...
    @Override
    protected Uniform_min.Match tupleToMatch(final Tuple t) {
      try {
          return Uniform_min.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralReal) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Uniform_min.Match arrayToMatch(final Object[] match) {
      try {
          return Uniform_min.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Uniform_min.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Uniform_min.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Uniform_min.Matcher> querySpecification() {
      return Uniform_min.instance();
    }
  }
   ...
   * 
   */
  public static Uniform_min instance() {
    try{
  ...
  @Override
  protected Uniform_min.Matcher instantiate(final ViatraQueryEngine engine) {
    return Uniform_min.Matcher.on(engine);
  }
  
  @Override
  public Uniform_min.Matcher instantiate() {
    return Uniform_min.Matcher.create();
  }
  
  @Override
  public Uniform_min.Match newEmptyMatch() {
    return Uniform_min.Match.newEmptyMatch();
  }
  
  @Override
  public Uniform_min.Match newMatch(final Object... parameters) {
    return Uniform_min.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralReal) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Uniform_min (visibility: PUBLIC, simpleName: Uniform_min, identifier: sysml.Uniform_min, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Uniform_min (visibility: PUBLIC, simpleName: Uniform_min, identifier: sysml.Uniform_min, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Uniform_min INSTANCE = new Uniform_min();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Uniform_min.GeneratedPQuery INSTANCE = new GeneratedPQuery();
