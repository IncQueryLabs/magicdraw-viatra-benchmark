...
public final class View_viewPoint extends BaseGeneratedEMFQuerySpecification<View_viewPoint.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.View_viewPoint pattern,
  ...
  /**
   * Generated pattern matcher API of the sysml.View_viewPoint pattern,
