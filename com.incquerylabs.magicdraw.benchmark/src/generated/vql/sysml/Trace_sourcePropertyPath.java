...
public final class Trace_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<Trace_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Trace_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Trace_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Trace_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Trace_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Trace_sourcePropertyPath.Match)) {
          Trace_sourcePropertyPath.Match other = (Trace_sourcePropertyPath.Match) obj;
    ...
    @Override
    public Trace_sourcePropertyPath specification() {
     ...
     * 
     */
    public static Trace_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Trace_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Trace_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Trace_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends Trace_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Trace_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Trace_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Trace_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Trace_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Trace_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Trace_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Trace_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Trace_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Trace_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Trace_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public Trace_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Trace_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Trace_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Trace_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Trace_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Trace_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected Trace_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Trace_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Trace_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Trace_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Trace_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Trace_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Trace_sourcePropertyPath.Matcher> querySpecification() {
      return Trace_sourcePropertyPath.instance();
    }
  }
  
  private Trace_sourcePropertyPath() {
   ...
   * 
   */
  public static Trace_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected Trace_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Trace_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Trace_sourcePropertyPath.Matcher instantiate() {
    return Trace_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public Trace_sourcePropertyPath.Match newEmptyMatch() {
    return Trace_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Trace_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return Trace_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Trace_sourcePropertyPath (visibility: PUBLIC, simpleName: Trace_sourcePropertyPath, identifier: sysml.Trace_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Trace_sourcePropertyPath (visibility: PUBLIC, simpleName: Trace_sourcePropertyPath, identifier: sysml.Trace_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Trace_sourcePropertyPath INSTANCE = new Trace_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Trace_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Trace(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Trace.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "sourcePropertyPath", valuespec)
