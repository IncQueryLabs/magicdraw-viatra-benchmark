...
public final class ExtendedRequirement_Master extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement_Master";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement_Master pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ExtendedRequirement_Master (visibility: PUBLIC, simpleName: ExtendedRequirement_Master, identifier: sysml.ExtendedRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ExtendedRequirement_Master (visibility: PUBLIC, simpleName: ExtendedRequirement_Master, identifier: sysml.ExtendedRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
