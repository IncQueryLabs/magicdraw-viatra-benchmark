...
public final class Refine_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<Refine_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Refine_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Refine_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Refine_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Refine_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Refine_sourcePropertyPath.Match)) {
          Refine_sourcePropertyPath.Match other = (Refine_sourcePropertyPath.Match) obj;
    ...
    @Override
    public Refine_sourcePropertyPath specification() {
     ...
     * 
     */
    public static Refine_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Refine_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Refine_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Refine_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends Refine_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Refine_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Refine_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Refine_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Refine_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Refine_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Refine_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Refine_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Refine_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Refine_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Refine_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public Refine_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Refine_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Refine_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Refine_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Refine_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Refine_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected Refine_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Refine_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Refine_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Refine_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Refine_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Refine_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Refine_sourcePropertyPath.Matcher> querySpecification() {
      return Refine_sourcePropertyPath.instance();
    }
  }
  
  private Refine_sourcePropertyPath() {
   ...
   * 
   */
  public static Refine_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected Refine_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Refine_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Refine_sourcePropertyPath.Matcher instantiate() {
    return Refine_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public Refine_sourcePropertyPath.Match newEmptyMatch() {
    return Refine_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Refine_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return Refine_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Refine_sourcePropertyPath (visibility: PUBLIC, simpleName: Refine_sourcePropertyPath, identifier: sysml.Refine_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Refine_sourcePropertyPath (visibility: PUBLIC, simpleName: Refine_sourcePropertyPath, identifier: sysml.Refine_sourcePropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Refine_sourcePropertyPath INSTANCE = new Refine_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Refine_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
