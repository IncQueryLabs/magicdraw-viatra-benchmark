...
public final class FlowPort extends BaseGeneratedEMFQuerySpecification<FlowPort.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.FlowPort pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static FlowPort.Match newMutableMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FlowPort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the sysml.FlowPort pattern,
  ...
  public static class Matcher extends BaseMatcher<FlowPort.Match> {
     ...
     * 
     */
    public Collection<FlowPort.Match> getAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FlowPort.Match> streamAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FlowPort.Match> getOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FlowPort.Match> processor) {
     ...
     * 
     */
    public FlowPort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FlowPort.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FlowPort.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FlowPort.Match partialMatch) {
    ...
    protected FlowPort.Match tupleToMatch(final Tuple t) {
      try {
          return FlowPort.Match.newMatch((Port) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected FlowPort.Match arrayToMatch(final Object[] match) {
      try {
          return FlowPort.Match.newMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected FlowPort.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FlowPort.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public FlowPort.Match newMatch(final Object... parameters) {
    return FlowPort.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FlowPort (visibility: PUBLIC, simpleName: FlowPort, identifier: sysml.FlowPort, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FlowPort (visibility: PUBLIC, simpleName: FlowPort, identifier: sysml.FlowPort, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
