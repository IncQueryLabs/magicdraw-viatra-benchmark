...
public final class Unit_symbol extends BaseGeneratedEMFQuerySpecification<Unit_symbol.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Unit_symbol pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Unit_symbol.Match newMutableMatch(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Unit_symbol.Match newMatch(final PackageableElement pElement, final LiteralString pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the sysml.Unit_symbol pattern,
  ...
  public static class Matcher extends BaseMatcher<Unit_symbol.Match> {
     ...
     * 
     */
    public Collection<Unit_symbol.Match> getAllMatches(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Unit_symbol.Match> streamAllMatches(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Unit_symbol.Match> getOneArbitraryMatch(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final LiteralString pValuespec, final Consumer<? super Unit_symbol.Match> processor) {
     ...
     * 
     */
    public Unit_symbol.Match newMatch(final PackageableElement pElement, final LiteralString pValuespec) {
      return Unit_symbol.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Unit_symbol.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Unit_symbol.Match partialMatch) {
    ...
    protected Unit_symbol.Match tupleToMatch(final Tuple t) {
      try {
          return Unit_symbol.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    protected Unit_symbol.Match arrayToMatch(final Object[] match) {
      try {
          return Unit_symbol.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected Unit_symbol.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unit_symbol.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Unit_symbol.Match newMatch(final Object... parameters) {
    return Unit_symbol.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Unit_symbol (visibility: PUBLIC, simpleName: Unit_symbol, identifier: sysml.Unit_symbol, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Unit_symbol (visibility: PUBLIC, simpleName: Unit_symbol, identifier: sysml.Unit_symbol, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
