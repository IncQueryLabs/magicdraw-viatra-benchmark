...
public final class BoundReference extends BaseGeneratedEMFQuerySpecification<BoundReference.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.BoundReference pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.BoundReference";
    }
    
    @Override
    public List<String> parameterNames() {
      return BoundReference.Match.parameterNames;
    }
    ...
    @Override
    public BoundReference.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BoundReference.Match)) {
          BoundReference.Match other = (BoundReference.Match) obj;
    ...
    @Override
    public BoundReference specification() {
     ...
     * 
     */
    public static BoundReference.Match newEmptyMatch() {
     ...
     * 
     */
    public static BoundReference.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static BoundReference.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends BoundReference.Match {
    ...
    private static final class Immutable extends BoundReference.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.BoundReference pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<BoundReference.Match> {
    /**
     ...
     * 
     */
    public static BoundReference.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BoundReference.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BoundReference.Matcher.class);
     ...
     * 
     */
    public Collection<BoundReference.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<BoundReference.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<BoundReference.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super BoundReference.Match> processor) {
     ...
     * 
     */
    public BoundReference.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return BoundReference.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final BoundReference.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final BoundReference.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final BoundReference.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final BoundReference.Match partialMatch) {
    ...
    @Override
    protected BoundReference.Match tupleToMatch(final Tuple t) {
      try {
          return BoundReference.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected BoundReference.Match arrayToMatch(final Object[] match) {
      try {
          return BoundReference.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BoundReference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BoundReference.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BoundReference.Matcher> querySpecification() {
      return BoundReference.instance();
    }
  }
   ...
   * 
   */
  public static BoundReference instance() {
    try{
  ...
  @Override
  protected BoundReference.Matcher instantiate(final ViatraQueryEngine engine) {
    return BoundReference.Matcher.on(engine);
  }
  
  @Override
  public BoundReference.Matcher instantiate() {
    return BoundReference.Matcher.create();
  }
  
  @Override
  public BoundReference.Match newEmptyMatch() {
    return BoundReference.Match.newEmptyMatch();
  }
  
  @Override
  public BoundReference.Match newMatch(final Object... parameters) {
    return BoundReference.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BoundReference (visibility: PUBLIC, simpleName: BoundReference, identifier: sysml.BoundReference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BoundReference (visibility: PUBLIC, simpleName: BoundReference, identifier: sysml.BoundReference, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BoundReference INSTANCE = new BoundReference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BoundReference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "BoundReference");
