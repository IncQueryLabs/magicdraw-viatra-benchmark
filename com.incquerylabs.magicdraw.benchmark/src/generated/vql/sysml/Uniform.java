...
public final class Uniform extends BaseGeneratedEMFQuerySpecification<Uniform.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Uniform pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Uniform";
    }
    
    @Override
    public List<String> parameterNames() {
      return Uniform.Match.parameterNames;
    }
    ...
    @Override
    public Uniform.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Uniform.Match)) {
          Uniform.Match other = (Uniform.Match) obj;
     ...
     * 
     */
    public static Uniform.Match newEmptyMatch() {
     ...
     * 
     */
    public static Uniform.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Uniform.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Uniform.Match {
    ...
    private static final class Immutable extends Uniform.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Uniform pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Uniform.Match> {
    /**
     ...
     * 
     */
    public static Uniform.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Uniform.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Uniform.Matcher.class);
     ...
     * 
     */
    public Collection<Uniform.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Uniform.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Uniform.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Uniform.Match> processor) {
     ...
     * 
     */
    public Uniform.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Uniform.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Uniform.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Uniform.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Uniform.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Uniform.Match partialMatch) {
    ...
    @Override
    protected Uniform.Match tupleToMatch(final Tuple t) {
      try {
          return Uniform.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Uniform.Match arrayToMatch(final Object[] match) {
      try {
          return Uniform.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Uniform.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Uniform.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Uniform.Matcher> querySpecification() {
      return Uniform.instance();
    }
  }
  ...
  @Override
  protected Uniform.Matcher instantiate(final ViatraQueryEngine engine) {
    return Uniform.Matcher.on(engine);
  }
  
  @Override
  public Uniform.Matcher instantiate() {
    return Uniform.Matcher.create();
  }
  
  @Override
  public Uniform.Match newEmptyMatch() {
    return Uniform.Match.newEmptyMatch();
  }
  
  @Override
  public Uniform.Match newMatch(final Object... parameters) {
    return Uniform.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Uniform (visibility: PUBLIC, simpleName: Uniform, identifier: sysml.Uniform, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Uniform (visibility: PUBLIC, simpleName: Uniform, identifier: sysml.Uniform, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Uniform.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Uniform");
