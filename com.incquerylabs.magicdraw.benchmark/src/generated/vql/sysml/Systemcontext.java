...
public final class Systemcontext extends BaseGeneratedEMFQuerySpecification<Systemcontext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Systemcontext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Systemcontext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Systemcontext.Match.parameterNames;
    }
    ...
    @Override
    public Systemcontext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Systemcontext.Match)) {
          Systemcontext.Match other = (Systemcontext.Match) obj;
    ...
    @Override
    public Systemcontext specification() {
     ...
     * 
     */
    public static Systemcontext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Systemcontext.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Systemcontext.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Systemcontext.Match {
    ...
    private static final class Immutable extends Systemcontext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Systemcontext pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Systemcontext.Match> {
    /**
     ...
     * 
     */
    public static Systemcontext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Systemcontext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Systemcontext.Matcher.class);
     ...
     * 
     */
    public Collection<Systemcontext.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Systemcontext.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Systemcontext.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Systemcontext.Match> processor) {
     ...
     * 
     */
    public Systemcontext.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Systemcontext.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Systemcontext.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Systemcontext.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Systemcontext.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Systemcontext.Match partialMatch) {
    ...
    @Override
    protected Systemcontext.Match tupleToMatch(final Tuple t) {
      try {
          return Systemcontext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Systemcontext.Match arrayToMatch(final Object[] match) {
      try {
          return Systemcontext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Systemcontext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Systemcontext.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Systemcontext.Matcher> querySpecification() {
      return Systemcontext.instance();
    }
  }
  ...
  @Override
  protected Systemcontext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Systemcontext.Matcher.on(engine);
  }
  
  @Override
  public Systemcontext.Matcher instantiate() {
    return Systemcontext.Matcher.create();
  }
  
  @Override
  public Systemcontext.Match newEmptyMatch() {
    return Systemcontext.Match.newEmptyMatch();
  }
  
  @Override
  public Systemcontext.Match newMatch(final Object... parameters) {
    return Systemcontext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Systemcontext (visibility: PUBLIC, simpleName: Systemcontext, identifier: sysml.Systemcontext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Systemcontext (visibility: PUBLIC, simpleName: Systemcontext, identifier: sysml.Systemcontext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Systemcontext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "System context");
