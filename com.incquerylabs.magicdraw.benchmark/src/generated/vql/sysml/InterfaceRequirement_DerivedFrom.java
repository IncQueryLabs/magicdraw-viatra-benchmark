...
public final class InterfaceRequirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.interfaceRequirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.interfaceRequirement_DerivedFrom";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.interfaceRequirement_DerivedFrom pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.InterfaceRequirement_DerivedFrom (visibility: PUBLIC, simpleName: InterfaceRequirement_DerivedFrom, identifier: sysml.InterfaceRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.InterfaceRequirement_DerivedFrom (visibility: PUBLIC, simpleName: InterfaceRequirement_DerivedFrom, identifier: sysml.InterfaceRequirement_DerivedFrom, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
