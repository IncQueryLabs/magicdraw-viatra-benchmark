...
public final class DesignConstraint_SatisfiedBy extends BaseGeneratedEMFQuerySpecification<DesignConstraint_SatisfiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.designConstraint_SatisfiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.designConstraint_SatisfiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint_SatisfiedBy.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint_SatisfiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint_SatisfiedBy.Match)) {
          DesignConstraint_SatisfiedBy.Match other = (DesignConstraint_SatisfiedBy.Match) obj;
    ...
    @Override
    public DesignConstraint_SatisfiedBy specification() {
     ...
     * 
     */
    public static DesignConstraint_SatisfiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint_SatisfiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static DesignConstraint_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DesignConstraint_SatisfiedBy.Match {
    ...
    private static final class Immutable extends DesignConstraint_SatisfiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.designConstraint_SatisfiedBy pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint_SatisfiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint_SatisfiedBy.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint_SatisfiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint_SatisfiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint_SatisfiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint_SatisfiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<DesignConstraint_SatisfiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<DesignConstraint_SatisfiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super DesignConstraint_SatisfiedBy.Match> processor) {
     ...
     * 
     */
    public DesignConstraint_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return DesignConstraint_SatisfiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DesignConstraint_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DesignConstraint_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final DesignConstraint_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final DesignConstraint_SatisfiedBy.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint_SatisfiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected DesignConstraint_SatisfiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint_SatisfiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint_SatisfiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint_SatisfiedBy.Matcher> querySpecification() {
      return DesignConstraint_SatisfiedBy.instance();
    }
  }
  
  private DesignConstraint_SatisfiedBy() {
   ...
   * 
   */
  public static DesignConstraint_SatisfiedBy instance() {
    try{
  ...
  @Override
  protected DesignConstraint_SatisfiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint_SatisfiedBy.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint_SatisfiedBy.Matcher instantiate() {
    return DesignConstraint_SatisfiedBy.Matcher.create();
  }
  
  @Override
  public DesignConstraint_SatisfiedBy.Match newEmptyMatch() {
    return DesignConstraint_SatisfiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint_SatisfiedBy.Match newMatch(final Object... parameters) {
    return DesignConstraint_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DesignConstraint_SatisfiedBy (visibility: PUBLIC, simpleName: DesignConstraint_SatisfiedBy, identifier: sysml.DesignConstraint_SatisfiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DesignConstraint_SatisfiedBy (visibility: PUBLIC, simpleName: DesignConstraint_SatisfiedBy, identifier: sysml.DesignConstraint_SatisfiedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesignConstraint_SatisfiedBy INSTANCE = new DesignConstraint_SatisfiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint_SatisfiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
