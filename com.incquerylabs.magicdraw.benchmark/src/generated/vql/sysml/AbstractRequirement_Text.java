...
public final class AbstractRequirement_Text extends BaseGeneratedEMFQuerySpecification<AbstractRequirement_Text.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.AbstractRequirement_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.AbstractRequirement_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return AbstractRequirement_Text.Match.parameterNames;
    }
    ...
    @Override
    public AbstractRequirement_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof AbstractRequirement_Text.Match)) {
          AbstractRequirement_Text.Match other = (AbstractRequirement_Text.Match) obj;
    ...
    @Override
    public AbstractRequirement_Text specification() {
     ...
     * 
     */
    public static AbstractRequirement_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static AbstractRequirement_Text.Match newMutableMatch(final NamedElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static AbstractRequirement_Text.Match newMatch(final NamedElement pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends AbstractRequirement_Text.Match {
    ...
    private static final class Immutable extends AbstractRequirement_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.AbstractRequirement_Text pattern,
   ...
   * 
   * @see Match
   * @see AbstractRequirement_Text
   * 
   */
  public static class Matcher extends BaseMatcher<AbstractRequirement_Text.Match> {
    /**
     ...
     * 
     */
    public static AbstractRequirement_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static AbstractRequirement_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(AbstractRequirement_Text.Matcher.class);
     ...
     * 
     */
    public Collection<AbstractRequirement_Text.Match> getAllMatches(final NamedElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<AbstractRequirement_Text.Match> streamAllMatches(final NamedElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<AbstractRequirement_Text.Match> getOneArbitraryMatch(final NamedElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final LiteralString pValuespec, final Consumer<? super AbstractRequirement_Text.Match> processor) {
     ...
     * 
     */
    public AbstractRequirement_Text.Match newMatch(final NamedElement pElement, final LiteralString pValuespec) {
      return AbstractRequirement_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfelement(final AbstractRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfelement(final AbstractRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final AbstractRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final AbstractRequirement_Text.Match partialMatch) {
    ...
    @Override
    protected AbstractRequirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return AbstractRequirement_Text.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected AbstractRequirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return AbstractRequirement_Text.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected AbstractRequirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AbstractRequirement_Text.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<AbstractRequirement_Text.Matcher> querySpecification() {
      return AbstractRequirement_Text.instance();
    }
  }
  
  private AbstractRequirement_Text() {
   ...
   * 
   */
  public static AbstractRequirement_Text instance() {
    try{
  ...
  @Override
  protected AbstractRequirement_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return AbstractRequirement_Text.Matcher.on(engine);
  }
  
  @Override
  public AbstractRequirement_Text.Matcher instantiate() {
    return AbstractRequirement_Text.Matcher.create();
  }
  
  @Override
  public AbstractRequirement_Text.Match newEmptyMatch() {
    return AbstractRequirement_Text.Match.newEmptyMatch();
  }
  
  @Override
  public AbstractRequirement_Text.Match newMatch(final Object... parameters) {
    return AbstractRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.AbstractRequirement_Text (visibility: PUBLIC, simpleName: AbstractRequirement_Text, identifier: sysml.AbstractRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.AbstractRequirement_Text (visibility: PUBLIC, simpleName: AbstractRequirement_Text, identifier: sysml.AbstractRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final AbstractRequirement_Text INSTANCE = new AbstractRequirement_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final AbstractRequirement_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
