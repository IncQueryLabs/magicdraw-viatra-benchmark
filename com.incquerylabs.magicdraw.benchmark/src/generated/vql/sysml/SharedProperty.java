...
public final class SharedProperty extends BaseGeneratedEMFQuerySpecification<SharedProperty.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.SharedProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.SharedProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return SharedProperty.Match.parameterNames;
    }
    ...
    @Override
    public SharedProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SharedProperty.Match)) {
          SharedProperty.Match other = (SharedProperty.Match) obj;
    ...
    @Override
    public SharedProperty specification() {
     ...
     * 
     */
    public static SharedProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static SharedProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SharedProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SharedProperty.Match {
    ...
    private static final class Immutable extends SharedProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.SharedProperty pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<SharedProperty.Match> {
    /**
     ...
     * 
     */
    public static SharedProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SharedProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SharedProperty.Matcher.class);
     ...
     * 
     */
    public Collection<SharedProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SharedProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SharedProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SharedProperty.Match> processor) {
     ...
     * 
     */
    public SharedProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SharedProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final SharedProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final SharedProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SharedProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SharedProperty.Match partialMatch) {
    ...
    @Override
    protected SharedProperty.Match tupleToMatch(final Tuple t) {
      try {
          return SharedProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SharedProperty.Match arrayToMatch(final Object[] match) {
      try {
          return SharedProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SharedProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SharedProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SharedProperty.Matcher> querySpecification() {
      return SharedProperty.instance();
    }
  }
   ...
   * 
   */
  public static SharedProperty instance() {
    try{
  ...
  @Override
  protected SharedProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return SharedProperty.Matcher.on(engine);
  }
  
  @Override
  public SharedProperty.Matcher instantiate() {
    return SharedProperty.Matcher.create();
  }
  
  @Override
  public SharedProperty.Match newEmptyMatch() {
    return SharedProperty.Match.newEmptyMatch();
  }
  
  @Override
  public SharedProperty.Match newMatch(final Object... parameters) {
    return SharedProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.SharedProperty (visibility: PUBLIC, simpleName: SharedProperty, identifier: sysml.SharedProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.SharedProperty (visibility: PUBLIC, simpleName: SharedProperty, identifier: sysml.SharedProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SharedProperty INSTANCE = new SharedProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SharedProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "SharedProperty");
