...
public final class AdjunctProperty extends BaseGeneratedEMFQuerySpecification<AdjunctProperty.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.AdjunctProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public List<String> parameterNames() {
      return AdjunctProperty.Match.parameterNames;
    }
    ...
    @Override
    public AdjunctProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof AdjunctProperty.Match)) {
          AdjunctProperty.Match other = (AdjunctProperty.Match) obj;
    ...
    @Override
    public AdjunctProperty specification() {
     ...
     * 
     */
    public static AdjunctProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static AdjunctProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static AdjunctProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends AdjunctProperty.Match {
    ...
    private static final class Immutable extends AdjunctProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.AdjunctProperty pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<AdjunctProperty.Match> {
    /**
     ...
     * 
     */
    public static AdjunctProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static AdjunctProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(AdjunctProperty.Matcher.class);
     ...
     * 
     */
    public Collection<AdjunctProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<AdjunctProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<AdjunctProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super AdjunctProperty.Match> processor) {
     ...
     * 
     */
    public AdjunctProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return AdjunctProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final AdjunctProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final AdjunctProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final AdjunctProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final AdjunctProperty.Match partialMatch) {
    ...
    @Override
    protected AdjunctProperty.Match tupleToMatch(final Tuple t) {
      try {
          return AdjunctProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected AdjunctProperty.Match arrayToMatch(final Object[] match) {
      try {
          return AdjunctProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected AdjunctProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AdjunctProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<AdjunctProperty.Matcher> querySpecification() {
      return AdjunctProperty.instance();
    }
  }
  
  private AdjunctProperty() {
   ...
   * 
   */
  public static AdjunctProperty instance() {
    try{
  ...
  @Override
  protected AdjunctProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return AdjunctProperty.Matcher.on(engine);
  }
  
  @Override
  public AdjunctProperty.Matcher instantiate() {
    return AdjunctProperty.Matcher.create();
  }
  
  @Override
  public AdjunctProperty.Match newEmptyMatch() {
    return AdjunctProperty.Match.newEmptyMatch();
  }
  
  @Override
  public AdjunctProperty.Match newMatch(final Object... parameters) {
    return AdjunctProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.AdjunctProperty (visibility: PUBLIC, simpleName: AdjunctProperty, identifier: sysml.AdjunctProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.AdjunctProperty (visibility: PUBLIC, simpleName: AdjunctProperty, identifier: sysml.AdjunctProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final AdjunctProperty INSTANCE = new AdjunctProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final AdjunctProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "AdjunctProperty");
