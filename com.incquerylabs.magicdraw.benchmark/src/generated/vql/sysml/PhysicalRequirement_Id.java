...
public final class PhysicalRequirement_Id extends BaseGeneratedEMFQuerySpecification<PhysicalRequirement_Id.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.physicalRequirement_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.physicalRequirement_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalRequirement_Id.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalRequirement_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalRequirement_Id.Match)) {
          PhysicalRequirement_Id.Match other = (PhysicalRequirement_Id.Match) obj;
    ...
    @Override
    public PhysicalRequirement_Id specification() {
     ...
     * 
     */
    public static PhysicalRequirement_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalRequirement_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static PhysicalRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends PhysicalRequirement_Id.Match {
    ...
    private static final class Immutable extends PhysicalRequirement_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.physicalRequirement_Id pattern,
   ...
   * 
   * @see Match
   * @see PhysicalRequirement_Id
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalRequirement_Id.Match> {
    /**
     ...
     * 
     */
    public static PhysicalRequirement_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalRequirement_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalRequirement_Id.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalRequirement_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<PhysicalRequirement_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<PhysicalRequirement_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super PhysicalRequirement_Id.Match> processor) {
     ...
     * 
     */
    public PhysicalRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return PhysicalRequirement_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final PhysicalRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final PhysicalRequirement_Id.Match partialMatch) {
    ...
    @Override
    protected PhysicalRequirement_Id.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected PhysicalRequirement_Id.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalRequirement_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalRequirement_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalRequirement_Id.Matcher> querySpecification() {
      return PhysicalRequirement_Id.instance();
    }
  }
  
  private PhysicalRequirement_Id() {
   ...
   * 
   */
  public static PhysicalRequirement_Id instance() {
    try{
  ...
  @Override
  protected PhysicalRequirement_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalRequirement_Id.Matcher.on(engine);
  }
  
  @Override
  public PhysicalRequirement_Id.Matcher instantiate() {
    return PhysicalRequirement_Id.Matcher.create();
  }
  
  @Override
  public PhysicalRequirement_Id.Match newEmptyMatch() {
    return PhysicalRequirement_Id.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalRequirement_Id.Match newMatch(final Object... parameters) {
    return PhysicalRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PhysicalRequirement_Id (visibility: PUBLIC, simpleName: PhysicalRequirement_Id, identifier: sysml.PhysicalRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PhysicalRequirement_Id (visibility: PUBLIC, simpleName: PhysicalRequirement_Id, identifier: sysml.PhysicalRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalRequirement_Id INSTANCE = new PhysicalRequirement_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalRequirement_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
