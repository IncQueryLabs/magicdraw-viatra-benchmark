...
public final class PartProperty extends BaseGeneratedEMFQuerySpecification<PartProperty.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.PartProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.PartProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return PartProperty.Match.parameterNames;
    }
    ...
    @Override
    public PartProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PartProperty.Match)) {
          PartProperty.Match other = (PartProperty.Match) obj;
    ...
    @Override
    public PartProperty specification() {
     ...
     * 
     */
    public static PartProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static PartProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static PartProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends PartProperty.Match {
    ...
    private static final class Immutable extends PartProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.PartProperty pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<PartProperty.Match> {
    /**
     ...
     * 
     */
    public static PartProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PartProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PartProperty.Matcher.class);
     ...
     * 
     */
    public Collection<PartProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<PartProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<PartProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super PartProperty.Match> processor) {
     ...
     * 
     */
    public PartProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return PartProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final PartProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final PartProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final PartProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final PartProperty.Match partialMatch) {
    ...
    @Override
    protected PartProperty.Match tupleToMatch(final Tuple t) {
      try {
          return PartProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected PartProperty.Match arrayToMatch(final Object[] match) {
      try {
          return PartProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PartProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PartProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PartProperty.Matcher> querySpecification() {
      return PartProperty.instance();
    }
  }
   ...
   * 
   */
  public static PartProperty instance() {
    try{
  ...
  @Override
  protected PartProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return PartProperty.Matcher.on(engine);
  }
  
  @Override
  public PartProperty.Matcher instantiate() {
    return PartProperty.Matcher.create();
  }
  
  @Override
  public PartProperty.Match newEmptyMatch() {
    return PartProperty.Match.newEmptyMatch();
  }
  
  @Override
  public PartProperty.Match newMatch(final Object... parameters) {
    return PartProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PartProperty (visibility: PUBLIC, simpleName: PartProperty, identifier: sysml.PartProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PartProperty (visibility: PUBLIC, simpleName: PartProperty, identifier: sysml.PartProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PartProperty INSTANCE = new PartProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PartProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "PartProperty");
