...
public final class Software extends BaseGeneratedEMFQuerySpecification<Software.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Software pattern,
  ...
  /**
   * Generated pattern matcher API of the sysml.Software pattern,
  ...
  public static class Matcher extends BaseMatcher<Software.Match> {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Software.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Software.Match partialMatch) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Software (visibility: PUBLIC, simpleName: Software, identifier: sysml.Software, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Software (visibility: PUBLIC, simpleName: Software, identifier: sysml.Software, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
