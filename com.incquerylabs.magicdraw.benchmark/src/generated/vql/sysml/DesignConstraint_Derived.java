...
public final class DesignConstraint_Derived extends BaseGeneratedEMFQuerySpecification<DesignConstraint_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.designConstraint_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.designConstraint_Derived";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.designConstraint_Derived pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DesignConstraint_Derived (visibility: PUBLIC, simpleName: DesignConstraint_Derived, identifier: sysml.DesignConstraint_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DesignConstraint_Derived (visibility: PUBLIC, simpleName: DesignConstraint_Derived, identifier: sysml.DesignConstraint_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
