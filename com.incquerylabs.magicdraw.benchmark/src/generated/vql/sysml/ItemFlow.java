...
public final class ItemFlow extends BaseGeneratedEMFQuerySpecification<ItemFlow.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ItemFlow pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.ItemFlow";
    }
    
    @Override
    public List<String> parameterNames() {
      return ItemFlow.Match.parameterNames;
    }
    ...
    @Override
    public ItemFlow.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ItemFlow.Match)) {
          ItemFlow.Match other = (ItemFlow.Match) obj;
     ...
     * 
     */
    public static ItemFlow.Match newEmptyMatch() {
     ...
     * 
     */
    public static ItemFlow.Match newMutableMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ItemFlow.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ItemFlow.Match {
    ...
    private static final class Immutable extends ItemFlow.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.ItemFlow pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ItemFlow.Match> {
    /**
     ...
     * 
     */
    public static ItemFlow.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ItemFlow.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ItemFlow.Matcher.class);
     ...
     * 
     */
    public Collection<ItemFlow.Match> getAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ItemFlow.Match> streamAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ItemFlow.Match> getOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ItemFlow.Match> processor) {
     ...
     * 
     */
    public ItemFlow.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ItemFlow.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final ItemFlow.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final ItemFlow.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ItemFlow.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ItemFlow.Match partialMatch) {
    ...
    @Override
    protected ItemFlow.Match tupleToMatch(final Tuple t) {
      try {
          return ItemFlow.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ItemFlow.Match arrayToMatch(final Object[] match) {
      try {
          return ItemFlow.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ItemFlow.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ItemFlow.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ItemFlow.Matcher> querySpecification() {
      return ItemFlow.instance();
    }
  }
   ...
   * 
   */
  public static ItemFlow instance() {
    try{
  ...
  @Override
  protected ItemFlow.Matcher instantiate(final ViatraQueryEngine engine) {
    return ItemFlow.Matcher.on(engine);
  }
  
  @Override
  public ItemFlow.Matcher instantiate() {
    return ItemFlow.Matcher.create();
  }
  
  @Override
  public ItemFlow.Match newEmptyMatch() {
    return ItemFlow.Match.newEmptyMatch();
  }
  
  @Override
  public ItemFlow.Match newMatch(final Object... parameters) {
    return ItemFlow.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ItemFlow (visibility: PUBLIC, simpleName: ItemFlow, identifier: sysml.ItemFlow, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ItemFlow (visibility: PUBLIC, simpleName: ItemFlow, identifier: sysml.ItemFlow, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ItemFlow INSTANCE = new ItemFlow();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ItemFlow.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ItemFlow");
