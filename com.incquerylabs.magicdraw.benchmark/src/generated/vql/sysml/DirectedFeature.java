...
public final class DirectedFeature extends BaseGeneratedEMFQuerySpecification<DirectedFeature.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.DirectedFeature pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    public List<String> parameterNames() {
      return DirectedFeature.Match.parameterNames;
    }
    ...
    @Override
    public DirectedFeature.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DirectedFeature.Match)) {
          DirectedFeature.Match other = (DirectedFeature.Match) obj;
    ...
    @Override
    public DirectedFeature specification() {
     ...
     * 
     */
    public static DirectedFeature.Match newEmptyMatch() {
     ...
     * 
     */
    public static DirectedFeature.Match newMutableMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static DirectedFeature.Match newMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends DirectedFeature.Match {
      Mutable(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    private static final class Immutable extends DirectedFeature.Match {
      Immutable(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
        super(pElement, pDomainStereotypeInstance);
      }
  ...
  /**
   * Generated pattern matcher API of the sysml.DirectedFeature pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<DirectedFeature.Match> {
    /**
     ...
     * 
     */
    public static DirectedFeature.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DirectedFeature.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DirectedFeature.Matcher.class);
     ...
     * 
     */
    public Collection<DirectedFeature.Match> getAllMatches(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<DirectedFeature.Match> streamAllMatches(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<DirectedFeature.Match> getOneArbitraryMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean hasMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public int countMatches(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super DirectedFeature.Match> processor) {
     ...
     * 
     */
    public DirectedFeature.Match newMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return DirectedFeature.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Feature> streamAllValuesOfelement(final DirectedFeature.Match partialMatch) {
     ...
     * 
     */
    public Stream<Feature> streamAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Set<Feature> getAllValuesOfelement(final DirectedFeature.Match partialMatch) {
     ...
     * 
     */
    public Set<Feature> getAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final DirectedFeature.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Feature pElement) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final DirectedFeature.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Feature pElement) {
      return rawStreamAllValuesOfdomainStereotypeInstance(new Object[]{pElement, null}).collect(Collectors.toSet());
    }
    
    @Override
    protected DirectedFeature.Match tupleToMatch(final Tuple t) {
      try {
          return DirectedFeature.Match.newMatch((Feature) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected DirectedFeature.Match arrayToMatch(final Object[] match) {
      try {
          return DirectedFeature.Match.newMatch((Feature) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DirectedFeature.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DirectedFeature.Match.newMutableMatch((Feature) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DirectedFeature.Matcher> querySpecification() {
      return DirectedFeature.instance();
    }
  }
  
  private DirectedFeature() {
   ...
   * 
   */
  public static DirectedFeature instance() {
    try{
  ...
  @Override
  protected DirectedFeature.Matcher instantiate(final ViatraQueryEngine engine) {
    return DirectedFeature.Matcher.on(engine);
  }
  
  @Override
  public DirectedFeature.Matcher instantiate() {
    return DirectedFeature.Matcher.create();
  }
  
  @Override
  public DirectedFeature.Match newEmptyMatch() {
    return DirectedFeature.Match.newEmptyMatch();
  }
  
  @Override
  public DirectedFeature.Match newMatch(final Object... parameters) {
    return DirectedFeature.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Feature) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DirectedFeature (visibility: PUBLIC, simpleName: DirectedFeature, identifier: sysml.DirectedFeature, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DirectedFeature (visibility: PUBLIC, simpleName: DirectedFeature, identifier: sysml.DirectedFeature, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DirectedFeature INSTANCE = new DirectedFeature();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DirectedFeature.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "DirectedFeature");
