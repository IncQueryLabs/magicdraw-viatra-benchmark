...
public final class Stakeholder extends BaseGeneratedEMFQuerySpecification<Stakeholder.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Stakeholder pattern,
  ...
  /**
   * Generated pattern matcher API of the sysml.Stakeholder pattern,
  ...
  public static class Matcher extends BaseMatcher<Stakeholder.Match> {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Stakeholder.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Stakeholder.Match partialMatch) {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Stakeholder (visibility: PUBLIC, simpleName: Stakeholder, identifier: sysml.Stakeholder, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Stakeholder (visibility: PUBLIC, simpleName: Stakeholder, identifier: sysml.Stakeholder, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
