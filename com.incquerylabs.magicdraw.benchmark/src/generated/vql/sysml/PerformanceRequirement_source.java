...
public final class PerformanceRequirement_source extends BaseGeneratedEMFQuerySpecification<PerformanceRequirement_source.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.performanceRequirement_source pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.performanceRequirement_source";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformanceRequirement_source.Match.parameterNames;
    }
    ...
    @Override
    public PerformanceRequirement_source.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformanceRequirement_source.Match)) {
          PerformanceRequirement_source.Match other = (PerformanceRequirement_source.Match) obj;
    ...
    @Override
    public PerformanceRequirement_source specification() {
     ...
     * 
     */
    public static PerformanceRequirement_source.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformanceRequirement_source.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static PerformanceRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends PerformanceRequirement_source.Match {
    ...
    private static final class Immutable extends PerformanceRequirement_source.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.performanceRequirement_source pattern,
   ...
   * 
   * @see Match
   * @see PerformanceRequirement_source
   * 
   */
  public static class Matcher extends BaseMatcher<PerformanceRequirement_source.Match> {
    /**
     ...
     * 
     */
    public static PerformanceRequirement_source.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformanceRequirement_source.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformanceRequirement_source.Matcher.class);
     ...
     * 
     */
    public Collection<PerformanceRequirement_source.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<PerformanceRequirement_source.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<PerformanceRequirement_source.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super PerformanceRequirement_source.Match> processor) {
     ...
     * 
     */
    public PerformanceRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return PerformanceRequirement_source.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PerformanceRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PerformanceRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final PerformanceRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final PerformanceRequirement_source.Match partialMatch) {
    ...
    @Override
    protected PerformanceRequirement_source.Match tupleToMatch(final Tuple t) {
      try {
          return PerformanceRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected PerformanceRequirement_source.Match arrayToMatch(final Object[] match) {
      try {
          return PerformanceRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformanceRequirement_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformanceRequirement_source.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformanceRequirement_source.Matcher> querySpecification() {
      return PerformanceRequirement_source.instance();
    }
  }
  
  private PerformanceRequirement_source() {
   ...
   * 
   */
  public static PerformanceRequirement_source instance() {
    try{
  ...
  @Override
  protected PerformanceRequirement_source.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformanceRequirement_source.Matcher.on(engine);
  }
  
  @Override
  public PerformanceRequirement_source.Matcher instantiate() {
    return PerformanceRequirement_source.Matcher.create();
  }
  
  @Override
  public PerformanceRequirement_source.Match newEmptyMatch() {
    return PerformanceRequirement_source.Match.newEmptyMatch();
  }
  
  @Override
  public PerformanceRequirement_source.Match newMatch(final Object... parameters) {
    return PerformanceRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PerformanceRequirement_source (visibility: PUBLIC, simpleName: PerformanceRequirement_source, identifier: sysml.PerformanceRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PerformanceRequirement_source (visibility: PUBLIC, simpleName: PerformanceRequirement_source, identifier: sysml.PerformanceRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformanceRequirement_source INSTANCE = new PerformanceRequirement_source();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformanceRequirement_source.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "source");
