...
public final class FlowSpecification extends BaseGeneratedEMFQuerySpecification<FlowSpecification.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.FlowSpecification pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    public String patternName() {
      return "sysml.FlowSpecification";
    }
     ...
     * 
     */
    public static FlowSpecification.Match newMutableMatch(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FlowSpecification.Match newMatch(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    private static final class Mutable extends FlowSpecification.Match {
      Mutable(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    private static final class Immutable extends FlowSpecification.Match {
      Immutable(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
        super(pElement, pDomainStereotypeInstance);
      }
  ...
  /**
   * Generated pattern matcher API of the sysml.FlowSpecification pattern,
  ...
  public static class Matcher extends BaseMatcher<FlowSpecification.Match> {
     ...
     * 
     */
    public Collection<FlowSpecification.Match> getAllMatches(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FlowSpecification.Match> streamAllMatches(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FlowSpecification.Match> getOneArbitraryMatch(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean hasMatch(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public int countMatches(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FlowSpecification.Match> processor) {
     ...
     * 
     */
    public FlowSpecification.Match newMatch(final Interface pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FlowSpecification.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Interface> streamAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Set<Interface> getAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FlowSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Interface pElement) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FlowSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Interface pElement) {
    ...
    protected FlowSpecification.Match tupleToMatch(final Tuple t) {
      try {
          return FlowSpecification.Match.newMatch((Interface) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected FlowSpecification.Match arrayToMatch(final Object[] match) {
      try {
          return FlowSpecification.Match.newMatch((Interface) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected FlowSpecification.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FlowSpecification.Match.newMutableMatch((Interface) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public FlowSpecification.Match newMatch(final Object... parameters) {
    return FlowSpecification.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdinterfaces.Interface) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FlowSpecification (visibility: PUBLIC, simpleName: FlowSpecification, identifier: sysml.FlowSpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FlowSpecification (visibility: PUBLIC, simpleName: FlowSpecification, identifier: sysml.FlowSpecification, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_element = new PParameter("element", "com.nomagic.uml2.ext.magicdraw.classes.mdinterfaces.Interface", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.nomagic.com/magicdraw/UML/2.5.1", "Interface")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_element), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "Interface")));
