...
public final class ContextSpecificValuesHolder extends BaseGeneratedEMFQuerySpecification<ContextSpecificValuesHolder.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.contextSpecificValuesHolder pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.contextSpecificValuesHolder";
    }
    
    @Override
    public List<String> parameterNames() {
      return ContextSpecificValuesHolder.Match.parameterNames;
    }
    ...
    @Override
    public ContextSpecificValuesHolder.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ContextSpecificValuesHolder.Match)) {
          ContextSpecificValuesHolder.Match other = (ContextSpecificValuesHolder.Match) obj;
    ...
    @Override
    public ContextSpecificValuesHolder specification() {
     ...
     * 
     */
    public static ContextSpecificValuesHolder.Match newEmptyMatch() {
     ...
     * 
     */
    public static ContextSpecificValuesHolder.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ContextSpecificValuesHolder.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ContextSpecificValuesHolder.Match {
    ...
    private static final class Immutable extends ContextSpecificValuesHolder.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.contextSpecificValuesHolder pattern,
   ...
   * 
   * @see Match
   * @see ContextSpecificValuesHolder
   * 
   */
  public static class Matcher extends BaseMatcher<ContextSpecificValuesHolder.Match> {
    /**
     ...
     * 
     */
    public static ContextSpecificValuesHolder.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ContextSpecificValuesHolder.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ContextSpecificValuesHolder.Matcher.class);
     ...
     * 
     */
    public Collection<ContextSpecificValuesHolder.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ContextSpecificValuesHolder.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ContextSpecificValuesHolder.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ContextSpecificValuesHolder.Match> processor) {
     ...
     * 
     */
    public ContextSpecificValuesHolder.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ContextSpecificValuesHolder.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final ContextSpecificValuesHolder.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final ContextSpecificValuesHolder.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ContextSpecificValuesHolder.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ContextSpecificValuesHolder.Match partialMatch) {
    ...
    @Override
    protected ContextSpecificValuesHolder.Match tupleToMatch(final Tuple t) {
      try {
          return ContextSpecificValuesHolder.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ContextSpecificValuesHolder.Match arrayToMatch(final Object[] match) {
      try {
          return ContextSpecificValuesHolder.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ContextSpecificValuesHolder.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ContextSpecificValuesHolder.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ContextSpecificValuesHolder.Matcher> querySpecification() {
      return ContextSpecificValuesHolder.instance();
    }
  }
  
  private ContextSpecificValuesHolder() {
   ...
   * 
   */
  public static ContextSpecificValuesHolder instance() {
    try{
  ...
  @Override
  protected ContextSpecificValuesHolder.Matcher instantiate(final ViatraQueryEngine engine) {
    return ContextSpecificValuesHolder.Matcher.on(engine);
  }
  
  @Override
  public ContextSpecificValuesHolder.Matcher instantiate() {
    return ContextSpecificValuesHolder.Matcher.create();
  }
  
  @Override
  public ContextSpecificValuesHolder.Match newEmptyMatch() {
    return ContextSpecificValuesHolder.Match.newEmptyMatch();
  }
  
  @Override
  public ContextSpecificValuesHolder.Match newMatch(final Object... parameters) {
    return ContextSpecificValuesHolder.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ContextSpecificValuesHolder (visibility: PUBLIC, simpleName: ContextSpecificValuesHolder, identifier: sysml.ContextSpecificValuesHolder, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ContextSpecificValuesHolder (visibility: PUBLIC, simpleName: ContextSpecificValuesHolder, identifier: sysml.ContextSpecificValuesHolder, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ContextSpecificValuesHolder INSTANCE = new ContextSpecificValuesHolder();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ContextSpecificValuesHolder.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "contextSpecificValuesHolder");
