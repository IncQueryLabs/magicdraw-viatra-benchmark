...
public final class BusinessRequirement_Master extends BaseGeneratedEMFQuerySpecification<BusinessRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.businessRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.businessRequirement_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return BusinessRequirement_Master.Match.parameterNames;
    }
    ...
    @Override
    public BusinessRequirement_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BusinessRequirement_Master.Match)) {
          BusinessRequirement_Master.Match other = (BusinessRequirement_Master.Match) obj;
    ...
    @Override
    public BusinessRequirement_Master specification() {
     ...
     * 
     */
    public static BusinessRequirement_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static BusinessRequirement_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static BusinessRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends BusinessRequirement_Master.Match {
    ...
    private static final class Immutable extends BusinessRequirement_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.businessRequirement_Master pattern,
   ...
   * 
   * @see Match
   * @see BusinessRequirement_Master
   * 
   */
  public static class Matcher extends BaseMatcher<BusinessRequirement_Master.Match> {
    /**
     ...
     * 
     */
    public static BusinessRequirement_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BusinessRequirement_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BusinessRequirement_Master.Matcher.class);
     ...
     * 
     */
    public Collection<BusinessRequirement_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<BusinessRequirement_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<BusinessRequirement_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super BusinessRequirement_Master.Match> processor) {
     ...
     * 
     */
    public BusinessRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return BusinessRequirement_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final BusinessRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final BusinessRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final BusinessRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final BusinessRequirement_Master.Match partialMatch) {
    ...
    @Override
    protected BusinessRequirement_Master.Match tupleToMatch(final Tuple t) {
      try {
          return BusinessRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected BusinessRequirement_Master.Match arrayToMatch(final Object[] match) {
      try {
          return BusinessRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BusinessRequirement_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BusinessRequirement_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BusinessRequirement_Master.Matcher> querySpecification() {
      return BusinessRequirement_Master.instance();
    }
  }
  
  private BusinessRequirement_Master() {
   ...
   * 
   */
  public static BusinessRequirement_Master instance() {
    try{
  ...
  @Override
  protected BusinessRequirement_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return BusinessRequirement_Master.Matcher.on(engine);
  }
  
  @Override
  public BusinessRequirement_Master.Matcher instantiate() {
    return BusinessRequirement_Master.Matcher.create();
  }
  
  @Override
  public BusinessRequirement_Master.Match newEmptyMatch() {
    return BusinessRequirement_Master.Match.newEmptyMatch();
  }
  
  @Override
  public BusinessRequirement_Master.Match newMatch(final Object... parameters) {
    return BusinessRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BusinessRequirement_Master (visibility: PUBLIC, simpleName: BusinessRequirement_Master, identifier: sysml.BusinessRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BusinessRequirement_Master (visibility: PUBLIC, simpleName: BusinessRequirement_Master, identifier: sysml.BusinessRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BusinessRequirement_Master INSTANCE = new BusinessRequirement_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BusinessRequirement_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
