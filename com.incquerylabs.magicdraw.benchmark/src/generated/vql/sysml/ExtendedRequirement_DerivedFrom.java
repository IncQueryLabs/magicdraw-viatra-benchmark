...
public final class ExtendedRequirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement_DerivedFrom";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement_DerivedFrom pattern,
