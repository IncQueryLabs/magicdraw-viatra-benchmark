...
public final class Domain_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Domain_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Domain_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Domain_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Domain_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Domain_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Domain_isEncapsulated.Match)) {
          Domain_isEncapsulated.Match other = (Domain_isEncapsulated.Match) obj;
    ...
    @Override
    public Domain_isEncapsulated specification() {
     ...
     * 
     */
    public static Domain_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Domain_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Domain_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Domain_isEncapsulated.Match {
    ...
    private static final class Immutable extends Domain_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Domain_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Domain_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Domain_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Domain_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Domain_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Domain_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Domain_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Domain_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Domain_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Domain_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Domain_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Domain_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Domain_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Domain_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Domain_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Domain_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Domain_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Domain_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Domain_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Domain_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Domain_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Domain_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Domain_isEncapsulated.Matcher> querySpecification() {
      return Domain_isEncapsulated.instance();
    }
  }
  
  private Domain_isEncapsulated() {
   ...
   * 
   */
  public static Domain_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Domain_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Domain_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Domain_isEncapsulated.Matcher instantiate() {
    return Domain_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Domain_isEncapsulated.Match newEmptyMatch() {
    return Domain_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Domain_isEncapsulated.Match newMatch(final Object... parameters) {
    return Domain_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Domain_isEncapsulated (visibility: PUBLIC, simpleName: Domain_isEncapsulated, identifier: sysml.Domain_isEncapsulated, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Domain_isEncapsulated (visibility: PUBLIC, simpleName: Domain_isEncapsulated, identifier: sysml.Domain_isEncapsulated, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Domain_isEncapsulated INSTANCE = new Domain_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Domain_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Domain(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Domain.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
