...
public final class UsabilityRequirement_Id extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement_Id.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.usabilityRequirement_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.usabilityRequirement_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return UsabilityRequirement_Id.Match.parameterNames;
    }
    ...
    @Override
    public UsabilityRequirement_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof UsabilityRequirement_Id.Match)) {
          UsabilityRequirement_Id.Match other = (UsabilityRequirement_Id.Match) obj;
    ...
    @Override
    public UsabilityRequirement_Id specification() {
     ...
     * 
     */
    public static UsabilityRequirement_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static UsabilityRequirement_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static UsabilityRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends UsabilityRequirement_Id.Match {
    ...
    private static final class Immutable extends UsabilityRequirement_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.usabilityRequirement_Id pattern,
   ...
   * 
   * @see Match
   * @see UsabilityRequirement_Id
   * 
   */
  public static class Matcher extends BaseMatcher<UsabilityRequirement_Id.Match> {
    /**
     ...
     * 
     */
    public static UsabilityRequirement_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static UsabilityRequirement_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(UsabilityRequirement_Id.Matcher.class);
     ...
     * 
     */
    public Collection<UsabilityRequirement_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<UsabilityRequirement_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<UsabilityRequirement_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super UsabilityRequirement_Id.Match> processor) {
     ...
     * 
     */
    public UsabilityRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return UsabilityRequirement_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final UsabilityRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final UsabilityRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final UsabilityRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final UsabilityRequirement_Id.Match partialMatch) {
    ...
    @Override
    protected UsabilityRequirement_Id.Match tupleToMatch(final Tuple t) {
      try {
          return UsabilityRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected UsabilityRequirement_Id.Match arrayToMatch(final Object[] match) {
      try {
          return UsabilityRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected UsabilityRequirement_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return UsabilityRequirement_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<UsabilityRequirement_Id.Matcher> querySpecification() {
      return UsabilityRequirement_Id.instance();
    }
  }
  
  private UsabilityRequirement_Id() {
   ...
   * 
   */
  public static UsabilityRequirement_Id instance() {
    try{
  ...
  @Override
  protected UsabilityRequirement_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return UsabilityRequirement_Id.Matcher.on(engine);
  }
  
  @Override
  public UsabilityRequirement_Id.Matcher instantiate() {
    return UsabilityRequirement_Id.Matcher.create();
  }
  
  @Override
  public UsabilityRequirement_Id.Match newEmptyMatch() {
    return UsabilityRequirement_Id.Match.newEmptyMatch();
  }
  
  @Override
  public UsabilityRequirement_Id.Match newMatch(final Object... parameters) {
    return UsabilityRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.UsabilityRequirement_Id (visibility: PUBLIC, simpleName: UsabilityRequirement_Id, identifier: sysml.UsabilityRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.UsabilityRequirement_Id (visibility: PUBLIC, simpleName: UsabilityRequirement_Id, identifier: sysml.UsabilityRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final UsabilityRequirement_Id INSTANCE = new UsabilityRequirement_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final UsabilityRequirement_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
