...
public final class BusinessRequirement_Id extends BaseGeneratedEMFQuerySpecification<BusinessRequirement_Id.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.businessRequirement_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.businessRequirement_Id";
    }
     ...
     * 
     */
    public static BusinessRequirement_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static BusinessRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the sysml.businessRequirement_Id pattern,
  ...
  public static class Matcher extends BaseMatcher<BusinessRequirement_Id.Match> {
     ...
     * 
     */
    public Collection<BusinessRequirement_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<BusinessRequirement_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<BusinessRequirement_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super BusinessRequirement_Id.Match> processor) {
     ...
     * 
     */
    public BusinessRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return BusinessRequirement_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final BusinessRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final BusinessRequirement_Id.Match partialMatch) {
    ...
    protected BusinessRequirement_Id.Match tupleToMatch(final Tuple t) {
      try {
          return BusinessRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    protected BusinessRequirement_Id.Match arrayToMatch(final Object[] match) {
      try {
          return BusinessRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected BusinessRequirement_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BusinessRequirement_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public BusinessRequirement_Id.Match newMatch(final Object... parameters) {
    return BusinessRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BusinessRequirement_Id (visibility: PUBLIC, simpleName: BusinessRequirement_Id, identifier: sysml.BusinessRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BusinessRequirement_Id (visibility: PUBLIC, simpleName: BusinessRequirement_Id, identifier: sysml.BusinessRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
