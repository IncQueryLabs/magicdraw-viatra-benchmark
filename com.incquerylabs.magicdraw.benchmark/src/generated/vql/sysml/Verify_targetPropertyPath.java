...
public final class Verify_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Verify_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Verify_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Verify_targetPropertyPath";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.Verify_targetPropertyPath pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Verify_targetPropertyPath (visibility: PUBLIC, simpleName: Verify_targetPropertyPath, identifier: sysml.Verify_targetPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Verify_targetPropertyPath (visibility: PUBLIC, simpleName: Verify_targetPropertyPath, identifier: sysml.Verify_targetPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
