...
public final class FunctionalRequirement_Id extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement_Id.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.functionalRequirement_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.functionalRequirement_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalRequirement_Id.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalRequirement_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalRequirement_Id.Match)) {
          FunctionalRequirement_Id.Match other = (FunctionalRequirement_Id.Match) obj;
    ...
    @Override
    public FunctionalRequirement_Id specification() {
     ...
     * 
     */
    public static FunctionalRequirement_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalRequirement_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static FunctionalRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends FunctionalRequirement_Id.Match {
    ...
    private static final class Immutable extends FunctionalRequirement_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.functionalRequirement_Id pattern,
   ...
   * 
   * @see Match
   * @see FunctionalRequirement_Id
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalRequirement_Id.Match> {
    /**
     ...
     * 
     */
    public static FunctionalRequirement_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalRequirement_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalRequirement_Id.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalRequirement_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<FunctionalRequirement_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<FunctionalRequirement_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super FunctionalRequirement_Id.Match> processor) {
     ...
     * 
     */
    public FunctionalRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return FunctionalRequirement_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final FunctionalRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final FunctionalRequirement_Id.Match partialMatch) {
    ...
    @Override
    protected FunctionalRequirement_Id.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected FunctionalRequirement_Id.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalRequirement_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalRequirement_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalRequirement_Id.Matcher> querySpecification() {
      return FunctionalRequirement_Id.instance();
    }
  }
  
  private FunctionalRequirement_Id() {
   ...
   * 
   */
  public static FunctionalRequirement_Id instance() {
    try{
  ...
  @Override
  protected FunctionalRequirement_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalRequirement_Id.Matcher.on(engine);
  }
  
  @Override
  public FunctionalRequirement_Id.Matcher instantiate() {
    return FunctionalRequirement_Id.Matcher.create();
  }
  
  @Override
  public FunctionalRequirement_Id.Match newEmptyMatch() {
    return FunctionalRequirement_Id.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalRequirement_Id.Match newMatch(final Object... parameters) {
    return FunctionalRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FunctionalRequirement_Id (visibility: PUBLIC, simpleName: FunctionalRequirement_Id, identifier: sysml.FunctionalRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FunctionalRequirement_Id (visibility: PUBLIC, simpleName: FunctionalRequirement_Id, identifier: sysml.FunctionalRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalRequirement_Id INSTANCE = new FunctionalRequirement_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalRequirement_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
