...
public final class PhysicalRequirement_Master extends BaseGeneratedEMFQuerySpecification<PhysicalRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.physicalRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.physicalRequirement_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalRequirement_Master.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalRequirement_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalRequirement_Master.Match)) {
          PhysicalRequirement_Master.Match other = (PhysicalRequirement_Master.Match) obj;
    ...
    @Override
    public PhysicalRequirement_Master specification() {
     ...
     * 
     */
    public static PhysicalRequirement_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalRequirement_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalRequirement_Master.Match {
    ...
    private static final class Immutable extends PhysicalRequirement_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.physicalRequirement_Master pattern,
   ...
   * 
   * @see Match
   * @see PhysicalRequirement_Master
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalRequirement_Master.Match> {
    /**
     ...
     * 
     */
    public static PhysicalRequirement_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalRequirement_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalRequirement_Master.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalRequirement_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalRequirement_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalRequirement_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalRequirement_Master.Match> processor) {
     ...
     * 
     */
    public PhysicalRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalRequirement_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalRequirement_Master.Match partialMatch) {
    ...
    @Override
    protected PhysicalRequirement_Master.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalRequirement_Master.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalRequirement_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalRequirement_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalRequirement_Master.Matcher> querySpecification() {
      return PhysicalRequirement_Master.instance();
    }
  }
  
  private PhysicalRequirement_Master() {
   ...
   * 
   */
  public static PhysicalRequirement_Master instance() {
    try{
  ...
  @Override
  protected PhysicalRequirement_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalRequirement_Master.Matcher.on(engine);
  }
  
  @Override
  public PhysicalRequirement_Master.Matcher instantiate() {
    return PhysicalRequirement_Master.Matcher.create();
  }
  
  @Override
  public PhysicalRequirement_Master.Match newEmptyMatch() {
    return PhysicalRequirement_Master.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalRequirement_Master.Match newMatch(final Object... parameters) {
    return PhysicalRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PhysicalRequirement_Master (visibility: PUBLIC, simpleName: PhysicalRequirement_Master, identifier: sysml.PhysicalRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PhysicalRequirement_Master (visibility: PUBLIC, simpleName: PhysicalRequirement_Master, identifier: sysml.PhysicalRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalRequirement_Master INSTANCE = new PhysicalRequirement_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalRequirement_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
