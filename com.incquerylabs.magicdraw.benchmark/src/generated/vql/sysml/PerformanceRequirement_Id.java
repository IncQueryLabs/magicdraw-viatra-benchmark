...
public final class PerformanceRequirement_Id extends BaseGeneratedEMFQuerySpecification<PerformanceRequirement_Id.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.performanceRequirement_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.performanceRequirement_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformanceRequirement_Id.Match.parameterNames;
    }
    ...
    @Override
    public PerformanceRequirement_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformanceRequirement_Id.Match)) {
          PerformanceRequirement_Id.Match other = (PerformanceRequirement_Id.Match) obj;
    ...
    @Override
    public PerformanceRequirement_Id specification() {
     ...
     * 
     */
    public static PerformanceRequirement_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformanceRequirement_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static PerformanceRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends PerformanceRequirement_Id.Match {
    ...
    private static final class Immutable extends PerformanceRequirement_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.performanceRequirement_Id pattern,
   ...
   * 
   * @see Match
   * @see PerformanceRequirement_Id
   * 
   */
  public static class Matcher extends BaseMatcher<PerformanceRequirement_Id.Match> {
    /**
     ...
     * 
     */
    public static PerformanceRequirement_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformanceRequirement_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformanceRequirement_Id.Matcher.class);
     ...
     * 
     */
    public Collection<PerformanceRequirement_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<PerformanceRequirement_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<PerformanceRequirement_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super PerformanceRequirement_Id.Match> processor) {
     ...
     * 
     */
    public PerformanceRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return PerformanceRequirement_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PerformanceRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PerformanceRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final PerformanceRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final PerformanceRequirement_Id.Match partialMatch) {
    ...
    @Override
    protected PerformanceRequirement_Id.Match tupleToMatch(final Tuple t) {
      try {
          return PerformanceRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected PerformanceRequirement_Id.Match arrayToMatch(final Object[] match) {
      try {
          return PerformanceRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformanceRequirement_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformanceRequirement_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformanceRequirement_Id.Matcher> querySpecification() {
      return PerformanceRequirement_Id.instance();
    }
  }
  
  private PerformanceRequirement_Id() {
   ...
   * 
   */
  public static PerformanceRequirement_Id instance() {
    try{
  ...
  @Override
  protected PerformanceRequirement_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformanceRequirement_Id.Matcher.on(engine);
  }
  
  @Override
  public PerformanceRequirement_Id.Matcher instantiate() {
    return PerformanceRequirement_Id.Matcher.create();
  }
  
  @Override
  public PerformanceRequirement_Id.Match newEmptyMatch() {
    return PerformanceRequirement_Id.Match.newEmptyMatch();
  }
  
  @Override
  public PerformanceRequirement_Id.Match newMatch(final Object... parameters) {
    return PerformanceRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PerformanceRequirement_Id (visibility: PUBLIC, simpleName: PerformanceRequirement_Id, identifier: sysml.PerformanceRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PerformanceRequirement_Id (visibility: PUBLIC, simpleName: PerformanceRequirement_Id, identifier: sysml.PerformanceRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformanceRequirement_Id INSTANCE = new PerformanceRequirement_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformanceRequirement_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
