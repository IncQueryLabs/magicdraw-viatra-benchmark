...
public final class DesignConstraint_source extends BaseGeneratedEMFQuerySpecification<DesignConstraint_source.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.designConstraint_source pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.designConstraint_source";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint_source.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint_source.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint_source.Match)) {
          DesignConstraint_source.Match other = (DesignConstraint_source.Match) obj;
    ...
    @Override
    public DesignConstraint_source specification() {
     ...
     * 
     */
    public static DesignConstraint_source.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint_source.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static DesignConstraint_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends DesignConstraint_source.Match {
    ...
    private static final class Immutable extends DesignConstraint_source.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.designConstraint_source pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint_source
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint_source.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint_source.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint_source.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint_source.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint_source.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<DesignConstraint_source.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<DesignConstraint_source.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super DesignConstraint_source.Match> processor) {
     ...
     * 
     */
    public DesignConstraint_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return DesignConstraint_source.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DesignConstraint_source.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DesignConstraint_source.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final DesignConstraint_source.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final DesignConstraint_source.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint_source.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected DesignConstraint_source.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint_source.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint_source.Matcher> querySpecification() {
      return DesignConstraint_source.instance();
    }
  }
  
  private DesignConstraint_source() {
   ...
   * 
   */
  public static DesignConstraint_source instance() {
    try{
  ...
  @Override
  protected DesignConstraint_source.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint_source.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint_source.Matcher instantiate() {
    return DesignConstraint_source.Matcher.create();
  }
  
  @Override
  public DesignConstraint_source.Match newEmptyMatch() {
    return DesignConstraint_source.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint_source.Match newMatch(final Object... parameters) {
    return DesignConstraint_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DesignConstraint_source (visibility: PUBLIC, simpleName: DesignConstraint_source, identifier: sysml.DesignConstraint_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DesignConstraint_source (visibility: PUBLIC, simpleName: DesignConstraint_source, identifier: sysml.DesignConstraint_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesignConstraint_source INSTANCE = new DesignConstraint_source();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint_source.GeneratedPQuery INSTANCE = new GeneratedPQuery();
