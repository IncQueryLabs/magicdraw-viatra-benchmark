...
public final class PhysicalRequirement_source extends BaseGeneratedEMFQuerySpecification<PhysicalRequirement_source.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.physicalRequirement_source pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.physicalRequirement_source";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalRequirement_source.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalRequirement_source.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalRequirement_source.Match)) {
          PhysicalRequirement_source.Match other = (PhysicalRequirement_source.Match) obj;
    ...
    @Override
    public PhysicalRequirement_source specification() {
     ...
     * 
     */
    public static PhysicalRequirement_source.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalRequirement_source.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static PhysicalRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends PhysicalRequirement_source.Match {
    ...
    private static final class Immutable extends PhysicalRequirement_source.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.physicalRequirement_source pattern,
   ...
   * 
   * @see Match
   * @see PhysicalRequirement_source
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalRequirement_source.Match> {
    /**
     ...
     * 
     */
    public static PhysicalRequirement_source.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalRequirement_source.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalRequirement_source.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalRequirement_source.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<PhysicalRequirement_source.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<PhysicalRequirement_source.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super PhysicalRequirement_source.Match> processor) {
     ...
     * 
     */
    public PhysicalRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return PhysicalRequirement_source.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final PhysicalRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final PhysicalRequirement_source.Match partialMatch) {
    ...
    @Override
    protected PhysicalRequirement_source.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected PhysicalRequirement_source.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalRequirement_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalRequirement_source.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalRequirement_source.Matcher> querySpecification() {
      return PhysicalRequirement_source.instance();
    }
  }
  
  private PhysicalRequirement_source() {
   ...
   * 
   */
  public static PhysicalRequirement_source instance() {
    try{
  ...
  @Override
  protected PhysicalRequirement_source.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalRequirement_source.Matcher.on(engine);
  }
  
  @Override
  public PhysicalRequirement_source.Matcher instantiate() {
    return PhysicalRequirement_source.Matcher.create();
  }
  
  @Override
  public PhysicalRequirement_source.Match newEmptyMatch() {
    return PhysicalRequirement_source.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalRequirement_source.Match newMatch(final Object... parameters) {
    return PhysicalRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PhysicalRequirement_source (visibility: PUBLIC, simpleName: PhysicalRequirement_source, identifier: sysml.PhysicalRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PhysicalRequirement_source (visibility: PUBLIC, simpleName: PhysicalRequirement_source, identifier: sysml.PhysicalRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalRequirement_source INSTANCE = new PhysicalRequirement_source();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalRequirement_source.GeneratedPQuery INSTANCE = new GeneratedPQuery();
