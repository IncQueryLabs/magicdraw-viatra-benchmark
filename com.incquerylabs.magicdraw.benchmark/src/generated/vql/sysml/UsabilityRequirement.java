...
public final class UsabilityRequirement extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.usabilityRequirement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.usabilityRequirement";
    }
    
    @Override
    public List<String> parameterNames() {
      return UsabilityRequirement.Match.parameterNames;
    }
    ...
    @Override
    public UsabilityRequirement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof UsabilityRequirement.Match)) {
          UsabilityRequirement.Match other = (UsabilityRequirement.Match) obj;
    ...
    @Override
    public UsabilityRequirement specification() {
     ...
     * 
     */
    public static UsabilityRequirement.Match newEmptyMatch() {
     ...
     * 
     */
    public static UsabilityRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static UsabilityRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends UsabilityRequirement.Match {
    ...
    private static final class Immutable extends UsabilityRequirement.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.usabilityRequirement pattern,
   ...
   * 
   * @see Match
   * @see UsabilityRequirement
   * 
   */
  public static class Matcher extends BaseMatcher<UsabilityRequirement.Match> {
    /**
     ...
     * 
     */
    public static UsabilityRequirement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static UsabilityRequirement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(UsabilityRequirement.Matcher.class);
     ...
     * 
     */
    public Collection<UsabilityRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<UsabilityRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<UsabilityRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super UsabilityRequirement.Match> processor) {
     ...
     * 
     */
    public UsabilityRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return UsabilityRequirement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final UsabilityRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final UsabilityRequirement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final UsabilityRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final UsabilityRequirement.Match partialMatch) {
    ...
    @Override
    protected UsabilityRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return UsabilityRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected UsabilityRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return UsabilityRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected UsabilityRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return UsabilityRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<UsabilityRequirement.Matcher> querySpecification() {
      return UsabilityRequirement.instance();
    }
  }
  
  private UsabilityRequirement() {
   ...
   * 
   */
  public static UsabilityRequirement instance() {
    try{
  ...
  @Override
  protected UsabilityRequirement.Matcher instantiate(final ViatraQueryEngine engine) {
    return UsabilityRequirement.Matcher.on(engine);
  }
  
  @Override
  public UsabilityRequirement.Matcher instantiate() {
    return UsabilityRequirement.Matcher.create();
  }
  
  @Override
  public UsabilityRequirement.Match newEmptyMatch() {
    return UsabilityRequirement.Match.newEmptyMatch();
  }
  
  @Override
  public UsabilityRequirement.Match newMatch(final Object... parameters) {
    return UsabilityRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.UsabilityRequirement (visibility: PUBLIC, simpleName: UsabilityRequirement, identifier: sysml.UsabilityRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.UsabilityRequirement (visibility: PUBLIC, simpleName: UsabilityRequirement, identifier: sysml.UsabilityRequirement, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final UsabilityRequirement INSTANCE = new UsabilityRequirement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final UsabilityRequirement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "usabilityRequirement");
