...
public final class Verify_targetContext extends BaseGeneratedEMFQuerySpecification<Verify_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Verify_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Verify_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Verify_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Verify_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Verify_targetContext.Match)) {
          Verify_targetContext.Match other = (Verify_targetContext.Match) obj;
    ...
    @Override
    public Verify_targetContext specification() {
     ...
     * 
     */
    public static Verify_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Verify_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Verify_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Verify_targetContext.Match {
    ...
    private static final class Immutable extends Verify_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Verify_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Verify_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Verify_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Verify_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Verify_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Verify_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Verify_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Verify_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Verify_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Verify_targetContext.Match> processor) {
     ...
     * 
     */
    public Verify_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Verify_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Verify_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Verify_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Verify_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Verify_targetContext.Match partialMatch) {
    ...
    @Override
    protected Verify_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Verify_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Verify_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Verify_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Verify_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Verify_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Verify_targetContext.Matcher> querySpecification() {
      return Verify_targetContext.instance();
    }
  }
  
  private Verify_targetContext() {
   ...
   * 
   */
  public static Verify_targetContext instance() {
    try{
  ...
  @Override
  protected Verify_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Verify_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Verify_targetContext.Matcher instantiate() {
    return Verify_targetContext.Matcher.create();
  }
  
  @Override
  public Verify_targetContext.Match newEmptyMatch() {
    return Verify_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Verify_targetContext.Match newMatch(final Object... parameters) {
    return Verify_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Verify_targetContext (visibility: PUBLIC, simpleName: Verify_targetContext, identifier: sysml.Verify_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Verify_targetContext (visibility: PUBLIC, simpleName: Verify_targetContext, identifier: sysml.Verify_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Verify_targetContext INSTANCE = new Verify_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Verify_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
