...
public final class ProxyPort extends BaseGeneratedEMFQuerySpecification<ProxyPort.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.ProxyPort pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.ProxyPort";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProxyPort.Match.parameterNames;
    }
    ...
    @Override
    public ProxyPort.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProxyPort.Match)) {
          ProxyPort.Match other = (ProxyPort.Match) obj;
    ...
    @Override
    public ProxyPort specification() {
     ...
     * 
     */
    public static ProxyPort.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProxyPort.Match newMutableMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProxyPort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProxyPort.Match {
    ...
    private static final class Immutable extends ProxyPort.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.ProxyPort pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProxyPort.Match> {
    /**
     ...
     * 
     */
    public static ProxyPort.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProxyPort.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProxyPort.Matcher.class);
     ...
     * 
     */
    public Collection<ProxyPort.Match> getAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProxyPort.Match> streamAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProxyPort.Match> getOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProxyPort.Match> processor) {
     ...
     * 
     */
    public ProxyPort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProxyPort.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final ProxyPort.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final ProxyPort.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProxyPort.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProxyPort.Match partialMatch) {
    ...
    @Override
    protected ProxyPort.Match tupleToMatch(final Tuple t) {
      try {
          return ProxyPort.Match.newMatch((Port) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProxyPort.Match arrayToMatch(final Object[] match) {
      try {
          return ProxyPort.Match.newMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProxyPort.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProxyPort.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProxyPort.Matcher> querySpecification() {
      return ProxyPort.instance();
    }
  }
   ...
   * 
   */
  public static ProxyPort instance() {
    try{
  ...
  @Override
  protected ProxyPort.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProxyPort.Matcher.on(engine);
  }
  
  @Override
  public ProxyPort.Matcher instantiate() {
    return ProxyPort.Matcher.create();
  }
  
  @Override
  public ProxyPort.Match newEmptyMatch() {
    return ProxyPort.Match.newEmptyMatch();
  }
  
  @Override
  public ProxyPort.Match newMatch(final Object... parameters) {
    return ProxyPort.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ProxyPort (visibility: PUBLIC, simpleName: ProxyPort, identifier: sysml.ProxyPort, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ProxyPort (visibility: PUBLIC, simpleName: ProxyPort, identifier: sysml.ProxyPort, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProxyPort INSTANCE = new ProxyPort();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProxyPort.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ProxyPort");
