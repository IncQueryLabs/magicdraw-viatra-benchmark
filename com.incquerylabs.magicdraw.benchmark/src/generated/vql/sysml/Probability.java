...
public final class Probability extends BaseGeneratedEMFQuerySpecification<Probability.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Probability pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Probability.Match newMutableMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Probability.Match newMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the sysml.Probability pattern,
  ...
  public static class Matcher extends BaseMatcher<Probability.Match> {
     ...
     * 
     */
    public Collection<Probability.Match> getAllMatches(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Probability.Match> streamAllMatches(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Probability.Match> getOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Probability.Match> processor) {
     ...
     * 
     */
    public Probability.Match newMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Probability.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Probability.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Probability.Match partialMatch) {
    ...
    protected Probability.Match tupleToMatch(final Tuple t) {
      try {
          return Probability.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected Probability.Match arrayToMatch(final Object[] match) {
      try {
          return Probability.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected Probability.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Probability.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Probability.Match newMatch(final Object... parameters) {
    return Probability.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Probability (visibility: PUBLIC, simpleName: Probability, identifier: sysml.Probability, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Probability (visibility: PUBLIC, simpleName: Probability, identifier: sysml.Probability, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
