...
public final class BoundReference_bindingPath extends BaseGeneratedEMFQuerySpecification<BoundReference_bindingPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.BoundReference_bindingPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.BoundReference_bindingPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return BoundReference_bindingPath.Match.parameterNames;
    }
    ...
    @Override
    public BoundReference_bindingPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BoundReference_bindingPath.Match)) {
          BoundReference_bindingPath.Match other = (BoundReference_bindingPath.Match) obj;
    ...
    @Override
    public BoundReference_bindingPath specification() {
     ...
     * 
     */
    public static BoundReference_bindingPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static BoundReference_bindingPath.Match newMutableMatch(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public static BoundReference_bindingPath.Match newMatch(final Property pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends BoundReference_bindingPath.Match {
      Mutable(final Property pElement, final Property pValue) {
    ...
    private static final class Immutable extends BoundReference_bindingPath.Match {
      Immutable(final Property pElement, final Property pValue) {
        super(pElement, pValue);
      }
  ...
  /**
   * Generated pattern matcher API of the sysml.BoundReference_bindingPath pattern,
   ...
   * 
   * @see Match
   * @see BoundReference_bindingPath
   * 
   */
  public static class Matcher extends BaseMatcher<BoundReference_bindingPath.Match> {
    /**
     ...
     * 
     */
    public static BoundReference_bindingPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BoundReference_bindingPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BoundReference_bindingPath.Matcher.class);
     ...
     * 
     */
    public Collection<BoundReference_bindingPath.Match> getAllMatches(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<BoundReference_bindingPath.Match> streamAllMatches(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<BoundReference_bindingPath.Match> getOneArbitraryMatch(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public boolean hasMatch(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public int countMatches(final Property pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Property pValue, final Consumer<? super BoundReference_bindingPath.Match> processor) {
     ...
     * 
     */
    public BoundReference_bindingPath.Match newMatch(final Property pElement, final Property pValue) {
      return BoundReference_bindingPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final BoundReference_bindingPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final BoundReference_bindingPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final BoundReference_bindingPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final BoundReference_bindingPath.Match partialMatch) {
    ...
    @Override
    protected BoundReference_bindingPath.Match tupleToMatch(final Tuple t) {
      try {
          return BoundReference_bindingPath.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected BoundReference_bindingPath.Match arrayToMatch(final Object[] match) {
      try {
          return BoundReference_bindingPath.Match.newMatch((Property) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BoundReference_bindingPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BoundReference_bindingPath.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BoundReference_bindingPath.Matcher> querySpecification() {
      return BoundReference_bindingPath.instance();
    }
  }
  
  private BoundReference_bindingPath() {
   ...
   * 
   */
  public static BoundReference_bindingPath instance() {
    try{
  ...
  @Override
  protected BoundReference_bindingPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return BoundReference_bindingPath.Matcher.on(engine);
  }
  
  @Override
  public BoundReference_bindingPath.Matcher instantiate() {
    return BoundReference_bindingPath.Matcher.create();
  }
  
  @Override
  public BoundReference_bindingPath.Match newEmptyMatch() {
    return BoundReference_bindingPath.Match.newEmptyMatch();
  }
  
  @Override
  public BoundReference_bindingPath.Match newMatch(final Object... parameters) {
    return BoundReference_bindingPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BoundReference_bindingPath (visibility: PUBLIC, simpleName: BoundReference_bindingPath, identifier: sysml.BoundReference_bindingPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BoundReference_bindingPath (visibility: PUBLIC, simpleName: BoundReference_bindingPath, identifier: sysml.BoundReference_bindingPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BoundReference_bindingPath INSTANCE = new BoundReference_bindingPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BoundReference_bindingPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "bindingPath");
