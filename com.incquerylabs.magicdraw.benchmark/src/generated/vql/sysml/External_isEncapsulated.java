...
public final class External_isEncapsulated extends BaseGeneratedEMFQuerySpecification<External_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.External_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.External_isEncapsulated";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.External_isEncapsulated pattern,
