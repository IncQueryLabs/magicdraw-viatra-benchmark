...
public final class ExtendedRequirement_Text extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_Text.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.extendedRequirement_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.extendedRequirement_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement_Text.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtendedRequirement_Text.Match)) {
          ExtendedRequirement_Text.Match other = (ExtendedRequirement_Text.Match) obj;
    ...
    @Override
    public ExtendedRequirement_Text specification() {
     ...
     * 
     */
    public static ExtendedRequirement_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtendedRequirement_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ExtendedRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ExtendedRequirement_Text.Match {
    ...
    private static final class Immutable extends ExtendedRequirement_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.extendedRequirement_Text pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement_Text
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement_Text.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtendedRequirement_Text.Matcher.class);
     ...
     * 
     */
    public Collection<ExtendedRequirement_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ExtendedRequirement_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ExtendedRequirement_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ExtendedRequirement_Text.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ExtendedRequirement_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExtendedRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExtendedRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ExtendedRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ExtendedRequirement_Text.Match partialMatch) {
    ...
    @Override
    protected ExtendedRequirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ExtendedRequirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExtendedRequirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement_Text.Matcher> querySpecification() {
      return ExtendedRequirement_Text.instance();
    }
  }
  
  private ExtendedRequirement_Text() {
   ...
   * 
   */
  public static ExtendedRequirement_Text instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement_Text.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement_Text.Matcher instantiate() {
    return ExtendedRequirement_Text.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement_Text.Match newEmptyMatch() {
    return ExtendedRequirement_Text.Match.newEmptyMatch();
  }
  
  @Override
  public ExtendedRequirement_Text.Match newMatch(final Object... parameters) {
    return ExtendedRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.ExtendedRequirement_Text (visibility: PUBLIC, simpleName: ExtendedRequirement_Text, identifier: sysml.ExtendedRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.ExtendedRequirement_Text (visibility: PUBLIC, simpleName: ExtendedRequirement_Text, identifier: sysml.ExtendedRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement_Text INSTANCE = new ExtendedRequirement_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExtendedRequirement_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
