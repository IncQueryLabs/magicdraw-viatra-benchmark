...
public final class Interval_min extends BaseGeneratedEMFQuerySpecification<Interval_min.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Interval_min pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Interval_min";
    }
    
    @Override
    public List<String> parameterNames() {
      return Interval_min.Match.parameterNames;
    }
    ...
    @Override
    public Interval_min.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Interval_min.Match)) {
          Interval_min.Match other = (Interval_min.Match) obj;
    ...
    @Override
    public Interval_min specification() {
     ...
     * 
     */
    public static Interval_min.Match newEmptyMatch() {
     ...
     * 
     */
    public static Interval_min.Match newMutableMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public static Interval_min.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Interval_min.Match {
    ...
    private static final class Immutable extends Interval_min.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Interval_min pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Interval_min.Match> {
    /**
     ...
     * 
     */
    public static Interval_min.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Interval_min.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Interval_min.Matcher.class);
     ...
     * 
     */
    public Collection<Interval_min.Match> getAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Stream<Interval_min.Match> streamAllMatches(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public Optional<Interval_min.Match> getOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralReal pValuespec, final Consumer<? super Interval_min.Match> processor) {
     ...
     * 
     */
    public Interval_min.Match newMatch(final Property pElement, final LiteralReal pValuespec) {
      return Interval_min.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Interval_min.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Interval_min.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralReal> streamAllValuesOfvaluespec(final Interval_min.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralReal> getAllValuesOfvaluespec(final Interval_min.Match partialMatch) {
    ...
    @Override
    protected Interval_min.Match tupleToMatch(final Tuple t) {
      try {
          return Interval_min.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralReal) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Interval_min.Match arrayToMatch(final Object[] match) {
      try {
          return Interval_min.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Interval_min.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Interval_min.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralReal) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Interval_min.Matcher> querySpecification() {
      return Interval_min.instance();
    }
  }
  
  private Interval_min() {
   ...
   * 
   */
  public static Interval_min instance() {
    try{
  ...
  @Override
  protected Interval_min.Matcher instantiate(final ViatraQueryEngine engine) {
    return Interval_min.Matcher.on(engine);
  }
  
  @Override
  public Interval_min.Matcher instantiate() {
    return Interval_min.Matcher.create();
  }
  
  @Override
  public Interval_min.Match newEmptyMatch() {
    return Interval_min.Match.newEmptyMatch();
  }
  
  @Override
  public Interval_min.Match newMatch(final Object... parameters) {
    return Interval_min.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralReal) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Interval_min (visibility: PUBLIC, simpleName: Interval_min, identifier: sysml.Interval_min, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Interval_min (visibility: PUBLIC, simpleName: Interval_min, identifier: sysml.Interval_min, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Interval_min INSTANCE = new Interval_min();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Interval_min.GeneratedPQuery INSTANCE = new GeneratedPQuery();
