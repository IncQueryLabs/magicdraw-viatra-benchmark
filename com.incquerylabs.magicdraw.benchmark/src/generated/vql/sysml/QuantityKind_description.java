...
public final class QuantityKind_description extends BaseGeneratedEMFQuerySpecification<QuantityKind_description.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.QuantityKind_description pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.QuantityKind_description";
    }
    
    @Override
    public List<String> parameterNames() {
      return QuantityKind_description.Match.parameterNames;
    }
    ...
    @Override
    public QuantityKind_description.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof QuantityKind_description.Match)) {
          QuantityKind_description.Match other = (QuantityKind_description.Match) obj;
    ...
    @Override
    public QuantityKind_description specification() {
     ...
     * 
     */
    public static QuantityKind_description.Match newEmptyMatch() {
     ...
     * 
     */
    public static QuantityKind_description.Match newMutableMatch(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static QuantityKind_description.Match newMatch(final PackageableElement pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends QuantityKind_description.Match {
    ...
    private static final class Immutable extends QuantityKind_description.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.QuantityKind_description pattern,
   ...
   * 
   * @see Match
   * @see QuantityKind_description
   * 
   */
  public static class Matcher extends BaseMatcher<QuantityKind_description.Match> {
    /**
     ...
     * 
     */
    public static QuantityKind_description.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static QuantityKind_description.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(QuantityKind_description.Matcher.class);
     ...
     * 
     */
    public Collection<QuantityKind_description.Match> getAllMatches(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<QuantityKind_description.Match> streamAllMatches(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<QuantityKind_description.Match> getOneArbitraryMatch(final PackageableElement pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final LiteralString pValuespec, final Consumer<? super QuantityKind_description.Match> processor) {
     ...
     * 
     */
    public QuantityKind_description.Match newMatch(final PackageableElement pElement, final LiteralString pValuespec) {
      return QuantityKind_description.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<PackageableElement> streamAllValuesOfelement(final QuantityKind_description.Match partialMatch) {
     ...
     * 
     */
    public Set<PackageableElement> getAllValuesOfelement(final QuantityKind_description.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final QuantityKind_description.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final QuantityKind_description.Match partialMatch) {
    ...
    @Override
    protected QuantityKind_description.Match tupleToMatch(final Tuple t) {
      try {
          return QuantityKind_description.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected QuantityKind_description.Match arrayToMatch(final Object[] match) {
      try {
          return QuantityKind_description.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected QuantityKind_description.Match arrayToMatchMutable(final Object[] match) {
      try {
          return QuantityKind_description.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<QuantityKind_description.Matcher> querySpecification() {
      return QuantityKind_description.instance();
    }
  }
  
  private QuantityKind_description() {
   ...
   * 
   */
  public static QuantityKind_description instance() {
    try{
  ...
  @Override
  protected QuantityKind_description.Matcher instantiate(final ViatraQueryEngine engine) {
    return QuantityKind_description.Matcher.on(engine);
  }
  
  @Override
  public QuantityKind_description.Matcher instantiate() {
    return QuantityKind_description.Matcher.create();
  }
  
  @Override
  public QuantityKind_description.Match newEmptyMatch() {
    return QuantityKind_description.Match.newEmptyMatch();
  }
  
  @Override
  public QuantityKind_description.Match newMatch(final Object... parameters) {
    return QuantityKind_description.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.QuantityKind_description (visibility: PUBLIC, simpleName: QuantityKind_description, identifier: sysml.QuantityKind_description, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.QuantityKind_description (visibility: PUBLIC, simpleName: QuantityKind_description, identifier: sysml.QuantityKind_description, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final QuantityKind_description INSTANCE = new QuantityKind_description();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final QuantityKind_description.GeneratedPQuery INSTANCE = new GeneratedPQuery();
