...
public final class Requirement_TracedTo extends BaseGeneratedEMFQuerySpecification<Requirement_TracedTo.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Requirement_TracedTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Requirement_TracedTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Requirement_TracedTo.Match.parameterNames;
    }
    ...
    @Override
    public Requirement_TracedTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Requirement_TracedTo.Match)) {
          Requirement_TracedTo.Match other = (Requirement_TracedTo.Match) obj;
    ...
    @Override
    public Requirement_TracedTo specification() {
     ...
     * 
     */
    public static Requirement_TracedTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Requirement_TracedTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static Requirement_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Requirement_TracedTo.Match {
    ...
    private static final class Immutable extends Requirement_TracedTo.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Requirement_TracedTo pattern,
   ...
   * 
   * @see Match
   * @see Requirement_TracedTo
   * 
   */
  public static class Matcher extends BaseMatcher<Requirement_TracedTo.Match> {
    /**
     ...
     * 
     */
    public static Requirement_TracedTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Requirement_TracedTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Requirement_TracedTo.Matcher.class);
     ...
     * 
     */
    public Collection<Requirement_TracedTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<Requirement_TracedTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<Requirement_TracedTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super Requirement_TracedTo.Match> processor) {
     ...
     * 
     */
    public Requirement_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return Requirement_TracedTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Requirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Requirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final Requirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final Requirement_TracedTo.Match partialMatch) {
    ...
    @Override
    protected Requirement_TracedTo.Match tupleToMatch(final Tuple t) {
      try {
          return Requirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected Requirement_TracedTo.Match arrayToMatch(final Object[] match) {
      try {
          return Requirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Requirement_TracedTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Requirement_TracedTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Requirement_TracedTo.Matcher> querySpecification() {
      return Requirement_TracedTo.instance();
    }
  }
  
  private Requirement_TracedTo() {
   ...
   * 
   */
  public static Requirement_TracedTo instance() {
    try{
  ...
  @Override
  protected Requirement_TracedTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Requirement_TracedTo.Matcher.on(engine);
  }
  
  @Override
  public Requirement_TracedTo.Matcher instantiate() {
    return Requirement_TracedTo.Matcher.create();
  }
  
  @Override
  public Requirement_TracedTo.Match newEmptyMatch() {
    return Requirement_TracedTo.Match.newEmptyMatch();
  }
  
  @Override
  public Requirement_TracedTo.Match newMatch(final Object... parameters) {
    return Requirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Requirement_TracedTo (visibility: PUBLIC, simpleName: Requirement_TracedTo, identifier: sysml.Requirement_TracedTo, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Requirement_TracedTo (visibility: PUBLIC, simpleName: Requirement_TracedTo, identifier: sysml.Requirement_TracedTo, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Requirement_TracedTo INSTANCE = new Requirement_TracedTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Requirement_TracedTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
