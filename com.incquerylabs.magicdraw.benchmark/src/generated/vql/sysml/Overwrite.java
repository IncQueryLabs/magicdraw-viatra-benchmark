...
public final class Overwrite extends BaseGeneratedEMFQuerySpecification<Overwrite.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Overwrite pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Overwrite.Match newMutableMatch(final ObjectNode pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Overwrite.Match newMatch(final ObjectNode pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the sysml.Overwrite pattern,
  ...
  public static class Matcher extends BaseMatcher<Overwrite.Match> {
     ...
     * 
     */
    public Collection<Overwrite.Match> getAllMatches(final ObjectNode pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Overwrite.Match> streamAllMatches(final ObjectNode pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Overwrite.Match> getOneArbitraryMatch(final ObjectNode pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final ObjectNode pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Overwrite.Match> processor) {
     ...
     * 
     */
    public Overwrite.Match newMatch(final ObjectNode pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Overwrite.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Overwrite.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Overwrite.Match partialMatch) {
    ...
    protected Overwrite.Match tupleToMatch(final Tuple t) {
      try {
          return Overwrite.Match.newMatch((ObjectNode) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected Overwrite.Match arrayToMatch(final Object[] match) {
      try {
          return Overwrite.Match.newMatch((ObjectNode) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected Overwrite.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Overwrite.Match.newMutableMatch((ObjectNode) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Overwrite.Match newMatch(final Object... parameters) {
    return Overwrite.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ObjectNode) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Overwrite (visibility: PUBLIC, simpleName: Overwrite, identifier: sysml.Overwrite, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Overwrite (visibility: PUBLIC, simpleName: Overwrite, identifier: sysml.Overwrite, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
