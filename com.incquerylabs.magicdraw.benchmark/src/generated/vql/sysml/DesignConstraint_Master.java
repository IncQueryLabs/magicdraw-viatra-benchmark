...
public final class DesignConstraint_Master extends BaseGeneratedEMFQuerySpecification<DesignConstraint_Master.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.designConstraint_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.designConstraint_Master";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.designConstraint_Master pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.DesignConstraint_Master (visibility: PUBLIC, simpleName: DesignConstraint_Master, identifier: sysml.DesignConstraint_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.DesignConstraint_Master (visibility: PUBLIC, simpleName: DesignConstraint_Master, identifier: sysml.DesignConstraint_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
