...
public final class PhysicalRequirement_RefinedBy extends BaseGeneratedEMFQuerySpecification<PhysicalRequirement_RefinedBy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.physicalRequirement_RefinedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.physicalRequirement_RefinedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalRequirement_RefinedBy.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalRequirement_RefinedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalRequirement_RefinedBy.Match)) {
          PhysicalRequirement_RefinedBy.Match other = (PhysicalRequirement_RefinedBy.Match) obj;
    ...
    @Override
    public PhysicalRequirement_RefinedBy specification() {
     ...
     * 
     */
    public static PhysicalRequirement_RefinedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalRequirement_RefinedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static PhysicalRequirement_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalRequirement_RefinedBy.Match {
    ...
    private static final class Immutable extends PhysicalRequirement_RefinedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.physicalRequirement_RefinedBy pattern,
   ...
   * 
   * @see Match
   * @see PhysicalRequirement_RefinedBy
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalRequirement_RefinedBy.Match> {
    /**
     ...
     * 
     */
    public static PhysicalRequirement_RefinedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalRequirement_RefinedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalRequirement_RefinedBy.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalRequirement_RefinedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<PhysicalRequirement_RefinedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<PhysicalRequirement_RefinedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super PhysicalRequirement_RefinedBy.Match> processor) {
     ...
     * 
     */
    public PhysicalRequirement_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return PhysicalRequirement_RefinedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalRequirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalRequirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final PhysicalRequirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final PhysicalRequirement_RefinedBy.Match partialMatch) {
    ...
    @Override
    protected PhysicalRequirement_RefinedBy.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalRequirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalRequirement_RefinedBy.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalRequirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalRequirement_RefinedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalRequirement_RefinedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalRequirement_RefinedBy.Matcher> querySpecification() {
      return PhysicalRequirement_RefinedBy.instance();
    }
  }
  
  private PhysicalRequirement_RefinedBy() {
   ...
   * 
   */
  public static PhysicalRequirement_RefinedBy instance() {
    try{
  ...
  @Override
  protected PhysicalRequirement_RefinedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalRequirement_RefinedBy.Matcher.on(engine);
  }
  
  @Override
  public PhysicalRequirement_RefinedBy.Matcher instantiate() {
    return PhysicalRequirement_RefinedBy.Matcher.create();
  }
  
  @Override
  public PhysicalRequirement_RefinedBy.Match newEmptyMatch() {
    return PhysicalRequirement_RefinedBy.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalRequirement_RefinedBy.Match newMatch(final Object... parameters) {
    return PhysicalRequirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PhysicalRequirement_RefinedBy (visibility: PUBLIC, simpleName: PhysicalRequirement_RefinedBy, identifier: sysml.PhysicalRequirement_RefinedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PhysicalRequirement_RefinedBy (visibility: PUBLIC, simpleName: PhysicalRequirement_RefinedBy, identifier: sysml.PhysicalRequirement_RefinedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalRequirement_RefinedBy INSTANCE = new PhysicalRequirement_RefinedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalRequirement_RefinedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
