...
public final class RequirementRelated extends BaseGeneratedEMFQuerySpecification<RequirementRelated.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.RequirementRelated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.RequirementRelated";
    }
     ...
     * 
     */
    public static RequirementRelated.Match newMutableMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static RequirementRelated.Match newMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the sysml.RequirementRelated pattern,
  ...
  public static class Matcher extends BaseMatcher<RequirementRelated.Match> {
     ...
     * 
     */
    public Collection<RequirementRelated.Match> getAllMatches(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<RequirementRelated.Match> streamAllMatches(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<RequirementRelated.Match> getOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super RequirementRelated.Match> processor) {
     ...
     * 
     */
    public RequirementRelated.Match newMatch(final NamedElement pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return RequirementRelated.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final RequirementRelated.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final RequirementRelated.Match partialMatch) {
    ...
    protected RequirementRelated.Match tupleToMatch(final Tuple t) {
      try {
          return RequirementRelated.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected RequirementRelated.Match arrayToMatch(final Object[] match) {
      try {
          return RequirementRelated.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected RequirementRelated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RequirementRelated.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public RequirementRelated.Match newMatch(final Object... parameters) {
    return RequirementRelated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.RequirementRelated (visibility: PUBLIC, simpleName: RequirementRelated, identifier: sysml.RequirementRelated, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.RequirementRelated (visibility: PUBLIC, simpleName: RequirementRelated, identifier: sysml.RequirementRelated, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
