...
public final class Viewpoint_language extends BaseGeneratedEMFQuerySpecification<Viewpoint_language.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Viewpoint_language pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Viewpoint_language";
    }
    
    @Override
    public List<String> parameterNames() {
      return Viewpoint_language.Match.parameterNames;
    }
    ...
    @Override
    public Viewpoint_language.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Viewpoint_language.Match)) {
          Viewpoint_language.Match other = (Viewpoint_language.Match) obj;
    ...
    @Override
    public Viewpoint_language specification() {
     ...
     * 
     */
    public static Viewpoint_language.Match newEmptyMatch() {
     ...
     * 
     */
    public static Viewpoint_language.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Viewpoint_language.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Viewpoint_language.Match {
    ...
    private static final class Immutable extends Viewpoint_language.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Viewpoint_language pattern,
   ...
   * 
   * @see Match
   * @see Viewpoint_language
   * 
   */
  public static class Matcher extends BaseMatcher<Viewpoint_language.Match> {
    /**
     ...
     * 
     */
    public static Viewpoint_language.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Viewpoint_language.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Viewpoint_language.Matcher.class);
     ...
     * 
     */
    public Collection<Viewpoint_language.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Viewpoint_language.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Viewpoint_language.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Viewpoint_language.Match> processor) {
     ...
     * 
     */
    public Viewpoint_language.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Viewpoint_language.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Viewpoint_language.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Viewpoint_language.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Viewpoint_language.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Viewpoint_language.Match partialMatch) {
    ...
    @Override
    protected Viewpoint_language.Match tupleToMatch(final Tuple t) {
      try {
          return Viewpoint_language.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Viewpoint_language.Match arrayToMatch(final Object[] match) {
      try {
          return Viewpoint_language.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Viewpoint_language.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Viewpoint_language.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Viewpoint_language.Matcher> querySpecification() {
      return Viewpoint_language.instance();
    }
  }
  
  private Viewpoint_language() {
   ...
   * 
   */
  public static Viewpoint_language instance() {
    try{
  ...
  @Override
  protected Viewpoint_language.Matcher instantiate(final ViatraQueryEngine engine) {
    return Viewpoint_language.Matcher.on(engine);
  }
  
  @Override
  public Viewpoint_language.Matcher instantiate() {
    return Viewpoint_language.Matcher.create();
  }
  
  @Override
  public Viewpoint_language.Match newEmptyMatch() {
    return Viewpoint_language.Match.newEmptyMatch();
  }
  
  @Override
  public Viewpoint_language.Match newMatch(final Object... parameters) {
    return Viewpoint_language.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Viewpoint_language (visibility: PUBLIC, simpleName: Viewpoint_language, identifier: sysml.Viewpoint_language, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Viewpoint_language (visibility: PUBLIC, simpleName: Viewpoint_language, identifier: sysml.Viewpoint_language, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Viewpoint_language INSTANCE = new Viewpoint_language();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Viewpoint_language.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "language");
