...
public final class BasicInterval_min extends BaseGeneratedEMFQuerySpecification<BasicInterval_min.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.BasicInterval_min pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.BasicInterval_min";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.BasicInterval_min pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BasicInterval_min (visibility: PUBLIC, simpleName: BasicInterval_min, identifier: sysml.BasicInterval_min, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BasicInterval_min (visibility: PUBLIC, simpleName: BasicInterval_min, identifier: sysml.BasicInterval_min, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
