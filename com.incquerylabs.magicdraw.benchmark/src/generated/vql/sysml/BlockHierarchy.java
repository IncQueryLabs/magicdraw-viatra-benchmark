...
public final class BlockHierarchy extends BaseGeneratedEMFQuerySpecification<BlockHierarchy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.BlockHierarchy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.BlockHierarchy";
    }
    
    @Override
    public List<String> parameterNames() {
      return BlockHierarchy.Match.parameterNames;
    }
    ...
    @Override
    public BlockHierarchy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BlockHierarchy.Match)) {
          BlockHierarchy.Match other = (BlockHierarchy.Match) obj;
    ...
    @Override
    public BlockHierarchy specification() {
     ...
     * 
     */
    public static BlockHierarchy.Match newEmptyMatch() {
     ...
     * 
     */
    public static BlockHierarchy.Match newMutableMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static BlockHierarchy.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends BlockHierarchy.Match {
    ...
    private static final class Immutable extends BlockHierarchy.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.BlockHierarchy pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<BlockHierarchy.Match> {
    /**
     ...
     * 
     */
    public static BlockHierarchy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BlockHierarchy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BlockHierarchy.Matcher.class);
     ...
     * 
     */
    public Collection<BlockHierarchy.Match> getAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<BlockHierarchy.Match> streamAllMatches(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<BlockHierarchy.Match> getOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super BlockHierarchy.Match> processor) {
     ...
     * 
     */
    public BlockHierarchy.Match newMatch(final Diagram pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return BlockHierarchy.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Diagram> streamAllValuesOfelement(final BlockHierarchy.Match partialMatch) {
     ...
     * 
     */
    public Set<Diagram> getAllValuesOfelement(final BlockHierarchy.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final BlockHierarchy.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final BlockHierarchy.Match partialMatch) {
    ...
    @Override
    protected BlockHierarchy.Match tupleToMatch(final Tuple t) {
      try {
          return BlockHierarchy.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected BlockHierarchy.Match arrayToMatch(final Object[] match) {
      try {
          return BlockHierarchy.Match.newMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BlockHierarchy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BlockHierarchy.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BlockHierarchy.Matcher> querySpecification() {
      return BlockHierarchy.instance();
    }
  }
   ...
   * 
   */
  public static BlockHierarchy instance() {
    try{
  ...
  @Override
  protected BlockHierarchy.Matcher instantiate(final ViatraQueryEngine engine) {
    return BlockHierarchy.Matcher.on(engine);
  }
  
  @Override
  public BlockHierarchy.Matcher instantiate() {
    return BlockHierarchy.Matcher.create();
  }
  
  @Override
  public BlockHierarchy.Match newEmptyMatch() {
    return BlockHierarchy.Match.newEmptyMatch();
  }
  
  @Override
  public BlockHierarchy.Match newMatch(final Object... parameters) {
    return BlockHierarchy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BlockHierarchy (visibility: PUBLIC, simpleName: BlockHierarchy, identifier: sysml.BlockHierarchy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BlockHierarchy (visibility: PUBLIC, simpleName: BlockHierarchy, identifier: sysml.BlockHierarchy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BlockHierarchy INSTANCE = new BlockHierarchy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BlockHierarchy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "BlockHierarchy");
