...
public final class FlowProperty_direction extends BaseGeneratedEMFQuerySpecification<FlowProperty_direction.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.FlowProperty_direction pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.FlowProperty_direction";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.FlowProperty_direction pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FlowProperty_direction (visibility: PUBLIC, simpleName: FlowProperty_direction, identifier: sysml.FlowProperty_direction, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FlowProperty_direction (visibility: PUBLIC, simpleName: FlowProperty_direction, identifier: sysml.FlowProperty_direction, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
