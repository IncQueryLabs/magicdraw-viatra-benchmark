...
public final class Refine_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Refine_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Refine_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Refine_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Refine_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Refine_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Refine_targetPropertyPath.Match)) {
          Refine_targetPropertyPath.Match other = (Refine_targetPropertyPath.Match) obj;
    ...
    @Override
    public Refine_targetPropertyPath specification() {
     ...
     * 
     */
    public static Refine_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Refine_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Refine_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Refine_targetPropertyPath.Match {
    ...
    private static final class Immutable extends Refine_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Refine_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Refine_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Refine_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Refine_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Refine_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Refine_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Refine_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Refine_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Refine_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Refine_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public Refine_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Refine_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Refine_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Refine_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Refine_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Refine_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected Refine_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Refine_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Refine_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Refine_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Refine_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Refine_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Refine_targetPropertyPath.Matcher> querySpecification() {
      return Refine_targetPropertyPath.instance();
    }
  }
  
  private Refine_targetPropertyPath() {
   ...
   * 
   */
  public static Refine_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected Refine_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Refine_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Refine_targetPropertyPath.Matcher instantiate() {
    return Refine_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public Refine_targetPropertyPath.Match newEmptyMatch() {
    return Refine_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Refine_targetPropertyPath.Match newMatch(final Object... parameters) {
    return Refine_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Refine_targetPropertyPath (visibility: PUBLIC, simpleName: Refine_targetPropertyPath, identifier: sysml.Refine_targetPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Refine_targetPropertyPath (visibility: PUBLIC, simpleName: Refine_targetPropertyPath, identifier: sysml.Refine_targetPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Refine_targetPropertyPath INSTANCE = new Refine_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Refine_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Refine(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Refine.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "targetPropertyPath", valuespec)
