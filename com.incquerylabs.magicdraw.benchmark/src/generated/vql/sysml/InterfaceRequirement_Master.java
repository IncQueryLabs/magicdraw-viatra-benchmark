...
public final class InterfaceRequirement_Master extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.interfaceRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.interfaceRequirement_Master";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.interfaceRequirement_Master pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.InterfaceRequirement_Master (visibility: PUBLIC, simpleName: InterfaceRequirement_Master, identifier: sysml.InterfaceRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.InterfaceRequirement_Master (visibility: PUBLIC, simpleName: InterfaceRequirement_Master, identifier: sysml.InterfaceRequirement_Master, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
