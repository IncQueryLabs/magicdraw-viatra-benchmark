...
public final class Requirement_RefinedBy extends BaseGeneratedEMFQuerySpecification<Requirement_RefinedBy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Requirement_RefinedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Requirement_RefinedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return Requirement_RefinedBy.Match.parameterNames;
    }
    ...
    @Override
    public Requirement_RefinedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Requirement_RefinedBy.Match)) {
          Requirement_RefinedBy.Match other = (Requirement_RefinedBy.Match) obj;
    ...
    @Override
    public Requirement_RefinedBy specification() {
     ...
     * 
     */
    public static Requirement_RefinedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static Requirement_RefinedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static Requirement_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Requirement_RefinedBy.Match {
    ...
    private static final class Immutable extends Requirement_RefinedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Requirement_RefinedBy pattern,
   ...
   * 
   * @see Match
   * @see Requirement_RefinedBy
   * 
   */
  public static class Matcher extends BaseMatcher<Requirement_RefinedBy.Match> {
    /**
     ...
     * 
     */
    public static Requirement_RefinedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Requirement_RefinedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Requirement_RefinedBy.Matcher.class);
     ...
     * 
     */
    public Collection<Requirement_RefinedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<Requirement_RefinedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<Requirement_RefinedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super Requirement_RefinedBy.Match> processor) {
     ...
     * 
     */
    public Requirement_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return Requirement_RefinedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Requirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Requirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final Requirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final Requirement_RefinedBy.Match partialMatch) {
    ...
    @Override
    protected Requirement_RefinedBy.Match tupleToMatch(final Tuple t) {
      try {
          return Requirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected Requirement_RefinedBy.Match arrayToMatch(final Object[] match) {
      try {
          return Requirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Requirement_RefinedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Requirement_RefinedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Requirement_RefinedBy.Matcher> querySpecification() {
      return Requirement_RefinedBy.instance();
    }
  }
  
  private Requirement_RefinedBy() {
   ...
   * 
   */
  public static Requirement_RefinedBy instance() {
    try{
  ...
  @Override
  protected Requirement_RefinedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return Requirement_RefinedBy.Matcher.on(engine);
  }
  
  @Override
  public Requirement_RefinedBy.Matcher instantiate() {
    return Requirement_RefinedBy.Matcher.create();
  }
  
  @Override
  public Requirement_RefinedBy.Match newEmptyMatch() {
    return Requirement_RefinedBy.Match.newEmptyMatch();
  }
  
  @Override
  public Requirement_RefinedBy.Match newMatch(final Object... parameters) {
    return Requirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Requirement_RefinedBy (visibility: PUBLIC, simpleName: Requirement_RefinedBy, identifier: sysml.Requirement_RefinedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Requirement_RefinedBy (visibility: PUBLIC, simpleName: Requirement_RefinedBy, identifier: sysml.Requirement_RefinedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Requirement_RefinedBy INSTANCE = new Requirement_RefinedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Requirement_RefinedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
