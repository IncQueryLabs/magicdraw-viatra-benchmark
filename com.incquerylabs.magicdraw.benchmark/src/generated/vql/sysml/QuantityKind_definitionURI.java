...
public final class QuantityKind_definitionURI extends BaseGeneratedEMFQuerySpecification<QuantityKind_definitionURI.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.QuantityKind_definitionURI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.QuantityKind_definitionURI";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.QuantityKind_definitionURI pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.QuantityKind_definitionURI (visibility: PUBLIC, simpleName: QuantityKind_definitionURI, identifier: sysml.QuantityKind_definitionURI, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.QuantityKind_definitionURI (visibility: PUBLIC, simpleName: QuantityKind_definitionURI, identifier: sysml.QuantityKind_definitionURI, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
