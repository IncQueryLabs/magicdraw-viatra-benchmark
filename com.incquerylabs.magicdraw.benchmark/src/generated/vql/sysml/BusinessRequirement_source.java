...
public final class BusinessRequirement_source extends BaseGeneratedEMFQuerySpecification<BusinessRequirement_source.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.businessRequirement_source pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.businessRequirement_source";
    }
    
    @Override
    public List<String> parameterNames() {
      return BusinessRequirement_source.Match.parameterNames;
    }
    ...
    @Override
    public BusinessRequirement_source.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BusinessRequirement_source.Match)) {
          BusinessRequirement_source.Match other = (BusinessRequirement_source.Match) obj;
    ...
    @Override
    public BusinessRequirement_source specification() {
     ...
     * 
     */
    public static BusinessRequirement_source.Match newEmptyMatch() {
     ...
     * 
     */
    public static BusinessRequirement_source.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static BusinessRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends BusinessRequirement_source.Match {
    ...
    private static final class Immutable extends BusinessRequirement_source.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.businessRequirement_source pattern,
   ...
   * 
   * @see Match
   * @see BusinessRequirement_source
   * 
   */
  public static class Matcher extends BaseMatcher<BusinessRequirement_source.Match> {
    /**
     ...
     * 
     */
    public static BusinessRequirement_source.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BusinessRequirement_source.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BusinessRequirement_source.Matcher.class);
     ...
     * 
     */
    public Collection<BusinessRequirement_source.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<BusinessRequirement_source.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<BusinessRequirement_source.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super BusinessRequirement_source.Match> processor) {
     ...
     * 
     */
    public BusinessRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return BusinessRequirement_source.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final BusinessRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final BusinessRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final BusinessRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final BusinessRequirement_source.Match partialMatch) {
    ...
    @Override
    protected BusinessRequirement_source.Match tupleToMatch(final Tuple t) {
      try {
          return BusinessRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected BusinessRequirement_source.Match arrayToMatch(final Object[] match) {
      try {
          return BusinessRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BusinessRequirement_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BusinessRequirement_source.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BusinessRequirement_source.Matcher> querySpecification() {
      return BusinessRequirement_source.instance();
    }
  }
  
  private BusinessRequirement_source() {
   ...
   * 
   */
  public static BusinessRequirement_source instance() {
    try{
  ...
  @Override
  protected BusinessRequirement_source.Matcher instantiate(final ViatraQueryEngine engine) {
    return BusinessRequirement_source.Matcher.on(engine);
  }
  
  @Override
  public BusinessRequirement_source.Matcher instantiate() {
    return BusinessRequirement_source.Matcher.create();
  }
  
  @Override
  public BusinessRequirement_source.Match newEmptyMatch() {
    return BusinessRequirement_source.Match.newEmptyMatch();
  }
  
  @Override
  public BusinessRequirement_source.Match newMatch(final Object... parameters) {
    return BusinessRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.BusinessRequirement_source (visibility: PUBLIC, simpleName: BusinessRequirement_source, identifier: sysml.BusinessRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.BusinessRequirement_source (visibility: PUBLIC, simpleName: BusinessRequirement_source, identifier: sysml.BusinessRequirement_source, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BusinessRequirement_source INSTANCE = new BusinessRequirement_source();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BusinessRequirement_source.GeneratedPQuery INSTANCE = new GeneratedPQuery();
