...
public final class PerformanceRequirement_Derived extends BaseGeneratedEMFQuerySpecification<PerformanceRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.performanceRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.performanceRequirement_Derived";
    }
  ...
  /**
   * Generated pattern matcher API of the sysml.performanceRequirement_Derived pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PerformanceRequirement_Derived (visibility: PUBLIC, simpleName: PerformanceRequirement_Derived, identifier: sysml.PerformanceRequirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PerformanceRequirement_Derived (visibility: PUBLIC, simpleName: PerformanceRequirement_Derived, identifier: sysml.PerformanceRequirement_Derived, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
