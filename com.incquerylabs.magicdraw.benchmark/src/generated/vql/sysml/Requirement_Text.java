...
public final class Requirement_Text extends BaseGeneratedEMFQuerySpecification<Requirement_Text.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Requirement_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Requirement_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return Requirement_Text.Match.parameterNames;
    }
    ...
    @Override
    public Requirement_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Requirement_Text.Match)) {
          Requirement_Text.Match other = (Requirement_Text.Match) obj;
    ...
    @Override
    public Requirement_Text specification() {
     ...
     * 
     */
    public static Requirement_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static Requirement_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Requirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Requirement_Text.Match {
    ...
    private static final class Immutable extends Requirement_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Requirement_Text pattern,
   ...
   * 
   * @see Match
   * @see Requirement_Text
   * 
   */
  public static class Matcher extends BaseMatcher<Requirement_Text.Match> {
    /**
     ...
     * 
     */
    public static Requirement_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Requirement_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Requirement_Text.Matcher.class);
     ...
     * 
     */
    public Collection<Requirement_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Requirement_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Requirement_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Requirement_Text.Match> processor) {
     ...
     * 
     */
    public Requirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Requirement_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Requirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Requirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Requirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Requirement_Text.Match partialMatch) {
    ...
    @Override
    protected Requirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return Requirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Requirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return Requirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Requirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Requirement_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Requirement_Text.Matcher> querySpecification() {
      return Requirement_Text.instance();
    }
  }
  
  private Requirement_Text() {
   ...
   * 
   */
  public static Requirement_Text instance() {
    try{
  ...
  @Override
  protected Requirement_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return Requirement_Text.Matcher.on(engine);
  }
  
  @Override
  public Requirement_Text.Matcher instantiate() {
    return Requirement_Text.Matcher.create();
  }
  
  @Override
  public Requirement_Text.Match newEmptyMatch() {
    return Requirement_Text.Match.newEmptyMatch();
  }
  
  @Override
  public Requirement_Text.Match newMatch(final Object... parameters) {
    return Requirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Requirement_Text (visibility: PUBLIC, simpleName: Requirement_Text, identifier: sysml.Requirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Requirement_Text (visibility: PUBLIC, simpleName: Requirement_Text, identifier: sysml.Requirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Requirement_Text INSTANCE = new Requirement_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Requirement_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
