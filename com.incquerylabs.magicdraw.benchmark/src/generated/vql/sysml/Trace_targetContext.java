...
public final class Trace_targetContext extends BaseGeneratedEMFQuerySpecification<Trace_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Trace_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Trace_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Trace_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Trace_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Trace_targetContext.Match)) {
          Trace_targetContext.Match other = (Trace_targetContext.Match) obj;
    ...
    @Override
    public Trace_targetContext specification() {
     ...
     * 
     */
    public static Trace_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Trace_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Trace_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Trace_targetContext.Match {
    ...
    private static final class Immutable extends Trace_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Trace_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Trace_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Trace_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Trace_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Trace_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Trace_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Trace_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Trace_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Trace_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Trace_targetContext.Match> processor) {
     ...
     * 
     */
    public Trace_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Trace_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Trace_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Trace_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Trace_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Trace_targetContext.Match partialMatch) {
    ...
    @Override
    protected Trace_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Trace_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Trace_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Trace_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Trace_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Trace_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Trace_targetContext.Matcher> querySpecification() {
      return Trace_targetContext.instance();
    }
  }
  
  private Trace_targetContext() {
   ...
   * 
   */
  public static Trace_targetContext instance() {
    try{
  ...
  @Override
  protected Trace_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Trace_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Trace_targetContext.Matcher instantiate() {
    return Trace_targetContext.Matcher.create();
  }
  
  @Override
  public Trace_targetContext.Match newEmptyMatch() {
    return Trace_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Trace_targetContext.Match newMatch(final Object... parameters) {
    return Trace_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Trace_targetContext (visibility: PUBLIC, simpleName: Trace_targetContext, identifier: sysml.Trace_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Trace_targetContext (visibility: PUBLIC, simpleName: Trace_targetContext, identifier: sysml.Trace_targetContext, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Trace_targetContext INSTANCE = new Trace_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Trace_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
