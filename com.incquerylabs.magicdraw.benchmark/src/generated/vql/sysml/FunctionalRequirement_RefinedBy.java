...
public final class FunctionalRequirement_RefinedBy extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement_RefinedBy.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.functionalRequirement_RefinedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.functionalRequirement_RefinedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalRequirement_RefinedBy.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalRequirement_RefinedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalRequirement_RefinedBy.Match)) {
          FunctionalRequirement_RefinedBy.Match other = (FunctionalRequirement_RefinedBy.Match) obj;
    ...
    @Override
    public FunctionalRequirement_RefinedBy specification() {
     ...
     * 
     */
    public static FunctionalRequirement_RefinedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalRequirement_RefinedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static FunctionalRequirement_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalRequirement_RefinedBy.Match {
    ...
    private static final class Immutable extends FunctionalRequirement_RefinedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.functionalRequirement_RefinedBy pattern,
   ...
   * 
   * @see Match
   * @see FunctionalRequirement_RefinedBy
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalRequirement_RefinedBy.Match> {
    /**
     ...
     * 
     */
    public static FunctionalRequirement_RefinedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalRequirement_RefinedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalRequirement_RefinedBy.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalRequirement_RefinedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<FunctionalRequirement_RefinedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<FunctionalRequirement_RefinedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super FunctionalRequirement_RefinedBy.Match> processor) {
     ...
     * 
     */
    public FunctionalRequirement_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return FunctionalRequirement_RefinedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalRequirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalRequirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final FunctionalRequirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final FunctionalRequirement_RefinedBy.Match partialMatch) {
    ...
    @Override
    protected FunctionalRequirement_RefinedBy.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalRequirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalRequirement_RefinedBy.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalRequirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalRequirement_RefinedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalRequirement_RefinedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalRequirement_RefinedBy.Matcher> querySpecification() {
      return FunctionalRequirement_RefinedBy.instance();
    }
  }
  
  private FunctionalRequirement_RefinedBy() {
   ...
   * 
   */
  public static FunctionalRequirement_RefinedBy instance() {
    try{
  ...
  @Override
  protected FunctionalRequirement_RefinedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalRequirement_RefinedBy.Matcher.on(engine);
  }
  
  @Override
  public FunctionalRequirement_RefinedBy.Matcher instantiate() {
    return FunctionalRequirement_RefinedBy.Matcher.create();
  }
  
  @Override
  public FunctionalRequirement_RefinedBy.Match newEmptyMatch() {
    return FunctionalRequirement_RefinedBy.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalRequirement_RefinedBy.Match newMatch(final Object... parameters) {
    return FunctionalRequirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FunctionalRequirement_RefinedBy (visibility: PUBLIC, simpleName: FunctionalRequirement_RefinedBy, identifier: sysml.FunctionalRequirement_RefinedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FunctionalRequirement_RefinedBy (visibility: PUBLIC, simpleName: FunctionalRequirement_RefinedBy, identifier: sysml.FunctionalRequirement_RefinedBy, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalRequirement_RefinedBy INSTANCE = new FunctionalRequirement_RefinedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalRequirement_RefinedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
