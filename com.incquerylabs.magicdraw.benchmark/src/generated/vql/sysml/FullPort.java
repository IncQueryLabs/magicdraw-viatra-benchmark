...
public final class FullPort extends BaseGeneratedEMFQuerySpecification<FullPort.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.FullPort pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.FullPort";
    }
    
    @Override
    public List<String> parameterNames() {
      return FullPort.Match.parameterNames;
    }
    ...
    @Override
    public FullPort.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FullPort.Match)) {
          FullPort.Match other = (FullPort.Match) obj;
     ...
     * 
     */
    public static FullPort.Match newEmptyMatch() {
     ...
     * 
     */
    public static FullPort.Match newMutableMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FullPort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends FullPort.Match {
    ...
    private static final class Immutable extends FullPort.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.FullPort pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<FullPort.Match> {
    /**
     ...
     * 
     */
    public static FullPort.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FullPort.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FullPort.Matcher.class);
     ...
     * 
     */
    public Collection<FullPort.Match> getAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FullPort.Match> streamAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FullPort.Match> getOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FullPort.Match> processor) {
     ...
     * 
     */
    public FullPort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FullPort.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final FullPort.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final FullPort.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FullPort.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FullPort.Match partialMatch) {
    ...
    @Override
    protected FullPort.Match tupleToMatch(final Tuple t) {
      try {
          return FullPort.Match.newMatch((Port) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected FullPort.Match arrayToMatch(final Object[] match) {
      try {
          return FullPort.Match.newMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FullPort.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FullPort.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FullPort.Matcher> querySpecification() {
      return FullPort.instance();
    }
  }
   ...
   * 
   */
  public static FullPort instance() {
    try{
  ...
  @Override
  protected FullPort.Matcher instantiate(final ViatraQueryEngine engine) {
    return FullPort.Matcher.on(engine);
  }
  
  @Override
  public FullPort.Matcher instantiate() {
    return FullPort.Matcher.create();
  }
  
  @Override
  public FullPort.Match newEmptyMatch() {
    return FullPort.Match.newEmptyMatch();
  }
  
  @Override
  public FullPort.Match newMatch(final Object... parameters) {
    return FullPort.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.FullPort (visibility: PUBLIC, simpleName: FullPort, identifier: sysml.FullPort, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.FullPort (visibility: PUBLIC, simpleName: FullPort, identifier: sysml.FullPort, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FullPort INSTANCE = new FullPort();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FullPort.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "FullPort");
