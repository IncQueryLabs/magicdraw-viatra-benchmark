...
public final class PerformanceRequirement_Text extends BaseGeneratedEMFQuerySpecification<PerformanceRequirement_Text.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.performanceRequirement_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.performanceRequirement_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformanceRequirement_Text.Match.parameterNames;
    }
    ...
    @Override
    public PerformanceRequirement_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformanceRequirement_Text.Match)) {
          PerformanceRequirement_Text.Match other = (PerformanceRequirement_Text.Match) obj;
    ...
    @Override
    public PerformanceRequirement_Text specification() {
     ...
     * 
     */
    public static PerformanceRequirement_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformanceRequirement_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static PerformanceRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends PerformanceRequirement_Text.Match {
    ...
    private static final class Immutable extends PerformanceRequirement_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.performanceRequirement_Text pattern,
   ...
   * 
   * @see Match
   * @see PerformanceRequirement_Text
   * 
   */
  public static class Matcher extends BaseMatcher<PerformanceRequirement_Text.Match> {
    /**
     ...
     * 
     */
    public static PerformanceRequirement_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformanceRequirement_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformanceRequirement_Text.Matcher.class);
     ...
     * 
     */
    public Collection<PerformanceRequirement_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<PerformanceRequirement_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<PerformanceRequirement_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super PerformanceRequirement_Text.Match> processor) {
     ...
     * 
     */
    public PerformanceRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return PerformanceRequirement_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PerformanceRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PerformanceRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final PerformanceRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final PerformanceRequirement_Text.Match partialMatch) {
    ...
    @Override
    protected PerformanceRequirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return PerformanceRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected PerformanceRequirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return PerformanceRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformanceRequirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformanceRequirement_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformanceRequirement_Text.Matcher> querySpecification() {
      return PerformanceRequirement_Text.instance();
    }
  }
  
  private PerformanceRequirement_Text() {
   ...
   * 
   */
  public static PerformanceRequirement_Text instance() {
    try{
  ...
  @Override
  protected PerformanceRequirement_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformanceRequirement_Text.Matcher.on(engine);
  }
  
  @Override
  public PerformanceRequirement_Text.Matcher instantiate() {
    return PerformanceRequirement_Text.Matcher.create();
  }
  
  @Override
  public PerformanceRequirement_Text.Match newEmptyMatch() {
    return PerformanceRequirement_Text.Match.newEmptyMatch();
  }
  
  @Override
  public PerformanceRequirement_Text.Match newMatch(final Object... parameters) {
    return PerformanceRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.PerformanceRequirement_Text (visibility: PUBLIC, simpleName: PerformanceRequirement_Text, identifier: sysml.PerformanceRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.PerformanceRequirement_Text (visibility: PUBLIC, simpleName: PerformanceRequirement_Text, identifier: sysml.PerformanceRequirement_Text, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformanceRequirement_Text INSTANCE = new PerformanceRequirement_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformanceRequirement_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
