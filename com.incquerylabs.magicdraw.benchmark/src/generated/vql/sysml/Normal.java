...
public final class Normal extends BaseGeneratedEMFQuerySpecification<Normal.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Normal pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public List<String> parameterNames() {
      return Normal.Match.parameterNames;
    }
    ...
    @Override
    public Normal.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Normal.Match)) {
          Normal.Match other = (Normal.Match) obj;
     ...
     * 
     */
    public static Normal.Match newEmptyMatch() {
     ...
     * 
     */
    public static Normal.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Normal.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Normal.Match {
    ...
    private static final class Immutable extends Normal.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Normal pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Normal.Match> {
    /**
     ...
     * 
     */
    public static Normal.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Normal.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Normal.Matcher.class);
     ...
     * 
     */
    public Collection<Normal.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Normal.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Normal.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Normal.Match> processor) {
     ...
     * 
     */
    public Normal.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Normal.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Normal.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Normal.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Normal.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Normal.Match partialMatch) {
    ...
    @Override
    protected Normal.Match tupleToMatch(final Tuple t) {
      try {
          return Normal.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Normal.Match arrayToMatch(final Object[] match) {
      try {
          return Normal.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Normal.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Normal.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Normal.Matcher> querySpecification() {
      return Normal.instance();
    }
  }
  ...
  @Override
  protected Normal.Matcher instantiate(final ViatraQueryEngine engine) {
    return Normal.Matcher.on(engine);
  }
  
  @Override
  public Normal.Matcher instantiate() {
    return Normal.Matcher.create();
  }
  
  @Override
  public Normal.Match newEmptyMatch() {
    return Normal.Match.newEmptyMatch();
  }
  
  @Override
  public Normal.Match newMatch(final Object... parameters) {
    return Normal.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Normal (visibility: PUBLIC, simpleName: Normal, identifier: sysml.Normal, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Normal (visibility: PUBLIC, simpleName: Normal, identifier: sysml.Normal, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Normal.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Normal");
