...
public final class AbstractRequirement_Id extends BaseGeneratedEMFQuerySpecification<AbstractRequirement_Id.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.AbstractRequirement_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.AbstractRequirement_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return AbstractRequirement_Id.Match.parameterNames;
    }
    ...
    @Override
    public AbstractRequirement_Id specification() {
     ...
     * 
     */
    public static AbstractRequirement_Id.Match newEmptyMatch() {
  ...
  /**
   * Generated pattern matcher API of the sysml.AbstractRequirement_Id pattern,
   ...
   * 
   * @see Match
   * @see AbstractRequirement_Id
   * 
   */
  public static class Matcher extends BaseMatcher<AbstractRequirement_Id.Match> {
    /**
     ...
     * 
     */
    public static AbstractRequirement_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static AbstractRequirement_Id.Matcher create() {
      return new Matcher();
    }
     ...
     * 
     */
    public static IQuerySpecification<AbstractRequirement_Id.Matcher> querySpecification() {
      return AbstractRequirement_Id.instance();
    }
  }
  
  private AbstractRequirement_Id() {
   ...
   * 
   */
  public static AbstractRequirement_Id instance() {
    try{
  ...
  @Override
  protected AbstractRequirement_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return AbstractRequirement_Id.Matcher.on(engine);
  }
  
  @Override
  public AbstractRequirement_Id.Matcher instantiate() {
    return AbstractRequirement_Id.Matcher.create();
  }
  
  @Override
  public AbstractRequirement_Id.Match newEmptyMatch() {
    return AbstractRequirement_Id.Match.newEmptyMatch();
  }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.AbstractRequirement_Id (visibility: PUBLIC, simpleName: AbstractRequirement_Id, identifier: sysml.AbstractRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.AbstractRequirement_Id (visibility: PUBLIC, simpleName: AbstractRequirement_Id, identifier: sysml.AbstractRequirement_Id, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final AbstractRequirement_Id INSTANCE = new AbstractRequirement_Id();
