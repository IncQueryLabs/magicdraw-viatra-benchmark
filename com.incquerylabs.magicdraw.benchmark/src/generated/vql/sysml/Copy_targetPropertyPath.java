...
public final class Copy_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Copy_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Copy_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "sysml.Copy_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Copy_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Copy_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Copy_targetPropertyPath.Match)) {
          Copy_targetPropertyPath.Match other = (Copy_targetPropertyPath.Match) obj;
    ...
    @Override
    public Copy_targetPropertyPath specification() {
     ...
     * 
     */
    public static Copy_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Copy_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Copy_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Copy_targetPropertyPath.Match {
    ...
    private static final class Immutable extends Copy_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the sysml.Copy_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Copy_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Copy_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Copy_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Copy_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Copy_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Copy_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Copy_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Copy_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Copy_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public Copy_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Copy_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Copy_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Copy_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Copy_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Copy_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected Copy_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Copy_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Copy_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Copy_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Copy_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Copy_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Copy_targetPropertyPath.Matcher> querySpecification() {
      return Copy_targetPropertyPath.instance();
    }
  }
  
  private Copy_targetPropertyPath() {
   ...
   * 
   */
  public static Copy_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected Copy_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Copy_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Copy_targetPropertyPath.Matcher instantiate() {
    return Copy_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public Copy_targetPropertyPath.Match newEmptyMatch() {
    return Copy_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Copy_targetPropertyPath.Match newMatch(final Object... parameters) {
    return Copy_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: sysml.Copy_targetPropertyPath (visibility: PUBLIC, simpleName: Copy_targetPropertyPath, identifier: sysml.Copy_targetPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: sysml.Copy_targetPropertyPath (visibility: PUBLIC, simpleName: Copy_targetPropertyPath, identifier: sysml.Copy_targetPropertyPath, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: sysml) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Copy_targetPropertyPath INSTANCE = new Copy_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Copy_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Copy(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Copy.instance().getInternalQueryRepresentation());
          // 	find util.slotValue(domainStereotypeInstance, "targetPropertyPath", valuespec)
