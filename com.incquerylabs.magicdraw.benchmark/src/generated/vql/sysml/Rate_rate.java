...
public final class Rate_rate extends BaseGeneratedEMFQuerySpecification<Rate_rate.Matcher> {
  /**
   * Pattern-specific match representation of the sysml.Rate_rate pattern,
  ...
  /**
   * Generated pattern matcher API of the sysml.Rate_rate pattern,
