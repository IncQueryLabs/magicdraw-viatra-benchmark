...
public final class OwningPackageOrSelf extends BaseGeneratedEMFQuerySpecification<OwningPackageOrSelf.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: util.OwningPackageOrSelf (visibility: PUBLIC, simpleName: OwningPackageOrSelf, identifier: util.OwningPackageOrSelf, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: util.OwningPackageOrSelf (visibility: PUBLIC, simpleName: OwningPackageOrSelf, identifier: util.OwningPackageOrSelf, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
