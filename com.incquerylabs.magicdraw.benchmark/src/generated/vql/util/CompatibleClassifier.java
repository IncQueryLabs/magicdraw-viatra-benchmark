/**
 * Generated from platform:/resource/com.incquerylabs.magicdraw.benchmark/src/main/java/util/CommonLibrary.vql
 */
package util;
...
public final class CompatibleClassifier extends BaseGeneratedEMFQuerySpecification<CompatibleClassifier.Matcher> {
  /**
   * Pattern-specific match representation of the util.compatibleClassifier pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "util.compatibleClassifier";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompatibleClassifier.Match.parameterNames;
    }
    ...
    @Override
    public CompatibleClassifier.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompatibleClassifier.Match)) {
          CompatibleClassifier.Match other = (CompatibleClassifier.Match) obj;
    ...
    @Override
    public CompatibleClassifier specification() {
     ...
     * 
     */
    public static CompatibleClassifier.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompatibleClassifier.Match newMutableMatch(final Classifier pClassifier, final Classifier pGeneral) {
     ...
     * 
     */
    public static CompatibleClassifier.Match newMatch(final Classifier pClassifier, final Classifier pGeneral) {
      return new Immutable(pClassifier, pGeneral);
    }
    
    private static final class Mutable extends CompatibleClassifier.Match {
    ...
    private static final class Immutable extends CompatibleClassifier.Match {
  ...
  /**
   * Generated pattern matcher API of the util.compatibleClassifier pattern,
   ...
   * 
   * @see Match
   * @see CompatibleClassifier
   * 
   */
  public static class Matcher extends BaseMatcher<CompatibleClassifier.Match> {
    /**
     ...
     * 
     */
    public static CompatibleClassifier.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompatibleClassifier.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompatibleClassifier.Matcher.class);
     ...
     * 
     */
    public Collection<CompatibleClassifier.Match> getAllMatches(final Classifier pClassifier, final Classifier pGeneral) {
     ...
     * 
     */
    public Stream<CompatibleClassifier.Match> streamAllMatches(final Classifier pClassifier, final Classifier pGeneral) {
     ...
     * 
     */
    public Optional<CompatibleClassifier.Match> getOneArbitraryMatch(final Classifier pClassifier, final Classifier pGeneral) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Classifier pClassifier, final Classifier pGeneral, final Consumer<? super CompatibleClassifier.Match> processor) {
     ...
     * 
     */
    public CompatibleClassifier.Match newMatch(final Classifier pClassifier, final Classifier pGeneral) {
      return CompatibleClassifier.Match.newMatch(pClassifier, pGeneral);
    }
    ...
    @Override
    protected CompatibleClassifier.Match tupleToMatch(final Tuple t) {
      try {
          return CompatibleClassifier.Match.newMatch((Classifier) t.get(POSITION_CLASSIFIER), (Classifier) t.get(POSITION_GENERAL));
    ...
    @Override
    protected CompatibleClassifier.Match arrayToMatch(final Object[] match) {
      try {
          return CompatibleClassifier.Match.newMatch((Classifier) match[POSITION_CLASSIFIER], (Classifier) match[POSITION_GENERAL]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompatibleClassifier.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompatibleClassifier.Match.newMutableMatch((Classifier) match[POSITION_CLASSIFIER], (Classifier) match[POSITION_GENERAL]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompatibleClassifier.Matcher> querySpecification() {
      return CompatibleClassifier.instance();
    }
  }
  
  private CompatibleClassifier() {
   ...
   * 
   */
  public static CompatibleClassifier instance() {
    try{
  ...
  @Override
  protected CompatibleClassifier.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompatibleClassifier.Matcher.on(engine);
  }
  
  @Override
  public CompatibleClassifier.Matcher instantiate() {
    return CompatibleClassifier.Matcher.create();
  }
  
  @Override
  public CompatibleClassifier.Match newEmptyMatch() {
    return CompatibleClassifier.Match.newEmptyMatch();
  }
  
  @Override
  public CompatibleClassifier.Match newMatch(final Object... parameters) {
    return CompatibleClassifier.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: util.CompatibleClassifier (visibility: PUBLIC, simpleName: CompatibleClassifier, identifier: util.CompatibleClassifier, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: util) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: util.CompatibleClassifier (visibility: PUBLIC, simpleName: CompatibleClassifier, identifier: util.CompatibleClassifier, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: util) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompatibleClassifier INSTANCE = new CompatibleClassifier();
