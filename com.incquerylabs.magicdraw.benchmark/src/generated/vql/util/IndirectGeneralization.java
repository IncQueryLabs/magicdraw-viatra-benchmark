...
public final class IndirectGeneralization extends BaseGeneratedEMFQuerySpecification<IndirectGeneralization.Matcher> {
  /**
   * Pattern-specific match representation of the util.indirectGeneralization pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "util.indirectGeneralization";
    }
  ...
  /**
   * Generated pattern matcher API of the util.indirectGeneralization pattern,
