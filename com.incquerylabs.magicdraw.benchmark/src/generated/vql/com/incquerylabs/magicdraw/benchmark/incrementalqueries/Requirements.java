...
public final class Requirements extends BaseGeneratedEMFQuerySpecification<Requirements.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.requirements pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.requirements";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.requirements pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Requirements.Match> {
    /**
     ...
     * 
     */
    public Collection<Requirements.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public Stream<Requirements.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public Optional<Requirements.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public static IQuerySpecification<Requirements.Matcher> querySpecification() {
      return Requirements.instance();
    }
  }
