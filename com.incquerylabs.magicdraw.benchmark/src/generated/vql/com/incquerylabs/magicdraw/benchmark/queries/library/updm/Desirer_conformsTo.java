...
public final class Desirer_conformsTo extends BaseGeneratedEMFQuerySpecification<Desirer_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Desirer_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Desirer_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Desirer_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Desirer_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Desirer_conformsTo.Match)) {
          Desirer_conformsTo.Match other = (Desirer_conformsTo.Match) obj;
    ...
    @Override
    public Desirer_conformsTo specification() {
      return Desirer_conformsTo.instance();
    }
     ...
     * 
     */
    public static Desirer_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Desirer_conformsTo.Match newMutableMatch(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public static Desirer_conformsTo.Match newMatch(final Element pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Desirer_conformsTo.Match {
    ...
    private static final class Immutable extends Desirer_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Desirer_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Desirer_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Desirer_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Desirer_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Desirer_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Desirer_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Desirer_conformsTo.Match> getAllMatches(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Desirer_conformsTo.Match> streamAllMatches(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Desirer_conformsTo.Match> getOneArbitraryMatch(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final Element pValue, final Consumer<? super Desirer_conformsTo.Match> processor) {
     ...
     * 
     */
    public Desirer_conformsTo.Match newMatch(final Element pElement, final Element pValue) {
      return Desirer_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Desirer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Desirer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Desirer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Desirer_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Desirer_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Desirer_conformsTo.Match.newMatch((Element) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Desirer_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Desirer_conformsTo.Match.newMatch((Element) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Desirer_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Desirer_conformsTo.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Desirer_conformsTo.Matcher> querySpecification() {
      return Desirer_conformsTo.instance();
    }
  }
  
  private Desirer_conformsTo() {
   ...
   * 
   */
  public static Desirer_conformsTo instance() {
    try{
  ...
  @Override
  protected Desirer_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Desirer_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Desirer_conformsTo.Matcher instantiate() {
    return Desirer_conformsTo.Matcher.create();
  }
  
  @Override
  public Desirer_conformsTo.Match newEmptyMatch() {
    return Desirer_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Desirer_conformsTo.Match newMatch(final Object... parameters) {
    return Desirer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Desirer_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Desirer_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Desirer_conformsTo INSTANCE = new Desirer_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Desirer_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
