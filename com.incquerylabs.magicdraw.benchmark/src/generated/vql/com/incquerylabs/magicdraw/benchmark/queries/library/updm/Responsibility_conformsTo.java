...
public final class Responsibility_conformsTo extends BaseGeneratedEMFQuerySpecification<Responsibility_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_conformsTo.Match)) {
          Responsibility_conformsTo.Match other = (Responsibility_conformsTo.Match) obj;
    ...
    @Override
    public Responsibility_conformsTo specification() {
      return Responsibility_conformsTo.instance();
    }
     ...
     * 
     */
    public static Responsibility_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_conformsTo.Match {
    ...
    private static final class Immutable extends Responsibility_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_conformsTo.Match> processor) {
     ...
     * 
     */
    public Responsibility_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Responsibility_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_conformsTo.Matcher> querySpecification() {
      return Responsibility_conformsTo.instance();
    }
  }
  
  private Responsibility_conformsTo() {
   ...
   * 
   */
  public static Responsibility_conformsTo instance() {
    try{
  ...
  @Override
  protected Responsibility_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_conformsTo.Matcher instantiate() {
    return Responsibility_conformsTo.Matcher.create();
  }
  
  @Override
  public Responsibility_conformsTo.Match newEmptyMatch() {
    return Responsibility_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_conformsTo.Match newMatch(final Object... parameters) {
    return Responsibility_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_conformsTo INSTANCE = new Responsibility_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
