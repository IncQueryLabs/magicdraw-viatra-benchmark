...
public final class PropertyOwnedByValueType extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private PropertyOwnedByValueType() {
   ...
   * 
   */
  public static PropertyOwnedByValueType instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link PropertyOwnedByValueType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PropertyOwnedByValueType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PropertyOwnedByValueType INSTANCE = new PropertyOwnedByValueType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.propertyOwnedByValueType";
    }
