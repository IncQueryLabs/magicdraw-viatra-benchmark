...
public final class SystemResource_URI extends BaseGeneratedEMFQuerySpecification<SystemResource_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_URI.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_URI.Match)) {
          SystemResource_URI.Match other = (SystemResource_URI.Match) obj;
    ...
    @Override
    public SystemResource_URI specification() {
      return SystemResource_URI.instance();
    }
     ...
     * 
     */
    public static SystemResource_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SystemResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SystemResource_URI.Match {
    ...
    private static final class Immutable extends SystemResource_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_URI pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_URI
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_URI.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_URI.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SystemResource_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SystemResource_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super SystemResource_URI.Match> processor) {
     ...
     * 
     */
    public SystemResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return SystemResource_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SystemResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SystemResource_URI.Match partialMatch) {
    ...
    @Override
    protected SystemResource_URI.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SystemResource_URI.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_URI.Matcher> querySpecification() {
      return SystemResource_URI.instance();
    }
  }
  
  private SystemResource_URI() {
   ...
   * 
   */
  public static SystemResource_URI instance() {
    try{
  ...
  @Override
  protected SystemResource_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_URI.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_URI.Matcher instantiate() {
    return SystemResource_URI.Matcher.create();
  }
  
  @Override
  public SystemResource_URI.Match newEmptyMatch() {
    return SystemResource_URI.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_URI.Match newMatch(final Object... parameters) {
    return SystemResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_URI INSTANCE = new SystemResource_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
