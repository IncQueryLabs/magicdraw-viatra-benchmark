...
public final class NaturalResource_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<NaturalResource_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return NaturalResource_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public NaturalResource_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NaturalResource_requiredEnvironment.Match)) {
          NaturalResource_requiredEnvironment.Match other = (NaturalResource_requiredEnvironment.Match) obj;
    ...
    @Override
    public NaturalResource_requiredEnvironment specification() {
      return NaturalResource_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static NaturalResource_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static NaturalResource_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NaturalResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NaturalResource_requiredEnvironment.Match {
    ...
    private static final class Immutable extends NaturalResource_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see NaturalResource_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<NaturalResource_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static NaturalResource_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NaturalResource_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NaturalResource_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<NaturalResource_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NaturalResource_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NaturalResource_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NaturalResource_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public NaturalResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NaturalResource_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NaturalResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NaturalResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NaturalResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NaturalResource_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected NaturalResource_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return NaturalResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NaturalResource_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return NaturalResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NaturalResource_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NaturalResource_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NaturalResource_requiredEnvironment.Matcher> querySpecification() {
      return NaturalResource_requiredEnvironment.instance();
    }
  }
  
  private NaturalResource_requiredEnvironment() {
   ...
   * 
   */
  public static NaturalResource_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected NaturalResource_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return NaturalResource_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public NaturalResource_requiredEnvironment.Matcher instantiate() {
    return NaturalResource_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public NaturalResource_requiredEnvironment.Match newEmptyMatch() {
    return NaturalResource_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public NaturalResource_requiredEnvironment.Match newMatch(final Object... parameters) {
    return NaturalResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NaturalResource_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NaturalResource_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NaturalResource_requiredEnvironment INSTANCE = new NaturalResource_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NaturalResource_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
