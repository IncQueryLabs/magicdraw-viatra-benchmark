...
public final class Participant_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Participant_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Participant_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_actualPropertySet.Match)) {
          Participant_actualPropertySet.Match other = (Participant_actualPropertySet.Match) obj;
    ...
    @Override
    public Participant_actualPropertySet specification() {
      return Participant_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Participant_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Participant_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Participant_actualPropertySet.Match {
    ...
    private static final class Immutable extends Participant_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Participant_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Participant_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Participant_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Participant_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Participant_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Participant_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Participant_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Participant_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Participant_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Participant_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Participant_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_actualPropertySet.Matcher> querySpecification() {
      return Participant_actualPropertySet.instance();
    }
  }
  
  private Participant_actualPropertySet() {
   ...
   * 
   */
  public static Participant_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Participant_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Participant_actualPropertySet.Matcher instantiate() {
    return Participant_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Participant_actualPropertySet.Match newEmptyMatch() {
    return Participant_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_actualPropertySet.Match newMatch(final Object... parameters) {
    return Participant_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_actualPropertySet INSTANCE = new Participant_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
