...
public final class Service_propertySet extends BaseGeneratedEMFQuerySpecification<Service_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Service_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Service_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Service_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Service_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Service_propertySet.Match)) {
          Service_propertySet.Match other = (Service_propertySet.Match) obj;
    ...
    @Override
    public Service_propertySet specification() {
      return Service_propertySet.instance();
    }
     ...
     * 
     */
    public static Service_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Service_propertySet.Match newMutableMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public static Service_propertySet.Match newMatch(final Port pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Service_propertySet.Match {
    ...
    private static final class Immutable extends Service_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Service_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Service_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Service_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Service_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Service_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Service_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Service_propertySet.Match> getAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Service_propertySet.Match> streamAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Service_propertySet.Match> getOneArbitraryMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final Element pValue, final Consumer<? super Service_propertySet.Match> processor) {
     ...
     * 
     */
    public Service_propertySet.Match newMatch(final Port pElement, final Element pValue) {
      return Service_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Service_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Service_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Service_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Service_propertySet.Match partialMatch) {
    ...
    @Override
    protected Service_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Service_propertySet.Match.newMatch((Port) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Service_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Service_propertySet.Match.newMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Service_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Service_propertySet.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Service_propertySet.Matcher> querySpecification() {
      return Service_propertySet.instance();
    }
  }
  
  private Service_propertySet() {
   ...
   * 
   */
  public static Service_propertySet instance() {
    try{
  ...
  @Override
  protected Service_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Service_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Service_propertySet.Matcher instantiate() {
    return Service_propertySet.Matcher.create();
  }
  
  @Override
  public Service_propertySet.Match newEmptyMatch() {
    return Service_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Service_propertySet.Match newMatch(final Object... parameters) {
    return Service_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Service_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Service_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Service_propertySet INSTANCE = new Service_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Service_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
