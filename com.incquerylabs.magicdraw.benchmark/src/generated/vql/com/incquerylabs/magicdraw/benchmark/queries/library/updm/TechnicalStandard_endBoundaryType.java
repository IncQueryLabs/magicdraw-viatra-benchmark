...
public final class TechnicalStandard_endBoundaryType extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_endBoundaryType.Match)) {
          TechnicalStandard_endBoundaryType.Match other = (TechnicalStandard_endBoundaryType.Match) obj;
    ...
    @Override
    public TechnicalStandard_endBoundaryType specification() {
      return TechnicalStandard_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static TechnicalStandard_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TechnicalStandard_endBoundaryType.Match {
    ...
    private static final class Immutable extends TechnicalStandard_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TechnicalStandard_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TechnicalStandard_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super TechnicalStandard_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return TechnicalStandard_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TechnicalStandard_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TechnicalStandard_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TechnicalStandard_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_endBoundaryType.Matcher> querySpecification() {
      return TechnicalStandard_endBoundaryType.instance();
    }
  }
  
  private TechnicalStandard_endBoundaryType() {
   ...
   * 
   */
  public static TechnicalStandard_endBoundaryType instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_endBoundaryType.Matcher instantiate() {
    return TechnicalStandard_endBoundaryType.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_endBoundaryType.Match newEmptyMatch() {
    return TechnicalStandard_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_endBoundaryType.Match newMatch(final Object... parameters) {
    return TechnicalStandard_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_endBoundaryType INSTANCE = new TechnicalStandard_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
