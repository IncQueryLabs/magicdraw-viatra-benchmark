...
public final class ResourcePerformer_physicalLocation extends BaseGeneratedEMFQuerySpecification<ResourcePerformer_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourcePerformer_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public ResourcePerformer_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourcePerformer_physicalLocation.Match)) {
          ResourcePerformer_physicalLocation.Match other = (ResourcePerformer_physicalLocation.Match) obj;
    ...
    @Override
    public ResourcePerformer_physicalLocation specification() {
      return ResourcePerformer_physicalLocation.instance();
    }
     ...
     * 
     */
    public static ResourcePerformer_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourcePerformer_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourcePerformer_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourcePerformer_physicalLocation.Match {
    ...
    private static final class Immutable extends ResourcePerformer_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see ResourcePerformer_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<ResourcePerformer_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static ResourcePerformer_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourcePerformer_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourcePerformer_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ResourcePerformer_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourcePerformer_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourcePerformer_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourcePerformer_physicalLocation.Match> processor) {
     ...
     * 
     */
    public ResourcePerformer_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourcePerformer_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourcePerformer_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourcePerformer_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourcePerformer_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourcePerformer_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected ResourcePerformer_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ResourcePerformer_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourcePerformer_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ResourcePerformer_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourcePerformer_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourcePerformer_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourcePerformer_physicalLocation.Matcher> querySpecification() {
      return ResourcePerformer_physicalLocation.instance();
    }
  }
  
  private ResourcePerformer_physicalLocation() {
   ...
   * 
   */
  public static ResourcePerformer_physicalLocation instance() {
    try{
  ...
  @Override
  protected ResourcePerformer_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourcePerformer_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public ResourcePerformer_physicalLocation.Matcher instantiate() {
    return ResourcePerformer_physicalLocation.Matcher.create();
  }
  
  @Override
  public ResourcePerformer_physicalLocation.Match newEmptyMatch() {
    return ResourcePerformer_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ResourcePerformer_physicalLocation.Match newMatch(final Object... parameters) {
    return ResourcePerformer_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourcePerformer_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourcePerformer_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourcePerformer_physicalLocation INSTANCE = new ResourcePerformer_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourcePerformer_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
