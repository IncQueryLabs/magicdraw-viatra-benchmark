...
public final class OrganizationalResource_physicalLocation extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_physicalLocation.Match)) {
          OrganizationalResource_physicalLocation.Match other = (OrganizationalResource_physicalLocation.Match) obj;
    ...
    @Override
    public OrganizationalResource_physicalLocation specification() {
      return OrganizationalResource_physicalLocation.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_physicalLocation.Match {
    ...
    private static final class Immutable extends OrganizationalResource_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_physicalLocation.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_physicalLocation.Matcher> querySpecification() {
      return OrganizationalResource_physicalLocation.instance();
    }
  }
  
  private OrganizationalResource_physicalLocation() {
   ...
   * 
   */
  public static OrganizationalResource_physicalLocation instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_physicalLocation.Matcher instantiate() {
    return OrganizationalResource_physicalLocation.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_physicalLocation.Match newEmptyMatch() {
    return OrganizationalResource_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_physicalLocation.Match newMatch(final Object... parameters) {
    return OrganizationalResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_physicalLocation INSTANCE = new OrganizationalResource_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
