 ...
 *         pattern SharedProperty(Element : Property, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "SharedProperty");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class SharedProperty extends BaseGeneratedEMFQuerySpecification<SharedProperty.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static SharedProperty.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static SharedProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<SharedProperty.Match> {
     ...
     * 
     */
    public Collection<SharedProperty.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<SharedProperty.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<SharedProperty.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super SharedProperty.Match> processor) {
     ...
     * 
     */
    public SharedProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return SharedProperty.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final SharedProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final SharedProperty.Match partialMatch) {
    ...
    protected SharedProperty.Match tupleToMatch(final Tuple t) {
      try {
          return SharedProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected SharedProperty.Match arrayToMatch(final Object[] match) {
      try {
          return SharedProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected SharedProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SharedProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public SharedProperty.Match newMatch(final Object... parameters) {
    return SharedProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
