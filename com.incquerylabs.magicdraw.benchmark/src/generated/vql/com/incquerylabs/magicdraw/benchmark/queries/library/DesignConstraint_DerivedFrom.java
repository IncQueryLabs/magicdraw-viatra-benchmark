...
public final class DesignConstraint_DerivedFrom extends BaseGeneratedEMFQuerySpecification<DesignConstraint_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint_DerivedFrom.Match)) {
          DesignConstraint_DerivedFrom.Match other = (DesignConstraint_DerivedFrom.Match) obj;
    ...
    @Override
    public DesignConstraint_DerivedFrom specification() {
     ...
     * 
     */
    public static DesignConstraint_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static DesignConstraint_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DesignConstraint_DerivedFrom.Match {
    ...
    private static final class Immutable extends DesignConstraint_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<DesignConstraint_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<DesignConstraint_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super DesignConstraint_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public DesignConstraint_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return DesignConstraint_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final DesignConstraint_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final DesignConstraint_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final DesignConstraint_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final DesignConstraint_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected DesignConstraint_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint_DerivedFrom.Matcher> querySpecification() {
      return DesignConstraint_DerivedFrom.instance();
    }
  }
  
  private DesignConstraint_DerivedFrom() {
   ...
   * 
   */
  public static DesignConstraint_DerivedFrom instance() {
    try{
  ...
  @Override
  protected DesignConstraint_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint_DerivedFrom.Matcher instantiate() {
    return DesignConstraint_DerivedFrom.Matcher.create();
  }
  
  @Override
  public DesignConstraint_DerivedFrom.Match newEmptyMatch() {
    return DesignConstraint_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint_DerivedFrom.Match newMatch(final Object... parameters) {
    return DesignConstraint_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DesignConstraint_DerivedFrom} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DesignConstraint_DerivedFrom#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesignConstraint_DerivedFrom INSTANCE = new DesignConstraint_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find designConstraint(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), DesignConstraint.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "DerivedFrom", taggedValue)
