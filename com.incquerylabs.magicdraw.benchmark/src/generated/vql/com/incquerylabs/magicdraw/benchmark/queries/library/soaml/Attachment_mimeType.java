...
public final class Attachment_mimeType extends BaseGeneratedEMFQuerySpecification<Attachment_mimeType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Attachment_mimeType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Attachment_mimeType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Attachment_mimeType.Match.parameterNames;
    }
    ...
    @Override
    public Attachment_mimeType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Attachment_mimeType.Match)) {
          Attachment_mimeType.Match other = (Attachment_mimeType.Match) obj;
    ...
    @Override
    public Attachment_mimeType specification() {
     ...
     * 
     */
    public static Attachment_mimeType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Attachment_mimeType.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Attachment_mimeType.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Attachment_mimeType.Match {
    ...
    private static final class Immutable extends Attachment_mimeType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Attachment_mimeType pattern,
   ...
   * 
   * @see Match
   * @see Attachment_mimeType
   * 
   */
  public static class Matcher extends BaseMatcher<Attachment_mimeType.Match> {
    /**
     ...
     * 
     */
    public static Attachment_mimeType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Attachment_mimeType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Attachment_mimeType.Matcher.class);
     ...
     * 
     */
    public Collection<Attachment_mimeType.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Attachment_mimeType.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Attachment_mimeType.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super Attachment_mimeType.Match> processor) {
     ...
     * 
     */
    public Attachment_mimeType.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return Attachment_mimeType.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Attachment_mimeType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Attachment_mimeType.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Attachment_mimeType.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Attachment_mimeType.Match partialMatch) {
    ...
    @Override
    protected Attachment_mimeType.Match tupleToMatch(final Tuple t) {
      try {
          return Attachment_mimeType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Attachment_mimeType.Match arrayToMatch(final Object[] match) {
      try {
          return Attachment_mimeType.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Attachment_mimeType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Attachment_mimeType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Attachment_mimeType.Matcher> querySpecification() {
      return Attachment_mimeType.instance();
    }
  }
  
  private Attachment_mimeType() {
   ...
   * 
   */
  public static Attachment_mimeType instance() {
    try{
  ...
  @Override
  protected Attachment_mimeType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Attachment_mimeType.Matcher.on(engine);
  }
  
  @Override
  public Attachment_mimeType.Matcher instantiate() {
    return Attachment_mimeType.Matcher.create();
  }
  
  @Override
  public Attachment_mimeType.Match newEmptyMatch() {
    return Attachment_mimeType.Match.newEmptyMatch();
  }
  
  @Override
  public Attachment_mimeType.Match newMatch(final Object... parameters) {
    return Attachment_mimeType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Attachment_mimeType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Attachment_mimeType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Attachment_mimeType INSTANCE = new Attachment_mimeType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Attachment_mimeType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "mimeType");
