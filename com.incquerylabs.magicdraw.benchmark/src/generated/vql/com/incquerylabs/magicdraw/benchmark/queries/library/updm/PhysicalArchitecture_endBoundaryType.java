...
public final class PhysicalArchitecture_endBoundaryType extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_endBoundaryType.Match)) {
          PhysicalArchitecture_endBoundaryType.Match other = (PhysicalArchitecture_endBoundaryType.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_endBoundaryType specification() {
      return PhysicalArchitecture_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_endBoundaryType.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_endBoundaryType.Matcher> querySpecification() {
      return PhysicalArchitecture_endBoundaryType.instance();
    }
  }
  
  private PhysicalArchitecture_endBoundaryType() {
   ...
   * 
   */
  public static PhysicalArchitecture_endBoundaryType instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_endBoundaryType.Matcher instantiate() {
    return PhysicalArchitecture_endBoundaryType.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_endBoundaryType.Match newEmptyMatch() {
    return PhysicalArchitecture_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_endBoundaryType.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_endBoundaryType INSTANCE = new PhysicalArchitecture_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
