...
public final class ActualProperty_endDate extends BaseGeneratedEMFQuerySpecification<ActualProperty_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProperty_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualProperty_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProperty_endDate.Match)) {
          ActualProperty_endDate.Match other = (ActualProperty_endDate.Match) obj;
    ...
    @Override
    public ActualProperty_endDate specification() {
      return ActualProperty_endDate.instance();
    }
     ...
     * 
     */
    public static ActualProperty_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProperty_endDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProperty_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProperty_endDate.Match {
    ...
    private static final class Immutable extends ActualProperty_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualProperty_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProperty_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualProperty_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProperty_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProperty_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProperty_endDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProperty_endDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProperty_endDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProperty_endDate.Match> processor) {
     ...
     * 
     */
    public ActualProperty_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProperty_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProperty_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProperty_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProperty_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProperty_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualProperty_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProperty_endDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProperty_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProperty_endDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProperty_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProperty_endDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProperty_endDate.Matcher> querySpecification() {
      return ActualProperty_endDate.instance();
    }
  }
  
  private ActualProperty_endDate() {
   ...
   * 
   */
  public static ActualProperty_endDate instance() {
    try{
  ...
  @Override
  protected ActualProperty_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProperty_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualProperty_endDate.Matcher instantiate() {
    return ActualProperty_endDate.Matcher.create();
  }
  
  @Override
  public ActualProperty_endDate.Match newEmptyMatch() {
    return ActualProperty_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProperty_endDate.Match newMatch(final Object... parameters) {
    return ActualProperty_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProperty_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProperty_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProperty_endDate INSTANCE = new ActualProperty_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProperty_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
