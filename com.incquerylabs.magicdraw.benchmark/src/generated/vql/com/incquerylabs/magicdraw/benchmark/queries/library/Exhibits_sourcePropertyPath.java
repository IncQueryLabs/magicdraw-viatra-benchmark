...
public final class Exhibits_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<Exhibits_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Exhibits_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Exhibits_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Exhibits_sourcePropertyPath.Match)) {
          Exhibits_sourcePropertyPath.Match other = (Exhibits_sourcePropertyPath.Match) obj;
    ...
    @Override
    public Exhibits_sourcePropertyPath specification() {
      return Exhibits_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static Exhibits_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Exhibits_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Exhibits_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Exhibits_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends Exhibits_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Exhibits_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Exhibits_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Exhibits_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Exhibits_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Exhibits_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Exhibits_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Exhibits_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Exhibits_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Exhibits_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public Exhibits_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Exhibits_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Exhibits_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Exhibits_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Exhibits_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Exhibits_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected Exhibits_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Exhibits_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Exhibits_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Exhibits_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Exhibits_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Exhibits_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Exhibits_sourcePropertyPath.Matcher> querySpecification() {
      return Exhibits_sourcePropertyPath.instance();
    }
  }
  
  private Exhibits_sourcePropertyPath() {
   ...
   * 
   */
  public static Exhibits_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected Exhibits_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Exhibits_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Exhibits_sourcePropertyPath.Matcher instantiate() {
    return Exhibits_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public Exhibits_sourcePropertyPath.Match newEmptyMatch() {
    return Exhibits_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Exhibits_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return Exhibits_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Exhibits_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Exhibits_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Exhibits_sourcePropertyPath INSTANCE = new Exhibits_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Exhibits_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
