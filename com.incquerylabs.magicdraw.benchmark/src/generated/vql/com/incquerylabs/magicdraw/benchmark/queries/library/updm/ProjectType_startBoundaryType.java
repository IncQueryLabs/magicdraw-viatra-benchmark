...
public final class ProjectType_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectType_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectType_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectType_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectType_startBoundaryType.Match)) {
          ProjectType_startBoundaryType.Match other = (ProjectType_startBoundaryType.Match) obj;
    ...
    @Override
    public ProjectType_startBoundaryType specification() {
      return ProjectType_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectType_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectType_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectType_startBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectType_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectType_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectType_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectType_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectType_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectType_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectType_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectType_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectType_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectType_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectType_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectType_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectType_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectType_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectType_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectType_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectType_startBoundaryType.Matcher> querySpecification() {
      return ProjectType_startBoundaryType.instance();
    }
  }
  
  private ProjectType_startBoundaryType() {
   ...
   * 
   */
  public static ProjectType_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectType_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectType_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectType_startBoundaryType.Matcher instantiate() {
    return ProjectType_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectType_startBoundaryType.Match newEmptyMatch() {
    return ProjectType_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectType_startBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectType_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectType_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectType_startBoundaryType INSTANCE = new ProjectType_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectType_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
