...
public final class CapabilityProperty_URI extends BaseGeneratedEMFQuerySpecification<CapabilityProperty_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty_URI.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty_URI.Match)) {
          CapabilityProperty_URI.Match other = (CapabilityProperty_URI.Match) obj;
    ...
    @Override
    public CapabilityProperty_URI specification() {
      return CapabilityProperty_URI.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static CapabilityProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends CapabilityProperty_URI.Match {
    ...
    private static final class Immutable extends CapabilityProperty_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_URI pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty_URI
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty_URI.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty_URI.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<CapabilityProperty_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<CapabilityProperty_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super CapabilityProperty_URI.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return CapabilityProperty_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final CapabilityProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final CapabilityProperty_URI.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty_URI.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected CapabilityProperty_URI.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty_URI.Matcher> querySpecification() {
      return CapabilityProperty_URI.instance();
    }
  }
  
  private CapabilityProperty_URI() {
   ...
   * 
   */
  public static CapabilityProperty_URI instance() {
    try{
  ...
  @Override
  protected CapabilityProperty_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty_URI.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty_URI.Matcher instantiate() {
    return CapabilityProperty_URI.Matcher.create();
  }
  
  @Override
  public CapabilityProperty_URI.Match newEmptyMatch() {
    return CapabilityProperty_URI.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty_URI.Match newMatch(final Object... parameters) {
    return CapabilityProperty_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty_URI INSTANCE = new CapabilityProperty_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
