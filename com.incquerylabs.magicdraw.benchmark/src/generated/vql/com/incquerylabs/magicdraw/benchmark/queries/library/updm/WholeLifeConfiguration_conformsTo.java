...
public final class WholeLifeConfiguration_conformsTo extends BaseGeneratedEMFQuerySpecification<WholeLifeConfiguration_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeConfiguration_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeConfiguration_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeConfiguration_conformsTo.Match)) {
          WholeLifeConfiguration_conformsTo.Match other = (WholeLifeConfiguration_conformsTo.Match) obj;
    ...
    @Override
    public WholeLifeConfiguration_conformsTo specification() {
      return WholeLifeConfiguration_conformsTo.instance();
    }
     ...
     * 
     */
    public static WholeLifeConfiguration_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeConfiguration_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeConfiguration_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeConfiguration_conformsTo.Match {
    ...
    private static final class Immutable extends WholeLifeConfiguration_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeConfiguration_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeConfiguration_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeConfiguration_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeConfiguration_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeConfiguration_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeConfiguration_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeConfiguration_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeConfiguration_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeConfiguration_conformsTo.Match> processor) {
     ...
     * 
     */
    public WholeLifeConfiguration_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeConfiguration_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeConfiguration_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeConfiguration_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeConfiguration_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeConfiguration_conformsTo.Match partialMatch) {
    ...
    @Override
    protected WholeLifeConfiguration_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeConfiguration_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeConfiguration_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeConfiguration_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeConfiguration_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeConfiguration_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeConfiguration_conformsTo.Matcher> querySpecification() {
      return WholeLifeConfiguration_conformsTo.instance();
    }
  }
  
  private WholeLifeConfiguration_conformsTo() {
   ...
   * 
   */
  public static WholeLifeConfiguration_conformsTo instance() {
    try{
  ...
  @Override
  protected WholeLifeConfiguration_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeConfiguration_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeConfiguration_conformsTo.Matcher instantiate() {
    return WholeLifeConfiguration_conformsTo.Matcher.create();
  }
  
  @Override
  public WholeLifeConfiguration_conformsTo.Match newEmptyMatch() {
    return WholeLifeConfiguration_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeConfiguration_conformsTo.Match newMatch(final Object... parameters) {
    return WholeLifeConfiguration_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeConfiguration_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeConfiguration_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeConfiguration_conformsTo INSTANCE = new WholeLifeConfiguration_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeConfiguration_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
