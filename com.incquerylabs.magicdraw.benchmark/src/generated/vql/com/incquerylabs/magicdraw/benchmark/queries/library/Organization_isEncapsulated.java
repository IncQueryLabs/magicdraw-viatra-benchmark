...
public final class Organization_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Organization_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Organization_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Organization_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_isEncapsulated.Match)) {
          Organization_isEncapsulated.Match other = (Organization_isEncapsulated.Match) obj;
    ...
    @Override
    public Organization_isEncapsulated specification() {
      return Organization_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Organization_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Organization_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Organization_isEncapsulated.Match {
    ...
    private static final class Immutable extends Organization_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Organization_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Organization_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Organization_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Organization_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Organization_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Organization_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Organization_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Organization_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Organization_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Organization_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Organization_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_isEncapsulated.Matcher> querySpecification() {
      return Organization_isEncapsulated.instance();
    }
  }
  
  private Organization_isEncapsulated() {
   ...
   * 
   */
  public static Organization_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Organization_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Organization_isEncapsulated.Matcher instantiate() {
    return Organization_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Organization_isEncapsulated.Match newEmptyMatch() {
    return Organization_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_isEncapsulated.Match newMatch(final Object... parameters) {
    return Organization_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_isEncapsulated INSTANCE = new Organization_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
