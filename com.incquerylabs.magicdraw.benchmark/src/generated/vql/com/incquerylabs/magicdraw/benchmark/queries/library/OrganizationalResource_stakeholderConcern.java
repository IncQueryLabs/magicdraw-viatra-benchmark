...
public final class OrganizationalResource_stakeholderConcern extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_stakeholderConcern.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_stakeholderConcern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_stakeholderConcern";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_stakeholderConcern.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_stakeholderConcern.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_stakeholderConcern.Match)) {
          OrganizationalResource_stakeholderConcern.Match other = (OrganizationalResource_stakeholderConcern.Match) obj;
    ...
    @Override
    public OrganizationalResource_stakeholderConcern specification() {
      return OrganizationalResource_stakeholderConcern.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_stakeholderConcern.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_stakeholderConcern.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_stakeholderConcern.Match {
    ...
    private static final class Immutable extends OrganizationalResource_stakeholderConcern.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_stakeholderConcern pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_stakeholderConcern
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_stakeholderConcern.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_stakeholderConcern.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_stakeholderConcern.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_stakeholderConcern.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_stakeholderConcern.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_stakeholderConcern.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_stakeholderConcern.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_stakeholderConcern.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_stakeholderConcern.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_stakeholderConcern.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_stakeholderConcern.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_stakeholderConcern.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_stakeholderConcern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_stakeholderConcern.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_stakeholderConcern.Matcher> querySpecification() {
      return OrganizationalResource_stakeholderConcern.instance();
    }
  }
  
  private OrganizationalResource_stakeholderConcern() {
   ...
   * 
   */
  public static OrganizationalResource_stakeholderConcern instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_stakeholderConcern.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_stakeholderConcern.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_stakeholderConcern.Matcher instantiate() {
    return OrganizationalResource_stakeholderConcern.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_stakeholderConcern.Match newEmptyMatch() {
    return OrganizationalResource_stakeholderConcern.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_stakeholderConcern.Match newMatch(final Object... parameters) {
    return OrganizationalResource_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_stakeholderConcern} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_stakeholderConcern#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_stakeholderConcern INSTANCE = new OrganizationalResource_stakeholderConcern();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_stakeholderConcern.GeneratedPQuery INSTANCE = new GeneratedPQuery();
