...
public final class ActualResourceRole_startDate extends BaseGeneratedEMFQuerySpecification<ActualResourceRole_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualResourceRole_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualResourceRole_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualResourceRole_startDate.Match)) {
          ActualResourceRole_startDate.Match other = (ActualResourceRole_startDate.Match) obj;
    ...
    @Override
    public ActualResourceRole_startDate specification() {
      return ActualResourceRole_startDate.instance();
    }
     ...
     * 
     */
    public static ActualResourceRole_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualResourceRole_startDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualResourceRole_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualResourceRole_startDate.Match {
    ...
    private static final class Immutable extends ActualResourceRole_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole_startDate pattern,
   ...
   * 
   * @see Match
   * @see ActualResourceRole_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualResourceRole_startDate.Match> {
    /**
     ...
     * 
     */
    public static ActualResourceRole_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualResourceRole_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualResourceRole_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualResourceRole_startDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualResourceRole_startDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualResourceRole_startDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualResourceRole_startDate.Match> processor) {
     ...
     * 
     */
    public ActualResourceRole_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualResourceRole_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualResourceRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualResourceRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualResourceRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualResourceRole_startDate.Match partialMatch) {
    ...
    @Override
    protected ActualResourceRole_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualResourceRole_startDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualResourceRole_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualResourceRole_startDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualResourceRole_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualResourceRole_startDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualResourceRole_startDate.Matcher> querySpecification() {
      return ActualResourceRole_startDate.instance();
    }
  }
  
  private ActualResourceRole_startDate() {
   ...
   * 
   */
  public static ActualResourceRole_startDate instance() {
    try{
  ...
  @Override
  protected ActualResourceRole_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualResourceRole_startDate.Matcher.on(engine);
  }
  
  @Override
  public ActualResourceRole_startDate.Matcher instantiate() {
    return ActualResourceRole_startDate.Matcher.create();
  }
  
  @Override
  public ActualResourceRole_startDate.Match newEmptyMatch() {
    return ActualResourceRole_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualResourceRole_startDate.Match newMatch(final Object... parameters) {
    return ActualResourceRole_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualResourceRole_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualResourceRole_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualResourceRole_startDate INSTANCE = new ActualResourceRole_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualResourceRole_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
