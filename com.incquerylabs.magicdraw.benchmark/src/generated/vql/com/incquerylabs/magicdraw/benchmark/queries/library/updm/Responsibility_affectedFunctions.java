...
public final class Responsibility_affectedFunctions extends BaseGeneratedEMFQuerySpecification<Responsibility_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_affectedFunctions.Match)) {
          Responsibility_affectedFunctions.Match other = (Responsibility_affectedFunctions.Match) obj;
    ...
    @Override
    public Responsibility_affectedFunctions specification() {
      return Responsibility_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static Responsibility_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_affectedFunctions.Match {
    ...
    private static final class Immutable extends Responsibility_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public Responsibility_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected Responsibility_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_affectedFunctions.Matcher> querySpecification() {
      return Responsibility_affectedFunctions.instance();
    }
  }
  
  private Responsibility_affectedFunctions() {
   ...
   * 
   */
  public static Responsibility_affectedFunctions instance() {
    try{
  ...
  @Override
  protected Responsibility_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_affectedFunctions.Matcher instantiate() {
    return Responsibility_affectedFunctions.Matcher.create();
  }
  
  @Override
  public Responsibility_affectedFunctions.Match newEmptyMatch() {
    return Responsibility_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_affectedFunctions.Match newMatch(final Object... parameters) {
    return Responsibility_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_affectedFunctions INSTANCE = new Responsibility_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
