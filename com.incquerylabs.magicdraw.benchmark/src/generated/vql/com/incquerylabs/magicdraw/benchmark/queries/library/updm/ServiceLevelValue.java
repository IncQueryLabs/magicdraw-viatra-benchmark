...
public final class ServiceLevelValue extends BaseGeneratedEMFQuerySpecification<ServiceLevelValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceLevelValue.Match.parameterNames;
    }
    ...
    @Override
    public ServiceLevelValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceLevelValue.Match)) {
          ServiceLevelValue.Match other = (ServiceLevelValue.Match) obj;
    ...
    @Override
    public ServiceLevelValue specification() {
      return ServiceLevelValue.instance();
    }
     ...
     * 
     */
    public static ServiceLevelValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceLevelValue.Match newMutableMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ServiceLevelValue.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ServiceLevelValue.Match {
    ...
    private static final class Immutable extends ServiceLevelValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue pattern,
   ...
   * 
   * @see Match
   * @see ServiceLevelValue
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceLevelValue.Match> {
    /**
     ...
     * 
     */
    public static ServiceLevelValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceLevelValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceLevelValue.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceLevelValue.Match> getAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ServiceLevelValue.Match> streamAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ServiceLevelValue.Match> getOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ServiceLevelValue.Match> processor) {
     ...
     * 
     */
    public ServiceLevelValue.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ServiceLevelValue.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ServiceLevelValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ServiceLevelValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ServiceLevelValue.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ServiceLevelValue.Match partialMatch) {
    ...
    @Override
    protected ServiceLevelValue.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceLevelValue.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ServiceLevelValue.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceLevelValue.Match.newMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceLevelValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceLevelValue.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceLevelValue.Matcher> querySpecification() {
      return ServiceLevelValue.instance();
    }
  }
  
  private ServiceLevelValue() {
   ...
   * 
   */
  public static ServiceLevelValue instance() {
    try{
  ...
  @Override
  protected ServiceLevelValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceLevelValue.Matcher.on(engine);
  }
  
  @Override
  public ServiceLevelValue.Matcher instantiate() {
    return ServiceLevelValue.Matcher.create();
  }
  
  @Override
  public ServiceLevelValue.Match newEmptyMatch() {
    return ServiceLevelValue.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceLevelValue.Match newMatch(final Object... parameters) {
    return ServiceLevelValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceLevelValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceLevelValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceLevelValue INSTANCE = new ServiceLevelValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceLevelValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ServiceLevelValue");
