...
public final class CompetenceRequirer extends BaseGeneratedEMFQuerySpecification<CompetenceRequirer.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CompetenceRequirer pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CompetenceRequirer";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceRequirer.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceRequirer.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceRequirer.Match)) {
          CompetenceRequirer.Match other = (CompetenceRequirer.Match) obj;
    ...
    @Override
    public CompetenceRequirer specification() {
      return CompetenceRequirer.instance();
    }
     ...
     * 
     */
    public static CompetenceRequirer.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceRequirer.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static CompetenceRequirer.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends CompetenceRequirer.Match {
    ...
    private static final class Immutable extends CompetenceRequirer.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CompetenceRequirer pattern,
   ...
   * 
   * @see Match
   * @see CompetenceRequirer
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceRequirer.Match> {
    /**
     ...
     * 
     */
    public static CompetenceRequirer.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceRequirer.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceRequirer.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceRequirer.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<CompetenceRequirer.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<CompetenceRequirer.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super CompetenceRequirer.Match> processor) {
     ...
     * 
     */
    public CompetenceRequirer.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return CompetenceRequirer.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final CompetenceRequirer.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final CompetenceRequirer.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final CompetenceRequirer.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final CompetenceRequirer.Match partialMatch) {
    ...
    @Override
    protected CompetenceRequirer.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceRequirer.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected CompetenceRequirer.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceRequirer.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceRequirer.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceRequirer.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceRequirer.Matcher> querySpecification() {
      return CompetenceRequirer.instance();
    }
  }
  
  private CompetenceRequirer() {
   ...
   * 
   */
  public static CompetenceRequirer instance() {
    try{
  ...
  @Override
  protected CompetenceRequirer.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceRequirer.Matcher.on(engine);
  }
  
  @Override
  public CompetenceRequirer.Matcher instantiate() {
    return CompetenceRequirer.Matcher.create();
  }
  
  @Override
  public CompetenceRequirer.Match newEmptyMatch() {
    return CompetenceRequirer.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceRequirer.Match newMatch(final Object... parameters) {
    return CompetenceRequirer.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceRequirer} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceRequirer#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceRequirer INSTANCE = new CompetenceRequirer();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceRequirer.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "CompetenceRequirer");
