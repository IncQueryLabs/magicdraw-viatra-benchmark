...
public final class CapabilityForTask_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<CapabilityForTask_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityForTask_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityForTask_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityForTask_sourcePropertyPath.Match)) {
          CapabilityForTask_sourcePropertyPath.Match other = (CapabilityForTask_sourcePropertyPath.Match) obj;
    ...
    @Override
    public CapabilityForTask_sourcePropertyPath specification() {
      return CapabilityForTask_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static CapabilityForTask_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityForTask_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static CapabilityForTask_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityForTask_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends CapabilityForTask_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see CapabilityForTask_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityForTask_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static CapabilityForTask_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityForTask_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityForTask_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityForTask_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<CapabilityForTask_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<CapabilityForTask_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super CapabilityForTask_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public CapabilityForTask_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return CapabilityForTask_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CapabilityForTask_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CapabilityForTask_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final CapabilityForTask_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final CapabilityForTask_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected CapabilityForTask_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityForTask_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityForTask_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityForTask_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityForTask_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityForTask_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityForTask_sourcePropertyPath.Matcher> querySpecification() {
      return CapabilityForTask_sourcePropertyPath.instance();
    }
  }
  
  private CapabilityForTask_sourcePropertyPath() {
   ...
   * 
   */
  public static CapabilityForTask_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected CapabilityForTask_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityForTask_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public CapabilityForTask_sourcePropertyPath.Matcher instantiate() {
    return CapabilityForTask_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public CapabilityForTask_sourcePropertyPath.Match newEmptyMatch() {
    return CapabilityForTask_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityForTask_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return CapabilityForTask_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityForTask_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityForTask_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityForTask_sourcePropertyPath INSTANCE = new CapabilityForTask_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityForTask_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
