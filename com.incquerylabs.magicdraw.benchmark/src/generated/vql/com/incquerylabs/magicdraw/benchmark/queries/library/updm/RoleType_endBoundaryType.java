...
public final class RoleType_endBoundaryType extends BaseGeneratedEMFQuerySpecification<RoleType_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_endBoundaryType.Match)) {
          RoleType_endBoundaryType.Match other = (RoleType_endBoundaryType.Match) obj;
    ...
    @Override
    public RoleType_endBoundaryType specification() {
      return RoleType_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static RoleType_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_endBoundaryType.Match {
    ...
    private static final class Immutable extends RoleType_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see RoleType_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static RoleType_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public RoleType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected RoleType_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_endBoundaryType.Matcher> querySpecification() {
      return RoleType_endBoundaryType.instance();
    }
  }
  
  private RoleType_endBoundaryType() {
   ...
   * 
   */
  public static RoleType_endBoundaryType instance() {
    try{
  ...
  @Override
  protected RoleType_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public RoleType_endBoundaryType.Matcher instantiate() {
    return RoleType_endBoundaryType.Matcher.create();
  }
  
  @Override
  public RoleType_endBoundaryType.Match newEmptyMatch() {
    return RoleType_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_endBoundaryType.Match newMatch(final Object... parameters) {
    return RoleType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_endBoundaryType INSTANCE = new RoleType_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
