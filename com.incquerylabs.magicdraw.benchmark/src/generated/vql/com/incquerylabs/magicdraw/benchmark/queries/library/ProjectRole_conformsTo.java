...
public final class ProjectRole_conformsTo extends BaseGeneratedEMFQuerySpecification<ProjectRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ProjectRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectRole_conformsTo.Match)) {
          ProjectRole_conformsTo.Match other = (ProjectRole_conformsTo.Match) obj;
    ...
    @Override
    public ProjectRole_conformsTo specification() {
      return ProjectRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static ProjectRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectRole_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectRole_conformsTo.Match {
    ...
    private static final class Immutable extends ProjectRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ProjectRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ProjectRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectRole_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectRole_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectRole_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public ProjectRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ProjectRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectRole_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectRole_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectRole_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectRole_conformsTo.Matcher> querySpecification() {
      return ProjectRole_conformsTo.instance();
    }
  }
  
  private ProjectRole_conformsTo() {
   ...
   * 
   */
  public static ProjectRole_conformsTo instance() {
    try{
  ...
  @Override
  protected ProjectRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ProjectRole_conformsTo.Matcher instantiate() {
    return ProjectRole_conformsTo.Matcher.create();
  }
  
  @Override
  public ProjectRole_conformsTo.Match newEmptyMatch() {
    return ProjectRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectRole_conformsTo.Match newMatch(final Object... parameters) {
    return ProjectRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectRole_conformsTo INSTANCE = new ProjectRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
