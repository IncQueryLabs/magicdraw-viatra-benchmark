...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart;
...
public final class StructuralPart_actualPropertySet extends BaseGeneratedEMFQuerySpecification<StructuralPart_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return StructuralPart_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public StructuralPart_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StructuralPart_actualPropertySet.Match)) {
          StructuralPart_actualPropertySet.Match other = (StructuralPart_actualPropertySet.Match) obj;
    ...
    @Override
    public StructuralPart_actualPropertySet specification() {
      return StructuralPart_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static StructuralPart_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static StructuralPart_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static StructuralPart_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends StructuralPart_actualPropertySet.Match {
    ...
    private static final class Immutable extends StructuralPart_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see StructuralPart_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<StructuralPart_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static StructuralPart_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StructuralPart_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StructuralPart_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<StructuralPart_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<StructuralPart_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<StructuralPart_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super StructuralPart_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public StructuralPart_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return StructuralPart_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final StructuralPart_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final StructuralPart_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final StructuralPart_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final StructuralPart_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected StructuralPart_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return StructuralPart_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected StructuralPart_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return StructuralPart_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StructuralPart_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StructuralPart_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StructuralPart_actualPropertySet.Matcher> querySpecification() {
      return StructuralPart_actualPropertySet.instance();
    }
  }
  
  private StructuralPart_actualPropertySet() {
   ...
   * 
   */
  public static StructuralPart_actualPropertySet instance() {
    try{
  ...
  @Override
  protected StructuralPart_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return StructuralPart_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public StructuralPart_actualPropertySet.Matcher instantiate() {
    return StructuralPart_actualPropertySet.Matcher.create();
  }
  
  @Override
  public StructuralPart_actualPropertySet.Match newEmptyMatch() {
    return StructuralPart_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public StructuralPart_actualPropertySet.Match newMatch(final Object... parameters) {
    return StructuralPart_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StructuralPart_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StructuralPart_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StructuralPart_actualPropertySet INSTANCE = new StructuralPart_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StructuralPart_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
