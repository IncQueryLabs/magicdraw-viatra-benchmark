...
public final class Responsibility_actsUpon extends BaseGeneratedEMFQuerySpecification<Responsibility_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_actsUpon.Match)) {
          Responsibility_actsUpon.Match other = (Responsibility_actsUpon.Match) obj;
    ...
    @Override
    public Responsibility_actsUpon specification() {
      return Responsibility_actsUpon.instance();
    }
     ...
     * 
     */
    public static Responsibility_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_actsUpon.Match {
    ...
    private static final class Immutable extends Responsibility_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_actsUpon.Match> processor) {
     ...
     * 
     */
    public Responsibility_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_actsUpon.Match partialMatch) {
    ...
    @Override
    protected Responsibility_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_actsUpon.Matcher> querySpecification() {
      return Responsibility_actsUpon.instance();
    }
  }
  
  private Responsibility_actsUpon() {
   ...
   * 
   */
  public static Responsibility_actsUpon instance() {
    try{
  ...
  @Override
  protected Responsibility_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_actsUpon.Matcher instantiate() {
    return Responsibility_actsUpon.Matcher.create();
  }
  
  @Override
  public Responsibility_actsUpon.Match newEmptyMatch() {
    return Responsibility_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_actsUpon.Match newMatch(final Object... parameters) {
    return Responsibility_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_actsUpon INSTANCE = new Responsibility_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
