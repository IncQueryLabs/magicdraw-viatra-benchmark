...
public final class Desirer_URI extends BaseGeneratedEMFQuerySpecification<Desirer_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Desirer_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Desirer_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Desirer_URI.Match.parameterNames;
    }
    ...
    @Override
    public Desirer_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Desirer_URI.Match)) {
          Desirer_URI.Match other = (Desirer_URI.Match) obj;
    ...
    @Override
    public Desirer_URI specification() {
      return Desirer_URI.instance();
    }
     ...
     * 
     */
    public static Desirer_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Desirer_URI.Match newMutableMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Desirer_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Desirer_URI.Match {
    ...
    private static final class Immutable extends Desirer_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Desirer_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Desirer_URI.Match> {
    /**
     ...
     * 
     */
    public static Desirer_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Desirer_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Desirer_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Desirer_URI.Match> getAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Desirer_URI.Match> streamAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Desirer_URI.Match> getOneArbitraryMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final LiteralString pValuespec, final Consumer<? super Desirer_URI.Match> processor) {
     ...
     * 
     */
    public Desirer_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
      return Desirer_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Desirer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Desirer_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Desirer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Desirer_URI.Match partialMatch) {
    ...
    @Override
    protected Desirer_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Desirer_URI.Match.newMatch((Element) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Desirer_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Desirer_URI.Match.newMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Desirer_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Desirer_URI.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Desirer_URI.Matcher> querySpecification() {
      return Desirer_URI.instance();
    }
  }
   ...
   * 
   */
  public static Desirer_URI instance() {
    try{
  ...
  @Override
  protected Desirer_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Desirer_URI.Matcher.on(engine);
  }
  
  @Override
  public Desirer_URI.Matcher instantiate() {
    return Desirer_URI.Matcher.create();
  }
  
  @Override
  public Desirer_URI.Match newEmptyMatch() {
    return Desirer_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Desirer_URI.Match newMatch(final Object... parameters) {
    return Desirer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Desirer_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Desirer_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Desirer_URI INSTANCE = new Desirer_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Desirer_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
