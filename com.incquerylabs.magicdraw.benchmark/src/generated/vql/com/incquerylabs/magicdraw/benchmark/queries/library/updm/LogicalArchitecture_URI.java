...
public final class LogicalArchitecture_URI extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_URI.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_URI.Match)) {
          LogicalArchitecture_URI.Match other = (LogicalArchitecture_URI.Match) obj;
    ...
    @Override
    public LogicalArchitecture_URI specification() {
      return LogicalArchitecture_URI.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static LogicalArchitecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends LogicalArchitecture_URI.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_URI pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_URI
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_URI.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_URI.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super LogicalArchitecture_URI.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return LogicalArchitecture_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final LogicalArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final LogicalArchitecture_URI.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_URI.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected LogicalArchitecture_URI.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_URI.Matcher> querySpecification() {
      return LogicalArchitecture_URI.instance();
    }
  }
  
  private LogicalArchitecture_URI() {
   ...
   * 
   */
  public static LogicalArchitecture_URI instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_URI.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_URI.Matcher instantiate() {
    return LogicalArchitecture_URI.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_URI.Match newEmptyMatch() {
    return LogicalArchitecture_URI.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_URI.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_URI INSTANCE = new LogicalArchitecture_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
