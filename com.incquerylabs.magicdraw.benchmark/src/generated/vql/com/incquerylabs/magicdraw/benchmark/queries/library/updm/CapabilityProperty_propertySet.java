...
public final class CapabilityProperty_propertySet extends BaseGeneratedEMFQuerySpecification<CapabilityProperty_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty_propertySet.Match)) {
          CapabilityProperty_propertySet.Match other = (CapabilityProperty_propertySet.Match) obj;
    ...
    @Override
    public CapabilityProperty_propertySet specification() {
      return CapabilityProperty_propertySet.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityProperty_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityProperty_propertySet.Match {
    ...
    private static final class Immutable extends CapabilityProperty_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_propertySet pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty_propertySet.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityProperty_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityProperty_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super CapabilityProperty_propertySet.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return CapabilityProperty_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityProperty_propertySet.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityProperty_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty_propertySet.Matcher> querySpecification() {
      return CapabilityProperty_propertySet.instance();
    }
  }
  
  private CapabilityProperty_propertySet() {
   ...
   * 
   */
  public static CapabilityProperty_propertySet instance() {
    try{
  ...
  @Override
  protected CapabilityProperty_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty_propertySet.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty_propertySet.Matcher instantiate() {
    return CapabilityProperty_propertySet.Matcher.create();
  }
  
  @Override
  public CapabilityProperty_propertySet.Match newEmptyMatch() {
    return CapabilityProperty_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty_propertySet.Match newMatch(final Object... parameters) {
    return CapabilityProperty_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty_propertySet INSTANCE = new CapabilityProperty_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
