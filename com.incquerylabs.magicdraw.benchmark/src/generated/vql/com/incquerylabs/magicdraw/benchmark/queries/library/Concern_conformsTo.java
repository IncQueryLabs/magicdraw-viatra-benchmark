...
public final class Concern_conformsTo extends BaseGeneratedEMFQuerySpecification<Concern_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Concern_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Concern_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Concern_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Concern_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Concern_conformsTo.Match)) {
          Concern_conformsTo.Match other = (Concern_conformsTo.Match) obj;
    ...
    @Override
    public Concern_conformsTo specification() {
      return Concern_conformsTo.instance();
    }
     ...
     * 
     */
    public static Concern_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Concern_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Concern_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Concern_conformsTo.Match {
    ...
    private static final class Immutable extends Concern_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Concern_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Concern_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Concern_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Concern_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Concern_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Concern_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Concern_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Concern_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Concern_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Concern_conformsTo.Match> processor) {
     ...
     * 
     */
    public Concern_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Concern_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Concern_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Concern_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Concern_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Concern_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Concern_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Concern_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Concern_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Concern_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Concern_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Concern_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Concern_conformsTo.Matcher> querySpecification() {
      return Concern_conformsTo.instance();
    }
  }
  
  private Concern_conformsTo() {
   ...
   * 
   */
  public static Concern_conformsTo instance() {
    try{
  ...
  @Override
  protected Concern_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Concern_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Concern_conformsTo.Matcher instantiate() {
    return Concern_conformsTo.Matcher.create();
  }
  
  @Override
  public Concern_conformsTo.Match newEmptyMatch() {
    return Concern_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Concern_conformsTo.Match newMatch(final Object... parameters) {
    return Concern_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Concern_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Concern_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Concern_conformsTo INSTANCE = new Concern_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Concern_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
