...
import com.incquerylabs.magicdraw.benchmark.queries.library.Technology;
...
public final class Technology_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<Technology_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Technology_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Technology_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public Technology_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Technology_isStandardConfiguration.Match)) {
          Technology_isStandardConfiguration.Match other = (Technology_isStandardConfiguration.Match) obj;
    ...
    @Override
    public Technology_isStandardConfiguration specification() {
      return Technology_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static Technology_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Technology_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Technology_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Technology_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends Technology_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see Technology_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<Technology_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static Technology_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Technology_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Technology_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<Technology_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Technology_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Technology_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Technology_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public Technology_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Technology_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Technology_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Technology_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Technology_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Technology_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected Technology_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return Technology_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Technology_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return Technology_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Technology_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Technology_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Technology_isStandardConfiguration.Matcher> querySpecification() {
      return Technology_isStandardConfiguration.instance();
    }
  }
  
  private Technology_isStandardConfiguration() {
   ...
   * 
   */
  public static Technology_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected Technology_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Technology_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public Technology_isStandardConfiguration.Matcher instantiate() {
    return Technology_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public Technology_isStandardConfiguration.Match newEmptyMatch() {
    return Technology_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public Technology_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return Technology_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Technology_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Technology_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Technology_isStandardConfiguration INSTANCE = new Technology_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Technology_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Technology(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Technology.instance().getInternalQueryRepresentation());
