...
public final class System_actualPropertySet extends BaseGeneratedEMFQuerySpecification<System_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public System_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_actualPropertySet.Match)) {
          System_actualPropertySet.Match other = (System_actualPropertySet.Match) obj;
    ...
    @Override
    public System_actualPropertySet specification() {
      return System_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static System_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_actualPropertySet.Match {
    ...
    private static final class Immutable extends System_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see System_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<System_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static System_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<System_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public System_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected System_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return System_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return System_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_actualPropertySet.Matcher> querySpecification() {
      return System_actualPropertySet.instance();
    }
  }
  
  private System_actualPropertySet() {
   ...
   * 
   */
  public static System_actualPropertySet instance() {
    try{
  ...
  @Override
  protected System_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public System_actualPropertySet.Matcher instantiate() {
    return System_actualPropertySet.Matcher.create();
  }
  
  @Override
  public System_actualPropertySet.Match newEmptyMatch() {
    return System_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public System_actualPropertySet.Match newMatch(final Object... parameters) {
    return System_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_actualPropertySet INSTANCE = new System_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
