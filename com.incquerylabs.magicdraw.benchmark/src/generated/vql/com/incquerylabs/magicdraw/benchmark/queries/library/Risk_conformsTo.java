...
public final class Risk_conformsTo extends BaseGeneratedEMFQuerySpecification<Risk_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Risk_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Risk_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Risk_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Risk_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Risk_conformsTo.Match)) {
          Risk_conformsTo.Match other = (Risk_conformsTo.Match) obj;
    ...
    @Override
    public Risk_conformsTo specification() {
      return Risk_conformsTo.instance();
    }
     ...
     * 
     */
    public static Risk_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Risk_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Risk_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Risk_conformsTo.Match {
    ...
    private static final class Immutable extends Risk_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Risk_conformsTo pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Risk_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Risk_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Risk_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Risk_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Risk_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Risk_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Risk_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Risk_conformsTo.Match> processor) {
     ...
     * 
     */
    public Risk_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Risk_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Risk_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Risk_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Risk_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Risk_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Risk_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Risk_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Risk_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Risk_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Risk_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Risk_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Risk_conformsTo.Matcher> querySpecification() {
      return Risk_conformsTo.instance();
    }
  }
  
  private Risk_conformsTo() {
   ...
   * 
   */
  public static Risk_conformsTo instance() {
    try{
  ...
  @Override
  protected Risk_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Risk_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Risk_conformsTo.Matcher instantiate() {
    return Risk_conformsTo.Matcher.create();
  }
  
  @Override
  public Risk_conformsTo.Match newEmptyMatch() {
    return Risk_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Risk_conformsTo.Match newMatch(final Object... parameters) {
    return Risk_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Risk_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Risk_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Risk_conformsTo INSTANCE = new Risk_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Risk_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
