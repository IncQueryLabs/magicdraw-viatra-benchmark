...
public final class ValueTypeValuePropertyNotComposite extends BaseGeneratedEMFQuerySpecification<ValueTypeValuePropertyNotComposite.Matcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private class EmbeddedQuery354322623 extends BaseGeneratedEMFPQuery {
      ...
      public EmbeddedQuery354322623() {
        super(PVisibility.EMBEDDED);
      }
      
      @Override
      public String getFullyQualifiedName() {
        return GeneratedPQuery.this.getFullyQualifiedName() + "$354322623";
      }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new NegativePatternCall(body, Tuples.flatTupleOf(var_property, var__virtual_2_), new ValueTypeValuePropertyNotComposite.GeneratedPQuery.EmbeddedQuery354322623());
          bodies.add(body);
      }
      return bodies;
    }
