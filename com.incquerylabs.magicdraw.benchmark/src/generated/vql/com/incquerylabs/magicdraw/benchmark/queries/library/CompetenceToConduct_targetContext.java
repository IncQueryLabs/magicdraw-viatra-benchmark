...
public final class CompetenceToConduct_targetContext extends BaseGeneratedEMFQuerySpecification<CompetenceToConduct_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceToConduct_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceToConduct_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceToConduct_targetContext.Match)) {
          CompetenceToConduct_targetContext.Match other = (CompetenceToConduct_targetContext.Match) obj;
    ...
    @Override
    public CompetenceToConduct_targetContext specification() {
      return CompetenceToConduct_targetContext.instance();
    }
     ...
     * 
     */
    public static CompetenceToConduct_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceToConduct_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static CompetenceToConduct_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CompetenceToConduct_targetContext.Match {
    ...
    private static final class Immutable extends CompetenceToConduct_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_targetContext pattern,
   ...
   * 
   * @see Match
   * @see CompetenceToConduct_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceToConduct_targetContext.Match> {
    /**
     ...
     * 
     */
    public static CompetenceToConduct_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceToConduct_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceToConduct_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceToConduct_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<CompetenceToConduct_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<CompetenceToConduct_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super CompetenceToConduct_targetContext.Match> processor) {
     ...
     * 
     */
    public CompetenceToConduct_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return CompetenceToConduct_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceToConduct_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceToConduct_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final CompetenceToConduct_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final CompetenceToConduct_targetContext.Match partialMatch) {
    ...
    @Override
    protected CompetenceToConduct_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceToConduct_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected CompetenceToConduct_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceToConduct_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceToConduct_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceToConduct_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceToConduct_targetContext.Matcher> querySpecification() {
      return CompetenceToConduct_targetContext.instance();
    }
  }
  
  private CompetenceToConduct_targetContext() {
   ...
   * 
   */
  public static CompetenceToConduct_targetContext instance() {
    try{
  ...
  @Override
  protected CompetenceToConduct_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceToConduct_targetContext.Matcher.on(engine);
  }
  
  @Override
  public CompetenceToConduct_targetContext.Matcher instantiate() {
    return CompetenceToConduct_targetContext.Matcher.create();
  }
  
  @Override
  public CompetenceToConduct_targetContext.Match newEmptyMatch() {
    return CompetenceToConduct_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceToConduct_targetContext.Match newMatch(final Object... parameters) {
    return CompetenceToConduct_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceToConduct_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceToConduct_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceToConduct_targetContext INSTANCE = new CompetenceToConduct_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceToConduct_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
