...
public final class Viewpoint_concern extends BaseGeneratedEMFQuerySpecification<Viewpoint_concern.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Viewpoint_concern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Viewpoint_concern";
    }
    
    @Override
    public List<String> parameterNames() {
      return Viewpoint_concern.Match.parameterNames;
    }
    ...
    @Override
    public Viewpoint_concern specification() {
     ...
     * 
     */
    public static Viewpoint_concern.Match newEmptyMatch() {
     ...
     * 
     */
    public static Viewpoint_concern.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public static Viewpoint_concern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Viewpoint_concern pattern,
   ...
   * 
   * @see Match
   * @see Viewpoint_concern
   * 
   */
  public static class Matcher extends BaseMatcher<Viewpoint_concern.Match> {
    /**
     ...
     * 
     */
    public static Viewpoint_concern.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Viewpoint_concern.Matcher create() {
      return new Matcher();
    }
     ...
     * 
     */
    public Collection<Viewpoint_concern.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Stream<Viewpoint_concern.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Optional<Viewpoint_concern.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue, final Consumer<? super Viewpoint_concern.Match> processor) {
     ...
     * 
     */
    public Viewpoint_concern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final Viewpoint_concern.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final Viewpoint_concern.Match partialMatch) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final Viewpoint_concern.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final Viewpoint_concern.Match partialMatch) {
    ...
    protected Viewpoint_concern.Match tupleToMatch(final Tuple t) {
      try {
          return Viewpoint_concern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected Viewpoint_concern.Match arrayToMatch(final Object[] match) {
      try {
          return Viewpoint_concern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Viewpoint_concern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Viewpoint_concern.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Viewpoint_concern.Matcher> querySpecification() {
      return Viewpoint_concern.instance();
    }
  }
  
  private Viewpoint_concern() {
   ...
   * 
   */
  public static Viewpoint_concern instance() {
    try{
  ...
  @Override
  protected Viewpoint_concern.Matcher instantiate(final ViatraQueryEngine engine) {
    return Viewpoint_concern.Matcher.on(engine);
  }
  
  @Override
  public Viewpoint_concern.Matcher instantiate() {
    return Viewpoint_concern.Matcher.create();
  }
  
  @Override
  public Viewpoint_concern.Match newEmptyMatch() {
    return Viewpoint_concern.Match.newEmptyMatch();
  }
  
  @Override
  public Viewpoint_concern.Match newMatch(final Object... parameters) {
    return Viewpoint_concern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.String) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Viewpoint_concern} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Viewpoint_concern#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Viewpoint_concern INSTANCE = new Viewpoint_concern();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Viewpoint_concern.GeneratedPQuery INSTANCE = new GeneratedPQuery();
