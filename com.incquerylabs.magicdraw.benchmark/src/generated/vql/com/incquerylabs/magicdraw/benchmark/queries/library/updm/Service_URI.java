...
public final class Service_URI extends BaseGeneratedEMFQuerySpecification<Service_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Service_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Service_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Service_URI.Match.parameterNames;
    }
    ...
    @Override
    public Service_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Service_URI.Match)) {
          Service_URI.Match other = (Service_URI.Match) obj;
    ...
    @Override
    public Service_URI specification() {
      return Service_URI.instance();
    }
     ...
     * 
     */
    public static Service_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Service_URI.Match newMutableMatch(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Service_URI.Match newMatch(final Port pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Service_URI.Match {
    ...
    private static final class Immutable extends Service_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Service_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Service_URI.Match> {
    /**
     ...
     * 
     */
    public static Service_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Service_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Service_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Service_URI.Match> getAllMatches(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Service_URI.Match> streamAllMatches(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Service_URI.Match> getOneArbitraryMatch(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final LiteralString pValuespec, final Consumer<? super Service_URI.Match> processor) {
     ...
     * 
     */
    public Service_URI.Match newMatch(final Port pElement, final LiteralString pValuespec) {
      return Service_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Service_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Service_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Service_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Service_URI.Match partialMatch) {
    ...
    @Override
    protected Service_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Service_URI.Match.newMatch((Port) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Service_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Service_URI.Match.newMatch((Port) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Service_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Service_URI.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Service_URI.Matcher> querySpecification() {
      return Service_URI.instance();
    }
  }
   ...
   * 
   */
  public static Service_URI instance() {
    try{
  ...
  @Override
  protected Service_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Service_URI.Matcher.on(engine);
  }
  
  @Override
  public Service_URI.Matcher instantiate() {
    return Service_URI.Matcher.create();
  }
  
  @Override
  public Service_URI.Match newEmptyMatch() {
    return Service_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Service_URI.Match newMatch(final Object... parameters) {
    return Service_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Service_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Service_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Service_URI INSTANCE = new Service_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Service_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
