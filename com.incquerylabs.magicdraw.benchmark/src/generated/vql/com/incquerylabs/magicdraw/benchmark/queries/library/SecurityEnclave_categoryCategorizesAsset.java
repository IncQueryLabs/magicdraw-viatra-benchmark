...
public final class SecurityEnclave_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<SecurityEnclave_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave_categoryCategorizesAsset.Match)) {
          SecurityEnclave_categoryCategorizesAsset.Match other = (SecurityEnclave_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public SecurityEnclave_categoryCategorizesAsset specification() {
      return SecurityEnclave_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityEnclave_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityEnclave_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends SecurityEnclave_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see SecurityEnclave_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityEnclave_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityEnclave_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityEnclave_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityEnclave_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityEnclave_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityEnclave_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityEnclave_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave_categoryCategorizesAsset.Matcher> querySpecification() {
      return SecurityEnclave_categoryCategorizesAsset.instance();
    }
  }
  
  private SecurityEnclave_categoryCategorizesAsset() {
   ...
   * 
   */
  public static SecurityEnclave_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected SecurityEnclave_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave_categoryCategorizesAsset.Matcher instantiate() {
    return SecurityEnclave_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public SecurityEnclave_categoryCategorizesAsset.Match newEmptyMatch() {
    return SecurityEnclave_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return SecurityEnclave_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave_categoryCategorizesAsset INSTANCE = new SecurityEnclave_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
