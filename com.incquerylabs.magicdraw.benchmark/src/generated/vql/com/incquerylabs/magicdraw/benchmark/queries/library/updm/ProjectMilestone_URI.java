...
public final class ProjectMilestone_URI extends BaseGeneratedEMFQuerySpecification<ProjectMilestone_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestone_URI.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestone_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestone_URI.Match)) {
          ProjectMilestone_URI.Match other = (ProjectMilestone_URI.Match) obj;
    ...
    @Override
    public ProjectMilestone_URI specification() {
      return ProjectMilestone_URI.instance();
    }
     ...
     * 
     */
    public static ProjectMilestone_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestone_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ProjectMilestone_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProjectMilestone_URI.Match {
    ...
    private static final class Immutable extends ProjectMilestone_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_URI pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestone_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestone_URI.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestone_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestone_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestone_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestone_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ProjectMilestone_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ProjectMilestone_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ProjectMilestone_URI.Match> processor) {
     ...
     * 
     */
    public ProjectMilestone_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ProjectMilestone_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectMilestone_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectMilestone_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ProjectMilestone_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ProjectMilestone_URI.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestone_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestone_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProjectMilestone_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestone_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestone_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestone_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestone_URI.Matcher> querySpecification() {
      return ProjectMilestone_URI.instance();
    }
  }
  
  private ProjectMilestone_URI() {
   ...
   * 
   */
  public static ProjectMilestone_URI instance() {
    try{
  ...
  @Override
  protected ProjectMilestone_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestone_URI.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestone_URI.Matcher instantiate() {
    return ProjectMilestone_URI.Matcher.create();
  }
  
  @Override
  public ProjectMilestone_URI.Match newEmptyMatch() {
    return ProjectMilestone_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestone_URI.Match newMatch(final Object... parameters) {
    return ProjectMilestone_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestone_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestone_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestone_URI INSTANCE = new ProjectMilestone_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestone_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
