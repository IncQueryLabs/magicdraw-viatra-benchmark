...
public final class ServiceAccess_actsUpon extends BaseGeneratedEMFQuerySpecification<ServiceAccess_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_actsUpon.Match)) {
          ServiceAccess_actsUpon.Match other = (ServiceAccess_actsUpon.Match) obj;
    ...
    @Override
    public ServiceAccess_actsUpon specification() {
      return ServiceAccess_actsUpon.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_actsUpon.Match {
    ...
    private static final class Immutable extends ServiceAccess_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_actsUpon.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_actsUpon.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_actsUpon.Matcher> querySpecification() {
      return ServiceAccess_actsUpon.instance();
    }
  }
  
  private ServiceAccess_actsUpon() {
   ...
   * 
   */
  public static ServiceAccess_actsUpon instance() {
    try{
  ...
  @Override
  protected ServiceAccess_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_actsUpon.Matcher instantiate() {
    return ServiceAccess_actsUpon.Matcher.create();
  }
  
  @Override
  public ServiceAccess_actsUpon.Match newEmptyMatch() {
    return ServiceAccess_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_actsUpon.Match newMatch(final Object... parameters) {
    return ServiceAccess_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_actsUpon INSTANCE = new ServiceAccess_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
