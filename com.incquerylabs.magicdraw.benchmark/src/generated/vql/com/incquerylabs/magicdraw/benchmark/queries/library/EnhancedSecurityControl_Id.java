...
public final class EnhancedSecurityControl_Id extends BaseGeneratedEMFQuerySpecification<EnhancedSecurityControl_Id.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnhancedSecurityControl_Id.Match.parameterNames;
    }
    ...
    @Override
    public EnhancedSecurityControl_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnhancedSecurityControl_Id.Match)) {
          EnhancedSecurityControl_Id.Match other = (EnhancedSecurityControl_Id.Match) obj;
    ...
    @Override
    public EnhancedSecurityControl_Id specification() {
      return EnhancedSecurityControl_Id.instance();
    }
     ...
     * 
     */
    public static EnhancedSecurityControl_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnhancedSecurityControl_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnhancedSecurityControl_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnhancedSecurityControl_Id.Match {
    ...
    private static final class Immutable extends EnhancedSecurityControl_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Id pattern,
   ...
   * 
   * @see Match
   * @see EnhancedSecurityControl_Id
   * 
   */
  public static class Matcher extends BaseMatcher<EnhancedSecurityControl_Id.Match> {
    /**
     ...
     * 
     */
    public static EnhancedSecurityControl_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnhancedSecurityControl_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnhancedSecurityControl_Id.Matcher.class);
     ...
     * 
     */
    public Collection<EnhancedSecurityControl_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnhancedSecurityControl_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnhancedSecurityControl_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EnhancedSecurityControl_Id.Match> processor) {
     ...
     * 
     */
    public EnhancedSecurityControl_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EnhancedSecurityControl_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnhancedSecurityControl_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnhancedSecurityControl_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnhancedSecurityControl_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnhancedSecurityControl_Id.Match partialMatch) {
    ...
    @Override
    protected EnhancedSecurityControl_Id.Match tupleToMatch(final Tuple t) {
      try {
          return EnhancedSecurityControl_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnhancedSecurityControl_Id.Match arrayToMatch(final Object[] match) {
      try {
          return EnhancedSecurityControl_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnhancedSecurityControl_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnhancedSecurityControl_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnhancedSecurityControl_Id.Matcher> querySpecification() {
      return EnhancedSecurityControl_Id.instance();
    }
  }
  
  private EnhancedSecurityControl_Id() {
   ...
   * 
   */
  public static EnhancedSecurityControl_Id instance() {
    try{
  ...
  @Override
  protected EnhancedSecurityControl_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnhancedSecurityControl_Id.Matcher.on(engine);
  }
  
  @Override
  public EnhancedSecurityControl_Id.Matcher instantiate() {
    return EnhancedSecurityControl_Id.Matcher.create();
  }
  
  @Override
  public EnhancedSecurityControl_Id.Match newEmptyMatch() {
    return EnhancedSecurityControl_Id.Match.newEmptyMatch();
  }
  
  @Override
  public EnhancedSecurityControl_Id.Match newMatch(final Object... parameters) {
    return EnhancedSecurityControl_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnhancedSecurityControl_Id} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnhancedSecurityControl_Id#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnhancedSecurityControl_Id INSTANCE = new EnhancedSecurityControl_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnhancedSecurityControl_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
