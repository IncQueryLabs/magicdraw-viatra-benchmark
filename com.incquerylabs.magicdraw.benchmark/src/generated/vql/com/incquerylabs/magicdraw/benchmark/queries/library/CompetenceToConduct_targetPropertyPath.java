...
public final class CompetenceToConduct_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<CompetenceToConduct_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceToConduct_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceToConduct_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceToConduct_targetPropertyPath.Match)) {
          CompetenceToConduct_targetPropertyPath.Match other = (CompetenceToConduct_targetPropertyPath.Match) obj;
    ...
    @Override
    public CompetenceToConduct_targetPropertyPath specification() {
      return CompetenceToConduct_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static CompetenceToConduct_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceToConduct_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static CompetenceToConduct_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CompetenceToConduct_targetPropertyPath.Match {
    ...
    private static final class Immutable extends CompetenceToConduct_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see CompetenceToConduct_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceToConduct_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static CompetenceToConduct_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceToConduct_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceToConduct_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceToConduct_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<CompetenceToConduct_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<CompetenceToConduct_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super CompetenceToConduct_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public CompetenceToConduct_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return CompetenceToConduct_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceToConduct_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceToConduct_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final CompetenceToConduct_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final CompetenceToConduct_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected CompetenceToConduct_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceToConduct_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected CompetenceToConduct_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceToConduct_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceToConduct_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceToConduct_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceToConduct_targetPropertyPath.Matcher> querySpecification() {
      return CompetenceToConduct_targetPropertyPath.instance();
    }
  }
  
  private CompetenceToConduct_targetPropertyPath() {
   ...
   * 
   */
  public static CompetenceToConduct_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected CompetenceToConduct_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceToConduct_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public CompetenceToConduct_targetPropertyPath.Matcher instantiate() {
    return CompetenceToConduct_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public CompetenceToConduct_targetPropertyPath.Match newEmptyMatch() {
    return CompetenceToConduct_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceToConduct_targetPropertyPath.Match newMatch(final Object... parameters) {
    return CompetenceToConduct_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceToConduct_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceToConduct_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceToConduct_targetPropertyPath INSTANCE = new CompetenceToConduct_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceToConduct_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
