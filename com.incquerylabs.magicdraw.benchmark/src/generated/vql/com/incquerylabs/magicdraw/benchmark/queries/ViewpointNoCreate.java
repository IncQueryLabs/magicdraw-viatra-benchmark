...
public final class ViewpointNoCreate extends BaseGeneratedEMFQuerySpecification<ViewpointNoCreate.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public Object get(final String parameterName) {
      if ("viewpoint".equals(parameterName)) return this.fViewpoint;
      return null;
    }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.ViewpointNoCreate (visibility: PUBLIC, simpleName: ViewpointNoCreate, identifier: com.incquerylabs.magicdraw.benchmark.queries.ViewpointNoCreate, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
