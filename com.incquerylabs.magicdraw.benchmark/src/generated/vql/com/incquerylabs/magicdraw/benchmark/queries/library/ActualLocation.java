...
public final class ActualLocation extends BaseGeneratedEMFQuerySpecification<ActualLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualLocation.Match.parameterNames;
    }
    ...
    @Override
    public ActualLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualLocation.Match)) {
          ActualLocation.Match other = (ActualLocation.Match) obj;
    ...
    @Override
    public ActualLocation specification() {
      return ActualLocation.instance();
    }
     ...
     * 
     */
    public static ActualLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualLocation.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualLocation.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualLocation.Match {
    ...
    private static final class Immutable extends ActualLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualLocation pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualLocation.Match> {
    /**
     ...
     * 
     */
    public static ActualLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ActualLocation.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualLocation.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualLocation.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualLocation.Match> processor) {
     ...
     * 
     */
    public ActualLocation.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualLocation.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualLocation.Match partialMatch) {
    ...
    @Override
    protected ActualLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ActualLocation.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ActualLocation.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualLocation.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualLocation.Matcher> querySpecification() {
      return ActualLocation.instance();
    }
  }
   ...
   * 
   */
  public static ActualLocation instance() {
    try{
  ...
  @Override
  protected ActualLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualLocation.Matcher.on(engine);
  }
  
  @Override
  public ActualLocation.Matcher instantiate() {
    return ActualLocation.Matcher.create();
  }
  
  @Override
  public ActualLocation.Match newEmptyMatch() {
    return ActualLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ActualLocation.Match newMatch(final Object... parameters) {
    return ActualLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualLocation INSTANCE = new ActualLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualLocation")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualLocation");
