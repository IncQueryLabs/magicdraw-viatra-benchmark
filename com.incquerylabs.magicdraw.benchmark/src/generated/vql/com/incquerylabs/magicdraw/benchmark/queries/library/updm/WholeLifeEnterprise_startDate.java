...
public final class WholeLifeEnterprise_startDate extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_startDate.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_startDate.Match)) {
          WholeLifeEnterprise_startDate.Match other = (WholeLifeEnterprise_startDate.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_startDate specification() {
      return WholeLifeEnterprise_startDate.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_startDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_startDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_startDate.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_startDate pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_startDate.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_startDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_startDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_startDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_startDate.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_startDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_startDate.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_startDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_startDate.Matcher> querySpecification() {
      return WholeLifeEnterprise_startDate.instance();
    }
  }
  
  private WholeLifeEnterprise_startDate() {
   ...
   * 
   */
  public static WholeLifeEnterprise_startDate instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_startDate.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_startDate.Matcher instantiate() {
    return WholeLifeEnterprise_startDate.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_startDate.Match newEmptyMatch() {
    return WholeLifeEnterprise_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_startDate.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_startDate INSTANCE = new WholeLifeEnterprise_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
