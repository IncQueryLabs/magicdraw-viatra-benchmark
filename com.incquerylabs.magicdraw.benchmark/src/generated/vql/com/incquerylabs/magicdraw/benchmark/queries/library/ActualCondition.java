...
public final class ActualCondition extends BaseGeneratedEMFQuerySpecification<ActualCondition.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualCondition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualCondition";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualCondition.Match.parameterNames;
    }
    ...
    @Override
    public ActualCondition.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualCondition.Match)) {
          ActualCondition.Match other = (ActualCondition.Match) obj;
    ...
    @Override
    public ActualCondition specification() {
      return ActualCondition.instance();
    }
     ...
     * 
     */
    public static ActualCondition.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualCondition.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualCondition.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualCondition.Match {
    ...
    private static final class Immutable extends ActualCondition.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualCondition pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualCondition.Match> {
    /**
     ...
     * 
     */
    public static ActualCondition.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualCondition.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualCondition.Matcher.class);
     ...
     * 
     */
    public Collection<ActualCondition.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualCondition.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualCondition.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualCondition.Match> processor) {
     ...
     * 
     */
    public ActualCondition.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualCondition.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualCondition.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualCondition.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualCondition.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualCondition.Match partialMatch) {
    ...
    @Override
    protected ActualCondition.Match tupleToMatch(final Tuple t) {
      try {
          return ActualCondition.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualCondition.Match arrayToMatch(final Object[] match) {
      try {
          return ActualCondition.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualCondition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualCondition.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualCondition.Matcher> querySpecification() {
      return ActualCondition.instance();
    }
  }
  
  private ActualCondition() {
   ...
   * 
   */
  public static ActualCondition instance() {
    try{
  ...
  @Override
  protected ActualCondition.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualCondition.Matcher.on(engine);
  }
  
  @Override
  public ActualCondition.Matcher instantiate() {
    return ActualCondition.Matcher.create();
  }
  
  @Override
  public ActualCondition.Match newEmptyMatch() {
    return ActualCondition.Match.newEmptyMatch();
  }
  
  @Override
  public ActualCondition.Match newMatch(final Object... parameters) {
    return ActualCondition.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualCondition} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualCondition#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualCondition INSTANCE = new ActualCondition();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualCondition.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualCondition")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualCondition");
