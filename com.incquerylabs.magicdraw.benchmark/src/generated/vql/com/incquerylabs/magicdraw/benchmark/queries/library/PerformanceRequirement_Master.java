...
public final class PerformanceRequirement_Master extends BaseGeneratedEMFQuerySpecification<PerformanceRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.performanceRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.performanceRequirement_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformanceRequirement_Master.Match.parameterNames;
    }
    ...
    @Override
    public PerformanceRequirement_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformanceRequirement_Master.Match)) {
          PerformanceRequirement_Master.Match other = (PerformanceRequirement_Master.Match) obj;
    ...
    @Override
    public PerformanceRequirement_Master specification() {
     ...
     * 
     */
    public static PerformanceRequirement_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformanceRequirement_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PerformanceRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PerformanceRequirement_Master.Match {
    ...
    private static final class Immutable extends PerformanceRequirement_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.performanceRequirement_Master pattern,
   ...
   * 
   * @see Match
   * @see PerformanceRequirement_Master
   * 
   */
  public static class Matcher extends BaseMatcher<PerformanceRequirement_Master.Match> {
    /**
     ...
     * 
     */
    public static PerformanceRequirement_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformanceRequirement_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformanceRequirement_Master.Matcher.class);
     ...
     * 
     */
    public Collection<PerformanceRequirement_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PerformanceRequirement_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PerformanceRequirement_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PerformanceRequirement_Master.Match> processor) {
     ...
     * 
     */
    public PerformanceRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PerformanceRequirement_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final PerformanceRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final PerformanceRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final PerformanceRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final PerformanceRequirement_Master.Match partialMatch) {
    ...
    @Override
    protected PerformanceRequirement_Master.Match tupleToMatch(final Tuple t) {
      try {
          return PerformanceRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PerformanceRequirement_Master.Match arrayToMatch(final Object[] match) {
      try {
          return PerformanceRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformanceRequirement_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformanceRequirement_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformanceRequirement_Master.Matcher> querySpecification() {
      return PerformanceRequirement_Master.instance();
    }
  }
  
  private PerformanceRequirement_Master() {
   ...
   * 
   */
  public static PerformanceRequirement_Master instance() {
    try{
  ...
  @Override
  protected PerformanceRequirement_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformanceRequirement_Master.Matcher.on(engine);
  }
  
  @Override
  public PerformanceRequirement_Master.Matcher instantiate() {
    return PerformanceRequirement_Master.Matcher.create();
  }
  
  @Override
  public PerformanceRequirement_Master.Match newEmptyMatch() {
    return PerformanceRequirement_Master.Match.newEmptyMatch();
  }
  
  @Override
  public PerformanceRequirement_Master.Match newMatch(final Object... parameters) {
    return PerformanceRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PerformanceRequirement_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PerformanceRequirement_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformanceRequirement_Master INSTANCE = new PerformanceRequirement_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformanceRequirement_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
