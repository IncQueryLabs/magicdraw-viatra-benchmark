...
import com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty;
...
public final class SecurityProperty_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<SecurityProperty_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityProperty_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public SecurityProperty_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityProperty_actualMeasurementSet.Match)) {
          SecurityProperty_actualMeasurementSet.Match other = (SecurityProperty_actualMeasurementSet.Match) obj;
    ...
    @Override
    public SecurityProperty_actualMeasurementSet specification() {
      return SecurityProperty_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static SecurityProperty_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityProperty_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityProperty_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityProperty_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends SecurityProperty_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see SecurityProperty_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityProperty_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static SecurityProperty_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityProperty_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityProperty_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityProperty_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityProperty_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityProperty_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super SecurityProperty_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public SecurityProperty_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return SecurityProperty_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final SecurityProperty_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final SecurityProperty_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityProperty_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityProperty_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected SecurityProperty_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityProperty_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityProperty_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityProperty_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityProperty_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityProperty_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityProperty_actualMeasurementSet.Matcher> querySpecification() {
      return SecurityProperty_actualMeasurementSet.instance();
    }
  }
  
  private SecurityProperty_actualMeasurementSet() {
   ...
   * 
   */
  public static SecurityProperty_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected SecurityProperty_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityProperty_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public SecurityProperty_actualMeasurementSet.Matcher instantiate() {
    return SecurityProperty_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public SecurityProperty_actualMeasurementSet.Match newEmptyMatch() {
    return SecurityProperty_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityProperty_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return SecurityProperty_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityProperty_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityProperty_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityProperty_actualMeasurementSet INSTANCE = new SecurityProperty_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityProperty_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find SecurityProperty(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), SecurityProperty.instance().getInternalQueryRepresentation());
