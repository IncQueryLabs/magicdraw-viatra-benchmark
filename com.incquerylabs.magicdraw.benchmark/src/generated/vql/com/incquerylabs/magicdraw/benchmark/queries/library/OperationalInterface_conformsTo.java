...
public final class OperationalInterface_conformsTo extends BaseGeneratedEMFQuerySpecification<OperationalInterface_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalInterface_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public OperationalInterface_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalInterface_conformsTo.Match)) {
          OperationalInterface_conformsTo.Match other = (OperationalInterface_conformsTo.Match) obj;
    ...
    @Override
    public OperationalInterface_conformsTo specification() {
      return OperationalInterface_conformsTo.instance();
    }
     ...
     * 
     */
    public static OperationalInterface_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalInterface_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalInterface_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalInterface_conformsTo.Match {
    ...
    private static final class Immutable extends OperationalInterface_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see OperationalInterface_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalInterface_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static OperationalInterface_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalInterface_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalInterface_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalInterface_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalInterface_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalInterface_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalInterface_conformsTo.Match> processor) {
     ...
     * 
     */
    public OperationalInterface_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalInterface_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalInterface_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalInterface_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalInterface_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalInterface_conformsTo.Match partialMatch) {
    ...
    @Override
    protected OperationalInterface_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalInterface_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalInterface_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalInterface_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalInterface_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalInterface_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalInterface_conformsTo.Matcher> querySpecification() {
      return OperationalInterface_conformsTo.instance();
    }
  }
  
  private OperationalInterface_conformsTo() {
   ...
   * 
   */
  public static OperationalInterface_conformsTo instance() {
    try{
  ...
  @Override
  protected OperationalInterface_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalInterface_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public OperationalInterface_conformsTo.Matcher instantiate() {
    return OperationalInterface_conformsTo.Matcher.create();
  }
  
  @Override
  public OperationalInterface_conformsTo.Match newEmptyMatch() {
    return OperationalInterface_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalInterface_conformsTo.Match newMatch(final Object... parameters) {
    return OperationalInterface_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalInterface_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalInterface_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalInterface_conformsTo INSTANCE = new OperationalInterface_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalInterface_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
