...
public final class Performer_propertySet extends BaseGeneratedEMFQuerySpecification<Performer_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Performer_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_propertySet.Match)) {
          Performer_propertySet.Match other = (Performer_propertySet.Match) obj;
    ...
    @Override
    public Performer_propertySet specification() {
      return Performer_propertySet.instance();
    }
     ...
     * 
     */
    public static Performer_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_propertySet.Match {
    ...
    private static final class Immutable extends Performer_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Performer_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Performer_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_propertySet.Match> processor) {
     ...
     * 
     */
    public Performer_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_propertySet.Match partialMatch) {
    ...
    @Override
    protected Performer_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_propertySet.Matcher> querySpecification() {
      return Performer_propertySet.instance();
    }
  }
  
  private Performer_propertySet() {
   ...
   * 
   */
  public static Performer_propertySet instance() {
    try{
  ...
  @Override
  protected Performer_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Performer_propertySet.Matcher instantiate() {
    return Performer_propertySet.Matcher.create();
  }
  
  @Override
  public Performer_propertySet.Match newEmptyMatch() {
    return Performer_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_propertySet.Match newMatch(final Object... parameters) {
    return Performer_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_propertySet INSTANCE = new Performer_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
