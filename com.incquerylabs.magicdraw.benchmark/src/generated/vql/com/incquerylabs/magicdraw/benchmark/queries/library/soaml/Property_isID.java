...
public final class Property_isID extends BaseGeneratedEMFQuerySpecification<Property_isID.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Property_isID pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Property pElement, final LiteralBoolean pValuespec) {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Property_isID";
    }
    
    @Override
    public List<String> parameterNames() {
      return Property_isID.Match.parameterNames;
    }
    ...
    @Override
    public Property_isID.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Property_isID.Match)) {
          Property_isID.Match other = (Property_isID.Match) obj;
    ...
    @Override
    public Property_isID specification() {
     ...
     * 
     */
    public static Property_isID.Match newEmptyMatch() {
     ...
     * 
     */
    public static Property_isID.Match newMutableMatch(final Property pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Property_isID.Match newMatch(final Property pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Property_isID.Match {
      Mutable(final Property pElement, final LiteralBoolean pValuespec) {
    ...
    private static final class Immutable extends Property_isID.Match {
      Immutable(final Property pElement, final LiteralBoolean pValuespec) {
        super(pElement, pValuespec);
      }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Property_isID pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Property_isID.Match> {
    /**
     ...
     * 
     */
    public static Property_isID.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Property_isID.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Property_isID.Matcher.class);
     ...
     * 
     */
    public Collection<Property_isID.Match> getAllMatches(final Property pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Property_isID.Match> streamAllMatches(final Property pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Property_isID.Match> getOneArbitraryMatch(final Property pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean hasMatch(final Property pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public int countMatches(final Property pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralBoolean pValuespec, final Consumer<? super Property_isID.Match> processor) {
     ...
     * 
     */
    public Property_isID.Match newMatch(final Property pElement, final LiteralBoolean pValuespec) {
      return Property_isID.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Property_isID.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Property_isID.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Property_isID.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Property pElement) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Property_isID.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Property pElement) {
      return rawStreamAllValuesOfvaluespec(new Object[]{pElement, null}).collect(Collectors.toSet());
    }
    
    @Override
    protected Property_isID.Match tupleToMatch(final Tuple t) {
      try {
          return Property_isID.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Property_isID.Match arrayToMatch(final Object[] match) {
      try {
          return Property_isID.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Property_isID.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Property_isID.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Property_isID.Matcher> querySpecification() {
      return Property_isID.instance();
    }
  }
  
  private Property_isID() {
   ...
   * 
   */
  public static Property_isID instance() {
    try{
  ...
  @Override
  protected Property_isID.Matcher instantiate(final ViatraQueryEngine engine) {
    return Property_isID.Matcher.on(engine);
  }
  
  @Override
  public Property_isID.Matcher instantiate() {
    return Property_isID.Matcher.create();
  }
  
  @Override
  public Property_isID.Match newEmptyMatch() {
    return Property_isID.Match.newEmptyMatch();
  }
  
  @Override
  public Property_isID.Match newMatch(final Object... parameters) {
    return Property_isID.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Property_isID} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Property_isID#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Property_isID INSTANCE = new Property_isID();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Property_isID.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Property(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Property.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "isID", valuespec)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "isID");
