...
public final class Protocol_retiredDate extends BaseGeneratedEMFQuerySpecification<Protocol_retiredDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_retiredDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_retiredDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_retiredDate.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_retiredDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_retiredDate.Match)) {
          Protocol_retiredDate.Match other = (Protocol_retiredDate.Match) obj;
    ...
    @Override
    public Protocol_retiredDate specification() {
      return Protocol_retiredDate.instance();
    }
     ...
     * 
     */
    public static Protocol_retiredDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_retiredDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Protocol_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Protocol_retiredDate.Match {
    ...
    private static final class Immutable extends Protocol_retiredDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_retiredDate pattern,
   ...
   * 
   * @see Match
   * @see Protocol_retiredDate
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_retiredDate.Match> {
    /**
     ...
     * 
     */
    public static Protocol_retiredDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_retiredDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_retiredDate.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_retiredDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Protocol_retiredDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Protocol_retiredDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Protocol_retiredDate.Match> processor) {
     ...
     * 
     */
    public Protocol_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Protocol_retiredDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Protocol_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Protocol_retiredDate.Match partialMatch) {
    ...
    @Override
    protected Protocol_retiredDate.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Protocol_retiredDate.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_retiredDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_retiredDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_retiredDate.Matcher> querySpecification() {
      return Protocol_retiredDate.instance();
    }
  }
  
  private Protocol_retiredDate() {
   ...
   * 
   */
  public static Protocol_retiredDate instance() {
    try{
  ...
  @Override
  protected Protocol_retiredDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_retiredDate.Matcher.on(engine);
  }
  
  @Override
  public Protocol_retiredDate.Matcher instantiate() {
    return Protocol_retiredDate.Matcher.create();
  }
  
  @Override
  public Protocol_retiredDate.Match newEmptyMatch() {
    return Protocol_retiredDate.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_retiredDate.Match newMatch(final Object... parameters) {
    return Protocol_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_retiredDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_retiredDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_retiredDate INSTANCE = new Protocol_retiredDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_retiredDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
