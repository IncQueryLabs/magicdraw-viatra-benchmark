...
public final class Exhibits_sourceContext extends BaseGeneratedEMFQuerySpecification<Exhibits_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Exhibits_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public Exhibits_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Exhibits_sourceContext.Match)) {
          Exhibits_sourceContext.Match other = (Exhibits_sourceContext.Match) obj;
    ...
    @Override
    public Exhibits_sourceContext specification() {
      return Exhibits_sourceContext.instance();
    }
     ...
     * 
     */
    public static Exhibits_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Exhibits_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Exhibits_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Exhibits_sourceContext.Match {
    ...
    private static final class Immutable extends Exhibits_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see Exhibits_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<Exhibits_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static Exhibits_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Exhibits_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Exhibits_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<Exhibits_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Exhibits_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Exhibits_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Exhibits_sourceContext.Match> processor) {
     ...
     * 
     */
    public Exhibits_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Exhibits_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Exhibits_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Exhibits_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Exhibits_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Exhibits_sourceContext.Match partialMatch) {
    ...
    @Override
    protected Exhibits_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return Exhibits_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Exhibits_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return Exhibits_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Exhibits_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Exhibits_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Exhibits_sourceContext.Matcher> querySpecification() {
      return Exhibits_sourceContext.instance();
    }
  }
  
  private Exhibits_sourceContext() {
   ...
   * 
   */
  public static Exhibits_sourceContext instance() {
    try{
  ...
  @Override
  protected Exhibits_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Exhibits_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public Exhibits_sourceContext.Matcher instantiate() {
    return Exhibits_sourceContext.Matcher.create();
  }
  
  @Override
  public Exhibits_sourceContext.Match newEmptyMatch() {
    return Exhibits_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public Exhibits_sourceContext.Match newMatch(final Object... parameters) {
    return Exhibits_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Exhibits_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Exhibits_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Exhibits_sourceContext INSTANCE = new Exhibits_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Exhibits_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
