...
public final class EnterpriseVision_propertySet extends BaseGeneratedEMFQuerySpecification<EnterpriseVision_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseVision_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseVision_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseVision_propertySet.Match)) {
          EnterpriseVision_propertySet.Match other = (EnterpriseVision_propertySet.Match) obj;
    ...
    @Override
    public EnterpriseVision_propertySet specification() {
      return EnterpriseVision_propertySet.instance();
    }
     ...
     * 
     */
    public static EnterpriseVision_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseVision_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseVision_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseVision_propertySet.Match {
    ...
    private static final class Immutable extends EnterpriseVision_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_propertySet pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseVision_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseVision_propertySet.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseVision_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseVision_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseVision_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseVision_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseVision_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseVision_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseVision_propertySet.Match> processor) {
     ...
     * 
     */
    public EnterpriseVision_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseVision_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseVision_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseVision_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseVision_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseVision_propertySet.Match partialMatch) {
    ...
    @Override
    protected EnterpriseVision_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseVision_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseVision_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseVision_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseVision_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseVision_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseVision_propertySet.Matcher> querySpecification() {
      return EnterpriseVision_propertySet.instance();
    }
  }
  
  private EnterpriseVision_propertySet() {
   ...
   * 
   */
  public static EnterpriseVision_propertySet instance() {
    try{
  ...
  @Override
  protected EnterpriseVision_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseVision_propertySet.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseVision_propertySet.Matcher instantiate() {
    return EnterpriseVision_propertySet.Matcher.create();
  }
  
  @Override
  public EnterpriseVision_propertySet.Match newEmptyMatch() {
    return EnterpriseVision_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseVision_propertySet.Match newMatch(final Object... parameters) {
    return EnterpriseVision_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseVision_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseVision_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseVision_propertySet INSTANCE = new EnterpriseVision_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseVision_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
