...
public final class Software_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Software_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Software_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_actualPropertySet.Match)) {
          Software_actualPropertySet.Match other = (Software_actualPropertySet.Match) obj;
    ...
    @Override
    public Software_actualPropertySet specification() {
      return Software_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Software_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_actualPropertySet.Match {
    ...
    private static final class Immutable extends Software_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Software_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Software_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Software_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Software_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Software_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Software_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Software_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Software_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_actualPropertySet.Matcher> querySpecification() {
      return Software_actualPropertySet.instance();
    }
  }
  
  private Software_actualPropertySet() {
   ...
   * 
   */
  public static Software_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Software_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Software_actualPropertySet.Matcher instantiate() {
    return Software_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Software_actualPropertySet.Match newEmptyMatch() {
    return Software_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Software_actualPropertySet.Match newMatch(final Object... parameters) {
    return Software_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_actualPropertySet INSTANCE = new Software_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
