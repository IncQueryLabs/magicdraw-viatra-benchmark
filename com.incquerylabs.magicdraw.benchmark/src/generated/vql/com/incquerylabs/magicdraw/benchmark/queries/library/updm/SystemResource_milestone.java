...
public final class SystemResource_milestone extends BaseGeneratedEMFQuerySpecification<SystemResource_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_milestone.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_milestone.Match)) {
          SystemResource_milestone.Match other = (SystemResource_milestone.Match) obj;
    ...
    @Override
    public SystemResource_milestone specification() {
      return SystemResource_milestone.instance();
    }
     ...
     * 
     */
    public static SystemResource_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_milestone.Match {
    ...
    private static final class Immutable extends SystemResource_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_milestone pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_milestone.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_milestone.Match> processor) {
     ...
     * 
     */
    public SystemResource_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_milestone.Match partialMatch) {
    ...
    @Override
    protected SystemResource_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_milestone.Matcher> querySpecification() {
      return SystemResource_milestone.instance();
    }
  }
  
  private SystemResource_milestone() {
   ...
   * 
   */
  public static SystemResource_milestone instance() {
    try{
  ...
  @Override
  protected SystemResource_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_milestone.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_milestone.Matcher instantiate() {
    return SystemResource_milestone.Matcher.create();
  }
  
  @Override
  public SystemResource_milestone.Match newEmptyMatch() {
    return SystemResource_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_milestone.Match newMatch(final Object... parameters) {
    return SystemResource_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_milestone INSTANCE = new SystemResource_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
