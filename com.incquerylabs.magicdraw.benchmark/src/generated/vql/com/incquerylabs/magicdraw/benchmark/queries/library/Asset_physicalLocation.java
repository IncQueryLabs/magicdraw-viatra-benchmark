...
public final class Asset_physicalLocation extends BaseGeneratedEMFQuerySpecification<Asset_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Asset_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Asset_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Asset_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Asset_physicalLocation.Match)) {
          Asset_physicalLocation.Match other = (Asset_physicalLocation.Match) obj;
    ...
    @Override
    public Asset_physicalLocation specification() {
      return Asset_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Asset_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Asset_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Asset_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Asset_physicalLocation.Match {
    ...
    private static final class Immutable extends Asset_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Asset_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Asset_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Asset_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Asset_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Asset_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Asset_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Asset_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Asset_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Asset_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Asset_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Asset_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Asset_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Asset_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Asset_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Asset_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Asset_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Asset_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Asset_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Asset_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Asset_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Asset_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Asset_physicalLocation.Matcher> querySpecification() {
      return Asset_physicalLocation.instance();
    }
  }
  
  private Asset_physicalLocation() {
   ...
   * 
   */
  public static Asset_physicalLocation instance() {
    try{
  ...
  @Override
  protected Asset_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Asset_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Asset_physicalLocation.Matcher instantiate() {
    return Asset_physicalLocation.Matcher.create();
  }
  
  @Override
  public Asset_physicalLocation.Match newEmptyMatch() {
    return Asset_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Asset_physicalLocation.Match newMatch(final Object... parameters) {
    return Asset_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Asset_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Asset_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Asset_physicalLocation INSTANCE = new Asset_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Asset_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
