...
public final class RequiresCompetence_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<RequiresCompetence_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return RequiresCompetence_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public RequiresCompetence_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RequiresCompetence_targetPropertyPath.Match)) {
          RequiresCompetence_targetPropertyPath.Match other = (RequiresCompetence_targetPropertyPath.Match) obj;
    ...
    @Override
    public RequiresCompetence_targetPropertyPath specification() {
      return RequiresCompetence_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static RequiresCompetence_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static RequiresCompetence_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static RequiresCompetence_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RequiresCompetence_targetPropertyPath.Match {
    ...
    private static final class Immutable extends RequiresCompetence_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see RequiresCompetence_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<RequiresCompetence_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static RequiresCompetence_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RequiresCompetence_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RequiresCompetence_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<RequiresCompetence_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<RequiresCompetence_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<RequiresCompetence_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super RequiresCompetence_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public RequiresCompetence_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return RequiresCompetence_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final RequiresCompetence_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final RequiresCompetence_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final RequiresCompetence_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final RequiresCompetence_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected RequiresCompetence_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return RequiresCompetence_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected RequiresCompetence_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return RequiresCompetence_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RequiresCompetence_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RequiresCompetence_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RequiresCompetence_targetPropertyPath.Matcher> querySpecification() {
      return RequiresCompetence_targetPropertyPath.instance();
    }
  }
  
  private RequiresCompetence_targetPropertyPath() {
   ...
   * 
   */
  public static RequiresCompetence_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected RequiresCompetence_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return RequiresCompetence_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public RequiresCompetence_targetPropertyPath.Matcher instantiate() {
    return RequiresCompetence_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public RequiresCompetence_targetPropertyPath.Match newEmptyMatch() {
    return RequiresCompetence_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public RequiresCompetence_targetPropertyPath.Match newMatch(final Object... parameters) {
    return RequiresCompetence_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RequiresCompetence_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RequiresCompetence_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RequiresCompetence_targetPropertyPath INSTANCE = new RequiresCompetence_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RequiresCompetence_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
