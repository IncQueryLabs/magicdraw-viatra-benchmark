...
public final class TechnicalStandard_mandatedDate extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_mandatedDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_mandatedDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_mandatedDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_mandatedDate.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_mandatedDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_mandatedDate.Match)) {
          TechnicalStandard_mandatedDate.Match other = (TechnicalStandard_mandatedDate.Match) obj;
    ...
    @Override
    public TechnicalStandard_mandatedDate specification() {
      return TechnicalStandard_mandatedDate.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_mandatedDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_mandatedDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static TechnicalStandard_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TechnicalStandard_mandatedDate.Match {
    ...
    private static final class Immutable extends TechnicalStandard_mandatedDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_mandatedDate pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_mandatedDate
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_mandatedDate.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_mandatedDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_mandatedDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_mandatedDate.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_mandatedDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TechnicalStandard_mandatedDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TechnicalStandard_mandatedDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super TechnicalStandard_mandatedDate.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return TechnicalStandard_mandatedDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TechnicalStandard_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TechnicalStandard_mandatedDate.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_mandatedDate.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TechnicalStandard_mandatedDate.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_mandatedDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_mandatedDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_mandatedDate.Matcher> querySpecification() {
      return TechnicalStandard_mandatedDate.instance();
    }
  }
  
  private TechnicalStandard_mandatedDate() {
   ...
   * 
   */
  public static TechnicalStandard_mandatedDate instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_mandatedDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_mandatedDate.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_mandatedDate.Matcher instantiate() {
    return TechnicalStandard_mandatedDate.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_mandatedDate.Match newEmptyMatch() {
    return TechnicalStandard_mandatedDate.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_mandatedDate.Match newMatch(final Object... parameters) {
    return TechnicalStandard_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_mandatedDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_mandatedDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_mandatedDate INSTANCE = new TechnicalStandard_mandatedDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_mandatedDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
