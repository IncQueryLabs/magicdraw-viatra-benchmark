...
public final class ExtendedRequirement_RefinedBy extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_RefinedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_RefinedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_RefinedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement_RefinedBy.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement_RefinedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtendedRequirement_RefinedBy.Match)) {
          ExtendedRequirement_RefinedBy.Match other = (ExtendedRequirement_RefinedBy.Match) obj;
    ...
    @Override
    public ExtendedRequirement_RefinedBy specification() {
     ...
     * 
     */
    public static ExtendedRequirement_RefinedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtendedRequirement_RefinedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static ExtendedRequirement_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExtendedRequirement_RefinedBy.Match {
    ...
    private static final class Immutable extends ExtendedRequirement_RefinedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_RefinedBy pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement_RefinedBy
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement_RefinedBy.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement_RefinedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement_RefinedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtendedRequirement_RefinedBy.Matcher.class);
     ...
     * 
     */
    public Collection<ExtendedRequirement_RefinedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<ExtendedRequirement_RefinedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<ExtendedRequirement_RefinedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super ExtendedRequirement_RefinedBy.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return ExtendedRequirement_RefinedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExtendedRequirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExtendedRequirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final ExtendedRequirement_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final ExtendedRequirement_RefinedBy.Match partialMatch) {
    ...
    @Override
    protected ExtendedRequirement_RefinedBy.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExtendedRequirement_RefinedBy.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExtendedRequirement_RefinedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement_RefinedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement_RefinedBy.Matcher> querySpecification() {
      return ExtendedRequirement_RefinedBy.instance();
    }
  }
  
  private ExtendedRequirement_RefinedBy() {
   ...
   * 
   */
  public static ExtendedRequirement_RefinedBy instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement_RefinedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement_RefinedBy.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement_RefinedBy.Matcher instantiate() {
    return ExtendedRequirement_RefinedBy.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement_RefinedBy.Match newEmptyMatch() {
    return ExtendedRequirement_RefinedBy.Match.newEmptyMatch();
  }
  
  @Override
  public ExtendedRequirement_RefinedBy.Match newMatch(final Object... parameters) {
    return ExtendedRequirement_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExtendedRequirement_RefinedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExtendedRequirement_RefinedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement_RefinedBy INSTANCE = new ExtendedRequirement_RefinedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExtendedRequirement_RefinedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
