...
public final class ServiceAttribute_maxValue extends BaseGeneratedEMFQuerySpecification<ServiceAttribute_maxValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_maxValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_maxValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAttribute_maxValue.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAttribute_maxValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAttribute_maxValue.Match)) {
          ServiceAttribute_maxValue.Match other = (ServiceAttribute_maxValue.Match) obj;
    ...
    @Override
    public ServiceAttribute_maxValue specification() {
      return ServiceAttribute_maxValue.instance();
    }
     ...
     * 
     */
    public static ServiceAttribute_maxValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAttribute_maxValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ServiceAttribute_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ServiceAttribute_maxValue.Match {
    ...
    private static final class Immutable extends ServiceAttribute_maxValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_maxValue pattern,
   ...
   * 
   * @see Match
   * @see ServiceAttribute_maxValue
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAttribute_maxValue.Match> {
    /**
     ...
     * 
     */
    public static ServiceAttribute_maxValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAttribute_maxValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAttribute_maxValue.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAttribute_maxValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ServiceAttribute_maxValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ServiceAttribute_maxValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ServiceAttribute_maxValue.Match> processor) {
     ...
     * 
     */
    public ServiceAttribute_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ServiceAttribute_maxValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceAttribute_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceAttribute_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ServiceAttribute_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ServiceAttribute_maxValue.Match partialMatch) {
    ...
    @Override
    protected ServiceAttribute_maxValue.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAttribute_maxValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ServiceAttribute_maxValue.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAttribute_maxValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAttribute_maxValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAttribute_maxValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAttribute_maxValue.Matcher> querySpecification() {
      return ServiceAttribute_maxValue.instance();
    }
  }
  
  private ServiceAttribute_maxValue() {
   ...
   * 
   */
  public static ServiceAttribute_maxValue instance() {
    try{
  ...
  @Override
  protected ServiceAttribute_maxValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAttribute_maxValue.Matcher.on(engine);
  }
  
  @Override
  public ServiceAttribute_maxValue.Matcher instantiate() {
    return ServiceAttribute_maxValue.Matcher.create();
  }
  
  @Override
  public ServiceAttribute_maxValue.Match newEmptyMatch() {
    return ServiceAttribute_maxValue.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAttribute_maxValue.Match newMatch(final Object... parameters) {
    return ServiceAttribute_maxValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAttribute_maxValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAttribute_maxValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAttribute_maxValue INSTANCE = new ServiceAttribute_maxValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAttribute_maxValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
