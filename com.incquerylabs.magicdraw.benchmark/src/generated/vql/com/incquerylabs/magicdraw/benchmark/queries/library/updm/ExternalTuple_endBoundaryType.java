...
public final class ExternalTuple_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ExternalTuple_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTuple_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTuple_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTuple_endBoundaryType.Match)) {
          ExternalTuple_endBoundaryType.Match other = (ExternalTuple_endBoundaryType.Match) obj;
    ...
    @Override
    public ExternalTuple_endBoundaryType specification() {
      return ExternalTuple_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ExternalTuple_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTuple_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTuple_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTuple_endBoundaryType.Match {
    ...
    private static final class Immutable extends ExternalTuple_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ExternalTuple_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTuple_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ExternalTuple_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTuple_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTuple_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTuple_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTuple_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTuple_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTuple_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ExternalTuple_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTuple_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTuple_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTuple_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTuple_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTuple_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ExternalTuple_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTuple_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTuple_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTuple_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTuple_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTuple_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTuple_endBoundaryType.Matcher> querySpecification() {
      return ExternalTuple_endBoundaryType.instance();
    }
  }
  
  private ExternalTuple_endBoundaryType() {
   ...
   * 
   */
  public static ExternalTuple_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ExternalTuple_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTuple_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ExternalTuple_endBoundaryType.Matcher instantiate() {
    return ExternalTuple_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ExternalTuple_endBoundaryType.Match newEmptyMatch() {
    return ExternalTuple_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTuple_endBoundaryType.Match newMatch(final Object... parameters) {
    return ExternalTuple_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTuple_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTuple_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTuple_endBoundaryType INSTANCE = new ExternalTuple_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTuple_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
