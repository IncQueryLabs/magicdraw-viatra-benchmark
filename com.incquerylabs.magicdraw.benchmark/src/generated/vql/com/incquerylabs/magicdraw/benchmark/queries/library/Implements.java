...
public final class Implements extends BaseGeneratedEMFQuerySpecification<Implements.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Implements";
    }
    
    @Override
    public List<String> parameterNames() {
      return Implements.Match.parameterNames;
    }
    ...
    @Override
    public Implements.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Implements.Match)) {
          Implements.Match other = (Implements.Match) obj;
    ...
    @Override
    public Implements specification() {
      return Implements.instance();
    }
     ...
     * 
     */
    public static Implements.Match newEmptyMatch() {
     ...
     * 
     */
    public static Implements.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Implements.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Implements.Match {
    ...
    private static final class Immutable extends Implements.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Implements.Match> {
    /**
     ...
     * 
     */
    public static Implements.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Implements.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Implements.Matcher.class);
     ...
     * 
     */
    public Collection<Implements.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Implements.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Implements.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Implements.Match> processor) {
     ...
     * 
     */
    public Implements.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Implements.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Implements.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Implements.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Implements.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Implements.Match partialMatch) {
    ...
    @Override
    protected Implements.Match tupleToMatch(final Tuple t) {
      try {
          return Implements.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Implements.Match arrayToMatch(final Object[] match) {
      try {
          return Implements.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Implements.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Implements.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Implements.Matcher> querySpecification() {
      return Implements.instance();
    }
  }
   ...
   * 
   */
  public static Implements instance() {
    try{
  ...
  @Override
  protected Implements.Matcher instantiate(final ViatraQueryEngine engine) {
    return Implements.Matcher.on(engine);
  }
  
  @Override
  public Implements.Matcher instantiate() {
    return Implements.Matcher.create();
  }
  
  @Override
  public Implements.Match newEmptyMatch() {
    return Implements.Match.newEmptyMatch();
  }
  
  @Override
  public Implements.Match newMatch(final Object... parameters) {
    return Implements.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Implements} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Implements#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Implements INSTANCE = new Implements();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Implements.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Implements")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Implements");
