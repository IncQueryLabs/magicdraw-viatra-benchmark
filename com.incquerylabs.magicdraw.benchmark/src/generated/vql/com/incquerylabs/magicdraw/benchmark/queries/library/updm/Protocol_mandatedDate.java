...
public final class Protocol_mandatedDate extends BaseGeneratedEMFQuerySpecification<Protocol_mandatedDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_mandatedDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_mandatedDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_mandatedDate.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_mandatedDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_mandatedDate.Match)) {
          Protocol_mandatedDate.Match other = (Protocol_mandatedDate.Match) obj;
    ...
    @Override
    public Protocol_mandatedDate specification() {
      return Protocol_mandatedDate.instance();
    }
     ...
     * 
     */
    public static Protocol_mandatedDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_mandatedDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Protocol_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Protocol_mandatedDate.Match {
    ...
    private static final class Immutable extends Protocol_mandatedDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_mandatedDate pattern,
   ...
   * 
   * @see Match
   * @see Protocol_mandatedDate
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_mandatedDate.Match> {
    /**
     ...
     * 
     */
    public static Protocol_mandatedDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_mandatedDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_mandatedDate.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_mandatedDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Protocol_mandatedDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Protocol_mandatedDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Protocol_mandatedDate.Match> processor) {
     ...
     * 
     */
    public Protocol_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Protocol_mandatedDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Protocol_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Protocol_mandatedDate.Match partialMatch) {
    ...
    @Override
    protected Protocol_mandatedDate.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Protocol_mandatedDate.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_mandatedDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_mandatedDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_mandatedDate.Matcher> querySpecification() {
      return Protocol_mandatedDate.instance();
    }
  }
  
  private Protocol_mandatedDate() {
   ...
   * 
   */
  public static Protocol_mandatedDate instance() {
    try{
  ...
  @Override
  protected Protocol_mandatedDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_mandatedDate.Matcher.on(engine);
  }
  
  @Override
  public Protocol_mandatedDate.Matcher instantiate() {
    return Protocol_mandatedDate.Matcher.create();
  }
  
  @Override
  public Protocol_mandatedDate.Match newEmptyMatch() {
    return Protocol_mandatedDate.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_mandatedDate.Match newMatch(final Object... parameters) {
    return Protocol_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_mandatedDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_mandatedDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_mandatedDate INSTANCE = new Protocol_mandatedDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_mandatedDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
