...
import com.incquerylabs.magicdraw.benchmark.queries.library.EnterprisePhase;
...
public final class EnterprisePhase_isEncapsulated extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterprisePhase_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterprisePhase_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_isEncapsulated.Match)) {
          EnterprisePhase_isEncapsulated.Match other = (EnterprisePhase_isEncapsulated.Match) obj;
    ...
    @Override
    public EnterprisePhase_isEncapsulated specification() {
      return EnterprisePhase_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static EnterprisePhase_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnterprisePhase_isEncapsulated.Match {
    ...
    private static final class Immutable extends EnterprisePhase_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterprisePhase_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<EnterprisePhase_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<EnterprisePhase_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super EnterprisePhase_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return EnterprisePhase_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final EnterprisePhase_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final EnterprisePhase_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnterprisePhase_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_isEncapsulated.Matcher> querySpecification() {
      return EnterprisePhase_isEncapsulated.instance();
    }
  }
  
  private EnterprisePhase_isEncapsulated() {
   ...
   * 
   */
  public static EnterprisePhase_isEncapsulated instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_isEncapsulated.Matcher instantiate() {
    return EnterprisePhase_isEncapsulated.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_isEncapsulated.Match newEmptyMatch() {
    return EnterprisePhase_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_isEncapsulated.Match newMatch(final Object... parameters) {
    return EnterprisePhase_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_isEncapsulated INSTANCE = new EnterprisePhase_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
