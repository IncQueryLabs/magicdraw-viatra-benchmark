...
public final class SystemResource_physicalLocation extends BaseGeneratedEMFQuerySpecification<SystemResource_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_physicalLocation.Match)) {
          SystemResource_physicalLocation.Match other = (SystemResource_physicalLocation.Match) obj;
    ...
    @Override
    public SystemResource_physicalLocation specification() {
      return SystemResource_physicalLocation.instance();
    }
     ...
     * 
     */
    public static SystemResource_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_physicalLocation.Match {
    ...
    private static final class Immutable extends SystemResource_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_physicalLocation.Match> processor) {
     ...
     * 
     */
    public SystemResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected SystemResource_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_physicalLocation.Matcher> querySpecification() {
      return SystemResource_physicalLocation.instance();
    }
  }
  
  private SystemResource_physicalLocation() {
   ...
   * 
   */
  public static SystemResource_physicalLocation instance() {
    try{
  ...
  @Override
  protected SystemResource_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_physicalLocation.Matcher instantiate() {
    return SystemResource_physicalLocation.Matcher.create();
  }
  
  @Override
  public SystemResource_physicalLocation.Match newEmptyMatch() {
    return SystemResource_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_physicalLocation.Match newMatch(final Object... parameters) {
    return SystemResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_physicalLocation INSTANCE = new SystemResource_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
