...
public final class CapabilityProperty_maxValue extends BaseGeneratedEMFQuerySpecification<CapabilityProperty_maxValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_maxValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_maxValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty_maxValue.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty_maxValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty_maxValue.Match)) {
          CapabilityProperty_maxValue.Match other = (CapabilityProperty_maxValue.Match) obj;
    ...
    @Override
    public CapabilityProperty_maxValue specification() {
      return CapabilityProperty_maxValue.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty_maxValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty_maxValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static CapabilityProperty_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends CapabilityProperty_maxValue.Match {
    ...
    private static final class Immutable extends CapabilityProperty_maxValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_maxValue pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty_maxValue
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty_maxValue.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty_maxValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty_maxValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty_maxValue.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty_maxValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<CapabilityProperty_maxValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<CapabilityProperty_maxValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super CapabilityProperty_maxValue.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return CapabilityProperty_maxValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final CapabilityProperty_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final CapabilityProperty_maxValue.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty_maxValue.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty_maxValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected CapabilityProperty_maxValue.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty_maxValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty_maxValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty_maxValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty_maxValue.Matcher> querySpecification() {
      return CapabilityProperty_maxValue.instance();
    }
  }
  
  private CapabilityProperty_maxValue() {
   ...
   * 
   */
  public static CapabilityProperty_maxValue instance() {
    try{
  ...
  @Override
  protected CapabilityProperty_maxValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty_maxValue.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty_maxValue.Matcher instantiate() {
    return CapabilityProperty_maxValue.Matcher.create();
  }
  
  @Override
  public CapabilityProperty_maxValue.Match newEmptyMatch() {
    return CapabilityProperty_maxValue.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty_maxValue.Match newMatch(final Object... parameters) {
    return CapabilityProperty_maxValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty_maxValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty_maxValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty_maxValue INSTANCE = new CapabilityProperty_maxValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty_maxValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
