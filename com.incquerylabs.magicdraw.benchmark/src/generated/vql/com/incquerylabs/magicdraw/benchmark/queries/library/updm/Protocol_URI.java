...
public final class Protocol_URI extends BaseGeneratedEMFQuerySpecification<Protocol_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_URI.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_URI.Match)) {
          Protocol_URI.Match other = (Protocol_URI.Match) obj;
    ...
    @Override
    public Protocol_URI specification() {
      return Protocol_URI.instance();
    }
     ...
     * 
     */
    public static Protocol_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Protocol_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Protocol_URI.Match {
    ...
    private static final class Immutable extends Protocol_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_URI.Match> {
    /**
     ...
     * 
     */
    public static Protocol_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Protocol_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Protocol_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Protocol_URI.Match> processor) {
     ...
     * 
     */
    public Protocol_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Protocol_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Protocol_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Protocol_URI.Match partialMatch) {
    ...
    @Override
    protected Protocol_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Protocol_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_URI.Matcher> querySpecification() {
      return Protocol_URI.instance();
    }
  }
  
  private Protocol_URI() {
   ...
   * 
   */
  public static Protocol_URI instance() {
    try{
  ...
  @Override
  protected Protocol_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_URI.Matcher.on(engine);
  }
  
  @Override
  public Protocol_URI.Matcher instantiate() {
    return Protocol_URI.Matcher.create();
  }
  
  @Override
  public Protocol_URI.Match newEmptyMatch() {
    return Protocol_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_URI.Match newMatch(final Object... parameters) {
    return Protocol_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_URI INSTANCE = new Protocol_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
