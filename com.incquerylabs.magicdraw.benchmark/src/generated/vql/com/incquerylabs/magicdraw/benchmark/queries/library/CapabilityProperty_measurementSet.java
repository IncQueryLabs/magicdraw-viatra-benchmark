...
public final class CapabilityProperty_measurementSet extends BaseGeneratedEMFQuerySpecification<CapabilityProperty_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityProperty_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityProperty_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty_measurementSet.Match)) {
          CapabilityProperty_measurementSet.Match other = (CapabilityProperty_measurementSet.Match) obj;
    ...
    @Override
    public CapabilityProperty_measurementSet specification() {
      return CapabilityProperty_measurementSet.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityProperty_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityProperty_measurementSet.Match {
    ...
    private static final class Immutable extends CapabilityProperty_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityProperty_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityProperty_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityProperty_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super CapabilityProperty_measurementSet.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return CapabilityProperty_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityProperty_measurementSet.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityProperty_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty_measurementSet.Matcher> querySpecification() {
      return CapabilityProperty_measurementSet.instance();
    }
  }
  
  private CapabilityProperty_measurementSet() {
   ...
   * 
   */
  public static CapabilityProperty_measurementSet instance() {
    try{
  ...
  @Override
  protected CapabilityProperty_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty_measurementSet.Matcher instantiate() {
    return CapabilityProperty_measurementSet.Matcher.create();
  }
  
  @Override
  public CapabilityProperty_measurementSet.Match newEmptyMatch() {
    return CapabilityProperty_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty_measurementSet.Match newMatch(final Object... parameters) {
    return CapabilityProperty_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty_measurementSet INSTANCE = new CapabilityProperty_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
