...
public final class FunctionalRequirement_Derived extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.functionalRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.functionalRequirement_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalRequirement_Derived.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalRequirement_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalRequirement_Derived.Match)) {
          FunctionalRequirement_Derived.Match other = (FunctionalRequirement_Derived.Match) obj;
    ...
    @Override
    public FunctionalRequirement_Derived specification() {
     ...
     * 
     */
    public static FunctionalRequirement_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalRequirement_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static FunctionalRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalRequirement_Derived.Match {
    ...
    private static final class Immutable extends FunctionalRequirement_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.functionalRequirement_Derived pattern,
   ...
   * 
   * @see Match
   * @see FunctionalRequirement_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalRequirement_Derived.Match> {
    /**
     ...
     * 
     */
    public static FunctionalRequirement_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalRequirement_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalRequirement_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalRequirement_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FunctionalRequirement_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FunctionalRequirement_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super FunctionalRequirement_Derived.Match> processor) {
     ...
     * 
     */
    public FunctionalRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return FunctionalRequirement_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final FunctionalRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final FunctionalRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final FunctionalRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final FunctionalRequirement_Derived.Match partialMatch) {
    ...
    @Override
    protected FunctionalRequirement_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalRequirement_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalRequirement_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalRequirement_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalRequirement_Derived.Matcher> querySpecification() {
      return FunctionalRequirement_Derived.instance();
    }
  }
  
  private FunctionalRequirement_Derived() {
   ...
   * 
   */
  public static FunctionalRequirement_Derived instance() {
    try{
  ...
  @Override
  protected FunctionalRequirement_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalRequirement_Derived.Matcher.on(engine);
  }
  
  @Override
  public FunctionalRequirement_Derived.Matcher instantiate() {
    return FunctionalRequirement_Derived.Matcher.create();
  }
  
  @Override
  public FunctionalRequirement_Derived.Match newEmptyMatch() {
    return FunctionalRequirement_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalRequirement_Derived.Match newMatch(final Object... parameters) {
    return FunctionalRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalRequirement_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalRequirement_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalRequirement_Derived INSTANCE = new FunctionalRequirement_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalRequirement_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
