...
public final class OperationalPerformer_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<OperationalPerformer_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalPerformer_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public OperationalPerformer_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalPerformer_requiredEnvironment.Match)) {
          OperationalPerformer_requiredEnvironment.Match other = (OperationalPerformer_requiredEnvironment.Match) obj;
    ...
    @Override
    public OperationalPerformer_requiredEnvironment specification() {
      return OperationalPerformer_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static OperationalPerformer_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalPerformer_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalPerformer_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalPerformer_requiredEnvironment.Match {
    ...
    private static final class Immutable extends OperationalPerformer_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see OperationalPerformer_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalPerformer_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static OperationalPerformer_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalPerformer_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalPerformer_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalPerformer_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalPerformer_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalPerformer_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalPerformer_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public OperationalPerformer_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalPerformer_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalPerformer_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalPerformer_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalPerformer_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalPerformer_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected OperationalPerformer_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalPerformer_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalPerformer_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalPerformer_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalPerformer_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalPerformer_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalPerformer_requiredEnvironment.Matcher> querySpecification() {
      return OperationalPerformer_requiredEnvironment.instance();
    }
  }
  
  private OperationalPerformer_requiredEnvironment() {
   ...
   * 
   */
  public static OperationalPerformer_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected OperationalPerformer_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalPerformer_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public OperationalPerformer_requiredEnvironment.Matcher instantiate() {
    return OperationalPerformer_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public OperationalPerformer_requiredEnvironment.Match newEmptyMatch() {
    return OperationalPerformer_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalPerformer_requiredEnvironment.Match newMatch(final Object... parameters) {
    return OperationalPerformer_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalPerformer_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalPerformer_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalPerformer_requiredEnvironment INSTANCE = new OperationalPerformer_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalPerformer_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
