...
public final class Organization_actsUpon extends BaseGeneratedEMFQuerySpecification<Organization_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public Organization_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_actsUpon.Match)) {
          Organization_actsUpon.Match other = (Organization_actsUpon.Match) obj;
    ...
    @Override
    public Organization_actsUpon specification() {
      return Organization_actsUpon.instance();
    }
     ...
     * 
     */
    public static Organization_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_actsUpon.Match {
    ...
    private static final class Immutable extends Organization_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see Organization_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static Organization_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_actsUpon.Match> processor) {
     ...
     * 
     */
    public Organization_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_actsUpon.Match partialMatch) {
    ...
    @Override
    protected Organization_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_actsUpon.Matcher> querySpecification() {
      return Organization_actsUpon.instance();
    }
  }
  
  private Organization_actsUpon() {
   ...
   * 
   */
  public static Organization_actsUpon instance() {
    try{
  ...
  @Override
  protected Organization_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public Organization_actsUpon.Matcher instantiate() {
    return Organization_actsUpon.Matcher.create();
  }
  
  @Override
  public Organization_actsUpon.Match newEmptyMatch() {
    return Organization_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_actsUpon.Match newMatch(final Object... parameters) {
    return Organization_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_actsUpon INSTANCE = new Organization_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
