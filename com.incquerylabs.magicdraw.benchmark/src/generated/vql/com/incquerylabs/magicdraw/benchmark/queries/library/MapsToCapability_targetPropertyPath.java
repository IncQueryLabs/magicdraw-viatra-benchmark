...
public final class MapsToCapability_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<MapsToCapability_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return MapsToCapability_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public MapsToCapability_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof MapsToCapability_targetPropertyPath.Match)) {
          MapsToCapability_targetPropertyPath.Match other = (MapsToCapability_targetPropertyPath.Match) obj;
    ...
    @Override
    public MapsToCapability_targetPropertyPath specification() {
      return MapsToCapability_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static MapsToCapability_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static MapsToCapability_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static MapsToCapability_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends MapsToCapability_targetPropertyPath.Match {
    ...
    private static final class Immutable extends MapsToCapability_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see MapsToCapability_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<MapsToCapability_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static MapsToCapability_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static MapsToCapability_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MapsToCapability_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<MapsToCapability_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<MapsToCapability_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<MapsToCapability_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super MapsToCapability_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public MapsToCapability_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return MapsToCapability_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final MapsToCapability_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final MapsToCapability_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final MapsToCapability_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final MapsToCapability_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected MapsToCapability_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return MapsToCapability_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected MapsToCapability_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return MapsToCapability_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected MapsToCapability_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return MapsToCapability_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<MapsToCapability_targetPropertyPath.Matcher> querySpecification() {
      return MapsToCapability_targetPropertyPath.instance();
    }
  }
  
  private MapsToCapability_targetPropertyPath() {
   ...
   * 
   */
  public static MapsToCapability_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected MapsToCapability_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return MapsToCapability_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public MapsToCapability_targetPropertyPath.Matcher instantiate() {
    return MapsToCapability_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public MapsToCapability_targetPropertyPath.Match newEmptyMatch() {
    return MapsToCapability_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public MapsToCapability_targetPropertyPath.Match newMatch(final Object... parameters) {
    return MapsToCapability_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MapsToCapability_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link MapsToCapability_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final MapsToCapability_targetPropertyPath INSTANCE = new MapsToCapability_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final MapsToCapability_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
