...
public final class NodePort extends BaseGeneratedEMFQuerySpecification<NodePort.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodePort pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodePort";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodePort.Match.parameterNames;
    }
    ...
    @Override
    public NodePort.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodePort.Match)) {
          NodePort.Match other = (NodePort.Match) obj;
    ...
    @Override
    public NodePort specification() {
      return NodePort.instance();
    }
     ...
     * 
     */
    public static NodePort.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodePort.Match newMutableMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static NodePort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends NodePort.Match {
    ...
    private static final class Immutable extends NodePort.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodePort pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<NodePort.Match> {
    /**
     ...
     * 
     */
    public static NodePort.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodePort.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodePort.Matcher.class);
     ...
     * 
     */
    public Collection<NodePort.Match> getAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<NodePort.Match> streamAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<NodePort.Match> getOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super NodePort.Match> processor) {
     ...
     * 
     */
    public NodePort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return NodePort.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final NodePort.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final NodePort.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final NodePort.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final NodePort.Match partialMatch) {
    ...
    @Override
    protected NodePort.Match tupleToMatch(final Tuple t) {
      try {
          return NodePort.Match.newMatch((Port) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected NodePort.Match arrayToMatch(final Object[] match) {
      try {
          return NodePort.Match.newMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodePort.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodePort.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodePort.Matcher> querySpecification() {
      return NodePort.instance();
    }
  }
   ...
   * 
   */
  public static NodePort instance() {
    try{
  ...
  @Override
  protected NodePort.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodePort.Matcher.on(engine);
  }
  
  @Override
  public NodePort.Matcher instantiate() {
    return NodePort.Matcher.create();
  }
  
  @Override
  public NodePort.Match newEmptyMatch() {
    return NodePort.Match.newEmptyMatch();
  }
  
  @Override
  public NodePort.Match newMatch(final Object... parameters) {
    return NodePort.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodePort} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodePort#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodePort INSTANCE = new NodePort();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodePort.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "NodePort");
