...
public final class ProtocolLayer_URI extends BaseGeneratedEMFQuerySpecification<ProtocolLayer_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolLayer_URI.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolLayer_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolLayer_URI.Match)) {
          ProtocolLayer_URI.Match other = (ProtocolLayer_URI.Match) obj;
    ...
    @Override
    public ProtocolLayer_URI specification() {
      return ProtocolLayer_URI.instance();
    }
     ...
     * 
     */
    public static ProtocolLayer_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolLayer_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ProtocolLayer_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProtocolLayer_URI.Match {
    ...
    private static final class Immutable extends ProtocolLayer_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_URI pattern,
   ...
   * 
   * @see Match
   * @see ProtocolLayer_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolLayer_URI.Match> {
    /**
     ...
     * 
     */
    public static ProtocolLayer_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolLayer_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolLayer_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolLayer_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ProtocolLayer_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ProtocolLayer_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ProtocolLayer_URI.Match> processor) {
     ...
     * 
     */
    public ProtocolLayer_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ProtocolLayer_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProtocolLayer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProtocolLayer_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ProtocolLayer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ProtocolLayer_URI.Match partialMatch) {
    ...
    @Override
    protected ProtocolLayer_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolLayer_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProtocolLayer_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolLayer_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolLayer_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolLayer_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolLayer_URI.Matcher> querySpecification() {
      return ProtocolLayer_URI.instance();
    }
  }
  
  private ProtocolLayer_URI() {
   ...
   * 
   */
  public static ProtocolLayer_URI instance() {
    try{
  ...
  @Override
  protected ProtocolLayer_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolLayer_URI.Matcher.on(engine);
  }
  
  @Override
  public ProtocolLayer_URI.Matcher instantiate() {
    return ProtocolLayer_URI.Matcher.create();
  }
  
  @Override
  public ProtocolLayer_URI.Match newEmptyMatch() {
    return ProtocolLayer_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolLayer_URI.Match newMatch(final Object... parameters) {
    return ProtocolLayer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolLayer_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolLayer_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolLayer_URI INSTANCE = new ProtocolLayer_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolLayer_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
