...
public final class SecurityDomain_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<SecurityDomain_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_requiredEnvironment.Match)) {
          SecurityDomain_requiredEnvironment.Match other = (SecurityDomain_requiredEnvironment.Match) obj;
    ...
    @Override
    public SecurityDomain_requiredEnvironment specification() {
      return SecurityDomain_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityDomain_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_requiredEnvironment.Match {
    ...
    private static final class Immutable extends SecurityDomain_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityDomain_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityDomain_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityDomain_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityDomain_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_requiredEnvironment.Matcher> querySpecification() {
      return SecurityDomain_requiredEnvironment.instance();
    }
  }
  
  private SecurityDomain_requiredEnvironment() {
   ...
   * 
   */
  public static SecurityDomain_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected SecurityDomain_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_requiredEnvironment.Matcher instantiate() {
    return SecurityDomain_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public SecurityDomain_requiredEnvironment.Match newEmptyMatch() {
    return SecurityDomain_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_requiredEnvironment.Match newMatch(final Object... parameters) {
    return SecurityDomain_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_requiredEnvironment INSTANCE = new SecurityDomain_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
