 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "Interval");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Interval extends BaseGeneratedEMFQuerySpecification<Interval.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Interval pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Interval";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Interval pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Interval} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Interval#instance()}.
   * 
