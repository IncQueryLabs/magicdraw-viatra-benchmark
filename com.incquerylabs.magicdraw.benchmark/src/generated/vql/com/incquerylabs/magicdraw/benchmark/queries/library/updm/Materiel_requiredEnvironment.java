...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel;
...
public final class Materiel_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Materiel_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_requiredEnvironment.Match)) {
          Materiel_requiredEnvironment.Match other = (Materiel_requiredEnvironment.Match) obj;
    ...
    @Override
    public Materiel_requiredEnvironment specification() {
      return Materiel_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Materiel_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Materiel_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Materiel_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Materiel_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Materiel_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Materiel_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Materiel_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Materiel_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Materiel_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Materiel_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Materiel_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Materiel_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Materiel_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Materiel_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Materiel_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_requiredEnvironment.Matcher> querySpecification() {
      return Materiel_requiredEnvironment.instance();
    }
  }
  
  private Materiel_requiredEnvironment() {
   ...
   * 
   */
  public static Materiel_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Materiel_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Materiel_requiredEnvironment.Matcher instantiate() {
    return Materiel_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Materiel_requiredEnvironment.Match newEmptyMatch() {
    return Materiel_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Materiel_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_requiredEnvironment INSTANCE = new Materiel_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Materiel(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Materiel.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
