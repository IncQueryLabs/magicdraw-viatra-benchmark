...
public final class UsabilityRequirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.usabilityRequirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.usabilityRequirement_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return UsabilityRequirement_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public UsabilityRequirement_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof UsabilityRequirement_DerivedFrom.Match)) {
          UsabilityRequirement_DerivedFrom.Match other = (UsabilityRequirement_DerivedFrom.Match) obj;
    ...
    @Override
    public UsabilityRequirement_DerivedFrom specification() {
     ...
     * 
     */
    public static UsabilityRequirement_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static UsabilityRequirement_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static UsabilityRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends UsabilityRequirement_DerivedFrom.Match {
    ...
    private static final class Immutable extends UsabilityRequirement_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.usabilityRequirement_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see UsabilityRequirement_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<UsabilityRequirement_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static UsabilityRequirement_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static UsabilityRequirement_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(UsabilityRequirement_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<UsabilityRequirement_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<UsabilityRequirement_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<UsabilityRequirement_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super UsabilityRequirement_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public UsabilityRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return UsabilityRequirement_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final UsabilityRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final UsabilityRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final UsabilityRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final UsabilityRequirement_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected UsabilityRequirement_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return UsabilityRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected UsabilityRequirement_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return UsabilityRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected UsabilityRequirement_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return UsabilityRequirement_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<UsabilityRequirement_DerivedFrom.Matcher> querySpecification() {
      return UsabilityRequirement_DerivedFrom.instance();
    }
  }
  
  private UsabilityRequirement_DerivedFrom() {
   ...
   * 
   */
  public static UsabilityRequirement_DerivedFrom instance() {
    try{
  ...
  @Override
  protected UsabilityRequirement_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return UsabilityRequirement_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public UsabilityRequirement_DerivedFrom.Matcher instantiate() {
    return UsabilityRequirement_DerivedFrom.Matcher.create();
  }
  
  @Override
  public UsabilityRequirement_DerivedFrom.Match newEmptyMatch() {
    return UsabilityRequirement_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public UsabilityRequirement_DerivedFrom.Match newMatch(final Object... parameters) {
    return UsabilityRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link UsabilityRequirement_DerivedFrom} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link UsabilityRequirement_DerivedFrom#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final UsabilityRequirement_DerivedFrom INSTANCE = new UsabilityRequirement_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final UsabilityRequirement_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find usabilityRequirement(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), UsabilityRequirement.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "DerivedFrom", taggedValue)
