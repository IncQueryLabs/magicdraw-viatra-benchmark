...
public final class OrganizationType_endBoundaryType extends BaseGeneratedEMFQuerySpecification<OrganizationType_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_endBoundaryType.Match)) {
          OrganizationType_endBoundaryType.Match other = (OrganizationType_endBoundaryType.Match) obj;
    ...
    @Override
    public OrganizationType_endBoundaryType specification() {
      return OrganizationType_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static OrganizationType_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_endBoundaryType.Match {
    ...
    private static final class Immutable extends OrganizationType_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public OrganizationType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_endBoundaryType.Matcher> querySpecification() {
      return OrganizationType_endBoundaryType.instance();
    }
  }
  
  private OrganizationType_endBoundaryType() {
   ...
   * 
   */
  public static OrganizationType_endBoundaryType instance() {
    try{
  ...
  @Override
  protected OrganizationType_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_endBoundaryType.Matcher instantiate() {
    return OrganizationType_endBoundaryType.Matcher.create();
  }
  
  @Override
  public OrganizationType_endBoundaryType.Match newEmptyMatch() {
    return OrganizationType_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_endBoundaryType.Match newMatch(final Object... parameters) {
    return OrganizationType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_endBoundaryType INSTANCE = new OrganizationType_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
