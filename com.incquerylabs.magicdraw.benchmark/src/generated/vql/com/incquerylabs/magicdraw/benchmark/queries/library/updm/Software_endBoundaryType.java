...
public final class Software_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Software_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Software_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_endBoundaryType.Match)) {
          Software_endBoundaryType.Match other = (Software_endBoundaryType.Match) obj;
    ...
    @Override
    public Software_endBoundaryType specification() {
      return Software_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Software_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_endBoundaryType.Match {
    ...
    private static final class Immutable extends Software_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Software_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Software_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Software_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Software_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Software_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Software_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Software_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Software_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_endBoundaryType.Matcher> querySpecification() {
      return Software_endBoundaryType.instance();
    }
  }
  
  private Software_endBoundaryType() {
   ...
   * 
   */
  public static Software_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Software_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Software_endBoundaryType.Matcher instantiate() {
    return Software_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Software_endBoundaryType.Match newEmptyMatch() {
    return Software_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Software_endBoundaryType.Match newMatch(final Object... parameters) {
    return Software_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_endBoundaryType INSTANCE = new Software_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
