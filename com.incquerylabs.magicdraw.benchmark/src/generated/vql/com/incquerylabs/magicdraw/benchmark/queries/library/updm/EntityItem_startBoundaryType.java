...
public final class EntityItem_startBoundaryType extends BaseGeneratedEMFQuerySpecification<EntityItem_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityItem_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EntityItem_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityItem_startBoundaryType.Match)) {
          EntityItem_startBoundaryType.Match other = (EntityItem_startBoundaryType.Match) obj;
    ...
    @Override
    public EntityItem_startBoundaryType specification() {
      return EntityItem_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static EntityItem_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityItem_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityItem_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityItem_startBoundaryType.Match {
    ...
    private static final class Immutable extends EntityItem_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EntityItem_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EntityItem_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EntityItem_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityItem_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityItem_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EntityItem_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityItem_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityItem_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EntityItem_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public EntityItem_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EntityItem_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EntityItem_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EntityItem_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityItem_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityItem_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EntityItem_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EntityItem_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityItem_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EntityItem_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityItem_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityItem_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityItem_startBoundaryType.Matcher> querySpecification() {
      return EntityItem_startBoundaryType.instance();
    }
  }
  
  private EntityItem_startBoundaryType() {
   ...
   * 
   */
  public static EntityItem_startBoundaryType instance() {
    try{
  ...
  @Override
  protected EntityItem_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityItem_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EntityItem_startBoundaryType.Matcher instantiate() {
    return EntityItem_startBoundaryType.Matcher.create();
  }
  
  @Override
  public EntityItem_startBoundaryType.Match newEmptyMatch() {
    return EntityItem_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EntityItem_startBoundaryType.Match newMatch(final Object... parameters) {
    return EntityItem_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityItem_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityItem_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityItem_startBoundaryType INSTANCE = new EntityItem_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityItem_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
