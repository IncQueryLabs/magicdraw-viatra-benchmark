...
public final class OwnsProcess_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<OwnsProcess_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsProcess_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public OwnsProcess_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsProcess_sourcePropertyPath.Match)) {
          OwnsProcess_sourcePropertyPath.Match other = (OwnsProcess_sourcePropertyPath.Match) obj;
    ...
    @Override
    public OwnsProcess_sourcePropertyPath specification() {
      return OwnsProcess_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static OwnsProcess_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsProcess_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static OwnsProcess_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsProcess_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends OwnsProcess_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see OwnsProcess_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsProcess_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static OwnsProcess_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsProcess_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsProcess_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsProcess_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<OwnsProcess_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<OwnsProcess_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super OwnsProcess_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public OwnsProcess_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return OwnsProcess_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsProcess_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsProcess_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final OwnsProcess_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final OwnsProcess_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected OwnsProcess_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsProcess_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsProcess_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsProcess_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsProcess_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsProcess_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsProcess_sourcePropertyPath.Matcher> querySpecification() {
      return OwnsProcess_sourcePropertyPath.instance();
    }
  }
  
  private OwnsProcess_sourcePropertyPath() {
   ...
   * 
   */
  public static OwnsProcess_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected OwnsProcess_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsProcess_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public OwnsProcess_sourcePropertyPath.Matcher instantiate() {
    return OwnsProcess_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public OwnsProcess_sourcePropertyPath.Match newEmptyMatch() {
    return OwnsProcess_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsProcess_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return OwnsProcess_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsProcess_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsProcess_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsProcess_sourcePropertyPath INSTANCE = new OwnsProcess_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsProcess_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
