...
public final class OrganizationalResource_startBoundaryType extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_startBoundaryType.Match)) {
          OrganizationalResource_startBoundaryType.Match other = (OrganizationalResource_startBoundaryType.Match) obj;
    ...
    @Override
    public OrganizationalResource_startBoundaryType specification() {
      return OrganizationalResource_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_startBoundaryType.Match {
    ...
    private static final class Immutable extends OrganizationalResource_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_startBoundaryType.Matcher> querySpecification() {
      return OrganizationalResource_startBoundaryType.instance();
    }
  }
  
  private OrganizationalResource_startBoundaryType() {
   ...
   * 
   */
  public static OrganizationalResource_startBoundaryType instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_startBoundaryType.Matcher instantiate() {
    return OrganizationalResource_startBoundaryType.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_startBoundaryType.Match newEmptyMatch() {
    return OrganizationalResource_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_startBoundaryType.Match newMatch(final Object... parameters) {
    return OrganizationalResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_startBoundaryType INSTANCE = new OrganizationalResource_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
