...
public final class InterfaceRequirement_Derived extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceRequirement_Derived.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceRequirement_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceRequirement_Derived.Match)) {
          InterfaceRequirement_Derived.Match other = (InterfaceRequirement_Derived.Match) obj;
    ...
    @Override
    public InterfaceRequirement_Derived specification() {
     ...
     * 
     */
    public static InterfaceRequirement_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceRequirement_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static InterfaceRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends InterfaceRequirement_Derived.Match {
    ...
    private static final class Immutable extends InterfaceRequirement_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Derived pattern,
   ...
   * 
   * @see Match
   * @see InterfaceRequirement_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceRequirement_Derived.Match> {
    /**
     ...
     * 
     */
    public static InterfaceRequirement_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceRequirement_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceRequirement_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceRequirement_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<InterfaceRequirement_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<InterfaceRequirement_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super InterfaceRequirement_Derived.Match> processor) {
     ...
     * 
     */
    public InterfaceRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return InterfaceRequirement_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final InterfaceRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final InterfaceRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final InterfaceRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final InterfaceRequirement_Derived.Match partialMatch) {
    ...
    @Override
    protected InterfaceRequirement_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected InterfaceRequirement_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceRequirement_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceRequirement_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceRequirement_Derived.Matcher> querySpecification() {
      return InterfaceRequirement_Derived.instance();
    }
  }
  
  private InterfaceRequirement_Derived() {
   ...
   * 
   */
  public static InterfaceRequirement_Derived instance() {
    try{
  ...
  @Override
  protected InterfaceRequirement_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceRequirement_Derived.Matcher.on(engine);
  }
  
  @Override
  public InterfaceRequirement_Derived.Matcher instantiate() {
    return InterfaceRequirement_Derived.Matcher.create();
  }
  
  @Override
  public InterfaceRequirement_Derived.Match newEmptyMatch() {
    return InterfaceRequirement_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceRequirement_Derived.Match newMatch(final Object... parameters) {
    return InterfaceRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceRequirement_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceRequirement_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceRequirement_Derived INSTANCE = new InterfaceRequirement_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceRequirement_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
