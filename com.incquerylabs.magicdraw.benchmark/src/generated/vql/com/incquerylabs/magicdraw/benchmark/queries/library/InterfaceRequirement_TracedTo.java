...
public final class InterfaceRequirement_TracedTo extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_TracedTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_TracedTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_TracedTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceRequirement_TracedTo.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceRequirement_TracedTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceRequirement_TracedTo.Match)) {
          InterfaceRequirement_TracedTo.Match other = (InterfaceRequirement_TracedTo.Match) obj;
    ...
    @Override
    public InterfaceRequirement_TracedTo specification() {
     ...
     * 
     */
    public static InterfaceRequirement_TracedTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceRequirement_TracedTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static InterfaceRequirement_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends InterfaceRequirement_TracedTo.Match {
    ...
    private static final class Immutable extends InterfaceRequirement_TracedTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_TracedTo pattern,
   ...
   * 
   * @see Match
   * @see InterfaceRequirement_TracedTo
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceRequirement_TracedTo.Match> {
    /**
     ...
     * 
     */
    public static InterfaceRequirement_TracedTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceRequirement_TracedTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceRequirement_TracedTo.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceRequirement_TracedTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<InterfaceRequirement_TracedTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<InterfaceRequirement_TracedTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super InterfaceRequirement_TracedTo.Match> processor) {
     ...
     * 
     */
    public InterfaceRequirement_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return InterfaceRequirement_TracedTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InterfaceRequirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InterfaceRequirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final InterfaceRequirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final InterfaceRequirement_TracedTo.Match partialMatch) {
    ...
    @Override
    protected InterfaceRequirement_TracedTo.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceRequirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected InterfaceRequirement_TracedTo.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceRequirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceRequirement_TracedTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceRequirement_TracedTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceRequirement_TracedTo.Matcher> querySpecification() {
      return InterfaceRequirement_TracedTo.instance();
    }
  }
  
  private InterfaceRequirement_TracedTo() {
   ...
   * 
   */
  public static InterfaceRequirement_TracedTo instance() {
    try{
  ...
  @Override
  protected InterfaceRequirement_TracedTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceRequirement_TracedTo.Matcher.on(engine);
  }
  
  @Override
  public InterfaceRequirement_TracedTo.Matcher instantiate() {
    return InterfaceRequirement_TracedTo.Matcher.create();
  }
  
  @Override
  public InterfaceRequirement_TracedTo.Match newEmptyMatch() {
    return InterfaceRequirement_TracedTo.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceRequirement_TracedTo.Match newMatch(final Object... parameters) {
    return InterfaceRequirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceRequirement_TracedTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceRequirement_TracedTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceRequirement_TracedTo INSTANCE = new InterfaceRequirement_TracedTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceRequirement_TracedTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
