...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy;
...
public final class Energy_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Energy_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Energy_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_requiredEnvironment.Match)) {
          Energy_requiredEnvironment.Match other = (Energy_requiredEnvironment.Match) obj;
    ...
    @Override
    public Energy_requiredEnvironment specification() {
      return Energy_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Energy_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Energy_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Energy_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Energy_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Energy_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Energy_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_requiredEnvironment.Matcher> querySpecification() {
      return Energy_requiredEnvironment.instance();
    }
  }
  
  private Energy_requiredEnvironment() {
   ...
   * 
   */
  public static Energy_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Energy_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Energy_requiredEnvironment.Matcher instantiate() {
    return Energy_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Energy_requiredEnvironment.Match newEmptyMatch() {
    return Energy_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Energy_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_requiredEnvironment INSTANCE = new Energy_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Energy(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Energy.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
