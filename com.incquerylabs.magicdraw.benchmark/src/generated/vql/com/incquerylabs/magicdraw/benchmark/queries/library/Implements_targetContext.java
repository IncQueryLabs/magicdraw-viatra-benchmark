...
public final class Implements_targetContext extends BaseGeneratedEMFQuerySpecification<Implements_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Implements_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Implements_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Implements_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Implements_targetContext.Match)) {
          Implements_targetContext.Match other = (Implements_targetContext.Match) obj;
    ...
    @Override
    public Implements_targetContext specification() {
      return Implements_targetContext.instance();
    }
     ...
     * 
     */
    public static Implements_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Implements_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Implements_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Implements_targetContext.Match {
    ...
    private static final class Immutable extends Implements_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Implements_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Implements_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Implements_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Implements_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Implements_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Implements_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Implements_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Implements_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Implements_targetContext.Match> processor) {
     ...
     * 
     */
    public Implements_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Implements_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Implements_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Implements_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Implements_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Implements_targetContext.Match partialMatch) {
    ...
    @Override
    protected Implements_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Implements_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Implements_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Implements_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Implements_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Implements_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Implements_targetContext.Matcher> querySpecification() {
      return Implements_targetContext.instance();
    }
  }
  
  private Implements_targetContext() {
   ...
   * 
   */
  public static Implements_targetContext instance() {
    try{
  ...
  @Override
  protected Implements_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Implements_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Implements_targetContext.Matcher instantiate() {
    return Implements_targetContext.Matcher.create();
  }
  
  @Override
  public Implements_targetContext.Match newEmptyMatch() {
    return Implements_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Implements_targetContext.Match newMatch(final Object... parameters) {
    return Implements_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Implements_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Implements_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Implements_targetContext INSTANCE = new Implements_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Implements_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
