...
public final class ExternalTupleType_propertySet extends BaseGeneratedEMFQuerySpecification<ExternalTupleType_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTupleType_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTupleType_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTupleType_propertySet.Match)) {
          ExternalTupleType_propertySet.Match other = (ExternalTupleType_propertySet.Match) obj;
    ...
    @Override
    public ExternalTupleType_propertySet specification() {
      return ExternalTupleType_propertySet.instance();
    }
     ...
     * 
     */
    public static ExternalTupleType_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTupleType_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTupleType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTupleType_propertySet.Match {
    ...
    private static final class Immutable extends ExternalTupleType_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ExternalTupleType_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTupleType_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ExternalTupleType_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTupleType_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTupleType_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTupleType_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTupleType_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTupleType_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTupleType_propertySet.Match> processor) {
     ...
     * 
     */
    public ExternalTupleType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTupleType_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTupleType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTupleType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTupleType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTupleType_propertySet.Match partialMatch) {
    ...
    @Override
    protected ExternalTupleType_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTupleType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTupleType_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTupleType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTupleType_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTupleType_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTupleType_propertySet.Matcher> querySpecification() {
      return ExternalTupleType_propertySet.instance();
    }
  }
  
  private ExternalTupleType_propertySet() {
   ...
   * 
   */
  public static ExternalTupleType_propertySet instance() {
    try{
  ...
  @Override
  protected ExternalTupleType_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTupleType_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ExternalTupleType_propertySet.Matcher instantiate() {
    return ExternalTupleType_propertySet.Matcher.create();
  }
  
  @Override
  public ExternalTupleType_propertySet.Match newEmptyMatch() {
    return ExternalTupleType_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTupleType_propertySet.Match newMatch(final Object... parameters) {
    return ExternalTupleType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTupleType_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTupleType_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTupleType_propertySet INSTANCE = new ExternalTupleType_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTupleType_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
