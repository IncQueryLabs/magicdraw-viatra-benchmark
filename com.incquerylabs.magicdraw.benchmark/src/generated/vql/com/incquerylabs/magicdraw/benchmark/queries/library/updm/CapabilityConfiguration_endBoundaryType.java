...
public final class CapabilityConfiguration_endBoundaryType extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_endBoundaryType.Match)) {
          CapabilityConfiguration_endBoundaryType.Match other = (CapabilityConfiguration_endBoundaryType.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_endBoundaryType specification() {
      return CapabilityConfiguration_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_endBoundaryType.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_endBoundaryType.Matcher> querySpecification() {
      return CapabilityConfiguration_endBoundaryType.instance();
    }
  }
  
  private CapabilityConfiguration_endBoundaryType() {
   ...
   * 
   */
  public static CapabilityConfiguration_endBoundaryType instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_endBoundaryType.Matcher instantiate() {
    return CapabilityConfiguration_endBoundaryType.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_endBoundaryType.Match newEmptyMatch() {
    return CapabilityConfiguration_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_endBoundaryType.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_endBoundaryType INSTANCE = new CapabilityConfiguration_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
