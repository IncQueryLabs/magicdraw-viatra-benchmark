...
public final class PropertySpecificType extends BaseGeneratedEMFQuerySpecification<PropertySpecificType.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static PropertySpecificType.Match newMutableMatch(final Classifier pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static PropertySpecificType.Match newMatch(final Classifier pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<PropertySpecificType.Match> {
     ...
     * 
     */
    public Collection<PropertySpecificType.Match> getAllMatches(final Classifier pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<PropertySpecificType.Match> streamAllMatches(final Classifier pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<PropertySpecificType.Match> getOneArbitraryMatch(final Classifier pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Classifier pElement, final Stereotype pStereotype, final Consumer<? super PropertySpecificType.Match> processor) {
     ...
     * 
     */
    public PropertySpecificType.Match newMatch(final Classifier pElement, final Stereotype pStereotype) {
      return PropertySpecificType.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final PropertySpecificType.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final PropertySpecificType.Match partialMatch) {
    ...
    protected PropertySpecificType.Match tupleToMatch(final Tuple t) {
      try {
          return PropertySpecificType.Match.newMatch((Classifier) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected PropertySpecificType.Match arrayToMatch(final Object[] match) {
      try {
          return PropertySpecificType.Match.newMatch((Classifier) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected PropertySpecificType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PropertySpecificType.Match.newMutableMatch((Classifier) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public PropertySpecificType.Match newMatch(final Object... parameters) {
    return PropertySpecificType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
