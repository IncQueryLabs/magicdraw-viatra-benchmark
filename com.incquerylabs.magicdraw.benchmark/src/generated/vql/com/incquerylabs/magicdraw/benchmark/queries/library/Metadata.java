...
public final class Metadata extends BaseGeneratedEMFQuerySpecification<Metadata.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Metadata pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Metadata";
    }
    
    @Override
    public List<String> parameterNames() {
      return Metadata.Match.parameterNames;
    }
    ...
    @Override
    public Metadata.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Metadata.Match)) {
          Metadata.Match other = (Metadata.Match) obj;
     ...
     * 
     */
    public static Metadata.Match newEmptyMatch() {
     ...
     * 
     */
    public static Metadata.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Metadata.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Metadata.Match {
    ...
    private static final class Immutable extends Metadata.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Metadata pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Metadata.Match> {
    /**
     ...
     * 
     */
    public static Metadata.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Metadata.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Metadata.Matcher.class);
     ...
     * 
     */
    public Collection<Metadata.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Metadata.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Metadata.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Metadata.Match> processor) {
     ...
     * 
     */
    public Metadata.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Metadata.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Metadata.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Metadata.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Metadata.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Metadata.Match partialMatch) {
    ...
    @Override
    protected Metadata.Match tupleToMatch(final Tuple t) {
      try {
          return Metadata.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Metadata.Match arrayToMatch(final Object[] match) {
      try {
          return Metadata.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Metadata.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Metadata.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Metadata.Matcher> querySpecification() {
      return Metadata.instance();
    }
  }
  ...
  @Override
  protected Metadata.Matcher instantiate(final ViatraQueryEngine engine) {
    return Metadata.Matcher.on(engine);
  }
  
  @Override
  public Metadata.Matcher instantiate() {
    return Metadata.Matcher.create();
  }
  
  @Override
  public Metadata.Match newEmptyMatch() {
    return Metadata.Match.newEmptyMatch();
  }
  
  @Override
  public Metadata.Match newMatch(final Object... parameters) {
    return Metadata.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Metadata} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Metadata#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Metadata.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Metadata")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Metadata");
