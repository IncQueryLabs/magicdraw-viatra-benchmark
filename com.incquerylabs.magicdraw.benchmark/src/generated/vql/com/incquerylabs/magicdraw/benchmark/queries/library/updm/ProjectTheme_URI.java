...
public final class ProjectTheme_URI extends BaseGeneratedEMFQuerySpecification<ProjectTheme_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectTheme_URI.Match.parameterNames;
    }
    ...
    @Override
    public ProjectTheme_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectTheme_URI.Match)) {
          ProjectTheme_URI.Match other = (ProjectTheme_URI.Match) obj;
    ...
    @Override
    public ProjectTheme_URI specification() {
      return ProjectTheme_URI.instance();
    }
     ...
     * 
     */
    public static ProjectTheme_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectTheme_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ProjectTheme_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProjectTheme_URI.Match {
    ...
    private static final class Immutable extends ProjectTheme_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_URI pattern,
   ...
   * 
   * @see Match
   * @see ProjectTheme_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectTheme_URI.Match> {
    /**
     ...
     * 
     */
    public static ProjectTheme_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectTheme_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectTheme_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectTheme_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ProjectTheme_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ProjectTheme_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ProjectTheme_URI.Match> processor) {
     ...
     * 
     */
    public ProjectTheme_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ProjectTheme_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectTheme_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectTheme_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ProjectTheme_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ProjectTheme_URI.Match partialMatch) {
    ...
    @Override
    protected ProjectTheme_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectTheme_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProjectTheme_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectTheme_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectTheme_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectTheme_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectTheme_URI.Matcher> querySpecification() {
      return ProjectTheme_URI.instance();
    }
  }
  
  private ProjectTheme_URI() {
   ...
   * 
   */
  public static ProjectTheme_URI instance() {
    try{
  ...
  @Override
  protected ProjectTheme_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectTheme_URI.Matcher.on(engine);
  }
  
  @Override
  public ProjectTheme_URI.Matcher instantiate() {
    return ProjectTheme_URI.Matcher.create();
  }
  
  @Override
  public ProjectTheme_URI.Match newEmptyMatch() {
    return ProjectTheme_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectTheme_URI.Match newMatch(final Object... parameters) {
    return ProjectTheme_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectTheme_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectTheme_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectTheme_URI INSTANCE = new ProjectTheme_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectTheme_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
