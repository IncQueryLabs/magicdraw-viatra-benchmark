...
public final class EnterpriseGoal extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal.Match)) {
          EnterpriseGoal.Match other = (EnterpriseGoal.Match) obj;
    ...
    @Override
    public EnterpriseGoal specification() {
      return EnterpriseGoal.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static EnterpriseGoal.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends EnterpriseGoal.Match {
    ...
    private static final class Immutable extends EnterpriseGoal.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<EnterpriseGoal.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<EnterpriseGoal.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super EnterpriseGoal.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return EnterpriseGoal.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final EnterpriseGoal.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final EnterpriseGoal.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected EnterpriseGoal.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal.Matcher> querySpecification() {
      return EnterpriseGoal.instance();
    }
  }
  
  private EnterpriseGoal() {
   ...
   * 
   */
  public static EnterpriseGoal instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal.Matcher instantiate() {
    return EnterpriseGoal.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal.Match newEmptyMatch() {
    return EnterpriseGoal.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal.Match newMatch(final Object... parameters) {
    return EnterpriseGoal.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal INSTANCE = new EnterpriseGoal();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "EnterpriseGoal")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "EnterpriseGoal");
