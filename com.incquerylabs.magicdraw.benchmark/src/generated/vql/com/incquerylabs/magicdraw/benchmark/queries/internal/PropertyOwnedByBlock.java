...
public final class PropertyOwnedByBlock extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private PropertyOwnedByBlock() {
   ...
   * 
   */
  public static PropertyOwnedByBlock instance() {
    try{
  ...
  private static class LazyHolder {
    private static final PropertyOwnedByBlock INSTANCE = new PropertyOwnedByBlock();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PropertyOwnedByBlock.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.propertyOwnedByBlock";
    }
