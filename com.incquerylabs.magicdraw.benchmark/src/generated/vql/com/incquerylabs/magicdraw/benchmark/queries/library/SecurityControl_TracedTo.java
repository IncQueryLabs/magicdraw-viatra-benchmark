...
public final class SecurityControl_TracedTo extends BaseGeneratedEMFQuerySpecification<SecurityControl_TracedTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_TracedTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_TracedTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_TracedTo.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_TracedTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_TracedTo.Match)) {
          SecurityControl_TracedTo.Match other = (SecurityControl_TracedTo.Match) obj;
    ...
    @Override
    public SecurityControl_TracedTo specification() {
      return SecurityControl_TracedTo.instance();
    }
     ...
     * 
     */
    public static SecurityControl_TracedTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_TracedTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static SecurityControl_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControl_TracedTo.Match {
    ...
    private static final class Immutable extends SecurityControl_TracedTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_TracedTo pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_TracedTo
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_TracedTo.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_TracedTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_TracedTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_TracedTo.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_TracedTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<SecurityControl_TracedTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<SecurityControl_TracedTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super SecurityControl_TracedTo.Match> processor) {
     ...
     * 
     */
    public SecurityControl_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return SecurityControl_TracedTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final SecurityControl_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final SecurityControl_TracedTo.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_TracedTo.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControl_TracedTo.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_TracedTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_TracedTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_TracedTo.Matcher> querySpecification() {
      return SecurityControl_TracedTo.instance();
    }
  }
  
  private SecurityControl_TracedTo() {
   ...
   * 
   */
  public static SecurityControl_TracedTo instance() {
    try{
  ...
  @Override
  protected SecurityControl_TracedTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_TracedTo.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_TracedTo.Matcher instantiate() {
    return SecurityControl_TracedTo.Matcher.create();
  }
  
  @Override
  public SecurityControl_TracedTo.Match newEmptyMatch() {
    return SecurityControl_TracedTo.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_TracedTo.Match newMatch(final Object... parameters) {
    return SecurityControl_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_TracedTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_TracedTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_TracedTo INSTANCE = new SecurityControl_TracedTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_TracedTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
