...
public final class ServiceAttribute_URI extends BaseGeneratedEMFQuerySpecification<ServiceAttribute_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAttribute_URI.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAttribute_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAttribute_URI.Match)) {
          ServiceAttribute_URI.Match other = (ServiceAttribute_URI.Match) obj;
    ...
    @Override
    public ServiceAttribute_URI specification() {
      return ServiceAttribute_URI.instance();
    }
     ...
     * 
     */
    public static ServiceAttribute_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAttribute_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ServiceAttribute_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ServiceAttribute_URI.Match {
    ...
    private static final class Immutable extends ServiceAttribute_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_URI pattern,
   ...
   * 
   * @see Match
   * @see ServiceAttribute_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAttribute_URI.Match> {
    /**
     ...
     * 
     */
    public static ServiceAttribute_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAttribute_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAttribute_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAttribute_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ServiceAttribute_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ServiceAttribute_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ServiceAttribute_URI.Match> processor) {
     ...
     * 
     */
    public ServiceAttribute_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ServiceAttribute_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceAttribute_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceAttribute_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ServiceAttribute_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ServiceAttribute_URI.Match partialMatch) {
    ...
    @Override
    protected ServiceAttribute_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAttribute_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ServiceAttribute_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAttribute_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAttribute_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAttribute_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAttribute_URI.Matcher> querySpecification() {
      return ServiceAttribute_URI.instance();
    }
  }
  
  private ServiceAttribute_URI() {
   ...
   * 
   */
  public static ServiceAttribute_URI instance() {
    try{
  ...
  @Override
  protected ServiceAttribute_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAttribute_URI.Matcher.on(engine);
  }
  
  @Override
  public ServiceAttribute_URI.Matcher instantiate() {
    return ServiceAttribute_URI.Matcher.create();
  }
  
  @Override
  public ServiceAttribute_URI.Match newEmptyMatch() {
    return ServiceAttribute_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAttribute_URI.Match newMatch(final Object... parameters) {
    return ServiceAttribute_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAttribute_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAttribute_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAttribute_URI INSTANCE = new ServiceAttribute_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAttribute_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
