...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill;
...
public final class Skill_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Skill_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Skill_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Skill_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Skill_actualPropertySet.Match)) {
          Skill_actualPropertySet.Match other = (Skill_actualPropertySet.Match) obj;
    ...
    @Override
    public Skill_actualPropertySet specification() {
      return Skill_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Skill_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Skill_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Skill_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Skill_actualPropertySet.Match {
    ...
    private static final class Immutable extends Skill_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Skill_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Skill_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Skill_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Skill_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Skill_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Skill_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Skill_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Skill_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Skill_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Skill_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Skill_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Skill_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Skill_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Skill_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Skill_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Skill_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Skill_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Skill_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Skill_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Skill_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Skill_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Skill_actualPropertySet.Matcher> querySpecification() {
      return Skill_actualPropertySet.instance();
    }
  }
  
  private Skill_actualPropertySet() {
   ...
   * 
   */
  public static Skill_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Skill_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Skill_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Skill_actualPropertySet.Matcher instantiate() {
    return Skill_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Skill_actualPropertySet.Match newEmptyMatch() {
    return Skill_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Skill_actualPropertySet.Match newMatch(final Object... parameters) {
    return Skill_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Skill_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Skill_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Skill_actualPropertySet INSTANCE = new Skill_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Skill_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Skill(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Skill.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
