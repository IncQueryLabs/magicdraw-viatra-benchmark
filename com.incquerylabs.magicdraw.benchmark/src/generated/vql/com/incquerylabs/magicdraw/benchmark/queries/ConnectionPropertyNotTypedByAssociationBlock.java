...
public final class ConnectionPropertyNotTypedByAssociationBlock extends BaseGeneratedEMFQuerySpecification<ConnectionPropertyNotTypedByAssociationBlock.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.connectionPropertyNotTypedByAssociationBlock pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.connectionPropertyNotTypedByAssociationBlock";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConnectionPropertyNotTypedByAssociationBlock.Match.parameterNames;
    }
    ...
    @Override
    public ConnectionPropertyNotTypedByAssociationBlock.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConnectionPropertyNotTypedByAssociationBlock.Match)) {
          ConnectionPropertyNotTypedByAssociationBlock.Match other = (ConnectionPropertyNotTypedByAssociationBlock.Match) obj;
    ...
    @Override
    public ConnectionPropertyNotTypedByAssociationBlock specification() {
     ...
     * 
     */
    public static ConnectionPropertyNotTypedByAssociationBlock.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConnectionPropertyNotTypedByAssociationBlock.Match newMutableMatch(final Property pProperty, final Connector pConnector) {
     ...
     * 
     */
    public static ConnectionPropertyNotTypedByAssociationBlock.Match newMatch(final Property pProperty, final Connector pConnector) {
      return new Immutable(pProperty, pConnector);
    }
    
    private static final class Mutable extends ConnectionPropertyNotTypedByAssociationBlock.Match {
    ...
    private static final class Immutable extends ConnectionPropertyNotTypedByAssociationBlock.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.connectionPropertyNotTypedByAssociationBlock pattern,
   ...
   * 
   * @see Match
   * @see ConnectionPropertyNotTypedByAssociationBlock
   * 
   */
  public static class Matcher extends BaseMatcher<ConnectionPropertyNotTypedByAssociationBlock.Match> {
    /**
     ...
     * 
     */
    public static ConnectionPropertyNotTypedByAssociationBlock.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConnectionPropertyNotTypedByAssociationBlock.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConnectionPropertyNotTypedByAssociationBlock.Matcher.class);
     ...
     * 
     */
    public Collection<ConnectionPropertyNotTypedByAssociationBlock.Match> getAllMatches(final Property pProperty, final Connector pConnector) {
     ...
     * 
     */
    public Stream<ConnectionPropertyNotTypedByAssociationBlock.Match> streamAllMatches(final Property pProperty, final Connector pConnector) {
     ...
     * 
     */
    public Optional<ConnectionPropertyNotTypedByAssociationBlock.Match> getOneArbitraryMatch(final Property pProperty, final Connector pConnector) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pProperty, final Connector pConnector, final Consumer<? super ConnectionPropertyNotTypedByAssociationBlock.Match> processor) {
     ...
     * 
     */
    public ConnectionPropertyNotTypedByAssociationBlock.Match newMatch(final Property pProperty, final Connector pConnector) {
      return ConnectionPropertyNotTypedByAssociationBlock.Match.newMatch(pProperty, pConnector);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfproperty(final ConnectionPropertyNotTypedByAssociationBlock.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfproperty(final ConnectionPropertyNotTypedByAssociationBlock.Match partialMatch) {
     ...
     * 
     */
    public Stream<Connector> streamAllValuesOfconnector(final ConnectionPropertyNotTypedByAssociationBlock.Match partialMatch) {
     ...
     * 
     */
    public Set<Connector> getAllValuesOfconnector(final ConnectionPropertyNotTypedByAssociationBlock.Match partialMatch) {
    ...
    @Override
    protected ConnectionPropertyNotTypedByAssociationBlock.Match tupleToMatch(final Tuple t) {
      try {
          return ConnectionPropertyNotTypedByAssociationBlock.Match.newMatch((Property) t.get(POSITION_PROPERTY), (Connector) t.get(POSITION_CONNECTOR));
    ...
    @Override
    protected ConnectionPropertyNotTypedByAssociationBlock.Match arrayToMatch(final Object[] match) {
      try {
          return ConnectionPropertyNotTypedByAssociationBlock.Match.newMatch((Property) match[POSITION_PROPERTY], (Connector) match[POSITION_CONNECTOR]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConnectionPropertyNotTypedByAssociationBlock.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConnectionPropertyNotTypedByAssociationBlock.Match.newMutableMatch((Property) match[POSITION_PROPERTY], (Connector) match[POSITION_CONNECTOR]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConnectionPropertyNotTypedByAssociationBlock.Matcher> querySpecification() {
      return ConnectionPropertyNotTypedByAssociationBlock.instance();
    }
  }
  
  private ConnectionPropertyNotTypedByAssociationBlock() {
   ...
   * 
   */
  public static ConnectionPropertyNotTypedByAssociationBlock instance() {
    try{
  ...
  @Override
  protected ConnectionPropertyNotTypedByAssociationBlock.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConnectionPropertyNotTypedByAssociationBlock.Matcher.on(engine);
  }
  
  @Override
  public ConnectionPropertyNotTypedByAssociationBlock.Matcher instantiate() {
    return ConnectionPropertyNotTypedByAssociationBlock.Matcher.create();
  }
  
  @Override
  public ConnectionPropertyNotTypedByAssociationBlock.Match newEmptyMatch() {
    return ConnectionPropertyNotTypedByAssociationBlock.Match.newEmptyMatch();
  }
  
  @Override
  public ConnectionPropertyNotTypedByAssociationBlock.Match newMatch(final Object... parameters) {
    return ConnectionPropertyNotTypedByAssociationBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.compositestructures.mdinternalstructures.Connector) parameters[1]);
  }
  ...
  private static class LazyHolder {
    private static final ConnectionPropertyNotTypedByAssociationBlock INSTANCE = new ConnectionPropertyNotTypedByAssociationBlock();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConnectionPropertyNotTypedByAssociationBlock.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_connector, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Connector", "type")));
          ...
          // 	neg find associationBlock(type)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_type), AssociationBlock.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
