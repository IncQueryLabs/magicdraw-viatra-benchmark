...
public final class InformationElement_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<InformationElement_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return InformationElement_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public InformationElement_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InformationElement_requiredEnvironment.Match)) {
          InformationElement_requiredEnvironment.Match other = (InformationElement_requiredEnvironment.Match) obj;
    ...
    @Override
    public InformationElement_requiredEnvironment specification() {
      return InformationElement_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static InformationElement_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static InformationElement_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static InformationElement_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends InformationElement_requiredEnvironment.Match {
    ...
    private static final class Immutable extends InformationElement_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see InformationElement_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<InformationElement_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static InformationElement_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InformationElement_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InformationElement_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<InformationElement_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<InformationElement_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<InformationElement_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super InformationElement_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public InformationElement_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return InformationElement_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InformationElement_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InformationElement_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final InformationElement_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final InformationElement_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected InformationElement_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return InformationElement_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected InformationElement_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return InformationElement_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InformationElement_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InformationElement_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InformationElement_requiredEnvironment.Matcher> querySpecification() {
      return InformationElement_requiredEnvironment.instance();
    }
  }
  
  private InformationElement_requiredEnvironment() {
   ...
   * 
   */
  public static InformationElement_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected InformationElement_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return InformationElement_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public InformationElement_requiredEnvironment.Matcher instantiate() {
    return InformationElement_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public InformationElement_requiredEnvironment.Match newEmptyMatch() {
    return InformationElement_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public InformationElement_requiredEnvironment.Match newMatch(final Object... parameters) {
    return InformationElement_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InformationElement_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InformationElement_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InformationElement_requiredEnvironment INSTANCE = new InformationElement_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InformationElement_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
