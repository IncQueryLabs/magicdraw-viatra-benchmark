...
public final class InterfaceBlock_original extends BaseGeneratedEMFQuerySpecification<InterfaceBlock_original.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.InterfaceBlock_original pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.InterfaceBlock_original";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceBlock_original.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceBlock_original.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceBlock_original.Match)) {
          InterfaceBlock_original.Match other = (InterfaceBlock_original.Match) obj;
    ...
    @Override
    public InterfaceBlock_original specification() {
     ...
     * 
     */
    public static InterfaceBlock_original.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceBlock_original.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static InterfaceBlock_original.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends InterfaceBlock_original.Match {
    ...
    private static final class Immutable extends InterfaceBlock_original.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.InterfaceBlock_original pattern,
   ...
   * 
   * @see Match
   * @see InterfaceBlock_original
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceBlock_original.Match> {
    /**
     ...
     * 
     */
    public static InterfaceBlock_original.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceBlock_original.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceBlock_original.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceBlock_original.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<InterfaceBlock_original.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<InterfaceBlock_original.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super InterfaceBlock_original.Match> processor) {
     ...
     * 
     */
    public InterfaceBlock_original.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return InterfaceBlock_original.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final InterfaceBlock_original.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final InterfaceBlock_original.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfValue(final InterfaceBlock_original.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfValue(final InterfaceBlock_original.Match partialMatch) {
    ...
    @Override
    protected InterfaceBlock_original.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceBlock_original.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    @Override
    protected InterfaceBlock_original.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceBlock_original.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceBlock_original.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceBlock_original.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceBlock_original.Matcher> querySpecification() {
      return InterfaceBlock_original.instance();
    }
  }
  
  private InterfaceBlock_original() {
   ...
   * 
   */
  public static InterfaceBlock_original instance() {
    try{
  ...
  @Override
  protected InterfaceBlock_original.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceBlock_original.Matcher.on(engine);
  }
  
  @Override
  public InterfaceBlock_original.Matcher instantiate() {
    return InterfaceBlock_original.Matcher.create();
  }
  
  @Override
  public InterfaceBlock_original.Match newEmptyMatch() {
    return InterfaceBlock_original.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceBlock_original.Match newMatch(final Object... parameters) {
    return InterfaceBlock_original.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceBlock_original} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceBlock_original#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceBlock_original INSTANCE = new InterfaceBlock_original();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceBlock_original.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private final PParameter parameter_Value = new PParameter("Value", "com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Class")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_Value), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Class")));
          body.setSymbolicParameters(Arrays.<ExportedParameter>asList(
             new ExportedParameter(body, var_Element, parameter_Element),
             new ExportedParameter(body, var_Value, parameter_Value)
          ));
          // 	find InterfaceBlock(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), InterfaceBlock.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "original", taggedValue)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "original");
