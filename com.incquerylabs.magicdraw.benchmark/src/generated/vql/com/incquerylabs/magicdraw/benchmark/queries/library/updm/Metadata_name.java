...
public final class Metadata_name extends BaseGeneratedEMFQuerySpecification<Metadata_name.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Metadata_name pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Metadata_name";
    }
    
    @Override
    public List<String> parameterNames() {
      return Metadata_name.Match.parameterNames;
    }
    ...
    @Override
    public Metadata_name.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Metadata_name.Match)) {
          Metadata_name.Match other = (Metadata_name.Match) obj;
    ...
    @Override
    public Metadata_name specification() {
      return Metadata_name.instance();
    }
     ...
     * 
     */
    public static Metadata_name.Match newEmptyMatch() {
     ...
     * 
     */
    public static Metadata_name.Match newMutableMatch(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Metadata_name.Match newMatch(final Comment pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Metadata_name.Match {
    ...
    private static final class Immutable extends Metadata_name.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Metadata_name pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Metadata_name.Match> {
    /**
     ...
     * 
     */
    public static Metadata_name.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Metadata_name.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Metadata_name.Matcher.class);
     ...
     * 
     */
    public Collection<Metadata_name.Match> getAllMatches(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Metadata_name.Match> streamAllMatches(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Metadata_name.Match> getOneArbitraryMatch(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final LiteralString pValuespec, final Consumer<? super Metadata_name.Match> processor) {
     ...
     * 
     */
    public Metadata_name.Match newMatch(final Comment pElement, final LiteralString pValuespec) {
      return Metadata_name.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Metadata_name.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Metadata_name.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Metadata_name.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Metadata_name.Match partialMatch) {
    ...
    @Override
    protected Metadata_name.Match tupleToMatch(final Tuple t) {
      try {
          return Metadata_name.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Metadata_name.Match arrayToMatch(final Object[] match) {
      try {
          return Metadata_name.Match.newMatch((Comment) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Metadata_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Metadata_name.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Metadata_name.Matcher> querySpecification() {
      return Metadata_name.instance();
    }
  }
   ...
   * 
   */
  public static Metadata_name instance() {
    try{
  ...
  @Override
  protected Metadata_name.Matcher instantiate(final ViatraQueryEngine engine) {
    return Metadata_name.Matcher.on(engine);
  }
  
  @Override
  public Metadata_name.Matcher instantiate() {
    return Metadata_name.Matcher.create();
  }
  
  @Override
  public Metadata_name.Match newEmptyMatch() {
    return Metadata_name.Match.newEmptyMatch();
  }
  
  @Override
  public Metadata_name.Match newMatch(final Object... parameters) {
    return Metadata_name.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Metadata_name} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Metadata_name#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Metadata_name INSTANCE = new Metadata_name();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Metadata_name.GeneratedPQuery INSTANCE = new GeneratedPQuery();
