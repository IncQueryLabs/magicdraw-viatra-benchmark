...
public final class ExchangeElement_propertySet extends BaseGeneratedEMFQuerySpecification<ExchangeElement_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_propertySet.Match)) {
          ExchangeElement_propertySet.Match other = (ExchangeElement_propertySet.Match) obj;
    ...
    @Override
    public ExchangeElement_propertySet specification() {
      return ExchangeElement_propertySet.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_propertySet.Match {
    ...
    private static final class Immutable extends ExchangeElement_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_propertySet.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_propertySet.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_propertySet.Matcher> querySpecification() {
      return ExchangeElement_propertySet.instance();
    }
  }
  
  private ExchangeElement_propertySet() {
   ...
   * 
   */
  public static ExchangeElement_propertySet instance() {
    try{
  ...
  @Override
  protected ExchangeElement_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_propertySet.Matcher instantiate() {
    return ExchangeElement_propertySet.Matcher.create();
  }
  
  @Override
  public ExchangeElement_propertySet.Match newEmptyMatch() {
    return ExchangeElement_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_propertySet.Match newMatch(final Object... parameters) {
    return ExchangeElement_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_propertySet INSTANCE = new ExchangeElement_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
