...
public final class ServiceSpecificationRole_measurementSet extends BaseGeneratedEMFQuerySpecification<ServiceSpecificationRole_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecificationRole_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecificationRole_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceSpecificationRole_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceSpecificationRole_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceSpecificationRole_measurementSet.Match)) {
          ServiceSpecificationRole_measurementSet.Match other = (ServiceSpecificationRole_measurementSet.Match) obj;
    ...
    @Override
    public ServiceSpecificationRole_measurementSet specification() {
      return ServiceSpecificationRole_measurementSet.instance();
    }
     ...
     * 
     */
    public static ServiceSpecificationRole_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceSpecificationRole_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceSpecificationRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceSpecificationRole_measurementSet.Match {
    ...
    private static final class Immutable extends ServiceSpecificationRole_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecificationRole_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see ServiceSpecificationRole_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceSpecificationRole_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static ServiceSpecificationRole_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceSpecificationRole_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceSpecificationRole_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceSpecificationRole_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceSpecificationRole_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceSpecificationRole_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ServiceSpecificationRole_measurementSet.Match> processor) {
     ...
     * 
     */
    public ServiceSpecificationRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ServiceSpecificationRole_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceSpecificationRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceSpecificationRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceSpecificationRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceSpecificationRole_measurementSet.Match partialMatch) {
    ...
    @Override
    protected ServiceSpecificationRole_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceSpecificationRole_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceSpecificationRole_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceSpecificationRole_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceSpecificationRole_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceSpecificationRole_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceSpecificationRole_measurementSet.Matcher> querySpecification() {
      return ServiceSpecificationRole_measurementSet.instance();
    }
  }
  
  private ServiceSpecificationRole_measurementSet() {
   ...
   * 
   */
  public static ServiceSpecificationRole_measurementSet instance() {
    try{
  ...
  @Override
  protected ServiceSpecificationRole_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceSpecificationRole_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public ServiceSpecificationRole_measurementSet.Matcher instantiate() {
    return ServiceSpecificationRole_measurementSet.Matcher.create();
  }
  
  @Override
  public ServiceSpecificationRole_measurementSet.Match newEmptyMatch() {
    return ServiceSpecificationRole_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceSpecificationRole_measurementSet.Match newMatch(final Object... parameters) {
    return ServiceSpecificationRole_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceSpecificationRole_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceSpecificationRole_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceSpecificationRole_measurementSet INSTANCE = new ServiceSpecificationRole_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceSpecificationRole_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
