...
public final class OperationalRole_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<OperationalRole_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalRole_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public OperationalRole_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalRole_actualMeasurementSet.Match)) {
          OperationalRole_actualMeasurementSet.Match other = (OperationalRole_actualMeasurementSet.Match) obj;
    ...
    @Override
    public OperationalRole_actualMeasurementSet specification() {
      return OperationalRole_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static OperationalRole_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalRole_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalRole_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalRole_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends OperationalRole_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see OperationalRole_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalRole_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static OperationalRole_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalRole_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalRole_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalRole_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalRole_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalRole_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super OperationalRole_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public OperationalRole_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return OperationalRole_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalRole_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected OperationalRole_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalRole_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalRole_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalRole_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalRole_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalRole_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalRole_actualMeasurementSet.Matcher> querySpecification() {
      return OperationalRole_actualMeasurementSet.instance();
    }
  }
  
  private OperationalRole_actualMeasurementSet() {
   ...
   * 
   */
  public static OperationalRole_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected OperationalRole_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalRole_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public OperationalRole_actualMeasurementSet.Matcher instantiate() {
    return OperationalRole_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public OperationalRole_actualMeasurementSet.Match newEmptyMatch() {
    return OperationalRole_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalRole_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return OperationalRole_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalRole_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalRole_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalRole_actualMeasurementSet INSTANCE = new OperationalRole_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalRole_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find OperationalRole(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), OperationalRole.instance().getInternalQueryRepresentation());
