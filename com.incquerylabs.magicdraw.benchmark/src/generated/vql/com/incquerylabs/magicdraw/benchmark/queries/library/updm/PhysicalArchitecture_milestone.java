...
public final class PhysicalArchitecture_milestone extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_milestone.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_milestone.Match)) {
          PhysicalArchitecture_milestone.Match other = (PhysicalArchitecture_milestone.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_milestone specification() {
      return PhysicalArchitecture_milestone.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_milestone.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_milestone pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_milestone.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_milestone.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_milestone.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_milestone.Matcher> querySpecification() {
      return PhysicalArchitecture_milestone.instance();
    }
  }
  
  private PhysicalArchitecture_milestone() {
   ...
   * 
   */
  public static PhysicalArchitecture_milestone instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_milestone.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_milestone.Matcher instantiate() {
    return PhysicalArchitecture_milestone.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_milestone.Match newEmptyMatch() {
    return PhysicalArchitecture_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_milestone.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_milestone INSTANCE = new PhysicalArchitecture_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
