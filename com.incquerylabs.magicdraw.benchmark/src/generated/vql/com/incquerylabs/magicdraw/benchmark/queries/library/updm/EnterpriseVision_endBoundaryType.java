...
public final class EnterpriseVision_endBoundaryType extends BaseGeneratedEMFQuerySpecification<EnterpriseVision_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseVision_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseVision_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseVision_endBoundaryType.Match)) {
          EnterpriseVision_endBoundaryType.Match other = (EnterpriseVision_endBoundaryType.Match) obj;
    ...
    @Override
    public EnterpriseVision_endBoundaryType specification() {
      return EnterpriseVision_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static EnterpriseVision_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseVision_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseVision_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseVision_endBoundaryType.Match {
    ...
    private static final class Immutable extends EnterpriseVision_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseVision_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseVision_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseVision_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseVision_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseVision_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseVision_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseVision_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseVision_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseVision_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public EnterpriseVision_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseVision_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseVision_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseVision_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseVision_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseVision_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EnterpriseVision_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseVision_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseVision_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseVision_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseVision_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseVision_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseVision_endBoundaryType.Matcher> querySpecification() {
      return EnterpriseVision_endBoundaryType.instance();
    }
  }
  
  private EnterpriseVision_endBoundaryType() {
   ...
   * 
   */
  public static EnterpriseVision_endBoundaryType instance() {
    try{
  ...
  @Override
  protected EnterpriseVision_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseVision_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseVision_endBoundaryType.Matcher instantiate() {
    return EnterpriseVision_endBoundaryType.Matcher.create();
  }
  
  @Override
  public EnterpriseVision_endBoundaryType.Match newEmptyMatch() {
    return EnterpriseVision_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseVision_endBoundaryType.Match newMatch(final Object... parameters) {
    return EnterpriseVision_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseVision_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseVision_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseVision_endBoundaryType INSTANCE = new EnterpriseVision_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseVision_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
