...
public final class OwnsProcess_targetContext extends BaseGeneratedEMFQuerySpecification<OwnsProcess_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsProcess_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public OwnsProcess_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsProcess_targetContext.Match)) {
          OwnsProcess_targetContext.Match other = (OwnsProcess_targetContext.Match) obj;
    ...
    @Override
    public OwnsProcess_targetContext specification() {
      return OwnsProcess_targetContext.instance();
    }
     ...
     * 
     */
    public static OwnsProcess_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsProcess_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static OwnsProcess_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsProcess_targetContext.Match {
    ...
    private static final class Immutable extends OwnsProcess_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_targetContext pattern,
   ...
   * 
   * @see Match
   * @see OwnsProcess_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsProcess_targetContext.Match> {
    /**
     ...
     * 
     */
    public static OwnsProcess_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsProcess_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsProcess_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsProcess_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<OwnsProcess_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<OwnsProcess_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super OwnsProcess_targetContext.Match> processor) {
     ...
     * 
     */
    public OwnsProcess_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return OwnsProcess_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsProcess_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsProcess_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final OwnsProcess_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final OwnsProcess_targetContext.Match partialMatch) {
    ...
    @Override
    protected OwnsProcess_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsProcess_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsProcess_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsProcess_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsProcess_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsProcess_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsProcess_targetContext.Matcher> querySpecification() {
      return OwnsProcess_targetContext.instance();
    }
  }
  
  private OwnsProcess_targetContext() {
   ...
   * 
   */
  public static OwnsProcess_targetContext instance() {
    try{
  ...
  @Override
  protected OwnsProcess_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsProcess_targetContext.Matcher.on(engine);
  }
  
  @Override
  public OwnsProcess_targetContext.Matcher instantiate() {
    return OwnsProcess_targetContext.Matcher.create();
  }
  
  @Override
  public OwnsProcess_targetContext.Match newEmptyMatch() {
    return OwnsProcess_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsProcess_targetContext.Match newMatch(final Object... parameters) {
    return OwnsProcess_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsProcess_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsProcess_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsProcess_targetContext INSTANCE = new OwnsProcess_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsProcess_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
