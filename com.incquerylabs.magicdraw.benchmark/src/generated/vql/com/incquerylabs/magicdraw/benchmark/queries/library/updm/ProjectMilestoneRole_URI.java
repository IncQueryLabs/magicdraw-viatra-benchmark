...
public final class ProjectMilestoneRole_URI extends BaseGeneratedEMFQuerySpecification<ProjectMilestoneRole_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestoneRole_URI.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestoneRole_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestoneRole_URI.Match)) {
          ProjectMilestoneRole_URI.Match other = (ProjectMilestoneRole_URI.Match) obj;
    ...
    @Override
    public ProjectMilestoneRole_URI specification() {
      return ProjectMilestoneRole_URI.instance();
    }
     ...
     * 
     */
    public static ProjectMilestoneRole_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestoneRole_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ProjectMilestoneRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProjectMilestoneRole_URI.Match {
    ...
    private static final class Immutable extends ProjectMilestoneRole_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_URI pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestoneRole_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestoneRole_URI.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestoneRole_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestoneRole_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestoneRole_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestoneRole_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ProjectMilestoneRole_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ProjectMilestoneRole_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ProjectMilestoneRole_URI.Match> processor) {
     ...
     * 
     */
    public ProjectMilestoneRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ProjectMilestoneRole_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectMilestoneRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectMilestoneRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ProjectMilestoneRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ProjectMilestoneRole_URI.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestoneRole_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestoneRole_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProjectMilestoneRole_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestoneRole_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestoneRole_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestoneRole_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestoneRole_URI.Matcher> querySpecification() {
      return ProjectMilestoneRole_URI.instance();
    }
  }
  
  private ProjectMilestoneRole_URI() {
   ...
   * 
   */
  public static ProjectMilestoneRole_URI instance() {
    try{
  ...
  @Override
  protected ProjectMilestoneRole_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestoneRole_URI.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestoneRole_URI.Matcher instantiate() {
    return ProjectMilestoneRole_URI.Matcher.create();
  }
  
  @Override
  public ProjectMilestoneRole_URI.Match newEmptyMatch() {
    return ProjectMilestoneRole_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestoneRole_URI.Match newMatch(final Object... parameters) {
    return ProjectMilestoneRole_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestoneRole_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestoneRole_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestoneRole_URI INSTANCE = new ProjectMilestoneRole_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestoneRole_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
