...
public final class Performer_connectedNodes extends BaseGeneratedEMFQuerySpecification<Performer_connectedNodes.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_connectedNodes pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_connectedNodes";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_connectedNodes.Match.parameterNames;
    }
    ...
    @Override
    public Performer_connectedNodes.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_connectedNodes.Match)) {
          Performer_connectedNodes.Match other = (Performer_connectedNodes.Match) obj;
    ...
    @Override
    public Performer_connectedNodes specification() {
      return Performer_connectedNodes.instance();
    }
     ...
     * 
     */
    public static Performer_connectedNodes.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_connectedNodes.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_connectedNodes.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_connectedNodes.Match {
    ...
    private static final class Immutable extends Performer_connectedNodes.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_connectedNodes pattern,
   ...
   * 
   * @see Match
   * @see Performer_connectedNodes
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_connectedNodes.Match> {
    /**
     ...
     * 
     */
    public static Performer_connectedNodes.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_connectedNodes.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_connectedNodes.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_connectedNodes.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_connectedNodes.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_connectedNodes.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_connectedNodes.Match> processor) {
     ...
     * 
     */
    public Performer_connectedNodes.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_connectedNodes.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_connectedNodes.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_connectedNodes.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_connectedNodes.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_connectedNodes.Match partialMatch) {
    ...
    @Override
    protected Performer_connectedNodes.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_connectedNodes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_connectedNodes.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_connectedNodes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_connectedNodes.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_connectedNodes.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_connectedNodes.Matcher> querySpecification() {
      return Performer_connectedNodes.instance();
    }
  }
  
  private Performer_connectedNodes() {
   ...
   * 
   */
  public static Performer_connectedNodes instance() {
    try{
  ...
  @Override
  protected Performer_connectedNodes.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_connectedNodes.Matcher.on(engine);
  }
  
  @Override
  public Performer_connectedNodes.Matcher instantiate() {
    return Performer_connectedNodes.Matcher.create();
  }
  
  @Override
  public Performer_connectedNodes.Match newEmptyMatch() {
    return Performer_connectedNodes.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_connectedNodes.Match newMatch(final Object... parameters) {
    return Performer_connectedNodes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_connectedNodes} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_connectedNodes#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_connectedNodes INSTANCE = new Performer_connectedNodes();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_connectedNodes.GeneratedPQuery INSTANCE = new GeneratedPQuery();
