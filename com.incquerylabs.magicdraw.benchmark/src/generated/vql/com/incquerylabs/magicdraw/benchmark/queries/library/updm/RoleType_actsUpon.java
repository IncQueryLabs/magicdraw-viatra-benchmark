...
public final class RoleType_actsUpon extends BaseGeneratedEMFQuerySpecification<RoleType_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_actsUpon.Match)) {
          RoleType_actsUpon.Match other = (RoleType_actsUpon.Match) obj;
    ...
    @Override
    public RoleType_actsUpon specification() {
      return RoleType_actsUpon.instance();
    }
     ...
     * 
     */
    public static RoleType_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_actsUpon.Match {
    ...
    private static final class Immutable extends RoleType_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see RoleType_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static RoleType_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_actsUpon.Match> processor) {
     ...
     * 
     */
    public RoleType_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_actsUpon.Match partialMatch) {
    ...
    @Override
    protected RoleType_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_actsUpon.Matcher> querySpecification() {
      return RoleType_actsUpon.instance();
    }
  }
  
  private RoleType_actsUpon() {
   ...
   * 
   */
  public static RoleType_actsUpon instance() {
    try{
  ...
  @Override
  protected RoleType_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public RoleType_actsUpon.Matcher instantiate() {
    return RoleType_actsUpon.Matcher.create();
  }
  
  @Override
  public RoleType_actsUpon.Match newEmptyMatch() {
    return RoleType_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_actsUpon.Match newMatch(final Object... parameters) {
    return RoleType_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_actsUpon INSTANCE = new RoleType_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
