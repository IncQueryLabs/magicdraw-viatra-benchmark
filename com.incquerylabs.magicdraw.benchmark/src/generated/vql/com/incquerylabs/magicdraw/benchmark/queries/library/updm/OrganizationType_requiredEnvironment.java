...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType;
...
public final class OrganizationType_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<OrganizationType_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_requiredEnvironment.Match)) {
          OrganizationType_requiredEnvironment.Match other = (OrganizationType_requiredEnvironment.Match) obj;
    ...
    @Override
    public OrganizationType_requiredEnvironment specification() {
      return OrganizationType_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static OrganizationType_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_requiredEnvironment.Match {
    ...
    private static final class Immutable extends OrganizationType_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public OrganizationType_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_requiredEnvironment.Matcher> querySpecification() {
      return OrganizationType_requiredEnvironment.instance();
    }
  }
  
  private OrganizationType_requiredEnvironment() {
   ...
   * 
   */
  public static OrganizationType_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected OrganizationType_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_requiredEnvironment.Matcher instantiate() {
    return OrganizationType_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public OrganizationType_requiredEnvironment.Match newEmptyMatch() {
    return OrganizationType_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_requiredEnvironment.Match newMatch(final Object... parameters) {
    return OrganizationType_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_requiredEnvironment INSTANCE = new OrganizationType_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find OrganizationType(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), OrganizationType.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
