...
public final class Node_conformsTo extends BaseGeneratedEMFQuerySpecification<Node_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Node_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_conformsTo.Match)) {
          Node_conformsTo.Match other = (Node_conformsTo.Match) obj;
    ...
    @Override
    public Node_conformsTo specification() {
      return Node_conformsTo.instance();
    }
     ...
     * 
     */
    public static Node_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Node_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_conformsTo.Match {
    ...
    private static final class Immutable extends Node_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_conformsTo pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Node_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Node_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Node_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Node_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Node_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Node_conformsTo.Match> processor) {
     ...
     * 
     */
    public Node_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Node_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Node_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Node_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Node_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Node_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Node_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_conformsTo.Matcher> querySpecification() {
      return Node_conformsTo.instance();
    }
  }
  
  private Node_conformsTo() {
   ...
   * 
   */
  public static Node_conformsTo instance() {
    try{
  ...
  @Override
  protected Node_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Node_conformsTo.Matcher instantiate() {
    return Node_conformsTo.Matcher.create();
  }
  
  @Override
  public Node_conformsTo.Match newEmptyMatch() {
    return Node_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Node_conformsTo.Match newMatch(final Object... parameters) {
    return Node_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_conformsTo INSTANCE = new Node_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
