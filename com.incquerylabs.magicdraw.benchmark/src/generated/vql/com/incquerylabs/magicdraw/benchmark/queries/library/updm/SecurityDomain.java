...
public final class SecurityDomain extends BaseGeneratedEMFQuerySpecification<SecurityDomain.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain.Match)) {
          SecurityDomain.Match other = (SecurityDomain.Match) obj;
    ...
    @Override
    public SecurityDomain specification() {
      return SecurityDomain.instance();
    }
     ...
     * 
     */
    public static SecurityDomain.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SecurityDomain.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SecurityDomain.Match {
    ...
    private static final class Immutable extends SecurityDomain.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SecurityDomain.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SecurityDomain.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SecurityDomain.Match> processor) {
     ...
     * 
     */
    public SecurityDomain.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SecurityDomain.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SecurityDomain.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SecurityDomain.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SecurityDomain.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain.Matcher> querySpecification() {
      return SecurityDomain.instance();
    }
  }
  ...
  @Override
  protected SecurityDomain.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain.Matcher instantiate() {
    return SecurityDomain.Matcher.create();
  }
  
  @Override
  public SecurityDomain.Match newEmptyMatch() {
    return SecurityDomain.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain.Match newMatch(final Object... parameters) {
    return SecurityDomain.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain INSTANCE = new SecurityDomain();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "SecurityDomain");
