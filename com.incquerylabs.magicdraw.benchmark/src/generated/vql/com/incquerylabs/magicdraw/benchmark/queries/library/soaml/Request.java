...
public final class Request extends BaseGeneratedEMFQuerySpecification<Request.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Request pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Request";
    }
    
    @Override
    public List<String> parameterNames() {
      return Request.Match.parameterNames;
    }
    ...
    @Override
    public Request.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Request.Match)) {
          Request.Match other = (Request.Match) obj;
     ...
     * 
     */
    public static Request.Match newEmptyMatch() {
     ...
     * 
     */
    public static Request.Match newMutableMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Request.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Request.Match {
    ...
    private static final class Immutable extends Request.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Request pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Request.Match> {
    /**
     ...
     * 
     */
    public static Request.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Request.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Request.Matcher.class);
     ...
     * 
     */
    public Collection<Request.Match> getAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Request.Match> streamAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Request.Match> getOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Request.Match> processor) {
     ...
     * 
     */
    public Request.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Request.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Request.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Request.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Request.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Request.Match partialMatch) {
    ...
    @Override
    protected Request.Match tupleToMatch(final Tuple t) {
      try {
          return Request.Match.newMatch((Port) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Request.Match arrayToMatch(final Object[] match) {
      try {
          return Request.Match.newMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Request.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Request.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Request.Matcher> querySpecification() {
      return Request.instance();
    }
  }
  ...
  @Override
  protected Request.Matcher instantiate(final ViatraQueryEngine engine) {
    return Request.Matcher.on(engine);
  }
  
  @Override
  public Request.Matcher instantiate() {
    return Request.Matcher.create();
  }
  
  @Override
  public Request.Match newEmptyMatch() {
    return Request.Match.newEmptyMatch();
  }
  
  @Override
  public Request.Match newMatch(final Object... parameters) {
    return Request.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Request} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Request#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Request.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Request");
