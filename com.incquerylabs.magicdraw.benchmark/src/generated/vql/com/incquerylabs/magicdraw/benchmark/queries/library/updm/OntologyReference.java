...
public final class OntologyReference extends BaseGeneratedEMFQuerySpecification<OntologyReference.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OntologyReference pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OntologyReference";
    }
    
    @Override
    public List<String> parameterNames() {
      return OntologyReference.Match.parameterNames;
    }
    ...
    @Override
    public OntologyReference.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OntologyReference.Match)) {
          OntologyReference.Match other = (OntologyReference.Match) obj;
    ...
    @Override
    public OntologyReference specification() {
      return OntologyReference.instance();
    }
     ...
     * 
     */
    public static OntologyReference.Match newEmptyMatch() {
     ...
     * 
     */
    public static OntologyReference.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OntologyReference.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OntologyReference.Match {
    ...
    private static final class Immutable extends OntologyReference.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OntologyReference pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<OntologyReference.Match> {
    /**
     ...
     * 
     */
    public static OntologyReference.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OntologyReference.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OntologyReference.Matcher.class);
     ...
     * 
     */
    public Collection<OntologyReference.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OntologyReference.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OntologyReference.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OntologyReference.Match> processor) {
     ...
     * 
     */
    public OntologyReference.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OntologyReference.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final OntologyReference.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final OntologyReference.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OntologyReference.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OntologyReference.Match partialMatch) {
    ...
    @Override
    protected OntologyReference.Match tupleToMatch(final Tuple t) {
      try {
          return OntologyReference.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OntologyReference.Match arrayToMatch(final Object[] match) {
      try {
          return OntologyReference.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OntologyReference.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OntologyReference.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OntologyReference.Matcher> querySpecification() {
      return OntologyReference.instance();
    }
  }
   ...
   * 
   */
  public static OntologyReference instance() {
    try{
  ...
  @Override
  protected OntologyReference.Matcher instantiate(final ViatraQueryEngine engine) {
    return OntologyReference.Matcher.on(engine);
  }
  
  @Override
  public OntologyReference.Matcher instantiate() {
    return OntologyReference.Matcher.create();
  }
  
  @Override
  public OntologyReference.Match newEmptyMatch() {
    return OntologyReference.Match.newEmptyMatch();
  }
  
  @Override
  public OntologyReference.Match newMatch(final Object... parameters) {
    return OntologyReference.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OntologyReference} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OntologyReference#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OntologyReference INSTANCE = new OntologyReference();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OntologyReference.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "OntologyReference");
