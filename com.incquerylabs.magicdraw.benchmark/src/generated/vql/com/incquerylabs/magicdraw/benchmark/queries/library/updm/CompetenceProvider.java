...
public final class CompetenceProvider extends BaseGeneratedEMFQuerySpecification<CompetenceProvider.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CompetenceProvider pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CompetenceProvider";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceProvider.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceProvider.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceProvider.Match)) {
          CompetenceProvider.Match other = (CompetenceProvider.Match) obj;
    ...
    @Override
    public CompetenceProvider specification() {
      return CompetenceProvider.instance();
    }
     ...
     * 
     */
    public static CompetenceProvider.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceProvider.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static CompetenceProvider.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends CompetenceProvider.Match {
    ...
    private static final class Immutable extends CompetenceProvider.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CompetenceProvider pattern,
   ...
   * 
   * @see Match
   * @see CompetenceProvider
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceProvider.Match> {
    /**
     ...
     * 
     */
    public static CompetenceProvider.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceProvider.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceProvider.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceProvider.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<CompetenceProvider.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<CompetenceProvider.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super CompetenceProvider.Match> processor) {
     ...
     * 
     */
    public CompetenceProvider.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return CompetenceProvider.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final CompetenceProvider.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final CompetenceProvider.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final CompetenceProvider.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final CompetenceProvider.Match partialMatch) {
    ...
    @Override
    protected CompetenceProvider.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceProvider.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected CompetenceProvider.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceProvider.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceProvider.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceProvider.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceProvider.Matcher> querySpecification() {
      return CompetenceProvider.instance();
    }
  }
  
  private CompetenceProvider() {
   ...
   * 
   */
  public static CompetenceProvider instance() {
    try{
  ...
  @Override
  protected CompetenceProvider.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceProvider.Matcher.on(engine);
  }
  
  @Override
  public CompetenceProvider.Matcher instantiate() {
    return CompetenceProvider.Matcher.create();
  }
  
  @Override
  public CompetenceProvider.Match newEmptyMatch() {
    return CompetenceProvider.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceProvider.Match newMatch(final Object... parameters) {
    return CompetenceProvider.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceProvider} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceProvider#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceProvider INSTANCE = new CompetenceProvider();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceProvider.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "CompetenceProvider");
