...
public final class Software_URI extends BaseGeneratedEMFQuerySpecification<Software_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_URI.Match.parameterNames;
    }
    ...
    @Override
    public Software_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_URI.Match)) {
          Software_URI.Match other = (Software_URI.Match) obj;
    ...
    @Override
    public Software_URI specification() {
      return Software_URI.instance();
    }
     ...
     * 
     */
    public static Software_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Software_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Software_URI.Match {
    ...
    private static final class Immutable extends Software_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Software_URI.Match> {
    /**
     ...
     * 
     */
    public static Software_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Software_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Software_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Software_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Software_URI.Match> processor) {
     ...
     * 
     */
    public Software_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Software_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Software_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Software_URI.Match partialMatch) {
    ...
    @Override
    protected Software_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Software_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Software_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Software_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_URI.Matcher> querySpecification() {
      return Software_URI.instance();
    }
  }
  
  private Software_URI() {
   ...
   * 
   */
  public static Software_URI instance() {
    try{
  ...
  @Override
  protected Software_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_URI.Matcher.on(engine);
  }
  
  @Override
  public Software_URI.Matcher instantiate() {
    return Software_URI.Matcher.create();
  }
  
  @Override
  public Software_URI.Match newEmptyMatch() {
    return Software_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Software_URI.Match newMatch(final Object... parameters) {
    return Software_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_URI INSTANCE = new Software_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
