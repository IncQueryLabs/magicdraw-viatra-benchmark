...
public final class ServiceSpecification extends BaseGeneratedEMFQuerySpecification<ServiceSpecification.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceSpecification.Match.parameterNames;
    }
    ...
    @Override
    public ServiceSpecification.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceSpecification.Match)) {
          ServiceSpecification.Match other = (ServiceSpecification.Match) obj;
    ...
    @Override
    public ServiceSpecification specification() {
     ...
     * 
     */
    public static ServiceSpecification.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceSpecification.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ServiceSpecification.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ServiceSpecification.Match {
    ...
    private static final class Immutable extends ServiceSpecification.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceSpecification.Match> {
    /**
     ...
     * 
     */
    public static ServiceSpecification.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceSpecification.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceSpecification.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceSpecification.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ServiceSpecification.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ServiceSpecification.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ServiceSpecification.Match> processor) {
     ...
     * 
     */
    public ServiceSpecification.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ServiceSpecification.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceSpecification.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ServiceSpecification.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ServiceSpecification.Match partialMatch) {
    ...
    @Override
    protected ServiceSpecification.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceSpecification.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ServiceSpecification.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceSpecification.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceSpecification.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceSpecification.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceSpecification.Matcher> querySpecification() {
      return ServiceSpecification.instance();
    }
  }
   ...
   * 
   */
  public static ServiceSpecification instance() {
    try{
  ...
  @Override
  protected ServiceSpecification.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceSpecification.Matcher.on(engine);
  }
  
  @Override
  public ServiceSpecification.Matcher instantiate() {
    return ServiceSpecification.Matcher.create();
  }
  
  @Override
  public ServiceSpecification.Match newEmptyMatch() {
    return ServiceSpecification.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceSpecification.Match newMatch(final Object... parameters) {
    return ServiceSpecification.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceSpecification} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceSpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceSpecification INSTANCE = new ServiceSpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceSpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ServiceSpecification")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ServiceSpecification");
