...
public final class TemporalPart_measurementSet extends BaseGeneratedEMFQuerySpecification<TemporalPart_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return TemporalPart_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public TemporalPart_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TemporalPart_measurementSet.Match)) {
          TemporalPart_measurementSet.Match other = (TemporalPart_measurementSet.Match) obj;
    ...
    @Override
    public TemporalPart_measurementSet specification() {
      return TemporalPart_measurementSet.instance();
    }
     ...
     * 
     */
    public static TemporalPart_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static TemporalPart_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static TemporalPart_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TemporalPart_measurementSet.Match {
    ...
    private static final class Immutable extends TemporalPart_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see TemporalPart_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<TemporalPart_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static TemporalPart_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TemporalPart_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TemporalPart_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<TemporalPart_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TemporalPart_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TemporalPart_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super TemporalPart_measurementSet.Match> processor) {
     ...
     * 
     */
    public TemporalPart_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return TemporalPart_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TemporalPart_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TemporalPart_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TemporalPart_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TemporalPart_measurementSet.Match partialMatch) {
    ...
    @Override
    protected TemporalPart_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return TemporalPart_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TemporalPart_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return TemporalPart_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TemporalPart_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TemporalPart_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TemporalPart_measurementSet.Matcher> querySpecification() {
      return TemporalPart_measurementSet.instance();
    }
  }
  
  private TemporalPart_measurementSet() {
   ...
   * 
   */
  public static TemporalPart_measurementSet instance() {
    try{
  ...
  @Override
  protected TemporalPart_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return TemporalPart_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public TemporalPart_measurementSet.Matcher instantiate() {
    return TemporalPart_measurementSet.Matcher.create();
  }
  
  @Override
  public TemporalPart_measurementSet.Match newEmptyMatch() {
    return TemporalPart_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public TemporalPart_measurementSet.Match newMatch(final Object... parameters) {
    return TemporalPart_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TemporalPart_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TemporalPart_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TemporalPart_measurementSet INSTANCE = new TemporalPart_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TemporalPart_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
