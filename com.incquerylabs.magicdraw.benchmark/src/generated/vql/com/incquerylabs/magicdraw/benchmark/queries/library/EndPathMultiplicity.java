...
public final class EndPathMultiplicity extends BaseGeneratedEMFQuerySpecification<EndPathMultiplicity.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static EndPathMultiplicity.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static EndPathMultiplicity.Match newMatch(final Property pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<EndPathMultiplicity.Match> {
     ...
     * 
     */
    public Collection<EndPathMultiplicity.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<EndPathMultiplicity.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<EndPathMultiplicity.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super EndPathMultiplicity.Match> processor) {
     ...
     * 
     */
    public EndPathMultiplicity.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return EndPathMultiplicity.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final EndPathMultiplicity.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final EndPathMultiplicity.Match partialMatch) {
    ...
    protected EndPathMultiplicity.Match tupleToMatch(final Tuple t) {
      try {
          return EndPathMultiplicity.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected EndPathMultiplicity.Match arrayToMatch(final Object[] match) {
      try {
          return EndPathMultiplicity.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected EndPathMultiplicity.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EndPathMultiplicity.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public EndPathMultiplicity.Match newMatch(final Object... parameters) {
    return EndPathMultiplicity.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
