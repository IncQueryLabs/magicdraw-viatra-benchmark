 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "interfaceRequirement");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class InterfaceRequirement extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceRequirement.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceRequirement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceRequirement.Match)) {
          InterfaceRequirement.Match other = (InterfaceRequirement.Match) obj;
    ...
    @Override
    public InterfaceRequirement specification() {
     ...
     * 
     */
    public static InterfaceRequirement.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static InterfaceRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends InterfaceRequirement.Match {
    ...
    private static final class Immutable extends InterfaceRequirement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement pattern,
   ...
   * 
   * @see Match
   * @see InterfaceRequirement
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceRequirement.Match> {
    /**
     ...
     * 
     */
    public static InterfaceRequirement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceRequirement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceRequirement.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<InterfaceRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<InterfaceRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super InterfaceRequirement.Match> processor) {
     ...
     * 
     */
    public InterfaceRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return InterfaceRequirement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InterfaceRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InterfaceRequirement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final InterfaceRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final InterfaceRequirement.Match partialMatch) {
    ...
    @Override
    protected InterfaceRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected InterfaceRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceRequirement.Matcher> querySpecification() {
      return InterfaceRequirement.instance();
    }
  }
   ...
   * 
   */
  public static InterfaceRequirement instance() {
    try{
  ...
  @Override
  protected InterfaceRequirement.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceRequirement.Matcher.on(engine);
  }
  
  @Override
  public InterfaceRequirement.Matcher instantiate() {
    return InterfaceRequirement.Matcher.create();
  }
  
  @Override
  public InterfaceRequirement.Match newEmptyMatch() {
    return InterfaceRequirement.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceRequirement.Match newMatch(final Object... parameters) {
    return InterfaceRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceRequirement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceRequirement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceRequirement INSTANCE = new InterfaceRequirement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceRequirement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "interfaceRequirement");
