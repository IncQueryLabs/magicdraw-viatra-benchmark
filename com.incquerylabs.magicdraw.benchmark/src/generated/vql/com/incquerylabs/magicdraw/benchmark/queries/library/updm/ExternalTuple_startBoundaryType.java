...
public final class ExternalTuple_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ExternalTuple_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTuple_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTuple_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTuple_startBoundaryType.Match)) {
          ExternalTuple_startBoundaryType.Match other = (ExternalTuple_startBoundaryType.Match) obj;
    ...
    @Override
    public ExternalTuple_startBoundaryType specification() {
      return ExternalTuple_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ExternalTuple_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTuple_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTuple_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTuple_startBoundaryType.Match {
    ...
    private static final class Immutable extends ExternalTuple_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ExternalTuple_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTuple_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ExternalTuple_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTuple_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTuple_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTuple_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTuple_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTuple_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTuple_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ExternalTuple_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTuple_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTuple_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTuple_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTuple_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTuple_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ExternalTuple_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTuple_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTuple_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTuple_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTuple_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTuple_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTuple_startBoundaryType.Matcher> querySpecification() {
      return ExternalTuple_startBoundaryType.instance();
    }
  }
  
  private ExternalTuple_startBoundaryType() {
   ...
   * 
   */
  public static ExternalTuple_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ExternalTuple_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTuple_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ExternalTuple_startBoundaryType.Matcher instantiate() {
    return ExternalTuple_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ExternalTuple_startBoundaryType.Match newEmptyMatch() {
    return ExternalTuple_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTuple_startBoundaryType.Match newMatch(final Object... parameters) {
    return ExternalTuple_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTuple_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTuple_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTuple_startBoundaryType INSTANCE = new ExternalTuple_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTuple_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
