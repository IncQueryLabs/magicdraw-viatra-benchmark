...
public final class ProjectMilestone_conformsTo extends BaseGeneratedEMFQuerySpecification<ProjectMilestone_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestone_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestone_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestone_conformsTo.Match)) {
          ProjectMilestone_conformsTo.Match other = (ProjectMilestone_conformsTo.Match) obj;
    ...
    @Override
    public ProjectMilestone_conformsTo specification() {
      return ProjectMilestone_conformsTo.instance();
    }
     ...
     * 
     */
    public static ProjectMilestone_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestone_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestone_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestone_conformsTo.Match {
    ...
    private static final class Immutable extends ProjectMilestone_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestone_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestone_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestone_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestone_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestone_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestone_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestone_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestone_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectMilestone_conformsTo.Match> processor) {
     ...
     * 
     */
    public ProjectMilestone_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectMilestone_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectMilestone_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectMilestone_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestone_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestone_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestone_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestone_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestone_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestone_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestone_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestone_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestone_conformsTo.Matcher> querySpecification() {
      return ProjectMilestone_conformsTo.instance();
    }
  }
  
  private ProjectMilestone_conformsTo() {
   ...
   * 
   */
  public static ProjectMilestone_conformsTo instance() {
    try{
  ...
  @Override
  protected ProjectMilestone_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestone_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestone_conformsTo.Matcher instantiate() {
    return ProjectMilestone_conformsTo.Matcher.create();
  }
  
  @Override
  public ProjectMilestone_conformsTo.Match newEmptyMatch() {
    return ProjectMilestone_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestone_conformsTo.Match newMatch(final Object... parameters) {
    return ProjectMilestone_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestone_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestone_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestone_conformsTo INSTANCE = new ProjectMilestone_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestone_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
