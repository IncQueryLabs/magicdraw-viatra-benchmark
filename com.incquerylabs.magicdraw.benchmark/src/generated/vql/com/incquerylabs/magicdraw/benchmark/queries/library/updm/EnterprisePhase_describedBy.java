...
public final class EnterprisePhase_describedBy extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_describedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_describedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_describedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_describedBy.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_describedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_describedBy.Match)) {
          EnterprisePhase_describedBy.Match other = (EnterprisePhase_describedBy.Match) obj;
    ...
    @Override
    public EnterprisePhase_describedBy specification() {
      return EnterprisePhase_describedBy.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_describedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_describedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_describedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_describedBy.Match {
    ...
    private static final class Immutable extends EnterprisePhase_describedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_describedBy pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_describedBy
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_describedBy.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_describedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_describedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_describedBy.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_describedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_describedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_describedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_describedBy.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_describedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_describedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_describedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_describedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_describedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_describedBy.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_describedBy.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_describedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_describedBy.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_describedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_describedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_describedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_describedBy.Matcher> querySpecification() {
      return EnterprisePhase_describedBy.instance();
    }
  }
  
  private EnterprisePhase_describedBy() {
   ...
   * 
   */
  public static EnterprisePhase_describedBy instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_describedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_describedBy.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_describedBy.Matcher instantiate() {
    return EnterprisePhase_describedBy.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_describedBy.Match newEmptyMatch() {
    return EnterprisePhase_describedBy.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_describedBy.Match newMatch(final Object... parameters) {
    return EnterprisePhase_describedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_describedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_describedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_describedBy INSTANCE = new EnterprisePhase_describedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_describedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
