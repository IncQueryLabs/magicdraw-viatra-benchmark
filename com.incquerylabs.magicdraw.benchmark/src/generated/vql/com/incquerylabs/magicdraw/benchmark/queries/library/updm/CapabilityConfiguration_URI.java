...
public final class CapabilityConfiguration_URI extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_URI.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_URI.Match)) {
          CapabilityConfiguration_URI.Match other = (CapabilityConfiguration_URI.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_URI specification() {
      return CapabilityConfiguration_URI.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static CapabilityConfiguration_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends CapabilityConfiguration_URI.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_URI pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_URI
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_URI.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_URI.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super CapabilityConfiguration_URI.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return CapabilityConfiguration_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final CapabilityConfiguration_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final CapabilityConfiguration_URI.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_URI.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected CapabilityConfiguration_URI.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_URI.Matcher> querySpecification() {
      return CapabilityConfiguration_URI.instance();
    }
  }
  
  private CapabilityConfiguration_URI() {
   ...
   * 
   */
  public static CapabilityConfiguration_URI instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_URI.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_URI.Matcher instantiate() {
    return CapabilityConfiguration_URI.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_URI.Match newEmptyMatch() {
    return CapabilityConfiguration_URI.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_URI.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_URI INSTANCE = new CapabilityConfiguration_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
