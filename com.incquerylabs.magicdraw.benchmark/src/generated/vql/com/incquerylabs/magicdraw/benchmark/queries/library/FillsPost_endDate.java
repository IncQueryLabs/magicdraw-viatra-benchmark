...
public final class FillsPost_endDate extends BaseGeneratedEMFQuerySpecification<FillsPost_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_endDate";
    }
     ...
     * 
     */
    public static FillsPost_endDate.Match newMutableMatch(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public static FillsPost_endDate.Match newMatch(final Abstraction pElement, final Element pValue) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_endDate pattern,
  ...
  public static class Matcher extends BaseMatcher<FillsPost_endDate.Match> {
     ...
     * 
     */
    public Collection<FillsPost_endDate.Match> getAllMatches(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FillsPost_endDate.Match> streamAllMatches(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FillsPost_endDate.Match> getOneArbitraryMatch(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Element pValue, final Consumer<? super FillsPost_endDate.Match> processor) {
     ...
     * 
     */
    public FillsPost_endDate.Match newMatch(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final FillsPost_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final FillsPost_endDate.Match partialMatch) {
    ...
    protected FillsPost_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return FillsPost_endDate.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    protected FillsPost_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return FillsPost_endDate.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected FillsPost_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FillsPost_endDate.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public FillsPost_endDate.Match newMatch(final Object... parameters) {
    return FillsPost_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
