...
public final class PhysicalResource_milestone extends BaseGeneratedEMFQuerySpecification<PhysicalResource_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_milestone.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_milestone.Match)) {
          PhysicalResource_milestone.Match other = (PhysicalResource_milestone.Match) obj;
    ...
    @Override
    public PhysicalResource_milestone specification() {
      return PhysicalResource_milestone.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_milestone.Match {
    ...
    private static final class Immutable extends PhysicalResource_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_milestone pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_milestone.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_milestone.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_milestone.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_milestone.Matcher> querySpecification() {
      return PhysicalResource_milestone.instance();
    }
  }
  
  private PhysicalResource_milestone() {
   ...
   * 
   */
  public static PhysicalResource_milestone instance() {
    try{
  ...
  @Override
  protected PhysicalResource_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_milestone.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_milestone.Matcher instantiate() {
    return PhysicalResource_milestone.Matcher.create();
  }
  
  @Override
  public PhysicalResource_milestone.Match newEmptyMatch() {
    return PhysicalResource_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_milestone.Match newMatch(final Object... parameters) {
    return PhysicalResource_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_milestone INSTANCE = new PhysicalResource_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
