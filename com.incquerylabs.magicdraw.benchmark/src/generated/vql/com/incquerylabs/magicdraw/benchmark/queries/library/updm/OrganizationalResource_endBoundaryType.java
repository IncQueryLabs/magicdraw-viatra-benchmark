...
public final class OrganizationalResource_endBoundaryType extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_endBoundaryType.Match)) {
          OrganizationalResource_endBoundaryType.Match other = (OrganizationalResource_endBoundaryType.Match) obj;
    ...
    @Override
    public OrganizationalResource_endBoundaryType specification() {
      return OrganizationalResource_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_endBoundaryType.Match {
    ...
    private static final class Immutable extends OrganizationalResource_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_endBoundaryType.Matcher> querySpecification() {
      return OrganizationalResource_endBoundaryType.instance();
    }
  }
  
  private OrganizationalResource_endBoundaryType() {
   ...
   * 
   */
  public static OrganizationalResource_endBoundaryType instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_endBoundaryType.Matcher instantiate() {
    return OrganizationalResource_endBoundaryType.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_endBoundaryType.Match newEmptyMatch() {
    return OrganizationalResource_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_endBoundaryType.Match newMatch(final Object... parameters) {
    return OrganizationalResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_endBoundaryType INSTANCE = new OrganizationalResource_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
