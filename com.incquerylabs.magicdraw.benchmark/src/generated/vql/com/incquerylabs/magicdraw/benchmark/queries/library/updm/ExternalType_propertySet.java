...
public final class ExternalType_propertySet extends BaseGeneratedEMFQuerySpecification<ExternalType_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalType_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ExternalType_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalType_propertySet.Match)) {
          ExternalType_propertySet.Match other = (ExternalType_propertySet.Match) obj;
    ...
    @Override
    public ExternalType_propertySet specification() {
      return ExternalType_propertySet.instance();
    }
     ...
     * 
     */
    public static ExternalType_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalType_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalType_propertySet.Match {
    ...
    private static final class Immutable extends ExternalType_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ExternalType_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalType_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ExternalType_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalType_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalType_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalType_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalType_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalType_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalType_propertySet.Match> processor) {
     ...
     * 
     */
    public ExternalType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalType_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalType_propertySet.Match partialMatch) {
    ...
    @Override
    protected ExternalType_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalType_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalType_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalType_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalType_propertySet.Matcher> querySpecification() {
      return ExternalType_propertySet.instance();
    }
  }
  
  private ExternalType_propertySet() {
   ...
   * 
   */
  public static ExternalType_propertySet instance() {
    try{
  ...
  @Override
  protected ExternalType_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalType_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ExternalType_propertySet.Matcher instantiate() {
    return ExternalType_propertySet.Matcher.create();
  }
  
  @Override
  public ExternalType_propertySet.Match newEmptyMatch() {
    return ExternalType_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalType_propertySet.Match newMatch(final Object... parameters) {
    return ExternalType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalType_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalType_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalType_propertySet INSTANCE = new ExternalType_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalType_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
