...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision;
...
public final class Vision_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Vision_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Vision_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Vision_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Vision_actualPropertySet.Match)) {
          Vision_actualPropertySet.Match other = (Vision_actualPropertySet.Match) obj;
    ...
    @Override
    public Vision_actualPropertySet specification() {
      return Vision_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Vision_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Vision_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Vision_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Vision_actualPropertySet.Match {
    ...
    private static final class Immutable extends Vision_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Vision_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Vision_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Vision_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Vision_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Vision_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Vision_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Vision_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Vision_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Vision_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Vision_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Vision_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Vision_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Vision_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Vision_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Vision_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Vision_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Vision_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Vision_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Vision_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Vision_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Vision_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Vision_actualPropertySet.Matcher> querySpecification() {
      return Vision_actualPropertySet.instance();
    }
  }
  
  private Vision_actualPropertySet() {
   ...
   * 
   */
  public static Vision_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Vision_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Vision_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Vision_actualPropertySet.Matcher instantiate() {
    return Vision_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Vision_actualPropertySet.Match newEmptyMatch() {
    return Vision_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Vision_actualPropertySet.Match newMatch(final Object... parameters) {
    return Vision_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Vision_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Vision_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Vision_actualPropertySet INSTANCE = new Vision_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Vision_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Vision(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Vision.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
