...
public final class WholeLifeEnterprise_actualPropertySet extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_actualPropertySet.Match)) {
          WholeLifeEnterprise_actualPropertySet.Match other = (WholeLifeEnterprise_actualPropertySet.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_actualPropertySet specification() {
      return WholeLifeEnterprise_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_actualPropertySet.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_actualPropertySet.Matcher> querySpecification() {
      return WholeLifeEnterprise_actualPropertySet.instance();
    }
  }
  
  private WholeLifeEnterprise_actualPropertySet() {
   ...
   * 
   */
  public static WholeLifeEnterprise_actualPropertySet instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_actualPropertySet.Matcher instantiate() {
    return WholeLifeEnterprise_actualPropertySet.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_actualPropertySet.Match newEmptyMatch() {
    return WholeLifeEnterprise_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_actualPropertySet.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_actualPropertySet INSTANCE = new WholeLifeEnterprise_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
