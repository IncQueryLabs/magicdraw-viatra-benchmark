...
public final class ProjectMilestone_propertySet extends BaseGeneratedEMFQuerySpecification<ProjectMilestone_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestone_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestone_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestone_propertySet.Match)) {
          ProjectMilestone_propertySet.Match other = (ProjectMilestone_propertySet.Match) obj;
    ...
    @Override
    public ProjectMilestone_propertySet specification() {
      return ProjectMilestone_propertySet.instance();
    }
     ...
     * 
     */
    public static ProjectMilestone_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestone_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestone_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestone_propertySet.Match {
    ...
    private static final class Immutable extends ProjectMilestone_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestone_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestone_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestone_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestone_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestone_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestone_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestone_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestone_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectMilestone_propertySet.Match> processor) {
     ...
     * 
     */
    public ProjectMilestone_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectMilestone_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectMilestone_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectMilestone_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestone_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestone_propertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestone_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestone_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestone_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestone_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestone_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestone_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestone_propertySet.Matcher> querySpecification() {
      return ProjectMilestone_propertySet.instance();
    }
  }
  
  private ProjectMilestone_propertySet() {
   ...
   * 
   */
  public static ProjectMilestone_propertySet instance() {
    try{
  ...
  @Override
  protected ProjectMilestone_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestone_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestone_propertySet.Matcher instantiate() {
    return ProjectMilestone_propertySet.Matcher.create();
  }
  
  @Override
  public ProjectMilestone_propertySet.Match newEmptyMatch() {
    return ProjectMilestone_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestone_propertySet.Match newMatch(final Object... parameters) {
    return ProjectMilestone_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestone_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestone_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestone_propertySet INSTANCE = new ProjectMilestone_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestone_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
