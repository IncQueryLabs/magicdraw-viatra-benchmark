...
public final class EnvironmentProperty_endBoundaryType extends BaseGeneratedEMFQuerySpecification<EnvironmentProperty_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnvironmentProperty_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EnvironmentProperty_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnvironmentProperty_endBoundaryType.Match)) {
          EnvironmentProperty_endBoundaryType.Match other = (EnvironmentProperty_endBoundaryType.Match) obj;
    ...
    @Override
    public EnvironmentProperty_endBoundaryType specification() {
      return EnvironmentProperty_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static EnvironmentProperty_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnvironmentProperty_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EnvironmentProperty_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnvironmentProperty_endBoundaryType.Match {
    ...
    private static final class Immutable extends EnvironmentProperty_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EnvironmentProperty_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EnvironmentProperty_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EnvironmentProperty_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnvironmentProperty_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnvironmentProperty_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EnvironmentProperty_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnvironmentProperty_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnvironmentProperty_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EnvironmentProperty_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public EnvironmentProperty_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return EnvironmentProperty_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EnvironmentProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EnvironmentProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnvironmentProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnvironmentProperty_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EnvironmentProperty_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EnvironmentProperty_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnvironmentProperty_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EnvironmentProperty_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnvironmentProperty_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnvironmentProperty_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnvironmentProperty_endBoundaryType.Matcher> querySpecification() {
      return EnvironmentProperty_endBoundaryType.instance();
    }
  }
  
  private EnvironmentProperty_endBoundaryType() {
   ...
   * 
   */
  public static EnvironmentProperty_endBoundaryType instance() {
    try{
  ...
  @Override
  protected EnvironmentProperty_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnvironmentProperty_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EnvironmentProperty_endBoundaryType.Matcher instantiate() {
    return EnvironmentProperty_endBoundaryType.Matcher.create();
  }
  
  @Override
  public EnvironmentProperty_endBoundaryType.Match newEmptyMatch() {
    return EnvironmentProperty_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EnvironmentProperty_endBoundaryType.Match newMatch(final Object... parameters) {
    return EnvironmentProperty_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnvironmentProperty_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnvironmentProperty_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnvironmentProperty_endBoundaryType INSTANCE = new EnvironmentProperty_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnvironmentProperty_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
