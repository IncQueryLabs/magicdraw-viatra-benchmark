...
public final class PhysicalResource_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<PhysicalResource_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_categoryCategorizesAsset.Match)) {
          PhysicalResource_categoryCategorizesAsset.Match other = (PhysicalResource_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public PhysicalResource_categoryCategorizesAsset specification() {
      return PhysicalResource_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends PhysicalResource_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_categoryCategorizesAsset.Matcher> querySpecification() {
      return PhysicalResource_categoryCategorizesAsset.instance();
    }
  }
  
  private PhysicalResource_categoryCategorizesAsset() {
   ...
   * 
   */
  public static PhysicalResource_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected PhysicalResource_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_categoryCategorizesAsset.Matcher instantiate() {
    return PhysicalResource_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public PhysicalResource_categoryCategorizesAsset.Match newEmptyMatch() {
    return PhysicalResource_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return PhysicalResource_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_categoryCategorizesAsset INSTANCE = new PhysicalResource_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
