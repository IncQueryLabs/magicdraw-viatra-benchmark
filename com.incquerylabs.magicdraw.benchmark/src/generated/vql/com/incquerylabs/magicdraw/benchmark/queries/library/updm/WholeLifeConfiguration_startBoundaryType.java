...
public final class WholeLifeConfiguration_startBoundaryType extends BaseGeneratedEMFQuerySpecification<WholeLifeConfiguration_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeConfiguration_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeConfiguration_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeConfiguration_startBoundaryType.Match)) {
          WholeLifeConfiguration_startBoundaryType.Match other = (WholeLifeConfiguration_startBoundaryType.Match) obj;
    ...
    @Override
    public WholeLifeConfiguration_startBoundaryType specification() {
      return WholeLifeConfiguration_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static WholeLifeConfiguration_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeConfiguration_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeConfiguration_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeConfiguration_startBoundaryType.Match {
    ...
    private static final class Immutable extends WholeLifeConfiguration_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeConfiguration_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeConfiguration_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeConfiguration_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeConfiguration_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeConfiguration_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeConfiguration_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeConfiguration_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeConfiguration_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeConfiguration_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public WholeLifeConfiguration_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeConfiguration_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeConfiguration_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeConfiguration_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeConfiguration_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeConfiguration_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected WholeLifeConfiguration_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeConfiguration_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeConfiguration_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeConfiguration_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeConfiguration_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeConfiguration_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeConfiguration_startBoundaryType.Matcher> querySpecification() {
      return WholeLifeConfiguration_startBoundaryType.instance();
    }
  }
  
  private WholeLifeConfiguration_startBoundaryType() {
   ...
   * 
   */
  public static WholeLifeConfiguration_startBoundaryType instance() {
    try{
  ...
  @Override
  protected WholeLifeConfiguration_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeConfiguration_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeConfiguration_startBoundaryType.Matcher instantiate() {
    return WholeLifeConfiguration_startBoundaryType.Matcher.create();
  }
  
  @Override
  public WholeLifeConfiguration_startBoundaryType.Match newEmptyMatch() {
    return WholeLifeConfiguration_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeConfiguration_startBoundaryType.Match newMatch(final Object... parameters) {
    return WholeLifeConfiguration_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeConfiguration_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeConfiguration_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeConfiguration_startBoundaryType INSTANCE = new WholeLifeConfiguration_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeConfiguration_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
