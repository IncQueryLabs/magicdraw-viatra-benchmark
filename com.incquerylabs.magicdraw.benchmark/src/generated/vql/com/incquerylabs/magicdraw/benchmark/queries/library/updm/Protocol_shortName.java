...
public final class Protocol_shortName extends BaseGeneratedEMFQuerySpecification<Protocol_shortName.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_shortName pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_shortName";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_shortName.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_shortName.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_shortName.Match)) {
          Protocol_shortName.Match other = (Protocol_shortName.Match) obj;
    ...
    @Override
    public Protocol_shortName specification() {
      return Protocol_shortName.instance();
    }
     ...
     * 
     */
    public static Protocol_shortName.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_shortName.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Protocol_shortName.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Protocol_shortName.Match {
    ...
    private static final class Immutable extends Protocol_shortName.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_shortName pattern,
   ...
   * 
   * @see Match
   * @see Protocol_shortName
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_shortName.Match> {
    /**
     ...
     * 
     */
    public static Protocol_shortName.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_shortName.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_shortName.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_shortName.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Protocol_shortName.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Protocol_shortName.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Protocol_shortName.Match> processor) {
     ...
     * 
     */
    public Protocol_shortName.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Protocol_shortName.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_shortName.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_shortName.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Protocol_shortName.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Protocol_shortName.Match partialMatch) {
    ...
    @Override
    protected Protocol_shortName.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Protocol_shortName.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_shortName.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_shortName.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_shortName.Matcher> querySpecification() {
      return Protocol_shortName.instance();
    }
  }
  
  private Protocol_shortName() {
   ...
   * 
   */
  public static Protocol_shortName instance() {
    try{
  ...
  @Override
  protected Protocol_shortName.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_shortName.Matcher.on(engine);
  }
  
  @Override
  public Protocol_shortName.Matcher instantiate() {
    return Protocol_shortName.Matcher.create();
  }
  
  @Override
  public Protocol_shortName.Match newEmptyMatch() {
    return Protocol_shortName.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_shortName.Match newMatch(final Object... parameters) {
    return Protocol_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_shortName} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_shortName#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_shortName INSTANCE = new Protocol_shortName();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_shortName.GeneratedPQuery INSTANCE = new GeneratedPQuery();
