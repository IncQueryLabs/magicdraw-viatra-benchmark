...
import com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer;
...
public final class ProtocolLayer_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<ProtocolLayer_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolLayer_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolLayer_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolLayer_actualMeasurementSet.Match)) {
          ProtocolLayer_actualMeasurementSet.Match other = (ProtocolLayer_actualMeasurementSet.Match) obj;
    ...
    @Override
    public ProtocolLayer_actualMeasurementSet specification() {
      return ProtocolLayer_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static ProtocolLayer_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolLayer_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolLayer_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolLayer_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends ProtocolLayer_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see ProtocolLayer_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolLayer_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static ProtocolLayer_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolLayer_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolLayer_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolLayer_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolLayer_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolLayer_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProtocolLayer_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public ProtocolLayer_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ProtocolLayer_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProtocolLayer_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProtocolLayer_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolLayer_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolLayer_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected ProtocolLayer_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolLayer_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolLayer_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolLayer_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolLayer_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolLayer_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolLayer_actualMeasurementSet.Matcher> querySpecification() {
      return ProtocolLayer_actualMeasurementSet.instance();
    }
  }
  
  private ProtocolLayer_actualMeasurementSet() {
   ...
   * 
   */
  public static ProtocolLayer_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected ProtocolLayer_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolLayer_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public ProtocolLayer_actualMeasurementSet.Matcher instantiate() {
    return ProtocolLayer_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public ProtocolLayer_actualMeasurementSet.Match newEmptyMatch() {
    return ProtocolLayer_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolLayer_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return ProtocolLayer_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolLayer_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolLayer_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolLayer_actualMeasurementSet INSTANCE = new ProtocolLayer_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolLayer_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ProtocolLayer(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ProtocolLayer.instance().getInternalQueryRepresentation());
