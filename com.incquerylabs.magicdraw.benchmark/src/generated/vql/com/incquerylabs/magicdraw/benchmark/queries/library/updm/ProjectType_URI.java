...
public final class ProjectType_URI extends BaseGeneratedEMFQuerySpecification<ProjectType_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectType_URI.Match.parameterNames;
    }
    ...
    @Override
    public ProjectType_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectType_URI.Match)) {
          ProjectType_URI.Match other = (ProjectType_URI.Match) obj;
    ...
    @Override
    public ProjectType_URI specification() {
      return ProjectType_URI.instance();
    }
     ...
     * 
     */
    public static ProjectType_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectType_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ProjectType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProjectType_URI.Match {
    ...
    private static final class Immutable extends ProjectType_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectType_URI.Match> {
    /**
     ...
     * 
     */
    public static ProjectType_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectType_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectType_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectType_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ProjectType_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ProjectType_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ProjectType_URI.Match> processor) {
     ...
     * 
     */
    public ProjectType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ProjectType_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectType_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ProjectType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ProjectType_URI.Match partialMatch) {
    ...
    @Override
    protected ProjectType_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProjectType_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectType_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectType_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectType_URI.Matcher> querySpecification() {
      return ProjectType_URI.instance();
    }
  }
  
  private ProjectType_URI() {
   ...
   * 
   */
  public static ProjectType_URI instance() {
    try{
  ...
  @Override
  protected ProjectType_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectType_URI.Matcher.on(engine);
  }
  
  @Override
  public ProjectType_URI.Matcher instantiate() {
    return ProjectType_URI.Matcher.create();
  }
  
  @Override
  public ProjectType_URI.Match newEmptyMatch() {
    return ProjectType_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectType_URI.Match newMatch(final Object... parameters) {
    return ProjectType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectType_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectType_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectType_URI INSTANCE = new ProjectType_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectType_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
