...
public final class Implements_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<Implements_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Implements_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Implements_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Implements_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Implements_sourcePropertyPath.Match)) {
          Implements_sourcePropertyPath.Match other = (Implements_sourcePropertyPath.Match) obj;
    ...
    @Override
    public Implements_sourcePropertyPath specification() {
      return Implements_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static Implements_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Implements_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Implements_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Implements_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends Implements_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Implements_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Implements_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Implements_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Implements_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Implements_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Implements_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Implements_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Implements_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Implements_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public Implements_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Implements_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Implements_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Implements_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Implements_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Implements_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected Implements_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Implements_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Implements_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Implements_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Implements_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Implements_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Implements_sourcePropertyPath.Matcher> querySpecification() {
      return Implements_sourcePropertyPath.instance();
    }
  }
  
  private Implements_sourcePropertyPath() {
   ...
   * 
   */
  public static Implements_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected Implements_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Implements_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Implements_sourcePropertyPath.Matcher instantiate() {
    return Implements_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public Implements_sourcePropertyPath.Match newEmptyMatch() {
    return Implements_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Implements_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return Implements_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Implements_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Implements_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Implements_sourcePropertyPath INSTANCE = new Implements_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Implements_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
