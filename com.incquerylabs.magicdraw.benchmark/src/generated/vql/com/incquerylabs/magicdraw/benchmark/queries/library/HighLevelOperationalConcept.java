...
public final class HighLevelOperationalConcept extends BaseGeneratedEMFQuerySpecification<HighLevelOperationalConcept.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.HighLevelOperationalConcept pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.HighLevelOperationalConcept";
    }
    
    @Override
    public List<String> parameterNames() {
      return HighLevelOperationalConcept.Match.parameterNames;
    }
    ...
    @Override
    public HighLevelOperationalConcept.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof HighLevelOperationalConcept.Match)) {
          HighLevelOperationalConcept.Match other = (HighLevelOperationalConcept.Match) obj;
    ...
    @Override
    public HighLevelOperationalConcept specification() {
      return HighLevelOperationalConcept.instance();
    }
     ...
     * 
     */
    public static HighLevelOperationalConcept.Match newEmptyMatch() {
     ...
     * 
     */
    public static HighLevelOperationalConcept.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static HighLevelOperationalConcept.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends HighLevelOperationalConcept.Match {
    ...
    private static final class Immutable extends HighLevelOperationalConcept.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.HighLevelOperationalConcept pattern,
   ...
   * 
   * @see Match
   * @see HighLevelOperationalConcept
   * 
   */
  public static class Matcher extends BaseMatcher<HighLevelOperationalConcept.Match> {
    /**
     ...
     * 
     */
    public static HighLevelOperationalConcept.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static HighLevelOperationalConcept.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(HighLevelOperationalConcept.Matcher.class);
     ...
     * 
     */
    public Collection<HighLevelOperationalConcept.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<HighLevelOperationalConcept.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<HighLevelOperationalConcept.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super HighLevelOperationalConcept.Match> processor) {
     ...
     * 
     */
    public HighLevelOperationalConcept.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return HighLevelOperationalConcept.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final HighLevelOperationalConcept.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final HighLevelOperationalConcept.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final HighLevelOperationalConcept.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final HighLevelOperationalConcept.Match partialMatch) {
    ...
    @Override
    protected HighLevelOperationalConcept.Match tupleToMatch(final Tuple t) {
      try {
          return HighLevelOperationalConcept.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected HighLevelOperationalConcept.Match arrayToMatch(final Object[] match) {
      try {
          return HighLevelOperationalConcept.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected HighLevelOperationalConcept.Match arrayToMatchMutable(final Object[] match) {
      try {
          return HighLevelOperationalConcept.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<HighLevelOperationalConcept.Matcher> querySpecification() {
      return HighLevelOperationalConcept.instance();
    }
  }
  
  private HighLevelOperationalConcept() {
   ...
   * 
   */
  public static HighLevelOperationalConcept instance() {
    try{
  ...
  @Override
  protected HighLevelOperationalConcept.Matcher instantiate(final ViatraQueryEngine engine) {
    return HighLevelOperationalConcept.Matcher.on(engine);
  }
  
  @Override
  public HighLevelOperationalConcept.Matcher instantiate() {
    return HighLevelOperationalConcept.Matcher.create();
  }
  
  @Override
  public HighLevelOperationalConcept.Match newEmptyMatch() {
    return HighLevelOperationalConcept.Match.newEmptyMatch();
  }
  
  @Override
  public HighLevelOperationalConcept.Match newMatch(final Object... parameters) {
    return HighLevelOperationalConcept.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link HighLevelOperationalConcept} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link HighLevelOperationalConcept#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final HighLevelOperationalConcept INSTANCE = new HighLevelOperationalConcept();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final HighLevelOperationalConcept.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "HighLevelOperationalConcept")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "HighLevelOperationalConcept");
