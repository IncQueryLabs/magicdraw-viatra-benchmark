...
public final class Responsibility_URI extends BaseGeneratedEMFQuerySpecification<Responsibility_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_URI.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_URI.Match)) {
          Responsibility_URI.Match other = (Responsibility_URI.Match) obj;
    ...
    @Override
    public Responsibility_URI specification() {
      return Responsibility_URI.instance();
    }
     ...
     * 
     */
    public static Responsibility_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Responsibility_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Responsibility_URI.Match {
    ...
    private static final class Immutable extends Responsibility_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_URI pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_URI
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_URI.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Responsibility_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Responsibility_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Responsibility_URI.Match> processor) {
     ...
     * 
     */
    public Responsibility_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Responsibility_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Responsibility_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Responsibility_URI.Match partialMatch) {
    ...
    @Override
    protected Responsibility_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Responsibility_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_URI.Matcher> querySpecification() {
      return Responsibility_URI.instance();
    }
  }
  
  private Responsibility_URI() {
   ...
   * 
   */
  public static Responsibility_URI instance() {
    try{
  ...
  @Override
  protected Responsibility_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_URI.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_URI.Matcher instantiate() {
    return Responsibility_URI.Matcher.create();
  }
  
  @Override
  public Responsibility_URI.Match newEmptyMatch() {
    return Responsibility_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_URI.Match newMatch(final Object... parameters) {
    return Responsibility_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_URI INSTANCE = new Responsibility_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
