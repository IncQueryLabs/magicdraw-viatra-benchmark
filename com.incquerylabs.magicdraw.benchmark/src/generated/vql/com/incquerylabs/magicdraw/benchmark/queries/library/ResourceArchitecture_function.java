...
public final class ResourceArchitecture_function extends BaseGeneratedEMFQuerySpecification<ResourceArchitecture_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArchitecture_function.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArchitecture_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArchitecture_function.Match)) {
          ResourceArchitecture_function.Match other = (ResourceArchitecture_function.Match) obj;
    ...
    @Override
    public ResourceArchitecture_function specification() {
      return ResourceArchitecture_function.instance();
    }
     ...
     * 
     */
    public static ResourceArchitecture_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArchitecture_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArchitecture_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArchitecture_function.Match {
    ...
    private static final class Immutable extends ResourceArchitecture_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_function pattern,
   ...
   * 
   * @see Match
   * @see ResourceArchitecture_function
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArchitecture_function.Match> {
    /**
     ...
     * 
     */
    public static ResourceArchitecture_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArchitecture_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArchitecture_function.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArchitecture_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArchitecture_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArchitecture_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArchitecture_function.Match> processor) {
     ...
     * 
     */
    public ResourceArchitecture_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArchitecture_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArchitecture_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArchitecture_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArchitecture_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArchitecture_function.Match partialMatch) {
    ...
    @Override
    protected ResourceArchitecture_function.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArchitecture_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArchitecture_function.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArchitecture_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArchitecture_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArchitecture_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArchitecture_function.Matcher> querySpecification() {
      return ResourceArchitecture_function.instance();
    }
  }
  
  private ResourceArchitecture_function() {
   ...
   * 
   */
  public static ResourceArchitecture_function instance() {
    try{
  ...
  @Override
  protected ResourceArchitecture_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArchitecture_function.Matcher.on(engine);
  }
  
  @Override
  public ResourceArchitecture_function.Matcher instantiate() {
    return ResourceArchitecture_function.Matcher.create();
  }
  
  @Override
  public ResourceArchitecture_function.Match newEmptyMatch() {
    return ResourceArchitecture_function.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArchitecture_function.Match newMatch(final Object... parameters) {
    return ResourceArchitecture_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArchitecture_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArchitecture_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArchitecture_function INSTANCE = new ResourceArchitecture_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArchitecture_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
