...
public final class VersionOfConfiguration_startBoundaryType extends BaseGeneratedEMFQuerySpecification<VersionOfConfiguration_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionOfConfiguration_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public VersionOfConfiguration_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionOfConfiguration_startBoundaryType.Match)) {
          VersionOfConfiguration_startBoundaryType.Match other = (VersionOfConfiguration_startBoundaryType.Match) obj;
    ...
    @Override
    public VersionOfConfiguration_startBoundaryType specification() {
      return VersionOfConfiguration_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static VersionOfConfiguration_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionOfConfiguration_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static VersionOfConfiguration_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends VersionOfConfiguration_startBoundaryType.Match {
    ...
    private static final class Immutable extends VersionOfConfiguration_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see VersionOfConfiguration_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<VersionOfConfiguration_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static VersionOfConfiguration_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionOfConfiguration_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionOfConfiguration_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<VersionOfConfiguration_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<VersionOfConfiguration_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<VersionOfConfiguration_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super VersionOfConfiguration_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public VersionOfConfiguration_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return VersionOfConfiguration_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final VersionOfConfiguration_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final VersionOfConfiguration_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final VersionOfConfiguration_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final VersionOfConfiguration_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected VersionOfConfiguration_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return VersionOfConfiguration_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected VersionOfConfiguration_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return VersionOfConfiguration_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionOfConfiguration_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionOfConfiguration_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionOfConfiguration_startBoundaryType.Matcher> querySpecification() {
      return VersionOfConfiguration_startBoundaryType.instance();
    }
  }
  
  private VersionOfConfiguration_startBoundaryType() {
   ...
   * 
   */
  public static VersionOfConfiguration_startBoundaryType instance() {
    try{
  ...
  @Override
  protected VersionOfConfiguration_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionOfConfiguration_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public VersionOfConfiguration_startBoundaryType.Matcher instantiate() {
    return VersionOfConfiguration_startBoundaryType.Matcher.create();
  }
  
  @Override
  public VersionOfConfiguration_startBoundaryType.Match newEmptyMatch() {
    return VersionOfConfiguration_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public VersionOfConfiguration_startBoundaryType.Match newMatch(final Object... parameters) {
    return VersionOfConfiguration_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionOfConfiguration_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionOfConfiguration_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionOfConfiguration_startBoundaryType INSTANCE = new VersionOfConfiguration_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionOfConfiguration_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
