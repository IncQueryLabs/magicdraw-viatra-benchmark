...
public final class ProjectType_conformsTo extends BaseGeneratedEMFQuerySpecification<ProjectType_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectType_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ProjectType_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectType_conformsTo.Match)) {
          ProjectType_conformsTo.Match other = (ProjectType_conformsTo.Match) obj;
    ...
    @Override
    public ProjectType_conformsTo specification() {
      return ProjectType_conformsTo.instance();
    }
     ...
     * 
     */
    public static ProjectType_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectType_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectType_conformsTo.Match {
    ...
    private static final class Immutable extends ProjectType_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ProjectType_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectType_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ProjectType_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectType_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectType_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectType_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectType_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectType_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectType_conformsTo.Match> processor) {
     ...
     * 
     */
    public ProjectType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectType_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectType_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ProjectType_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectType_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectType_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectType_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectType_conformsTo.Matcher> querySpecification() {
      return ProjectType_conformsTo.instance();
    }
  }
  
  private ProjectType_conformsTo() {
   ...
   * 
   */
  public static ProjectType_conformsTo instance() {
    try{
  ...
  @Override
  protected ProjectType_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectType_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ProjectType_conformsTo.Matcher instantiate() {
    return ProjectType_conformsTo.Matcher.create();
  }
  
  @Override
  public ProjectType_conformsTo.Match newEmptyMatch() {
    return ProjectType_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectType_conformsTo.Match newMatch(final Object... parameters) {
    return ProjectType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectType_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectType_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectType_conformsTo INSTANCE = new ProjectType_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectType_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
