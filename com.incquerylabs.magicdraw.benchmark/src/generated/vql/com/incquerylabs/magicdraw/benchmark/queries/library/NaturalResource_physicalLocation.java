...
public final class NaturalResource_physicalLocation extends BaseGeneratedEMFQuerySpecification<NaturalResource_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return NaturalResource_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public NaturalResource_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NaturalResource_physicalLocation.Match)) {
          NaturalResource_physicalLocation.Match other = (NaturalResource_physicalLocation.Match) obj;
    ...
    @Override
    public NaturalResource_physicalLocation specification() {
      return NaturalResource_physicalLocation.instance();
    }
     ...
     * 
     */
    public static NaturalResource_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static NaturalResource_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NaturalResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NaturalResource_physicalLocation.Match {
    ...
    private static final class Immutable extends NaturalResource_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see NaturalResource_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<NaturalResource_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static NaturalResource_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NaturalResource_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NaturalResource_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<NaturalResource_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NaturalResource_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NaturalResource_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NaturalResource_physicalLocation.Match> processor) {
     ...
     * 
     */
    public NaturalResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NaturalResource_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NaturalResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NaturalResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NaturalResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NaturalResource_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected NaturalResource_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return NaturalResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NaturalResource_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return NaturalResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NaturalResource_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NaturalResource_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NaturalResource_physicalLocation.Matcher> querySpecification() {
      return NaturalResource_physicalLocation.instance();
    }
  }
  
  private NaturalResource_physicalLocation() {
   ...
   * 
   */
  public static NaturalResource_physicalLocation instance() {
    try{
  ...
  @Override
  protected NaturalResource_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return NaturalResource_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public NaturalResource_physicalLocation.Matcher instantiate() {
    return NaturalResource_physicalLocation.Matcher.create();
  }
  
  @Override
  public NaturalResource_physicalLocation.Match newEmptyMatch() {
    return NaturalResource_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public NaturalResource_physicalLocation.Match newMatch(final Object... parameters) {
    return NaturalResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NaturalResource_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NaturalResource_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NaturalResource_physicalLocation INSTANCE = new NaturalResource_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NaturalResource_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
