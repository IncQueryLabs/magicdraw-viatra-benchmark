...
public final class GeoPoliticalExtent extends BaseGeneratedEMFQuerySpecification<GeoPoliticalExtent.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.GeoPoliticalExtent pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.GeoPoliticalExtent";
    }
    
    @Override
    public List<String> parameterNames() {
      return GeoPoliticalExtent.Match.parameterNames;
    }
    ...
    @Override
    public GeoPoliticalExtent.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof GeoPoliticalExtent.Match)) {
          GeoPoliticalExtent.Match other = (GeoPoliticalExtent.Match) obj;
    ...
    @Override
    public GeoPoliticalExtent specification() {
      return GeoPoliticalExtent.instance();
    }
     ...
     * 
     */
    public static GeoPoliticalExtent.Match newEmptyMatch() {
     ...
     * 
     */
    public static GeoPoliticalExtent.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static GeoPoliticalExtent.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends GeoPoliticalExtent.Match {
    ...
    private static final class Immutable extends GeoPoliticalExtent.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.GeoPoliticalExtent pattern,
   ...
   * 
   * @see Match
   * @see GeoPoliticalExtent
   * 
   */
  public static class Matcher extends BaseMatcher<GeoPoliticalExtent.Match> {
    /**
     ...
     * 
     */
    public static GeoPoliticalExtent.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static GeoPoliticalExtent.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(GeoPoliticalExtent.Matcher.class);
     ...
     * 
     */
    public Collection<GeoPoliticalExtent.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<GeoPoliticalExtent.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<GeoPoliticalExtent.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super GeoPoliticalExtent.Match> processor) {
     ...
     * 
     */
    public GeoPoliticalExtent.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return GeoPoliticalExtent.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final GeoPoliticalExtent.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final GeoPoliticalExtent.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final GeoPoliticalExtent.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final GeoPoliticalExtent.Match partialMatch) {
    ...
    @Override
    protected GeoPoliticalExtent.Match tupleToMatch(final Tuple t) {
      try {
          return GeoPoliticalExtent.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected GeoPoliticalExtent.Match arrayToMatch(final Object[] match) {
      try {
          return GeoPoliticalExtent.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected GeoPoliticalExtent.Match arrayToMatchMutable(final Object[] match) {
      try {
          return GeoPoliticalExtent.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<GeoPoliticalExtent.Matcher> querySpecification() {
      return GeoPoliticalExtent.instance();
    }
  }
  
  private GeoPoliticalExtent() {
   ...
   * 
   */
  public static GeoPoliticalExtent instance() {
    try{
  ...
  @Override
  protected GeoPoliticalExtent.Matcher instantiate(final ViatraQueryEngine engine) {
    return GeoPoliticalExtent.Matcher.on(engine);
  }
  
  @Override
  public GeoPoliticalExtent.Matcher instantiate() {
    return GeoPoliticalExtent.Matcher.create();
  }
  
  @Override
  public GeoPoliticalExtent.Match newEmptyMatch() {
    return GeoPoliticalExtent.Match.newEmptyMatch();
  }
  
  @Override
  public GeoPoliticalExtent.Match newMatch(final Object... parameters) {
    return GeoPoliticalExtent.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link GeoPoliticalExtent} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link GeoPoliticalExtent#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final GeoPoliticalExtent INSTANCE = new GeoPoliticalExtent();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final GeoPoliticalExtent.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "GeoPoliticalExtent");
