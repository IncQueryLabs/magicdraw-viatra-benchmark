...
public final class PhysicalArchitecture_actualPropertySet extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_actualPropertySet.Match)) {
          PhysicalArchitecture_actualPropertySet.Match other = (PhysicalArchitecture_actualPropertySet.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_actualPropertySet specification() {
      return PhysicalArchitecture_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_actualPropertySet.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_actualPropertySet.Matcher> querySpecification() {
      return PhysicalArchitecture_actualPropertySet.instance();
    }
  }
  
  private PhysicalArchitecture_actualPropertySet() {
   ...
   * 
   */
  public static PhysicalArchitecture_actualPropertySet instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_actualPropertySet.Matcher instantiate() {
    return PhysicalArchitecture_actualPropertySet.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_actualPropertySet.Match newEmptyMatch() {
    return PhysicalArchitecture_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_actualPropertySet.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_actualPropertySet INSTANCE = new PhysicalArchitecture_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
