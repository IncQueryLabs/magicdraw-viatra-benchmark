...
public final class DataElement_physicalLocation extends BaseGeneratedEMFQuerySpecification<DataElement_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return DataElement_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public DataElement_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DataElement_physicalLocation.Match)) {
          DataElement_physicalLocation.Match other = (DataElement_physicalLocation.Match) obj;
    ...
    @Override
    public DataElement_physicalLocation specification() {
      return DataElement_physicalLocation.instance();
    }
     ...
     * 
     */
    public static DataElement_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static DataElement_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static DataElement_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DataElement_physicalLocation.Match {
    ...
    private static final class Immutable extends DataElement_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see DataElement_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<DataElement_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static DataElement_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DataElement_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DataElement_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<DataElement_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<DataElement_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<DataElement_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super DataElement_physicalLocation.Match> processor) {
     ...
     * 
     */
    public DataElement_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return DataElement_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DataElement_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DataElement_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final DataElement_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final DataElement_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected DataElement_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return DataElement_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected DataElement_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return DataElement_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DataElement_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DataElement_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DataElement_physicalLocation.Matcher> querySpecification() {
      return DataElement_physicalLocation.instance();
    }
  }
  
  private DataElement_physicalLocation() {
   ...
   * 
   */
  public static DataElement_physicalLocation instance() {
    try{
  ...
  @Override
  protected DataElement_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return DataElement_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public DataElement_physicalLocation.Matcher instantiate() {
    return DataElement_physicalLocation.Matcher.create();
  }
  
  @Override
  public DataElement_physicalLocation.Match newEmptyMatch() {
    return DataElement_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public DataElement_physicalLocation.Match newMatch(final Object... parameters) {
    return DataElement_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataElement_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataElement_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DataElement_physicalLocation INSTANCE = new DataElement_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DataElement_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
