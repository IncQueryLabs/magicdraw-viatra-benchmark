...
public final class Organization_physicalLocation extends BaseGeneratedEMFQuerySpecification<Organization_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Organization_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_physicalLocation.Match)) {
          Organization_physicalLocation.Match other = (Organization_physicalLocation.Match) obj;
    ...
    @Override
    public Organization_physicalLocation specification() {
      return Organization_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Organization_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_physicalLocation.Match {
    ...
    private static final class Immutable extends Organization_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Organization_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Organization_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Organization_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Organization_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_physicalLocation.Matcher> querySpecification() {
      return Organization_physicalLocation.instance();
    }
  }
  
  private Organization_physicalLocation() {
   ...
   * 
   */
  public static Organization_physicalLocation instance() {
    try{
  ...
  @Override
  protected Organization_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Organization_physicalLocation.Matcher instantiate() {
    return Organization_physicalLocation.Matcher.create();
  }
  
  @Override
  public Organization_physicalLocation.Match newEmptyMatch() {
    return Organization_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_physicalLocation.Match newMatch(final Object... parameters) {
    return Organization_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_physicalLocation INSTANCE = new Organization_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
