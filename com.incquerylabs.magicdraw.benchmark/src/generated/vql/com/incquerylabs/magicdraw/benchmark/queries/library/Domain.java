 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "Domain");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Domain extends BaseGeneratedEMFQuerySpecification<Domain.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Domain pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Domain";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Domain pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Domain} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Domain#instance()}.
   * 
