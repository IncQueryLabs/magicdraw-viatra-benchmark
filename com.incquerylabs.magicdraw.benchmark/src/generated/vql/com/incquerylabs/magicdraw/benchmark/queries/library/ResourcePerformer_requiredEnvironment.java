...
public final class ResourcePerformer_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<ResourcePerformer_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourcePerformer_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ResourcePerformer_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourcePerformer_requiredEnvironment.Match)) {
          ResourcePerformer_requiredEnvironment.Match other = (ResourcePerformer_requiredEnvironment.Match) obj;
    ...
    @Override
    public ResourcePerformer_requiredEnvironment specification() {
      return ResourcePerformer_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static ResourcePerformer_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourcePerformer_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourcePerformer_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourcePerformer_requiredEnvironment.Match {
    ...
    private static final class Immutable extends ResourcePerformer_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ResourcePerformer_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ResourcePerformer_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ResourcePerformer_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourcePerformer_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourcePerformer_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ResourcePerformer_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourcePerformer_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourcePerformer_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourcePerformer_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public ResourcePerformer_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourcePerformer_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourcePerformer_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourcePerformer_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourcePerformer_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourcePerformer_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected ResourcePerformer_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ResourcePerformer_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourcePerformer_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ResourcePerformer_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourcePerformer_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourcePerformer_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourcePerformer_requiredEnvironment.Matcher> querySpecification() {
      return ResourcePerformer_requiredEnvironment.instance();
    }
  }
  
  private ResourcePerformer_requiredEnvironment() {
   ...
   * 
   */
  public static ResourcePerformer_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected ResourcePerformer_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourcePerformer_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ResourcePerformer_requiredEnvironment.Matcher instantiate() {
    return ResourcePerformer_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public ResourcePerformer_requiredEnvironment.Match newEmptyMatch() {
    return ResourcePerformer_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ResourcePerformer_requiredEnvironment.Match newMatch(final Object... parameters) {
    return ResourcePerformer_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourcePerformer_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourcePerformer_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourcePerformer_requiredEnvironment INSTANCE = new ResourcePerformer_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourcePerformer_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
