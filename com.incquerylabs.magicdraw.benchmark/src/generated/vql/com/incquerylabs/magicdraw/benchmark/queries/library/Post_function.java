...
public final class Post_function extends BaseGeneratedEMFQuerySpecification<Post_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Post_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_function.Match.parameterNames;
    }
    ...
    @Override
    public Post_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_function.Match)) {
          Post_function.Match other = (Post_function.Match) obj;
    ...
    @Override
    public Post_function specification() {
      return Post_function.instance();
    }
     ...
     * 
     */
    public static Post_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_function.Match {
    ...
    private static final class Immutable extends Post_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_function pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Post_function.Match> {
    /**
     ...
     * 
     */
    public static Post_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_function.Matcher.class);
     ...
     * 
     */
    public Collection<Post_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_function.Match> processor) {
     ...
     * 
     */
    public Post_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_function.Match partialMatch) {
    ...
    @Override
    protected Post_function.Match tupleToMatch(final Tuple t) {
      try {
          return Post_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_function.Match arrayToMatch(final Object[] match) {
      try {
          return Post_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_function.Matcher> querySpecification() {
      return Post_function.instance();
    }
  }
  
  private Post_function() {
   ...
   * 
   */
  public static Post_function instance() {
    try{
  ...
  @Override
  protected Post_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_function.Matcher.on(engine);
  }
  
  @Override
  public Post_function.Matcher instantiate() {
    return Post_function.Matcher.create();
  }
  
  @Override
  public Post_function.Match newEmptyMatch() {
    return Post_function.Match.newEmptyMatch();
  }
  
  @Override
  public Post_function.Match newMatch(final Object... parameters) {
    return Post_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_function INSTANCE = new Post_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
