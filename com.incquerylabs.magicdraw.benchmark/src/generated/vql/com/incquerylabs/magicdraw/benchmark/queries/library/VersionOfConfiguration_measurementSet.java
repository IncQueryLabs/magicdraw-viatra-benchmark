...
public final class VersionOfConfiguration_measurementSet extends BaseGeneratedEMFQuerySpecification<VersionOfConfiguration_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.VersionOfConfiguration_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.VersionOfConfiguration_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionOfConfiguration_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public VersionOfConfiguration_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionOfConfiguration_measurementSet.Match)) {
          VersionOfConfiguration_measurementSet.Match other = (VersionOfConfiguration_measurementSet.Match) obj;
    ...
    @Override
    public VersionOfConfiguration_measurementSet specification() {
      return VersionOfConfiguration_measurementSet.instance();
    }
     ...
     * 
     */
    public static VersionOfConfiguration_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionOfConfiguration_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static VersionOfConfiguration_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends VersionOfConfiguration_measurementSet.Match {
    ...
    private static final class Immutable extends VersionOfConfiguration_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.VersionOfConfiguration_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see VersionOfConfiguration_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<VersionOfConfiguration_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static VersionOfConfiguration_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionOfConfiguration_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionOfConfiguration_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<VersionOfConfiguration_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<VersionOfConfiguration_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<VersionOfConfiguration_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super VersionOfConfiguration_measurementSet.Match> processor) {
     ...
     * 
     */
    public VersionOfConfiguration_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return VersionOfConfiguration_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final VersionOfConfiguration_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final VersionOfConfiguration_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final VersionOfConfiguration_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final VersionOfConfiguration_measurementSet.Match partialMatch) {
    ...
    @Override
    protected VersionOfConfiguration_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return VersionOfConfiguration_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected VersionOfConfiguration_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return VersionOfConfiguration_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionOfConfiguration_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionOfConfiguration_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionOfConfiguration_measurementSet.Matcher> querySpecification() {
      return VersionOfConfiguration_measurementSet.instance();
    }
  }
  
  private VersionOfConfiguration_measurementSet() {
   ...
   * 
   */
  public static VersionOfConfiguration_measurementSet instance() {
    try{
  ...
  @Override
  protected VersionOfConfiguration_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionOfConfiguration_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public VersionOfConfiguration_measurementSet.Matcher instantiate() {
    return VersionOfConfiguration_measurementSet.Matcher.create();
  }
  
  @Override
  public VersionOfConfiguration_measurementSet.Match newEmptyMatch() {
    return VersionOfConfiguration_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public VersionOfConfiguration_measurementSet.Match newMatch(final Object... parameters) {
    return VersionOfConfiguration_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionOfConfiguration_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionOfConfiguration_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionOfConfiguration_measurementSet INSTANCE = new VersionOfConfiguration_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionOfConfiguration_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
