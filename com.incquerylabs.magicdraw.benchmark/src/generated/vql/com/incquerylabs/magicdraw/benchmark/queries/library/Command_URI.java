...
public final class Command_URI extends BaseGeneratedEMFQuerySpecification<Command_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Command_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Command_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Command_URI.Match.parameterNames;
    }
    ...
    @Override
    public Command_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Command_URI.Match)) {
          Command_URI.Match other = (Command_URI.Match) obj;
    ...
    @Override
    public Command_URI specification() {
      return Command_URI.instance();
    }
     ...
     * 
     */
    public static Command_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Command_URI.Match newMutableMatch(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Command_URI.Match newMatch(final InformationFlow pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Command_URI.Match {
    ...
    private static final class Immutable extends Command_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Command_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Command_URI.Match> {
    /**
     ...
     * 
     */
    public static Command_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Command_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Command_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Command_URI.Match> getAllMatches(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Command_URI.Match> streamAllMatches(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Command_URI.Match> getOneArbitraryMatch(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final LiteralString pValuespec, final Consumer<? super Command_URI.Match> processor) {
     ...
     * 
     */
    public Command_URI.Match newMatch(final InformationFlow pElement, final LiteralString pValuespec) {
      return Command_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Command_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Command_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Command_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Command_URI.Match partialMatch) {
    ...
    @Override
    protected Command_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Command_URI.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Command_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Command_URI.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Command_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Command_URI.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Command_URI.Matcher> querySpecification() {
      return Command_URI.instance();
    }
  }
   ...
   * 
   */
  public static Command_URI instance() {
    try{
  ...
  @Override
  protected Command_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Command_URI.Matcher.on(engine);
  }
  
  @Override
  public Command_URI.Matcher instantiate() {
    return Command_URI.Matcher.create();
  }
  
  @Override
  public Command_URI.Match newEmptyMatch() {
    return Command_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Command_URI.Match newMatch(final Object... parameters) {
    return Command_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Command_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Command_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Command_URI INSTANCE = new Command_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Command_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
