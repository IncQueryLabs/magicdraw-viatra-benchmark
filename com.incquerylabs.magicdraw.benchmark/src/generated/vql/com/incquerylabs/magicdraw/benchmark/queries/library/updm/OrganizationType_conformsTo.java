...
public final class OrganizationType_conformsTo extends BaseGeneratedEMFQuerySpecification<OrganizationType_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_conformsTo.Match)) {
          OrganizationType_conformsTo.Match other = (OrganizationType_conformsTo.Match) obj;
    ...
    @Override
    public OrganizationType_conformsTo specification() {
      return OrganizationType_conformsTo.instance();
    }
     ...
     * 
     */
    public static OrganizationType_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_conformsTo.Match {
    ...
    private static final class Immutable extends OrganizationType_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_conformsTo.Match> processor) {
     ...
     * 
     */
    public OrganizationType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_conformsTo.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_conformsTo.Matcher> querySpecification() {
      return OrganizationType_conformsTo.instance();
    }
  }
  
  private OrganizationType_conformsTo() {
   ...
   * 
   */
  public static OrganizationType_conformsTo instance() {
    try{
  ...
  @Override
  protected OrganizationType_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_conformsTo.Matcher instantiate() {
    return OrganizationType_conformsTo.Matcher.create();
  }
  
  @Override
  public OrganizationType_conformsTo.Match newEmptyMatch() {
    return OrganizationType_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_conformsTo.Match newMatch(final Object... parameters) {
    return OrganizationType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_conformsTo INSTANCE = new OrganizationType_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
