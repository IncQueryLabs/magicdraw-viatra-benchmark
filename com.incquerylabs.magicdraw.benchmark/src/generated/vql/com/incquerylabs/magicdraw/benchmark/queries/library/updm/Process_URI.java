...
public final class Process_URI extends BaseGeneratedEMFQuerySpecification<Process_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Process_URI.Match.parameterNames;
    }
    ...
    @Override
    public Process_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Process_URI.Match)) {
          Process_URI.Match other = (Process_URI.Match) obj;
    ...
    @Override
    public Process_URI specification() {
      return Process_URI.instance();
    }
     ...
     * 
     */
    public static Process_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Process_URI.Match newMutableMatch(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Process_URI.Match newMatch(final Activity pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Process_URI.Match {
    ...
    private static final class Immutable extends Process_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Process_URI.Match> {
    /**
     ...
     * 
     */
    public static Process_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Process_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Process_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Process_URI.Match> getAllMatches(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Process_URI.Match> streamAllMatches(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Process_URI.Match> getOneArbitraryMatch(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final LiteralString pValuespec, final Consumer<? super Process_URI.Match> processor) {
     ...
     * 
     */
    public Process_URI.Match newMatch(final Activity pElement, final LiteralString pValuespec) {
      return Process_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Process_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Process_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Process_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Process_URI.Match partialMatch) {
    ...
    @Override
    protected Process_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Process_URI.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Process_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Process_URI.Match.newMatch((Activity) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Process_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Process_URI.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Process_URI.Matcher> querySpecification() {
      return Process_URI.instance();
    }
  }
   ...
   * 
   */
  public static Process_URI instance() {
    try{
  ...
  @Override
  protected Process_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Process_URI.Matcher.on(engine);
  }
  
  @Override
  public Process_URI.Matcher instantiate() {
    return Process_URI.Matcher.create();
  }
  
  @Override
  public Process_URI.Match newEmptyMatch() {
    return Process_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Process_URI.Match newMatch(final Object... parameters) {
    return Process_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Process_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Process_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Process_URI INSTANCE = new Process_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Process_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
