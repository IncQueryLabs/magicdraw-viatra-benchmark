...
public final class WholeLifeEnterprise_visions extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_visions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_visions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_visions";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_visions.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_visions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_visions.Match)) {
          WholeLifeEnterprise_visions.Match other = (WholeLifeEnterprise_visions.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_visions specification() {
      return WholeLifeEnterprise_visions.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_visions.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_visions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_visions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_visions.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_visions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_visions pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_visions
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_visions.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_visions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_visions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_visions.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_visions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_visions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_visions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_visions.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_visions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_visions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_visions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_visions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_visions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_visions.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_visions.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_visions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_visions.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_visions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_visions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_visions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_visions.Matcher> querySpecification() {
      return WholeLifeEnterprise_visions.instance();
    }
  }
  
  private WholeLifeEnterprise_visions() {
   ...
   * 
   */
  public static WholeLifeEnterprise_visions instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_visions.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_visions.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_visions.Matcher instantiate() {
    return WholeLifeEnterprise_visions.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_visions.Match newEmptyMatch() {
    return WholeLifeEnterprise_visions.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_visions.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_visions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_visions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_visions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_visions INSTANCE = new WholeLifeEnterprise_visions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_visions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
