...
public final class ParticipantPropertyMultiplicity extends BaseGeneratedEMFQuerySpecification<ParticipantPropertyMultiplicity.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.participantPropertyMultiplicity pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.participantPropertyMultiplicity";
    }
    
    @Override
    public List<String> parameterNames() {
      return ParticipantPropertyMultiplicity.Match.parameterNames;
    }
    ...
    @Override
    public ParticipantPropertyMultiplicity.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ParticipantPropertyMultiplicity.Match)) {
          ParticipantPropertyMultiplicity.Match other = (ParticipantPropertyMultiplicity.Match) obj;
    ...
    @Override
    public ParticipantPropertyMultiplicity specification() {
     ...
     * 
     */
    public static ParticipantPropertyMultiplicity.Match newEmptyMatch() {
     ...
     * 
     */
    public static ParticipantPropertyMultiplicity.Match newMutableMatch(final Property pProperty) {
     ...
     * 
     */
    public static ParticipantPropertyMultiplicity.Match newMatch(final Property pProperty) {
      return new Immutable(pProperty);
    }
    
    private static final class Mutable extends ParticipantPropertyMultiplicity.Match {
    ...
    private static final class Immutable extends ParticipantPropertyMultiplicity.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.participantPropertyMultiplicity pattern,
   ...
   * 
   * @see Match
   * @see ParticipantPropertyMultiplicity
   * 
   */
  public static class Matcher extends BaseMatcher<ParticipantPropertyMultiplicity.Match> {
    /**
     ...
     * 
     */
    public static ParticipantPropertyMultiplicity.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ParticipantPropertyMultiplicity.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_PROPERTY = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ParticipantPropertyMultiplicity.Matcher.class);
     ...
     * 
     */
    public Collection<ParticipantPropertyMultiplicity.Match> getAllMatches(final Property pProperty) {
     ...
     * 
     */
    public Stream<ParticipantPropertyMultiplicity.Match> streamAllMatches(final Property pProperty) {
     ...
     * 
     */
    public Optional<ParticipantPropertyMultiplicity.Match> getOneArbitraryMatch(final Property pProperty) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pProperty, final Consumer<? super ParticipantPropertyMultiplicity.Match> processor) {
     ...
     * 
     */
    public ParticipantPropertyMultiplicity.Match newMatch(final Property pProperty) {
      return ParticipantPropertyMultiplicity.Match.newMatch(pProperty);
    }
    ...
    @Override
    protected ParticipantPropertyMultiplicity.Match tupleToMatch(final Tuple t) {
      try {
          return ParticipantPropertyMultiplicity.Match.newMatch((Property) t.get(POSITION_PROPERTY));
    ...
    @Override
    protected ParticipantPropertyMultiplicity.Match arrayToMatch(final Object[] match) {
      try {
          return ParticipantPropertyMultiplicity.Match.newMatch((Property) match[POSITION_PROPERTY]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ParticipantPropertyMultiplicity.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ParticipantPropertyMultiplicity.Match.newMutableMatch((Property) match[POSITION_PROPERTY]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ParticipantPropertyMultiplicity.Matcher> querySpecification() {
      return ParticipantPropertyMultiplicity.instance();
    }
  }
  
  private ParticipantPropertyMultiplicity() {
   ...
   * 
   */
  public static ParticipantPropertyMultiplicity instance() {
    try{
  ...
  @Override
  protected ParticipantPropertyMultiplicity.Matcher instantiate(final ViatraQueryEngine engine) {
    return ParticipantPropertyMultiplicity.Matcher.on(engine);
  }
  
  @Override
  public ParticipantPropertyMultiplicity.Matcher instantiate() {
    return ParticipantPropertyMultiplicity.Matcher.create();
  }
  
  @Override
  public ParticipantPropertyMultiplicity.Match newEmptyMatch() {
    return ParticipantPropertyMultiplicity.Match.newEmptyMatch();
  }
  
  @Override
  public ParticipantPropertyMultiplicity.Match newMatch(final Object... parameters) {
    return ParticipantPropertyMultiplicity.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ParticipantPropertyMultiplicity} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ParticipantPropertyMultiplicity#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ParticipantPropertyMultiplicity INSTANCE = new ParticipantPropertyMultiplicity();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ParticipantPropertyMultiplicity.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern participantPropertyMultiplicity";
              }
      ...
      }
      {
          ...
          // 	LiteralUnlimitedNatural.value(upper, value)
          new TypeConstraint(body, Tuples.flatTupleOf(var_upper), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "LiteralUnlimitedNatural")));
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new TypeConstraint(body, Tuples.flatTupleOf(var_upper, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "LiteralUnlimitedNatural", "value")));
          new TypeConstraint(body, Tuples.flatTupleOf(var__virtual_1_), new EDataTypeInSlotsKey((EDataType)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "UnlimitedNatural")));
          new Equality(body, var__virtual_1_, var_value);
          // 	check(value != 1)
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
