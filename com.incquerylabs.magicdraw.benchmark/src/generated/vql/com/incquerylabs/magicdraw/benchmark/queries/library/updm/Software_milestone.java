...
public final class Software_milestone extends BaseGeneratedEMFQuerySpecification<Software_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_milestone.Match.parameterNames;
    }
    ...
    @Override
    public Software_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_milestone.Match)) {
          Software_milestone.Match other = (Software_milestone.Match) obj;
    ...
    @Override
    public Software_milestone specification() {
      return Software_milestone.instance();
    }
     ...
     * 
     */
    public static Software_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_milestone.Match {
    ...
    private static final class Immutable extends Software_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_milestone pattern,
   ...
   * 
   * @see Match
   * @see Software_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<Software_milestone.Match> {
    /**
     ...
     * 
     */
    public static Software_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<Software_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_milestone.Match> processor) {
     ...
     * 
     */
    public Software_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_milestone.Match partialMatch) {
    ...
    @Override
    protected Software_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return Software_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return Software_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_milestone.Matcher> querySpecification() {
      return Software_milestone.instance();
    }
  }
  
  private Software_milestone() {
   ...
   * 
   */
  public static Software_milestone instance() {
    try{
  ...
  @Override
  protected Software_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_milestone.Matcher.on(engine);
  }
  
  @Override
  public Software_milestone.Matcher instantiate() {
    return Software_milestone.Matcher.create();
  }
  
  @Override
  public Software_milestone.Match newEmptyMatch() {
    return Software_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public Software_milestone.Match newMatch(final Object... parameters) {
    return Software_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_milestone INSTANCE = new Software_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
