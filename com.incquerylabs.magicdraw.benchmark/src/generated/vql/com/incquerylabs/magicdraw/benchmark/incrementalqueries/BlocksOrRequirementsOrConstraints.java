...
public final class BlocksOrRequirementsOrConstraints extends BaseGeneratedEMFQuerySpecification<BlocksOrRequirementsOrConstraints.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.blocksOrRequirementsOrConstraints pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.blocksOrRequirementsOrConstraints";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.blocksOrRequirementsOrConstraints pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<BlocksOrRequirementsOrConstraints.Match> {
    /**
     ...
     * 
     */
    public Collection<BlocksOrRequirementsOrConstraints.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public Stream<BlocksOrRequirementsOrConstraints.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public Optional<BlocksOrRequirementsOrConstraints.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public static IQuerySpecification<BlocksOrRequirementsOrConstraints.Matcher> querySpecification() {
      return BlocksOrRequirementsOrConstraints.instance();
    }
  }
