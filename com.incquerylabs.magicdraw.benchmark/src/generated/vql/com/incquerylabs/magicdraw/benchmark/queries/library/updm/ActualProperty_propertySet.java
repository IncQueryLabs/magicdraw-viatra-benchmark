...
public final class ActualProperty_propertySet extends BaseGeneratedEMFQuerySpecification<ActualProperty_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProperty_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ActualProperty_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProperty_propertySet.Match)) {
          ActualProperty_propertySet.Match other = (ActualProperty_propertySet.Match) obj;
    ...
    @Override
    public ActualProperty_propertySet specification() {
      return ActualProperty_propertySet.instance();
    }
     ...
     * 
     */
    public static ActualProperty_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProperty_propertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProperty_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProperty_propertySet.Match {
    ...
    private static final class Immutable extends ActualProperty_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ActualProperty_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProperty_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ActualProperty_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProperty_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProperty_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProperty_propertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProperty_propertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProperty_propertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProperty_propertySet.Match> processor) {
     ...
     * 
     */
    public ActualProperty_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProperty_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProperty_propertySet.Match partialMatch) {
    ...
    @Override
    protected ActualProperty_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProperty_propertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProperty_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProperty_propertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProperty_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProperty_propertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProperty_propertySet.Matcher> querySpecification() {
      return ActualProperty_propertySet.instance();
    }
  }
  
  private ActualProperty_propertySet() {
   ...
   * 
   */
  public static ActualProperty_propertySet instance() {
    try{
  ...
  @Override
  protected ActualProperty_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProperty_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ActualProperty_propertySet.Matcher instantiate() {
    return ActualProperty_propertySet.Matcher.create();
  }
  
  @Override
  public ActualProperty_propertySet.Match newEmptyMatch() {
    return ActualProperty_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProperty_propertySet.Match newMatch(final Object... parameters) {
    return ActualProperty_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProperty_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProperty_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProperty_propertySet INSTANCE = new ActualProperty_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProperty_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
