...
public final class Vision_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Vision_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Vision_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Vision_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Vision_endBoundaryType.Match)) {
          Vision_endBoundaryType.Match other = (Vision_endBoundaryType.Match) obj;
    ...
    @Override
    public Vision_endBoundaryType specification() {
      return Vision_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Vision_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Vision_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Vision_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Vision_endBoundaryType.Match {
    ...
    private static final class Immutable extends Vision_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Vision_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Vision_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Vision_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Vision_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Vision_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Vision_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Vision_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Vision_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Vision_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Vision_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Vision_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Vision_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Vision_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Vision_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Vision_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Vision_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Vision_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Vision_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Vision_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Vision_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Vision_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Vision_endBoundaryType.Matcher> querySpecification() {
      return Vision_endBoundaryType.instance();
    }
  }
  
  private Vision_endBoundaryType() {
   ...
   * 
   */
  public static Vision_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Vision_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Vision_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Vision_endBoundaryType.Matcher instantiate() {
    return Vision_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Vision_endBoundaryType.Match newEmptyMatch() {
    return Vision_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Vision_endBoundaryType.Match newMatch(final Object... parameters) {
    return Vision_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Vision_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Vision_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Vision_endBoundaryType INSTANCE = new Vision_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Vision_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
