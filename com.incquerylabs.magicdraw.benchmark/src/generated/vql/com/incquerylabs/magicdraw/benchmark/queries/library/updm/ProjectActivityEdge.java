...
public final class ProjectActivityEdge extends BaseGeneratedEMFQuerySpecification<ProjectActivityEdge.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectActivityEdge pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectActivityEdge";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectActivityEdge.Match.parameterNames;
    }
    ...
    @Override
    public ProjectActivityEdge.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectActivityEdge.Match)) {
          ProjectActivityEdge.Match other = (ProjectActivityEdge.Match) obj;
    ...
    @Override
    public ProjectActivityEdge specification() {
      return ProjectActivityEdge.instance();
    }
     ...
     * 
     */
    public static ProjectActivityEdge.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectActivityEdge.Match newMutableMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProjectActivityEdge.Match newMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProjectActivityEdge.Match {
    ...
    private static final class Immutable extends ProjectActivityEdge.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectActivityEdge pattern,
   ...
   * 
   * @see Match
   * @see ProjectActivityEdge
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectActivityEdge.Match> {
    /**
     ...
     * 
     */
    public static ProjectActivityEdge.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectActivityEdge.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectActivityEdge.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectActivityEdge.Match> getAllMatches(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProjectActivityEdge.Match> streamAllMatches(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProjectActivityEdge.Match> getOneArbitraryMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProjectActivityEdge.Match> processor) {
     ...
     * 
     */
    public ProjectActivityEdge.Match newMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProjectActivityEdge.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<ActivityEdge> streamAllValuesOfelement(final ProjectActivityEdge.Match partialMatch) {
     ...
     * 
     */
    public Set<ActivityEdge> getAllValuesOfelement(final ProjectActivityEdge.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProjectActivityEdge.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProjectActivityEdge.Match partialMatch) {
    ...
    @Override
    protected ProjectActivityEdge.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectActivityEdge.Match.newMatch((ActivityEdge) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProjectActivityEdge.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectActivityEdge.Match.newMatch((ActivityEdge) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectActivityEdge.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectActivityEdge.Match.newMutableMatch((ActivityEdge) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectActivityEdge.Matcher> querySpecification() {
      return ProjectActivityEdge.instance();
    }
  }
  
  private ProjectActivityEdge() {
   ...
   * 
   */
  public static ProjectActivityEdge instance() {
    try{
  ...
  @Override
  protected ProjectActivityEdge.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectActivityEdge.Matcher.on(engine);
  }
  
  @Override
  public ProjectActivityEdge.Matcher instantiate() {
    return ProjectActivityEdge.Matcher.create();
  }
  
  @Override
  public ProjectActivityEdge.Match newEmptyMatch() {
    return ProjectActivityEdge.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectActivityEdge.Match newMatch(final Object... parameters) {
    return ProjectActivityEdge.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ActivityEdge) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectActivityEdge} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectActivityEdge#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectActivityEdge INSTANCE = new ProjectActivityEdge();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectActivityEdge.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ProjectActivityEdge");
