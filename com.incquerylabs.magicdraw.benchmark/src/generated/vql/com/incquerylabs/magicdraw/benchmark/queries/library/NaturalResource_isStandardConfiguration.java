...
import com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource;
...
public final class NaturalResource_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<NaturalResource_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return NaturalResource_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public NaturalResource_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NaturalResource_isStandardConfiguration.Match)) {
          NaturalResource_isStandardConfiguration.Match other = (NaturalResource_isStandardConfiguration.Match) obj;
    ...
    @Override
    public NaturalResource_isStandardConfiguration specification() {
      return NaturalResource_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static NaturalResource_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static NaturalResource_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static NaturalResource_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends NaturalResource_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends NaturalResource_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see NaturalResource_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<NaturalResource_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static NaturalResource_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NaturalResource_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NaturalResource_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<NaturalResource_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<NaturalResource_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<NaturalResource_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super NaturalResource_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public NaturalResource_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return NaturalResource_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NaturalResource_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NaturalResource_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final NaturalResource_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final NaturalResource_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected NaturalResource_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return NaturalResource_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected NaturalResource_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return NaturalResource_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NaturalResource_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NaturalResource_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NaturalResource_isStandardConfiguration.Matcher> querySpecification() {
      return NaturalResource_isStandardConfiguration.instance();
    }
  }
  
  private NaturalResource_isStandardConfiguration() {
   ...
   * 
   */
  public static NaturalResource_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected NaturalResource_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return NaturalResource_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public NaturalResource_isStandardConfiguration.Matcher instantiate() {
    return NaturalResource_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public NaturalResource_isStandardConfiguration.Match newEmptyMatch() {
    return NaturalResource_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public NaturalResource_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return NaturalResource_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NaturalResource_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NaturalResource_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NaturalResource_isStandardConfiguration INSTANCE = new NaturalResource_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NaturalResource_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find NaturalResource(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), NaturalResource.instance().getInternalQueryRepresentation());
