...
public final class Capability_conformsTo extends BaseGeneratedEMFQuerySpecification<Capability_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Capability_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Capability_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Capability_conformsTo.Match)) {
          Capability_conformsTo.Match other = (Capability_conformsTo.Match) obj;
    ...
    @Override
    public Capability_conformsTo specification() {
      return Capability_conformsTo.instance();
    }
     ...
     * 
     */
    public static Capability_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Capability_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Capability_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Capability_conformsTo.Match {
    ...
    private static final class Immutable extends Capability_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Capability_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Capability_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Capability_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Capability_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Capability_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Capability_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Capability_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Capability_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Capability_conformsTo.Match> processor) {
     ...
     * 
     */
    public Capability_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Capability_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Capability_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Capability_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Capability_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Capability_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Capability_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Capability_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Capability_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Capability_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Capability_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Capability_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Capability_conformsTo.Matcher> querySpecification() {
      return Capability_conformsTo.instance();
    }
  }
  
  private Capability_conformsTo() {
   ...
   * 
   */
  public static Capability_conformsTo instance() {
    try{
  ...
  @Override
  protected Capability_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Capability_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Capability_conformsTo.Matcher instantiate() {
    return Capability_conformsTo.Matcher.create();
  }
  
  @Override
  public Capability_conformsTo.Match newEmptyMatch() {
    return Capability_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Capability_conformsTo.Match newMatch(final Object... parameters) {
    return Capability_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Capability_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Capability_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Capability_conformsTo INSTANCE = new Capability_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Capability_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
