...
public final class ResourcePerformer_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<ResourcePerformer_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourcePerformer_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public ResourcePerformer_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourcePerformer_categoryCategorizesAsset.Match)) {
          ResourcePerformer_categoryCategorizesAsset.Match other = (ResourcePerformer_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public ResourcePerformer_categoryCategorizesAsset specification() {
      return ResourcePerformer_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static ResourcePerformer_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourcePerformer_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourcePerformer_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourcePerformer_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends ResourcePerformer_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see ResourcePerformer_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<ResourcePerformer_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static ResourcePerformer_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourcePerformer_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourcePerformer_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<ResourcePerformer_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourcePerformer_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourcePerformer_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourcePerformer_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public ResourcePerformer_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourcePerformer_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourcePerformer_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourcePerformer_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourcePerformer_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourcePerformer_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected ResourcePerformer_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return ResourcePerformer_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourcePerformer_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return ResourcePerformer_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourcePerformer_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourcePerformer_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourcePerformer_categoryCategorizesAsset.Matcher> querySpecification() {
      return ResourcePerformer_categoryCategorizesAsset.instance();
    }
  }
  
  private ResourcePerformer_categoryCategorizesAsset() {
   ...
   * 
   */
  public static ResourcePerformer_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected ResourcePerformer_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourcePerformer_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public ResourcePerformer_categoryCategorizesAsset.Matcher instantiate() {
    return ResourcePerformer_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public ResourcePerformer_categoryCategorizesAsset.Match newEmptyMatch() {
    return ResourcePerformer_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public ResourcePerformer_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return ResourcePerformer_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourcePerformer_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourcePerformer_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourcePerformer_categoryCategorizesAsset INSTANCE = new ResourcePerformer_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourcePerformer_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
