...
public final class WrapperAttribute extends BaseGeneratedEMFQuerySpecification<WrapperAttribute.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WrapperAttribute pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WrapperAttribute";
    }
    
    @Override
    public List<String> parameterNames() {
      return WrapperAttribute.Match.parameterNames;
    }
    ...
    @Override
    public WrapperAttribute.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WrapperAttribute.Match)) {
          WrapperAttribute.Match other = (WrapperAttribute.Match) obj;
    ...
    @Override
    public WrapperAttribute specification() {
      return WrapperAttribute.instance();
    }
     ...
     * 
     */
    public static WrapperAttribute.Match newEmptyMatch() {
     ...
     * 
     */
    public static WrapperAttribute.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static WrapperAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends WrapperAttribute.Match {
    ...
    private static final class Immutable extends WrapperAttribute.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WrapperAttribute pattern,
   ...
   * 
   * @see Match
   * @see WrapperAttribute
   * 
   */
  public static class Matcher extends BaseMatcher<WrapperAttribute.Match> {
    /**
     ...
     * 
     */
    public static WrapperAttribute.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WrapperAttribute.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WrapperAttribute.Matcher.class);
     ...
     * 
     */
    public Collection<WrapperAttribute.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<WrapperAttribute.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<WrapperAttribute.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super WrapperAttribute.Match> processor) {
     ...
     * 
     */
    public WrapperAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return WrapperAttribute.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final WrapperAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final WrapperAttribute.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final WrapperAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final WrapperAttribute.Match partialMatch) {
    ...
    @Override
    protected WrapperAttribute.Match tupleToMatch(final Tuple t) {
      try {
          return WrapperAttribute.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected WrapperAttribute.Match arrayToMatch(final Object[] match) {
      try {
          return WrapperAttribute.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WrapperAttribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WrapperAttribute.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WrapperAttribute.Matcher> querySpecification() {
      return WrapperAttribute.instance();
    }
  }
  
  private WrapperAttribute() {
   ...
   * 
   */
  public static WrapperAttribute instance() {
    try{
  ...
  @Override
  protected WrapperAttribute.Matcher instantiate(final ViatraQueryEngine engine) {
    return WrapperAttribute.Matcher.on(engine);
  }
  
  @Override
  public WrapperAttribute.Matcher instantiate() {
    return WrapperAttribute.Matcher.create();
  }
  
  @Override
  public WrapperAttribute.Match newEmptyMatch() {
    return WrapperAttribute.Match.newEmptyMatch();
  }
  
  @Override
  public WrapperAttribute.Match newMatch(final Object... parameters) {
    return WrapperAttribute.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WrapperAttribute} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WrapperAttribute#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WrapperAttribute INSTANCE = new WrapperAttribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WrapperAttribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "WrapperAttribute");
