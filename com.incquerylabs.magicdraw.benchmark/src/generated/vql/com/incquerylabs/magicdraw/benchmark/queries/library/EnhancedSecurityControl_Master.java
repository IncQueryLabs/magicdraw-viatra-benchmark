...
public final class EnhancedSecurityControl_Master extends BaseGeneratedEMFQuerySpecification<EnhancedSecurityControl_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnhancedSecurityControl_Master.Match.parameterNames;
    }
    ...
    @Override
    public EnhancedSecurityControl_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnhancedSecurityControl_Master.Match)) {
          EnhancedSecurityControl_Master.Match other = (EnhancedSecurityControl_Master.Match) obj;
    ...
    @Override
    public EnhancedSecurityControl_Master specification() {
      return EnhancedSecurityControl_Master.instance();
    }
     ...
     * 
     */
    public static EnhancedSecurityControl_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnhancedSecurityControl_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnhancedSecurityControl_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnhancedSecurityControl_Master.Match {
    ...
    private static final class Immutable extends EnhancedSecurityControl_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Master pattern,
   ...
   * 
   * @see Match
   * @see EnhancedSecurityControl_Master
   * 
   */
  public static class Matcher extends BaseMatcher<EnhancedSecurityControl_Master.Match> {
    /**
     ...
     * 
     */
    public static EnhancedSecurityControl_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnhancedSecurityControl_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnhancedSecurityControl_Master.Matcher.class);
     ...
     * 
     */
    public Collection<EnhancedSecurityControl_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnhancedSecurityControl_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnhancedSecurityControl_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnhancedSecurityControl_Master.Match> processor) {
     ...
     * 
     */
    public EnhancedSecurityControl_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnhancedSecurityControl_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnhancedSecurityControl_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnhancedSecurityControl_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnhancedSecurityControl_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnhancedSecurityControl_Master.Match partialMatch) {
    ...
    @Override
    protected EnhancedSecurityControl_Master.Match tupleToMatch(final Tuple t) {
      try {
          return EnhancedSecurityControl_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnhancedSecurityControl_Master.Match arrayToMatch(final Object[] match) {
      try {
          return EnhancedSecurityControl_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnhancedSecurityControl_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnhancedSecurityControl_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnhancedSecurityControl_Master.Matcher> querySpecification() {
      return EnhancedSecurityControl_Master.instance();
    }
  }
  
  private EnhancedSecurityControl_Master() {
   ...
   * 
   */
  public static EnhancedSecurityControl_Master instance() {
    try{
  ...
  @Override
  protected EnhancedSecurityControl_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnhancedSecurityControl_Master.Matcher.on(engine);
  }
  
  @Override
  public EnhancedSecurityControl_Master.Matcher instantiate() {
    return EnhancedSecurityControl_Master.Matcher.create();
  }
  
  @Override
  public EnhancedSecurityControl_Master.Match newEmptyMatch() {
    return EnhancedSecurityControl_Master.Match.newEmptyMatch();
  }
  
  @Override
  public EnhancedSecurityControl_Master.Match newMatch(final Object... parameters) {
    return EnhancedSecurityControl_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnhancedSecurityControl_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnhancedSecurityControl_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnhancedSecurityControl_Master INSTANCE = new EnhancedSecurityControl_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnhancedSecurityControl_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
