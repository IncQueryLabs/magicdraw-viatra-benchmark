 ...
 *         pattern Unit_definitionURI(Element : PackageableElement, Value: java String) {
 *         	find Unit(Element, stereotype);
 *         	find taggedValue(Element, stereotype, "definitionURI", taggedValue);
...
public final class Unit_definitionURI extends BaseGeneratedEMFQuerySpecification<Unit_definitionURI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Unit_definitionURI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Unit_definitionURI";
    }
     ...
     * 
     */
    public static Unit_definitionURI.Match newMutableMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public static Unit_definitionURI.Match newMatch(final PackageableElement pElement, final String pValue) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Unit_definitionURI pattern,
  ...
  public static class Matcher extends BaseMatcher<Unit_definitionURI.Match> {
     ...
     * 
     */
    public Collection<Unit_definitionURI.Match> getAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Stream<Unit_definitionURI.Match> streamAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Optional<Unit_definitionURI.Match> getOneArbitraryMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final String pValue, final Consumer<? super Unit_definitionURI.Match> processor) {
     ...
     * 
     */
    public Unit_definitionURI.Match newMatch(final PackageableElement pElement, final String pValue) {
      return Unit_definitionURI.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final Unit_definitionURI.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final Unit_definitionURI.Match partialMatch) {
    ...
    protected Unit_definitionURI.Match tupleToMatch(final Tuple t) {
      try {
          return Unit_definitionURI.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected Unit_definitionURI.Match arrayToMatch(final Object[] match) {
      try {
          return Unit_definitionURI.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Unit_definitionURI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unit_definitionURI.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Unit_definitionURI.Match newMatch(final Object... parameters) {
    return Unit_definitionURI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (java.lang.String) parameters[1]);
  }
