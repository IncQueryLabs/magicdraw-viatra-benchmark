...
public final class StereotypeExtension extends BaseGeneratedEMFQuerySpecification<StereotypeExtension.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StereotypeExtension pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.StereotypeExtension";
    }
    
    @Override
    public List<String> parameterNames() {
      return StereotypeExtension.Match.parameterNames;
    }
    ...
    @Override
    public StereotypeExtension.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StereotypeExtension.Match)) {
          StereotypeExtension.Match other = (StereotypeExtension.Match) obj;
    ...
    @Override
    public StereotypeExtension specification() {
      return StereotypeExtension.instance();
    }
     ...
     * 
     */
    public static StereotypeExtension.Match newEmptyMatch() {
     ...
     * 
     */
    public static StereotypeExtension.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static StereotypeExtension.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends StereotypeExtension.Match {
    ...
    private static final class Immutable extends StereotypeExtension.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StereotypeExtension pattern,
   ...
   * 
   * @see Match
   * @see StereotypeExtension
   * 
   */
  public static class Matcher extends BaseMatcher<StereotypeExtension.Match> {
    /**
     ...
     * 
     */
    public static StereotypeExtension.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StereotypeExtension.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StereotypeExtension.Matcher.class);
     ...
     * 
     */
    public Collection<StereotypeExtension.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<StereotypeExtension.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<StereotypeExtension.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super StereotypeExtension.Match> processor) {
     ...
     * 
     */
    public StereotypeExtension.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return StereotypeExtension.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final StereotypeExtension.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final StereotypeExtension.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final StereotypeExtension.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final StereotypeExtension.Match partialMatch) {
    ...
    @Override
    protected StereotypeExtension.Match tupleToMatch(final Tuple t) {
      try {
          return StereotypeExtension.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected StereotypeExtension.Match arrayToMatch(final Object[] match) {
      try {
          return StereotypeExtension.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StereotypeExtension.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StereotypeExtension.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StereotypeExtension.Matcher> querySpecification() {
      return StereotypeExtension.instance();
    }
  }
  
  private StereotypeExtension() {
   ...
   * 
   */
  public static StereotypeExtension instance() {
    try{
  ...
  @Override
  protected StereotypeExtension.Matcher instantiate(final ViatraQueryEngine engine) {
    return StereotypeExtension.Matcher.on(engine);
  }
  
  @Override
  public StereotypeExtension.Matcher instantiate() {
    return StereotypeExtension.Matcher.create();
  }
  
  @Override
  public StereotypeExtension.Match newEmptyMatch() {
    return StereotypeExtension.Match.newEmptyMatch();
  }
  
  @Override
  public StereotypeExtension.Match newMatch(final Object... parameters) {
    return StereotypeExtension.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StereotypeExtension} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StereotypeExtension#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StereotypeExtension INSTANCE = new StereotypeExtension();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StereotypeExtension.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "StereotypeExtension");
