...
public final class WholeLifeConfiguration extends BaseGeneratedEMFQuerySpecification<WholeLifeConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeConfiguration.Match)) {
          WholeLifeConfiguration.Match other = (WholeLifeConfiguration.Match) obj;
    ...
    @Override
    public WholeLifeConfiguration specification() {
      return WholeLifeConfiguration.instance();
    }
     ...
     * 
     */
    public static WholeLifeConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static WholeLifeConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends WholeLifeConfiguration.Match {
    ...
    private static final class Immutable extends WholeLifeConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeConfiguration pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeConfiguration.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<WholeLifeConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<WholeLifeConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super WholeLifeConfiguration.Match> processor) {
     ...
     * 
     */
    public WholeLifeConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return WholeLifeConfiguration.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final WholeLifeConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final WholeLifeConfiguration.Match partialMatch) {
    ...
    @Override
    protected WholeLifeConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected WholeLifeConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeConfiguration.Matcher> querySpecification() {
      return WholeLifeConfiguration.instance();
    }
  }
  
  private WholeLifeConfiguration() {
   ...
   * 
   */
  public static WholeLifeConfiguration instance() {
    try{
  ...
  @Override
  protected WholeLifeConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeConfiguration.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeConfiguration.Matcher instantiate() {
    return WholeLifeConfiguration.Matcher.create();
  }
  
  @Override
  public WholeLifeConfiguration.Match newEmptyMatch() {
    return WholeLifeConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeConfiguration.Match newMatch(final Object... parameters) {
    return WholeLifeConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeConfiguration INSTANCE = new WholeLifeConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "WholeLifeConfiguration")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "WholeLifeConfiguration");
