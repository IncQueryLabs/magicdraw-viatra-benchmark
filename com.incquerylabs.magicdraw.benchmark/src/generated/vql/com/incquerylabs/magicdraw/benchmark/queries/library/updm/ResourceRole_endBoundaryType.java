...
public final class ResourceRole_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ResourceRole_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_endBoundaryType.Match)) {
          ResourceRole_endBoundaryType.Match other = (ResourceRole_endBoundaryType.Match) obj;
    ...
    @Override
    public ResourceRole_endBoundaryType specification() {
      return ResourceRole_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ResourceRole_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_endBoundaryType.Match {
    ...
    private static final class Immutable extends ResourceRole_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ResourceRole_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_endBoundaryType.Matcher> querySpecification() {
      return ResourceRole_endBoundaryType.instance();
    }
  }
  
  private ResourceRole_endBoundaryType() {
   ...
   * 
   */
  public static ResourceRole_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ResourceRole_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_endBoundaryType.Matcher instantiate() {
    return ResourceRole_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ResourceRole_endBoundaryType.Match newEmptyMatch() {
    return ResourceRole_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_endBoundaryType.Match newMatch(final Object... parameters) {
    return ResourceRole_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_endBoundaryType INSTANCE = new ResourceRole_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
