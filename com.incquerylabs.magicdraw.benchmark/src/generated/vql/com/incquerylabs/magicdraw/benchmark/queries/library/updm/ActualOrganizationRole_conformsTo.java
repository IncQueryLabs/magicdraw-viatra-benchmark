...
public final class ActualOrganizationRole_conformsTo extends BaseGeneratedEMFQuerySpecification<ActualOrganizationRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualOrganizationRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ActualOrganizationRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualOrganizationRole_conformsTo.Match)) {
          ActualOrganizationRole_conformsTo.Match other = (ActualOrganizationRole_conformsTo.Match) obj;
    ...
    @Override
    public ActualOrganizationRole_conformsTo specification() {
      return ActualOrganizationRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static ActualOrganizationRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualOrganizationRole_conformsTo.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualOrganizationRole_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualOrganizationRole_conformsTo.Match {
    ...
    private static final class Immutable extends ActualOrganizationRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ActualOrganizationRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ActualOrganizationRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ActualOrganizationRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualOrganizationRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualOrganizationRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ActualOrganizationRole_conformsTo.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualOrganizationRole_conformsTo.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualOrganizationRole_conformsTo.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualOrganizationRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public ActualOrganizationRole_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualOrganizationRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualOrganizationRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualOrganizationRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualOrganizationRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualOrganizationRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ActualOrganizationRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ActualOrganizationRole_conformsTo.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualOrganizationRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ActualOrganizationRole_conformsTo.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualOrganizationRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualOrganizationRole_conformsTo.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualOrganizationRole_conformsTo.Matcher> querySpecification() {
      return ActualOrganizationRole_conformsTo.instance();
    }
  }
  
  private ActualOrganizationRole_conformsTo() {
   ...
   * 
   */
  public static ActualOrganizationRole_conformsTo instance() {
    try{
  ...
  @Override
  protected ActualOrganizationRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualOrganizationRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ActualOrganizationRole_conformsTo.Matcher instantiate() {
    return ActualOrganizationRole_conformsTo.Matcher.create();
  }
  
  @Override
  public ActualOrganizationRole_conformsTo.Match newEmptyMatch() {
    return ActualOrganizationRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ActualOrganizationRole_conformsTo.Match newMatch(final Object... parameters) {
    return ActualOrganizationRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualOrganizationRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualOrganizationRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualOrganizationRole_conformsTo INSTANCE = new ActualOrganizationRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualOrganizationRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
