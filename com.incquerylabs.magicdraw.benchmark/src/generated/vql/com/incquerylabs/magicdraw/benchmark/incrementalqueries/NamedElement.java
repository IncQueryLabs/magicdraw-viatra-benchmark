...
public final class NamedElement extends BaseGeneratedEMFQuerySpecification<NamedElement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.namedElement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.namedElement";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.namedElement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<NamedElement.Match> {
    /**
     ...
     * 
     */
    public Collection<NamedElement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement pElement, final String pName) {
     ...
     * 
     */
    public Stream<NamedElement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement pElement, final String pName) {
     ...
     * 
     */
    public Optional<NamedElement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement pElement, final String pName) {
     ...
     * 
     */
    protected Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement> rawStreamAllValuesOfelement(final Object[] parameters) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement> getAllValuesOfelement() {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement> streamAllValuesOfelement() {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement> streamAllValuesOfelement(final NamedElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement> streamAllValuesOfelement(final String pName) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement> getAllValuesOfelement(final NamedElement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement> getAllValuesOfelement(final String pName) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfname(final NamedElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfname(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement pElement) {
     ...
     * 
     */
    public Set<String> getAllValuesOfname(final NamedElement.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfname(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement pElement) {
     ...
     * 
     */
    public static IQuerySpecification<NamedElement.Matcher> querySpecification() {
      return NamedElement.instance();
    }
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_element, parameter_name);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_element, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "NamedElement", "name")));
