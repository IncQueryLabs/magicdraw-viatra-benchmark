...
public final class ClassifierBehaviorProperty extends BaseGeneratedEMFQuerySpecification<ClassifierBehaviorProperty.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ClassifierBehaviorProperty.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ClassifierBehaviorProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<ClassifierBehaviorProperty.Match> {
     ...
     * 
     */
    public Collection<ClassifierBehaviorProperty.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ClassifierBehaviorProperty.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ClassifierBehaviorProperty.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super ClassifierBehaviorProperty.Match> processor) {
     ...
     * 
     */
    public ClassifierBehaviorProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return ClassifierBehaviorProperty.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ClassifierBehaviorProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ClassifierBehaviorProperty.Match partialMatch) {
    ...
    protected ClassifierBehaviorProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ClassifierBehaviorProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ClassifierBehaviorProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ClassifierBehaviorProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ClassifierBehaviorProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ClassifierBehaviorProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ClassifierBehaviorProperty.Match newMatch(final Object... parameters) {
    return ClassifierBehaviorProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
