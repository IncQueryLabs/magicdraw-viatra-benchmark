...
public final class ConceptRole_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<ConceptRole_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ConceptRole_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ConceptRole_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptRole_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ConceptRole_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptRole_actualMeasurementSet.Match)) {
          ConceptRole_actualMeasurementSet.Match other = (ConceptRole_actualMeasurementSet.Match) obj;
    ...
    @Override
    public ConceptRole_actualMeasurementSet specification() {
      return ConceptRole_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static ConceptRole_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptRole_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConceptRole_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConceptRole_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends ConceptRole_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ConceptRole_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see ConceptRole_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptRole_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static ConceptRole_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptRole_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptRole_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptRole_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConceptRole_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConceptRole_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConceptRole_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public ConceptRole_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ConceptRole_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConceptRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConceptRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConceptRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConceptRole_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected ConceptRole_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptRole_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConceptRole_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptRole_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptRole_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptRole_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptRole_actualMeasurementSet.Matcher> querySpecification() {
      return ConceptRole_actualMeasurementSet.instance();
    }
  }
  
  private ConceptRole_actualMeasurementSet() {
   ...
   * 
   */
  public static ConceptRole_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected ConceptRole_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptRole_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public ConceptRole_actualMeasurementSet.Matcher instantiate() {
    return ConceptRole_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public ConceptRole_actualMeasurementSet.Match newEmptyMatch() {
    return ConceptRole_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptRole_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return ConceptRole_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptRole_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptRole_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptRole_actualMeasurementSet INSTANCE = new ConceptRole_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptRole_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ConceptRole(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ConceptRole.instance().getInternalQueryRepresentation());
