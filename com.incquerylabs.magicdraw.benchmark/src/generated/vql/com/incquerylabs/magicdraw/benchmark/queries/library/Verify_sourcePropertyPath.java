...
public final class Verify_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<Verify_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Verify_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Verify_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Verify_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Verify_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Verify_sourcePropertyPath.Match)) {
          Verify_sourcePropertyPath.Match other = (Verify_sourcePropertyPath.Match) obj;
    ...
    @Override
    public Verify_sourcePropertyPath specification() {
     ...
     * 
     */
    public static Verify_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Verify_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Verify_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Verify_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends Verify_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Verify_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Verify_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Verify_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Verify_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Verify_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Verify_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Verify_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Verify_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Verify_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Verify_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public Verify_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Verify_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Verify_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Verify_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Verify_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Verify_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected Verify_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Verify_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Verify_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Verify_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Verify_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Verify_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Verify_sourcePropertyPath.Matcher> querySpecification() {
      return Verify_sourcePropertyPath.instance();
    }
  }
  
  private Verify_sourcePropertyPath() {
   ...
   * 
   */
  public static Verify_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected Verify_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Verify_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Verify_sourcePropertyPath.Matcher instantiate() {
    return Verify_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public Verify_sourcePropertyPath.Match newEmptyMatch() {
    return Verify_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Verify_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return Verify_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Verify_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Verify_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Verify_sourcePropertyPath INSTANCE = new Verify_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Verify_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
