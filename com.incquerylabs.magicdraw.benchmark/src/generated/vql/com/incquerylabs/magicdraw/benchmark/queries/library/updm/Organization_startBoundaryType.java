...
public final class Organization_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Organization_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Organization_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_startBoundaryType.Match)) {
          Organization_startBoundaryType.Match other = (Organization_startBoundaryType.Match) obj;
    ...
    @Override
    public Organization_startBoundaryType specification() {
      return Organization_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Organization_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_startBoundaryType.Match {
    ...
    private static final class Immutable extends Organization_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Organization_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Organization_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Organization_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Organization_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_startBoundaryType.Matcher> querySpecification() {
      return Organization_startBoundaryType.instance();
    }
  }
  
  private Organization_startBoundaryType() {
   ...
   * 
   */
  public static Organization_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Organization_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Organization_startBoundaryType.Matcher instantiate() {
    return Organization_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Organization_startBoundaryType.Match newEmptyMatch() {
    return Organization_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_startBoundaryType.Match newMatch(final Object... parameters) {
    return Organization_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_startBoundaryType INSTANCE = new Organization_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
