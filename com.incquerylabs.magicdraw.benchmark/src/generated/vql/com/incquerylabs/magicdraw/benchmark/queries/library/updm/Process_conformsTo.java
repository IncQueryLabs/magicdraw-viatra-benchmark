...
public final class Process_conformsTo extends BaseGeneratedEMFQuerySpecification<Process_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Process_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Process_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Process_conformsTo.Match)) {
          Process_conformsTo.Match other = (Process_conformsTo.Match) obj;
    ...
    @Override
    public Process_conformsTo specification() {
      return Process_conformsTo.instance();
    }
     ...
     * 
     */
    public static Process_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Process_conformsTo.Match newMutableMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public static Process_conformsTo.Match newMatch(final Activity pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Process_conformsTo.Match {
    ...
    private static final class Immutable extends Process_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Process_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Process_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Process_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Process_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Process_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Process_conformsTo.Match> getAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Process_conformsTo.Match> streamAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Process_conformsTo.Match> getOneArbitraryMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final Element pValue, final Consumer<? super Process_conformsTo.Match> processor) {
     ...
     * 
     */
    public Process_conformsTo.Match newMatch(final Activity pElement, final Element pValue) {
      return Process_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Process_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Process_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Process_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Process_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Process_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Process_conformsTo.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Process_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Process_conformsTo.Match.newMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Process_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Process_conformsTo.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Process_conformsTo.Matcher> querySpecification() {
      return Process_conformsTo.instance();
    }
  }
  
  private Process_conformsTo() {
   ...
   * 
   */
  public static Process_conformsTo instance() {
    try{
  ...
  @Override
  protected Process_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Process_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Process_conformsTo.Matcher instantiate() {
    return Process_conformsTo.Matcher.create();
  }
  
  @Override
  public Process_conformsTo.Match newEmptyMatch() {
    return Process_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Process_conformsTo.Match newMatch(final Object... parameters) {
    return Process_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Process_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Process_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Process_conformsTo INSTANCE = new Process_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Process_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
