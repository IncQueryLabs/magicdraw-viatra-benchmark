...
public final class InformationElement_isEncapsulated extends BaseGeneratedEMFQuerySpecification<InformationElement_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return InformationElement_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public InformationElement_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InformationElement_isEncapsulated.Match)) {
          InformationElement_isEncapsulated.Match other = (InformationElement_isEncapsulated.Match) obj;
    ...
    @Override
    public InformationElement_isEncapsulated specification() {
      return InformationElement_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static InformationElement_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static InformationElement_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static InformationElement_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends InformationElement_isEncapsulated.Match {
    ...
    private static final class Immutable extends InformationElement_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see InformationElement_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<InformationElement_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static InformationElement_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InformationElement_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InformationElement_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<InformationElement_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<InformationElement_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<InformationElement_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super InformationElement_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public InformationElement_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return InformationElement_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InformationElement_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InformationElement_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final InformationElement_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final InformationElement_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected InformationElement_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return InformationElement_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected InformationElement_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return InformationElement_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InformationElement_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InformationElement_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InformationElement_isEncapsulated.Matcher> querySpecification() {
      return InformationElement_isEncapsulated.instance();
    }
  }
  
  private InformationElement_isEncapsulated() {
   ...
   * 
   */
  public static InformationElement_isEncapsulated instance() {
    try{
  ...
  @Override
  protected InformationElement_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return InformationElement_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public InformationElement_isEncapsulated.Matcher instantiate() {
    return InformationElement_isEncapsulated.Matcher.create();
  }
  
  @Override
  public InformationElement_isEncapsulated.Match newEmptyMatch() {
    return InformationElement_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public InformationElement_isEncapsulated.Match newMatch(final Object... parameters) {
    return InformationElement_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InformationElement_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InformationElement_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InformationElement_isEncapsulated INSTANCE = new InformationElement_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InformationElement_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
