...
public final class CapabilityForTask_targetContext extends BaseGeneratedEMFQuerySpecification<CapabilityForTask_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityForTask_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityForTask_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityForTask_targetContext.Match)) {
          CapabilityForTask_targetContext.Match other = (CapabilityForTask_targetContext.Match) obj;
    ...
    @Override
    public CapabilityForTask_targetContext specification() {
      return CapabilityForTask_targetContext.instance();
    }
     ...
     * 
     */
    public static CapabilityForTask_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityForTask_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static CapabilityForTask_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityForTask_targetContext.Match {
    ...
    private static final class Immutable extends CapabilityForTask_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_targetContext pattern,
   ...
   * 
   * @see Match
   * @see CapabilityForTask_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityForTask_targetContext.Match> {
    /**
     ...
     * 
     */
    public static CapabilityForTask_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityForTask_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityForTask_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityForTask_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<CapabilityForTask_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<CapabilityForTask_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super CapabilityForTask_targetContext.Match> processor) {
     ...
     * 
     */
    public CapabilityForTask_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return CapabilityForTask_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CapabilityForTask_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CapabilityForTask_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final CapabilityForTask_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final CapabilityForTask_targetContext.Match partialMatch) {
    ...
    @Override
    protected CapabilityForTask_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityForTask_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityForTask_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityForTask_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityForTask_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityForTask_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityForTask_targetContext.Matcher> querySpecification() {
      return CapabilityForTask_targetContext.instance();
    }
  }
  
  private CapabilityForTask_targetContext() {
   ...
   * 
   */
  public static CapabilityForTask_targetContext instance() {
    try{
  ...
  @Override
  protected CapabilityForTask_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityForTask_targetContext.Matcher.on(engine);
  }
  
  @Override
  public CapabilityForTask_targetContext.Matcher instantiate() {
    return CapabilityForTask_targetContext.Matcher.create();
  }
  
  @Override
  public CapabilityForTask_targetContext.Match newEmptyMatch() {
    return CapabilityForTask_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityForTask_targetContext.Match newMatch(final Object... parameters) {
    return CapabilityForTask_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityForTask_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityForTask_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityForTask_targetContext INSTANCE = new CapabilityForTask_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityForTask_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
