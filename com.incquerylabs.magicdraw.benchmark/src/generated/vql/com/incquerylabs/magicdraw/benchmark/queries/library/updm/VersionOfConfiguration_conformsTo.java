...
public final class VersionOfConfiguration_conformsTo extends BaseGeneratedEMFQuerySpecification<VersionOfConfiguration_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionOfConfiguration_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public VersionOfConfiguration_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionOfConfiguration_conformsTo.Match)) {
          VersionOfConfiguration_conformsTo.Match other = (VersionOfConfiguration_conformsTo.Match) obj;
    ...
    @Override
    public VersionOfConfiguration_conformsTo specification() {
      return VersionOfConfiguration_conformsTo.instance();
    }
     ...
     * 
     */
    public static VersionOfConfiguration_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionOfConfiguration_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static VersionOfConfiguration_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends VersionOfConfiguration_conformsTo.Match {
    ...
    private static final class Immutable extends VersionOfConfiguration_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see VersionOfConfiguration_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<VersionOfConfiguration_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static VersionOfConfiguration_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionOfConfiguration_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionOfConfiguration_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<VersionOfConfiguration_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<VersionOfConfiguration_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<VersionOfConfiguration_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super VersionOfConfiguration_conformsTo.Match> processor) {
     ...
     * 
     */
    public VersionOfConfiguration_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return VersionOfConfiguration_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final VersionOfConfiguration_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final VersionOfConfiguration_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final VersionOfConfiguration_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final VersionOfConfiguration_conformsTo.Match partialMatch) {
    ...
    @Override
    protected VersionOfConfiguration_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return VersionOfConfiguration_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected VersionOfConfiguration_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return VersionOfConfiguration_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionOfConfiguration_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionOfConfiguration_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionOfConfiguration_conformsTo.Matcher> querySpecification() {
      return VersionOfConfiguration_conformsTo.instance();
    }
  }
  
  private VersionOfConfiguration_conformsTo() {
   ...
   * 
   */
  public static VersionOfConfiguration_conformsTo instance() {
    try{
  ...
  @Override
  protected VersionOfConfiguration_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionOfConfiguration_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public VersionOfConfiguration_conformsTo.Matcher instantiate() {
    return VersionOfConfiguration_conformsTo.Matcher.create();
  }
  
  @Override
  public VersionOfConfiguration_conformsTo.Match newEmptyMatch() {
    return VersionOfConfiguration_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public VersionOfConfiguration_conformsTo.Match newMatch(final Object... parameters) {
    return VersionOfConfiguration_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionOfConfiguration_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionOfConfiguration_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionOfConfiguration_conformsTo INSTANCE = new VersionOfConfiguration_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionOfConfiguration_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
