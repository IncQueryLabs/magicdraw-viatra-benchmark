...
public final class EnterpriseGoal_endBoundaryType extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_endBoundaryType.Match)) {
          EnterpriseGoal_endBoundaryType.Match other = (EnterpriseGoal_endBoundaryType.Match) obj;
    ...
    @Override
    public EnterpriseGoal_endBoundaryType specification() {
      return EnterpriseGoal_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_endBoundaryType.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseGoal_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseGoal_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseGoal_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseGoal_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_endBoundaryType.Matcher> querySpecification() {
      return EnterpriseGoal_endBoundaryType.instance();
    }
  }
  
  private EnterpriseGoal_endBoundaryType() {
   ...
   * 
   */
  public static EnterpriseGoal_endBoundaryType instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_endBoundaryType.Matcher instantiate() {
    return EnterpriseGoal_endBoundaryType.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_endBoundaryType.Match newEmptyMatch() {
    return EnterpriseGoal_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_endBoundaryType.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_endBoundaryType INSTANCE = new EnterpriseGoal_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
