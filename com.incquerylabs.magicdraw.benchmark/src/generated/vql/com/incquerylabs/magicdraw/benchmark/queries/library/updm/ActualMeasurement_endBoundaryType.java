...
public final class ActualMeasurement_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ActualMeasurement_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualMeasurement_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ActualMeasurement_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualMeasurement_endBoundaryType.Match)) {
          ActualMeasurement_endBoundaryType.Match other = (ActualMeasurement_endBoundaryType.Match) obj;
    ...
    @Override
    public ActualMeasurement_endBoundaryType specification() {
      return ActualMeasurement_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ActualMeasurement_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualMeasurement_endBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualMeasurement_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualMeasurement_endBoundaryType.Match {
    ...
    private static final class Immutable extends ActualMeasurement_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ActualMeasurement_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ActualMeasurement_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ActualMeasurement_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualMeasurement_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualMeasurement_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ActualMeasurement_endBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualMeasurement_endBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualMeasurement_endBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualMeasurement_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ActualMeasurement_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualMeasurement_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualMeasurement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualMeasurement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualMeasurement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualMeasurement_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ActualMeasurement_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ActualMeasurement_endBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualMeasurement_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ActualMeasurement_endBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualMeasurement_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualMeasurement_endBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualMeasurement_endBoundaryType.Matcher> querySpecification() {
      return ActualMeasurement_endBoundaryType.instance();
    }
  }
  
  private ActualMeasurement_endBoundaryType() {
   ...
   * 
   */
  public static ActualMeasurement_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ActualMeasurement_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualMeasurement_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ActualMeasurement_endBoundaryType.Matcher instantiate() {
    return ActualMeasurement_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ActualMeasurement_endBoundaryType.Match newEmptyMatch() {
    return ActualMeasurement_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ActualMeasurement_endBoundaryType.Match newMatch(final Object... parameters) {
    return ActualMeasurement_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualMeasurement_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualMeasurement_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualMeasurement_endBoundaryType INSTANCE = new ActualMeasurement_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualMeasurement_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
