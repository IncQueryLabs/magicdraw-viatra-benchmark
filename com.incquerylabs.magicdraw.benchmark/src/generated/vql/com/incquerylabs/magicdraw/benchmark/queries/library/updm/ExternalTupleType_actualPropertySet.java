...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType;
...
public final class ExternalTupleType_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ExternalTupleType_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTupleType_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTupleType_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTupleType_actualPropertySet.Match)) {
          ExternalTupleType_actualPropertySet.Match other = (ExternalTupleType_actualPropertySet.Match) obj;
    ...
    @Override
    public ExternalTupleType_actualPropertySet specification() {
      return ExternalTupleType_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ExternalTupleType_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTupleType_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTupleType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTupleType_actualPropertySet.Match {
    ...
    private static final class Immutable extends ExternalTupleType_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ExternalTupleType_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTupleType_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ExternalTupleType_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTupleType_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTupleType_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTupleType_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTupleType_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTupleType_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTupleType_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ExternalTupleType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTupleType_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTupleType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTupleType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTupleType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTupleType_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ExternalTupleType_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTupleType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTupleType_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTupleType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTupleType_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTupleType_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTupleType_actualPropertySet.Matcher> querySpecification() {
      return ExternalTupleType_actualPropertySet.instance();
    }
  }
  
  private ExternalTupleType_actualPropertySet() {
   ...
   * 
   */
  public static ExternalTupleType_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ExternalTupleType_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTupleType_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ExternalTupleType_actualPropertySet.Matcher instantiate() {
    return ExternalTupleType_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ExternalTupleType_actualPropertySet.Match newEmptyMatch() {
    return ExternalTupleType_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTupleType_actualPropertySet.Match newMatch(final Object... parameters) {
    return ExternalTupleType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTupleType_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTupleType_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTupleType_actualPropertySet INSTANCE = new ExternalTupleType_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTupleType_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ExternalTupleType(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ExternalTupleType.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
