...
public final class Performer_conformsTo extends BaseGeneratedEMFQuerySpecification<Performer_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Performer_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_conformsTo.Match)) {
          Performer_conformsTo.Match other = (Performer_conformsTo.Match) obj;
    ...
    @Override
    public Performer_conformsTo specification() {
      return Performer_conformsTo.instance();
    }
     ...
     * 
     */
    public static Performer_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_conformsTo.Match {
    ...
    private static final class Immutable extends Performer_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Performer_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Performer_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_conformsTo.Match> processor) {
     ...
     * 
     */
    public Performer_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Performer_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_conformsTo.Matcher> querySpecification() {
      return Performer_conformsTo.instance();
    }
  }
  
  private Performer_conformsTo() {
   ...
   * 
   */
  public static Performer_conformsTo instance() {
    try{
  ...
  @Override
  protected Performer_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Performer_conformsTo.Matcher instantiate() {
    return Performer_conformsTo.Matcher.create();
  }
  
  @Override
  public Performer_conformsTo.Match newEmptyMatch() {
    return Performer_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_conformsTo.Match newMatch(final Object... parameters) {
    return Performer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_conformsTo INSTANCE = new Performer_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
