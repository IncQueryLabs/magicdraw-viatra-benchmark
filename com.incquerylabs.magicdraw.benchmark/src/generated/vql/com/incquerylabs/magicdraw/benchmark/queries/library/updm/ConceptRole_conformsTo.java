...
public final class ConceptRole_conformsTo extends BaseGeneratedEMFQuerySpecification<ConceptRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ConceptRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptRole_conformsTo.Match)) {
          ConceptRole_conformsTo.Match other = (ConceptRole_conformsTo.Match) obj;
    ...
    @Override
    public ConceptRole_conformsTo specification() {
      return ConceptRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static ConceptRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptRole_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConceptRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConceptRole_conformsTo.Match {
    ...
    private static final class Immutable extends ConceptRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ConceptRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ConceptRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptRole_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConceptRole_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConceptRole_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConceptRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public ConceptRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ConceptRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConceptRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConceptRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConceptRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConceptRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ConceptRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptRole_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConceptRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptRole_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptRole_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptRole_conformsTo.Matcher> querySpecification() {
      return ConceptRole_conformsTo.instance();
    }
  }
  
  private ConceptRole_conformsTo() {
   ...
   * 
   */
  public static ConceptRole_conformsTo instance() {
    try{
  ...
  @Override
  protected ConceptRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ConceptRole_conformsTo.Matcher instantiate() {
    return ConceptRole_conformsTo.Matcher.create();
  }
  
  @Override
  public ConceptRole_conformsTo.Match newEmptyMatch() {
    return ConceptRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptRole_conformsTo.Match newMatch(final Object... parameters) {
    return ConceptRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptRole_conformsTo INSTANCE = new ConceptRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
