...
public final class DataElement_isEncapsulated extends BaseGeneratedEMFQuerySpecification<DataElement_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return DataElement_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public DataElement_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DataElement_isEncapsulated.Match)) {
          DataElement_isEncapsulated.Match other = (DataElement_isEncapsulated.Match) obj;
    ...
    @Override
    public DataElement_isEncapsulated specification() {
      return DataElement_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static DataElement_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static DataElement_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static DataElement_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends DataElement_isEncapsulated.Match {
    ...
    private static final class Immutable extends DataElement_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see DataElement_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<DataElement_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static DataElement_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DataElement_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DataElement_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<DataElement_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<DataElement_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<DataElement_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super DataElement_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public DataElement_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return DataElement_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DataElement_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DataElement_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final DataElement_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final DataElement_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected DataElement_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return DataElement_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected DataElement_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return DataElement_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DataElement_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DataElement_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DataElement_isEncapsulated.Matcher> querySpecification() {
      return DataElement_isEncapsulated.instance();
    }
  }
  
  private DataElement_isEncapsulated() {
   ...
   * 
   */
  public static DataElement_isEncapsulated instance() {
    try{
  ...
  @Override
  protected DataElement_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return DataElement_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public DataElement_isEncapsulated.Matcher instantiate() {
    return DataElement_isEncapsulated.Matcher.create();
  }
  
  @Override
  public DataElement_isEncapsulated.Match newEmptyMatch() {
    return DataElement_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public DataElement_isEncapsulated.Match newMatch(final Object... parameters) {
    return DataElement_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataElement_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataElement_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DataElement_isEncapsulated INSTANCE = new DataElement_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DataElement_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
