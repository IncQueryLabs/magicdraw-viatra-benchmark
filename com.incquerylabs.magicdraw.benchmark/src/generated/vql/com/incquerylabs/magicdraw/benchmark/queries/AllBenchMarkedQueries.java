...
public final class AllBenchMarkedQueries extends BaseGeneratedEMFQuerySpecification<AllBenchMarkedQueries.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.AllBenchMarkedQueries (visibility: PUBLIC, simpleName: AllBenchMarkedQueries, identifier: com.incquerylabs.magicdraw.benchmark.queries.AllBenchMarkedQueries, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
