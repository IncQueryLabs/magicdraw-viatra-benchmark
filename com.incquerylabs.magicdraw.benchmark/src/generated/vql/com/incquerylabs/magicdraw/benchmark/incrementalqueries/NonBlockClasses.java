...
public final class NonBlockClasses extends BaseGeneratedEMFQuerySpecification<NonBlockClasses.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.nonBlockClasses pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.nonBlockClasses";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.nonBlockClasses pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<NonBlockClasses.Match> {
    /**
     ...
     * 
     */
    public Collection<NonBlockClasses.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public Stream<NonBlockClasses.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public Optional<NonBlockClasses.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public static IQuerySpecification<NonBlockClasses.Matcher> querySpecification() {
      return NonBlockClasses.instance();
    }
  }
