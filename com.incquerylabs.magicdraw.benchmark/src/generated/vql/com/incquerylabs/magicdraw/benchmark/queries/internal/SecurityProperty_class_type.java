...
public final class SecurityProperty_class_type extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private SecurityProperty_class_type() {
   ...
   * 
   */
  public static SecurityProperty_class_type instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link SecurityProperty_class_type} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityProperty_class_type#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityProperty_class_type INSTANCE = new SecurityProperty_class_type();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityProperty_class_type.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    private final PParameter parameter_poperty = new PParameter("poperty", "com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.nomagic.com/magicdraw/UML/2.5.1", "Property")), PParameterDirection.INOUT);
    ...
    private final List<PParameter> parameters = Arrays.asList(parameter_poperty, parameter_class, parameter_type);
    ...
    public String getFullyQualifiedName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.SecurityProperty_class_type";
    }
    
    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("poperty","class","type");
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          PVariable var_poperty = body.getOrCreateVariableByName("poperty");
          PVariable var_class = body.getOrCreateVariableByName("class");
          PVariable var_type = body.getOrCreateVariableByName("type");
          PVariable var_element = body.getOrCreateVariableByName("element");
          PVariable var___0_ = body.getOrCreateVariableByName("_<0>");
          PVariable var_property = body.getOrCreateVariableByName("property");
          new TypeConstraint(body, Tuples.flatTupleOf(var_poperty), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "Property")));
          ...
          body.setSymbolicParameters(Arrays.<ExportedParameter>asList(
             new ExportedParameter(body, var_poperty, parameter_poperty),
          ...
          new Equality(body, var__virtual_0_, var_poperty);
          //     Property.type(property, type)
