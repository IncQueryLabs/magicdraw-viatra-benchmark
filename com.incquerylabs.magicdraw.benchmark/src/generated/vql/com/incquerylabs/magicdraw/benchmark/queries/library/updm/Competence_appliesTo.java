...
public final class Competence_appliesTo extends BaseGeneratedEMFQuerySpecification<Competence_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Competence_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Competence_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Competence_appliesTo.Match)) {
          Competence_appliesTo.Match other = (Competence_appliesTo.Match) obj;
    ...
    @Override
    public Competence_appliesTo specification() {
      return Competence_appliesTo.instance();
    }
     ...
     * 
     */
    public static Competence_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Competence_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Competence_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Competence_appliesTo.Match {
    ...
    private static final class Immutable extends Competence_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Competence_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Competence_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Competence_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Competence_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Competence_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Competence_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Competence_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Competence_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Competence_appliesTo.Match> processor) {
     ...
     * 
     */
    public Competence_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Competence_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Competence_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Competence_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Competence_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Competence_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Competence_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Competence_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Competence_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Competence_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Competence_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Competence_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Competence_appliesTo.Matcher> querySpecification() {
      return Competence_appliesTo.instance();
    }
  }
  
  private Competence_appliesTo() {
   ...
   * 
   */
  public static Competence_appliesTo instance() {
    try{
  ...
  @Override
  protected Competence_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Competence_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Competence_appliesTo.Matcher instantiate() {
    return Competence_appliesTo.Matcher.create();
  }
  
  @Override
  public Competence_appliesTo.Match newEmptyMatch() {
    return Competence_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Competence_appliesTo.Match newMatch(final Object... parameters) {
    return Competence_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Competence_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Competence_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Competence_appliesTo INSTANCE = new Competence_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Competence_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
