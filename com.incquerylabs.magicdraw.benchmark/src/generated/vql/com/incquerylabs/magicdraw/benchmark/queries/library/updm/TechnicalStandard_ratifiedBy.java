...
public final class TechnicalStandard_ratifiedBy extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_ratifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_ratifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_ratifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_ratifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_ratifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_ratifiedBy.Match)) {
          TechnicalStandard_ratifiedBy.Match other = (TechnicalStandard_ratifiedBy.Match) obj;
    ...
    @Override
    public TechnicalStandard_ratifiedBy specification() {
      return TechnicalStandard_ratifiedBy.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_ratifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_ratifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static TechnicalStandard_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TechnicalStandard_ratifiedBy.Match {
    ...
    private static final class Immutable extends TechnicalStandard_ratifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_ratifiedBy pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_ratifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_ratifiedBy.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_ratifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_ratifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_ratifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_ratifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TechnicalStandard_ratifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TechnicalStandard_ratifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super TechnicalStandard_ratifiedBy.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return TechnicalStandard_ratifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TechnicalStandard_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TechnicalStandard_ratifiedBy.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_ratifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TechnicalStandard_ratifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_ratifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_ratifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_ratifiedBy.Matcher> querySpecification() {
      return TechnicalStandard_ratifiedBy.instance();
    }
  }
  
  private TechnicalStandard_ratifiedBy() {
   ...
   * 
   */
  public static TechnicalStandard_ratifiedBy instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_ratifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_ratifiedBy.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_ratifiedBy.Matcher instantiate() {
    return TechnicalStandard_ratifiedBy.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_ratifiedBy.Match newEmptyMatch() {
    return TechnicalStandard_ratifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_ratifiedBy.Match newMatch(final Object... parameters) {
    return TechnicalStandard_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_ratifiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_ratifiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_ratifiedBy INSTANCE = new TechnicalStandard_ratifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_ratifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
