...
public final class System_appliesTo extends BaseGeneratedEMFQuerySpecification<System_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public System_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_appliesTo.Match)) {
          System_appliesTo.Match other = (System_appliesTo.Match) obj;
    ...
    @Override
    public System_appliesTo specification() {
      return System_appliesTo.instance();
    }
     ...
     * 
     */
    public static System_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_appliesTo.Match {
    ...
    private static final class Immutable extends System_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see System_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<System_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static System_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<System_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_appliesTo.Match> processor) {
     ...
     * 
     */
    public System_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_appliesTo.Match partialMatch) {
    ...
    @Override
    protected System_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return System_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return System_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_appliesTo.Matcher> querySpecification() {
      return System_appliesTo.instance();
    }
  }
  
  private System_appliesTo() {
   ...
   * 
   */
  public static System_appliesTo instance() {
    try{
  ...
  @Override
  protected System_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public System_appliesTo.Matcher instantiate() {
    return System_appliesTo.Matcher.create();
  }
  
  @Override
  public System_appliesTo.Match newEmptyMatch() {
    return System_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public System_appliesTo.Match newMatch(final Object... parameters) {
    return System_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_appliesTo INSTANCE = new System_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
