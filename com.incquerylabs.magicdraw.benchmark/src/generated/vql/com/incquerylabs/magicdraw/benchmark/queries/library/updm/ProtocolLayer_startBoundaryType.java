...
public final class ProtocolLayer_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ProtocolLayer_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolLayer_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolLayer_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolLayer_startBoundaryType.Match)) {
          ProtocolLayer_startBoundaryType.Match other = (ProtocolLayer_startBoundaryType.Match) obj;
    ...
    @Override
    public ProtocolLayer_startBoundaryType specification() {
      return ProtocolLayer_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProtocolLayer_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolLayer_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolLayer_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolLayer_startBoundaryType.Match {
    ...
    private static final class Immutable extends ProtocolLayer_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProtocolLayer_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolLayer_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProtocolLayer_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolLayer_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolLayer_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolLayer_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolLayer_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolLayer_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProtocolLayer_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProtocolLayer_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ProtocolLayer_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProtocolLayer_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProtocolLayer_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolLayer_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolLayer_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProtocolLayer_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolLayer_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolLayer_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolLayer_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolLayer_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolLayer_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolLayer_startBoundaryType.Matcher> querySpecification() {
      return ProtocolLayer_startBoundaryType.instance();
    }
  }
  
  private ProtocolLayer_startBoundaryType() {
   ...
   * 
   */
  public static ProtocolLayer_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ProtocolLayer_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolLayer_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProtocolLayer_startBoundaryType.Matcher instantiate() {
    return ProtocolLayer_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ProtocolLayer_startBoundaryType.Match newEmptyMatch() {
    return ProtocolLayer_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolLayer_startBoundaryType.Match newMatch(final Object... parameters) {
    return ProtocolLayer_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolLayer_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolLayer_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolLayer_startBoundaryType INSTANCE = new ProtocolLayer_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolLayer_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
