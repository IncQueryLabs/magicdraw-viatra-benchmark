...
public final class PhysicalArchitecture_startBoundaryType extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_startBoundaryType.Match)) {
          PhysicalArchitecture_startBoundaryType.Match other = (PhysicalArchitecture_startBoundaryType.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_startBoundaryType specification() {
      return PhysicalArchitecture_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_startBoundaryType.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_startBoundaryType.Matcher> querySpecification() {
      return PhysicalArchitecture_startBoundaryType.instance();
    }
  }
  
  private PhysicalArchitecture_startBoundaryType() {
   ...
   * 
   */
  public static PhysicalArchitecture_startBoundaryType instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_startBoundaryType.Matcher instantiate() {
    return PhysicalArchitecture_startBoundaryType.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_startBoundaryType.Match newEmptyMatch() {
    return PhysicalArchitecture_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_startBoundaryType.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_startBoundaryType INSTANCE = new PhysicalArchitecture_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
