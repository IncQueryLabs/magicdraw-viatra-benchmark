...
public final class RoleType_actualPropertySet extends BaseGeneratedEMFQuerySpecification<RoleType_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_actualPropertySet.Match)) {
          RoleType_actualPropertySet.Match other = (RoleType_actualPropertySet.Match) obj;
    ...
    @Override
    public RoleType_actualPropertySet specification() {
      return RoleType_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static RoleType_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_actualPropertySet.Match {
    ...
    private static final class Immutable extends RoleType_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see RoleType_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static RoleType_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public RoleType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected RoleType_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_actualPropertySet.Matcher> querySpecification() {
      return RoleType_actualPropertySet.instance();
    }
  }
  
  private RoleType_actualPropertySet() {
   ...
   * 
   */
  public static RoleType_actualPropertySet instance() {
    try{
  ...
  @Override
  protected RoleType_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public RoleType_actualPropertySet.Matcher instantiate() {
    return RoleType_actualPropertySet.Matcher.create();
  }
  
  @Override
  public RoleType_actualPropertySet.Match newEmptyMatch() {
    return RoleType_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_actualPropertySet.Match newMatch(final Object... parameters) {
    return RoleType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_actualPropertySet INSTANCE = new RoleType_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
