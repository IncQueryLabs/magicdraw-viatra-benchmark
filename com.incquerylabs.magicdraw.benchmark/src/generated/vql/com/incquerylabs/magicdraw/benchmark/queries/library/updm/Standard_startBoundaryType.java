...
public final class Standard_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Standard_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Standard_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_startBoundaryType.Match)) {
          Standard_startBoundaryType.Match other = (Standard_startBoundaryType.Match) obj;
    ...
    @Override
    public Standard_startBoundaryType specification() {
      return Standard_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Standard_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Standard_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Standard_startBoundaryType.Match {
    ...
    private static final class Immutable extends Standard_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Standard_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Standard_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Standard_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Standard_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Standard_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Standard_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Standard_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Standard_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Standard_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Standard_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Standard_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_startBoundaryType.Matcher> querySpecification() {
      return Standard_startBoundaryType.instance();
    }
  }
  
  private Standard_startBoundaryType() {
   ...
   * 
   */
  public static Standard_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Standard_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Standard_startBoundaryType.Matcher instantiate() {
    return Standard_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Standard_startBoundaryType.Match newEmptyMatch() {
    return Standard_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_startBoundaryType.Match newMatch(final Object... parameters) {
    return Standard_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_startBoundaryType INSTANCE = new Standard_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
