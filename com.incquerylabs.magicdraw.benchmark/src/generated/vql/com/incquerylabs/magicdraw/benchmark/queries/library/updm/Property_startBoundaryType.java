...
public final class Property_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Property_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Property_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Property_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Property_startBoundaryType.Match)) {
          Property_startBoundaryType.Match other = (Property_startBoundaryType.Match) obj;
    ...
    @Override
    public Property_startBoundaryType specification() {
      return Property_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Property_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Property_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static Property_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Property_startBoundaryType.Match {
    ...
    private static final class Immutable extends Property_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Property_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Property_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Property_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Property_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Property_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Property_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Property_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Property_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super Property_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Property_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return Property_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Property_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Property_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Property_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Property_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Property_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Property_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Property_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Property_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Property_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Property_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Property_startBoundaryType.Matcher> querySpecification() {
      return Property_startBoundaryType.instance();
    }
  }
  
  private Property_startBoundaryType() {
   ...
   * 
   */
  public static Property_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Property_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Property_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Property_startBoundaryType.Matcher instantiate() {
    return Property_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Property_startBoundaryType.Match newEmptyMatch() {
    return Property_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Property_startBoundaryType.Match newMatch(final Object... parameters) {
    return Property_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Property_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Property_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Property_startBoundaryType INSTANCE = new Property_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Property_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
