...
public final class ResourceArchitecture_URI extends BaseGeneratedEMFQuerySpecification<ResourceArchitecture_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArchitecture_URI.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArchitecture_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArchitecture_URI.Match)) {
          ResourceArchitecture_URI.Match other = (ResourceArchitecture_URI.Match) obj;
    ...
    @Override
    public ResourceArchitecture_URI specification() {
      return ResourceArchitecture_URI.instance();
    }
     ...
     * 
     */
    public static ResourceArchitecture_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArchitecture_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ResourceArchitecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourceArchitecture_URI.Match {
    ...
    private static final class Immutable extends ResourceArchitecture_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_URI pattern,
   ...
   * 
   * @see Match
   * @see ResourceArchitecture_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArchitecture_URI.Match> {
    /**
     ...
     * 
     */
    public static ResourceArchitecture_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArchitecture_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArchitecture_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArchitecture_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ResourceArchitecture_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ResourceArchitecture_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ResourceArchitecture_URI.Match> processor) {
     ...
     * 
     */
    public ResourceArchitecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ResourceArchitecture_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ResourceArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ResourceArchitecture_URI.Match partialMatch) {
    ...
    @Override
    protected ResourceArchitecture_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourceArchitecture_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArchitecture_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArchitecture_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArchitecture_URI.Matcher> querySpecification() {
      return ResourceArchitecture_URI.instance();
    }
  }
  
  private ResourceArchitecture_URI() {
   ...
   * 
   */
  public static ResourceArchitecture_URI instance() {
    try{
  ...
  @Override
  protected ResourceArchitecture_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArchitecture_URI.Matcher.on(engine);
  }
  
  @Override
  public ResourceArchitecture_URI.Matcher instantiate() {
    return ResourceArchitecture_URI.Matcher.create();
  }
  
  @Override
  public ResourceArchitecture_URI.Match newEmptyMatch() {
    return ResourceArchitecture_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArchitecture_URI.Match newMatch(final Object... parameters) {
    return ResourceArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArchitecture_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArchitecture_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArchitecture_URI INSTANCE = new ResourceArchitecture_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArchitecture_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
