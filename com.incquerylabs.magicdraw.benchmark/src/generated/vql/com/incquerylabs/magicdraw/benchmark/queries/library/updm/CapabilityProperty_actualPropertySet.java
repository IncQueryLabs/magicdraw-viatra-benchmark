...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty;
...
public final class CapabilityProperty_actualPropertySet extends BaseGeneratedEMFQuerySpecification<CapabilityProperty_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty_actualPropertySet.Match)) {
          CapabilityProperty_actualPropertySet.Match other = (CapabilityProperty_actualPropertySet.Match) obj;
    ...
    @Override
    public CapabilityProperty_actualPropertySet specification() {
      return CapabilityProperty_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityProperty_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityProperty_actualPropertySet.Match {
    ...
    private static final class Immutable extends CapabilityProperty_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityProperty_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityProperty_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super CapabilityProperty_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return CapabilityProperty_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityProperty_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityProperty_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityProperty_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty_actualPropertySet.Matcher> querySpecification() {
      return CapabilityProperty_actualPropertySet.instance();
    }
  }
  
  private CapabilityProperty_actualPropertySet() {
   ...
   * 
   */
  public static CapabilityProperty_actualPropertySet instance() {
    try{
  ...
  @Override
  protected CapabilityProperty_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty_actualPropertySet.Matcher instantiate() {
    return CapabilityProperty_actualPropertySet.Matcher.create();
  }
  
  @Override
  public CapabilityProperty_actualPropertySet.Match newEmptyMatch() {
    return CapabilityProperty_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty_actualPropertySet.Match newMatch(final Object... parameters) {
    return CapabilityProperty_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty_actualPropertySet INSTANCE = new CapabilityProperty_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
