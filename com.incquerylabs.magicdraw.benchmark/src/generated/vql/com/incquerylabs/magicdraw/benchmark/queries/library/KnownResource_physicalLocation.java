...
public final class KnownResource_physicalLocation extends BaseGeneratedEMFQuerySpecification<KnownResource_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_physicalLocation.Match)) {
          KnownResource_physicalLocation.Match other = (KnownResource_physicalLocation.Match) obj;
    ...
    @Override
    public KnownResource_physicalLocation specification() {
      return KnownResource_physicalLocation.instance();
    }
     ...
     * 
     */
    public static KnownResource_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_physicalLocation.Match {
    ...
    private static final class Immutable extends KnownResource_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super KnownResource_physicalLocation.Match> processor) {
     ...
     * 
     */
    public KnownResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return KnownResource_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final KnownResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final KnownResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected KnownResource_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_physicalLocation.Matcher> querySpecification() {
      return KnownResource_physicalLocation.instance();
    }
  }
  
  private KnownResource_physicalLocation() {
   ...
   * 
   */
  public static KnownResource_physicalLocation instance() {
    try{
  ...
  @Override
  protected KnownResource_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_physicalLocation.Matcher instantiate() {
    return KnownResource_physicalLocation.Matcher.create();
  }
  
  @Override
  public KnownResource_physicalLocation.Match newEmptyMatch() {
    return KnownResource_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_physicalLocation.Match newMatch(final Object... parameters) {
    return KnownResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_physicalLocation INSTANCE = new KnownResource_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
