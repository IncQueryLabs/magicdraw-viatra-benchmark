...
public final class EnterpriseVision extends BaseGeneratedEMFQuerySpecification<EnterpriseVision.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseVision pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseVision";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseVision.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseVision.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseVision.Match)) {
          EnterpriseVision.Match other = (EnterpriseVision.Match) obj;
    ...
    @Override
    public EnterpriseVision specification() {
      return EnterpriseVision.instance();
    }
     ...
     * 
     */
    public static EnterpriseVision.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseVision.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static EnterpriseVision.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends EnterpriseVision.Match {
    ...
    private static final class Immutable extends EnterpriseVision.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseVision pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseVision
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseVision.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseVision.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseVision.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseVision.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseVision.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<EnterpriseVision.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<EnterpriseVision.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super EnterpriseVision.Match> processor) {
     ...
     * 
     */
    public EnterpriseVision.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return EnterpriseVision.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseVision.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseVision.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final EnterpriseVision.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final EnterpriseVision.Match partialMatch) {
    ...
    @Override
    protected EnterpriseVision.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseVision.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected EnterpriseVision.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseVision.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseVision.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseVision.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseVision.Matcher> querySpecification() {
      return EnterpriseVision.instance();
    }
  }
  
  private EnterpriseVision() {
   ...
   * 
   */
  public static EnterpriseVision instance() {
    try{
  ...
  @Override
  protected EnterpriseVision.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseVision.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseVision.Matcher instantiate() {
    return EnterpriseVision.Matcher.create();
  }
  
  @Override
  public EnterpriseVision.Match newEmptyMatch() {
    return EnterpriseVision.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseVision.Match newMatch(final Object... parameters) {
    return EnterpriseVision.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseVision} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseVision#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseVision INSTANCE = new EnterpriseVision();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseVision.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "EnterpriseVision")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "EnterpriseVision");
