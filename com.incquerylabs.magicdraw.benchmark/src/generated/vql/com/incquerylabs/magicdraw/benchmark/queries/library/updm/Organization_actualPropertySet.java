...
public final class Organization_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Organization_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Organization_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_actualPropertySet.Match)) {
          Organization_actualPropertySet.Match other = (Organization_actualPropertySet.Match) obj;
    ...
    @Override
    public Organization_actualPropertySet specification() {
      return Organization_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Organization_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_actualPropertySet.Match {
    ...
    private static final class Immutable extends Organization_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Organization_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Organization_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Organization_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Organization_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_actualPropertySet.Matcher> querySpecification() {
      return Organization_actualPropertySet.instance();
    }
  }
  
  private Organization_actualPropertySet() {
   ...
   * 
   */
  public static Organization_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Organization_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Organization_actualPropertySet.Matcher instantiate() {
    return Organization_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Organization_actualPropertySet.Match newEmptyMatch() {
    return Organization_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_actualPropertySet.Match newMatch(final Object... parameters) {
    return Organization_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_actualPropertySet INSTANCE = new Organization_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
