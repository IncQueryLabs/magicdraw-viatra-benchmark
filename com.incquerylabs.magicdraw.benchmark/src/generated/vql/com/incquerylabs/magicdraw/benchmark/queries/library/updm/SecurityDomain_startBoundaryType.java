...
public final class SecurityDomain_startBoundaryType extends BaseGeneratedEMFQuerySpecification<SecurityDomain_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_startBoundaryType.Match)) {
          SecurityDomain_startBoundaryType.Match other = (SecurityDomain_startBoundaryType.Match) obj;
    ...
    @Override
    public SecurityDomain_startBoundaryType specification() {
      return SecurityDomain_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityDomain_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_startBoundaryType.Match {
    ...
    private static final class Immutable extends SecurityDomain_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityDomain_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityDomain_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityDomain_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityDomain_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_startBoundaryType.Matcher> querySpecification() {
      return SecurityDomain_startBoundaryType.instance();
    }
  }
  
  private SecurityDomain_startBoundaryType() {
   ...
   * 
   */
  public static SecurityDomain_startBoundaryType instance() {
    try{
  ...
  @Override
  protected SecurityDomain_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_startBoundaryType.Matcher instantiate() {
    return SecurityDomain_startBoundaryType.Matcher.create();
  }
  
  @Override
  public SecurityDomain_startBoundaryType.Match newEmptyMatch() {
    return SecurityDomain_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_startBoundaryType.Match newMatch(final Object... parameters) {
    return SecurityDomain_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_startBoundaryType INSTANCE = new SecurityDomain_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
