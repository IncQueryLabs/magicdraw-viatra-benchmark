...
public final class View extends BaseGeneratedEMFQuerySpecification<View.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.View pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.View";
    }
    
    @Override
    public List<String> parameterNames() {
      return View.Match.parameterNames;
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof View.Match)) {
          View.Match other = (View.Match) obj;
     ...
     * 
     */
    public static View.Match newEmptyMatch() {
     ...
     * 
     */
    public static View.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static View.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.View pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<View.Match> {
    /**
     ...
     * 
     */
    public static View.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static View.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(View.Matcher.class);
     ...
     * 
     */
    public Collection<View.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<View.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<View.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super View.Match> processor) {
     ...
     * 
     */
    public View.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package> streamAllValuesOfelement(final View.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package> getAllValuesOfelement(final View.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final View.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final View.Match partialMatch) {
    ...
    protected View.Match tupleToMatch(final Tuple t) {
      try {
          return View.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected View.Match arrayToMatch(final Object[] match) {
      try {
          return View.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected View.Match arrayToMatchMutable(final Object[] match) {
      try {
          return View.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<View.Matcher> querySpecification() {
      return View.instance();
    }
  }
  ...
  @Override
  protected View.Matcher instantiate(final ViatraQueryEngine engine) {
    return View.Matcher.on(engine);
  }
  
  @Override
  public View.Matcher instantiate() {
    return View.Matcher.create();
  }
  
  @Override
  public View.Match newEmptyMatch() {
    return View.Match.newEmptyMatch();
  }
  
  @Override
  public View.Match newMatch(final Object... parameters) {
    return View.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link View} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link View#instance()}.
   * 
