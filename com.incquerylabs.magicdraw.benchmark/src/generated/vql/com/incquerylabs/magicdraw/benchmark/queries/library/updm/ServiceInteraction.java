...
public final class ServiceInteraction extends BaseGeneratedEMFQuerySpecification<ServiceInteraction.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInteraction pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInteraction";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInteraction.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInteraction.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInteraction.Match)) {
          ServiceInteraction.Match other = (ServiceInteraction.Match) obj;
    ...
    @Override
    public ServiceInteraction specification() {
      return ServiceInteraction.instance();
    }
     ...
     * 
     */
    public static ServiceInteraction.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInteraction.Match newMutableMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ServiceInteraction.Match newMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ServiceInteraction.Match {
    ...
    private static final class Immutable extends ServiceInteraction.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInteraction pattern,
   ...
   * 
   * @see Match
   * @see ServiceInteraction
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInteraction.Match> {
    /**
     ...
     * 
     */
    public static ServiceInteraction.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInteraction.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInteraction.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInteraction.Match> getAllMatches(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ServiceInteraction.Match> streamAllMatches(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ServiceInteraction.Match> getOneArbitraryMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ServiceInteraction.Match> processor) {
     ...
     * 
     */
    public ServiceInteraction.Match newMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ServiceInteraction.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Interaction> streamAllValuesOfelement(final ServiceInteraction.Match partialMatch) {
     ...
     * 
     */
    public Set<Interaction> getAllValuesOfelement(final ServiceInteraction.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ServiceInteraction.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ServiceInteraction.Match partialMatch) {
    ...
    @Override
    protected ServiceInteraction.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInteraction.Match.newMatch((Interaction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ServiceInteraction.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInteraction.Match.newMatch((Interaction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInteraction.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInteraction.Match.newMutableMatch((Interaction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInteraction.Matcher> querySpecification() {
      return ServiceInteraction.instance();
    }
  }
  ...
  @Override
  protected ServiceInteraction.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInteraction.Matcher.on(engine);
  }
  
  @Override
  public ServiceInteraction.Matcher instantiate() {
    return ServiceInteraction.Matcher.create();
  }
  
  @Override
  public ServiceInteraction.Match newEmptyMatch() {
    return ServiceInteraction.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInteraction.Match newMatch(final Object... parameters) {
    return ServiceInteraction.Match.newMatch((com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.Interaction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInteraction} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInteraction#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInteraction INSTANCE = new ServiceInteraction();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInteraction.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ServiceInteraction");
