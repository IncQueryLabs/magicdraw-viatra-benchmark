...
public final class DataElement_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<DataElement_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return DataElement_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public DataElement_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DataElement_requiredEnvironment.Match)) {
          DataElement_requiredEnvironment.Match other = (DataElement_requiredEnvironment.Match) obj;
    ...
    @Override
    public DataElement_requiredEnvironment specification() {
      return DataElement_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static DataElement_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static DataElement_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static DataElement_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DataElement_requiredEnvironment.Match {
    ...
    private static final class Immutable extends DataElement_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see DataElement_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<DataElement_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static DataElement_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DataElement_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DataElement_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<DataElement_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<DataElement_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<DataElement_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super DataElement_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public DataElement_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return DataElement_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DataElement_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DataElement_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final DataElement_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final DataElement_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected DataElement_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return DataElement_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected DataElement_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return DataElement_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DataElement_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DataElement_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DataElement_requiredEnvironment.Matcher> querySpecification() {
      return DataElement_requiredEnvironment.instance();
    }
  }
  
  private DataElement_requiredEnvironment() {
   ...
   * 
   */
  public static DataElement_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected DataElement_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return DataElement_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public DataElement_requiredEnvironment.Matcher instantiate() {
    return DataElement_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public DataElement_requiredEnvironment.Match newEmptyMatch() {
    return DataElement_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public DataElement_requiredEnvironment.Match newMatch(final Object... parameters) {
    return DataElement_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataElement_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataElement_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DataElement_requiredEnvironment INSTANCE = new DataElement_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DataElement_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
