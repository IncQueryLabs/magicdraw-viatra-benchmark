...
public final class WholeLifeConfiguration_URI extends BaseGeneratedEMFQuerySpecification<WholeLifeConfiguration_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeConfiguration_URI.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeConfiguration_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeConfiguration_URI.Match)) {
          WholeLifeConfiguration_URI.Match other = (WholeLifeConfiguration_URI.Match) obj;
    ...
    @Override
    public WholeLifeConfiguration_URI specification() {
      return WholeLifeConfiguration_URI.instance();
    }
     ...
     * 
     */
    public static WholeLifeConfiguration_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeConfiguration_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static WholeLifeConfiguration_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends WholeLifeConfiguration_URI.Match {
    ...
    private static final class Immutable extends WholeLifeConfiguration_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_URI pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeConfiguration_URI
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeConfiguration_URI.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeConfiguration_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeConfiguration_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeConfiguration_URI.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeConfiguration_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<WholeLifeConfiguration_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<WholeLifeConfiguration_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super WholeLifeConfiguration_URI.Match> processor) {
     ...
     * 
     */
    public WholeLifeConfiguration_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return WholeLifeConfiguration_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeConfiguration_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeConfiguration_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final WholeLifeConfiguration_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final WholeLifeConfiguration_URI.Match partialMatch) {
    ...
    @Override
    protected WholeLifeConfiguration_URI.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeConfiguration_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected WholeLifeConfiguration_URI.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeConfiguration_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeConfiguration_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeConfiguration_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeConfiguration_URI.Matcher> querySpecification() {
      return WholeLifeConfiguration_URI.instance();
    }
  }
  
  private WholeLifeConfiguration_URI() {
   ...
   * 
   */
  public static WholeLifeConfiguration_URI instance() {
    try{
  ...
  @Override
  protected WholeLifeConfiguration_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeConfiguration_URI.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeConfiguration_URI.Matcher instantiate() {
    return WholeLifeConfiguration_URI.Matcher.create();
  }
  
  @Override
  public WholeLifeConfiguration_URI.Match newEmptyMatch() {
    return WholeLifeConfiguration_URI.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeConfiguration_URI.Match newMatch(final Object... parameters) {
    return WholeLifeConfiguration_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeConfiguration_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeConfiguration_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeConfiguration_URI INSTANCE = new WholeLifeConfiguration_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeConfiguration_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
