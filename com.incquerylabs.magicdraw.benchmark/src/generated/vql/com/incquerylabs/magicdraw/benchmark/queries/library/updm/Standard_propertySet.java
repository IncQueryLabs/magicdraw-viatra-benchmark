...
public final class Standard_propertySet extends BaseGeneratedEMFQuerySpecification<Standard_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Standard_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_propertySet.Match)) {
          Standard_propertySet.Match other = (Standard_propertySet.Match) obj;
    ...
    @Override
    public Standard_propertySet specification() {
      return Standard_propertySet.instance();
    }
     ...
     * 
     */
    public static Standard_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Standard_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Standard_propertySet.Match {
    ...
    private static final class Immutable extends Standard_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Standard_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Standard_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Standard_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Standard_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Standard_propertySet.Match> processor) {
     ...
     * 
     */
    public Standard_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Standard_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Standard_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Standard_propertySet.Match partialMatch) {
    ...
    @Override
    protected Standard_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Standard_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_propertySet.Matcher> querySpecification() {
      return Standard_propertySet.instance();
    }
  }
  
  private Standard_propertySet() {
   ...
   * 
   */
  public static Standard_propertySet instance() {
    try{
  ...
  @Override
  protected Standard_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Standard_propertySet.Matcher instantiate() {
    return Standard_propertySet.Matcher.create();
  }
  
  @Override
  public Standard_propertySet.Match newEmptyMatch() {
    return Standard_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_propertySet.Match newMatch(final Object... parameters) {
    return Standard_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_propertySet INSTANCE = new Standard_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
