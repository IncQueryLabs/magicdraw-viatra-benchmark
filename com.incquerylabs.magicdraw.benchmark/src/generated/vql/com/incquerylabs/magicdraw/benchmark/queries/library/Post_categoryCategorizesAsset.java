...
public final class Post_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<Post_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Post_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public Post_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_categoryCategorizesAsset.Match)) {
          Post_categoryCategorizesAsset.Match other = (Post_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public Post_categoryCategorizesAsset specification() {
      return Post_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static Post_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends Post_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see Post_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<Post_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static Post_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<Post_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public Post_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected Post_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return Post_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return Post_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_categoryCategorizesAsset.Matcher> querySpecification() {
      return Post_categoryCategorizesAsset.instance();
    }
  }
  
  private Post_categoryCategorizesAsset() {
   ...
   * 
   */
  public static Post_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected Post_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public Post_categoryCategorizesAsset.Matcher instantiate() {
    return Post_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public Post_categoryCategorizesAsset.Match newEmptyMatch() {
    return Post_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public Post_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return Post_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_categoryCategorizesAsset INSTANCE = new Post_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
