...
public final class StateWithMostSubstates extends BaseGeneratedEMFQuerySpecification<StateWithMostSubstates.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.StateWithMostSubstates (visibility: PUBLIC, simpleName: StateWithMostSubstates, identifier: com.incquerylabs.magicdraw.benchmark.queries.StateWithMostSubstates, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
