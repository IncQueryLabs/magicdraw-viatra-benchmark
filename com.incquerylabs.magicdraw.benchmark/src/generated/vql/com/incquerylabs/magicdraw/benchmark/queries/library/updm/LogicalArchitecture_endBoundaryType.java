...
public final class LogicalArchitecture_endBoundaryType extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_endBoundaryType.Match)) {
          LogicalArchitecture_endBoundaryType.Match other = (LogicalArchitecture_endBoundaryType.Match) obj;
    ...
    @Override
    public LogicalArchitecture_endBoundaryType specification() {
      return LogicalArchitecture_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static LogicalArchitecture_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends LogicalArchitecture_endBoundaryType.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super LogicalArchitecture_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return LogicalArchitecture_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final LogicalArchitecture_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final LogicalArchitecture_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected LogicalArchitecture_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_endBoundaryType.Matcher> querySpecification() {
      return LogicalArchitecture_endBoundaryType.instance();
    }
  }
  
  private LogicalArchitecture_endBoundaryType() {
   ...
   * 
   */
  public static LogicalArchitecture_endBoundaryType instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_endBoundaryType.Matcher instantiate() {
    return LogicalArchitecture_endBoundaryType.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_endBoundaryType.Match newEmptyMatch() {
    return LogicalArchitecture_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_endBoundaryType.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_endBoundaryType INSTANCE = new LogicalArchitecture_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
