...
public final class MapsToCapability_targetContext extends BaseGeneratedEMFQuerySpecification<MapsToCapability_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return MapsToCapability_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public MapsToCapability_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof MapsToCapability_targetContext.Match)) {
          MapsToCapability_targetContext.Match other = (MapsToCapability_targetContext.Match) obj;
    ...
    @Override
    public MapsToCapability_targetContext specification() {
      return MapsToCapability_targetContext.instance();
    }
     ...
     * 
     */
    public static MapsToCapability_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static MapsToCapability_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static MapsToCapability_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends MapsToCapability_targetContext.Match {
    ...
    private static final class Immutable extends MapsToCapability_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_targetContext pattern,
   ...
   * 
   * @see Match
   * @see MapsToCapability_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<MapsToCapability_targetContext.Match> {
    /**
     ...
     * 
     */
    public static MapsToCapability_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static MapsToCapability_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MapsToCapability_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<MapsToCapability_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<MapsToCapability_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<MapsToCapability_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super MapsToCapability_targetContext.Match> processor) {
     ...
     * 
     */
    public MapsToCapability_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return MapsToCapability_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final MapsToCapability_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final MapsToCapability_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final MapsToCapability_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final MapsToCapability_targetContext.Match partialMatch) {
    ...
    @Override
    protected MapsToCapability_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return MapsToCapability_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected MapsToCapability_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return MapsToCapability_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected MapsToCapability_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return MapsToCapability_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<MapsToCapability_targetContext.Matcher> querySpecification() {
      return MapsToCapability_targetContext.instance();
    }
  }
  
  private MapsToCapability_targetContext() {
   ...
   * 
   */
  public static MapsToCapability_targetContext instance() {
    try{
  ...
  @Override
  protected MapsToCapability_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return MapsToCapability_targetContext.Matcher.on(engine);
  }
  
  @Override
  public MapsToCapability_targetContext.Matcher instantiate() {
    return MapsToCapability_targetContext.Matcher.create();
  }
  
  @Override
  public MapsToCapability_targetContext.Match newEmptyMatch() {
    return MapsToCapability_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public MapsToCapability_targetContext.Match newMatch(final Object... parameters) {
    return MapsToCapability_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MapsToCapability_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link MapsToCapability_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final MapsToCapability_targetContext INSTANCE = new MapsToCapability_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final MapsToCapability_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
