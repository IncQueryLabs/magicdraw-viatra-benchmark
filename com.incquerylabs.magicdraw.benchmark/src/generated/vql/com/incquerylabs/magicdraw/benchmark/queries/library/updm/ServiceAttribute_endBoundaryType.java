...
public final class ServiceAttribute_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ServiceAttribute_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAttribute_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAttribute_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAttribute_endBoundaryType.Match)) {
          ServiceAttribute_endBoundaryType.Match other = (ServiceAttribute_endBoundaryType.Match) obj;
    ...
    @Override
    public ServiceAttribute_endBoundaryType specification() {
      return ServiceAttribute_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ServiceAttribute_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAttribute_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAttribute_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAttribute_endBoundaryType.Match {
    ...
    private static final class Immutable extends ServiceAttribute_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ServiceAttribute_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAttribute_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ServiceAttribute_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAttribute_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAttribute_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAttribute_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAttribute_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAttribute_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ServiceAttribute_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ServiceAttribute_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ServiceAttribute_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceAttribute_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceAttribute_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAttribute_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAttribute_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ServiceAttribute_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAttribute_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAttribute_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAttribute_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAttribute_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAttribute_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAttribute_endBoundaryType.Matcher> querySpecification() {
      return ServiceAttribute_endBoundaryType.instance();
    }
  }
  
  private ServiceAttribute_endBoundaryType() {
   ...
   * 
   */
  public static ServiceAttribute_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ServiceAttribute_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAttribute_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ServiceAttribute_endBoundaryType.Matcher instantiate() {
    return ServiceAttribute_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ServiceAttribute_endBoundaryType.Match newEmptyMatch() {
    return ServiceAttribute_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAttribute_endBoundaryType.Match newMatch(final Object... parameters) {
    return ServiceAttribute_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAttribute_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAttribute_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAttribute_endBoundaryType INSTANCE = new ServiceAttribute_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAttribute_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
