...
public final class SecurityEnclave_conformsTo extends BaseGeneratedEMFQuerySpecification<SecurityEnclave_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave_conformsTo.Match)) {
          SecurityEnclave_conformsTo.Match other = (SecurityEnclave_conformsTo.Match) obj;
    ...
    @Override
    public SecurityEnclave_conformsTo specification() {
      return SecurityEnclave_conformsTo.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityEnclave_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityEnclave_conformsTo.Match {
    ...
    private static final class Immutable extends SecurityEnclave_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see SecurityEnclave_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityEnclave_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityEnclave_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityEnclave_conformsTo.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityEnclave_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityEnclave_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityEnclave_conformsTo.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityEnclave_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave_conformsTo.Matcher> querySpecification() {
      return SecurityEnclave_conformsTo.instance();
    }
  }
  
  private SecurityEnclave_conformsTo() {
   ...
   * 
   */
  public static SecurityEnclave_conformsTo instance() {
    try{
  ...
  @Override
  protected SecurityEnclave_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave_conformsTo.Matcher instantiate() {
    return SecurityEnclave_conformsTo.Matcher.create();
  }
  
  @Override
  public SecurityEnclave_conformsTo.Match newEmptyMatch() {
    return SecurityEnclave_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave_conformsTo.Match newMatch(final Object... parameters) {
    return SecurityEnclave_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave_conformsTo INSTANCE = new SecurityEnclave_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
