...
public final class PersonType_endBoundaryType extends BaseGeneratedEMFQuerySpecification<PersonType_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_endBoundaryType.Match)) {
          PersonType_endBoundaryType.Match other = (PersonType_endBoundaryType.Match) obj;
    ...
    @Override
    public PersonType_endBoundaryType specification() {
      return PersonType_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static PersonType_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_endBoundaryType.Match {
    ...
    private static final class Immutable extends PersonType_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see PersonType_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static PersonType_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public PersonType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected PersonType_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_endBoundaryType.Matcher> querySpecification() {
      return PersonType_endBoundaryType.instance();
    }
  }
  
  private PersonType_endBoundaryType() {
   ...
   * 
   */
  public static PersonType_endBoundaryType instance() {
    try{
  ...
  @Override
  protected PersonType_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public PersonType_endBoundaryType.Matcher instantiate() {
    return PersonType_endBoundaryType.Matcher.create();
  }
  
  @Override
  public PersonType_endBoundaryType.Match newEmptyMatch() {
    return PersonType_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_endBoundaryType.Match newMatch(final Object... parameters) {
    return PersonType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_endBoundaryType INSTANCE = new PersonType_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
