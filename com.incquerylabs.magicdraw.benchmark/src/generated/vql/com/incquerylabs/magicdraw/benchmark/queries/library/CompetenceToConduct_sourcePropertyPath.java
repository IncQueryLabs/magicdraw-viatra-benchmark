...
public final class CompetenceToConduct_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<CompetenceToConduct_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceToConduct_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceToConduct_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceToConduct_sourcePropertyPath.Match)) {
          CompetenceToConduct_sourcePropertyPath.Match other = (CompetenceToConduct_sourcePropertyPath.Match) obj;
    ...
    @Override
    public CompetenceToConduct_sourcePropertyPath specification() {
      return CompetenceToConduct_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static CompetenceToConduct_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceToConduct_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static CompetenceToConduct_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CompetenceToConduct_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends CompetenceToConduct_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see CompetenceToConduct_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceToConduct_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static CompetenceToConduct_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceToConduct_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceToConduct_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceToConduct_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<CompetenceToConduct_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<CompetenceToConduct_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super CompetenceToConduct_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public CompetenceToConduct_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return CompetenceToConduct_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceToConduct_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceToConduct_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final CompetenceToConduct_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final CompetenceToConduct_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected CompetenceToConduct_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceToConduct_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected CompetenceToConduct_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceToConduct_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceToConduct_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceToConduct_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceToConduct_sourcePropertyPath.Matcher> querySpecification() {
      return CompetenceToConduct_sourcePropertyPath.instance();
    }
  }
  
  private CompetenceToConduct_sourcePropertyPath() {
   ...
   * 
   */
  public static CompetenceToConduct_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected CompetenceToConduct_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceToConduct_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public CompetenceToConduct_sourcePropertyPath.Matcher instantiate() {
    return CompetenceToConduct_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public CompetenceToConduct_sourcePropertyPath.Match newEmptyMatch() {
    return CompetenceToConduct_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceToConduct_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return CompetenceToConduct_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceToConduct_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceToConduct_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceToConduct_sourcePropertyPath INSTANCE = new CompetenceToConduct_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceToConduct_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
