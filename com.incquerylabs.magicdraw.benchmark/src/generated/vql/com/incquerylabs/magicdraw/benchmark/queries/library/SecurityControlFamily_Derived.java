...
public final class SecurityControlFamily_Derived extends BaseGeneratedEMFQuerySpecification<SecurityControlFamily_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControlFamily_Derived.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControlFamily_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControlFamily_Derived.Match)) {
          SecurityControlFamily_Derived.Match other = (SecurityControlFamily_Derived.Match) obj;
    ...
    @Override
    public SecurityControlFamily_Derived specification() {
      return SecurityControlFamily_Derived.instance();
    }
     ...
     * 
     */
    public static SecurityControlFamily_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControlFamily_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityControlFamily_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControlFamily_Derived.Match {
    ...
    private static final class Immutable extends SecurityControlFamily_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Derived pattern,
   ...
   * 
   * @see Match
   * @see SecurityControlFamily_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControlFamily_Derived.Match> {
    /**
     ...
     * 
     */
    public static SecurityControlFamily_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControlFamily_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControlFamily_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControlFamily_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityControlFamily_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityControlFamily_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityControlFamily_Derived.Match> processor) {
     ...
     * 
     */
    public SecurityControlFamily_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityControlFamily_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControlFamily_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControlFamily_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityControlFamily_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityControlFamily_Derived.Match partialMatch) {
    ...
    @Override
    protected SecurityControlFamily_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControlFamily_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControlFamily_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControlFamily_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControlFamily_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControlFamily_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControlFamily_Derived.Matcher> querySpecification() {
      return SecurityControlFamily_Derived.instance();
    }
  }
  
  private SecurityControlFamily_Derived() {
   ...
   * 
   */
  public static SecurityControlFamily_Derived instance() {
    try{
  ...
  @Override
  protected SecurityControlFamily_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControlFamily_Derived.Matcher.on(engine);
  }
  
  @Override
  public SecurityControlFamily_Derived.Matcher instantiate() {
    return SecurityControlFamily_Derived.Matcher.create();
  }
  
  @Override
  public SecurityControlFamily_Derived.Match newEmptyMatch() {
    return SecurityControlFamily_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControlFamily_Derived.Match newMatch(final Object... parameters) {
    return SecurityControlFamily_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControlFamily_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControlFamily_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControlFamily_Derived INSTANCE = new SecurityControlFamily_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControlFamily_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
