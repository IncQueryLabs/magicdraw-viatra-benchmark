...
public final class CapabilityConfiguration_conformsTo extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_conformsTo.Match)) {
          CapabilityConfiguration_conformsTo.Match other = (CapabilityConfiguration_conformsTo.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_conformsTo specification() {
      return CapabilityConfiguration_conformsTo.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_conformsTo.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_conformsTo.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_conformsTo.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_conformsTo.Matcher> querySpecification() {
      return CapabilityConfiguration_conformsTo.instance();
    }
  }
  
  private CapabilityConfiguration_conformsTo() {
   ...
   * 
   */
  public static CapabilityConfiguration_conformsTo instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_conformsTo.Matcher instantiate() {
    return CapabilityConfiguration_conformsTo.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_conformsTo.Match newEmptyMatch() {
    return CapabilityConfiguration_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_conformsTo.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_conformsTo INSTANCE = new CapabilityConfiguration_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
