...
public final class OwnsRiskInContext_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<OwnsRiskInContext_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRiskInContext_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRiskInContext_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRiskInContext_sourcePropertyPath.Match)) {
          OwnsRiskInContext_sourcePropertyPath.Match other = (OwnsRiskInContext_sourcePropertyPath.Match) obj;
    ...
    @Override
    public OwnsRiskInContext_sourcePropertyPath specification() {
      return OwnsRiskInContext_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static OwnsRiskInContext_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRiskInContext_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static OwnsRiskInContext_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsRiskInContext_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends OwnsRiskInContext_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see OwnsRiskInContext_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRiskInContext_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static OwnsRiskInContext_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRiskInContext_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRiskInContext_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRiskInContext_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<OwnsRiskInContext_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<OwnsRiskInContext_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super OwnsRiskInContext_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public OwnsRiskInContext_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return OwnsRiskInContext_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRiskInContext_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRiskInContext_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final OwnsRiskInContext_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final OwnsRiskInContext_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected OwnsRiskInContext_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRiskInContext_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsRiskInContext_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRiskInContext_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRiskInContext_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRiskInContext_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRiskInContext_sourcePropertyPath.Matcher> querySpecification() {
      return OwnsRiskInContext_sourcePropertyPath.instance();
    }
  }
  
  private OwnsRiskInContext_sourcePropertyPath() {
   ...
   * 
   */
  public static OwnsRiskInContext_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected OwnsRiskInContext_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRiskInContext_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public OwnsRiskInContext_sourcePropertyPath.Matcher instantiate() {
    return OwnsRiskInContext_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public OwnsRiskInContext_sourcePropertyPath.Match newEmptyMatch() {
    return OwnsRiskInContext_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRiskInContext_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return OwnsRiskInContext_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRiskInContext_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRiskInContext_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRiskInContext_sourcePropertyPath INSTANCE = new OwnsRiskInContext_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRiskInContext_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
