...
public final class PhysicalResource_URI extends BaseGeneratedEMFQuerySpecification<PhysicalResource_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_URI.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_URI.Match)) {
          PhysicalResource_URI.Match other = (PhysicalResource_URI.Match) obj;
    ...
    @Override
    public PhysicalResource_URI specification() {
      return PhysicalResource_URI.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static PhysicalResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends PhysicalResource_URI.Match {
    ...
    private static final class Immutable extends PhysicalResource_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_URI pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_URI
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_URI.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_URI.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<PhysicalResource_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<PhysicalResource_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super PhysicalResource_URI.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return PhysicalResource_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final PhysicalResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final PhysicalResource_URI.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_URI.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected PhysicalResource_URI.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_URI.Matcher> querySpecification() {
      return PhysicalResource_URI.instance();
    }
  }
  
  private PhysicalResource_URI() {
   ...
   * 
   */
  public static PhysicalResource_URI instance() {
    try{
  ...
  @Override
  protected PhysicalResource_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_URI.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_URI.Matcher instantiate() {
    return PhysicalResource_URI.Matcher.create();
  }
  
  @Override
  public PhysicalResource_URI.Match newEmptyMatch() {
    return PhysicalResource_URI.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_URI.Match newMatch(final Object... parameters) {
    return PhysicalResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_URI INSTANCE = new PhysicalResource_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
