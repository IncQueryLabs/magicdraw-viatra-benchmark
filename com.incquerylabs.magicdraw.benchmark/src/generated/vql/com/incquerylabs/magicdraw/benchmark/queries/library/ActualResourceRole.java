...
public final class ActualResourceRole extends BaseGeneratedEMFQuerySpecification<ActualResourceRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualResourceRole.Match.parameterNames;
    }
    ...
    @Override
    public ActualResourceRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualResourceRole.Match)) {
          ActualResourceRole.Match other = (ActualResourceRole.Match) obj;
    ...
    @Override
    public ActualResourceRole specification() {
      return ActualResourceRole.instance();
    }
     ...
     * 
     */
    public static ActualResourceRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualResourceRole.Match newMutableMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualResourceRole.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualResourceRole.Match {
    ...
    private static final class Immutable extends ActualResourceRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole pattern,
   ...
   * 
   * @see Match
   * @see ActualResourceRole
   * 
   */
  public static class Matcher extends BaseMatcher<ActualResourceRole.Match> {
    /**
     ...
     * 
     */
    public static ActualResourceRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualResourceRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualResourceRole.Matcher.class);
     ...
     * 
     */
    public Collection<ActualResourceRole.Match> getAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualResourceRole.Match> streamAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualResourceRole.Match> getOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualResourceRole.Match> processor) {
     ...
     * 
     */
    public ActualResourceRole.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualResourceRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualResourceRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualResourceRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualResourceRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualResourceRole.Match partialMatch) {
    ...
    @Override
    protected ActualResourceRole.Match tupleToMatch(final Tuple t) {
      try {
          return ActualResourceRole.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualResourceRole.Match arrayToMatch(final Object[] match) {
      try {
          return ActualResourceRole.Match.newMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualResourceRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualResourceRole.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualResourceRole.Matcher> querySpecification() {
      return ActualResourceRole.instance();
    }
  }
  
  private ActualResourceRole() {
   ...
   * 
   */
  public static ActualResourceRole instance() {
    try{
  ...
  @Override
  protected ActualResourceRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualResourceRole.Matcher.on(engine);
  }
  
  @Override
  public ActualResourceRole.Matcher instantiate() {
    return ActualResourceRole.Matcher.create();
  }
  
  @Override
  public ActualResourceRole.Match newEmptyMatch() {
    return ActualResourceRole.Match.newEmptyMatch();
  }
  
  @Override
  public ActualResourceRole.Match newMatch(final Object... parameters) {
    return ActualResourceRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualResourceRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualResourceRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualResourceRole INSTANCE = new ActualResourceRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualResourceRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualResourceRole")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualResourceRole");
