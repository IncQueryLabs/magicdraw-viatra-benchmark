...
import com.incquerylabs.magicdraw.benchmark.queries.library.Organization;
...
public final class Organization_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<Organization_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Organization_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public Organization_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_isStandardConfiguration.Match)) {
          Organization_isStandardConfiguration.Match other = (Organization_isStandardConfiguration.Match) obj;
    ...
    @Override
    public Organization_isStandardConfiguration specification() {
      return Organization_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static Organization_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Organization_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Organization_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends Organization_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see Organization_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static Organization_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Organization_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Organization_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Organization_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public Organization_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Organization_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Organization_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Organization_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected Organization_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Organization_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_isStandardConfiguration.Matcher> querySpecification() {
      return Organization_isStandardConfiguration.instance();
    }
  }
  
  private Organization_isStandardConfiguration() {
   ...
   * 
   */
  public static Organization_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected Organization_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public Organization_isStandardConfiguration.Matcher instantiate() {
    return Organization_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public Organization_isStandardConfiguration.Match newEmptyMatch() {
    return Organization_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return Organization_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_isStandardConfiguration INSTANCE = new Organization_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Organization(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Organization.instance().getInternalQueryRepresentation());
