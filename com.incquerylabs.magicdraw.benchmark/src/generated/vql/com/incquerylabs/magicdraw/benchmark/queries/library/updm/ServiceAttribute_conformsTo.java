...
public final class ServiceAttribute_conformsTo extends BaseGeneratedEMFQuerySpecification<ServiceAttribute_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAttribute_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAttribute_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAttribute_conformsTo.Match)) {
          ServiceAttribute_conformsTo.Match other = (ServiceAttribute_conformsTo.Match) obj;
    ...
    @Override
    public ServiceAttribute_conformsTo specification() {
      return ServiceAttribute_conformsTo.instance();
    }
     ...
     * 
     */
    public static ServiceAttribute_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAttribute_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAttribute_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAttribute_conformsTo.Match {
    ...
    private static final class Immutable extends ServiceAttribute_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ServiceAttribute_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAttribute_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ServiceAttribute_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAttribute_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAttribute_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAttribute_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAttribute_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAttribute_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ServiceAttribute_conformsTo.Match> processor) {
     ...
     * 
     */
    public ServiceAttribute_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ServiceAttribute_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceAttribute_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceAttribute_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAttribute_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAttribute_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ServiceAttribute_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAttribute_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAttribute_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAttribute_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAttribute_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAttribute_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAttribute_conformsTo.Matcher> querySpecification() {
      return ServiceAttribute_conformsTo.instance();
    }
  }
  
  private ServiceAttribute_conformsTo() {
   ...
   * 
   */
  public static ServiceAttribute_conformsTo instance() {
    try{
  ...
  @Override
  protected ServiceAttribute_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAttribute_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ServiceAttribute_conformsTo.Matcher instantiate() {
    return ServiceAttribute_conformsTo.Matcher.create();
  }
  
  @Override
  public ServiceAttribute_conformsTo.Match newEmptyMatch() {
    return ServiceAttribute_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAttribute_conformsTo.Match newMatch(final Object... parameters) {
    return ServiceAttribute_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAttribute_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAttribute_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAttribute_conformsTo INSTANCE = new ServiceAttribute_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAttribute_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
