...
public final class TechnicalStandard_conformsTo extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_conformsTo.Match)) {
          TechnicalStandard_conformsTo.Match other = (TechnicalStandard_conformsTo.Match) obj;
    ...
    @Override
    public TechnicalStandard_conformsTo specification() {
      return TechnicalStandard_conformsTo.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static TechnicalStandard_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TechnicalStandard_conformsTo.Match {
    ...
    private static final class Immutable extends TechnicalStandard_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TechnicalStandard_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TechnicalStandard_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super TechnicalStandard_conformsTo.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return TechnicalStandard_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TechnicalStandard_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TechnicalStandard_conformsTo.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TechnicalStandard_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_conformsTo.Matcher> querySpecification() {
      return TechnicalStandard_conformsTo.instance();
    }
  }
  
  private TechnicalStandard_conformsTo() {
   ...
   * 
   */
  public static TechnicalStandard_conformsTo instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_conformsTo.Matcher instantiate() {
    return TechnicalStandard_conformsTo.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_conformsTo.Match newEmptyMatch() {
    return TechnicalStandard_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_conformsTo.Match newMatch(final Object... parameters) {
    return TechnicalStandard_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_conformsTo INSTANCE = new TechnicalStandard_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
