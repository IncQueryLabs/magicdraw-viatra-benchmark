...
public final class PersonType_actualPropertySet extends BaseGeneratedEMFQuerySpecification<PersonType_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_actualPropertySet.Match)) {
          PersonType_actualPropertySet.Match other = (PersonType_actualPropertySet.Match) obj;
    ...
    @Override
    public PersonType_actualPropertySet specification() {
      return PersonType_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static PersonType_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_actualPropertySet.Match {
    ...
    private static final class Immutable extends PersonType_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see PersonType_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static PersonType_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public PersonType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected PersonType_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_actualPropertySet.Matcher> querySpecification() {
      return PersonType_actualPropertySet.instance();
    }
  }
  
  private PersonType_actualPropertySet() {
   ...
   * 
   */
  public static PersonType_actualPropertySet instance() {
    try{
  ...
  @Override
  protected PersonType_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public PersonType_actualPropertySet.Matcher instantiate() {
    return PersonType_actualPropertySet.Matcher.create();
  }
  
  @Override
  public PersonType_actualPropertySet.Match newEmptyMatch() {
    return PersonType_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_actualPropertySet.Match newMatch(final Object... parameters) {
    return PersonType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_actualPropertySet INSTANCE = new PersonType_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
