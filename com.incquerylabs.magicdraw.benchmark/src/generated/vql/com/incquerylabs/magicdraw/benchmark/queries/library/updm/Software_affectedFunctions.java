...
public final class Software_affectedFunctions extends BaseGeneratedEMFQuerySpecification<Software_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public Software_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_affectedFunctions.Match)) {
          Software_affectedFunctions.Match other = (Software_affectedFunctions.Match) obj;
    ...
    @Override
    public Software_affectedFunctions specification() {
      return Software_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static Software_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_affectedFunctions.Match {
    ...
    private static final class Immutable extends Software_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see Software_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<Software_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static Software_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<Software_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public Software_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected Software_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return Software_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return Software_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_affectedFunctions.Matcher> querySpecification() {
      return Software_affectedFunctions.instance();
    }
  }
  
  private Software_affectedFunctions() {
   ...
   * 
   */
  public static Software_affectedFunctions instance() {
    try{
  ...
  @Override
  protected Software_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public Software_affectedFunctions.Matcher instantiate() {
    return Software_affectedFunctions.Matcher.create();
  }
  
  @Override
  public Software_affectedFunctions.Match newEmptyMatch() {
    return Software_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public Software_affectedFunctions.Match newMatch(final Object... parameters) {
    return Software_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_affectedFunctions INSTANCE = new Software_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
