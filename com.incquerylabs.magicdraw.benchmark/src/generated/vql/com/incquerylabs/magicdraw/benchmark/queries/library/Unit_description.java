 ...
 *         pattern Unit_description(Element : PackageableElement, Value: java String) {
...
public final class Unit_description extends BaseGeneratedEMFQuerySpecification<Unit_description.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Unit_description.Match newMutableMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public static Unit_description.Match newMatch(final PackageableElement pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<Unit_description.Match> {
     ...
     * 
     */
    public Collection<Unit_description.Match> getAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Stream<Unit_description.Match> streamAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Optional<Unit_description.Match> getOneArbitraryMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final String pValue, final Consumer<? super Unit_description.Match> processor) {
     ...
     * 
     */
    public Unit_description.Match newMatch(final PackageableElement pElement, final String pValue) {
      return Unit_description.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final Unit_description.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final Unit_description.Match partialMatch) {
    ...
    protected Unit_description.Match tupleToMatch(final Tuple t) {
      try {
          return Unit_description.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected Unit_description.Match arrayToMatch(final Object[] match) {
      try {
          return Unit_description.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Unit_description.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unit_description.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Unit_description.Match newMatch(final Object... parameters) {
    return Unit_description.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (java.lang.String) parameters[1]);
  }
