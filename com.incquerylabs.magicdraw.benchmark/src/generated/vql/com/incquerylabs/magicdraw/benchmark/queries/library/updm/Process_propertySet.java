...
public final class Process_propertySet extends BaseGeneratedEMFQuerySpecification<Process_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Process_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Process_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Process_propertySet.Match)) {
          Process_propertySet.Match other = (Process_propertySet.Match) obj;
    ...
    @Override
    public Process_propertySet specification() {
      return Process_propertySet.instance();
    }
     ...
     * 
     */
    public static Process_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Process_propertySet.Match newMutableMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public static Process_propertySet.Match newMatch(final Activity pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Process_propertySet.Match {
    ...
    private static final class Immutable extends Process_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Process_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Process_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Process_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Process_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Process_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Process_propertySet.Match> getAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Process_propertySet.Match> streamAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Process_propertySet.Match> getOneArbitraryMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final Element pValue, final Consumer<? super Process_propertySet.Match> processor) {
     ...
     * 
     */
    public Process_propertySet.Match newMatch(final Activity pElement, final Element pValue) {
      return Process_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Process_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Process_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Process_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Process_propertySet.Match partialMatch) {
    ...
    @Override
    protected Process_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Process_propertySet.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Process_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Process_propertySet.Match.newMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Process_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Process_propertySet.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Process_propertySet.Matcher> querySpecification() {
      return Process_propertySet.instance();
    }
  }
  
  private Process_propertySet() {
   ...
   * 
   */
  public static Process_propertySet instance() {
    try{
  ...
  @Override
  protected Process_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Process_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Process_propertySet.Matcher instantiate() {
    return Process_propertySet.Matcher.create();
  }
  
  @Override
  public Process_propertySet.Match newEmptyMatch() {
    return Process_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Process_propertySet.Match newMatch(final Object... parameters) {
    return Process_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Process_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Process_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Process_propertySet INSTANCE = new Process_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Process_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
