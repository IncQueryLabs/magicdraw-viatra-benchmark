...
import com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave;
...
public final class SecurityEnclave_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<SecurityEnclave_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave_isStandardConfiguration.Match)) {
          SecurityEnclave_isStandardConfiguration.Match other = (SecurityEnclave_isStandardConfiguration.Match) obj;
    ...
    @Override
    public SecurityEnclave_isStandardConfiguration specification() {
      return SecurityEnclave_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static SecurityEnclave_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityEnclave_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends SecurityEnclave_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see SecurityEnclave_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<SecurityEnclave_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<SecurityEnclave_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super SecurityEnclave_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return SecurityEnclave_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final SecurityEnclave_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final SecurityEnclave_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityEnclave_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave_isStandardConfiguration.Matcher> querySpecification() {
      return SecurityEnclave_isStandardConfiguration.instance();
    }
  }
  
  private SecurityEnclave_isStandardConfiguration() {
   ...
   * 
   */
  public static SecurityEnclave_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected SecurityEnclave_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave_isStandardConfiguration.Matcher instantiate() {
    return SecurityEnclave_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public SecurityEnclave_isStandardConfiguration.Match newEmptyMatch() {
    return SecurityEnclave_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return SecurityEnclave_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave_isStandardConfiguration INSTANCE = new SecurityEnclave_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find SecurityEnclave(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), SecurityEnclave.instance().getInternalQueryRepresentation());
