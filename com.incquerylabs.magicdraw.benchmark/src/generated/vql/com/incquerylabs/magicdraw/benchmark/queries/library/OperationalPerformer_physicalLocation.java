...
public final class OperationalPerformer_physicalLocation extends BaseGeneratedEMFQuerySpecification<OperationalPerformer_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalPerformer_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public OperationalPerformer_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalPerformer_physicalLocation.Match)) {
          OperationalPerformer_physicalLocation.Match other = (OperationalPerformer_physicalLocation.Match) obj;
    ...
    @Override
    public OperationalPerformer_physicalLocation specification() {
      return OperationalPerformer_physicalLocation.instance();
    }
     ...
     * 
     */
    public static OperationalPerformer_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalPerformer_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalPerformer_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalPerformer_physicalLocation.Match {
    ...
    private static final class Immutable extends OperationalPerformer_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see OperationalPerformer_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalPerformer_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static OperationalPerformer_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalPerformer_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalPerformer_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalPerformer_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalPerformer_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalPerformer_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalPerformer_physicalLocation.Match> processor) {
     ...
     * 
     */
    public OperationalPerformer_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalPerformer_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalPerformer_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalPerformer_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalPerformer_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalPerformer_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected OperationalPerformer_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalPerformer_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalPerformer_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalPerformer_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalPerformer_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalPerformer_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalPerformer_physicalLocation.Matcher> querySpecification() {
      return OperationalPerformer_physicalLocation.instance();
    }
  }
  
  private OperationalPerformer_physicalLocation() {
   ...
   * 
   */
  public static OperationalPerformer_physicalLocation instance() {
    try{
  ...
  @Override
  protected OperationalPerformer_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalPerformer_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public OperationalPerformer_physicalLocation.Matcher instantiate() {
    return OperationalPerformer_physicalLocation.Matcher.create();
  }
  
  @Override
  public OperationalPerformer_physicalLocation.Match newEmptyMatch() {
    return OperationalPerformer_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalPerformer_physicalLocation.Match newMatch(final Object... parameters) {
    return OperationalPerformer_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalPerformer_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalPerformer_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalPerformer_physicalLocation INSTANCE = new OperationalPerformer_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalPerformer_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
