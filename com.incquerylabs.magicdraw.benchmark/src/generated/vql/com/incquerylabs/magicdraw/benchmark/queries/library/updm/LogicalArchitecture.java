...
public final class LogicalArchitecture extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture.Match)) {
          LogicalArchitecture.Match other = (LogicalArchitecture.Match) obj;
    ...
    @Override
    public LogicalArchitecture specification() {
      return LogicalArchitecture.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static LogicalArchitecture.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends LogicalArchitecture.Match {
    ...
    private static final class Immutable extends LogicalArchitecture.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<LogicalArchitecture.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<LogicalArchitecture.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super LogicalArchitecture.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return LogicalArchitecture.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final LogicalArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final LogicalArchitecture.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected LogicalArchitecture.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture.Matcher> querySpecification() {
      return LogicalArchitecture.instance();
    }
  }
  ...
  @Override
  protected LogicalArchitecture.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture.Matcher instantiate() {
    return LogicalArchitecture.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture.Match newEmptyMatch() {
    return LogicalArchitecture.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture.Match newMatch(final Object... parameters) {
    return LogicalArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture INSTANCE = new LogicalArchitecture();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "LogicalArchitecture");
