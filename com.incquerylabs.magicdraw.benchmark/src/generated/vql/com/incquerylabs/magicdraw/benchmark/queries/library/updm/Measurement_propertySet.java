...
public final class Measurement_propertySet extends BaseGeneratedEMFQuerySpecification<Measurement_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measurement_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Measurement_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measurement_propertySet.Match)) {
          Measurement_propertySet.Match other = (Measurement_propertySet.Match) obj;
    ...
    @Override
    public Measurement_propertySet specification() {
      return Measurement_propertySet.instance();
    }
     ...
     * 
     */
    public static Measurement_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measurement_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static Measurement_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Measurement_propertySet.Match {
    ...
    private static final class Immutable extends Measurement_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Measurement_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Measurement_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Measurement_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measurement_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measurement_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Measurement_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Measurement_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Measurement_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super Measurement_propertySet.Match> processor) {
     ...
     * 
     */
    public Measurement_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return Measurement_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Measurement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Measurement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Measurement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Measurement_propertySet.Match partialMatch) {
    ...
    @Override
    protected Measurement_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Measurement_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Measurement_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Measurement_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measurement_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measurement_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measurement_propertySet.Matcher> querySpecification() {
      return Measurement_propertySet.instance();
    }
  }
  
  private Measurement_propertySet() {
   ...
   * 
   */
  public static Measurement_propertySet instance() {
    try{
  ...
  @Override
  protected Measurement_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measurement_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Measurement_propertySet.Matcher instantiate() {
    return Measurement_propertySet.Matcher.create();
  }
  
  @Override
  public Measurement_propertySet.Match newEmptyMatch() {
    return Measurement_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Measurement_propertySet.Match newMatch(final Object... parameters) {
    return Measurement_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measurement_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measurement_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Measurement_propertySet INSTANCE = new Measurement_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measurement_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
