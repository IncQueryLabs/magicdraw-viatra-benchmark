...
public final class SecurityControl_Text extends BaseGeneratedEMFQuerySpecification<SecurityControl_Text.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_Text.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_Text.Match)) {
          SecurityControl_Text.Match other = (SecurityControl_Text.Match) obj;
    ...
    @Override
    public SecurityControl_Text specification() {
      return SecurityControl_Text.instance();
    }
     ...
     * 
     */
    public static SecurityControl_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SecurityControl_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityControl_Text.Match {
    ...
    private static final class Immutable extends SecurityControl_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Text pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_Text
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_Text.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_Text.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SecurityControl_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SecurityControl_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super SecurityControl_Text.Match> processor) {
     ...
     * 
     */
    public SecurityControl_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return SecurityControl_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SecurityControl_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SecurityControl_Text.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_Text.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityControl_Text.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_Text.Matcher> querySpecification() {
      return SecurityControl_Text.instance();
    }
  }
  
  private SecurityControl_Text() {
   ...
   * 
   */
  public static SecurityControl_Text instance() {
    try{
  ...
  @Override
  protected SecurityControl_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_Text.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_Text.Matcher instantiate() {
    return SecurityControl_Text.Matcher.create();
  }
  
  @Override
  public SecurityControl_Text.Match newEmptyMatch() {
    return SecurityControl_Text.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_Text.Match newMatch(final Object... parameters) {
    return SecurityControl_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_Text} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_Text#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_Text INSTANCE = new SecurityControl_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
