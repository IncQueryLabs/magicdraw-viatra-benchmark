...
public final class Mission_URI extends BaseGeneratedEMFQuerySpecification<Mission_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Mission_URI.Match.parameterNames;
    }
    ...
    @Override
    public Mission_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Mission_URI.Match)) {
          Mission_URI.Match other = (Mission_URI.Match) obj;
    ...
    @Override
    public Mission_URI specification() {
      return Mission_URI.instance();
    }
     ...
     * 
     */
    public static Mission_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Mission_URI.Match newMutableMatch(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Mission_URI.Match newMatch(final Activity pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Mission_URI.Match {
    ...
    private static final class Immutable extends Mission_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Mission_URI.Match> {
    /**
     ...
     * 
     */
    public static Mission_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Mission_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Mission_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Mission_URI.Match> getAllMatches(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Mission_URI.Match> streamAllMatches(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Mission_URI.Match> getOneArbitraryMatch(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final LiteralString pValuespec, final Consumer<? super Mission_URI.Match> processor) {
     ...
     * 
     */
    public Mission_URI.Match newMatch(final Activity pElement, final LiteralString pValuespec) {
      return Mission_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Mission_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Mission_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Mission_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Mission_URI.Match partialMatch) {
    ...
    @Override
    protected Mission_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Mission_URI.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Mission_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Mission_URI.Match.newMatch((Activity) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Mission_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Mission_URI.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Mission_URI.Matcher> querySpecification() {
      return Mission_URI.instance();
    }
  }
   ...
   * 
   */
  public static Mission_URI instance() {
    try{
  ...
  @Override
  protected Mission_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Mission_URI.Matcher.on(engine);
  }
  
  @Override
  public Mission_URI.Matcher instantiate() {
    return Mission_URI.Matcher.create();
  }
  
  @Override
  public Mission_URI.Match newEmptyMatch() {
    return Mission_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Mission_URI.Match newMatch(final Object... parameters) {
    return Mission_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Mission_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Mission_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Mission_URI INSTANCE = new Mission_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Mission_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
