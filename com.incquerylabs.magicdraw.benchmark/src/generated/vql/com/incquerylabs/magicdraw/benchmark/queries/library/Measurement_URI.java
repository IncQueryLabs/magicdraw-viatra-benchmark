...
public final class Measurement_URI extends BaseGeneratedEMFQuerySpecification<Measurement_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Measurement_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Measurement_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measurement_URI.Match.parameterNames;
    }
    ...
    @Override
    public Measurement_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measurement_URI.Match)) {
          Measurement_URI.Match other = (Measurement_URI.Match) obj;
    ...
    @Override
    public Measurement_URI specification() {
      return Measurement_URI.instance();
    }
     ...
     * 
     */
    public static Measurement_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measurement_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Measurement_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Measurement_URI.Match {
    ...
    private static final class Immutable extends Measurement_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Measurement_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Measurement_URI.Match> {
    /**
     ...
     * 
     */
    public static Measurement_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measurement_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measurement_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Measurement_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Measurement_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Measurement_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super Measurement_URI.Match> processor) {
     ...
     * 
     */
    public Measurement_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return Measurement_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Measurement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Measurement_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Measurement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Measurement_URI.Match partialMatch) {
    ...
    @Override
    protected Measurement_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Measurement_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Measurement_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Measurement_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measurement_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measurement_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measurement_URI.Matcher> querySpecification() {
      return Measurement_URI.instance();
    }
  }
  
  private Measurement_URI() {
   ...
   * 
   */
  public static Measurement_URI instance() {
    try{
  ...
  @Override
  protected Measurement_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measurement_URI.Matcher.on(engine);
  }
  
  @Override
  public Measurement_URI.Matcher instantiate() {
    return Measurement_URI.Matcher.create();
  }
  
  @Override
  public Measurement_URI.Match newEmptyMatch() {
    return Measurement_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Measurement_URI.Match newMatch(final Object... parameters) {
    return Measurement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measurement_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measurement_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Measurement_URI INSTANCE = new Measurement_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measurement_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
