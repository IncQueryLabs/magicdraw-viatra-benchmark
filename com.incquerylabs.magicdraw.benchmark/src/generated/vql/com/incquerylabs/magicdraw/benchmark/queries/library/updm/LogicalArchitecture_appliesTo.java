...
public final class LogicalArchitecture_appliesTo extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_appliesTo.Match)) {
          LogicalArchitecture_appliesTo.Match other = (LogicalArchitecture_appliesTo.Match) obj;
    ...
    @Override
    public LogicalArchitecture_appliesTo specification() {
      return LogicalArchitecture_appliesTo.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static LogicalArchitecture_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends LogicalArchitecture_appliesTo.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super LogicalArchitecture_appliesTo.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return LogicalArchitecture_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final LogicalArchitecture_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final LogicalArchitecture_appliesTo.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected LogicalArchitecture_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_appliesTo.Matcher> querySpecification() {
      return LogicalArchitecture_appliesTo.instance();
    }
  }
  
  private LogicalArchitecture_appliesTo() {
   ...
   * 
   */
  public static LogicalArchitecture_appliesTo instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_appliesTo.Matcher instantiate() {
    return LogicalArchitecture_appliesTo.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_appliesTo.Match newEmptyMatch() {
    return LogicalArchitecture_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_appliesTo.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_appliesTo INSTANCE = new LogicalArchitecture_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
