...
public final class Function_URI extends BaseGeneratedEMFQuerySpecification<Function_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Function_URI.Match.parameterNames;
    }
    ...
    @Override
    public Function_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Function_URI.Match)) {
          Function_URI.Match other = (Function_URI.Match) obj;
    ...
    @Override
    public Function_URI specification() {
      return Function_URI.instance();
    }
     ...
     * 
     */
    public static Function_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Function_URI.Match newMutableMatch(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Function_URI.Match newMatch(final Activity pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Function_URI.Match {
    ...
    private static final class Immutable extends Function_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Function_URI.Match> {
    /**
     ...
     * 
     */
    public static Function_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Function_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Function_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Function_URI.Match> getAllMatches(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Function_URI.Match> streamAllMatches(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Function_URI.Match> getOneArbitraryMatch(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final LiteralString pValuespec, final Consumer<? super Function_URI.Match> processor) {
     ...
     * 
     */
    public Function_URI.Match newMatch(final Activity pElement, final LiteralString pValuespec) {
      return Function_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Function_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Function_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Function_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Function_URI.Match partialMatch) {
    ...
    @Override
    protected Function_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Function_URI.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Function_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Function_URI.Match.newMatch((Activity) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Function_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Function_URI.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Function_URI.Matcher> querySpecification() {
      return Function_URI.instance();
    }
  }
  
  private Function_URI() {
   ...
   * 
   */
  public static Function_URI instance() {
    try{
  ...
  @Override
  protected Function_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Function_URI.Matcher.on(engine);
  }
  
  @Override
  public Function_URI.Matcher instantiate() {
    return Function_URI.Matcher.create();
  }
  
  @Override
  public Function_URI.Match newEmptyMatch() {
    return Function_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Function_URI.Match newMatch(final Object... parameters) {
    return Function_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Function_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Function_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Function_URI INSTANCE = new Function_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Function_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
