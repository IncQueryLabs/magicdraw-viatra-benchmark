...
public final class SecurityControl_SatisfiedBy extends BaseGeneratedEMFQuerySpecification<SecurityControl_SatisfiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_SatisfiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_SatisfiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_SatisfiedBy.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_SatisfiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_SatisfiedBy.Match)) {
          SecurityControl_SatisfiedBy.Match other = (SecurityControl_SatisfiedBy.Match) obj;
    ...
    @Override
    public SecurityControl_SatisfiedBy specification() {
      return SecurityControl_SatisfiedBy.instance();
    }
     ...
     * 
     */
    public static SecurityControl_SatisfiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_SatisfiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static SecurityControl_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControl_SatisfiedBy.Match {
    ...
    private static final class Immutable extends SecurityControl_SatisfiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_SatisfiedBy pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_SatisfiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_SatisfiedBy.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_SatisfiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_SatisfiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_SatisfiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_SatisfiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<SecurityControl_SatisfiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<SecurityControl_SatisfiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super SecurityControl_SatisfiedBy.Match> processor) {
     ...
     * 
     */
    public SecurityControl_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return SecurityControl_SatisfiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final SecurityControl_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final SecurityControl_SatisfiedBy.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_SatisfiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControl_SatisfiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_SatisfiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_SatisfiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_SatisfiedBy.Matcher> querySpecification() {
      return SecurityControl_SatisfiedBy.instance();
    }
  }
  
  private SecurityControl_SatisfiedBy() {
   ...
   * 
   */
  public static SecurityControl_SatisfiedBy instance() {
    try{
  ...
  @Override
  protected SecurityControl_SatisfiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_SatisfiedBy.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_SatisfiedBy.Matcher instantiate() {
    return SecurityControl_SatisfiedBy.Matcher.create();
  }
  
  @Override
  public SecurityControl_SatisfiedBy.Match newEmptyMatch() {
    return SecurityControl_SatisfiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_SatisfiedBy.Match newMatch(final Object... parameters) {
    return SecurityControl_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_SatisfiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_SatisfiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_SatisfiedBy INSTANCE = new SecurityControl_SatisfiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_SatisfiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
