...
public final class EnterpriseGoal_benefits extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_benefits.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_benefits pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_benefits";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_benefits.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_benefits.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_benefits.Match)) {
          EnterpriseGoal_benefits.Match other = (EnterpriseGoal_benefits.Match) obj;
    ...
    @Override
    public EnterpriseGoal_benefits specification() {
      return EnterpriseGoal_benefits.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_benefits.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_benefits.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnterpriseGoal_benefits.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnterpriseGoal_benefits.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_benefits.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_benefits pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_benefits
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_benefits.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_benefits.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_benefits.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_benefits.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_benefits.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_benefits.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_benefits.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EnterpriseGoal_benefits.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_benefits.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EnterpriseGoal_benefits.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_benefits.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_benefits.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnterpriseGoal_benefits.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnterpriseGoal_benefits.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_benefits.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_benefits.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnterpriseGoal_benefits.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_benefits.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_benefits.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_benefits.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_benefits.Matcher> querySpecification() {
      return EnterpriseGoal_benefits.instance();
    }
  }
  
  private EnterpriseGoal_benefits() {
   ...
   * 
   */
  public static EnterpriseGoal_benefits instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_benefits.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_benefits.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_benefits.Matcher instantiate() {
    return EnterpriseGoal_benefits.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_benefits.Match newEmptyMatch() {
    return EnterpriseGoal_benefits.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_benefits.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_benefits.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_benefits} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_benefits#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_benefits INSTANCE = new EnterpriseGoal_benefits();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_benefits.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "benefits");
