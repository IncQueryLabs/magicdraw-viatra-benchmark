...
public final class ResourceMitigation_physicalLocation extends BaseGeneratedEMFQuerySpecification<ResourceMitigation_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceMitigation_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public ResourceMitigation_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceMitigation_physicalLocation.Match)) {
          ResourceMitigation_physicalLocation.Match other = (ResourceMitigation_physicalLocation.Match) obj;
    ...
    @Override
    public ResourceMitigation_physicalLocation specification() {
      return ResourceMitigation_physicalLocation.instance();
    }
     ...
     * 
     */
    public static ResourceMitigation_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceMitigation_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceMitigation_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceMitigation_physicalLocation.Match {
    ...
    private static final class Immutable extends ResourceMitigation_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see ResourceMitigation_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceMitigation_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static ResourceMitigation_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceMitigation_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceMitigation_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceMitigation_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceMitigation_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceMitigation_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceMitigation_physicalLocation.Match> processor) {
     ...
     * 
     */
    public ResourceMitigation_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceMitigation_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceMitigation_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceMitigation_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceMitigation_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceMitigation_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected ResourceMitigation_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceMitigation_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceMitigation_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceMitigation_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceMitigation_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceMitigation_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceMitigation_physicalLocation.Matcher> querySpecification() {
      return ResourceMitigation_physicalLocation.instance();
    }
  }
  
  private ResourceMitigation_physicalLocation() {
   ...
   * 
   */
  public static ResourceMitigation_physicalLocation instance() {
    try{
  ...
  @Override
  protected ResourceMitigation_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceMitigation_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public ResourceMitigation_physicalLocation.Matcher instantiate() {
    return ResourceMitigation_physicalLocation.Matcher.create();
  }
  
  @Override
  public ResourceMitigation_physicalLocation.Match newEmptyMatch() {
    return ResourceMitigation_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceMitigation_physicalLocation.Match newMatch(final Object... parameters) {
    return ResourceMitigation_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceMitigation_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceMitigation_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceMitigation_physicalLocation INSTANCE = new ResourceMitigation_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceMitigation_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
