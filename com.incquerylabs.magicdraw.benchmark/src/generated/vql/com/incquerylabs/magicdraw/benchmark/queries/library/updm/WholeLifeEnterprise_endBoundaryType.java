...
public final class WholeLifeEnterprise_endBoundaryType extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_endBoundaryType.Match)) {
          WholeLifeEnterprise_endBoundaryType.Match other = (WholeLifeEnterprise_endBoundaryType.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_endBoundaryType specification() {
      return WholeLifeEnterprise_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_endBoundaryType.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_endBoundaryType.Matcher> querySpecification() {
      return WholeLifeEnterprise_endBoundaryType.instance();
    }
  }
  
  private WholeLifeEnterprise_endBoundaryType() {
   ...
   * 
   */
  public static WholeLifeEnterprise_endBoundaryType instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_endBoundaryType.Matcher instantiate() {
    return WholeLifeEnterprise_endBoundaryType.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_endBoundaryType.Match newEmptyMatch() {
    return WholeLifeEnterprise_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_endBoundaryType.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_endBoundaryType INSTANCE = new WholeLifeEnterprise_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
