...
public final class System_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<System_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.System_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.System_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public System_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_requiredEnvironment.Match)) {
          System_requiredEnvironment.Match other = (System_requiredEnvironment.Match) obj;
    ...
    @Override
    public System_requiredEnvironment specification() {
      return System_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static System_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_requiredEnvironment.Match {
    ...
    private static final class Immutable extends System_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.System_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see System_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<System_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static System_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<System_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public System_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected System_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return System_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return System_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_requiredEnvironment.Matcher> querySpecification() {
      return System_requiredEnvironment.instance();
    }
  }
  
  private System_requiredEnvironment() {
   ...
   * 
   */
  public static System_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected System_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public System_requiredEnvironment.Matcher instantiate() {
    return System_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public System_requiredEnvironment.Match newEmptyMatch() {
    return System_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public System_requiredEnvironment.Match newMatch(final Object... parameters) {
    return System_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_requiredEnvironment INSTANCE = new System_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
