...
public final class ResourcePerformer_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ResourcePerformer_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourcePerformer_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public ResourcePerformer_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourcePerformer_isEncapsulated.Match)) {
          ResourcePerformer_isEncapsulated.Match other = (ResourcePerformer_isEncapsulated.Match) obj;
    ...
    @Override
    public ResourcePerformer_isEncapsulated specification() {
      return ResourcePerformer_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static ResourcePerformer_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourcePerformer_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ResourcePerformer_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourcePerformer_isEncapsulated.Match {
    ...
    private static final class Immutable extends ResourcePerformer_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see ResourcePerformer_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<ResourcePerformer_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static ResourcePerformer_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourcePerformer_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourcePerformer_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<ResourcePerformer_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ResourcePerformer_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ResourcePerformer_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ResourcePerformer_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ResourcePerformer_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ResourcePerformer_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourcePerformer_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourcePerformer_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ResourcePerformer_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ResourcePerformer_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected ResourcePerformer_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ResourcePerformer_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourcePerformer_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ResourcePerformer_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourcePerformer_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourcePerformer_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourcePerformer_isEncapsulated.Matcher> querySpecification() {
      return ResourcePerformer_isEncapsulated.instance();
    }
  }
  
  private ResourcePerformer_isEncapsulated() {
   ...
   * 
   */
  public static ResourcePerformer_isEncapsulated instance() {
    try{
  ...
  @Override
  protected ResourcePerformer_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourcePerformer_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public ResourcePerformer_isEncapsulated.Matcher instantiate() {
    return ResourcePerformer_isEncapsulated.Matcher.create();
  }
  
  @Override
  public ResourcePerformer_isEncapsulated.Match newEmptyMatch() {
    return ResourcePerformer_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public ResourcePerformer_isEncapsulated.Match newMatch(final Object... parameters) {
    return ResourcePerformer_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourcePerformer_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourcePerformer_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourcePerformer_isEncapsulated INSTANCE = new ResourcePerformer_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourcePerformer_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
