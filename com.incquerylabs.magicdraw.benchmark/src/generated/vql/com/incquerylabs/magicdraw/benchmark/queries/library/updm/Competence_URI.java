...
public final class Competence_URI extends BaseGeneratedEMFQuerySpecification<Competence_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Competence_URI.Match.parameterNames;
    }
    ...
    @Override
    public Competence_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Competence_URI.Match)) {
          Competence_URI.Match other = (Competence_URI.Match) obj;
    ...
    @Override
    public Competence_URI specification() {
      return Competence_URI.instance();
    }
     ...
     * 
     */
    public static Competence_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Competence_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Competence_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Competence_URI.Match {
    ...
    private static final class Immutable extends Competence_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Competence_URI.Match> {
    /**
     ...
     * 
     */
    public static Competence_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Competence_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Competence_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Competence_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Competence_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Competence_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Competence_URI.Match> processor) {
     ...
     * 
     */
    public Competence_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Competence_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Competence_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Competence_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Competence_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Competence_URI.Match partialMatch) {
    ...
    @Override
    protected Competence_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Competence_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Competence_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Competence_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Competence_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Competence_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Competence_URI.Matcher> querySpecification() {
      return Competence_URI.instance();
    }
  }
  
  private Competence_URI() {
   ...
   * 
   */
  public static Competence_URI instance() {
    try{
  ...
  @Override
  protected Competence_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Competence_URI.Matcher.on(engine);
  }
  
  @Override
  public Competence_URI.Matcher instantiate() {
    return Competence_URI.Matcher.create();
  }
  
  @Override
  public Competence_URI.Match newEmptyMatch() {
    return Competence_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Competence_URI.Match newMatch(final Object... parameters) {
    return Competence_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Competence_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Competence_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Competence_URI INSTANCE = new Competence_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Competence_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
