...
public final class EnvironmentProperty extends BaseGeneratedEMFQuerySpecification<EnvironmentProperty.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnvironmentProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnvironmentProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnvironmentProperty.Match.parameterNames;
    }
    ...
    @Override
    public EnvironmentProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnvironmentProperty.Match)) {
          EnvironmentProperty.Match other = (EnvironmentProperty.Match) obj;
    ...
    @Override
    public EnvironmentProperty specification() {
      return EnvironmentProperty.instance();
    }
     ...
     * 
     */
    public static EnvironmentProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnvironmentProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static EnvironmentProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends EnvironmentProperty.Match {
    ...
    private static final class Immutable extends EnvironmentProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnvironmentProperty pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<EnvironmentProperty.Match> {
    /**
     ...
     * 
     */
    public static EnvironmentProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnvironmentProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnvironmentProperty.Matcher.class);
     ...
     * 
     */
    public Collection<EnvironmentProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<EnvironmentProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<EnvironmentProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super EnvironmentProperty.Match> processor) {
     ...
     * 
     */
    public EnvironmentProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return EnvironmentProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EnvironmentProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EnvironmentProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final EnvironmentProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final EnvironmentProperty.Match partialMatch) {
    ...
    @Override
    protected EnvironmentProperty.Match tupleToMatch(final Tuple t) {
      try {
          return EnvironmentProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected EnvironmentProperty.Match arrayToMatch(final Object[] match) {
      try {
          return EnvironmentProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnvironmentProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnvironmentProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnvironmentProperty.Matcher> querySpecification() {
      return EnvironmentProperty.instance();
    }
  }
   ...
   * 
   */
  public static EnvironmentProperty instance() {
    try{
  ...
  @Override
  protected EnvironmentProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnvironmentProperty.Matcher.on(engine);
  }
  
  @Override
  public EnvironmentProperty.Matcher instantiate() {
    return EnvironmentProperty.Matcher.create();
  }
  
  @Override
  public EnvironmentProperty.Match newEmptyMatch() {
    return EnvironmentProperty.Match.newEmptyMatch();
  }
  
  @Override
  public EnvironmentProperty.Match newMatch(final Object... parameters) {
    return EnvironmentProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnvironmentProperty} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnvironmentProperty#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnvironmentProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "EnvironmentProperty")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "EnvironmentProperty");
