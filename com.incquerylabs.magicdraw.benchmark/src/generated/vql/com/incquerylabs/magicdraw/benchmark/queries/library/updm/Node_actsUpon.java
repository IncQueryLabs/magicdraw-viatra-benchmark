...
public final class Node_actsUpon extends BaseGeneratedEMFQuerySpecification<Node_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public Node_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_actsUpon.Match)) {
          Node_actsUpon.Match other = (Node_actsUpon.Match) obj;
    ...
    @Override
    public Node_actsUpon specification() {
      return Node_actsUpon.instance();
    }
     ...
     * 
     */
    public static Node_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Node_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_actsUpon.Match {
    ...
    private static final class Immutable extends Node_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_actsUpon pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Node_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static Node_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<Node_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Node_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Node_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Node_actsUpon.Match> processor) {
     ...
     * 
     */
    public Node_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Node_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Node_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Node_actsUpon.Match partialMatch) {
    ...
    @Override
    protected Node_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return Node_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return Node_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_actsUpon.Matcher> querySpecification() {
      return Node_actsUpon.instance();
    }
  }
  
  private Node_actsUpon() {
   ...
   * 
   */
  public static Node_actsUpon instance() {
    try{
  ...
  @Override
  protected Node_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public Node_actsUpon.Matcher instantiate() {
    return Node_actsUpon.Matcher.create();
  }
  
  @Override
  public Node_actsUpon.Match newEmptyMatch() {
    return Node_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public Node_actsUpon.Match newMatch(final Object... parameters) {
    return Node_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_actsUpon INSTANCE = new Node_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
