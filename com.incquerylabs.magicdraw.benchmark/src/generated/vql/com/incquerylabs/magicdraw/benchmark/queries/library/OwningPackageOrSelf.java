...
public final class OwningPackageOrSelf extends BaseGeneratedEMFQuerySpecification<OwningPackageOrSelf.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.owningPackageOrSelf pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.owningPackageOrSelf";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.owningPackageOrSelf pattern,
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find owningPackage *(Element, Owner)
          new BinaryReflexiveTransitiveClosure(body, Tuples.flatTupleOf(var_Element, var_Owner), OwningPackage.instance().getInternalQueryRepresentation(), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Package")));
          bodies.add(body);
      }
      return bodies;
    }
