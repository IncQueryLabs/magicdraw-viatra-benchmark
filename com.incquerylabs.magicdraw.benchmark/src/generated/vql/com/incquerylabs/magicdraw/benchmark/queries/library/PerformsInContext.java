...
public final class PerformsInContext extends BaseGeneratedEMFQuerySpecification<PerformsInContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformsInContext.Match.parameterNames;
    }
    ...
    @Override
    public PerformsInContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformsInContext.Match)) {
          PerformsInContext.Match other = (PerformsInContext.Match) obj;
    ...
    @Override
    public PerformsInContext specification() {
      return PerformsInContext.instance();
    }
     ...
     * 
     */
    public static PerformsInContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformsInContext.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static PerformsInContext.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends PerformsInContext.Match {
    ...
    private static final class Immutable extends PerformsInContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext pattern,
   ...
   * 
   * @see Match
   * @see PerformsInContext
   * 
   */
  public static class Matcher extends BaseMatcher<PerformsInContext.Match> {
    /**
     ...
     * 
     */
    public static PerformsInContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformsInContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformsInContext.Matcher.class);
     ...
     * 
     */
    public Collection<PerformsInContext.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<PerformsInContext.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<PerformsInContext.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super PerformsInContext.Match> processor) {
     ...
     * 
     */
    public PerformsInContext.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return PerformsInContext.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final PerformsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final PerformsInContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final PerformsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final PerformsInContext.Match partialMatch) {
    ...
    @Override
    protected PerformsInContext.Match tupleToMatch(final Tuple t) {
      try {
          return PerformsInContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected PerformsInContext.Match arrayToMatch(final Object[] match) {
      try {
          return PerformsInContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformsInContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformsInContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformsInContext.Matcher> querySpecification() {
      return PerformsInContext.instance();
    }
  }
  
  private PerformsInContext() {
   ...
   * 
   */
  public static PerformsInContext instance() {
    try{
  ...
  @Override
  protected PerformsInContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformsInContext.Matcher.on(engine);
  }
  
  @Override
  public PerformsInContext.Matcher instantiate() {
    return PerformsInContext.Matcher.create();
  }
  
  @Override
  public PerformsInContext.Match newEmptyMatch() {
    return PerformsInContext.Match.newEmptyMatch();
  }
  
  @Override
  public PerformsInContext.Match newMatch(final Object... parameters) {
    return PerformsInContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PerformsInContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PerformsInContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformsInContext INSTANCE = new PerformsInContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformsInContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "PerformsInContext")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "PerformsInContext");
