...
public final class ServiceAccess_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ServiceAccess_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_endBoundaryType.Match)) {
          ServiceAccess_endBoundaryType.Match other = (ServiceAccess_endBoundaryType.Match) obj;
    ...
    @Override
    public ServiceAccess_endBoundaryType specification() {
      return ServiceAccess_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_endBoundaryType.Match {
    ...
    private static final class Immutable extends ServiceAccess_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_endBoundaryType.Matcher> querySpecification() {
      return ServiceAccess_endBoundaryType.instance();
    }
  }
  
  private ServiceAccess_endBoundaryType() {
   ...
   * 
   */
  public static ServiceAccess_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ServiceAccess_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_endBoundaryType.Matcher instantiate() {
    return ServiceAccess_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ServiceAccess_endBoundaryType.Match newEmptyMatch() {
    return ServiceAccess_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_endBoundaryType.Match newMatch(final Object... parameters) {
    return ServiceAccess_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_endBoundaryType INSTANCE = new ServiceAccess_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
