...
public final class BlockValuePropertyNotComposite extends BaseGeneratedEMFQuerySpecification<BlockValuePropertyNotComposite.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.BlockValuePropertyNotComposite (visibility: PUBLIC, simpleName: BlockValuePropertyNotComposite, identifier: com.incquerylabs.magicdraw.benchmark.queries.BlockValuePropertyNotComposite, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private class EmbeddedQuery486053876 extends BaseGeneratedEMFPQuery {
      ...
      public EmbeddedQuery486053876() {
        super(PVisibility.EMBEDDED);
      }
      
      @Override
      public String getFullyQualifiedName() {
        return GeneratedPQuery.this.getFullyQualifiedName() + "$486053876";
      }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new NegativePatternCall(body, Tuples.flatTupleOf(var_property, var__virtual_2_), new BlockValuePropertyNotComposite.GeneratedPQuery.EmbeddedQuery486053876());
          bodies.add(body);
      }
      return bodies;
    }
