...
import com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource;
...
public final class KnownResource_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<KnownResource_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_isStandardConfiguration.Match)) {
          KnownResource_isStandardConfiguration.Match other = (KnownResource_isStandardConfiguration.Match) obj;
    ...
    @Override
    public KnownResource_isStandardConfiguration specification() {
      return KnownResource_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static KnownResource_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static KnownResource_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends KnownResource_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends KnownResource_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<KnownResource_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<KnownResource_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super KnownResource_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public KnownResource_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return KnownResource_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final KnownResource_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final KnownResource_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final KnownResource_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final KnownResource_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected KnownResource_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected KnownResource_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_isStandardConfiguration.Matcher> querySpecification() {
      return KnownResource_isStandardConfiguration.instance();
    }
  }
  
  private KnownResource_isStandardConfiguration() {
   ...
   * 
   */
  public static KnownResource_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected KnownResource_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_isStandardConfiguration.Matcher instantiate() {
    return KnownResource_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public KnownResource_isStandardConfiguration.Match newEmptyMatch() {
    return KnownResource_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return KnownResource_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_isStandardConfiguration INSTANCE = new KnownResource_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find KnownResource(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), KnownResource.instance().getInternalQueryRepresentation());
