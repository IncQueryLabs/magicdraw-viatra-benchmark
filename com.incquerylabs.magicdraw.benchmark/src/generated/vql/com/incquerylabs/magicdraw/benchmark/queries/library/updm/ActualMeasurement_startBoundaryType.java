...
public final class ActualMeasurement_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ActualMeasurement_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualMeasurement_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ActualMeasurement_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualMeasurement_startBoundaryType.Match)) {
          ActualMeasurement_startBoundaryType.Match other = (ActualMeasurement_startBoundaryType.Match) obj;
    ...
    @Override
    public ActualMeasurement_startBoundaryType specification() {
      return ActualMeasurement_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ActualMeasurement_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualMeasurement_startBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualMeasurement_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualMeasurement_startBoundaryType.Match {
    ...
    private static final class Immutable extends ActualMeasurement_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ActualMeasurement_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ActualMeasurement_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ActualMeasurement_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualMeasurement_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualMeasurement_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ActualMeasurement_startBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualMeasurement_startBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualMeasurement_startBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualMeasurement_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ActualMeasurement_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualMeasurement_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualMeasurement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualMeasurement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualMeasurement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualMeasurement_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ActualMeasurement_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ActualMeasurement_startBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualMeasurement_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ActualMeasurement_startBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualMeasurement_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualMeasurement_startBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualMeasurement_startBoundaryType.Matcher> querySpecification() {
      return ActualMeasurement_startBoundaryType.instance();
    }
  }
  
  private ActualMeasurement_startBoundaryType() {
   ...
   * 
   */
  public static ActualMeasurement_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ActualMeasurement_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualMeasurement_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ActualMeasurement_startBoundaryType.Matcher instantiate() {
    return ActualMeasurement_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ActualMeasurement_startBoundaryType.Match newEmptyMatch() {
    return ActualMeasurement_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ActualMeasurement_startBoundaryType.Match newMatch(final Object... parameters) {
    return ActualMeasurement_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualMeasurement_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualMeasurement_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualMeasurement_startBoundaryType INSTANCE = new ActualMeasurement_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualMeasurement_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
