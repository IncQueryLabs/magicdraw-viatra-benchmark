...
public final class CapableElement_conformsTo extends BaseGeneratedEMFQuerySpecification<CapableElement_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapableElement_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public CapableElement_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapableElement_conformsTo.Match)) {
          CapableElement_conformsTo.Match other = (CapableElement_conformsTo.Match) obj;
    ...
    @Override
    public CapableElement_conformsTo specification() {
      return CapableElement_conformsTo.instance();
    }
     ...
     * 
     */
    public static CapableElement_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapableElement_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapableElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapableElement_conformsTo.Match {
    ...
    private static final class Immutable extends CapableElement_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see CapableElement_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<CapableElement_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static CapableElement_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapableElement_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapableElement_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<CapableElement_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapableElement_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapableElement_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapableElement_conformsTo.Match> processor) {
     ...
     * 
     */
    public CapableElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapableElement_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapableElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapableElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapableElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapableElement_conformsTo.Match partialMatch) {
    ...
    @Override
    protected CapableElement_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return CapableElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapableElement_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return CapableElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapableElement_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapableElement_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapableElement_conformsTo.Matcher> querySpecification() {
      return CapableElement_conformsTo.instance();
    }
  }
  
  private CapableElement_conformsTo() {
   ...
   * 
   */
  public static CapableElement_conformsTo instance() {
    try{
  ...
  @Override
  protected CapableElement_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapableElement_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public CapableElement_conformsTo.Matcher instantiate() {
    return CapableElement_conformsTo.Matcher.create();
  }
  
  @Override
  public CapableElement_conformsTo.Match newEmptyMatch() {
    return CapableElement_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public CapableElement_conformsTo.Match newMatch(final Object... parameters) {
    return CapableElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapableElement_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapableElement_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapableElement_conformsTo INSTANCE = new CapableElement_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapableElement_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
