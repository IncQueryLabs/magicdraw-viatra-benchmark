...
public final class ConceptRole_URI extends BaseGeneratedEMFQuerySpecification<ConceptRole_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptRole_URI.Match.parameterNames;
    }
    ...
    @Override
    public ConceptRole_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptRole_URI.Match)) {
          ConceptRole_URI.Match other = (ConceptRole_URI.Match) obj;
    ...
    @Override
    public ConceptRole_URI specification() {
      return ConceptRole_URI.instance();
    }
     ...
     * 
     */
    public static ConceptRole_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptRole_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ConceptRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ConceptRole_URI.Match {
    ...
    private static final class Immutable extends ConceptRole_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptRole_URI.Match> {
    /**
     ...
     * 
     */
    public static ConceptRole_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptRole_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptRole_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptRole_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ConceptRole_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ConceptRole_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ConceptRole_URI.Match> processor) {
     ...
     * 
     */
    public ConceptRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ConceptRole_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConceptRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConceptRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ConceptRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ConceptRole_URI.Match partialMatch) {
    ...
    @Override
    protected ConceptRole_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptRole_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ConceptRole_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptRole_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptRole_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptRole_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptRole_URI.Matcher> querySpecification() {
      return ConceptRole_URI.instance();
    }
  }
  
  private ConceptRole_URI() {
   ...
   * 
   */
  public static ConceptRole_URI instance() {
    try{
  ...
  @Override
  protected ConceptRole_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptRole_URI.Matcher.on(engine);
  }
  
  @Override
  public ConceptRole_URI.Matcher instantiate() {
    return ConceptRole_URI.Matcher.create();
  }
  
  @Override
  public ConceptRole_URI.Match newEmptyMatch() {
    return ConceptRole_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptRole_URI.Match newMatch(final Object... parameters) {
    return ConceptRole_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptRole_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptRole_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptRole_URI INSTANCE = new ConceptRole_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptRole_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
