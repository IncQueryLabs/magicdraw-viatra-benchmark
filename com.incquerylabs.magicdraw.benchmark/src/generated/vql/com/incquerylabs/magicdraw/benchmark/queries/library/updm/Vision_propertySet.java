...
public final class Vision_propertySet extends BaseGeneratedEMFQuerySpecification<Vision_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Vision_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Vision_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Vision_propertySet.Match)) {
          Vision_propertySet.Match other = (Vision_propertySet.Match) obj;
    ...
    @Override
    public Vision_propertySet specification() {
      return Vision_propertySet.instance();
    }
     ...
     * 
     */
    public static Vision_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Vision_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Vision_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Vision_propertySet.Match {
    ...
    private static final class Immutable extends Vision_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Vision_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Vision_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Vision_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Vision_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Vision_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Vision_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Vision_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Vision_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Vision_propertySet.Match> processor) {
     ...
     * 
     */
    public Vision_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Vision_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Vision_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Vision_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Vision_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Vision_propertySet.Match partialMatch) {
    ...
    @Override
    protected Vision_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Vision_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Vision_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Vision_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Vision_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Vision_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Vision_propertySet.Matcher> querySpecification() {
      return Vision_propertySet.instance();
    }
  }
  
  private Vision_propertySet() {
   ...
   * 
   */
  public static Vision_propertySet instance() {
    try{
  ...
  @Override
  protected Vision_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Vision_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Vision_propertySet.Matcher instantiate() {
    return Vision_propertySet.Matcher.create();
  }
  
  @Override
  public Vision_propertySet.Match newEmptyMatch() {
    return Vision_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Vision_propertySet.Match newMatch(final Object... parameters) {
    return Vision_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Vision_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Vision_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Vision_propertySet INSTANCE = new Vision_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Vision_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
