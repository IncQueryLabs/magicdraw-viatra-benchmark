...
public final class KnownResource_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<KnownResource_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_requiredEnvironment.Match)) {
          KnownResource_requiredEnvironment.Match other = (KnownResource_requiredEnvironment.Match) obj;
    ...
    @Override
    public KnownResource_requiredEnvironment specification() {
      return KnownResource_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static KnownResource_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_requiredEnvironment.Match {
    ...
    private static final class Immutable extends KnownResource_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super KnownResource_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public KnownResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return KnownResource_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final KnownResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final KnownResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected KnownResource_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_requiredEnvironment.Matcher> querySpecification() {
      return KnownResource_requiredEnvironment.instance();
    }
  }
  
  private KnownResource_requiredEnvironment() {
   ...
   * 
   */
  public static KnownResource_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected KnownResource_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_requiredEnvironment.Matcher instantiate() {
    return KnownResource_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public KnownResource_requiredEnvironment.Match newEmptyMatch() {
    return KnownResource_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_requiredEnvironment.Match newMatch(final Object... parameters) {
    return KnownResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_requiredEnvironment INSTANCE = new KnownResource_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
