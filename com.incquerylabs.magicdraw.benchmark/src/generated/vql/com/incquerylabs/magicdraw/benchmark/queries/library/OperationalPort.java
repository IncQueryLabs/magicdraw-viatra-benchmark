...
public final class OperationalPort extends BaseGeneratedEMFQuerySpecification<OperationalPort.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPort pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPort";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalPort.Match.parameterNames;
    }
    ...
    @Override
    public OperationalPort.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalPort.Match)) {
          OperationalPort.Match other = (OperationalPort.Match) obj;
    ...
    @Override
    public OperationalPort specification() {
      return OperationalPort.instance();
    }
     ...
     * 
     */
    public static OperationalPort.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalPort.Match newMutableMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalPort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalPort.Match {
    ...
    private static final class Immutable extends OperationalPort.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPort pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalPort.Match> {
    /**
     ...
     * 
     */
    public static OperationalPort.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalPort.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalPort.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalPort.Match> getAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalPort.Match> streamAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalPort.Match> getOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalPort.Match> processor) {
     ...
     * 
     */
    public OperationalPort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalPort.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final OperationalPort.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final OperationalPort.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalPort.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalPort.Match partialMatch) {
    ...
    @Override
    protected OperationalPort.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalPort.Match.newMatch((Port) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalPort.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalPort.Match.newMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalPort.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalPort.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalPort.Matcher> querySpecification() {
      return OperationalPort.instance();
    }
  }
  
  private OperationalPort() {
   ...
   * 
   */
  public static OperationalPort instance() {
    try{
  ...
  @Override
  protected OperationalPort.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalPort.Matcher.on(engine);
  }
  
  @Override
  public OperationalPort.Matcher instantiate() {
    return OperationalPort.Matcher.create();
  }
  
  @Override
  public OperationalPort.Match newEmptyMatch() {
    return OperationalPort.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalPort.Match newMatch(final Object... parameters) {
    return OperationalPort.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalPort} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalPort#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalPort INSTANCE = new OperationalPort();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalPort.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalPort")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalPort");
