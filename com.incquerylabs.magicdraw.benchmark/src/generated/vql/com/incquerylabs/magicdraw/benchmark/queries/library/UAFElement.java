...
public final class UAFElement extends BaseGeneratedEMFQuerySpecification<UAFElement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.UAFElement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.UAFElement";
    }
    
    @Override
    public List<String> parameterNames() {
      return UAFElement.Match.parameterNames;
    }
    ...
    @Override
    public UAFElement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof UAFElement.Match)) {
          UAFElement.Match other = (UAFElement.Match) obj;
    ...
    @Override
    public UAFElement specification() {
      return UAFElement.instance();
    }
     ...
     * 
     */
    public static UAFElement.Match newEmptyMatch() {
     ...
     * 
     */
    public static UAFElement.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static UAFElement.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends UAFElement.Match {
    ...
    private static final class Immutable extends UAFElement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.UAFElement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<UAFElement.Match> {
    /**
     ...
     * 
     */
    public static UAFElement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static UAFElement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(UAFElement.Matcher.class);
     ...
     * 
     */
    public Collection<UAFElement.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<UAFElement.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<UAFElement.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super UAFElement.Match> processor) {
     ...
     * 
     */
    public UAFElement.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return UAFElement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final UAFElement.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final UAFElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final UAFElement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final UAFElement.Match partialMatch) {
    ...
    @Override
    protected UAFElement.Match tupleToMatch(final Tuple t) {
      try {
          return UAFElement.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected UAFElement.Match arrayToMatch(final Object[] match) {
      try {
          return UAFElement.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected UAFElement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return UAFElement.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<UAFElement.Matcher> querySpecification() {
      return UAFElement.instance();
    }
  }
   ...
   * 
   */
  public static UAFElement instance() {
    try{
  ...
  @Override
  protected UAFElement.Matcher instantiate(final ViatraQueryEngine engine) {
    return UAFElement.Matcher.on(engine);
  }
  
  @Override
  public UAFElement.Matcher instantiate() {
    return UAFElement.Matcher.create();
  }
  
  @Override
  public UAFElement.Match newEmptyMatch() {
    return UAFElement.Match.newEmptyMatch();
  }
  
  @Override
  public UAFElement.Match newMatch(final Object... parameters) {
    return UAFElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link UAFElement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link UAFElement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final UAFElement INSTANCE = new UAFElement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final UAFElement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "UAFElement")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "UAFElement");
