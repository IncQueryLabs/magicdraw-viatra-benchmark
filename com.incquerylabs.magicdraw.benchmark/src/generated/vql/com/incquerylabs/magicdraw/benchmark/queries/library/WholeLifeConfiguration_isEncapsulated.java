...
public final class WholeLifeConfiguration_isEncapsulated extends BaseGeneratedEMFQuerySpecification<WholeLifeConfiguration_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeConfiguration_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeConfiguration_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeConfiguration_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeConfiguration_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeConfiguration_isEncapsulated.Match)) {
          WholeLifeConfiguration_isEncapsulated.Match other = (WholeLifeConfiguration_isEncapsulated.Match) obj;
    ...
    @Override
    public WholeLifeConfiguration_isEncapsulated specification() {
      return WholeLifeConfiguration_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static WholeLifeConfiguration_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeConfiguration_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static WholeLifeConfiguration_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends WholeLifeConfiguration_isEncapsulated.Match {
    ...
    private static final class Immutable extends WholeLifeConfiguration_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeConfiguration_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeConfiguration_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeConfiguration_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeConfiguration_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeConfiguration_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeConfiguration_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeConfiguration_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<WholeLifeConfiguration_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<WholeLifeConfiguration_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super WholeLifeConfiguration_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public WholeLifeConfiguration_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return WholeLifeConfiguration_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeConfiguration_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeConfiguration_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final WholeLifeConfiguration_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final WholeLifeConfiguration_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected WholeLifeConfiguration_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeConfiguration_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected WholeLifeConfiguration_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeConfiguration_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeConfiguration_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeConfiguration_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeConfiguration_isEncapsulated.Matcher> querySpecification() {
      return WholeLifeConfiguration_isEncapsulated.instance();
    }
  }
  
  private WholeLifeConfiguration_isEncapsulated() {
   ...
   * 
   */
  public static WholeLifeConfiguration_isEncapsulated instance() {
    try{
  ...
  @Override
  protected WholeLifeConfiguration_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeConfiguration_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeConfiguration_isEncapsulated.Matcher instantiate() {
    return WholeLifeConfiguration_isEncapsulated.Matcher.create();
  }
  
  @Override
  public WholeLifeConfiguration_isEncapsulated.Match newEmptyMatch() {
    return WholeLifeConfiguration_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeConfiguration_isEncapsulated.Match newMatch(final Object... parameters) {
    return WholeLifeConfiguration_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeConfiguration_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeConfiguration_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeConfiguration_isEncapsulated INSTANCE = new WholeLifeConfiguration_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeConfiguration_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
