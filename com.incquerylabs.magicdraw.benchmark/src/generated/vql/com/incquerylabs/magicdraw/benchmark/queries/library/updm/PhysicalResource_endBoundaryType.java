...
public final class PhysicalResource_endBoundaryType extends BaseGeneratedEMFQuerySpecification<PhysicalResource_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_endBoundaryType.Match)) {
          PhysicalResource_endBoundaryType.Match other = (PhysicalResource_endBoundaryType.Match) obj;
    ...
    @Override
    public PhysicalResource_endBoundaryType specification() {
      return PhysicalResource_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_endBoundaryType.Match {
    ...
    private static final class Immutable extends PhysicalResource_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_endBoundaryType.Matcher> querySpecification() {
      return PhysicalResource_endBoundaryType.instance();
    }
  }
  
  private PhysicalResource_endBoundaryType() {
   ...
   * 
   */
  public static PhysicalResource_endBoundaryType instance() {
    try{
  ...
  @Override
  protected PhysicalResource_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_endBoundaryType.Matcher instantiate() {
    return PhysicalResource_endBoundaryType.Matcher.create();
  }
  
  @Override
  public PhysicalResource_endBoundaryType.Match newEmptyMatch() {
    return PhysicalResource_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_endBoundaryType.Match newMatch(final Object... parameters) {
    return PhysicalResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_endBoundaryType INSTANCE = new PhysicalResource_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
