...
public final class Competence_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Competence_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Competence_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Competence_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Competence_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Competence_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Competence_isEncapsulated.Match)) {
          Competence_isEncapsulated.Match other = (Competence_isEncapsulated.Match) obj;
    ...
    @Override
    public Competence_isEncapsulated specification() {
      return Competence_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Competence_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Competence_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Competence_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Competence_isEncapsulated.Match {
    ...
    private static final class Immutable extends Competence_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Competence_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Competence_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Competence_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Competence_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Competence_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Competence_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Competence_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Competence_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Competence_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Competence_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Competence_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Competence_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Competence_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Competence_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Competence_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Competence_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Competence_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Competence_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Competence_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Competence_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Competence_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Competence_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Competence_isEncapsulated.Matcher> querySpecification() {
      return Competence_isEncapsulated.instance();
    }
  }
  
  private Competence_isEncapsulated() {
   ...
   * 
   */
  public static Competence_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Competence_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Competence_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Competence_isEncapsulated.Matcher instantiate() {
    return Competence_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Competence_isEncapsulated.Match newEmptyMatch() {
    return Competence_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Competence_isEncapsulated.Match newMatch(final Object... parameters) {
    return Competence_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Competence_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Competence_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Competence_isEncapsulated INSTANCE = new Competence_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Competence_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
