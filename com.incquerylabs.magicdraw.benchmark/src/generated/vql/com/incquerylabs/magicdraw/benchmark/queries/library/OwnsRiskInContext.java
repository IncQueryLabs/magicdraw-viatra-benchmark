...
public final class OwnsRiskInContext extends BaseGeneratedEMFQuerySpecification<OwnsRiskInContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRiskInContext.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRiskInContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRiskInContext.Match)) {
          OwnsRiskInContext.Match other = (OwnsRiskInContext.Match) obj;
    ...
    @Override
    public OwnsRiskInContext specification() {
      return OwnsRiskInContext.instance();
    }
     ...
     * 
     */
    public static OwnsRiskInContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRiskInContext.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OwnsRiskInContext.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OwnsRiskInContext.Match {
    ...
    private static final class Immutable extends OwnsRiskInContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext pattern,
   ...
   * 
   * @see Match
   * @see OwnsRiskInContext
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRiskInContext.Match> {
    /**
     ...
     * 
     */
    public static OwnsRiskInContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRiskInContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRiskInContext.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRiskInContext.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OwnsRiskInContext.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OwnsRiskInContext.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OwnsRiskInContext.Match> processor) {
     ...
     * 
     */
    public OwnsRiskInContext.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OwnsRiskInContext.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRiskInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRiskInContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OwnsRiskInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OwnsRiskInContext.Match partialMatch) {
    ...
    @Override
    protected OwnsRiskInContext.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRiskInContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OwnsRiskInContext.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRiskInContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRiskInContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRiskInContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRiskInContext.Matcher> querySpecification() {
      return OwnsRiskInContext.instance();
    }
  }
  
  private OwnsRiskInContext() {
   ...
   * 
   */
  public static OwnsRiskInContext instance() {
    try{
  ...
  @Override
  protected OwnsRiskInContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRiskInContext.Matcher.on(engine);
  }
  
  @Override
  public OwnsRiskInContext.Matcher instantiate() {
    return OwnsRiskInContext.Matcher.create();
  }
  
  @Override
  public OwnsRiskInContext.Match newEmptyMatch() {
    return OwnsRiskInContext.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRiskInContext.Match newMatch(final Object... parameters) {
    return OwnsRiskInContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRiskInContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRiskInContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRiskInContext INSTANCE = new OwnsRiskInContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRiskInContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OwnsRiskInContext")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OwnsRiskInContext");
