...
public final class Organization_propertySet extends BaseGeneratedEMFQuerySpecification<Organization_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Organization_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_propertySet.Match)) {
          Organization_propertySet.Match other = (Organization_propertySet.Match) obj;
    ...
    @Override
    public Organization_propertySet specification() {
      return Organization_propertySet.instance();
    }
     ...
     * 
     */
    public static Organization_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_propertySet.Match {
    ...
    private static final class Immutable extends Organization_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Organization_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Organization_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_propertySet.Match> processor) {
     ...
     * 
     */
    public Organization_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_propertySet.Match partialMatch) {
    ...
    @Override
    protected Organization_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_propertySet.Matcher> querySpecification() {
      return Organization_propertySet.instance();
    }
  }
  
  private Organization_propertySet() {
   ...
   * 
   */
  public static Organization_propertySet instance() {
    try{
  ...
  @Override
  protected Organization_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Organization_propertySet.Matcher instantiate() {
    return Organization_propertySet.Matcher.create();
  }
  
  @Override
  public Organization_propertySet.Match newEmptyMatch() {
    return Organization_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_propertySet.Match newMatch(final Object... parameters) {
    return Organization_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_propertySet INSTANCE = new Organization_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
