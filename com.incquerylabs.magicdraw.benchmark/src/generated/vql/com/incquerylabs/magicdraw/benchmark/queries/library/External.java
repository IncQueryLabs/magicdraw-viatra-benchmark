 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "External");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class External extends BaseGeneratedEMFQuerySpecification<External.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.External pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.External";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.External pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link External} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link External#instance()}.
   * 
