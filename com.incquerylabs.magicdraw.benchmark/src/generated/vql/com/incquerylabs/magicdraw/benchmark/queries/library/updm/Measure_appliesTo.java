...
public final class Measure_appliesTo extends BaseGeneratedEMFQuerySpecification<Measure_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measure_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measure_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measure_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Measure_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measure_appliesTo.Match)) {
          Measure_appliesTo.Match other = (Measure_appliesTo.Match) obj;
    ...
    @Override
    public Measure_appliesTo specification() {
      return Measure_appliesTo.instance();
    }
     ...
     * 
     */
    public static Measure_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measure_appliesTo.Match newMutableMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public static Measure_appliesTo.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Measure_appliesTo.Match {
    ...
    private static final class Immutable extends Measure_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measure_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Measure_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Measure_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Measure_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measure_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measure_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Measure_appliesTo.Match> getAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Measure_appliesTo.Match> streamAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Measure_appliesTo.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue, final Consumer<? super Measure_appliesTo.Match> processor) {
     ...
     * 
     */
    public Measure_appliesTo.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return Measure_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Measure_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Measure_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Measure_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Measure_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Measure_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Measure_appliesTo.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Measure_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Measure_appliesTo.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measure_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measure_appliesTo.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measure_appliesTo.Matcher> querySpecification() {
      return Measure_appliesTo.instance();
    }
  }
  
  private Measure_appliesTo() {
   ...
   * 
   */
  public static Measure_appliesTo instance() {
    try{
  ...
  @Override
  protected Measure_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measure_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Measure_appliesTo.Matcher instantiate() {
    return Measure_appliesTo.Matcher.create();
  }
  
  @Override
  public Measure_appliesTo.Match newEmptyMatch() {
    return Measure_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Measure_appliesTo.Match newMatch(final Object... parameters) {
    return Measure_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measure_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measure_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Measure_appliesTo INSTANCE = new Measure_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measure_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
