...
public final class Mission_propertySet extends BaseGeneratedEMFQuerySpecification<Mission_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Mission_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Mission_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Mission_propertySet.Match)) {
          Mission_propertySet.Match other = (Mission_propertySet.Match) obj;
    ...
    @Override
    public Mission_propertySet specification() {
      return Mission_propertySet.instance();
    }
     ...
     * 
     */
    public static Mission_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Mission_propertySet.Match newMutableMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public static Mission_propertySet.Match newMatch(final Activity pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Mission_propertySet.Match {
    ...
    private static final class Immutable extends Mission_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Mission_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Mission_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Mission_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Mission_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Mission_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Mission_propertySet.Match> getAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Mission_propertySet.Match> streamAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Mission_propertySet.Match> getOneArbitraryMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final Element pValue, final Consumer<? super Mission_propertySet.Match> processor) {
     ...
     * 
     */
    public Mission_propertySet.Match newMatch(final Activity pElement, final Element pValue) {
      return Mission_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Mission_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Mission_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Mission_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Mission_propertySet.Match partialMatch) {
    ...
    @Override
    protected Mission_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Mission_propertySet.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Mission_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Mission_propertySet.Match.newMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Mission_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Mission_propertySet.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Mission_propertySet.Matcher> querySpecification() {
      return Mission_propertySet.instance();
    }
  }
  
  private Mission_propertySet() {
   ...
   * 
   */
  public static Mission_propertySet instance() {
    try{
  ...
  @Override
  protected Mission_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Mission_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Mission_propertySet.Matcher instantiate() {
    return Mission_propertySet.Matcher.create();
  }
  
  @Override
  public Mission_propertySet.Match newEmptyMatch() {
    return Mission_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Mission_propertySet.Match newMatch(final Object... parameters) {
    return Mission_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Mission_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Mission_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Mission_propertySet INSTANCE = new Mission_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Mission_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
