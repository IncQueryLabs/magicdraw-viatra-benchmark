...
public final class PhysicalArchitecture_physicalLocation extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_physicalLocation.Match)) {
          PhysicalArchitecture_physicalLocation.Match other = (PhysicalArchitecture_physicalLocation.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_physicalLocation specification() {
      return PhysicalArchitecture_physicalLocation.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_physicalLocation.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_physicalLocation.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_physicalLocation.Matcher> querySpecification() {
      return PhysicalArchitecture_physicalLocation.instance();
    }
  }
  
  private PhysicalArchitecture_physicalLocation() {
   ...
   * 
   */
  public static PhysicalArchitecture_physicalLocation instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_physicalLocation.Matcher instantiate() {
    return PhysicalArchitecture_physicalLocation.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_physicalLocation.Match newEmptyMatch() {
    return PhysicalArchitecture_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_physicalLocation.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_physicalLocation INSTANCE = new PhysicalArchitecture_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
