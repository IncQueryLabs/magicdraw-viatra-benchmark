...
public final class DeriveReqt extends BaseGeneratedEMFQuerySpecification<DeriveReqt.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DeriveReqt pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Abstraction pElement, final Stereotype pStereotype) {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DeriveReqt";
    }
    
    @Override
    public List<String> parameterNames() {
      return DeriveReqt.Match.parameterNames;
    }
    ...
    @Override
    public DeriveReqt.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DeriveReqt.Match)) {
          DeriveReqt.Match other = (DeriveReqt.Match) obj;
    ...
    @Override
    public DeriveReqt specification() {
     ...
     * 
     */
    public static DeriveReqt.Match newEmptyMatch() {
     ...
     * 
     */
    public static DeriveReqt.Match newMutableMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static DeriveReqt.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends DeriveReqt.Match {
      Mutable(final Abstraction pElement, final Stereotype pStereotype) {
    ...
    private static final class Immutable extends DeriveReqt.Match {
      Immutable(final Abstraction pElement, final Stereotype pStereotype) {
        super(pElement, pStereotype);
      }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DeriveReqt pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<DeriveReqt.Match> {
    /**
     ...
     * 
     */
    public static DeriveReqt.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DeriveReqt.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DeriveReqt.Matcher.class);
     ...
     * 
     */
    public Collection<DeriveReqt.Match> getAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<DeriveReqt.Match> streamAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<DeriveReqt.Match> getOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean hasMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public int countMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype, final Consumer<? super DeriveReqt.Match> processor) {
     ...
     * 
     */
    public DeriveReqt.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return DeriveReqt.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfElement(final DeriveReqt.Match partialMatch) {
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfElement(final Stereotype pStereotype) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfElement(final DeriveReqt.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfElement(final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final DeriveReqt.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Abstraction pElement) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final DeriveReqt.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Abstraction pElement) {
      return rawStreamAllValuesOfStereotype(new Object[]{pElement, null}).collect(Collectors.toSet());
    }
    
    @Override
    protected DeriveReqt.Match tupleToMatch(final Tuple t) {
      try {
          return DeriveReqt.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected DeriveReqt.Match arrayToMatch(final Object[] match) {
      try {
          return DeriveReqt.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DeriveReqt.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeriveReqt.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DeriveReqt.Matcher> querySpecification() {
      return DeriveReqt.instance();
    }
  }
   ...
   * 
   */
  public static DeriveReqt instance() {
    try{
  ...
  @Override
  protected DeriveReqt.Matcher instantiate(final ViatraQueryEngine engine) {
    return DeriveReqt.Matcher.on(engine);
  }
  
  @Override
  public DeriveReqt.Matcher instantiate() {
    return DeriveReqt.Matcher.create();
  }
  
  @Override
  public DeriveReqt.Match newEmptyMatch() {
    return DeriveReqt.Match.newEmptyMatch();
  }
  
  @Override
  public DeriveReqt.Match newMatch(final Object... parameters) {
    return DeriveReqt.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DeriveReqt} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DeriveReqt#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DeriveReqt INSTANCE = new DeriveReqt();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DeriveReqt.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "DeriveReqt");
