 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "moe");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Moe extends BaseGeneratedEMFQuerySpecification<Moe.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.moe pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.moe";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.moe pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Moe} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Moe#instance()}.
   * 
