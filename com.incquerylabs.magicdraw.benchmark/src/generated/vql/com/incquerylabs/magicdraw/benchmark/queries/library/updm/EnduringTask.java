...
public final class EnduringTask extends BaseGeneratedEMFQuerySpecification<EnduringTask.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnduringTask pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnduringTask";
    }
     ...
     * 
     */
    public static EnduringTask.Match newMutableMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static EnduringTask.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnduringTask pattern,
  ...
  public static class Matcher extends BaseMatcher<EnduringTask.Match> {
     ...
     * 
     */
    public Collection<EnduringTask.Match> getAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<EnduringTask.Match> streamAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<EnduringTask.Match> getOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super EnduringTask.Match> processor) {
     ...
     * 
     */
    public EnduringTask.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final EnduringTask.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final EnduringTask.Match partialMatch) {
    ...
    protected EnduringTask.Match tupleToMatch(final Tuple t) {
      try {
          return EnduringTask.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected EnduringTask.Match arrayToMatch(final Object[] match) {
      try {
          return EnduringTask.Match.newMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected EnduringTask.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnduringTask.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public EnduringTask.Match newMatch(final Object... parameters) {
    return EnduringTask.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
