...
public final class OperationalArchitecture extends BaseGeneratedEMFQuerySpecification<OperationalArchitecture.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalArchitecture.Match.parameterNames;
    }
    ...
    @Override
    public OperationalArchitecture.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalArchitecture.Match)) {
          OperationalArchitecture.Match other = (OperationalArchitecture.Match) obj;
    ...
    @Override
    public OperationalArchitecture specification() {
      return OperationalArchitecture.instance();
    }
     ...
     * 
     */
    public static OperationalArchitecture.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalArchitecture.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalArchitecture.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalArchitecture.Match {
    ...
    private static final class Immutable extends OperationalArchitecture.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture pattern,
   ...
   * 
   * @see Match
   * @see OperationalArchitecture
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalArchitecture.Match> {
    /**
     ...
     * 
     */
    public static OperationalArchitecture.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalArchitecture.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalArchitecture.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalArchitecture.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalArchitecture.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalArchitecture.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalArchitecture.Match> processor) {
     ...
     * 
     */
    public OperationalArchitecture.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalArchitecture.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalArchitecture.Match partialMatch) {
    ...
    @Override
    protected OperationalArchitecture.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalArchitecture.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalArchitecture.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalArchitecture.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalArchitecture.Matcher> querySpecification() {
      return OperationalArchitecture.instance();
    }
  }
  
  private OperationalArchitecture() {
   ...
   * 
   */
  public static OperationalArchitecture instance() {
    try{
  ...
  @Override
  protected OperationalArchitecture.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalArchitecture.Matcher.on(engine);
  }
  
  @Override
  public OperationalArchitecture.Matcher instantiate() {
    return OperationalArchitecture.Matcher.create();
  }
  
  @Override
  public OperationalArchitecture.Match newEmptyMatch() {
    return OperationalArchitecture.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalArchitecture.Match newMatch(final Object... parameters) {
    return OperationalArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalArchitecture} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalArchitecture#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalArchitecture INSTANCE = new OperationalArchitecture();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalArchitecture.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalArchitecture")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalArchitecture");
