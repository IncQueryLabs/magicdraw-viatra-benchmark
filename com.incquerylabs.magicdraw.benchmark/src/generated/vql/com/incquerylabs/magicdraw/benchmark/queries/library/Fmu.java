 ...
 *         pattern fmu(Element : Element, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "fmu");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Fmu extends BaseGeneratedEMFQuerySpecification<Fmu.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.fmu pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.fmu";
    }
    
    @Override
    public List<String> parameterNames() {
      return Fmu.Match.parameterNames;
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Fmu.Match)) {
          Fmu.Match other = (Fmu.Match) obj;
     ...
     * 
     */
    public static Fmu.Match newEmptyMatch() {
     ...
     * 
     */
    public static Fmu.Match newMutableMatch(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Fmu.Match newMatch(final Element pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Fmu.Match {
    ...
    private static final class Immutable extends Fmu.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.fmu pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Fmu.Match> {
    /**
     ...
     * 
     */
    public static Fmu.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Fmu.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Fmu.Matcher.class);
     ...
     * 
     */
    public Collection<Fmu.Match> getAllMatches(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Fmu.Match> streamAllMatches(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Fmu.Match> getOneArbitraryMatch(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final Stereotype pStereotype, final Consumer<? super Fmu.Match> processor) {
     ...
     * 
     */
    public Fmu.Match newMatch(final Element pElement, final Stereotype pStereotype) {
      return Fmu.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfElement(final Fmu.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfElement(final Fmu.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Fmu.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Fmu.Match partialMatch) {
    ...
    @Override
    protected Fmu.Match tupleToMatch(final Tuple t) {
      try {
          return Fmu.Match.newMatch((Element) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Fmu.Match arrayToMatch(final Object[] match) {
      try {
          return Fmu.Match.newMatch((Element) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Fmu.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Fmu.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Fmu.Matcher> querySpecification() {
      return Fmu.instance();
    }
  }
  ...
  @Override
  protected Fmu.Matcher instantiate(final ViatraQueryEngine engine) {
    return Fmu.Matcher.on(engine);
  }
  
  @Override
  public Fmu.Matcher instantiate() {
    return Fmu.Matcher.create();
  }
  
  @Override
  public Fmu.Match newEmptyMatch() {
    return Fmu.Match.newEmptyMatch();
  }
  
  @Override
  public Fmu.Match newMatch(final Object... parameters) {
    return Fmu.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Fmu} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Fmu#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Fmu INSTANCE = new Fmu();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Fmu.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "fmu");
