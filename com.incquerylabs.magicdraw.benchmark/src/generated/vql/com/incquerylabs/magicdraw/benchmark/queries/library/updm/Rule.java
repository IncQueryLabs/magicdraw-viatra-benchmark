...
public final class Rule extends BaseGeneratedEMFQuerySpecification<Rule.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule";
    }
     ...
     * 
     */
    public static Rule.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Rule.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule pattern,
  ...
  public static class Matcher extends BaseMatcher<Rule.Match> {
     ...
     * 
     */
    public Collection<Rule.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Rule.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Rule.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Rule.Match> processor) {
     ...
     * 
     */
    public Rule.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Rule.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Rule.Match partialMatch) {
    ...
    protected Rule.Match tupleToMatch(final Tuple t) {
      try {
          return Rule.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected Rule.Match arrayToMatch(final Object[] match) {
      try {
          return Rule.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected Rule.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rule.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Rule.Match newMatch(final Object... parameters) {
    return Rule.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
