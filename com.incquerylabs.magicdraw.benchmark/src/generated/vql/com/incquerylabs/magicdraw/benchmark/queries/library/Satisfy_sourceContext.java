...
public final class Satisfy_sourceContext extends BaseGeneratedEMFQuerySpecification<Satisfy_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Satisfy_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Satisfy_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Satisfy_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public Satisfy_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Satisfy_sourceContext.Match)) {
          Satisfy_sourceContext.Match other = (Satisfy_sourceContext.Match) obj;
    ...
    @Override
    public Satisfy_sourceContext specification() {
     ...
     * 
     */
    public static Satisfy_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Satisfy_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Satisfy_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Satisfy_sourceContext.Match {
    ...
    private static final class Immutable extends Satisfy_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Satisfy_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see Satisfy_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<Satisfy_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static Satisfy_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Satisfy_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Satisfy_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<Satisfy_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Satisfy_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Satisfy_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Satisfy_sourceContext.Match> processor) {
     ...
     * 
     */
    public Satisfy_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Satisfy_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Satisfy_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Satisfy_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Satisfy_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Satisfy_sourceContext.Match partialMatch) {
    ...
    @Override
    protected Satisfy_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return Satisfy_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Satisfy_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return Satisfy_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Satisfy_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Satisfy_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Satisfy_sourceContext.Matcher> querySpecification() {
      return Satisfy_sourceContext.instance();
    }
  }
  
  private Satisfy_sourceContext() {
   ...
   * 
   */
  public static Satisfy_sourceContext instance() {
    try{
  ...
  @Override
  protected Satisfy_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Satisfy_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public Satisfy_sourceContext.Matcher instantiate() {
    return Satisfy_sourceContext.Matcher.create();
  }
  
  @Override
  public Satisfy_sourceContext.Match newEmptyMatch() {
    return Satisfy_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public Satisfy_sourceContext.Match newMatch(final Object... parameters) {
    return Satisfy_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Satisfy_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Satisfy_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Satisfy_sourceContext INSTANCE = new Satisfy_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Satisfy_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
