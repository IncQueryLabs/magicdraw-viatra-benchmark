...
public final class Command_conformsTo extends BaseGeneratedEMFQuerySpecification<Command_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Command_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Command_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Command_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Command_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Command_conformsTo.Match)) {
          Command_conformsTo.Match other = (Command_conformsTo.Match) obj;
    ...
    @Override
    public Command_conformsTo specification() {
      return Command_conformsTo.instance();
    }
     ...
     * 
     */
    public static Command_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Command_conformsTo.Match newMutableMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public static Command_conformsTo.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Command_conformsTo.Match {
    ...
    private static final class Immutable extends Command_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Command_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Command_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Command_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Command_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Command_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Command_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Command_conformsTo.Match> getAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Command_conformsTo.Match> streamAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Command_conformsTo.Match> getOneArbitraryMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final Element pValue, final Consumer<? super Command_conformsTo.Match> processor) {
     ...
     * 
     */
    public Command_conformsTo.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return Command_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Command_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Command_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Command_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Command_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Command_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Command_conformsTo.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Command_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Command_conformsTo.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Command_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Command_conformsTo.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Command_conformsTo.Matcher> querySpecification() {
      return Command_conformsTo.instance();
    }
  }
  
  private Command_conformsTo() {
   ...
   * 
   */
  public static Command_conformsTo instance() {
    try{
  ...
  @Override
  protected Command_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Command_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Command_conformsTo.Matcher instantiate() {
    return Command_conformsTo.Matcher.create();
  }
  
  @Override
  public Command_conformsTo.Match newEmptyMatch() {
    return Command_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Command_conformsTo.Match newMatch(final Object... parameters) {
    return Command_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Command_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Command_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Command_conformsTo INSTANCE = new Command_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Command_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
