...
public final class SystemResource_actsUpon extends BaseGeneratedEMFQuerySpecification<SystemResource_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_actsUpon.Match)) {
          SystemResource_actsUpon.Match other = (SystemResource_actsUpon.Match) obj;
    ...
    @Override
    public SystemResource_actsUpon specification() {
      return SystemResource_actsUpon.instance();
    }
     ...
     * 
     */
    public static SystemResource_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_actsUpon.Match {
    ...
    private static final class Immutable extends SystemResource_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_actsUpon.Match> processor) {
     ...
     * 
     */
    public SystemResource_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_actsUpon.Match partialMatch) {
    ...
    @Override
    protected SystemResource_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_actsUpon.Matcher> querySpecification() {
      return SystemResource_actsUpon.instance();
    }
  }
  
  private SystemResource_actsUpon() {
   ...
   * 
   */
  public static SystemResource_actsUpon instance() {
    try{
  ...
  @Override
  protected SystemResource_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_actsUpon.Matcher instantiate() {
    return SystemResource_actsUpon.Matcher.create();
  }
  
  @Override
  public SystemResource_actsUpon.Match newEmptyMatch() {
    return SystemResource_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_actsUpon.Match newMatch(final Object... parameters) {
    return SystemResource_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_actsUpon INSTANCE = new SystemResource_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
