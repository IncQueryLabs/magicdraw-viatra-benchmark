...
public final class Technology_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Technology_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Technology_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Technology_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Technology_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Technology_requiredEnvironment.Match)) {
          Technology_requiredEnvironment.Match other = (Technology_requiredEnvironment.Match) obj;
    ...
    @Override
    public Technology_requiredEnvironment specification() {
      return Technology_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Technology_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Technology_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Technology_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Technology_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Technology_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Technology_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Technology_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Technology_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Technology_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Technology_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Technology_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Technology_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Technology_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Technology_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Technology_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Technology_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Technology_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Technology_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Technology_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Technology_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Technology_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Technology_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Technology_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Technology_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Technology_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Technology_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Technology_requiredEnvironment.Matcher> querySpecification() {
      return Technology_requiredEnvironment.instance();
    }
  }
  
  private Technology_requiredEnvironment() {
   ...
   * 
   */
  public static Technology_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Technology_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Technology_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Technology_requiredEnvironment.Matcher instantiate() {
    return Technology_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Technology_requiredEnvironment.Match newEmptyMatch() {
    return Technology_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Technology_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Technology_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Technology_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Technology_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Technology_requiredEnvironment INSTANCE = new Technology_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Technology_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
