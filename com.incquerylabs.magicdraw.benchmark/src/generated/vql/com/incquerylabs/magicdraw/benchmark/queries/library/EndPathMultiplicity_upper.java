...
public final class EndPathMultiplicity_upper extends BaseGeneratedEMFQuerySpecification<EndPathMultiplicity_upper.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static EndPathMultiplicity_upper.Match newMutableMatch(final Property pElement, final Integer pValue) {
     ...
     * 
     */
    public static EndPathMultiplicity_upper.Match newMatch(final Property pElement, final Integer pValue) {
  ...
  public static class Matcher extends BaseMatcher<EndPathMultiplicity_upper.Match> {
     ...
     * 
     */
    public Collection<EndPathMultiplicity_upper.Match> getAllMatches(final Property pElement, final Integer pValue) {
     ...
     * 
     */
    public Stream<EndPathMultiplicity_upper.Match> streamAllMatches(final Property pElement, final Integer pValue) {
     ...
     * 
     */
    public Optional<EndPathMultiplicity_upper.Match> getOneArbitraryMatch(final Property pElement, final Integer pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Integer pValue, final Consumer<? super EndPathMultiplicity_upper.Match> processor) {
     ...
     * 
     */
    public EndPathMultiplicity_upper.Match newMatch(final Property pElement, final Integer pValue) {
      return EndPathMultiplicity_upper.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Integer> streamAllValuesOfValue(final EndPathMultiplicity_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfValue(final EndPathMultiplicity_upper.Match partialMatch) {
    ...
    protected EndPathMultiplicity_upper.Match tupleToMatch(final Tuple t) {
      try {
          return EndPathMultiplicity_upper.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Integer) t.get(POSITION_VALUE));
    ...
    protected EndPathMultiplicity_upper.Match arrayToMatch(final Object[] match) {
      try {
          return EndPathMultiplicity_upper.Match.newMatch((Property) match[POSITION_ELEMENT], (Integer) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected EndPathMultiplicity_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EndPathMultiplicity_upper.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Integer) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public EndPathMultiplicity_upper.Match newMatch(final Object... parameters) {
    return EndPathMultiplicity_upper.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (java.lang.Integer) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find EndPathMultiplicity(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), EndPathMultiplicity.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "upper", taggedValue)
