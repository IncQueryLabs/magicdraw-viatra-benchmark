...
public final class ResponsibleFor extends BaseGeneratedEMFQuerySpecification<ResponsibleFor.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResponsibleFor.Match.parameterNames;
    }
    ...
    @Override
    public ResponsibleFor.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResponsibleFor.Match)) {
          ResponsibleFor.Match other = (ResponsibleFor.Match) obj;
    ...
    @Override
    public ResponsibleFor specification() {
      return ResponsibleFor.instance();
    }
     ...
     * 
     */
    public static ResponsibleFor.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResponsibleFor.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResponsibleFor.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResponsibleFor.Match {
    ...
    private static final class Immutable extends ResponsibleFor.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ResponsibleFor.Match> {
    /**
     ...
     * 
     */
    public static ResponsibleFor.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResponsibleFor.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResponsibleFor.Matcher.class);
     ...
     * 
     */
    public Collection<ResponsibleFor.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResponsibleFor.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResponsibleFor.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResponsibleFor.Match> processor) {
     ...
     * 
     */
    public ResponsibleFor.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResponsibleFor.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final ResponsibleFor.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final ResponsibleFor.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResponsibleFor.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResponsibleFor.Match partialMatch) {
    ...
    @Override
    protected ResponsibleFor.Match tupleToMatch(final Tuple t) {
      try {
          return ResponsibleFor.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResponsibleFor.Match arrayToMatch(final Object[] match) {
      try {
          return ResponsibleFor.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResponsibleFor.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResponsibleFor.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResponsibleFor.Matcher> querySpecification() {
      return ResponsibleFor.instance();
    }
  }
   ...
   * 
   */
  public static ResponsibleFor instance() {
    try{
  ...
  @Override
  protected ResponsibleFor.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResponsibleFor.Matcher.on(engine);
  }
  
  @Override
  public ResponsibleFor.Matcher instantiate() {
    return ResponsibleFor.Matcher.create();
  }
  
  @Override
  public ResponsibleFor.Match newEmptyMatch() {
    return ResponsibleFor.Match.newEmptyMatch();
  }
  
  @Override
  public ResponsibleFor.Match newMatch(final Object... parameters) {
    return ResponsibleFor.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResponsibleFor} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResponsibleFor#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResponsibleFor INSTANCE = new ResponsibleFor();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResponsibleFor.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ResponsibleFor")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ResponsibleFor");
