...
public final class SecurityProperty_URI extends BaseGeneratedEMFQuerySpecification<SecurityProperty_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityProperty_URI.Match.parameterNames;
    }
    ...
    @Override
    public SecurityProperty_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityProperty_URI.Match)) {
          SecurityProperty_URI.Match other = (SecurityProperty_URI.Match) obj;
    ...
    @Override
    public SecurityProperty_URI specification() {
      return SecurityProperty_URI.instance();
    }
     ...
     * 
     */
    public static SecurityProperty_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityProperty_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SecurityProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityProperty_URI.Match {
    ...
    private static final class Immutable extends SecurityProperty_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_URI pattern,
   ...
   * 
   * @see Match
   * @see SecurityProperty_URI
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityProperty_URI.Match> {
    /**
     ...
     * 
     */
    public static SecurityProperty_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityProperty_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityProperty_URI.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityProperty_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SecurityProperty_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SecurityProperty_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super SecurityProperty_URI.Match> processor) {
     ...
     * 
     */
    public SecurityProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return SecurityProperty_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final SecurityProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final SecurityProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SecurityProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SecurityProperty_URI.Match partialMatch) {
    ...
    @Override
    protected SecurityProperty_URI.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityProperty_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityProperty_URI.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityProperty_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityProperty_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityProperty_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityProperty_URI.Matcher> querySpecification() {
      return SecurityProperty_URI.instance();
    }
  }
  
  private SecurityProperty_URI() {
   ...
   * 
   */
  public static SecurityProperty_URI instance() {
    try{
  ...
  @Override
  protected SecurityProperty_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityProperty_URI.Matcher.on(engine);
  }
  
  @Override
  public SecurityProperty_URI.Matcher instantiate() {
    return SecurityProperty_URI.Matcher.create();
  }
  
  @Override
  public SecurityProperty_URI.Match newEmptyMatch() {
    return SecurityProperty_URI.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityProperty_URI.Match newMatch(final Object... parameters) {
    return SecurityProperty_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityProperty_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityProperty_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityProperty_URI INSTANCE = new SecurityProperty_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityProperty_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
