...
public final class Property_URI extends BaseGeneratedEMFQuerySpecification<Property_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Property_URI.Match.parameterNames;
    }
    ...
    @Override
    public Property_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Property_URI.Match)) {
          Property_URI.Match other = (Property_URI.Match) obj;
    ...
    @Override
    public Property_URI specification() {
      return Property_URI.instance();
    }
     ...
     * 
     */
    public static Property_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Property_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Property_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Property_URI.Match {
    ...
    private static final class Immutable extends Property_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Property_URI.Match> {
    /**
     ...
     * 
     */
    public static Property_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Property_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Property_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Property_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Property_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Property_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super Property_URI.Match> processor) {
     ...
     * 
     */
    public Property_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return Property_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Property_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Property_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Property_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Property_URI.Match partialMatch) {
    ...
    @Override
    protected Property_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Property_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Property_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Property_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Property_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Property_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Property_URI.Matcher> querySpecification() {
      return Property_URI.instance();
    }
  }
  
  private Property_URI() {
   ...
   * 
   */
  public static Property_URI instance() {
    try{
  ...
  @Override
  protected Property_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Property_URI.Matcher.on(engine);
  }
  
  @Override
  public Property_URI.Matcher instantiate() {
    return Property_URI.Matcher.create();
  }
  
  @Override
  public Property_URI.Match newEmptyMatch() {
    return Property_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Property_URI.Match newMatch(final Object... parameters) {
    return Property_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Property_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Property_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Property_URI INSTANCE = new Property_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Property_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
