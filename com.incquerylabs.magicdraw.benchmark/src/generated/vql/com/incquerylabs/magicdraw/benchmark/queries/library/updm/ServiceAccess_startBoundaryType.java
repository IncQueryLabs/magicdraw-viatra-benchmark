...
public final class ServiceAccess_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ServiceAccess_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_startBoundaryType.Match)) {
          ServiceAccess_startBoundaryType.Match other = (ServiceAccess_startBoundaryType.Match) obj;
    ...
    @Override
    public ServiceAccess_startBoundaryType specification() {
      return ServiceAccess_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_startBoundaryType.Match {
    ...
    private static final class Immutable extends ServiceAccess_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_startBoundaryType.Matcher> querySpecification() {
      return ServiceAccess_startBoundaryType.instance();
    }
  }
  
  private ServiceAccess_startBoundaryType() {
   ...
   * 
   */
  public static ServiceAccess_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ServiceAccess_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_startBoundaryType.Matcher instantiate() {
    return ServiceAccess_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ServiceAccess_startBoundaryType.Match newEmptyMatch() {
    return ServiceAccess_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_startBoundaryType.Match newMatch(final Object... parameters) {
    return ServiceAccess_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_startBoundaryType INSTANCE = new ServiceAccess_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
