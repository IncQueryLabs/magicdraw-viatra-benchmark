...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute;
...
public final class ServiceAttribute_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ServiceAttribute_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAttribute_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAttribute_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAttribute_actualPropertySet.Match)) {
          ServiceAttribute_actualPropertySet.Match other = (ServiceAttribute_actualPropertySet.Match) obj;
    ...
    @Override
    public ServiceAttribute_actualPropertySet specification() {
      return ServiceAttribute_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ServiceAttribute_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAttribute_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAttribute_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAttribute_actualPropertySet.Match {
    ...
    private static final class Immutable extends ServiceAttribute_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ServiceAttribute_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAttribute_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ServiceAttribute_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAttribute_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAttribute_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAttribute_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAttribute_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAttribute_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ServiceAttribute_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ServiceAttribute_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ServiceAttribute_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceAttribute_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceAttribute_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAttribute_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAttribute_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ServiceAttribute_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAttribute_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAttribute_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAttribute_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAttribute_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAttribute_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAttribute_actualPropertySet.Matcher> querySpecification() {
      return ServiceAttribute_actualPropertySet.instance();
    }
  }
  
  private ServiceAttribute_actualPropertySet() {
   ...
   * 
   */
  public static ServiceAttribute_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ServiceAttribute_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAttribute_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ServiceAttribute_actualPropertySet.Matcher instantiate() {
    return ServiceAttribute_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ServiceAttribute_actualPropertySet.Match newEmptyMatch() {
    return ServiceAttribute_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAttribute_actualPropertySet.Match newMatch(final Object... parameters) {
    return ServiceAttribute_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAttribute_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAttribute_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAttribute_actualPropertySet INSTANCE = new ServiceAttribute_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAttribute_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ServiceAttribute(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ServiceAttribute.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
