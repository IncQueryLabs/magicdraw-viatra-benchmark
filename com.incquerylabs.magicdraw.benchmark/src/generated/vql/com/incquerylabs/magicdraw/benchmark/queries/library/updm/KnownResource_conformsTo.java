...
public final class KnownResource_conformsTo extends BaseGeneratedEMFQuerySpecification<KnownResource_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_conformsTo";
    }
     ...
     * 
     */
    public static KnownResource_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_conformsTo pattern,
  ...
  public static class Matcher extends BaseMatcher<KnownResource_conformsTo.Match> {
     ...
     * 
     */
    public Collection<KnownResource_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super KnownResource_conformsTo.Match> processor) {
     ...
     * 
     */
    public KnownResource_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final KnownResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final KnownResource_conformsTo.Match partialMatch) {
    ...
    protected KnownResource_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    protected KnownResource_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected KnownResource_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public KnownResource_conformsTo.Match newMatch(final Object... parameters) {
    return KnownResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
