...
public final class ServiceInterface_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ServiceInterface_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInterface_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInterface_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInterface_startBoundaryType.Match)) {
          ServiceInterface_startBoundaryType.Match other = (ServiceInterface_startBoundaryType.Match) obj;
    ...
    @Override
    public ServiceInterface_startBoundaryType specification() {
      return ServiceInterface_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ServiceInterface_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInterface_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceInterface_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceInterface_startBoundaryType.Match {
    ...
    private static final class Immutable extends ServiceInterface_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ServiceInterface_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInterface_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ServiceInterface_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInterface_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInterface_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInterface_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceInterface_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceInterface_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceInterface_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ServiceInterface_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceInterface_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceInterface_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceInterface_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceInterface_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceInterface_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ServiceInterface_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInterface_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceInterface_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInterface_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInterface_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInterface_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInterface_startBoundaryType.Matcher> querySpecification() {
      return ServiceInterface_startBoundaryType.instance();
    }
  }
  
  private ServiceInterface_startBoundaryType() {
   ...
   * 
   */
  public static ServiceInterface_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ServiceInterface_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInterface_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ServiceInterface_startBoundaryType.Matcher instantiate() {
    return ServiceInterface_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ServiceInterface_startBoundaryType.Match newEmptyMatch() {
    return ServiceInterface_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInterface_startBoundaryType.Match newMatch(final Object... parameters) {
    return ServiceInterface_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInterface_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInterface_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInterface_startBoundaryType INSTANCE = new ServiceInterface_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInterface_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
