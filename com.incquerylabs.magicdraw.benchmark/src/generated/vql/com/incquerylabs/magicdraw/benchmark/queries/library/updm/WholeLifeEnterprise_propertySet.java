...
public final class WholeLifeEnterprise_propertySet extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_propertySet.Match)) {
          WholeLifeEnterprise_propertySet.Match other = (WholeLifeEnterprise_propertySet.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_propertySet specification() {
      return WholeLifeEnterprise_propertySet.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_propertySet.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_propertySet pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_propertySet.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_propertySet.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_propertySet.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_propertySet.Matcher> querySpecification() {
      return WholeLifeEnterprise_propertySet.instance();
    }
  }
  
  private WholeLifeEnterprise_propertySet() {
   ...
   * 
   */
  public static WholeLifeEnterprise_propertySet instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_propertySet.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_propertySet.Matcher instantiate() {
    return WholeLifeEnterprise_propertySet.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_propertySet.Match newEmptyMatch() {
    return WholeLifeEnterprise_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_propertySet.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_propertySet INSTANCE = new WholeLifeEnterprise_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
