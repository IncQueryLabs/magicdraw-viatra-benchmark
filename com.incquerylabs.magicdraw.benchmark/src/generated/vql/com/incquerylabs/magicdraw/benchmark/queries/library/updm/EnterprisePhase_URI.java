...
public final class EnterprisePhase_URI extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_URI.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_URI.Match)) {
          EnterprisePhase_URI.Match other = (EnterprisePhase_URI.Match) obj;
    ...
    @Override
    public EnterprisePhase_URI specification() {
      return EnterprisePhase_URI.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnterprisePhase_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnterprisePhase_URI.Match {
    ...
    private static final class Immutable extends EnterprisePhase_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_URI pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_URI
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_URI.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_URI.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnterprisePhase_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnterprisePhase_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EnterprisePhase_URI.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EnterprisePhase_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnterprisePhase_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnterprisePhase_URI.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_URI.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnterprisePhase_URI.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_URI.Matcher> querySpecification() {
      return EnterprisePhase_URI.instance();
    }
  }
  
  private EnterprisePhase_URI() {
   ...
   * 
   */
  public static EnterprisePhase_URI instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_URI.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_URI.Matcher instantiate() {
    return EnterprisePhase_URI.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_URI.Match newEmptyMatch() {
    return EnterprisePhase_URI.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_URI.Match newMatch(final Object... parameters) {
    return EnterprisePhase_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_URI INSTANCE = new EnterprisePhase_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
