...
public final class Post_actsUpon extends BaseGeneratedEMFQuerySpecification<Post_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public Post_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_actsUpon.Match)) {
          Post_actsUpon.Match other = (Post_actsUpon.Match) obj;
    ...
    @Override
    public Post_actsUpon specification() {
      return Post_actsUpon.instance();
    }
     ...
     * 
     */
    public static Post_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_actsUpon.Match {
    ...
    private static final class Immutable extends Post_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_actsUpon pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Post_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static Post_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<Post_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_actsUpon.Match> processor) {
     ...
     * 
     */
    public Post_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_actsUpon.Match partialMatch) {
    ...
    @Override
    protected Post_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return Post_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return Post_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_actsUpon.Matcher> querySpecification() {
      return Post_actsUpon.instance();
    }
  }
  
  private Post_actsUpon() {
   ...
   * 
   */
  public static Post_actsUpon instance() {
    try{
  ...
  @Override
  protected Post_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public Post_actsUpon.Matcher instantiate() {
    return Post_actsUpon.Matcher.create();
  }
  
  @Override
  public Post_actsUpon.Match newEmptyMatch() {
    return Post_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public Post_actsUpon.Match newMatch(final Object... parameters) {
    return Post_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_actsUpon INSTANCE = new Post_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
