...
public final class ServiceLevelValue_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ServiceLevelValue_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceLevelValue_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceLevelValue_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceLevelValue_actualPropertySet.Match)) {
          ServiceLevelValue_actualPropertySet.Match other = (ServiceLevelValue_actualPropertySet.Match) obj;
    ...
    @Override
    public ServiceLevelValue_actualPropertySet specification() {
      return ServiceLevelValue_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ServiceLevelValue_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceLevelValue_actualPropertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceLevelValue_actualPropertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceLevelValue_actualPropertySet.Match {
    ...
    private static final class Immutable extends ServiceLevelValue_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ServiceLevelValue_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceLevelValue_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ServiceLevelValue_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceLevelValue_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceLevelValue_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceLevelValue_actualPropertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceLevelValue_actualPropertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceLevelValue_actualPropertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ServiceLevelValue_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ServiceLevelValue_actualPropertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ServiceLevelValue_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ServiceLevelValue_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ServiceLevelValue_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceLevelValue_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceLevelValue_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ServiceLevelValue_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceLevelValue_actualPropertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceLevelValue_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceLevelValue_actualPropertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceLevelValue_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceLevelValue_actualPropertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceLevelValue_actualPropertySet.Matcher> querySpecification() {
      return ServiceLevelValue_actualPropertySet.instance();
    }
  }
  
  private ServiceLevelValue_actualPropertySet() {
   ...
   * 
   */
  public static ServiceLevelValue_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ServiceLevelValue_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceLevelValue_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ServiceLevelValue_actualPropertySet.Matcher instantiate() {
    return ServiceLevelValue_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ServiceLevelValue_actualPropertySet.Match newEmptyMatch() {
    return ServiceLevelValue_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceLevelValue_actualPropertySet.Match newMatch(final Object... parameters) {
    return ServiceLevelValue_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceLevelValue_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceLevelValue_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceLevelValue_actualPropertySet INSTANCE = new ServiceLevelValue_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceLevelValue_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
