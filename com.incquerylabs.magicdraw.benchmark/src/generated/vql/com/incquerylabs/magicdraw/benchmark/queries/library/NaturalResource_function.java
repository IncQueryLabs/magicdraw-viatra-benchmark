...
public final class NaturalResource_function extends BaseGeneratedEMFQuerySpecification<NaturalResource_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return NaturalResource_function.Match.parameterNames;
    }
    ...
    @Override
    public NaturalResource_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NaturalResource_function.Match)) {
          NaturalResource_function.Match other = (NaturalResource_function.Match) obj;
    ...
    @Override
    public NaturalResource_function specification() {
      return NaturalResource_function.instance();
    }
     ...
     * 
     */
    public static NaturalResource_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static NaturalResource_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NaturalResource_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NaturalResource_function.Match {
    ...
    private static final class Immutable extends NaturalResource_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_function pattern,
   ...
   * 
   * @see Match
   * @see NaturalResource_function
   * 
   */
  public static class Matcher extends BaseMatcher<NaturalResource_function.Match> {
    /**
     ...
     * 
     */
    public static NaturalResource_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NaturalResource_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NaturalResource_function.Matcher.class);
     ...
     * 
     */
    public Collection<NaturalResource_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NaturalResource_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NaturalResource_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NaturalResource_function.Match> processor) {
     ...
     * 
     */
    public NaturalResource_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NaturalResource_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NaturalResource_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NaturalResource_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NaturalResource_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NaturalResource_function.Match partialMatch) {
    ...
    @Override
    protected NaturalResource_function.Match tupleToMatch(final Tuple t) {
      try {
          return NaturalResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NaturalResource_function.Match arrayToMatch(final Object[] match) {
      try {
          return NaturalResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NaturalResource_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NaturalResource_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NaturalResource_function.Matcher> querySpecification() {
      return NaturalResource_function.instance();
    }
  }
  
  private NaturalResource_function() {
   ...
   * 
   */
  public static NaturalResource_function instance() {
    try{
  ...
  @Override
  protected NaturalResource_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return NaturalResource_function.Matcher.on(engine);
  }
  
  @Override
  public NaturalResource_function.Matcher instantiate() {
    return NaturalResource_function.Matcher.create();
  }
  
  @Override
  public NaturalResource_function.Match newEmptyMatch() {
    return NaturalResource_function.Match.newEmptyMatch();
  }
  
  @Override
  public NaturalResource_function.Match newMatch(final Object... parameters) {
    return NaturalResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NaturalResource_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NaturalResource_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NaturalResource_function INSTANCE = new NaturalResource_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NaturalResource_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
