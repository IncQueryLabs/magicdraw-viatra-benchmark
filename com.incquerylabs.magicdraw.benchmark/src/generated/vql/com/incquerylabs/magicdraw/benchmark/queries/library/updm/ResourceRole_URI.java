...
public final class ResourceRole_URI extends BaseGeneratedEMFQuerySpecification<ResourceRole_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_URI.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_URI.Match)) {
          ResourceRole_URI.Match other = (ResourceRole_URI.Match) obj;
    ...
    @Override
    public ResourceRole_URI specification() {
      return ResourceRole_URI.instance();
    }
     ...
     * 
     */
    public static ResourceRole_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ResourceRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourceRole_URI.Match {
    ...
    private static final class Immutable extends ResourceRole_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_URI pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_URI.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ResourceRole_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ResourceRole_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ResourceRole_URI.Match> processor) {
     ...
     * 
     */
    public ResourceRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ResourceRole_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ResourceRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ResourceRole_URI.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourceRole_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_URI.Matcher> querySpecification() {
      return ResourceRole_URI.instance();
    }
  }
  
  private ResourceRole_URI() {
   ...
   * 
   */
  public static ResourceRole_URI instance() {
    try{
  ...
  @Override
  protected ResourceRole_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_URI.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_URI.Matcher instantiate() {
    return ResourceRole_URI.Matcher.create();
  }
  
  @Override
  public ResourceRole_URI.Match newEmptyMatch() {
    return ResourceRole_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_URI.Match newMatch(final Object... parameters) {
    return ResourceRole_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_URI INSTANCE = new ResourceRole_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
