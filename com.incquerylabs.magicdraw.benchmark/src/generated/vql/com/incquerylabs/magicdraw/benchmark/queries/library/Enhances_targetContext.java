...
public final class Enhances_targetContext extends BaseGeneratedEMFQuerySpecification<Enhances_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Enhances_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Enhances_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Enhances_targetContext.Match)) {
          Enhances_targetContext.Match other = (Enhances_targetContext.Match) obj;
    ...
    @Override
    public Enhances_targetContext specification() {
      return Enhances_targetContext.instance();
    }
     ...
     * 
     */
    public static Enhances_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Enhances_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Enhances_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Enhances_targetContext.Match {
    ...
    private static final class Immutable extends Enhances_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Enhances_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Enhances_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Enhances_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Enhances_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Enhances_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Enhances_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Enhances_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Enhances_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Enhances_targetContext.Match> processor) {
     ...
     * 
     */
    public Enhances_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Enhances_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Enhances_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Enhances_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Enhances_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Enhances_targetContext.Match partialMatch) {
    ...
    @Override
    protected Enhances_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Enhances_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Enhances_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Enhances_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Enhances_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Enhances_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Enhances_targetContext.Matcher> querySpecification() {
      return Enhances_targetContext.instance();
    }
  }
  
  private Enhances_targetContext() {
   ...
   * 
   */
  public static Enhances_targetContext instance() {
    try{
  ...
  @Override
  protected Enhances_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Enhances_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Enhances_targetContext.Matcher instantiate() {
    return Enhances_targetContext.Matcher.create();
  }
  
  @Override
  public Enhances_targetContext.Match newEmptyMatch() {
    return Enhances_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Enhances_targetContext.Match newMatch(final Object... parameters) {
    return Enhances_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Enhances_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Enhances_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Enhances_targetContext INSTANCE = new Enhances_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Enhances_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
