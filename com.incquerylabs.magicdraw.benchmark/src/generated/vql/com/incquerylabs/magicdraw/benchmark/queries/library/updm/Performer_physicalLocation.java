...
public final class Performer_physicalLocation extends BaseGeneratedEMFQuerySpecification<Performer_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Performer_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_physicalLocation.Match)) {
          Performer_physicalLocation.Match other = (Performer_physicalLocation.Match) obj;
    ...
    @Override
    public Performer_physicalLocation specification() {
      return Performer_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Performer_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_physicalLocation.Match {
    ...
    private static final class Immutable extends Performer_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Performer_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Performer_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Performer_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Performer_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_physicalLocation.Matcher> querySpecification() {
      return Performer_physicalLocation.instance();
    }
  }
  
  private Performer_physicalLocation() {
   ...
   * 
   */
  public static Performer_physicalLocation instance() {
    try{
  ...
  @Override
  protected Performer_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Performer_physicalLocation.Matcher instantiate() {
    return Performer_physicalLocation.Matcher.create();
  }
  
  @Override
  public Performer_physicalLocation.Match newEmptyMatch() {
    return Performer_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_physicalLocation.Match newMatch(final Object... parameters) {
    return Performer_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_physicalLocation INSTANCE = new Performer_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
