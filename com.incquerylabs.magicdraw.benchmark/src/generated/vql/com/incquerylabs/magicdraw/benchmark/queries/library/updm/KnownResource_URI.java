...
public final class KnownResource_URI extends BaseGeneratedEMFQuerySpecification<KnownResource_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_URI";
    }
     ...
     * 
     */
    public static KnownResource_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static KnownResource_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_URI pattern,
  ...
  public static class Matcher extends BaseMatcher<KnownResource_URI.Match> {
     ...
     * 
     */
    public Collection<KnownResource_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<KnownResource_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<KnownResource_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super KnownResource_URI.Match> processor) {
     ...
     * 
     */
    public KnownResource_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final KnownResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final KnownResource_URI.Match partialMatch) {
    ...
    protected KnownResource_URI.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    protected KnownResource_URI.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected KnownResource_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public KnownResource_URI.Match newMatch(final Object... parameters) {
    return KnownResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
