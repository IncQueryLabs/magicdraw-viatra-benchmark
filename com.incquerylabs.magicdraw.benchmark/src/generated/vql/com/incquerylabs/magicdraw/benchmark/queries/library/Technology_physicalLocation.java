...
public final class Technology_physicalLocation extends BaseGeneratedEMFQuerySpecification<Technology_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Technology_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Technology_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Technology_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Technology_physicalLocation.Match)) {
          Technology_physicalLocation.Match other = (Technology_physicalLocation.Match) obj;
    ...
    @Override
    public Technology_physicalLocation specification() {
      return Technology_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Technology_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Technology_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Technology_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Technology_physicalLocation.Match {
    ...
    private static final class Immutable extends Technology_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Technology_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Technology_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Technology_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Technology_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Technology_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Technology_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Technology_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Technology_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Technology_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Technology_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Technology_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Technology_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Technology_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Technology_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Technology_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Technology_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Technology_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Technology_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Technology_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Technology_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Technology_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Technology_physicalLocation.Matcher> querySpecification() {
      return Technology_physicalLocation.instance();
    }
  }
  
  private Technology_physicalLocation() {
   ...
   * 
   */
  public static Technology_physicalLocation instance() {
    try{
  ...
  @Override
  protected Technology_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Technology_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Technology_physicalLocation.Matcher instantiate() {
    return Technology_physicalLocation.Matcher.create();
  }
  
  @Override
  public Technology_physicalLocation.Match newEmptyMatch() {
    return Technology_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Technology_physicalLocation.Match newMatch(final Object... parameters) {
    return Technology_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Technology_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Technology_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Technology_physicalLocation INSTANCE = new Technology_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Technology_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
