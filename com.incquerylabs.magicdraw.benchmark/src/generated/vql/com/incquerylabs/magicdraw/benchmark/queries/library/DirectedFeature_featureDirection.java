...
public final class DirectedFeature_featureDirection extends BaseGeneratedEMFQuerySpecification<DirectedFeature_featureDirection.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DirectedFeature_featureDirection pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DirectedFeature_featureDirection";
    }
    
    @Override
    public List<String> parameterNames() {
      return DirectedFeature_featureDirection.Match.parameterNames;
    }
    ...
    @Override
    public DirectedFeature_featureDirection.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DirectedFeature_featureDirection.Match)) {
          DirectedFeature_featureDirection.Match other = (DirectedFeature_featureDirection.Match) obj;
    ...
    @Override
    public DirectedFeature_featureDirection specification() {
     ...
     * 
     */
    public static DirectedFeature_featureDirection.Match newEmptyMatch() {
     ...
     * 
     */
    public static DirectedFeature_featureDirection.Match newMutableMatch(final Feature pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public static DirectedFeature_featureDirection.Match newMatch(final Feature pElement, final EnumerationLiteral pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DirectedFeature_featureDirection.Match {
      Mutable(final Feature pElement, final EnumerationLiteral pValue) {
    ...
    private static final class Immutable extends DirectedFeature_featureDirection.Match {
      Immutable(final Feature pElement, final EnumerationLiteral pValue) {
        super(pElement, pValue);
      }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DirectedFeature_featureDirection pattern,
   ...
   * 
   * @see Match
   * @see DirectedFeature_featureDirection
   * 
   */
  public static class Matcher extends BaseMatcher<DirectedFeature_featureDirection.Match> {
    /**
     ...
     * 
     */
    public static DirectedFeature_featureDirection.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DirectedFeature_featureDirection.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DirectedFeature_featureDirection.Matcher.class);
     ...
     * 
     */
    public Collection<DirectedFeature_featureDirection.Match> getAllMatches(final Feature pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public Stream<DirectedFeature_featureDirection.Match> streamAllMatches(final Feature pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public Optional<DirectedFeature_featureDirection.Match> getOneArbitraryMatch(final Feature pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public boolean hasMatch(final Feature pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public int countMatches(final Feature pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Feature pElement, final EnumerationLiteral pValue, final Consumer<? super DirectedFeature_featureDirection.Match> processor) {
     ...
     * 
     */
    public DirectedFeature_featureDirection.Match newMatch(final Feature pElement, final EnumerationLiteral pValue) {
      return DirectedFeature_featureDirection.Match.newMatch(pElement, pValue);
    }
    ...
    @Override
    protected DirectedFeature_featureDirection.Match tupleToMatch(final Tuple t) {
      try {
          return DirectedFeature_featureDirection.Match.newMatch((Feature) t.get(POSITION_ELEMENT), (EnumerationLiteral) t.get(POSITION_VALUE));
    ...
    @Override
    protected DirectedFeature_featureDirection.Match arrayToMatch(final Object[] match) {
      try {
          return DirectedFeature_featureDirection.Match.newMatch((Feature) match[POSITION_ELEMENT], (EnumerationLiteral) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DirectedFeature_featureDirection.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DirectedFeature_featureDirection.Match.newMutableMatch((Feature) match[POSITION_ELEMENT], (EnumerationLiteral) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DirectedFeature_featureDirection.Matcher> querySpecification() {
      return DirectedFeature_featureDirection.instance();
    }
  }
  
  private DirectedFeature_featureDirection() {
   ...
   * 
   */
  public static DirectedFeature_featureDirection instance() {
    try{
  ...
  @Override
  protected DirectedFeature_featureDirection.Matcher instantiate(final ViatraQueryEngine engine) {
    return DirectedFeature_featureDirection.Matcher.on(engine);
  }
  
  @Override
  public DirectedFeature_featureDirection.Matcher instantiate() {
    return DirectedFeature_featureDirection.Matcher.create();
  }
  
  @Override
  public DirectedFeature_featureDirection.Match newEmptyMatch() {
    return DirectedFeature_featureDirection.Match.newEmptyMatch();
  }
  
  @Override
  public DirectedFeature_featureDirection.Match newMatch(final Object... parameters) {
    return DirectedFeature_featureDirection.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Feature) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.EnumerationLiteral) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DirectedFeature_featureDirection} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DirectedFeature_featureDirection#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DirectedFeature_featureDirection INSTANCE = new DirectedFeature_featureDirection();
