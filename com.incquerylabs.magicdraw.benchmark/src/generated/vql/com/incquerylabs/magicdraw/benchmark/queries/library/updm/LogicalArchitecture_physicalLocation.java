...
public final class LogicalArchitecture_physicalLocation extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_physicalLocation.Match)) {
          LogicalArchitecture_physicalLocation.Match other = (LogicalArchitecture_physicalLocation.Match) obj;
    ...
    @Override
    public LogicalArchitecture_physicalLocation specification() {
      return LogicalArchitecture_physicalLocation.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static LogicalArchitecture_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends LogicalArchitecture_physicalLocation.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super LogicalArchitecture_physicalLocation.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return LogicalArchitecture_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final LogicalArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final LogicalArchitecture_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected LogicalArchitecture_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_physicalLocation.Matcher> querySpecification() {
      return LogicalArchitecture_physicalLocation.instance();
    }
  }
  
  private LogicalArchitecture_physicalLocation() {
   ...
   * 
   */
  public static LogicalArchitecture_physicalLocation instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_physicalLocation.Matcher instantiate() {
    return LogicalArchitecture_physicalLocation.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_physicalLocation.Match newEmptyMatch() {
    return LogicalArchitecture_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_physicalLocation.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_physicalLocation INSTANCE = new LogicalArchitecture_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
