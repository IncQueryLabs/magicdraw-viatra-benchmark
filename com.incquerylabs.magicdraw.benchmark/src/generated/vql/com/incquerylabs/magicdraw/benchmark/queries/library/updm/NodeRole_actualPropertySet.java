...
public final class NodeRole_actualPropertySet extends BaseGeneratedEMFQuerySpecification<NodeRole_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeRole_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public NodeRole_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeRole_actualPropertySet.Match)) {
          NodeRole_actualPropertySet.Match other = (NodeRole_actualPropertySet.Match) obj;
    ...
    @Override
    public NodeRole_actualPropertySet specification() {
      return NodeRole_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static NodeRole_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeRole_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeRole_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeRole_actualPropertySet.Match {
    ...
    private static final class Immutable extends NodeRole_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see NodeRole_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<NodeRole_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static NodeRole_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeRole_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeRole_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<NodeRole_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeRole_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeRole_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super NodeRole_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public NodeRole_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return NodeRole_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final NodeRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final NodeRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeRole_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected NodeRole_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return NodeRole_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeRole_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return NodeRole_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeRole_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeRole_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeRole_actualPropertySet.Matcher> querySpecification() {
      return NodeRole_actualPropertySet.instance();
    }
  }
  
  private NodeRole_actualPropertySet() {
   ...
   * 
   */
  public static NodeRole_actualPropertySet instance() {
    try{
  ...
  @Override
  protected NodeRole_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeRole_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public NodeRole_actualPropertySet.Matcher instantiate() {
    return NodeRole_actualPropertySet.Matcher.create();
  }
  
  @Override
  public NodeRole_actualPropertySet.Match newEmptyMatch() {
    return NodeRole_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public NodeRole_actualPropertySet.Match newMatch(final Object... parameters) {
    return NodeRole_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeRole_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeRole_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeRole_actualPropertySet INSTANCE = new NodeRole_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeRole_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
