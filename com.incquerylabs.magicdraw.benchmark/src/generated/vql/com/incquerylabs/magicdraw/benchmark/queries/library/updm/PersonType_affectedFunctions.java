...
public final class PersonType_affectedFunctions extends BaseGeneratedEMFQuerySpecification<PersonType_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_affectedFunctions.Match)) {
          PersonType_affectedFunctions.Match other = (PersonType_affectedFunctions.Match) obj;
    ...
    @Override
    public PersonType_affectedFunctions specification() {
      return PersonType_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static PersonType_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_affectedFunctions.Match {
    ...
    private static final class Immutable extends PersonType_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see PersonType_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static PersonType_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public PersonType_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected PersonType_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_affectedFunctions.Matcher> querySpecification() {
      return PersonType_affectedFunctions.instance();
    }
  }
  
  private PersonType_affectedFunctions() {
   ...
   * 
   */
  public static PersonType_affectedFunctions instance() {
    try{
  ...
  @Override
  protected PersonType_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public PersonType_affectedFunctions.Matcher instantiate() {
    return PersonType_affectedFunctions.Matcher.create();
  }
  
  @Override
  public PersonType_affectedFunctions.Match newEmptyMatch() {
    return PersonType_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_affectedFunctions.Match newMatch(final Object... parameters) {
    return PersonType_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_affectedFunctions INSTANCE = new PersonType_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
