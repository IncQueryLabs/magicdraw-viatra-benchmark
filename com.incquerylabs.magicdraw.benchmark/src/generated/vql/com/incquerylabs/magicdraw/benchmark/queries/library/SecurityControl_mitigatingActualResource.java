...
import com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl;
...
public final class SecurityControl_mitigatingActualResource extends BaseGeneratedEMFQuerySpecification<SecurityControl_mitigatingActualResource.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_mitigatingActualResource pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_mitigatingActualResource";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_mitigatingActualResource.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_mitigatingActualResource.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_mitigatingActualResource.Match)) {
          SecurityControl_mitigatingActualResource.Match other = (SecurityControl_mitigatingActualResource.Match) obj;
    ...
    @Override
    public SecurityControl_mitigatingActualResource specification() {
      return SecurityControl_mitigatingActualResource.instance();
    }
     ...
     * 
     */
    public static SecurityControl_mitigatingActualResource.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_mitigatingActualResource.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityControl_mitigatingActualResource.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControl_mitigatingActualResource.Match {
    ...
    private static final class Immutable extends SecurityControl_mitigatingActualResource.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_mitigatingActualResource pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_mitigatingActualResource
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_mitigatingActualResource.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_mitigatingActualResource.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_mitigatingActualResource.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_mitigatingActualResource.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_mitigatingActualResource.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityControl_mitigatingActualResource.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityControl_mitigatingActualResource.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityControl_mitigatingActualResource.Match> processor) {
     ...
     * 
     */
    public SecurityControl_mitigatingActualResource.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityControl_mitigatingActualResource.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_mitigatingActualResource.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_mitigatingActualResource.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityControl_mitigatingActualResource.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityControl_mitigatingActualResource.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_mitigatingActualResource.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_mitigatingActualResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControl_mitigatingActualResource.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_mitigatingActualResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_mitigatingActualResource.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_mitigatingActualResource.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_mitigatingActualResource.Matcher> querySpecification() {
      return SecurityControl_mitigatingActualResource.instance();
    }
  }
  
  private SecurityControl_mitigatingActualResource() {
   ...
   * 
   */
  public static SecurityControl_mitigatingActualResource instance() {
    try{
  ...
  @Override
  protected SecurityControl_mitigatingActualResource.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_mitigatingActualResource.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_mitigatingActualResource.Matcher instantiate() {
    return SecurityControl_mitigatingActualResource.Matcher.create();
  }
  
  @Override
  public SecurityControl_mitigatingActualResource.Match newEmptyMatch() {
    return SecurityControl_mitigatingActualResource.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_mitigatingActualResource.Match newMatch(final Object... parameters) {
    return SecurityControl_mitigatingActualResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_mitigatingActualResource} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_mitigatingActualResource#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_mitigatingActualResource INSTANCE = new SecurityControl_mitigatingActualResource();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_mitigatingActualResource.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find SecurityControl(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), SecurityControl.instance().getInternalQueryRepresentation());
          // 	find	slotValue(domainStereotypeInstance, "mitigatingActualResource", valuespec)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "mitigatingActualResource");
