...
public final class ProjectMilestoneRole_measurementSet extends BaseGeneratedEMFQuerySpecification<ProjectMilestoneRole_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestoneRole_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestoneRole_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestoneRole_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestoneRole_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestoneRole_measurementSet.Match)) {
          ProjectMilestoneRole_measurementSet.Match other = (ProjectMilestoneRole_measurementSet.Match) obj;
    ...
    @Override
    public ProjectMilestoneRole_measurementSet specification() {
      return ProjectMilestoneRole_measurementSet.instance();
    }
     ...
     * 
     */
    public static ProjectMilestoneRole_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestoneRole_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestoneRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestoneRole_measurementSet.Match {
    ...
    private static final class Immutable extends ProjectMilestoneRole_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestoneRole_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestoneRole_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestoneRole_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestoneRole_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestoneRole_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestoneRole_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestoneRole_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestoneRole_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestoneRole_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectMilestoneRole_measurementSet.Match> processor) {
     ...
     * 
     */
    public ProjectMilestoneRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectMilestoneRole_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectMilestoneRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectMilestoneRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestoneRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestoneRole_measurementSet.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestoneRole_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestoneRole_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestoneRole_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestoneRole_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestoneRole_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestoneRole_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestoneRole_measurementSet.Matcher> querySpecification() {
      return ProjectMilestoneRole_measurementSet.instance();
    }
  }
  
  private ProjectMilestoneRole_measurementSet() {
   ...
   * 
   */
  public static ProjectMilestoneRole_measurementSet instance() {
    try{
  ...
  @Override
  protected ProjectMilestoneRole_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestoneRole_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestoneRole_measurementSet.Matcher instantiate() {
    return ProjectMilestoneRole_measurementSet.Matcher.create();
  }
  
  @Override
  public ProjectMilestoneRole_measurementSet.Match newEmptyMatch() {
    return ProjectMilestoneRole_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestoneRole_measurementSet.Match newMatch(final Object... parameters) {
    return ProjectMilestoneRole_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestoneRole_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestoneRole_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestoneRole_measurementSet INSTANCE = new ProjectMilestoneRole_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestoneRole_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
