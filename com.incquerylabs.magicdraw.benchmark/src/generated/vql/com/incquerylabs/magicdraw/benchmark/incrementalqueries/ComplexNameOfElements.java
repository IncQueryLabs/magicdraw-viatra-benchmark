...
public final class ComplexNameOfElements extends BaseGeneratedEMFQuerySpecification<ComplexNameOfElements.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.complexNameOfElements pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.complexNameOfElements";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.complexNameOfElements pattern,
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find namedElement(element, name)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_name), com.incquerylabs.magicdraw.benchmark.incrementalqueries.NamedElement.instance().getInternalQueryRepresentation());
          // 	complexName == eval(name.toFirstUpper + ". "+ name.toFirstLower + "." + name.toUpperCase + "." + name.toLowerCase + "." + name.length)
