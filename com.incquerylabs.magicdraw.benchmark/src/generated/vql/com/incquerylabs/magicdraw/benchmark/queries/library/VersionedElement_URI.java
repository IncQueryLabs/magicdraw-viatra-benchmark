...
public final class VersionedElement_URI extends BaseGeneratedEMFQuerySpecification<VersionedElement_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.VersionedElement_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.VersionedElement_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionedElement_URI.Match.parameterNames;
    }
    ...
    @Override
    public VersionedElement_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionedElement_URI.Match)) {
          VersionedElement_URI.Match other = (VersionedElement_URI.Match) obj;
    ...
    @Override
    public VersionedElement_URI specification() {
      return VersionedElement_URI.instance();
    }
     ...
     * 
     */
    public static VersionedElement_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionedElement_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static VersionedElement_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends VersionedElement_URI.Match {
    ...
    private static final class Immutable extends VersionedElement_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.VersionedElement_URI pattern,
   ...
   * 
   * @see Match
   * @see VersionedElement_URI
   * 
   */
  public static class Matcher extends BaseMatcher<VersionedElement_URI.Match> {
    /**
     ...
     * 
     */
    public static VersionedElement_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionedElement_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionedElement_URI.Matcher.class);
     ...
     * 
     */
    public Collection<VersionedElement_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<VersionedElement_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<VersionedElement_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super VersionedElement_URI.Match> processor) {
     ...
     * 
     */
    public VersionedElement_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return VersionedElement_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final VersionedElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final VersionedElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final VersionedElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final VersionedElement_URI.Match partialMatch) {
    ...
    @Override
    protected VersionedElement_URI.Match tupleToMatch(final Tuple t) {
      try {
          return VersionedElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected VersionedElement_URI.Match arrayToMatch(final Object[] match) {
      try {
          return VersionedElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionedElement_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionedElement_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionedElement_URI.Matcher> querySpecification() {
      return VersionedElement_URI.instance();
    }
  }
  
  private VersionedElement_URI() {
   ...
   * 
   */
  public static VersionedElement_URI instance() {
    try{
  ...
  @Override
  protected VersionedElement_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionedElement_URI.Matcher.on(engine);
  }
  
  @Override
  public VersionedElement_URI.Matcher instantiate() {
    return VersionedElement_URI.Matcher.create();
  }
  
  @Override
  public VersionedElement_URI.Match newEmptyMatch() {
    return VersionedElement_URI.Match.newEmptyMatch();
  }
  
  @Override
  public VersionedElement_URI.Match newMatch(final Object... parameters) {
    return VersionedElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionedElement_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionedElement_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionedElement_URI INSTANCE = new VersionedElement_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionedElement_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
