...
public final class ArchitecturalDescription_toBe extends BaseGeneratedEMFQuerySpecification<ArchitecturalDescription_toBe.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ArchitecturalDescription_toBe pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ArchitecturalDescription_toBe";
    }
    
    @Override
    public List<String> parameterNames() {
      return ArchitecturalDescription_toBe.Match.parameterNames;
    }
    ...
    @Override
    public ArchitecturalDescription_toBe.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ArchitecturalDescription_toBe.Match)) {
          ArchitecturalDescription_toBe.Match other = (ArchitecturalDescription_toBe.Match) obj;
    ...
    @Override
    public ArchitecturalDescription_toBe specification() {
      return ArchitecturalDescription_toBe.instance();
    }
     ...
     * 
     */
    public static ArchitecturalDescription_toBe.Match newEmptyMatch() {
     ...
     * 
     */
    public static ArchitecturalDescription_toBe.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ArchitecturalDescription_toBe.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ArchitecturalDescription_toBe.Match {
    ...
    private static final class Immutable extends ArchitecturalDescription_toBe.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ArchitecturalDescription_toBe pattern,
   ...
   * 
   * @see Match
   * @see ArchitecturalDescription_toBe
   * 
   */
  public static class Matcher extends BaseMatcher<ArchitecturalDescription_toBe.Match> {
    /**
     ...
     * 
     */
    public static ArchitecturalDescription_toBe.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ArchitecturalDescription_toBe.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ArchitecturalDescription_toBe.Matcher.class);
     ...
     * 
     */
    public Collection<ArchitecturalDescription_toBe.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ArchitecturalDescription_toBe.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ArchitecturalDescription_toBe.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final LiteralBoolean pValuespec, final Consumer<? super ArchitecturalDescription_toBe.Match> processor) {
     ...
     * 
     */
    public ArchitecturalDescription_toBe.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final LiteralBoolean pValuespec) {
      return ArchitecturalDescription_toBe.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package> streamAllValuesOfelement(final ArchitecturalDescription_toBe.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package> getAllValuesOfelement(final ArchitecturalDescription_toBe.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ArchitecturalDescription_toBe.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ArchitecturalDescription_toBe.Match partialMatch) {
    ...
    @Override
    protected ArchitecturalDescription_toBe.Match tupleToMatch(final Tuple t) {
      try {
          return ArchitecturalDescription_toBe.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ArchitecturalDescription_toBe.Match arrayToMatch(final Object[] match) {
      try {
          return ArchitecturalDescription_toBe.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ArchitecturalDescription_toBe.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ArchitecturalDescription_toBe.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ArchitecturalDescription_toBe.Matcher> querySpecification() {
      return ArchitecturalDescription_toBe.instance();
    }
  }
  
  private ArchitecturalDescription_toBe() {
   ...
   * 
   */
  public static ArchitecturalDescription_toBe instance() {
    try{
  ...
  @Override
  protected ArchitecturalDescription_toBe.Matcher instantiate(final ViatraQueryEngine engine) {
    return ArchitecturalDescription_toBe.Matcher.on(engine);
  }
  
  @Override
  public ArchitecturalDescription_toBe.Matcher instantiate() {
    return ArchitecturalDescription_toBe.Matcher.create();
  }
  
  @Override
  public ArchitecturalDescription_toBe.Match newEmptyMatch() {
    return ArchitecturalDescription_toBe.Match.newEmptyMatch();
  }
  
  @Override
  public ArchitecturalDescription_toBe.Match newMatch(final Object... parameters) {
    return ArchitecturalDescription_toBe.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ArchitecturalDescription_toBe} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ArchitecturalDescription_toBe#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ArchitecturalDescription_toBe INSTANCE = new ArchitecturalDescription_toBe();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ArchitecturalDescription_toBe.GeneratedPQuery INSTANCE = new GeneratedPQuery();
