...
public final class Alias_propertySet extends BaseGeneratedEMFQuerySpecification<Alias_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Alias_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Alias_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Alias_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Alias_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Alias_propertySet.Match)) {
          Alias_propertySet.Match other = (Alias_propertySet.Match) obj;
    ...
    @Override
    public Alias_propertySet specification() {
      return Alias_propertySet.instance();
    }
     ...
     * 
     */
    public static Alias_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Alias_propertySet.Match newMutableMatch(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public static Alias_propertySet.Match newMatch(final Comment pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Alias_propertySet.Match {
    ...
    private static final class Immutable extends Alias_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Alias_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Alias_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Alias_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Alias_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Alias_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Alias_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Alias_propertySet.Match> getAllMatches(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Alias_propertySet.Match> streamAllMatches(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Alias_propertySet.Match> getOneArbitraryMatch(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final Element pValue, final Consumer<? super Alias_propertySet.Match> processor) {
     ...
     * 
     */
    public Alias_propertySet.Match newMatch(final Comment pElement, final Element pValue) {
      return Alias_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Alias_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Alias_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Alias_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Alias_propertySet.Match partialMatch) {
    ...
    @Override
    protected Alias_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Alias_propertySet.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Alias_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Alias_propertySet.Match.newMatch((Comment) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Alias_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Alias_propertySet.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Alias_propertySet.Matcher> querySpecification() {
      return Alias_propertySet.instance();
    }
  }
  
  private Alias_propertySet() {
   ...
   * 
   */
  public static Alias_propertySet instance() {
    try{
  ...
  @Override
  protected Alias_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Alias_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Alias_propertySet.Matcher instantiate() {
    return Alias_propertySet.Matcher.create();
  }
  
  @Override
  public Alias_propertySet.Match newEmptyMatch() {
    return Alias_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Alias_propertySet.Match newMatch(final Object... parameters) {
    return Alias_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Alias_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Alias_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Alias_propertySet INSTANCE = new Alias_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Alias_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
