...
public final class ConditionProperty extends BaseGeneratedEMFQuerySpecification<ConditionProperty.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionProperty.Match.parameterNames;
    }
    ...
    @Override
    public ConditionProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionProperty.Match)) {
          ConditionProperty.Match other = (ConditionProperty.Match) obj;
    ...
    @Override
    public ConditionProperty specification() {
      return ConditionProperty.instance();
    }
     ...
     * 
     */
    public static ConditionProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ConditionProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ConditionProperty.Match {
    ...
    private static final class Immutable extends ConditionProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty pattern,
   ...
   * 
   * @see Match
   * @see ConditionProperty
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionProperty.Match> {
    /**
     ...
     * 
     */
    public static ConditionProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionProperty.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ConditionProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ConditionProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ConditionProperty.Match> processor) {
     ...
     * 
     */
    public ConditionProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ConditionProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConditionProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConditionProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ConditionProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ConditionProperty.Match partialMatch) {
    ...
    @Override
    protected ConditionProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ConditionProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionProperty.Matcher> querySpecification() {
      return ConditionProperty.instance();
    }
  }
   ...
   * 
   */
  public static ConditionProperty instance() {
    try{
  ...
  @Override
  protected ConditionProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionProperty.Matcher.on(engine);
  }
  
  @Override
  public ConditionProperty.Matcher instantiate() {
    return ConditionProperty.Matcher.create();
  }
  
  @Override
  public ConditionProperty.Match newEmptyMatch() {
    return ConditionProperty.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionProperty.Match newMatch(final Object... parameters) {
    return ConditionProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionProperty} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionProperty#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionProperty INSTANCE = new ConditionProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ConditionProperty");
