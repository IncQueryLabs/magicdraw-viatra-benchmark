...
public final class Rule_URI extends BaseGeneratedEMFQuerySpecification<Rule_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_URI";
    }
     ...
     * 
     */
    public static Rule_URI.Match newMutableMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Rule_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_URI pattern,
  ...
  public static class Matcher extends BaseMatcher<Rule_URI.Match> {
     ...
     * 
     */
    public Collection<Rule_URI.Match> getAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Rule_URI.Match> streamAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Rule_URI.Match> getOneArbitraryMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final LiteralString pValuespec, final Consumer<? super Rule_URI.Match> processor) {
     ...
     * 
     */
    public Rule_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Rule_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Rule_URI.Match partialMatch) {
    ...
    protected Rule_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Rule_URI.Match.newMatch((Element) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    protected Rule_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Rule_URI.Match.newMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected Rule_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rule_URI.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Rule_URI.Match newMatch(final Object... parameters) {
    return Rule_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
