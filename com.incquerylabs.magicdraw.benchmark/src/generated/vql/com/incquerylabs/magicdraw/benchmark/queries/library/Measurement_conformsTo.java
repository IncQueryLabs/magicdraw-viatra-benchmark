...
public final class Measurement_conformsTo extends BaseGeneratedEMFQuerySpecification<Measurement_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Measurement_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Measurement_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measurement_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Measurement_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measurement_conformsTo.Match)) {
          Measurement_conformsTo.Match other = (Measurement_conformsTo.Match) obj;
    ...
    @Override
    public Measurement_conformsTo specification() {
      return Measurement_conformsTo.instance();
    }
     ...
     * 
     */
    public static Measurement_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measurement_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static Measurement_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Measurement_conformsTo.Match {
    ...
    private static final class Immutable extends Measurement_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Measurement_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Measurement_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Measurement_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Measurement_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measurement_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measurement_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Measurement_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Measurement_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Measurement_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super Measurement_conformsTo.Match> processor) {
     ...
     * 
     */
    public Measurement_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return Measurement_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Measurement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Measurement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Measurement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Measurement_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Measurement_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Measurement_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Measurement_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Measurement_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measurement_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measurement_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measurement_conformsTo.Matcher> querySpecification() {
      return Measurement_conformsTo.instance();
    }
  }
  
  private Measurement_conformsTo() {
   ...
   * 
   */
  public static Measurement_conformsTo instance() {
    try{
  ...
  @Override
  protected Measurement_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measurement_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Measurement_conformsTo.Matcher instantiate() {
    return Measurement_conformsTo.Matcher.create();
  }
  
  @Override
  public Measurement_conformsTo.Match newEmptyMatch() {
    return Measurement_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Measurement_conformsTo.Match newMatch(final Object... parameters) {
    return Measurement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measurement_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measurement_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Measurement_conformsTo INSTANCE = new Measurement_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measurement_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
