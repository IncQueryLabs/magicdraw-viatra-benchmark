...
public final class System_conformsTo extends BaseGeneratedEMFQuerySpecification<System_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public System_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_conformsTo.Match)) {
          System_conformsTo.Match other = (System_conformsTo.Match) obj;
    ...
    @Override
    public System_conformsTo specification() {
      return System_conformsTo.instance();
    }
     ...
     * 
     */
    public static System_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_conformsTo.Match {
    ...
    private static final class Immutable extends System_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see System_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<System_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static System_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<System_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_conformsTo.Match> processor) {
     ...
     * 
     */
    public System_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_conformsTo.Match partialMatch) {
    ...
    @Override
    protected System_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return System_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return System_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_conformsTo.Matcher> querySpecification() {
      return System_conformsTo.instance();
    }
  }
  
  private System_conformsTo() {
   ...
   * 
   */
  public static System_conformsTo instance() {
    try{
  ...
  @Override
  protected System_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public System_conformsTo.Matcher instantiate() {
    return System_conformsTo.Matcher.create();
  }
  
  @Override
  public System_conformsTo.Match newEmptyMatch() {
    return System_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public System_conformsTo.Match newMatch(final Object... parameters) {
    return System_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_conformsTo INSTANCE = new System_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
