...
public final class ElementGroup_criterion extends BaseGeneratedEMFQuerySpecification<ElementGroup_criterion.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public static ElementGroup_criterion.Match newMutableMatch(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public static ElementGroup_criterion.Match newMatch(final Comment pElement, final String pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ElementGroup_criterion.Match {
      Mutable(final Comment pElement, final String pValue) {
    ...
    private static final class Immutable extends ElementGroup_criterion.Match {
      Immutable(final Comment pElement, final String pValue) {
        super(pElement, pValue);
      }
  ...
  public static class Matcher extends BaseMatcher<ElementGroup_criterion.Match> {
     ...
     * 
     */
    public Collection<ElementGroup_criterion.Match> getAllMatches(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public Stream<ElementGroup_criterion.Match> streamAllMatches(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public Optional<ElementGroup_criterion.Match> getOneArbitraryMatch(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public boolean hasMatch(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public int countMatches(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final String pValue, final Consumer<? super ElementGroup_criterion.Match> processor) {
     ...
     * 
     */
    public ElementGroup_criterion.Match newMatch(final Comment pElement, final String pValue) {
      return ElementGroup_criterion.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfElement(final String pValue) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfElement(final String pValue) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final ElementGroup_criterion.Match partialMatch) {
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final Comment pElement) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final ElementGroup_criterion.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final Comment pElement) {
    ...
    protected ElementGroup_criterion.Match tupleToMatch(final Tuple t) {
      try {
          return ElementGroup_criterion.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected ElementGroup_criterion.Match arrayToMatch(final Object[] match) {
      try {
          return ElementGroup_criterion.Match.newMatch((Comment) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected ElementGroup_criterion.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ElementGroup_criterion.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ElementGroup_criterion.Match newMatch(final Object... parameters) {
    return ElementGroup_criterion.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (java.lang.String) parameters[1]);
  }
