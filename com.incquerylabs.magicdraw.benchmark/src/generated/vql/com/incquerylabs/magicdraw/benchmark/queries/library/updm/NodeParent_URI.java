...
public final class NodeParent_URI extends BaseGeneratedEMFQuerySpecification<NodeParent_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_URI.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_URI.Match)) {
          NodeParent_URI.Match other = (NodeParent_URI.Match) obj;
    ...
    @Override
    public NodeParent_URI specification() {
      return NodeParent_URI.instance();
    }
     ...
     * 
     */
    public static NodeParent_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static NodeParent_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends NodeParent_URI.Match {
    ...
    private static final class Immutable extends NodeParent_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_URI.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_URI.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<NodeParent_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<NodeParent_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super NodeParent_URI.Match> processor) {
     ...
     * 
     */
    public NodeParent_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return NodeParent_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final NodeParent_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final NodeParent_URI.Match partialMatch) {
    ...
    @Override
    protected NodeParent_URI.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected NodeParent_URI.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_URI.Matcher> querySpecification() {
      return NodeParent_URI.instance();
    }
  }
  
  private NodeParent_URI() {
   ...
   * 
   */
  public static NodeParent_URI instance() {
    try{
  ...
  @Override
  protected NodeParent_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_URI.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_URI.Matcher instantiate() {
    return NodeParent_URI.Matcher.create();
  }
  
  @Override
  public NodeParent_URI.Match newEmptyMatch() {
    return NodeParent_URI.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_URI.Match newMatch(final Object... parameters) {
    return NodeParent_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_URI INSTANCE = new NodeParent_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
