...
public final class ResourceMitigation_conformsTo extends BaseGeneratedEMFQuerySpecification<ResourceMitigation_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceMitigation_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ResourceMitigation_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceMitigation_conformsTo.Match)) {
          ResourceMitigation_conformsTo.Match other = (ResourceMitigation_conformsTo.Match) obj;
    ...
    @Override
    public ResourceMitigation_conformsTo specification() {
      return ResourceMitigation_conformsTo.instance();
    }
     ...
     * 
     */
    public static ResourceMitigation_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceMitigation_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceMitigation_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceMitigation_conformsTo.Match {
    ...
    private static final class Immutable extends ResourceMitigation_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ResourceMitigation_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceMitigation_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ResourceMitigation_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceMitigation_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceMitigation_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceMitigation_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceMitigation_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceMitigation_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceMitigation_conformsTo.Match> processor) {
     ...
     * 
     */
    public ResourceMitigation_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceMitigation_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceMitigation_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceMitigation_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceMitigation_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceMitigation_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ResourceMitigation_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceMitigation_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceMitigation_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceMitigation_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceMitigation_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceMitigation_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceMitigation_conformsTo.Matcher> querySpecification() {
      return ResourceMitigation_conformsTo.instance();
    }
  }
  
  private ResourceMitigation_conformsTo() {
   ...
   * 
   */
  public static ResourceMitigation_conformsTo instance() {
    try{
  ...
  @Override
  protected ResourceMitigation_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceMitigation_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ResourceMitigation_conformsTo.Matcher instantiate() {
    return ResourceMitigation_conformsTo.Matcher.create();
  }
  
  @Override
  public ResourceMitigation_conformsTo.Match newEmptyMatch() {
    return ResourceMitigation_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceMitigation_conformsTo.Match newMatch(final Object... parameters) {
    return ResourceMitigation_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceMitigation_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceMitigation_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceMitigation_conformsTo INSTANCE = new ResourceMitigation_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceMitigation_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
