...
public final class PhysicalArchitecture_conformsTo extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_conformsTo.Match)) {
          PhysicalArchitecture_conformsTo.Match other = (PhysicalArchitecture_conformsTo.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_conformsTo specification() {
      return PhysicalArchitecture_conformsTo.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_conformsTo.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_conformsTo.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_conformsTo.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_conformsTo.Matcher> querySpecification() {
      return PhysicalArchitecture_conformsTo.instance();
    }
  }
  
  private PhysicalArchitecture_conformsTo() {
   ...
   * 
   */
  public static PhysicalArchitecture_conformsTo instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_conformsTo.Matcher instantiate() {
    return PhysicalArchitecture_conformsTo.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_conformsTo.Match newEmptyMatch() {
    return PhysicalArchitecture_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_conformsTo.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_conformsTo INSTANCE = new PhysicalArchitecture_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
