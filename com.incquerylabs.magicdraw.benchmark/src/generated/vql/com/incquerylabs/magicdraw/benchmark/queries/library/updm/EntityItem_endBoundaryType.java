...
public final class EntityItem_endBoundaryType extends BaseGeneratedEMFQuerySpecification<EntityItem_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityItem_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EntityItem_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityItem_endBoundaryType.Match)) {
          EntityItem_endBoundaryType.Match other = (EntityItem_endBoundaryType.Match) obj;
    ...
    @Override
    public EntityItem_endBoundaryType specification() {
      return EntityItem_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static EntityItem_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityItem_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityItem_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityItem_endBoundaryType.Match {
    ...
    private static final class Immutable extends EntityItem_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EntityItem_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EntityItem_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EntityItem_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityItem_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityItem_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EntityItem_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityItem_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityItem_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EntityItem_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public EntityItem_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EntityItem_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EntityItem_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EntityItem_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityItem_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityItem_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EntityItem_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EntityItem_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityItem_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EntityItem_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityItem_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityItem_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityItem_endBoundaryType.Matcher> querySpecification() {
      return EntityItem_endBoundaryType.instance();
    }
  }
  
  private EntityItem_endBoundaryType() {
   ...
   * 
   */
  public static EntityItem_endBoundaryType instance() {
    try{
  ...
  @Override
  protected EntityItem_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityItem_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EntityItem_endBoundaryType.Matcher instantiate() {
    return EntityItem_endBoundaryType.Matcher.create();
  }
  
  @Override
  public EntityItem_endBoundaryType.Match newEmptyMatch() {
    return EntityItem_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EntityItem_endBoundaryType.Match newMatch(final Object... parameters) {
    return EntityItem_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityItem_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityItem_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityItem_endBoundaryType INSTANCE = new EntityItem_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityItem_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
