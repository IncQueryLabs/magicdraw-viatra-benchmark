...
public final class PhysicalResource_function extends BaseGeneratedEMFQuerySpecification<PhysicalResource_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_function.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_function.Match)) {
          PhysicalResource_function.Match other = (PhysicalResource_function.Match) obj;
    ...
    @Override
    public PhysicalResource_function specification() {
      return PhysicalResource_function.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_function.Match {
    ...
    private static final class Immutable extends PhysicalResource_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_function pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_function
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_function.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_function.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_function.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_function.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_function.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_function.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_function.Matcher> querySpecification() {
      return PhysicalResource_function.instance();
    }
  }
  
  private PhysicalResource_function() {
   ...
   * 
   */
  public static PhysicalResource_function instance() {
    try{
  ...
  @Override
  protected PhysicalResource_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_function.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_function.Matcher instantiate() {
    return PhysicalResource_function.Matcher.create();
  }
  
  @Override
  public PhysicalResource_function.Match newEmptyMatch() {
    return PhysicalResource_function.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_function.Match newMatch(final Object... parameters) {
    return PhysicalResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_function INSTANCE = new PhysicalResource_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
