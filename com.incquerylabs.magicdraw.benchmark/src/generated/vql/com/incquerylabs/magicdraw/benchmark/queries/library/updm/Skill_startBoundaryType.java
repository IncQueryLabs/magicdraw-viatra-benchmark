...
public final class Skill_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Skill_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Skill_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Skill_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Skill_startBoundaryType.Match)) {
          Skill_startBoundaryType.Match other = (Skill_startBoundaryType.Match) obj;
    ...
    @Override
    public Skill_startBoundaryType specification() {
      return Skill_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Skill_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Skill_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Skill_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Skill_startBoundaryType.Match {
    ...
    private static final class Immutable extends Skill_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Skill_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Skill_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Skill_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Skill_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Skill_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Skill_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Skill_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Skill_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Skill_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Skill_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Skill_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Skill_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Skill_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Skill_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Skill_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Skill_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Skill_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Skill_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Skill_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Skill_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Skill_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Skill_startBoundaryType.Matcher> querySpecification() {
      return Skill_startBoundaryType.instance();
    }
  }
  
  private Skill_startBoundaryType() {
   ...
   * 
   */
  public static Skill_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Skill_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Skill_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Skill_startBoundaryType.Matcher instantiate() {
    return Skill_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Skill_startBoundaryType.Match newEmptyMatch() {
    return Skill_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Skill_startBoundaryType.Match newMatch(final Object... parameters) {
    return Skill_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Skill_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Skill_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Skill_startBoundaryType INSTANCE = new Skill_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Skill_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
