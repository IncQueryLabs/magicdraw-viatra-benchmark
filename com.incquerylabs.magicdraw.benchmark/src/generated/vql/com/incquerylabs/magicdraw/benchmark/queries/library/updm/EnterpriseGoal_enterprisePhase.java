...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal;
...
public final class EnterpriseGoal_enterprisePhase extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_enterprisePhase.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_enterprisePhase pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_enterprisePhase";
    }
     ...
     * 
     */
    public static EnterpriseGoal_enterprisePhase.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_enterprisePhase.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_enterprisePhase pattern,
  ...
  public static class Matcher extends BaseMatcher<EnterpriseGoal_enterprisePhase.Match> {
     ...
     * 
     */
    public Collection<EnterpriseGoal_enterprisePhase.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_enterprisePhase.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_enterprisePhase.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super EnterpriseGoal_enterprisePhase.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_enterprisePhase.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfvalue(final EnterpriseGoal_enterprisePhase.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfvalue(final EnterpriseGoal_enterprisePhase.Match partialMatch) {
    ...
    protected EnterpriseGoal_enterprisePhase.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_enterprisePhase.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    protected EnterpriseGoal_enterprisePhase.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_enterprisePhase.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected EnterpriseGoal_enterprisePhase.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_enterprisePhase.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public EnterpriseGoal_enterprisePhase.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_enterprisePhase.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
