...
public final class EnvironmentProperty_actualPropertySet extends BaseGeneratedEMFQuerySpecification<EnvironmentProperty_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnvironmentProperty_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public EnvironmentProperty_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnvironmentProperty_actualPropertySet.Match)) {
          EnvironmentProperty_actualPropertySet.Match other = (EnvironmentProperty_actualPropertySet.Match) obj;
    ...
    @Override
    public EnvironmentProperty_actualPropertySet specification() {
      return EnvironmentProperty_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static EnvironmentProperty_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnvironmentProperty_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EnvironmentProperty_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnvironmentProperty_actualPropertySet.Match {
    ...
    private static final class Immutable extends EnvironmentProperty_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see EnvironmentProperty_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EnvironmentProperty_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static EnvironmentProperty_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnvironmentProperty_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnvironmentProperty_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EnvironmentProperty_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnvironmentProperty_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnvironmentProperty_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EnvironmentProperty_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public EnvironmentProperty_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return EnvironmentProperty_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EnvironmentProperty_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EnvironmentProperty_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnvironmentProperty_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnvironmentProperty_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected EnvironmentProperty_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EnvironmentProperty_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnvironmentProperty_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EnvironmentProperty_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnvironmentProperty_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnvironmentProperty_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnvironmentProperty_actualPropertySet.Matcher> querySpecification() {
      return EnvironmentProperty_actualPropertySet.instance();
    }
  }
  
  private EnvironmentProperty_actualPropertySet() {
   ...
   * 
   */
  public static EnvironmentProperty_actualPropertySet instance() {
    try{
  ...
  @Override
  protected EnvironmentProperty_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnvironmentProperty_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public EnvironmentProperty_actualPropertySet.Matcher instantiate() {
    return EnvironmentProperty_actualPropertySet.Matcher.create();
  }
  
  @Override
  public EnvironmentProperty_actualPropertySet.Match newEmptyMatch() {
    return EnvironmentProperty_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EnvironmentProperty_actualPropertySet.Match newMatch(final Object... parameters) {
    return EnvironmentProperty_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnvironmentProperty_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnvironmentProperty_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnvironmentProperty_actualPropertySet INSTANCE = new EnvironmentProperty_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnvironmentProperty_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
