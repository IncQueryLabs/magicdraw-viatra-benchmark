...
public final class ContextDiagram extends BaseGeneratedEMFQuerySpecification<ContextDiagram.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ContextDiagram.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ContextDiagram.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<ContextDiagram.Match> {
     ...
     * 
     */
    public Collection<ContextDiagram.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ContextDiagram.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ContextDiagram.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super ContextDiagram.Match> processor) {
     ...
     * 
     */
    public ContextDiagram.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return ContextDiagram.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ContextDiagram.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ContextDiagram.Match partialMatch) {
    ...
    protected ContextDiagram.Match tupleToMatch(final Tuple t) {
      try {
          return ContextDiagram.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ContextDiagram.Match arrayToMatch(final Object[] match) {
      try {
          return ContextDiagram.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ContextDiagram.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ContextDiagram.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ContextDiagram.Match newMatch(final Object... parameters) {
    return ContextDiagram.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
