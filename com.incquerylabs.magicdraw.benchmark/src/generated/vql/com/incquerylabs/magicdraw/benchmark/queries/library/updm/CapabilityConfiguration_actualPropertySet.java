...
public final class CapabilityConfiguration_actualPropertySet extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_actualPropertySet.Match)) {
          CapabilityConfiguration_actualPropertySet.Match other = (CapabilityConfiguration_actualPropertySet.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_actualPropertySet specification() {
      return CapabilityConfiguration_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_actualPropertySet.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_actualPropertySet.Matcher> querySpecification() {
      return CapabilityConfiguration_actualPropertySet.instance();
    }
  }
  
  private CapabilityConfiguration_actualPropertySet() {
   ...
   * 
   */
  public static CapabilityConfiguration_actualPropertySet instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_actualPropertySet.Matcher instantiate() {
    return CapabilityConfiguration_actualPropertySet.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_actualPropertySet.Match newEmptyMatch() {
    return CapabilityConfiguration_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_actualPropertySet.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_actualPropertySet INSTANCE = new CapabilityConfiguration_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
