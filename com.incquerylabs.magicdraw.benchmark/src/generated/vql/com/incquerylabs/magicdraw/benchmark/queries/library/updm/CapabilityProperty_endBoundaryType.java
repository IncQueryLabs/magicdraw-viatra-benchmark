...
public final class CapabilityProperty_endBoundaryType extends BaseGeneratedEMFQuerySpecification<CapabilityProperty_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty_endBoundaryType.Match)) {
          CapabilityProperty_endBoundaryType.Match other = (CapabilityProperty_endBoundaryType.Match) obj;
    ...
    @Override
    public CapabilityProperty_endBoundaryType specification() {
      return CapabilityProperty_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityProperty_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityProperty_endBoundaryType.Match {
    ...
    private static final class Immutable extends CapabilityProperty_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityProperty_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityProperty_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super CapabilityProperty_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return CapabilityProperty_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityProperty_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityProperty_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty_endBoundaryType.Matcher> querySpecification() {
      return CapabilityProperty_endBoundaryType.instance();
    }
  }
  
  private CapabilityProperty_endBoundaryType() {
   ...
   * 
   */
  public static CapabilityProperty_endBoundaryType instance() {
    try{
  ...
  @Override
  protected CapabilityProperty_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty_endBoundaryType.Matcher instantiate() {
    return CapabilityProperty_endBoundaryType.Matcher.create();
  }
  
  @Override
  public CapabilityProperty_endBoundaryType.Match newEmptyMatch() {
    return CapabilityProperty_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty_endBoundaryType.Match newMatch(final Object... parameters) {
    return CapabilityProperty_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty_endBoundaryType INSTANCE = new CapabilityProperty_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
