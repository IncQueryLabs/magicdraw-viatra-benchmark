...
public final class StandardConfiguration extends BaseGeneratedEMFQuerySpecification<StandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.StandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return StandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public StandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StandardConfiguration.Match)) {
          StandardConfiguration.Match other = (StandardConfiguration.Match) obj;
    ...
    @Override
    public StandardConfiguration specification() {
      return StandardConfiguration.instance();
    }
     ...
     * 
     */
    public static StandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static StandardConfiguration.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static StandardConfiguration.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends StandardConfiguration.Match {
    ...
    private static final class Immutable extends StandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StandardConfiguration pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<StandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static StandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<StandardConfiguration.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<StandardConfiguration.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<StandardConfiguration.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super StandardConfiguration.Match> processor) {
     ...
     * 
     */
    public StandardConfiguration.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return StandardConfiguration.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final StandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final StandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final StandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final StandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected StandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return StandardConfiguration.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected StandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return StandardConfiguration.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StandardConfiguration.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StandardConfiguration.Matcher> querySpecification() {
      return StandardConfiguration.instance();
    }
  }
  ...
  @Override
  protected StandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return StandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public StandardConfiguration.Matcher instantiate() {
    return StandardConfiguration.Matcher.create();
  }
  
  @Override
  public StandardConfiguration.Match newEmptyMatch() {
    return StandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public StandardConfiguration.Match newMatch(final Object... parameters) {
    return StandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StandardConfiguration INSTANCE = new StandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "StandardConfiguration");
