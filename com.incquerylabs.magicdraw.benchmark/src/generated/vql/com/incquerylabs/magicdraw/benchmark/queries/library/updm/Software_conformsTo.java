...
public final class Software_conformsTo extends BaseGeneratedEMFQuerySpecification<Software_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Software_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_conformsTo.Match)) {
          Software_conformsTo.Match other = (Software_conformsTo.Match) obj;
    ...
    @Override
    public Software_conformsTo specification() {
      return Software_conformsTo.instance();
    }
     ...
     * 
     */
    public static Software_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_conformsTo.Match {
    ...
    private static final class Immutable extends Software_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Software_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Software_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Software_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Software_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_conformsTo.Match> processor) {
     ...
     * 
     */
    public Software_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Software_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Software_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Software_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_conformsTo.Matcher> querySpecification() {
      return Software_conformsTo.instance();
    }
  }
  
  private Software_conformsTo() {
   ...
   * 
   */
  public static Software_conformsTo instance() {
    try{
  ...
  @Override
  protected Software_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Software_conformsTo.Matcher instantiate() {
    return Software_conformsTo.Matcher.create();
  }
  
  @Override
  public Software_conformsTo.Match newEmptyMatch() {
    return Software_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Software_conformsTo.Match newMatch(final Object... parameters) {
    return Software_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_conformsTo INSTANCE = new Software_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
