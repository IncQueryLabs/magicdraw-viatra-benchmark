...
public final class ServiceSpecification_conformsTo extends BaseGeneratedEMFQuerySpecification<ServiceSpecification_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceSpecification_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ServiceSpecification_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceSpecification_conformsTo.Match)) {
          ServiceSpecification_conformsTo.Match other = (ServiceSpecification_conformsTo.Match) obj;
    ...
    @Override
    public ServiceSpecification_conformsTo specification() {
      return ServiceSpecification_conformsTo.instance();
    }
     ...
     * 
     */
    public static ServiceSpecification_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceSpecification_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceSpecification_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceSpecification_conformsTo.Match {
    ...
    private static final class Immutable extends ServiceSpecification_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ServiceSpecification_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceSpecification_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ServiceSpecification_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceSpecification_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceSpecification_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceSpecification_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceSpecification_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceSpecification_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceSpecification_conformsTo.Match> processor) {
     ...
     * 
     */
    public ServiceSpecification_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceSpecification_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceSpecification_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceSpecification_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceSpecification_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceSpecification_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ServiceSpecification_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceSpecification_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceSpecification_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceSpecification_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceSpecification_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceSpecification_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceSpecification_conformsTo.Matcher> querySpecification() {
      return ServiceSpecification_conformsTo.instance();
    }
  }
  
  private ServiceSpecification_conformsTo() {
   ...
   * 
   */
  public static ServiceSpecification_conformsTo instance() {
    try{
  ...
  @Override
  protected ServiceSpecification_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceSpecification_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ServiceSpecification_conformsTo.Matcher instantiate() {
    return ServiceSpecification_conformsTo.Matcher.create();
  }
  
  @Override
  public ServiceSpecification_conformsTo.Match newEmptyMatch() {
    return ServiceSpecification_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceSpecification_conformsTo.Match newMatch(final Object... parameters) {
    return ServiceSpecification_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceSpecification_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceSpecification_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceSpecification_conformsTo INSTANCE = new ServiceSpecification_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceSpecification_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
