...
public final class ConceptRole extends BaseGeneratedEMFQuerySpecification<ConceptRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ConceptRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ConceptRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptRole.Match.parameterNames;
    }
    ...
    @Override
    public ConceptRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptRole.Match)) {
          ConceptRole.Match other = (ConceptRole.Match) obj;
    ...
    @Override
    public ConceptRole specification() {
      return ConceptRole.instance();
    }
     ...
     * 
     */
    public static ConceptRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptRole.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ConceptRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ConceptRole.Match {
    ...
    private static final class Immutable extends ConceptRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ConceptRole pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptRole.Match> {
    /**
     ...
     * 
     */
    public static ConceptRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptRole.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptRole.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ConceptRole.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ConceptRole.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ConceptRole.Match> processor) {
     ...
     * 
     */
    public ConceptRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ConceptRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConceptRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConceptRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ConceptRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ConceptRole.Match partialMatch) {
    ...
    @Override
    protected ConceptRole.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptRole.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ConceptRole.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptRole.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptRole.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptRole.Matcher> querySpecification() {
      return ConceptRole.instance();
    }
  }
   ...
   * 
   */
  public static ConceptRole instance() {
    try{
  ...
  @Override
  protected ConceptRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptRole.Matcher.on(engine);
  }
  
  @Override
  public ConceptRole.Matcher instantiate() {
    return ConceptRole.Matcher.create();
  }
  
  @Override
  public ConceptRole.Match newEmptyMatch() {
    return ConceptRole.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptRole.Match newMatch(final Object... parameters) {
    return ConceptRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptRole INSTANCE = new ConceptRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ConceptRole")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ConceptRole");
