...
public final class PhysicalResource_physicalLocation extends BaseGeneratedEMFQuerySpecification<PhysicalResource_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_physicalLocation.Match)) {
          PhysicalResource_physicalLocation.Match other = (PhysicalResource_physicalLocation.Match) obj;
    ...
    @Override
    public PhysicalResource_physicalLocation specification() {
      return PhysicalResource_physicalLocation.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_physicalLocation.Match {
    ...
    private static final class Immutable extends PhysicalResource_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_physicalLocation.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_physicalLocation.Matcher> querySpecification() {
      return PhysicalResource_physicalLocation.instance();
    }
  }
  
  private PhysicalResource_physicalLocation() {
   ...
   * 
   */
  public static PhysicalResource_physicalLocation instance() {
    try{
  ...
  @Override
  protected PhysicalResource_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_physicalLocation.Matcher instantiate() {
    return PhysicalResource_physicalLocation.Matcher.create();
  }
  
  @Override
  public PhysicalResource_physicalLocation.Match newEmptyMatch() {
    return PhysicalResource_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_physicalLocation.Match newMatch(final Object... parameters) {
    return PhysicalResource_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_physicalLocation INSTANCE = new PhysicalResource_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
