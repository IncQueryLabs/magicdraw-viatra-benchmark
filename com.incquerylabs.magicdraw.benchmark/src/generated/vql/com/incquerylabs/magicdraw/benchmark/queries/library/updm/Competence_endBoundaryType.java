...
public final class Competence_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Competence_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Competence_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Competence_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Competence_endBoundaryType.Match)) {
          Competence_endBoundaryType.Match other = (Competence_endBoundaryType.Match) obj;
    ...
    @Override
    public Competence_endBoundaryType specification() {
      return Competence_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Competence_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Competence_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Competence_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Competence_endBoundaryType.Match {
    ...
    private static final class Immutable extends Competence_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Competence_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Competence_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Competence_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Competence_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Competence_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Competence_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Competence_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Competence_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Competence_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Competence_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Competence_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Competence_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Competence_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Competence_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Competence_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Competence_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Competence_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Competence_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Competence_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Competence_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Competence_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Competence_endBoundaryType.Matcher> querySpecification() {
      return Competence_endBoundaryType.instance();
    }
  }
  
  private Competence_endBoundaryType() {
   ...
   * 
   */
  public static Competence_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Competence_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Competence_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Competence_endBoundaryType.Matcher instantiate() {
    return Competence_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Competence_endBoundaryType.Match newEmptyMatch() {
    return Competence_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Competence_endBoundaryType.Match newMatch(final Object... parameters) {
    return Competence_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Competence_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Competence_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Competence_endBoundaryType INSTANCE = new Competence_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Competence_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
