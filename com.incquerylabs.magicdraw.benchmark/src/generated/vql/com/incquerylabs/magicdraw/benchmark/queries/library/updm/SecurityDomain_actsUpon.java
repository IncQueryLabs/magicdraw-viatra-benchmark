...
public final class SecurityDomain_actsUpon extends BaseGeneratedEMFQuerySpecification<SecurityDomain_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_actsUpon.Match)) {
          SecurityDomain_actsUpon.Match other = (SecurityDomain_actsUpon.Match) obj;
    ...
    @Override
    public SecurityDomain_actsUpon specification() {
      return SecurityDomain_actsUpon.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityDomain_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_actsUpon.Match {
    ...
    private static final class Immutable extends SecurityDomain_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityDomain_actsUpon.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityDomain_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityDomain_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityDomain_actsUpon.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_actsUpon.Matcher> querySpecification() {
      return SecurityDomain_actsUpon.instance();
    }
  }
  
  private SecurityDomain_actsUpon() {
   ...
   * 
   */
  public static SecurityDomain_actsUpon instance() {
    try{
  ...
  @Override
  protected SecurityDomain_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_actsUpon.Matcher instantiate() {
    return SecurityDomain_actsUpon.Matcher.create();
  }
  
  @Override
  public SecurityDomain_actsUpon.Match newEmptyMatch() {
    return SecurityDomain_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_actsUpon.Match newMatch(final Object... parameters) {
    return SecurityDomain_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_actsUpon INSTANCE = new SecurityDomain_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
