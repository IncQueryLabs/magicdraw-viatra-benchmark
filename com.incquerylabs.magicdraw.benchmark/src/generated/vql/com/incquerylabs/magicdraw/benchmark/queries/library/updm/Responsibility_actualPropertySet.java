...
public final class Responsibility_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Responsibility_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_actualPropertySet.Match)) {
          Responsibility_actualPropertySet.Match other = (Responsibility_actualPropertySet.Match) obj;
    ...
    @Override
    public Responsibility_actualPropertySet specification() {
      return Responsibility_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Responsibility_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_actualPropertySet.Match {
    ...
    private static final class Immutable extends Responsibility_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Responsibility_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Responsibility_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_actualPropertySet.Matcher> querySpecification() {
      return Responsibility_actualPropertySet.instance();
    }
  }
  
  private Responsibility_actualPropertySet() {
   ...
   * 
   */
  public static Responsibility_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Responsibility_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_actualPropertySet.Matcher instantiate() {
    return Responsibility_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Responsibility_actualPropertySet.Match newEmptyMatch() {
    return Responsibility_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_actualPropertySet.Match newMatch(final Object... parameters) {
    return Responsibility_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_actualPropertySet INSTANCE = new Responsibility_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
