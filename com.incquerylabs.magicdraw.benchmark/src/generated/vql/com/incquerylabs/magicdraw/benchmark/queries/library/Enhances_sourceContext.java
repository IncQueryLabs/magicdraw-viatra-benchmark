...
public final class Enhances_sourceContext extends BaseGeneratedEMFQuerySpecification<Enhances_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Enhances_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public Enhances_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Enhances_sourceContext.Match)) {
          Enhances_sourceContext.Match other = (Enhances_sourceContext.Match) obj;
    ...
    @Override
    public Enhances_sourceContext specification() {
      return Enhances_sourceContext.instance();
    }
     ...
     * 
     */
    public static Enhances_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Enhances_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Enhances_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Enhances_sourceContext.Match {
    ...
    private static final class Immutable extends Enhances_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see Enhances_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<Enhances_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static Enhances_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Enhances_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Enhances_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<Enhances_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Enhances_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Enhances_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Enhances_sourceContext.Match> processor) {
     ...
     * 
     */
    public Enhances_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Enhances_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Enhances_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Enhances_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Enhances_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Enhances_sourceContext.Match partialMatch) {
    ...
    @Override
    protected Enhances_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return Enhances_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Enhances_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return Enhances_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Enhances_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Enhances_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Enhances_sourceContext.Matcher> querySpecification() {
      return Enhances_sourceContext.instance();
    }
  }
  
  private Enhances_sourceContext() {
   ...
   * 
   */
  public static Enhances_sourceContext instance() {
    try{
  ...
  @Override
  protected Enhances_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Enhances_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public Enhances_sourceContext.Matcher instantiate() {
    return Enhances_sourceContext.Matcher.create();
  }
  
  @Override
  public Enhances_sourceContext.Match newEmptyMatch() {
    return Enhances_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public Enhances_sourceContext.Match newMatch(final Object... parameters) {
    return Enhances_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Enhances_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Enhances_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Enhances_sourceContext INSTANCE = new Enhances_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Enhances_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
