...
public final class Attachment_encoding extends BaseGeneratedEMFQuerySpecification<Attachment_encoding.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Attachment_encoding pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Attachment_encoding";
    }
    
    @Override
    public List<String> parameterNames() {
      return Attachment_encoding.Match.parameterNames;
    }
    ...
    @Override
    public Attachment_encoding.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Attachment_encoding.Match)) {
          Attachment_encoding.Match other = (Attachment_encoding.Match) obj;
    ...
    @Override
    public Attachment_encoding specification() {
     ...
     * 
     */
    public static Attachment_encoding.Match newEmptyMatch() {
     ...
     * 
     */
    public static Attachment_encoding.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Attachment_encoding.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Attachment_encoding.Match {
    ...
    private static final class Immutable extends Attachment_encoding.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Attachment_encoding pattern,
   ...
   * 
   * @see Match
   * @see Attachment_encoding
   * 
   */
  public static class Matcher extends BaseMatcher<Attachment_encoding.Match> {
    /**
     ...
     * 
     */
    public static Attachment_encoding.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Attachment_encoding.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Attachment_encoding.Matcher.class);
     ...
     * 
     */
    public Collection<Attachment_encoding.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Attachment_encoding.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Attachment_encoding.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super Attachment_encoding.Match> processor) {
     ...
     * 
     */
    public Attachment_encoding.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return Attachment_encoding.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Attachment_encoding.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Attachment_encoding.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Attachment_encoding.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Attachment_encoding.Match partialMatch) {
    ...
    @Override
    protected Attachment_encoding.Match tupleToMatch(final Tuple t) {
      try {
          return Attachment_encoding.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Attachment_encoding.Match arrayToMatch(final Object[] match) {
      try {
          return Attachment_encoding.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Attachment_encoding.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Attachment_encoding.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Attachment_encoding.Matcher> querySpecification() {
      return Attachment_encoding.instance();
    }
  }
  
  private Attachment_encoding() {
   ...
   * 
   */
  public static Attachment_encoding instance() {
    try{
  ...
  @Override
  protected Attachment_encoding.Matcher instantiate(final ViatraQueryEngine engine) {
    return Attachment_encoding.Matcher.on(engine);
  }
  
  @Override
  public Attachment_encoding.Matcher instantiate() {
    return Attachment_encoding.Matcher.create();
  }
  
  @Override
  public Attachment_encoding.Match newEmptyMatch() {
    return Attachment_encoding.Match.newEmptyMatch();
  }
  
  @Override
  public Attachment_encoding.Match newMatch(final Object... parameters) {
    return Attachment_encoding.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Attachment_encoding} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Attachment_encoding#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Attachment_encoding INSTANCE = new Attachment_encoding();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Attachment_encoding.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Attachment(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Attachment.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "encoding", valuespec)
