...
public final class OperationalMitigation_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<OperationalMitigation_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalMitigation_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public OperationalMitigation_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalMitigation_requiredEnvironment.Match)) {
          OperationalMitigation_requiredEnvironment.Match other = (OperationalMitigation_requiredEnvironment.Match) obj;
    ...
    @Override
    public OperationalMitigation_requiredEnvironment specification() {
      return OperationalMitigation_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static OperationalMitigation_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalMitigation_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalMitigation_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalMitigation_requiredEnvironment.Match {
    ...
    private static final class Immutable extends OperationalMitigation_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see OperationalMitigation_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalMitigation_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static OperationalMitigation_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalMitigation_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalMitigation_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalMitigation_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalMitigation_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalMitigation_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalMitigation_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public OperationalMitigation_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalMitigation_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalMitigation_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalMitigation_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalMitigation_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalMitigation_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected OperationalMitigation_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalMitigation_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalMitigation_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalMitigation_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalMitigation_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalMitigation_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalMitigation_requiredEnvironment.Matcher> querySpecification() {
      return OperationalMitigation_requiredEnvironment.instance();
    }
  }
  
  private OperationalMitigation_requiredEnvironment() {
   ...
   * 
   */
  public static OperationalMitigation_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected OperationalMitigation_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalMitigation_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public OperationalMitigation_requiredEnvironment.Matcher instantiate() {
    return OperationalMitigation_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public OperationalMitigation_requiredEnvironment.Match newEmptyMatch() {
    return OperationalMitigation_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalMitigation_requiredEnvironment.Match newMatch(final Object... parameters) {
    return OperationalMitigation_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalMitigation_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalMitigation_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalMitigation_requiredEnvironment INSTANCE = new OperationalMitigation_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalMitigation_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
