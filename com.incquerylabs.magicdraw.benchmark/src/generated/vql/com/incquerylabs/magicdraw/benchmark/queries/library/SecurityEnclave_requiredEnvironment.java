...
public final class SecurityEnclave_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<SecurityEnclave_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave_requiredEnvironment.Match)) {
          SecurityEnclave_requiredEnvironment.Match other = (SecurityEnclave_requiredEnvironment.Match) obj;
    ...
    @Override
    public SecurityEnclave_requiredEnvironment specification() {
      return SecurityEnclave_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityEnclave_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityEnclave_requiredEnvironment.Match {
    ...
    private static final class Immutable extends SecurityEnclave_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see SecurityEnclave_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityEnclave_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityEnclave_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityEnclave_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityEnclave_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityEnclave_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityEnclave_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityEnclave_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave_requiredEnvironment.Matcher> querySpecification() {
      return SecurityEnclave_requiredEnvironment.instance();
    }
  }
  
  private SecurityEnclave_requiredEnvironment() {
   ...
   * 
   */
  public static SecurityEnclave_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected SecurityEnclave_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave_requiredEnvironment.Matcher instantiate() {
    return SecurityEnclave_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public SecurityEnclave_requiredEnvironment.Match newEmptyMatch() {
    return SecurityEnclave_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave_requiredEnvironment.Match newMatch(final Object... parameters) {
    return SecurityEnclave_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave_requiredEnvironment INSTANCE = new SecurityEnclave_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
