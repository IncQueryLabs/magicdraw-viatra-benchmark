...
public final class ServiceAccess_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ServiceAccess_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_actualPropertySet.Match)) {
          ServiceAccess_actualPropertySet.Match other = (ServiceAccess_actualPropertySet.Match) obj;
    ...
    @Override
    public ServiceAccess_actualPropertySet specification() {
      return ServiceAccess_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_actualPropertySet.Match {
    ...
    private static final class Immutable extends ServiceAccess_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_actualPropertySet.Matcher> querySpecification() {
      return ServiceAccess_actualPropertySet.instance();
    }
  }
  
  private ServiceAccess_actualPropertySet() {
   ...
   * 
   */
  public static ServiceAccess_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ServiceAccess_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_actualPropertySet.Matcher instantiate() {
    return ServiceAccess_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ServiceAccess_actualPropertySet.Match newEmptyMatch() {
    return ServiceAccess_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_actualPropertySet.Match newMatch(final Object... parameters) {
    return ServiceAccess_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_actualPropertySet INSTANCE = new ServiceAccess_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
