...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase;
...
public final class EnterprisePhase_actualPropertySet extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_actualPropertySet.Match)) {
          EnterprisePhase_actualPropertySet.Match other = (EnterprisePhase_actualPropertySet.Match) obj;
    ...
    @Override
    public EnterprisePhase_actualPropertySet specification() {
      return EnterprisePhase_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_actualPropertySet.Match {
    ...
    private static final class Immutable extends EnterprisePhase_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_actualPropertySet.Matcher> querySpecification() {
      return EnterprisePhase_actualPropertySet.instance();
    }
  }
  
  private EnterprisePhase_actualPropertySet() {
   ...
   * 
   */
  public static EnterprisePhase_actualPropertySet instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_actualPropertySet.Matcher instantiate() {
    return EnterprisePhase_actualPropertySet.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_actualPropertySet.Match newEmptyMatch() {
    return EnterprisePhase_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_actualPropertySet.Match newMatch(final Object... parameters) {
    return EnterprisePhase_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_actualPropertySet INSTANCE = new EnterprisePhase_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find EnterprisePhase(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), EnterprisePhase.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
