...
public final class NodeRole_startBoundaryType extends BaseGeneratedEMFQuerySpecification<NodeRole_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeRole_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public NodeRole_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeRole_startBoundaryType.Match)) {
          NodeRole_startBoundaryType.Match other = (NodeRole_startBoundaryType.Match) obj;
    ...
    @Override
    public NodeRole_startBoundaryType specification() {
      return NodeRole_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static NodeRole_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeRole_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeRole_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeRole_startBoundaryType.Match {
    ...
    private static final class Immutable extends NodeRole_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see NodeRole_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<NodeRole_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static NodeRole_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeRole_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeRole_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<NodeRole_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeRole_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeRole_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super NodeRole_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public NodeRole_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return NodeRole_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final NodeRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final NodeRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeRole_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected NodeRole_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return NodeRole_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeRole_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return NodeRole_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeRole_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeRole_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeRole_startBoundaryType.Matcher> querySpecification() {
      return NodeRole_startBoundaryType.instance();
    }
  }
  
  private NodeRole_startBoundaryType() {
   ...
   * 
   */
  public static NodeRole_startBoundaryType instance() {
    try{
  ...
  @Override
  protected NodeRole_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeRole_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public NodeRole_startBoundaryType.Matcher instantiate() {
    return NodeRole_startBoundaryType.Matcher.create();
  }
  
  @Override
  public NodeRole_startBoundaryType.Match newEmptyMatch() {
    return NodeRole_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public NodeRole_startBoundaryType.Match newMatch(final Object... parameters) {
    return NodeRole_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeRole_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeRole_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeRole_startBoundaryType INSTANCE = new NodeRole_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeRole_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
