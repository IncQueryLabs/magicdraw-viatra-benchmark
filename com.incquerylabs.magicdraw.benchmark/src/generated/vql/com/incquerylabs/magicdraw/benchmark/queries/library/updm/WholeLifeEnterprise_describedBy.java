...
public final class WholeLifeEnterprise_describedBy extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_describedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_describedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_describedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_describedBy.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_describedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_describedBy.Match)) {
          WholeLifeEnterprise_describedBy.Match other = (WholeLifeEnterprise_describedBy.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_describedBy specification() {
      return WholeLifeEnterprise_describedBy.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_describedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_describedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_describedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_describedBy.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_describedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_describedBy pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_describedBy
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_describedBy.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_describedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_describedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_describedBy.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_describedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_describedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_describedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_describedBy.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_describedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_describedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_describedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_describedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_describedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_describedBy.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_describedBy.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_describedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_describedBy.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_describedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_describedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_describedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_describedBy.Matcher> querySpecification() {
      return WholeLifeEnterprise_describedBy.instance();
    }
  }
  
  private WholeLifeEnterprise_describedBy() {
   ...
   * 
   */
  public static WholeLifeEnterprise_describedBy instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_describedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_describedBy.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_describedBy.Matcher instantiate() {
    return WholeLifeEnterprise_describedBy.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_describedBy.Match newEmptyMatch() {
    return WholeLifeEnterprise_describedBy.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_describedBy.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_describedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_describedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_describedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_describedBy INSTANCE = new WholeLifeEnterprise_describedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_describedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "describedBy");
