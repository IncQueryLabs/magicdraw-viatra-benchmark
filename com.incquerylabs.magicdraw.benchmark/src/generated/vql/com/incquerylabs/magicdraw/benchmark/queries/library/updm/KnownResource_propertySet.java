...
public final class KnownResource_propertySet extends BaseGeneratedEMFQuerySpecification<KnownResource_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_propertySet.Match)) {
          KnownResource_propertySet.Match other = (KnownResource_propertySet.Match) obj;
    ...
    @Override
    public KnownResource_propertySet specification() {
      return KnownResource_propertySet.instance();
    }
     ...
     * 
     */
    public static KnownResource_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_propertySet.Match {
    ...
    private static final class Immutable extends KnownResource_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_propertySet pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_propertySet.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super KnownResource_propertySet.Match> processor) {
     ...
     * 
     */
    public KnownResource_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return KnownResource_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final KnownResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final KnownResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_propertySet.Match partialMatch) {
    ...
    @Override
    protected KnownResource_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_propertySet.Matcher> querySpecification() {
      return KnownResource_propertySet.instance();
    }
  }
  
  private KnownResource_propertySet() {
   ...
   * 
   */
  public static KnownResource_propertySet instance() {
    try{
  ...
  @Override
  protected KnownResource_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_propertySet.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_propertySet.Matcher instantiate() {
    return KnownResource_propertySet.Matcher.create();
  }
  
  @Override
  public KnownResource_propertySet.Match newEmptyMatch() {
    return KnownResource_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_propertySet.Match newMatch(final Object... parameters) {
    return KnownResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_propertySet INSTANCE = new KnownResource_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
