...
public final class ExternalTuple_URI extends BaseGeneratedEMFQuerySpecification<ExternalTuple_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTuple_URI.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTuple_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTuple_URI.Match)) {
          ExternalTuple_URI.Match other = (ExternalTuple_URI.Match) obj;
    ...
    @Override
    public ExternalTuple_URI specification() {
      return ExternalTuple_URI.instance();
    }
     ...
     * 
     */
    public static ExternalTuple_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTuple_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ExternalTuple_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ExternalTuple_URI.Match {
    ...
    private static final class Immutable extends ExternalTuple_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_URI pattern,
   ...
   * 
   * @see Match
   * @see ExternalTuple_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTuple_URI.Match> {
    /**
     ...
     * 
     */
    public static ExternalTuple_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTuple_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTuple_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTuple_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ExternalTuple_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ExternalTuple_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ExternalTuple_URI.Match> processor) {
     ...
     * 
     */
    public ExternalTuple_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ExternalTuple_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTuple_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTuple_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ExternalTuple_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ExternalTuple_URI.Match partialMatch) {
    ...
    @Override
    protected ExternalTuple_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTuple_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ExternalTuple_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTuple_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTuple_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTuple_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTuple_URI.Matcher> querySpecification() {
      return ExternalTuple_URI.instance();
    }
  }
  
  private ExternalTuple_URI() {
   ...
   * 
   */
  public static ExternalTuple_URI instance() {
    try{
  ...
  @Override
  protected ExternalTuple_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTuple_URI.Matcher.on(engine);
  }
  
  @Override
  public ExternalTuple_URI.Matcher instantiate() {
    return ExternalTuple_URI.Matcher.create();
  }
  
  @Override
  public ExternalTuple_URI.Match newEmptyMatch() {
    return ExternalTuple_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTuple_URI.Match newMatch(final Object... parameters) {
    return ExternalTuple_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTuple_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTuple_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTuple_URI INSTANCE = new ExternalTuple_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTuple_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
