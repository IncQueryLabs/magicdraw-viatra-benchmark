...
public final class CapabilityForTask_sourceContext extends BaseGeneratedEMFQuerySpecification<CapabilityForTask_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityForTask_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityForTask_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityForTask_sourceContext.Match)) {
          CapabilityForTask_sourceContext.Match other = (CapabilityForTask_sourceContext.Match) obj;
    ...
    @Override
    public CapabilityForTask_sourceContext specification() {
      return CapabilityForTask_sourceContext.instance();
    }
     ...
     * 
     */
    public static CapabilityForTask_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityForTask_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static CapabilityForTask_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityForTask_sourceContext.Match {
    ...
    private static final class Immutable extends CapabilityForTask_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see CapabilityForTask_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityForTask_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static CapabilityForTask_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityForTask_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityForTask_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityForTask_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<CapabilityForTask_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<CapabilityForTask_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super CapabilityForTask_sourceContext.Match> processor) {
     ...
     * 
     */
    public CapabilityForTask_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return CapabilityForTask_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CapabilityForTask_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CapabilityForTask_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final CapabilityForTask_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final CapabilityForTask_sourceContext.Match partialMatch) {
    ...
    @Override
    protected CapabilityForTask_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityForTask_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityForTask_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityForTask_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityForTask_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityForTask_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityForTask_sourceContext.Matcher> querySpecification() {
      return CapabilityForTask_sourceContext.instance();
    }
  }
  
  private CapabilityForTask_sourceContext() {
   ...
   * 
   */
  public static CapabilityForTask_sourceContext instance() {
    try{
  ...
  @Override
  protected CapabilityForTask_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityForTask_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public CapabilityForTask_sourceContext.Matcher instantiate() {
    return CapabilityForTask_sourceContext.Matcher.create();
  }
  
  @Override
  public CapabilityForTask_sourceContext.Match newEmptyMatch() {
    return CapabilityForTask_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityForTask_sourceContext.Match newMatch(final Object... parameters) {
    return CapabilityForTask_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityForTask_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityForTask_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityForTask_sourceContext INSTANCE = new CapabilityForTask_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityForTask_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
