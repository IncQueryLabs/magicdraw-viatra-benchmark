...
public final class Responsibility_stakeholderConcern extends BaseGeneratedEMFQuerySpecification<Responsibility_stakeholderConcern.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_stakeholderConcern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_stakeholderConcern";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_stakeholderConcern.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_stakeholderConcern.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_stakeholderConcern.Match)) {
          Responsibility_stakeholderConcern.Match other = (Responsibility_stakeholderConcern.Match) obj;
    ...
    @Override
    public Responsibility_stakeholderConcern specification() {
      return Responsibility_stakeholderConcern.instance();
    }
     ...
     * 
     */
    public static Responsibility_stakeholderConcern.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_stakeholderConcern.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_stakeholderConcern.Match {
    ...
    private static final class Immutable extends Responsibility_stakeholderConcern.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_stakeholderConcern pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_stakeholderConcern
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_stakeholderConcern.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_stakeholderConcern.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_stakeholderConcern.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_stakeholderConcern.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_stakeholderConcern.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_stakeholderConcern.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_stakeholderConcern.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_stakeholderConcern.Match> processor) {
     ...
     * 
     */
    public Responsibility_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_stakeholderConcern.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_stakeholderConcern.Match partialMatch) {
    ...
    @Override
    protected Responsibility_stakeholderConcern.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_stakeholderConcern.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_stakeholderConcern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_stakeholderConcern.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_stakeholderConcern.Matcher> querySpecification() {
      return Responsibility_stakeholderConcern.instance();
    }
  }
  
  private Responsibility_stakeholderConcern() {
   ...
   * 
   */
  public static Responsibility_stakeholderConcern instance() {
    try{
  ...
  @Override
  protected Responsibility_stakeholderConcern.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_stakeholderConcern.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_stakeholderConcern.Matcher instantiate() {
    return Responsibility_stakeholderConcern.Matcher.create();
  }
  
  @Override
  public Responsibility_stakeholderConcern.Match newEmptyMatch() {
    return Responsibility_stakeholderConcern.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_stakeholderConcern.Match newMatch(final Object... parameters) {
    return Responsibility_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_stakeholderConcern} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_stakeholderConcern#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_stakeholderConcern INSTANCE = new Responsibility_stakeholderConcern();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_stakeholderConcern.GeneratedPQuery INSTANCE = new GeneratedPQuery();
