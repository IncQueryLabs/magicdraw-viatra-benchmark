...
public final class SecurityEnclave_isEncapsulated extends BaseGeneratedEMFQuerySpecification<SecurityEnclave_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave_isEncapsulated.Match)) {
          SecurityEnclave_isEncapsulated.Match other = (SecurityEnclave_isEncapsulated.Match) obj;
    ...
    @Override
    public SecurityEnclave_isEncapsulated specification() {
      return SecurityEnclave_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static SecurityEnclave_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityEnclave_isEncapsulated.Match {
    ...
    private static final class Immutable extends SecurityEnclave_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see SecurityEnclave_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<SecurityEnclave_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<SecurityEnclave_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super SecurityEnclave_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return SecurityEnclave_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final SecurityEnclave_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final SecurityEnclave_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityEnclave_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave_isEncapsulated.Matcher> querySpecification() {
      return SecurityEnclave_isEncapsulated.instance();
    }
  }
  
  private SecurityEnclave_isEncapsulated() {
   ...
   * 
   */
  public static SecurityEnclave_isEncapsulated instance() {
    try{
  ...
  @Override
  protected SecurityEnclave_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave_isEncapsulated.Matcher instantiate() {
    return SecurityEnclave_isEncapsulated.Matcher.create();
  }
  
  @Override
  public SecurityEnclave_isEncapsulated.Match newEmptyMatch() {
    return SecurityEnclave_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave_isEncapsulated.Match newMatch(final Object... parameters) {
    return SecurityEnclave_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave_isEncapsulated INSTANCE = new SecurityEnclave_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
