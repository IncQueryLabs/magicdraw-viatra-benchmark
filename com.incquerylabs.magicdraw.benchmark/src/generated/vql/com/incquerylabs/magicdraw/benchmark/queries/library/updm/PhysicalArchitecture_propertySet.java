...
public final class PhysicalArchitecture_propertySet extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_propertySet.Match)) {
          PhysicalArchitecture_propertySet.Match other = (PhysicalArchitecture_propertySet.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_propertySet specification() {
      return PhysicalArchitecture_propertySet.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_propertySet.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_propertySet pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_propertySet.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_propertySet.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_propertySet.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_propertySet.Matcher> querySpecification() {
      return PhysicalArchitecture_propertySet.instance();
    }
  }
  
  private PhysicalArchitecture_propertySet() {
   ...
   * 
   */
  public static PhysicalArchitecture_propertySet instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_propertySet.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_propertySet.Matcher instantiate() {
    return PhysicalArchitecture_propertySet.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_propertySet.Match newEmptyMatch() {
    return PhysicalArchitecture_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_propertySet.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_propertySet INSTANCE = new PhysicalArchitecture_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
