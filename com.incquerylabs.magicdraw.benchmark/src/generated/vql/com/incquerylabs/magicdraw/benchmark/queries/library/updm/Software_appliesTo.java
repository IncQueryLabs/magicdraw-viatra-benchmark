...
public final class Software_appliesTo extends BaseGeneratedEMFQuerySpecification<Software_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Software_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_appliesTo.Match)) {
          Software_appliesTo.Match other = (Software_appliesTo.Match) obj;
    ...
    @Override
    public Software_appliesTo specification() {
      return Software_appliesTo.instance();
    }
     ...
     * 
     */
    public static Software_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_appliesTo.Match {
    ...
    private static final class Immutable extends Software_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Software_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Software_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Software_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Software_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_appliesTo.Match> processor) {
     ...
     * 
     */
    public Software_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Software_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Software_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Software_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_appliesTo.Matcher> querySpecification() {
      return Software_appliesTo.instance();
    }
  }
  
  private Software_appliesTo() {
   ...
   * 
   */
  public static Software_appliesTo instance() {
    try{
  ...
  @Override
  protected Software_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Software_appliesTo.Matcher instantiate() {
    return Software_appliesTo.Matcher.create();
  }
  
  @Override
  public Software_appliesTo.Match newEmptyMatch() {
    return Software_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Software_appliesTo.Match newMatch(final Object... parameters) {
    return Software_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_appliesTo INSTANCE = new Software_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
