...
public final class FillsPost_sourceContext extends BaseGeneratedEMFQuerySpecification<FillsPost_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return FillsPost_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public FillsPost_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FillsPost_sourceContext.Match)) {
          FillsPost_sourceContext.Match other = (FillsPost_sourceContext.Match) obj;
    ...
    @Override
    public FillsPost_sourceContext specification() {
      return FillsPost_sourceContext.instance();
    }
     ...
     * 
     */
    public static FillsPost_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static FillsPost_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static FillsPost_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FillsPost_sourceContext.Match {
    ...
    private static final class Immutable extends FillsPost_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see FillsPost_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<FillsPost_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static FillsPost_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FillsPost_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FillsPost_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<FillsPost_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<FillsPost_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<FillsPost_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super FillsPost_sourceContext.Match> processor) {
     ...
     * 
     */
    public FillsPost_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return FillsPost_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final FillsPost_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final FillsPost_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final FillsPost_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final FillsPost_sourceContext.Match partialMatch) {
    ...
    @Override
    protected FillsPost_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return FillsPost_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected FillsPost_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return FillsPost_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FillsPost_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FillsPost_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FillsPost_sourceContext.Matcher> querySpecification() {
      return FillsPost_sourceContext.instance();
    }
  }
  
  private FillsPost_sourceContext() {
   ...
   * 
   */
  public static FillsPost_sourceContext instance() {
    try{
  ...
  @Override
  protected FillsPost_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return FillsPost_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public FillsPost_sourceContext.Matcher instantiate() {
    return FillsPost_sourceContext.Matcher.create();
  }
  
  @Override
  public FillsPost_sourceContext.Match newEmptyMatch() {
    return FillsPost_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public FillsPost_sourceContext.Match newMatch(final Object... parameters) {
    return FillsPost_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FillsPost_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FillsPost_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FillsPost_sourceContext INSTANCE = new FillsPost_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FillsPost_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
