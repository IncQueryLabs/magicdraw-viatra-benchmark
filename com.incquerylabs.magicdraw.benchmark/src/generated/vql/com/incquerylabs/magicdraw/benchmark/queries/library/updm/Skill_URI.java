...
public final class Skill_URI extends BaseGeneratedEMFQuerySpecification<Skill_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Skill_URI.Match.parameterNames;
    }
    ...
    @Override
    public Skill_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Skill_URI.Match)) {
          Skill_URI.Match other = (Skill_URI.Match) obj;
    ...
    @Override
    public Skill_URI specification() {
      return Skill_URI.instance();
    }
     ...
     * 
     */
    public static Skill_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Skill_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Skill_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Skill_URI.Match {
    ...
    private static final class Immutable extends Skill_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Skill_URI.Match> {
    /**
     ...
     * 
     */
    public static Skill_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Skill_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Skill_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Skill_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Skill_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Skill_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Skill_URI.Match> processor) {
     ...
     * 
     */
    public Skill_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Skill_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Skill_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Skill_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Skill_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Skill_URI.Match partialMatch) {
    ...
    @Override
    protected Skill_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Skill_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Skill_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Skill_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Skill_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Skill_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Skill_URI.Matcher> querySpecification() {
      return Skill_URI.instance();
    }
  }
   ...
   * 
   */
  public static Skill_URI instance() {
    try{
  ...
  @Override
  protected Skill_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Skill_URI.Matcher.on(engine);
  }
  
  @Override
  public Skill_URI.Matcher instantiate() {
    return Skill_URI.Matcher.create();
  }
  
  @Override
  public Skill_URI.Match newEmptyMatch() {
    return Skill_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Skill_URI.Match newMatch(final Object... parameters) {
    return Skill_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Skill_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Skill_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Skill_URI INSTANCE = new Skill_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Skill_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
