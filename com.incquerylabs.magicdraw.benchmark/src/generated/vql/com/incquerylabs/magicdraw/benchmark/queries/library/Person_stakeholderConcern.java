...
public final class Person_stakeholderConcern extends BaseGeneratedEMFQuerySpecification<Person_stakeholderConcern.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_stakeholderConcern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Person_stakeholderConcern";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_stakeholderConcern.Match.parameterNames;
    }
    ...
    @Override
    public Person_stakeholderConcern.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_stakeholderConcern.Match)) {
          Person_stakeholderConcern.Match other = (Person_stakeholderConcern.Match) obj;
    ...
    @Override
    public Person_stakeholderConcern specification() {
      return Person_stakeholderConcern.instance();
    }
     ...
     * 
     */
    public static Person_stakeholderConcern.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_stakeholderConcern.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Person_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Person_stakeholderConcern.Match {
    ...
    private static final class Immutable extends Person_stakeholderConcern.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_stakeholderConcern pattern,
   ...
   * 
   * @see Match
   * @see Person_stakeholderConcern
   * 
   */
  public static class Matcher extends BaseMatcher<Person_stakeholderConcern.Match> {
    /**
     ...
     * 
     */
    public static Person_stakeholderConcern.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_stakeholderConcern.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_stakeholderConcern.Matcher.class);
     ...
     * 
     */
    public Collection<Person_stakeholderConcern.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Person_stakeholderConcern.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Person_stakeholderConcern.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Person_stakeholderConcern.Match> processor) {
     ...
     * 
     */
    public Person_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Person_stakeholderConcern.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Person_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Person_stakeholderConcern.Match partialMatch) {
    ...
    @Override
    protected Person_stakeholderConcern.Match tupleToMatch(final Tuple t) {
      try {
          return Person_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Person_stakeholderConcern.Match arrayToMatch(final Object[] match) {
      try {
          return Person_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_stakeholderConcern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_stakeholderConcern.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_stakeholderConcern.Matcher> querySpecification() {
      return Person_stakeholderConcern.instance();
    }
  }
  
  private Person_stakeholderConcern() {
   ...
   * 
   */
  public static Person_stakeholderConcern instance() {
    try{
  ...
  @Override
  protected Person_stakeholderConcern.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_stakeholderConcern.Matcher.on(engine);
  }
  
  @Override
  public Person_stakeholderConcern.Matcher instantiate() {
    return Person_stakeholderConcern.Matcher.create();
  }
  
  @Override
  public Person_stakeholderConcern.Match newEmptyMatch() {
    return Person_stakeholderConcern.Match.newEmptyMatch();
  }
  
  @Override
  public Person_stakeholderConcern.Match newMatch(final Object... parameters) {
    return Person_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_stakeholderConcern} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_stakeholderConcern#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_stakeholderConcern INSTANCE = new Person_stakeholderConcern();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_stakeholderConcern.GeneratedPQuery INSTANCE = new GeneratedPQuery();
