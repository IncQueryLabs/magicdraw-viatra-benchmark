...
public final class OrganizationalResource_propertySet extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_propertySet.Match)) {
          OrganizationalResource_propertySet.Match other = (OrganizationalResource_propertySet.Match) obj;
    ...
    @Override
    public OrganizationalResource_propertySet specification() {
      return OrganizationalResource_propertySet.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_propertySet.Match {
    ...
    private static final class Immutable extends OrganizationalResource_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_propertySet pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_propertySet.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_propertySet.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_propertySet.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_propertySet.Matcher> querySpecification() {
      return OrganizationalResource_propertySet.instance();
    }
  }
  
  private OrganizationalResource_propertySet() {
   ...
   * 
   */
  public static OrganizationalResource_propertySet instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_propertySet.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_propertySet.Matcher instantiate() {
    return OrganizationalResource_propertySet.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_propertySet.Match newEmptyMatch() {
    return OrganizationalResource_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_propertySet.Match newMatch(final Object... parameters) {
    return OrganizationalResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_propertySet INSTANCE = new OrganizationalResource_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
