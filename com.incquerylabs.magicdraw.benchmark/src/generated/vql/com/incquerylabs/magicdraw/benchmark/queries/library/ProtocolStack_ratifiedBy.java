...
public final class ProtocolStack_ratifiedBy extends BaseGeneratedEMFQuerySpecification<ProtocolStack_ratifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_ratifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_ratifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolStack_ratifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolStack_ratifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolStack_ratifiedBy.Match)) {
          ProtocolStack_ratifiedBy.Match other = (ProtocolStack_ratifiedBy.Match) obj;
    ...
    @Override
    public ProtocolStack_ratifiedBy specification() {
      return ProtocolStack_ratifiedBy.instance();
    }
     ...
     * 
     */
    public static ProtocolStack_ratifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolStack_ratifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolStack_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolStack_ratifiedBy.Match {
    ...
    private static final class Immutable extends ProtocolStack_ratifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_ratifiedBy pattern,
   ...
   * 
   * @see Match
   * @see ProtocolStack_ratifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolStack_ratifiedBy.Match> {
    /**
     ...
     * 
     */
    public static ProtocolStack_ratifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolStack_ratifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolStack_ratifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolStack_ratifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolStack_ratifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolStack_ratifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProtocolStack_ratifiedBy.Match> processor) {
     ...
     * 
     */
    public ProtocolStack_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProtocolStack_ratifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProtocolStack_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProtocolStack_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolStack_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolStack_ratifiedBy.Match partialMatch) {
    ...
    @Override
    protected ProtocolStack_ratifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolStack_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolStack_ratifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolStack_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolStack_ratifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolStack_ratifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolStack_ratifiedBy.Matcher> querySpecification() {
      return ProtocolStack_ratifiedBy.instance();
    }
  }
  
  private ProtocolStack_ratifiedBy() {
   ...
   * 
   */
  public static ProtocolStack_ratifiedBy instance() {
    try{
  ...
  @Override
  protected ProtocolStack_ratifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolStack_ratifiedBy.Matcher.on(engine);
  }
  
  @Override
  public ProtocolStack_ratifiedBy.Matcher instantiate() {
    return ProtocolStack_ratifiedBy.Matcher.create();
  }
  
  @Override
  public ProtocolStack_ratifiedBy.Match newEmptyMatch() {
    return ProtocolStack_ratifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolStack_ratifiedBy.Match newMatch(final Object... parameters) {
    return ProtocolStack_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolStack_ratifiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolStack_ratifiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolStack_ratifiedBy INSTANCE = new ProtocolStack_ratifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolStack_ratifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
