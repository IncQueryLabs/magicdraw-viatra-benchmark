...
public final class SecurityControlFamily extends BaseGeneratedEMFQuerySpecification<SecurityControlFamily.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControlFamily.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControlFamily.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControlFamily.Match)) {
          SecurityControlFamily.Match other = (SecurityControlFamily.Match) obj;
    ...
    @Override
    public SecurityControlFamily specification() {
      return SecurityControlFamily.instance();
    }
     ...
     * 
     */
    public static SecurityControlFamily.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControlFamily.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SecurityControlFamily.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SecurityControlFamily.Match {
    ...
    private static final class Immutable extends SecurityControlFamily.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily pattern,
   ...
   * 
   * @see Match
   * @see SecurityControlFamily
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControlFamily.Match> {
    /**
     ...
     * 
     */
    public static SecurityControlFamily.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControlFamily.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControlFamily.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControlFamily.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SecurityControlFamily.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SecurityControlFamily.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SecurityControlFamily.Match> processor) {
     ...
     * 
     */
    public SecurityControlFamily.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SecurityControlFamily.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControlFamily.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControlFamily.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SecurityControlFamily.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SecurityControlFamily.Match partialMatch) {
    ...
    @Override
    protected SecurityControlFamily.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControlFamily.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SecurityControlFamily.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControlFamily.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControlFamily.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControlFamily.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControlFamily.Matcher> querySpecification() {
      return SecurityControlFamily.instance();
    }
  }
  
  private SecurityControlFamily() {
   ...
   * 
   */
  public static SecurityControlFamily instance() {
    try{
  ...
  @Override
  protected SecurityControlFamily.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControlFamily.Matcher.on(engine);
  }
  
  @Override
  public SecurityControlFamily.Matcher instantiate() {
    return SecurityControlFamily.Matcher.create();
  }
  
  @Override
  public SecurityControlFamily.Match newEmptyMatch() {
    return SecurityControlFamily.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControlFamily.Match newMatch(final Object... parameters) {
    return SecurityControlFamily.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControlFamily} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControlFamily#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControlFamily INSTANCE = new SecurityControlFamily();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControlFamily.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "SecurityControlFamily")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "SecurityControlFamily");
