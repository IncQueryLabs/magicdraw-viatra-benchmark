...
public final class GeneralizedClassifier extends BaseGeneratedEMFQuerySpecification<GeneralizedClassifier.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.generalizedClassifier pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.generalizedClassifier";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.generalizedClassifier pattern,
