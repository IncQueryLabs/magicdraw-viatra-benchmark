...
public final class ProblemDomain_conformsTo extends BaseGeneratedEMFQuerySpecification<ProblemDomain_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_conformsTo.Match)) {
          ProblemDomain_conformsTo.Match other = (ProblemDomain_conformsTo.Match) obj;
    ...
    @Override
    public ProblemDomain_conformsTo specification() {
      return ProblemDomain_conformsTo.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_conformsTo.Match {
    ...
    private static final class Immutable extends ProblemDomain_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_conformsTo.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_conformsTo.Matcher> querySpecification() {
      return ProblemDomain_conformsTo.instance();
    }
  }
  
  private ProblemDomain_conformsTo() {
   ...
   * 
   */
  public static ProblemDomain_conformsTo instance() {
    try{
  ...
  @Override
  protected ProblemDomain_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_conformsTo.Matcher instantiate() {
    return ProblemDomain_conformsTo.Matcher.create();
  }
  
  @Override
  public ProblemDomain_conformsTo.Match newEmptyMatch() {
    return ProblemDomain_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_conformsTo.Match newMatch(final Object... parameters) {
    return ProblemDomain_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_conformsTo INSTANCE = new ProblemDomain_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
