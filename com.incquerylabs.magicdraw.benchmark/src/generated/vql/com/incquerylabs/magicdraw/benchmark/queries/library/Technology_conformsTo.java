...
public final class Technology_conformsTo extends BaseGeneratedEMFQuerySpecification<Technology_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Technology_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Technology_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Technology_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Technology_conformsTo.Match)) {
          Technology_conformsTo.Match other = (Technology_conformsTo.Match) obj;
    ...
    @Override
    public Technology_conformsTo specification() {
      return Technology_conformsTo.instance();
    }
     ...
     * 
     */
    public static Technology_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Technology_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Technology_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Technology_conformsTo.Match {
    ...
    private static final class Immutable extends Technology_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Technology_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Technology_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Technology_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Technology_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Technology_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Technology_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Technology_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Technology_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Technology_conformsTo.Match> processor) {
     ...
     * 
     */
    public Technology_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Technology_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Technology_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Technology_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Technology_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Technology_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Technology_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Technology_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Technology_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Technology_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Technology_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Technology_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Technology_conformsTo.Matcher> querySpecification() {
      return Technology_conformsTo.instance();
    }
  }
  
  private Technology_conformsTo() {
   ...
   * 
   */
  public static Technology_conformsTo instance() {
    try{
  ...
  @Override
  protected Technology_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Technology_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Technology_conformsTo.Matcher instantiate() {
    return Technology_conformsTo.Matcher.create();
  }
  
  @Override
  public Technology_conformsTo.Match newEmptyMatch() {
    return Technology_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Technology_conformsTo.Match newMatch(final Object... parameters) {
    return Technology_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Technology_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Technology_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Technology_conformsTo INSTANCE = new Technology_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Technology_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
