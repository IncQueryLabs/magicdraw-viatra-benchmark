...
public final class InterfaceRequirement_Master extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceRequirement_Master.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceRequirement_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceRequirement_Master.Match)) {
          InterfaceRequirement_Master.Match other = (InterfaceRequirement_Master.Match) obj;
    ...
    @Override
    public InterfaceRequirement_Master specification() {
     ...
     * 
     */
    public static InterfaceRequirement_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceRequirement_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static InterfaceRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends InterfaceRequirement_Master.Match {
    ...
    private static final class Immutable extends InterfaceRequirement_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Master pattern,
   ...
   * 
   * @see Match
   * @see InterfaceRequirement_Master
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceRequirement_Master.Match> {
    /**
     ...
     * 
     */
    public static InterfaceRequirement_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceRequirement_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceRequirement_Master.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceRequirement_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<InterfaceRequirement_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<InterfaceRequirement_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super InterfaceRequirement_Master.Match> processor) {
     ...
     * 
     */
    public InterfaceRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return InterfaceRequirement_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final InterfaceRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final InterfaceRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final InterfaceRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final InterfaceRequirement_Master.Match partialMatch) {
    ...
    @Override
    protected InterfaceRequirement_Master.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected InterfaceRequirement_Master.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceRequirement_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceRequirement_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceRequirement_Master.Matcher> querySpecification() {
      return InterfaceRequirement_Master.instance();
    }
  }
  
  private InterfaceRequirement_Master() {
   ...
   * 
   */
  public static InterfaceRequirement_Master instance() {
    try{
  ...
  @Override
  protected InterfaceRequirement_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceRequirement_Master.Matcher.on(engine);
  }
  
  @Override
  public InterfaceRequirement_Master.Matcher instantiate() {
    return InterfaceRequirement_Master.Matcher.create();
  }
  
  @Override
  public InterfaceRequirement_Master.Match newEmptyMatch() {
    return InterfaceRequirement_Master.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceRequirement_Master.Match newMatch(final Object... parameters) {
    return InterfaceRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceRequirement_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceRequirement_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceRequirement_Master INSTANCE = new InterfaceRequirement_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceRequirement_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
