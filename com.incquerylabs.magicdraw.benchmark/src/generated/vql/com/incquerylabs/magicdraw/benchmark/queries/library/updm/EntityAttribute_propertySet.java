...
public final class EntityAttribute_propertySet extends BaseGeneratedEMFQuerySpecification<EntityAttribute_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityAttribute_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public EntityAttribute_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityAttribute_propertySet.Match)) {
          EntityAttribute_propertySet.Match other = (EntityAttribute_propertySet.Match) obj;
    ...
    @Override
    public EntityAttribute_propertySet specification() {
      return EntityAttribute_propertySet.instance();
    }
     ...
     * 
     */
    public static EntityAttribute_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityAttribute_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityAttribute_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityAttribute_propertySet.Match {
    ...
    private static final class Immutable extends EntityAttribute_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_propertySet pattern,
   ...
   * 
   * @see Match
   * @see EntityAttribute_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EntityAttribute_propertySet.Match> {
    /**
     ...
     * 
     */
    public static EntityAttribute_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityAttribute_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityAttribute_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EntityAttribute_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityAttribute_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityAttribute_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EntityAttribute_propertySet.Match> processor) {
     ...
     * 
     */
    public EntityAttribute_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return EntityAttribute_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EntityAttribute_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EntityAttribute_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityAttribute_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityAttribute_propertySet.Match partialMatch) {
    ...
    @Override
    protected EntityAttribute_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EntityAttribute_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityAttribute_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EntityAttribute_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityAttribute_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityAttribute_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityAttribute_propertySet.Matcher> querySpecification() {
      return EntityAttribute_propertySet.instance();
    }
  }
  
  private EntityAttribute_propertySet() {
   ...
   * 
   */
  public static EntityAttribute_propertySet instance() {
    try{
  ...
  @Override
  protected EntityAttribute_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityAttribute_propertySet.Matcher.on(engine);
  }
  
  @Override
  public EntityAttribute_propertySet.Matcher instantiate() {
    return EntityAttribute_propertySet.Matcher.create();
  }
  
  @Override
  public EntityAttribute_propertySet.Match newEmptyMatch() {
    return EntityAttribute_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EntityAttribute_propertySet.Match newMatch(final Object... parameters) {
    return EntityAttribute_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityAttribute_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityAttribute_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityAttribute_propertySet INSTANCE = new EntityAttribute_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityAttribute_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
