...
public final class OperationalMitigation_conformsTo extends BaseGeneratedEMFQuerySpecification<OperationalMitigation_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalMitigation_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public OperationalMitigation_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalMitigation_conformsTo.Match)) {
          OperationalMitigation_conformsTo.Match other = (OperationalMitigation_conformsTo.Match) obj;
    ...
    @Override
    public OperationalMitigation_conformsTo specification() {
      return OperationalMitigation_conformsTo.instance();
    }
     ...
     * 
     */
    public static OperationalMitigation_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalMitigation_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalMitigation_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalMitigation_conformsTo.Match {
    ...
    private static final class Immutable extends OperationalMitigation_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see OperationalMitigation_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalMitigation_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static OperationalMitigation_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalMitigation_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalMitigation_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalMitigation_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalMitigation_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalMitigation_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalMitigation_conformsTo.Match> processor) {
     ...
     * 
     */
    public OperationalMitigation_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalMitigation_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalMitigation_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalMitigation_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalMitigation_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalMitigation_conformsTo.Match partialMatch) {
    ...
    @Override
    protected OperationalMitigation_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalMitigation_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalMitigation_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalMitigation_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalMitigation_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalMitigation_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalMitigation_conformsTo.Matcher> querySpecification() {
      return OperationalMitigation_conformsTo.instance();
    }
  }
  
  private OperationalMitigation_conformsTo() {
   ...
   * 
   */
  public static OperationalMitigation_conformsTo instance() {
    try{
  ...
  @Override
  protected OperationalMitigation_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalMitigation_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public OperationalMitigation_conformsTo.Matcher instantiate() {
    return OperationalMitigation_conformsTo.Matcher.create();
  }
  
  @Override
  public OperationalMitigation_conformsTo.Match newEmptyMatch() {
    return OperationalMitigation_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalMitigation_conformsTo.Match newMatch(final Object... parameters) {
    return OperationalMitigation_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalMitigation_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalMitigation_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalMitigation_conformsTo INSTANCE = new OperationalMitigation_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalMitigation_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
