...
public final class ProtocolImplementation extends BaseGeneratedEMFQuerySpecification<ProtocolImplementation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolImplementation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolImplementation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolImplementation.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolImplementation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolImplementation.Match)) {
          ProtocolImplementation.Match other = (ProtocolImplementation.Match) obj;
    ...
    @Override
    public ProtocolImplementation specification() {
      return ProtocolImplementation.instance();
    }
     ...
     * 
     */
    public static ProtocolImplementation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolImplementation.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProtocolImplementation.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProtocolImplementation.Match {
    ...
    private static final class Immutable extends ProtocolImplementation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolImplementation pattern,
   ...
   * 
   * @see Match
   * @see ProtocolImplementation
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolImplementation.Match> {
    /**
     ...
     * 
     */
    public static ProtocolImplementation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolImplementation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolImplementation.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolImplementation.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProtocolImplementation.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProtocolImplementation.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProtocolImplementation.Match> processor) {
     ...
     * 
     */
    public ProtocolImplementation.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProtocolImplementation.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final ProtocolImplementation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final ProtocolImplementation.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProtocolImplementation.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProtocolImplementation.Match partialMatch) {
    ...
    @Override
    protected ProtocolImplementation.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolImplementation.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProtocolImplementation.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolImplementation.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolImplementation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolImplementation.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolImplementation.Matcher> querySpecification() {
      return ProtocolImplementation.instance();
    }
  }
  
  private ProtocolImplementation() {
   ...
   * 
   */
  public static ProtocolImplementation instance() {
    try{
  ...
  @Override
  protected ProtocolImplementation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolImplementation.Matcher.on(engine);
  }
  
  @Override
  public ProtocolImplementation.Matcher instantiate() {
    return ProtocolImplementation.Matcher.create();
  }
  
  @Override
  public ProtocolImplementation.Match newEmptyMatch() {
    return ProtocolImplementation.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolImplementation.Match newMatch(final Object... parameters) {
    return ProtocolImplementation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolImplementation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolImplementation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolImplementation INSTANCE = new ProtocolImplementation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolImplementation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ProtocolImplementation")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ProtocolImplementation");
