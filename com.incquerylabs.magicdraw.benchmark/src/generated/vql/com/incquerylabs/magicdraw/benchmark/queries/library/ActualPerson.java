...
public final class ActualPerson extends BaseGeneratedEMFQuerySpecification<ActualPerson.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPerson pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualPerson";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualPerson.Match.parameterNames;
    }
    ...
    @Override
    public ActualPerson.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualPerson.Match)) {
          ActualPerson.Match other = (ActualPerson.Match) obj;
    ...
    @Override
    public ActualPerson specification() {
      return ActualPerson.instance();
    }
     ...
     * 
     */
    public static ActualPerson.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualPerson.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualPerson.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualPerson.Match {
    ...
    private static final class Immutable extends ActualPerson.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPerson pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualPerson.Match> {
    /**
     ...
     * 
     */
    public static ActualPerson.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualPerson.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualPerson.Matcher.class);
     ...
     * 
     */
    public Collection<ActualPerson.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualPerson.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualPerson.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualPerson.Match> processor) {
     ...
     * 
     */
    public ActualPerson.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualPerson.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualPerson.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualPerson.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualPerson.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualPerson.Match partialMatch) {
    ...
    @Override
    protected ActualPerson.Match tupleToMatch(final Tuple t) {
      try {
          return ActualPerson.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualPerson.Match arrayToMatch(final Object[] match) {
      try {
          return ActualPerson.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualPerson.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualPerson.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualPerson.Matcher> querySpecification() {
      return ActualPerson.instance();
    }
  }
  
  private ActualPerson() {
   ...
   * 
   */
  public static ActualPerson instance() {
    try{
  ...
  @Override
  protected ActualPerson.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualPerson.Matcher.on(engine);
  }
  
  @Override
  public ActualPerson.Matcher instantiate() {
    return ActualPerson.Matcher.create();
  }
  
  @Override
  public ActualPerson.Match newEmptyMatch() {
    return ActualPerson.Match.newEmptyMatch();
  }
  
  @Override
  public ActualPerson.Match newMatch(final Object... parameters) {
    return ActualPerson.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualPerson} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualPerson#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualPerson INSTANCE = new ActualPerson();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualPerson.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualPerson")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualPerson");
