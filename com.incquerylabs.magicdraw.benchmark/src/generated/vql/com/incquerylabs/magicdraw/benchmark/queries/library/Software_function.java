...
public final class Software_function extends BaseGeneratedEMFQuerySpecification<Software_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Software_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_function.Match.parameterNames;
    }
    ...
    @Override
    public Software_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_function.Match)) {
          Software_function.Match other = (Software_function.Match) obj;
    ...
    @Override
    public Software_function specification() {
      return Software_function.instance();
    }
     ...
     * 
     */
    public static Software_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_function.Match {
    ...
    private static final class Immutable extends Software_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_function pattern,
   ...
   * 
   * @see Match
   * @see Software_function
   * 
   */
  public static class Matcher extends BaseMatcher<Software_function.Match> {
    /**
     ...
     * 
     */
    public static Software_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_function.Matcher.class);
     ...
     * 
     */
    public Collection<Software_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_function.Match> processor) {
     ...
     * 
     */
    public Software_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_function.Match partialMatch) {
    ...
    @Override
    protected Software_function.Match tupleToMatch(final Tuple t) {
      try {
          return Software_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_function.Match arrayToMatch(final Object[] match) {
      try {
          return Software_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_function.Matcher> querySpecification() {
      return Software_function.instance();
    }
  }
  
  private Software_function() {
   ...
   * 
   */
  public static Software_function instance() {
    try{
  ...
  @Override
  protected Software_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_function.Matcher.on(engine);
  }
  
  @Override
  public Software_function.Matcher instantiate() {
    return Software_function.Matcher.create();
  }
  
  @Override
  public Software_function.Match newEmptyMatch() {
    return Software_function.Match.newEmptyMatch();
  }
  
  @Override
  public Software_function.Match newMatch(final Object... parameters) {
    return Software_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_function INSTANCE = new Software_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
