...
public final class ConceptRole_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ConceptRole_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptRole_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ConceptRole_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptRole_endBoundaryType.Match)) {
          ConceptRole_endBoundaryType.Match other = (ConceptRole_endBoundaryType.Match) obj;
    ...
    @Override
    public ConceptRole_endBoundaryType specification() {
      return ConceptRole_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ConceptRole_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptRole_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConceptRole_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConceptRole_endBoundaryType.Match {
    ...
    private static final class Immutable extends ConceptRole_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ConceptRole_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptRole_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ConceptRole_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptRole_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptRole_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptRole_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConceptRole_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConceptRole_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConceptRole_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ConceptRole_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ConceptRole_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConceptRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConceptRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConceptRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConceptRole_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ConceptRole_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptRole_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConceptRole_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptRole_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptRole_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptRole_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptRole_endBoundaryType.Matcher> querySpecification() {
      return ConceptRole_endBoundaryType.instance();
    }
  }
  
  private ConceptRole_endBoundaryType() {
   ...
   * 
   */
  public static ConceptRole_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ConceptRole_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptRole_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ConceptRole_endBoundaryType.Matcher instantiate() {
    return ConceptRole_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ConceptRole_endBoundaryType.Match newEmptyMatch() {
    return ConceptRole_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptRole_endBoundaryType.Match newMatch(final Object... parameters) {
    return ConceptRole_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptRole_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptRole_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptRole_endBoundaryType INSTANCE = new ConceptRole_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptRole_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
