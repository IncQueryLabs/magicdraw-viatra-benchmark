...
public final class Standard_shortName extends BaseGeneratedEMFQuerySpecification<Standard_shortName.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_shortName pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_shortName";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_shortName.Match.parameterNames;
    }
    ...
    @Override
    public Standard_shortName.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_shortName.Match)) {
          Standard_shortName.Match other = (Standard_shortName.Match) obj;
    ...
    @Override
    public Standard_shortName specification() {
      return Standard_shortName.instance();
    }
     ...
     * 
     */
    public static Standard_shortName.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_shortName.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Standard_shortName.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Standard_shortName.Match {
    ...
    private static final class Immutable extends Standard_shortName.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_shortName pattern,
   ...
   * 
   * @see Match
   * @see Standard_shortName
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_shortName.Match> {
    /**
     ...
     * 
     */
    public static Standard_shortName.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_shortName.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_shortName.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_shortName.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Standard_shortName.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Standard_shortName.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Standard_shortName.Match> processor) {
     ...
     * 
     */
    public Standard_shortName.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Standard_shortName.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_shortName.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_shortName.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Standard_shortName.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Standard_shortName.Match partialMatch) {
    ...
    @Override
    protected Standard_shortName.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Standard_shortName.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_shortName.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_shortName.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_shortName.Matcher> querySpecification() {
      return Standard_shortName.instance();
    }
  }
  
  private Standard_shortName() {
   ...
   * 
   */
  public static Standard_shortName instance() {
    try{
  ...
  @Override
  protected Standard_shortName.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_shortName.Matcher.on(engine);
  }
  
  @Override
  public Standard_shortName.Matcher instantiate() {
    return Standard_shortName.Matcher.create();
  }
  
  @Override
  public Standard_shortName.Match newEmptyMatch() {
    return Standard_shortName.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_shortName.Match newMatch(final Object... parameters) {
    return Standard_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_shortName} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_shortName#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_shortName INSTANCE = new Standard_shortName();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_shortName.GeneratedPQuery INSTANCE = new GeneratedPQuery();
