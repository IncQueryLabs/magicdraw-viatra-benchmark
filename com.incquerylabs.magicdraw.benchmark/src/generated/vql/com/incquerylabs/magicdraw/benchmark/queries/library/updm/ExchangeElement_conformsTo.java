...
public final class ExchangeElement_conformsTo extends BaseGeneratedEMFQuerySpecification<ExchangeElement_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_conformsTo.Match)) {
          ExchangeElement_conformsTo.Match other = (ExchangeElement_conformsTo.Match) obj;
    ...
    @Override
    public ExchangeElement_conformsTo specification() {
      return ExchangeElement_conformsTo.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_conformsTo.Match {
    ...
    private static final class Immutable extends ExchangeElement_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_conformsTo.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_conformsTo.Matcher> querySpecification() {
      return ExchangeElement_conformsTo.instance();
    }
  }
  
  private ExchangeElement_conformsTo() {
   ...
   * 
   */
  public static ExchangeElement_conformsTo instance() {
    try{
  ...
  @Override
  protected ExchangeElement_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_conformsTo.Matcher instantiate() {
    return ExchangeElement_conformsTo.Matcher.create();
  }
  
  @Override
  public ExchangeElement_conformsTo.Match newEmptyMatch() {
    return ExchangeElement_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_conformsTo.Match newMatch(final Object... parameters) {
    return ExchangeElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_conformsTo INSTANCE = new ExchangeElement_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
