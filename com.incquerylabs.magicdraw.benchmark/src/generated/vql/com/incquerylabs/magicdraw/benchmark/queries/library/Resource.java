...
public final class Resource extends BaseGeneratedEMFQuerySpecification<Resource.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Resource pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Resource";
    }
    
    @Override
    public List<String> parameterNames() {
      return Resource.Match.parameterNames;
    }
    ...
    @Override
    public Resource.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Resource.Match)) {
          Resource.Match other = (Resource.Match) obj;
     ...
     * 
     */
    public static Resource.Match newEmptyMatch() {
     ...
     * 
     */
    public static Resource.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Resource.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Resource.Match {
    ...
    private static final class Immutable extends Resource.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Resource pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Resource.Match> {
    /**
     ...
     * 
     */
    public static Resource.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Resource.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Resource.Matcher.class);
     ...
     * 
     */
    public Collection<Resource.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Resource.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Resource.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Resource.Match> processor) {
     ...
     * 
     */
    public Resource.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Resource.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Resource.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Resource.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Resource.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Resource.Match partialMatch) {
    ...
    @Override
    protected Resource.Match tupleToMatch(final Tuple t) {
      try {
          return Resource.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Resource.Match arrayToMatch(final Object[] match) {
      try {
          return Resource.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Resource.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Resource.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Resource.Matcher> querySpecification() {
      return Resource.instance();
    }
  }
  ...
  @Override
  protected Resource.Matcher instantiate(final ViatraQueryEngine engine) {
    return Resource.Matcher.on(engine);
  }
  
  @Override
  public Resource.Matcher instantiate() {
    return Resource.Matcher.create();
  }
  
  @Override
  public Resource.Match newEmptyMatch() {
    return Resource.Match.newEmptyMatch();
  }
  
  @Override
  public Resource.Match newMatch(final Object... parameters) {
    return Resource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Resource} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Resource#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Resource.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Resource")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Resource");
