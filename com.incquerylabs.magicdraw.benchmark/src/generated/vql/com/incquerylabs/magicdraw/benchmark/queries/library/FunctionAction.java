...
public final class FunctionAction extends BaseGeneratedEMFQuerySpecification<FunctionAction.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FunctionAction pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FunctionAction";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionAction.Match.parameterNames;
    }
    ...
    @Override
    public FunctionAction.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionAction.Match)) {
          FunctionAction.Match other = (FunctionAction.Match) obj;
    ...
    @Override
    public FunctionAction specification() {
      return FunctionAction.instance();
    }
     ...
     * 
     */
    public static FunctionAction.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionAction.Match newMutableMatch(final CallBehaviorAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FunctionAction.Match newMatch(final CallBehaviorAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends FunctionAction.Match {
    ...
    private static final class Immutable extends FunctionAction.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FunctionAction pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionAction.Match> {
    /**
     ...
     * 
     */
    public static FunctionAction.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionAction.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionAction.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionAction.Match> getAllMatches(final CallBehaviorAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FunctionAction.Match> streamAllMatches(final CallBehaviorAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FunctionAction.Match> getOneArbitraryMatch(final CallBehaviorAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final CallBehaviorAction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FunctionAction.Match> processor) {
     ...
     * 
     */
    public FunctionAction.Match newMatch(final CallBehaviorAction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FunctionAction.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<CallBehaviorAction> streamAllValuesOfelement(final FunctionAction.Match partialMatch) {
     ...
     * 
     */
    public Set<CallBehaviorAction> getAllValuesOfelement(final FunctionAction.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FunctionAction.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FunctionAction.Match partialMatch) {
    ...
    @Override
    protected FunctionAction.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionAction.Match.newMatch((CallBehaviorAction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected FunctionAction.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionAction.Match.newMatch((CallBehaviorAction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionAction.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionAction.Match.newMutableMatch((CallBehaviorAction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionAction.Matcher> querySpecification() {
      return FunctionAction.instance();
    }
  }
   ...
   * 
   */
  public static FunctionAction instance() {
    try{
  ...
  @Override
  protected FunctionAction.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionAction.Matcher.on(engine);
  }
  
  @Override
  public FunctionAction.Matcher instantiate() {
    return FunctionAction.Matcher.create();
  }
  
  @Override
  public FunctionAction.Match newEmptyMatch() {
    return FunctionAction.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionAction.Match newMatch(final Object... parameters) {
    return FunctionAction.Match.newMatch((com.nomagic.uml2.ext.magicdraw.actions.mdbasicactions.CallBehaviorAction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionAction} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionAction#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionAction INSTANCE = new FunctionAction();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionAction.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "FunctionAction")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "FunctionAction");
