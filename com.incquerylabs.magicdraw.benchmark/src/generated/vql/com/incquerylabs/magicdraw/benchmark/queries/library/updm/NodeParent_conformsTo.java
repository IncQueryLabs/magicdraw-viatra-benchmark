...
public final class NodeParent_conformsTo extends BaseGeneratedEMFQuerySpecification<NodeParent_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_conformsTo.Match)) {
          NodeParent_conformsTo.Match other = (NodeParent_conformsTo.Match) obj;
    ...
    @Override
    public NodeParent_conformsTo specification() {
      return NodeParent_conformsTo.instance();
    }
     ...
     * 
     */
    public static NodeParent_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeParent_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeParent_conformsTo.Match {
    ...
    private static final class Immutable extends NodeParent_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see NodeParent_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeParent_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeParent_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NodeParent_conformsTo.Match> processor) {
     ...
     * 
     */
    public NodeParent_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NodeParent_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeParent_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeParent_conformsTo.Match partialMatch) {
    ...
    @Override
    protected NodeParent_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeParent_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_conformsTo.Matcher> querySpecification() {
      return NodeParent_conformsTo.instance();
    }
  }
  
  private NodeParent_conformsTo() {
   ...
   * 
   */
  public static NodeParent_conformsTo instance() {
    try{
  ...
  @Override
  protected NodeParent_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_conformsTo.Matcher instantiate() {
    return NodeParent_conformsTo.Matcher.create();
  }
  
  @Override
  public NodeParent_conformsTo.Match newEmptyMatch() {
    return NodeParent_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_conformsTo.Match newMatch(final Object... parameters) {
    return NodeParent_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_conformsTo INSTANCE = new NodeParent_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
