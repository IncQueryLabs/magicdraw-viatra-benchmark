...
public final class CapabilityProperty_conformsTo extends BaseGeneratedEMFQuerySpecification<CapabilityProperty_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty_conformsTo.Match)) {
          CapabilityProperty_conformsTo.Match other = (CapabilityProperty_conformsTo.Match) obj;
    ...
    @Override
    public CapabilityProperty_conformsTo specification() {
      return CapabilityProperty_conformsTo.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityProperty_conformsTo.Match {
    ...
    private static final class Immutable extends CapabilityProperty_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityProperty_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityProperty_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super CapabilityProperty_conformsTo.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return CapabilityProperty_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityProperty_conformsTo.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityProperty_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty_conformsTo.Matcher> querySpecification() {
      return CapabilityProperty_conformsTo.instance();
    }
  }
  
  private CapabilityProperty_conformsTo() {
   ...
   * 
   */
  public static CapabilityProperty_conformsTo instance() {
    try{
  ...
  @Override
  protected CapabilityProperty_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty_conformsTo.Matcher instantiate() {
    return CapabilityProperty_conformsTo.Matcher.create();
  }
  
  @Override
  public CapabilityProperty_conformsTo.Match newEmptyMatch() {
    return CapabilityProperty_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty_conformsTo.Match newMatch(final Object... parameters) {
    return CapabilityProperty_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty_conformsTo INSTANCE = new CapabilityProperty_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
