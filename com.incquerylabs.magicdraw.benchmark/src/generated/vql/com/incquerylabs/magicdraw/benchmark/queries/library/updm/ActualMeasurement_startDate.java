...
public final class ActualMeasurement_startDate extends BaseGeneratedEMFQuerySpecification<ActualMeasurement_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_startDate";
    }
     ...
     * 
     */
    public static ActualMeasurement_startDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualMeasurement_startDate.Match newMatch(final Slot pElement, final Element pValue) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_startDate pattern,
  ...
  public static class Matcher extends BaseMatcher<ActualMeasurement_startDate.Match> {
     ...
     * 
     */
    public Collection<ActualMeasurement_startDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualMeasurement_startDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualMeasurement_startDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualMeasurement_startDate.Match> processor) {
     ...
     * 
     */
    public ActualMeasurement_startDate.Match newMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualMeasurement_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualMeasurement_startDate.Match partialMatch) {
    ...
    protected ActualMeasurement_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualMeasurement_startDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    protected ActualMeasurement_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualMeasurement_startDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected ActualMeasurement_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualMeasurement_startDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ActualMeasurement_startDate.Match newMatch(final Object... parameters) {
    return ActualMeasurement_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
