...
public final class OrganizationType extends BaseGeneratedEMFQuerySpecification<OrganizationType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType.Match)) {
          OrganizationType.Match other = (OrganizationType.Match) obj;
    ...
    @Override
    public OrganizationType specification() {
      return OrganizationType.instance();
    }
     ...
     * 
     */
    public static OrganizationType.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OrganizationType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OrganizationType.Match {
    ...
    private static final class Immutable extends OrganizationType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OrganizationType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OrganizationType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OrganizationType.Match> processor) {
     ...
     * 
     */
    public OrganizationType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OrganizationType.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OrganizationType.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OrganizationType.Match partialMatch) {
    ...
    @Override
    protected OrganizationType.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OrganizationType.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType.Matcher> querySpecification() {
      return OrganizationType.instance();
    }
  }
   ...
   * 
   */
  public static OrganizationType instance() {
    try{
  ...
  @Override
  protected OrganizationType.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType.Matcher instantiate() {
    return OrganizationType.Matcher.create();
  }
  
  @Override
  public OrganizationType.Match newEmptyMatch() {
    return OrganizationType.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType.Match newMatch(final Object... parameters) {
    return OrganizationType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType INSTANCE = new OrganizationType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "OrganizationType");
