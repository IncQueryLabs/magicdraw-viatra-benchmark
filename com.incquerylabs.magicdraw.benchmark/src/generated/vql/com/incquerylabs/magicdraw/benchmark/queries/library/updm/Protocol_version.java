...
public final class Protocol_version extends BaseGeneratedEMFQuerySpecification<Protocol_version.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_version pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_version";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_version.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_version.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_version.Match)) {
          Protocol_version.Match other = (Protocol_version.Match) obj;
    ...
    @Override
    public Protocol_version specification() {
      return Protocol_version.instance();
    }
     ...
     * 
     */
    public static Protocol_version.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_version.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Protocol_version.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Protocol_version.Match {
    ...
    private static final class Immutable extends Protocol_version.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_version pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_version.Match> {
    /**
     ...
     * 
     */
    public static Protocol_version.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_version.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_version.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_version.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Protocol_version.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Protocol_version.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Protocol_version.Match> processor) {
     ...
     * 
     */
    public Protocol_version.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Protocol_version.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_version.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_version.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Protocol_version.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Protocol_version.Match partialMatch) {
    ...
    @Override
    protected Protocol_version.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Protocol_version.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_version.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_version.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_version.Matcher> querySpecification() {
      return Protocol_version.instance();
    }
  }
   ...
   * 
   */
  public static Protocol_version instance() {
    try{
  ...
  @Override
  protected Protocol_version.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_version.Matcher.on(engine);
  }
  
  @Override
  public Protocol_version.Matcher instantiate() {
    return Protocol_version.Matcher.create();
  }
  
  @Override
  public Protocol_version.Match newEmptyMatch() {
    return Protocol_version.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_version.Match newMatch(final Object... parameters) {
    return Protocol_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_version} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_version#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_version INSTANCE = new Protocol_version();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_version.GeneratedPQuery INSTANCE = new GeneratedPQuery();
