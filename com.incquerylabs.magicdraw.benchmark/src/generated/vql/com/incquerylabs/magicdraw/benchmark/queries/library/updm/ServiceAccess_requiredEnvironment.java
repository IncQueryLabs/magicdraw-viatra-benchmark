...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess;
...
public final class ServiceAccess_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<ServiceAccess_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_requiredEnvironment.Match)) {
          ServiceAccess_requiredEnvironment.Match other = (ServiceAccess_requiredEnvironment.Match) obj;
    ...
    @Override
    public ServiceAccess_requiredEnvironment specification() {
      return ServiceAccess_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_requiredEnvironment.Match {
    ...
    private static final class Immutable extends ServiceAccess_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_requiredEnvironment.Matcher> querySpecification() {
      return ServiceAccess_requiredEnvironment.instance();
    }
  }
  
  private ServiceAccess_requiredEnvironment() {
   ...
   * 
   */
  public static ServiceAccess_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected ServiceAccess_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_requiredEnvironment.Matcher instantiate() {
    return ServiceAccess_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public ServiceAccess_requiredEnvironment.Match newEmptyMatch() {
    return ServiceAccess_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_requiredEnvironment.Match newMatch(final Object... parameters) {
    return ServiceAccess_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_requiredEnvironment INSTANCE = new ServiceAccess_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ServiceAccess(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ServiceAccess.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
