...
public final class Post_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Post_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Post_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_endBoundaryType.Match)) {
          Post_endBoundaryType.Match other = (Post_endBoundaryType.Match) obj;
    ...
    @Override
    public Post_endBoundaryType specification() {
      return Post_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Post_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_endBoundaryType.Match {
    ...
    private static final class Immutable extends Post_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Post_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Post_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Post_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Post_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Post_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Post_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Post_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Post_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_endBoundaryType.Matcher> querySpecification() {
      return Post_endBoundaryType.instance();
    }
  }
  
  private Post_endBoundaryType() {
   ...
   * 
   */
  public static Post_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Post_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Post_endBoundaryType.Matcher instantiate() {
    return Post_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Post_endBoundaryType.Match newEmptyMatch() {
    return Post_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Post_endBoundaryType.Match newMatch(final Object... parameters) {
    return Post_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_endBoundaryType INSTANCE = new Post_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
