...
public final class NodeParent_physicalLocation extends BaseGeneratedEMFQuerySpecification<NodeParent_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_physicalLocation.Match)) {
          NodeParent_physicalLocation.Match other = (NodeParent_physicalLocation.Match) obj;
    ...
    @Override
    public NodeParent_physicalLocation specification() {
      return NodeParent_physicalLocation.instance();
    }
     ...
     * 
     */
    public static NodeParent_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeParent_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeParent_physicalLocation.Match {
    ...
    private static final class Immutable extends NodeParent_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see NodeParent_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeParent_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeParent_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NodeParent_physicalLocation.Match> processor) {
     ...
     * 
     */
    public NodeParent_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NodeParent_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeParent_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeParent_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected NodeParent_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeParent_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_physicalLocation.Matcher> querySpecification() {
      return NodeParent_physicalLocation.instance();
    }
  }
  
  private NodeParent_physicalLocation() {
   ...
   * 
   */
  public static NodeParent_physicalLocation instance() {
    try{
  ...
  @Override
  protected NodeParent_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_physicalLocation.Matcher instantiate() {
    return NodeParent_physicalLocation.Matcher.create();
  }
  
  @Override
  public NodeParent_physicalLocation.Match newEmptyMatch() {
    return NodeParent_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_physicalLocation.Match newMatch(final Object... parameters) {
    return NodeParent_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_physicalLocation INSTANCE = new NodeParent_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
