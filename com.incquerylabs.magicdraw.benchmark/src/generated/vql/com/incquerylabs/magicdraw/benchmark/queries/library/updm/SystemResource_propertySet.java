...
public final class SystemResource_propertySet extends BaseGeneratedEMFQuerySpecification<SystemResource_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_propertySet.Match)) {
          SystemResource_propertySet.Match other = (SystemResource_propertySet.Match) obj;
    ...
    @Override
    public SystemResource_propertySet specification() {
      return SystemResource_propertySet.instance();
    }
     ...
     * 
     */
    public static SystemResource_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_propertySet.Match {
    ...
    private static final class Immutable extends SystemResource_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_propertySet pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_propertySet.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_propertySet.Match> processor) {
     ...
     * 
     */
    public SystemResource_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_propertySet.Match partialMatch) {
    ...
    @Override
    protected SystemResource_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_propertySet.Matcher> querySpecification() {
      return SystemResource_propertySet.instance();
    }
  }
  
  private SystemResource_propertySet() {
   ...
   * 
   */
  public static SystemResource_propertySet instance() {
    try{
  ...
  @Override
  protected SystemResource_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_propertySet.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_propertySet.Matcher instantiate() {
    return SystemResource_propertySet.Matcher.create();
  }
  
  @Override
  public SystemResource_propertySet.Match newEmptyMatch() {
    return SystemResource_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_propertySet.Match newMatch(final Object... parameters) {
    return SystemResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_propertySet INSTANCE = new SystemResource_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
