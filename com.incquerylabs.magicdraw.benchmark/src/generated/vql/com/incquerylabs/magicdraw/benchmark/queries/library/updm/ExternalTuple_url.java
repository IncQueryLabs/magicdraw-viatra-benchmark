...
public final class ExternalTuple_url extends BaseGeneratedEMFQuerySpecification<ExternalTuple_url.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_url pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_url";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTuple_url.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTuple_url.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTuple_url.Match)) {
          ExternalTuple_url.Match other = (ExternalTuple_url.Match) obj;
    ...
    @Override
    public ExternalTuple_url specification() {
      return ExternalTuple_url.instance();
    }
     ...
     * 
     */
    public static ExternalTuple_url.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTuple_url.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ExternalTuple_url.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ExternalTuple_url.Match {
    ...
    private static final class Immutable extends ExternalTuple_url.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_url pattern,
   ...
   * 
   * @see Match
   * @see ExternalTuple_url
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTuple_url.Match> {
    /**
     ...
     * 
     */
    public static ExternalTuple_url.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTuple_url.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTuple_url.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTuple_url.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ExternalTuple_url.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ExternalTuple_url.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ExternalTuple_url.Match> processor) {
     ...
     * 
     */
    public ExternalTuple_url.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ExternalTuple_url.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTuple_url.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTuple_url.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ExternalTuple_url.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ExternalTuple_url.Match partialMatch) {
    ...
    @Override
    protected ExternalTuple_url.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTuple_url.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ExternalTuple_url.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTuple_url.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTuple_url.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTuple_url.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTuple_url.Matcher> querySpecification() {
      return ExternalTuple_url.instance();
    }
  }
  
  private ExternalTuple_url() {
   ...
   * 
   */
  public static ExternalTuple_url instance() {
    try{
  ...
  @Override
  protected ExternalTuple_url.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTuple_url.Matcher.on(engine);
  }
  
  @Override
  public ExternalTuple_url.Matcher instantiate() {
    return ExternalTuple_url.Matcher.create();
  }
  
  @Override
  public ExternalTuple_url.Match newEmptyMatch() {
    return ExternalTuple_url.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTuple_url.Match newMatch(final Object... parameters) {
    return ExternalTuple_url.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTuple_url} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTuple_url#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTuple_url INSTANCE = new ExternalTuple_url();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTuple_url.GeneratedPQuery INSTANCE = new GeneratedPQuery();
