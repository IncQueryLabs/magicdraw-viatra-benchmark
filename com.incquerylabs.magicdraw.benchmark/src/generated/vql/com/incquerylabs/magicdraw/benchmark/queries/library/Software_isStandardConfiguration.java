...
import com.incquerylabs.magicdraw.benchmark.queries.library.Software;
...
public final class Software_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<Software_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Software_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public Software_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_isStandardConfiguration.Match)) {
          Software_isStandardConfiguration.Match other = (Software_isStandardConfiguration.Match) obj;
    ...
    @Override
    public Software_isStandardConfiguration specification() {
      return Software_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static Software_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Software_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Software_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends Software_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see Software_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<Software_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static Software_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<Software_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Software_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Software_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Software_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public Software_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Software_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Software_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Software_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected Software_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return Software_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Software_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return Software_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_isStandardConfiguration.Matcher> querySpecification() {
      return Software_isStandardConfiguration.instance();
    }
  }
  
  private Software_isStandardConfiguration() {
   ...
   * 
   */
  public static Software_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected Software_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public Software_isStandardConfiguration.Matcher instantiate() {
    return Software_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public Software_isStandardConfiguration.Match newEmptyMatch() {
    return Software_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public Software_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return Software_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_isStandardConfiguration INSTANCE = new Software_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Software(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Software.instance().getInternalQueryRepresentation());
