...
public final class Rate_rate extends BaseGeneratedEMFQuerySpecification<Rate_rate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Rate_rate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Rate_rate";
    }
    
    @Override
    public List<String> parameterNames() {
      return Rate_rate.Match.parameterNames;
    }
    ...
    @Override
    public Rate_rate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Rate_rate.Match)) {
          Rate_rate.Match other = (Rate_rate.Match) obj;
    ...
    @Override
    public Rate_rate specification() {
     ...
     * 
     */
    public static Rate_rate.Match newEmptyMatch() {
     ...
     * 
     */
    public static Rate_rate.Match newMutableMatch(final NamedElement pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public static Rate_rate.Match newMatch(final NamedElement pElement, final InstanceSpecification pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Rate_rate.Match {
    ...
    private static final class Immutable extends Rate_rate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Rate_rate pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Rate_rate.Match> {
    /**
     ...
     * 
     */
    public static Rate_rate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Rate_rate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Rate_rate.Matcher.class);
     ...
     * 
     */
    public Collection<Rate_rate.Match> getAllMatches(final NamedElement pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public Stream<Rate_rate.Match> streamAllMatches(final NamedElement pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public Optional<Rate_rate.Match> getOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pValue, final Consumer<? super Rate_rate.Match> processor) {
     ...
     * 
     */
    public Rate_rate.Match newMatch(final NamedElement pElement, final InstanceSpecification pValue) {
      return Rate_rate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfElement(final Rate_rate.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfElement(final Rate_rate.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfValue(final Rate_rate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfValue(final Rate_rate.Match partialMatch) {
    ...
    @Override
    protected Rate_rate.Match tupleToMatch(final Tuple t) {
      try {
          return Rate_rate.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_VALUE));
    ...
    @Override
    protected Rate_rate.Match arrayToMatch(final Object[] match) {
      try {
          return Rate_rate.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Rate_rate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rate_rate.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Rate_rate.Matcher> querySpecification() {
      return Rate_rate.instance();
    }
  }
   ...
   * 
   */
  public static Rate_rate instance() {
    try{
  ...
  @Override
  protected Rate_rate.Matcher instantiate(final ViatraQueryEngine engine) {
    return Rate_rate.Matcher.on(engine);
  }
  
  @Override
  public Rate_rate.Matcher instantiate() {
    return Rate_rate.Matcher.create();
  }
  
  @Override
  public Rate_rate.Match newEmptyMatch() {
    return Rate_rate.Match.newEmptyMatch();
  }
  
  @Override
  public Rate_rate.Match newMatch(final Object... parameters) {
    return Rate_rate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  ...
  private static class LazyHolder {
    private static final Rate_rate INSTANCE = new Rate_rate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Rate_rate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Rate(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), Rate.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "rate", taggedValue)
