...
public final class ActualProjectRole_endDate extends BaseGeneratedEMFQuerySpecification<ActualProjectRole_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectRole_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectRole_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectRole_endDate.Match)) {
          ActualProjectRole_endDate.Match other = (ActualProjectRole_endDate.Match) obj;
    ...
    @Override
    public ActualProjectRole_endDate specification() {
      return ActualProjectRole_endDate.instance();
    }
     ...
     * 
     */
    public static ActualProjectRole_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectRole_endDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProjectRole_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProjectRole_endDate.Match {
    ...
    private static final class Immutable extends ActualProjectRole_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectRole_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectRole_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectRole_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectRole_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectRole_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectRole_endDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProjectRole_endDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProjectRole_endDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProjectRole_endDate.Match> processor) {
     ...
     * 
     */
    public ActualProjectRole_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProjectRole_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProjectRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProjectRole_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualProjectRole_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectRole_endDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProjectRole_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectRole_endDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectRole_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectRole_endDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectRole_endDate.Matcher> querySpecification() {
      return ActualProjectRole_endDate.instance();
    }
  }
  
  private ActualProjectRole_endDate() {
   ...
   * 
   */
  public static ActualProjectRole_endDate instance() {
    try{
  ...
  @Override
  protected ActualProjectRole_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectRole_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectRole_endDate.Matcher instantiate() {
    return ActualProjectRole_endDate.Matcher.create();
  }
  
  @Override
  public ActualProjectRole_endDate.Match newEmptyMatch() {
    return ActualProjectRole_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectRole_endDate.Match newMatch(final Object... parameters) {
    return ActualProjectRole_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectRole_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectRole_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectRole_endDate INSTANCE = new ActualProjectRole_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectRole_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
