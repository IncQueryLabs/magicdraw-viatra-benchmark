...
public final class ExtendedRequirement extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ExtendedRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ExtendedRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<ExtendedRequirement.Match> {
     ...
     * 
     */
    public Collection<ExtendedRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ExtendedRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ExtendedRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype, final Consumer<? super ExtendedRequirement.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
      return ExtendedRequirement.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ExtendedRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ExtendedRequirement.Match partialMatch) {
    ...
    protected ExtendedRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ExtendedRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ExtendedRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ExtendedRequirement.Match newMatch(final Object... parameters) {
    return ExtendedRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
