...
public final class NodeRole_conformsTo extends BaseGeneratedEMFQuerySpecification<NodeRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public NodeRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeRole_conformsTo.Match)) {
          NodeRole_conformsTo.Match other = (NodeRole_conformsTo.Match) obj;
    ...
    @Override
    public NodeRole_conformsTo specification() {
      return NodeRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static NodeRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeRole_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeRole_conformsTo.Match {
    ...
    private static final class Immutable extends NodeRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see NodeRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<NodeRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static NodeRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<NodeRole_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeRole_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeRole_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super NodeRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public NodeRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return NodeRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final NodeRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final NodeRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected NodeRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return NodeRole_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return NodeRole_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeRole_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeRole_conformsTo.Matcher> querySpecification() {
      return NodeRole_conformsTo.instance();
    }
  }
  
  private NodeRole_conformsTo() {
   ...
   * 
   */
  public static NodeRole_conformsTo instance() {
    try{
  ...
  @Override
  protected NodeRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public NodeRole_conformsTo.Matcher instantiate() {
    return NodeRole_conformsTo.Matcher.create();
  }
  
  @Override
  public NodeRole_conformsTo.Match newEmptyMatch() {
    return NodeRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public NodeRole_conformsTo.Match newMatch(final Object... parameters) {
    return NodeRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeRole_conformsTo INSTANCE = new NodeRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
