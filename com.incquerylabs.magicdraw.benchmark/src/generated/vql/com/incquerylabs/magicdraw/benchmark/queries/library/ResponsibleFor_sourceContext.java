...
public final class ResponsibleFor_sourceContext extends BaseGeneratedEMFQuerySpecification<ResponsibleFor_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResponsibleFor_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public ResponsibleFor_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResponsibleFor_sourceContext.Match)) {
          ResponsibleFor_sourceContext.Match other = (ResponsibleFor_sourceContext.Match) obj;
    ...
    @Override
    public ResponsibleFor_sourceContext specification() {
      return ResponsibleFor_sourceContext.instance();
    }
     ...
     * 
     */
    public static ResponsibleFor_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResponsibleFor_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static ResponsibleFor_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResponsibleFor_sourceContext.Match {
    ...
    private static final class Immutable extends ResponsibleFor_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see ResponsibleFor_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<ResponsibleFor_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static ResponsibleFor_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResponsibleFor_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResponsibleFor_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<ResponsibleFor_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<ResponsibleFor_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<ResponsibleFor_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super ResponsibleFor_sourceContext.Match> processor) {
     ...
     * 
     */
    public ResponsibleFor_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return ResponsibleFor_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final ResponsibleFor_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final ResponsibleFor_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final ResponsibleFor_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final ResponsibleFor_sourceContext.Match partialMatch) {
    ...
    @Override
    protected ResponsibleFor_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return ResponsibleFor_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResponsibleFor_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return ResponsibleFor_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResponsibleFor_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResponsibleFor_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResponsibleFor_sourceContext.Matcher> querySpecification() {
      return ResponsibleFor_sourceContext.instance();
    }
  }
  
  private ResponsibleFor_sourceContext() {
   ...
   * 
   */
  public static ResponsibleFor_sourceContext instance() {
    try{
  ...
  @Override
  protected ResponsibleFor_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResponsibleFor_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public ResponsibleFor_sourceContext.Matcher instantiate() {
    return ResponsibleFor_sourceContext.Matcher.create();
  }
  
  @Override
  public ResponsibleFor_sourceContext.Match newEmptyMatch() {
    return ResponsibleFor_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public ResponsibleFor_sourceContext.Match newMatch(final Object... parameters) {
    return ResponsibleFor_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResponsibleFor_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResponsibleFor_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResponsibleFor_sourceContext INSTANCE = new ResponsibleFor_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResponsibleFor_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
