...
public final class InformationElement extends BaseGeneratedEMFQuerySpecification<InformationElement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement";
    }
    
    @Override
    public List<String> parameterNames() {
      return InformationElement.Match.parameterNames;
    }
    ...
    @Override
    public InformationElement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InformationElement.Match)) {
          InformationElement.Match other = (InformationElement.Match) obj;
    ...
    @Override
    public InformationElement specification() {
      return InformationElement.instance();
    }
     ...
     * 
     */
    public static InformationElement.Match newEmptyMatch() {
     ...
     * 
     */
    public static InformationElement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static InformationElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends InformationElement.Match {
    ...
    private static final class Immutable extends InformationElement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<InformationElement.Match> {
    /**
     ...
     * 
     */
    public static InformationElement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InformationElement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InformationElement.Matcher.class);
     ...
     * 
     */
    public Collection<InformationElement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<InformationElement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<InformationElement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super InformationElement.Match> processor) {
     ...
     * 
     */
    public InformationElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return InformationElement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InformationElement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InformationElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final InformationElement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final InformationElement.Match partialMatch) {
    ...
    @Override
    protected InformationElement.Match tupleToMatch(final Tuple t) {
      try {
          return InformationElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected InformationElement.Match arrayToMatch(final Object[] match) {
      try {
          return InformationElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InformationElement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InformationElement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InformationElement.Matcher> querySpecification() {
      return InformationElement.instance();
    }
  }
  
  private InformationElement() {
   ...
   * 
   */
  public static InformationElement instance() {
    try{
  ...
  @Override
  protected InformationElement.Matcher instantiate(final ViatraQueryEngine engine) {
    return InformationElement.Matcher.on(engine);
  }
  
  @Override
  public InformationElement.Matcher instantiate() {
    return InformationElement.Matcher.create();
  }
  
  @Override
  public InformationElement.Match newEmptyMatch() {
    return InformationElement.Match.newEmptyMatch();
  }
  
  @Override
  public InformationElement.Match newMatch(final Object... parameters) {
    return InformationElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InformationElement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InformationElement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InformationElement INSTANCE = new InformationElement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InformationElement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "InformationElement")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "InformationElement");
