...
public final class ElementGroup extends BaseGeneratedEMFQuerySpecification<ElementGroup.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ElementGroup pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Comment pElement, final Stereotype pStereotype) {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ElementGroup";
    }
     ...
     * 
     */
    public static ElementGroup.Match newMutableMatch(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ElementGroup.Match newMatch(final Comment pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends ElementGroup.Match {
      Mutable(final Comment pElement, final Stereotype pStereotype) {
    ...
    private static final class Immutable extends ElementGroup.Match {
      Immutable(final Comment pElement, final Stereotype pStereotype) {
        super(pElement, pStereotype);
      }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ElementGroup pattern,
  ...
  public static class Matcher extends BaseMatcher<ElementGroup.Match> {
     ...
     * 
     */
    public Collection<ElementGroup.Match> getAllMatches(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ElementGroup.Match> streamAllMatches(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ElementGroup.Match> getOneArbitraryMatch(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean hasMatch(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public int countMatches(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final Stereotype pStereotype, final Consumer<? super ElementGroup.Match> processor) {
     ...
     * 
     */
    public ElementGroup.Match newMatch(final Comment pElement, final Stereotype pStereotype) {
      return ElementGroup.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfElement(final Stereotype pStereotype) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfElement(final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ElementGroup.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Comment pElement) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ElementGroup.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Comment pElement) {
    ...
    protected ElementGroup.Match tupleToMatch(final Tuple t) {
      try {
          return ElementGroup.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ElementGroup.Match arrayToMatch(final Object[] match) {
      try {
          return ElementGroup.Match.newMatch((Comment) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ElementGroup.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ElementGroup.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ElementGroup.Match newMatch(final Object... parameters) {
    return ElementGroup.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ElementGroup} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ElementGroup#instance()}.
   * 
