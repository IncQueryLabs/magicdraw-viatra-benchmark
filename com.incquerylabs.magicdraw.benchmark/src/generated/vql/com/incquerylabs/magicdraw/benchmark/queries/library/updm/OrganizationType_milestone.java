...
public final class OrganizationType_milestone extends BaseGeneratedEMFQuerySpecification<OrganizationType_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_milestone.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_milestone.Match)) {
          OrganizationType_milestone.Match other = (OrganizationType_milestone.Match) obj;
    ...
    @Override
    public OrganizationType_milestone specification() {
      return OrganizationType_milestone.instance();
    }
     ...
     * 
     */
    public static OrganizationType_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_milestone.Match {
    ...
    private static final class Immutable extends OrganizationType_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_milestone pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_milestone.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_milestone.Match> processor) {
     ...
     * 
     */
    public OrganizationType_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_milestone.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_milestone.Matcher> querySpecification() {
      return OrganizationType_milestone.instance();
    }
  }
  
  private OrganizationType_milestone() {
   ...
   * 
   */
  public static OrganizationType_milestone instance() {
    try{
  ...
  @Override
  protected OrganizationType_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_milestone.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_milestone.Matcher instantiate() {
    return OrganizationType_milestone.Matcher.create();
  }
  
  @Override
  public OrganizationType_milestone.Match newEmptyMatch() {
    return OrganizationType_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_milestone.Match newMatch(final Object... parameters) {
    return OrganizationType_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_milestone INSTANCE = new OrganizationType_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
