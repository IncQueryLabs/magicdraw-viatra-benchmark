...
public final class DataElement extends BaseGeneratedEMFQuerySpecification<DataElement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DataElement";
    }
    
    @Override
    public List<String> parameterNames() {
      return DataElement.Match.parameterNames;
    }
    ...
    @Override
    public DataElement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DataElement.Match)) {
          DataElement.Match other = (DataElement.Match) obj;
    ...
    @Override
    public DataElement specification() {
      return DataElement.instance();
    }
     ...
     * 
     */
    public static DataElement.Match newEmptyMatch() {
     ...
     * 
     */
    public static DataElement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static DataElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends DataElement.Match {
    ...
    private static final class Immutable extends DataElement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<DataElement.Match> {
    /**
     ...
     * 
     */
    public static DataElement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DataElement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DataElement.Matcher.class);
     ...
     * 
     */
    public Collection<DataElement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<DataElement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<DataElement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super DataElement.Match> processor) {
     ...
     * 
     */
    public DataElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return DataElement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DataElement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DataElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final DataElement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final DataElement.Match partialMatch) {
    ...
    @Override
    protected DataElement.Match tupleToMatch(final Tuple t) {
      try {
          return DataElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected DataElement.Match arrayToMatch(final Object[] match) {
      try {
          return DataElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DataElement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DataElement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DataElement.Matcher> querySpecification() {
      return DataElement.instance();
    }
  }
   ...
   * 
   */
  public static DataElement instance() {
    try{
  ...
  @Override
  protected DataElement.Matcher instantiate(final ViatraQueryEngine engine) {
    return DataElement.Matcher.on(engine);
  }
  
  @Override
  public DataElement.Matcher instantiate() {
    return DataElement.Matcher.create();
  }
  
  @Override
  public DataElement.Match newEmptyMatch() {
    return DataElement.Match.newEmptyMatch();
  }
  
  @Override
  public DataElement.Match newMatch(final Object... parameters) {
    return DataElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataElement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataElement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DataElement INSTANCE = new DataElement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DataElement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "DataElement")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "DataElement");
