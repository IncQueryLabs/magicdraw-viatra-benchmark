...
public final class Probability extends BaseGeneratedEMFQuerySpecification<Probability.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Probability pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Probability";
    }
    
    @Override
    public List<String> parameterNames() {
      return Probability.Match.parameterNames;
    }
    ...
    @Override
    public Probability.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Probability.Match)) {
          Probability.Match other = (Probability.Match) obj;
    ...
    @Override
    public Probability specification() {
     ...
     * 
     */
    public static Probability.Match newEmptyMatch() {
     ...
     * 
     */
    public static Probability.Match newMutableMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Probability.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Probability.Match {
    ...
    private static final class Immutable extends Probability.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Probability pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Probability.Match> {
    /**
     ...
     * 
     */
    public static Probability.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Probability.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Probability.Matcher.class);
     ...
     * 
     */
    public Collection<Probability.Match> getAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Probability.Match> streamAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Probability.Match> getOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype, final Consumer<? super Probability.Match> processor) {
     ...
     * 
     */
    public Probability.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
      return Probability.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfElement(final Probability.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfElement(final Probability.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Probability.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Probability.Match partialMatch) {
    ...
    @Override
    protected Probability.Match tupleToMatch(final Tuple t) {
      try {
          return Probability.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Probability.Match arrayToMatch(final Object[] match) {
      try {
          return Probability.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Probability.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Probability.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Probability.Matcher> querySpecification() {
      return Probability.instance();
    }
  }
  ...
  @Override
  protected Probability.Matcher instantiate(final ViatraQueryEngine engine) {
    return Probability.Matcher.on(engine);
  }
  
  @Override
  public Probability.Matcher instantiate() {
    return Probability.Matcher.create();
  }
  
  @Override
  public Probability.Match newEmptyMatch() {
    return Probability.Match.newEmptyMatch();
  }
  
  @Override
  public Probability.Match newMatch(final Object... parameters) {
    return Probability.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Probability} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Probability#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Probability.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Probability");
