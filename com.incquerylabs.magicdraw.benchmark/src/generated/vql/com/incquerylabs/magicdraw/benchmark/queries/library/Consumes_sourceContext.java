...
public final class Consumes_sourceContext extends BaseGeneratedEMFQuerySpecification<Consumes_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Consumes_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public Consumes_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Consumes_sourceContext.Match)) {
          Consumes_sourceContext.Match other = (Consumes_sourceContext.Match) obj;
    ...
    @Override
    public Consumes_sourceContext specification() {
      return Consumes_sourceContext.instance();
    }
     ...
     * 
     */
    public static Consumes_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Consumes_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Consumes_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Consumes_sourceContext.Match {
    ...
    private static final class Immutable extends Consumes_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see Consumes_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<Consumes_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static Consumes_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Consumes_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Consumes_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<Consumes_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Consumes_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Consumes_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Consumes_sourceContext.Match> processor) {
     ...
     * 
     */
    public Consumes_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Consumes_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Consumes_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Consumes_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Consumes_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Consumes_sourceContext.Match partialMatch) {
    ...
    @Override
    protected Consumes_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return Consumes_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Consumes_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return Consumes_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Consumes_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Consumes_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Consumes_sourceContext.Matcher> querySpecification() {
      return Consumes_sourceContext.instance();
    }
  }
  
  private Consumes_sourceContext() {
   ...
   * 
   */
  public static Consumes_sourceContext instance() {
    try{
  ...
  @Override
  protected Consumes_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Consumes_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public Consumes_sourceContext.Matcher instantiate() {
    return Consumes_sourceContext.Matcher.create();
  }
  
  @Override
  public Consumes_sourceContext.Match newEmptyMatch() {
    return Consumes_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public Consumes_sourceContext.Match newMatch(final Object... parameters) {
    return Consumes_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Consumes_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Consumes_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Consumes_sourceContext INSTANCE = new Consumes_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Consumes_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
