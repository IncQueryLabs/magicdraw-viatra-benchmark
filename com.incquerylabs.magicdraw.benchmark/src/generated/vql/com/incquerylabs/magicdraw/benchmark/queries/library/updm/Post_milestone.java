...
public final class Post_milestone extends BaseGeneratedEMFQuerySpecification<Post_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_milestone.Match.parameterNames;
    }
    ...
    @Override
    public Post_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_milestone.Match)) {
          Post_milestone.Match other = (Post_milestone.Match) obj;
    ...
    @Override
    public Post_milestone specification() {
      return Post_milestone.instance();
    }
     ...
     * 
     */
    public static Post_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_milestone.Match {
    ...
    private static final class Immutable extends Post_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_milestone pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Post_milestone.Match> {
    /**
     ...
     * 
     */
    public static Post_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<Post_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_milestone.Match> processor) {
     ...
     * 
     */
    public Post_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_milestone.Match partialMatch) {
    ...
    @Override
    protected Post_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return Post_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return Post_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_milestone.Matcher> querySpecification() {
      return Post_milestone.instance();
    }
  }
  
  private Post_milestone() {
   ...
   * 
   */
  public static Post_milestone instance() {
    try{
  ...
  @Override
  protected Post_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_milestone.Matcher.on(engine);
  }
  
  @Override
  public Post_milestone.Matcher instantiate() {
    return Post_milestone.Matcher.create();
  }
  
  @Override
  public Post_milestone.Match newEmptyMatch() {
    return Post_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public Post_milestone.Match newMatch(final Object... parameters) {
    return Post_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_milestone INSTANCE = new Post_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
