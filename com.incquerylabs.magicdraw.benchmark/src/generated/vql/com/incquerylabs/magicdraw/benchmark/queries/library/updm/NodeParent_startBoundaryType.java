...
public final class NodeParent_startBoundaryType extends BaseGeneratedEMFQuerySpecification<NodeParent_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_startBoundaryType.Match)) {
          NodeParent_startBoundaryType.Match other = (NodeParent_startBoundaryType.Match) obj;
    ...
    @Override
    public NodeParent_startBoundaryType specification() {
      return NodeParent_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static NodeParent_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeParent_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeParent_startBoundaryType.Match {
    ...
    private static final class Immutable extends NodeParent_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see NodeParent_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeParent_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeParent_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NodeParent_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public NodeParent_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NodeParent_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeParent_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeParent_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected NodeParent_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeParent_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_startBoundaryType.Matcher> querySpecification() {
      return NodeParent_startBoundaryType.instance();
    }
  }
  
  private NodeParent_startBoundaryType() {
   ...
   * 
   */
  public static NodeParent_startBoundaryType instance() {
    try{
  ...
  @Override
  protected NodeParent_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_startBoundaryType.Matcher instantiate() {
    return NodeParent_startBoundaryType.Matcher.create();
  }
  
  @Override
  public NodeParent_startBoundaryType.Match newEmptyMatch() {
    return NodeParent_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_startBoundaryType.Match newMatch(final Object... parameters) {
    return NodeParent_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_startBoundaryType INSTANCE = new NodeParent_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
