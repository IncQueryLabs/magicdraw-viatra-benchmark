...
public final class HighLevelOperationalConcept_actualPropertySet extends BaseGeneratedEMFQuerySpecification<HighLevelOperationalConcept_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return HighLevelOperationalConcept_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public HighLevelOperationalConcept_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof HighLevelOperationalConcept_actualPropertySet.Match)) {
          HighLevelOperationalConcept_actualPropertySet.Match other = (HighLevelOperationalConcept_actualPropertySet.Match) obj;
    ...
    @Override
    public HighLevelOperationalConcept_actualPropertySet specification() {
      return HighLevelOperationalConcept_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static HighLevelOperationalConcept_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static HighLevelOperationalConcept_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends HighLevelOperationalConcept_actualPropertySet.Match {
    ...
    private static final class Immutable extends HighLevelOperationalConcept_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see HighLevelOperationalConcept_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<HighLevelOperationalConcept_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static HighLevelOperationalConcept_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(HighLevelOperationalConcept_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<HighLevelOperationalConcept_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<HighLevelOperationalConcept_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<HighLevelOperationalConcept_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super HighLevelOperationalConcept_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public HighLevelOperationalConcept_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return HighLevelOperationalConcept_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final HighLevelOperationalConcept_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final HighLevelOperationalConcept_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final HighLevelOperationalConcept_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final HighLevelOperationalConcept_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected HighLevelOperationalConcept_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return HighLevelOperationalConcept_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected HighLevelOperationalConcept_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return HighLevelOperationalConcept_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected HighLevelOperationalConcept_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return HighLevelOperationalConcept_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<HighLevelOperationalConcept_actualPropertySet.Matcher> querySpecification() {
      return HighLevelOperationalConcept_actualPropertySet.instance();
    }
  }
  
  private HighLevelOperationalConcept_actualPropertySet() {
   ...
   * 
   */
  public static HighLevelOperationalConcept_actualPropertySet instance() {
    try{
  ...
  @Override
  protected HighLevelOperationalConcept_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return HighLevelOperationalConcept_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public HighLevelOperationalConcept_actualPropertySet.Matcher instantiate() {
    return HighLevelOperationalConcept_actualPropertySet.Matcher.create();
  }
  
  @Override
  public HighLevelOperationalConcept_actualPropertySet.Match newEmptyMatch() {
    return HighLevelOperationalConcept_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public HighLevelOperationalConcept_actualPropertySet.Match newMatch(final Object... parameters) {
    return HighLevelOperationalConcept_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link HighLevelOperationalConcept_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link HighLevelOperationalConcept_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final HighLevelOperationalConcept_actualPropertySet INSTANCE = new HighLevelOperationalConcept_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final HighLevelOperationalConcept_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
