...
public final class Exchange_URI extends BaseGeneratedEMFQuerySpecification<Exchange_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Exchange_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Exchange_URI";
    }
     ...
     * 
     */
    public static Exchange_URI.Match newMutableMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Exchange_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Exchange_URI pattern,
  ...
  public static class Matcher extends BaseMatcher<Exchange_URI.Match> {
     ...
     * 
     */
    public Collection<Exchange_URI.Match> getAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Exchange_URI.Match> streamAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Exchange_URI.Match> getOneArbitraryMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final LiteralString pValuespec, final Consumer<? super Exchange_URI.Match> processor) {
     ...
     * 
     */
    public Exchange_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Exchange_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Exchange_URI.Match partialMatch) {
    ...
    protected Exchange_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Exchange_URI.Match.newMatch((Element) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    protected Exchange_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Exchange_URI.Match.newMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected Exchange_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Exchange_URI.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Exchange_URI.Match newMatch(final Object... parameters) {
    return Exchange_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
