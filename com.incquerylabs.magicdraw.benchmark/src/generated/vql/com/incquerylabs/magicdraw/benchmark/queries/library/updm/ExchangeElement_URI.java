...
public final class ExchangeElement_URI extends BaseGeneratedEMFQuerySpecification<ExchangeElement_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_URI.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_URI.Match)) {
          ExchangeElement_URI.Match other = (ExchangeElement_URI.Match) obj;
    ...
    @Override
    public ExchangeElement_URI specification() {
      return ExchangeElement_URI.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ExchangeElement_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ExchangeElement_URI.Match {
    ...
    private static final class Immutable extends ExchangeElement_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_URI pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_URI.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ExchangeElement_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ExchangeElement_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ExchangeElement_URI.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ExchangeElement_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ExchangeElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ExchangeElement_URI.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ExchangeElement_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_URI.Matcher> querySpecification() {
      return ExchangeElement_URI.instance();
    }
  }
  
  private ExchangeElement_URI() {
   ...
   * 
   */
  public static ExchangeElement_URI instance() {
    try{
  ...
  @Override
  protected ExchangeElement_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_URI.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_URI.Matcher instantiate() {
    return ExchangeElement_URI.Matcher.create();
  }
  
  @Override
  public ExchangeElement_URI.Match newEmptyMatch() {
    return ExchangeElement_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_URI.Match newMatch(final Object... parameters) {
    return ExchangeElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_URI INSTANCE = new ExchangeElement_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
