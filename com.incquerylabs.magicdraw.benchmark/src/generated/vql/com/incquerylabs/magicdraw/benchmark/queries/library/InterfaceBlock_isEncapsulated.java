...
public final class InterfaceBlock_isEncapsulated extends BaseGeneratedEMFQuerySpecification<InterfaceBlock_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.InterfaceBlock_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.InterfaceBlock_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceBlock_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceBlock_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceBlock_isEncapsulated.Match)) {
          InterfaceBlock_isEncapsulated.Match other = (InterfaceBlock_isEncapsulated.Match) obj;
    ...
    @Override
    public InterfaceBlock_isEncapsulated specification() {
     ...
     * 
     */
    public static InterfaceBlock_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceBlock_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static InterfaceBlock_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends InterfaceBlock_isEncapsulated.Match {
    ...
    private static final class Immutable extends InterfaceBlock_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.InterfaceBlock_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see InterfaceBlock_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceBlock_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static InterfaceBlock_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceBlock_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceBlock_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceBlock_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<InterfaceBlock_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<InterfaceBlock_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super InterfaceBlock_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public InterfaceBlock_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return InterfaceBlock_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InterfaceBlock_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InterfaceBlock_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final InterfaceBlock_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final InterfaceBlock_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected InterfaceBlock_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected InterfaceBlock_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceBlock_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceBlock_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceBlock_isEncapsulated.Matcher> querySpecification() {
      return InterfaceBlock_isEncapsulated.instance();
    }
  }
  
  private InterfaceBlock_isEncapsulated() {
   ...
   * 
   */
  public static InterfaceBlock_isEncapsulated instance() {
    try{
  ...
  @Override
  protected InterfaceBlock_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceBlock_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public InterfaceBlock_isEncapsulated.Matcher instantiate() {
    return InterfaceBlock_isEncapsulated.Matcher.create();
  }
  
  @Override
  public InterfaceBlock_isEncapsulated.Match newEmptyMatch() {
    return InterfaceBlock_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceBlock_isEncapsulated.Match newMatch(final Object... parameters) {
    return InterfaceBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceBlock_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceBlock_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceBlock_isEncapsulated INSTANCE = new InterfaceBlock_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceBlock_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find InterfaceBlock(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), InterfaceBlock.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
