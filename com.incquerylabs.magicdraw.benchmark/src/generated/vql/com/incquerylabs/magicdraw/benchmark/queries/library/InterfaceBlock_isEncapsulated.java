...
public final class InterfaceBlock_isEncapsulated extends BaseGeneratedEMFQuerySpecification<InterfaceBlock_isEncapsulated.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static InterfaceBlock_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public static InterfaceBlock_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
  ...
  public static class Matcher extends BaseMatcher<InterfaceBlock_isEncapsulated.Match> {
     ...
     * 
     */
    public Collection<InterfaceBlock_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public Stream<InterfaceBlock_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public Optional<InterfaceBlock_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue, final Consumer<? super InterfaceBlock_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public InterfaceBlock_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
      return InterfaceBlock_isEncapsulated.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Boolean> streamAllValuesOfValue(final InterfaceBlock_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfValue(final InterfaceBlock_isEncapsulated.Match partialMatch) {
    ...
    protected InterfaceBlock_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Boolean) t.get(POSITION_VALUE));
    ...
    protected InterfaceBlock_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Boolean) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected InterfaceBlock_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceBlock_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Boolean) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public InterfaceBlock_isEncapsulated.Match newMatch(final Object... parameters) {
    return InterfaceBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.Boolean) parameters[1]);
  }
