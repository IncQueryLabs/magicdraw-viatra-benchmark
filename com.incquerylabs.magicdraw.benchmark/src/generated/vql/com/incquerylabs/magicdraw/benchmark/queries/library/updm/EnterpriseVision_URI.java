...
public final class EnterpriseVision_URI extends BaseGeneratedEMFQuerySpecification<EnterpriseVision_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseVision_URI.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseVision_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseVision_URI.Match)) {
          EnterpriseVision_URI.Match other = (EnterpriseVision_URI.Match) obj;
    ...
    @Override
    public EnterpriseVision_URI specification() {
      return EnterpriseVision_URI.instance();
    }
     ...
     * 
     */
    public static EnterpriseVision_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseVision_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnterpriseVision_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnterpriseVision_URI.Match {
    ...
    private static final class Immutable extends EnterpriseVision_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_URI pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseVision_URI
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseVision_URI.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseVision_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseVision_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseVision_URI.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseVision_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnterpriseVision_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnterpriseVision_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EnterpriseVision_URI.Match> processor) {
     ...
     * 
     */
    public EnterpriseVision_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EnterpriseVision_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseVision_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseVision_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnterpriseVision_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnterpriseVision_URI.Match partialMatch) {
    ...
    @Override
    protected EnterpriseVision_URI.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseVision_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnterpriseVision_URI.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseVision_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseVision_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseVision_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseVision_URI.Matcher> querySpecification() {
      return EnterpriseVision_URI.instance();
    }
  }
  
  private EnterpriseVision_URI() {
   ...
   * 
   */
  public static EnterpriseVision_URI instance() {
    try{
  ...
  @Override
  protected EnterpriseVision_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseVision_URI.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseVision_URI.Matcher instantiate() {
    return EnterpriseVision_URI.Matcher.create();
  }
  
  @Override
  public EnterpriseVision_URI.Match newEmptyMatch() {
    return EnterpriseVision_URI.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseVision_URI.Match newMatch(final Object... parameters) {
    return EnterpriseVision_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseVision_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseVision_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseVision_URI INSTANCE = new EnterpriseVision_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseVision_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
