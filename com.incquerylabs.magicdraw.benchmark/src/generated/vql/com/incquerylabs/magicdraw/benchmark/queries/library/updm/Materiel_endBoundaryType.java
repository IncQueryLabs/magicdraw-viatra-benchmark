...
public final class Materiel_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Materiel_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_endBoundaryType.Match)) {
          Materiel_endBoundaryType.Match other = (Materiel_endBoundaryType.Match) obj;
    ...
    @Override
    public Materiel_endBoundaryType specification() {
      return Materiel_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Materiel_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Materiel_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Materiel_endBoundaryType.Match {
    ...
    private static final class Immutable extends Materiel_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Materiel_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Materiel_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Materiel_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Materiel_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Materiel_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Materiel_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Materiel_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Materiel_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Materiel_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Materiel_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Materiel_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_endBoundaryType.Matcher> querySpecification() {
      return Materiel_endBoundaryType.instance();
    }
  }
  
  private Materiel_endBoundaryType() {
   ...
   * 
   */
  public static Materiel_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Materiel_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Materiel_endBoundaryType.Matcher instantiate() {
    return Materiel_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Materiel_endBoundaryType.Match newEmptyMatch() {
    return Materiel_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_endBoundaryType.Match newMatch(final Object... parameters) {
    return Materiel_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_endBoundaryType INSTANCE = new Materiel_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
