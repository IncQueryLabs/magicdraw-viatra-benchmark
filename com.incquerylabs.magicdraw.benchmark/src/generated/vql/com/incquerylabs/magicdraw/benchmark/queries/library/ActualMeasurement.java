...
public final class ActualMeasurement extends BaseGeneratedEMFQuerySpecification<ActualMeasurement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualMeasurement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualMeasurement";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualMeasurement.Match.parameterNames;
    }
    ...
    @Override
    public ActualMeasurement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualMeasurement.Match)) {
          ActualMeasurement.Match other = (ActualMeasurement.Match) obj;
    ...
    @Override
    public ActualMeasurement specification() {
      return ActualMeasurement.instance();
    }
     ...
     * 
     */
    public static ActualMeasurement.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualMeasurement.Match newMutableMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualMeasurement.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualMeasurement.Match {
    ...
    private static final class Immutable extends ActualMeasurement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualMeasurement pattern,
   ...
   * 
   * @see Match
   * @see ActualMeasurement
   * 
   */
  public static class Matcher extends BaseMatcher<ActualMeasurement.Match> {
    /**
     ...
     * 
     */
    public static ActualMeasurement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualMeasurement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualMeasurement.Matcher.class);
     ...
     * 
     */
    public Collection<ActualMeasurement.Match> getAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualMeasurement.Match> streamAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualMeasurement.Match> getOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualMeasurement.Match> processor) {
     ...
     * 
     */
    public ActualMeasurement.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualMeasurement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualMeasurement.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualMeasurement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualMeasurement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualMeasurement.Match partialMatch) {
    ...
    @Override
    protected ActualMeasurement.Match tupleToMatch(final Tuple t) {
      try {
          return ActualMeasurement.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualMeasurement.Match arrayToMatch(final Object[] match) {
      try {
          return ActualMeasurement.Match.newMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualMeasurement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualMeasurement.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualMeasurement.Matcher> querySpecification() {
      return ActualMeasurement.instance();
    }
  }
  
  private ActualMeasurement() {
   ...
   * 
   */
  public static ActualMeasurement instance() {
    try{
  ...
  @Override
  protected ActualMeasurement.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualMeasurement.Matcher.on(engine);
  }
  
  @Override
  public ActualMeasurement.Matcher instantiate() {
    return ActualMeasurement.Matcher.create();
  }
  
  @Override
  public ActualMeasurement.Match newEmptyMatch() {
    return ActualMeasurement.Match.newEmptyMatch();
  }
  
  @Override
  public ActualMeasurement.Match newMatch(final Object... parameters) {
    return ActualMeasurement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualMeasurement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualMeasurement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualMeasurement INSTANCE = new ActualMeasurement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualMeasurement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualMeasurement")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualMeasurement");
