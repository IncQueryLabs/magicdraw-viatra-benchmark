...
public final class Protocol_propertySet extends BaseGeneratedEMFQuerySpecification<Protocol_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_propertySet.Match)) {
          Protocol_propertySet.Match other = (Protocol_propertySet.Match) obj;
    ...
    @Override
    public Protocol_propertySet specification() {
      return Protocol_propertySet.instance();
    }
     ...
     * 
     */
    public static Protocol_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Protocol_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Protocol_propertySet.Match {
    ...
    private static final class Immutable extends Protocol_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Protocol_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Protocol_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Protocol_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Protocol_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Protocol_propertySet.Match> processor) {
     ...
     * 
     */
    public Protocol_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Protocol_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Protocol_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Protocol_propertySet.Match partialMatch) {
    ...
    @Override
    protected Protocol_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Protocol_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_propertySet.Matcher> querySpecification() {
      return Protocol_propertySet.instance();
    }
  }
  
  private Protocol_propertySet() {
   ...
   * 
   */
  public static Protocol_propertySet instance() {
    try{
  ...
  @Override
  protected Protocol_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Protocol_propertySet.Matcher instantiate() {
    return Protocol_propertySet.Matcher.create();
  }
  
  @Override
  public Protocol_propertySet.Match newEmptyMatch() {
    return Protocol_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_propertySet.Match newMatch(final Object... parameters) {
    return Protocol_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_propertySet INSTANCE = new Protocol_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
