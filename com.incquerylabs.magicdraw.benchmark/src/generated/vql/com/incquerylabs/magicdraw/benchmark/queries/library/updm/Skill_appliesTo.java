...
public final class Skill_appliesTo extends BaseGeneratedEMFQuerySpecification<Skill_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Skill_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Skill_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Skill_appliesTo.Match)) {
          Skill_appliesTo.Match other = (Skill_appliesTo.Match) obj;
    ...
    @Override
    public Skill_appliesTo specification() {
      return Skill_appliesTo.instance();
    }
     ...
     * 
     */
    public static Skill_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Skill_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Skill_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Skill_appliesTo.Match {
    ...
    private static final class Immutable extends Skill_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_appliesTo pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Skill_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Skill_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Skill_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Skill_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Skill_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Skill_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Skill_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Skill_appliesTo.Match> processor) {
     ...
     * 
     */
    public Skill_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Skill_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Skill_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Skill_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Skill_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Skill_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Skill_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Skill_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Skill_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Skill_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Skill_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Skill_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Skill_appliesTo.Matcher> querySpecification() {
      return Skill_appliesTo.instance();
    }
  }
  
  private Skill_appliesTo() {
   ...
   * 
   */
  public static Skill_appliesTo instance() {
    try{
  ...
  @Override
  protected Skill_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Skill_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Skill_appliesTo.Matcher instantiate() {
    return Skill_appliesTo.Matcher.create();
  }
  
  @Override
  public Skill_appliesTo.Match newEmptyMatch() {
    return Skill_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Skill_appliesTo.Match newMatch(final Object... parameters) {
    return Skill_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Skill_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Skill_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Skill_appliesTo INSTANCE = new Skill_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Skill_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
