...
public final class SecurityProcess extends BaseGeneratedEMFQuerySpecification<SecurityProcess.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProcess pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProcess";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityProcess.Match.parameterNames;
    }
    ...
    @Override
    public SecurityProcess.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityProcess.Match)) {
          SecurityProcess.Match other = (SecurityProcess.Match) obj;
    ...
    @Override
    public SecurityProcess specification() {
      return SecurityProcess.instance();
    }
     ...
     * 
     */
    public static SecurityProcess.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityProcess.Match newMutableMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SecurityProcess.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SecurityProcess.Match {
    ...
    private static final class Immutable extends SecurityProcess.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProcess pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityProcess.Match> {
    /**
     ...
     * 
     */
    public static SecurityProcess.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityProcess.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityProcess.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityProcess.Match> getAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SecurityProcess.Match> streamAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SecurityProcess.Match> getOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SecurityProcess.Match> processor) {
     ...
     * 
     */
    public SecurityProcess.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SecurityProcess.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final SecurityProcess.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final SecurityProcess.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SecurityProcess.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SecurityProcess.Match partialMatch) {
    ...
    @Override
    protected SecurityProcess.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityProcess.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SecurityProcess.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityProcess.Match.newMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityProcess.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityProcess.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityProcess.Matcher> querySpecification() {
      return SecurityProcess.instance();
    }
  }
   ...
   * 
   */
  public static SecurityProcess instance() {
    try{
  ...
  @Override
  protected SecurityProcess.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityProcess.Matcher.on(engine);
  }
  
  @Override
  public SecurityProcess.Matcher instantiate() {
    return SecurityProcess.Matcher.create();
  }
  
  @Override
  public SecurityProcess.Match newEmptyMatch() {
    return SecurityProcess.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityProcess.Match newMatch(final Object... parameters) {
    return SecurityProcess.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityProcess} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityProcess#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityProcess INSTANCE = new SecurityProcess();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityProcess.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "SecurityProcess")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "SecurityProcess");
