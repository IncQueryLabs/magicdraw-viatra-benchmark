...
public final class FunctionalStandard_version extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_version.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_version pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_version";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_version.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_version.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_version.Match)) {
          FunctionalStandard_version.Match other = (FunctionalStandard_version.Match) obj;
    ...
    @Override
    public FunctionalStandard_version specification() {
      return FunctionalStandard_version.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_version.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_version.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static FunctionalStandard_version.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends FunctionalStandard_version.Match {
    ...
    private static final class Immutable extends FunctionalStandard_version.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_version pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_version
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_version.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_version.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_version.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_version.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_version.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<FunctionalStandard_version.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<FunctionalStandard_version.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super FunctionalStandard_version.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_version.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return FunctionalStandard_version.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_version.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_version.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final FunctionalStandard_version.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final FunctionalStandard_version.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_version.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected FunctionalStandard_version.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_version.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_version.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_version.Matcher> querySpecification() {
      return FunctionalStandard_version.instance();
    }
  }
  
  private FunctionalStandard_version() {
   ...
   * 
   */
  public static FunctionalStandard_version instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_version.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_version.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_version.Matcher instantiate() {
    return FunctionalStandard_version.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_version.Match newEmptyMatch() {
    return FunctionalStandard_version.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_version.Match newMatch(final Object... parameters) {
    return FunctionalStandard_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_version} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_version#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_version INSTANCE = new FunctionalStandard_version();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_version.GeneratedPQuery INSTANCE = new GeneratedPQuery();
