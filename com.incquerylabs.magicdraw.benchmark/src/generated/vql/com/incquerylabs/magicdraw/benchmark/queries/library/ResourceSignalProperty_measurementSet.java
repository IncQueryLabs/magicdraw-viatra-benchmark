...
public final class ResourceSignalProperty_measurementSet extends BaseGeneratedEMFQuerySpecification<ResourceSignalProperty_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceSignalProperty_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceSignalProperty_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceSignalProperty_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ResourceSignalProperty_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceSignalProperty_measurementSet.Match)) {
          ResourceSignalProperty_measurementSet.Match other = (ResourceSignalProperty_measurementSet.Match) obj;
    ...
    @Override
    public ResourceSignalProperty_measurementSet specification() {
      return ResourceSignalProperty_measurementSet.instance();
    }
     ...
     * 
     */
    public static ResourceSignalProperty_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceSignalProperty_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceSignalProperty_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceSignalProperty_measurementSet.Match {
    ...
    private static final class Immutable extends ResourceSignalProperty_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceSignalProperty_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see ResourceSignalProperty_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceSignalProperty_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static ResourceSignalProperty_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceSignalProperty_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceSignalProperty_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceSignalProperty_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceSignalProperty_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceSignalProperty_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceSignalProperty_measurementSet.Match> processor) {
     ...
     * 
     */
    public ResourceSignalProperty_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceSignalProperty_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceSignalProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceSignalProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceSignalProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceSignalProperty_measurementSet.Match partialMatch) {
    ...
    @Override
    protected ResourceSignalProperty_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceSignalProperty_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceSignalProperty_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceSignalProperty_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceSignalProperty_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceSignalProperty_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceSignalProperty_measurementSet.Matcher> querySpecification() {
      return ResourceSignalProperty_measurementSet.instance();
    }
  }
  
  private ResourceSignalProperty_measurementSet() {
   ...
   * 
   */
  public static ResourceSignalProperty_measurementSet instance() {
    try{
  ...
  @Override
  protected ResourceSignalProperty_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceSignalProperty_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public ResourceSignalProperty_measurementSet.Matcher instantiate() {
    return ResourceSignalProperty_measurementSet.Matcher.create();
  }
  
  @Override
  public ResourceSignalProperty_measurementSet.Match newEmptyMatch() {
    return ResourceSignalProperty_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceSignalProperty_measurementSet.Match newMatch(final Object... parameters) {
    return ResourceSignalProperty_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceSignalProperty_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceSignalProperty_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceSignalProperty_measurementSet INSTANCE = new ResourceSignalProperty_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceSignalProperty_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
