...
public final class Capability_appliesTo extends BaseGeneratedEMFQuerySpecification<Capability_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Capability_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Capability_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Capability_appliesTo.Match)) {
          Capability_appliesTo.Match other = (Capability_appliesTo.Match) obj;
    ...
    @Override
    public Capability_appliesTo specification() {
      return Capability_appliesTo.instance();
    }
     ...
     * 
     */
    public static Capability_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Capability_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Capability_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Capability_appliesTo.Match {
    ...
    private static final class Immutable extends Capability_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Capability_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Capability_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Capability_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Capability_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Capability_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Capability_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Capability_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Capability_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Capability_appliesTo.Match> processor) {
     ...
     * 
     */
    public Capability_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Capability_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Capability_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Capability_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Capability_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Capability_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Capability_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Capability_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Capability_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Capability_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Capability_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Capability_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Capability_appliesTo.Matcher> querySpecification() {
      return Capability_appliesTo.instance();
    }
  }
  
  private Capability_appliesTo() {
   ...
   * 
   */
  public static Capability_appliesTo instance() {
    try{
  ...
  @Override
  protected Capability_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Capability_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Capability_appliesTo.Matcher instantiate() {
    return Capability_appliesTo.Matcher.create();
  }
  
  @Override
  public Capability_appliesTo.Match newEmptyMatch() {
    return Capability_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Capability_appliesTo.Match newMatch(final Object... parameters) {
    return Capability_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Capability_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Capability_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Capability_appliesTo INSTANCE = new Capability_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Capability_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
