...
public final class EnterprisePhase_statementTasks extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_statementTasks.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_statementTasks pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_statementTasks";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_statementTasks.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_statementTasks.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_statementTasks.Match)) {
          EnterprisePhase_statementTasks.Match other = (EnterprisePhase_statementTasks.Match) obj;
    ...
    @Override
    public EnterprisePhase_statementTasks specification() {
      return EnterprisePhase_statementTasks.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_statementTasks.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_statementTasks.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_statementTasks.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_statementTasks.Match {
    ...
    private static final class Immutable extends EnterprisePhase_statementTasks.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_statementTasks pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_statementTasks
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_statementTasks.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_statementTasks.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_statementTasks.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_statementTasks.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_statementTasks.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_statementTasks.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_statementTasks.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_statementTasks.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_statementTasks.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_statementTasks.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_statementTasks.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_statementTasks.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_statementTasks.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_statementTasks.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_statementTasks.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_statementTasks.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_statementTasks.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_statementTasks.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_statementTasks.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_statementTasks.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_statementTasks.Matcher> querySpecification() {
      return EnterprisePhase_statementTasks.instance();
    }
  }
  
  private EnterprisePhase_statementTasks() {
   ...
   * 
   */
  public static EnterprisePhase_statementTasks instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_statementTasks.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_statementTasks.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_statementTasks.Matcher instantiate() {
    return EnterprisePhase_statementTasks.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_statementTasks.Match newEmptyMatch() {
    return EnterprisePhase_statementTasks.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_statementTasks.Match newMatch(final Object... parameters) {
    return EnterprisePhase_statementTasks.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_statementTasks} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_statementTasks#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_statementTasks INSTANCE = new EnterprisePhase_statementTasks();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_statementTasks.GeneratedPQuery INSTANCE = new GeneratedPQuery();
