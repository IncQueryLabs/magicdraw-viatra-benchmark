...
public final class ProjectTheme_conformsTo extends BaseGeneratedEMFQuerySpecification<ProjectTheme_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectTheme_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ProjectTheme_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectTheme_conformsTo.Match)) {
          ProjectTheme_conformsTo.Match other = (ProjectTheme_conformsTo.Match) obj;
    ...
    @Override
    public ProjectTheme_conformsTo specification() {
      return ProjectTheme_conformsTo.instance();
    }
     ...
     * 
     */
    public static ProjectTheme_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectTheme_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectTheme_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectTheme_conformsTo.Match {
    ...
    private static final class Immutable extends ProjectTheme_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ProjectTheme_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectTheme_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ProjectTheme_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectTheme_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectTheme_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectTheme_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectTheme_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectTheme_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectTheme_conformsTo.Match> processor) {
     ...
     * 
     */
    public ProjectTheme_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectTheme_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectTheme_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectTheme_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectTheme_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectTheme_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ProjectTheme_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectTheme_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectTheme_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectTheme_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectTheme_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectTheme_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectTheme_conformsTo.Matcher> querySpecification() {
      return ProjectTheme_conformsTo.instance();
    }
  }
  
  private ProjectTheme_conformsTo() {
   ...
   * 
   */
  public static ProjectTheme_conformsTo instance() {
    try{
  ...
  @Override
  protected ProjectTheme_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectTheme_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ProjectTheme_conformsTo.Matcher instantiate() {
    return ProjectTheme_conformsTo.Matcher.create();
  }
  
  @Override
  public ProjectTheme_conformsTo.Match newEmptyMatch() {
    return ProjectTheme_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectTheme_conformsTo.Match newMatch(final Object... parameters) {
    return ProjectTheme_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectTheme_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectTheme_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectTheme_conformsTo INSTANCE = new ProjectTheme_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectTheme_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
