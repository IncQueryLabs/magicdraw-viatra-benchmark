...
public final class OwnsRisk_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<OwnsRisk_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRisk_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRisk_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRisk_targetPropertyPath.Match)) {
          OwnsRisk_targetPropertyPath.Match other = (OwnsRisk_targetPropertyPath.Match) obj;
    ...
    @Override
    public OwnsRisk_targetPropertyPath specification() {
      return OwnsRisk_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static OwnsRisk_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRisk_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static OwnsRisk_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsRisk_targetPropertyPath.Match {
    ...
    private static final class Immutable extends OwnsRisk_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see OwnsRisk_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRisk_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static OwnsRisk_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRisk_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRisk_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRisk_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<OwnsRisk_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<OwnsRisk_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super OwnsRisk_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public OwnsRisk_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return OwnsRisk_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRisk_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRisk_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final OwnsRisk_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final OwnsRisk_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected OwnsRisk_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRisk_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsRisk_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRisk_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRisk_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRisk_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRisk_targetPropertyPath.Matcher> querySpecification() {
      return OwnsRisk_targetPropertyPath.instance();
    }
  }
  
  private OwnsRisk_targetPropertyPath() {
   ...
   * 
   */
  public static OwnsRisk_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected OwnsRisk_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRisk_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public OwnsRisk_targetPropertyPath.Matcher instantiate() {
    return OwnsRisk_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public OwnsRisk_targetPropertyPath.Match newEmptyMatch() {
    return OwnsRisk_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRisk_targetPropertyPath.Match newMatch(final Object... parameters) {
    return OwnsRisk_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRisk_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRisk_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRisk_targetPropertyPath INSTANCE = new OwnsRisk_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRisk_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
