...
public final class BasicInterval extends BaseGeneratedEMFQuerySpecification<BasicInterval.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static BasicInterval.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static BasicInterval.Match newMatch(final Property pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<BasicInterval.Match> {
     ...
     * 
     */
    public Collection<BasicInterval.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<BasicInterval.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<BasicInterval.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super BasicInterval.Match> processor) {
     ...
     * 
     */
    public BasicInterval.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return BasicInterval.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final BasicInterval.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final BasicInterval.Match partialMatch) {
    ...
    protected BasicInterval.Match tupleToMatch(final Tuple t) {
      try {
          return BasicInterval.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected BasicInterval.Match arrayToMatch(final Object[] match) {
      try {
          return BasicInterval.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected BasicInterval.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BasicInterval.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public BasicInterval.Match newMatch(final Object... parameters) {
    return BasicInterval.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
