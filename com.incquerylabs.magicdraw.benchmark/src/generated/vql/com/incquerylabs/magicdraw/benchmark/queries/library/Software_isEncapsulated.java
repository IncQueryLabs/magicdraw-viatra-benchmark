...
public final class Software_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Software_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Software_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Software_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_isEncapsulated.Match)) {
          Software_isEncapsulated.Match other = (Software_isEncapsulated.Match) obj;
    ...
    @Override
    public Software_isEncapsulated specification() {
      return Software_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Software_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Software_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Software_isEncapsulated.Match {
    ...
    private static final class Immutable extends Software_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Software_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Software_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Software_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Software_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Software_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Software_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Software_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Software_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Software_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Software_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Software_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Software_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Software_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Software_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Software_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_isEncapsulated.Matcher> querySpecification() {
      return Software_isEncapsulated.instance();
    }
  }
  
  private Software_isEncapsulated() {
   ...
   * 
   */
  public static Software_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Software_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Software_isEncapsulated.Matcher instantiate() {
    return Software_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Software_isEncapsulated.Match newEmptyMatch() {
    return Software_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Software_isEncapsulated.Match newMatch(final Object... parameters) {
    return Software_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_isEncapsulated INSTANCE = new Software_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
