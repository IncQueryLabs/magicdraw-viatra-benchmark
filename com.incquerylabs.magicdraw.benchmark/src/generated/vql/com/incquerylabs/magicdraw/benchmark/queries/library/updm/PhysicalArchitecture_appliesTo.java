...
public final class PhysicalArchitecture_appliesTo extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_appliesTo.Match)) {
          PhysicalArchitecture_appliesTo.Match other = (PhysicalArchitecture_appliesTo.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_appliesTo specification() {
      return PhysicalArchitecture_appliesTo.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_appliesTo.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_appliesTo.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_appliesTo.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_appliesTo.Matcher> querySpecification() {
      return PhysicalArchitecture_appliesTo.instance();
    }
  }
  
  private PhysicalArchitecture_appliesTo() {
   ...
   * 
   */
  public static PhysicalArchitecture_appliesTo instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_appliesTo.Matcher instantiate() {
    return PhysicalArchitecture_appliesTo.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_appliesTo.Match newEmptyMatch() {
    return PhysicalArchitecture_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_appliesTo.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_appliesTo INSTANCE = new PhysicalArchitecture_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
