...
public final class OwnsRisk_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<OwnsRisk_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRisk_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRisk_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRisk_sourcePropertyPath.Match)) {
          OwnsRisk_sourcePropertyPath.Match other = (OwnsRisk_sourcePropertyPath.Match) obj;
    ...
    @Override
    public OwnsRisk_sourcePropertyPath specification() {
      return OwnsRisk_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static OwnsRisk_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRisk_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static OwnsRisk_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsRisk_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends OwnsRisk_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see OwnsRisk_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRisk_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static OwnsRisk_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRisk_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRisk_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRisk_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<OwnsRisk_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<OwnsRisk_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super OwnsRisk_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public OwnsRisk_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return OwnsRisk_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRisk_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRisk_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final OwnsRisk_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final OwnsRisk_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected OwnsRisk_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRisk_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsRisk_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRisk_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRisk_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRisk_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRisk_sourcePropertyPath.Matcher> querySpecification() {
      return OwnsRisk_sourcePropertyPath.instance();
    }
  }
  
  private OwnsRisk_sourcePropertyPath() {
   ...
   * 
   */
  public static OwnsRisk_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected OwnsRisk_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRisk_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public OwnsRisk_sourcePropertyPath.Matcher instantiate() {
    return OwnsRisk_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public OwnsRisk_sourcePropertyPath.Match newEmptyMatch() {
    return OwnsRisk_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRisk_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return OwnsRisk_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRisk_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRisk_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRisk_sourcePropertyPath INSTANCE = new OwnsRisk_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRisk_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
