...
public final class ResourceArchitecture extends BaseGeneratedEMFQuerySpecification<ResourceArchitecture.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArchitecture.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArchitecture.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArchitecture.Match)) {
          ResourceArchitecture.Match other = (ResourceArchitecture.Match) obj;
    ...
    @Override
    public ResourceArchitecture specification() {
      return ResourceArchitecture.instance();
    }
     ...
     * 
     */
    public static ResourceArchitecture.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArchitecture.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResourceArchitecture.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResourceArchitecture.Match {
    ...
    private static final class Immutable extends ResourceArchitecture.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture pattern,
   ...
   * 
   * @see Match
   * @see ResourceArchitecture
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArchitecture.Match> {
    /**
     ...
     * 
     */
    public static ResourceArchitecture.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArchitecture.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArchitecture.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArchitecture.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResourceArchitecture.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResourceArchitecture.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResourceArchitecture.Match> processor) {
     ...
     * 
     */
    public ResourceArchitecture.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResourceArchitecture.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResourceArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResourceArchitecture.Match partialMatch) {
    ...
    @Override
    protected ResourceArchitecture.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResourceArchitecture.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArchitecture.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArchitecture.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArchitecture.Matcher> querySpecification() {
      return ResourceArchitecture.instance();
    }
  }
  
  private ResourceArchitecture() {
   ...
   * 
   */
  public static ResourceArchitecture instance() {
    try{
  ...
  @Override
  protected ResourceArchitecture.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArchitecture.Matcher.on(engine);
  }
  
  @Override
  public ResourceArchitecture.Matcher instantiate() {
    return ResourceArchitecture.Matcher.create();
  }
  
  @Override
  public ResourceArchitecture.Match newEmptyMatch() {
    return ResourceArchitecture.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArchitecture.Match newMatch(final Object... parameters) {
    return ResourceArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArchitecture} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArchitecture#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArchitecture INSTANCE = new ResourceArchitecture();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArchitecture.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ResourceArchitecture")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ResourceArchitecture");
