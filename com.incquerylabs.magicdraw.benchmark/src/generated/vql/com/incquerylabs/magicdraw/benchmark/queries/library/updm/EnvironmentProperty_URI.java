...
public final class EnvironmentProperty_URI extends BaseGeneratedEMFQuerySpecification<EnvironmentProperty_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnvironmentProperty_URI.Match.parameterNames;
    }
    ...
    @Override
    public EnvironmentProperty_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnvironmentProperty_URI.Match)) {
          EnvironmentProperty_URI.Match other = (EnvironmentProperty_URI.Match) obj;
    ...
    @Override
    public EnvironmentProperty_URI specification() {
      return EnvironmentProperty_URI.instance();
    }
     ...
     * 
     */
    public static EnvironmentProperty_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnvironmentProperty_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnvironmentProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnvironmentProperty_URI.Match {
    ...
    private static final class Immutable extends EnvironmentProperty_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_URI pattern,
   ...
   * 
   * @see Match
   * @see EnvironmentProperty_URI
   * 
   */
  public static class Matcher extends BaseMatcher<EnvironmentProperty_URI.Match> {
    /**
     ...
     * 
     */
    public static EnvironmentProperty_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnvironmentProperty_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnvironmentProperty_URI.Matcher.class);
     ...
     * 
     */
    public Collection<EnvironmentProperty_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnvironmentProperty_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnvironmentProperty_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super EnvironmentProperty_URI.Match> processor) {
     ...
     * 
     */
    public EnvironmentProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return EnvironmentProperty_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EnvironmentProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EnvironmentProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnvironmentProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnvironmentProperty_URI.Match partialMatch) {
    ...
    @Override
    protected EnvironmentProperty_URI.Match tupleToMatch(final Tuple t) {
      try {
          return EnvironmentProperty_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnvironmentProperty_URI.Match arrayToMatch(final Object[] match) {
      try {
          return EnvironmentProperty_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnvironmentProperty_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnvironmentProperty_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnvironmentProperty_URI.Matcher> querySpecification() {
      return EnvironmentProperty_URI.instance();
    }
  }
  
  private EnvironmentProperty_URI() {
   ...
   * 
   */
  public static EnvironmentProperty_URI instance() {
    try{
  ...
  @Override
  protected EnvironmentProperty_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnvironmentProperty_URI.Matcher.on(engine);
  }
  
  @Override
  public EnvironmentProperty_URI.Matcher instantiate() {
    return EnvironmentProperty_URI.Matcher.create();
  }
  
  @Override
  public EnvironmentProperty_URI.Match newEmptyMatch() {
    return EnvironmentProperty_URI.Match.newEmptyMatch();
  }
  
  @Override
  public EnvironmentProperty_URI.Match newMatch(final Object... parameters) {
    return EnvironmentProperty_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnvironmentProperty_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnvironmentProperty_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnvironmentProperty_URI INSTANCE = new EnvironmentProperty_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnvironmentProperty_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
