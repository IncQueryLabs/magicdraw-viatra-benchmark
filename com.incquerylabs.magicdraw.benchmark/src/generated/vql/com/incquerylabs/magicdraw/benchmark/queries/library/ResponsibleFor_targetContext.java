...
public final class ResponsibleFor_targetContext extends BaseGeneratedEMFQuerySpecification<ResponsibleFor_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResponsibleFor_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public ResponsibleFor_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResponsibleFor_targetContext.Match)) {
          ResponsibleFor_targetContext.Match other = (ResponsibleFor_targetContext.Match) obj;
    ...
    @Override
    public ResponsibleFor_targetContext specification() {
      return ResponsibleFor_targetContext.instance();
    }
     ...
     * 
     */
    public static ResponsibleFor_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResponsibleFor_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static ResponsibleFor_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResponsibleFor_targetContext.Match {
    ...
    private static final class Immutable extends ResponsibleFor_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_targetContext pattern,
   ...
   * 
   * @see Match
   * @see ResponsibleFor_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<ResponsibleFor_targetContext.Match> {
    /**
     ...
     * 
     */
    public static ResponsibleFor_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResponsibleFor_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResponsibleFor_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<ResponsibleFor_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<ResponsibleFor_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<ResponsibleFor_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super ResponsibleFor_targetContext.Match> processor) {
     ...
     * 
     */
    public ResponsibleFor_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return ResponsibleFor_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final ResponsibleFor_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final ResponsibleFor_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final ResponsibleFor_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final ResponsibleFor_targetContext.Match partialMatch) {
    ...
    @Override
    protected ResponsibleFor_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return ResponsibleFor_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResponsibleFor_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return ResponsibleFor_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResponsibleFor_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResponsibleFor_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResponsibleFor_targetContext.Matcher> querySpecification() {
      return ResponsibleFor_targetContext.instance();
    }
  }
  
  private ResponsibleFor_targetContext() {
   ...
   * 
   */
  public static ResponsibleFor_targetContext instance() {
    try{
  ...
  @Override
  protected ResponsibleFor_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResponsibleFor_targetContext.Matcher.on(engine);
  }
  
  @Override
  public ResponsibleFor_targetContext.Matcher instantiate() {
    return ResponsibleFor_targetContext.Matcher.create();
  }
  
  @Override
  public ResponsibleFor_targetContext.Match newEmptyMatch() {
    return ResponsibleFor_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public ResponsibleFor_targetContext.Match newMatch(final Object... parameters) {
    return ResponsibleFor_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResponsibleFor_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResponsibleFor_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResponsibleFor_targetContext INSTANCE = new ResponsibleFor_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResponsibleFor_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
