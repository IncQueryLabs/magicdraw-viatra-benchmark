...
import com.incquerylabs.magicdraw.benchmark.queries.library.DataElement;
...
public final class DataElement_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<DataElement_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return DataElement_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public DataElement_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DataElement_categoryCategorizesAsset.Match)) {
          DataElement_categoryCategorizesAsset.Match other = (DataElement_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public DataElement_categoryCategorizesAsset specification() {
      return DataElement_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static DataElement_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static DataElement_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static DataElement_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DataElement_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends DataElement_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see DataElement_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<DataElement_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static DataElement_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DataElement_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DataElement_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<DataElement_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<DataElement_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<DataElement_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super DataElement_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public DataElement_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return DataElement_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DataElement_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DataElement_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final DataElement_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final DataElement_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected DataElement_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return DataElement_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected DataElement_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return DataElement_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DataElement_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DataElement_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DataElement_categoryCategorizesAsset.Matcher> querySpecification() {
      return DataElement_categoryCategorizesAsset.instance();
    }
  }
  
  private DataElement_categoryCategorizesAsset() {
   ...
   * 
   */
  public static DataElement_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected DataElement_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return DataElement_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public DataElement_categoryCategorizesAsset.Matcher instantiate() {
    return DataElement_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public DataElement_categoryCategorizesAsset.Match newEmptyMatch() {
    return DataElement_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public DataElement_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return DataElement_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataElement_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataElement_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DataElement_categoryCategorizesAsset INSTANCE = new DataElement_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DataElement_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find DataElement(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), DataElement.instance().getInternalQueryRepresentation());
