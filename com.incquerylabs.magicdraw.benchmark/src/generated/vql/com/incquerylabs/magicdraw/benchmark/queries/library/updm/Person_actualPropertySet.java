...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person;
...
public final class Person_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Person_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Person_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_actualPropertySet.Match)) {
          Person_actualPropertySet.Match other = (Person_actualPropertySet.Match) obj;
    ...
    @Override
    public Person_actualPropertySet specification() {
      return Person_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Person_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Person_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Person_actualPropertySet.Match {
    ...
    private static final class Immutable extends Person_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Person_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Person_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Person_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Person_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Person_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Person_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Person_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Person_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Person_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Person_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Person_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Person_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Person_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Person_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Person_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_actualPropertySet.Matcher> querySpecification() {
      return Person_actualPropertySet.instance();
    }
  }
  
  private Person_actualPropertySet() {
   ...
   * 
   */
  public static Person_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Person_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Person_actualPropertySet.Matcher instantiate() {
    return Person_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Person_actualPropertySet.Match newEmptyMatch() {
    return Person_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Person_actualPropertySet.Match newMatch(final Object... parameters) {
    return Person_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_actualPropertySet INSTANCE = new Person_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
