...
public final class Organization_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Organization_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Organization_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_endBoundaryType.Match)) {
          Organization_endBoundaryType.Match other = (Organization_endBoundaryType.Match) obj;
    ...
    @Override
    public Organization_endBoundaryType specification() {
      return Organization_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Organization_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_endBoundaryType.Match {
    ...
    private static final class Immutable extends Organization_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Organization_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Organization_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Organization_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Organization_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_endBoundaryType.Matcher> querySpecification() {
      return Organization_endBoundaryType.instance();
    }
  }
  
  private Organization_endBoundaryType() {
   ...
   * 
   */
  public static Organization_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Organization_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Organization_endBoundaryType.Matcher instantiate() {
    return Organization_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Organization_endBoundaryType.Match newEmptyMatch() {
    return Organization_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_endBoundaryType.Match newMatch(final Object... parameters) {
    return Organization_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_endBoundaryType INSTANCE = new Organization_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
