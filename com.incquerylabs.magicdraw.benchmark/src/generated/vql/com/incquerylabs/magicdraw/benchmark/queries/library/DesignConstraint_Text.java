...
public final class DesignConstraint_Text extends BaseGeneratedEMFQuerySpecification<DesignConstraint_Text.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint_Text.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint_Text.Match)) {
          DesignConstraint_Text.Match other = (DesignConstraint_Text.Match) obj;
    ...
    @Override
    public DesignConstraint_Text specification() {
     ...
     * 
     */
    public static DesignConstraint_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static DesignConstraint_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends DesignConstraint_Text.Match {
    ...
    private static final class Immutable extends DesignConstraint_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_Text pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint_Text
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint_Text.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint_Text.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<DesignConstraint_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<DesignConstraint_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super DesignConstraint_Text.Match> processor) {
     ...
     * 
     */
    public DesignConstraint_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return DesignConstraint_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DesignConstraint_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DesignConstraint_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final DesignConstraint_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final DesignConstraint_Text.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint_Text.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected DesignConstraint_Text.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint_Text.Matcher> querySpecification() {
      return DesignConstraint_Text.instance();
    }
  }
  
  private DesignConstraint_Text() {
   ...
   * 
   */
  public static DesignConstraint_Text instance() {
    try{
  ...
  @Override
  protected DesignConstraint_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint_Text.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint_Text.Matcher instantiate() {
    return DesignConstraint_Text.Matcher.create();
  }
  
  @Override
  public DesignConstraint_Text.Match newEmptyMatch() {
    return DesignConstraint_Text.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint_Text.Match newMatch(final Object... parameters) {
    return DesignConstraint_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DesignConstraint_Text} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DesignConstraint_Text#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesignConstraint_Text INSTANCE = new DesignConstraint_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
