...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration;
...
public final class WholeLifeConfiguration_actualPropertySet extends BaseGeneratedEMFQuerySpecification<WholeLifeConfiguration_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeConfiguration_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeConfiguration_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeConfiguration_actualPropertySet.Match)) {
          WholeLifeConfiguration_actualPropertySet.Match other = (WholeLifeConfiguration_actualPropertySet.Match) obj;
    ...
    @Override
    public WholeLifeConfiguration_actualPropertySet specification() {
      return WholeLifeConfiguration_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static WholeLifeConfiguration_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeConfiguration_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeConfiguration_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeConfiguration_actualPropertySet.Match {
    ...
    private static final class Immutable extends WholeLifeConfiguration_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeConfiguration_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeConfiguration_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeConfiguration_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeConfiguration_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeConfiguration_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeConfiguration_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeConfiguration_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeConfiguration_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeConfiguration_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public WholeLifeConfiguration_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeConfiguration_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeConfiguration_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeConfiguration_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeConfiguration_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeConfiguration_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected WholeLifeConfiguration_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeConfiguration_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeConfiguration_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeConfiguration_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeConfiguration_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeConfiguration_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeConfiguration_actualPropertySet.Matcher> querySpecification() {
      return WholeLifeConfiguration_actualPropertySet.instance();
    }
  }
  
  private WholeLifeConfiguration_actualPropertySet() {
   ...
   * 
   */
  public static WholeLifeConfiguration_actualPropertySet instance() {
    try{
  ...
  @Override
  protected WholeLifeConfiguration_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeConfiguration_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeConfiguration_actualPropertySet.Matcher instantiate() {
    return WholeLifeConfiguration_actualPropertySet.Matcher.create();
  }
  
  @Override
  public WholeLifeConfiguration_actualPropertySet.Match newEmptyMatch() {
    return WholeLifeConfiguration_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeConfiguration_actualPropertySet.Match newMatch(final Object... parameters) {
    return WholeLifeConfiguration_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeConfiguration_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeConfiguration_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeConfiguration_actualPropertySet INSTANCE = new WholeLifeConfiguration_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeConfiguration_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
