...
public final class Standard_conformsTo extends BaseGeneratedEMFQuerySpecification<Standard_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Standard_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_conformsTo.Match)) {
          Standard_conformsTo.Match other = (Standard_conformsTo.Match) obj;
    ...
    @Override
    public Standard_conformsTo specification() {
      return Standard_conformsTo.instance();
    }
     ...
     * 
     */
    public static Standard_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static Standard_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Standard_conformsTo.Match {
    ...
    private static final class Immutable extends Standard_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Standard_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Standard_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<Standard_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<Standard_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super Standard_conformsTo.Match> processor) {
     ...
     * 
     */
    public Standard_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return Standard_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfvalue(final Standard_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfvalue(final Standard_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Standard_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    @Override
    protected Standard_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_conformsTo.Matcher> querySpecification() {
      return Standard_conformsTo.instance();
    }
  }
  
  private Standard_conformsTo() {
   ...
   * 
   */
  public static Standard_conformsTo instance() {
    try{
  ...
  @Override
  protected Standard_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Standard_conformsTo.Matcher instantiate() {
    return Standard_conformsTo.Matcher.create();
  }
  
  @Override
  public Standard_conformsTo.Match newEmptyMatch() {
    return Standard_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_conformsTo.Match newMatch(final Object... parameters) {
    return Standard_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_conformsTo INSTANCE = new Standard_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
