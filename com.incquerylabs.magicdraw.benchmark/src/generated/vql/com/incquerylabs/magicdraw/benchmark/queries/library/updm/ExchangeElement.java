...
public final class ExchangeElement extends BaseGeneratedEMFQuerySpecification<ExchangeElement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement.Match)) {
          ExchangeElement.Match other = (ExchangeElement.Match) obj;
    ...
    @Override
    public ExchangeElement specification() {
      return ExchangeElement.instance();
    }
     ...
     * 
     */
    public static ExchangeElement.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ExchangeElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ExchangeElement.Match {
    ...
    private static final class Immutable extends ExchangeElement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ExchangeElement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ExchangeElement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ExchangeElement.Match> processor) {
     ...
     * 
     */
    public ExchangeElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ExchangeElement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ExchangeElement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ExchangeElement.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ExchangeElement.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement.Matcher> querySpecification() {
      return ExchangeElement.instance();
    }
  }
  
  private ExchangeElement() {
   ...
   * 
   */
  public static ExchangeElement instance() {
    try{
  ...
  @Override
  protected ExchangeElement.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement.Matcher instantiate() {
    return ExchangeElement.Matcher.create();
  }
  
  @Override
  public ExchangeElement.Match newEmptyMatch() {
    return ExchangeElement.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement.Match newMatch(final Object... parameters) {
    return ExchangeElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement INSTANCE = new ExchangeElement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ExchangeElement");
