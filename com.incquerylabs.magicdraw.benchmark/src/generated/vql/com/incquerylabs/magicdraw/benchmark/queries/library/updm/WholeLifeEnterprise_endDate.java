...
public final class WholeLifeEnterprise_endDate extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_endDate.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_endDate.Match)) {
          WholeLifeEnterprise_endDate.Match other = (WholeLifeEnterprise_endDate.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_endDate specification() {
      return WholeLifeEnterprise_endDate.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_endDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_endDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_endDate.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_endDate pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_endDate.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_endDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_endDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_endDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_endDate.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_endDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_endDate.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_endDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_endDate.Matcher> querySpecification() {
      return WholeLifeEnterprise_endDate.instance();
    }
  }
  
  private WholeLifeEnterprise_endDate() {
   ...
   * 
   */
  public static WholeLifeEnterprise_endDate instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_endDate.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_endDate.Matcher instantiate() {
    return WholeLifeEnterprise_endDate.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_endDate.Match newEmptyMatch() {
    return WholeLifeEnterprise_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_endDate.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_endDate INSTANCE = new WholeLifeEnterprise_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
