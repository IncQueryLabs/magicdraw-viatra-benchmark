...
public final class Post_physicalLocation extends BaseGeneratedEMFQuerySpecification<Post_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Post_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_physicalLocation.Match)) {
          Post_physicalLocation.Match other = (Post_physicalLocation.Match) obj;
    ...
    @Override
    public Post_physicalLocation specification() {
      return Post_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Post_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_physicalLocation.Match {
    ...
    private static final class Immutable extends Post_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Post_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Post_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Post_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Post_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Post_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Post_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Post_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Post_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_physicalLocation.Matcher> querySpecification() {
      return Post_physicalLocation.instance();
    }
  }
  
  private Post_physicalLocation() {
   ...
   * 
   */
  public static Post_physicalLocation instance() {
    try{
  ...
  @Override
  protected Post_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Post_physicalLocation.Matcher instantiate() {
    return Post_physicalLocation.Matcher.create();
  }
  
  @Override
  public Post_physicalLocation.Match newEmptyMatch() {
    return Post_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Post_physicalLocation.Match newMatch(final Object... parameters) {
    return Post_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_physicalLocation INSTANCE = new Post_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
