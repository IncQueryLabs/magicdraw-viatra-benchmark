...
public final class ResourceArtifact_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_startBoundaryType.Match)) {
          ResourceArtifact_startBoundaryType.Match other = (ResourceArtifact_startBoundaryType.Match) obj;
    ...
    @Override
    public ResourceArtifact_startBoundaryType specification() {
      return ResourceArtifact_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_startBoundaryType.Match {
    ...
    private static final class Immutable extends ResourceArtifact_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_startBoundaryType.Matcher> querySpecification() {
      return ResourceArtifact_startBoundaryType.instance();
    }
  }
  
  private ResourceArtifact_startBoundaryType() {
   ...
   * 
   */
  public static ResourceArtifact_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_startBoundaryType.Matcher instantiate() {
    return ResourceArtifact_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_startBoundaryType.Match newEmptyMatch() {
    return ResourceArtifact_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_startBoundaryType.Match newMatch(final Object... parameters) {
    return ResourceArtifact_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_startBoundaryType INSTANCE = new ResourceArtifact_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
