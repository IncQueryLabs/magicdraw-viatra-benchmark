...
public final class Participant_physicalLocation extends BaseGeneratedEMFQuerySpecification<Participant_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Participant_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_physicalLocation.Match)) {
          Participant_physicalLocation.Match other = (Participant_physicalLocation.Match) obj;
    ...
    @Override
    public Participant_physicalLocation specification() {
      return Participant_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Participant_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Participant_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Participant_physicalLocation.Match {
    ...
    private static final class Immutable extends Participant_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Participant_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Participant_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Participant_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Participant_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Participant_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Participant_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Participant_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Participant_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Participant_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Participant_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Participant_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_physicalLocation.Matcher> querySpecification() {
      return Participant_physicalLocation.instance();
    }
  }
  
  private Participant_physicalLocation() {
   ...
   * 
   */
  public static Participant_physicalLocation instance() {
    try{
  ...
  @Override
  protected Participant_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Participant_physicalLocation.Matcher instantiate() {
    return Participant_physicalLocation.Matcher.create();
  }
  
  @Override
  public Participant_physicalLocation.Match newEmptyMatch() {
    return Participant_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_physicalLocation.Match newMatch(final Object... parameters) {
    return Participant_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_physicalLocation INSTANCE = new Participant_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
