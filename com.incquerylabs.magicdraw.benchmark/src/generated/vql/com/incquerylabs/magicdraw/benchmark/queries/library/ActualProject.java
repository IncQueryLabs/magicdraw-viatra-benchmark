...
public final class ActualProject extends BaseGeneratedEMFQuerySpecification<ActualProject.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProject pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualProject";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProject.Match.parameterNames;
    }
    ...
    @Override
    public ActualProject.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProject.Match)) {
          ActualProject.Match other = (ActualProject.Match) obj;
    ...
    @Override
    public ActualProject specification() {
      return ActualProject.instance();
    }
     ...
     * 
     */
    public static ActualProject.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProject.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualProject.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualProject.Match {
    ...
    private static final class Immutable extends ActualProject.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProject pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProject.Match> {
    /**
     ...
     * 
     */
    public static ActualProject.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProject.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProject.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProject.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualProject.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualProject.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualProject.Match> processor) {
     ...
     * 
     */
    public ActualProject.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualProject.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualProject.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualProject.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualProject.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualProject.Match partialMatch) {
    ...
    @Override
    protected ActualProject.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProject.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualProject.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProject.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProject.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProject.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProject.Matcher> querySpecification() {
      return ActualProject.instance();
    }
  }
   ...
   * 
   */
  public static ActualProject instance() {
    try{
  ...
  @Override
  protected ActualProject.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProject.Matcher.on(engine);
  }
  
  @Override
  public ActualProject.Matcher instantiate() {
    return ActualProject.Matcher.create();
  }
  
  @Override
  public ActualProject.Match newEmptyMatch() {
    return ActualProject.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProject.Match newMatch(final Object... parameters) {
    return ActualProject.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProject} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProject#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProject INSTANCE = new ActualProject();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProject.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualProject")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualProject");
