...
public final class ActualOrganizationRole_startDate extends BaseGeneratedEMFQuerySpecification<ActualOrganizationRole_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualOrganizationRole_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualOrganizationRole_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualOrganizationRole_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualOrganizationRole_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualOrganizationRole_startDate.Match)) {
          ActualOrganizationRole_startDate.Match other = (ActualOrganizationRole_startDate.Match) obj;
    ...
    @Override
    public ActualOrganizationRole_startDate specification() {
      return ActualOrganizationRole_startDate.instance();
    }
     ...
     * 
     */
    public static ActualOrganizationRole_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualOrganizationRole_startDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualOrganizationRole_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualOrganizationRole_startDate.Match {
    ...
    private static final class Immutable extends ActualOrganizationRole_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualOrganizationRole_startDate pattern,
   ...
   * 
   * @see Match
   * @see ActualOrganizationRole_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualOrganizationRole_startDate.Match> {
    /**
     ...
     * 
     */
    public static ActualOrganizationRole_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualOrganizationRole_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualOrganizationRole_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualOrganizationRole_startDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualOrganizationRole_startDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualOrganizationRole_startDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualOrganizationRole_startDate.Match> processor) {
     ...
     * 
     */
    public ActualOrganizationRole_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualOrganizationRole_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualOrganizationRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualOrganizationRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualOrganizationRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualOrganizationRole_startDate.Match partialMatch) {
    ...
    @Override
    protected ActualOrganizationRole_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualOrganizationRole_startDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualOrganizationRole_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualOrganizationRole_startDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualOrganizationRole_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualOrganizationRole_startDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualOrganizationRole_startDate.Matcher> querySpecification() {
      return ActualOrganizationRole_startDate.instance();
    }
  }
  
  private ActualOrganizationRole_startDate() {
   ...
   * 
   */
  public static ActualOrganizationRole_startDate instance() {
    try{
  ...
  @Override
  protected ActualOrganizationRole_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualOrganizationRole_startDate.Matcher.on(engine);
  }
  
  @Override
  public ActualOrganizationRole_startDate.Matcher instantiate() {
    return ActualOrganizationRole_startDate.Matcher.create();
  }
  
  @Override
  public ActualOrganizationRole_startDate.Match newEmptyMatch() {
    return ActualOrganizationRole_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualOrganizationRole_startDate.Match newMatch(final Object... parameters) {
    return ActualOrganizationRole_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualOrganizationRole_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualOrganizationRole_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualOrganizationRole_startDate INSTANCE = new ActualOrganizationRole_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualOrganizationRole_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
