...
public final class ActualMeasurementSet_endDate extends BaseGeneratedEMFQuerySpecification<ActualMeasurementSet_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualMeasurementSet_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualMeasurementSet_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualMeasurementSet_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualMeasurementSet_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualMeasurementSet_endDate.Match)) {
          ActualMeasurementSet_endDate.Match other = (ActualMeasurementSet_endDate.Match) obj;
    ...
    @Override
    public ActualMeasurementSet_endDate specification() {
      return ActualMeasurementSet_endDate.instance();
    }
     ...
     * 
     */
    public static ActualMeasurementSet_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualMeasurementSet_endDate.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public static ActualMeasurementSet_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualMeasurementSet_endDate.Match {
    ...
    private static final class Immutable extends ActualMeasurementSet_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualMeasurementSet_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualMeasurementSet_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualMeasurementSet_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualMeasurementSet_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualMeasurementSet_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualMeasurementSet_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualMeasurementSet_endDate.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Stream<ActualMeasurementSet_endDate.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Optional<ActualMeasurementSet_endDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue, final Consumer<? super ActualMeasurementSet_endDate.Match> processor) {
     ...
     * 
     */
    public ActualMeasurementSet_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return ActualMeasurementSet_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualMeasurementSet_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualMeasurementSet_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvalue(final ActualMeasurementSet_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvalue(final ActualMeasurementSet_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualMeasurementSet_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualMeasurementSet_endDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualMeasurementSet_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualMeasurementSet_endDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualMeasurementSet_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualMeasurementSet_endDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualMeasurementSet_endDate.Matcher> querySpecification() {
      return ActualMeasurementSet_endDate.instance();
    }
  }
  
  private ActualMeasurementSet_endDate() {
   ...
   * 
   */
  public static ActualMeasurementSet_endDate instance() {
    try{
  ...
  @Override
  protected ActualMeasurementSet_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualMeasurementSet_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualMeasurementSet_endDate.Matcher instantiate() {
    return ActualMeasurementSet_endDate.Matcher.create();
  }
  
  @Override
  public ActualMeasurementSet_endDate.Match newEmptyMatch() {
    return ActualMeasurementSet_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualMeasurementSet_endDate.Match newMatch(final Object... parameters) {
    return ActualMeasurementSet_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualMeasurementSet_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualMeasurementSet_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualMeasurementSet_endDate INSTANCE = new ActualMeasurementSet_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualMeasurementSet_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
