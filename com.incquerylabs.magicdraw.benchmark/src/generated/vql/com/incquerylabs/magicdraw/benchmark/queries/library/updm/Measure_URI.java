...
public final class Measure_URI extends BaseGeneratedEMFQuerySpecification<Measure_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measure_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measure_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measure_URI.Match.parameterNames;
    }
    ...
    @Override
    public Measure_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measure_URI.Match)) {
          Measure_URI.Match other = (Measure_URI.Match) obj;
    ...
    @Override
    public Measure_URI specification() {
      return Measure_URI.instance();
    }
     ...
     * 
     */
    public static Measure_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measure_URI.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Measure_URI.Match newMatch(final InstanceSpecification pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Measure_URI.Match {
    ...
    private static final class Immutable extends Measure_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measure_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Measure_URI.Match> {
    /**
     ...
     * 
     */
    public static Measure_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measure_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measure_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Measure_URI.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Measure_URI.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Measure_URI.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValuespec, final Consumer<? super Measure_URI.Match> processor) {
     ...
     * 
     */
    public Measure_URI.Match newMatch(final InstanceSpecification pElement, final LiteralString pValuespec) {
      return Measure_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Measure_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Measure_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Measure_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Measure_URI.Match partialMatch) {
    ...
    @Override
    protected Measure_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Measure_URI.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Measure_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Measure_URI.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measure_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measure_URI.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measure_URI.Matcher> querySpecification() {
      return Measure_URI.instance();
    }
  }
   ...
   * 
   */
  public static Measure_URI instance() {
    try{
  ...
  @Override
  protected Measure_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measure_URI.Matcher.on(engine);
  }
  
  @Override
  public Measure_URI.Matcher instantiate() {
    return Measure_URI.Matcher.create();
  }
  
  @Override
  public Measure_URI.Match newEmptyMatch() {
    return Measure_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Measure_URI.Match newMatch(final Object... parameters) {
    return Measure_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measure_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measure_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Measure_URI INSTANCE = new Measure_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measure_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
