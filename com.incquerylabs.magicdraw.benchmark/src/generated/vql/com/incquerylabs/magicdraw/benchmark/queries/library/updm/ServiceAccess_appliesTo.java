...
public final class ServiceAccess_appliesTo extends BaseGeneratedEMFQuerySpecification<ServiceAccess_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_appliesTo.Match)) {
          ServiceAccess_appliesTo.Match other = (ServiceAccess_appliesTo.Match) obj;
    ...
    @Override
    public ServiceAccess_appliesTo specification() {
      return ServiceAccess_appliesTo.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_appliesTo.Match {
    ...
    private static final class Immutable extends ServiceAccess_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_appliesTo.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_appliesTo.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_appliesTo.Matcher> querySpecification() {
      return ServiceAccess_appliesTo.instance();
    }
  }
  
  private ServiceAccess_appliesTo() {
   ...
   * 
   */
  public static ServiceAccess_appliesTo instance() {
    try{
  ...
  @Override
  protected ServiceAccess_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_appliesTo.Matcher instantiate() {
    return ServiceAccess_appliesTo.Matcher.create();
  }
  
  @Override
  public ServiceAccess_appliesTo.Match newEmptyMatch() {
    return ServiceAccess_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_appliesTo.Match newMatch(final Object... parameters) {
    return ServiceAccess_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_appliesTo INSTANCE = new ServiceAccess_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
