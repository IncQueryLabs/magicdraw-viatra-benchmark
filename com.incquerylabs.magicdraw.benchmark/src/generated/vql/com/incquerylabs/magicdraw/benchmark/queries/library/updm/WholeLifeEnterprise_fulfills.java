...
public final class WholeLifeEnterprise_fulfills extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_fulfills.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_fulfills pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_fulfills";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_fulfills.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_fulfills.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_fulfills.Match)) {
          WholeLifeEnterprise_fulfills.Match other = (WholeLifeEnterprise_fulfills.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_fulfills specification() {
      return WholeLifeEnterprise_fulfills.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_fulfills.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_fulfills.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_fulfills.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_fulfills.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_fulfills.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_fulfills pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_fulfills
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_fulfills.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_fulfills.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_fulfills.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_fulfills.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_fulfills.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_fulfills.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_fulfills.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_fulfills.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_fulfills.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_fulfills.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_fulfills.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_fulfills.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_fulfills.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_fulfills.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_fulfills.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_fulfills.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_fulfills.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_fulfills.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_fulfills.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_fulfills.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_fulfills.Matcher> querySpecification() {
      return WholeLifeEnterprise_fulfills.instance();
    }
  }
  
  private WholeLifeEnterprise_fulfills() {
   ...
   * 
   */
  public static WholeLifeEnterprise_fulfills instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_fulfills.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_fulfills.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_fulfills.Matcher instantiate() {
    return WholeLifeEnterprise_fulfills.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_fulfills.Match newEmptyMatch() {
    return WholeLifeEnterprise_fulfills.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_fulfills.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_fulfills.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_fulfills} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_fulfills#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_fulfills INSTANCE = new WholeLifeEnterprise_fulfills();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_fulfills.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "fulfills");
