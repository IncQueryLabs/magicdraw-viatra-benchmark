...
public final class ActualLocation_startDate extends BaseGeneratedEMFQuerySpecification<ActualLocation_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualLocation_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualLocation_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualLocation_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualLocation_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualLocation_startDate.Match)) {
          ActualLocation_startDate.Match other = (ActualLocation_startDate.Match) obj;
    ...
    @Override
    public ActualLocation_startDate specification() {
      return ActualLocation_startDate.instance();
    }
     ...
     * 
     */
    public static ActualLocation_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualLocation_startDate.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public static ActualLocation_startDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualLocation_startDate.Match {
    ...
    private static final class Immutable extends ActualLocation_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualLocation_startDate pattern,
   ...
   * 
   * @see Match
   * @see ActualLocation_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualLocation_startDate.Match> {
    /**
     ...
     * 
     */
    public static ActualLocation_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualLocation_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualLocation_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualLocation_startDate.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Stream<ActualLocation_startDate.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Optional<ActualLocation_startDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue, final Consumer<? super ActualLocation_startDate.Match> processor) {
     ...
     * 
     */
    public ActualLocation_startDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return ActualLocation_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualLocation_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualLocation_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvalue(final ActualLocation_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvalue(final ActualLocation_startDate.Match partialMatch) {
    ...
    @Override
    protected ActualLocation_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualLocation_startDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualLocation_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualLocation_startDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualLocation_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualLocation_startDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualLocation_startDate.Matcher> querySpecification() {
      return ActualLocation_startDate.instance();
    }
  }
  
  private ActualLocation_startDate() {
   ...
   * 
   */
  public static ActualLocation_startDate instance() {
    try{
  ...
  @Override
  protected ActualLocation_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualLocation_startDate.Matcher.on(engine);
  }
  
  @Override
  public ActualLocation_startDate.Matcher instantiate() {
    return ActualLocation_startDate.Matcher.create();
  }
  
  @Override
  public ActualLocation_startDate.Match newEmptyMatch() {
    return ActualLocation_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualLocation_startDate.Match newMatch(final Object... parameters) {
    return ActualLocation_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualLocation_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualLocation_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualLocation_startDate INSTANCE = new ActualLocation_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualLocation_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
