...
public final class OwnsProcess_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<OwnsProcess_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsProcess_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public OwnsProcess_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsProcess_targetPropertyPath.Match)) {
          OwnsProcess_targetPropertyPath.Match other = (OwnsProcess_targetPropertyPath.Match) obj;
    ...
    @Override
    public OwnsProcess_targetPropertyPath specification() {
      return OwnsProcess_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static OwnsProcess_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsProcess_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static OwnsProcess_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsProcess_targetPropertyPath.Match {
    ...
    private static final class Immutable extends OwnsProcess_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see OwnsProcess_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsProcess_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static OwnsProcess_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsProcess_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsProcess_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsProcess_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<OwnsProcess_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<OwnsProcess_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super OwnsProcess_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public OwnsProcess_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return OwnsProcess_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsProcess_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsProcess_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final OwnsProcess_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final OwnsProcess_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected OwnsProcess_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsProcess_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsProcess_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsProcess_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsProcess_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsProcess_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsProcess_targetPropertyPath.Matcher> querySpecification() {
      return OwnsProcess_targetPropertyPath.instance();
    }
  }
  
  private OwnsProcess_targetPropertyPath() {
   ...
   * 
   */
  public static OwnsProcess_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected OwnsProcess_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsProcess_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public OwnsProcess_targetPropertyPath.Matcher instantiate() {
    return OwnsProcess_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public OwnsProcess_targetPropertyPath.Match newEmptyMatch() {
    return OwnsProcess_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsProcess_targetPropertyPath.Match newMatch(final Object... parameters) {
    return OwnsProcess_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsProcess_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsProcess_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsProcess_targetPropertyPath INSTANCE = new OwnsProcess_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsProcess_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
