...
public final class MapsToCapability_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<MapsToCapability_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return MapsToCapability_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public MapsToCapability_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof MapsToCapability_sourcePropertyPath.Match)) {
          MapsToCapability_sourcePropertyPath.Match other = (MapsToCapability_sourcePropertyPath.Match) obj;
    ...
    @Override
    public MapsToCapability_sourcePropertyPath specification() {
      return MapsToCapability_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static MapsToCapability_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static MapsToCapability_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static MapsToCapability_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends MapsToCapability_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends MapsToCapability_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see MapsToCapability_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<MapsToCapability_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static MapsToCapability_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static MapsToCapability_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MapsToCapability_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<MapsToCapability_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<MapsToCapability_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<MapsToCapability_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super MapsToCapability_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public MapsToCapability_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return MapsToCapability_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final MapsToCapability_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final MapsToCapability_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final MapsToCapability_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final MapsToCapability_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected MapsToCapability_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return MapsToCapability_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected MapsToCapability_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return MapsToCapability_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected MapsToCapability_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return MapsToCapability_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<MapsToCapability_sourcePropertyPath.Matcher> querySpecification() {
      return MapsToCapability_sourcePropertyPath.instance();
    }
  }
  
  private MapsToCapability_sourcePropertyPath() {
   ...
   * 
   */
  public static MapsToCapability_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected MapsToCapability_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return MapsToCapability_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public MapsToCapability_sourcePropertyPath.Matcher instantiate() {
    return MapsToCapability_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public MapsToCapability_sourcePropertyPath.Match newEmptyMatch() {
    return MapsToCapability_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public MapsToCapability_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return MapsToCapability_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MapsToCapability_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link MapsToCapability_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final MapsToCapability_sourcePropertyPath INSTANCE = new MapsToCapability_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final MapsToCapability_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
