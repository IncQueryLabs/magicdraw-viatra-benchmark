...
public final class InformationElement_URI extends BaseGeneratedEMFQuerySpecification<InformationElement_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return InformationElement_URI.Match.parameterNames;
    }
    ...
    @Override
    public InformationElement_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InformationElement_URI.Match)) {
          InformationElement_URI.Match other = (InformationElement_URI.Match) obj;
    ...
    @Override
    public InformationElement_URI specification() {
      return InformationElement_URI.instance();
    }
     ...
     * 
     */
    public static InformationElement_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static InformationElement_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static InformationElement_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends InformationElement_URI.Match {
    ...
    private static final class Immutable extends InformationElement_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_URI pattern,
   ...
   * 
   * @see Match
   * @see InformationElement_URI
   * 
   */
  public static class Matcher extends BaseMatcher<InformationElement_URI.Match> {
    /**
     ...
     * 
     */
    public static InformationElement_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InformationElement_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InformationElement_URI.Matcher.class);
     ...
     * 
     */
    public Collection<InformationElement_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<InformationElement_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<InformationElement_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super InformationElement_URI.Match> processor) {
     ...
     * 
     */
    public InformationElement_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return InformationElement_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InformationElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InformationElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final InformationElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final InformationElement_URI.Match partialMatch) {
    ...
    @Override
    protected InformationElement_URI.Match tupleToMatch(final Tuple t) {
      try {
          return InformationElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected InformationElement_URI.Match arrayToMatch(final Object[] match) {
      try {
          return InformationElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InformationElement_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InformationElement_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InformationElement_URI.Matcher> querySpecification() {
      return InformationElement_URI.instance();
    }
  }
  
  private InformationElement_URI() {
   ...
   * 
   */
  public static InformationElement_URI instance() {
    try{
  ...
  @Override
  protected InformationElement_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return InformationElement_URI.Matcher.on(engine);
  }
  
  @Override
  public InformationElement_URI.Matcher instantiate() {
    return InformationElement_URI.Matcher.create();
  }
  
  @Override
  public InformationElement_URI.Match newEmptyMatch() {
    return InformationElement_URI.Match.newEmptyMatch();
  }
  
  @Override
  public InformationElement_URI.Match newMatch(final Object... parameters) {
    return InformationElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InformationElement_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InformationElement_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InformationElement_URI INSTANCE = new InformationElement_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InformationElement_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
