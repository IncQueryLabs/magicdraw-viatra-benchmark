...
public final class CapabilityConfiguration_function extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_function.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_function.Match)) {
          CapabilityConfiguration_function.Match other = (CapabilityConfiguration_function.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_function specification() {
      return CapabilityConfiguration_function.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_function.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration_function pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_function
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_function.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_function.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_function.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_function.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_function.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_function.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_function.Matcher> querySpecification() {
      return CapabilityConfiguration_function.instance();
    }
  }
  
  private CapabilityConfiguration_function() {
   ...
   * 
   */
  public static CapabilityConfiguration_function instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_function.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_function.Matcher instantiate() {
    return CapabilityConfiguration_function.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_function.Match newEmptyMatch() {
    return CapabilityConfiguration_function.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_function.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_function INSTANCE = new CapabilityConfiguration_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
