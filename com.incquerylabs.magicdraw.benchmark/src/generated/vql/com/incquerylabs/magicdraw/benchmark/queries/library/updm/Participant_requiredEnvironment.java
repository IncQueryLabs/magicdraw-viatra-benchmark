...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant;
...
public final class Participant_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Participant_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Participant_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_requiredEnvironment.Match)) {
          Participant_requiredEnvironment.Match other = (Participant_requiredEnvironment.Match) obj;
    ...
    @Override
    public Participant_requiredEnvironment specification() {
      return Participant_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Participant_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Participant_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Participant_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Participant_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Participant_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Participant_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Participant_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Participant_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Participant_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Participant_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Participant_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Participant_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Participant_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Participant_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Participant_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_requiredEnvironment.Matcher> querySpecification() {
      return Participant_requiredEnvironment.instance();
    }
  }
  
  private Participant_requiredEnvironment() {
   ...
   * 
   */
  public static Participant_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Participant_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Participant_requiredEnvironment.Matcher instantiate() {
    return Participant_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Participant_requiredEnvironment.Match newEmptyMatch() {
    return Participant_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Participant_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_requiredEnvironment INSTANCE = new Participant_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Participant(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Participant.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
