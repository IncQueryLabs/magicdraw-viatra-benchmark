...
public final class Enhances extends BaseGeneratedEMFQuerySpecification<Enhances.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Enhances";
    }
    
    @Override
    public List<String> parameterNames() {
      return Enhances.Match.parameterNames;
    }
    ...
    @Override
    public Enhances.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Enhances.Match)) {
          Enhances.Match other = (Enhances.Match) obj;
    ...
    @Override
    public Enhances specification() {
      return Enhances.instance();
    }
     ...
     * 
     */
    public static Enhances.Match newEmptyMatch() {
     ...
     * 
     */
    public static Enhances.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Enhances.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Enhances.Match {
    ...
    private static final class Immutable extends Enhances.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Enhances.Match> {
    /**
     ...
     * 
     */
    public static Enhances.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Enhances.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Enhances.Matcher.class);
     ...
     * 
     */
    public Collection<Enhances.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Enhances.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Enhances.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Enhances.Match> processor) {
     ...
     * 
     */
    public Enhances.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Enhances.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Enhances.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Enhances.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Enhances.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Enhances.Match partialMatch) {
    ...
    @Override
    protected Enhances.Match tupleToMatch(final Tuple t) {
      try {
          return Enhances.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Enhances.Match arrayToMatch(final Object[] match) {
      try {
          return Enhances.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Enhances.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Enhances.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Enhances.Matcher> querySpecification() {
      return Enhances.instance();
    }
  }
   ...
   * 
   */
  public static Enhances instance() {
    try{
  ...
  @Override
  protected Enhances.Matcher instantiate(final ViatraQueryEngine engine) {
    return Enhances.Matcher.on(engine);
  }
  
  @Override
  public Enhances.Matcher instantiate() {
    return Enhances.Matcher.create();
  }
  
  @Override
  public Enhances.Match newEmptyMatch() {
    return Enhances.Match.newEmptyMatch();
  }
  
  @Override
  public Enhances.Match newMatch(final Object... parameters) {
    return Enhances.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Enhances} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Enhances#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Enhances INSTANCE = new Enhances();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Enhances.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Enhances")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Enhances");
