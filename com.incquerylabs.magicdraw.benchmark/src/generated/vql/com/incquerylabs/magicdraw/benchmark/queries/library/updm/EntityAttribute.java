...
public final class EntityAttribute extends BaseGeneratedEMFQuerySpecification<EntityAttribute.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityAttribute.Match.parameterNames;
    }
    ...
    @Override
    public EntityAttribute.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityAttribute.Match)) {
          EntityAttribute.Match other = (EntityAttribute.Match) obj;
    ...
    @Override
    public EntityAttribute specification() {
      return EntityAttribute.instance();
    }
     ...
     * 
     */
    public static EntityAttribute.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityAttribute.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static EntityAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends EntityAttribute.Match {
    ...
    private static final class Immutable extends EntityAttribute.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<EntityAttribute.Match> {
    /**
     ...
     * 
     */
    public static EntityAttribute.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityAttribute.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityAttribute.Matcher.class);
     ...
     * 
     */
    public Collection<EntityAttribute.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<EntityAttribute.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<EntityAttribute.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super EntityAttribute.Match> processor) {
     ...
     * 
     */
    public EntityAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return EntityAttribute.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EntityAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EntityAttribute.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final EntityAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final EntityAttribute.Match partialMatch) {
    ...
    @Override
    protected EntityAttribute.Match tupleToMatch(final Tuple t) {
      try {
          return EntityAttribute.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected EntityAttribute.Match arrayToMatch(final Object[] match) {
      try {
          return EntityAttribute.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityAttribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityAttribute.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityAttribute.Matcher> querySpecification() {
      return EntityAttribute.instance();
    }
  }
   ...
   * 
   */
  public static EntityAttribute instance() {
    try{
  ...
  @Override
  protected EntityAttribute.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityAttribute.Matcher.on(engine);
  }
  
  @Override
  public EntityAttribute.Matcher instantiate() {
    return EntityAttribute.Matcher.create();
  }
  
  @Override
  public EntityAttribute.Match newEmptyMatch() {
    return EntityAttribute.Match.newEmptyMatch();
  }
  
  @Override
  public EntityAttribute.Match newMatch(final Object... parameters) {
    return EntityAttribute.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityAttribute} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityAttribute#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityAttribute INSTANCE = new EntityAttribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityAttribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "EntityAttribute");
