...
public final class Competence_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Competence_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Competence_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Competence_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Competence_startBoundaryType.Match)) {
          Competence_startBoundaryType.Match other = (Competence_startBoundaryType.Match) obj;
    ...
    @Override
    public Competence_startBoundaryType specification() {
      return Competence_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Competence_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Competence_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Competence_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Competence_startBoundaryType.Match {
    ...
    private static final class Immutable extends Competence_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Competence_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Competence_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Competence_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Competence_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Competence_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Competence_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Competence_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Competence_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Competence_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Competence_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Competence_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Competence_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Competence_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Competence_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Competence_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Competence_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Competence_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Competence_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Competence_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Competence_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Competence_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Competence_startBoundaryType.Matcher> querySpecification() {
      return Competence_startBoundaryType.instance();
    }
  }
  
  private Competence_startBoundaryType() {
   ...
   * 
   */
  public static Competence_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Competence_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Competence_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Competence_startBoundaryType.Matcher instantiate() {
    return Competence_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Competence_startBoundaryType.Match newEmptyMatch() {
    return Competence_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Competence_startBoundaryType.Match newMatch(final Object... parameters) {
    return Competence_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Competence_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Competence_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Competence_startBoundaryType INSTANCE = new Competence_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Competence_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
