...
public final class PhysicalArchitecture_affectedFunctions extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_affectedFunctions.Match)) {
          PhysicalArchitecture_affectedFunctions.Match other = (PhysicalArchitecture_affectedFunctions.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_affectedFunctions specification() {
      return PhysicalArchitecture_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_affectedFunctions.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_affectedFunctions.Matcher> querySpecification() {
      return PhysicalArchitecture_affectedFunctions.instance();
    }
  }
  
  private PhysicalArchitecture_affectedFunctions() {
   ...
   * 
   */
  public static PhysicalArchitecture_affectedFunctions instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_affectedFunctions.Matcher instantiate() {
    return PhysicalArchitecture_affectedFunctions.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_affectedFunctions.Match newEmptyMatch() {
    return PhysicalArchitecture_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_affectedFunctions.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_affectedFunctions INSTANCE = new PhysicalArchitecture_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
