...
public final class CompetenceForRole_targetContext extends BaseGeneratedEMFQuerySpecification<CompetenceForRole_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceForRole_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceForRole_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceForRole_targetContext.Match)) {
          CompetenceForRole_targetContext.Match other = (CompetenceForRole_targetContext.Match) obj;
    ...
    @Override
    public CompetenceForRole_targetContext specification() {
      return CompetenceForRole_targetContext.instance();
    }
     ...
     * 
     */
    public static CompetenceForRole_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceForRole_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static CompetenceForRole_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CompetenceForRole_targetContext.Match {
    ...
    private static final class Immutable extends CompetenceForRole_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_targetContext pattern,
   ...
   * 
   * @see Match
   * @see CompetenceForRole_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceForRole_targetContext.Match> {
    /**
     ...
     * 
     */
    public static CompetenceForRole_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceForRole_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceForRole_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceForRole_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<CompetenceForRole_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<CompetenceForRole_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super CompetenceForRole_targetContext.Match> processor) {
     ...
     * 
     */
    public CompetenceForRole_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return CompetenceForRole_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceForRole_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceForRole_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final CompetenceForRole_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final CompetenceForRole_targetContext.Match partialMatch) {
    ...
    @Override
    protected CompetenceForRole_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceForRole_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected CompetenceForRole_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceForRole_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceForRole_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceForRole_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceForRole_targetContext.Matcher> querySpecification() {
      return CompetenceForRole_targetContext.instance();
    }
  }
  
  private CompetenceForRole_targetContext() {
   ...
   * 
   */
  public static CompetenceForRole_targetContext instance() {
    try{
  ...
  @Override
  protected CompetenceForRole_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceForRole_targetContext.Matcher.on(engine);
  }
  
  @Override
  public CompetenceForRole_targetContext.Matcher instantiate() {
    return CompetenceForRole_targetContext.Matcher.create();
  }
  
  @Override
  public CompetenceForRole_targetContext.Match newEmptyMatch() {
    return CompetenceForRole_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceForRole_targetContext.Match newMatch(final Object... parameters) {
    return CompetenceForRole_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceForRole_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceForRole_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceForRole_targetContext INSTANCE = new CompetenceForRole_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceForRole_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
