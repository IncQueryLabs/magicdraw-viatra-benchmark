...
public final class Risk_riskOwner extends BaseGeneratedEMFQuerySpecification<Risk_riskOwner.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Risk_riskOwner pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Risk_riskOwner";
    }
    
    @Override
    public List<String> parameterNames() {
      return Risk_riskOwner.Match.parameterNames;
    }
    ...
    @Override
    public Risk_riskOwner.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Risk_riskOwner.Match)) {
          Risk_riskOwner.Match other = (Risk_riskOwner.Match) obj;
    ...
    @Override
    public Risk_riskOwner specification() {
      return Risk_riskOwner.instance();
    }
     ...
     * 
     */
    public static Risk_riskOwner.Match newEmptyMatch() {
     ...
     * 
     */
    public static Risk_riskOwner.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Risk_riskOwner.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Risk_riskOwner.Match {
    ...
    private static final class Immutable extends Risk_riskOwner.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Risk_riskOwner pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Risk_riskOwner.Match> {
    /**
     ...
     * 
     */
    public static Risk_riskOwner.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Risk_riskOwner.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Risk_riskOwner.Matcher.class);
     ...
     * 
     */
    public Collection<Risk_riskOwner.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Risk_riskOwner.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Risk_riskOwner.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Risk_riskOwner.Match> processor) {
     ...
     * 
     */
    public Risk_riskOwner.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Risk_riskOwner.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Risk_riskOwner.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Risk_riskOwner.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Risk_riskOwner.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Risk_riskOwner.Match partialMatch) {
    ...
    @Override
    protected Risk_riskOwner.Match tupleToMatch(final Tuple t) {
      try {
          return Risk_riskOwner.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Risk_riskOwner.Match arrayToMatch(final Object[] match) {
      try {
          return Risk_riskOwner.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Risk_riskOwner.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Risk_riskOwner.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Risk_riskOwner.Matcher> querySpecification() {
      return Risk_riskOwner.instance();
    }
  }
  
  private Risk_riskOwner() {
   ...
   * 
   */
  public static Risk_riskOwner instance() {
    try{
  ...
  @Override
  protected Risk_riskOwner.Matcher instantiate(final ViatraQueryEngine engine) {
    return Risk_riskOwner.Matcher.on(engine);
  }
  
  @Override
  public Risk_riskOwner.Matcher instantiate() {
    return Risk_riskOwner.Matcher.create();
  }
  
  @Override
  public Risk_riskOwner.Match newEmptyMatch() {
    return Risk_riskOwner.Match.newEmptyMatch();
  }
  
  @Override
  public Risk_riskOwner.Match newMatch(final Object... parameters) {
    return Risk_riskOwner.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Risk_riskOwner} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Risk_riskOwner#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Risk_riskOwner INSTANCE = new Risk_riskOwner();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Risk_riskOwner.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "riskOwner");
