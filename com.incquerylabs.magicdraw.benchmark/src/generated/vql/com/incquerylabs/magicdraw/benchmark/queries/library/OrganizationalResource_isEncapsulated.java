...
public final class OrganizationalResource_isEncapsulated extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_isEncapsulated.Match)) {
          OrganizationalResource_isEncapsulated.Match other = (OrganizationalResource_isEncapsulated.Match) obj;
    ...
    @Override
    public OrganizationalResource_isEncapsulated specification() {
      return OrganizationalResource_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static OrganizationalResource_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OrganizationalResource_isEncapsulated.Match {
    ...
    private static final class Immutable extends OrganizationalResource_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<OrganizationalResource_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<OrganizationalResource_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super OrganizationalResource_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return OrganizationalResource_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final OrganizationalResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final OrganizationalResource_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OrganizationalResource_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_isEncapsulated.Matcher> querySpecification() {
      return OrganizationalResource_isEncapsulated.instance();
    }
  }
  
  private OrganizationalResource_isEncapsulated() {
   ...
   * 
   */
  public static OrganizationalResource_isEncapsulated instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_isEncapsulated.Matcher instantiate() {
    return OrganizationalResource_isEncapsulated.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_isEncapsulated.Match newEmptyMatch() {
    return OrganizationalResource_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_isEncapsulated.Match newMatch(final Object... parameters) {
    return OrganizationalResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_isEncapsulated INSTANCE = new OrganizationalResource_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
