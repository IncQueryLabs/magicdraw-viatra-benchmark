...
public final class ActualProjectMilestoneRole_conformsTo extends BaseGeneratedEMFQuerySpecification<ActualProjectMilestoneRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectMilestoneRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectMilestoneRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectMilestoneRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectMilestoneRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectMilestoneRole_conformsTo.Match)) {
          ActualProjectMilestoneRole_conformsTo.Match other = (ActualProjectMilestoneRole_conformsTo.Match) obj;
    ...
    @Override
    public ActualProjectMilestoneRole_conformsTo specification() {
      return ActualProjectMilestoneRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static ActualProjectMilestoneRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_conformsTo.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProjectMilestoneRole_conformsTo.Match {
    ...
    private static final class Immutable extends ActualProjectMilestoneRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectMilestoneRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectMilestoneRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectMilestoneRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectMilestoneRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectMilestoneRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectMilestoneRole_conformsTo.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProjectMilestoneRole_conformsTo.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProjectMilestoneRole_conformsTo.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProjectMilestoneRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public ActualProjectMilestoneRole_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProjectMilestoneRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectMilestoneRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectMilestoneRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProjectMilestoneRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProjectMilestoneRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ActualProjectMilestoneRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectMilestoneRole_conformsTo.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProjectMilestoneRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_conformsTo.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectMilestoneRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_conformsTo.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectMilestoneRole_conformsTo.Matcher> querySpecification() {
      return ActualProjectMilestoneRole_conformsTo.instance();
    }
  }
  
  private ActualProjectMilestoneRole_conformsTo() {
   ...
   * 
   */
  public static ActualProjectMilestoneRole_conformsTo instance() {
    try{
  ...
  @Override
  protected ActualProjectMilestoneRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectMilestoneRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectMilestoneRole_conformsTo.Matcher instantiate() {
    return ActualProjectMilestoneRole_conformsTo.Matcher.create();
  }
  
  @Override
  public ActualProjectMilestoneRole_conformsTo.Match newEmptyMatch() {
    return ActualProjectMilestoneRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectMilestoneRole_conformsTo.Match newMatch(final Object... parameters) {
    return ActualProjectMilestoneRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectMilestoneRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectMilestoneRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectMilestoneRole_conformsTo INSTANCE = new ActualProjectMilestoneRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectMilestoneRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
