...
public final class ProjectMilestone_resource extends BaseGeneratedEMFQuerySpecification<ProjectMilestone_resource.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestone_resource pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestone_resource";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestone_resource.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestone_resource.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestone_resource.Match)) {
          ProjectMilestone_resource.Match other = (ProjectMilestone_resource.Match) obj;
    ...
    @Override
    public ProjectMilestone_resource specification() {
      return ProjectMilestone_resource.instance();
    }
     ...
     * 
     */
    public static ProjectMilestone_resource.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestone_resource.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestone_resource.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestone_resource.Match {
    ...
    private static final class Immutable extends ProjectMilestone_resource.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestone_resource pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestone_resource
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestone_resource.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestone_resource.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestone_resource.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestone_resource.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestone_resource.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestone_resource.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestone_resource.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectMilestone_resource.Match> processor) {
     ...
     * 
     */
    public ProjectMilestone_resource.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectMilestone_resource.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectMilestone_resource.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectMilestone_resource.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestone_resource.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestone_resource.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestone_resource.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestone_resource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestone_resource.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestone_resource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestone_resource.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestone_resource.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestone_resource.Matcher> querySpecification() {
      return ProjectMilestone_resource.instance();
    }
  }
  
  private ProjectMilestone_resource() {
   ...
   * 
   */
  public static ProjectMilestone_resource instance() {
    try{
  ...
  @Override
  protected ProjectMilestone_resource.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestone_resource.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestone_resource.Matcher instantiate() {
    return ProjectMilestone_resource.Matcher.create();
  }
  
  @Override
  public ProjectMilestone_resource.Match newEmptyMatch() {
    return ProjectMilestone_resource.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestone_resource.Match newMatch(final Object... parameters) {
    return ProjectMilestone_resource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestone_resource} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestone_resource#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestone_resource INSTANCE = new ProjectMilestone_resource();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestone_resource.GeneratedPQuery INSTANCE = new GeneratedPQuery();
