...
public final class OperationalInterface_URI extends BaseGeneratedEMFQuerySpecification<OperationalInterface_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalInterface_URI.Match.parameterNames;
    }
    ...
    @Override
    public OperationalInterface_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalInterface_URI.Match)) {
          OperationalInterface_URI.Match other = (OperationalInterface_URI.Match) obj;
    ...
    @Override
    public OperationalInterface_URI specification() {
      return OperationalInterface_URI.instance();
    }
     ...
     * 
     */
    public static OperationalInterface_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalInterface_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static OperationalInterface_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalInterface_URI.Match {
    ...
    private static final class Immutable extends OperationalInterface_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface_URI pattern,
   ...
   * 
   * @see Match
   * @see OperationalInterface_URI
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalInterface_URI.Match> {
    /**
     ...
     * 
     */
    public static OperationalInterface_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalInterface_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalInterface_URI.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalInterface_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<OperationalInterface_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<OperationalInterface_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super OperationalInterface_URI.Match> processor) {
     ...
     * 
     */
    public OperationalInterface_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return OperationalInterface_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalInterface_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalInterface_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final OperationalInterface_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final OperationalInterface_URI.Match partialMatch) {
    ...
    @Override
    protected OperationalInterface_URI.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalInterface_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalInterface_URI.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalInterface_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalInterface_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalInterface_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalInterface_URI.Matcher> querySpecification() {
      return OperationalInterface_URI.instance();
    }
  }
  
  private OperationalInterface_URI() {
   ...
   * 
   */
  public static OperationalInterface_URI instance() {
    try{
  ...
  @Override
  protected OperationalInterface_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalInterface_URI.Matcher.on(engine);
  }
  
  @Override
  public OperationalInterface_URI.Matcher instantiate() {
    return OperationalInterface_URI.Matcher.create();
  }
  
  @Override
  public OperationalInterface_URI.Match newEmptyMatch() {
    return OperationalInterface_URI.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalInterface_URI.Match newMatch(final Object... parameters) {
    return OperationalInterface_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalInterface_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalInterface_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalInterface_URI INSTANCE = new OperationalInterface_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalInterface_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
