...
public final class Resource_appliesTo extends BaseGeneratedEMFQuerySpecification<Resource_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Resource_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Resource_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Resource_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Resource_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Resource_appliesTo.Match)) {
          Resource_appliesTo.Match other = (Resource_appliesTo.Match) obj;
    ...
    @Override
    public Resource_appliesTo specification() {
      return Resource_appliesTo.instance();
    }
     ...
     * 
     */
    public static Resource_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Resource_appliesTo.Match newMutableMatch(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public static Resource_appliesTo.Match newMatch(final Element pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Resource_appliesTo.Match {
    ...
    private static final class Immutable extends Resource_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Resource_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Resource_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Resource_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Resource_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Resource_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Resource_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Resource_appliesTo.Match> getAllMatches(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Resource_appliesTo.Match> streamAllMatches(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Resource_appliesTo.Match> getOneArbitraryMatch(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final Element pValue, final Consumer<? super Resource_appliesTo.Match> processor) {
     ...
     * 
     */
    public Resource_appliesTo.Match newMatch(final Element pElement, final Element pValue) {
      return Resource_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Resource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Resource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Resource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Resource_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Resource_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Resource_appliesTo.Match.newMatch((Element) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Resource_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Resource_appliesTo.Match.newMatch((Element) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Resource_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Resource_appliesTo.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Resource_appliesTo.Matcher> querySpecification() {
      return Resource_appliesTo.instance();
    }
  }
  
  private Resource_appliesTo() {
   ...
   * 
   */
  public static Resource_appliesTo instance() {
    try{
  ...
  @Override
  protected Resource_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Resource_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Resource_appliesTo.Matcher instantiate() {
    return Resource_appliesTo.Matcher.create();
  }
  
  @Override
  public Resource_appliesTo.Match newEmptyMatch() {
    return Resource_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Resource_appliesTo.Match newMatch(final Object... parameters) {
    return Resource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Resource_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Resource_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Resource_appliesTo INSTANCE = new Resource_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Resource_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
