...
public final class Resource_URI extends BaseGeneratedEMFQuerySpecification<Resource_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Resource_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Resource_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Resource_URI.Match.parameterNames;
    }
    ...
    @Override
    public Resource_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Resource_URI.Match)) {
          Resource_URI.Match other = (Resource_URI.Match) obj;
    ...
    @Override
    public Resource_URI specification() {
      return Resource_URI.instance();
    }
     ...
     * 
     */
    public static Resource_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Resource_URI.Match newMutableMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Resource_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Resource_URI.Match {
    ...
    private static final class Immutable extends Resource_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Resource_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Resource_URI.Match> {
    /**
     ...
     * 
     */
    public static Resource_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Resource_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Resource_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Resource_URI.Match> getAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Resource_URI.Match> streamAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Resource_URI.Match> getOneArbitraryMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final LiteralString pValuespec, final Consumer<? super Resource_URI.Match> processor) {
     ...
     * 
     */
    public Resource_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
      return Resource_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Resource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Resource_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Resource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Resource_URI.Match partialMatch) {
    ...
    @Override
    protected Resource_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Resource_URI.Match.newMatch((Element) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Resource_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Resource_URI.Match.newMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Resource_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Resource_URI.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Resource_URI.Matcher> querySpecification() {
      return Resource_URI.instance();
    }
  }
   ...
   * 
   */
  public static Resource_URI instance() {
    try{
  ...
  @Override
  protected Resource_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Resource_URI.Matcher.on(engine);
  }
  
  @Override
  public Resource_URI.Matcher instantiate() {
    return Resource_URI.Matcher.create();
  }
  
  @Override
  public Resource_URI.Match newEmptyMatch() {
    return Resource_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Resource_URI.Match newMatch(final Object... parameters) {
    return Resource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Resource_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Resource_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Resource_URI INSTANCE = new Resource_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Resource_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
