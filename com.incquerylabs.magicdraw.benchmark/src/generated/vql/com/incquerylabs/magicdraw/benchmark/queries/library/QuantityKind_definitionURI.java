 ...
 *         pattern QuantityKind_definitionURI(Element : PackageableElement, Value: java String) {
...
public final class QuantityKind_definitionURI extends BaseGeneratedEMFQuerySpecification<QuantityKind_definitionURI.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static QuantityKind_definitionURI.Match newMutableMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public static QuantityKind_definitionURI.Match newMatch(final PackageableElement pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<QuantityKind_definitionURI.Match> {
     ...
     * 
     */
    public Collection<QuantityKind_definitionURI.Match> getAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Stream<QuantityKind_definitionURI.Match> streamAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Optional<QuantityKind_definitionURI.Match> getOneArbitraryMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final String pValue, final Consumer<? super QuantityKind_definitionURI.Match> processor) {
     ...
     * 
     */
    public QuantityKind_definitionURI.Match newMatch(final PackageableElement pElement, final String pValue) {
      return QuantityKind_definitionURI.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final QuantityKind_definitionURI.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final QuantityKind_definitionURI.Match partialMatch) {
    ...
    protected QuantityKind_definitionURI.Match tupleToMatch(final Tuple t) {
      try {
          return QuantityKind_definitionURI.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected QuantityKind_definitionURI.Match arrayToMatch(final Object[] match) {
      try {
          return QuantityKind_definitionURI.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected QuantityKind_definitionURI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return QuantityKind_definitionURI.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public QuantityKind_definitionURI.Match newMatch(final Object... parameters) {
    return QuantityKind_definitionURI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (java.lang.String) parameters[1]);
  }
