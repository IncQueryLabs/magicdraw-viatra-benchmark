...
public final class Participant_actsUpon extends BaseGeneratedEMFQuerySpecification<Participant_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public Participant_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_actsUpon.Match)) {
          Participant_actsUpon.Match other = (Participant_actsUpon.Match) obj;
    ...
    @Override
    public Participant_actsUpon specification() {
      return Participant_actsUpon.instance();
    }
     ...
     * 
     */
    public static Participant_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Participant_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Participant_actsUpon.Match {
    ...
    private static final class Immutable extends Participant_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see Participant_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static Participant_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Participant_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Participant_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Participant_actsUpon.Match> processor) {
     ...
     * 
     */
    public Participant_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Participant_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Participant_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Participant_actsUpon.Match partialMatch) {
    ...
    @Override
    protected Participant_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Participant_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_actsUpon.Matcher> querySpecification() {
      return Participant_actsUpon.instance();
    }
  }
  
  private Participant_actsUpon() {
   ...
   * 
   */
  public static Participant_actsUpon instance() {
    try{
  ...
  @Override
  protected Participant_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public Participant_actsUpon.Matcher instantiate() {
    return Participant_actsUpon.Matcher.create();
  }
  
  @Override
  public Participant_actsUpon.Match newEmptyMatch() {
    return Participant_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_actsUpon.Match newMatch(final Object... parameters) {
    return Participant_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_actsUpon INSTANCE = new Participant_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
