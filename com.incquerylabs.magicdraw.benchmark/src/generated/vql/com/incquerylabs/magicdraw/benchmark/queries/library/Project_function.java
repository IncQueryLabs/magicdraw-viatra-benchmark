...
public final class Project_function extends BaseGeneratedEMFQuerySpecification<Project_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Project_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_function.Match.parameterNames;
    }
    ...
    @Override
    public Project_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_function.Match)) {
          Project_function.Match other = (Project_function.Match) obj;
    ...
    @Override
    public Project_function specification() {
      return Project_function.instance();
    }
     ...
     * 
     */
    public static Project_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Project_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Project_function.Match {
    ...
    private static final class Immutable extends Project_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_function pattern,
   ...
   * 
   * @see Match
   * @see Project_function
   * 
   */
  public static class Matcher extends BaseMatcher<Project_function.Match> {
    /**
     ...
     * 
     */
    public static Project_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_function.Matcher.class);
     ...
     * 
     */
    public Collection<Project_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Project_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Project_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Project_function.Match> processor) {
     ...
     * 
     */
    public Project_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Project_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Project_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Project_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Project_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Project_function.Match partialMatch) {
    ...
    @Override
    protected Project_function.Match tupleToMatch(final Tuple t) {
      try {
          return Project_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Project_function.Match arrayToMatch(final Object[] match) {
      try {
          return Project_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_function.Matcher> querySpecification() {
      return Project_function.instance();
    }
  }
  
  private Project_function() {
   ...
   * 
   */
  public static Project_function instance() {
    try{
  ...
  @Override
  protected Project_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_function.Matcher.on(engine);
  }
  
  @Override
  public Project_function.Matcher instantiate() {
    return Project_function.Matcher.create();
  }
  
  @Override
  public Project_function.Match newEmptyMatch() {
    return Project_function.Match.newEmptyMatch();
  }
  
  @Override
  public Project_function.Match newMatch(final Object... parameters) {
    return Project_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_function INSTANCE = new Project_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
