...
public final class ConceptItem extends BaseGeneratedEMFQuerySpecification<ConceptItem.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ConceptItem pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ConceptItem";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptItem.Match.parameterNames;
    }
    ...
    @Override
    public ConceptItem.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptItem.Match)) {
          ConceptItem.Match other = (ConceptItem.Match) obj;
    ...
    @Override
    public ConceptItem specification() {
      return ConceptItem.instance();
    }
     ...
     * 
     */
    public static ConceptItem.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptItem.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ConceptItem.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ConceptItem.Match {
    ...
    private static final class Immutable extends ConceptItem.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ConceptItem pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptItem.Match> {
    /**
     ...
     * 
     */
    public static ConceptItem.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptItem.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptItem.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptItem.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ConceptItem.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ConceptItem.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ConceptItem.Match> processor) {
     ...
     * 
     */
    public ConceptItem.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ConceptItem.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final ConceptItem.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final ConceptItem.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ConceptItem.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ConceptItem.Match partialMatch) {
    ...
    @Override
    protected ConceptItem.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptItem.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ConceptItem.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptItem.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptItem.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptItem.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptItem.Matcher> querySpecification() {
      return ConceptItem.instance();
    }
  }
   ...
   * 
   */
  public static ConceptItem instance() {
    try{
  ...
  @Override
  protected ConceptItem.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptItem.Matcher.on(engine);
  }
  
  @Override
  public ConceptItem.Matcher instantiate() {
    return ConceptItem.Matcher.create();
  }
  
  @Override
  public ConceptItem.Match newEmptyMatch() {
    return ConceptItem.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptItem.Match newMatch(final Object... parameters) {
    return ConceptItem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptItem} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptItem#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptItem INSTANCE = new ConceptItem();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptItem.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ConceptItem")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ConceptItem");
