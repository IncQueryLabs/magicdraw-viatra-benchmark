...
public final class ActivitySubject extends BaseGeneratedEMFQuerySpecification<ActivitySubject.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActivitySubject pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActivitySubject";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActivitySubject.Match.parameterNames;
    }
    ...
    @Override
    public ActivitySubject.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActivitySubject.Match)) {
          ActivitySubject.Match other = (ActivitySubject.Match) obj;
    ...
    @Override
    public ActivitySubject specification() {
      return ActivitySubject.instance();
    }
     ...
     * 
     */
    public static ActivitySubject.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActivitySubject.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActivitySubject.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActivitySubject.Match {
    ...
    private static final class Immutable extends ActivitySubject.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActivitySubject pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActivitySubject.Match> {
    /**
     ...
     * 
     */
    public static ActivitySubject.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActivitySubject.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActivitySubject.Matcher.class);
     ...
     * 
     */
    public Collection<ActivitySubject.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActivitySubject.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActivitySubject.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActivitySubject.Match> processor) {
     ...
     * 
     */
    public ActivitySubject.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActivitySubject.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final ActivitySubject.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final ActivitySubject.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActivitySubject.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActivitySubject.Match partialMatch) {
    ...
    @Override
    protected ActivitySubject.Match tupleToMatch(final Tuple t) {
      try {
          return ActivitySubject.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActivitySubject.Match arrayToMatch(final Object[] match) {
      try {
          return ActivitySubject.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActivitySubject.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActivitySubject.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActivitySubject.Matcher> querySpecification() {
      return ActivitySubject.instance();
    }
  }
   ...
   * 
   */
  public static ActivitySubject instance() {
    try{
  ...
  @Override
  protected ActivitySubject.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActivitySubject.Matcher.on(engine);
  }
  
  @Override
  public ActivitySubject.Matcher instantiate() {
    return ActivitySubject.Matcher.create();
  }
  
  @Override
  public ActivitySubject.Match newEmptyMatch() {
    return ActivitySubject.Match.newEmptyMatch();
  }
  
  @Override
  public ActivitySubject.Match newMatch(final Object... parameters) {
    return ActivitySubject.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActivitySubject} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActivitySubject#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActivitySubject INSTANCE = new ActivitySubject();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActivitySubject.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ActivitySubject");
