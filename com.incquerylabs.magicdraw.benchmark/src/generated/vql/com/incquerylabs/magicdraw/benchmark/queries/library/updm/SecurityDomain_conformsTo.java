...
public final class SecurityDomain_conformsTo extends BaseGeneratedEMFQuerySpecification<SecurityDomain_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_conformsTo.Match)) {
          SecurityDomain_conformsTo.Match other = (SecurityDomain_conformsTo.Match) obj;
    ...
    @Override
    public SecurityDomain_conformsTo specification() {
      return SecurityDomain_conformsTo.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityDomain_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_conformsTo.Match {
    ...
    private static final class Immutable extends SecurityDomain_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityDomain_conformsTo.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityDomain_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityDomain_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityDomain_conformsTo.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_conformsTo.Matcher> querySpecification() {
      return SecurityDomain_conformsTo.instance();
    }
  }
  
  private SecurityDomain_conformsTo() {
   ...
   * 
   */
  public static SecurityDomain_conformsTo instance() {
    try{
  ...
  @Override
  protected SecurityDomain_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_conformsTo.Matcher instantiate() {
    return SecurityDomain_conformsTo.Matcher.create();
  }
  
  @Override
  public SecurityDomain_conformsTo.Match newEmptyMatch() {
    return SecurityDomain_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_conformsTo.Match newMatch(final Object... parameters) {
    return SecurityDomain_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_conformsTo INSTANCE = new SecurityDomain_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
