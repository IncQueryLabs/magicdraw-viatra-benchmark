...
public final class EnterprisePhase_endDate extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_endDate.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_endDate.Match)) {
          EnterprisePhase_endDate.Match other = (EnterprisePhase_endDate.Match) obj;
    ...
    @Override
    public EnterprisePhase_endDate specification() {
      return EnterprisePhase_endDate.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_endDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_endDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_endDate.Match {
    ...
    private static final class Immutable extends EnterprisePhase_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_endDate pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_endDate.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_endDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_endDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_endDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_endDate.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_endDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_endDate.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_endDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_endDate.Matcher> querySpecification() {
      return EnterprisePhase_endDate.instance();
    }
  }
  
  private EnterprisePhase_endDate() {
   ...
   * 
   */
  public static EnterprisePhase_endDate instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_endDate.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_endDate.Matcher instantiate() {
    return EnterprisePhase_endDate.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_endDate.Match newEmptyMatch() {
    return EnterprisePhase_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_endDate.Match newMatch(final Object... parameters) {
    return EnterprisePhase_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_endDate INSTANCE = new EnterprisePhase_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
