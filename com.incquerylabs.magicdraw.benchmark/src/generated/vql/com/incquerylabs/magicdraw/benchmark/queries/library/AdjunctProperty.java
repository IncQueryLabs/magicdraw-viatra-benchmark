...
public final class AdjunctProperty extends BaseGeneratedEMFQuerySpecification<AdjunctProperty.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static AdjunctProperty.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static AdjunctProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<AdjunctProperty.Match> {
     ...
     * 
     */
    public Collection<AdjunctProperty.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<AdjunctProperty.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<AdjunctProperty.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super AdjunctProperty.Match> processor) {
     ...
     * 
     */
    public AdjunctProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return AdjunctProperty.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final AdjunctProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final AdjunctProperty.Match partialMatch) {
    ...
    protected AdjunctProperty.Match tupleToMatch(final Tuple t) {
      try {
          return AdjunctProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected AdjunctProperty.Match arrayToMatch(final Object[] match) {
      try {
          return AdjunctProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected AdjunctProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AdjunctProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public AdjunctProperty.Match newMatch(final Object... parameters) {
    return AdjunctProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
