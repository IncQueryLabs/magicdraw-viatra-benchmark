...
public final class ActualProjectMilestoneRole_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ActualProjectMilestoneRole_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProjectMilestoneRole_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProjectMilestoneRole_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectMilestoneRole_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectMilestoneRole_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectMilestoneRole_endBoundaryType.Match)) {
          ActualProjectMilestoneRole_endBoundaryType.Match other = (ActualProjectMilestoneRole_endBoundaryType.Match) obj;
    ...
    @Override
    public ActualProjectMilestoneRole_endBoundaryType specification() {
      return ActualProjectMilestoneRole_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProjectMilestoneRole_endBoundaryType.Match {
    ...
    private static final class Immutable extends ActualProjectMilestoneRole_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProjectMilestoneRole_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectMilestoneRole_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectMilestoneRole_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectMilestoneRole_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectMilestoneRole_endBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProjectMilestoneRole_endBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProjectMilestoneRole_endBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProjectMilestoneRole_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ActualProjectMilestoneRole_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProjectMilestoneRole_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectMilestoneRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectMilestoneRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProjectMilestoneRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProjectMilestoneRole_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ActualProjectMilestoneRole_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectMilestoneRole_endBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProjectMilestoneRole_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_endBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectMilestoneRole_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_endBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectMilestoneRole_endBoundaryType.Matcher> querySpecification() {
      return ActualProjectMilestoneRole_endBoundaryType.instance();
    }
  }
  
  private ActualProjectMilestoneRole_endBoundaryType() {
   ...
   * 
   */
  public static ActualProjectMilestoneRole_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ActualProjectMilestoneRole_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectMilestoneRole_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectMilestoneRole_endBoundaryType.Matcher instantiate() {
    return ActualProjectMilestoneRole_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ActualProjectMilestoneRole_endBoundaryType.Match newEmptyMatch() {
    return ActualProjectMilestoneRole_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectMilestoneRole_endBoundaryType.Match newMatch(final Object... parameters) {
    return ActualProjectMilestoneRole_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectMilestoneRole_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectMilestoneRole_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectMilestoneRole_endBoundaryType INSTANCE = new ActualProjectMilestoneRole_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectMilestoneRole_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
