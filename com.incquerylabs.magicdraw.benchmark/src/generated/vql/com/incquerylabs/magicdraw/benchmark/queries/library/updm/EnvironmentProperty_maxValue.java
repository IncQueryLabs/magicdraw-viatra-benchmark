...
public final class EnvironmentProperty_maxValue extends BaseGeneratedEMFQuerySpecification<EnvironmentProperty_maxValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_maxValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_maxValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnvironmentProperty_maxValue.Match.parameterNames;
    }
    ...
    @Override
    public EnvironmentProperty_maxValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnvironmentProperty_maxValue.Match)) {
          EnvironmentProperty_maxValue.Match other = (EnvironmentProperty_maxValue.Match) obj;
    ...
    @Override
    public EnvironmentProperty_maxValue specification() {
      return EnvironmentProperty_maxValue.instance();
    }
     ...
     * 
     */
    public static EnvironmentProperty_maxValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnvironmentProperty_maxValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnvironmentProperty_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnvironmentProperty_maxValue.Match {
    ...
    private static final class Immutable extends EnvironmentProperty_maxValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_maxValue pattern,
   ...
   * 
   * @see Match
   * @see EnvironmentProperty_maxValue
   * 
   */
  public static class Matcher extends BaseMatcher<EnvironmentProperty_maxValue.Match> {
    /**
     ...
     * 
     */
    public static EnvironmentProperty_maxValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnvironmentProperty_maxValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnvironmentProperty_maxValue.Matcher.class);
     ...
     * 
     */
    public Collection<EnvironmentProperty_maxValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnvironmentProperty_maxValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnvironmentProperty_maxValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super EnvironmentProperty_maxValue.Match> processor) {
     ...
     * 
     */
    public EnvironmentProperty_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return EnvironmentProperty_maxValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EnvironmentProperty_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EnvironmentProperty_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnvironmentProperty_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnvironmentProperty_maxValue.Match partialMatch) {
    ...
    @Override
    protected EnvironmentProperty_maxValue.Match tupleToMatch(final Tuple t) {
      try {
          return EnvironmentProperty_maxValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnvironmentProperty_maxValue.Match arrayToMatch(final Object[] match) {
      try {
          return EnvironmentProperty_maxValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnvironmentProperty_maxValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnvironmentProperty_maxValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnvironmentProperty_maxValue.Matcher> querySpecification() {
      return EnvironmentProperty_maxValue.instance();
    }
  }
  
  private EnvironmentProperty_maxValue() {
   ...
   * 
   */
  public static EnvironmentProperty_maxValue instance() {
    try{
  ...
  @Override
  protected EnvironmentProperty_maxValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnvironmentProperty_maxValue.Matcher.on(engine);
  }
  
  @Override
  public EnvironmentProperty_maxValue.Matcher instantiate() {
    return EnvironmentProperty_maxValue.Matcher.create();
  }
  
  @Override
  public EnvironmentProperty_maxValue.Match newEmptyMatch() {
    return EnvironmentProperty_maxValue.Match.newEmptyMatch();
  }
  
  @Override
  public EnvironmentProperty_maxValue.Match newMatch(final Object... parameters) {
    return EnvironmentProperty_maxValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnvironmentProperty_maxValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnvironmentProperty_maxValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnvironmentProperty_maxValue INSTANCE = new EnvironmentProperty_maxValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnvironmentProperty_maxValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
