...
public final class SecurityDomain_actualPropertySet extends BaseGeneratedEMFQuerySpecification<SecurityDomain_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_actualPropertySet.Match)) {
          SecurityDomain_actualPropertySet.Match other = (SecurityDomain_actualPropertySet.Match) obj;
    ...
    @Override
    public SecurityDomain_actualPropertySet specification() {
      return SecurityDomain_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityDomain_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_actualPropertySet.Match {
    ...
    private static final class Immutable extends SecurityDomain_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityDomain_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityDomain_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityDomain_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityDomain_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_actualPropertySet.Matcher> querySpecification() {
      return SecurityDomain_actualPropertySet.instance();
    }
  }
  
  private SecurityDomain_actualPropertySet() {
   ...
   * 
   */
  public static SecurityDomain_actualPropertySet instance() {
    try{
  ...
  @Override
  protected SecurityDomain_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_actualPropertySet.Matcher instantiate() {
    return SecurityDomain_actualPropertySet.Matcher.create();
  }
  
  @Override
  public SecurityDomain_actualPropertySet.Match newEmptyMatch() {
    return SecurityDomain_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_actualPropertySet.Match newMatch(final Object... parameters) {
    return SecurityDomain_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_actualPropertySet INSTANCE = new SecurityDomain_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
