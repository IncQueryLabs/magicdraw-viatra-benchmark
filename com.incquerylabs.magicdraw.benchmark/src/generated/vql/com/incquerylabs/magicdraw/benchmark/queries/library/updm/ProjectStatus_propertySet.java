...
public final class ProjectStatus_propertySet extends BaseGeneratedEMFQuerySpecification<ProjectStatus_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectStatus_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectStatus_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectStatus_propertySet.Match)) {
          ProjectStatus_propertySet.Match other = (ProjectStatus_propertySet.Match) obj;
    ...
    @Override
    public ProjectStatus_propertySet specification() {
      return ProjectStatus_propertySet.instance();
    }
     ...
     * 
     */
    public static ProjectStatus_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectStatus_propertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectStatus_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectStatus_propertySet.Match {
    ...
    private static final class Immutable extends ProjectStatus_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectStatus_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectStatus_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectStatus_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectStatus_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectStatus_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectStatus_propertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectStatus_propertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectStatus_propertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ProjectStatus_propertySet.Match> processor) {
     ...
     * 
     */
    public ProjectStatus_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ProjectStatus_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ProjectStatus_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ProjectStatus_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectStatus_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectStatus_propertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectStatus_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectStatus_propertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectStatus_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectStatus_propertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectStatus_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectStatus_propertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectStatus_propertySet.Matcher> querySpecification() {
      return ProjectStatus_propertySet.instance();
    }
  }
  
  private ProjectStatus_propertySet() {
   ...
   * 
   */
  public static ProjectStatus_propertySet instance() {
    try{
  ...
  @Override
  protected ProjectStatus_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectStatus_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectStatus_propertySet.Matcher instantiate() {
    return ProjectStatus_propertySet.Matcher.create();
  }
  
  @Override
  public ProjectStatus_propertySet.Match newEmptyMatch() {
    return ProjectStatus_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectStatus_propertySet.Match newMatch(final Object... parameters) {
    return ProjectStatus_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectStatus_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectStatus_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectStatus_propertySet INSTANCE = new ProjectStatus_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectStatus_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
