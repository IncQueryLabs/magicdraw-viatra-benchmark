...
public final class ResourceSignalProperty_conformsTo extends BaseGeneratedEMFQuerySpecification<ResourceSignalProperty_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceSignalProperty_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceSignalProperty_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceSignalProperty_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ResourceSignalProperty_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceSignalProperty_conformsTo.Match)) {
          ResourceSignalProperty_conformsTo.Match other = (ResourceSignalProperty_conformsTo.Match) obj;
    ...
    @Override
    public ResourceSignalProperty_conformsTo specification() {
      return ResourceSignalProperty_conformsTo.instance();
    }
     ...
     * 
     */
    public static ResourceSignalProperty_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceSignalProperty_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceSignalProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceSignalProperty_conformsTo.Match {
    ...
    private static final class Immutable extends ResourceSignalProperty_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceSignalProperty_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ResourceSignalProperty_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceSignalProperty_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ResourceSignalProperty_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceSignalProperty_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceSignalProperty_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceSignalProperty_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceSignalProperty_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceSignalProperty_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceSignalProperty_conformsTo.Match> processor) {
     ...
     * 
     */
    public ResourceSignalProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceSignalProperty_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceSignalProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceSignalProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceSignalProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceSignalProperty_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ResourceSignalProperty_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceSignalProperty_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceSignalProperty_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceSignalProperty_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceSignalProperty_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceSignalProperty_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceSignalProperty_conformsTo.Matcher> querySpecification() {
      return ResourceSignalProperty_conformsTo.instance();
    }
  }
  
  private ResourceSignalProperty_conformsTo() {
   ...
   * 
   */
  public static ResourceSignalProperty_conformsTo instance() {
    try{
  ...
  @Override
  protected ResourceSignalProperty_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceSignalProperty_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ResourceSignalProperty_conformsTo.Matcher instantiate() {
    return ResourceSignalProperty_conformsTo.Matcher.create();
  }
  
  @Override
  public ResourceSignalProperty_conformsTo.Match newEmptyMatch() {
    return ResourceSignalProperty_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceSignalProperty_conformsTo.Match newMatch(final Object... parameters) {
    return ResourceSignalProperty_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceSignalProperty_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceSignalProperty_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceSignalProperty_conformsTo INSTANCE = new ResourceSignalProperty_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceSignalProperty_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
