...
public final class FunctionalStandard_conformsTo extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_conformsTo.Match)) {
          FunctionalStandard_conformsTo.Match other = (FunctionalStandard_conformsTo.Match) obj;
    ...
    @Override
    public FunctionalStandard_conformsTo specification() {
      return FunctionalStandard_conformsTo.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static FunctionalStandard_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalStandard_conformsTo.Match {
    ...
    private static final class Immutable extends FunctionalStandard_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FunctionalStandard_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FunctionalStandard_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super FunctionalStandard_conformsTo.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return FunctionalStandard_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final FunctionalStandard_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final FunctionalStandard_conformsTo.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalStandard_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_conformsTo.Matcher> querySpecification() {
      return FunctionalStandard_conformsTo.instance();
    }
  }
  
  private FunctionalStandard_conformsTo() {
   ...
   * 
   */
  public static FunctionalStandard_conformsTo instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_conformsTo.Matcher instantiate() {
    return FunctionalStandard_conformsTo.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_conformsTo.Match newEmptyMatch() {
    return FunctionalStandard_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_conformsTo.Match newMatch(final Object... parameters) {
    return FunctionalStandard_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_conformsTo INSTANCE = new FunctionalStandard_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
