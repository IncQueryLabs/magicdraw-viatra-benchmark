...
public final class OperationalArchitecture_isEncapsulated extends BaseGeneratedEMFQuerySpecification<OperationalArchitecture_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalArchitecture_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public OperationalArchitecture_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalArchitecture_isEncapsulated.Match)) {
          OperationalArchitecture_isEncapsulated.Match other = (OperationalArchitecture_isEncapsulated.Match) obj;
    ...
    @Override
    public OperationalArchitecture_isEncapsulated specification() {
      return OperationalArchitecture_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static OperationalArchitecture_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalArchitecture_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static OperationalArchitecture_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalArchitecture_isEncapsulated.Match {
    ...
    private static final class Immutable extends OperationalArchitecture_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see OperationalArchitecture_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalArchitecture_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static OperationalArchitecture_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalArchitecture_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalArchitecture_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalArchitecture_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<OperationalArchitecture_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<OperationalArchitecture_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super OperationalArchitecture_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public OperationalArchitecture_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return OperationalArchitecture_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalArchitecture_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalArchitecture_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final OperationalArchitecture_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final OperationalArchitecture_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected OperationalArchitecture_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalArchitecture_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalArchitecture_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalArchitecture_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalArchitecture_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalArchitecture_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalArchitecture_isEncapsulated.Matcher> querySpecification() {
      return OperationalArchitecture_isEncapsulated.instance();
    }
  }
  
  private OperationalArchitecture_isEncapsulated() {
   ...
   * 
   */
  public static OperationalArchitecture_isEncapsulated instance() {
    try{
  ...
  @Override
  protected OperationalArchitecture_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalArchitecture_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public OperationalArchitecture_isEncapsulated.Matcher instantiate() {
    return OperationalArchitecture_isEncapsulated.Matcher.create();
  }
  
  @Override
  public OperationalArchitecture_isEncapsulated.Match newEmptyMatch() {
    return OperationalArchitecture_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalArchitecture_isEncapsulated.Match newMatch(final Object... parameters) {
    return OperationalArchitecture_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalArchitecture_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalArchitecture_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalArchitecture_isEncapsulated INSTANCE = new OperationalArchitecture_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalArchitecture_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
