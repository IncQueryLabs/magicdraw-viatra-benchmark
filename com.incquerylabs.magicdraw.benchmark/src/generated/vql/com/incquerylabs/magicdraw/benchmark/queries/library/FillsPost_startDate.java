...
public final class FillsPost_startDate extends BaseGeneratedEMFQuerySpecification<FillsPost_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_startDate";
    }
     ...
     * 
     */
    public static FillsPost_startDate.Match newMutableMatch(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public static FillsPost_startDate.Match newMatch(final Abstraction pElement, final Element pValue) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_startDate pattern,
  ...
  public static class Matcher extends BaseMatcher<FillsPost_startDate.Match> {
     ...
     * 
     */
    public Collection<FillsPost_startDate.Match> getAllMatches(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FillsPost_startDate.Match> streamAllMatches(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FillsPost_startDate.Match> getOneArbitraryMatch(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Element pValue, final Consumer<? super FillsPost_startDate.Match> processor) {
     ...
     * 
     */
    public FillsPost_startDate.Match newMatch(final Abstraction pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final FillsPost_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final FillsPost_startDate.Match partialMatch) {
    ...
    protected FillsPost_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return FillsPost_startDate.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    protected FillsPost_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return FillsPost_startDate.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected FillsPost_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FillsPost_startDate.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public FillsPost_startDate.Match newMatch(final Object... parameters) {
    return FillsPost_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
