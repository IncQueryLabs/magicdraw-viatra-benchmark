...
public final class FunctionalRequirement_Master extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.functionalRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.functionalRequirement_Master";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.functionalRequirement_Master pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link FunctionalRequirement_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalRequirement_Master#instance()}.
   * 
