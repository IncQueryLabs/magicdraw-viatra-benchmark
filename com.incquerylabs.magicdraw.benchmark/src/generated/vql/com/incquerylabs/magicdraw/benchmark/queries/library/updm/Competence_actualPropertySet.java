...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence;
...
public final class Competence_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Competence_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Competence_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Competence_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Competence_actualPropertySet.Match)) {
          Competence_actualPropertySet.Match other = (Competence_actualPropertySet.Match) obj;
    ...
    @Override
    public Competence_actualPropertySet specification() {
      return Competence_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Competence_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Competence_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Competence_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Competence_actualPropertySet.Match {
    ...
    private static final class Immutable extends Competence_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Competence_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Competence_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Competence_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Competence_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Competence_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Competence_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Competence_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Competence_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Competence_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Competence_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Competence_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Competence_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Competence_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Competence_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Competence_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Competence_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Competence_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Competence_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Competence_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Competence_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Competence_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Competence_actualPropertySet.Matcher> querySpecification() {
      return Competence_actualPropertySet.instance();
    }
  }
  
  private Competence_actualPropertySet() {
   ...
   * 
   */
  public static Competence_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Competence_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Competence_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Competence_actualPropertySet.Matcher instantiate() {
    return Competence_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Competence_actualPropertySet.Match newEmptyMatch() {
    return Competence_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Competence_actualPropertySet.Match newMatch(final Object... parameters) {
    return Competence_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Competence_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Competence_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Competence_actualPropertySet INSTANCE = new Competence_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Competence_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Competence(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Competence.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
