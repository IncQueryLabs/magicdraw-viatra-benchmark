...
import com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart;
...
public final class TemporalPart_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<TemporalPart_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return TemporalPart_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public TemporalPart_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TemporalPart_actualMeasurementSet.Match)) {
          TemporalPart_actualMeasurementSet.Match other = (TemporalPart_actualMeasurementSet.Match) obj;
    ...
    @Override
    public TemporalPart_actualMeasurementSet specification() {
      return TemporalPart_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static TemporalPart_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static TemporalPart_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static TemporalPart_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TemporalPart_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends TemporalPart_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see TemporalPart_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<TemporalPart_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static TemporalPart_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TemporalPart_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TemporalPart_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<TemporalPart_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TemporalPart_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TemporalPart_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super TemporalPart_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public TemporalPart_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return TemporalPart_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TemporalPart_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TemporalPart_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TemporalPart_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TemporalPart_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected TemporalPart_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return TemporalPart_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TemporalPart_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return TemporalPart_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TemporalPart_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TemporalPart_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TemporalPart_actualMeasurementSet.Matcher> querySpecification() {
      return TemporalPart_actualMeasurementSet.instance();
    }
  }
  
  private TemporalPart_actualMeasurementSet() {
   ...
   * 
   */
  public static TemporalPart_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected TemporalPart_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return TemporalPart_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public TemporalPart_actualMeasurementSet.Matcher instantiate() {
    return TemporalPart_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public TemporalPart_actualMeasurementSet.Match newEmptyMatch() {
    return TemporalPart_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public TemporalPart_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return TemporalPart_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TemporalPart_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TemporalPart_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TemporalPart_actualMeasurementSet INSTANCE = new TemporalPart_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TemporalPart_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find TemporalPart(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), TemporalPart.instance().getInternalQueryRepresentation());
