...
public final class OrganizationType_startBoundaryType extends BaseGeneratedEMFQuerySpecification<OrganizationType_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_startBoundaryType.Match)) {
          OrganizationType_startBoundaryType.Match other = (OrganizationType_startBoundaryType.Match) obj;
    ...
    @Override
    public OrganizationType_startBoundaryType specification() {
      return OrganizationType_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static OrganizationType_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_startBoundaryType.Match {
    ...
    private static final class Immutable extends OrganizationType_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public OrganizationType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_startBoundaryType.Matcher> querySpecification() {
      return OrganizationType_startBoundaryType.instance();
    }
  }
  
  private OrganizationType_startBoundaryType() {
   ...
   * 
   */
  public static OrganizationType_startBoundaryType instance() {
    try{
  ...
  @Override
  protected OrganizationType_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_startBoundaryType.Matcher instantiate() {
    return OrganizationType_startBoundaryType.Matcher.create();
  }
  
  @Override
  public OrganizationType_startBoundaryType.Match newEmptyMatch() {
    return OrganizationType_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_startBoundaryType.Match newMatch(final Object... parameters) {
    return OrganizationType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_startBoundaryType INSTANCE = new OrganizationType_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
