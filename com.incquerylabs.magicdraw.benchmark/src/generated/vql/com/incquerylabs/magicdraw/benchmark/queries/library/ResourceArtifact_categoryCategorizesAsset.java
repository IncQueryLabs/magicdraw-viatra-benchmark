...
public final class ResourceArtifact_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_categoryCategorizesAsset.Match)) {
          ResourceArtifact_categoryCategorizesAsset.Match other = (ResourceArtifact_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public ResourceArtifact_categoryCategorizesAsset specification() {
      return ResourceArtifact_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends ResourceArtifact_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_categoryCategorizesAsset.Matcher> querySpecification() {
      return ResourceArtifact_categoryCategorizesAsset.instance();
    }
  }
  
  private ResourceArtifact_categoryCategorizesAsset() {
   ...
   * 
   */
  public static ResourceArtifact_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_categoryCategorizesAsset.Matcher instantiate() {
    return ResourceArtifact_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_categoryCategorizesAsset.Match newEmptyMatch() {
    return ResourceArtifact_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return ResourceArtifact_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_categoryCategorizesAsset INSTANCE = new ResourceArtifact_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
