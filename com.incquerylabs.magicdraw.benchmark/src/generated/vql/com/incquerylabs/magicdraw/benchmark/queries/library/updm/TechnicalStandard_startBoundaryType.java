...
public final class TechnicalStandard_startBoundaryType extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_startBoundaryType.Match)) {
          TechnicalStandard_startBoundaryType.Match other = (TechnicalStandard_startBoundaryType.Match) obj;
    ...
    @Override
    public TechnicalStandard_startBoundaryType specification() {
      return TechnicalStandard_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static TechnicalStandard_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TechnicalStandard_startBoundaryType.Match {
    ...
    private static final class Immutable extends TechnicalStandard_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TechnicalStandard_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TechnicalStandard_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super TechnicalStandard_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return TechnicalStandard_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TechnicalStandard_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TechnicalStandard_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TechnicalStandard_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_startBoundaryType.Matcher> querySpecification() {
      return TechnicalStandard_startBoundaryType.instance();
    }
  }
  
  private TechnicalStandard_startBoundaryType() {
   ...
   * 
   */
  public static TechnicalStandard_startBoundaryType instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_startBoundaryType.Matcher instantiate() {
    return TechnicalStandard_startBoundaryType.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_startBoundaryType.Match newEmptyMatch() {
    return TechnicalStandard_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_startBoundaryType.Match newMatch(final Object... parameters) {
    return TechnicalStandard_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_startBoundaryType INSTANCE = new TechnicalStandard_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
