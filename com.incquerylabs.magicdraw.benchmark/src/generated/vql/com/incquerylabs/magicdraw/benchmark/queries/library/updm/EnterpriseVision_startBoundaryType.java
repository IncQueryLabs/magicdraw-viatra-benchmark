...
public final class EnterpriseVision_startBoundaryType extends BaseGeneratedEMFQuerySpecification<EnterpriseVision_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseVision_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseVision_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseVision_startBoundaryType.Match)) {
          EnterpriseVision_startBoundaryType.Match other = (EnterpriseVision_startBoundaryType.Match) obj;
    ...
    @Override
    public EnterpriseVision_startBoundaryType specification() {
      return EnterpriseVision_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static EnterpriseVision_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseVision_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseVision_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseVision_startBoundaryType.Match {
    ...
    private static final class Immutable extends EnterpriseVision_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseVision_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseVision_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseVision_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseVision_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseVision_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseVision_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseVision_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseVision_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseVision_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public EnterpriseVision_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseVision_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseVision_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseVision_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseVision_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseVision_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EnterpriseVision_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseVision_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseVision_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseVision_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseVision_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseVision_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseVision_startBoundaryType.Matcher> querySpecification() {
      return EnterpriseVision_startBoundaryType.instance();
    }
  }
  
  private EnterpriseVision_startBoundaryType() {
   ...
   * 
   */
  public static EnterpriseVision_startBoundaryType instance() {
    try{
  ...
  @Override
  protected EnterpriseVision_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseVision_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseVision_startBoundaryType.Matcher instantiate() {
    return EnterpriseVision_startBoundaryType.Matcher.create();
  }
  
  @Override
  public EnterpriseVision_startBoundaryType.Match newEmptyMatch() {
    return EnterpriseVision_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseVision_startBoundaryType.Match newMatch(final Object... parameters) {
    return EnterpriseVision_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseVision_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseVision_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseVision_startBoundaryType INSTANCE = new EnterpriseVision_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseVision_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
