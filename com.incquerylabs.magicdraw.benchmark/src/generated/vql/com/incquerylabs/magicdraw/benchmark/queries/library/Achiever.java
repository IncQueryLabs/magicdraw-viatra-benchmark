...
public final class Achiever extends BaseGeneratedEMFQuerySpecification<Achiever.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Achiever pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Achiever";
    }
    
    @Override
    public List<String> parameterNames() {
      return Achiever.Match.parameterNames;
    }
    ...
    @Override
    public Achiever.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Achiever.Match)) {
          Achiever.Match other = (Achiever.Match) obj;
    ...
    @Override
    public Achiever specification() {
      return Achiever.instance();
    }
     ...
     * 
     */
    public static Achiever.Match newEmptyMatch() {
     ...
     * 
     */
    public static Achiever.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Achiever.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Achiever.Match {
    ...
    private static final class Immutable extends Achiever.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Achiever pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Achiever.Match> {
    /**
     ...
     * 
     */
    public static Achiever.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Achiever.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Achiever.Matcher.class);
     ...
     * 
     */
    public Collection<Achiever.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Achiever.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Achiever.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Achiever.Match> processor) {
     ...
     * 
     */
    public Achiever.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Achiever.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Achiever.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Achiever.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Achiever.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Achiever.Match partialMatch) {
    ...
    @Override
    protected Achiever.Match tupleToMatch(final Tuple t) {
      try {
          return Achiever.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Achiever.Match arrayToMatch(final Object[] match) {
      try {
          return Achiever.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Achiever.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Achiever.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Achiever.Matcher> querySpecification() {
      return Achiever.instance();
    }
  }
  ...
  @Override
  protected Achiever.Matcher instantiate(final ViatraQueryEngine engine) {
    return Achiever.Matcher.on(engine);
  }
  
  @Override
  public Achiever.Matcher instantiate() {
    return Achiever.Matcher.create();
  }
  
  @Override
  public Achiever.Match newEmptyMatch() {
    return Achiever.Match.newEmptyMatch();
  }
  
  @Override
  public Achiever.Match newMatch(final Object... parameters) {
    return Achiever.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Achiever} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Achiever#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Achiever INSTANCE = new Achiever();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Achiever.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Achiever")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Achiever");
