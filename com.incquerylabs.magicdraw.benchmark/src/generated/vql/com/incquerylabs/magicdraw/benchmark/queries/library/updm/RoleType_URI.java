...
public final class RoleType_URI extends BaseGeneratedEMFQuerySpecification<RoleType_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_URI.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_URI.Match)) {
          RoleType_URI.Match other = (RoleType_URI.Match) obj;
    ...
    @Override
    public RoleType_URI specification() {
      return RoleType_URI.instance();
    }
     ...
     * 
     */
    public static RoleType_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static RoleType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends RoleType_URI.Match {
    ...
    private static final class Immutable extends RoleType_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_URI.Match> {
    /**
     ...
     * 
     */
    public static RoleType_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_URI.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<RoleType_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<RoleType_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super RoleType_URI.Match> processor) {
     ...
     * 
     */
    public RoleType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return RoleType_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final RoleType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final RoleType_URI.Match partialMatch) {
    ...
    @Override
    protected RoleType_URI.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected RoleType_URI.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_URI.Matcher> querySpecification() {
      return RoleType_URI.instance();
    }
  }
  
  private RoleType_URI() {
   ...
   * 
   */
  public static RoleType_URI instance() {
    try{
  ...
  @Override
  protected RoleType_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_URI.Matcher.on(engine);
  }
  
  @Override
  public RoleType_URI.Matcher instantiate() {
    return RoleType_URI.Matcher.create();
  }
  
  @Override
  public RoleType_URI.Match newEmptyMatch() {
    return RoleType_URI.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_URI.Match newMatch(final Object... parameters) {
    return RoleType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_URI INSTANCE = new RoleType_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
