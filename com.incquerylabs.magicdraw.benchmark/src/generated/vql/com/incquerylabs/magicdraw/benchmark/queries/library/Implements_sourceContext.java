...
public final class Implements_sourceContext extends BaseGeneratedEMFQuerySpecification<Implements_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Implements_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Implements_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public Implements_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Implements_sourceContext.Match)) {
          Implements_sourceContext.Match other = (Implements_sourceContext.Match) obj;
    ...
    @Override
    public Implements_sourceContext specification() {
      return Implements_sourceContext.instance();
    }
     ...
     * 
     */
    public static Implements_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Implements_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Implements_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Implements_sourceContext.Match {
    ...
    private static final class Immutable extends Implements_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see Implements_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<Implements_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static Implements_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Implements_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Implements_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<Implements_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Implements_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Implements_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Implements_sourceContext.Match> processor) {
     ...
     * 
     */
    public Implements_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Implements_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Implements_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Implements_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Implements_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Implements_sourceContext.Match partialMatch) {
    ...
    @Override
    protected Implements_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return Implements_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Implements_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return Implements_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Implements_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Implements_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Implements_sourceContext.Matcher> querySpecification() {
      return Implements_sourceContext.instance();
    }
  }
  
  private Implements_sourceContext() {
   ...
   * 
   */
  public static Implements_sourceContext instance() {
    try{
  ...
  @Override
  protected Implements_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Implements_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public Implements_sourceContext.Matcher instantiate() {
    return Implements_sourceContext.Matcher.create();
  }
  
  @Override
  public Implements_sourceContext.Match newEmptyMatch() {
    return Implements_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public Implements_sourceContext.Match newMatch(final Object... parameters) {
    return Implements_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Implements_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Implements_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Implements_sourceContext INSTANCE = new Implements_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Implements_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
