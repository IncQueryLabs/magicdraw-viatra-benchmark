...
public final class OperationalSignalProperty_conformsTo extends BaseGeneratedEMFQuerySpecification<OperationalSignalProperty_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalSignalProperty_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalSignalProperty_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalSignalProperty_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public OperationalSignalProperty_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalSignalProperty_conformsTo.Match)) {
          OperationalSignalProperty_conformsTo.Match other = (OperationalSignalProperty_conformsTo.Match) obj;
    ...
    @Override
    public OperationalSignalProperty_conformsTo specification() {
      return OperationalSignalProperty_conformsTo.instance();
    }
     ...
     * 
     */
    public static OperationalSignalProperty_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalSignalProperty_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalSignalProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalSignalProperty_conformsTo.Match {
    ...
    private static final class Immutable extends OperationalSignalProperty_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalSignalProperty_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see OperationalSignalProperty_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalSignalProperty_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static OperationalSignalProperty_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalSignalProperty_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalSignalProperty_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalSignalProperty_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalSignalProperty_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalSignalProperty_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super OperationalSignalProperty_conformsTo.Match> processor) {
     ...
     * 
     */
    public OperationalSignalProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return OperationalSignalProperty_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalSignalProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalSignalProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalSignalProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalSignalProperty_conformsTo.Match partialMatch) {
    ...
    @Override
    protected OperationalSignalProperty_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalSignalProperty_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalSignalProperty_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalSignalProperty_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalSignalProperty_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalSignalProperty_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalSignalProperty_conformsTo.Matcher> querySpecification() {
      return OperationalSignalProperty_conformsTo.instance();
    }
  }
  
  private OperationalSignalProperty_conformsTo() {
   ...
   * 
   */
  public static OperationalSignalProperty_conformsTo instance() {
    try{
  ...
  @Override
  protected OperationalSignalProperty_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalSignalProperty_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public OperationalSignalProperty_conformsTo.Matcher instantiate() {
    return OperationalSignalProperty_conformsTo.Matcher.create();
  }
  
  @Override
  public OperationalSignalProperty_conformsTo.Match newEmptyMatch() {
    return OperationalSignalProperty_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalSignalProperty_conformsTo.Match newMatch(final Object... parameters) {
    return OperationalSignalProperty_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalSignalProperty_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalSignalProperty_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalSignalProperty_conformsTo INSTANCE = new OperationalSignalProperty_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalSignalProperty_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
