 ...
 * <p>Original source:
 *         <code><pre>
 *         //Pattern that queries the 'source' attribute of elements with the stereotype 'alternatives'.
 *         pattern alternatives_source(Element : Property, Value: Element) {
...
public final class Alternatives_source extends BaseGeneratedEMFQuerySpecification<Alternatives_source.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.alternatives_source pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.alternatives_source";
    }
    
    @Override
    public List<String> parameterNames() {
      return Alternatives_source.Match.parameterNames;
    }
    ...
    @Override
    public Alternatives_source.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Alternatives_source.Match)) {
          Alternatives_source.Match other = (Alternatives_source.Match) obj;
    ...
    @Override
    public Alternatives_source specification() {
     ...
     * 
     */
    public static Alternatives_source.Match newEmptyMatch() {
     ...
     * 
     */
    public static Alternatives_source.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static Alternatives_source.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Alternatives_source.Match {
    ...
    private static final class Immutable extends Alternatives_source.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.alternatives_source pattern,
   ...
   * 
   * @see Match
   * @see Alternatives_source
   * 
   */
  public static class Matcher extends BaseMatcher<Alternatives_source.Match> {
    /**
     ...
     * 
     */
    public static Alternatives_source.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Alternatives_source.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Alternatives_source.Matcher.class);
     ...
     * 
     */
    public Collection<Alternatives_source.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Alternatives_source.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Alternatives_source.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super Alternatives_source.Match> processor) {
     ...
     * 
     */
    public Alternatives_source.Match newMatch(final Property pElement, final Element pValue) {
      return Alternatives_source.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfElement(final Alternatives_source.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfElement(final Alternatives_source.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final Alternatives_source.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final Alternatives_source.Match partialMatch) {
    ...
    @Override
    protected Alternatives_source.Match tupleToMatch(final Tuple t) {
      try {
          return Alternatives_source.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Alternatives_source.Match arrayToMatch(final Object[] match) {
      try {
          return Alternatives_source.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Alternatives_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Alternatives_source.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Alternatives_source.Matcher> querySpecification() {
      return Alternatives_source.instance();
    }
  }
  
  private Alternatives_source() {
   ...
   * 
   */
  public static Alternatives_source instance() {
    try{
  ...
  @Override
  protected Alternatives_source.Matcher instantiate(final ViatraQueryEngine engine) {
    return Alternatives_source.Matcher.on(engine);
  }
  
  @Override
  public Alternatives_source.Matcher instantiate() {
    return Alternatives_source.Matcher.create();
  }
  
  @Override
  public Alternatives_source.Match newEmptyMatch() {
    return Alternatives_source.Match.newEmptyMatch();
  }
  
  @Override
  public Alternatives_source.Match newMatch(final Object... parameters) {
    return Alternatives_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Alternatives_source} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Alternatives_source#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Alternatives_source INSTANCE = new Alternatives_source();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Alternatives_source.GeneratedPQuery INSTANCE = new GeneratedPQuery();
