...
public final class OperationalExchange extends BaseGeneratedEMFQuerySpecification<OperationalExchange.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalExchange pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalExchange";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalExchange.Match.parameterNames;
    }
    ...
    @Override
    public OperationalExchange.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalExchange.Match)) {
          OperationalExchange.Match other = (OperationalExchange.Match) obj;
    ...
    @Override
    public OperationalExchange specification() {
      return OperationalExchange.instance();
    }
     ...
     * 
     */
    public static OperationalExchange.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalExchange.Match newMutableMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalExchange.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalExchange.Match {
    ...
    private static final class Immutable extends OperationalExchange.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalExchange pattern,
   ...
   * 
   * @see Match
   * @see OperationalExchange
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalExchange.Match> {
    /**
     ...
     * 
     */
    public static OperationalExchange.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalExchange.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalExchange.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalExchange.Match> getAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalExchange.Match> streamAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalExchange.Match> getOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalExchange.Match> processor) {
     ...
     * 
     */
    public OperationalExchange.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalExchange.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final OperationalExchange.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final OperationalExchange.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalExchange.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalExchange.Match partialMatch) {
    ...
    @Override
    protected OperationalExchange.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalExchange.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalExchange.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalExchange.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalExchange.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalExchange.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalExchange.Matcher> querySpecification() {
      return OperationalExchange.instance();
    }
  }
  
  private OperationalExchange() {
   ...
   * 
   */
  public static OperationalExchange instance() {
    try{
  ...
  @Override
  protected OperationalExchange.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalExchange.Matcher.on(engine);
  }
  
  @Override
  public OperationalExchange.Matcher instantiate() {
    return OperationalExchange.Matcher.create();
  }
  
  @Override
  public OperationalExchange.Match newEmptyMatch() {
    return OperationalExchange.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalExchange.Match newMatch(final Object... parameters) {
    return OperationalExchange.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalExchange} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalExchange#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalExchange INSTANCE = new OperationalExchange();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalExchange.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalExchange")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalExchange");
