...
public final class BlocksOrRequirements extends BaseGeneratedEMFQuerySpecification<BlocksOrRequirements.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.blocksOrRequirements pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.blocksOrRequirements";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.blocksOrRequirements pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<BlocksOrRequirements.Match> {
    /**
     ...
     * 
     */
    public Collection<BlocksOrRequirements.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public Stream<BlocksOrRequirements.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public Optional<BlocksOrRequirements.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass) {
     ...
     * 
     */
    public static IQuerySpecification<BlocksOrRequirements.Matcher> querySpecification() {
      return BlocksOrRequirements.instance();
    }
  }
