...
public final class EnterprisePhase_startBoundaryType extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_startBoundaryType.Match)) {
          EnterprisePhase_startBoundaryType.Match other = (EnterprisePhase_startBoundaryType.Match) obj;
    ...
    @Override
    public EnterprisePhase_startBoundaryType specification() {
      return EnterprisePhase_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_startBoundaryType.Match {
    ...
    private static final class Immutable extends EnterprisePhase_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_startBoundaryType.Matcher> querySpecification() {
      return EnterprisePhase_startBoundaryType.instance();
    }
  }
  
  private EnterprisePhase_startBoundaryType() {
   ...
   * 
   */
  public static EnterprisePhase_startBoundaryType instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_startBoundaryType.Matcher instantiate() {
    return EnterprisePhase_startBoundaryType.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_startBoundaryType.Match newEmptyMatch() {
    return EnterprisePhase_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_startBoundaryType.Match newMatch(final Object... parameters) {
    return EnterprisePhase_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_startBoundaryType INSTANCE = new EnterprisePhase_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
