...
public final class MeasurableElement extends BaseGeneratedEMFQuerySpecification<MeasurableElement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.MeasurableElement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.MeasurableElement";
    }
    
    @Override
    public List<String> parameterNames() {
      return MeasurableElement.Match.parameterNames;
    }
    ...
    @Override
    public MeasurableElement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof MeasurableElement.Match)) {
          MeasurableElement.Match other = (MeasurableElement.Match) obj;
    ...
    @Override
    public MeasurableElement specification() {
      return MeasurableElement.instance();
    }
     ...
     * 
     */
    public static MeasurableElement.Match newEmptyMatch() {
     ...
     * 
     */
    public static MeasurableElement.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static MeasurableElement.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends MeasurableElement.Match {
    ...
    private static final class Immutable extends MeasurableElement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.MeasurableElement pattern,
   ...
   * 
   * @see Match
   * @see MeasurableElement
   * 
   */
  public static class Matcher extends BaseMatcher<MeasurableElement.Match> {
    /**
     ...
     * 
     */
    public static MeasurableElement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static MeasurableElement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MeasurableElement.Matcher.class);
     ...
     * 
     */
    public Collection<MeasurableElement.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<MeasurableElement.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<MeasurableElement.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super MeasurableElement.Match> processor) {
     ...
     * 
     */
    public MeasurableElement.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return MeasurableElement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final MeasurableElement.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final MeasurableElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final MeasurableElement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final MeasurableElement.Match partialMatch) {
    ...
    @Override
    protected MeasurableElement.Match tupleToMatch(final Tuple t) {
      try {
          return MeasurableElement.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected MeasurableElement.Match arrayToMatch(final Object[] match) {
      try {
          return MeasurableElement.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected MeasurableElement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return MeasurableElement.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<MeasurableElement.Matcher> querySpecification() {
      return MeasurableElement.instance();
    }
  }
  
  private MeasurableElement() {
   ...
   * 
   */
  public static MeasurableElement instance() {
    try{
  ...
  @Override
  protected MeasurableElement.Matcher instantiate(final ViatraQueryEngine engine) {
    return MeasurableElement.Matcher.on(engine);
  }
  
  @Override
  public MeasurableElement.Matcher instantiate() {
    return MeasurableElement.Matcher.create();
  }
  
  @Override
  public MeasurableElement.Match newEmptyMatch() {
    return MeasurableElement.Match.newEmptyMatch();
  }
  
  @Override
  public MeasurableElement.Match newMatch(final Object... parameters) {
    return MeasurableElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MeasurableElement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link MeasurableElement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final MeasurableElement INSTANCE = new MeasurableElement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final MeasurableElement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "MeasurableElement")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "MeasurableElement");
