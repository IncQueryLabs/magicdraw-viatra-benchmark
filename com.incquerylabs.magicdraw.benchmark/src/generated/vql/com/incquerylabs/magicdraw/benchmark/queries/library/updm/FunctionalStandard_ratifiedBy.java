...
public final class FunctionalStandard_ratifiedBy extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_ratifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_ratifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_ratifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_ratifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_ratifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_ratifiedBy.Match)) {
          FunctionalStandard_ratifiedBy.Match other = (FunctionalStandard_ratifiedBy.Match) obj;
    ...
    @Override
    public FunctionalStandard_ratifiedBy specification() {
      return FunctionalStandard_ratifiedBy.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_ratifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_ratifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static FunctionalStandard_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalStandard_ratifiedBy.Match {
    ...
    private static final class Immutable extends FunctionalStandard_ratifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_ratifiedBy pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_ratifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_ratifiedBy.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_ratifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_ratifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_ratifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_ratifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FunctionalStandard_ratifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FunctionalStandard_ratifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super FunctionalStandard_ratifiedBy.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return FunctionalStandard_ratifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final FunctionalStandard_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final FunctionalStandard_ratifiedBy.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_ratifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalStandard_ratifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_ratifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_ratifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_ratifiedBy.Matcher> querySpecification() {
      return FunctionalStandard_ratifiedBy.instance();
    }
  }
  
  private FunctionalStandard_ratifiedBy() {
   ...
   * 
   */
  public static FunctionalStandard_ratifiedBy instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_ratifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_ratifiedBy.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_ratifiedBy.Matcher instantiate() {
    return FunctionalStandard_ratifiedBy.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_ratifiedBy.Match newEmptyMatch() {
    return FunctionalStandard_ratifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_ratifiedBy.Match newMatch(final Object... parameters) {
    return FunctionalStandard_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_ratifiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_ratifiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_ratifiedBy INSTANCE = new FunctionalStandard_ratifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_ratifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "ratifiedBy");
