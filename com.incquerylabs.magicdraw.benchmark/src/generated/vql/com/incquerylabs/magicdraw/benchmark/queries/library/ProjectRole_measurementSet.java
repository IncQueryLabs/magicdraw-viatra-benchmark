...
public final class ProjectRole_measurementSet extends BaseGeneratedEMFQuerySpecification<ProjectRole_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectRole_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectRole_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectRole_measurementSet.Match)) {
          ProjectRole_measurementSet.Match other = (ProjectRole_measurementSet.Match) obj;
    ...
    @Override
    public ProjectRole_measurementSet specification() {
      return ProjectRole_measurementSet.instance();
    }
     ...
     * 
     */
    public static ProjectRole_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectRole_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectRole_measurementSet.Match {
    ...
    private static final class Immutable extends ProjectRole_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see ProjectRole_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectRole_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static ProjectRole_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectRole_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectRole_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectRole_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectRole_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectRole_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectRole_measurementSet.Match> processor) {
     ...
     * 
     */
    public ProjectRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectRole_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectRole_measurementSet.Match partialMatch) {
    ...
    @Override
    protected ProjectRole_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectRole_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectRole_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectRole_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectRole_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectRole_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectRole_measurementSet.Matcher> querySpecification() {
      return ProjectRole_measurementSet.instance();
    }
  }
  
  private ProjectRole_measurementSet() {
   ...
   * 
   */
  public static ProjectRole_measurementSet instance() {
    try{
  ...
  @Override
  protected ProjectRole_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectRole_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public ProjectRole_measurementSet.Matcher instantiate() {
    return ProjectRole_measurementSet.Matcher.create();
  }
  
  @Override
  public ProjectRole_measurementSet.Match newEmptyMatch() {
    return ProjectRole_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectRole_measurementSet.Match newMatch(final Object... parameters) {
    return ProjectRole_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectRole_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectRole_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectRole_measurementSet INSTANCE = new ProjectRole_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectRole_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
