...
public final class ResourceRole_physicalLocation extends BaseGeneratedEMFQuerySpecification<ResourceRole_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_physicalLocation.Match)) {
          ResourceRole_physicalLocation.Match other = (ResourceRole_physicalLocation.Match) obj;
    ...
    @Override
    public ResourceRole_physicalLocation specification() {
      return ResourceRole_physicalLocation.instance();
    }
     ...
     * 
     */
    public static ResourceRole_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_physicalLocation.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_physicalLocation.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_physicalLocation.Match {
    ...
    private static final class Immutable extends ResourceRole_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_physicalLocation.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_physicalLocation.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_physicalLocation.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_physicalLocation.Match> processor) {
     ...
     * 
     */
    public ResourceRole_physicalLocation.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_physicalLocation.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_physicalLocation.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_physicalLocation.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_physicalLocation.Matcher> querySpecification() {
      return ResourceRole_physicalLocation.instance();
    }
  }
  
  private ResourceRole_physicalLocation() {
   ...
   * 
   */
  public static ResourceRole_physicalLocation instance() {
    try{
  ...
  @Override
  protected ResourceRole_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_physicalLocation.Matcher instantiate() {
    return ResourceRole_physicalLocation.Matcher.create();
  }
  
  @Override
  public ResourceRole_physicalLocation.Match newEmptyMatch() {
    return ResourceRole_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_physicalLocation.Match newMatch(final Object... parameters) {
    return ResourceRole_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_physicalLocation INSTANCE = new ResourceRole_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
