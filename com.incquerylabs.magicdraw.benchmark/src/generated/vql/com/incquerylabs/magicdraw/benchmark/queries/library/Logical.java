...
public final class Logical extends BaseGeneratedEMFQuerySpecification<Logical.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Logical pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Logical";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Logical pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Logical} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Logical#instance()}.
   * 
