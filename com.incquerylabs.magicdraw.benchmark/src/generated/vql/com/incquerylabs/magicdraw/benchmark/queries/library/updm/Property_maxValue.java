...
public final class Property_maxValue extends BaseGeneratedEMFQuerySpecification<Property_maxValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_maxValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_maxValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return Property_maxValue.Match.parameterNames;
    }
    ...
    @Override
    public Property_maxValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Property_maxValue.Match)) {
          Property_maxValue.Match other = (Property_maxValue.Match) obj;
    ...
    @Override
    public Property_maxValue specification() {
      return Property_maxValue.instance();
    }
     ...
     * 
     */
    public static Property_maxValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static Property_maxValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Property_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Property_maxValue.Match {
    ...
    private static final class Immutable extends Property_maxValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_maxValue pattern,
   ...
   * 
   * @see Match
   * @see Property_maxValue
   * 
   */
  public static class Matcher extends BaseMatcher<Property_maxValue.Match> {
    /**
     ...
     * 
     */
    public static Property_maxValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Property_maxValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Property_maxValue.Matcher.class);
     ...
     * 
     */
    public Collection<Property_maxValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Property_maxValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Property_maxValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super Property_maxValue.Match> processor) {
     ...
     * 
     */
    public Property_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return Property_maxValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Property_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Property_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Property_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Property_maxValue.Match partialMatch) {
    ...
    @Override
    protected Property_maxValue.Match tupleToMatch(final Tuple t) {
      try {
          return Property_maxValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Property_maxValue.Match arrayToMatch(final Object[] match) {
      try {
          return Property_maxValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Property_maxValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Property_maxValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Property_maxValue.Matcher> querySpecification() {
      return Property_maxValue.instance();
    }
  }
  
  private Property_maxValue() {
   ...
   * 
   */
  public static Property_maxValue instance() {
    try{
  ...
  @Override
  protected Property_maxValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return Property_maxValue.Matcher.on(engine);
  }
  
  @Override
  public Property_maxValue.Matcher instantiate() {
    return Property_maxValue.Matcher.create();
  }
  
  @Override
  public Property_maxValue.Match newEmptyMatch() {
    return Property_maxValue.Match.newEmptyMatch();
  }
  
  @Override
  public Property_maxValue.Match newMatch(final Object... parameters) {
    return Property_maxValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Property_maxValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Property_maxValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Property_maxValue INSTANCE = new Property_maxValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Property_maxValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
