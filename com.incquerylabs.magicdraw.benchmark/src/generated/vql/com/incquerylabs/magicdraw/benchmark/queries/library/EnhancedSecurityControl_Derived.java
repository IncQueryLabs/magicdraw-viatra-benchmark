...
public final class EnhancedSecurityControl_Derived extends BaseGeneratedEMFQuerySpecification<EnhancedSecurityControl_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnhancedSecurityControl_Derived.Match.parameterNames;
    }
    ...
    @Override
    public EnhancedSecurityControl_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnhancedSecurityControl_Derived.Match)) {
          EnhancedSecurityControl_Derived.Match other = (EnhancedSecurityControl_Derived.Match) obj;
    ...
    @Override
    public EnhancedSecurityControl_Derived specification() {
      return EnhancedSecurityControl_Derived.instance();
    }
     ...
     * 
     */
    public static EnhancedSecurityControl_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnhancedSecurityControl_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnhancedSecurityControl_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnhancedSecurityControl_Derived.Match {
    ...
    private static final class Immutable extends EnhancedSecurityControl_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Derived pattern,
   ...
   * 
   * @see Match
   * @see EnhancedSecurityControl_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<EnhancedSecurityControl_Derived.Match> {
    /**
     ...
     * 
     */
    public static EnhancedSecurityControl_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnhancedSecurityControl_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnhancedSecurityControl_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<EnhancedSecurityControl_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnhancedSecurityControl_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnhancedSecurityControl_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnhancedSecurityControl_Derived.Match> processor) {
     ...
     * 
     */
    public EnhancedSecurityControl_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnhancedSecurityControl_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnhancedSecurityControl_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnhancedSecurityControl_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnhancedSecurityControl_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnhancedSecurityControl_Derived.Match partialMatch) {
    ...
    @Override
    protected EnhancedSecurityControl_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return EnhancedSecurityControl_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnhancedSecurityControl_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return EnhancedSecurityControl_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnhancedSecurityControl_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnhancedSecurityControl_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnhancedSecurityControl_Derived.Matcher> querySpecification() {
      return EnhancedSecurityControl_Derived.instance();
    }
  }
  
  private EnhancedSecurityControl_Derived() {
   ...
   * 
   */
  public static EnhancedSecurityControl_Derived instance() {
    try{
  ...
  @Override
  protected EnhancedSecurityControl_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnhancedSecurityControl_Derived.Matcher.on(engine);
  }
  
  @Override
  public EnhancedSecurityControl_Derived.Matcher instantiate() {
    return EnhancedSecurityControl_Derived.Matcher.create();
  }
  
  @Override
  public EnhancedSecurityControl_Derived.Match newEmptyMatch() {
    return EnhancedSecurityControl_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public EnhancedSecurityControl_Derived.Match newMatch(final Object... parameters) {
    return EnhancedSecurityControl_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnhancedSecurityControl_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnhancedSecurityControl_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnhancedSecurityControl_Derived INSTANCE = new EnhancedSecurityControl_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnhancedSecurityControl_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
