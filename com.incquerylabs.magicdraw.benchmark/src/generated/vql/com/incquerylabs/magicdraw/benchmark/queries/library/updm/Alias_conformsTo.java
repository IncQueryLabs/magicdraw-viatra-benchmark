...
public final class Alias_conformsTo extends BaseGeneratedEMFQuerySpecification<Alias_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Alias_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Alias_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Alias_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Alias_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Alias_conformsTo.Match)) {
          Alias_conformsTo.Match other = (Alias_conformsTo.Match) obj;
    ...
    @Override
    public Alias_conformsTo specification() {
      return Alias_conformsTo.instance();
    }
     ...
     * 
     */
    public static Alias_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Alias_conformsTo.Match newMutableMatch(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public static Alias_conformsTo.Match newMatch(final Comment pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Alias_conformsTo.Match {
    ...
    private static final class Immutable extends Alias_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Alias_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Alias_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Alias_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Alias_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Alias_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Alias_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Alias_conformsTo.Match> getAllMatches(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Alias_conformsTo.Match> streamAllMatches(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Alias_conformsTo.Match> getOneArbitraryMatch(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final Element pValue, final Consumer<? super Alias_conformsTo.Match> processor) {
     ...
     * 
     */
    public Alias_conformsTo.Match newMatch(final Comment pElement, final Element pValue) {
      return Alias_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Alias_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Alias_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Alias_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Alias_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Alias_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Alias_conformsTo.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Alias_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Alias_conformsTo.Match.newMatch((Comment) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Alias_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Alias_conformsTo.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Alias_conformsTo.Matcher> querySpecification() {
      return Alias_conformsTo.instance();
    }
  }
  
  private Alias_conformsTo() {
   ...
   * 
   */
  public static Alias_conformsTo instance() {
    try{
  ...
  @Override
  protected Alias_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Alias_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Alias_conformsTo.Matcher instantiate() {
    return Alias_conformsTo.Matcher.create();
  }
  
  @Override
  public Alias_conformsTo.Match newEmptyMatch() {
    return Alias_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Alias_conformsTo.Match newMatch(final Object... parameters) {
    return Alias_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Alias_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Alias_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Alias_conformsTo INSTANCE = new Alias_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Alias_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
