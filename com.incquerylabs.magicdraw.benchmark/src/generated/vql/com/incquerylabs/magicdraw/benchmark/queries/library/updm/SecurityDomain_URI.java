...
public final class SecurityDomain_URI extends BaseGeneratedEMFQuerySpecification<SecurityDomain_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_URI.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_URI.Match)) {
          SecurityDomain_URI.Match other = (SecurityDomain_URI.Match) obj;
    ...
    @Override
    public SecurityDomain_URI specification() {
      return SecurityDomain_URI.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SecurityDomain_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityDomain_URI.Match {
    ...
    private static final class Immutable extends SecurityDomain_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_URI pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_URI
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_URI.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_URI.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SecurityDomain_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SecurityDomain_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super SecurityDomain_URI.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return SecurityDomain_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SecurityDomain_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SecurityDomain_URI.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_URI.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityDomain_URI.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_URI.Matcher> querySpecification() {
      return SecurityDomain_URI.instance();
    }
  }
  
  private SecurityDomain_URI() {
   ...
   * 
   */
  public static SecurityDomain_URI instance() {
    try{
  ...
  @Override
  protected SecurityDomain_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_URI.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_URI.Matcher instantiate() {
    return SecurityDomain_URI.Matcher.create();
  }
  
  @Override
  public SecurityDomain_URI.Match newEmptyMatch() {
    return SecurityDomain_URI.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_URI.Match newMatch(final Object... parameters) {
    return SecurityDomain_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_URI INSTANCE = new SecurityDomain_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
