...
public final class ProtocolLayer_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ProtocolLayer_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolLayer_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolLayer_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolLayer_endBoundaryType.Match)) {
          ProtocolLayer_endBoundaryType.Match other = (ProtocolLayer_endBoundaryType.Match) obj;
    ...
    @Override
    public ProtocolLayer_endBoundaryType specification() {
      return ProtocolLayer_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProtocolLayer_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolLayer_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolLayer_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolLayer_endBoundaryType.Match {
    ...
    private static final class Immutable extends ProtocolLayer_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProtocolLayer_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolLayer_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProtocolLayer_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolLayer_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolLayer_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolLayer_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolLayer_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolLayer_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProtocolLayer_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProtocolLayer_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ProtocolLayer_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProtocolLayer_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProtocolLayer_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolLayer_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolLayer_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProtocolLayer_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolLayer_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolLayer_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolLayer_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolLayer_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolLayer_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolLayer_endBoundaryType.Matcher> querySpecification() {
      return ProtocolLayer_endBoundaryType.instance();
    }
  }
  
  private ProtocolLayer_endBoundaryType() {
   ...
   * 
   */
  public static ProtocolLayer_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ProtocolLayer_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolLayer_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProtocolLayer_endBoundaryType.Matcher instantiate() {
    return ProtocolLayer_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ProtocolLayer_endBoundaryType.Match newEmptyMatch() {
    return ProtocolLayer_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolLayer_endBoundaryType.Match newMatch(final Object... parameters) {
    return ProtocolLayer_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolLayer_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolLayer_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolLayer_endBoundaryType INSTANCE = new ProtocolLayer_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolLayer_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
