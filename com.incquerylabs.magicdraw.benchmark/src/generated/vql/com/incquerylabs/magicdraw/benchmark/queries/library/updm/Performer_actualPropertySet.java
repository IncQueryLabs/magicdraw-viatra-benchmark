...
public final class Performer_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Performer_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Performer_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_actualPropertySet.Match)) {
          Performer_actualPropertySet.Match other = (Performer_actualPropertySet.Match) obj;
    ...
    @Override
    public Performer_actualPropertySet specification() {
      return Performer_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Performer_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_actualPropertySet.Match {
    ...
    private static final class Immutable extends Performer_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Performer_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Performer_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Performer_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Performer_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_actualPropertySet.Matcher> querySpecification() {
      return Performer_actualPropertySet.instance();
    }
  }
  
  private Performer_actualPropertySet() {
   ...
   * 
   */
  public static Performer_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Performer_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Performer_actualPropertySet.Matcher instantiate() {
    return Performer_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Performer_actualPropertySet.Match newEmptyMatch() {
    return Performer_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_actualPropertySet.Match newMatch(final Object... parameters) {
    return Performer_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_actualPropertySet INSTANCE = new Performer_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
