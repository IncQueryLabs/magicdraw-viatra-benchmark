...
public final class ExchangeElement_physicalLocation extends BaseGeneratedEMFQuerySpecification<ExchangeElement_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_physicalLocation.Match)) {
          ExchangeElement_physicalLocation.Match other = (ExchangeElement_physicalLocation.Match) obj;
    ...
    @Override
    public ExchangeElement_physicalLocation specification() {
      return ExchangeElement_physicalLocation.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_physicalLocation.Match {
    ...
    private static final class Immutable extends ExchangeElement_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_physicalLocation.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_physicalLocation.Matcher> querySpecification() {
      return ExchangeElement_physicalLocation.instance();
    }
  }
  
  private ExchangeElement_physicalLocation() {
   ...
   * 
   */
  public static ExchangeElement_physicalLocation instance() {
    try{
  ...
  @Override
  protected ExchangeElement_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_physicalLocation.Matcher instantiate() {
    return ExchangeElement_physicalLocation.Matcher.create();
  }
  
  @Override
  public ExchangeElement_physicalLocation.Match newEmptyMatch() {
    return ExchangeElement_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_physicalLocation.Match newMatch(final Object... parameters) {
    return ExchangeElement_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_physicalLocation INSTANCE = new ExchangeElement_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
