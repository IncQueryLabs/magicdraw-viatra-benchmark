...
public final class Measurement_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Measurement_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measurement_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Measurement_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measurement_startBoundaryType.Match)) {
          Measurement_startBoundaryType.Match other = (Measurement_startBoundaryType.Match) obj;
    ...
    @Override
    public Measurement_startBoundaryType specification() {
      return Measurement_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Measurement_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measurement_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static Measurement_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Measurement_startBoundaryType.Match {
    ...
    private static final class Immutable extends Measurement_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Measurement_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Measurement_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Measurement_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measurement_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measurement_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Measurement_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Measurement_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Measurement_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super Measurement_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Measurement_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return Measurement_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Measurement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Measurement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Measurement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Measurement_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Measurement_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Measurement_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Measurement_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Measurement_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measurement_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measurement_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measurement_startBoundaryType.Matcher> querySpecification() {
      return Measurement_startBoundaryType.instance();
    }
  }
  
  private Measurement_startBoundaryType() {
   ...
   * 
   */
  public static Measurement_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Measurement_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measurement_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Measurement_startBoundaryType.Matcher instantiate() {
    return Measurement_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Measurement_startBoundaryType.Match newEmptyMatch() {
    return Measurement_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Measurement_startBoundaryType.Match newMatch(final Object... parameters) {
    return Measurement_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measurement_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measurement_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Measurement_startBoundaryType INSTANCE = new Measurement_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measurement_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
