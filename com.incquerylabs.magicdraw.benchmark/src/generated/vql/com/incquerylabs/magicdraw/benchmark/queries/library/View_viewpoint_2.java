...
public final class View_viewpoint_2 extends BaseGeneratedEMFQuerySpecification<View_viewpoint_2.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.View_viewpoint_2 pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.View_viewpoint_2";
    }
    
    @Override
    public List<String> parameterNames() {
      return View_viewpoint_2.Match.parameterNames;
    }
    ...
    @Override
    public View_viewpoint_2.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof View_viewpoint_2.Match)) {
          View_viewpoint_2.Match other = (View_viewpoint_2.Match) obj;
    ...
    @Override
    public View_viewpoint_2 specification() {
      return View_viewpoint_2.instance();
    }
     ...
     * 
     */
    public static View_viewpoint_2.Match newEmptyMatch() {
     ...
     * 
     */
    public static View_viewpoint_2.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static View_viewpoint_2.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends View_viewpoint_2.Match {
    ...
    private static final class Immutable extends View_viewpoint_2.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.View_viewpoint_2 pattern,
   ...
   * 
   * @see Match
   * @see View_viewpoint_2
   * 
   */
  public static class Matcher extends BaseMatcher<View_viewpoint_2.Match> {
    /**
     ...
     * 
     */
    public static View_viewpoint_2.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static View_viewpoint_2.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(View_viewpoint_2.Matcher.class);
     ...
     * 
     */
    public Collection<View_viewpoint_2.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<View_viewpoint_2.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<View_viewpoint_2.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super View_viewpoint_2.Match> processor) {
     ...
     * 
     */
    public View_viewpoint_2.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return View_viewpoint_2.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final View_viewpoint_2.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final View_viewpoint_2.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfvalue(final View_viewpoint_2.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfvalue(final View_viewpoint_2.Match partialMatch) {
    ...
    @Override
    protected View_viewpoint_2.Match tupleToMatch(final Tuple t) {
      try {
          return View_viewpoint_2.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    @Override
    protected View_viewpoint_2.Match arrayToMatch(final Object[] match) {
      try {
          return View_viewpoint_2.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected View_viewpoint_2.Match arrayToMatchMutable(final Object[] match) {
      try {
          return View_viewpoint_2.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<View_viewpoint_2.Matcher> querySpecification() {
      return View_viewpoint_2.instance();
    }
  }
  
  private View_viewpoint_2() {
   ...
   * 
   */
  public static View_viewpoint_2 instance() {
    try{
  ...
  @Override
  protected View_viewpoint_2.Matcher instantiate(final ViatraQueryEngine engine) {
    return View_viewpoint_2.Matcher.on(engine);
  }
  
  @Override
  public View_viewpoint_2.Matcher instantiate() {
    return View_viewpoint_2.Matcher.create();
  }
  
  @Override
  public View_viewpoint_2.Match newEmptyMatch() {
    return View_viewpoint_2.Match.newEmptyMatch();
  }
  
  @Override
  public View_viewpoint_2.Match newMatch(final Object... parameters) {
    return View_viewpoint_2.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link View_viewpoint_2} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link View_viewpoint_2#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final View_viewpoint_2 INSTANCE = new View_viewpoint_2();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final View_viewpoint_2.GeneratedPQuery INSTANCE = new GeneratedPQuery();
