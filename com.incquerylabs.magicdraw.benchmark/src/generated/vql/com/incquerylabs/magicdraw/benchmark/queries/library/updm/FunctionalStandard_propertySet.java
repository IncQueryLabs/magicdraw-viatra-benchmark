...
public final class FunctionalStandard_propertySet extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_propertySet.Match)) {
          FunctionalStandard_propertySet.Match other = (FunctionalStandard_propertySet.Match) obj;
    ...
    @Override
    public FunctionalStandard_propertySet specification() {
      return FunctionalStandard_propertySet.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static FunctionalStandard_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalStandard_propertySet.Match {
    ...
    private static final class Immutable extends FunctionalStandard_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_propertySet pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_propertySet.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FunctionalStandard_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FunctionalStandard_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super FunctionalStandard_propertySet.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return FunctionalStandard_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final FunctionalStandard_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final FunctionalStandard_propertySet.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalStandard_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_propertySet.Matcher> querySpecification() {
      return FunctionalStandard_propertySet.instance();
    }
  }
  
  private FunctionalStandard_propertySet() {
   ...
   * 
   */
  public static FunctionalStandard_propertySet instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_propertySet.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_propertySet.Matcher instantiate() {
    return FunctionalStandard_propertySet.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_propertySet.Match newEmptyMatch() {
    return FunctionalStandard_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_propertySet.Match newMatch(final Object... parameters) {
    return FunctionalStandard_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_propertySet INSTANCE = new FunctionalStandard_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
