...
public final class Energy_affectedFunctions extends BaseGeneratedEMFQuerySpecification<Energy_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public Energy_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_affectedFunctions.Match)) {
          Energy_affectedFunctions.Match other = (Energy_affectedFunctions.Match) obj;
    ...
    @Override
    public Energy_affectedFunctions specification() {
      return Energy_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static Energy_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_affectedFunctions.Match {
    ...
    private static final class Immutable extends Energy_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see Energy_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static Energy_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public Energy_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected Energy_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_affectedFunctions.Matcher> querySpecification() {
      return Energy_affectedFunctions.instance();
    }
  }
  
  private Energy_affectedFunctions() {
   ...
   * 
   */
  public static Energy_affectedFunctions instance() {
    try{
  ...
  @Override
  protected Energy_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public Energy_affectedFunctions.Matcher instantiate() {
    return Energy_affectedFunctions.Matcher.create();
  }
  
  @Override
  public Energy_affectedFunctions.Match newEmptyMatch() {
    return Energy_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_affectedFunctions.Match newMatch(final Object... parameters) {
    return Energy_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_affectedFunctions INSTANCE = new Energy_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
