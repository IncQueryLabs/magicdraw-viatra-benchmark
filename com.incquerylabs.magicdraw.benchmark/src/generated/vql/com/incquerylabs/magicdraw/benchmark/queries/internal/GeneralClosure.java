...
public final class GeneralClosure extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private GeneralClosure() {
   ...
   * 
   */
  public static GeneralClosure instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.internal.GeneralClosure (visibility: PUBLIC, simpleName: GeneralClosure, identifier: com.incquerylabs.magicdraw.benchmark.queries.internal.GeneralClosure, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class LazyHolder {
    private static final GeneralClosure INSTANCE = new GeneralClosure();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.generalClosure";
    }
