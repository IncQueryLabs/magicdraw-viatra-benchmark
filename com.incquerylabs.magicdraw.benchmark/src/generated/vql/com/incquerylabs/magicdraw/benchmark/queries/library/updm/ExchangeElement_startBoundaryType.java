...
public final class ExchangeElement_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ExchangeElement_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_startBoundaryType.Match)) {
          ExchangeElement_startBoundaryType.Match other = (ExchangeElement_startBoundaryType.Match) obj;
    ...
    @Override
    public ExchangeElement_startBoundaryType specification() {
      return ExchangeElement_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_startBoundaryType.Match {
    ...
    private static final class Immutable extends ExchangeElement_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_startBoundaryType.Matcher> querySpecification() {
      return ExchangeElement_startBoundaryType.instance();
    }
  }
  
  private ExchangeElement_startBoundaryType() {
   ...
   * 
   */
  public static ExchangeElement_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ExchangeElement_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_startBoundaryType.Matcher instantiate() {
    return ExchangeElement_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ExchangeElement_startBoundaryType.Match newEmptyMatch() {
    return ExchangeElement_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_startBoundaryType.Match newMatch(final Object... parameters) {
    return ExchangeElement_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_startBoundaryType INSTANCE = new ExchangeElement_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
