...
public final class OwnsRisk extends BaseGeneratedEMFQuerySpecification<OwnsRisk.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRisk.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRisk.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRisk.Match)) {
          OwnsRisk.Match other = (OwnsRisk.Match) obj;
    ...
    @Override
    public OwnsRisk specification() {
      return OwnsRisk.instance();
    }
     ...
     * 
     */
    public static OwnsRisk.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRisk.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OwnsRisk.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OwnsRisk.Match {
    ...
    private static final class Immutable extends OwnsRisk.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRisk.Match> {
    /**
     ...
     * 
     */
    public static OwnsRisk.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRisk.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRisk.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRisk.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OwnsRisk.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OwnsRisk.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OwnsRisk.Match> processor) {
     ...
     * 
     */
    public OwnsRisk.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OwnsRisk.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRisk.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRisk.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OwnsRisk.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OwnsRisk.Match partialMatch) {
    ...
    @Override
    protected OwnsRisk.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRisk.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OwnsRisk.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRisk.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRisk.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRisk.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRisk.Matcher> querySpecification() {
      return OwnsRisk.instance();
    }
  }
   ...
   * 
   */
  public static OwnsRisk instance() {
    try{
  ...
  @Override
  protected OwnsRisk.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRisk.Matcher.on(engine);
  }
  
  @Override
  public OwnsRisk.Matcher instantiate() {
    return OwnsRisk.Matcher.create();
  }
  
  @Override
  public OwnsRisk.Match newEmptyMatch() {
    return OwnsRisk.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRisk.Match newMatch(final Object... parameters) {
    return OwnsRisk.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRisk} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRisk#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRisk INSTANCE = new OwnsRisk();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRisk.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OwnsRisk")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OwnsRisk");
