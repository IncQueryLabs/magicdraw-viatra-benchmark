...
public final class Alias_URI extends BaseGeneratedEMFQuerySpecification<Alias_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Alias_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Alias_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Alias_URI.Match.parameterNames;
    }
    ...
    @Override
    public Alias_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Alias_URI.Match)) {
          Alias_URI.Match other = (Alias_URI.Match) obj;
    ...
    @Override
    public Alias_URI specification() {
      return Alias_URI.instance();
    }
     ...
     * 
     */
    public static Alias_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Alias_URI.Match newMutableMatch(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Alias_URI.Match newMatch(final Comment pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Alias_URI.Match {
    ...
    private static final class Immutable extends Alias_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Alias_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Alias_URI.Match> {
    /**
     ...
     * 
     */
    public static Alias_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Alias_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Alias_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Alias_URI.Match> getAllMatches(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Alias_URI.Match> streamAllMatches(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Alias_URI.Match> getOneArbitraryMatch(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final LiteralString pValuespec, final Consumer<? super Alias_URI.Match> processor) {
     ...
     * 
     */
    public Alias_URI.Match newMatch(final Comment pElement, final LiteralString pValuespec) {
      return Alias_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Alias_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Alias_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Alias_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Alias_URI.Match partialMatch) {
    ...
    @Override
    protected Alias_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Alias_URI.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Alias_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Alias_URI.Match.newMatch((Comment) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Alias_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Alias_URI.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Alias_URI.Matcher> querySpecification() {
      return Alias_URI.instance();
    }
  }
   ...
   * 
   */
  public static Alias_URI instance() {
    try{
  ...
  @Override
  protected Alias_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Alias_URI.Matcher.on(engine);
  }
  
  @Override
  public Alias_URI.Matcher instantiate() {
    return Alias_URI.Matcher.create();
  }
  
  @Override
  public Alias_URI.Match newEmptyMatch() {
    return Alias_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Alias_URI.Match newMatch(final Object... parameters) {
    return Alias_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Alias_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Alias_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Alias_URI INSTANCE = new Alias_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Alias_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
