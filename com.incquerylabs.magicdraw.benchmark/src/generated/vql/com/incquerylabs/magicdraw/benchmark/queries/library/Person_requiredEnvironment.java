...
public final class Person_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Person_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Person_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Person_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_requiredEnvironment.Match)) {
          Person_requiredEnvironment.Match other = (Person_requiredEnvironment.Match) obj;
    ...
    @Override
    public Person_requiredEnvironment specification() {
      return Person_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Person_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Person_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Person_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Person_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Person_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Person_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Person_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Person_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Person_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Person_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Person_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Person_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Person_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Person_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Person_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Person_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Person_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Person_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Person_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_requiredEnvironment.Matcher> querySpecification() {
      return Person_requiredEnvironment.instance();
    }
  }
  
  private Person_requiredEnvironment() {
   ...
   * 
   */
  public static Person_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Person_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Person_requiredEnvironment.Matcher instantiate() {
    return Person_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Person_requiredEnvironment.Match newEmptyMatch() {
    return Person_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Person_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Person_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_requiredEnvironment INSTANCE = new Person_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
