...
public final class Protocol_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Protocol_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_actualPropertySet.Match)) {
          Protocol_actualPropertySet.Match other = (Protocol_actualPropertySet.Match) obj;
    ...
    @Override
    public Protocol_actualPropertySet specification() {
      return Protocol_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Protocol_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Protocol_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Protocol_actualPropertySet.Match {
    ...
    private static final class Immutable extends Protocol_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Protocol_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Protocol_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Protocol_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Protocol_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Protocol_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Protocol_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Protocol_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Protocol_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Protocol_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Protocol_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Protocol_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_actualPropertySet.Matcher> querySpecification() {
      return Protocol_actualPropertySet.instance();
    }
  }
  
  private Protocol_actualPropertySet() {
   ...
   * 
   */
  public static Protocol_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Protocol_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Protocol_actualPropertySet.Matcher instantiate() {
    return Protocol_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Protocol_actualPropertySet.Match newEmptyMatch() {
    return Protocol_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_actualPropertySet.Match newMatch(final Object... parameters) {
    return Protocol_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_actualPropertySet INSTANCE = new Protocol_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
