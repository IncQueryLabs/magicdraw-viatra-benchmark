...
public final class Project_endDate extends BaseGeneratedEMFQuerySpecification<Project_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_endDate.Match.parameterNames;
    }
    ...
    @Override
    public Project_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_endDate.Match)) {
          Project_endDate.Match other = (Project_endDate.Match) obj;
    ...
    @Override
    public Project_endDate specification() {
      return Project_endDate.instance();
    }
     ...
     * 
     */
    public static Project_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_endDate.Match newMutableMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public static Project_endDate.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Project_endDate.Match {
    ...
    private static final class Immutable extends Project_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_endDate pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Project_endDate.Match> {
    /**
     ...
     * 
     */
    public static Project_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<Project_endDate.Match> getAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Project_endDate.Match> streamAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Project_endDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue, final Consumer<? super Project_endDate.Match> processor) {
     ...
     * 
     */
    public Project_endDate.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return Project_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Project_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Project_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Project_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Project_endDate.Match partialMatch) {
    ...
    @Override
    protected Project_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return Project_endDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Project_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return Project_endDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_endDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_endDate.Matcher> querySpecification() {
      return Project_endDate.instance();
    }
  }
   ...
   * 
   */
  public static Project_endDate instance() {
    try{
  ...
  @Override
  protected Project_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_endDate.Matcher.on(engine);
  }
  
  @Override
  public Project_endDate.Matcher instantiate() {
    return Project_endDate.Matcher.create();
  }
  
  @Override
  public Project_endDate.Match newEmptyMatch() {
    return Project_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public Project_endDate.Match newMatch(final Object... parameters) {
    return Project_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_endDate INSTANCE = new Project_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
