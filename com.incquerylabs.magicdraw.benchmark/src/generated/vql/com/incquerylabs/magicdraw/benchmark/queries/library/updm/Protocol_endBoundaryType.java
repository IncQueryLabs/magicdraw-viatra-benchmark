...
public final class Protocol_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Protocol_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_endBoundaryType.Match)) {
          Protocol_endBoundaryType.Match other = (Protocol_endBoundaryType.Match) obj;
    ...
    @Override
    public Protocol_endBoundaryType specification() {
      return Protocol_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Protocol_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Protocol_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Protocol_endBoundaryType.Match {
    ...
    private static final class Immutable extends Protocol_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Protocol_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Protocol_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Protocol_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Protocol_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Protocol_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Protocol_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Protocol_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Protocol_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Protocol_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Protocol_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Protocol_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_endBoundaryType.Matcher> querySpecification() {
      return Protocol_endBoundaryType.instance();
    }
  }
  
  private Protocol_endBoundaryType() {
   ...
   * 
   */
  public static Protocol_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Protocol_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Protocol_endBoundaryType.Matcher instantiate() {
    return Protocol_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Protocol_endBoundaryType.Match newEmptyMatch() {
    return Protocol_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_endBoundaryType.Match newMatch(final Object... parameters) {
    return Protocol_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_endBoundaryType INSTANCE = new Protocol_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
