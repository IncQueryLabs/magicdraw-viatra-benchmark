...
public final class NodeParent_actsUpon extends BaseGeneratedEMFQuerySpecification<NodeParent_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_actsUpon.Match)) {
          NodeParent_actsUpon.Match other = (NodeParent_actsUpon.Match) obj;
    ...
    @Override
    public NodeParent_actsUpon specification() {
      return NodeParent_actsUpon.instance();
    }
     ...
     * 
     */
    public static NodeParent_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeParent_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeParent_actsUpon.Match {
    ...
    private static final class Immutable extends NodeParent_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see NodeParent_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeParent_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeParent_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NodeParent_actsUpon.Match> processor) {
     ...
     * 
     */
    public NodeParent_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NodeParent_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeParent_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeParent_actsUpon.Match partialMatch) {
    ...
    @Override
    protected NodeParent_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeParent_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_actsUpon.Matcher> querySpecification() {
      return NodeParent_actsUpon.instance();
    }
  }
  
  private NodeParent_actsUpon() {
   ...
   * 
   */
  public static NodeParent_actsUpon instance() {
    try{
  ...
  @Override
  protected NodeParent_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_actsUpon.Matcher instantiate() {
    return NodeParent_actsUpon.Matcher.create();
  }
  
  @Override
  public NodeParent_actsUpon.Match newEmptyMatch() {
    return NodeParent_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_actsUpon.Match newMatch(final Object... parameters) {
    return NodeParent_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_actsUpon INSTANCE = new NodeParent_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
