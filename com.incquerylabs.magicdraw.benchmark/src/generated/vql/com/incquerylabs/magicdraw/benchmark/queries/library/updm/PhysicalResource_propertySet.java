...
public final class PhysicalResource_propertySet extends BaseGeneratedEMFQuerySpecification<PhysicalResource_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_propertySet.Match)) {
          PhysicalResource_propertySet.Match other = (PhysicalResource_propertySet.Match) obj;
    ...
    @Override
    public PhysicalResource_propertySet specification() {
      return PhysicalResource_propertySet.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_propertySet.Match {
    ...
    private static final class Immutable extends PhysicalResource_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_propertySet pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_propertySet.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_propertySet.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_propertySet.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_propertySet.Matcher> querySpecification() {
      return PhysicalResource_propertySet.instance();
    }
  }
  
  private PhysicalResource_propertySet() {
   ...
   * 
   */
  public static PhysicalResource_propertySet instance() {
    try{
  ...
  @Override
  protected PhysicalResource_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_propertySet.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_propertySet.Matcher instantiate() {
    return PhysicalResource_propertySet.Matcher.create();
  }
  
  @Override
  public PhysicalResource_propertySet.Match newEmptyMatch() {
    return PhysicalResource_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_propertySet.Match newMatch(final Object... parameters) {
    return PhysicalResource_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_propertySet INSTANCE = new PhysicalResource_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
