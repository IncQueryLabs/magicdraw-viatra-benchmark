...
public final class Person_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Person_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Person_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_startBoundaryType.Match)) {
          Person_startBoundaryType.Match other = (Person_startBoundaryType.Match) obj;
    ...
    @Override
    public Person_startBoundaryType specification() {
      return Person_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Person_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Person_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Person_startBoundaryType.Match {
    ...
    private static final class Immutable extends Person_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Person_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Person_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Person_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Person_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Person_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Person_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Person_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Person_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Person_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Person_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Person_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Person_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Person_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Person_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Person_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_startBoundaryType.Matcher> querySpecification() {
      return Person_startBoundaryType.instance();
    }
  }
  
  private Person_startBoundaryType() {
   ...
   * 
   */
  public static Person_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Person_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Person_startBoundaryType.Matcher instantiate() {
    return Person_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Person_startBoundaryType.Match newEmptyMatch() {
    return Person_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Person_startBoundaryType.Match newMatch(final Object... parameters) {
    return Person_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_startBoundaryType INSTANCE = new Person_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
