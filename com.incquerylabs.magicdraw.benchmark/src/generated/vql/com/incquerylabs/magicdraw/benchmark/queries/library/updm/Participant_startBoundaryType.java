...
public final class Participant_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Participant_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Participant_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_startBoundaryType.Match)) {
          Participant_startBoundaryType.Match other = (Participant_startBoundaryType.Match) obj;
    ...
    @Override
    public Participant_startBoundaryType specification() {
      return Participant_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Participant_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Participant_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Participant_startBoundaryType.Match {
    ...
    private static final class Immutable extends Participant_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Participant_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Participant_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Participant_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Participant_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Participant_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Participant_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Participant_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Participant_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Participant_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Participant_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Participant_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_startBoundaryType.Matcher> querySpecification() {
      return Participant_startBoundaryType.instance();
    }
  }
  
  private Participant_startBoundaryType() {
   ...
   * 
   */
  public static Participant_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Participant_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Participant_startBoundaryType.Matcher instantiate() {
    return Participant_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Participant_startBoundaryType.Match newEmptyMatch() {
    return Participant_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_startBoundaryType.Match newMatch(final Object... parameters) {
    return Participant_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_startBoundaryType INSTANCE = new Participant_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
