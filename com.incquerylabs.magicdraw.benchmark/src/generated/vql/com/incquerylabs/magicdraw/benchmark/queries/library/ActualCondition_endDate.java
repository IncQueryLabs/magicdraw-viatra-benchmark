...
public final class ActualCondition_endDate extends BaseGeneratedEMFQuerySpecification<ActualCondition_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualCondition_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualCondition_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualCondition_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualCondition_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualCondition_endDate.Match)) {
          ActualCondition_endDate.Match other = (ActualCondition_endDate.Match) obj;
    ...
    @Override
    public ActualCondition_endDate specification() {
      return ActualCondition_endDate.instance();
    }
     ...
     * 
     */
    public static ActualCondition_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualCondition_endDate.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public static ActualCondition_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualCondition_endDate.Match {
    ...
    private static final class Immutable extends ActualCondition_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualCondition_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualCondition_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualCondition_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualCondition_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualCondition_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualCondition_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualCondition_endDate.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Stream<ActualCondition_endDate.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Optional<ActualCondition_endDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue, final Consumer<? super ActualCondition_endDate.Match> processor) {
     ...
     * 
     */
    public ActualCondition_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return ActualCondition_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualCondition_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualCondition_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvalue(final ActualCondition_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvalue(final ActualCondition_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualCondition_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualCondition_endDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualCondition_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualCondition_endDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualCondition_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualCondition_endDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualCondition_endDate.Matcher> querySpecification() {
      return ActualCondition_endDate.instance();
    }
  }
  
  private ActualCondition_endDate() {
   ...
   * 
   */
  public static ActualCondition_endDate instance() {
    try{
  ...
  @Override
  protected ActualCondition_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualCondition_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualCondition_endDate.Matcher instantiate() {
    return ActualCondition_endDate.Matcher.create();
  }
  
  @Override
  public ActualCondition_endDate.Match newEmptyMatch() {
    return ActualCondition_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualCondition_endDate.Match newMatch(final Object... parameters) {
    return ActualCondition_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualCondition_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualCondition_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualCondition_endDate INSTANCE = new ActualCondition_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualCondition_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
