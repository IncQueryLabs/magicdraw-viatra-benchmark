...
public final class RoleType_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<RoleType_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_requiredEnvironment.Match)) {
          RoleType_requiredEnvironment.Match other = (RoleType_requiredEnvironment.Match) obj;
    ...
    @Override
    public RoleType_requiredEnvironment specification() {
      return RoleType_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static RoleType_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_requiredEnvironment.Match {
    ...
    private static final class Immutable extends RoleType_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see RoleType_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static RoleType_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public RoleType_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected RoleType_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_requiredEnvironment.Matcher> querySpecification() {
      return RoleType_requiredEnvironment.instance();
    }
  }
  
  private RoleType_requiredEnvironment() {
   ...
   * 
   */
  public static RoleType_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected RoleType_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public RoleType_requiredEnvironment.Matcher instantiate() {
    return RoleType_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public RoleType_requiredEnvironment.Match newEmptyMatch() {
    return RoleType_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_requiredEnvironment.Match newMatch(final Object... parameters) {
    return RoleType_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_requiredEnvironment INSTANCE = new RoleType_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find RoleType(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), RoleType.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
