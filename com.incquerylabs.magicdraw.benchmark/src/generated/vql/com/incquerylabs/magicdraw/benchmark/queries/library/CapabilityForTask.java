...
public final class CapabilityForTask extends BaseGeneratedEMFQuerySpecification<CapabilityForTask.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityForTask.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityForTask.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityForTask.Match)) {
          CapabilityForTask.Match other = (CapabilityForTask.Match) obj;
    ...
    @Override
    public CapabilityForTask specification() {
      return CapabilityForTask.instance();
    }
     ...
     * 
     */
    public static CapabilityForTask.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityForTask.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static CapabilityForTask.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends CapabilityForTask.Match {
    ...
    private static final class Immutable extends CapabilityForTask.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask pattern,
   ...
   * 
   * @see Match
   * @see CapabilityForTask
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityForTask.Match> {
    /**
     ...
     * 
     */
    public static CapabilityForTask.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityForTask.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityForTask.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityForTask.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<CapabilityForTask.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<CapabilityForTask.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super CapabilityForTask.Match> processor) {
     ...
     * 
     */
    public CapabilityForTask.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return CapabilityForTask.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CapabilityForTask.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CapabilityForTask.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final CapabilityForTask.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final CapabilityForTask.Match partialMatch) {
    ...
    @Override
    protected CapabilityForTask.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityForTask.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected CapabilityForTask.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityForTask.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityForTask.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityForTask.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityForTask.Matcher> querySpecification() {
      return CapabilityForTask.instance();
    }
  }
  
  private CapabilityForTask() {
   ...
   * 
   */
  public static CapabilityForTask instance() {
    try{
  ...
  @Override
  protected CapabilityForTask.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityForTask.Matcher.on(engine);
  }
  
  @Override
  public CapabilityForTask.Matcher instantiate() {
    return CapabilityForTask.Matcher.create();
  }
  
  @Override
  public CapabilityForTask.Match newEmptyMatch() {
    return CapabilityForTask.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityForTask.Match newMatch(final Object... parameters) {
    return CapabilityForTask.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityForTask} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityForTask#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityForTask INSTANCE = new CapabilityForTask();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityForTask.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "CapabilityForTask")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "CapabilityForTask");
