...
public final class NodePort_conformsTo extends BaseGeneratedEMFQuerySpecification<NodePort_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodePort_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodePort_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodePort_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public NodePort_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodePort_conformsTo.Match)) {
          NodePort_conformsTo.Match other = (NodePort_conformsTo.Match) obj;
    ...
    @Override
    public NodePort_conformsTo specification() {
      return NodePort_conformsTo.instance();
    }
     ...
     * 
     */
    public static NodePort_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodePort_conformsTo.Match newMutableMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public static NodePort_conformsTo.Match newMatch(final Port pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodePort_conformsTo.Match {
    ...
    private static final class Immutable extends NodePort_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodePort_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see NodePort_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<NodePort_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static NodePort_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodePort_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodePort_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<NodePort_conformsTo.Match> getAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodePort_conformsTo.Match> streamAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodePort_conformsTo.Match> getOneArbitraryMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final Element pValue, final Consumer<? super NodePort_conformsTo.Match> processor) {
     ...
     * 
     */
    public NodePort_conformsTo.Match newMatch(final Port pElement, final Element pValue) {
      return NodePort_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final NodePort_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final NodePort_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodePort_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodePort_conformsTo.Match partialMatch) {
    ...
    @Override
    protected NodePort_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return NodePort_conformsTo.Match.newMatch((Port) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodePort_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return NodePort_conformsTo.Match.newMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodePort_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodePort_conformsTo.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodePort_conformsTo.Matcher> querySpecification() {
      return NodePort_conformsTo.instance();
    }
  }
  
  private NodePort_conformsTo() {
   ...
   * 
   */
  public static NodePort_conformsTo instance() {
    try{
  ...
  @Override
  protected NodePort_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodePort_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public NodePort_conformsTo.Matcher instantiate() {
    return NodePort_conformsTo.Matcher.create();
  }
  
  @Override
  public NodePort_conformsTo.Match newEmptyMatch() {
    return NodePort_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public NodePort_conformsTo.Match newMatch(final Object... parameters) {
    return NodePort_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodePort_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodePort_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodePort_conformsTo INSTANCE = new NodePort_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodePort_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
