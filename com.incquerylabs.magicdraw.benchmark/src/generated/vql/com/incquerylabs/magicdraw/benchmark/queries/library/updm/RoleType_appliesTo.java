...
public final class RoleType_appliesTo extends BaseGeneratedEMFQuerySpecification<RoleType_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_appliesTo.Match)) {
          RoleType_appliesTo.Match other = (RoleType_appliesTo.Match) obj;
    ...
    @Override
    public RoleType_appliesTo specification() {
      return RoleType_appliesTo.instance();
    }
     ...
     * 
     */
    public static RoleType_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_appliesTo.Match {
    ...
    private static final class Immutable extends RoleType_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see RoleType_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static RoleType_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_appliesTo.Match> processor) {
     ...
     * 
     */
    public RoleType_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_appliesTo.Match partialMatch) {
    ...
    @Override
    protected RoleType_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_appliesTo.Matcher> querySpecification() {
      return RoleType_appliesTo.instance();
    }
  }
  
  private RoleType_appliesTo() {
   ...
   * 
   */
  public static RoleType_appliesTo instance() {
    try{
  ...
  @Override
  protected RoleType_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public RoleType_appliesTo.Matcher instantiate() {
    return RoleType_appliesTo.Matcher.create();
  }
  
  @Override
  public RoleType_appliesTo.Match newEmptyMatch() {
    return RoleType_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_appliesTo.Match newMatch(final Object... parameters) {
    return RoleType_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_appliesTo INSTANCE = new RoleType_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
