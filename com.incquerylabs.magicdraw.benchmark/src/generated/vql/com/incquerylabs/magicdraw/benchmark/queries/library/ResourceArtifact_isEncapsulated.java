...
public final class ResourceArtifact_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_isEncapsulated.Match)) {
          ResourceArtifact_isEncapsulated.Match other = (ResourceArtifact_isEncapsulated.Match) obj;
    ...
    @Override
    public ResourceArtifact_isEncapsulated specification() {
      return ResourceArtifact_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ResourceArtifact_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourceArtifact_isEncapsulated.Match {
    ...
    private static final class Immutable extends ResourceArtifact_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ResourceArtifact_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ResourceArtifact_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ResourceArtifact_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ResourceArtifact_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ResourceArtifact_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ResourceArtifact_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourceArtifact_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_isEncapsulated.Matcher> querySpecification() {
      return ResourceArtifact_isEncapsulated.instance();
    }
  }
  
  private ResourceArtifact_isEncapsulated() {
   ...
   * 
   */
  public static ResourceArtifact_isEncapsulated instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_isEncapsulated.Matcher instantiate() {
    return ResourceArtifact_isEncapsulated.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_isEncapsulated.Match newEmptyMatch() {
    return ResourceArtifact_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_isEncapsulated.Match newMatch(final Object... parameters) {
    return ResourceArtifact_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_isEncapsulated INSTANCE = new ResourceArtifact_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
