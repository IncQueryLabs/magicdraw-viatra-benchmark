...
public final class NodeParent_propertySet extends BaseGeneratedEMFQuerySpecification<NodeParent_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_propertySet.Match)) {
          NodeParent_propertySet.Match other = (NodeParent_propertySet.Match) obj;
    ...
    @Override
    public NodeParent_propertySet specification() {
      return NodeParent_propertySet.instance();
    }
     ...
     * 
     */
    public static NodeParent_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeParent_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeParent_propertySet.Match {
    ...
    private static final class Immutable extends NodeParent_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_propertySet pattern,
   ...
   * 
   * @see Match
   * @see NodeParent_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_propertySet.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeParent_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeParent_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NodeParent_propertySet.Match> processor) {
     ...
     * 
     */
    public NodeParent_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NodeParent_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeParent_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeParent_propertySet.Match partialMatch) {
    ...
    @Override
    protected NodeParent_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeParent_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_propertySet.Matcher> querySpecification() {
      return NodeParent_propertySet.instance();
    }
  }
  
  private NodeParent_propertySet() {
   ...
   * 
   */
  public static NodeParent_propertySet instance() {
    try{
  ...
  @Override
  protected NodeParent_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_propertySet.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_propertySet.Matcher instantiate() {
    return NodeParent_propertySet.Matcher.create();
  }
  
  @Override
  public NodeParent_propertySet.Match newEmptyMatch() {
    return NodeParent_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_propertySet.Match newMatch(final Object... parameters) {
    return NodeParent_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_propertySet INSTANCE = new NodeParent_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
