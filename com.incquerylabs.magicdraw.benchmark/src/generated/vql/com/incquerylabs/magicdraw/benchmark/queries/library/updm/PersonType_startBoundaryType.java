...
public final class PersonType_startBoundaryType extends BaseGeneratedEMFQuerySpecification<PersonType_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_startBoundaryType.Match)) {
          PersonType_startBoundaryType.Match other = (PersonType_startBoundaryType.Match) obj;
    ...
    @Override
    public PersonType_startBoundaryType specification() {
      return PersonType_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static PersonType_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_startBoundaryType.Match {
    ...
    private static final class Immutable extends PersonType_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see PersonType_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static PersonType_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public PersonType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected PersonType_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_startBoundaryType.Matcher> querySpecification() {
      return PersonType_startBoundaryType.instance();
    }
  }
  
  private PersonType_startBoundaryType() {
   ...
   * 
   */
  public static PersonType_startBoundaryType instance() {
    try{
  ...
  @Override
  protected PersonType_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public PersonType_startBoundaryType.Matcher instantiate() {
    return PersonType_startBoundaryType.Matcher.create();
  }
  
  @Override
  public PersonType_startBoundaryType.Match newEmptyMatch() {
    return PersonType_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_startBoundaryType.Match newMatch(final Object... parameters) {
    return PersonType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_startBoundaryType INSTANCE = new PersonType_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
