...
public final class ProblemDomain_measurementSet extends BaseGeneratedEMFQuerySpecification<ProblemDomain_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_measurementSet.Match)) {
          ProblemDomain_measurementSet.Match other = (ProblemDomain_measurementSet.Match) obj;
    ...
    @Override
    public ProblemDomain_measurementSet specification() {
      return ProblemDomain_measurementSet.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_measurementSet.Match {
    ...
    private static final class Immutable extends ProblemDomain_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_measurementSet.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_measurementSet.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_measurementSet.Matcher> querySpecification() {
      return ProblemDomain_measurementSet.instance();
    }
  }
  
  private ProblemDomain_measurementSet() {
   ...
   * 
   */
  public static ProblemDomain_measurementSet instance() {
    try{
  ...
  @Override
  protected ProblemDomain_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_measurementSet.Matcher instantiate() {
    return ProblemDomain_measurementSet.Matcher.create();
  }
  
  @Override
  public ProblemDomain_measurementSet.Match newEmptyMatch() {
    return ProblemDomain_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_measurementSet.Match newMatch(final Object... parameters) {
    return ProblemDomain_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_measurementSet INSTANCE = new ProblemDomain_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
