...
public final class OperationalMitigation_isEncapsulated extends BaseGeneratedEMFQuerySpecification<OperationalMitigation_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalMitigation_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public OperationalMitigation_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalMitigation_isEncapsulated.Match)) {
          OperationalMitigation_isEncapsulated.Match other = (OperationalMitigation_isEncapsulated.Match) obj;
    ...
    @Override
    public OperationalMitigation_isEncapsulated specification() {
      return OperationalMitigation_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static OperationalMitigation_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalMitigation_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static OperationalMitigation_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalMitigation_isEncapsulated.Match {
    ...
    private static final class Immutable extends OperationalMitigation_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see OperationalMitigation_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalMitigation_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static OperationalMitigation_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalMitigation_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalMitigation_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalMitigation_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<OperationalMitigation_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<OperationalMitigation_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super OperationalMitigation_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public OperationalMitigation_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return OperationalMitigation_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalMitigation_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalMitigation_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final OperationalMitigation_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final OperationalMitigation_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected OperationalMitigation_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalMitigation_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalMitigation_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalMitigation_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalMitigation_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalMitigation_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalMitigation_isEncapsulated.Matcher> querySpecification() {
      return OperationalMitigation_isEncapsulated.instance();
    }
  }
  
  private OperationalMitigation_isEncapsulated() {
   ...
   * 
   */
  public static OperationalMitigation_isEncapsulated instance() {
    try{
  ...
  @Override
  protected OperationalMitigation_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalMitigation_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public OperationalMitigation_isEncapsulated.Matcher instantiate() {
    return OperationalMitigation_isEncapsulated.Matcher.create();
  }
  
  @Override
  public OperationalMitigation_isEncapsulated.Match newEmptyMatch() {
    return OperationalMitigation_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalMitigation_isEncapsulated.Match newMatch(final Object... parameters) {
    return OperationalMitigation_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalMitigation_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalMitigation_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalMitigation_isEncapsulated INSTANCE = new OperationalMitigation_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalMitigation_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
