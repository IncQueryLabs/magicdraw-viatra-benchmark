...
public final class FunctionalRequirement_TracedTo extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement_TracedTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.functionalRequirement_TracedTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.functionalRequirement_TracedTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalRequirement_TracedTo.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalRequirement_TracedTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalRequirement_TracedTo.Match)) {
          FunctionalRequirement_TracedTo.Match other = (FunctionalRequirement_TracedTo.Match) obj;
    ...
    @Override
    public FunctionalRequirement_TracedTo specification() {
     ...
     * 
     */
    public static FunctionalRequirement_TracedTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalRequirement_TracedTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static FunctionalRequirement_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalRequirement_TracedTo.Match {
    ...
    private static final class Immutable extends FunctionalRequirement_TracedTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.functionalRequirement_TracedTo pattern,
   ...
   * 
   * @see Match
   * @see FunctionalRequirement_TracedTo
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalRequirement_TracedTo.Match> {
    /**
     ...
     * 
     */
    public static FunctionalRequirement_TracedTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalRequirement_TracedTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalRequirement_TracedTo.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalRequirement_TracedTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<FunctionalRequirement_TracedTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<FunctionalRequirement_TracedTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super FunctionalRequirement_TracedTo.Match> processor) {
     ...
     * 
     */
    public FunctionalRequirement_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return FunctionalRequirement_TracedTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalRequirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalRequirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final FunctionalRequirement_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final FunctionalRequirement_TracedTo.Match partialMatch) {
    ...
    @Override
    protected FunctionalRequirement_TracedTo.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalRequirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalRequirement_TracedTo.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalRequirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalRequirement_TracedTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalRequirement_TracedTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalRequirement_TracedTo.Matcher> querySpecification() {
      return FunctionalRequirement_TracedTo.instance();
    }
  }
  
  private FunctionalRequirement_TracedTo() {
   ...
   * 
   */
  public static FunctionalRequirement_TracedTo instance() {
    try{
  ...
  @Override
  protected FunctionalRequirement_TracedTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalRequirement_TracedTo.Matcher.on(engine);
  }
  
  @Override
  public FunctionalRequirement_TracedTo.Matcher instantiate() {
    return FunctionalRequirement_TracedTo.Matcher.create();
  }
  
  @Override
  public FunctionalRequirement_TracedTo.Match newEmptyMatch() {
    return FunctionalRequirement_TracedTo.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalRequirement_TracedTo.Match newMatch(final Object... parameters) {
    return FunctionalRequirement_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalRequirement_TracedTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalRequirement_TracedTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalRequirement_TracedTo INSTANCE = new FunctionalRequirement_TracedTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalRequirement_TracedTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
