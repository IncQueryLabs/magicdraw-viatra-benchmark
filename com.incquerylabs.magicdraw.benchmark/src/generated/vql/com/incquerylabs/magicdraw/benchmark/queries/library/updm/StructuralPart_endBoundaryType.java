...
public final class StructuralPart_endBoundaryType extends BaseGeneratedEMFQuerySpecification<StructuralPart_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return StructuralPart_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public StructuralPart_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StructuralPart_endBoundaryType.Match)) {
          StructuralPart_endBoundaryType.Match other = (StructuralPart_endBoundaryType.Match) obj;
    ...
    @Override
    public StructuralPart_endBoundaryType specification() {
      return StructuralPart_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static StructuralPart_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static StructuralPart_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static StructuralPart_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends StructuralPart_endBoundaryType.Match {
    ...
    private static final class Immutable extends StructuralPart_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see StructuralPart_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<StructuralPart_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static StructuralPart_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StructuralPart_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StructuralPart_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<StructuralPart_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<StructuralPart_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<StructuralPart_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super StructuralPart_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public StructuralPart_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return StructuralPart_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final StructuralPart_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final StructuralPart_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final StructuralPart_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final StructuralPart_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected StructuralPart_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return StructuralPart_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected StructuralPart_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return StructuralPart_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StructuralPart_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StructuralPart_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StructuralPart_endBoundaryType.Matcher> querySpecification() {
      return StructuralPart_endBoundaryType.instance();
    }
  }
  
  private StructuralPart_endBoundaryType() {
   ...
   * 
   */
  public static StructuralPart_endBoundaryType instance() {
    try{
  ...
  @Override
  protected StructuralPart_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return StructuralPart_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public StructuralPart_endBoundaryType.Matcher instantiate() {
    return StructuralPart_endBoundaryType.Matcher.create();
  }
  
  @Override
  public StructuralPart_endBoundaryType.Match newEmptyMatch() {
    return StructuralPart_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public StructuralPart_endBoundaryType.Match newMatch(final Object... parameters) {
    return StructuralPart_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StructuralPart_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StructuralPart_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StructuralPart_endBoundaryType INSTANCE = new StructuralPart_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StructuralPart_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
