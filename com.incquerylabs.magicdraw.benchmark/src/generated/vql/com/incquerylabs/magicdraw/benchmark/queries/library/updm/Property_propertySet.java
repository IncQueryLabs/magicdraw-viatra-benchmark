...
public final class Property_propertySet extends BaseGeneratedEMFQuerySpecification<Property_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Property_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Property_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Property_propertySet.Match)) {
          Property_propertySet.Match other = (Property_propertySet.Match) obj;
    ...
    @Override
    public Property_propertySet specification() {
      return Property_propertySet.instance();
    }
     ...
     * 
     */
    public static Property_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Property_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static Property_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Property_propertySet.Match {
    ...
    private static final class Immutable extends Property_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Property_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Property_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Property_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Property_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Property_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Property_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Property_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Property_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super Property_propertySet.Match> processor) {
     ...
     * 
     */
    public Property_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return Property_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Property_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Property_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Property_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Property_propertySet.Match partialMatch) {
    ...
    @Override
    protected Property_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Property_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Property_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Property_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Property_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Property_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Property_propertySet.Matcher> querySpecification() {
      return Property_propertySet.instance();
    }
  }
  
  private Property_propertySet() {
   ...
   * 
   */
  public static Property_propertySet instance() {
    try{
  ...
  @Override
  protected Property_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Property_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Property_propertySet.Matcher instantiate() {
    return Property_propertySet.Matcher.create();
  }
  
  @Override
  public Property_propertySet.Match newEmptyMatch() {
    return Property_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Property_propertySet.Match newMatch(final Object... parameters) {
    return Property_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Property_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Property_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Property_propertySet INSTANCE = new Property_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Property_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
