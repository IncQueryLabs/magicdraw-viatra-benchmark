...
public final class OperationalPerformer_conformsTo extends BaseGeneratedEMFQuerySpecification<OperationalPerformer_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalPerformer_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public OperationalPerformer_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalPerformer_conformsTo.Match)) {
          OperationalPerformer_conformsTo.Match other = (OperationalPerformer_conformsTo.Match) obj;
    ...
    @Override
    public OperationalPerformer_conformsTo specification() {
      return OperationalPerformer_conformsTo.instance();
    }
     ...
     * 
     */
    public static OperationalPerformer_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalPerformer_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalPerformer_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalPerformer_conformsTo.Match {
    ...
    private static final class Immutable extends OperationalPerformer_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see OperationalPerformer_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalPerformer_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static OperationalPerformer_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalPerformer_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalPerformer_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalPerformer_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalPerformer_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalPerformer_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalPerformer_conformsTo.Match> processor) {
     ...
     * 
     */
    public OperationalPerformer_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalPerformer_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalPerformer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalPerformer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalPerformer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalPerformer_conformsTo.Match partialMatch) {
    ...
    @Override
    protected OperationalPerformer_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalPerformer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalPerformer_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalPerformer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalPerformer_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalPerformer_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalPerformer_conformsTo.Matcher> querySpecification() {
      return OperationalPerformer_conformsTo.instance();
    }
  }
  
  private OperationalPerformer_conformsTo() {
   ...
   * 
   */
  public static OperationalPerformer_conformsTo instance() {
    try{
  ...
  @Override
  protected OperationalPerformer_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalPerformer_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public OperationalPerformer_conformsTo.Matcher instantiate() {
    return OperationalPerformer_conformsTo.Matcher.create();
  }
  
  @Override
  public OperationalPerformer_conformsTo.Match newEmptyMatch() {
    return OperationalPerformer_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalPerformer_conformsTo.Match newMatch(final Object... parameters) {
    return OperationalPerformer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalPerformer_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalPerformer_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalPerformer_conformsTo INSTANCE = new OperationalPerformer_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalPerformer_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
