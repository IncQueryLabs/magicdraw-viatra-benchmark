...
public final class OperationalAgent_isEncapsulated extends BaseGeneratedEMFQuerySpecification<OperationalAgent_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalAgent_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public OperationalAgent_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalAgent_isEncapsulated.Match)) {
          OperationalAgent_isEncapsulated.Match other = (OperationalAgent_isEncapsulated.Match) obj;
    ...
    @Override
    public OperationalAgent_isEncapsulated specification() {
      return OperationalAgent_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static OperationalAgent_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalAgent_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static OperationalAgent_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalAgent_isEncapsulated.Match {
    ...
    private static final class Immutable extends OperationalAgent_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see OperationalAgent_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalAgent_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static OperationalAgent_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalAgent_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalAgent_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalAgent_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<OperationalAgent_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<OperationalAgent_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super OperationalAgent_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public OperationalAgent_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return OperationalAgent_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalAgent_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalAgent_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final OperationalAgent_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final OperationalAgent_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected OperationalAgent_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalAgent_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalAgent_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalAgent_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalAgent_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalAgent_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalAgent_isEncapsulated.Matcher> querySpecification() {
      return OperationalAgent_isEncapsulated.instance();
    }
  }
  
  private OperationalAgent_isEncapsulated() {
   ...
   * 
   */
  public static OperationalAgent_isEncapsulated instance() {
    try{
  ...
  @Override
  protected OperationalAgent_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalAgent_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public OperationalAgent_isEncapsulated.Matcher instantiate() {
    return OperationalAgent_isEncapsulated.Matcher.create();
  }
  
  @Override
  public OperationalAgent_isEncapsulated.Match newEmptyMatch() {
    return OperationalAgent_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalAgent_isEncapsulated.Match newMatch(final Object... parameters) {
    return OperationalAgent_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalAgent_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalAgent_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalAgent_isEncapsulated INSTANCE = new OperationalAgent_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalAgent_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
