...
public final class ActualRisk extends BaseGeneratedEMFQuerySpecification<ActualRisk.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualRisk pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualRisk";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualRisk.Match.parameterNames;
    }
    ...
    @Override
    public ActualRisk.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualRisk.Match)) {
          ActualRisk.Match other = (ActualRisk.Match) obj;
    ...
    @Override
    public ActualRisk specification() {
      return ActualRisk.instance();
    }
     ...
     * 
     */
    public static ActualRisk.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualRisk.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualRisk.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualRisk.Match {
    ...
    private static final class Immutable extends ActualRisk.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualRisk pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualRisk.Match> {
    /**
     ...
     * 
     */
    public static ActualRisk.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualRisk.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualRisk.Matcher.class);
     ...
     * 
     */
    public Collection<ActualRisk.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualRisk.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualRisk.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualRisk.Match> processor) {
     ...
     * 
     */
    public ActualRisk.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualRisk.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualRisk.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualRisk.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualRisk.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualRisk.Match partialMatch) {
    ...
    @Override
    protected ActualRisk.Match tupleToMatch(final Tuple t) {
      try {
          return ActualRisk.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualRisk.Match arrayToMatch(final Object[] match) {
      try {
          return ActualRisk.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualRisk.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualRisk.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualRisk.Matcher> querySpecification() {
      return ActualRisk.instance();
    }
  }
   ...
   * 
   */
  public static ActualRisk instance() {
    try{
  ...
  @Override
  protected ActualRisk.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualRisk.Matcher.on(engine);
  }
  
  @Override
  public ActualRisk.Matcher instantiate() {
    return ActualRisk.Matcher.create();
  }
  
  @Override
  public ActualRisk.Match newEmptyMatch() {
    return ActualRisk.Match.newEmptyMatch();
  }
  
  @Override
  public ActualRisk.Match newMatch(final Object... parameters) {
    return ActualRisk.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualRisk} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualRisk#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualRisk INSTANCE = new ActualRisk();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualRisk.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualRisk")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualRisk");
