...
public final class ProtocolStack_retiredDate extends BaseGeneratedEMFQuerySpecification<ProtocolStack_retiredDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_retiredDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_retiredDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolStack_retiredDate.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolStack_retiredDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolStack_retiredDate.Match)) {
          ProtocolStack_retiredDate.Match other = (ProtocolStack_retiredDate.Match) obj;
    ...
    @Override
    public ProtocolStack_retiredDate specification() {
      return ProtocolStack_retiredDate.instance();
    }
     ...
     * 
     */
    public static ProtocolStack_retiredDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolStack_retiredDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolStack_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolStack_retiredDate.Match {
    ...
    private static final class Immutable extends ProtocolStack_retiredDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_retiredDate pattern,
   ...
   * 
   * @see Match
   * @see ProtocolStack_retiredDate
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolStack_retiredDate.Match> {
    /**
     ...
     * 
     */
    public static ProtocolStack_retiredDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolStack_retiredDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolStack_retiredDate.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolStack_retiredDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolStack_retiredDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolStack_retiredDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProtocolStack_retiredDate.Match> processor) {
     ...
     * 
     */
    public ProtocolStack_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProtocolStack_retiredDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProtocolStack_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProtocolStack_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolStack_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolStack_retiredDate.Match partialMatch) {
    ...
    @Override
    protected ProtocolStack_retiredDate.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolStack_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolStack_retiredDate.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolStack_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolStack_retiredDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolStack_retiredDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolStack_retiredDate.Matcher> querySpecification() {
      return ProtocolStack_retiredDate.instance();
    }
  }
  
  private ProtocolStack_retiredDate() {
   ...
   * 
   */
  public static ProtocolStack_retiredDate instance() {
    try{
  ...
  @Override
  protected ProtocolStack_retiredDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolStack_retiredDate.Matcher.on(engine);
  }
  
  @Override
  public ProtocolStack_retiredDate.Matcher instantiate() {
    return ProtocolStack_retiredDate.Matcher.create();
  }
  
  @Override
  public ProtocolStack_retiredDate.Match newEmptyMatch() {
    return ProtocolStack_retiredDate.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolStack_retiredDate.Match newMatch(final Object... parameters) {
    return ProtocolStack_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolStack_retiredDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolStack_retiredDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolStack_retiredDate INSTANCE = new ProtocolStack_retiredDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolStack_retiredDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
