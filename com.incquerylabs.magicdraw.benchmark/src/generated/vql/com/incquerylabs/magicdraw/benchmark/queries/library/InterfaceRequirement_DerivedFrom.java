...
public final class InterfaceRequirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceRequirement_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceRequirement_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceRequirement_DerivedFrom.Match)) {
          InterfaceRequirement_DerivedFrom.Match other = (InterfaceRequirement_DerivedFrom.Match) obj;
    ...
    @Override
    public InterfaceRequirement_DerivedFrom specification() {
     ...
     * 
     */
    public static InterfaceRequirement_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceRequirement_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static InterfaceRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends InterfaceRequirement_DerivedFrom.Match {
    ...
    private static final class Immutable extends InterfaceRequirement_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see InterfaceRequirement_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceRequirement_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static InterfaceRequirement_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceRequirement_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceRequirement_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceRequirement_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<InterfaceRequirement_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<InterfaceRequirement_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super InterfaceRequirement_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public InterfaceRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return InterfaceRequirement_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final InterfaceRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final InterfaceRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final InterfaceRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final InterfaceRequirement_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected InterfaceRequirement_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected InterfaceRequirement_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceRequirement_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceRequirement_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceRequirement_DerivedFrom.Matcher> querySpecification() {
      return InterfaceRequirement_DerivedFrom.instance();
    }
  }
  
  private InterfaceRequirement_DerivedFrom() {
   ...
   * 
   */
  public static InterfaceRequirement_DerivedFrom instance() {
    try{
  ...
  @Override
  protected InterfaceRequirement_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceRequirement_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public InterfaceRequirement_DerivedFrom.Matcher instantiate() {
    return InterfaceRequirement_DerivedFrom.Matcher.create();
  }
  
  @Override
  public InterfaceRequirement_DerivedFrom.Match newEmptyMatch() {
    return InterfaceRequirement_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceRequirement_DerivedFrom.Match newMatch(final Object... parameters) {
    return InterfaceRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceRequirement_DerivedFrom} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceRequirement_DerivedFrom#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceRequirement_DerivedFrom INSTANCE = new InterfaceRequirement_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceRequirement_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find interfaceRequirement(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), InterfaceRequirement.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "DerivedFrom", taggedValue)
