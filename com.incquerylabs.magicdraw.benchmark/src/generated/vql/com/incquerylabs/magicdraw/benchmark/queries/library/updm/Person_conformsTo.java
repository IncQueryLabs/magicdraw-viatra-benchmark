...
public final class Person_conformsTo extends BaseGeneratedEMFQuerySpecification<Person_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Person_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_conformsTo.Match)) {
          Person_conformsTo.Match other = (Person_conformsTo.Match) obj;
    ...
    @Override
    public Person_conformsTo specification() {
      return Person_conformsTo.instance();
    }
     ...
     * 
     */
    public static Person_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Person_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Person_conformsTo.Match {
    ...
    private static final class Immutable extends Person_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Person_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Person_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Person_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Person_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Person_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Person_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Person_conformsTo.Match> processor) {
     ...
     * 
     */
    public Person_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Person_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Person_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Person_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Person_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Person_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Person_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Person_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_conformsTo.Matcher> querySpecification() {
      return Person_conformsTo.instance();
    }
  }
  
  private Person_conformsTo() {
   ...
   * 
   */
  public static Person_conformsTo instance() {
    try{
  ...
  @Override
  protected Person_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Person_conformsTo.Matcher instantiate() {
    return Person_conformsTo.Matcher.create();
  }
  
  @Override
  public Person_conformsTo.Match newEmptyMatch() {
    return Person_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Person_conformsTo.Match newMatch(final Object... parameters) {
    return Person_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_conformsTo INSTANCE = new Person_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
