...
public final class ServiceLevelValue_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ServiceLevelValue_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceLevelValue_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ServiceLevelValue_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceLevelValue_endBoundaryType.Match)) {
          ServiceLevelValue_endBoundaryType.Match other = (ServiceLevelValue_endBoundaryType.Match) obj;
    ...
    @Override
    public ServiceLevelValue_endBoundaryType specification() {
      return ServiceLevelValue_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ServiceLevelValue_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceLevelValue_endBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceLevelValue_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceLevelValue_endBoundaryType.Match {
    ...
    private static final class Immutable extends ServiceLevelValue_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ServiceLevelValue_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceLevelValue_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ServiceLevelValue_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceLevelValue_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceLevelValue_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceLevelValue_endBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceLevelValue_endBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceLevelValue_endBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ServiceLevelValue_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ServiceLevelValue_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ServiceLevelValue_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ServiceLevelValue_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ServiceLevelValue_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceLevelValue_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceLevelValue_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ServiceLevelValue_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceLevelValue_endBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceLevelValue_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceLevelValue_endBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceLevelValue_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceLevelValue_endBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceLevelValue_endBoundaryType.Matcher> querySpecification() {
      return ServiceLevelValue_endBoundaryType.instance();
    }
  }
  
  private ServiceLevelValue_endBoundaryType() {
   ...
   * 
   */
  public static ServiceLevelValue_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ServiceLevelValue_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceLevelValue_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ServiceLevelValue_endBoundaryType.Matcher instantiate() {
    return ServiceLevelValue_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ServiceLevelValue_endBoundaryType.Match newEmptyMatch() {
    return ServiceLevelValue_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceLevelValue_endBoundaryType.Match newMatch(final Object... parameters) {
    return ServiceLevelValue_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceLevelValue_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceLevelValue_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceLevelValue_endBoundaryType INSTANCE = new ServiceLevelValue_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceLevelValue_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
