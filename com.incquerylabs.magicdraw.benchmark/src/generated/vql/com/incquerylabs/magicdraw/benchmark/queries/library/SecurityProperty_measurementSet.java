...
public final class SecurityProperty_measurementSet extends BaseGeneratedEMFQuerySpecification<SecurityProperty_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityProperty_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public SecurityProperty_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityProperty_measurementSet.Match)) {
          SecurityProperty_measurementSet.Match other = (SecurityProperty_measurementSet.Match) obj;
    ...
    @Override
    public SecurityProperty_measurementSet specification() {
      return SecurityProperty_measurementSet.instance();
    }
     ...
     * 
     */
    public static SecurityProperty_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityProperty_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityProperty_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityProperty_measurementSet.Match {
    ...
    private static final class Immutable extends SecurityProperty_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see SecurityProperty_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityProperty_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static SecurityProperty_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityProperty_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityProperty_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityProperty_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityProperty_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityProperty_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super SecurityProperty_measurementSet.Match> processor) {
     ...
     * 
     */
    public SecurityProperty_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return SecurityProperty_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final SecurityProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final SecurityProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityProperty_measurementSet.Match partialMatch) {
    ...
    @Override
    protected SecurityProperty_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityProperty_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityProperty_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityProperty_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityProperty_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityProperty_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityProperty_measurementSet.Matcher> querySpecification() {
      return SecurityProperty_measurementSet.instance();
    }
  }
  
  private SecurityProperty_measurementSet() {
   ...
   * 
   */
  public static SecurityProperty_measurementSet instance() {
    try{
  ...
  @Override
  protected SecurityProperty_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityProperty_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public SecurityProperty_measurementSet.Matcher instantiate() {
    return SecurityProperty_measurementSet.Matcher.create();
  }
  
  @Override
  public SecurityProperty_measurementSet.Match newEmptyMatch() {
    return SecurityProperty_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityProperty_measurementSet.Match newMatch(final Object... parameters) {
    return SecurityProperty_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityProperty_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityProperty_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityProperty_measurementSet INSTANCE = new SecurityProperty_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityProperty_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
