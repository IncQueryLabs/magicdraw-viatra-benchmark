...
public final class Project_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Project_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Project_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Project_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_requiredEnvironment.Match)) {
          Project_requiredEnvironment.Match other = (Project_requiredEnvironment.Match) obj;
    ...
    @Override
    public Project_requiredEnvironment specification() {
      return Project_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Project_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Project_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Project_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Project_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Project_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Project_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Project_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Project_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Project_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Project_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Project_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Project_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Project_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Project_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Project_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Project_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Project_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Project_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Project_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Project_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Project_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_requiredEnvironment.Matcher> querySpecification() {
      return Project_requiredEnvironment.instance();
    }
  }
  
  private Project_requiredEnvironment() {
   ...
   * 
   */
  public static Project_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Project_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Project_requiredEnvironment.Matcher instantiate() {
    return Project_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Project_requiredEnvironment.Match newEmptyMatch() {
    return Project_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Project_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Project_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_requiredEnvironment INSTANCE = new Project_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
