...
public final class OperationalArchitecture_physicalLocation extends BaseGeneratedEMFQuerySpecification<OperationalArchitecture_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalArchitecture_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public OperationalArchitecture_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalArchitecture_physicalLocation.Match)) {
          OperationalArchitecture_physicalLocation.Match other = (OperationalArchitecture_physicalLocation.Match) obj;
    ...
    @Override
    public OperationalArchitecture_physicalLocation specification() {
      return OperationalArchitecture_physicalLocation.instance();
    }
     ...
     * 
     */
    public static OperationalArchitecture_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalArchitecture_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalArchitecture_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalArchitecture_physicalLocation.Match {
    ...
    private static final class Immutable extends OperationalArchitecture_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see OperationalArchitecture_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalArchitecture_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static OperationalArchitecture_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalArchitecture_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalArchitecture_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalArchitecture_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalArchitecture_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalArchitecture_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalArchitecture_physicalLocation.Match> processor) {
     ...
     * 
     */
    public OperationalArchitecture_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalArchitecture_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalArchitecture_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected OperationalArchitecture_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalArchitecture_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalArchitecture_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalArchitecture_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalArchitecture_physicalLocation.Matcher> querySpecification() {
      return OperationalArchitecture_physicalLocation.instance();
    }
  }
  
  private OperationalArchitecture_physicalLocation() {
   ...
   * 
   */
  public static OperationalArchitecture_physicalLocation instance() {
    try{
  ...
  @Override
  protected OperationalArchitecture_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalArchitecture_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public OperationalArchitecture_physicalLocation.Matcher instantiate() {
    return OperationalArchitecture_physicalLocation.Matcher.create();
  }
  
  @Override
  public OperationalArchitecture_physicalLocation.Match newEmptyMatch() {
    return OperationalArchitecture_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalArchitecture_physicalLocation.Match newMatch(final Object... parameters) {
    return OperationalArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalArchitecture_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalArchitecture_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalArchitecture_physicalLocation INSTANCE = new OperationalArchitecture_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalArchitecture_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
