...
public final class PersonType_milestone extends BaseGeneratedEMFQuerySpecification<PersonType_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_milestone.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_milestone.Match)) {
          PersonType_milestone.Match other = (PersonType_milestone.Match) obj;
    ...
    @Override
    public PersonType_milestone specification() {
      return PersonType_milestone.instance();
    }
     ...
     * 
     */
    public static PersonType_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_milestone.Match {
    ...
    private static final class Immutable extends PersonType_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_milestone pattern,
   ...
   * 
   * @see Match
   * @see PersonType_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_milestone.Match> {
    /**
     ...
     * 
     */
    public static PersonType_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_milestone.Match> processor) {
     ...
     * 
     */
    public PersonType_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_milestone.Match partialMatch) {
    ...
    @Override
    protected PersonType_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_milestone.Matcher> querySpecification() {
      return PersonType_milestone.instance();
    }
  }
  
  private PersonType_milestone() {
   ...
   * 
   */
  public static PersonType_milestone instance() {
    try{
  ...
  @Override
  protected PersonType_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_milestone.Matcher.on(engine);
  }
  
  @Override
  public PersonType_milestone.Matcher instantiate() {
    return PersonType_milestone.Matcher.create();
  }
  
  @Override
  public PersonType_milestone.Match newEmptyMatch() {
    return PersonType_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_milestone.Match newMatch(final Object... parameters) {
    return PersonType_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_milestone INSTANCE = new PersonType_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
