...
public final class EnhancedSecurityControl_Text extends BaseGeneratedEMFQuerySpecification<EnhancedSecurityControl_Text.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnhancedSecurityControl_Text.Match.parameterNames;
    }
    ...
    @Override
    public EnhancedSecurityControl_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnhancedSecurityControl_Text.Match)) {
          EnhancedSecurityControl_Text.Match other = (EnhancedSecurityControl_Text.Match) obj;
    ...
    @Override
    public EnhancedSecurityControl_Text specification() {
      return EnhancedSecurityControl_Text.instance();
    }
     ...
     * 
     */
    public static EnhancedSecurityControl_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnhancedSecurityControl_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnhancedSecurityControl_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnhancedSecurityControl_Text.Match {
    ...
    private static final class Immutable extends EnhancedSecurityControl_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_Text pattern,
   ...
   * 
   * @see Match
   * @see EnhancedSecurityControl_Text
   * 
   */
  public static class Matcher extends BaseMatcher<EnhancedSecurityControl_Text.Match> {
    /**
     ...
     * 
     */
    public static EnhancedSecurityControl_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnhancedSecurityControl_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnhancedSecurityControl_Text.Matcher.class);
     ...
     * 
     */
    public Collection<EnhancedSecurityControl_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnhancedSecurityControl_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnhancedSecurityControl_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EnhancedSecurityControl_Text.Match> processor) {
     ...
     * 
     */
    public EnhancedSecurityControl_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EnhancedSecurityControl_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnhancedSecurityControl_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnhancedSecurityControl_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnhancedSecurityControl_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnhancedSecurityControl_Text.Match partialMatch) {
    ...
    @Override
    protected EnhancedSecurityControl_Text.Match tupleToMatch(final Tuple t) {
      try {
          return EnhancedSecurityControl_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnhancedSecurityControl_Text.Match arrayToMatch(final Object[] match) {
      try {
          return EnhancedSecurityControl_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnhancedSecurityControl_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnhancedSecurityControl_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnhancedSecurityControl_Text.Matcher> querySpecification() {
      return EnhancedSecurityControl_Text.instance();
    }
  }
  
  private EnhancedSecurityControl_Text() {
   ...
   * 
   */
  public static EnhancedSecurityControl_Text instance() {
    try{
  ...
  @Override
  protected EnhancedSecurityControl_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnhancedSecurityControl_Text.Matcher.on(engine);
  }
  
  @Override
  public EnhancedSecurityControl_Text.Matcher instantiate() {
    return EnhancedSecurityControl_Text.Matcher.create();
  }
  
  @Override
  public EnhancedSecurityControl_Text.Match newEmptyMatch() {
    return EnhancedSecurityControl_Text.Match.newEmptyMatch();
  }
  
  @Override
  public EnhancedSecurityControl_Text.Match newMatch(final Object... parameters) {
    return EnhancedSecurityControl_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnhancedSecurityControl_Text} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnhancedSecurityControl_Text#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnhancedSecurityControl_Text INSTANCE = new EnhancedSecurityControl_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnhancedSecurityControl_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
