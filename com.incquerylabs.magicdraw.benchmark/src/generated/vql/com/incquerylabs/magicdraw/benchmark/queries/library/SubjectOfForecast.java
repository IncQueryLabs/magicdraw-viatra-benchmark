...
public final class SubjectOfForecast extends BaseGeneratedEMFQuerySpecification<SubjectOfForecast.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfForecast pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfForecast";
    }
    
    @Override
    public List<String> parameterNames() {
      return SubjectOfForecast.Match.parameterNames;
    }
    ...
    @Override
    public SubjectOfForecast.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SubjectOfForecast.Match)) {
          SubjectOfForecast.Match other = (SubjectOfForecast.Match) obj;
    ...
    @Override
    public SubjectOfForecast specification() {
      return SubjectOfForecast.instance();
    }
     ...
     * 
     */
    public static SubjectOfForecast.Match newEmptyMatch() {
     ...
     * 
     */
    public static SubjectOfForecast.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SubjectOfForecast.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SubjectOfForecast.Match {
    ...
    private static final class Immutable extends SubjectOfForecast.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfForecast pattern,
   ...
   * 
   * @see Match
   * @see SubjectOfForecast
   * 
   */
  public static class Matcher extends BaseMatcher<SubjectOfForecast.Match> {
    /**
     ...
     * 
     */
    public static SubjectOfForecast.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SubjectOfForecast.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SubjectOfForecast.Matcher.class);
     ...
     * 
     */
    public Collection<SubjectOfForecast.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SubjectOfForecast.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SubjectOfForecast.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SubjectOfForecast.Match> processor) {
     ...
     * 
     */
    public SubjectOfForecast.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SubjectOfForecast.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final SubjectOfForecast.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final SubjectOfForecast.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SubjectOfForecast.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SubjectOfForecast.Match partialMatch) {
    ...
    @Override
    protected SubjectOfForecast.Match tupleToMatch(final Tuple t) {
      try {
          return SubjectOfForecast.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SubjectOfForecast.Match arrayToMatch(final Object[] match) {
      try {
          return SubjectOfForecast.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SubjectOfForecast.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SubjectOfForecast.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SubjectOfForecast.Matcher> querySpecification() {
      return SubjectOfForecast.instance();
    }
  }
  
  private SubjectOfForecast() {
   ...
   * 
   */
  public static SubjectOfForecast instance() {
    try{
  ...
  @Override
  protected SubjectOfForecast.Matcher instantiate(final ViatraQueryEngine engine) {
    return SubjectOfForecast.Matcher.on(engine);
  }
  
  @Override
  public SubjectOfForecast.Matcher instantiate() {
    return SubjectOfForecast.Matcher.create();
  }
  
  @Override
  public SubjectOfForecast.Match newEmptyMatch() {
    return SubjectOfForecast.Match.newEmptyMatch();
  }
  
  @Override
  public SubjectOfForecast.Match newMatch(final Object... parameters) {
    return SubjectOfForecast.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SubjectOfForecast} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SubjectOfForecast#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SubjectOfForecast INSTANCE = new SubjectOfForecast();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SubjectOfForecast.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "SubjectOfForecast")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "SubjectOfForecast");
