...
public final class ResourceArtifact_affectedFunctions extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_affectedFunctions.Match)) {
          ResourceArtifact_affectedFunctions.Match other = (ResourceArtifact_affectedFunctions.Match) obj;
    ...
    @Override
    public ResourceArtifact_affectedFunctions specification() {
      return ResourceArtifact_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_affectedFunctions.Match {
    ...
    private static final class Immutable extends ResourceArtifact_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_affectedFunctions.Matcher> querySpecification() {
      return ResourceArtifact_affectedFunctions.instance();
    }
  }
  
  private ResourceArtifact_affectedFunctions() {
   ...
   * 
   */
  public static ResourceArtifact_affectedFunctions instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_affectedFunctions.Matcher instantiate() {
    return ResourceArtifact_affectedFunctions.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_affectedFunctions.Match newEmptyMatch() {
    return ResourceArtifact_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_affectedFunctions.Match newMatch(final Object... parameters) {
    return ResourceArtifact_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_affectedFunctions INSTANCE = new ResourceArtifact_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
