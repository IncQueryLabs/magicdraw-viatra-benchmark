...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole;
...
public final class ActualOrganizationRole_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ActualOrganizationRole_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualOrganizationRole_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ActualOrganizationRole_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualOrganizationRole_actualPropertySet.Match)) {
          ActualOrganizationRole_actualPropertySet.Match other = (ActualOrganizationRole_actualPropertySet.Match) obj;
    ...
    @Override
    public ActualOrganizationRole_actualPropertySet specification() {
      return ActualOrganizationRole_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ActualOrganizationRole_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualOrganizationRole_actualPropertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualOrganizationRole_actualPropertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualOrganizationRole_actualPropertySet.Match {
    ...
    private static final class Immutable extends ActualOrganizationRole_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ActualOrganizationRole_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ActualOrganizationRole_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ActualOrganizationRole_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualOrganizationRole_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualOrganizationRole_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ActualOrganizationRole_actualPropertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualOrganizationRole_actualPropertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualOrganizationRole_actualPropertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualOrganizationRole_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ActualOrganizationRole_actualPropertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualOrganizationRole_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualOrganizationRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualOrganizationRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualOrganizationRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualOrganizationRole_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ActualOrganizationRole_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ActualOrganizationRole_actualPropertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualOrganizationRole_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ActualOrganizationRole_actualPropertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualOrganizationRole_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualOrganizationRole_actualPropertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualOrganizationRole_actualPropertySet.Matcher> querySpecification() {
      return ActualOrganizationRole_actualPropertySet.instance();
    }
  }
  
  private ActualOrganizationRole_actualPropertySet() {
   ...
   * 
   */
  public static ActualOrganizationRole_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ActualOrganizationRole_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualOrganizationRole_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ActualOrganizationRole_actualPropertySet.Matcher instantiate() {
    return ActualOrganizationRole_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ActualOrganizationRole_actualPropertySet.Match newEmptyMatch() {
    return ActualOrganizationRole_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ActualOrganizationRole_actualPropertySet.Match newMatch(final Object... parameters) {
    return ActualOrganizationRole_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualOrganizationRole_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualOrganizationRole_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualOrganizationRole_actualPropertySet INSTANCE = new ActualOrganizationRole_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualOrganizationRole_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ActualOrganizationRole(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ActualOrganizationRole.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
