...
public final class ProjectMilestoneRole_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectMilestoneRole_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestoneRole_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestoneRole_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestoneRole_endBoundaryType.Match)) {
          ProjectMilestoneRole_endBoundaryType.Match other = (ProjectMilestoneRole_endBoundaryType.Match) obj;
    ...
    @Override
    public ProjectMilestoneRole_endBoundaryType specification() {
      return ProjectMilestoneRole_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectMilestoneRole_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestoneRole_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestoneRole_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestoneRole_endBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectMilestoneRole_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestoneRole_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestoneRole_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestoneRole_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestoneRole_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestoneRole_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestoneRole_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestoneRole_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestoneRole_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectMilestoneRole_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectMilestoneRole_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectMilestoneRole_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectMilestoneRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectMilestoneRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestoneRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestoneRole_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestoneRole_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestoneRole_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestoneRole_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestoneRole_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestoneRole_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestoneRole_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestoneRole_endBoundaryType.Matcher> querySpecification() {
      return ProjectMilestoneRole_endBoundaryType.instance();
    }
  }
  
  private ProjectMilestoneRole_endBoundaryType() {
   ...
   * 
   */
  public static ProjectMilestoneRole_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectMilestoneRole_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestoneRole_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestoneRole_endBoundaryType.Matcher instantiate() {
    return ProjectMilestoneRole_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectMilestoneRole_endBoundaryType.Match newEmptyMatch() {
    return ProjectMilestoneRole_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestoneRole_endBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectMilestoneRole_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestoneRole_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestoneRole_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestoneRole_endBoundaryType INSTANCE = new ProjectMilestoneRole_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestoneRole_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
