...
public final class TechnicalStandard_version extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_version.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_version pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_version";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_version.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_version.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_version.Match)) {
          TechnicalStandard_version.Match other = (TechnicalStandard_version.Match) obj;
    ...
    @Override
    public TechnicalStandard_version specification() {
      return TechnicalStandard_version.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_version.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_version.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static TechnicalStandard_version.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends TechnicalStandard_version.Match {
    ...
    private static final class Immutable extends TechnicalStandard_version.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_version pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_version
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_version.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_version.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_version.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_version.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_version.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<TechnicalStandard_version.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<TechnicalStandard_version.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super TechnicalStandard_version.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_version.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return TechnicalStandard_version.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_version.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_version.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final TechnicalStandard_version.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final TechnicalStandard_version.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_version.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected TechnicalStandard_version.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_version.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_version.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_version.Matcher> querySpecification() {
      return TechnicalStandard_version.instance();
    }
  }
  
  private TechnicalStandard_version() {
   ...
   * 
   */
  public static TechnicalStandard_version instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_version.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_version.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_version.Matcher instantiate() {
    return TechnicalStandard_version.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_version.Match newEmptyMatch() {
    return TechnicalStandard_version.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_version.Match newMatch(final Object... parameters) {
    return TechnicalStandard_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_version} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_version#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_version INSTANCE = new TechnicalStandard_version();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_version.GeneratedPQuery INSTANCE = new GeneratedPQuery();
