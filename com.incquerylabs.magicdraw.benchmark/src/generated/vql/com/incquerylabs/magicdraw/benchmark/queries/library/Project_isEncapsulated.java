...
public final class Project_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Project_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Project_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Project_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_isEncapsulated.Match)) {
          Project_isEncapsulated.Match other = (Project_isEncapsulated.Match) obj;
    ...
    @Override
    public Project_isEncapsulated specification() {
      return Project_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Project_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Project_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Project_isEncapsulated.Match {
    ...
    private static final class Immutable extends Project_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Project_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Project_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Project_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Project_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Project_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Project_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Project_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Project_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Project_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Project_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Project_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Project_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Project_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Project_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Project_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Project_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Project_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_isEncapsulated.Matcher> querySpecification() {
      return Project_isEncapsulated.instance();
    }
  }
  
  private Project_isEncapsulated() {
   ...
   * 
   */
  public static Project_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Project_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Project_isEncapsulated.Matcher instantiate() {
    return Project_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Project_isEncapsulated.Match newEmptyMatch() {
    return Project_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Project_isEncapsulated.Match newMatch(final Object... parameters) {
    return Project_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_isEncapsulated INSTANCE = new Project_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
