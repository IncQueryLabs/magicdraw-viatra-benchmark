...
public final class Organization_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Organization_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Organization_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Organization_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_requiredEnvironment.Match)) {
          Organization_requiredEnvironment.Match other = (Organization_requiredEnvironment.Match) obj;
    ...
    @Override
    public Organization_requiredEnvironment specification() {
      return Organization_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Organization_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Organization_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Organization_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Organization_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Organization_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Organization_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_requiredEnvironment.Matcher> querySpecification() {
      return Organization_requiredEnvironment.instance();
    }
  }
  
  private Organization_requiredEnvironment() {
   ...
   * 
   */
  public static Organization_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Organization_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Organization_requiredEnvironment.Matcher instantiate() {
    return Organization_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Organization_requiredEnvironment.Match newEmptyMatch() {
    return Organization_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Organization_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_requiredEnvironment INSTANCE = new Organization_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
