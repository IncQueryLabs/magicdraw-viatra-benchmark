...
public final class Post_URI extends BaseGeneratedEMFQuerySpecification<Post_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_URI.Match.parameterNames;
    }
    ...
    @Override
    public Post_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_URI.Match)) {
          Post_URI.Match other = (Post_URI.Match) obj;
    ...
    @Override
    public Post_URI specification() {
      return Post_URI.instance();
    }
     ...
     * 
     */
    public static Post_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Post_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Post_URI.Match {
    ...
    private static final class Immutable extends Post_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Post_URI.Match> {
    /**
     ...
     * 
     */
    public static Post_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Post_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Post_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Post_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Post_URI.Match> processor) {
     ...
     * 
     */
    public Post_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Post_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Post_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Post_URI.Match partialMatch) {
    ...
    @Override
    protected Post_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Post_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Post_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Post_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_URI.Matcher> querySpecification() {
      return Post_URI.instance();
    }
  }
   ...
   * 
   */
  public static Post_URI instance() {
    try{
  ...
  @Override
  protected Post_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_URI.Matcher.on(engine);
  }
  
  @Override
  public Post_URI.Matcher instantiate() {
    return Post_URI.Matcher.create();
  }
  
  @Override
  public Post_URI.Match newEmptyMatch() {
    return Post_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Post_URI.Match newMatch(final Object... parameters) {
    return Post_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_URI INSTANCE = new Post_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
