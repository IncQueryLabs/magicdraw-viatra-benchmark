...
public final class ExchangeElement_affectedFunctions extends BaseGeneratedEMFQuerySpecification<ExchangeElement_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_affectedFunctions.Match)) {
          ExchangeElement_affectedFunctions.Match other = (ExchangeElement_affectedFunctions.Match) obj;
    ...
    @Override
    public ExchangeElement_affectedFunctions specification() {
      return ExchangeElement_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_affectedFunctions.Match {
    ...
    private static final class Immutable extends ExchangeElement_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_affectedFunctions.Matcher> querySpecification() {
      return ExchangeElement_affectedFunctions.instance();
    }
  }
  
  private ExchangeElement_affectedFunctions() {
   ...
   * 
   */
  public static ExchangeElement_affectedFunctions instance() {
    try{
  ...
  @Override
  protected ExchangeElement_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_affectedFunctions.Matcher instantiate() {
    return ExchangeElement_affectedFunctions.Matcher.create();
  }
  
  @Override
  public ExchangeElement_affectedFunctions.Match newEmptyMatch() {
    return ExchangeElement_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_affectedFunctions.Match newMatch(final Object... parameters) {
    return ExchangeElement_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_affectedFunctions INSTANCE = new ExchangeElement_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
