...
public final class Materiel_physicalLocation extends BaseGeneratedEMFQuerySpecification<Materiel_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_physicalLocation.Match)) {
          Materiel_physicalLocation.Match other = (Materiel_physicalLocation.Match) obj;
    ...
    @Override
    public Materiel_physicalLocation specification() {
      return Materiel_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Materiel_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Materiel_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Materiel_physicalLocation.Match {
    ...
    private static final class Immutable extends Materiel_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Materiel_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Materiel_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Materiel_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Materiel_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Materiel_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Materiel_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Materiel_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Materiel_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Materiel_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Materiel_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Materiel_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_physicalLocation.Matcher> querySpecification() {
      return Materiel_physicalLocation.instance();
    }
  }
  
  private Materiel_physicalLocation() {
   ...
   * 
   */
  public static Materiel_physicalLocation instance() {
    try{
  ...
  @Override
  protected Materiel_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Materiel_physicalLocation.Matcher instantiate() {
    return Materiel_physicalLocation.Matcher.create();
  }
  
  @Override
  public Materiel_physicalLocation.Match newEmptyMatch() {
    return Materiel_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_physicalLocation.Match newMatch(final Object... parameters) {
    return Materiel_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_physicalLocation INSTANCE = new Materiel_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
