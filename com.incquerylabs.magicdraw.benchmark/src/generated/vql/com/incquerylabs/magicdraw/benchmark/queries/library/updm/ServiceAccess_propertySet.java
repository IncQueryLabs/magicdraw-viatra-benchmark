...
public final class ServiceAccess_propertySet extends BaseGeneratedEMFQuerySpecification<ServiceAccess_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_propertySet.Match)) {
          ServiceAccess_propertySet.Match other = (ServiceAccess_propertySet.Match) obj;
    ...
    @Override
    public ServiceAccess_propertySet specification() {
      return ServiceAccess_propertySet.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_propertySet.Match {
    ...
    private static final class Immutable extends ServiceAccess_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_propertySet.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_propertySet.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_propertySet.Matcher> querySpecification() {
      return ServiceAccess_propertySet.instance();
    }
  }
  
  private ServiceAccess_propertySet() {
   ...
   * 
   */
  public static ServiceAccess_propertySet instance() {
    try{
  ...
  @Override
  protected ServiceAccess_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_propertySet.Matcher instantiate() {
    return ServiceAccess_propertySet.Matcher.create();
  }
  
  @Override
  public ServiceAccess_propertySet.Match newEmptyMatch() {
    return ServiceAccess_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_propertySet.Match newMatch(final Object... parameters) {
    return ServiceAccess_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_propertySet INSTANCE = new ServiceAccess_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
