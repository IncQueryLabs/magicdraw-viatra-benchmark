...
public final class OperationalActivity extends BaseGeneratedEMFQuerySpecification<OperationalActivity.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalActivity pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalActivity";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalActivity.Match.parameterNames;
    }
    ...
    @Override
    public OperationalActivity.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalActivity.Match)) {
          OperationalActivity.Match other = (OperationalActivity.Match) obj;
    ...
    @Override
    public OperationalActivity specification() {
      return OperationalActivity.instance();
    }
     ...
     * 
     */
    public static OperationalActivity.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalActivity.Match newMutableMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalActivity.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalActivity.Match {
    ...
    private static final class Immutable extends OperationalActivity.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalActivity pattern,
   ...
   * 
   * @see Match
   * @see OperationalActivity
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalActivity.Match> {
    /**
     ...
     * 
     */
    public static OperationalActivity.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalActivity.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalActivity.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalActivity.Match> getAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalActivity.Match> streamAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalActivity.Match> getOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalActivity.Match> processor) {
     ...
     * 
     */
    public OperationalActivity.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalActivity.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final OperationalActivity.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final OperationalActivity.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalActivity.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalActivity.Match partialMatch) {
    ...
    @Override
    protected OperationalActivity.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalActivity.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalActivity.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalActivity.Match.newMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalActivity.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalActivity.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalActivity.Matcher> querySpecification() {
      return OperationalActivity.instance();
    }
  }
  ...
  @Override
  protected OperationalActivity.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalActivity.Matcher.on(engine);
  }
  
  @Override
  public OperationalActivity.Matcher instantiate() {
    return OperationalActivity.Matcher.create();
  }
  
  @Override
  public OperationalActivity.Match newEmptyMatch() {
    return OperationalActivity.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalActivity.Match newMatch(final Object... parameters) {
    return OperationalActivity.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalActivity} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalActivity#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalActivity INSTANCE = new OperationalActivity();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalActivity.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalActivity")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalActivity");
