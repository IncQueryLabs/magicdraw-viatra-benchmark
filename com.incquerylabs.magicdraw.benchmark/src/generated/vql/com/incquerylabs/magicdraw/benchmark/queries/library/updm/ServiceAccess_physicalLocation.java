...
public final class ServiceAccess_physicalLocation extends BaseGeneratedEMFQuerySpecification<ServiceAccess_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_physicalLocation.Match)) {
          ServiceAccess_physicalLocation.Match other = (ServiceAccess_physicalLocation.Match) obj;
    ...
    @Override
    public ServiceAccess_physicalLocation specification() {
      return ServiceAccess_physicalLocation.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_physicalLocation.Match {
    ...
    private static final class Immutable extends ServiceAccess_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_physicalLocation.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_physicalLocation.Matcher> querySpecification() {
      return ServiceAccess_physicalLocation.instance();
    }
  }
  
  private ServiceAccess_physicalLocation() {
   ...
   * 
   */
  public static ServiceAccess_physicalLocation instance() {
    try{
  ...
  @Override
  protected ServiceAccess_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_physicalLocation.Matcher instantiate() {
    return ServiceAccess_physicalLocation.Matcher.create();
  }
  
  @Override
  public ServiceAccess_physicalLocation.Match newEmptyMatch() {
    return ServiceAccess_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_physicalLocation.Match newMatch(final Object... parameters) {
    return ServiceAccess_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_physicalLocation INSTANCE = new ServiceAccess_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
