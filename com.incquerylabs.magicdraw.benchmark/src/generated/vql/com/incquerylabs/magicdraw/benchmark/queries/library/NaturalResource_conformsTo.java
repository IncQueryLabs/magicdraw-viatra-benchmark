...
public final class NaturalResource_conformsTo extends BaseGeneratedEMFQuerySpecification<NaturalResource_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return NaturalResource_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public NaturalResource_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NaturalResource_conformsTo.Match)) {
          NaturalResource_conformsTo.Match other = (NaturalResource_conformsTo.Match) obj;
    ...
    @Override
    public NaturalResource_conformsTo specification() {
      return NaturalResource_conformsTo.instance();
    }
     ...
     * 
     */
    public static NaturalResource_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static NaturalResource_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NaturalResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NaturalResource_conformsTo.Match {
    ...
    private static final class Immutable extends NaturalResource_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see NaturalResource_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<NaturalResource_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static NaturalResource_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NaturalResource_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NaturalResource_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<NaturalResource_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NaturalResource_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NaturalResource_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NaturalResource_conformsTo.Match> processor) {
     ...
     * 
     */
    public NaturalResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NaturalResource_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NaturalResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NaturalResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NaturalResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NaturalResource_conformsTo.Match partialMatch) {
    ...
    @Override
    protected NaturalResource_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return NaturalResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NaturalResource_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return NaturalResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NaturalResource_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NaturalResource_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NaturalResource_conformsTo.Matcher> querySpecification() {
      return NaturalResource_conformsTo.instance();
    }
  }
  
  private NaturalResource_conformsTo() {
   ...
   * 
   */
  public static NaturalResource_conformsTo instance() {
    try{
  ...
  @Override
  protected NaturalResource_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return NaturalResource_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public NaturalResource_conformsTo.Matcher instantiate() {
    return NaturalResource_conformsTo.Matcher.create();
  }
  
  @Override
  public NaturalResource_conformsTo.Match newEmptyMatch() {
    return NaturalResource_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public NaturalResource_conformsTo.Match newMatch(final Object... parameters) {
    return NaturalResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NaturalResource_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NaturalResource_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NaturalResource_conformsTo INSTANCE = new NaturalResource_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NaturalResource_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
