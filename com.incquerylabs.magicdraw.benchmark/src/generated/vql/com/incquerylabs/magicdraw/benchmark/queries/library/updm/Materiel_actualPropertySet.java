...
public final class Materiel_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Materiel_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_actualPropertySet.Match)) {
          Materiel_actualPropertySet.Match other = (Materiel_actualPropertySet.Match) obj;
    ...
    @Override
    public Materiel_actualPropertySet specification() {
      return Materiel_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Materiel_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Materiel_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Materiel_actualPropertySet.Match {
    ...
    private static final class Immutable extends Materiel_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Materiel_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Materiel_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Materiel_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Materiel_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Materiel_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Materiel_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Materiel_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Materiel_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Materiel_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Materiel_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Materiel_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_actualPropertySet.Matcher> querySpecification() {
      return Materiel_actualPropertySet.instance();
    }
  }
  
  private Materiel_actualPropertySet() {
   ...
   * 
   */
  public static Materiel_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Materiel_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Materiel_actualPropertySet.Matcher instantiate() {
    return Materiel_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Materiel_actualPropertySet.Match newEmptyMatch() {
    return Materiel_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_actualPropertySet.Match newMatch(final Object... parameters) {
    return Materiel_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_actualPropertySet INSTANCE = new Materiel_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
