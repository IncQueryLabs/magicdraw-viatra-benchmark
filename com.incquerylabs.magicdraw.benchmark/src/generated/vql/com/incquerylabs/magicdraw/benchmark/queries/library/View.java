...
public final class View extends BaseGeneratedEMFQuerySpecification<View.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.View pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.View";
    }
     ...
     * 
     */
    public static View.Match newMutableMatch(final PackageableElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static View.Match newMatch(final PackageableElement pElement, final Stereotype pStereotype) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.View pattern,
  ...
  public static class Matcher extends BaseMatcher<View.Match> {
     ...
     * 
     */
    public Collection<View.Match> getAllMatches(final PackageableElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<View.Match> streamAllMatches(final PackageableElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<View.Match> getOneArbitraryMatch(final PackageableElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final Stereotype pStereotype, final Consumer<? super View.Match> processor) {
     ...
     * 
     */
    public View.Match newMatch(final PackageableElement pElement, final Stereotype pStereotype) {
      return View.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<PackageableElement> streamAllValuesOfElement(final View.Match partialMatch) {
     ...
     * 
     */
    public Set<PackageableElement> getAllValuesOfElement(final View.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final View.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final View.Match partialMatch) {
    ...
    protected View.Match tupleToMatch(final Tuple t) {
      try {
          return View.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected View.Match arrayToMatch(final Object[] match) {
      try {
          return View.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected View.Match arrayToMatchMutable(final Object[] match) {
      try {
          return View.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public View.Match newMatch(final Object... parameters) {
    return View.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
