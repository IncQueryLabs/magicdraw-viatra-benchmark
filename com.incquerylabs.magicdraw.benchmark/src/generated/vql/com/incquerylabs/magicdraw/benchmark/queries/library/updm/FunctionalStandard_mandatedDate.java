...
public final class FunctionalStandard_mandatedDate extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_mandatedDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_mandatedDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_mandatedDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_mandatedDate.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_mandatedDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_mandatedDate.Match)) {
          FunctionalStandard_mandatedDate.Match other = (FunctionalStandard_mandatedDate.Match) obj;
    ...
    @Override
    public FunctionalStandard_mandatedDate specification() {
      return FunctionalStandard_mandatedDate.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_mandatedDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_mandatedDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static FunctionalStandard_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalStandard_mandatedDate.Match {
    ...
    private static final class Immutable extends FunctionalStandard_mandatedDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_mandatedDate pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_mandatedDate
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_mandatedDate.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_mandatedDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_mandatedDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_mandatedDate.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_mandatedDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FunctionalStandard_mandatedDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FunctionalStandard_mandatedDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super FunctionalStandard_mandatedDate.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return FunctionalStandard_mandatedDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final FunctionalStandard_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final FunctionalStandard_mandatedDate.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_mandatedDate.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalStandard_mandatedDate.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_mandatedDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_mandatedDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_mandatedDate.Matcher> querySpecification() {
      return FunctionalStandard_mandatedDate.instance();
    }
  }
  
  private FunctionalStandard_mandatedDate() {
   ...
   * 
   */
  public static FunctionalStandard_mandatedDate instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_mandatedDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_mandatedDate.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_mandatedDate.Matcher instantiate() {
    return FunctionalStandard_mandatedDate.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_mandatedDate.Match newEmptyMatch() {
    return FunctionalStandard_mandatedDate.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_mandatedDate.Match newMatch(final Object... parameters) {
    return FunctionalStandard_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_mandatedDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_mandatedDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_mandatedDate INSTANCE = new FunctionalStandard_mandatedDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_mandatedDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "mandatedDate");
