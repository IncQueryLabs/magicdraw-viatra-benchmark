...
public final class DesignConstraint_RefinedBy extends BaseGeneratedEMFQuerySpecification<DesignConstraint_RefinedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_RefinedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_RefinedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint_RefinedBy.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint_RefinedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint_RefinedBy.Match)) {
          DesignConstraint_RefinedBy.Match other = (DesignConstraint_RefinedBy.Match) obj;
    ...
    @Override
    public DesignConstraint_RefinedBy specification() {
     ...
     * 
     */
    public static DesignConstraint_RefinedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint_RefinedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static DesignConstraint_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DesignConstraint_RefinedBy.Match {
    ...
    private static final class Immutable extends DesignConstraint_RefinedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_RefinedBy pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint_RefinedBy
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint_RefinedBy.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint_RefinedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint_RefinedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint_RefinedBy.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint_RefinedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<DesignConstraint_RefinedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<DesignConstraint_RefinedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super DesignConstraint_RefinedBy.Match> processor) {
     ...
     * 
     */
    public DesignConstraint_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return DesignConstraint_RefinedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DesignConstraint_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DesignConstraint_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final DesignConstraint_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final DesignConstraint_RefinedBy.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint_RefinedBy.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected DesignConstraint_RefinedBy.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint_RefinedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint_RefinedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint_RefinedBy.Matcher> querySpecification() {
      return DesignConstraint_RefinedBy.instance();
    }
  }
  
  private DesignConstraint_RefinedBy() {
   ...
   * 
   */
  public static DesignConstraint_RefinedBy instance() {
    try{
  ...
  @Override
  protected DesignConstraint_RefinedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint_RefinedBy.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint_RefinedBy.Matcher instantiate() {
    return DesignConstraint_RefinedBy.Matcher.create();
  }
  
  @Override
  public DesignConstraint_RefinedBy.Match newEmptyMatch() {
    return DesignConstraint_RefinedBy.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint_RefinedBy.Match newMatch(final Object... parameters) {
    return DesignConstraint_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  ...
  private static class LazyHolder {
    private static final DesignConstraint_RefinedBy INSTANCE = new DesignConstraint_RefinedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint_RefinedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
