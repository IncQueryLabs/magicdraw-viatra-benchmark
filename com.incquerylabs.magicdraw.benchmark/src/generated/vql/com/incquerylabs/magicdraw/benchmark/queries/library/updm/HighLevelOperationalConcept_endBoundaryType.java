...
public final class HighLevelOperationalConcept_endBoundaryType extends BaseGeneratedEMFQuerySpecification<HighLevelOperationalConcept_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return HighLevelOperationalConcept_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public HighLevelOperationalConcept_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof HighLevelOperationalConcept_endBoundaryType.Match)) {
          HighLevelOperationalConcept_endBoundaryType.Match other = (HighLevelOperationalConcept_endBoundaryType.Match) obj;
    ...
    @Override
    public HighLevelOperationalConcept_endBoundaryType specification() {
      return HighLevelOperationalConcept_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static HighLevelOperationalConcept_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static HighLevelOperationalConcept_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends HighLevelOperationalConcept_endBoundaryType.Match {
    ...
    private static final class Immutable extends HighLevelOperationalConcept_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see HighLevelOperationalConcept_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<HighLevelOperationalConcept_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static HighLevelOperationalConcept_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(HighLevelOperationalConcept_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<HighLevelOperationalConcept_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<HighLevelOperationalConcept_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<HighLevelOperationalConcept_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super HighLevelOperationalConcept_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public HighLevelOperationalConcept_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return HighLevelOperationalConcept_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final HighLevelOperationalConcept_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final HighLevelOperationalConcept_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final HighLevelOperationalConcept_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final HighLevelOperationalConcept_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected HighLevelOperationalConcept_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return HighLevelOperationalConcept_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected HighLevelOperationalConcept_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return HighLevelOperationalConcept_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected HighLevelOperationalConcept_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return HighLevelOperationalConcept_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<HighLevelOperationalConcept_endBoundaryType.Matcher> querySpecification() {
      return HighLevelOperationalConcept_endBoundaryType.instance();
    }
  }
  
  private HighLevelOperationalConcept_endBoundaryType() {
   ...
   * 
   */
  public static HighLevelOperationalConcept_endBoundaryType instance() {
    try{
  ...
  @Override
  protected HighLevelOperationalConcept_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return HighLevelOperationalConcept_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public HighLevelOperationalConcept_endBoundaryType.Matcher instantiate() {
    return HighLevelOperationalConcept_endBoundaryType.Matcher.create();
  }
  
  @Override
  public HighLevelOperationalConcept_endBoundaryType.Match newEmptyMatch() {
    return HighLevelOperationalConcept_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public HighLevelOperationalConcept_endBoundaryType.Match newMatch(final Object... parameters) {
    return HighLevelOperationalConcept_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link HighLevelOperationalConcept_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link HighLevelOperationalConcept_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final HighLevelOperationalConcept_endBoundaryType INSTANCE = new HighLevelOperationalConcept_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final HighLevelOperationalConcept_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
