...
public final class ProtocolStack_URI extends BaseGeneratedEMFQuerySpecification<ProtocolStack_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolStack_URI.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolStack_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolStack_URI.Match)) {
          ProtocolStack_URI.Match other = (ProtocolStack_URI.Match) obj;
    ...
    @Override
    public ProtocolStack_URI specification() {
      return ProtocolStack_URI.instance();
    }
     ...
     * 
     */
    public static ProtocolStack_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolStack_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ProtocolStack_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProtocolStack_URI.Match {
    ...
    private static final class Immutable extends ProtocolStack_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_URI pattern,
   ...
   * 
   * @see Match
   * @see ProtocolStack_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolStack_URI.Match> {
    /**
     ...
     * 
     */
    public static ProtocolStack_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolStack_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolStack_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolStack_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ProtocolStack_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ProtocolStack_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ProtocolStack_URI.Match> processor) {
     ...
     * 
     */
    public ProtocolStack_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ProtocolStack_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProtocolStack_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProtocolStack_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ProtocolStack_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ProtocolStack_URI.Match partialMatch) {
    ...
    @Override
    protected ProtocolStack_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolStack_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProtocolStack_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolStack_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolStack_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolStack_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolStack_URI.Matcher> querySpecification() {
      return ProtocolStack_URI.instance();
    }
  }
  
  private ProtocolStack_URI() {
   ...
   * 
   */
  public static ProtocolStack_URI instance() {
    try{
  ...
  @Override
  protected ProtocolStack_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolStack_URI.Matcher.on(engine);
  }
  
  @Override
  public ProtocolStack_URI.Matcher instantiate() {
    return ProtocolStack_URI.Matcher.create();
  }
  
  @Override
  public ProtocolStack_URI.Match newEmptyMatch() {
    return ProtocolStack_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolStack_URI.Match newMatch(final Object... parameters) {
    return ProtocolStack_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolStack_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolStack_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolStack_URI INSTANCE = new ProtocolStack_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolStack_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
