...
public final class DesiredState extends BaseGeneratedEMFQuerySpecification<DesiredState.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.DesiredState pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.DesiredState";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesiredState.Match.parameterNames;
    }
    ...
    @Override
    public DesiredState.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesiredState.Match)) {
          DesiredState.Match other = (DesiredState.Match) obj;
    ...
    @Override
    public DesiredState specification() {
      return DesiredState.instance();
    }
     ...
     * 
     */
    public static DesiredState.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesiredState.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static DesiredState.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends DesiredState.Match {
    ...
    private static final class Immutable extends DesiredState.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.DesiredState pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<DesiredState.Match> {
    /**
     ...
     * 
     */
    public static DesiredState.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesiredState.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesiredState.Matcher.class);
     ...
     * 
     */
    public Collection<DesiredState.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<DesiredState.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<DesiredState.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super DesiredState.Match> processor) {
     ...
     * 
     */
    public DesiredState.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return DesiredState.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final DesiredState.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final DesiredState.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final DesiredState.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final DesiredState.Match partialMatch) {
    ...
    @Override
    protected DesiredState.Match tupleToMatch(final Tuple t) {
      try {
          return DesiredState.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected DesiredState.Match arrayToMatch(final Object[] match) {
      try {
          return DesiredState.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesiredState.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesiredState.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesiredState.Matcher> querySpecification() {
      return DesiredState.instance();
    }
  }
   ...
   * 
   */
  public static DesiredState instance() {
    try{
  ...
  @Override
  protected DesiredState.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesiredState.Matcher.on(engine);
  }
  
  @Override
  public DesiredState.Matcher instantiate() {
    return DesiredState.Matcher.create();
  }
  
  @Override
  public DesiredState.Match newEmptyMatch() {
    return DesiredState.Match.newEmptyMatch();
  }
  
  @Override
  public DesiredState.Match newMatch(final Object... parameters) {
    return DesiredState.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DesiredState} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DesiredState#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesiredState INSTANCE = new DesiredState();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesiredState.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "DesiredState");
