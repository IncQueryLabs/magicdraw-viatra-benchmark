...
public final class Software_actsUpon extends BaseGeneratedEMFQuerySpecification<Software_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public Software_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_actsUpon.Match)) {
          Software_actsUpon.Match other = (Software_actsUpon.Match) obj;
    ...
    @Override
    public Software_actsUpon specification() {
      return Software_actsUpon.instance();
    }
     ...
     * 
     */
    public static Software_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_actsUpon.Match {
    ...
    private static final class Immutable extends Software_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see Software_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<Software_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static Software_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<Software_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_actsUpon.Match> processor) {
     ...
     * 
     */
    public Software_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_actsUpon.Match partialMatch) {
    ...
    @Override
    protected Software_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return Software_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return Software_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_actsUpon.Matcher> querySpecification() {
      return Software_actsUpon.instance();
    }
  }
  
  private Software_actsUpon() {
   ...
   * 
   */
  public static Software_actsUpon instance() {
    try{
  ...
  @Override
  protected Software_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public Software_actsUpon.Matcher instantiate() {
    return Software_actsUpon.Matcher.create();
  }
  
  @Override
  public Software_actsUpon.Match newEmptyMatch() {
    return Software_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public Software_actsUpon.Match newMatch(final Object... parameters) {
    return Software_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_actsUpon INSTANCE = new Software_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
