...
public final class PerformsInContext_sourceContext extends BaseGeneratedEMFQuerySpecification<PerformsInContext_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformsInContext_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public PerformsInContext_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformsInContext_sourceContext.Match)) {
          PerformsInContext_sourceContext.Match other = (PerformsInContext_sourceContext.Match) obj;
    ...
    @Override
    public PerformsInContext_sourceContext specification() {
      return PerformsInContext_sourceContext.instance();
    }
     ...
     * 
     */
    public static PerformsInContext_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformsInContext_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static PerformsInContext_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PerformsInContext_sourceContext.Match {
    ...
    private static final class Immutable extends PerformsInContext_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see PerformsInContext_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<PerformsInContext_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static PerformsInContext_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformsInContext_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformsInContext_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<PerformsInContext_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<PerformsInContext_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<PerformsInContext_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super PerformsInContext_sourceContext.Match> processor) {
     ...
     * 
     */
    public PerformsInContext_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return PerformsInContext_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final PerformsInContext_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final PerformsInContext_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final PerformsInContext_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final PerformsInContext_sourceContext.Match partialMatch) {
    ...
    @Override
    protected PerformsInContext_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return PerformsInContext_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected PerformsInContext_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return PerformsInContext_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformsInContext_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformsInContext_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformsInContext_sourceContext.Matcher> querySpecification() {
      return PerformsInContext_sourceContext.instance();
    }
  }
  
  private PerformsInContext_sourceContext() {
   ...
   * 
   */
  public static PerformsInContext_sourceContext instance() {
    try{
  ...
  @Override
  protected PerformsInContext_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformsInContext_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public PerformsInContext_sourceContext.Matcher instantiate() {
    return PerformsInContext_sourceContext.Matcher.create();
  }
  
  @Override
  public PerformsInContext_sourceContext.Match newEmptyMatch() {
    return PerformsInContext_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public PerformsInContext_sourceContext.Match newMatch(final Object... parameters) {
    return PerformsInContext_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PerformsInContext_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PerformsInContext_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformsInContext_sourceContext INSTANCE = new PerformsInContext_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformsInContext_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
