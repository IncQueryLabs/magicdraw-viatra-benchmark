...
public final class OwnsProcess_sourceContext extends BaseGeneratedEMFQuerySpecification<OwnsProcess_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsProcess_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public OwnsProcess_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsProcess_sourceContext.Match)) {
          OwnsProcess_sourceContext.Match other = (OwnsProcess_sourceContext.Match) obj;
    ...
    @Override
    public OwnsProcess_sourceContext specification() {
      return OwnsProcess_sourceContext.instance();
    }
     ...
     * 
     */
    public static OwnsProcess_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsProcess_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static OwnsProcess_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsProcess_sourceContext.Match {
    ...
    private static final class Immutable extends OwnsProcess_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsProcess_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see OwnsProcess_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsProcess_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static OwnsProcess_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsProcess_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsProcess_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsProcess_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<OwnsProcess_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<OwnsProcess_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super OwnsProcess_sourceContext.Match> processor) {
     ...
     * 
     */
    public OwnsProcess_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return OwnsProcess_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsProcess_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsProcess_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final OwnsProcess_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final OwnsProcess_sourceContext.Match partialMatch) {
    ...
    @Override
    protected OwnsProcess_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsProcess_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsProcess_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsProcess_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsProcess_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsProcess_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsProcess_sourceContext.Matcher> querySpecification() {
      return OwnsProcess_sourceContext.instance();
    }
  }
  
  private OwnsProcess_sourceContext() {
   ...
   * 
   */
  public static OwnsProcess_sourceContext instance() {
    try{
  ...
  @Override
  protected OwnsProcess_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsProcess_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public OwnsProcess_sourceContext.Matcher instantiate() {
    return OwnsProcess_sourceContext.Matcher.create();
  }
  
  @Override
  public OwnsProcess_sourceContext.Match newEmptyMatch() {
    return OwnsProcess_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsProcess_sourceContext.Match newMatch(final Object... parameters) {
    return OwnsProcess_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsProcess_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsProcess_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsProcess_sourceContext INSTANCE = new OwnsProcess_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsProcess_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
