...
public final class Node_physicalLocation extends BaseGeneratedEMFQuerySpecification<Node_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Node_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_physicalLocation.Match)) {
          Node_physicalLocation.Match other = (Node_physicalLocation.Match) obj;
    ...
    @Override
    public Node_physicalLocation specification() {
      return Node_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Node_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Node_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_physicalLocation.Match {
    ...
    private static final class Immutable extends Node_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Node_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Node_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Node_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Node_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Node_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Node_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Node_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Node_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Node_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Node_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Node_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Node_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Node_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Node_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_physicalLocation.Matcher> querySpecification() {
      return Node_physicalLocation.instance();
    }
  }
  
  private Node_physicalLocation() {
   ...
   * 
   */
  public static Node_physicalLocation instance() {
    try{
  ...
  @Override
  protected Node_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Node_physicalLocation.Matcher instantiate() {
    return Node_physicalLocation.Matcher.create();
  }
  
  @Override
  public Node_physicalLocation.Match newEmptyMatch() {
    return Node_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Node_physicalLocation.Match newMatch(final Object... parameters) {
    return Node_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_physicalLocation INSTANCE = new Node_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
