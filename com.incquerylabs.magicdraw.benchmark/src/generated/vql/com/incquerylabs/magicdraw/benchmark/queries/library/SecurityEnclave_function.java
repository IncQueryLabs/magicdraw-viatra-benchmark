...
public final class SecurityEnclave_function extends BaseGeneratedEMFQuerySpecification<SecurityEnclave_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave_function.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave_function.Match)) {
          SecurityEnclave_function.Match other = (SecurityEnclave_function.Match) obj;
    ...
    @Override
    public SecurityEnclave_function specification() {
      return SecurityEnclave_function.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityEnclave_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityEnclave_function.Match {
    ...
    private static final class Immutable extends SecurityEnclave_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_function pattern,
   ...
   * 
   * @see Match
   * @see SecurityEnclave_function
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave_function.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave_function.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityEnclave_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityEnclave_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityEnclave_function.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityEnclave_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityEnclave_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityEnclave_function.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave_function.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityEnclave_function.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave_function.Matcher> querySpecification() {
      return SecurityEnclave_function.instance();
    }
  }
  
  private SecurityEnclave_function() {
   ...
   * 
   */
  public static SecurityEnclave_function instance() {
    try{
  ...
  @Override
  protected SecurityEnclave_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave_function.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave_function.Matcher instantiate() {
    return SecurityEnclave_function.Matcher.create();
  }
  
  @Override
  public SecurityEnclave_function.Match newEmptyMatch() {
    return SecurityEnclave_function.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave_function.Match newMatch(final Object... parameters) {
    return SecurityEnclave_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave_function INSTANCE = new SecurityEnclave_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
