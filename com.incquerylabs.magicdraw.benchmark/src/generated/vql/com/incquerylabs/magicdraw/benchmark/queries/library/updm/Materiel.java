...
public final class Materiel extends BaseGeneratedEMFQuerySpecification<Materiel.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel.Match.parameterNames;
    }
    ...
    @Override
    public Materiel.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel.Match)) {
          Materiel.Match other = (Materiel.Match) obj;
    ...
    @Override
    public Materiel specification() {
      return Materiel.instance();
    }
     ...
     * 
     */
    public static Materiel.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Materiel.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Materiel.Match {
    ...
    private static final class Immutable extends Materiel.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel.Match> {
    /**
     ...
     * 
     */
    public static Materiel.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Materiel.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Materiel.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Materiel.Match> processor) {
     ...
     * 
     */
    public Materiel.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Materiel.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Materiel.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Materiel.Match partialMatch) {
    ...
    @Override
    protected Materiel.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Materiel.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel.Matcher> querySpecification() {
      return Materiel.instance();
    }
  }
   ...
   * 
   */
  public static Materiel instance() {
    try{
  ...
  @Override
  protected Materiel.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel.Matcher.on(engine);
  }
  
  @Override
  public Materiel.Matcher instantiate() {
    return Materiel.Matcher.create();
  }
  
  @Override
  public Materiel.Match newEmptyMatch() {
    return Materiel.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel.Match newMatch(final Object... parameters) {
    return Materiel.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel INSTANCE = new Materiel();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Materiel");
