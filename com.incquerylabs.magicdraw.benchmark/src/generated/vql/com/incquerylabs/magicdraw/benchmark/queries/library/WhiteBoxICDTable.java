 ...
 *         pattern WhiteBoxICDTable(Element : Diagram, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "WhiteBoxICDTable");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class WhiteBoxICDTable extends BaseGeneratedEMFQuerySpecification<WhiteBoxICDTable.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static WhiteBoxICDTable.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static WhiteBoxICDTable.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<WhiteBoxICDTable.Match> {
     ...
     * 
     */
    public Collection<WhiteBoxICDTable.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<WhiteBoxICDTable.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<WhiteBoxICDTable.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super WhiteBoxICDTable.Match> processor) {
     ...
     * 
     */
    public WhiteBoxICDTable.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return WhiteBoxICDTable.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final WhiteBoxICDTable.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final WhiteBoxICDTable.Match partialMatch) {
    ...
    protected WhiteBoxICDTable.Match tupleToMatch(final Tuple t) {
      try {
          return WhiteBoxICDTable.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected WhiteBoxICDTable.Match arrayToMatch(final Object[] match) {
      try {
          return WhiteBoxICDTable.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected WhiteBoxICDTable.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WhiteBoxICDTable.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public WhiteBoxICDTable.Match newMatch(final Object... parameters) {
    return WhiteBoxICDTable.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
