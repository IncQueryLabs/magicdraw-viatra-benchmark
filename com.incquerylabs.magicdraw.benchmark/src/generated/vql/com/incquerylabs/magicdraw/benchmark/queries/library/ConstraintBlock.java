...
public final class ConstraintBlock extends BaseGeneratedEMFQuerySpecification<ConstraintBlock.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ConstraintBlock.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ConstraintBlock.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<ConstraintBlock.Match> {
     ...
     * 
     */
    public Collection<ConstraintBlock.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ConstraintBlock.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ConstraintBlock.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype, final Consumer<? super ConstraintBlock.Match> processor) {
     ...
     * 
     */
    public ConstraintBlock.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
      return ConstraintBlock.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ConstraintBlock.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ConstraintBlock.Match partialMatch) {
    ...
    protected ConstraintBlock.Match tupleToMatch(final Tuple t) {
      try {
          return ConstraintBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ConstraintBlock.Match arrayToMatch(final Object[] match) {
      try {
          return ConstraintBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ConstraintBlock.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConstraintBlock.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ConstraintBlock.Match newMatch(final Object... parameters) {
    return ConstraintBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
