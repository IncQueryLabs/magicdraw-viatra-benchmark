...
public final class Consumes_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Consumes_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Consumes_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Consumes_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Consumes_targetPropertyPath.Match)) {
          Consumes_targetPropertyPath.Match other = (Consumes_targetPropertyPath.Match) obj;
    ...
    @Override
    public Consumes_targetPropertyPath specification() {
      return Consumes_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static Consumes_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Consumes_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Consumes_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Consumes_targetPropertyPath.Match {
    ...
    private static final class Immutable extends Consumes_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Consumes_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Consumes_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Consumes_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Consumes_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Consumes_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Consumes_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Consumes_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Consumes_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Consumes_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public Consumes_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Consumes_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Consumes_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Consumes_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Consumes_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Consumes_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected Consumes_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Consumes_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Consumes_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Consumes_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Consumes_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Consumes_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Consumes_targetPropertyPath.Matcher> querySpecification() {
      return Consumes_targetPropertyPath.instance();
    }
  }
  
  private Consumes_targetPropertyPath() {
   ...
   * 
   */
  public static Consumes_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected Consumes_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Consumes_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Consumes_targetPropertyPath.Matcher instantiate() {
    return Consumes_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public Consumes_targetPropertyPath.Match newEmptyMatch() {
    return Consumes_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Consumes_targetPropertyPath.Match newMatch(final Object... parameters) {
    return Consumes_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Consumes_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Consumes_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Consumes_targetPropertyPath INSTANCE = new Consumes_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Consumes_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
