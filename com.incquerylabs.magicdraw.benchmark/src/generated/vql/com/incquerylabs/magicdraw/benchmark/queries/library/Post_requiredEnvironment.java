...
public final class Post_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Post_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Post_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Post_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_requiredEnvironment.Match)) {
          Post_requiredEnvironment.Match other = (Post_requiredEnvironment.Match) obj;
    ...
    @Override
    public Post_requiredEnvironment specification() {
      return Post_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Post_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Post_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Post_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Post_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Post_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Post_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Post_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Post_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Post_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Post_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_requiredEnvironment.Matcher> querySpecification() {
      return Post_requiredEnvironment.instance();
    }
  }
  
  private Post_requiredEnvironment() {
   ...
   * 
   */
  public static Post_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Post_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Post_requiredEnvironment.Matcher instantiate() {
    return Post_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Post_requiredEnvironment.Match newEmptyMatch() {
    return Post_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Post_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Post_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_requiredEnvironment INSTANCE = new Post_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
