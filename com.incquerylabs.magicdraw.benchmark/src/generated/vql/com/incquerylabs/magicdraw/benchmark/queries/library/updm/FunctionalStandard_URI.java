...
public final class FunctionalStandard_URI extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_URI.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_URI.Match)) {
          FunctionalStandard_URI.Match other = (FunctionalStandard_URI.Match) obj;
    ...
    @Override
    public FunctionalStandard_URI specification() {
      return FunctionalStandard_URI.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static FunctionalStandard_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends FunctionalStandard_URI.Match {
    ...
    private static final class Immutable extends FunctionalStandard_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_URI pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_URI
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_URI.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_URI.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<FunctionalStandard_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<FunctionalStandard_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super FunctionalStandard_URI.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return FunctionalStandard_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final FunctionalStandard_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final FunctionalStandard_URI.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_URI.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected FunctionalStandard_URI.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_URI.Matcher> querySpecification() {
      return FunctionalStandard_URI.instance();
    }
  }
  
  private FunctionalStandard_URI() {
   ...
   * 
   */
  public static FunctionalStandard_URI instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_URI.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_URI.Matcher instantiate() {
    return FunctionalStandard_URI.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_URI.Match newEmptyMatch() {
    return FunctionalStandard_URI.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_URI.Match newMatch(final Object... parameters) {
    return FunctionalStandard_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_URI INSTANCE = new FunctionalStandard_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
