...
public final class ActualEnvironment extends BaseGeneratedEMFQuerySpecification<ActualEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ActualEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualEnvironment.Match)) {
          ActualEnvironment.Match other = (ActualEnvironment.Match) obj;
    ...
    @Override
    public ActualEnvironment specification() {
      return ActualEnvironment.instance();
    }
     ...
     * 
     */
    public static ActualEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualEnvironment.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualEnvironment.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualEnvironment.Match {
    ...
    private static final class Immutable extends ActualEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ActualEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ActualEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ActualEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ActualEnvironment.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualEnvironment.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualEnvironment.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualEnvironment.Match> processor) {
     ...
     * 
     */
    public ActualEnvironment.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualEnvironment.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualEnvironment.Match partialMatch) {
    ...
    @Override
    protected ActualEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ActualEnvironment.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ActualEnvironment.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualEnvironment.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualEnvironment.Matcher> querySpecification() {
      return ActualEnvironment.instance();
    }
  }
  
  private ActualEnvironment() {
   ...
   * 
   */
  public static ActualEnvironment instance() {
    try{
  ...
  @Override
  protected ActualEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ActualEnvironment.Matcher instantiate() {
    return ActualEnvironment.Matcher.create();
  }
  
  @Override
  public ActualEnvironment.Match newEmptyMatch() {
    return ActualEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ActualEnvironment.Match newMatch(final Object... parameters) {
    return ActualEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualEnvironment INSTANCE = new ActualEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualEnvironment")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualEnvironment");
