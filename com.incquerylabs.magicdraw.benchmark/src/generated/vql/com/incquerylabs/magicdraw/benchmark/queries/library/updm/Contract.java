...
public final class Contract extends BaseGeneratedEMFQuerySpecification<Contract.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Contract pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Contract";
    }
    
    @Override
    public List<String> parameterNames() {
      return Contract.Match.parameterNames;
    }
    ...
    @Override
    public Contract.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Contract.Match)) {
          Contract.Match other = (Contract.Match) obj;
     ...
     * 
     */
    public static Contract.Match newEmptyMatch() {
     ...
     * 
     */
    public static Contract.Match newMutableMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Contract.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Contract.Match {
    ...
    private static final class Immutable extends Contract.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Contract pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Contract.Match> {
    /**
     ...
     * 
     */
    public static Contract.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Contract.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Contract.Matcher.class);
     ...
     * 
     */
    public Collection<Contract.Match> getAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Contract.Match> streamAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Contract.Match> getOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Contract.Match> processor) {
     ...
     * 
     */
    public Contract.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Contract.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Contract.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Contract.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Contract.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Contract.Match partialMatch) {
    ...
    @Override
    protected Contract.Match tupleToMatch(final Tuple t) {
      try {
          return Contract.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Contract.Match arrayToMatch(final Object[] match) {
      try {
          return Contract.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Contract.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Contract.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Contract.Matcher> querySpecification() {
      return Contract.instance();
    }
  }
  ...
  @Override
  protected Contract.Matcher instantiate(final ViatraQueryEngine engine) {
    return Contract.Matcher.on(engine);
  }
  
  @Override
  public Contract.Matcher instantiate() {
    return Contract.Matcher.create();
  }
  
  @Override
  public Contract.Match newEmptyMatch() {
    return Contract.Match.newEmptyMatch();
  }
  
  @Override
  public Contract.Match newMatch(final Object... parameters) {
    return Contract.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Contract} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Contract#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Contract.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Contract");
