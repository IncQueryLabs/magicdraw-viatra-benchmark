...
public final class RoleType_startBoundaryType extends BaseGeneratedEMFQuerySpecification<RoleType_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_startBoundaryType.Match)) {
          RoleType_startBoundaryType.Match other = (RoleType_startBoundaryType.Match) obj;
    ...
    @Override
    public RoleType_startBoundaryType specification() {
      return RoleType_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static RoleType_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_startBoundaryType.Match {
    ...
    private static final class Immutable extends RoleType_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see RoleType_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static RoleType_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public RoleType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected RoleType_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_startBoundaryType.Matcher> querySpecification() {
      return RoleType_startBoundaryType.instance();
    }
  }
  
  private RoleType_startBoundaryType() {
   ...
   * 
   */
  public static RoleType_startBoundaryType instance() {
    try{
  ...
  @Override
  protected RoleType_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public RoleType_startBoundaryType.Matcher instantiate() {
    return RoleType_startBoundaryType.Matcher.create();
  }
  
  @Override
  public RoleType_startBoundaryType.Match newEmptyMatch() {
    return RoleType_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_startBoundaryType.Match newMatch(final Object... parameters) {
    return RoleType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_startBoundaryType INSTANCE = new RoleType_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
