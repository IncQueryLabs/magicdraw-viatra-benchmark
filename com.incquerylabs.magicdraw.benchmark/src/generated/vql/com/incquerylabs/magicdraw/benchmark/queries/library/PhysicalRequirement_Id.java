...
public final class PhysicalRequirement_Id extends BaseGeneratedEMFQuerySpecification<PhysicalRequirement_Id.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static PhysicalRequirement_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public static PhysicalRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<PhysicalRequirement_Id.Match> {
     ...
     * 
     */
    public Collection<PhysicalRequirement_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Stream<PhysicalRequirement_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Optional<PhysicalRequirement_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue, final Consumer<? super PhysicalRequirement_Id.Match> processor) {
     ...
     * 
     */
    public PhysicalRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
      return PhysicalRequirement_Id.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final PhysicalRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final PhysicalRequirement_Id.Match partialMatch) {
    ...
    protected PhysicalRequirement_Id.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected PhysicalRequirement_Id.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected PhysicalRequirement_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalRequirement_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public PhysicalRequirement_Id.Match newMatch(final Object... parameters) {
    return PhysicalRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.String) parameters[1]);
  }
