...
public final class VersionOfConfiguration_endBoundaryType extends BaseGeneratedEMFQuerySpecification<VersionOfConfiguration_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionOfConfiguration_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public VersionOfConfiguration_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionOfConfiguration_endBoundaryType.Match)) {
          VersionOfConfiguration_endBoundaryType.Match other = (VersionOfConfiguration_endBoundaryType.Match) obj;
    ...
    @Override
    public VersionOfConfiguration_endBoundaryType specification() {
      return VersionOfConfiguration_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static VersionOfConfiguration_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionOfConfiguration_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static VersionOfConfiguration_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends VersionOfConfiguration_endBoundaryType.Match {
    ...
    private static final class Immutable extends VersionOfConfiguration_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see VersionOfConfiguration_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<VersionOfConfiguration_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static VersionOfConfiguration_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionOfConfiguration_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionOfConfiguration_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<VersionOfConfiguration_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<VersionOfConfiguration_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<VersionOfConfiguration_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super VersionOfConfiguration_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public VersionOfConfiguration_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return VersionOfConfiguration_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final VersionOfConfiguration_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final VersionOfConfiguration_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final VersionOfConfiguration_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final VersionOfConfiguration_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected VersionOfConfiguration_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return VersionOfConfiguration_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected VersionOfConfiguration_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return VersionOfConfiguration_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionOfConfiguration_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionOfConfiguration_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionOfConfiguration_endBoundaryType.Matcher> querySpecification() {
      return VersionOfConfiguration_endBoundaryType.instance();
    }
  }
  
  private VersionOfConfiguration_endBoundaryType() {
   ...
   * 
   */
  public static VersionOfConfiguration_endBoundaryType instance() {
    try{
  ...
  @Override
  protected VersionOfConfiguration_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionOfConfiguration_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public VersionOfConfiguration_endBoundaryType.Matcher instantiate() {
    return VersionOfConfiguration_endBoundaryType.Matcher.create();
  }
  
  @Override
  public VersionOfConfiguration_endBoundaryType.Match newEmptyMatch() {
    return VersionOfConfiguration_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public VersionOfConfiguration_endBoundaryType.Match newMatch(final Object... parameters) {
    return VersionOfConfiguration_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionOfConfiguration_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionOfConfiguration_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionOfConfiguration_endBoundaryType INSTANCE = new VersionOfConfiguration_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionOfConfiguration_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
