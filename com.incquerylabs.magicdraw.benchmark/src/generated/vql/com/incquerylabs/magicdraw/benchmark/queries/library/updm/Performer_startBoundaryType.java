...
public final class Performer_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Performer_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Performer_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_startBoundaryType.Match)) {
          Performer_startBoundaryType.Match other = (Performer_startBoundaryType.Match) obj;
    ...
    @Override
    public Performer_startBoundaryType specification() {
      return Performer_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Performer_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_startBoundaryType.Match {
    ...
    private static final class Immutable extends Performer_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Performer_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Performer_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Performer_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Performer_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_startBoundaryType.Matcher> querySpecification() {
      return Performer_startBoundaryType.instance();
    }
  }
  
  private Performer_startBoundaryType() {
   ...
   * 
   */
  public static Performer_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Performer_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Performer_startBoundaryType.Matcher instantiate() {
    return Performer_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Performer_startBoundaryType.Match newEmptyMatch() {
    return Performer_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_startBoundaryType.Match newMatch(final Object... parameters) {
    return Performer_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_startBoundaryType INSTANCE = new Performer_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
