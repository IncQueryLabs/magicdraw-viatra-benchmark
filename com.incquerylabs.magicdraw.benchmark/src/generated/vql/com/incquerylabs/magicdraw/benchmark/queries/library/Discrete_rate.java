...
public final class Discrete_rate extends BaseGeneratedEMFQuerySpecification<Discrete_rate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Discrete_rate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Discrete_rate";
    }
    
    @Override
    public List<String> parameterNames() {
      return Discrete_rate.Match.parameterNames;
    }
    ...
    @Override
    public Discrete_rate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Discrete_rate.Match)) {
          Discrete_rate.Match other = (Discrete_rate.Match) obj;
    ...
    @Override
    public Discrete_rate specification() {
     ...
     * 
     */
    public static Discrete_rate.Match newEmptyMatch() {
     ...
     * 
     */
    public static Discrete_rate.Match newMutableMatch(final NamedElement pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public static Discrete_rate.Match newMatch(final NamedElement pElement, final InstanceSpecification pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Discrete_rate.Match {
    ...
    private static final class Immutable extends Discrete_rate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Discrete_rate pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Discrete_rate.Match> {
    /**
     ...
     * 
     */
    public static Discrete_rate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Discrete_rate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Discrete_rate.Matcher.class);
     ...
     * 
     */
    public Collection<Discrete_rate.Match> getAllMatches(final NamedElement pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public Stream<Discrete_rate.Match> streamAllMatches(final NamedElement pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public Optional<Discrete_rate.Match> getOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final InstanceSpecification pValue, final Consumer<? super Discrete_rate.Match> processor) {
     ...
     * 
     */
    public Discrete_rate.Match newMatch(final NamedElement pElement, final InstanceSpecification pValue) {
      return Discrete_rate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfElement(final Discrete_rate.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfElement(final Discrete_rate.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfValue(final Discrete_rate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfValue(final Discrete_rate.Match partialMatch) {
    ...
    @Override
    protected Discrete_rate.Match tupleToMatch(final Tuple t) {
      try {
          return Discrete_rate.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_VALUE));
    ...
    @Override
    protected Discrete_rate.Match arrayToMatch(final Object[] match) {
      try {
          return Discrete_rate.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Discrete_rate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Discrete_rate.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Discrete_rate.Matcher> querySpecification() {
      return Discrete_rate.instance();
    }
  }
  
  private Discrete_rate() {
   ...
   * 
   */
  public static Discrete_rate instance() {
    try{
  ...
  @Override
  protected Discrete_rate.Matcher instantiate(final ViatraQueryEngine engine) {
    return Discrete_rate.Matcher.on(engine);
  }
  
  @Override
  public Discrete_rate.Matcher instantiate() {
    return Discrete_rate.Matcher.create();
  }
  
  @Override
  public Discrete_rate.Match newEmptyMatch() {
    return Discrete_rate.Match.newEmptyMatch();
  }
  
  @Override
  public Discrete_rate.Match newMatch(final Object... parameters) {
    return Discrete_rate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Discrete_rate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Discrete_rate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Discrete_rate INSTANCE = new Discrete_rate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Discrete_rate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Discrete(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), Discrete.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "rate", taggedValue)
