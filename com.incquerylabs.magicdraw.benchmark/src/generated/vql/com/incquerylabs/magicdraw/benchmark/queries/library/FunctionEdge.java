...
public final class FunctionEdge extends BaseGeneratedEMFQuerySpecification<FunctionEdge.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FunctionEdge pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FunctionEdge";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionEdge.Match.parameterNames;
    }
    ...
    @Override
    public FunctionEdge.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionEdge.Match)) {
          FunctionEdge.Match other = (FunctionEdge.Match) obj;
    ...
    @Override
    public FunctionEdge specification() {
      return FunctionEdge.instance();
    }
     ...
     * 
     */
    public static FunctionEdge.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionEdge.Match newMutableMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FunctionEdge.Match newMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends FunctionEdge.Match {
    ...
    private static final class Immutable extends FunctionEdge.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FunctionEdge pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionEdge.Match> {
    /**
     ...
     * 
     */
    public static FunctionEdge.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionEdge.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionEdge.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionEdge.Match> getAllMatches(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FunctionEdge.Match> streamAllMatches(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FunctionEdge.Match> getOneArbitraryMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FunctionEdge.Match> processor) {
     ...
     * 
     */
    public FunctionEdge.Match newMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FunctionEdge.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<ActivityEdge> streamAllValuesOfelement(final FunctionEdge.Match partialMatch) {
     ...
     * 
     */
    public Set<ActivityEdge> getAllValuesOfelement(final FunctionEdge.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FunctionEdge.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FunctionEdge.Match partialMatch) {
    ...
    @Override
    protected FunctionEdge.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionEdge.Match.newMatch((ActivityEdge) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected FunctionEdge.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionEdge.Match.newMatch((ActivityEdge) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionEdge.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionEdge.Match.newMutableMatch((ActivityEdge) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionEdge.Matcher> querySpecification() {
      return FunctionEdge.instance();
    }
  }
   ...
   * 
   */
  public static FunctionEdge instance() {
    try{
  ...
  @Override
  protected FunctionEdge.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionEdge.Matcher.on(engine);
  }
  
  @Override
  public FunctionEdge.Matcher instantiate() {
    return FunctionEdge.Matcher.create();
  }
  
  @Override
  public FunctionEdge.Match newEmptyMatch() {
    return FunctionEdge.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionEdge.Match newMatch(final Object... parameters) {
    return FunctionEdge.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ActivityEdge) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionEdge} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionEdge#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionEdge INSTANCE = new FunctionEdge();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionEdge.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "FunctionEdge")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "FunctionEdge");
