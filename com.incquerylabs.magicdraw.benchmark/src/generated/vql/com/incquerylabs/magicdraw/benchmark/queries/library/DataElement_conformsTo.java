...
public final class DataElement_conformsTo extends BaseGeneratedEMFQuerySpecification<DataElement_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return DataElement_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public DataElement_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DataElement_conformsTo.Match)) {
          DataElement_conformsTo.Match other = (DataElement_conformsTo.Match) obj;
    ...
    @Override
    public DataElement_conformsTo specification() {
      return DataElement_conformsTo.instance();
    }
     ...
     * 
     */
    public static DataElement_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static DataElement_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static DataElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DataElement_conformsTo.Match {
    ...
    private static final class Immutable extends DataElement_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see DataElement_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<DataElement_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static DataElement_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DataElement_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DataElement_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<DataElement_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<DataElement_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<DataElement_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super DataElement_conformsTo.Match> processor) {
     ...
     * 
     */
    public DataElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return DataElement_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DataElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DataElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final DataElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final DataElement_conformsTo.Match partialMatch) {
    ...
    @Override
    protected DataElement_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return DataElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected DataElement_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return DataElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DataElement_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DataElement_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DataElement_conformsTo.Matcher> querySpecification() {
      return DataElement_conformsTo.instance();
    }
  }
  
  private DataElement_conformsTo() {
   ...
   * 
   */
  public static DataElement_conformsTo instance() {
    try{
  ...
  @Override
  protected DataElement_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return DataElement_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public DataElement_conformsTo.Matcher instantiate() {
    return DataElement_conformsTo.Matcher.create();
  }
  
  @Override
  public DataElement_conformsTo.Match newEmptyMatch() {
    return DataElement_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public DataElement_conformsTo.Match newMatch(final Object... parameters) {
    return DataElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataElement_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataElement_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DataElement_conformsTo INSTANCE = new DataElement_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DataElement_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
