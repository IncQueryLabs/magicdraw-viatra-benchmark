 ...
 *         pattern ReferenceProperty(Element : Property, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "ReferenceProperty");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class ReferenceProperty extends BaseGeneratedEMFQuerySpecification<ReferenceProperty.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ReferenceProperty.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ReferenceProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<ReferenceProperty.Match> {
     ...
     * 
     */
    public Collection<ReferenceProperty.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ReferenceProperty.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ReferenceProperty.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super ReferenceProperty.Match> processor) {
     ...
     * 
     */
    public ReferenceProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return ReferenceProperty.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ReferenceProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ReferenceProperty.Match partialMatch) {
    ...
    protected ReferenceProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ReferenceProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ReferenceProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ReferenceProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ReferenceProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ReferenceProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ReferenceProperty.Match newMatch(final Object... parameters) {
    return ReferenceProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
