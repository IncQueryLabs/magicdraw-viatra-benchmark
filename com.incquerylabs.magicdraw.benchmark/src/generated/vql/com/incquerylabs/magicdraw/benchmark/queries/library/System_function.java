...
public final class System_function extends BaseGeneratedEMFQuerySpecification<System_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.System_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.System_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_function.Match.parameterNames;
    }
    ...
    @Override
    public System_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_function.Match)) {
          System_function.Match other = (System_function.Match) obj;
    ...
    @Override
    public System_function specification() {
      return System_function.instance();
    }
     ...
     * 
     */
    public static System_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_function.Match {
    ...
    private static final class Immutable extends System_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.System_function pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<System_function.Match> {
    /**
     ...
     * 
     */
    public static System_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_function.Matcher.class);
     ...
     * 
     */
    public Collection<System_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_function.Match> processor) {
     ...
     * 
     */
    public System_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_function.Match partialMatch) {
    ...
    @Override
    protected System_function.Match tupleToMatch(final Tuple t) {
      try {
          return System_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_function.Match arrayToMatch(final Object[] match) {
      try {
          return System_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_function.Matcher> querySpecification() {
      return System_function.instance();
    }
  }
  
  private System_function() {
   ...
   * 
   */
  public static System_function instance() {
    try{
  ...
  @Override
  protected System_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_function.Matcher.on(engine);
  }
  
  @Override
  public System_function.Matcher instantiate() {
    return System_function.Matcher.create();
  }
  
  @Override
  public System_function.Match newEmptyMatch() {
    return System_function.Match.newEmptyMatch();
  }
  
  @Override
  public System_function.Match newMatch(final Object... parameters) {
    return System_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_function INSTANCE = new System_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
