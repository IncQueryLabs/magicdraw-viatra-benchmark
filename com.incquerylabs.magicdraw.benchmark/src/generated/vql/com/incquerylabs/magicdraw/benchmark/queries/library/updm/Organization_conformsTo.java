...
public final class Organization_conformsTo extends BaseGeneratedEMFQuerySpecification<Organization_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Organization_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_conformsTo.Match)) {
          Organization_conformsTo.Match other = (Organization_conformsTo.Match) obj;
    ...
    @Override
    public Organization_conformsTo specification() {
      return Organization_conformsTo.instance();
    }
     ...
     * 
     */
    public static Organization_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_conformsTo.Match {
    ...
    private static final class Immutable extends Organization_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Organization_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Organization_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_conformsTo.Match> processor) {
     ...
     * 
     */
    public Organization_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Organization_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_conformsTo.Matcher> querySpecification() {
      return Organization_conformsTo.instance();
    }
  }
  
  private Organization_conformsTo() {
   ...
   * 
   */
  public static Organization_conformsTo instance() {
    try{
  ...
  @Override
  protected Organization_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Organization_conformsTo.Matcher instantiate() {
    return Organization_conformsTo.Matcher.create();
  }
  
  @Override
  public Organization_conformsTo.Match newEmptyMatch() {
    return Organization_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_conformsTo.Match newMatch(final Object... parameters) {
    return Organization_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_conformsTo INSTANCE = new Organization_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
