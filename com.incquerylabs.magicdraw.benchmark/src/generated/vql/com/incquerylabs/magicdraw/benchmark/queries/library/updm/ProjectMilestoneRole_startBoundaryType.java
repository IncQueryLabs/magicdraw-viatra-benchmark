...
public final class ProjectMilestoneRole_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectMilestoneRole_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestoneRole_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestoneRole_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestoneRole_startBoundaryType.Match)) {
          ProjectMilestoneRole_startBoundaryType.Match other = (ProjectMilestoneRole_startBoundaryType.Match) obj;
    ...
    @Override
    public ProjectMilestoneRole_startBoundaryType specification() {
      return ProjectMilestoneRole_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectMilestoneRole_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestoneRole_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestoneRole_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestoneRole_startBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectMilestoneRole_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestoneRole_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestoneRole_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestoneRole_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestoneRole_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestoneRole_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestoneRole_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestoneRole_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestoneRole_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectMilestoneRole_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectMilestoneRole_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectMilestoneRole_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectMilestoneRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectMilestoneRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestoneRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestoneRole_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestoneRole_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestoneRole_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestoneRole_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestoneRole_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestoneRole_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestoneRole_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestoneRole_startBoundaryType.Matcher> querySpecification() {
      return ProjectMilestoneRole_startBoundaryType.instance();
    }
  }
  
  private ProjectMilestoneRole_startBoundaryType() {
   ...
   * 
   */
  public static ProjectMilestoneRole_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectMilestoneRole_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestoneRole_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestoneRole_startBoundaryType.Matcher instantiate() {
    return ProjectMilestoneRole_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectMilestoneRole_startBoundaryType.Match newEmptyMatch() {
    return ProjectMilestoneRole_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestoneRole_startBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectMilestoneRole_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestoneRole_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestoneRole_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestoneRole_startBoundaryType INSTANCE = new ProjectMilestoneRole_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestoneRole_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
