...
public final class ControlNotItemFlow extends BaseGeneratedEMFQuerySpecification<ControlNotItemFlow.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.controlNotItemFlow pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.controlNotItemFlow";
    }
    
    @Override
    public List<String> parameterNames() {
      return ControlNotItemFlow.Match.parameterNames;
    }
    ...
    @Override
    public ControlNotItemFlow.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ControlNotItemFlow.Match)) {
          ControlNotItemFlow.Match other = (ControlNotItemFlow.Match) obj;
    ...
    @Override
    public ControlNotItemFlow specification() {
     ...
     * 
     */
    public static ControlNotItemFlow.Match newEmptyMatch() {
     ...
     * 
     */
    public static ControlNotItemFlow.Match newMutableMatch(final InformationFlow pInformationFlow) {
     ...
     * 
     */
    public static ControlNotItemFlow.Match newMatch(final InformationFlow pInformationFlow) {
      return new Immutable(pInformationFlow);
    }
    
    private static final class Mutable extends ControlNotItemFlow.Match {
    ...
    private static final class Immutable extends ControlNotItemFlow.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.controlNotItemFlow pattern,
   ...
   * 
   * @see Match
   * @see ControlNotItemFlow
   * 
   */
  public static class Matcher extends BaseMatcher<ControlNotItemFlow.Match> {
    /**
     ...
     * 
     */
    public static ControlNotItemFlow.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ControlNotItemFlow.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_INFORMATIONFLOW = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ControlNotItemFlow.Matcher.class);
     ...
     * 
     */
    public Collection<ControlNotItemFlow.Match> getAllMatches(final InformationFlow pInformationFlow) {
     ...
     * 
     */
    public Stream<ControlNotItemFlow.Match> streamAllMatches(final InformationFlow pInformationFlow) {
     ...
     * 
     */
    public Optional<ControlNotItemFlow.Match> getOneArbitraryMatch(final InformationFlow pInformationFlow) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pInformationFlow, final Consumer<? super ControlNotItemFlow.Match> processor) {
     ...
     * 
     */
    public ControlNotItemFlow.Match newMatch(final InformationFlow pInformationFlow) {
      return ControlNotItemFlow.Match.newMatch(pInformationFlow);
    }
    ...
    @Override
    protected ControlNotItemFlow.Match tupleToMatch(final Tuple t) {
      try {
          return ControlNotItemFlow.Match.newMatch((InformationFlow) t.get(POSITION_INFORMATIONFLOW));
    ...
    @Override
    protected ControlNotItemFlow.Match arrayToMatch(final Object[] match) {
      try {
          return ControlNotItemFlow.Match.newMatch((InformationFlow) match[POSITION_INFORMATIONFLOW]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ControlNotItemFlow.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ControlNotItemFlow.Match.newMutableMatch((InformationFlow) match[POSITION_INFORMATIONFLOW]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ControlNotItemFlow.Matcher> querySpecification() {
      return ControlNotItemFlow.instance();
    }
  }
  
  private ControlNotItemFlow() {
   ...
   * 
   */
  public static ControlNotItemFlow instance() {
    try{
  ...
  @Override
  protected ControlNotItemFlow.Matcher instantiate(final ViatraQueryEngine engine) {
    return ControlNotItemFlow.Matcher.on(engine);
  }
  
  @Override
  public ControlNotItemFlow.Matcher instantiate() {
    return ControlNotItemFlow.Matcher.create();
  }
  
  @Override
  public ControlNotItemFlow.Match newEmptyMatch() {
    return ControlNotItemFlow.Match.newEmptyMatch();
  }
  
  @Override
  public ControlNotItemFlow.Match newMatch(final Object... parameters) {
    return ControlNotItemFlow.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ControlNotItemFlow} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ControlNotItemFlow#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ControlNotItemFlow INSTANCE = new ControlNotItemFlow();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ControlNotItemFlow.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //     find com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control(informationFlow, _)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_informationFlow, var___0_), Control.instance().getInternalQueryRepresentation());
          //     neg find com.incquerylabs.magicdraw.benchmark.queries.library.ItemFlow(informationFlow, _)
