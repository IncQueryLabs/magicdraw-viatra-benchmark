...
public final class TransactionalAttribute extends BaseGeneratedEMFQuerySpecification<TransactionalAttribute.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TransactionalAttribute pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TransactionalAttribute";
    }
    
    @Override
    public List<String> parameterNames() {
      return TransactionalAttribute.Match.parameterNames;
    }
    ...
    @Override
    public TransactionalAttribute.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TransactionalAttribute.Match)) {
          TransactionalAttribute.Match other = (TransactionalAttribute.Match) obj;
    ...
    @Override
    public TransactionalAttribute specification() {
      return TransactionalAttribute.instance();
    }
     ...
     * 
     */
    public static TransactionalAttribute.Match newEmptyMatch() {
     ...
     * 
     */
    public static TransactionalAttribute.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static TransactionalAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends TransactionalAttribute.Match {
    ...
    private static final class Immutable extends TransactionalAttribute.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TransactionalAttribute pattern,
   ...
   * 
   * @see Match
   * @see TransactionalAttribute
   * 
   */
  public static class Matcher extends BaseMatcher<TransactionalAttribute.Match> {
    /**
     ...
     * 
     */
    public static TransactionalAttribute.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TransactionalAttribute.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TransactionalAttribute.Matcher.class);
     ...
     * 
     */
    public Collection<TransactionalAttribute.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<TransactionalAttribute.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<TransactionalAttribute.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super TransactionalAttribute.Match> processor) {
     ...
     * 
     */
    public TransactionalAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return TransactionalAttribute.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TransactionalAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TransactionalAttribute.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final TransactionalAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final TransactionalAttribute.Match partialMatch) {
    ...
    @Override
    protected TransactionalAttribute.Match tupleToMatch(final Tuple t) {
      try {
          return TransactionalAttribute.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected TransactionalAttribute.Match arrayToMatch(final Object[] match) {
      try {
          return TransactionalAttribute.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TransactionalAttribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TransactionalAttribute.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TransactionalAttribute.Matcher> querySpecification() {
      return TransactionalAttribute.instance();
    }
  }
  
  private TransactionalAttribute() {
   ...
   * 
   */
  public static TransactionalAttribute instance() {
    try{
  ...
  @Override
  protected TransactionalAttribute.Matcher instantiate(final ViatraQueryEngine engine) {
    return TransactionalAttribute.Matcher.on(engine);
  }
  
  @Override
  public TransactionalAttribute.Matcher instantiate() {
    return TransactionalAttribute.Matcher.create();
  }
  
  @Override
  public TransactionalAttribute.Match newEmptyMatch() {
    return TransactionalAttribute.Match.newEmptyMatch();
  }
  
  @Override
  public TransactionalAttribute.Match newMatch(final Object... parameters) {
    return TransactionalAttribute.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TransactionalAttribute} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TransactionalAttribute#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TransactionalAttribute INSTANCE = new TransactionalAttribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TransactionalAttribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "TransactionalAttribute");
