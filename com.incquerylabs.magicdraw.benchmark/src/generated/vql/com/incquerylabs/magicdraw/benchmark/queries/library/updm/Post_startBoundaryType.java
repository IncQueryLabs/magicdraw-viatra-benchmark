...
public final class Post_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Post_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Post_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_startBoundaryType.Match)) {
          Post_startBoundaryType.Match other = (Post_startBoundaryType.Match) obj;
    ...
    @Override
    public Post_startBoundaryType specification() {
      return Post_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Post_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_startBoundaryType.Match {
    ...
    private static final class Immutable extends Post_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Post_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Post_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Post_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Post_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Post_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Post_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Post_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Post_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_startBoundaryType.Matcher> querySpecification() {
      return Post_startBoundaryType.instance();
    }
  }
  
  private Post_startBoundaryType() {
   ...
   * 
   */
  public static Post_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Post_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Post_startBoundaryType.Matcher instantiate() {
    return Post_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Post_startBoundaryType.Match newEmptyMatch() {
    return Post_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Post_startBoundaryType.Match newMatch(final Object... parameters) {
    return Post_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_startBoundaryType INSTANCE = new Post_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
