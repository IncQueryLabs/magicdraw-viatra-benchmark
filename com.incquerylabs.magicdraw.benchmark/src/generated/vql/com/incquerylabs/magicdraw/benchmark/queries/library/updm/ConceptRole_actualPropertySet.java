...
public final class ConceptRole_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ConceptRole_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptRole_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ConceptRole_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptRole_actualPropertySet.Match)) {
          ConceptRole_actualPropertySet.Match other = (ConceptRole_actualPropertySet.Match) obj;
    ...
    @Override
    public ConceptRole_actualPropertySet specification() {
      return ConceptRole_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ConceptRole_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptRole_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConceptRole_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConceptRole_actualPropertySet.Match {
    ...
    private static final class Immutable extends ConceptRole_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ConceptRole_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptRole_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ConceptRole_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptRole_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptRole_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptRole_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConceptRole_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConceptRole_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConceptRole_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ConceptRole_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ConceptRole_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConceptRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConceptRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConceptRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConceptRole_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ConceptRole_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptRole_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConceptRole_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptRole_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptRole_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptRole_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptRole_actualPropertySet.Matcher> querySpecification() {
      return ConceptRole_actualPropertySet.instance();
    }
  }
  
  private ConceptRole_actualPropertySet() {
   ...
   * 
   */
  public static ConceptRole_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ConceptRole_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptRole_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ConceptRole_actualPropertySet.Matcher instantiate() {
    return ConceptRole_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ConceptRole_actualPropertySet.Match newEmptyMatch() {
    return ConceptRole_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptRole_actualPropertySet.Match newMatch(final Object... parameters) {
    return ConceptRole_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptRole_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptRole_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptRole_actualPropertySet INSTANCE = new ConceptRole_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptRole_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
