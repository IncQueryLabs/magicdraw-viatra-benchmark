...
public final class Organization_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<Organization_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Organization_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public Organization_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_categoryCategorizesAsset.Match)) {
          Organization_categoryCategorizesAsset.Match other = (Organization_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public Organization_categoryCategorizesAsset specification() {
      return Organization_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static Organization_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends Organization_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see Organization_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static Organization_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public Organization_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected Organization_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_categoryCategorizesAsset.Matcher> querySpecification() {
      return Organization_categoryCategorizesAsset.instance();
    }
  }
  
  private Organization_categoryCategorizesAsset() {
   ...
   * 
   */
  public static Organization_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected Organization_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public Organization_categoryCategorizesAsset.Matcher instantiate() {
    return Organization_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public Organization_categoryCategorizesAsset.Match newEmptyMatch() {
    return Organization_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return Organization_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_categoryCategorizesAsset INSTANCE = new Organization_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
