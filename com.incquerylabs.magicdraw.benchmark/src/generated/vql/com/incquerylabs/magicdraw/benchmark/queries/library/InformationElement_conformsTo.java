...
public final class InformationElement_conformsTo extends BaseGeneratedEMFQuerySpecification<InformationElement_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return InformationElement_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public InformationElement_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InformationElement_conformsTo.Match)) {
          InformationElement_conformsTo.Match other = (InformationElement_conformsTo.Match) obj;
    ...
    @Override
    public InformationElement_conformsTo specification() {
      return InformationElement_conformsTo.instance();
    }
     ...
     * 
     */
    public static InformationElement_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static InformationElement_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static InformationElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends InformationElement_conformsTo.Match {
    ...
    private static final class Immutable extends InformationElement_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see InformationElement_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<InformationElement_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static InformationElement_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InformationElement_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InformationElement_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<InformationElement_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<InformationElement_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<InformationElement_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super InformationElement_conformsTo.Match> processor) {
     ...
     * 
     */
    public InformationElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return InformationElement_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InformationElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InformationElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final InformationElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final InformationElement_conformsTo.Match partialMatch) {
    ...
    @Override
    protected InformationElement_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return InformationElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected InformationElement_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return InformationElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InformationElement_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InformationElement_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InformationElement_conformsTo.Matcher> querySpecification() {
      return InformationElement_conformsTo.instance();
    }
  }
  
  private InformationElement_conformsTo() {
   ...
   * 
   */
  public static InformationElement_conformsTo instance() {
    try{
  ...
  @Override
  protected InformationElement_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return InformationElement_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public InformationElement_conformsTo.Matcher instantiate() {
    return InformationElement_conformsTo.Matcher.create();
  }
  
  @Override
  public InformationElement_conformsTo.Match newEmptyMatch() {
    return InformationElement_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public InformationElement_conformsTo.Match newMatch(final Object... parameters) {
    return InformationElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InformationElement_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InformationElement_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InformationElement_conformsTo INSTANCE = new InformationElement_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InformationElement_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
