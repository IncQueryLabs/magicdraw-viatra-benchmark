...
public final class EnvironmentProperty_minValue extends BaseGeneratedEMFQuerySpecification<EnvironmentProperty_minValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_minValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_minValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnvironmentProperty_minValue.Match.parameterNames;
    }
    ...
    @Override
    public EnvironmentProperty_minValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnvironmentProperty_minValue.Match)) {
          EnvironmentProperty_minValue.Match other = (EnvironmentProperty_minValue.Match) obj;
    ...
    @Override
    public EnvironmentProperty_minValue specification() {
      return EnvironmentProperty_minValue.instance();
    }
     ...
     * 
     */
    public static EnvironmentProperty_minValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnvironmentProperty_minValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnvironmentProperty_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnvironmentProperty_minValue.Match {
    ...
    private static final class Immutable extends EnvironmentProperty_minValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_minValue pattern,
   ...
   * 
   * @see Match
   * @see EnvironmentProperty_minValue
   * 
   */
  public static class Matcher extends BaseMatcher<EnvironmentProperty_minValue.Match> {
    /**
     ...
     * 
     */
    public static EnvironmentProperty_minValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnvironmentProperty_minValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnvironmentProperty_minValue.Matcher.class);
     ...
     * 
     */
    public Collection<EnvironmentProperty_minValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnvironmentProperty_minValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnvironmentProperty_minValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super EnvironmentProperty_minValue.Match> processor) {
     ...
     * 
     */
    public EnvironmentProperty_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return EnvironmentProperty_minValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EnvironmentProperty_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EnvironmentProperty_minValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnvironmentProperty_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnvironmentProperty_minValue.Match partialMatch) {
    ...
    @Override
    protected EnvironmentProperty_minValue.Match tupleToMatch(final Tuple t) {
      try {
          return EnvironmentProperty_minValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnvironmentProperty_minValue.Match arrayToMatch(final Object[] match) {
      try {
          return EnvironmentProperty_minValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnvironmentProperty_minValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnvironmentProperty_minValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnvironmentProperty_minValue.Matcher> querySpecification() {
      return EnvironmentProperty_minValue.instance();
    }
  }
  
  private EnvironmentProperty_minValue() {
   ...
   * 
   */
  public static EnvironmentProperty_minValue instance() {
    try{
  ...
  @Override
  protected EnvironmentProperty_minValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnvironmentProperty_minValue.Matcher.on(engine);
  }
  
  @Override
  public EnvironmentProperty_minValue.Matcher instantiate() {
    return EnvironmentProperty_minValue.Matcher.create();
  }
  
  @Override
  public EnvironmentProperty_minValue.Match newEmptyMatch() {
    return EnvironmentProperty_minValue.Match.newEmptyMatch();
  }
  
  @Override
  public EnvironmentProperty_minValue.Match newMatch(final Object... parameters) {
    return EnvironmentProperty_minValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnvironmentProperty_minValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnvironmentProperty_minValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnvironmentProperty_minValue INSTANCE = new EnvironmentProperty_minValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnvironmentProperty_minValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "minValue");
