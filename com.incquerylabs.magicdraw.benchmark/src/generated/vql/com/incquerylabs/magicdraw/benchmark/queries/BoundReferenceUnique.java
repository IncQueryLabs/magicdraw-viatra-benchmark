...
public final class BoundReferenceUnique extends BaseGeneratedEMFQuerySpecification<BoundReferenceUnique.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.boundReferenceUnique pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.boundReferenceUnique";
    }
    
    @Override
    public List<String> parameterNames() {
      return BoundReferenceUnique.Match.parameterNames;
    }
    ...
    @Override
    public BoundReferenceUnique.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BoundReferenceUnique.Match)) {
          BoundReferenceUnique.Match other = (BoundReferenceUnique.Match) obj;
    ...
    @Override
    public BoundReferenceUnique specification() {
     ...
     * 
     */
    public static BoundReferenceUnique.Match newEmptyMatch() {
     ...
     * 
     */
    public static BoundReferenceUnique.Match newMutableMatch(final Property pBoundReference) {
     ...
     * 
     */
    public static BoundReferenceUnique.Match newMatch(final Property pBoundReference) {
      return new Immutable(pBoundReference);
    }
    
    private static final class Mutable extends BoundReferenceUnique.Match {
    ...
    private static final class Immutable extends BoundReferenceUnique.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.boundReferenceUnique pattern,
   ...
   * 
   * @see Match
   * @see BoundReferenceUnique
   * 
   */
  public static class Matcher extends BaseMatcher<BoundReferenceUnique.Match> {
    /**
     ...
     * 
     */
    public static BoundReferenceUnique.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BoundReferenceUnique.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_BOUNDREFERENCE = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BoundReferenceUnique.Matcher.class);
     ...
     * 
     */
    public Collection<BoundReferenceUnique.Match> getAllMatches(final Property pBoundReference) {
     ...
     * 
     */
    public Stream<BoundReferenceUnique.Match> streamAllMatches(final Property pBoundReference) {
     ...
     * 
     */
    public Optional<BoundReferenceUnique.Match> getOneArbitraryMatch(final Property pBoundReference) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pBoundReference, final Consumer<? super BoundReferenceUnique.Match> processor) {
     ...
     * 
     */
    public BoundReferenceUnique.Match newMatch(final Property pBoundReference) {
      return BoundReferenceUnique.Match.newMatch(pBoundReference);
    }
    ...
    @Override
    protected BoundReferenceUnique.Match tupleToMatch(final Tuple t) {
      try {
          return BoundReferenceUnique.Match.newMatch((Property) t.get(POSITION_BOUNDREFERENCE));
    ...
    @Override
    protected BoundReferenceUnique.Match arrayToMatch(final Object[] match) {
      try {
          return BoundReferenceUnique.Match.newMatch((Property) match[POSITION_BOUNDREFERENCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BoundReferenceUnique.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BoundReferenceUnique.Match.newMutableMatch((Property) match[POSITION_BOUNDREFERENCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BoundReferenceUnique.Matcher> querySpecification() {
      return BoundReferenceUnique.instance();
    }
  }
  
  private BoundReferenceUnique() {
   ...
   * 
   */
  public static BoundReferenceUnique instance() {
    try{
  ...
  @Override
  protected BoundReferenceUnique.Matcher instantiate(final ViatraQueryEngine engine) {
    return BoundReferenceUnique.Matcher.on(engine);
  }
  
  @Override
  public BoundReferenceUnique.Matcher instantiate() {
    return BoundReferenceUnique.Matcher.create();
  }
  
  @Override
  public BoundReferenceUnique.Match newEmptyMatch() {
    return BoundReferenceUnique.Match.newEmptyMatch();
  }
  
  @Override
  public BoundReferenceUnique.Match newMatch(final Object... parameters) {
    return BoundReferenceUnique.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0]);
  }
  ...
  private static class LazyHolder {
    private static final BoundReferenceUnique INSTANCE = new BoundReferenceUnique();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BoundReferenceUnique.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_boundReference, var__virtual_2_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "MultiplicityElement", "isUnique")));
