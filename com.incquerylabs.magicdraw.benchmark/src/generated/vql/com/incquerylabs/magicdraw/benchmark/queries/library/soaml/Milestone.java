...
public final class Milestone extends BaseGeneratedEMFQuerySpecification<Milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return Milestone.Match.parameterNames;
    }
    ...
    @Override
    public Milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Milestone.Match)) {
          Milestone.Match other = (Milestone.Match) obj;
    ...
    @Override
    public Milestone specification() {
     ...
     * 
     */
    public static Milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static Milestone.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Milestone.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Milestone.Match {
    ...
    private static final class Immutable extends Milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Milestone pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Milestone.Match> {
    /**
     ...
     * 
     */
    public static Milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Milestone.Matcher.class);
     ...
     * 
     */
    public Collection<Milestone.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Milestone.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Milestone.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Milestone.Match> processor) {
     ...
     * 
     */
    public Milestone.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Milestone.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Milestone.Match partialMatch) {
    ...
    @Override
    protected Milestone.Match tupleToMatch(final Tuple t) {
      try {
          return Milestone.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Milestone.Match arrayToMatch(final Object[] match) {
      try {
          return Milestone.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Milestone.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Milestone.Matcher> querySpecification() {
      return Milestone.instance();
    }
  }
  ...
  @Override
  protected Milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return Milestone.Matcher.on(engine);
  }
  
  @Override
  public Milestone.Matcher instantiate() {
    return Milestone.Matcher.create();
  }
  
  @Override
  public Milestone.Match newEmptyMatch() {
    return Milestone.Match.newEmptyMatch();
  }
  
  @Override
  public Milestone.Match newMatch(final Object... parameters) {
    return Milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Milestone INSTANCE = new Milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Milestone");
