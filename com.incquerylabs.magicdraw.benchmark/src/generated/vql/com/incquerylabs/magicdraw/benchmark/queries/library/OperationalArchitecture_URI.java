...
public final class OperationalArchitecture_URI extends BaseGeneratedEMFQuerySpecification<OperationalArchitecture_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalArchitecture_URI.Match.parameterNames;
    }
    ...
    @Override
    public OperationalArchitecture_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalArchitecture_URI.Match)) {
          OperationalArchitecture_URI.Match other = (OperationalArchitecture_URI.Match) obj;
    ...
    @Override
    public OperationalArchitecture_URI specification() {
      return OperationalArchitecture_URI.instance();
    }
     ...
     * 
     */
    public static OperationalArchitecture_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalArchitecture_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static OperationalArchitecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalArchitecture_URI.Match {
    ...
    private static final class Immutable extends OperationalArchitecture_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_URI pattern,
   ...
   * 
   * @see Match
   * @see OperationalArchitecture_URI
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalArchitecture_URI.Match> {
    /**
     ...
     * 
     */
    public static OperationalArchitecture_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalArchitecture_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalArchitecture_URI.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalArchitecture_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<OperationalArchitecture_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<OperationalArchitecture_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super OperationalArchitecture_URI.Match> processor) {
     ...
     * 
     */
    public OperationalArchitecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return OperationalArchitecture_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final OperationalArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final OperationalArchitecture_URI.Match partialMatch) {
    ...
    @Override
    protected OperationalArchitecture_URI.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalArchitecture_URI.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalArchitecture_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalArchitecture_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalArchitecture_URI.Matcher> querySpecification() {
      return OperationalArchitecture_URI.instance();
    }
  }
  
  private OperationalArchitecture_URI() {
   ...
   * 
   */
  public static OperationalArchitecture_URI instance() {
    try{
  ...
  @Override
  protected OperationalArchitecture_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalArchitecture_URI.Matcher.on(engine);
  }
  
  @Override
  public OperationalArchitecture_URI.Matcher instantiate() {
    return OperationalArchitecture_URI.Matcher.create();
  }
  
  @Override
  public OperationalArchitecture_URI.Match newEmptyMatch() {
    return OperationalArchitecture_URI.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalArchitecture_URI.Match newMatch(final Object... parameters) {
    return OperationalArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalArchitecture_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalArchitecture_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalArchitecture_URI INSTANCE = new OperationalArchitecture_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalArchitecture_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
