...
public final class Performer_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Performer_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Performer_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_endBoundaryType.Match)) {
          Performer_endBoundaryType.Match other = (Performer_endBoundaryType.Match) obj;
    ...
    @Override
    public Performer_endBoundaryType specification() {
      return Performer_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Performer_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_endBoundaryType.Match {
    ...
    private static final class Immutable extends Performer_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Performer_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Performer_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Performer_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Performer_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_endBoundaryType.Matcher> querySpecification() {
      return Performer_endBoundaryType.instance();
    }
  }
  
  private Performer_endBoundaryType() {
   ...
   * 
   */
  public static Performer_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Performer_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Performer_endBoundaryType.Matcher instantiate() {
    return Performer_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Performer_endBoundaryType.Match newEmptyMatch() {
    return Performer_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_endBoundaryType.Match newMatch(final Object... parameters) {
    return Performer_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_endBoundaryType INSTANCE = new Performer_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
