...
public final class OrganizationInEnterprise extends BaseGeneratedEMFQuerySpecification<OrganizationInEnterprise.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationInEnterprise pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationInEnterprise";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationInEnterprise.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationInEnterprise.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationInEnterprise.Match)) {
          OrganizationInEnterprise.Match other = (OrganizationInEnterprise.Match) obj;
    ...
    @Override
    public OrganizationInEnterprise specification() {
      return OrganizationInEnterprise.instance();
    }
     ...
     * 
     */
    public static OrganizationInEnterprise.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationInEnterprise.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OrganizationInEnterprise.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OrganizationInEnterprise.Match {
    ...
    private static final class Immutable extends OrganizationInEnterprise.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationInEnterprise pattern,
   ...
   * 
   * @see Match
   * @see OrganizationInEnterprise
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationInEnterprise.Match> {
    /**
     ...
     * 
     */
    public static OrganizationInEnterprise.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationInEnterprise.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationInEnterprise.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationInEnterprise.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OrganizationInEnterprise.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OrganizationInEnterprise.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OrganizationInEnterprise.Match> processor) {
     ...
     * 
     */
    public OrganizationInEnterprise.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OrganizationInEnterprise.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OrganizationInEnterprise.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OrganizationInEnterprise.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OrganizationInEnterprise.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OrganizationInEnterprise.Match partialMatch) {
    ...
    @Override
    protected OrganizationInEnterprise.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationInEnterprise.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OrganizationInEnterprise.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationInEnterprise.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationInEnterprise.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationInEnterprise.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationInEnterprise.Matcher> querySpecification() {
      return OrganizationInEnterprise.instance();
    }
  }
  
  private OrganizationInEnterprise() {
   ...
   * 
   */
  public static OrganizationInEnterprise instance() {
    try{
  ...
  @Override
  protected OrganizationInEnterprise.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationInEnterprise.Matcher.on(engine);
  }
  
  @Override
  public OrganizationInEnterprise.Matcher instantiate() {
    return OrganizationInEnterprise.Matcher.create();
  }
  
  @Override
  public OrganizationInEnterprise.Match newEmptyMatch() {
    return OrganizationInEnterprise.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationInEnterprise.Match newMatch(final Object... parameters) {
    return OrganizationInEnterprise.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationInEnterprise} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationInEnterprise#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationInEnterprise INSTANCE = new OrganizationInEnterprise();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationInEnterprise.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OrganizationInEnterprise")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OrganizationInEnterprise");
