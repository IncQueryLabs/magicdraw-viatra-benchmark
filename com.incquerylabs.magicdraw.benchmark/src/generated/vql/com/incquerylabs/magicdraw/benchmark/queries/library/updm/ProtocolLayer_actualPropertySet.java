...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer;
...
public final class ProtocolLayer_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ProtocolLayer_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolLayer_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolLayer_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolLayer_actualPropertySet.Match)) {
          ProtocolLayer_actualPropertySet.Match other = (ProtocolLayer_actualPropertySet.Match) obj;
    ...
    @Override
    public ProtocolLayer_actualPropertySet specification() {
      return ProtocolLayer_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ProtocolLayer_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolLayer_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolLayer_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolLayer_actualPropertySet.Match {
    ...
    private static final class Immutable extends ProtocolLayer_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ProtocolLayer_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolLayer_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ProtocolLayer_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolLayer_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolLayer_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolLayer_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolLayer_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolLayer_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProtocolLayer_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ProtocolLayer_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ProtocolLayer_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProtocolLayer_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProtocolLayer_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolLayer_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolLayer_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ProtocolLayer_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolLayer_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolLayer_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolLayer_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolLayer_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolLayer_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolLayer_actualPropertySet.Matcher> querySpecification() {
      return ProtocolLayer_actualPropertySet.instance();
    }
  }
  
  private ProtocolLayer_actualPropertySet() {
   ...
   * 
   */
  public static ProtocolLayer_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ProtocolLayer_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolLayer_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ProtocolLayer_actualPropertySet.Matcher instantiate() {
    return ProtocolLayer_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ProtocolLayer_actualPropertySet.Match newEmptyMatch() {
    return ProtocolLayer_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolLayer_actualPropertySet.Match newMatch(final Object... parameters) {
    return ProtocolLayer_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolLayer_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolLayer_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolLayer_actualPropertySet INSTANCE = new ProtocolLayer_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolLayer_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
