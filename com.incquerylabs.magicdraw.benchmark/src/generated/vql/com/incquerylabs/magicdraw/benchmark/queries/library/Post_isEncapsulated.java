...
public final class Post_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Post_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Post_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Post_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_isEncapsulated.Match)) {
          Post_isEncapsulated.Match other = (Post_isEncapsulated.Match) obj;
    ...
    @Override
    public Post_isEncapsulated specification() {
      return Post_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Post_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Post_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Post_isEncapsulated.Match {
    ...
    private static final class Immutable extends Post_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Post_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Post_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Post_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Post_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Post_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Post_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Post_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Post_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Post_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Post_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Post_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Post_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Post_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Post_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Post_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_isEncapsulated.Matcher> querySpecification() {
      return Post_isEncapsulated.instance();
    }
  }
  
  private Post_isEncapsulated() {
   ...
   * 
   */
  public static Post_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Post_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Post_isEncapsulated.Matcher instantiate() {
    return Post_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Post_isEncapsulated.Match newEmptyMatch() {
    return Post_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Post_isEncapsulated.Match newMatch(final Object... parameters) {
    return Post_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_isEncapsulated INSTANCE = new Post_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
