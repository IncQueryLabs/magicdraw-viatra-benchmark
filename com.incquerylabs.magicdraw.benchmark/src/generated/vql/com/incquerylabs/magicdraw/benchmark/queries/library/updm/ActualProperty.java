...
public final class ActualProperty extends BaseGeneratedEMFQuerySpecification<ActualProperty.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProperty.Match.parameterNames;
    }
    ...
    @Override
    public ActualProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProperty.Match)) {
          ActualProperty.Match other = (ActualProperty.Match) obj;
    ...
    @Override
    public ActualProperty specification() {
      return ActualProperty.instance();
    }
     ...
     * 
     */
    public static ActualProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProperty.Match newMutableMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualProperty.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualProperty.Match {
    ...
    private static final class Immutable extends ActualProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProperty.Match> {
    /**
     ...
     * 
     */
    public static ActualProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProperty.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProperty.Match> getAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualProperty.Match> streamAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualProperty.Match> getOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualProperty.Match> processor) {
     ...
     * 
     */
    public ActualProperty.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualProperty.Match partialMatch) {
    ...
    @Override
    protected ActualProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProperty.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProperty.Match.newMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProperty.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProperty.Matcher> querySpecification() {
      return ActualProperty.instance();
    }
  }
  
  private ActualProperty() {
   ...
   * 
   */
  public static ActualProperty instance() {
    try{
  ...
  @Override
  protected ActualProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProperty.Matcher.on(engine);
  }
  
  @Override
  public ActualProperty.Matcher instantiate() {
    return ActualProperty.Matcher.create();
  }
  
  @Override
  public ActualProperty.Match newEmptyMatch() {
    return ActualProperty.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProperty.Match newMatch(final Object... parameters) {
    return ActualProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProperty} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProperty#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProperty INSTANCE = new ActualProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ActualProperty");
