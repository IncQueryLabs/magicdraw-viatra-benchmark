...
public final class System_URI extends BaseGeneratedEMFQuerySpecification<System_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_URI.Match.parameterNames;
    }
    ...
    @Override
    public System_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_URI.Match)) {
          System_URI.Match other = (System_URI.Match) obj;
    ...
    @Override
    public System_URI specification() {
      return System_URI.instance();
    }
     ...
     * 
     */
    public static System_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static System_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends System_URI.Match {
    ...
    private static final class Immutable extends System_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<System_URI.Match> {
    /**
     ...
     * 
     */
    public static System_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_URI.Matcher.class);
     ...
     * 
     */
    public Collection<System_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<System_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<System_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super System_URI.Match> processor) {
     ...
     * 
     */
    public System_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return System_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final System_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final System_URI.Match partialMatch) {
    ...
    @Override
    protected System_URI.Match tupleToMatch(final Tuple t) {
      try {
          return System_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected System_URI.Match arrayToMatch(final Object[] match) {
      try {
          return System_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_URI.Matcher> querySpecification() {
      return System_URI.instance();
    }
  }
   ...
   * 
   */
  public static System_URI instance() {
    try{
  ...
  @Override
  protected System_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_URI.Matcher.on(engine);
  }
  
  @Override
  public System_URI.Matcher instantiate() {
    return System_URI.Matcher.create();
  }
  
  @Override
  public System_URI.Match newEmptyMatch() {
    return System_URI.Match.newEmptyMatch();
  }
  
  @Override
  public System_URI.Match newMatch(final Object... parameters) {
    return System_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_URI INSTANCE = new System_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
