...
public final class WholeLifeEnterprise_startBoundaryType extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_startBoundaryType.Match)) {
          WholeLifeEnterprise_startBoundaryType.Match other = (WholeLifeEnterprise_startBoundaryType.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_startBoundaryType specification() {
      return WholeLifeEnterprise_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_startBoundaryType.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_startBoundaryType.Matcher> querySpecification() {
      return WholeLifeEnterprise_startBoundaryType.instance();
    }
  }
  
  private WholeLifeEnterprise_startBoundaryType() {
   ...
   * 
   */
  public static WholeLifeEnterprise_startBoundaryType instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_startBoundaryType.Matcher instantiate() {
    return WholeLifeEnterprise_startBoundaryType.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_startBoundaryType.Match newEmptyMatch() {
    return WholeLifeEnterprise_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_startBoundaryType.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_startBoundaryType INSTANCE = new WholeLifeEnterprise_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
