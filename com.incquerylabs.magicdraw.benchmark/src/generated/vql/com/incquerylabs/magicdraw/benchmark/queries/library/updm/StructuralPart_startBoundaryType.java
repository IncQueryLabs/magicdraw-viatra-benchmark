...
public final class StructuralPart_startBoundaryType extends BaseGeneratedEMFQuerySpecification<StructuralPart_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return StructuralPart_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public StructuralPart_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StructuralPart_startBoundaryType.Match)) {
          StructuralPart_startBoundaryType.Match other = (StructuralPart_startBoundaryType.Match) obj;
    ...
    @Override
    public StructuralPart_startBoundaryType specification() {
      return StructuralPart_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static StructuralPart_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static StructuralPart_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static StructuralPart_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends StructuralPart_startBoundaryType.Match {
    ...
    private static final class Immutable extends StructuralPart_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see StructuralPart_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<StructuralPart_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static StructuralPart_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StructuralPart_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StructuralPart_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<StructuralPart_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<StructuralPart_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<StructuralPart_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super StructuralPart_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public StructuralPart_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return StructuralPart_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final StructuralPart_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final StructuralPart_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final StructuralPart_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final StructuralPart_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected StructuralPart_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return StructuralPart_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected StructuralPart_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return StructuralPart_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StructuralPart_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StructuralPart_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StructuralPart_startBoundaryType.Matcher> querySpecification() {
      return StructuralPart_startBoundaryType.instance();
    }
  }
  
  private StructuralPart_startBoundaryType() {
   ...
   * 
   */
  public static StructuralPart_startBoundaryType instance() {
    try{
  ...
  @Override
  protected StructuralPart_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return StructuralPart_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public StructuralPart_startBoundaryType.Matcher instantiate() {
    return StructuralPart_startBoundaryType.Matcher.create();
  }
  
  @Override
  public StructuralPart_startBoundaryType.Match newEmptyMatch() {
    return StructuralPart_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public StructuralPart_startBoundaryType.Match newMatch(final Object... parameters) {
    return StructuralPart_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StructuralPart_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StructuralPart_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StructuralPart_startBoundaryType INSTANCE = new StructuralPart_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StructuralPart_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
