...
public final class PhysicalRequirement_Derived extends BaseGeneratedEMFQuerySpecification<PhysicalRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.physicalRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.physicalRequirement_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalRequirement_Derived.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalRequirement_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalRequirement_Derived.Match)) {
          PhysicalRequirement_Derived.Match other = (PhysicalRequirement_Derived.Match) obj;
    ...
    @Override
    public PhysicalRequirement_Derived specification() {
     ...
     * 
     */
    public static PhysicalRequirement_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalRequirement_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalRequirement_Derived.Match {
    ...
    private static final class Immutable extends PhysicalRequirement_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.physicalRequirement_Derived pattern,
   ...
   * 
   * @see Match
   * @see PhysicalRequirement_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalRequirement_Derived.Match> {
    /**
     ...
     * 
     */
    public static PhysicalRequirement_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalRequirement_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalRequirement_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalRequirement_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalRequirement_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalRequirement_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalRequirement_Derived.Match> processor) {
     ...
     * 
     */
    public PhysicalRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalRequirement_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final PhysicalRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final PhysicalRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final PhysicalRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final PhysicalRequirement_Derived.Match partialMatch) {
    ...
    @Override
    protected PhysicalRequirement_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalRequirement_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalRequirement_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalRequirement_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalRequirement_Derived.Matcher> querySpecification() {
      return PhysicalRequirement_Derived.instance();
    }
  }
  
  private PhysicalRequirement_Derived() {
   ...
   * 
   */
  public static PhysicalRequirement_Derived instance() {
    try{
  ...
  @Override
  protected PhysicalRequirement_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalRequirement_Derived.Matcher.on(engine);
  }
  
  @Override
  public PhysicalRequirement_Derived.Matcher instantiate() {
    return PhysicalRequirement_Derived.Matcher.create();
  }
  
  @Override
  public PhysicalRequirement_Derived.Match newEmptyMatch() {
    return PhysicalRequirement_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalRequirement_Derived.Match newMatch(final Object... parameters) {
    return PhysicalRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  ...
  private static class LazyHolder {
    private static final PhysicalRequirement_Derived INSTANCE = new PhysicalRequirement_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalRequirement_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
