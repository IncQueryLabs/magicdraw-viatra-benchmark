...
public final class ResourcePerformer_function extends BaseGeneratedEMFQuerySpecification<ResourcePerformer_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourcePerformer_function.Match.parameterNames;
    }
    ...
    @Override
    public ResourcePerformer_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourcePerformer_function.Match)) {
          ResourcePerformer_function.Match other = (ResourcePerformer_function.Match) obj;
    ...
    @Override
    public ResourcePerformer_function specification() {
      return ResourcePerformer_function.instance();
    }
     ...
     * 
     */
    public static ResourcePerformer_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourcePerformer_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourcePerformer_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourcePerformer_function.Match {
    ...
    private static final class Immutable extends ResourcePerformer_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_function pattern,
   ...
   * 
   * @see Match
   * @see ResourcePerformer_function
   * 
   */
  public static class Matcher extends BaseMatcher<ResourcePerformer_function.Match> {
    /**
     ...
     * 
     */
    public static ResourcePerformer_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourcePerformer_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourcePerformer_function.Matcher.class);
     ...
     * 
     */
    public Collection<ResourcePerformer_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourcePerformer_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourcePerformer_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourcePerformer_function.Match> processor) {
     ...
     * 
     */
    public ResourcePerformer_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourcePerformer_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourcePerformer_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourcePerformer_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourcePerformer_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourcePerformer_function.Match partialMatch) {
    ...
    @Override
    protected ResourcePerformer_function.Match tupleToMatch(final Tuple t) {
      try {
          return ResourcePerformer_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourcePerformer_function.Match arrayToMatch(final Object[] match) {
      try {
          return ResourcePerformer_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourcePerformer_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourcePerformer_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourcePerformer_function.Matcher> querySpecification() {
      return ResourcePerformer_function.instance();
    }
  }
  
  private ResourcePerformer_function() {
   ...
   * 
   */
  public static ResourcePerformer_function instance() {
    try{
  ...
  @Override
  protected ResourcePerformer_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourcePerformer_function.Matcher.on(engine);
  }
  
  @Override
  public ResourcePerformer_function.Matcher instantiate() {
    return ResourcePerformer_function.Matcher.create();
  }
  
  @Override
  public ResourcePerformer_function.Match newEmptyMatch() {
    return ResourcePerformer_function.Match.newEmptyMatch();
  }
  
  @Override
  public ResourcePerformer_function.Match newMatch(final Object... parameters) {
    return ResourcePerformer_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourcePerformer_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourcePerformer_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourcePerformer_function INSTANCE = new ResourcePerformer_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourcePerformer_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
