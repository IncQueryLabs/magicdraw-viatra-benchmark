...
public final class ProjectStatus_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ProjectStatus_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectStatus_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectStatus_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectStatus_actualPropertySet.Match)) {
          ProjectStatus_actualPropertySet.Match other = (ProjectStatus_actualPropertySet.Match) obj;
    ...
    @Override
    public ProjectStatus_actualPropertySet specification() {
      return ProjectStatus_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ProjectStatus_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectStatus_actualPropertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectStatus_actualPropertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectStatus_actualPropertySet.Match {
    ...
    private static final class Immutable extends ProjectStatus_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectStatus_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectStatus_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectStatus_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectStatus_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectStatus_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectStatus_actualPropertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectStatus_actualPropertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectStatus_actualPropertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ProjectStatus_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ProjectStatus_actualPropertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ProjectStatus_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ProjectStatus_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ProjectStatus_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectStatus_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectStatus_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectStatus_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectStatus_actualPropertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectStatus_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectStatus_actualPropertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectStatus_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectStatus_actualPropertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectStatus_actualPropertySet.Matcher> querySpecification() {
      return ProjectStatus_actualPropertySet.instance();
    }
  }
  
  private ProjectStatus_actualPropertySet() {
   ...
   * 
   */
  public static ProjectStatus_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ProjectStatus_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectStatus_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectStatus_actualPropertySet.Matcher instantiate() {
    return ProjectStatus_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ProjectStatus_actualPropertySet.Match newEmptyMatch() {
    return ProjectStatus_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectStatus_actualPropertySet.Match newMatch(final Object... parameters) {
    return ProjectStatus_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectStatus_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectStatus_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectStatus_actualPropertySet INSTANCE = new ProjectStatus_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectStatus_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
