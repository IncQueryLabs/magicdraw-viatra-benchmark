...
public final class ExternalTupleType extends BaseGeneratedEMFQuerySpecification<ExternalTupleType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTupleType.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTupleType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTupleType.Match)) {
          ExternalTupleType.Match other = (ExternalTupleType.Match) obj;
    ...
    @Override
    public ExternalTupleType specification() {
      return ExternalTupleType.instance();
    }
     ...
     * 
     */
    public static ExternalTupleType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTupleType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ExternalTupleType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ExternalTupleType.Match {
    ...
    private static final class Immutable extends ExternalTupleType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType pattern,
   ...
   * 
   * @see Match
   * @see ExternalTupleType
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTupleType.Match> {
    /**
     ...
     * 
     */
    public static ExternalTupleType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTupleType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTupleType.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTupleType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ExternalTupleType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ExternalTupleType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ExternalTupleType.Match> processor) {
     ...
     * 
     */
    public ExternalTupleType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ExternalTupleType.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTupleType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTupleType.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ExternalTupleType.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ExternalTupleType.Match partialMatch) {
    ...
    @Override
    protected ExternalTupleType.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTupleType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ExternalTupleType.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTupleType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTupleType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTupleType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTupleType.Matcher> querySpecification() {
      return ExternalTupleType.instance();
    }
  }
  
  private ExternalTupleType() {
   ...
   * 
   */
  public static ExternalTupleType instance() {
    try{
  ...
  @Override
  protected ExternalTupleType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTupleType.Matcher.on(engine);
  }
  
  @Override
  public ExternalTupleType.Matcher instantiate() {
    return ExternalTupleType.Matcher.create();
  }
  
  @Override
  public ExternalTupleType.Match newEmptyMatch() {
    return ExternalTupleType.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTupleType.Match newMatch(final Object... parameters) {
    return ExternalTupleType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTupleType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTupleType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTupleType INSTANCE = new ExternalTupleType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTupleType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ExternalTupleType");
