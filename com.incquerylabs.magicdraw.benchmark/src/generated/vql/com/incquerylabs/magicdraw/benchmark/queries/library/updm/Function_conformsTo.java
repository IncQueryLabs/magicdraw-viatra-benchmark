...
public final class Function_conformsTo extends BaseGeneratedEMFQuerySpecification<Function_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Function_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Function_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Function_conformsTo.Match)) {
          Function_conformsTo.Match other = (Function_conformsTo.Match) obj;
    ...
    @Override
    public Function_conformsTo specification() {
      return Function_conformsTo.instance();
    }
     ...
     * 
     */
    public static Function_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Function_conformsTo.Match newMutableMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public static Function_conformsTo.Match newMatch(final Activity pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Function_conformsTo.Match {
    ...
    private static final class Immutable extends Function_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Function_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Function_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Function_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Function_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Function_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Function_conformsTo.Match> getAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Function_conformsTo.Match> streamAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Function_conformsTo.Match> getOneArbitraryMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final Element pValue, final Consumer<? super Function_conformsTo.Match> processor) {
     ...
     * 
     */
    public Function_conformsTo.Match newMatch(final Activity pElement, final Element pValue) {
      return Function_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Function_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Function_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Function_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Function_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Function_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Function_conformsTo.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Function_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Function_conformsTo.Match.newMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Function_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Function_conformsTo.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Function_conformsTo.Matcher> querySpecification() {
      return Function_conformsTo.instance();
    }
  }
  
  private Function_conformsTo() {
   ...
   * 
   */
  public static Function_conformsTo instance() {
    try{
  ...
  @Override
  protected Function_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Function_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Function_conformsTo.Matcher instantiate() {
    return Function_conformsTo.Matcher.create();
  }
  
  @Override
  public Function_conformsTo.Match newEmptyMatch() {
    return Function_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Function_conformsTo.Match newMatch(final Object... parameters) {
    return Function_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Function_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Function_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Function_conformsTo INSTANCE = new Function_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Function_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
