...
public final class HighLevelOperationalConcept_URI extends BaseGeneratedEMFQuerySpecification<HighLevelOperationalConcept_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return HighLevelOperationalConcept_URI.Match.parameterNames;
    }
    ...
    @Override
    public HighLevelOperationalConcept_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof HighLevelOperationalConcept_URI.Match)) {
          HighLevelOperationalConcept_URI.Match other = (HighLevelOperationalConcept_URI.Match) obj;
    ...
    @Override
    public HighLevelOperationalConcept_URI specification() {
      return HighLevelOperationalConcept_URI.instance();
    }
     ...
     * 
     */
    public static HighLevelOperationalConcept_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static HighLevelOperationalConcept_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends HighLevelOperationalConcept_URI.Match {
    ...
    private static final class Immutable extends HighLevelOperationalConcept_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_URI pattern,
   ...
   * 
   * @see Match
   * @see HighLevelOperationalConcept_URI
   * 
   */
  public static class Matcher extends BaseMatcher<HighLevelOperationalConcept_URI.Match> {
    /**
     ...
     * 
     */
    public static HighLevelOperationalConcept_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(HighLevelOperationalConcept_URI.Matcher.class);
     ...
     * 
     */
    public Collection<HighLevelOperationalConcept_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<HighLevelOperationalConcept_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<HighLevelOperationalConcept_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super HighLevelOperationalConcept_URI.Match> processor) {
     ...
     * 
     */
    public HighLevelOperationalConcept_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return HighLevelOperationalConcept_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final HighLevelOperationalConcept_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final HighLevelOperationalConcept_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final HighLevelOperationalConcept_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final HighLevelOperationalConcept_URI.Match partialMatch) {
    ...
    @Override
    protected HighLevelOperationalConcept_URI.Match tupleToMatch(final Tuple t) {
      try {
          return HighLevelOperationalConcept_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected HighLevelOperationalConcept_URI.Match arrayToMatch(final Object[] match) {
      try {
          return HighLevelOperationalConcept_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected HighLevelOperationalConcept_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return HighLevelOperationalConcept_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<HighLevelOperationalConcept_URI.Matcher> querySpecification() {
      return HighLevelOperationalConcept_URI.instance();
    }
  }
  
  private HighLevelOperationalConcept_URI() {
   ...
   * 
   */
  public static HighLevelOperationalConcept_URI instance() {
    try{
  ...
  @Override
  protected HighLevelOperationalConcept_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return HighLevelOperationalConcept_URI.Matcher.on(engine);
  }
  
  @Override
  public HighLevelOperationalConcept_URI.Matcher instantiate() {
    return HighLevelOperationalConcept_URI.Matcher.create();
  }
  
  @Override
  public HighLevelOperationalConcept_URI.Match newEmptyMatch() {
    return HighLevelOperationalConcept_URI.Match.newEmptyMatch();
  }
  
  @Override
  public HighLevelOperationalConcept_URI.Match newMatch(final Object... parameters) {
    return HighLevelOperationalConcept_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link HighLevelOperationalConcept_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link HighLevelOperationalConcept_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final HighLevelOperationalConcept_URI INSTANCE = new HighLevelOperationalConcept_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final HighLevelOperationalConcept_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
