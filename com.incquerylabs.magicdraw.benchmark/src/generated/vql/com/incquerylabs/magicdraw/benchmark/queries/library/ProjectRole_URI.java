...
public final class ProjectRole_URI extends BaseGeneratedEMFQuerySpecification<ProjectRole_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectRole_URI.Match.parameterNames;
    }
    ...
    @Override
    public ProjectRole_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectRole_URI.Match)) {
          ProjectRole_URI.Match other = (ProjectRole_URI.Match) obj;
    ...
    @Override
    public ProjectRole_URI specification() {
      return ProjectRole_URI.instance();
    }
     ...
     * 
     */
    public static ProjectRole_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectRole_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ProjectRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProjectRole_URI.Match {
    ...
    private static final class Immutable extends ProjectRole_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectRole_URI.Match> {
    /**
     ...
     * 
     */
    public static ProjectRole_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectRole_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectRole_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectRole_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ProjectRole_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ProjectRole_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ProjectRole_URI.Match> processor) {
     ...
     * 
     */
    public ProjectRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ProjectRole_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ProjectRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ProjectRole_URI.Match partialMatch) {
    ...
    @Override
    protected ProjectRole_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectRole_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProjectRole_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectRole_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectRole_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectRole_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectRole_URI.Matcher> querySpecification() {
      return ProjectRole_URI.instance();
    }
  }
  
  private ProjectRole_URI() {
   ...
   * 
   */
  public static ProjectRole_URI instance() {
    try{
  ...
  @Override
  protected ProjectRole_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectRole_URI.Matcher.on(engine);
  }
  
  @Override
  public ProjectRole_URI.Matcher instantiate() {
    return ProjectRole_URI.Matcher.create();
  }
  
  @Override
  public ProjectRole_URI.Match newEmptyMatch() {
    return ProjectRole_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectRole_URI.Match newMatch(final Object... parameters) {
    return ProjectRole_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectRole_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectRole_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectRole_URI INSTANCE = new ProjectRole_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectRole_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
