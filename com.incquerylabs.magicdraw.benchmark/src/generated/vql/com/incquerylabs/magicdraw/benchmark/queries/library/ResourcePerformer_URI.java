...
public final class ResourcePerformer_URI extends BaseGeneratedEMFQuerySpecification<ResourcePerformer_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourcePerformer_URI.Match.parameterNames;
    }
    ...
    @Override
    public ResourcePerformer_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourcePerformer_URI.Match)) {
          ResourcePerformer_URI.Match other = (ResourcePerformer_URI.Match) obj;
    ...
    @Override
    public ResourcePerformer_URI specification() {
      return ResourcePerformer_URI.instance();
    }
     ...
     * 
     */
    public static ResourcePerformer_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourcePerformer_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ResourcePerformer_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourcePerformer_URI.Match {
    ...
    private static final class Immutable extends ResourcePerformer_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_URI pattern,
   ...
   * 
   * @see Match
   * @see ResourcePerformer_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ResourcePerformer_URI.Match> {
    /**
     ...
     * 
     */
    public static ResourcePerformer_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourcePerformer_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourcePerformer_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ResourcePerformer_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ResourcePerformer_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ResourcePerformer_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ResourcePerformer_URI.Match> processor) {
     ...
     * 
     */
    public ResourcePerformer_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ResourcePerformer_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourcePerformer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourcePerformer_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ResourcePerformer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ResourcePerformer_URI.Match partialMatch) {
    ...
    @Override
    protected ResourcePerformer_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ResourcePerformer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourcePerformer_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ResourcePerformer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourcePerformer_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourcePerformer_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourcePerformer_URI.Matcher> querySpecification() {
      return ResourcePerformer_URI.instance();
    }
  }
  
  private ResourcePerformer_URI() {
   ...
   * 
   */
  public static ResourcePerformer_URI instance() {
    try{
  ...
  @Override
  protected ResourcePerformer_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourcePerformer_URI.Matcher.on(engine);
  }
  
  @Override
  public ResourcePerformer_URI.Matcher instantiate() {
    return ResourcePerformer_URI.Matcher.create();
  }
  
  @Override
  public ResourcePerformer_URI.Match newEmptyMatch() {
    return ResourcePerformer_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ResourcePerformer_URI.Match newMatch(final Object... parameters) {
    return ResourcePerformer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourcePerformer_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourcePerformer_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourcePerformer_URI INSTANCE = new ResourcePerformer_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourcePerformer_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
