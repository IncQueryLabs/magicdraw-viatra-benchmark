...
public final class ResourceRole_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ResourceRole_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_startBoundaryType.Match)) {
          ResourceRole_startBoundaryType.Match other = (ResourceRole_startBoundaryType.Match) obj;
    ...
    @Override
    public ResourceRole_startBoundaryType specification() {
      return ResourceRole_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ResourceRole_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_startBoundaryType.Match {
    ...
    private static final class Immutable extends ResourceRole_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ResourceRole_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_startBoundaryType.Matcher> querySpecification() {
      return ResourceRole_startBoundaryType.instance();
    }
  }
  
  private ResourceRole_startBoundaryType() {
   ...
   * 
   */
  public static ResourceRole_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ResourceRole_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_startBoundaryType.Matcher instantiate() {
    return ResourceRole_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ResourceRole_startBoundaryType.Match newEmptyMatch() {
    return ResourceRole_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_startBoundaryType.Match newMatch(final Object... parameters) {
    return ResourceRole_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_startBoundaryType INSTANCE = new ResourceRole_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
