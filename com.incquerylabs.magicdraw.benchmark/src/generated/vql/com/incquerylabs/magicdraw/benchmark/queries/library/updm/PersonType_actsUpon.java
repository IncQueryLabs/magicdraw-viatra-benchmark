...
public final class PersonType_actsUpon extends BaseGeneratedEMFQuerySpecification<PersonType_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_actsUpon.Match)) {
          PersonType_actsUpon.Match other = (PersonType_actsUpon.Match) obj;
    ...
    @Override
    public PersonType_actsUpon specification() {
      return PersonType_actsUpon.instance();
    }
     ...
     * 
     */
    public static PersonType_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_actsUpon.Match {
    ...
    private static final class Immutable extends PersonType_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see PersonType_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static PersonType_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_actsUpon.Match> processor) {
     ...
     * 
     */
    public PersonType_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_actsUpon.Match partialMatch) {
    ...
    @Override
    protected PersonType_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_actsUpon.Matcher> querySpecification() {
      return PersonType_actsUpon.instance();
    }
  }
  
  private PersonType_actsUpon() {
   ...
   * 
   */
  public static PersonType_actsUpon instance() {
    try{
  ...
  @Override
  protected PersonType_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public PersonType_actsUpon.Matcher instantiate() {
    return PersonType_actsUpon.Matcher.create();
  }
  
  @Override
  public PersonType_actsUpon.Match newEmptyMatch() {
    return PersonType_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_actsUpon.Match newMatch(final Object... parameters) {
    return PersonType_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_actsUpon INSTANCE = new PersonType_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
