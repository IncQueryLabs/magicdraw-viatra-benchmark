...
public final class ResourceArtifact_function extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_function.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_function.Match)) {
          ResourceArtifact_function.Match other = (ResourceArtifact_function.Match) obj;
    ...
    @Override
    public ResourceArtifact_function specification() {
      return ResourceArtifact_function.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_function.Match {
    ...
    private static final class Immutable extends ResourceArtifact_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_function pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_function
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_function.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_function.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_function.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_function.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_function.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_function.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_function.Matcher> querySpecification() {
      return ResourceArtifact_function.instance();
    }
  }
  
  private ResourceArtifact_function() {
   ...
   * 
   */
  public static ResourceArtifact_function instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_function.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_function.Matcher instantiate() {
    return ResourceArtifact_function.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_function.Match newEmptyMatch() {
    return ResourceArtifact_function.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_function.Match newMatch(final Object... parameters) {
    return ResourceArtifact_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_function INSTANCE = new ResourceArtifact_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
