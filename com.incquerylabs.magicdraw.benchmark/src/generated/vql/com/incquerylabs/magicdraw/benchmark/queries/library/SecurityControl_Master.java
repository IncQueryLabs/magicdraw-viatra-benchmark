...
public final class SecurityControl_Master extends BaseGeneratedEMFQuerySpecification<SecurityControl_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_Master.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_Master.Match)) {
          SecurityControl_Master.Match other = (SecurityControl_Master.Match) obj;
    ...
    @Override
    public SecurityControl_Master specification() {
      return SecurityControl_Master.instance();
    }
     ...
     * 
     */
    public static SecurityControl_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityControl_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControl_Master.Match {
    ...
    private static final class Immutable extends SecurityControl_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Master pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_Master
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_Master.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_Master.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityControl_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityControl_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityControl_Master.Match> processor) {
     ...
     * 
     */
    public SecurityControl_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityControl_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityControl_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityControl_Master.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_Master.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControl_Master.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_Master.Matcher> querySpecification() {
      return SecurityControl_Master.instance();
    }
  }
  
  private SecurityControl_Master() {
   ...
   * 
   */
  public static SecurityControl_Master instance() {
    try{
  ...
  @Override
  protected SecurityControl_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_Master.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_Master.Matcher instantiate() {
    return SecurityControl_Master.Matcher.create();
  }
  
  @Override
  public SecurityControl_Master.Match newEmptyMatch() {
    return SecurityControl_Master.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_Master.Match newMatch(final Object... parameters) {
    return SecurityControl_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_Master INSTANCE = new SecurityControl_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
