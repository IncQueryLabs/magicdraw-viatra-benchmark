...
public final class Project_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<Project_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Project_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public Project_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_isStandardConfiguration.Match)) {
          Project_isStandardConfiguration.Match other = (Project_isStandardConfiguration.Match) obj;
    ...
    @Override
    public Project_isStandardConfiguration specification() {
      return Project_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static Project_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Project_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Project_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends Project_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see Project_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<Project_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static Project_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<Project_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Project_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Project_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Project_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public Project_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Project_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Project_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Project_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Project_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Project_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected Project_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return Project_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Project_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return Project_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_isStandardConfiguration.Matcher> querySpecification() {
      return Project_isStandardConfiguration.instance();
    }
  }
  
  private Project_isStandardConfiguration() {
   ...
   * 
   */
  public static Project_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected Project_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public Project_isStandardConfiguration.Matcher instantiate() {
    return Project_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public Project_isStandardConfiguration.Match newEmptyMatch() {
    return Project_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public Project_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return Project_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_isStandardConfiguration INSTANCE = new Project_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Project(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Project.instance().getInternalQueryRepresentation());
