...
public final class Person_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Person_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Person_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_endBoundaryType.Match)) {
          Person_endBoundaryType.Match other = (Person_endBoundaryType.Match) obj;
    ...
    @Override
    public Person_endBoundaryType specification() {
      return Person_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Person_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Person_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Person_endBoundaryType.Match {
    ...
    private static final class Immutable extends Person_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Person_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Person_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Person_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Person_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Person_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Person_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Person_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Person_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Person_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Person_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Person_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Person_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Person_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Person_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Person_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_endBoundaryType.Matcher> querySpecification() {
      return Person_endBoundaryType.instance();
    }
  }
  
  private Person_endBoundaryType() {
   ...
   * 
   */
  public static Person_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Person_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Person_endBoundaryType.Matcher instantiate() {
    return Person_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Person_endBoundaryType.Match newEmptyMatch() {
    return Person_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Person_endBoundaryType.Match newMatch(final Object... parameters) {
    return Person_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_endBoundaryType INSTANCE = new Person_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
