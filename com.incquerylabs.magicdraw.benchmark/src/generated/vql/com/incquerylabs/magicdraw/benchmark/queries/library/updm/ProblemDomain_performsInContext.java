...
public final class ProblemDomain_performsInContext extends BaseGeneratedEMFQuerySpecification<ProblemDomain_performsInContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_performsInContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_performsInContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_performsInContext.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_performsInContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_performsInContext.Match)) {
          ProblemDomain_performsInContext.Match other = (ProblemDomain_performsInContext.Match) obj;
    ...
    @Override
    public ProblemDomain_performsInContext specification() {
      return ProblemDomain_performsInContext.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_performsInContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_performsInContext.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_performsInContext.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_performsInContext.Match {
    ...
    private static final class Immutable extends ProblemDomain_performsInContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_performsInContext pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_performsInContext
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_performsInContext.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_performsInContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_performsInContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_performsInContext.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_performsInContext.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_performsInContext.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_performsInContext.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_performsInContext.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_performsInContext.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_performsInContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_performsInContext.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_performsInContext.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_performsInContext.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_performsInContext.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_performsInContext.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_performsInContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_performsInContext.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_performsInContext.Matcher> querySpecification() {
      return ProblemDomain_performsInContext.instance();
    }
  }
  
  private ProblemDomain_performsInContext() {
   ...
   * 
   */
  public static ProblemDomain_performsInContext instance() {
    try{
  ...
  @Override
  protected ProblemDomain_performsInContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_performsInContext.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_performsInContext.Matcher instantiate() {
    return ProblemDomain_performsInContext.Matcher.create();
  }
  
  @Override
  public ProblemDomain_performsInContext.Match newEmptyMatch() {
    return ProblemDomain_performsInContext.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_performsInContext.Match newMatch(final Object... parameters) {
    return ProblemDomain_performsInContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_performsInContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_performsInContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_performsInContext INSTANCE = new ProblemDomain_performsInContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_performsInContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "performsInContext");
