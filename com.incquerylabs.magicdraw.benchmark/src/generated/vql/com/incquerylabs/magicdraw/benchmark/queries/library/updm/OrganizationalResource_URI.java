...
public final class OrganizationalResource_URI extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_URI.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_URI.Match)) {
          OrganizationalResource_URI.Match other = (OrganizationalResource_URI.Match) obj;
    ...
    @Override
    public OrganizationalResource_URI specification() {
      return OrganizationalResource_URI.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static OrganizationalResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OrganizationalResource_URI.Match {
    ...
    private static final class Immutable extends OrganizationalResource_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_URI pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_URI
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_URI.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_URI.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<OrganizationalResource_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<OrganizationalResource_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super OrganizationalResource_URI.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return OrganizationalResource_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final OrganizationalResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final OrganizationalResource_URI.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_URI.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OrganizationalResource_URI.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_URI.Matcher> querySpecification() {
      return OrganizationalResource_URI.instance();
    }
  }
  
  private OrganizationalResource_URI() {
   ...
   * 
   */
  public static OrganizationalResource_URI instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_URI.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_URI.Matcher instantiate() {
    return OrganizationalResource_URI.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_URI.Match newEmptyMatch() {
    return OrganizationalResource_URI.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_URI.Match newMatch(final Object... parameters) {
    return OrganizationalResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_URI INSTANCE = new OrganizationalResource_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
