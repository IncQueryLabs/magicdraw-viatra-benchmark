...
public final class EnterpriseVision_actualPropertySet extends BaseGeneratedEMFQuerySpecification<EnterpriseVision_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseVision_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseVision_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseVision_actualPropertySet.Match)) {
          EnterpriseVision_actualPropertySet.Match other = (EnterpriseVision_actualPropertySet.Match) obj;
    ...
    @Override
    public EnterpriseVision_actualPropertySet specification() {
      return EnterpriseVision_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static EnterpriseVision_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseVision_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseVision_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseVision_actualPropertySet.Match {
    ...
    private static final class Immutable extends EnterpriseVision_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseVision_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseVision_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseVision_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseVision_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseVision_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseVision_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseVision_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseVision_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseVision_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public EnterpriseVision_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseVision_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseVision_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseVision_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseVision_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseVision_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected EnterpriseVision_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseVision_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseVision_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseVision_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseVision_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseVision_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseVision_actualPropertySet.Matcher> querySpecification() {
      return EnterpriseVision_actualPropertySet.instance();
    }
  }
  
  private EnterpriseVision_actualPropertySet() {
   ...
   * 
   */
  public static EnterpriseVision_actualPropertySet instance() {
    try{
  ...
  @Override
  protected EnterpriseVision_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseVision_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseVision_actualPropertySet.Matcher instantiate() {
    return EnterpriseVision_actualPropertySet.Matcher.create();
  }
  
  @Override
  public EnterpriseVision_actualPropertySet.Match newEmptyMatch() {
    return EnterpriseVision_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseVision_actualPropertySet.Match newMatch(final Object... parameters) {
    return EnterpriseVision_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseVision_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseVision_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseVision_actualPropertySet INSTANCE = new EnterpriseVision_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseVision_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
