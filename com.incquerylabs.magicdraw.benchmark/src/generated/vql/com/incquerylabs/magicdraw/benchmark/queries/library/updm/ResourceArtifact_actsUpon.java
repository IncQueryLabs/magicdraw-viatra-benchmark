...
public final class ResourceArtifact_actsUpon extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_actsUpon.Match)) {
          ResourceArtifact_actsUpon.Match other = (ResourceArtifact_actsUpon.Match) obj;
    ...
    @Override
    public ResourceArtifact_actsUpon specification() {
      return ResourceArtifact_actsUpon.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_actsUpon.Match {
    ...
    private static final class Immutable extends ResourceArtifact_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_actsUpon.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_actsUpon.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_actsUpon.Matcher> querySpecification() {
      return ResourceArtifact_actsUpon.instance();
    }
  }
  
  private ResourceArtifact_actsUpon() {
   ...
   * 
   */
  public static ResourceArtifact_actsUpon instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_actsUpon.Matcher instantiate() {
    return ResourceArtifact_actsUpon.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_actsUpon.Match newEmptyMatch() {
    return ResourceArtifact_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_actsUpon.Match newMatch(final Object... parameters) {
    return ResourceArtifact_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_actsUpon INSTANCE = new ResourceArtifact_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
