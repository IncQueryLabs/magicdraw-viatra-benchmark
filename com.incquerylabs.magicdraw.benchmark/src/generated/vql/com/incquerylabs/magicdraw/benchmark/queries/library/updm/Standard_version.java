...
public final class Standard_version extends BaseGeneratedEMFQuerySpecification<Standard_version.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_version pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_version";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_version.Match.parameterNames;
    }
    ...
    @Override
    public Standard_version.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_version.Match)) {
          Standard_version.Match other = (Standard_version.Match) obj;
    ...
    @Override
    public Standard_version specification() {
      return Standard_version.instance();
    }
     ...
     * 
     */
    public static Standard_version.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_version.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Standard_version.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Standard_version.Match {
    ...
    private static final class Immutable extends Standard_version.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_version pattern,
   ...
   * 
   * @see Match
   * @see Standard_version
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_version.Match> {
    /**
     ...
     * 
     */
    public static Standard_version.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_version.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_version.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_version.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Standard_version.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Standard_version.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Standard_version.Match> processor) {
     ...
     * 
     */
    public Standard_version.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Standard_version.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_version.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_version.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Standard_version.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Standard_version.Match partialMatch) {
    ...
    @Override
    protected Standard_version.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Standard_version.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_version.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_version.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_version.Matcher> querySpecification() {
      return Standard_version.instance();
    }
  }
  
  private Standard_version() {
   ...
   * 
   */
  public static Standard_version instance() {
    try{
  ...
  @Override
  protected Standard_version.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_version.Matcher.on(engine);
  }
  
  @Override
  public Standard_version.Matcher instantiate() {
    return Standard_version.Matcher.create();
  }
  
  @Override
  public Standard_version.Match newEmptyMatch() {
    return Standard_version.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_version.Match newMatch(final Object... parameters) {
    return Standard_version.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_version} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_version#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_version INSTANCE = new Standard_version();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_version.GeneratedPQuery INSTANCE = new GeneratedPQuery();
