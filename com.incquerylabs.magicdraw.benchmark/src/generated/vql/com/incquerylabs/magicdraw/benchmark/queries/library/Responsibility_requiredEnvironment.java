...
public final class Responsibility_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Responsibility_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_requiredEnvironment.Match)) {
          Responsibility_requiredEnvironment.Match other = (Responsibility_requiredEnvironment.Match) obj;
    ...
    @Override
    public Responsibility_requiredEnvironment specification() {
      return Responsibility_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Responsibility_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Responsibility_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Responsibility_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Responsibility_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_requiredEnvironment.Matcher> querySpecification() {
      return Responsibility_requiredEnvironment.instance();
    }
  }
  
  private Responsibility_requiredEnvironment() {
   ...
   * 
   */
  public static Responsibility_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Responsibility_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_requiredEnvironment.Matcher instantiate() {
    return Responsibility_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Responsibility_requiredEnvironment.Match newEmptyMatch() {
    return Responsibility_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Responsibility_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_requiredEnvironment INSTANCE = new Responsibility_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
