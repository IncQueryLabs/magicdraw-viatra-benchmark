...
public final class ResourceArtifact_milestone extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_milestone.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_milestone.Match)) {
          ResourceArtifact_milestone.Match other = (ResourceArtifact_milestone.Match) obj;
    ...
    @Override
    public ResourceArtifact_milestone specification() {
      return ResourceArtifact_milestone.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_milestone.Match {
    ...
    private static final class Immutable extends ResourceArtifact_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_milestone pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_milestone.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_milestone.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_milestone.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_milestone.Matcher> querySpecification() {
      return ResourceArtifact_milestone.instance();
    }
  }
  
  private ResourceArtifact_milestone() {
   ...
   * 
   */
  public static ResourceArtifact_milestone instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_milestone.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_milestone.Matcher instantiate() {
    return ResourceArtifact_milestone.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_milestone.Match newEmptyMatch() {
    return ResourceArtifact_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_milestone.Match newMatch(final Object... parameters) {
    return ResourceArtifact_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_milestone INSTANCE = new ResourceArtifact_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
