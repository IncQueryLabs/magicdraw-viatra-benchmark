...
public final class OperationalSignalProperty_URI extends BaseGeneratedEMFQuerySpecification<OperationalSignalProperty_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalSignalProperty_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalSignalProperty_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalSignalProperty_URI.Match.parameterNames;
    }
    ...
    @Override
    public OperationalSignalProperty_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalSignalProperty_URI.Match)) {
          OperationalSignalProperty_URI.Match other = (OperationalSignalProperty_URI.Match) obj;
    ...
    @Override
    public OperationalSignalProperty_URI specification() {
      return OperationalSignalProperty_URI.instance();
    }
     ...
     * 
     */
    public static OperationalSignalProperty_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalSignalProperty_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static OperationalSignalProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalSignalProperty_URI.Match {
    ...
    private static final class Immutable extends OperationalSignalProperty_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalSignalProperty_URI pattern,
   ...
   * 
   * @see Match
   * @see OperationalSignalProperty_URI
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalSignalProperty_URI.Match> {
    /**
     ...
     * 
     */
    public static OperationalSignalProperty_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalSignalProperty_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalSignalProperty_URI.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalSignalProperty_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<OperationalSignalProperty_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<OperationalSignalProperty_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super OperationalSignalProperty_URI.Match> processor) {
     ...
     * 
     */
    public OperationalSignalProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return OperationalSignalProperty_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalSignalProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalSignalProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final OperationalSignalProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final OperationalSignalProperty_URI.Match partialMatch) {
    ...
    @Override
    protected OperationalSignalProperty_URI.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalSignalProperty_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalSignalProperty_URI.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalSignalProperty_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalSignalProperty_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalSignalProperty_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalSignalProperty_URI.Matcher> querySpecification() {
      return OperationalSignalProperty_URI.instance();
    }
  }
  
  private OperationalSignalProperty_URI() {
   ...
   * 
   */
  public static OperationalSignalProperty_URI instance() {
    try{
  ...
  @Override
  protected OperationalSignalProperty_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalSignalProperty_URI.Matcher.on(engine);
  }
  
  @Override
  public OperationalSignalProperty_URI.Matcher instantiate() {
    return OperationalSignalProperty_URI.Matcher.create();
  }
  
  @Override
  public OperationalSignalProperty_URI.Match newEmptyMatch() {
    return OperationalSignalProperty_URI.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalSignalProperty_URI.Match newMatch(final Object... parameters) {
    return OperationalSignalProperty_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalSignalProperty_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalSignalProperty_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalSignalProperty_URI INSTANCE = new OperationalSignalProperty_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalSignalProperty_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
