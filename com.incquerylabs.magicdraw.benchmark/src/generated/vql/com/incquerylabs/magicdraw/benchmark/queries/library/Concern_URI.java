...
public final class Concern_URI extends BaseGeneratedEMFQuerySpecification<Concern_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Concern_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Concern_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Concern_URI.Match.parameterNames;
    }
    ...
    @Override
    public Concern_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Concern_URI.Match)) {
          Concern_URI.Match other = (Concern_URI.Match) obj;
    ...
    @Override
    public Concern_URI specification() {
      return Concern_URI.instance();
    }
     ...
     * 
     */
    public static Concern_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Concern_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Concern_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Concern_URI.Match {
    ...
    private static final class Immutable extends Concern_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Concern_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Concern_URI.Match> {
    /**
     ...
     * 
     */
    public static Concern_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Concern_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Concern_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Concern_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Concern_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Concern_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Concern_URI.Match> processor) {
     ...
     * 
     */
    public Concern_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Concern_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Concern_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Concern_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Concern_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Concern_URI.Match partialMatch) {
    ...
    @Override
    protected Concern_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Concern_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Concern_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Concern_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Concern_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Concern_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Concern_URI.Matcher> querySpecification() {
      return Concern_URI.instance();
    }
  }
   ...
   * 
   */
  public static Concern_URI instance() {
    try{
  ...
  @Override
  protected Concern_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Concern_URI.Matcher.on(engine);
  }
  
  @Override
  public Concern_URI.Matcher instantiate() {
    return Concern_URI.Matcher.create();
  }
  
  @Override
  public Concern_URI.Match newEmptyMatch() {
    return Concern_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Concern_URI.Match newMatch(final Object... parameters) {
    return Concern_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Concern_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Concern_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Concern_URI INSTANCE = new Concern_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Concern_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
