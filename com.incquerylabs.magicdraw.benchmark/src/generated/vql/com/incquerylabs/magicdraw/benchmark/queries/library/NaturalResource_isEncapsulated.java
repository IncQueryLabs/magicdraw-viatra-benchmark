...
public final class NaturalResource_isEncapsulated extends BaseGeneratedEMFQuerySpecification<NaturalResource_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return NaturalResource_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public NaturalResource_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NaturalResource_isEncapsulated.Match)) {
          NaturalResource_isEncapsulated.Match other = (NaturalResource_isEncapsulated.Match) obj;
    ...
    @Override
    public NaturalResource_isEncapsulated specification() {
      return NaturalResource_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static NaturalResource_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static NaturalResource_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static NaturalResource_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends NaturalResource_isEncapsulated.Match {
    ...
    private static final class Immutable extends NaturalResource_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see NaturalResource_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<NaturalResource_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static NaturalResource_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NaturalResource_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NaturalResource_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<NaturalResource_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<NaturalResource_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<NaturalResource_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super NaturalResource_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public NaturalResource_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return NaturalResource_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NaturalResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NaturalResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final NaturalResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final NaturalResource_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected NaturalResource_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return NaturalResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected NaturalResource_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return NaturalResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NaturalResource_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NaturalResource_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NaturalResource_isEncapsulated.Matcher> querySpecification() {
      return NaturalResource_isEncapsulated.instance();
    }
  }
  
  private NaturalResource_isEncapsulated() {
   ...
   * 
   */
  public static NaturalResource_isEncapsulated instance() {
    try{
  ...
  @Override
  protected NaturalResource_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return NaturalResource_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public NaturalResource_isEncapsulated.Matcher instantiate() {
    return NaturalResource_isEncapsulated.Matcher.create();
  }
  
  @Override
  public NaturalResource_isEncapsulated.Match newEmptyMatch() {
    return NaturalResource_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public NaturalResource_isEncapsulated.Match newMatch(final Object... parameters) {
    return NaturalResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NaturalResource_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NaturalResource_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NaturalResource_isEncapsulated INSTANCE = new NaturalResource_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NaturalResource_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
