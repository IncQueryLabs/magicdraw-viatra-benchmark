...
public final class Property_conformsTo extends BaseGeneratedEMFQuerySpecification<Property_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Property_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Property_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Property_conformsTo.Match)) {
          Property_conformsTo.Match other = (Property_conformsTo.Match) obj;
    ...
    @Override
    public Property_conformsTo specification() {
      return Property_conformsTo.instance();
    }
     ...
     * 
     */
    public static Property_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Property_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static Property_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Property_conformsTo.Match {
    ...
    private static final class Immutable extends Property_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Property_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Property_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Property_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Property_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Property_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Property_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Property_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Property_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super Property_conformsTo.Match> processor) {
     ...
     * 
     */
    public Property_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return Property_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Property_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Property_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Property_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Property_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Property_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Property_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Property_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Property_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Property_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Property_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Property_conformsTo.Matcher> querySpecification() {
      return Property_conformsTo.instance();
    }
  }
  
  private Property_conformsTo() {
   ...
   * 
   */
  public static Property_conformsTo instance() {
    try{
  ...
  @Override
  protected Property_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Property_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Property_conformsTo.Matcher instantiate() {
    return Property_conformsTo.Matcher.create();
  }
  
  @Override
  public Property_conformsTo.Match newEmptyMatch() {
    return Property_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Property_conformsTo.Match newMatch(final Object... parameters) {
    return Property_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Property_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Property_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Property_conformsTo INSTANCE = new Property_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Property_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
