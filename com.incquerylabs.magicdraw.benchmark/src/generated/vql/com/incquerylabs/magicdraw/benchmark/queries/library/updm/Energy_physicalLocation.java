...
public final class Energy_physicalLocation extends BaseGeneratedEMFQuerySpecification<Energy_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Energy_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_physicalLocation.Match)) {
          Energy_physicalLocation.Match other = (Energy_physicalLocation.Match) obj;
    ...
    @Override
    public Energy_physicalLocation specification() {
      return Energy_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Energy_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_physicalLocation.Match {
    ...
    private static final class Immutable extends Energy_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Energy_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Energy_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Energy_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Energy_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_physicalLocation.Matcher> querySpecification() {
      return Energy_physicalLocation.instance();
    }
  }
  
  private Energy_physicalLocation() {
   ...
   * 
   */
  public static Energy_physicalLocation instance() {
    try{
  ...
  @Override
  protected Energy_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Energy_physicalLocation.Matcher instantiate() {
    return Energy_physicalLocation.Matcher.create();
  }
  
  @Override
  public Energy_physicalLocation.Match newEmptyMatch() {
    return Energy_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_physicalLocation.Match newMatch(final Object... parameters) {
    return Energy_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_physicalLocation INSTANCE = new Energy_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
