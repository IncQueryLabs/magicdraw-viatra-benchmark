...
public final class Standard_mandatedDate extends BaseGeneratedEMFQuerySpecification<Standard_mandatedDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_mandatedDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_mandatedDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_mandatedDate.Match.parameterNames;
    }
    ...
    @Override
    public Standard_mandatedDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_mandatedDate.Match)) {
          Standard_mandatedDate.Match other = (Standard_mandatedDate.Match) obj;
    ...
    @Override
    public Standard_mandatedDate specification() {
      return Standard_mandatedDate.instance();
    }
     ...
     * 
     */
    public static Standard_mandatedDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_mandatedDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Standard_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Standard_mandatedDate.Match {
    ...
    private static final class Immutable extends Standard_mandatedDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_mandatedDate pattern,
   ...
   * 
   * @see Match
   * @see Standard_mandatedDate
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_mandatedDate.Match> {
    /**
     ...
     * 
     */
    public static Standard_mandatedDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_mandatedDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_mandatedDate.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_mandatedDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Standard_mandatedDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Standard_mandatedDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Standard_mandatedDate.Match> processor) {
     ...
     * 
     */
    public Standard_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Standard_mandatedDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Standard_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Standard_mandatedDate.Match partialMatch) {
    ...
    @Override
    protected Standard_mandatedDate.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Standard_mandatedDate.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_mandatedDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_mandatedDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_mandatedDate.Matcher> querySpecification() {
      return Standard_mandatedDate.instance();
    }
  }
  
  private Standard_mandatedDate() {
   ...
   * 
   */
  public static Standard_mandatedDate instance() {
    try{
  ...
  @Override
  protected Standard_mandatedDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_mandatedDate.Matcher.on(engine);
  }
  
  @Override
  public Standard_mandatedDate.Matcher instantiate() {
    return Standard_mandatedDate.Matcher.create();
  }
  
  @Override
  public Standard_mandatedDate.Match newEmptyMatch() {
    return Standard_mandatedDate.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_mandatedDate.Match newMatch(final Object... parameters) {
    return Standard_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_mandatedDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_mandatedDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_mandatedDate INSTANCE = new Standard_mandatedDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_mandatedDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
