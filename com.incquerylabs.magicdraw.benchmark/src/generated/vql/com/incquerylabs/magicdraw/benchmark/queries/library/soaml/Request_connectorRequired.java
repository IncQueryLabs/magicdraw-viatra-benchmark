...
public final class Request_connectorRequired extends BaseGeneratedEMFQuerySpecification<Request_connectorRequired.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Request_connectorRequired pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Request_connectorRequired";
    }
    
    @Override
    public List<String> parameterNames() {
      return Request_connectorRequired.Match.parameterNames;
    }
    ...
    @Override
    public Request_connectorRequired.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Request_connectorRequired.Match)) {
          Request_connectorRequired.Match other = (Request_connectorRequired.Match) obj;
    ...
    @Override
    public Request_connectorRequired specification() {
     ...
     * 
     */
    public static Request_connectorRequired.Match newEmptyMatch() {
     ...
     * 
     */
    public static Request_connectorRequired.Match newMutableMatch(final Port pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Request_connectorRequired.Match newMatch(final Port pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Request_connectorRequired.Match {
    ...
    private static final class Immutable extends Request_connectorRequired.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Request_connectorRequired pattern,
   ...
   * 
   * @see Match
   * @see Request_connectorRequired
   * 
   */
  public static class Matcher extends BaseMatcher<Request_connectorRequired.Match> {
    /**
     ...
     * 
     */
    public static Request_connectorRequired.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Request_connectorRequired.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Request_connectorRequired.Matcher.class);
     ...
     * 
     */
    public Collection<Request_connectorRequired.Match> getAllMatches(final Port pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Request_connectorRequired.Match> streamAllMatches(final Port pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Request_connectorRequired.Match> getOneArbitraryMatch(final Port pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final LiteralBoolean pValuespec, final Consumer<? super Request_connectorRequired.Match> processor) {
     ...
     * 
     */
    public Request_connectorRequired.Match newMatch(final Port pElement, final LiteralBoolean pValuespec) {
      return Request_connectorRequired.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Request_connectorRequired.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Request_connectorRequired.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Request_connectorRequired.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Request_connectorRequired.Match partialMatch) {
    ...
    @Override
    protected Request_connectorRequired.Match tupleToMatch(final Tuple t) {
      try {
          return Request_connectorRequired.Match.newMatch((Port) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Request_connectorRequired.Match arrayToMatch(final Object[] match) {
      try {
          return Request_connectorRequired.Match.newMatch((Port) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Request_connectorRequired.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Request_connectorRequired.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Request_connectorRequired.Matcher> querySpecification() {
      return Request_connectorRequired.instance();
    }
  }
  
  private Request_connectorRequired() {
   ...
   * 
   */
  public static Request_connectorRequired instance() {
    try{
  ...
  @Override
  protected Request_connectorRequired.Matcher instantiate(final ViatraQueryEngine engine) {
    return Request_connectorRequired.Matcher.on(engine);
  }
  
  @Override
  public Request_connectorRequired.Matcher instantiate() {
    return Request_connectorRequired.Matcher.create();
  }
  
  @Override
  public Request_connectorRequired.Match newEmptyMatch() {
    return Request_connectorRequired.Match.newEmptyMatch();
  }
  
  @Override
  public Request_connectorRequired.Match newMatch(final Object... parameters) {
    return Request_connectorRequired.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Request_connectorRequired} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Request_connectorRequired#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Request_connectorRequired INSTANCE = new Request_connectorRequired();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Request_connectorRequired.GeneratedPQuery INSTANCE = new GeneratedPQuery();
