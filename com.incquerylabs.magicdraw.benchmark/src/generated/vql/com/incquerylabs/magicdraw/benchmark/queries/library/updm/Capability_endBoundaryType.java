...
public final class Capability_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Capability_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Capability_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Capability_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Capability_endBoundaryType.Match)) {
          Capability_endBoundaryType.Match other = (Capability_endBoundaryType.Match) obj;
    ...
    @Override
    public Capability_endBoundaryType specification() {
      return Capability_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Capability_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Capability_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Capability_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Capability_endBoundaryType.Match {
    ...
    private static final class Immutable extends Capability_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Capability_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Capability_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Capability_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Capability_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Capability_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Capability_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Capability_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Capability_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Capability_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Capability_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Capability_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Capability_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Capability_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Capability_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Capability_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Capability_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Capability_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Capability_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Capability_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Capability_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Capability_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Capability_endBoundaryType.Matcher> querySpecification() {
      return Capability_endBoundaryType.instance();
    }
  }
  
  private Capability_endBoundaryType() {
   ...
   * 
   */
  public static Capability_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Capability_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Capability_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Capability_endBoundaryType.Matcher instantiate() {
    return Capability_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Capability_endBoundaryType.Match newEmptyMatch() {
    return Capability_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Capability_endBoundaryType.Match newMatch(final Object... parameters) {
    return Capability_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Capability_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Capability_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Capability_endBoundaryType INSTANCE = new Capability_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Capability_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
