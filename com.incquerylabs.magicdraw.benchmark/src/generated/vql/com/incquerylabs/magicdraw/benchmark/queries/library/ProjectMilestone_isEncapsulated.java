...
import com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestone;
...
public final class ProjectMilestone_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ProjectMilestone_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestone_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestone_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestone_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestone_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestone_isEncapsulated.Match)) {
          ProjectMilestone_isEncapsulated.Match other = (ProjectMilestone_isEncapsulated.Match) obj;
    ...
    @Override
    public ProjectMilestone_isEncapsulated specification() {
      return ProjectMilestone_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static ProjectMilestone_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestone_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ProjectMilestone_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProjectMilestone_isEncapsulated.Match {
    ...
    private static final class Immutable extends ProjectMilestone_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestone_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestone_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestone_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestone_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestone_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestone_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestone_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ProjectMilestone_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ProjectMilestone_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ProjectMilestone_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ProjectMilestone_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ProjectMilestone_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectMilestone_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectMilestone_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ProjectMilestone_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ProjectMilestone_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestone_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestone_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProjectMilestone_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestone_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestone_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestone_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestone_isEncapsulated.Matcher> querySpecification() {
      return ProjectMilestone_isEncapsulated.instance();
    }
  }
  
  private ProjectMilestone_isEncapsulated() {
   ...
   * 
   */
  public static ProjectMilestone_isEncapsulated instance() {
    try{
  ...
  @Override
  protected ProjectMilestone_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestone_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestone_isEncapsulated.Matcher instantiate() {
    return ProjectMilestone_isEncapsulated.Matcher.create();
  }
  
  @Override
  public ProjectMilestone_isEncapsulated.Match newEmptyMatch() {
    return ProjectMilestone_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestone_isEncapsulated.Match newMatch(final Object... parameters) {
    return ProjectMilestone_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestone_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestone_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestone_isEncapsulated INSTANCE = new ProjectMilestone_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestone_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
