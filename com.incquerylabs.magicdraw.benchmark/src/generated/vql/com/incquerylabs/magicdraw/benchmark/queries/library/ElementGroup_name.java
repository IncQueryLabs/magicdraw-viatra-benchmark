...
public final class ElementGroup_name extends BaseGeneratedEMFQuerySpecification<ElementGroup_name.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ElementGroup_name.Match newMutableMatch(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public static ElementGroup_name.Match newMatch(final Comment pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<ElementGroup_name.Match> {
     ...
     * 
     */
    public Collection<ElementGroup_name.Match> getAllMatches(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public Stream<ElementGroup_name.Match> streamAllMatches(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public Optional<ElementGroup_name.Match> getOneArbitraryMatch(final Comment pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final String pValue, final Consumer<? super ElementGroup_name.Match> processor) {
     ...
     * 
     */
    public ElementGroup_name.Match newMatch(final Comment pElement, final String pValue) {
      return ElementGroup_name.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final ElementGroup_name.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final ElementGroup_name.Match partialMatch) {
    ...
    protected ElementGroup_name.Match tupleToMatch(final Tuple t) {
      try {
          return ElementGroup_name.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected ElementGroup_name.Match arrayToMatch(final Object[] match) {
      try {
          return ElementGroup_name.Match.newMatch((Comment) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected ElementGroup_name.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ElementGroup_name.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ElementGroup_name.Match newMatch(final Object... parameters) {
    return ElementGroup_name.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (java.lang.String) parameters[1]);
  }
