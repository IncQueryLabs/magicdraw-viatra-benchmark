...
public final class NodeRole extends BaseGeneratedEMFQuerySpecification<NodeRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeRole.Match.parameterNames;
    }
    ...
    @Override
    public NodeRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeRole.Match)) {
          NodeRole.Match other = (NodeRole.Match) obj;
    ...
    @Override
    public NodeRole specification() {
      return NodeRole.instance();
    }
     ...
     * 
     */
    public static NodeRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeRole.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static NodeRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends NodeRole.Match {
    ...
    private static final class Immutable extends NodeRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<NodeRole.Match> {
    /**
     ...
     * 
     */
    public static NodeRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeRole.Matcher.class);
     ...
     * 
     */
    public Collection<NodeRole.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<NodeRole.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<NodeRole.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super NodeRole.Match> processor) {
     ...
     * 
     */
    public NodeRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return NodeRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final NodeRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final NodeRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final NodeRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final NodeRole.Match partialMatch) {
    ...
    @Override
    protected NodeRole.Match tupleToMatch(final Tuple t) {
      try {
          return NodeRole.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected NodeRole.Match arrayToMatch(final Object[] match) {
      try {
          return NodeRole.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeRole.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeRole.Matcher> querySpecification() {
      return NodeRole.instance();
    }
  }
   ...
   * 
   */
  public static NodeRole instance() {
    try{
  ...
  @Override
  protected NodeRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeRole.Matcher.on(engine);
  }
  
  @Override
  public NodeRole.Matcher instantiate() {
    return NodeRole.Matcher.create();
  }
  
  @Override
  public NodeRole.Match newEmptyMatch() {
    return NodeRole.Match.newEmptyMatch();
  }
  
  @Override
  public NodeRole.Match newMatch(final Object... parameters) {
    return NodeRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeRole INSTANCE = new NodeRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "NodeRole");
