...
public final class ActualOrganizationRole_endDate extends BaseGeneratedEMFQuerySpecification<ActualOrganizationRole_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualOrganizationRole_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualOrganizationRole_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualOrganizationRole_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualOrganizationRole_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualOrganizationRole_endDate.Match)) {
          ActualOrganizationRole_endDate.Match other = (ActualOrganizationRole_endDate.Match) obj;
    ...
    @Override
    public ActualOrganizationRole_endDate specification() {
      return ActualOrganizationRole_endDate.instance();
    }
     ...
     * 
     */
    public static ActualOrganizationRole_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualOrganizationRole_endDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualOrganizationRole_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualOrganizationRole_endDate.Match {
    ...
    private static final class Immutable extends ActualOrganizationRole_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualOrganizationRole_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualOrganizationRole_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualOrganizationRole_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualOrganizationRole_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualOrganizationRole_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualOrganizationRole_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualOrganizationRole_endDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualOrganizationRole_endDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualOrganizationRole_endDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualOrganizationRole_endDate.Match> processor) {
     ...
     * 
     */
    public ActualOrganizationRole_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualOrganizationRole_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualOrganizationRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualOrganizationRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualOrganizationRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualOrganizationRole_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualOrganizationRole_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualOrganizationRole_endDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualOrganizationRole_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualOrganizationRole_endDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualOrganizationRole_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualOrganizationRole_endDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualOrganizationRole_endDate.Matcher> querySpecification() {
      return ActualOrganizationRole_endDate.instance();
    }
  }
  
  private ActualOrganizationRole_endDate() {
   ...
   * 
   */
  public static ActualOrganizationRole_endDate instance() {
    try{
  ...
  @Override
  protected ActualOrganizationRole_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualOrganizationRole_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualOrganizationRole_endDate.Matcher instantiate() {
    return ActualOrganizationRole_endDate.Matcher.create();
  }
  
  @Override
  public ActualOrganizationRole_endDate.Match newEmptyMatch() {
    return ActualOrganizationRole_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualOrganizationRole_endDate.Match newMatch(final Object... parameters) {
    return ActualOrganizationRole_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualOrganizationRole_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualOrganizationRole_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualOrganizationRole_endDate INSTANCE = new ActualOrganizationRole_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualOrganizationRole_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
