...
public final class FlowPortDeprecated extends BaseGeneratedEMFQuerySpecification<FlowPortDeprecated.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.FlowPortDeprecated (visibility: PUBLIC, simpleName: FlowPortDeprecated, identifier: com.incquerylabs.magicdraw.benchmark.queries.FlowPortDeprecated, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
