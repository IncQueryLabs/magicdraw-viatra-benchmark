...
public final class AdjunctPropertyInvalidPrincipalKind extends BaseGeneratedEMFQuerySpecification<AdjunctPropertyInvalidPrincipalKind.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.adjunctPropertyInvalidPrincipalKind pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.adjunctPropertyInvalidPrincipalKind";
    }
    
    @Override
    public List<String> parameterNames() {
      return AdjunctPropertyInvalidPrincipalKind.Match.parameterNames;
    }
    ...
    @Override
    public AdjunctPropertyInvalidPrincipalKind.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof AdjunctPropertyInvalidPrincipalKind.Match)) {
          AdjunctPropertyInvalidPrincipalKind.Match other = (AdjunctPropertyInvalidPrincipalKind.Match) obj;
    ...
    @Override
    public AdjunctPropertyInvalidPrincipalKind specification() {
     ...
     * 
     */
    public static AdjunctPropertyInvalidPrincipalKind.Match newEmptyMatch() {
     ...
     * 
     */
    public static AdjunctPropertyInvalidPrincipalKind.Match newMutableMatch(final Property pProperty) {
     ...
     * 
     */
    public static AdjunctPropertyInvalidPrincipalKind.Match newMatch(final Property pProperty) {
      return new Immutable(pProperty);
    }
    
    private static final class Mutable extends AdjunctPropertyInvalidPrincipalKind.Match {
    ...
    private static final class Immutable extends AdjunctPropertyInvalidPrincipalKind.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.adjunctPropertyInvalidPrincipalKind pattern,
   ...
   * 
   * @see Match
   * @see AdjunctPropertyInvalidPrincipalKind
   * 
   */
  public static class Matcher extends BaseMatcher<AdjunctPropertyInvalidPrincipalKind.Match> {
    /**
     ...
     * 
     */
    public static AdjunctPropertyInvalidPrincipalKind.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static AdjunctPropertyInvalidPrincipalKind.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_PROPERTY = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(AdjunctPropertyInvalidPrincipalKind.Matcher.class);
     ...
     * 
     */
    public Collection<AdjunctPropertyInvalidPrincipalKind.Match> getAllMatches(final Property pProperty) {
     ...
     * 
     */
    public Stream<AdjunctPropertyInvalidPrincipalKind.Match> streamAllMatches(final Property pProperty) {
     ...
     * 
     */
    public Optional<AdjunctPropertyInvalidPrincipalKind.Match> getOneArbitraryMatch(final Property pProperty) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pProperty, final Consumer<? super AdjunctPropertyInvalidPrincipalKind.Match> processor) {
     ...
     * 
     */
    public AdjunctPropertyInvalidPrincipalKind.Match newMatch(final Property pProperty) {
      return AdjunctPropertyInvalidPrincipalKind.Match.newMatch(pProperty);
    }
    ...
    @Override
    protected AdjunctPropertyInvalidPrincipalKind.Match tupleToMatch(final Tuple t) {
      try {
          return AdjunctPropertyInvalidPrincipalKind.Match.newMatch((Property) t.get(POSITION_PROPERTY));
    ...
    @Override
    protected AdjunctPropertyInvalidPrincipalKind.Match arrayToMatch(final Object[] match) {
      try {
          return AdjunctPropertyInvalidPrincipalKind.Match.newMatch((Property) match[POSITION_PROPERTY]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected AdjunctPropertyInvalidPrincipalKind.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AdjunctPropertyInvalidPrincipalKind.Match.newMutableMatch((Property) match[POSITION_PROPERTY]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<AdjunctPropertyInvalidPrincipalKind.Matcher> querySpecification() {
      return AdjunctPropertyInvalidPrincipalKind.instance();
    }
  }
  
  private AdjunctPropertyInvalidPrincipalKind() {
   ...
   * 
   */
  public static AdjunctPropertyInvalidPrincipalKind instance() {
    try{
  ...
  @Override
  protected AdjunctPropertyInvalidPrincipalKind.Matcher instantiate(final ViatraQueryEngine engine) {
    return AdjunctPropertyInvalidPrincipalKind.Matcher.on(engine);
  }
  
  @Override
  public AdjunctPropertyInvalidPrincipalKind.Matcher instantiate() {
    return AdjunctPropertyInvalidPrincipalKind.Matcher.create();
  }
  
  @Override
  public AdjunctPropertyInvalidPrincipalKind.Match newEmptyMatch() {
    return AdjunctPropertyInvalidPrincipalKind.Match.newEmptyMatch();
  }
  
  @Override
  public AdjunctPropertyInvalidPrincipalKind.Match newMatch(final Object... parameters) {
    return AdjunctPropertyInvalidPrincipalKind.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0]);
  }
  ...
  private static class LazyHolder {
    private static final AdjunctPropertyInvalidPrincipalKind INSTANCE = new AdjunctPropertyInvalidPrincipalKind();
