...
public final class OperationalRole_URI extends BaseGeneratedEMFQuerySpecification<OperationalRole_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalRole_URI.Match.parameterNames;
    }
    ...
    @Override
    public OperationalRole_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalRole_URI.Match)) {
          OperationalRole_URI.Match other = (OperationalRole_URI.Match) obj;
    ...
    @Override
    public OperationalRole_URI specification() {
      return OperationalRole_URI.instance();
    }
     ...
     * 
     */
    public static OperationalRole_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalRole_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static OperationalRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalRole_URI.Match {
    ...
    private static final class Immutable extends OperationalRole_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_URI pattern,
   ...
   * 
   * @see Match
   * @see OperationalRole_URI
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalRole_URI.Match> {
    /**
     ...
     * 
     */
    public static OperationalRole_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalRole_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalRole_URI.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalRole_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<OperationalRole_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<OperationalRole_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super OperationalRole_URI.Match> processor) {
     ...
     * 
     */
    public OperationalRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return OperationalRole_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final OperationalRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final OperationalRole_URI.Match partialMatch) {
    ...
    @Override
    protected OperationalRole_URI.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalRole_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalRole_URI.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalRole_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalRole_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalRole_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalRole_URI.Matcher> querySpecification() {
      return OperationalRole_URI.instance();
    }
  }
  
  private OperationalRole_URI() {
   ...
   * 
   */
  public static OperationalRole_URI instance() {
    try{
  ...
  @Override
  protected OperationalRole_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalRole_URI.Matcher.on(engine);
  }
  
  @Override
  public OperationalRole_URI.Matcher instantiate() {
    return OperationalRole_URI.Matcher.create();
  }
  
  @Override
  public OperationalRole_URI.Match newEmptyMatch() {
    return OperationalRole_URI.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalRole_URI.Match newMatch(final Object... parameters) {
    return OperationalRole_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalRole_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalRole_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalRole_URI INSTANCE = new OperationalRole_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalRole_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
