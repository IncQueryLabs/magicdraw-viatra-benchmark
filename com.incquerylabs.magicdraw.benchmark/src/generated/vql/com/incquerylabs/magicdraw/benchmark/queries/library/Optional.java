 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "Optional");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Optional extends BaseGeneratedEMFQuerySpecification<Optional.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Optional pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Optional";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Optional pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Optional} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Optional#instance()}.
   * 
