...
public final class EntityItem_URI extends BaseGeneratedEMFQuerySpecification<EntityItem_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityItem_URI.Match.parameterNames;
    }
    ...
    @Override
    public EntityItem_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityItem_URI.Match)) {
          EntityItem_URI.Match other = (EntityItem_URI.Match) obj;
    ...
    @Override
    public EntityItem_URI specification() {
      return EntityItem_URI.instance();
    }
     ...
     * 
     */
    public static EntityItem_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityItem_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EntityItem_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EntityItem_URI.Match {
    ...
    private static final class Immutable extends EntityItem_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<EntityItem_URI.Match> {
    /**
     ...
     * 
     */
    public static EntityItem_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityItem_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityItem_URI.Matcher.class);
     ...
     * 
     */
    public Collection<EntityItem_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EntityItem_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EntityItem_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EntityItem_URI.Match> processor) {
     ...
     * 
     */
    public EntityItem_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EntityItem_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EntityItem_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EntityItem_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EntityItem_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EntityItem_URI.Match partialMatch) {
    ...
    @Override
    protected EntityItem_URI.Match tupleToMatch(final Tuple t) {
      try {
          return EntityItem_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EntityItem_URI.Match arrayToMatch(final Object[] match) {
      try {
          return EntityItem_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityItem_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityItem_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityItem_URI.Matcher> querySpecification() {
      return EntityItem_URI.instance();
    }
  }
  
  private EntityItem_URI() {
   ...
   * 
   */
  public static EntityItem_URI instance() {
    try{
  ...
  @Override
  protected EntityItem_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityItem_URI.Matcher.on(engine);
  }
  
  @Override
  public EntityItem_URI.Matcher instantiate() {
    return EntityItem_URI.Matcher.create();
  }
  
  @Override
  public EntityItem_URI.Match newEmptyMatch() {
    return EntityItem_URI.Match.newEmptyMatch();
  }
  
  @Override
  public EntityItem_URI.Match newMatch(final Object... parameters) {
    return EntityItem_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityItem_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityItem_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityItem_URI INSTANCE = new EntityItem_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityItem_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
