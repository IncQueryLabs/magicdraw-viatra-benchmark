...
public final class FillsPost_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<FillsPost_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return FillsPost_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public FillsPost_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FillsPost_sourcePropertyPath.Match)) {
          FillsPost_sourcePropertyPath.Match other = (FillsPost_sourcePropertyPath.Match) obj;
    ...
    @Override
    public FillsPost_sourcePropertyPath specification() {
      return FillsPost_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static FillsPost_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static FillsPost_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static FillsPost_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FillsPost_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends FillsPost_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see FillsPost_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<FillsPost_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static FillsPost_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FillsPost_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FillsPost_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<FillsPost_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<FillsPost_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<FillsPost_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super FillsPost_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public FillsPost_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return FillsPost_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final FillsPost_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final FillsPost_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final FillsPost_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final FillsPost_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected FillsPost_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return FillsPost_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected FillsPost_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return FillsPost_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FillsPost_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FillsPost_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FillsPost_sourcePropertyPath.Matcher> querySpecification() {
      return FillsPost_sourcePropertyPath.instance();
    }
  }
  
  private FillsPost_sourcePropertyPath() {
   ...
   * 
   */
  public static FillsPost_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected FillsPost_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return FillsPost_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public FillsPost_sourcePropertyPath.Matcher instantiate() {
    return FillsPost_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public FillsPost_sourcePropertyPath.Match newEmptyMatch() {
    return FillsPost_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public FillsPost_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return FillsPost_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FillsPost_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FillsPost_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FillsPost_sourcePropertyPath INSTANCE = new FillsPost_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FillsPost_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
