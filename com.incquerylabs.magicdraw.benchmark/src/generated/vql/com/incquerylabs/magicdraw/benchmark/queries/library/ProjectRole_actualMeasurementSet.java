...
public final class ProjectRole_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<ProjectRole_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectRole_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectRole_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectRole_actualMeasurementSet.Match)) {
          ProjectRole_actualMeasurementSet.Match other = (ProjectRole_actualMeasurementSet.Match) obj;
    ...
    @Override
    public ProjectRole_actualMeasurementSet specification() {
      return ProjectRole_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static ProjectRole_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectRole_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectRole_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectRole_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends ProjectRole_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see ProjectRole_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectRole_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static ProjectRole_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectRole_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectRole_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectRole_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectRole_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectRole_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectRole_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public ProjectRole_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectRole_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectRole_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected ProjectRole_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectRole_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectRole_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectRole_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectRole_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectRole_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectRole_actualMeasurementSet.Matcher> querySpecification() {
      return ProjectRole_actualMeasurementSet.instance();
    }
  }
  
  private ProjectRole_actualMeasurementSet() {
   ...
   * 
   */
  public static ProjectRole_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected ProjectRole_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectRole_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public ProjectRole_actualMeasurementSet.Matcher instantiate() {
    return ProjectRole_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public ProjectRole_actualMeasurementSet.Match newEmptyMatch() {
    return ProjectRole_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectRole_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return ProjectRole_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectRole_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectRole_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectRole_actualMeasurementSet INSTANCE = new ProjectRole_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectRole_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
