...
public final class ActualProperty_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ActualProperty_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProperty_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ActualProperty_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProperty_endBoundaryType.Match)) {
          ActualProperty_endBoundaryType.Match other = (ActualProperty_endBoundaryType.Match) obj;
    ...
    @Override
    public ActualProperty_endBoundaryType specification() {
      return ActualProperty_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ActualProperty_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProperty_endBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProperty_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProperty_endBoundaryType.Match {
    ...
    private static final class Immutable extends ActualProperty_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ActualProperty_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProperty_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ActualProperty_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProperty_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProperty_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProperty_endBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProperty_endBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProperty_endBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProperty_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ActualProperty_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProperty_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProperty_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ActualProperty_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProperty_endBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProperty_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProperty_endBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProperty_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProperty_endBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProperty_endBoundaryType.Matcher> querySpecification() {
      return ActualProperty_endBoundaryType.instance();
    }
  }
  
  private ActualProperty_endBoundaryType() {
   ...
   * 
   */
  public static ActualProperty_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ActualProperty_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProperty_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ActualProperty_endBoundaryType.Matcher instantiate() {
    return ActualProperty_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ActualProperty_endBoundaryType.Match newEmptyMatch() {
    return ActualProperty_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProperty_endBoundaryType.Match newMatch(final Object... parameters) {
    return ActualProperty_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProperty_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProperty_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProperty_endBoundaryType INSTANCE = new ActualProperty_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProperty_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
