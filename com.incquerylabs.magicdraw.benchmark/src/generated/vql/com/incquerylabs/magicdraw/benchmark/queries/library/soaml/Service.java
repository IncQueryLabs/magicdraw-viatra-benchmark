...
public final class Service extends BaseGeneratedEMFQuerySpecification<Service.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Service pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Service";
    }
    
    @Override
    public List<String> parameterNames() {
      return Service.Match.parameterNames;
    }
    ...
    @Override
    public Service.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Service.Match)) {
          Service.Match other = (Service.Match) obj;
     ...
     * 
     */
    public static Service.Match newEmptyMatch() {
     ...
     * 
     */
    public static Service.Match newMutableMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Service.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Service.Match {
    ...
    private static final class Immutable extends Service.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Service pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Service.Match> {
    /**
     ...
     * 
     */
    public static Service.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Service.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Service.Matcher.class);
     ...
     * 
     */
    public Collection<Service.Match> getAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Service.Match> streamAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Service.Match> getOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Service.Match> processor) {
     ...
     * 
     */
    public Service.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Service.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Service.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Service.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Service.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Service.Match partialMatch) {
    ...
    @Override
    protected Service.Match tupleToMatch(final Tuple t) {
      try {
          return Service.Match.newMatch((Port) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Service.Match arrayToMatch(final Object[] match) {
      try {
          return Service.Match.newMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Service.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Service.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Service.Matcher> querySpecification() {
      return Service.instance();
    }
  }
  ...
  @Override
  protected Service.Matcher instantiate(final ViatraQueryEngine engine) {
    return Service.Matcher.on(engine);
  }
  
  @Override
  public Service.Matcher instantiate() {
    return Service.Matcher.create();
  }
  
  @Override
  public Service.Match newEmptyMatch() {
    return Service.Match.newEmptyMatch();
  }
  
  @Override
  public Service.Match newMatch(final Object... parameters) {
    return Service.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Service} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Service#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Service.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Service");
