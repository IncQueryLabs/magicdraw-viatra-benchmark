...
public final class NodeParent_appliesTo extends BaseGeneratedEMFQuerySpecification<NodeParent_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_appliesTo.Match)) {
          NodeParent_appliesTo.Match other = (NodeParent_appliesTo.Match) obj;
    ...
    @Override
    public NodeParent_appliesTo specification() {
      return NodeParent_appliesTo.instance();
    }
     ...
     * 
     */
    public static NodeParent_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeParent_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeParent_appliesTo.Match {
    ...
    private static final class Immutable extends NodeParent_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see NodeParent_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeParent_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeParent_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NodeParent_appliesTo.Match> processor) {
     ...
     * 
     */
    public NodeParent_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NodeParent_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeParent_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeParent_appliesTo.Match partialMatch) {
    ...
    @Override
    protected NodeParent_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeParent_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_appliesTo.Matcher> querySpecification() {
      return NodeParent_appliesTo.instance();
    }
  }
  
  private NodeParent_appliesTo() {
   ...
   * 
   */
  public static NodeParent_appliesTo instance() {
    try{
  ...
  @Override
  protected NodeParent_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_appliesTo.Matcher instantiate() {
    return NodeParent_appliesTo.Matcher.create();
  }
  
  @Override
  public NodeParent_appliesTo.Match newEmptyMatch() {
    return NodeParent_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_appliesTo.Match newMatch(final Object... parameters) {
    return NodeParent_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_appliesTo INSTANCE = new NodeParent_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
