...
public final class Post_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Post_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Post_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_actualPropertySet.Match)) {
          Post_actualPropertySet.Match other = (Post_actualPropertySet.Match) obj;
    ...
    @Override
    public Post_actualPropertySet specification() {
      return Post_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Post_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_actualPropertySet.Match {
    ...
    private static final class Immutable extends Post_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Post_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Post_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Post_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Post_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Post_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Post_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Post_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Post_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_actualPropertySet.Matcher> querySpecification() {
      return Post_actualPropertySet.instance();
    }
  }
  
  private Post_actualPropertySet() {
   ...
   * 
   */
  public static Post_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Post_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Post_actualPropertySet.Matcher instantiate() {
    return Post_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Post_actualPropertySet.Match newEmptyMatch() {
    return Post_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Post_actualPropertySet.Match newMatch(final Object... parameters) {
    return Post_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_actualPropertySet INSTANCE = new Post_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
