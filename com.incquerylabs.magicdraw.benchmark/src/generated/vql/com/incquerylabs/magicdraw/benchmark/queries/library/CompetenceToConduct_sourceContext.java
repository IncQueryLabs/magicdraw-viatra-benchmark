...
public final class CompetenceToConduct_sourceContext extends BaseGeneratedEMFQuerySpecification<CompetenceToConduct_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceToConduct_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceToConduct_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceToConduct_sourceContext.Match)) {
          CompetenceToConduct_sourceContext.Match other = (CompetenceToConduct_sourceContext.Match) obj;
    ...
    @Override
    public CompetenceToConduct_sourceContext specification() {
      return CompetenceToConduct_sourceContext.instance();
    }
     ...
     * 
     */
    public static CompetenceToConduct_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceToConduct_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static CompetenceToConduct_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CompetenceToConduct_sourceContext.Match {
    ...
    private static final class Immutable extends CompetenceToConduct_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see CompetenceToConduct_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceToConduct_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static CompetenceToConduct_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceToConduct_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceToConduct_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceToConduct_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<CompetenceToConduct_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<CompetenceToConduct_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super CompetenceToConduct_sourceContext.Match> processor) {
     ...
     * 
     */
    public CompetenceToConduct_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return CompetenceToConduct_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceToConduct_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceToConduct_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final CompetenceToConduct_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final CompetenceToConduct_sourceContext.Match partialMatch) {
    ...
    @Override
    protected CompetenceToConduct_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceToConduct_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected CompetenceToConduct_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceToConduct_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceToConduct_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceToConduct_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceToConduct_sourceContext.Matcher> querySpecification() {
      return CompetenceToConduct_sourceContext.instance();
    }
  }
  
  private CompetenceToConduct_sourceContext() {
   ...
   * 
   */
  public static CompetenceToConduct_sourceContext instance() {
    try{
  ...
  @Override
  protected CompetenceToConduct_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceToConduct_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public CompetenceToConduct_sourceContext.Matcher instantiate() {
    return CompetenceToConduct_sourceContext.Matcher.create();
  }
  
  @Override
  public CompetenceToConduct_sourceContext.Match newEmptyMatch() {
    return CompetenceToConduct_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceToConduct_sourceContext.Match newMatch(final Object... parameters) {
    return CompetenceToConduct_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceToConduct_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceToConduct_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceToConduct_sourceContext INSTANCE = new CompetenceToConduct_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceToConduct_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
