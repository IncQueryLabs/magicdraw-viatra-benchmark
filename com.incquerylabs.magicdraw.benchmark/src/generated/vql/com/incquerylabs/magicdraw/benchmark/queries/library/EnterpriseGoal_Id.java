...
public final class EnterpriseGoal_Id extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_Id.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_Id.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_Id.Match)) {
          EnterpriseGoal_Id.Match other = (EnterpriseGoal_Id.Match) obj;
    ...
    @Override
    public EnterpriseGoal_Id specification() {
      return EnterpriseGoal_Id.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnterpriseGoal_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnterpriseGoal_Id.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Id pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_Id
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_Id.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_Id.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EnterpriseGoal_Id.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EnterpriseGoal_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnterpriseGoal_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnterpriseGoal_Id.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_Id.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnterpriseGoal_Id.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_Id.Matcher> querySpecification() {
      return EnterpriseGoal_Id.instance();
    }
  }
  
  private EnterpriseGoal_Id() {
   ...
   * 
   */
  public static EnterpriseGoal_Id instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_Id.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_Id.Matcher instantiate() {
    return EnterpriseGoal_Id.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_Id.Match newEmptyMatch() {
    return EnterpriseGoal_Id.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_Id.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_Id} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_Id#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_Id INSTANCE = new EnterpriseGoal_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
