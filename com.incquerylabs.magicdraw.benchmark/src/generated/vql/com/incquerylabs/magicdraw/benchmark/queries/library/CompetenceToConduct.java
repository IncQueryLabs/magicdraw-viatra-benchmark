...
public final class CompetenceToConduct extends BaseGeneratedEMFQuerySpecification<CompetenceToConduct.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceToConduct.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceToConduct.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceToConduct.Match)) {
          CompetenceToConduct.Match other = (CompetenceToConduct.Match) obj;
    ...
    @Override
    public CompetenceToConduct specification() {
      return CompetenceToConduct.instance();
    }
     ...
     * 
     */
    public static CompetenceToConduct.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceToConduct.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static CompetenceToConduct.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends CompetenceToConduct.Match {
    ...
    private static final class Immutable extends CompetenceToConduct.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceToConduct pattern,
   ...
   * 
   * @see Match
   * @see CompetenceToConduct
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceToConduct.Match> {
    /**
     ...
     * 
     */
    public static CompetenceToConduct.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceToConduct.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceToConduct.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceToConduct.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<CompetenceToConduct.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<CompetenceToConduct.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super CompetenceToConduct.Match> processor) {
     ...
     * 
     */
    public CompetenceToConduct.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return CompetenceToConduct.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceToConduct.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceToConduct.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final CompetenceToConduct.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final CompetenceToConduct.Match partialMatch) {
    ...
    @Override
    protected CompetenceToConduct.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceToConduct.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected CompetenceToConduct.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceToConduct.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceToConduct.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceToConduct.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceToConduct.Matcher> querySpecification() {
      return CompetenceToConduct.instance();
    }
  }
  
  private CompetenceToConduct() {
   ...
   * 
   */
  public static CompetenceToConduct instance() {
    try{
  ...
  @Override
  protected CompetenceToConduct.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceToConduct.Matcher.on(engine);
  }
  
  @Override
  public CompetenceToConduct.Matcher instantiate() {
    return CompetenceToConduct.Matcher.create();
  }
  
  @Override
  public CompetenceToConduct.Match newEmptyMatch() {
    return CompetenceToConduct.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceToConduct.Match newMatch(final Object... parameters) {
    return CompetenceToConduct.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceToConduct} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceToConduct#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceToConduct INSTANCE = new CompetenceToConduct();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceToConduct.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "CompetenceToConduct")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "CompetenceToConduct");
