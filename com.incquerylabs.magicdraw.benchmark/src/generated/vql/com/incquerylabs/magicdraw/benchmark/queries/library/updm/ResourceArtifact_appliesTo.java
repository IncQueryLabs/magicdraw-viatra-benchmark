...
public final class ResourceArtifact_appliesTo extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_appliesTo.Match)) {
          ResourceArtifact_appliesTo.Match other = (ResourceArtifact_appliesTo.Match) obj;
    ...
    @Override
    public ResourceArtifact_appliesTo specification() {
      return ResourceArtifact_appliesTo.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_appliesTo.Match {
    ...
    private static final class Immutable extends ResourceArtifact_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_appliesTo.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_appliesTo.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_appliesTo.Matcher> querySpecification() {
      return ResourceArtifact_appliesTo.instance();
    }
  }
  
  private ResourceArtifact_appliesTo() {
   ...
   * 
   */
  public static ResourceArtifact_appliesTo instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_appliesTo.Matcher instantiate() {
    return ResourceArtifact_appliesTo.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_appliesTo.Match newEmptyMatch() {
    return ResourceArtifact_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_appliesTo.Match newMatch(final Object... parameters) {
    return ResourceArtifact_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_appliesTo INSTANCE = new ResourceArtifact_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
