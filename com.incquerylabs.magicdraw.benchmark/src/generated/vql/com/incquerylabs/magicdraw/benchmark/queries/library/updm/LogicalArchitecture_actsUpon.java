...
public final class LogicalArchitecture_actsUpon extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_actsUpon.Match)) {
          LogicalArchitecture_actsUpon.Match other = (LogicalArchitecture_actsUpon.Match) obj;
    ...
    @Override
    public LogicalArchitecture_actsUpon specification() {
      return LogicalArchitecture_actsUpon.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static LogicalArchitecture_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends LogicalArchitecture_actsUpon.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super LogicalArchitecture_actsUpon.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return LogicalArchitecture_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final LogicalArchitecture_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final LogicalArchitecture_actsUpon.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected LogicalArchitecture_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_actsUpon.Matcher> querySpecification() {
      return LogicalArchitecture_actsUpon.instance();
    }
  }
  
  private LogicalArchitecture_actsUpon() {
   ...
   * 
   */
  public static LogicalArchitecture_actsUpon instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_actsUpon.Matcher instantiate() {
    return LogicalArchitecture_actsUpon.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_actsUpon.Match newEmptyMatch() {
    return LogicalArchitecture_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_actsUpon.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_actsUpon INSTANCE = new LogicalArchitecture_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
