...
public final class Service_connectorRequired extends BaseGeneratedEMFQuerySpecification<Service_connectorRequired.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Service_connectorRequired pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Service_connectorRequired";
    }
    
    @Override
    public List<String> parameterNames() {
      return Service_connectorRequired.Match.parameterNames;
    }
    ...
    @Override
    public Service_connectorRequired.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Service_connectorRequired.Match)) {
          Service_connectorRequired.Match other = (Service_connectorRequired.Match) obj;
    ...
    @Override
    public Service_connectorRequired specification() {
     ...
     * 
     */
    public static Service_connectorRequired.Match newEmptyMatch() {
     ...
     * 
     */
    public static Service_connectorRequired.Match newMutableMatch(final Port pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Service_connectorRequired.Match newMatch(final Port pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Service_connectorRequired.Match {
    ...
    private static final class Immutable extends Service_connectorRequired.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Service_connectorRequired pattern,
   ...
   * 
   * @see Match
   * @see Service_connectorRequired
   * 
   */
  public static class Matcher extends BaseMatcher<Service_connectorRequired.Match> {
    /**
     ...
     * 
     */
    public static Service_connectorRequired.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Service_connectorRequired.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Service_connectorRequired.Matcher.class);
     ...
     * 
     */
    public Collection<Service_connectorRequired.Match> getAllMatches(final Port pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Service_connectorRequired.Match> streamAllMatches(final Port pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Service_connectorRequired.Match> getOneArbitraryMatch(final Port pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final LiteralBoolean pValuespec, final Consumer<? super Service_connectorRequired.Match> processor) {
     ...
     * 
     */
    public Service_connectorRequired.Match newMatch(final Port pElement, final LiteralBoolean pValuespec) {
      return Service_connectorRequired.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Service_connectorRequired.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Service_connectorRequired.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Service_connectorRequired.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Service_connectorRequired.Match partialMatch) {
    ...
    @Override
    protected Service_connectorRequired.Match tupleToMatch(final Tuple t) {
      try {
          return Service_connectorRequired.Match.newMatch((Port) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Service_connectorRequired.Match arrayToMatch(final Object[] match) {
      try {
          return Service_connectorRequired.Match.newMatch((Port) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Service_connectorRequired.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Service_connectorRequired.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Service_connectorRequired.Matcher> querySpecification() {
      return Service_connectorRequired.instance();
    }
  }
  
  private Service_connectorRequired() {
   ...
   * 
   */
  public static Service_connectorRequired instance() {
    try{
  ...
  @Override
  protected Service_connectorRequired.Matcher instantiate(final ViatraQueryEngine engine) {
    return Service_connectorRequired.Matcher.on(engine);
  }
  
  @Override
  public Service_connectorRequired.Matcher instantiate() {
    return Service_connectorRequired.Matcher.create();
  }
  
  @Override
  public Service_connectorRequired.Match newEmptyMatch() {
    return Service_connectorRequired.Match.newEmptyMatch();
  }
  
  @Override
  public Service_connectorRequired.Match newMatch(final Object... parameters) {
    return Service_connectorRequired.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Service_connectorRequired} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Service_connectorRequired#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Service_connectorRequired INSTANCE = new Service_connectorRequired();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Service_connectorRequired.GeneratedPQuery INSTANCE = new GeneratedPQuery();
