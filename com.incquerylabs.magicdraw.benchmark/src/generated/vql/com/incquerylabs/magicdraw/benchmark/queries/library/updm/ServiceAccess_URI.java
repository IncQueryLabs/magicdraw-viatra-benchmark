...
public final class ServiceAccess_URI extends BaseGeneratedEMFQuerySpecification<ServiceAccess_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_URI.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_URI.Match)) {
          ServiceAccess_URI.Match other = (ServiceAccess_URI.Match) obj;
    ...
    @Override
    public ServiceAccess_URI specification() {
      return ServiceAccess_URI.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ServiceAccess_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ServiceAccess_URI.Match {
    ...
    private static final class Immutable extends ServiceAccess_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_URI pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_URI.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ServiceAccess_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ServiceAccess_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ServiceAccess_URI.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ServiceAccess_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ServiceAccess_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ServiceAccess_URI.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ServiceAccess_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_URI.Matcher> querySpecification() {
      return ServiceAccess_URI.instance();
    }
  }
  
  private ServiceAccess_URI() {
   ...
   * 
   */
  public static ServiceAccess_URI instance() {
    try{
  ...
  @Override
  protected ServiceAccess_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_URI.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_URI.Matcher instantiate() {
    return ServiceAccess_URI.Matcher.create();
  }
  
  @Override
  public ServiceAccess_URI.Match newEmptyMatch() {
    return ServiceAccess_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_URI.Match newMatch(final Object... parameters) {
    return ServiceAccess_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_URI INSTANCE = new ServiceAccess_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
