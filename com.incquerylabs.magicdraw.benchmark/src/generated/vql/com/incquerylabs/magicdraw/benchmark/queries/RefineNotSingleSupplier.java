...
public final class RefineNotSingleSupplier extends BaseGeneratedEMFQuerySpecification<RefineNotSingleSupplier.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.refineNotSingleSupplier pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.refineNotSingleSupplier";
    }
    
    @Override
    public List<String> parameterNames() {
      return RefineNotSingleSupplier.Match.parameterNames;
    }
    ...
    @Override
    public RefineNotSingleSupplier.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RefineNotSingleSupplier.Match)) {
          RefineNotSingleSupplier.Match other = (RefineNotSingleSupplier.Match) obj;
    ...
    @Override
    public RefineNotSingleSupplier specification() {
     ...
     * 
     */
    public static RefineNotSingleSupplier.Match newEmptyMatch() {
     ...
     * 
     */
    public static RefineNotSingleSupplier.Match newMutableMatch(final Abstraction pAbstraction) {
     ...
     * 
     */
    public static RefineNotSingleSupplier.Match newMatch(final Abstraction pAbstraction) {
      return new Immutable(pAbstraction);
    }
    
    private static final class Mutable extends RefineNotSingleSupplier.Match {
    ...
    private static final class Immutable extends RefineNotSingleSupplier.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.refineNotSingleSupplier pattern,
   ...
   * 
   * @see Match
   * @see RefineNotSingleSupplier
   * 
   */
  public static class Matcher extends BaseMatcher<RefineNotSingleSupplier.Match> {
    /**
     ...
     * 
     */
    public static RefineNotSingleSupplier.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RefineNotSingleSupplier.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_ABSTRACTION = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RefineNotSingleSupplier.Matcher.class);
     ...
     * 
     */
    public Collection<RefineNotSingleSupplier.Match> getAllMatches(final Abstraction pAbstraction) {
     ...
     * 
     */
    public Stream<RefineNotSingleSupplier.Match> streamAllMatches(final Abstraction pAbstraction) {
     ...
     * 
     */
    public Optional<RefineNotSingleSupplier.Match> getOneArbitraryMatch(final Abstraction pAbstraction) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pAbstraction, final Consumer<? super RefineNotSingleSupplier.Match> processor) {
     ...
     * 
     */
    public RefineNotSingleSupplier.Match newMatch(final Abstraction pAbstraction) {
      return RefineNotSingleSupplier.Match.newMatch(pAbstraction);
    }
    ...
    @Override
    protected RefineNotSingleSupplier.Match tupleToMatch(final Tuple t) {
      try {
          return RefineNotSingleSupplier.Match.newMatch((Abstraction) t.get(POSITION_ABSTRACTION));
    ...
    @Override
    protected RefineNotSingleSupplier.Match arrayToMatch(final Object[] match) {
      try {
          return RefineNotSingleSupplier.Match.newMatch((Abstraction) match[POSITION_ABSTRACTION]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RefineNotSingleSupplier.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RefineNotSingleSupplier.Match.newMutableMatch((Abstraction) match[POSITION_ABSTRACTION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RefineNotSingleSupplier.Matcher> querySpecification() {
      return RefineNotSingleSupplier.instance();
    }
  }
  
  private RefineNotSingleSupplier() {
   ...
   * 
   */
  public static RefineNotSingleSupplier instance() {
    try{
  ...
  @Override
  protected RefineNotSingleSupplier.Matcher instantiate(final ViatraQueryEngine engine) {
    return RefineNotSingleSupplier.Matcher.on(engine);
  }
  
  @Override
  public RefineNotSingleSupplier.Matcher instantiate() {
    return RefineNotSingleSupplier.Matcher.create();
  }
  
  @Override
  public RefineNotSingleSupplier.Match newEmptyMatch() {
    return RefineNotSingleSupplier.Match.newEmptyMatch();
  }
  
  @Override
  public RefineNotSingleSupplier.Match newMatch(final Object... parameters) {
    return RefineNotSingleSupplier.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0]);
  }
  ...
  private static class LazyHolder {
    private static final RefineNotSingleSupplier INSTANCE = new RefineNotSingleSupplier();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RefineNotSingleSupplier.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private class Embedded_1_Abstraction_supplier extends BaseGeneratedEMFPQuery {
      ...
      public Set<PBody> doGetContainedBodies() {
        ...
        new TypeConstraint(body, Tuples.flatTupleOf(var_p0, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency", "supplier")));
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern refineNotSingleSupplier";
              }
