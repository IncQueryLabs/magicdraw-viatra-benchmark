...
public final class Person_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Person_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Person_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Person_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_isEncapsulated.Match)) {
          Person_isEncapsulated.Match other = (Person_isEncapsulated.Match) obj;
    ...
    @Override
    public Person_isEncapsulated specification() {
      return Person_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Person_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Person_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Person_isEncapsulated.Match {
    ...
    private static final class Immutable extends Person_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Person_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Person_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Person_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Person_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Person_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Person_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Person_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Person_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Person_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Person_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Person_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Person_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Person_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Person_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Person_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_isEncapsulated.Matcher> querySpecification() {
      return Person_isEncapsulated.instance();
    }
  }
  
  private Person_isEncapsulated() {
   ...
   * 
   */
  public static Person_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Person_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Person_isEncapsulated.Matcher instantiate() {
    return Person_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Person_isEncapsulated.Match newEmptyMatch() {
    return Person_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Person_isEncapsulated.Match newMatch(final Object... parameters) {
    return Person_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_isEncapsulated INSTANCE = new Person_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
