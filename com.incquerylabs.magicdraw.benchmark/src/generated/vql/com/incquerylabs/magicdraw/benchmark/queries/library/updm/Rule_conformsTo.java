...
public final class Rule_conformsTo extends BaseGeneratedEMFQuerySpecification<Rule_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_conformsTo";
    }
     ...
     * 
     */
    public static Rule_conformsTo.Match newMutableMatch(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public static Rule_conformsTo.Match newMatch(final Element pElement, final Element pValue) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_conformsTo pattern,
  ...
  public static class Matcher extends BaseMatcher<Rule_conformsTo.Match> {
     ...
     * 
     */
    public Collection<Rule_conformsTo.Match> getAllMatches(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Rule_conformsTo.Match> streamAllMatches(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Rule_conformsTo.Match> getOneArbitraryMatch(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final Element pValue, final Consumer<? super Rule_conformsTo.Match> processor) {
     ...
     * 
     */
    public Rule_conformsTo.Match newMatch(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Rule_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Rule_conformsTo.Match partialMatch) {
    ...
    protected Rule_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Rule_conformsTo.Match.newMatch((Element) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    protected Rule_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Rule_conformsTo.Match.newMatch((Element) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Rule_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rule_conformsTo.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Rule_conformsTo.Match newMatch(final Object... parameters) {
    return Rule_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
