...
public final class OrganizationType_URI extends BaseGeneratedEMFQuerySpecification<OrganizationType_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_URI.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_URI.Match)) {
          OrganizationType_URI.Match other = (OrganizationType_URI.Match) obj;
    ...
    @Override
    public OrganizationType_URI specification() {
      return OrganizationType_URI.instance();
    }
     ...
     * 
     */
    public static OrganizationType_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static OrganizationType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OrganizationType_URI.Match {
    ...
    private static final class Immutable extends OrganizationType_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_URI pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_URI
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_URI.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_URI.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<OrganizationType_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<OrganizationType_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super OrganizationType_URI.Match> processor) {
     ...
     * 
     */
    public OrganizationType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return OrganizationType_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final OrganizationType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final OrganizationType_URI.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_URI.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OrganizationType_URI.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_URI.Matcher> querySpecification() {
      return OrganizationType_URI.instance();
    }
  }
  
  private OrganizationType_URI() {
   ...
   * 
   */
  public static OrganizationType_URI instance() {
    try{
  ...
  @Override
  protected OrganizationType_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_URI.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_URI.Matcher instantiate() {
    return OrganizationType_URI.Matcher.create();
  }
  
  @Override
  public OrganizationType_URI.Match newEmptyMatch() {
    return OrganizationType_URI.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_URI.Match newMatch(final Object... parameters) {
    return OrganizationType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_URI INSTANCE = new OrganizationType_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
