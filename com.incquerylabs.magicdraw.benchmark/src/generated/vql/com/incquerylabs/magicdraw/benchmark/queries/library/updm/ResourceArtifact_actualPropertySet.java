...
public final class ResourceArtifact_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_actualPropertySet.Match)) {
          ResourceArtifact_actualPropertySet.Match other = (ResourceArtifact_actualPropertySet.Match) obj;
    ...
    @Override
    public ResourceArtifact_actualPropertySet specification() {
      return ResourceArtifact_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_actualPropertySet.Match {
    ...
    private static final class Immutable extends ResourceArtifact_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_actualPropertySet.Matcher> querySpecification() {
      return ResourceArtifact_actualPropertySet.instance();
    }
  }
  
  private ResourceArtifact_actualPropertySet() {
   ...
   * 
   */
  public static ResourceArtifact_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_actualPropertySet.Matcher instantiate() {
    return ResourceArtifact_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_actualPropertySet.Match newEmptyMatch() {
    return ResourceArtifact_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_actualPropertySet.Match newMatch(final Object... parameters) {
    return ResourceArtifact_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_actualPropertySet INSTANCE = new ResourceArtifact_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
