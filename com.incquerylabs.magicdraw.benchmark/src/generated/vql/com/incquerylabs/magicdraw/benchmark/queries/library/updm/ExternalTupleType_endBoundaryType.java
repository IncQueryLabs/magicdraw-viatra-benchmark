...
public final class ExternalTupleType_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ExternalTupleType_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTupleType_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTupleType_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTupleType_endBoundaryType.Match)) {
          ExternalTupleType_endBoundaryType.Match other = (ExternalTupleType_endBoundaryType.Match) obj;
    ...
    @Override
    public ExternalTupleType_endBoundaryType specification() {
      return ExternalTupleType_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ExternalTupleType_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTupleType_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTupleType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTupleType_endBoundaryType.Match {
    ...
    private static final class Immutable extends ExternalTupleType_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ExternalTupleType_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTupleType_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ExternalTupleType_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTupleType_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTupleType_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTupleType_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTupleType_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTupleType_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTupleType_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ExternalTupleType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTupleType_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTupleType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTupleType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTupleType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTupleType_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ExternalTupleType_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTupleType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTupleType_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTupleType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTupleType_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTupleType_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTupleType_endBoundaryType.Matcher> querySpecification() {
      return ExternalTupleType_endBoundaryType.instance();
    }
  }
  
  private ExternalTupleType_endBoundaryType() {
   ...
   * 
   */
  public static ExternalTupleType_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ExternalTupleType_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTupleType_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ExternalTupleType_endBoundaryType.Matcher instantiate() {
    return ExternalTupleType_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ExternalTupleType_endBoundaryType.Match newEmptyMatch() {
    return ExternalTupleType_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTupleType_endBoundaryType.Match newMatch(final Object... parameters) {
    return ExternalTupleType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTupleType_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTupleType_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTupleType_endBoundaryType INSTANCE = new ExternalTupleType_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTupleType_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
