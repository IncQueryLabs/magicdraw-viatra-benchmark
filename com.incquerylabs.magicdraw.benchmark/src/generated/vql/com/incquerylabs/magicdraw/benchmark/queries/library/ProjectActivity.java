...
public final class ProjectActivity extends BaseGeneratedEMFQuerySpecification<ProjectActivity.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectActivity pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectActivity";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectActivity.Match.parameterNames;
    }
    ...
    @Override
    public ProjectActivity.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectActivity.Match)) {
          ProjectActivity.Match other = (ProjectActivity.Match) obj;
    ...
    @Override
    public ProjectActivity specification() {
      return ProjectActivity.instance();
    }
     ...
     * 
     */
    public static ProjectActivity.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectActivity.Match newMutableMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProjectActivity.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProjectActivity.Match {
    ...
    private static final class Immutable extends ProjectActivity.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectActivity pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectActivity.Match> {
    /**
     ...
     * 
     */
    public static ProjectActivity.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectActivity.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectActivity.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectActivity.Match> getAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProjectActivity.Match> streamAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProjectActivity.Match> getOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProjectActivity.Match> processor) {
     ...
     * 
     */
    public ProjectActivity.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProjectActivity.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final ProjectActivity.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final ProjectActivity.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProjectActivity.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProjectActivity.Match partialMatch) {
    ...
    @Override
    protected ProjectActivity.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectActivity.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProjectActivity.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectActivity.Match.newMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectActivity.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectActivity.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectActivity.Matcher> querySpecification() {
      return ProjectActivity.instance();
    }
  }
  ...
  @Override
  protected ProjectActivity.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectActivity.Matcher.on(engine);
  }
  
  @Override
  public ProjectActivity.Matcher instantiate() {
    return ProjectActivity.Matcher.create();
  }
  
  @Override
  public ProjectActivity.Match newEmptyMatch() {
    return ProjectActivity.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectActivity.Match newMatch(final Object... parameters) {
    return ProjectActivity.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectActivity} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectActivity#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectActivity INSTANCE = new ProjectActivity();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectActivity.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ProjectActivity")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ProjectActivity");
