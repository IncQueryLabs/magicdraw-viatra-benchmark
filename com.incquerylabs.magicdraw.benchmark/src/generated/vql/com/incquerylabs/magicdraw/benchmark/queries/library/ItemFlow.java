 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "ItemFlow");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class ItemFlow extends BaseGeneratedEMFQuerySpecification<ItemFlow.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ItemFlow pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ItemFlow";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ItemFlow pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link ItemFlow} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ItemFlow#instance()}.
   * 
