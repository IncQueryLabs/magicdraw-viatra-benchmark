...
public final class ItemFlow extends BaseGeneratedEMFQuerySpecification<ItemFlow.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final InformationFlow pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ItemFlow.Match newMutableMatch(final InformationFlow pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ItemFlow.Match newMatch(final InformationFlow pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends ItemFlow.Match {
      Mutable(final InformationFlow pElement, final Stereotype pStereotype) {
    ...
    private static final class Immutable extends ItemFlow.Match {
      Immutable(final InformationFlow pElement, final Stereotype pStereotype) {
        super(pElement, pStereotype);
      }
  ...
  public static class Matcher extends BaseMatcher<ItemFlow.Match> {
     ...
     * 
     */
    public Collection<ItemFlow.Match> getAllMatches(final InformationFlow pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ItemFlow.Match> streamAllMatches(final InformationFlow pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ItemFlow.Match> getOneArbitraryMatch(final InformationFlow pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean hasMatch(final InformationFlow pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public int countMatches(final InformationFlow pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final Stereotype pStereotype, final Consumer<? super ItemFlow.Match> processor) {
     ...
     * 
     */
    public ItemFlow.Match newMatch(final InformationFlow pElement, final Stereotype pStereotype) {
      return ItemFlow.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfElement(final Stereotype pStereotype) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfElement(final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ItemFlow.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final InformationFlow pElement) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ItemFlow.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final InformationFlow pElement) {
    ...
    protected ItemFlow.Match tupleToMatch(final Tuple t) {
      try {
          return ItemFlow.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ItemFlow.Match arrayToMatch(final Object[] match) {
      try {
          return ItemFlow.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ItemFlow.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ItemFlow.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ItemFlow.Match newMatch(final Object... parameters) {
    return ItemFlow.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
