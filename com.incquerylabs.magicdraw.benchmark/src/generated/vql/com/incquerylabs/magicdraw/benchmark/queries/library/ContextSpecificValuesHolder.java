 ...
 *         pattern contextSpecificValuesHolder(Element : Diagram, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "contextSpecificValuesHolder");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class ContextSpecificValuesHolder extends BaseGeneratedEMFQuerySpecification<ContextSpecificValuesHolder.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ContextSpecificValuesHolder.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ContextSpecificValuesHolder.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<ContextSpecificValuesHolder.Match> {
     ...
     * 
     */
    public Collection<ContextSpecificValuesHolder.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ContextSpecificValuesHolder.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ContextSpecificValuesHolder.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super ContextSpecificValuesHolder.Match> processor) {
     ...
     * 
     */
    public ContextSpecificValuesHolder.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return ContextSpecificValuesHolder.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ContextSpecificValuesHolder.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ContextSpecificValuesHolder.Match partialMatch) {
    ...
    protected ContextSpecificValuesHolder.Match tupleToMatch(final Tuple t) {
      try {
          return ContextSpecificValuesHolder.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ContextSpecificValuesHolder.Match arrayToMatch(final Object[] match) {
      try {
          return ContextSpecificValuesHolder.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ContextSpecificValuesHolder.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ContextSpecificValuesHolder.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ContextSpecificValuesHolder.Match newMatch(final Object... parameters) {
    return ContextSpecificValuesHolder.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
