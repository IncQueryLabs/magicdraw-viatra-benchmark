...
public final class ProjectRole extends BaseGeneratedEMFQuerySpecification<ProjectRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectRole.Match.parameterNames;
    }
    ...
    @Override
    public ProjectRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectRole.Match)) {
          ProjectRole.Match other = (ProjectRole.Match) obj;
    ...
    @Override
    public ProjectRole specification() {
      return ProjectRole.instance();
    }
     ...
     * 
     */
    public static ProjectRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectRole.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProjectRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProjectRole.Match {
    ...
    private static final class Immutable extends ProjectRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectRole.Match> {
    /**
     ...
     * 
     */
    public static ProjectRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectRole.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectRole.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProjectRole.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProjectRole.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProjectRole.Match> processor) {
     ...
     * 
     */
    public ProjectRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProjectRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProjectRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProjectRole.Match partialMatch) {
    ...
    @Override
    protected ProjectRole.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectRole.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProjectRole.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectRole.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectRole.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectRole.Matcher> querySpecification() {
      return ProjectRole.instance();
    }
  }
   ...
   * 
   */
  public static ProjectRole instance() {
    try{
  ...
  @Override
  protected ProjectRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectRole.Matcher.on(engine);
  }
  
  @Override
  public ProjectRole.Matcher instantiate() {
    return ProjectRole.Matcher.create();
  }
  
  @Override
  public ProjectRole.Match newEmptyMatch() {
    return ProjectRole.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectRole.Match newMatch(final Object... parameters) {
    return ProjectRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectRole INSTANCE = new ProjectRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ProjectRole")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ProjectRole");
