...
public final class OwnsRisk_sourceContext extends BaseGeneratedEMFQuerySpecification<OwnsRisk_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRisk_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRisk_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRisk_sourceContext.Match)) {
          OwnsRisk_sourceContext.Match other = (OwnsRisk_sourceContext.Match) obj;
    ...
    @Override
    public OwnsRisk_sourceContext specification() {
      return OwnsRisk_sourceContext.instance();
    }
     ...
     * 
     */
    public static OwnsRisk_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRisk_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static OwnsRisk_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsRisk_sourceContext.Match {
    ...
    private static final class Immutable extends OwnsRisk_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see OwnsRisk_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRisk_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static OwnsRisk_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRisk_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRisk_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRisk_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<OwnsRisk_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<OwnsRisk_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super OwnsRisk_sourceContext.Match> processor) {
     ...
     * 
     */
    public OwnsRisk_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return OwnsRisk_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRisk_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRisk_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final OwnsRisk_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final OwnsRisk_sourceContext.Match partialMatch) {
    ...
    @Override
    protected OwnsRisk_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRisk_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsRisk_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRisk_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRisk_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRisk_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRisk_sourceContext.Matcher> querySpecification() {
      return OwnsRisk_sourceContext.instance();
    }
  }
  
  private OwnsRisk_sourceContext() {
   ...
   * 
   */
  public static OwnsRisk_sourceContext instance() {
    try{
  ...
  @Override
  protected OwnsRisk_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRisk_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public OwnsRisk_sourceContext.Matcher instantiate() {
    return OwnsRisk_sourceContext.Matcher.create();
  }
  
  @Override
  public OwnsRisk_sourceContext.Match newEmptyMatch() {
    return OwnsRisk_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRisk_sourceContext.Match newMatch(final Object... parameters) {
    return OwnsRisk_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRisk_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRisk_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRisk_sourceContext INSTANCE = new OwnsRisk_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRisk_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
