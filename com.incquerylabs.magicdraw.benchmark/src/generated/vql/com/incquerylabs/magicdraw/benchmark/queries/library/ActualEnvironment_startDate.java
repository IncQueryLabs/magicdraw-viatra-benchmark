...
public final class ActualEnvironment_startDate extends BaseGeneratedEMFQuerySpecification<ActualEnvironment_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnvironment_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnvironment_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualEnvironment_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualEnvironment_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualEnvironment_startDate.Match)) {
          ActualEnvironment_startDate.Match other = (ActualEnvironment_startDate.Match) obj;
    ...
    @Override
    public ActualEnvironment_startDate specification() {
      return ActualEnvironment_startDate.instance();
    }
     ...
     * 
     */
    public static ActualEnvironment_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualEnvironment_startDate.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public static ActualEnvironment_startDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualEnvironment_startDate.Match {
    ...
    private static final class Immutable extends ActualEnvironment_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnvironment_startDate pattern,
   ...
   * 
   * @see Match
   * @see ActualEnvironment_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualEnvironment_startDate.Match> {
    /**
     ...
     * 
     */
    public static ActualEnvironment_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualEnvironment_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualEnvironment_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualEnvironment_startDate.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Stream<ActualEnvironment_startDate.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Optional<ActualEnvironment_startDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue, final Consumer<? super ActualEnvironment_startDate.Match> processor) {
     ...
     * 
     */
    public ActualEnvironment_startDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return ActualEnvironment_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualEnvironment_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualEnvironment_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvalue(final ActualEnvironment_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvalue(final ActualEnvironment_startDate.Match partialMatch) {
    ...
    @Override
    protected ActualEnvironment_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualEnvironment_startDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualEnvironment_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualEnvironment_startDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualEnvironment_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualEnvironment_startDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualEnvironment_startDate.Matcher> querySpecification() {
      return ActualEnvironment_startDate.instance();
    }
  }
  
  private ActualEnvironment_startDate() {
   ...
   * 
   */
  public static ActualEnvironment_startDate instance() {
    try{
  ...
  @Override
  protected ActualEnvironment_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualEnvironment_startDate.Matcher.on(engine);
  }
  
  @Override
  public ActualEnvironment_startDate.Matcher instantiate() {
    return ActualEnvironment_startDate.Matcher.create();
  }
  
  @Override
  public ActualEnvironment_startDate.Match newEmptyMatch() {
    return ActualEnvironment_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualEnvironment_startDate.Match newMatch(final Object... parameters) {
    return ActualEnvironment_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualEnvironment_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualEnvironment_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualEnvironment_startDate INSTANCE = new ActualEnvironment_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualEnvironment_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
