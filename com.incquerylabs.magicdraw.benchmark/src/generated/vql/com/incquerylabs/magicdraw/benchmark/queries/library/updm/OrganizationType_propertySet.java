...
public final class OrganizationType_propertySet extends BaseGeneratedEMFQuerySpecification<OrganizationType_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_propertySet.Match)) {
          OrganizationType_propertySet.Match other = (OrganizationType_propertySet.Match) obj;
    ...
    @Override
    public OrganizationType_propertySet specification() {
      return OrganizationType_propertySet.instance();
    }
     ...
     * 
     */
    public static OrganizationType_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_propertySet.Match {
    ...
    private static final class Immutable extends OrganizationType_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_propertySet pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_propertySet.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_propertySet.Match> processor) {
     ...
     * 
     */
    public OrganizationType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_propertySet.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_propertySet.Matcher> querySpecification() {
      return OrganizationType_propertySet.instance();
    }
  }
  
  private OrganizationType_propertySet() {
   ...
   * 
   */
  public static OrganizationType_propertySet instance() {
    try{
  ...
  @Override
  protected OrganizationType_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_propertySet.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_propertySet.Matcher instantiate() {
    return OrganizationType_propertySet.Matcher.create();
  }
  
  @Override
  public OrganizationType_propertySet.Match newEmptyMatch() {
    return OrganizationType_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_propertySet.Match newMatch(final Object... parameters) {
    return OrganizationType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_propertySet INSTANCE = new OrganizationType_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
