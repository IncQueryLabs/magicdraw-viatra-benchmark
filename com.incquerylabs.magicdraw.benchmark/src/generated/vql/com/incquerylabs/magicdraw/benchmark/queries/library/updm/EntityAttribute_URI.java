...
public final class EntityAttribute_URI extends BaseGeneratedEMFQuerySpecification<EntityAttribute_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityAttribute_URI.Match.parameterNames;
    }
    ...
    @Override
    public EntityAttribute_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityAttribute_URI.Match)) {
          EntityAttribute_URI.Match other = (EntityAttribute_URI.Match) obj;
    ...
    @Override
    public EntityAttribute_URI specification() {
      return EntityAttribute_URI.instance();
    }
     ...
     * 
     */
    public static EntityAttribute_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityAttribute_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EntityAttribute_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EntityAttribute_URI.Match {
    ...
    private static final class Immutable extends EntityAttribute_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_URI pattern,
   ...
   * 
   * @see Match
   * @see EntityAttribute_URI
   * 
   */
  public static class Matcher extends BaseMatcher<EntityAttribute_URI.Match> {
    /**
     ...
     * 
     */
    public static EntityAttribute_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityAttribute_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityAttribute_URI.Matcher.class);
     ...
     * 
     */
    public Collection<EntityAttribute_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EntityAttribute_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EntityAttribute_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super EntityAttribute_URI.Match> processor) {
     ...
     * 
     */
    public EntityAttribute_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return EntityAttribute_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EntityAttribute_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EntityAttribute_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EntityAttribute_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EntityAttribute_URI.Match partialMatch) {
    ...
    @Override
    protected EntityAttribute_URI.Match tupleToMatch(final Tuple t) {
      try {
          return EntityAttribute_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EntityAttribute_URI.Match arrayToMatch(final Object[] match) {
      try {
          return EntityAttribute_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityAttribute_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityAttribute_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityAttribute_URI.Matcher> querySpecification() {
      return EntityAttribute_URI.instance();
    }
  }
  
  private EntityAttribute_URI() {
   ...
   * 
   */
  public static EntityAttribute_URI instance() {
    try{
  ...
  @Override
  protected EntityAttribute_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityAttribute_URI.Matcher.on(engine);
  }
  
  @Override
  public EntityAttribute_URI.Matcher instantiate() {
    return EntityAttribute_URI.Matcher.create();
  }
  
  @Override
  public EntityAttribute_URI.Match newEmptyMatch() {
    return EntityAttribute_URI.Match.newEmptyMatch();
  }
  
  @Override
  public EntityAttribute_URI.Match newMatch(final Object... parameters) {
    return EntityAttribute_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityAttribute_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityAttribute_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityAttribute_URI INSTANCE = new EntityAttribute_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityAttribute_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
