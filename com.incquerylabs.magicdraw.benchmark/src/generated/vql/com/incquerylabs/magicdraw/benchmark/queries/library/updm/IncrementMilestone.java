...
public final class IncrementMilestone extends BaseGeneratedEMFQuerySpecification<IncrementMilestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.IncrementMilestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.IncrementMilestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return IncrementMilestone.Match.parameterNames;
    }
    ...
    @Override
    public IncrementMilestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof IncrementMilestone.Match)) {
          IncrementMilestone.Match other = (IncrementMilestone.Match) obj;
    ...
    @Override
    public IncrementMilestone specification() {
      return IncrementMilestone.instance();
    }
     ...
     * 
     */
    public static IncrementMilestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static IncrementMilestone.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static IncrementMilestone.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends IncrementMilestone.Match {
    ...
    private static final class Immutable extends IncrementMilestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.IncrementMilestone pattern,
   ...
   * 
   * @see Match
   * @see IncrementMilestone
   * 
   */
  public static class Matcher extends BaseMatcher<IncrementMilestone.Match> {
    /**
     ...
     * 
     */
    public static IncrementMilestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static IncrementMilestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(IncrementMilestone.Matcher.class);
     ...
     * 
     */
    public Collection<IncrementMilestone.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<IncrementMilestone.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<IncrementMilestone.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super IncrementMilestone.Match> processor) {
     ...
     * 
     */
    public IncrementMilestone.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return IncrementMilestone.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final IncrementMilestone.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final IncrementMilestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final IncrementMilestone.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final IncrementMilestone.Match partialMatch) {
    ...
    @Override
    protected IncrementMilestone.Match tupleToMatch(final Tuple t) {
      try {
          return IncrementMilestone.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected IncrementMilestone.Match arrayToMatch(final Object[] match) {
      try {
          return IncrementMilestone.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected IncrementMilestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return IncrementMilestone.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<IncrementMilestone.Matcher> querySpecification() {
      return IncrementMilestone.instance();
    }
  }
  
  private IncrementMilestone() {
   ...
   * 
   */
  public static IncrementMilestone instance() {
    try{
  ...
  @Override
  protected IncrementMilestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return IncrementMilestone.Matcher.on(engine);
  }
  
  @Override
  public IncrementMilestone.Matcher instantiate() {
    return IncrementMilestone.Matcher.create();
  }
  
  @Override
  public IncrementMilestone.Match newEmptyMatch() {
    return IncrementMilestone.Match.newEmptyMatch();
  }
  
  @Override
  public IncrementMilestone.Match newMatch(final Object... parameters) {
    return IncrementMilestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link IncrementMilestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link IncrementMilestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final IncrementMilestone INSTANCE = new IncrementMilestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final IncrementMilestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "IncrementMilestone");
