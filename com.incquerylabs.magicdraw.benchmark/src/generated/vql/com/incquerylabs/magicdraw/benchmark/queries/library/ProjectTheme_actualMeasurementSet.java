...
import com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme;
...
public final class ProjectTheme_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<ProjectTheme_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectTheme_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectTheme_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectTheme_actualMeasurementSet.Match)) {
          ProjectTheme_actualMeasurementSet.Match other = (ProjectTheme_actualMeasurementSet.Match) obj;
    ...
    @Override
    public ProjectTheme_actualMeasurementSet specification() {
      return ProjectTheme_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static ProjectTheme_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectTheme_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectTheme_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectTheme_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends ProjectTheme_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see ProjectTheme_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectTheme_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static ProjectTheme_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectTheme_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectTheme_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectTheme_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectTheme_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectTheme_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectTheme_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public ProjectTheme_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectTheme_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectTheme_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectTheme_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectTheme_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectTheme_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected ProjectTheme_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectTheme_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectTheme_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectTheme_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectTheme_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectTheme_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectTheme_actualMeasurementSet.Matcher> querySpecification() {
      return ProjectTheme_actualMeasurementSet.instance();
    }
  }
  
  private ProjectTheme_actualMeasurementSet() {
   ...
   * 
   */
  public static ProjectTheme_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected ProjectTheme_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectTheme_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public ProjectTheme_actualMeasurementSet.Matcher instantiate() {
    return ProjectTheme_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public ProjectTheme_actualMeasurementSet.Match newEmptyMatch() {
    return ProjectTheme_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectTheme_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return ProjectTheme_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectTheme_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectTheme_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectTheme_actualMeasurementSet INSTANCE = new ProjectTheme_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectTheme_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ProjectTheme(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ProjectTheme.instance().getInternalQueryRepresentation());
