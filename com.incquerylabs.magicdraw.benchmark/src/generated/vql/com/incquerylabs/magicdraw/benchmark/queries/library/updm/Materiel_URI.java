...
public final class Materiel_URI extends BaseGeneratedEMFQuerySpecification<Materiel_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_URI.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_URI.Match)) {
          Materiel_URI.Match other = (Materiel_URI.Match) obj;
    ...
    @Override
    public Materiel_URI specification() {
      return Materiel_URI.instance();
    }
     ...
     * 
     */
    public static Materiel_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Materiel_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Materiel_URI.Match {
    ...
    private static final class Immutable extends Materiel_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_URI.Match> {
    /**
     ...
     * 
     */
    public static Materiel_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Materiel_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Materiel_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Materiel_URI.Match> processor) {
     ...
     * 
     */
    public Materiel_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Materiel_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Materiel_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Materiel_URI.Match partialMatch) {
    ...
    @Override
    protected Materiel_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Materiel_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_URI.Matcher> querySpecification() {
      return Materiel_URI.instance();
    }
  }
  
  private Materiel_URI() {
   ...
   * 
   */
  public static Materiel_URI instance() {
    try{
  ...
  @Override
  protected Materiel_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_URI.Matcher.on(engine);
  }
  
  @Override
  public Materiel_URI.Matcher instantiate() {
    return Materiel_URI.Matcher.create();
  }
  
  @Override
  public Materiel_URI.Match newEmptyMatch() {
    return Materiel_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_URI.Match newMatch(final Object... parameters) {
    return Materiel_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_URI INSTANCE = new Materiel_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
