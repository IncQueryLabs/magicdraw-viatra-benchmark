...
public final class CapabilityConfiguration extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration.Match)) {
          CapabilityConfiguration.Match other = (CapabilityConfiguration.Match) obj;
    ...
    @Override
    public CapabilityConfiguration specification() {
      return CapabilityConfiguration.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static CapabilityConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends CapabilityConfiguration.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super CapabilityConfiguration.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return CapabilityConfiguration.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final CapabilityConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final CapabilityConfiguration.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected CapabilityConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration.Matcher> querySpecification() {
      return CapabilityConfiguration.instance();
    }
  }
   ...
   * 
   */
  public static CapabilityConfiguration instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration.Matcher instantiate() {
    return CapabilityConfiguration.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration.Match newEmptyMatch() {
    return CapabilityConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration INSTANCE = new CapabilityConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "CapabilityConfiguration")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "CapabilityConfiguration");
