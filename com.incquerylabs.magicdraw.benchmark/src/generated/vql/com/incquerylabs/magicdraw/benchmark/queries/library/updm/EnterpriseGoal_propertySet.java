...
public final class EnterpriseGoal_propertySet extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_propertySet.Match)) {
          EnterpriseGoal_propertySet.Match other = (EnterpriseGoal_propertySet.Match) obj;
    ...
    @Override
    public EnterpriseGoal_propertySet specification() {
      return EnterpriseGoal_propertySet.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_propertySet.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_propertySet pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_propertySet.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseGoal_propertySet.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseGoal_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseGoal_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseGoal_propertySet.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_propertySet.Matcher> querySpecification() {
      return EnterpriseGoal_propertySet.instance();
    }
  }
  
  private EnterpriseGoal_propertySet() {
   ...
   * 
   */
  public static EnterpriseGoal_propertySet instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_propertySet.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_propertySet.Matcher instantiate() {
    return EnterpriseGoal_propertySet.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_propertySet.Match newEmptyMatch() {
    return EnterpriseGoal_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_propertySet.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_propertySet INSTANCE = new EnterpriseGoal_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
