...
public final class ResourcePort extends BaseGeneratedEMFQuerySpecification<ResourcePort.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePort pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePort";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourcePort.Match.parameterNames;
    }
    ...
    @Override
    public ResourcePort.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourcePort.Match)) {
          ResourcePort.Match other = (ResourcePort.Match) obj;
    ...
    @Override
    public ResourcePort specification() {
      return ResourcePort.instance();
    }
     ...
     * 
     */
    public static ResourcePort.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourcePort.Match newMutableMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResourcePort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResourcePort.Match {
    ...
    private static final class Immutable extends ResourcePort.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePort pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ResourcePort.Match> {
    /**
     ...
     * 
     */
    public static ResourcePort.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourcePort.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourcePort.Matcher.class);
     ...
     * 
     */
    public Collection<ResourcePort.Match> getAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResourcePort.Match> streamAllMatches(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResourcePort.Match> getOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResourcePort.Match> processor) {
     ...
     * 
     */
    public ResourcePort.Match newMatch(final Port pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResourcePort.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final ResourcePort.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final ResourcePort.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResourcePort.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResourcePort.Match partialMatch) {
    ...
    @Override
    protected ResourcePort.Match tupleToMatch(final Tuple t) {
      try {
          return ResourcePort.Match.newMatch((Port) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResourcePort.Match arrayToMatch(final Object[] match) {
      try {
          return ResourcePort.Match.newMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourcePort.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourcePort.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourcePort.Matcher> querySpecification() {
      return ResourcePort.instance();
    }
  }
  
  private ResourcePort() {
   ...
   * 
   */
  public static ResourcePort instance() {
    try{
  ...
  @Override
  protected ResourcePort.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourcePort.Matcher.on(engine);
  }
  
  @Override
  public ResourcePort.Matcher instantiate() {
    return ResourcePort.Matcher.create();
  }
  
  @Override
  public ResourcePort.Match newEmptyMatch() {
    return ResourcePort.Match.newEmptyMatch();
  }
  
  @Override
  public ResourcePort.Match newMatch(final Object... parameters) {
    return ResourcePort.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourcePort} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourcePort#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourcePort INSTANCE = new ResourcePort();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourcePort.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ResourcePort")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ResourcePort");
