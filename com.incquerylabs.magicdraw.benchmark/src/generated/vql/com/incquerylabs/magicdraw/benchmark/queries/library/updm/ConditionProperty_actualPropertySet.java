...
public final class ConditionProperty_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ConditionProperty_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionProperty_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ConditionProperty_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionProperty_actualPropertySet.Match)) {
          ConditionProperty_actualPropertySet.Match other = (ConditionProperty_actualPropertySet.Match) obj;
    ...
    @Override
    public ConditionProperty_actualPropertySet specification() {
      return ConditionProperty_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ConditionProperty_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionProperty_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConditionProperty_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConditionProperty_actualPropertySet.Match {
    ...
    private static final class Immutable extends ConditionProperty_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ConditionProperty_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionProperty_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ConditionProperty_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionProperty_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionProperty_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionProperty_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConditionProperty_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConditionProperty_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConditionProperty_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ConditionProperty_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ConditionProperty_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConditionProperty_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConditionProperty_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConditionProperty_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConditionProperty_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ConditionProperty_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionProperty_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConditionProperty_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionProperty_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionProperty_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionProperty_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionProperty_actualPropertySet.Matcher> querySpecification() {
      return ConditionProperty_actualPropertySet.instance();
    }
  }
  
  private ConditionProperty_actualPropertySet() {
   ...
   * 
   */
  public static ConditionProperty_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ConditionProperty_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionProperty_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ConditionProperty_actualPropertySet.Matcher instantiate() {
    return ConditionProperty_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ConditionProperty_actualPropertySet.Match newEmptyMatch() {
    return ConditionProperty_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionProperty_actualPropertySet.Match newMatch(final Object... parameters) {
    return ConditionProperty_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionProperty_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionProperty_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionProperty_actualPropertySet INSTANCE = new ConditionProperty_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionProperty_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ConditionProperty(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ConditionProperty.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
