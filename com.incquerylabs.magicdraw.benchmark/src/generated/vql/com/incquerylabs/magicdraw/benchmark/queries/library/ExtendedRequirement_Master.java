...
public final class ExtendedRequirement_Master extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement_Master.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtendedRequirement_Master.Match)) {
          ExtendedRequirement_Master.Match other = (ExtendedRequirement_Master.Match) obj;
    ...
    @Override
    public ExtendedRequirement_Master specification() {
     ...
     * 
     */
    public static ExtendedRequirement_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtendedRequirement_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExtendedRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExtendedRequirement_Master.Match {
    ...
    private static final class Immutable extends ExtendedRequirement_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_Master pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement_Master
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement_Master.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtendedRequirement_Master.Matcher.class);
     ...
     * 
     */
    public Collection<ExtendedRequirement_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExtendedRequirement_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExtendedRequirement_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExtendedRequirement_Master.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExtendedRequirement_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final ExtendedRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final ExtendedRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final ExtendedRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final ExtendedRequirement_Master.Match partialMatch) {
    ...
    @Override
    protected ExtendedRequirement_Master.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExtendedRequirement_Master.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExtendedRequirement_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement_Master.Matcher> querySpecification() {
      return ExtendedRequirement_Master.instance();
    }
  }
  
  private ExtendedRequirement_Master() {
   ...
   * 
   */
  public static ExtendedRequirement_Master instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement_Master.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement_Master.Matcher instantiate() {
    return ExtendedRequirement_Master.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement_Master.Match newEmptyMatch() {
    return ExtendedRequirement_Master.Match.newEmptyMatch();
  }
  
  @Override
  public ExtendedRequirement_Master.Match newMatch(final Object... parameters) {
    return ExtendedRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExtendedRequirement_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExtendedRequirement_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement_Master INSTANCE = new ExtendedRequirement_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExtendedRequirement_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
