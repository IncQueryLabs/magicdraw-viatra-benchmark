...
public final class Protocol_ratifiedBy extends BaseGeneratedEMFQuerySpecification<Protocol_ratifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_ratifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_ratifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_ratifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_ratifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_ratifiedBy.Match)) {
          Protocol_ratifiedBy.Match other = (Protocol_ratifiedBy.Match) obj;
    ...
    @Override
    public Protocol_ratifiedBy specification() {
      return Protocol_ratifiedBy.instance();
    }
     ...
     * 
     */
    public static Protocol_ratifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_ratifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Protocol_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Protocol_ratifiedBy.Match {
    ...
    private static final class Immutable extends Protocol_ratifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_ratifiedBy pattern,
   ...
   * 
   * @see Match
   * @see Protocol_ratifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_ratifiedBy.Match> {
    /**
     ...
     * 
     */
    public static Protocol_ratifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_ratifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_ratifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_ratifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Protocol_ratifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Protocol_ratifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Protocol_ratifiedBy.Match> processor) {
     ...
     * 
     */
    public Protocol_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Protocol_ratifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Protocol_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Protocol_ratifiedBy.Match partialMatch) {
    ...
    @Override
    protected Protocol_ratifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Protocol_ratifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_ratifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_ratifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_ratifiedBy.Matcher> querySpecification() {
      return Protocol_ratifiedBy.instance();
    }
  }
  
  private Protocol_ratifiedBy() {
   ...
   * 
   */
  public static Protocol_ratifiedBy instance() {
    try{
  ...
  @Override
  protected Protocol_ratifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_ratifiedBy.Matcher.on(engine);
  }
  
  @Override
  public Protocol_ratifiedBy.Matcher instantiate() {
    return Protocol_ratifiedBy.Matcher.create();
  }
  
  @Override
  public Protocol_ratifiedBy.Match newEmptyMatch() {
    return Protocol_ratifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_ratifiedBy.Match newMatch(final Object... parameters) {
    return Protocol_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_ratifiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_ratifiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_ratifiedBy INSTANCE = new Protocol_ratifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_ratifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
