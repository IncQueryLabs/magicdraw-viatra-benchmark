...
public final class PhysicalArchitecture_URI extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_URI.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_URI.Match)) {
          PhysicalArchitecture_URI.Match other = (PhysicalArchitecture_URI.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_URI specification() {
      return PhysicalArchitecture_URI.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static PhysicalArchitecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends PhysicalArchitecture_URI.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_URI pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_URI
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_URI.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_URI.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super PhysicalArchitecture_URI.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return PhysicalArchitecture_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final PhysicalArchitecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final PhysicalArchitecture_URI.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_URI.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected PhysicalArchitecture_URI.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_URI.Matcher> querySpecification() {
      return PhysicalArchitecture_URI.instance();
    }
  }
  
  private PhysicalArchitecture_URI() {
   ...
   * 
   */
  public static PhysicalArchitecture_URI instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_URI.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_URI.Matcher instantiate() {
    return PhysicalArchitecture_URI.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_URI.Match newEmptyMatch() {
    return PhysicalArchitecture_URI.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_URI.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_URI INSTANCE = new PhysicalArchitecture_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
