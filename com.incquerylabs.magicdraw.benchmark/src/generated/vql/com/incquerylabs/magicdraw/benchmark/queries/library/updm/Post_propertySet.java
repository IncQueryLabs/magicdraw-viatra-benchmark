...
public final class Post_propertySet extends BaseGeneratedEMFQuerySpecification<Post_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Post_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_propertySet.Match)) {
          Post_propertySet.Match other = (Post_propertySet.Match) obj;
    ...
    @Override
    public Post_propertySet specification() {
      return Post_propertySet.instance();
    }
     ...
     * 
     */
    public static Post_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_propertySet.Match {
    ...
    private static final class Immutable extends Post_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Post_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Post_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Post_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Post_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_propertySet.Match> processor) {
     ...
     * 
     */
    public Post_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_propertySet.Match partialMatch) {
    ...
    @Override
    protected Post_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Post_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Post_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_propertySet.Matcher> querySpecification() {
      return Post_propertySet.instance();
    }
  }
  
  private Post_propertySet() {
   ...
   * 
   */
  public static Post_propertySet instance() {
    try{
  ...
  @Override
  protected Post_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Post_propertySet.Matcher instantiate() {
    return Post_propertySet.Matcher.create();
  }
  
  @Override
  public Post_propertySet.Match newEmptyMatch() {
    return Post_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Post_propertySet.Match newMatch(final Object... parameters) {
    return Post_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_propertySet INSTANCE = new Post_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
