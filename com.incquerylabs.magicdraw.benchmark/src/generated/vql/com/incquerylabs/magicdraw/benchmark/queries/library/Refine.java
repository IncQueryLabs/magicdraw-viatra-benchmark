...
public final class Refine extends BaseGeneratedEMFQuerySpecification<Refine.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Refine pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Refine";
    }
    
    @Override
    public List<String> parameterNames() {
      return Refine.Match.parameterNames;
    }
    ...
    @Override
    public Refine.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Refine.Match)) {
          Refine.Match other = (Refine.Match) obj;
     ...
     * 
     */
    public static Refine.Match newEmptyMatch() {
     ...
     * 
     */
    public static Refine.Match newMutableMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Refine.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Refine.Match {
    ...
    private static final class Immutable extends Refine.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Refine pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Refine.Match> {
    /**
     ...
     * 
     */
    public static Refine.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Refine.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Refine.Matcher.class);
     ...
     * 
     */
    public Collection<Refine.Match> getAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Refine.Match> streamAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Refine.Match> getOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype, final Consumer<? super Refine.Match> processor) {
     ...
     * 
     */
    public Refine.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return Refine.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfElement(final Refine.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfElement(final Refine.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Refine.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Refine.Match partialMatch) {
    ...
    @Override
    protected Refine.Match tupleToMatch(final Tuple t) {
      try {
          return Refine.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Refine.Match arrayToMatch(final Object[] match) {
      try {
          return Refine.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Refine.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Refine.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Refine.Matcher> querySpecification() {
      return Refine.instance();
    }
  }
  ...
  @Override
  protected Refine.Matcher instantiate(final ViatraQueryEngine engine) {
    return Refine.Matcher.on(engine);
  }
  
  @Override
  public Refine.Matcher instantiate() {
    return Refine.Matcher.create();
  }
  
  @Override
  public Refine.Match newEmptyMatch() {
    return Refine.Match.newEmptyMatch();
  }
  
  @Override
  public Refine.Match newMatch(final Object... parameters) {
    return Refine.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Refine} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Refine#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Refine INSTANCE = new Refine();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Refine.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Refine");
