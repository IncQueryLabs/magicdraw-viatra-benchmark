...
public final class CapabilityProperty_minValue extends BaseGeneratedEMFQuerySpecification<CapabilityProperty_minValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_minValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_minValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty_minValue.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty_minValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty_minValue.Match)) {
          CapabilityProperty_minValue.Match other = (CapabilityProperty_minValue.Match) obj;
    ...
    @Override
    public CapabilityProperty_minValue specification() {
      return CapabilityProperty_minValue.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty_minValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty_minValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static CapabilityProperty_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends CapabilityProperty_minValue.Match {
    ...
    private static final class Immutable extends CapabilityProperty_minValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_minValue pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty_minValue
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty_minValue.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty_minValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty_minValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty_minValue.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty_minValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<CapabilityProperty_minValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<CapabilityProperty_minValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super CapabilityProperty_minValue.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return CapabilityProperty_minValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty_minValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final CapabilityProperty_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final CapabilityProperty_minValue.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty_minValue.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty_minValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected CapabilityProperty_minValue.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty_minValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty_minValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty_minValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty_minValue.Matcher> querySpecification() {
      return CapabilityProperty_minValue.instance();
    }
  }
  
  private CapabilityProperty_minValue() {
   ...
   * 
   */
  public static CapabilityProperty_minValue instance() {
    try{
  ...
  @Override
  protected CapabilityProperty_minValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty_minValue.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty_minValue.Matcher instantiate() {
    return CapabilityProperty_minValue.Matcher.create();
  }
  
  @Override
  public CapabilityProperty_minValue.Match newEmptyMatch() {
    return CapabilityProperty_minValue.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty_minValue.Match newMatch(final Object... parameters) {
    return CapabilityProperty_minValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty_minValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty_minValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty_minValue INSTANCE = new CapabilityProperty_minValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty_minValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
