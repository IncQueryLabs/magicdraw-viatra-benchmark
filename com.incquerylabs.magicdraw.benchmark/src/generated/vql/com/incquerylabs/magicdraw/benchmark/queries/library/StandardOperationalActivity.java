...
public final class StandardOperationalActivity extends BaseGeneratedEMFQuerySpecification<StandardOperationalActivity.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.StandardOperationalActivity pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.StandardOperationalActivity";
    }
    
    @Override
    public List<String> parameterNames() {
      return StandardOperationalActivity.Match.parameterNames;
    }
    ...
    @Override
    public StandardOperationalActivity.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StandardOperationalActivity.Match)) {
          StandardOperationalActivity.Match other = (StandardOperationalActivity.Match) obj;
    ...
    @Override
    public StandardOperationalActivity specification() {
      return StandardOperationalActivity.instance();
    }
     ...
     * 
     */
    public static StandardOperationalActivity.Match newEmptyMatch() {
     ...
     * 
     */
    public static StandardOperationalActivity.Match newMutableMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static StandardOperationalActivity.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends StandardOperationalActivity.Match {
    ...
    private static final class Immutable extends StandardOperationalActivity.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.StandardOperationalActivity pattern,
   ...
   * 
   * @see Match
   * @see StandardOperationalActivity
   * 
   */
  public static class Matcher extends BaseMatcher<StandardOperationalActivity.Match> {
    /**
     ...
     * 
     */
    public static StandardOperationalActivity.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StandardOperationalActivity.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StandardOperationalActivity.Matcher.class);
     ...
     * 
     */
    public Collection<StandardOperationalActivity.Match> getAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<StandardOperationalActivity.Match> streamAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<StandardOperationalActivity.Match> getOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super StandardOperationalActivity.Match> processor) {
     ...
     * 
     */
    public StandardOperationalActivity.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return StandardOperationalActivity.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final StandardOperationalActivity.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final StandardOperationalActivity.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final StandardOperationalActivity.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final StandardOperationalActivity.Match partialMatch) {
    ...
    @Override
    protected StandardOperationalActivity.Match tupleToMatch(final Tuple t) {
      try {
          return StandardOperationalActivity.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected StandardOperationalActivity.Match arrayToMatch(final Object[] match) {
      try {
          return StandardOperationalActivity.Match.newMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StandardOperationalActivity.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StandardOperationalActivity.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StandardOperationalActivity.Matcher> querySpecification() {
      return StandardOperationalActivity.instance();
    }
  }
  
  private StandardOperationalActivity() {
   ...
   * 
   */
  public static StandardOperationalActivity instance() {
    try{
  ...
  @Override
  protected StandardOperationalActivity.Matcher instantiate(final ViatraQueryEngine engine) {
    return StandardOperationalActivity.Matcher.on(engine);
  }
  
  @Override
  public StandardOperationalActivity.Matcher instantiate() {
    return StandardOperationalActivity.Matcher.create();
  }
  
  @Override
  public StandardOperationalActivity.Match newEmptyMatch() {
    return StandardOperationalActivity.Match.newEmptyMatch();
  }
  
  @Override
  public StandardOperationalActivity.Match newMatch(final Object... parameters) {
    return StandardOperationalActivity.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StandardOperationalActivity} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StandardOperationalActivity#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StandardOperationalActivity INSTANCE = new StandardOperationalActivity();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StandardOperationalActivity.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "StandardOperationalActivity")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "StandardOperationalActivity");
