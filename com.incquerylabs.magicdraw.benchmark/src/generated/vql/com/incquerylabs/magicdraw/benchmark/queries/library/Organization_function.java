...
public final class Organization_function extends BaseGeneratedEMFQuerySpecification<Organization_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Organization_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_function.Match.parameterNames;
    }
    ...
    @Override
    public Organization_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_function.Match)) {
          Organization_function.Match other = (Organization_function.Match) obj;
    ...
    @Override
    public Organization_function specification() {
      return Organization_function.instance();
    }
     ...
     * 
     */
    public static Organization_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_function.Match {
    ...
    private static final class Immutable extends Organization_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_function pattern,
   ...
   * 
   * @see Match
   * @see Organization_function
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_function.Match> {
    /**
     ...
     * 
     */
    public static Organization_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_function.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_function.Match> processor) {
     ...
     * 
     */
    public Organization_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_function.Match partialMatch) {
    ...
    @Override
    protected Organization_function.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_function.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_function.Matcher> querySpecification() {
      return Organization_function.instance();
    }
  }
  
  private Organization_function() {
   ...
   * 
   */
  public static Organization_function instance() {
    try{
  ...
  @Override
  protected Organization_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_function.Matcher.on(engine);
  }
  
  @Override
  public Organization_function.Matcher instantiate() {
    return Organization_function.Matcher.create();
  }
  
  @Override
  public Organization_function.Match newEmptyMatch() {
    return Organization_function.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_function.Match newMatch(final Object... parameters) {
    return Organization_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_function INSTANCE = new Organization_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
