...
public final class ProblemDomain_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ProblemDomain_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_endBoundaryType.Match)) {
          ProblemDomain_endBoundaryType.Match other = (ProblemDomain_endBoundaryType.Match) obj;
    ...
    @Override
    public ProblemDomain_endBoundaryType specification() {
      return ProblemDomain_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_endBoundaryType.Match {
    ...
    private static final class Immutable extends ProblemDomain_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_endBoundaryType.Matcher> querySpecification() {
      return ProblemDomain_endBoundaryType.instance();
    }
  }
  
  private ProblemDomain_endBoundaryType() {
   ...
   * 
   */
  public static ProblemDomain_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ProblemDomain_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_endBoundaryType.Matcher instantiate() {
    return ProblemDomain_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ProblemDomain_endBoundaryType.Match newEmptyMatch() {
    return ProblemDomain_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_endBoundaryType.Match newMatch(final Object... parameters) {
    return ProblemDomain_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_endBoundaryType INSTANCE = new ProblemDomain_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
