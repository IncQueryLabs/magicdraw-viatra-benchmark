...
public final class ResourceArtifact_URI extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_URI.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_URI.Match)) {
          ResourceArtifact_URI.Match other = (ResourceArtifact_URI.Match) obj;
    ...
    @Override
    public ResourceArtifact_URI specification() {
      return ResourceArtifact_URI.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ResourceArtifact_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourceArtifact_URI.Match {
    ...
    private static final class Immutable extends ResourceArtifact_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_URI pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_URI.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ResourceArtifact_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ResourceArtifact_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ResourceArtifact_URI.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ResourceArtifact_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ResourceArtifact_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ResourceArtifact_URI.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourceArtifact_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_URI.Matcher> querySpecification() {
      return ResourceArtifact_URI.instance();
    }
  }
  
  private ResourceArtifact_URI() {
   ...
   * 
   */
  public static ResourceArtifact_URI instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_URI.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_URI.Matcher instantiate() {
    return ResourceArtifact_URI.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_URI.Match newEmptyMatch() {
    return ResourceArtifact_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_URI.Match newMatch(final Object... parameters) {
    return ResourceArtifact_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_URI INSTANCE = new ResourceArtifact_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
