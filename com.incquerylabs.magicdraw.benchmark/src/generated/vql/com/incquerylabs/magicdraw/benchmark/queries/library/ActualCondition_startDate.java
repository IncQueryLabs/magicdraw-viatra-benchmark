...
public final class ActualCondition_startDate extends BaseGeneratedEMFQuerySpecification<ActualCondition_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualCondition_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualCondition_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualCondition_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualCondition_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualCondition_startDate.Match)) {
          ActualCondition_startDate.Match other = (ActualCondition_startDate.Match) obj;
    ...
    @Override
    public ActualCondition_startDate specification() {
      return ActualCondition_startDate.instance();
    }
     ...
     * 
     */
    public static ActualCondition_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualCondition_startDate.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public static ActualCondition_startDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualCondition_startDate.Match {
    ...
    private static final class Immutable extends ActualCondition_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualCondition_startDate pattern,
   ...
   * 
   * @see Match
   * @see ActualCondition_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualCondition_startDate.Match> {
    /**
     ...
     * 
     */
    public static ActualCondition_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualCondition_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualCondition_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualCondition_startDate.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Stream<ActualCondition_startDate.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Optional<ActualCondition_startDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue, final Consumer<? super ActualCondition_startDate.Match> processor) {
     ...
     * 
     */
    public ActualCondition_startDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return ActualCondition_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualCondition_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualCondition_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvalue(final ActualCondition_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvalue(final ActualCondition_startDate.Match partialMatch) {
    ...
    @Override
    protected ActualCondition_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualCondition_startDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualCondition_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualCondition_startDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualCondition_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualCondition_startDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualCondition_startDate.Matcher> querySpecification() {
      return ActualCondition_startDate.instance();
    }
  }
  
  private ActualCondition_startDate() {
   ...
   * 
   */
  public static ActualCondition_startDate instance() {
    try{
  ...
  @Override
  protected ActualCondition_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualCondition_startDate.Matcher.on(engine);
  }
  
  @Override
  public ActualCondition_startDate.Matcher instantiate() {
    return ActualCondition_startDate.Matcher.create();
  }
  
  @Override
  public ActualCondition_startDate.Match newEmptyMatch() {
    return ActualCondition_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualCondition_startDate.Match newMatch(final Object... parameters) {
    return ActualCondition_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualCondition_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualCondition_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualCondition_startDate INSTANCE = new ActualCondition_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualCondition_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
