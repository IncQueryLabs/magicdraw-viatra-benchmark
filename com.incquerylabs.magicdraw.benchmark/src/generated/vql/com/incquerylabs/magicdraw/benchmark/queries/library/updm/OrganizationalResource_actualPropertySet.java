...
public final class OrganizationalResource_actualPropertySet extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_actualPropertySet.Match)) {
          OrganizationalResource_actualPropertySet.Match other = (OrganizationalResource_actualPropertySet.Match) obj;
    ...
    @Override
    public OrganizationalResource_actualPropertySet specification() {
      return OrganizationalResource_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_actualPropertySet.Match {
    ...
    private static final class Immutable extends OrganizationalResource_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_actualPropertySet.Matcher> querySpecification() {
      return OrganizationalResource_actualPropertySet.instance();
    }
  }
  
  private OrganizationalResource_actualPropertySet() {
   ...
   * 
   */
  public static OrganizationalResource_actualPropertySet instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_actualPropertySet.Matcher instantiate() {
    return OrganizationalResource_actualPropertySet.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_actualPropertySet.Match newEmptyMatch() {
    return OrganizationalResource_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_actualPropertySet.Match newMatch(final Object... parameters) {
    return OrganizationalResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_actualPropertySet INSTANCE = new OrganizationalResource_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
