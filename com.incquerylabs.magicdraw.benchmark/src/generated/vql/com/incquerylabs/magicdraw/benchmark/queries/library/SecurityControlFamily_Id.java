...
public final class SecurityControlFamily_Id extends BaseGeneratedEMFQuerySpecification<SecurityControlFamily_Id.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControlFamily_Id.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControlFamily_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControlFamily_Id.Match)) {
          SecurityControlFamily_Id.Match other = (SecurityControlFamily_Id.Match) obj;
    ...
    @Override
    public SecurityControlFamily_Id specification() {
      return SecurityControlFamily_Id.instance();
    }
     ...
     * 
     */
    public static SecurityControlFamily_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControlFamily_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SecurityControlFamily_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityControlFamily_Id.Match {
    ...
    private static final class Immutable extends SecurityControlFamily_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Id pattern,
   ...
   * 
   * @see Match
   * @see SecurityControlFamily_Id
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControlFamily_Id.Match> {
    /**
     ...
     * 
     */
    public static SecurityControlFamily_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControlFamily_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControlFamily_Id.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControlFamily_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SecurityControlFamily_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SecurityControlFamily_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super SecurityControlFamily_Id.Match> processor) {
     ...
     * 
     */
    public SecurityControlFamily_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return SecurityControlFamily_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControlFamily_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControlFamily_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SecurityControlFamily_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SecurityControlFamily_Id.Match partialMatch) {
    ...
    @Override
    protected SecurityControlFamily_Id.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControlFamily_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityControlFamily_Id.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControlFamily_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControlFamily_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControlFamily_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControlFamily_Id.Matcher> querySpecification() {
      return SecurityControlFamily_Id.instance();
    }
  }
  
  private SecurityControlFamily_Id() {
   ...
   * 
   */
  public static SecurityControlFamily_Id instance() {
    try{
  ...
  @Override
  protected SecurityControlFamily_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControlFamily_Id.Matcher.on(engine);
  }
  
  @Override
  public SecurityControlFamily_Id.Matcher instantiate() {
    return SecurityControlFamily_Id.Matcher.create();
  }
  
  @Override
  public SecurityControlFamily_Id.Match newEmptyMatch() {
    return SecurityControlFamily_Id.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControlFamily_Id.Match newMatch(final Object... parameters) {
    return SecurityControlFamily_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControlFamily_Id} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControlFamily_Id#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControlFamily_Id INSTANCE = new SecurityControlFamily_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControlFamily_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
