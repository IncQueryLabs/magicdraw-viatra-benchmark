...
public final class CapabilityConfiguration_milestone extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_milestone.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_milestone.Match)) {
          CapabilityConfiguration_milestone.Match other = (CapabilityConfiguration_milestone.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_milestone specification() {
      return CapabilityConfiguration_milestone.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_milestone.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_milestone pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_milestone.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_milestone.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_milestone.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_milestone.Matcher> querySpecification() {
      return CapabilityConfiguration_milestone.instance();
    }
  }
  
  private CapabilityConfiguration_milestone() {
   ...
   * 
   */
  public static CapabilityConfiguration_milestone instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_milestone.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_milestone.Matcher instantiate() {
    return CapabilityConfiguration_milestone.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_milestone.Match newEmptyMatch() {
    return CapabilityConfiguration_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_milestone.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_milestone INSTANCE = new CapabilityConfiguration_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
