...
public final class ProjectStatus_endDate extends BaseGeneratedEMFQuerySpecification<ProjectStatus_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectStatus_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ProjectStatus_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectStatus_endDate.Match)) {
          ProjectStatus_endDate.Match other = (ProjectStatus_endDate.Match) obj;
    ...
    @Override
    public ProjectStatus_endDate specification() {
      return ProjectStatus_endDate.instance();
    }
     ...
     * 
     */
    public static ProjectStatus_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectStatus_endDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectStatus_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectStatus_endDate.Match {
    ...
    private static final class Immutable extends ProjectStatus_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus_endDate pattern,
   ...
   * 
   * @see Match
   * @see ProjectStatus_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectStatus_endDate.Match> {
    /**
     ...
     * 
     */
    public static ProjectStatus_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectStatus_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectStatus_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectStatus_endDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectStatus_endDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectStatus_endDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ProjectStatus_endDate.Match> processor) {
     ...
     * 
     */
    public ProjectStatus_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ProjectStatus_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ProjectStatus_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ProjectStatus_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectStatus_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectStatus_endDate.Match partialMatch) {
    ...
    @Override
    protected ProjectStatus_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectStatus_endDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectStatus_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectStatus_endDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectStatus_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectStatus_endDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectStatus_endDate.Matcher> querySpecification() {
      return ProjectStatus_endDate.instance();
    }
  }
  
  private ProjectStatus_endDate() {
   ...
   * 
   */
  public static ProjectStatus_endDate instance() {
    try{
  ...
  @Override
  protected ProjectStatus_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectStatus_endDate.Matcher.on(engine);
  }
  
  @Override
  public ProjectStatus_endDate.Matcher instantiate() {
    return ProjectStatus_endDate.Matcher.create();
  }
  
  @Override
  public ProjectStatus_endDate.Match newEmptyMatch() {
    return ProjectStatus_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectStatus_endDate.Match newMatch(final Object... parameters) {
    return ProjectStatus_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectStatus_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectStatus_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectStatus_endDate INSTANCE = new ProjectStatus_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectStatus_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
