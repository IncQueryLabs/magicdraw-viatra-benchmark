...
public final class ResourceArchitecture_physicalLocation extends BaseGeneratedEMFQuerySpecification<ResourceArchitecture_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArchitecture_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArchitecture_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArchitecture_physicalLocation.Match)) {
          ResourceArchitecture_physicalLocation.Match other = (ResourceArchitecture_physicalLocation.Match) obj;
    ...
    @Override
    public ResourceArchitecture_physicalLocation specification() {
      return ResourceArchitecture_physicalLocation.instance();
    }
     ...
     * 
     */
    public static ResourceArchitecture_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArchitecture_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArchitecture_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArchitecture_physicalLocation.Match {
    ...
    private static final class Immutable extends ResourceArchitecture_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see ResourceArchitecture_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArchitecture_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static ResourceArchitecture_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArchitecture_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArchitecture_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArchitecture_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArchitecture_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArchitecture_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArchitecture_physicalLocation.Match> processor) {
     ...
     * 
     */
    public ResourceArchitecture_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArchitecture_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArchitecture_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArchitecture_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected ResourceArchitecture_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArchitecture_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArchitecture_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArchitecture_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArchitecture_physicalLocation.Matcher> querySpecification() {
      return ResourceArchitecture_physicalLocation.instance();
    }
  }
  
  private ResourceArchitecture_physicalLocation() {
   ...
   * 
   */
  public static ResourceArchitecture_physicalLocation instance() {
    try{
  ...
  @Override
  protected ResourceArchitecture_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArchitecture_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public ResourceArchitecture_physicalLocation.Matcher instantiate() {
    return ResourceArchitecture_physicalLocation.Matcher.create();
  }
  
  @Override
  public ResourceArchitecture_physicalLocation.Match newEmptyMatch() {
    return ResourceArchitecture_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArchitecture_physicalLocation.Match newMatch(final Object... parameters) {
    return ResourceArchitecture_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArchitecture_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArchitecture_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArchitecture_physicalLocation INSTANCE = new ResourceArchitecture_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArchitecture_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
