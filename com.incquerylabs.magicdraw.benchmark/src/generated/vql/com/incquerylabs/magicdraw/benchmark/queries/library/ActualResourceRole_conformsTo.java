...
public final class ActualResourceRole_conformsTo extends BaseGeneratedEMFQuerySpecification<ActualResourceRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualResourceRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ActualResourceRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualResourceRole_conformsTo.Match)) {
          ActualResourceRole_conformsTo.Match other = (ActualResourceRole_conformsTo.Match) obj;
    ...
    @Override
    public ActualResourceRole_conformsTo specification() {
      return ActualResourceRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static ActualResourceRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualResourceRole_conformsTo.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualResourceRole_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualResourceRole_conformsTo.Match {
    ...
    private static final class Immutable extends ActualResourceRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ActualResourceRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ActualResourceRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ActualResourceRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualResourceRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualResourceRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ActualResourceRole_conformsTo.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualResourceRole_conformsTo.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualResourceRole_conformsTo.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualResourceRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public ActualResourceRole_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualResourceRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualResourceRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualResourceRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualResourceRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualResourceRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ActualResourceRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ActualResourceRole_conformsTo.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualResourceRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ActualResourceRole_conformsTo.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualResourceRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualResourceRole_conformsTo.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualResourceRole_conformsTo.Matcher> querySpecification() {
      return ActualResourceRole_conformsTo.instance();
    }
  }
  
  private ActualResourceRole_conformsTo() {
   ...
   * 
   */
  public static ActualResourceRole_conformsTo instance() {
    try{
  ...
  @Override
  protected ActualResourceRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualResourceRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ActualResourceRole_conformsTo.Matcher instantiate() {
    return ActualResourceRole_conformsTo.Matcher.create();
  }
  
  @Override
  public ActualResourceRole_conformsTo.Match newEmptyMatch() {
    return ActualResourceRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ActualResourceRole_conformsTo.Match newMatch(final Object... parameters) {
    return ActualResourceRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualResourceRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualResourceRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualResourceRole_conformsTo INSTANCE = new ActualResourceRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualResourceRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
