...
public final class System_affectedFunctions extends BaseGeneratedEMFQuerySpecification<System_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public System_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_affectedFunctions.Match)) {
          System_affectedFunctions.Match other = (System_affectedFunctions.Match) obj;
    ...
    @Override
    public System_affectedFunctions specification() {
      return System_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static System_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_affectedFunctions.Match {
    ...
    private static final class Immutable extends System_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see System_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<System_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static System_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<System_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public System_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected System_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return System_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return System_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_affectedFunctions.Matcher> querySpecification() {
      return System_affectedFunctions.instance();
    }
  }
  
  private System_affectedFunctions() {
   ...
   * 
   */
  public static System_affectedFunctions instance() {
    try{
  ...
  @Override
  protected System_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public System_affectedFunctions.Matcher instantiate() {
    return System_affectedFunctions.Matcher.create();
  }
  
  @Override
  public System_affectedFunctions.Match newEmptyMatch() {
    return System_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public System_affectedFunctions.Match newMatch(final Object... parameters) {
    return System_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_affectedFunctions INSTANCE = new System_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
