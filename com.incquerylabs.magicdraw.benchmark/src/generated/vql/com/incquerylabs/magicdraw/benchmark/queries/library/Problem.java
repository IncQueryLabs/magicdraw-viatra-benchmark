...
public final class Problem extends BaseGeneratedEMFQuerySpecification<Problem.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Problem pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Problem";
    }
     ...
     * 
     */
    public static Problem.Match newMutableMatch(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Problem.Match newMatch(final Comment pElement, final Stereotype pStereotype) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Problem pattern,
  ...
  public static class Matcher extends BaseMatcher<Problem.Match> {
     ...
     * 
     */
    public Collection<Problem.Match> getAllMatches(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Problem.Match> streamAllMatches(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Problem.Match> getOneArbitraryMatch(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final Stereotype pStereotype, final Consumer<? super Problem.Match> processor) {
     ...
     * 
     */
    public Problem.Match newMatch(final Comment pElement, final Stereotype pStereotype) {
      return Problem.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Problem.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Problem.Match partialMatch) {
    ...
    protected Problem.Match tupleToMatch(final Tuple t) {
      try {
          return Problem.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected Problem.Match arrayToMatch(final Object[] match) {
      try {
          return Problem.Match.newMatch((Comment) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected Problem.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Problem.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Problem.Match newMatch(final Object... parameters) {
    return Problem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Problem} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Problem#instance()}.
   * 
