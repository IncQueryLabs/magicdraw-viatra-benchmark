...
public final class System_desribedBy extends BaseGeneratedEMFQuerySpecification<System_desribedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.System_desribedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.System_desribedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_desribedBy.Match.parameterNames;
    }
    ...
    @Override
    public System_desribedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_desribedBy.Match)) {
          System_desribedBy.Match other = (System_desribedBy.Match) obj;
    ...
    @Override
    public System_desribedBy specification() {
      return System_desribedBy.instance();
    }
     ...
     * 
     */
    public static System_desribedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_desribedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_desribedBy.Match {
    ...
    private static final class Immutable extends System_desribedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.System_desribedBy pattern,
   ...
   * 
   * @see Match
   * @see System_desribedBy
   * 
   */
  public static class Matcher extends BaseMatcher<System_desribedBy.Match> {
    /**
     ...
     * 
     */
    public static System_desribedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_desribedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_desribedBy.Matcher.class);
     ...
     * 
     */
    public Collection<System_desribedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_desribedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_desribedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_desribedBy.Match> processor) {
     ...
     * 
     */
    public System_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_desribedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_desribedBy.Match partialMatch) {
    ...
    @Override
    protected System_desribedBy.Match tupleToMatch(final Tuple t) {
      try {
          return System_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_desribedBy.Match arrayToMatch(final Object[] match) {
      try {
          return System_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_desribedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_desribedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_desribedBy.Matcher> querySpecification() {
      return System_desribedBy.instance();
    }
  }
  
  private System_desribedBy() {
   ...
   * 
   */
  public static System_desribedBy instance() {
    try{
  ...
  @Override
  protected System_desribedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_desribedBy.Matcher.on(engine);
  }
  
  @Override
  public System_desribedBy.Matcher instantiate() {
    return System_desribedBy.Matcher.create();
  }
  
  @Override
  public System_desribedBy.Match newEmptyMatch() {
    return System_desribedBy.Match.newEmptyMatch();
  }
  
  @Override
  public System_desribedBy.Match newMatch(final Object... parameters) {
    return System_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_desribedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_desribedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_desribedBy INSTANCE = new System_desribedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_desribedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
