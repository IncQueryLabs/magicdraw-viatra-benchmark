...
public final class OrganizationalResource_affectedFunctions extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_affectedFunctions.Match)) {
          OrganizationalResource_affectedFunctions.Match other = (OrganizationalResource_affectedFunctions.Match) obj;
    ...
    @Override
    public OrganizationalResource_affectedFunctions specification() {
      return OrganizationalResource_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_affectedFunctions.Match {
    ...
    private static final class Immutable extends OrganizationalResource_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_affectedFunctions.Matcher> querySpecification() {
      return OrganizationalResource_affectedFunctions.instance();
    }
  }
  
  private OrganizationalResource_affectedFunctions() {
   ...
   * 
   */
  public static OrganizationalResource_affectedFunctions instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_affectedFunctions.Matcher instantiate() {
    return OrganizationalResource_affectedFunctions.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_affectedFunctions.Match newEmptyMatch() {
    return OrganizationalResource_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_affectedFunctions.Match newMatch(final Object... parameters) {
    return OrganizationalResource_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_affectedFunctions INSTANCE = new OrganizationalResource_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
