...
public final class OperationalArchitecture_desribedBy extends BaseGeneratedEMFQuerySpecification<OperationalArchitecture_desribedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_desribedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_desribedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalArchitecture_desribedBy.Match.parameterNames;
    }
    ...
    @Override
    public OperationalArchitecture_desribedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalArchitecture_desribedBy.Match)) {
          OperationalArchitecture_desribedBy.Match other = (OperationalArchitecture_desribedBy.Match) obj;
    ...
    @Override
    public OperationalArchitecture_desribedBy specification() {
      return OperationalArchitecture_desribedBy.instance();
    }
     ...
     * 
     */
    public static OperationalArchitecture_desribedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalArchitecture_desribedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalArchitecture_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalArchitecture_desribedBy.Match {
    ...
    private static final class Immutable extends OperationalArchitecture_desribedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_desribedBy pattern,
   ...
   * 
   * @see Match
   * @see OperationalArchitecture_desribedBy
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalArchitecture_desribedBy.Match> {
    /**
     ...
     * 
     */
    public static OperationalArchitecture_desribedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalArchitecture_desribedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalArchitecture_desribedBy.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalArchitecture_desribedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalArchitecture_desribedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalArchitecture_desribedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalArchitecture_desribedBy.Match> processor) {
     ...
     * 
     */
    public OperationalArchitecture_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalArchitecture_desribedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalArchitecture_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalArchitecture_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalArchitecture_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalArchitecture_desribedBy.Match partialMatch) {
    ...
    @Override
    protected OperationalArchitecture_desribedBy.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalArchitecture_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalArchitecture_desribedBy.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalArchitecture_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalArchitecture_desribedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalArchitecture_desribedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalArchitecture_desribedBy.Matcher> querySpecification() {
      return OperationalArchitecture_desribedBy.instance();
    }
  }
  
  private OperationalArchitecture_desribedBy() {
   ...
   * 
   */
  public static OperationalArchitecture_desribedBy instance() {
    try{
  ...
  @Override
  protected OperationalArchitecture_desribedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalArchitecture_desribedBy.Matcher.on(engine);
  }
  
  @Override
  public OperationalArchitecture_desribedBy.Matcher instantiate() {
    return OperationalArchitecture_desribedBy.Matcher.create();
  }
  
  @Override
  public OperationalArchitecture_desribedBy.Match newEmptyMatch() {
    return OperationalArchitecture_desribedBy.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalArchitecture_desribedBy.Match newMatch(final Object... parameters) {
    return OperationalArchitecture_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalArchitecture_desribedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalArchitecture_desribedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalArchitecture_desribedBy INSTANCE = new OperationalArchitecture_desribedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalArchitecture_desribedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
