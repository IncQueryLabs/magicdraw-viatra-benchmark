...
public final class SecurityDomain_appliesTo extends BaseGeneratedEMFQuerySpecification<SecurityDomain_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_appliesTo.Match)) {
          SecurityDomain_appliesTo.Match other = (SecurityDomain_appliesTo.Match) obj;
    ...
    @Override
    public SecurityDomain_appliesTo specification() {
      return SecurityDomain_appliesTo.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityDomain_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_appliesTo.Match {
    ...
    private static final class Immutable extends SecurityDomain_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityDomain_appliesTo.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityDomain_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityDomain_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityDomain_appliesTo.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_appliesTo.Matcher> querySpecification() {
      return SecurityDomain_appliesTo.instance();
    }
  }
  
  private SecurityDomain_appliesTo() {
   ...
   * 
   */
  public static SecurityDomain_appliesTo instance() {
    try{
  ...
  @Override
  protected SecurityDomain_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_appliesTo.Matcher instantiate() {
    return SecurityDomain_appliesTo.Matcher.create();
  }
  
  @Override
  public SecurityDomain_appliesTo.Match newEmptyMatch() {
    return SecurityDomain_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_appliesTo.Match newMatch(final Object... parameters) {
    return SecurityDomain_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_appliesTo INSTANCE = new SecurityDomain_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
