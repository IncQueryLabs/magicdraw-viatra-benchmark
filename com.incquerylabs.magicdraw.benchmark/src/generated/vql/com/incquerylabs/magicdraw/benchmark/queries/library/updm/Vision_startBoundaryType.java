...
public final class Vision_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Vision_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Vision_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Vision_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Vision_startBoundaryType.Match)) {
          Vision_startBoundaryType.Match other = (Vision_startBoundaryType.Match) obj;
    ...
    @Override
    public Vision_startBoundaryType specification() {
      return Vision_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Vision_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Vision_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Vision_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Vision_startBoundaryType.Match {
    ...
    private static final class Immutable extends Vision_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Vision_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Vision_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Vision_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Vision_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Vision_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Vision_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Vision_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Vision_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Vision_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Vision_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Vision_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Vision_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Vision_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Vision_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Vision_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Vision_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Vision_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Vision_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Vision_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Vision_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Vision_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Vision_startBoundaryType.Matcher> querySpecification() {
      return Vision_startBoundaryType.instance();
    }
  }
  
  private Vision_startBoundaryType() {
   ...
   * 
   */
  public static Vision_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Vision_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Vision_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Vision_startBoundaryType.Matcher instantiate() {
    return Vision_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Vision_startBoundaryType.Match newEmptyMatch() {
    return Vision_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Vision_startBoundaryType.Match newMatch(final Object... parameters) {
    return Vision_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Vision_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Vision_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Vision_startBoundaryType INSTANCE = new Vision_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Vision_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
