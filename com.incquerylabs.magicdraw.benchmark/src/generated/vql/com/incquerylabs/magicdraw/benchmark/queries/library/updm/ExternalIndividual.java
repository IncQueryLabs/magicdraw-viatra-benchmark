...
public final class ExternalIndividual extends BaseGeneratedEMFQuerySpecification<ExternalIndividual.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalIndividual pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalIndividual";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalIndividual.Match.parameterNames;
    }
    ...
    @Override
    public ExternalIndividual.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalIndividual.Match)) {
          ExternalIndividual.Match other = (ExternalIndividual.Match) obj;
    ...
    @Override
    public ExternalIndividual specification() {
      return ExternalIndividual.instance();
    }
     ...
     * 
     */
    public static ExternalIndividual.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalIndividual.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ExternalIndividual.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ExternalIndividual.Match {
    ...
    private static final class Immutable extends ExternalIndividual.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalIndividual pattern,
   ...
   * 
   * @see Match
   * @see ExternalIndividual
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalIndividual.Match> {
    /**
     ...
     * 
     */
    public static ExternalIndividual.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalIndividual.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalIndividual.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalIndividual.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ExternalIndividual.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ExternalIndividual.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ExternalIndividual.Match> processor) {
     ...
     * 
     */
    public ExternalIndividual.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ExternalIndividual.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ExternalIndividual.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ExternalIndividual.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ExternalIndividual.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ExternalIndividual.Match partialMatch) {
    ...
    @Override
    protected ExternalIndividual.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalIndividual.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ExternalIndividual.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalIndividual.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalIndividual.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalIndividual.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalIndividual.Matcher> querySpecification() {
      return ExternalIndividual.instance();
    }
  }
  
  private ExternalIndividual() {
   ...
   * 
   */
  public static ExternalIndividual instance() {
    try{
  ...
  @Override
  protected ExternalIndividual.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalIndividual.Matcher.on(engine);
  }
  
  @Override
  public ExternalIndividual.Matcher instantiate() {
    return ExternalIndividual.Matcher.create();
  }
  
  @Override
  public ExternalIndividual.Match newEmptyMatch() {
    return ExternalIndividual.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalIndividual.Match newMatch(final Object... parameters) {
    return ExternalIndividual.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalIndividual} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalIndividual#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalIndividual INSTANCE = new ExternalIndividual();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalIndividual.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ExternalIndividual");
