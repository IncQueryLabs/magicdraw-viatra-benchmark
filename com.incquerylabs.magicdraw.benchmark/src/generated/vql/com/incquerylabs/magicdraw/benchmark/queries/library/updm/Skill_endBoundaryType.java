...
public final class Skill_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Skill_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Skill_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Skill_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Skill_endBoundaryType.Match)) {
          Skill_endBoundaryType.Match other = (Skill_endBoundaryType.Match) obj;
    ...
    @Override
    public Skill_endBoundaryType specification() {
      return Skill_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Skill_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Skill_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Skill_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Skill_endBoundaryType.Match {
    ...
    private static final class Immutable extends Skill_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Skill_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Skill_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Skill_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Skill_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Skill_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Skill_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Skill_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Skill_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Skill_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Skill_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Skill_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Skill_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Skill_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Skill_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Skill_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Skill_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Skill_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Skill_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Skill_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Skill_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Skill_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Skill_endBoundaryType.Matcher> querySpecification() {
      return Skill_endBoundaryType.instance();
    }
  }
  
  private Skill_endBoundaryType() {
   ...
   * 
   */
  public static Skill_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Skill_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Skill_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Skill_endBoundaryType.Matcher instantiate() {
    return Skill_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Skill_endBoundaryType.Match newEmptyMatch() {
    return Skill_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Skill_endBoundaryType.Match newMatch(final Object... parameters) {
    return Skill_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Skill_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Skill_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Skill_endBoundaryType INSTANCE = new Skill_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Skill_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
