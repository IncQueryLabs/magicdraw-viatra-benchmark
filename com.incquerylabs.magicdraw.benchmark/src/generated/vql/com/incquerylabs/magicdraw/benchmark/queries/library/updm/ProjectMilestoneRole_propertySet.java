...
public final class ProjectMilestoneRole_propertySet extends BaseGeneratedEMFQuerySpecification<ProjectMilestoneRole_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestoneRole_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestoneRole_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestoneRole_propertySet.Match)) {
          ProjectMilestoneRole_propertySet.Match other = (ProjectMilestoneRole_propertySet.Match) obj;
    ...
    @Override
    public ProjectMilestoneRole_propertySet specification() {
      return ProjectMilestoneRole_propertySet.instance();
    }
     ...
     * 
     */
    public static ProjectMilestoneRole_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestoneRole_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestoneRole_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestoneRole_propertySet.Match {
    ...
    private static final class Immutable extends ProjectMilestoneRole_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestoneRole_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestoneRole_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestoneRole_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestoneRole_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestoneRole_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestoneRole_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestoneRole_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestoneRole_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectMilestoneRole_propertySet.Match> processor) {
     ...
     * 
     */
    public ProjectMilestoneRole_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectMilestoneRole_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectMilestoneRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectMilestoneRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestoneRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestoneRole_propertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestoneRole_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestoneRole_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestoneRole_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestoneRole_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestoneRole_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestoneRole_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestoneRole_propertySet.Matcher> querySpecification() {
      return ProjectMilestoneRole_propertySet.instance();
    }
  }
  
  private ProjectMilestoneRole_propertySet() {
   ...
   * 
   */
  public static ProjectMilestoneRole_propertySet instance() {
    try{
  ...
  @Override
  protected ProjectMilestoneRole_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestoneRole_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestoneRole_propertySet.Matcher instantiate() {
    return ProjectMilestoneRole_propertySet.Matcher.create();
  }
  
  @Override
  public ProjectMilestoneRole_propertySet.Match newEmptyMatch() {
    return ProjectMilestoneRole_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestoneRole_propertySet.Match newMatch(final Object... parameters) {
    return ProjectMilestoneRole_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestoneRole_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestoneRole_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestoneRole_propertySet INSTANCE = new ProjectMilestoneRole_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestoneRole_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
