...
public final class OperationalAgent_URI extends BaseGeneratedEMFQuerySpecification<OperationalAgent_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalAgent_URI.Match.parameterNames;
    }
    ...
    @Override
    public OperationalAgent_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalAgent_URI.Match)) {
          OperationalAgent_URI.Match other = (OperationalAgent_URI.Match) obj;
    ...
    @Override
    public OperationalAgent_URI specification() {
      return OperationalAgent_URI.instance();
    }
     ...
     * 
     */
    public static OperationalAgent_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalAgent_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static OperationalAgent_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalAgent_URI.Match {
    ...
    private static final class Immutable extends OperationalAgent_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_URI pattern,
   ...
   * 
   * @see Match
   * @see OperationalAgent_URI
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalAgent_URI.Match> {
    /**
     ...
     * 
     */
    public static OperationalAgent_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalAgent_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalAgent_URI.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalAgent_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<OperationalAgent_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<OperationalAgent_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super OperationalAgent_URI.Match> processor) {
     ...
     * 
     */
    public OperationalAgent_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return OperationalAgent_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalAgent_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalAgent_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final OperationalAgent_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final OperationalAgent_URI.Match partialMatch) {
    ...
    @Override
    protected OperationalAgent_URI.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalAgent_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalAgent_URI.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalAgent_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalAgent_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalAgent_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalAgent_URI.Matcher> querySpecification() {
      return OperationalAgent_URI.instance();
    }
  }
  
  private OperationalAgent_URI() {
   ...
   * 
   */
  public static OperationalAgent_URI instance() {
    try{
  ...
  @Override
  protected OperationalAgent_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalAgent_URI.Matcher.on(engine);
  }
  
  @Override
  public OperationalAgent_URI.Matcher instantiate() {
    return OperationalAgent_URI.Matcher.create();
  }
  
  @Override
  public OperationalAgent_URI.Match newEmptyMatch() {
    return OperationalAgent_URI.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalAgent_URI.Match newMatch(final Object... parameters) {
    return OperationalAgent_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalAgent_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalAgent_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalAgent_URI INSTANCE = new OperationalAgent_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalAgent_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
