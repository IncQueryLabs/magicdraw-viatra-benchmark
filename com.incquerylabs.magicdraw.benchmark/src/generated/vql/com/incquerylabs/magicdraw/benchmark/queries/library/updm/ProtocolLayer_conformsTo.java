...
public final class ProtocolLayer_conformsTo extends BaseGeneratedEMFQuerySpecification<ProtocolLayer_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolLayer_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolLayer_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolLayer_conformsTo.Match)) {
          ProtocolLayer_conformsTo.Match other = (ProtocolLayer_conformsTo.Match) obj;
    ...
    @Override
    public ProtocolLayer_conformsTo specification() {
      return ProtocolLayer_conformsTo.instance();
    }
     ...
     * 
     */
    public static ProtocolLayer_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolLayer_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolLayer_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolLayer_conformsTo.Match {
    ...
    private static final class Immutable extends ProtocolLayer_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ProtocolLayer_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolLayer_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ProtocolLayer_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolLayer_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolLayer_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolLayer_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolLayer_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolLayer_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProtocolLayer_conformsTo.Match> processor) {
     ...
     * 
     */
    public ProtocolLayer_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ProtocolLayer_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProtocolLayer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProtocolLayer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolLayer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolLayer_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ProtocolLayer_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolLayer_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolLayer_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolLayer_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolLayer_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolLayer_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolLayer_conformsTo.Matcher> querySpecification() {
      return ProtocolLayer_conformsTo.instance();
    }
  }
  
  private ProtocolLayer_conformsTo() {
   ...
   * 
   */
  public static ProtocolLayer_conformsTo instance() {
    try{
  ...
  @Override
  protected ProtocolLayer_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolLayer_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ProtocolLayer_conformsTo.Matcher instantiate() {
    return ProtocolLayer_conformsTo.Matcher.create();
  }
  
  @Override
  public ProtocolLayer_conformsTo.Match newEmptyMatch() {
    return ProtocolLayer_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolLayer_conformsTo.Match newMatch(final Object... parameters) {
    return ProtocolLayer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolLayer_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolLayer_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolLayer_conformsTo INSTANCE = new ProtocolLayer_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolLayer_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
