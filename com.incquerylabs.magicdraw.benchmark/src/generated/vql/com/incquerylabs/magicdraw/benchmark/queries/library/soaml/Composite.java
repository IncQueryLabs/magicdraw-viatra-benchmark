...
public final class Composite extends BaseGeneratedEMFQuerySpecification<Composite.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Composite pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Composite";
    }
    
    @Override
    public List<String> parameterNames() {
      return Composite.Match.parameterNames;
    }
    ...
    @Override
    public Composite.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Composite.Match)) {
          Composite.Match other = (Composite.Match) obj;
    ...
    @Override
    public Composite specification() {
     ...
     * 
     */
    public static Composite.Match newEmptyMatch() {
     ...
     * 
     */
    public static Composite.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Composite.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Composite.Match {
    ...
    private static final class Immutable extends Composite.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Composite pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Composite.Match> {
    /**
     ...
     * 
     */
    public static Composite.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Composite.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Composite.Matcher.class);
     ...
     * 
     */
    public Collection<Composite.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Composite.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Composite.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Composite.Match> processor) {
     ...
     * 
     */
    public Composite.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Composite.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Composite.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Composite.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Composite.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Composite.Match partialMatch) {
    ...
    @Override
    protected Composite.Match tupleToMatch(final Tuple t) {
      try {
          return Composite.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Composite.Match arrayToMatch(final Object[] match) {
      try {
          return Composite.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Composite.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Composite.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Composite.Matcher> querySpecification() {
      return Composite.instance();
    }
  }
   ...
   * 
   */
  public static Composite instance() {
    try{
  ...
  @Override
  protected Composite.Matcher instantiate(final ViatraQueryEngine engine) {
    return Composite.Matcher.on(engine);
  }
  
  @Override
  public Composite.Matcher instantiate() {
    return Composite.Matcher.create();
  }
  
  @Override
  public Composite.Match newEmptyMatch() {
    return Composite.Match.newEmptyMatch();
  }
  
  @Override
  public Composite.Match newMatch(final Object... parameters) {
    return Composite.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Composite} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Composite#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Composite INSTANCE = new Composite();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Composite.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Composite");
