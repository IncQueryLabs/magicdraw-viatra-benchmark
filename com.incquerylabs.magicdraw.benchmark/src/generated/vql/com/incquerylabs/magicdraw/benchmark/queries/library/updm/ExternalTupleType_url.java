...
public final class ExternalTupleType_url extends BaseGeneratedEMFQuerySpecification<ExternalTupleType_url.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_url pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_url";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTupleType_url.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTupleType_url.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTupleType_url.Match)) {
          ExternalTupleType_url.Match other = (ExternalTupleType_url.Match) obj;
    ...
    @Override
    public ExternalTupleType_url specification() {
      return ExternalTupleType_url.instance();
    }
     ...
     * 
     */
    public static ExternalTupleType_url.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTupleType_url.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ExternalTupleType_url.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ExternalTupleType_url.Match {
    ...
    private static final class Immutable extends ExternalTupleType_url.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_url pattern,
   ...
   * 
   * @see Match
   * @see ExternalTupleType_url
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTupleType_url.Match> {
    /**
     ...
     * 
     */
    public static ExternalTupleType_url.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTupleType_url.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTupleType_url.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTupleType_url.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ExternalTupleType_url.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ExternalTupleType_url.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ExternalTupleType_url.Match> processor) {
     ...
     * 
     */
    public ExternalTupleType_url.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ExternalTupleType_url.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTupleType_url.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTupleType_url.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ExternalTupleType_url.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ExternalTupleType_url.Match partialMatch) {
    ...
    @Override
    protected ExternalTupleType_url.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTupleType_url.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ExternalTupleType_url.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTupleType_url.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTupleType_url.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTupleType_url.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTupleType_url.Matcher> querySpecification() {
      return ExternalTupleType_url.instance();
    }
  }
  
  private ExternalTupleType_url() {
   ...
   * 
   */
  public static ExternalTupleType_url instance() {
    try{
  ...
  @Override
  protected ExternalTupleType_url.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTupleType_url.Matcher.on(engine);
  }
  
  @Override
  public ExternalTupleType_url.Matcher instantiate() {
    return ExternalTupleType_url.Matcher.create();
  }
  
  @Override
  public ExternalTupleType_url.Match newEmptyMatch() {
    return ExternalTupleType_url.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTupleType_url.Match newMatch(final Object... parameters) {
    return ExternalTupleType_url.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTupleType_url} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTupleType_url#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTupleType_url INSTANCE = new ExternalTupleType_url();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTupleType_url.GeneratedPQuery INSTANCE = new GeneratedPQuery();
