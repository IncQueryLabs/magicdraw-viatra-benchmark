...
public final class EntityItem_propertySet extends BaseGeneratedEMFQuerySpecification<EntityItem_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityItem_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public EntityItem_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityItem_propertySet.Match)) {
          EntityItem_propertySet.Match other = (EntityItem_propertySet.Match) obj;
    ...
    @Override
    public EntityItem_propertySet specification() {
      return EntityItem_propertySet.instance();
    }
     ...
     * 
     */
    public static EntityItem_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityItem_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityItem_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityItem_propertySet.Match {
    ...
    private static final class Immutable extends EntityItem_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_propertySet pattern,
   ...
   * 
   * @see Match
   * @see EntityItem_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EntityItem_propertySet.Match> {
    /**
     ...
     * 
     */
    public static EntityItem_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityItem_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityItem_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EntityItem_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityItem_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityItem_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EntityItem_propertySet.Match> processor) {
     ...
     * 
     */
    public EntityItem_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EntityItem_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EntityItem_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EntityItem_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityItem_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityItem_propertySet.Match partialMatch) {
    ...
    @Override
    protected EntityItem_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EntityItem_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityItem_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EntityItem_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityItem_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityItem_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityItem_propertySet.Matcher> querySpecification() {
      return EntityItem_propertySet.instance();
    }
  }
  
  private EntityItem_propertySet() {
   ...
   * 
   */
  public static EntityItem_propertySet instance() {
    try{
  ...
  @Override
  protected EntityItem_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityItem_propertySet.Matcher.on(engine);
  }
  
  @Override
  public EntityItem_propertySet.Matcher instantiate() {
    return EntityItem_propertySet.Matcher.create();
  }
  
  @Override
  public EntityItem_propertySet.Match newEmptyMatch() {
    return EntityItem_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EntityItem_propertySet.Match newMatch(final Object... parameters) {
    return EntityItem_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityItem_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityItem_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityItem_propertySet INSTANCE = new EntityItem_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityItem_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
