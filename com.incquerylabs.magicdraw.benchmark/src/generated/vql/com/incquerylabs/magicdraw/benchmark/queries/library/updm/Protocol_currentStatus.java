...
public final class Protocol_currentStatus extends BaseGeneratedEMFQuerySpecification<Protocol_currentStatus.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_currentStatus pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_currentStatus";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_currentStatus.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_currentStatus.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_currentStatus.Match)) {
          Protocol_currentStatus.Match other = (Protocol_currentStatus.Match) obj;
    ...
    @Override
    public Protocol_currentStatus specification() {
      return Protocol_currentStatus.instance();
    }
     ...
     * 
     */
    public static Protocol_currentStatus.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_currentStatus.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Protocol_currentStatus.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Protocol_currentStatus.Match {
    ...
    private static final class Immutable extends Protocol_currentStatus.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_currentStatus pattern,
   ...
   * 
   * @see Match
   * @see Protocol_currentStatus
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_currentStatus.Match> {
    /**
     ...
     * 
     */
    public static Protocol_currentStatus.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_currentStatus.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_currentStatus.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_currentStatus.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Protocol_currentStatus.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Protocol_currentStatus.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Protocol_currentStatus.Match> processor) {
     ...
     * 
     */
    public Protocol_currentStatus.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Protocol_currentStatus.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Protocol_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Protocol_currentStatus.Match partialMatch) {
    ...
    @Override
    protected Protocol_currentStatus.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Protocol_currentStatus.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_currentStatus.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_currentStatus.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_currentStatus.Matcher> querySpecification() {
      return Protocol_currentStatus.instance();
    }
  }
  
  private Protocol_currentStatus() {
   ...
   * 
   */
  public static Protocol_currentStatus instance() {
    try{
  ...
  @Override
  protected Protocol_currentStatus.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_currentStatus.Matcher.on(engine);
  }
  
  @Override
  public Protocol_currentStatus.Matcher instantiate() {
    return Protocol_currentStatus.Matcher.create();
  }
  
  @Override
  public Protocol_currentStatus.Match newEmptyMatch() {
    return Protocol_currentStatus.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_currentStatus.Match newMatch(final Object... parameters) {
    return Protocol_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_currentStatus} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_currentStatus#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_currentStatus INSTANCE = new Protocol_currentStatus();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_currentStatus.GeneratedPQuery INSTANCE = new GeneratedPQuery();
