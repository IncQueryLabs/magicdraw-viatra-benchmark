...
public final class Technology_URI extends BaseGeneratedEMFQuerySpecification<Technology_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Technology_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Technology_URI.Match.parameterNames;
    }
    ...
    @Override
    public Technology_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Technology_URI.Match)) {
          Technology_URI.Match other = (Technology_URI.Match) obj;
    ...
    @Override
    public Technology_URI specification() {
      return Technology_URI.instance();
    }
     ...
     * 
     */
    public static Technology_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Technology_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Technology_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Technology_URI.Match {
    ...
    private static final class Immutable extends Technology_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Technology_URI.Match> {
    /**
     ...
     * 
     */
    public static Technology_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Technology_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Technology_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Technology_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Technology_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Technology_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Technology_URI.Match> processor) {
     ...
     * 
     */
    public Technology_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Technology_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Technology_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Technology_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Technology_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Technology_URI.Match partialMatch) {
    ...
    @Override
    protected Technology_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Technology_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Technology_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Technology_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Technology_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Technology_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Technology_URI.Matcher> querySpecification() {
      return Technology_URI.instance();
    }
  }
  
  private Technology_URI() {
   ...
   * 
   */
  public static Technology_URI instance() {
    try{
  ...
  @Override
  protected Technology_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Technology_URI.Matcher.on(engine);
  }
  
  @Override
  public Technology_URI.Matcher instantiate() {
    return Technology_URI.Matcher.create();
  }
  
  @Override
  public Technology_URI.Match newEmptyMatch() {
    return Technology_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Technology_URI.Match newMatch(final Object... parameters) {
    return Technology_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Technology_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Technology_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Technology_URI INSTANCE = new Technology_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Technology_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
