...
public final class ServiceAttribute_propertySet extends BaseGeneratedEMFQuerySpecification<ServiceAttribute_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAttribute_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAttribute_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAttribute_propertySet.Match)) {
          ServiceAttribute_propertySet.Match other = (ServiceAttribute_propertySet.Match) obj;
    ...
    @Override
    public ServiceAttribute_propertySet specification() {
      return ServiceAttribute_propertySet.instance();
    }
     ...
     * 
     */
    public static ServiceAttribute_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAttribute_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAttribute_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAttribute_propertySet.Match {
    ...
    private static final class Immutable extends ServiceAttribute_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ServiceAttribute_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAttribute_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ServiceAttribute_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAttribute_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAttribute_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAttribute_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAttribute_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAttribute_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ServiceAttribute_propertySet.Match> processor) {
     ...
     * 
     */
    public ServiceAttribute_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ServiceAttribute_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceAttribute_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceAttribute_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAttribute_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAttribute_propertySet.Match partialMatch) {
    ...
    @Override
    protected ServiceAttribute_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAttribute_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAttribute_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAttribute_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAttribute_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAttribute_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAttribute_propertySet.Matcher> querySpecification() {
      return ServiceAttribute_propertySet.instance();
    }
  }
  
  private ServiceAttribute_propertySet() {
   ...
   * 
   */
  public static ServiceAttribute_propertySet instance() {
    try{
  ...
  @Override
  protected ServiceAttribute_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAttribute_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ServiceAttribute_propertySet.Matcher instantiate() {
    return ServiceAttribute_propertySet.Matcher.create();
  }
  
  @Override
  public ServiceAttribute_propertySet.Match newEmptyMatch() {
    return ServiceAttribute_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAttribute_propertySet.Match newMatch(final Object... parameters) {
    return ServiceAttribute_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAttribute_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAttribute_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAttribute_propertySet INSTANCE = new ServiceAttribute_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAttribute_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
