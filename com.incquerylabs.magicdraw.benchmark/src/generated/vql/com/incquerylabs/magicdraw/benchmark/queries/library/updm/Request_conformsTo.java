...
public final class Request_conformsTo extends BaseGeneratedEMFQuerySpecification<Request_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Request_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Request_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Request_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Request_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Request_conformsTo.Match)) {
          Request_conformsTo.Match other = (Request_conformsTo.Match) obj;
    ...
    @Override
    public Request_conformsTo specification() {
      return Request_conformsTo.instance();
    }
     ...
     * 
     */
    public static Request_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Request_conformsTo.Match newMutableMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public static Request_conformsTo.Match newMatch(final Port pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Request_conformsTo.Match {
    ...
    private static final class Immutable extends Request_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Request_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Request_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Request_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Request_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Request_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Request_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Request_conformsTo.Match> getAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Request_conformsTo.Match> streamAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Request_conformsTo.Match> getOneArbitraryMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final Element pValue, final Consumer<? super Request_conformsTo.Match> processor) {
     ...
     * 
     */
    public Request_conformsTo.Match newMatch(final Port pElement, final Element pValue) {
      return Request_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Request_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Request_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Request_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Request_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Request_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Request_conformsTo.Match.newMatch((Port) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Request_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Request_conformsTo.Match.newMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Request_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Request_conformsTo.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Request_conformsTo.Matcher> querySpecification() {
      return Request_conformsTo.instance();
    }
  }
  
  private Request_conformsTo() {
   ...
   * 
   */
  public static Request_conformsTo instance() {
    try{
  ...
  @Override
  protected Request_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Request_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Request_conformsTo.Matcher instantiate() {
    return Request_conformsTo.Matcher.create();
  }
  
  @Override
  public Request_conformsTo.Match newEmptyMatch() {
    return Request_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Request_conformsTo.Match newMatch(final Object... parameters) {
    return Request_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Request_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Request_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Request_conformsTo INSTANCE = new Request_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Request_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
