...
public final class ActualProperty_startDate extends BaseGeneratedEMFQuerySpecification<ActualProperty_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProperty_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualProperty_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProperty_startDate.Match)) {
          ActualProperty_startDate.Match other = (ActualProperty_startDate.Match) obj;
    ...
    @Override
    public ActualProperty_startDate specification() {
      return ActualProperty_startDate.instance();
    }
     ...
     * 
     */
    public static ActualProperty_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProperty_startDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProperty_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProperty_startDate.Match {
    ...
    private static final class Immutable extends ActualProperty_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_startDate pattern,
   ...
   * 
   * @see Match
   * @see ActualProperty_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProperty_startDate.Match> {
    /**
     ...
     * 
     */
    public static ActualProperty_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProperty_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProperty_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProperty_startDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProperty_startDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProperty_startDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProperty_startDate.Match> processor) {
     ...
     * 
     */
    public ActualProperty_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProperty_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProperty_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProperty_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProperty_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProperty_startDate.Match partialMatch) {
    ...
    @Override
    protected ActualProperty_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProperty_startDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProperty_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProperty_startDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProperty_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProperty_startDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProperty_startDate.Matcher> querySpecification() {
      return ActualProperty_startDate.instance();
    }
  }
  
  private ActualProperty_startDate() {
   ...
   * 
   */
  public static ActualProperty_startDate instance() {
    try{
  ...
  @Override
  protected ActualProperty_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProperty_startDate.Matcher.on(engine);
  }
  
  @Override
  public ActualProperty_startDate.Matcher instantiate() {
    return ActualProperty_startDate.Matcher.create();
  }
  
  @Override
  public ActualProperty_startDate.Match newEmptyMatch() {
    return ActualProperty_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProperty_startDate.Match newMatch(final Object... parameters) {
    return ActualProperty_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProperty_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProperty_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProperty_startDate INSTANCE = new ActualProperty_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProperty_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
