...
public final class KnownResource_isEncapsulated extends BaseGeneratedEMFQuerySpecification<KnownResource_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_isEncapsulated.Match)) {
          KnownResource_isEncapsulated.Match other = (KnownResource_isEncapsulated.Match) obj;
    ...
    @Override
    public KnownResource_isEncapsulated specification() {
      return KnownResource_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static KnownResource_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static KnownResource_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends KnownResource_isEncapsulated.Match {
    ...
    private static final class Immutable extends KnownResource_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<KnownResource_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<KnownResource_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super KnownResource_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public KnownResource_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return KnownResource_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final KnownResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final KnownResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final KnownResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final KnownResource_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected KnownResource_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected KnownResource_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_isEncapsulated.Matcher> querySpecification() {
      return KnownResource_isEncapsulated.instance();
    }
  }
  
  private KnownResource_isEncapsulated() {
   ...
   * 
   */
  public static KnownResource_isEncapsulated instance() {
    try{
  ...
  @Override
  protected KnownResource_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_isEncapsulated.Matcher instantiate() {
    return KnownResource_isEncapsulated.Matcher.create();
  }
  
  @Override
  public KnownResource_isEncapsulated.Match newEmptyMatch() {
    return KnownResource_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_isEncapsulated.Match newMatch(final Object... parameters) {
    return KnownResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_isEncapsulated INSTANCE = new KnownResource_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
