...
public final class Activity_URI extends BaseGeneratedEMFQuerySpecification<Activity_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Activity_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Activity_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Activity_URI.Match.parameterNames;
    }
    ...
    @Override
    public Activity_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Activity_URI.Match)) {
          Activity_URI.Match other = (Activity_URI.Match) obj;
    ...
    @Override
    public Activity_URI specification() {
      return Activity_URI.instance();
    }
     ...
     * 
     */
    public static Activity_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Activity_URI.Match newMutableMatch(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Activity_URI.Match newMatch(final Activity pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Activity_URI.Match {
    ...
    private static final class Immutable extends Activity_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Activity_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Activity_URI.Match> {
    /**
     ...
     * 
     */
    public static Activity_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Activity_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Activity_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Activity_URI.Match> getAllMatches(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Activity_URI.Match> streamAllMatches(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Activity_URI.Match> getOneArbitraryMatch(final Activity pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final LiteralString pValuespec, final Consumer<? super Activity_URI.Match> processor) {
     ...
     * 
     */
    public Activity_URI.Match newMatch(final Activity pElement, final LiteralString pValuespec) {
      return Activity_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Activity_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Activity_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Activity_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Activity_URI.Match partialMatch) {
    ...
    @Override
    protected Activity_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Activity_URI.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Activity_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Activity_URI.Match.newMatch((Activity) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Activity_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Activity_URI.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Activity_URI.Matcher> querySpecification() {
      return Activity_URI.instance();
    }
  }
  
  private Activity_URI() {
   ...
   * 
   */
  public static Activity_URI instance() {
    try{
  ...
  @Override
  protected Activity_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Activity_URI.Matcher.on(engine);
  }
  
  @Override
  public Activity_URI.Matcher instantiate() {
    return Activity_URI.Matcher.create();
  }
  
  @Override
  public Activity_URI.Match newEmptyMatch() {
    return Activity_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Activity_URI.Match newMatch(final Object... parameters) {
    return Activity_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Activity_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Activity_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Activity_URI INSTANCE = new Activity_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Activity_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
