...
public final class EntityItem_conformsTo extends BaseGeneratedEMFQuerySpecification<EntityItem_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityItem_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public EntityItem_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityItem_conformsTo.Match)) {
          EntityItem_conformsTo.Match other = (EntityItem_conformsTo.Match) obj;
    ...
    @Override
    public EntityItem_conformsTo specification() {
      return EntityItem_conformsTo.instance();
    }
     ...
     * 
     */
    public static EntityItem_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityItem_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityItem_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityItem_conformsTo.Match {
    ...
    private static final class Immutable extends EntityItem_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see EntityItem_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<EntityItem_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static EntityItem_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityItem_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityItem_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<EntityItem_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityItem_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityItem_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EntityItem_conformsTo.Match> processor) {
     ...
     * 
     */
    public EntityItem_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EntityItem_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EntityItem_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EntityItem_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityItem_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityItem_conformsTo.Match partialMatch) {
    ...
    @Override
    protected EntityItem_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return EntityItem_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityItem_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return EntityItem_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityItem_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityItem_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityItem_conformsTo.Matcher> querySpecification() {
      return EntityItem_conformsTo.instance();
    }
  }
  
  private EntityItem_conformsTo() {
   ...
   * 
   */
  public static EntityItem_conformsTo instance() {
    try{
  ...
  @Override
  protected EntityItem_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityItem_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public EntityItem_conformsTo.Matcher instantiate() {
    return EntityItem_conformsTo.Matcher.create();
  }
  
  @Override
  public EntityItem_conformsTo.Match newEmptyMatch() {
    return EntityItem_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public EntityItem_conformsTo.Match newMatch(final Object... parameters) {
    return EntityItem_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityItem_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityItem_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityItem_conformsTo INSTANCE = new EntityItem_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityItem_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
