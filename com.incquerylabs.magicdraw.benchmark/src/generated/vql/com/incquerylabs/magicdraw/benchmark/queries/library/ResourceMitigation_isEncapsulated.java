...
public final class ResourceMitigation_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ResourceMitigation_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceMitigation_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public ResourceMitigation_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceMitigation_isEncapsulated.Match)) {
          ResourceMitigation_isEncapsulated.Match other = (ResourceMitigation_isEncapsulated.Match) obj;
    ...
    @Override
    public ResourceMitigation_isEncapsulated specification() {
      return ResourceMitigation_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static ResourceMitigation_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceMitigation_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ResourceMitigation_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourceMitigation_isEncapsulated.Match {
    ...
    private static final class Immutable extends ResourceMitigation_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see ResourceMitigation_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceMitigation_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static ResourceMitigation_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceMitigation_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceMitigation_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceMitigation_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ResourceMitigation_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ResourceMitigation_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ResourceMitigation_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ResourceMitigation_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ResourceMitigation_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceMitigation_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceMitigation_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ResourceMitigation_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ResourceMitigation_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected ResourceMitigation_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceMitigation_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourceMitigation_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceMitigation_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceMitigation_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceMitigation_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceMitigation_isEncapsulated.Matcher> querySpecification() {
      return ResourceMitigation_isEncapsulated.instance();
    }
  }
  
  private ResourceMitigation_isEncapsulated() {
   ...
   * 
   */
  public static ResourceMitigation_isEncapsulated instance() {
    try{
  ...
  @Override
  protected ResourceMitigation_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceMitigation_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public ResourceMitigation_isEncapsulated.Matcher instantiate() {
    return ResourceMitigation_isEncapsulated.Matcher.create();
  }
  
  @Override
  public ResourceMitigation_isEncapsulated.Match newEmptyMatch() {
    return ResourceMitigation_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceMitigation_isEncapsulated.Match newMatch(final Object... parameters) {
    return ResourceMitigation_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceMitigation_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceMitigation_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceMitigation_isEncapsulated INSTANCE = new ResourceMitigation_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceMitigation_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
