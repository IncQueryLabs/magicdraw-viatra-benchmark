...
public final class ServiceInterface_appliesTo extends BaseGeneratedEMFQuerySpecification<ServiceInterface_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInterface_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInterface_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInterface_appliesTo.Match)) {
          ServiceInterface_appliesTo.Match other = (ServiceInterface_appliesTo.Match) obj;
    ...
    @Override
    public ServiceInterface_appliesTo specification() {
      return ServiceInterface_appliesTo.instance();
    }
     ...
     * 
     */
    public static ServiceInterface_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInterface_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceInterface_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceInterface_appliesTo.Match {
    ...
    private static final class Immutable extends ServiceInterface_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see ServiceInterface_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInterface_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static ServiceInterface_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInterface_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInterface_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInterface_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceInterface_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceInterface_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceInterface_appliesTo.Match> processor) {
     ...
     * 
     */
    public ServiceInterface_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceInterface_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceInterface_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceInterface_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceInterface_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceInterface_appliesTo.Match partialMatch) {
    ...
    @Override
    protected ServiceInterface_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInterface_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceInterface_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInterface_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInterface_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInterface_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInterface_appliesTo.Matcher> querySpecification() {
      return ServiceInterface_appliesTo.instance();
    }
  }
  
  private ServiceInterface_appliesTo() {
   ...
   * 
   */
  public static ServiceInterface_appliesTo instance() {
    try{
  ...
  @Override
  protected ServiceInterface_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInterface_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public ServiceInterface_appliesTo.Matcher instantiate() {
    return ServiceInterface_appliesTo.Matcher.create();
  }
  
  @Override
  public ServiceInterface_appliesTo.Match newEmptyMatch() {
    return ServiceInterface_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInterface_appliesTo.Match newMatch(final Object... parameters) {
    return ServiceInterface_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInterface_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInterface_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInterface_appliesTo INSTANCE = new ServiceInterface_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInterface_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
