...
public final class TemporalPart_propertySet extends BaseGeneratedEMFQuerySpecification<TemporalPart_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return TemporalPart_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public TemporalPart_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TemporalPart_propertySet.Match)) {
          TemporalPart_propertySet.Match other = (TemporalPart_propertySet.Match) obj;
    ...
    @Override
    public TemporalPart_propertySet specification() {
      return TemporalPart_propertySet.instance();
    }
     ...
     * 
     */
    public static TemporalPart_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static TemporalPart_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static TemporalPart_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TemporalPart_propertySet.Match {
    ...
    private static final class Immutable extends TemporalPart_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_propertySet pattern,
   ...
   * 
   * @see Match
   * @see TemporalPart_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<TemporalPart_propertySet.Match> {
    /**
     ...
     * 
     */
    public static TemporalPart_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TemporalPart_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TemporalPart_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<TemporalPart_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TemporalPart_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TemporalPart_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super TemporalPart_propertySet.Match> processor) {
     ...
     * 
     */
    public TemporalPart_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return TemporalPart_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TemporalPart_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TemporalPart_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TemporalPart_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TemporalPart_propertySet.Match partialMatch) {
    ...
    @Override
    protected TemporalPart_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return TemporalPart_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TemporalPart_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return TemporalPart_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TemporalPart_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TemporalPart_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TemporalPart_propertySet.Matcher> querySpecification() {
      return TemporalPart_propertySet.instance();
    }
  }
  
  private TemporalPart_propertySet() {
   ...
   * 
   */
  public static TemporalPart_propertySet instance() {
    try{
  ...
  @Override
  protected TemporalPart_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return TemporalPart_propertySet.Matcher.on(engine);
  }
  
  @Override
  public TemporalPart_propertySet.Matcher instantiate() {
    return TemporalPart_propertySet.Matcher.create();
  }
  
  @Override
  public TemporalPart_propertySet.Match newEmptyMatch() {
    return TemporalPart_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public TemporalPart_propertySet.Match newMatch(final Object... parameters) {
    return TemporalPart_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TemporalPart_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TemporalPart_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TemporalPart_propertySet INSTANCE = new TemporalPart_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TemporalPart_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
