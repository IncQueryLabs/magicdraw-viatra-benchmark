...
public final class System_actsUpon extends BaseGeneratedEMFQuerySpecification<System_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public System_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_actsUpon.Match)) {
          System_actsUpon.Match other = (System_actsUpon.Match) obj;
    ...
    @Override
    public System_actsUpon specification() {
      return System_actsUpon.instance();
    }
     ...
     * 
     */
    public static System_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_actsUpon.Match {
    ...
    private static final class Immutable extends System_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_actsUpon pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<System_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static System_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<System_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_actsUpon.Match> processor) {
     ...
     * 
     */
    public System_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_actsUpon.Match partialMatch) {
    ...
    @Override
    protected System_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return System_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return System_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_actsUpon.Matcher> querySpecification() {
      return System_actsUpon.instance();
    }
  }
  
  private System_actsUpon() {
   ...
   * 
   */
  public static System_actsUpon instance() {
    try{
  ...
  @Override
  protected System_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public System_actsUpon.Matcher instantiate() {
    return System_actsUpon.Matcher.create();
  }
  
  @Override
  public System_actsUpon.Match newEmptyMatch() {
    return System_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public System_actsUpon.Match newMatch(final Object... parameters) {
    return System_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_actsUpon INSTANCE = new System_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
