...
public final class ResourcePerformer_conformsTo extends BaseGeneratedEMFQuerySpecification<ResourcePerformer_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourcePerformer_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ResourcePerformer_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourcePerformer_conformsTo.Match)) {
          ResourcePerformer_conformsTo.Match other = (ResourcePerformer_conformsTo.Match) obj;
    ...
    @Override
    public ResourcePerformer_conformsTo specification() {
      return ResourcePerformer_conformsTo.instance();
    }
     ...
     * 
     */
    public static ResourcePerformer_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourcePerformer_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourcePerformer_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourcePerformer_conformsTo.Match {
    ...
    private static final class Immutable extends ResourcePerformer_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ResourcePerformer_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ResourcePerformer_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ResourcePerformer_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourcePerformer_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourcePerformer_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ResourcePerformer_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourcePerformer_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourcePerformer_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourcePerformer_conformsTo.Match> processor) {
     ...
     * 
     */
    public ResourcePerformer_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourcePerformer_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourcePerformer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourcePerformer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourcePerformer_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourcePerformer_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ResourcePerformer_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ResourcePerformer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourcePerformer_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ResourcePerformer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourcePerformer_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourcePerformer_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourcePerformer_conformsTo.Matcher> querySpecification() {
      return ResourcePerformer_conformsTo.instance();
    }
  }
  
  private ResourcePerformer_conformsTo() {
   ...
   * 
   */
  public static ResourcePerformer_conformsTo instance() {
    try{
  ...
  @Override
  protected ResourcePerformer_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourcePerformer_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ResourcePerformer_conformsTo.Matcher instantiate() {
    return ResourcePerformer_conformsTo.Matcher.create();
  }
  
  @Override
  public ResourcePerformer_conformsTo.Match newEmptyMatch() {
    return ResourcePerformer_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ResourcePerformer_conformsTo.Match newMatch(final Object... parameters) {
    return ResourcePerformer_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourcePerformer_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourcePerformer_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourcePerformer_conformsTo INSTANCE = new ResourcePerformer_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourcePerformer_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
