...
public final class AllocateNotSingleSupplier extends BaseGeneratedEMFQuerySpecification<AllocateNotSingleSupplier.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link AllocateNotSingleSupplier} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link AllocateNotSingleSupplier#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	suppliers == count Abstraction.supplier(abstraction, _)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new PatternMatchCounter(body, Tuples.flatTupleOf(var_abstraction, var___1_), new AllocateNotSingleSupplier.GeneratedPQuery.Embedded_1_Abstraction_supplier(), var__virtual_0_);
