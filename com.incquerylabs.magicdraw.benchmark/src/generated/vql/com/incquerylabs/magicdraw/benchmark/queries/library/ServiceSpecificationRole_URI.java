...
public final class ServiceSpecificationRole_URI extends BaseGeneratedEMFQuerySpecification<ServiceSpecificationRole_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecificationRole_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecificationRole_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceSpecificationRole_URI.Match.parameterNames;
    }
    ...
    @Override
    public ServiceSpecificationRole_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceSpecificationRole_URI.Match)) {
          ServiceSpecificationRole_URI.Match other = (ServiceSpecificationRole_URI.Match) obj;
    ...
    @Override
    public ServiceSpecificationRole_URI specification() {
      return ServiceSpecificationRole_URI.instance();
    }
     ...
     * 
     */
    public static ServiceSpecificationRole_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceSpecificationRole_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ServiceSpecificationRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ServiceSpecificationRole_URI.Match {
    ...
    private static final class Immutable extends ServiceSpecificationRole_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecificationRole_URI pattern,
   ...
   * 
   * @see Match
   * @see ServiceSpecificationRole_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceSpecificationRole_URI.Match> {
    /**
     ...
     * 
     */
    public static ServiceSpecificationRole_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceSpecificationRole_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceSpecificationRole_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceSpecificationRole_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ServiceSpecificationRole_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ServiceSpecificationRole_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ServiceSpecificationRole_URI.Match> processor) {
     ...
     * 
     */
    public ServiceSpecificationRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ServiceSpecificationRole_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceSpecificationRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceSpecificationRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ServiceSpecificationRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ServiceSpecificationRole_URI.Match partialMatch) {
    ...
    @Override
    protected ServiceSpecificationRole_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceSpecificationRole_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ServiceSpecificationRole_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceSpecificationRole_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceSpecificationRole_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceSpecificationRole_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceSpecificationRole_URI.Matcher> querySpecification() {
      return ServiceSpecificationRole_URI.instance();
    }
  }
  
  private ServiceSpecificationRole_URI() {
   ...
   * 
   */
  public static ServiceSpecificationRole_URI instance() {
    try{
  ...
  @Override
  protected ServiceSpecificationRole_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceSpecificationRole_URI.Matcher.on(engine);
  }
  
  @Override
  public ServiceSpecificationRole_URI.Matcher instantiate() {
    return ServiceSpecificationRole_URI.Matcher.create();
  }
  
  @Override
  public ServiceSpecificationRole_URI.Match newEmptyMatch() {
    return ServiceSpecificationRole_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceSpecificationRole_URI.Match newMatch(final Object... parameters) {
    return ServiceSpecificationRole_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceSpecificationRole_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceSpecificationRole_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceSpecificationRole_URI INSTANCE = new ServiceSpecificationRole_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceSpecificationRole_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
