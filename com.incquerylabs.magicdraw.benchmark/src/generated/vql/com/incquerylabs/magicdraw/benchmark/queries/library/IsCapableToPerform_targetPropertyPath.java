...
public final class IsCapableToPerform_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<IsCapableToPerform_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return IsCapableToPerform_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public IsCapableToPerform_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof IsCapableToPerform_targetPropertyPath.Match)) {
          IsCapableToPerform_targetPropertyPath.Match other = (IsCapableToPerform_targetPropertyPath.Match) obj;
    ...
    @Override
    public IsCapableToPerform_targetPropertyPath specification() {
      return IsCapableToPerform_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static IsCapableToPerform_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static IsCapableToPerform_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static IsCapableToPerform_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends IsCapableToPerform_targetPropertyPath.Match {
    ...
    private static final class Immutable extends IsCapableToPerform_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see IsCapableToPerform_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<IsCapableToPerform_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static IsCapableToPerform_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static IsCapableToPerform_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(IsCapableToPerform_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<IsCapableToPerform_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<IsCapableToPerform_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<IsCapableToPerform_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super IsCapableToPerform_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public IsCapableToPerform_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return IsCapableToPerform_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final IsCapableToPerform_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final IsCapableToPerform_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final IsCapableToPerform_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final IsCapableToPerform_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected IsCapableToPerform_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return IsCapableToPerform_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected IsCapableToPerform_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return IsCapableToPerform_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected IsCapableToPerform_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return IsCapableToPerform_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<IsCapableToPerform_targetPropertyPath.Matcher> querySpecification() {
      return IsCapableToPerform_targetPropertyPath.instance();
    }
  }
  
  private IsCapableToPerform_targetPropertyPath() {
   ...
   * 
   */
  public static IsCapableToPerform_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected IsCapableToPerform_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return IsCapableToPerform_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public IsCapableToPerform_targetPropertyPath.Matcher instantiate() {
    return IsCapableToPerform_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public IsCapableToPerform_targetPropertyPath.Match newEmptyMatch() {
    return IsCapableToPerform_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public IsCapableToPerform_targetPropertyPath.Match newMatch(final Object... parameters) {
    return IsCapableToPerform_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link IsCapableToPerform_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link IsCapableToPerform_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final IsCapableToPerform_targetPropertyPath INSTANCE = new IsCapableToPerform_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final IsCapableToPerform_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
