...
public final class OptionalLowerZero extends BaseGeneratedEMFQuerySpecification<OptionalLowerZero.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.optionalLowerZero pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.optionalLowerZero";
    }
    
    @Override
    public List<String> parameterNames() {
      return OptionalLowerZero.Match.parameterNames;
    }
    ...
    @Override
    public OptionalLowerZero.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OptionalLowerZero.Match)) {
          OptionalLowerZero.Match other = (OptionalLowerZero.Match) obj;
    ...
    @Override
    public OptionalLowerZero specification() {
     ...
     * 
     */
    public static OptionalLowerZero.Match newEmptyMatch() {
     ...
     * 
     */
    public static OptionalLowerZero.Match newMutableMatch(final Parameter pParameter) {
     ...
     * 
     */
    public static OptionalLowerZero.Match newMatch(final Parameter pParameter) {
      return new Immutable(pParameter);
    }
    
    private static final class Mutable extends OptionalLowerZero.Match {
    ...
    private static final class Immutable extends OptionalLowerZero.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.optionalLowerZero pattern,
   ...
   * 
   * @see Match
   * @see OptionalLowerZero
   * 
   */
  public static class Matcher extends BaseMatcher<OptionalLowerZero.Match> {
    /**
     ...
     * 
     */
    public static OptionalLowerZero.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OptionalLowerZero.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_PARAMETER = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OptionalLowerZero.Matcher.class);
     ...
     * 
     */
    public Collection<OptionalLowerZero.Match> getAllMatches(final Parameter pParameter) {
     ...
     * 
     */
    public Stream<OptionalLowerZero.Match> streamAllMatches(final Parameter pParameter) {
     ...
     * 
     */
    public Optional<OptionalLowerZero.Match> getOneArbitraryMatch(final Parameter pParameter) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Parameter pParameter, final Consumer<? super OptionalLowerZero.Match> processor) {
     ...
     * 
     */
    public OptionalLowerZero.Match newMatch(final Parameter pParameter) {
      return OptionalLowerZero.Match.newMatch(pParameter);
    }
    ...
    @Override
    protected OptionalLowerZero.Match tupleToMatch(final Tuple t) {
      try {
          return OptionalLowerZero.Match.newMatch((Parameter) t.get(POSITION_PARAMETER));
    ...
    @Override
    protected OptionalLowerZero.Match arrayToMatch(final Object[] match) {
      try {
          return OptionalLowerZero.Match.newMatch((Parameter) match[POSITION_PARAMETER]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OptionalLowerZero.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OptionalLowerZero.Match.newMutableMatch((Parameter) match[POSITION_PARAMETER]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OptionalLowerZero.Matcher> querySpecification() {
      return OptionalLowerZero.instance();
    }
  }
  
  private OptionalLowerZero() {
   ...
   * 
   */
  public static OptionalLowerZero instance() {
    try{
  ...
  @Override
  protected OptionalLowerZero.Matcher instantiate(final ViatraQueryEngine engine) {
    return OptionalLowerZero.Matcher.on(engine);
  }
  
  @Override
  public OptionalLowerZero.Matcher instantiate() {
    return OptionalLowerZero.Matcher.create();
  }
  
  @Override
  public OptionalLowerZero.Match newEmptyMatch() {
    return OptionalLowerZero.Match.newEmptyMatch();
  }
  
  @Override
  public OptionalLowerZero.Match newMatch(final Object... parameters) {
    return OptionalLowerZero.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.OptionalLowerZero (visibility: PUBLIC, simpleName: OptionalLowerZero, identifier: com.incquerylabs.magicdraw.benchmark.queries.OptionalLowerZero, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class LazyHolder {
    private static final OptionalLowerZero INSTANCE = new OptionalLowerZero();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find sysml.Optional(parameter, _)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_parameter, var___0_), sysml.Optional.instance().getInternalQueryRepresentation());
          // 	Parameter.lowerValue(parameter, lower)
          new TypeConstraint(body, Tuples.flatTupleOf(var_parameter), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "Parameter")));
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern optionalLowerZero";
              }
