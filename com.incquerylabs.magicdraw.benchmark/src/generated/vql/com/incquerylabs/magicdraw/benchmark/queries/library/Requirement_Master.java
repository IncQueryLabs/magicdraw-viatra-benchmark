...
public final class Requirement_Master extends BaseGeneratedEMFQuerySpecification<Requirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Requirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Requirement_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return Requirement_Master.Match.parameterNames;
    }
    ...
    @Override
    public Requirement_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Requirement_Master.Match)) {
          Requirement_Master.Match other = (Requirement_Master.Match) obj;
    ...
    @Override
    public Requirement_Master specification() {
     ...
     * 
     */
    public static Requirement_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static Requirement_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static Requirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Requirement_Master.Match {
    ...
    private static final class Immutable extends Requirement_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Requirement_Master pattern,
   ...
   * 
   * @see Match
   * @see Requirement_Master
   * 
   */
  public static class Matcher extends BaseMatcher<Requirement_Master.Match> {
    /**
     ...
     * 
     */
    public static Requirement_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Requirement_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Requirement_Master.Matcher.class);
     ...
     * 
     */
    public Collection<Requirement_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<Requirement_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<Requirement_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super Requirement_Master.Match> processor) {
     ...
     * 
     */
    public Requirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return Requirement_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Requirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Requirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final Requirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final Requirement_Master.Match partialMatch) {
    ...
    @Override
    protected Requirement_Master.Match tupleToMatch(final Tuple t) {
      try {
          return Requirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected Requirement_Master.Match arrayToMatch(final Object[] match) {
      try {
          return Requirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Requirement_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Requirement_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Requirement_Master.Matcher> querySpecification() {
      return Requirement_Master.instance();
    }
  }
  
  private Requirement_Master() {
   ...
   * 
   */
  public static Requirement_Master instance() {
    try{
  ...
  @Override
  protected Requirement_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return Requirement_Master.Matcher.on(engine);
  }
  
  @Override
  public Requirement_Master.Matcher instantiate() {
    return Requirement_Master.Matcher.create();
  }
  
  @Override
  public Requirement_Master.Match newEmptyMatch() {
    return Requirement_Master.Match.newEmptyMatch();
  }
  
  @Override
  public Requirement_Master.Match newMatch(final Object... parameters) {
    return Requirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Requirement_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Requirement_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Requirement_Master INSTANCE = new Requirement_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Requirement_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
