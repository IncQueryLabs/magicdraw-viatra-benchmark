...
public final class Verify_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Verify_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Verify_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Verify_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Verify_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Verify_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Verify_targetPropertyPath.Match)) {
          Verify_targetPropertyPath.Match other = (Verify_targetPropertyPath.Match) obj;
    ...
    @Override
    public Verify_targetPropertyPath specification() {
     ...
     * 
     */
    public static Verify_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Verify_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Verify_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Verify_targetPropertyPath.Match {
    ...
    private static final class Immutable extends Verify_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Verify_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Verify_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Verify_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Verify_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Verify_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Verify_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Verify_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Verify_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Verify_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Verify_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public Verify_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Verify_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Verify_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Verify_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Verify_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Verify_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected Verify_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Verify_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Verify_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Verify_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Verify_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Verify_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Verify_targetPropertyPath.Matcher> querySpecification() {
      return Verify_targetPropertyPath.instance();
    }
  }
  
  private Verify_targetPropertyPath() {
   ...
   * 
   */
  public static Verify_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected Verify_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Verify_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Verify_targetPropertyPath.Matcher instantiate() {
    return Verify_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public Verify_targetPropertyPath.Match newEmptyMatch() {
    return Verify_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Verify_targetPropertyPath.Match newMatch(final Object... parameters) {
    return Verify_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Verify_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Verify_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Verify_targetPropertyPath INSTANCE = new Verify_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Verify_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Verify(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Verify.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "targetPropertyPath", valuespec)
