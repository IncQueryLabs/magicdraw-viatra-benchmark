...
public final class WholeLifeConfiguration_endBoundaryType extends BaseGeneratedEMFQuerySpecification<WholeLifeConfiguration_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeConfiguration_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeConfiguration_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeConfiguration_endBoundaryType.Match)) {
          WholeLifeConfiguration_endBoundaryType.Match other = (WholeLifeConfiguration_endBoundaryType.Match) obj;
    ...
    @Override
    public WholeLifeConfiguration_endBoundaryType specification() {
      return WholeLifeConfiguration_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static WholeLifeConfiguration_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeConfiguration_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeConfiguration_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeConfiguration_endBoundaryType.Match {
    ...
    private static final class Immutable extends WholeLifeConfiguration_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeConfiguration_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeConfiguration_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeConfiguration_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeConfiguration_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeConfiguration_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeConfiguration_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeConfiguration_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeConfiguration_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeConfiguration_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public WholeLifeConfiguration_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeConfiguration_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeConfiguration_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeConfiguration_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeConfiguration_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeConfiguration_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected WholeLifeConfiguration_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeConfiguration_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeConfiguration_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeConfiguration_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeConfiguration_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeConfiguration_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeConfiguration_endBoundaryType.Matcher> querySpecification() {
      return WholeLifeConfiguration_endBoundaryType.instance();
    }
  }
  
  private WholeLifeConfiguration_endBoundaryType() {
   ...
   * 
   */
  public static WholeLifeConfiguration_endBoundaryType instance() {
    try{
  ...
  @Override
  protected WholeLifeConfiguration_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeConfiguration_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeConfiguration_endBoundaryType.Matcher instantiate() {
    return WholeLifeConfiguration_endBoundaryType.Matcher.create();
  }
  
  @Override
  public WholeLifeConfiguration_endBoundaryType.Match newEmptyMatch() {
    return WholeLifeConfiguration_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeConfiguration_endBoundaryType.Match newMatch(final Object... parameters) {
    return WholeLifeConfiguration_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeConfiguration_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeConfiguration_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeConfiguration_endBoundaryType INSTANCE = new WholeLifeConfiguration_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeConfiguration_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
