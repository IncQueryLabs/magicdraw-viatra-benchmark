...
public final class AdjunctPropertyNotComposite extends BaseGeneratedEMFQuerySpecification<AdjunctPropertyNotComposite.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.adjunctPropertyNotComposite pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.adjunctPropertyNotComposite";
    }
    
    @Override
    public List<String> parameterNames() {
      return AdjunctPropertyNotComposite.Match.parameterNames;
    }
    ...
    @Override
    public AdjunctPropertyNotComposite.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof AdjunctPropertyNotComposite.Match)) {
          AdjunctPropertyNotComposite.Match other = (AdjunctPropertyNotComposite.Match) obj;
    ...
    @Override
    public AdjunctPropertyNotComposite specification() {
     ...
     * 
     */
    public static AdjunctPropertyNotComposite.Match newEmptyMatch() {
     ...
     * 
     */
    public static AdjunctPropertyNotComposite.Match newMutableMatch(final Property pProperty) {
     ...
     * 
     */
    public static AdjunctPropertyNotComposite.Match newMatch(final Property pProperty) {
      return new Immutable(pProperty);
    }
    
    private static final class Mutable extends AdjunctPropertyNotComposite.Match {
    ...
    private static final class Immutable extends AdjunctPropertyNotComposite.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.adjunctPropertyNotComposite pattern,
   ...
   * 
   * @see Match
   * @see AdjunctPropertyNotComposite
   * 
   */
  public static class Matcher extends BaseMatcher<AdjunctPropertyNotComposite.Match> {
    /**
     ...
     * 
     */
    public static AdjunctPropertyNotComposite.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static AdjunctPropertyNotComposite.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_PROPERTY = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(AdjunctPropertyNotComposite.Matcher.class);
     ...
     * 
     */
    public Collection<AdjunctPropertyNotComposite.Match> getAllMatches(final Property pProperty) {
     ...
     * 
     */
    public Stream<AdjunctPropertyNotComposite.Match> streamAllMatches(final Property pProperty) {
     ...
     * 
     */
    public Optional<AdjunctPropertyNotComposite.Match> getOneArbitraryMatch(final Property pProperty) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pProperty, final Consumer<? super AdjunctPropertyNotComposite.Match> processor) {
     ...
     * 
     */
    public AdjunctPropertyNotComposite.Match newMatch(final Property pProperty) {
      return AdjunctPropertyNotComposite.Match.newMatch(pProperty);
    }
    ...
    @Override
    protected AdjunctPropertyNotComposite.Match tupleToMatch(final Tuple t) {
      try {
          return AdjunctPropertyNotComposite.Match.newMatch((Property) t.get(POSITION_PROPERTY));
    ...
    @Override
    protected AdjunctPropertyNotComposite.Match arrayToMatch(final Object[] match) {
      try {
          return AdjunctPropertyNotComposite.Match.newMatch((Property) match[POSITION_PROPERTY]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected AdjunctPropertyNotComposite.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AdjunctPropertyNotComposite.Match.newMutableMatch((Property) match[POSITION_PROPERTY]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<AdjunctPropertyNotComposite.Matcher> querySpecification() {
      return AdjunctPropertyNotComposite.instance();
    }
  }
  
  private AdjunctPropertyNotComposite() {
   ...
   * 
   */
  public static AdjunctPropertyNotComposite instance() {
    try{
  ...
  @Override
  protected AdjunctPropertyNotComposite.Matcher instantiate(final ViatraQueryEngine engine) {
    return AdjunctPropertyNotComposite.Matcher.on(engine);
  }
  
  @Override
  public AdjunctPropertyNotComposite.Matcher instantiate() {
    return AdjunctPropertyNotComposite.Matcher.create();
  }
  
  @Override
  public AdjunctPropertyNotComposite.Match newEmptyMatch() {
    return AdjunctPropertyNotComposite.Match.newEmptyMatch();
  }
  
  @Override
  public AdjunctPropertyNotComposite.Match newMatch(final Object... parameters) {
    return AdjunctPropertyNotComposite.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0]);
  }
  ...
  private static class LazyHolder {
    private static final AdjunctPropertyNotComposite INSTANCE = new AdjunctPropertyNotComposite();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final AdjunctPropertyNotComposite.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      }
      {
          ...
          new PositivePatternCall(body, Tuples.flatTupleOf(var_property, var_principal), AdjunctProperty_principal.instance().getInternalQueryRepresentation());
          // 	CallAction(principal)
          new TypeConstraint(body, Tuples.flatTupleOf(var_principal), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "CallAction")));
          // 	neg Property.aggregation(property, ::composite)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, com.nomagic.uml2.ext.magicdraw.classes.mdkernel.AggregationKindEnum.get("composite"));
