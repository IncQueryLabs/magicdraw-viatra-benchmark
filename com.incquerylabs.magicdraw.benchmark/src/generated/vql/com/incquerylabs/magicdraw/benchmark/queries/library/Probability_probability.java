...
public final class Probability_probability extends BaseGeneratedEMFQuerySpecification<Probability_probability.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Probability_probability.Match newMutableMatch(final NamedElement pElement, final String pValue) {
     ...
     * 
     */
    public static Probability_probability.Match newMatch(final NamedElement pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<Probability_probability.Match> {
     ...
     * 
     */
    public Collection<Probability_probability.Match> getAllMatches(final NamedElement pElement, final String pValue) {
     ...
     * 
     */
    public Stream<Probability_probability.Match> streamAllMatches(final NamedElement pElement, final String pValue) {
     ...
     * 
     */
    public Optional<Probability_probability.Match> getOneArbitraryMatch(final NamedElement pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final String pValue, final Consumer<? super Probability_probability.Match> processor) {
     ...
     * 
     */
    public Probability_probability.Match newMatch(final NamedElement pElement, final String pValue) {
      return Probability_probability.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final Probability_probability.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final Probability_probability.Match partialMatch) {
    ...
    protected Probability_probability.Match tupleToMatch(final Tuple t) {
      try {
          return Probability_probability.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected Probability_probability.Match arrayToMatch(final Object[] match) {
      try {
          return Probability_probability.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Probability_probability.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Probability_probability.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Probability_probability.Match newMatch(final Object... parameters) {
    return Probability_probability.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (java.lang.String) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Probability(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), Probability.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "probability", taggedValue)
