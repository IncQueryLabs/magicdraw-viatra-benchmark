...
public final class Energy_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Energy_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Energy_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_startBoundaryType.Match)) {
          Energy_startBoundaryType.Match other = (Energy_startBoundaryType.Match) obj;
    ...
    @Override
    public Energy_startBoundaryType specification() {
      return Energy_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Energy_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_startBoundaryType.Match {
    ...
    private static final class Immutable extends Energy_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Energy_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Energy_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Energy_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Energy_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_startBoundaryType.Matcher> querySpecification() {
      return Energy_startBoundaryType.instance();
    }
  }
  
  private Energy_startBoundaryType() {
   ...
   * 
   */
  public static Energy_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Energy_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Energy_startBoundaryType.Matcher instantiate() {
    return Energy_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Energy_startBoundaryType.Match newEmptyMatch() {
    return Energy_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_startBoundaryType.Match newMatch(final Object... parameters) {
    return Energy_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_startBoundaryType INSTANCE = new Energy_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
