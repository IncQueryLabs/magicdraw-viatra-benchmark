...
public final class StructuralPart_propertySet extends BaseGeneratedEMFQuerySpecification<StructuralPart_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return StructuralPart_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public StructuralPart_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StructuralPart_propertySet.Match)) {
          StructuralPart_propertySet.Match other = (StructuralPart_propertySet.Match) obj;
    ...
    @Override
    public StructuralPart_propertySet specification() {
      return StructuralPart_propertySet.instance();
    }
     ...
     * 
     */
    public static StructuralPart_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static StructuralPart_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static StructuralPart_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends StructuralPart_propertySet.Match {
    ...
    private static final class Immutable extends StructuralPart_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_propertySet pattern,
   ...
   * 
   * @see Match
   * @see StructuralPart_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<StructuralPart_propertySet.Match> {
    /**
     ...
     * 
     */
    public static StructuralPart_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StructuralPart_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StructuralPart_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<StructuralPart_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<StructuralPart_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<StructuralPart_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super StructuralPart_propertySet.Match> processor) {
     ...
     * 
     */
    public StructuralPart_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return StructuralPart_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final StructuralPart_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final StructuralPart_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final StructuralPart_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final StructuralPart_propertySet.Match partialMatch) {
    ...
    @Override
    protected StructuralPart_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return StructuralPart_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected StructuralPart_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return StructuralPart_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StructuralPart_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StructuralPart_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StructuralPart_propertySet.Matcher> querySpecification() {
      return StructuralPart_propertySet.instance();
    }
  }
  
  private StructuralPart_propertySet() {
   ...
   * 
   */
  public static StructuralPart_propertySet instance() {
    try{
  ...
  @Override
  protected StructuralPart_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return StructuralPart_propertySet.Matcher.on(engine);
  }
  
  @Override
  public StructuralPart_propertySet.Matcher instantiate() {
    return StructuralPart_propertySet.Matcher.create();
  }
  
  @Override
  public StructuralPart_propertySet.Match newEmptyMatch() {
    return StructuralPart_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public StructuralPart_propertySet.Match newMatch(final Object... parameters) {
    return StructuralPart_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StructuralPart_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StructuralPart_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StructuralPart_propertySet INSTANCE = new StructuralPart_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StructuralPart_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
