...
public final class FunctionControlFlow extends BaseGeneratedEMFQuerySpecification<FunctionControlFlow.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FunctionControlFlow pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FunctionControlFlow";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionControlFlow.Match.parameterNames;
    }
    ...
    @Override
    public FunctionControlFlow.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionControlFlow.Match)) {
          FunctionControlFlow.Match other = (FunctionControlFlow.Match) obj;
    ...
    @Override
    public FunctionControlFlow specification() {
      return FunctionControlFlow.instance();
    }
     ...
     * 
     */
    public static FunctionControlFlow.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionControlFlow.Match newMutableMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FunctionControlFlow.Match newMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends FunctionControlFlow.Match {
    ...
    private static final class Immutable extends FunctionControlFlow.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FunctionControlFlow pattern,
   ...
   * 
   * @see Match
   * @see FunctionControlFlow
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionControlFlow.Match> {
    /**
     ...
     * 
     */
    public static FunctionControlFlow.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionControlFlow.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionControlFlow.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionControlFlow.Match> getAllMatches(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FunctionControlFlow.Match> streamAllMatches(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FunctionControlFlow.Match> getOneArbitraryMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FunctionControlFlow.Match> processor) {
     ...
     * 
     */
    public FunctionControlFlow.Match newMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FunctionControlFlow.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<ControlFlow> streamAllValuesOfelement(final FunctionControlFlow.Match partialMatch) {
     ...
     * 
     */
    public Set<ControlFlow> getAllValuesOfelement(final FunctionControlFlow.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FunctionControlFlow.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FunctionControlFlow.Match partialMatch) {
    ...
    @Override
    protected FunctionControlFlow.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionControlFlow.Match.newMatch((ControlFlow) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected FunctionControlFlow.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionControlFlow.Match.newMatch((ControlFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionControlFlow.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionControlFlow.Match.newMutableMatch((ControlFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionControlFlow.Matcher> querySpecification() {
      return FunctionControlFlow.instance();
    }
  }
  
  private FunctionControlFlow() {
   ...
   * 
   */
  public static FunctionControlFlow instance() {
    try{
  ...
  @Override
  protected FunctionControlFlow.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionControlFlow.Matcher.on(engine);
  }
  
  @Override
  public FunctionControlFlow.Matcher instantiate() {
    return FunctionControlFlow.Matcher.create();
  }
  
  @Override
  public FunctionControlFlow.Match newEmptyMatch() {
    return FunctionControlFlow.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionControlFlow.Match newMatch(final Object... parameters) {
    return FunctionControlFlow.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ControlFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionControlFlow} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionControlFlow#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionControlFlow INSTANCE = new FunctionControlFlow();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionControlFlow.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "FunctionControlFlow")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "FunctionControlFlow");
