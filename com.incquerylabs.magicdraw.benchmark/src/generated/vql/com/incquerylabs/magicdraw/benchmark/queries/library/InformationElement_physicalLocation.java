...
public final class InformationElement_physicalLocation extends BaseGeneratedEMFQuerySpecification<InformationElement_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return InformationElement_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public InformationElement_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InformationElement_physicalLocation.Match)) {
          InformationElement_physicalLocation.Match other = (InformationElement_physicalLocation.Match) obj;
    ...
    @Override
    public InformationElement_physicalLocation specification() {
      return InformationElement_physicalLocation.instance();
    }
     ...
     * 
     */
    public static InformationElement_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static InformationElement_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static InformationElement_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends InformationElement_physicalLocation.Match {
    ...
    private static final class Immutable extends InformationElement_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.InformationElement_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see InformationElement_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<InformationElement_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static InformationElement_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InformationElement_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InformationElement_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<InformationElement_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<InformationElement_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<InformationElement_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super InformationElement_physicalLocation.Match> processor) {
     ...
     * 
     */
    public InformationElement_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return InformationElement_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InformationElement_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InformationElement_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final InformationElement_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final InformationElement_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected InformationElement_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return InformationElement_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected InformationElement_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return InformationElement_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InformationElement_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InformationElement_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InformationElement_physicalLocation.Matcher> querySpecification() {
      return InformationElement_physicalLocation.instance();
    }
  }
  
  private InformationElement_physicalLocation() {
   ...
   * 
   */
  public static InformationElement_physicalLocation instance() {
    try{
  ...
  @Override
  protected InformationElement_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return InformationElement_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public InformationElement_physicalLocation.Matcher instantiate() {
    return InformationElement_physicalLocation.Matcher.create();
  }
  
  @Override
  public InformationElement_physicalLocation.Match newEmptyMatch() {
    return InformationElement_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public InformationElement_physicalLocation.Match newMatch(final Object... parameters) {
    return InformationElement_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InformationElement_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InformationElement_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InformationElement_physicalLocation INSTANCE = new InformationElement_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InformationElement_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
