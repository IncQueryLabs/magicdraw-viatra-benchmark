...
public final class InterfaceRequirement_Id extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_Id.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceRequirement_Id.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceRequirement_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceRequirement_Id.Match)) {
          InterfaceRequirement_Id.Match other = (InterfaceRequirement_Id.Match) obj;
    ...
    @Override
    public InterfaceRequirement_Id specification() {
     ...
     * 
     */
    public static InterfaceRequirement_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceRequirement_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static InterfaceRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends InterfaceRequirement_Id.Match {
    ...
    private static final class Immutable extends InterfaceRequirement_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Id pattern,
   ...
   * 
   * @see Match
   * @see InterfaceRequirement_Id
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceRequirement_Id.Match> {
    /**
     ...
     * 
     */
    public static InterfaceRequirement_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceRequirement_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceRequirement_Id.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceRequirement_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<InterfaceRequirement_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<InterfaceRequirement_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super InterfaceRequirement_Id.Match> processor) {
     ...
     * 
     */
    public InterfaceRequirement_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return InterfaceRequirement_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InterfaceRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InterfaceRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final InterfaceRequirement_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final InterfaceRequirement_Id.Match partialMatch) {
    ...
    @Override
    protected InterfaceRequirement_Id.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected InterfaceRequirement_Id.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceRequirement_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceRequirement_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceRequirement_Id.Matcher> querySpecification() {
      return InterfaceRequirement_Id.instance();
    }
  }
  
  private InterfaceRequirement_Id() {
   ...
   * 
   */
  public static InterfaceRequirement_Id instance() {
    try{
  ...
  @Override
  protected InterfaceRequirement_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceRequirement_Id.Matcher.on(engine);
  }
  
  @Override
  public InterfaceRequirement_Id.Matcher instantiate() {
    return InterfaceRequirement_Id.Matcher.create();
  }
  
  @Override
  public InterfaceRequirement_Id.Match newEmptyMatch() {
    return InterfaceRequirement_Id.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceRequirement_Id.Match newMatch(final Object... parameters) {
    return InterfaceRequirement_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceRequirement_Id} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceRequirement_Id#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceRequirement_Id INSTANCE = new InterfaceRequirement_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceRequirement_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
