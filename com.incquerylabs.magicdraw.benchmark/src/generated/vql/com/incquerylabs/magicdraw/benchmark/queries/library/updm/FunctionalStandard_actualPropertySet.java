...
public final class FunctionalStandard_actualPropertySet extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_actualPropertySet.Match)) {
          FunctionalStandard_actualPropertySet.Match other = (FunctionalStandard_actualPropertySet.Match) obj;
    ...
    @Override
    public FunctionalStandard_actualPropertySet specification() {
      return FunctionalStandard_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static FunctionalStandard_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalStandard_actualPropertySet.Match {
    ...
    private static final class Immutable extends FunctionalStandard_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FunctionalStandard_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FunctionalStandard_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super FunctionalStandard_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return FunctionalStandard_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final FunctionalStandard_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final FunctionalStandard_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalStandard_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_actualPropertySet.Matcher> querySpecification() {
      return FunctionalStandard_actualPropertySet.instance();
    }
  }
  
  private FunctionalStandard_actualPropertySet() {
   ...
   * 
   */
  public static FunctionalStandard_actualPropertySet instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_actualPropertySet.Matcher instantiate() {
    return FunctionalStandard_actualPropertySet.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_actualPropertySet.Match newEmptyMatch() {
    return FunctionalStandard_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_actualPropertySet.Match newMatch(final Object... parameters) {
    return FunctionalStandard_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_actualPropertySet INSTANCE = new FunctionalStandard_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
