...
public final class ConceptRole_measurementSet extends BaseGeneratedEMFQuerySpecification<ConceptRole_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ConceptRole_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ConceptRole_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptRole_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ConceptRole_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptRole_measurementSet.Match)) {
          ConceptRole_measurementSet.Match other = (ConceptRole_measurementSet.Match) obj;
    ...
    @Override
    public ConceptRole_measurementSet specification() {
      return ConceptRole_measurementSet.instance();
    }
     ...
     * 
     */
    public static ConceptRole_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptRole_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConceptRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConceptRole_measurementSet.Match {
    ...
    private static final class Immutable extends ConceptRole_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ConceptRole_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see ConceptRole_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptRole_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static ConceptRole_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptRole_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptRole_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptRole_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConceptRole_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConceptRole_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConceptRole_measurementSet.Match> processor) {
     ...
     * 
     */
    public ConceptRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ConceptRole_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConceptRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConceptRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConceptRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConceptRole_measurementSet.Match partialMatch) {
    ...
    @Override
    protected ConceptRole_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptRole_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConceptRole_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptRole_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptRole_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptRole_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptRole_measurementSet.Matcher> querySpecification() {
      return ConceptRole_measurementSet.instance();
    }
  }
  
  private ConceptRole_measurementSet() {
   ...
   * 
   */
  public static ConceptRole_measurementSet instance() {
    try{
  ...
  @Override
  protected ConceptRole_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptRole_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public ConceptRole_measurementSet.Matcher instantiate() {
    return ConceptRole_measurementSet.Matcher.create();
  }
  
  @Override
  public ConceptRole_measurementSet.Match newEmptyMatch() {
    return ConceptRole_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptRole_measurementSet.Match newMatch(final Object... parameters) {
    return ConceptRole_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptRole_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptRole_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptRole_measurementSet INSTANCE = new ConceptRole_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptRole_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
