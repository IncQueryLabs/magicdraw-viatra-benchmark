...
public final class ProjectMilestoneRole_conformsTo extends BaseGeneratedEMFQuerySpecification<ProjectMilestoneRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestoneRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestoneRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestoneRole_conformsTo.Match)) {
          ProjectMilestoneRole_conformsTo.Match other = (ProjectMilestoneRole_conformsTo.Match) obj;
    ...
    @Override
    public ProjectMilestoneRole_conformsTo specification() {
      return ProjectMilestoneRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static ProjectMilestoneRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestoneRole_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestoneRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestoneRole_conformsTo.Match {
    ...
    private static final class Immutable extends ProjectMilestoneRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestoneRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestoneRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestoneRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestoneRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestoneRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestoneRole_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestoneRole_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestoneRole_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectMilestoneRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public ProjectMilestoneRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectMilestoneRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectMilestoneRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectMilestoneRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestoneRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestoneRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestoneRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestoneRole_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestoneRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestoneRole_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestoneRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestoneRole_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestoneRole_conformsTo.Matcher> querySpecification() {
      return ProjectMilestoneRole_conformsTo.instance();
    }
  }
  
  private ProjectMilestoneRole_conformsTo() {
   ...
   * 
   */
  public static ProjectMilestoneRole_conformsTo instance() {
    try{
  ...
  @Override
  protected ProjectMilestoneRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestoneRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestoneRole_conformsTo.Matcher instantiate() {
    return ProjectMilestoneRole_conformsTo.Matcher.create();
  }
  
  @Override
  public ProjectMilestoneRole_conformsTo.Match newEmptyMatch() {
    return ProjectMilestoneRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestoneRole_conformsTo.Match newMatch(final Object... parameters) {
    return ProjectMilestoneRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestoneRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestoneRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestoneRole_conformsTo INSTANCE = new ProjectMilestoneRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestoneRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
