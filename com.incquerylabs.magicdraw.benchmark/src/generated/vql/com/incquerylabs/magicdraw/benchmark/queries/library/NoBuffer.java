...
public final class NoBuffer extends BaseGeneratedEMFQuerySpecification<NoBuffer.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.NoBuffer pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.NoBuffer";
    }
     ...
     * 
     */
    public static NoBuffer.Match newMutableMatch(final ObjectNode pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static NoBuffer.Match newMatch(final ObjectNode pElement, final Stereotype pStereotype) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.NoBuffer pattern,
  ...
  public static class Matcher extends BaseMatcher<NoBuffer.Match> {
     ...
     * 
     */
    public Collection<NoBuffer.Match> getAllMatches(final ObjectNode pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<NoBuffer.Match> streamAllMatches(final ObjectNode pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<NoBuffer.Match> getOneArbitraryMatch(final ObjectNode pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final ObjectNode pElement, final Stereotype pStereotype, final Consumer<? super NoBuffer.Match> processor) {
     ...
     * 
     */
    public NoBuffer.Match newMatch(final ObjectNode pElement, final Stereotype pStereotype) {
      return NoBuffer.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final NoBuffer.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final NoBuffer.Match partialMatch) {
    ...
    protected NoBuffer.Match tupleToMatch(final Tuple t) {
      try {
          return NoBuffer.Match.newMatch((ObjectNode) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected NoBuffer.Match arrayToMatch(final Object[] match) {
      try {
          return NoBuffer.Match.newMatch((ObjectNode) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected NoBuffer.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NoBuffer.Match.newMutableMatch((ObjectNode) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public NoBuffer.Match newMatch(final Object... parameters) {
    return NoBuffer.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ObjectNode) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
