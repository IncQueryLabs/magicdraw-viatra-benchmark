...
public final class Asset_conformsTo extends BaseGeneratedEMFQuerySpecification<Asset_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Asset_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Asset_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Asset_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Asset_conformsTo.Match)) {
          Asset_conformsTo.Match other = (Asset_conformsTo.Match) obj;
    ...
    @Override
    public Asset_conformsTo specification() {
      return Asset_conformsTo.instance();
    }
     ...
     * 
     */
    public static Asset_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Asset_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Asset_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Asset_conformsTo.Match {
    ...
    private static final class Immutable extends Asset_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Asset_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Asset_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Asset_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Asset_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Asset_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Asset_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Asset_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Asset_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Asset_conformsTo.Match> processor) {
     ...
     * 
     */
    public Asset_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Asset_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Asset_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Asset_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Asset_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Asset_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Asset_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Asset_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Asset_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Asset_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Asset_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Asset_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Asset_conformsTo.Matcher> querySpecification() {
      return Asset_conformsTo.instance();
    }
  }
  
  private Asset_conformsTo() {
   ...
   * 
   */
  public static Asset_conformsTo instance() {
    try{
  ...
  @Override
  protected Asset_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Asset_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Asset_conformsTo.Matcher instantiate() {
    return Asset_conformsTo.Matcher.create();
  }
  
  @Override
  public Asset_conformsTo.Match newEmptyMatch() {
    return Asset_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Asset_conformsTo.Match newMatch(final Object... parameters) {
    return Asset_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Asset_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Asset_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Asset_conformsTo INSTANCE = new Asset_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Asset_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
