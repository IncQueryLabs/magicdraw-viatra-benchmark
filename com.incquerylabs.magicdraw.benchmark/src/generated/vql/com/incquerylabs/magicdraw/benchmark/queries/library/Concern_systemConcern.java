...
public final class Concern_systemConcern extends BaseGeneratedEMFQuerySpecification<Concern_systemConcern.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Concern_systemConcern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Concern_systemConcern";
    }
    
    @Override
    public List<String> parameterNames() {
      return Concern_systemConcern.Match.parameterNames;
    }
    ...
    @Override
    public Concern_systemConcern.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Concern_systemConcern.Match)) {
          Concern_systemConcern.Match other = (Concern_systemConcern.Match) obj;
    ...
    @Override
    public Concern_systemConcern specification() {
      return Concern_systemConcern.instance();
    }
     ...
     * 
     */
    public static Concern_systemConcern.Match newEmptyMatch() {
     ...
     * 
     */
    public static Concern_systemConcern.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Concern_systemConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Concern_systemConcern.Match {
    ...
    private static final class Immutable extends Concern_systemConcern.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Concern_systemConcern pattern,
   ...
   * 
   * @see Match
   * @see Concern_systemConcern
   * 
   */
  public static class Matcher extends BaseMatcher<Concern_systemConcern.Match> {
    /**
     ...
     * 
     */
    public static Concern_systemConcern.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Concern_systemConcern.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Concern_systemConcern.Matcher.class);
     ...
     * 
     */
    public Collection<Concern_systemConcern.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Concern_systemConcern.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Concern_systemConcern.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Concern_systemConcern.Match> processor) {
     ...
     * 
     */
    public Concern_systemConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Concern_systemConcern.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Concern_systemConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Concern_systemConcern.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Concern_systemConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Concern_systemConcern.Match partialMatch) {
    ...
    @Override
    protected Concern_systemConcern.Match tupleToMatch(final Tuple t) {
      try {
          return Concern_systemConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Concern_systemConcern.Match arrayToMatch(final Object[] match) {
      try {
          return Concern_systemConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Concern_systemConcern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Concern_systemConcern.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Concern_systemConcern.Matcher> querySpecification() {
      return Concern_systemConcern.instance();
    }
  }
  
  private Concern_systemConcern() {
   ...
   * 
   */
  public static Concern_systemConcern instance() {
    try{
  ...
  @Override
  protected Concern_systemConcern.Matcher instantiate(final ViatraQueryEngine engine) {
    return Concern_systemConcern.Matcher.on(engine);
  }
  
  @Override
  public Concern_systemConcern.Matcher instantiate() {
    return Concern_systemConcern.Matcher.create();
  }
  
  @Override
  public Concern_systemConcern.Match newEmptyMatch() {
    return Concern_systemConcern.Match.newEmptyMatch();
  }
  
  @Override
  public Concern_systemConcern.Match newMatch(final Object... parameters) {
    return Concern_systemConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Concern_systemConcern} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Concern_systemConcern#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Concern_systemConcern INSTANCE = new Concern_systemConcern();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Concern_systemConcern.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "systemConcern");
