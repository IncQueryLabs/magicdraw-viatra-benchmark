...
public final class OperationalMitigation_URI extends BaseGeneratedEMFQuerySpecification<OperationalMitigation_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalMitigation_URI.Match.parameterNames;
    }
    ...
    @Override
    public OperationalMitigation_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalMitigation_URI.Match)) {
          OperationalMitigation_URI.Match other = (OperationalMitigation_URI.Match) obj;
    ...
    @Override
    public OperationalMitigation_URI specification() {
      return OperationalMitigation_URI.instance();
    }
     ...
     * 
     */
    public static OperationalMitigation_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalMitigation_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static OperationalMitigation_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalMitigation_URI.Match {
    ...
    private static final class Immutable extends OperationalMitigation_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_URI pattern,
   ...
   * 
   * @see Match
   * @see OperationalMitigation_URI
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalMitigation_URI.Match> {
    /**
     ...
     * 
     */
    public static OperationalMitigation_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalMitigation_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalMitigation_URI.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalMitigation_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<OperationalMitigation_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<OperationalMitigation_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super OperationalMitigation_URI.Match> processor) {
     ...
     * 
     */
    public OperationalMitigation_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return OperationalMitigation_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalMitigation_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalMitigation_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final OperationalMitigation_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final OperationalMitigation_URI.Match partialMatch) {
    ...
    @Override
    protected OperationalMitigation_URI.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalMitigation_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalMitigation_URI.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalMitigation_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalMitigation_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalMitigation_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalMitigation_URI.Matcher> querySpecification() {
      return OperationalMitigation_URI.instance();
    }
  }
  
  private OperationalMitigation_URI() {
   ...
   * 
   */
  public static OperationalMitigation_URI instance() {
    try{
  ...
  @Override
  protected OperationalMitigation_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalMitigation_URI.Matcher.on(engine);
  }
  
  @Override
  public OperationalMitigation_URI.Matcher instantiate() {
    return OperationalMitigation_URI.Matcher.create();
  }
  
  @Override
  public OperationalMitigation_URI.Match newEmptyMatch() {
    return OperationalMitigation_URI.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalMitigation_URI.Match newMatch(final Object... parameters) {
    return OperationalMitigation_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalMitigation_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalMitigation_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalMitigation_URI INSTANCE = new OperationalMitigation_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalMitigation_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
