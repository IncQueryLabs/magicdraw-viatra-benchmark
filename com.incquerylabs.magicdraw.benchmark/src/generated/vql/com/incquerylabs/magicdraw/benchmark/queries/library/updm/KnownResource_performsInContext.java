...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource;
...
public final class KnownResource_performsInContext extends BaseGeneratedEMFQuerySpecification<KnownResource_performsInContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_performsInContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_performsInContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_performsInContext.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_performsInContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_performsInContext.Match)) {
          KnownResource_performsInContext.Match other = (KnownResource_performsInContext.Match) obj;
    ...
    @Override
    public KnownResource_performsInContext specification() {
      return KnownResource_performsInContext.instance();
    }
     ...
     * 
     */
    public static KnownResource_performsInContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_performsInContext.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_performsInContext.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_performsInContext.Match {
    ...
    private static final class Immutable extends KnownResource_performsInContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_performsInContext pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_performsInContext
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_performsInContext.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_performsInContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_performsInContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_performsInContext.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_performsInContext.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_performsInContext.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_performsInContext.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super KnownResource_performsInContext.Match> processor) {
     ...
     * 
     */
    public KnownResource_performsInContext.Match newMatch(final Property pElement, final Element pValue) {
      return KnownResource_performsInContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final KnownResource_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final KnownResource_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_performsInContext.Match partialMatch) {
    ...
    @Override
    protected KnownResource_performsInContext.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_performsInContext.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_performsInContext.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_performsInContext.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_performsInContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_performsInContext.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_performsInContext.Matcher> querySpecification() {
      return KnownResource_performsInContext.instance();
    }
  }
  
  private KnownResource_performsInContext() {
   ...
   * 
   */
  public static KnownResource_performsInContext instance() {
    try{
  ...
  @Override
  protected KnownResource_performsInContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_performsInContext.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_performsInContext.Matcher instantiate() {
    return KnownResource_performsInContext.Matcher.create();
  }
  
  @Override
  public KnownResource_performsInContext.Match newEmptyMatch() {
    return KnownResource_performsInContext.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_performsInContext.Match newMatch(final Object... parameters) {
    return KnownResource_performsInContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_performsInContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_performsInContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_performsInContext INSTANCE = new KnownResource_performsInContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_performsInContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
