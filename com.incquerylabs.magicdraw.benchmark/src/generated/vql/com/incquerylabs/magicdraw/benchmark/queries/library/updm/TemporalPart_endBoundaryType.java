...
public final class TemporalPart_endBoundaryType extends BaseGeneratedEMFQuerySpecification<TemporalPart_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return TemporalPart_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public TemporalPart_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TemporalPart_endBoundaryType.Match)) {
          TemporalPart_endBoundaryType.Match other = (TemporalPart_endBoundaryType.Match) obj;
    ...
    @Override
    public TemporalPart_endBoundaryType specification() {
      return TemporalPart_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static TemporalPart_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static TemporalPart_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static TemporalPart_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TemporalPart_endBoundaryType.Match {
    ...
    private static final class Immutable extends TemporalPart_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see TemporalPart_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<TemporalPart_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static TemporalPart_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TemporalPart_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TemporalPart_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<TemporalPart_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TemporalPart_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TemporalPart_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super TemporalPart_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public TemporalPart_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return TemporalPart_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TemporalPart_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TemporalPart_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TemporalPart_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TemporalPart_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected TemporalPart_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return TemporalPart_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TemporalPart_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return TemporalPart_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TemporalPart_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TemporalPart_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TemporalPart_endBoundaryType.Matcher> querySpecification() {
      return TemporalPart_endBoundaryType.instance();
    }
  }
  
  private TemporalPart_endBoundaryType() {
   ...
   * 
   */
  public static TemporalPart_endBoundaryType instance() {
    try{
  ...
  @Override
  protected TemporalPart_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return TemporalPart_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public TemporalPart_endBoundaryType.Matcher instantiate() {
    return TemporalPart_endBoundaryType.Matcher.create();
  }
  
  @Override
  public TemporalPart_endBoundaryType.Match newEmptyMatch() {
    return TemporalPart_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public TemporalPart_endBoundaryType.Match newMatch(final Object... parameters) {
    return TemporalPart_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TemporalPart_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TemporalPart_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TemporalPart_endBoundaryType INSTANCE = new TemporalPart_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TemporalPart_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
