...
public final class ServiceInterface_conformsTo extends BaseGeneratedEMFQuerySpecification<ServiceInterface_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInterface_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInterface_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInterface_conformsTo.Match)) {
          ServiceInterface_conformsTo.Match other = (ServiceInterface_conformsTo.Match) obj;
    ...
    @Override
    public ServiceInterface_conformsTo specification() {
      return ServiceInterface_conformsTo.instance();
    }
     ...
     * 
     */
    public static ServiceInterface_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInterface_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceInterface_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceInterface_conformsTo.Match {
    ...
    private static final class Immutable extends ServiceInterface_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ServiceInterface_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInterface_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ServiceInterface_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInterface_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInterface_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInterface_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceInterface_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceInterface_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceInterface_conformsTo.Match> processor) {
     ...
     * 
     */
    public ServiceInterface_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceInterface_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceInterface_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceInterface_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceInterface_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceInterface_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ServiceInterface_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInterface_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceInterface_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInterface_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInterface_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInterface_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInterface_conformsTo.Matcher> querySpecification() {
      return ServiceInterface_conformsTo.instance();
    }
  }
  
  private ServiceInterface_conformsTo() {
   ...
   * 
   */
  public static ServiceInterface_conformsTo instance() {
    try{
  ...
  @Override
  protected ServiceInterface_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInterface_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ServiceInterface_conformsTo.Matcher instantiate() {
    return ServiceInterface_conformsTo.Matcher.create();
  }
  
  @Override
  public ServiceInterface_conformsTo.Match newEmptyMatch() {
    return ServiceInterface_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInterface_conformsTo.Match newMatch(final Object... parameters) {
    return ServiceInterface_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInterface_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInterface_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInterface_conformsTo INSTANCE = new ServiceInterface_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInterface_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
