...
public final class EnterpriseVision_isEncapsulated extends BaseGeneratedEMFQuerySpecification<EnterpriseVision_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseVision_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseVision_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseVision_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseVision_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseVision_isEncapsulated.Match)) {
          EnterpriseVision_isEncapsulated.Match other = (EnterpriseVision_isEncapsulated.Match) obj;
    ...
    @Override
    public EnterpriseVision_isEncapsulated specification() {
      return EnterpriseVision_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static EnterpriseVision_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseVision_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static EnterpriseVision_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnterpriseVision_isEncapsulated.Match {
    ...
    private static final class Immutable extends EnterpriseVision_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseVision_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseVision_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseVision_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseVision_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseVision_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseVision_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseVision_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<EnterpriseVision_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<EnterpriseVision_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super EnterpriseVision_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public EnterpriseVision_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return EnterpriseVision_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseVision_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseVision_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final EnterpriseVision_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final EnterpriseVision_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected EnterpriseVision_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseVision_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnterpriseVision_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseVision_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseVision_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseVision_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseVision_isEncapsulated.Matcher> querySpecification() {
      return EnterpriseVision_isEncapsulated.instance();
    }
  }
  
  private EnterpriseVision_isEncapsulated() {
   ...
   * 
   */
  public static EnterpriseVision_isEncapsulated instance() {
    try{
  ...
  @Override
  protected EnterpriseVision_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseVision_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseVision_isEncapsulated.Matcher instantiate() {
    return EnterpriseVision_isEncapsulated.Matcher.create();
  }
  
  @Override
  public EnterpriseVision_isEncapsulated.Match newEmptyMatch() {
    return EnterpriseVision_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseVision_isEncapsulated.Match newMatch(final Object... parameters) {
    return EnterpriseVision_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseVision_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseVision_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseVision_isEncapsulated INSTANCE = new EnterpriseVision_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseVision_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
