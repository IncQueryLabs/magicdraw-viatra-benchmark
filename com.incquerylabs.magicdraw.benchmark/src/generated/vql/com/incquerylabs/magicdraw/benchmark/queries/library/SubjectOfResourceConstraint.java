...
public final class SubjectOfResourceConstraint extends BaseGeneratedEMFQuerySpecification<SubjectOfResourceConstraint.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfResourceConstraint pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfResourceConstraint";
    }
    
    @Override
    public List<String> parameterNames() {
      return SubjectOfResourceConstraint.Match.parameterNames;
    }
    ...
    @Override
    public SubjectOfResourceConstraint.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SubjectOfResourceConstraint.Match)) {
          SubjectOfResourceConstraint.Match other = (SubjectOfResourceConstraint.Match) obj;
    ...
    @Override
    public SubjectOfResourceConstraint specification() {
      return SubjectOfResourceConstraint.instance();
    }
     ...
     * 
     */
    public static SubjectOfResourceConstraint.Match newEmptyMatch() {
     ...
     * 
     */
    public static SubjectOfResourceConstraint.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SubjectOfResourceConstraint.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SubjectOfResourceConstraint.Match {
    ...
    private static final class Immutable extends SubjectOfResourceConstraint.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfResourceConstraint pattern,
   ...
   * 
   * @see Match
   * @see SubjectOfResourceConstraint
   * 
   */
  public static class Matcher extends BaseMatcher<SubjectOfResourceConstraint.Match> {
    /**
     ...
     * 
     */
    public static SubjectOfResourceConstraint.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SubjectOfResourceConstraint.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SubjectOfResourceConstraint.Matcher.class);
     ...
     * 
     */
    public Collection<SubjectOfResourceConstraint.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SubjectOfResourceConstraint.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SubjectOfResourceConstraint.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SubjectOfResourceConstraint.Match> processor) {
     ...
     * 
     */
    public SubjectOfResourceConstraint.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SubjectOfResourceConstraint.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final SubjectOfResourceConstraint.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final SubjectOfResourceConstraint.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SubjectOfResourceConstraint.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SubjectOfResourceConstraint.Match partialMatch) {
    ...
    @Override
    protected SubjectOfResourceConstraint.Match tupleToMatch(final Tuple t) {
      try {
          return SubjectOfResourceConstraint.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SubjectOfResourceConstraint.Match arrayToMatch(final Object[] match) {
      try {
          return SubjectOfResourceConstraint.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SubjectOfResourceConstraint.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SubjectOfResourceConstraint.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SubjectOfResourceConstraint.Matcher> querySpecification() {
      return SubjectOfResourceConstraint.instance();
    }
  }
  
  private SubjectOfResourceConstraint() {
   ...
   * 
   */
  public static SubjectOfResourceConstraint instance() {
    try{
  ...
  @Override
  protected SubjectOfResourceConstraint.Matcher instantiate(final ViatraQueryEngine engine) {
    return SubjectOfResourceConstraint.Matcher.on(engine);
  }
  
  @Override
  public SubjectOfResourceConstraint.Matcher instantiate() {
    return SubjectOfResourceConstraint.Matcher.create();
  }
  
  @Override
  public SubjectOfResourceConstraint.Match newEmptyMatch() {
    return SubjectOfResourceConstraint.Match.newEmptyMatch();
  }
  
  @Override
  public SubjectOfResourceConstraint.Match newMatch(final Object... parameters) {
    return SubjectOfResourceConstraint.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SubjectOfResourceConstraint} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SubjectOfResourceConstraint#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SubjectOfResourceConstraint INSTANCE = new SubjectOfResourceConstraint();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SubjectOfResourceConstraint.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "SubjectOfResourceConstraint")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "SubjectOfResourceConstraint");
