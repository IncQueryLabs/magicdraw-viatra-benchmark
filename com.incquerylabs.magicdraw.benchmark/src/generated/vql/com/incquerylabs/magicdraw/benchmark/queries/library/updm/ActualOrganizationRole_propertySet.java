...
public final class ActualOrganizationRole_propertySet extends BaseGeneratedEMFQuerySpecification<ActualOrganizationRole_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualOrganizationRole_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ActualOrganizationRole_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualOrganizationRole_propertySet.Match)) {
          ActualOrganizationRole_propertySet.Match other = (ActualOrganizationRole_propertySet.Match) obj;
    ...
    @Override
    public ActualOrganizationRole_propertySet specification() {
      return ActualOrganizationRole_propertySet.instance();
    }
     ...
     * 
     */
    public static ActualOrganizationRole_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualOrganizationRole_propertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualOrganizationRole_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualOrganizationRole_propertySet.Match {
    ...
    private static final class Immutable extends ActualOrganizationRole_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ActualOrganizationRole_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ActualOrganizationRole_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ActualOrganizationRole_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualOrganizationRole_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualOrganizationRole_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ActualOrganizationRole_propertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualOrganizationRole_propertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualOrganizationRole_propertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualOrganizationRole_propertySet.Match> processor) {
     ...
     * 
     */
    public ActualOrganizationRole_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualOrganizationRole_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualOrganizationRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualOrganizationRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualOrganizationRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualOrganizationRole_propertySet.Match partialMatch) {
    ...
    @Override
    protected ActualOrganizationRole_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ActualOrganizationRole_propertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualOrganizationRole_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ActualOrganizationRole_propertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualOrganizationRole_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualOrganizationRole_propertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualOrganizationRole_propertySet.Matcher> querySpecification() {
      return ActualOrganizationRole_propertySet.instance();
    }
  }
  
  private ActualOrganizationRole_propertySet() {
   ...
   * 
   */
  public static ActualOrganizationRole_propertySet instance() {
    try{
  ...
  @Override
  protected ActualOrganizationRole_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualOrganizationRole_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ActualOrganizationRole_propertySet.Matcher instantiate() {
    return ActualOrganizationRole_propertySet.Matcher.create();
  }
  
  @Override
  public ActualOrganizationRole_propertySet.Match newEmptyMatch() {
    return ActualOrganizationRole_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ActualOrganizationRole_propertySet.Match newMatch(final Object... parameters) {
    return ActualOrganizationRole_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualOrganizationRole_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualOrganizationRole_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualOrganizationRole_propertySet INSTANCE = new ActualOrganizationRole_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualOrganizationRole_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
