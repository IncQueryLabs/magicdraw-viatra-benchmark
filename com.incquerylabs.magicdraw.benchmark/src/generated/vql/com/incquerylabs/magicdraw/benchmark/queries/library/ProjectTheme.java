...
public final class ProjectTheme extends BaseGeneratedEMFQuerySpecification<ProjectTheme.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectTheme.Match.parameterNames;
    }
    ...
    @Override
    public ProjectTheme.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectTheme.Match)) {
          ProjectTheme.Match other = (ProjectTheme.Match) obj;
    ...
    @Override
    public ProjectTheme specification() {
      return ProjectTheme.instance();
    }
     ...
     * 
     */
    public static ProjectTheme.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectTheme.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProjectTheme.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProjectTheme.Match {
    ...
    private static final class Immutable extends ProjectTheme.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectTheme.Match> {
    /**
     ...
     * 
     */
    public static ProjectTheme.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectTheme.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectTheme.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectTheme.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProjectTheme.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProjectTheme.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProjectTheme.Match> processor) {
     ...
     * 
     */
    public ProjectTheme.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProjectTheme.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectTheme.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectTheme.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProjectTheme.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProjectTheme.Match partialMatch) {
    ...
    @Override
    protected ProjectTheme.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectTheme.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProjectTheme.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectTheme.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectTheme.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectTheme.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectTheme.Matcher> querySpecification() {
      return ProjectTheme.instance();
    }
  }
   ...
   * 
   */
  public static ProjectTheme instance() {
    try{
  ...
  @Override
  protected ProjectTheme.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectTheme.Matcher.on(engine);
  }
  
  @Override
  public ProjectTheme.Matcher instantiate() {
    return ProjectTheme.Matcher.create();
  }
  
  @Override
  public ProjectTheme.Match newEmptyMatch() {
    return ProjectTheme.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectTheme.Match newMatch(final Object... parameters) {
    return ProjectTheme.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectTheme} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectTheme#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectTheme INSTANCE = new ProjectTheme();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectTheme.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ProjectTheme")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ProjectTheme");
