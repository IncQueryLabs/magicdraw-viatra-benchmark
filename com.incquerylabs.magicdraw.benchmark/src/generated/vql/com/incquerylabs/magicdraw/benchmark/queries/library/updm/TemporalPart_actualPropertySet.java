...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart;
...
public final class TemporalPart_actualPropertySet extends BaseGeneratedEMFQuerySpecification<TemporalPart_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return TemporalPart_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public TemporalPart_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TemporalPart_actualPropertySet.Match)) {
          TemporalPart_actualPropertySet.Match other = (TemporalPart_actualPropertySet.Match) obj;
    ...
    @Override
    public TemporalPart_actualPropertySet specification() {
      return TemporalPart_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static TemporalPart_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static TemporalPart_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static TemporalPart_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TemporalPart_actualPropertySet.Match {
    ...
    private static final class Immutable extends TemporalPart_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see TemporalPart_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<TemporalPart_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static TemporalPart_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TemporalPart_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TemporalPart_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<TemporalPart_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TemporalPart_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TemporalPart_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super TemporalPart_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public TemporalPart_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return TemporalPart_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TemporalPart_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TemporalPart_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TemporalPart_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TemporalPart_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected TemporalPart_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return TemporalPart_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TemporalPart_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return TemporalPart_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TemporalPart_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TemporalPart_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TemporalPart_actualPropertySet.Matcher> querySpecification() {
      return TemporalPart_actualPropertySet.instance();
    }
  }
  
  private TemporalPart_actualPropertySet() {
   ...
   * 
   */
  public static TemporalPart_actualPropertySet instance() {
    try{
  ...
  @Override
  protected TemporalPart_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return TemporalPart_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public TemporalPart_actualPropertySet.Matcher instantiate() {
    return TemporalPart_actualPropertySet.Matcher.create();
  }
  
  @Override
  public TemporalPart_actualPropertySet.Match newEmptyMatch() {
    return TemporalPart_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public TemporalPart_actualPropertySet.Match newMatch(final Object... parameters) {
    return TemporalPart_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TemporalPart_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TemporalPart_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TemporalPart_actualPropertySet INSTANCE = new TemporalPart_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TemporalPart_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
