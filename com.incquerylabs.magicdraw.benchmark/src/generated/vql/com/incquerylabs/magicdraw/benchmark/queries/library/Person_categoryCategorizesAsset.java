...
public final class Person_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<Person_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Person_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public Person_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_categoryCategorizesAsset.Match)) {
          Person_categoryCategorizesAsset.Match other = (Person_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public Person_categoryCategorizesAsset specification() {
      return Person_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static Person_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Person_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Person_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends Person_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see Person_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<Person_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static Person_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<Person_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Person_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Person_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Person_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public Person_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Person_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Person_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Person_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected Person_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return Person_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Person_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return Person_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_categoryCategorizesAsset.Matcher> querySpecification() {
      return Person_categoryCategorizesAsset.instance();
    }
  }
  
  private Person_categoryCategorizesAsset() {
   ...
   * 
   */
  public static Person_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected Person_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public Person_categoryCategorizesAsset.Matcher instantiate() {
    return Person_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public Person_categoryCategorizesAsset.Match newEmptyMatch() {
    return Person_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public Person_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return Person_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_categoryCategorizesAsset INSTANCE = new Person_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
