...
public final class ResourceRole_performsInContext extends BaseGeneratedEMFQuerySpecification<ResourceRole_performsInContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_performsInContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_performsInContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_performsInContext.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_performsInContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_performsInContext.Match)) {
          ResourceRole_performsInContext.Match other = (ResourceRole_performsInContext.Match) obj;
    ...
    @Override
    public ResourceRole_performsInContext specification() {
      return ResourceRole_performsInContext.instance();
    }
     ...
     * 
     */
    public static ResourceRole_performsInContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_performsInContext.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_performsInContext.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_performsInContext.Match {
    ...
    private static final class Immutable extends ResourceRole_performsInContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_performsInContext pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_performsInContext
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_performsInContext.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_performsInContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_performsInContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_performsInContext.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_performsInContext.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_performsInContext.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_performsInContext.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_performsInContext.Match> processor) {
     ...
     * 
     */
    public ResourceRole_performsInContext.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_performsInContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_performsInContext.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_performsInContext.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_performsInContext.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_performsInContext.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_performsInContext.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_performsInContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_performsInContext.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_performsInContext.Matcher> querySpecification() {
      return ResourceRole_performsInContext.instance();
    }
  }
  
  private ResourceRole_performsInContext() {
   ...
   * 
   */
  public static ResourceRole_performsInContext instance() {
    try{
  ...
  @Override
  protected ResourceRole_performsInContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_performsInContext.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_performsInContext.Matcher instantiate() {
    return ResourceRole_performsInContext.Matcher.create();
  }
  
  @Override
  public ResourceRole_performsInContext.Match newEmptyMatch() {
    return ResourceRole_performsInContext.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_performsInContext.Match newMatch(final Object... parameters) {
    return ResourceRole_performsInContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_performsInContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_performsInContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_performsInContext INSTANCE = new ResourceRole_performsInContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_performsInContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
