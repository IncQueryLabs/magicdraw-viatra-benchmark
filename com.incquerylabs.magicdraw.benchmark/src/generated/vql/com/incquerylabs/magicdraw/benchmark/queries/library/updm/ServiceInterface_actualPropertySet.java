...
public final class ServiceInterface_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ServiceInterface_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInterface_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInterface_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInterface_actualPropertySet.Match)) {
          ServiceInterface_actualPropertySet.Match other = (ServiceInterface_actualPropertySet.Match) obj;
    ...
    @Override
    public ServiceInterface_actualPropertySet specification() {
      return ServiceInterface_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ServiceInterface_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInterface_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceInterface_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceInterface_actualPropertySet.Match {
    ...
    private static final class Immutable extends ServiceInterface_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ServiceInterface_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInterface_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ServiceInterface_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInterface_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInterface_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInterface_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceInterface_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceInterface_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceInterface_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ServiceInterface_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceInterface_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceInterface_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceInterface_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceInterface_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceInterface_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ServiceInterface_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInterface_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceInterface_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInterface_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInterface_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInterface_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInterface_actualPropertySet.Matcher> querySpecification() {
      return ServiceInterface_actualPropertySet.instance();
    }
  }
  
  private ServiceInterface_actualPropertySet() {
   ...
   * 
   */
  public static ServiceInterface_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ServiceInterface_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInterface_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ServiceInterface_actualPropertySet.Matcher instantiate() {
    return ServiceInterface_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ServiceInterface_actualPropertySet.Match newEmptyMatch() {
    return ServiceInterface_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInterface_actualPropertySet.Match newMatch(final Object... parameters) {
    return ServiceInterface_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInterface_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInterface_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInterface_actualPropertySet INSTANCE = new ServiceInterface_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInterface_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
