...
public final class ActualResource extends BaseGeneratedEMFQuerySpecification<ActualResource.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResource pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualResource";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualResource.Match.parameterNames;
    }
    ...
    @Override
    public ActualResource.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualResource.Match)) {
          ActualResource.Match other = (ActualResource.Match) obj;
    ...
    @Override
    public ActualResource specification() {
      return ActualResource.instance();
    }
     ...
     * 
     */
    public static ActualResource.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualResource.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualResource.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualResource.Match {
    ...
    private static final class Immutable extends ActualResource.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResource pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualResource.Match> {
    /**
     ...
     * 
     */
    public static ActualResource.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualResource.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualResource.Matcher.class);
     ...
     * 
     */
    public Collection<ActualResource.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualResource.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualResource.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualResource.Match> processor) {
     ...
     * 
     */
    public ActualResource.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualResource.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualResource.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualResource.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualResource.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualResource.Match partialMatch) {
    ...
    @Override
    protected ActualResource.Match tupleToMatch(final Tuple t) {
      try {
          return ActualResource.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualResource.Match arrayToMatch(final Object[] match) {
      try {
          return ActualResource.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualResource.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualResource.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualResource.Matcher> querySpecification() {
      return ActualResource.instance();
    }
  }
   ...
   * 
   */
  public static ActualResource instance() {
    try{
  ...
  @Override
  protected ActualResource.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualResource.Matcher.on(engine);
  }
  
  @Override
  public ActualResource.Matcher instantiate() {
    return ActualResource.Matcher.create();
  }
  
  @Override
  public ActualResource.Match newEmptyMatch() {
    return ActualResource.Match.newEmptyMatch();
  }
  
  @Override
  public ActualResource.Match newMatch(final Object... parameters) {
    return ActualResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualResource} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualResource#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualResource INSTANCE = new ActualResource();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualResource.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualResource")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualResource");
