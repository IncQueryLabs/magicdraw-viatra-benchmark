...
public final class NodeParent_actualPropertySet extends BaseGeneratedEMFQuerySpecification<NodeParent_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_actualPropertySet.Match)) {
          NodeParent_actualPropertySet.Match other = (NodeParent_actualPropertySet.Match) obj;
    ...
    @Override
    public NodeParent_actualPropertySet specification() {
      return NodeParent_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static NodeParent_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeParent_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeParent_actualPropertySet.Match {
    ...
    private static final class Immutable extends NodeParent_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see NodeParent_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeParent_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeParent_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NodeParent_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public NodeParent_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NodeParent_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeParent_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeParent_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected NodeParent_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeParent_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_actualPropertySet.Matcher> querySpecification() {
      return NodeParent_actualPropertySet.instance();
    }
  }
  
  private NodeParent_actualPropertySet() {
   ...
   * 
   */
  public static NodeParent_actualPropertySet instance() {
    try{
  ...
  @Override
  protected NodeParent_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_actualPropertySet.Matcher instantiate() {
    return NodeParent_actualPropertySet.Matcher.create();
  }
  
  @Override
  public NodeParent_actualPropertySet.Match newEmptyMatch() {
    return NodeParent_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_actualPropertySet.Match newMatch(final Object... parameters) {
    return NodeParent_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_actualPropertySet INSTANCE = new NodeParent_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
