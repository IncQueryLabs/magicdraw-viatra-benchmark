...
public final class EnterprisePhase_startDate extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_startDate.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_startDate.Match)) {
          EnterprisePhase_startDate.Match other = (EnterprisePhase_startDate.Match) obj;
    ...
    @Override
    public EnterprisePhase_startDate specification() {
      return EnterprisePhase_startDate.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_startDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_startDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_startDate.Match {
    ...
    private static final class Immutable extends EnterprisePhase_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_startDate pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_startDate.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_startDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_startDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_startDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_startDate.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_startDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_startDate.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_startDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_startDate.Matcher> querySpecification() {
      return EnterprisePhase_startDate.instance();
    }
  }
  
  private EnterprisePhase_startDate() {
   ...
   * 
   */
  public static EnterprisePhase_startDate instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_startDate.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_startDate.Matcher instantiate() {
    return EnterprisePhase_startDate.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_startDate.Match newEmptyMatch() {
    return EnterprisePhase_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_startDate.Match newMatch(final Object... parameters) {
    return EnterprisePhase_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_startDate INSTANCE = new EnterprisePhase_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
