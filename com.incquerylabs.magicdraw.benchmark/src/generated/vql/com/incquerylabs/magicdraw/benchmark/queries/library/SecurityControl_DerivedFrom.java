...
public final class SecurityControl_DerivedFrom extends BaseGeneratedEMFQuerySpecification<SecurityControl_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_DerivedFrom.Match)) {
          SecurityControl_DerivedFrom.Match other = (SecurityControl_DerivedFrom.Match) obj;
    ...
    @Override
    public SecurityControl_DerivedFrom specification() {
      return SecurityControl_DerivedFrom.instance();
    }
     ...
     * 
     */
    public static SecurityControl_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityControl_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControl_DerivedFrom.Match {
    ...
    private static final class Immutable extends SecurityControl_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityControl_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityControl_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityControl_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public SecurityControl_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityControl_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityControl_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityControl_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControl_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_DerivedFrom.Matcher> querySpecification() {
      return SecurityControl_DerivedFrom.instance();
    }
  }
  
  private SecurityControl_DerivedFrom() {
   ...
   * 
   */
  public static SecurityControl_DerivedFrom instance() {
    try{
  ...
  @Override
  protected SecurityControl_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_DerivedFrom.Matcher instantiate() {
    return SecurityControl_DerivedFrom.Matcher.create();
  }
  
  @Override
  public SecurityControl_DerivedFrom.Match newEmptyMatch() {
    return SecurityControl_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_DerivedFrom.Match newMatch(final Object... parameters) {
    return SecurityControl_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_DerivedFrom} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_DerivedFrom#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_DerivedFrom INSTANCE = new SecurityControl_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
