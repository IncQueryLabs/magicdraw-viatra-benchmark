...
public final class ParticipantProperty extends BaseGeneratedEMFQuerySpecification<ParticipantProperty.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ParticipantProperty.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ParticipantProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<ParticipantProperty.Match> {
     ...
     * 
     */
    public Collection<ParticipantProperty.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ParticipantProperty.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ParticipantProperty.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super ParticipantProperty.Match> processor) {
     ...
     * 
     */
    public ParticipantProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return ParticipantProperty.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ParticipantProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ParticipantProperty.Match partialMatch) {
    ...
    protected ParticipantProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ParticipantProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ParticipantProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ParticipantProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ParticipantProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ParticipantProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ParticipantProperty.Match newMatch(final Object... parameters) {
    return ParticipantProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
