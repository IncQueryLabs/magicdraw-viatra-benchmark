...
public final class BusinessRequirement extends BaseGeneratedEMFQuerySpecification<BusinessRequirement.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static BusinessRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static BusinessRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<BusinessRequirement.Match> {
     ...
     * 
     */
    public Collection<BusinessRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<BusinessRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<BusinessRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype, final Consumer<? super BusinessRequirement.Match> processor) {
     ...
     * 
     */
    public BusinessRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
      return BusinessRequirement.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final BusinessRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final BusinessRequirement.Match partialMatch) {
    ...
    protected BusinessRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return BusinessRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected BusinessRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return BusinessRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected BusinessRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BusinessRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public BusinessRequirement.Match newMatch(final Object... parameters) {
    return BusinessRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
