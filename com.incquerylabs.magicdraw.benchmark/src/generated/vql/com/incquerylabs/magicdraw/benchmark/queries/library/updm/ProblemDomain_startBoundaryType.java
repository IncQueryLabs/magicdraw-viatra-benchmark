...
public final class ProblemDomain_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ProblemDomain_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_startBoundaryType.Match)) {
          ProblemDomain_startBoundaryType.Match other = (ProblemDomain_startBoundaryType.Match) obj;
    ...
    @Override
    public ProblemDomain_startBoundaryType specification() {
      return ProblemDomain_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_startBoundaryType.Match {
    ...
    private static final class Immutable extends ProblemDomain_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_startBoundaryType.Matcher> querySpecification() {
      return ProblemDomain_startBoundaryType.instance();
    }
  }
  
  private ProblemDomain_startBoundaryType() {
   ...
   * 
   */
  public static ProblemDomain_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ProblemDomain_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_startBoundaryType.Matcher instantiate() {
    return ProblemDomain_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ProblemDomain_startBoundaryType.Match newEmptyMatch() {
    return ProblemDomain_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_startBoundaryType.Match newMatch(final Object... parameters) {
    return ProblemDomain_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_startBoundaryType INSTANCE = new ProblemDomain_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
