...
public final class Software_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Software_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Software_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Software_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_requiredEnvironment.Match)) {
          Software_requiredEnvironment.Match other = (Software_requiredEnvironment.Match) obj;
    ...
    @Override
    public Software_requiredEnvironment specification() {
      return Software_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Software_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Software_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Software_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Software_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Software_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Software_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Software_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Software_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Software_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Software_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_requiredEnvironment.Matcher> querySpecification() {
      return Software_requiredEnvironment.instance();
    }
  }
  
  private Software_requiredEnvironment() {
   ...
   * 
   */
  public static Software_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Software_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Software_requiredEnvironment.Matcher instantiate() {
    return Software_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Software_requiredEnvironment.Match newEmptyMatch() {
    return Software_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Software_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Software_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_requiredEnvironment INSTANCE = new Software_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
