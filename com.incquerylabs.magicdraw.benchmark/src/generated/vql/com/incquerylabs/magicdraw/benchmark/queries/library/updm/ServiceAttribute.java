...
public final class ServiceAttribute extends BaseGeneratedEMFQuerySpecification<ServiceAttribute.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAttribute.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAttribute.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAttribute.Match)) {
          ServiceAttribute.Match other = (ServiceAttribute.Match) obj;
    ...
    @Override
    public ServiceAttribute specification() {
      return ServiceAttribute.instance();
    }
     ...
     * 
     */
    public static ServiceAttribute.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAttribute.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ServiceAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ServiceAttribute.Match {
    ...
    private static final class Immutable extends ServiceAttribute.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute pattern,
   ...
   * 
   * @see Match
   * @see ServiceAttribute
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAttribute.Match> {
    /**
     ...
     * 
     */
    public static ServiceAttribute.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAttribute.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAttribute.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAttribute.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ServiceAttribute.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ServiceAttribute.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ServiceAttribute.Match> processor) {
     ...
     * 
     */
    public ServiceAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ServiceAttribute.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceAttribute.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ServiceAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ServiceAttribute.Match partialMatch) {
    ...
    @Override
    protected ServiceAttribute.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAttribute.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ServiceAttribute.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAttribute.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAttribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAttribute.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAttribute.Matcher> querySpecification() {
      return ServiceAttribute.instance();
    }
  }
   ...
   * 
   */
  public static ServiceAttribute instance() {
    try{
  ...
  @Override
  protected ServiceAttribute.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAttribute.Matcher.on(engine);
  }
  
  @Override
  public ServiceAttribute.Matcher instantiate() {
    return ServiceAttribute.Matcher.create();
  }
  
  @Override
  public ServiceAttribute.Match newEmptyMatch() {
    return ServiceAttribute.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAttribute.Match newMatch(final Object... parameters) {
    return ServiceAttribute.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAttribute} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAttribute#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAttribute INSTANCE = new ServiceAttribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAttribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ServiceAttribute");
