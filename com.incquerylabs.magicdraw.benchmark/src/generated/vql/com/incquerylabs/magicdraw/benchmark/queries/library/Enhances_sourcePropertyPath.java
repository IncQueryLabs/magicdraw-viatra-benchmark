...
public final class Enhances_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<Enhances_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Enhances_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Enhances_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Enhances_sourcePropertyPath.Match)) {
          Enhances_sourcePropertyPath.Match other = (Enhances_sourcePropertyPath.Match) obj;
    ...
    @Override
    public Enhances_sourcePropertyPath specification() {
      return Enhances_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static Enhances_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Enhances_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Enhances_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Enhances_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends Enhances_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Enhances_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Enhances_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Enhances_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Enhances_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Enhances_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Enhances_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Enhances_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Enhances_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Enhances_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public Enhances_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Enhances_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Enhances_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Enhances_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Enhances_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Enhances_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected Enhances_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Enhances_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Enhances_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Enhances_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Enhances_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Enhances_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Enhances_sourcePropertyPath.Matcher> querySpecification() {
      return Enhances_sourcePropertyPath.instance();
    }
  }
  
  private Enhances_sourcePropertyPath() {
   ...
   * 
   */
  public static Enhances_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected Enhances_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Enhances_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Enhances_sourcePropertyPath.Matcher instantiate() {
    return Enhances_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public Enhances_sourcePropertyPath.Match newEmptyMatch() {
    return Enhances_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Enhances_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return Enhances_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Enhances_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Enhances_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Enhances_sourcePropertyPath INSTANCE = new Enhances_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Enhances_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
