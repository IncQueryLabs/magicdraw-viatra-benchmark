...
public final class Competence_propertySet extends BaseGeneratedEMFQuerySpecification<Competence_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Competence_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Competence_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Competence_propertySet.Match)) {
          Competence_propertySet.Match other = (Competence_propertySet.Match) obj;
    ...
    @Override
    public Competence_propertySet specification() {
      return Competence_propertySet.instance();
    }
     ...
     * 
     */
    public static Competence_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Competence_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Competence_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Competence_propertySet.Match {
    ...
    private static final class Immutable extends Competence_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Competence_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Competence_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Competence_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Competence_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Competence_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Competence_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Competence_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Competence_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Competence_propertySet.Match> processor) {
     ...
     * 
     */
    public Competence_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Competence_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Competence_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Competence_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Competence_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Competence_propertySet.Match partialMatch) {
    ...
    @Override
    protected Competence_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Competence_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Competence_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Competence_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Competence_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Competence_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Competence_propertySet.Matcher> querySpecification() {
      return Competence_propertySet.instance();
    }
  }
  
  private Competence_propertySet() {
   ...
   * 
   */
  public static Competence_propertySet instance() {
    try{
  ...
  @Override
  protected Competence_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Competence_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Competence_propertySet.Matcher instantiate() {
    return Competence_propertySet.Matcher.create();
  }
  
  @Override
  public Competence_propertySet.Match newEmptyMatch() {
    return Competence_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Competence_propertySet.Match newMatch(final Object... parameters) {
    return Competence_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Competence_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Competence_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Competence_propertySet INSTANCE = new Competence_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Competence_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
