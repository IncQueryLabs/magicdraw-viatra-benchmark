...
public final class FillsPost extends BaseGeneratedEMFQuerySpecification<FillsPost.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost";
    }
     ...
     * 
     */
    public static FillsPost.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FillsPost.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost pattern,
  ...
  public static class Matcher extends BaseMatcher<FillsPost.Match> {
     ...
     * 
     */
    public Collection<FillsPost.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FillsPost.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FillsPost.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FillsPost.Match> processor) {
     ...
     * 
     */
    public FillsPost.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final FillsPost.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final FillsPost.Match partialMatch) {
    ...
    protected FillsPost.Match tupleToMatch(final Tuple t) {
      try {
          return FillsPost.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected FillsPost.Match arrayToMatch(final Object[] match) {
      try {
          return FillsPost.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected FillsPost.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FillsPost.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public FillsPost.Match newMatch(final Object... parameters) {
    return FillsPost.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "FillsPost")
