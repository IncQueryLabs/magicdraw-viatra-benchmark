...
public final class StructuralPart_measurementSet extends BaseGeneratedEMFQuerySpecification<StructuralPart_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return StructuralPart_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public StructuralPart_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StructuralPart_measurementSet.Match)) {
          StructuralPart_measurementSet.Match other = (StructuralPart_measurementSet.Match) obj;
    ...
    @Override
    public StructuralPart_measurementSet specification() {
      return StructuralPart_measurementSet.instance();
    }
     ...
     * 
     */
    public static StructuralPart_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static StructuralPart_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static StructuralPart_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends StructuralPart_measurementSet.Match {
    ...
    private static final class Immutable extends StructuralPart_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see StructuralPart_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<StructuralPart_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static StructuralPart_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StructuralPart_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StructuralPart_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<StructuralPart_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<StructuralPart_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<StructuralPart_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super StructuralPart_measurementSet.Match> processor) {
     ...
     * 
     */
    public StructuralPart_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return StructuralPart_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final StructuralPart_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final StructuralPart_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final StructuralPart_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final StructuralPart_measurementSet.Match partialMatch) {
    ...
    @Override
    protected StructuralPart_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return StructuralPart_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected StructuralPart_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return StructuralPart_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StructuralPart_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StructuralPart_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StructuralPart_measurementSet.Matcher> querySpecification() {
      return StructuralPart_measurementSet.instance();
    }
  }
  
  private StructuralPart_measurementSet() {
   ...
   * 
   */
  public static StructuralPart_measurementSet instance() {
    try{
  ...
  @Override
  protected StructuralPart_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return StructuralPart_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public StructuralPart_measurementSet.Matcher instantiate() {
    return StructuralPart_measurementSet.Matcher.create();
  }
  
  @Override
  public StructuralPart_measurementSet.Match newEmptyMatch() {
    return StructuralPart_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public StructuralPart_measurementSet.Match newMatch(final Object... parameters) {
    return StructuralPart_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StructuralPart_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StructuralPart_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StructuralPart_measurementSet INSTANCE = new StructuralPart_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StructuralPart_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
