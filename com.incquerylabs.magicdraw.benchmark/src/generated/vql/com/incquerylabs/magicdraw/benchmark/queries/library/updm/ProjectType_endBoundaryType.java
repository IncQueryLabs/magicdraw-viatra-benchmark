...
public final class ProjectType_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectType_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectType_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectType_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectType_endBoundaryType.Match)) {
          ProjectType_endBoundaryType.Match other = (ProjectType_endBoundaryType.Match) obj;
    ...
    @Override
    public ProjectType_endBoundaryType specification() {
      return ProjectType_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectType_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectType_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectType_endBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectType_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectType_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectType_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectType_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectType_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectType_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectType_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectType_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectType_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectType_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectType_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectType_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectType_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectType_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectType_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectType_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectType_endBoundaryType.Matcher> querySpecification() {
      return ProjectType_endBoundaryType.instance();
    }
  }
  
  private ProjectType_endBoundaryType() {
   ...
   * 
   */
  public static ProjectType_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectType_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectType_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectType_endBoundaryType.Matcher instantiate() {
    return ProjectType_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectType_endBoundaryType.Match newEmptyMatch() {
    return ProjectType_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectType_endBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectType_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectType_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectType_endBoundaryType INSTANCE = new ProjectType_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectType_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
