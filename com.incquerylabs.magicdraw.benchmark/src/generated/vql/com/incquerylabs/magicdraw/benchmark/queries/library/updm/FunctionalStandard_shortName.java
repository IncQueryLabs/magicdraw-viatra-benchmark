...
public final class FunctionalStandard_shortName extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_shortName.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_shortName pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_shortName";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_shortName.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_shortName.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_shortName.Match)) {
          FunctionalStandard_shortName.Match other = (FunctionalStandard_shortName.Match) obj;
    ...
    @Override
    public FunctionalStandard_shortName specification() {
      return FunctionalStandard_shortName.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_shortName.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_shortName.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static FunctionalStandard_shortName.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends FunctionalStandard_shortName.Match {
    ...
    private static final class Immutable extends FunctionalStandard_shortName.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_shortName pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_shortName
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_shortName.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_shortName.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_shortName.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_shortName.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_shortName.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<FunctionalStandard_shortName.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<FunctionalStandard_shortName.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super FunctionalStandard_shortName.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_shortName.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return FunctionalStandard_shortName.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_shortName.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_shortName.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final FunctionalStandard_shortName.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final FunctionalStandard_shortName.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_shortName.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected FunctionalStandard_shortName.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_shortName.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_shortName.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_shortName.Matcher> querySpecification() {
      return FunctionalStandard_shortName.instance();
    }
  }
  
  private FunctionalStandard_shortName() {
   ...
   * 
   */
  public static FunctionalStandard_shortName instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_shortName.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_shortName.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_shortName.Matcher instantiate() {
    return FunctionalStandard_shortName.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_shortName.Match newEmptyMatch() {
    return FunctionalStandard_shortName.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_shortName.Match newMatch(final Object... parameters) {
    return FunctionalStandard_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_shortName} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_shortName#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_shortName INSTANCE = new FunctionalStandard_shortName();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_shortName.GeneratedPQuery INSTANCE = new GeneratedPQuery();
