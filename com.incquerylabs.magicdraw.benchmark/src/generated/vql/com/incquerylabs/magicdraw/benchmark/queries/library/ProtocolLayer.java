...
public final class ProtocolLayer extends BaseGeneratedEMFQuerySpecification<ProtocolLayer.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolLayer.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolLayer.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolLayer.Match)) {
          ProtocolLayer.Match other = (ProtocolLayer.Match) obj;
    ...
    @Override
    public ProtocolLayer specification() {
      return ProtocolLayer.instance();
    }
     ...
     * 
     */
    public static ProtocolLayer.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolLayer.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProtocolLayer.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProtocolLayer.Match {
    ...
    private static final class Immutable extends ProtocolLayer.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolLayer.Match> {
    /**
     ...
     * 
     */
    public static ProtocolLayer.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolLayer.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolLayer.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolLayer.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProtocolLayer.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProtocolLayer.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProtocolLayer.Match> processor) {
     ...
     * 
     */
    public ProtocolLayer.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProtocolLayer.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProtocolLayer.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProtocolLayer.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProtocolLayer.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProtocolLayer.Match partialMatch) {
    ...
    @Override
    protected ProtocolLayer.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolLayer.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProtocolLayer.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolLayer.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolLayer.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolLayer.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolLayer.Matcher> querySpecification() {
      return ProtocolLayer.instance();
    }
  }
   ...
   * 
   */
  public static ProtocolLayer instance() {
    try{
  ...
  @Override
  protected ProtocolLayer.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolLayer.Matcher.on(engine);
  }
  
  @Override
  public ProtocolLayer.Matcher instantiate() {
    return ProtocolLayer.Matcher.create();
  }
  
  @Override
  public ProtocolLayer.Match newEmptyMatch() {
    return ProtocolLayer.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolLayer.Match newMatch(final Object... parameters) {
    return ProtocolLayer.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolLayer} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolLayer#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolLayer INSTANCE = new ProtocolLayer();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolLayer.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ProtocolLayer")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ProtocolLayer");
