...
public final class Project_part extends BaseGeneratedEMFQuerySpecification<Project_part.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_part pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_part";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_part.Match.parameterNames;
    }
    ...
    @Override
    public Project_part.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_part.Match)) {
          Project_part.Match other = (Project_part.Match) obj;
    ...
    @Override
    public Project_part specification() {
      return Project_part.instance();
    }
     ...
     * 
     */
    public static Project_part.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_part.Match newMutableMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public static Project_part.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Project_part.Match {
    ...
    private static final class Immutable extends Project_part.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_part pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Project_part.Match> {
    /**
     ...
     * 
     */
    public static Project_part.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_part.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_part.Matcher.class);
     ...
     * 
     */
    public Collection<Project_part.Match> getAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Project_part.Match> streamAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Project_part.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue, final Consumer<? super Project_part.Match> processor) {
     ...
     * 
     */
    public Project_part.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return Project_part.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Project_part.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Project_part.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Project_part.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Project_part.Match partialMatch) {
    ...
    @Override
    protected Project_part.Match tupleToMatch(final Tuple t) {
      try {
          return Project_part.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Project_part.Match arrayToMatch(final Object[] match) {
      try {
          return Project_part.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_part.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_part.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_part.Matcher> querySpecification() {
      return Project_part.instance();
    }
  }
  
  private Project_part() {
   ...
   * 
   */
  public static Project_part instance() {
    try{
  ...
  @Override
  protected Project_part.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_part.Matcher.on(engine);
  }
  
  @Override
  public Project_part.Matcher instantiate() {
    return Project_part.Matcher.create();
  }
  
  @Override
  public Project_part.Match newEmptyMatch() {
    return Project_part.Match.newEmptyMatch();
  }
  
  @Override
  public Project_part.Match newMatch(final Object... parameters) {
    return Project_part.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_part} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_part#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_part INSTANCE = new Project_part();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_part.GeneratedPQuery INSTANCE = new GeneratedPQuery();
