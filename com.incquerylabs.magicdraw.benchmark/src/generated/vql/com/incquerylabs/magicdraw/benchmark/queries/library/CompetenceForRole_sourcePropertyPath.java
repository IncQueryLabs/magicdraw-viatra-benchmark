...
public final class CompetenceForRole_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<CompetenceForRole_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceForRole_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceForRole_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceForRole_sourcePropertyPath.Match)) {
          CompetenceForRole_sourcePropertyPath.Match other = (CompetenceForRole_sourcePropertyPath.Match) obj;
    ...
    @Override
    public CompetenceForRole_sourcePropertyPath specification() {
      return CompetenceForRole_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static CompetenceForRole_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceForRole_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static CompetenceForRole_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CompetenceForRole_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends CompetenceForRole_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see CompetenceForRole_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceForRole_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static CompetenceForRole_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceForRole_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceForRole_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceForRole_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<CompetenceForRole_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<CompetenceForRole_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super CompetenceForRole_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public CompetenceForRole_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return CompetenceForRole_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceForRole_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceForRole_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final CompetenceForRole_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final CompetenceForRole_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected CompetenceForRole_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceForRole_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected CompetenceForRole_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceForRole_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceForRole_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceForRole_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceForRole_sourcePropertyPath.Matcher> querySpecification() {
      return CompetenceForRole_sourcePropertyPath.instance();
    }
  }
  
  private CompetenceForRole_sourcePropertyPath() {
   ...
   * 
   */
  public static CompetenceForRole_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected CompetenceForRole_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceForRole_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public CompetenceForRole_sourcePropertyPath.Matcher instantiate() {
    return CompetenceForRole_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public CompetenceForRole_sourcePropertyPath.Match newEmptyMatch() {
    return CompetenceForRole_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceForRole_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return CompetenceForRole_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceForRole_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceForRole_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceForRole_sourcePropertyPath INSTANCE = new CompetenceForRole_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceForRole_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
