...
public final class OrganizationalResource_actsUpon extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_actsUpon.Match)) {
          OrganizationalResource_actsUpon.Match other = (OrganizationalResource_actsUpon.Match) obj;
    ...
    @Override
    public OrganizationalResource_actsUpon specification() {
      return OrganizationalResource_actsUpon.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_actsUpon.Match {
    ...
    private static final class Immutable extends OrganizationalResource_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_actsUpon.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_actsUpon.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_actsUpon.Matcher> querySpecification() {
      return OrganizationalResource_actsUpon.instance();
    }
  }
  
  private OrganizationalResource_actsUpon() {
   ...
   * 
   */
  public static OrganizationalResource_actsUpon instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_actsUpon.Matcher instantiate() {
    return OrganizationalResource_actsUpon.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_actsUpon.Match newEmptyMatch() {
    return OrganizationalResource_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_actsUpon.Match newMatch(final Object... parameters) {
    return OrganizationalResource_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_actsUpon INSTANCE = new OrganizationalResource_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
