...
public final class AbstractRequirement_Text extends BaseGeneratedEMFQuerySpecification<AbstractRequirement_Text.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static AbstractRequirement_Text.Match newMutableMatch(final NamedElement pElement, final String pValue) {
     ...
     * 
     */
    public static AbstractRequirement_Text.Match newMatch(final NamedElement pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<AbstractRequirement_Text.Match> {
     ...
     * 
     */
    public Collection<AbstractRequirement_Text.Match> getAllMatches(final NamedElement pElement, final String pValue) {
     ...
     * 
     */
    public Stream<AbstractRequirement_Text.Match> streamAllMatches(final NamedElement pElement, final String pValue) {
     ...
     * 
     */
    public Optional<AbstractRequirement_Text.Match> getOneArbitraryMatch(final NamedElement pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final String pValue, final Consumer<? super AbstractRequirement_Text.Match> processor) {
     ...
     * 
     */
    public AbstractRequirement_Text.Match newMatch(final NamedElement pElement, final String pValue) {
      return AbstractRequirement_Text.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final AbstractRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final AbstractRequirement_Text.Match partialMatch) {
    ...
    protected AbstractRequirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return AbstractRequirement_Text.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected AbstractRequirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return AbstractRequirement_Text.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected AbstractRequirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AbstractRequirement_Text.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public AbstractRequirement_Text.Match newMatch(final Object... parameters) {
    return AbstractRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (java.lang.String) parameters[1]);
  }
