...
public final class ConstraintBlock_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ConstraintBlock_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ConstraintBlock_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ConstraintBlock_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConstraintBlock_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public ConstraintBlock_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConstraintBlock_isEncapsulated.Match)) {
          ConstraintBlock_isEncapsulated.Match other = (ConstraintBlock_isEncapsulated.Match) obj;
    ...
    @Override
    public ConstraintBlock_isEncapsulated specification() {
     ...
     * 
     */
    public static ConstraintBlock_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConstraintBlock_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ConstraintBlock_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ConstraintBlock_isEncapsulated.Match {
    ...
    private static final class Immutable extends ConstraintBlock_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ConstraintBlock_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see ConstraintBlock_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<ConstraintBlock_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static ConstraintBlock_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConstraintBlock_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConstraintBlock_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<ConstraintBlock_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ConstraintBlock_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ConstraintBlock_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ConstraintBlock_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ConstraintBlock_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ConstraintBlock_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ConstraintBlock_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ConstraintBlock_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ConstraintBlock_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ConstraintBlock_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected ConstraintBlock_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ConstraintBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ConstraintBlock_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ConstraintBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConstraintBlock_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConstraintBlock_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConstraintBlock_isEncapsulated.Matcher> querySpecification() {
      return ConstraintBlock_isEncapsulated.instance();
    }
  }
  
  private ConstraintBlock_isEncapsulated() {
   ...
   * 
   */
  public static ConstraintBlock_isEncapsulated instance() {
    try{
  ...
  @Override
  protected ConstraintBlock_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConstraintBlock_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public ConstraintBlock_isEncapsulated.Matcher instantiate() {
    return ConstraintBlock_isEncapsulated.Matcher.create();
  }
  
  @Override
  public ConstraintBlock_isEncapsulated.Match newEmptyMatch() {
    return ConstraintBlock_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public ConstraintBlock_isEncapsulated.Match newMatch(final Object... parameters) {
    return ConstraintBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConstraintBlock_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConstraintBlock_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConstraintBlock_isEncapsulated INSTANCE = new ConstraintBlock_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConstraintBlock_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ConstraintBlock(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ConstraintBlock.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
