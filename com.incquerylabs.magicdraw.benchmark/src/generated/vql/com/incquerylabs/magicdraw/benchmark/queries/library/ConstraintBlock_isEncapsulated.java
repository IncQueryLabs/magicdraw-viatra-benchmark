...
public final class ConstraintBlock_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ConstraintBlock_isEncapsulated.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ConstraintBlock_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public static ConstraintBlock_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
  ...
  public static class Matcher extends BaseMatcher<ConstraintBlock_isEncapsulated.Match> {
     ...
     * 
     */
    public Collection<ConstraintBlock_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public Stream<ConstraintBlock_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public Optional<ConstraintBlock_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue, final Consumer<? super ConstraintBlock_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ConstraintBlock_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
      return ConstraintBlock_isEncapsulated.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Boolean> streamAllValuesOfValue(final ConstraintBlock_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfValue(final ConstraintBlock_isEncapsulated.Match partialMatch) {
    ...
    protected ConstraintBlock_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ConstraintBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Boolean) t.get(POSITION_VALUE));
    ...
    protected ConstraintBlock_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ConstraintBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Boolean) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected ConstraintBlock_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConstraintBlock_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Boolean) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ConstraintBlock_isEncapsulated.Match newMatch(final Object... parameters) {
    return ConstraintBlock_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.Boolean) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ConstraintBlock(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), ConstraintBlock.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "isEncapsulated", taggedValue)
