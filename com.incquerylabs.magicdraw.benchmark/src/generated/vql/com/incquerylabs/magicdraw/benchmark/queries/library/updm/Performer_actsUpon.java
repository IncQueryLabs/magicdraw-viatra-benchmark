...
public final class Performer_actsUpon extends BaseGeneratedEMFQuerySpecification<Performer_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public Performer_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_actsUpon.Match)) {
          Performer_actsUpon.Match other = (Performer_actsUpon.Match) obj;
    ...
    @Override
    public Performer_actsUpon specification() {
      return Performer_actsUpon.instance();
    }
     ...
     * 
     */
    public static Performer_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_actsUpon.Match {
    ...
    private static final class Immutable extends Performer_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see Performer_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static Performer_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_actsUpon.Match> processor) {
     ...
     * 
     */
    public Performer_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_actsUpon.Match partialMatch) {
    ...
    @Override
    protected Performer_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_actsUpon.Matcher> querySpecification() {
      return Performer_actsUpon.instance();
    }
  }
  
  private Performer_actsUpon() {
   ...
   * 
   */
  public static Performer_actsUpon instance() {
    try{
  ...
  @Override
  protected Performer_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public Performer_actsUpon.Matcher instantiate() {
    return Performer_actsUpon.Matcher.create();
  }
  
  @Override
  public Performer_actsUpon.Match newEmptyMatch() {
    return Performer_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_actsUpon.Match newMatch(final Object... parameters) {
    return Performer_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_actsUpon INSTANCE = new Performer_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
