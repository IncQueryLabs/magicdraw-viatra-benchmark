...
public final class Competence_conformsTo extends BaseGeneratedEMFQuerySpecification<Competence_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Competence_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Competence_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Competence_conformsTo.Match)) {
          Competence_conformsTo.Match other = (Competence_conformsTo.Match) obj;
    ...
    @Override
    public Competence_conformsTo specification() {
      return Competence_conformsTo.instance();
    }
     ...
     * 
     */
    public static Competence_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Competence_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Competence_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Competence_conformsTo.Match {
    ...
    private static final class Immutable extends Competence_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Competence_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Competence_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Competence_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Competence_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Competence_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Competence_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Competence_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Competence_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Competence_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Competence_conformsTo.Match> processor) {
     ...
     * 
     */
    public Competence_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Competence_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Competence_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Competence_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Competence_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Competence_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Competence_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Competence_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Competence_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Competence_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Competence_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Competence_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Competence_conformsTo.Matcher> querySpecification() {
      return Competence_conformsTo.instance();
    }
  }
  
  private Competence_conformsTo() {
   ...
   * 
   */
  public static Competence_conformsTo instance() {
    try{
  ...
  @Override
  protected Competence_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Competence_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Competence_conformsTo.Matcher instantiate() {
    return Competence_conformsTo.Matcher.create();
  }
  
  @Override
  public Competence_conformsTo.Match newEmptyMatch() {
    return Competence_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Competence_conformsTo.Match newMatch(final Object... parameters) {
    return Competence_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Competence_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Competence_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Competence_conformsTo INSTANCE = new Competence_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Competence_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
