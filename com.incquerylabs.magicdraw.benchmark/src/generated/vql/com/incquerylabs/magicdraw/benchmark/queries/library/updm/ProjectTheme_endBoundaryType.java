...
public final class ProjectTheme_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectTheme_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectTheme_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectTheme_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectTheme_endBoundaryType.Match)) {
          ProjectTheme_endBoundaryType.Match other = (ProjectTheme_endBoundaryType.Match) obj;
    ...
    @Override
    public ProjectTheme_endBoundaryType specification() {
      return ProjectTheme_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectTheme_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectTheme_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectTheme_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectTheme_endBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectTheme_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectTheme_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectTheme_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectTheme_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectTheme_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectTheme_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectTheme_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectTheme_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectTheme_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectTheme_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectTheme_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectTheme_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectTheme_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectTheme_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectTheme_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectTheme_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectTheme_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectTheme_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectTheme_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectTheme_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectTheme_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectTheme_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectTheme_endBoundaryType.Matcher> querySpecification() {
      return ProjectTheme_endBoundaryType.instance();
    }
  }
  
  private ProjectTheme_endBoundaryType() {
   ...
   * 
   */
  public static ProjectTheme_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectTheme_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectTheme_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectTheme_endBoundaryType.Matcher instantiate() {
    return ProjectTheme_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectTheme_endBoundaryType.Match newEmptyMatch() {
    return ProjectTheme_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectTheme_endBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectTheme_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectTheme_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectTheme_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectTheme_endBoundaryType INSTANCE = new ProjectTheme_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectTheme_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
