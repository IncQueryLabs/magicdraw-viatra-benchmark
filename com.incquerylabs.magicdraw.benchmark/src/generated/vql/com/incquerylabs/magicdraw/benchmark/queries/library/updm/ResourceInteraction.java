...
public final class ResourceInteraction extends BaseGeneratedEMFQuerySpecification<ResourceInteraction.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceInteraction pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceInteraction";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceInteraction.Match.parameterNames;
    }
    ...
    @Override
    public ResourceInteraction.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceInteraction.Match)) {
          ResourceInteraction.Match other = (ResourceInteraction.Match) obj;
    ...
    @Override
    public ResourceInteraction specification() {
      return ResourceInteraction.instance();
    }
     ...
     * 
     */
    public static ResourceInteraction.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceInteraction.Match newMutableMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResourceInteraction.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResourceInteraction.Match {
    ...
    private static final class Immutable extends ResourceInteraction.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceInteraction pattern,
   ...
   * 
   * @see Match
   * @see ResourceInteraction
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceInteraction.Match> {
    /**
     ...
     * 
     */
    public static ResourceInteraction.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceInteraction.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceInteraction.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceInteraction.Match> getAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResourceInteraction.Match> streamAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResourceInteraction.Match> getOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResourceInteraction.Match> processor) {
     ...
     * 
     */
    public ResourceInteraction.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResourceInteraction.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final ResourceInteraction.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final ResourceInteraction.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResourceInteraction.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResourceInteraction.Match partialMatch) {
    ...
    @Override
    protected ResourceInteraction.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceInteraction.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResourceInteraction.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceInteraction.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceInteraction.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceInteraction.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceInteraction.Matcher> querySpecification() {
      return ResourceInteraction.instance();
    }
  }
  
  private ResourceInteraction() {
   ...
   * 
   */
  public static ResourceInteraction instance() {
    try{
  ...
  @Override
  protected ResourceInteraction.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceInteraction.Matcher.on(engine);
  }
  
  @Override
  public ResourceInteraction.Matcher instantiate() {
    return ResourceInteraction.Matcher.create();
  }
  
  @Override
  public ResourceInteraction.Match newEmptyMatch() {
    return ResourceInteraction.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceInteraction.Match newMatch(final Object... parameters) {
    return ResourceInteraction.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceInteraction} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceInteraction#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceInteraction INSTANCE = new ResourceInteraction();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceInteraction.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ResourceInteraction");
