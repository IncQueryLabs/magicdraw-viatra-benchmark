...
public final class Energy_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Energy_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Energy_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_actualPropertySet.Match)) {
          Energy_actualPropertySet.Match other = (Energy_actualPropertySet.Match) obj;
    ...
    @Override
    public Energy_actualPropertySet specification() {
      return Energy_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Energy_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_actualPropertySet.Match {
    ...
    private static final class Immutable extends Energy_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Energy_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Energy_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Energy_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Energy_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_actualPropertySet.Matcher> querySpecification() {
      return Energy_actualPropertySet.instance();
    }
  }
  
  private Energy_actualPropertySet() {
   ...
   * 
   */
  public static Energy_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Energy_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Energy_actualPropertySet.Matcher instantiate() {
    return Energy_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Energy_actualPropertySet.Match newEmptyMatch() {
    return Energy_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_actualPropertySet.Match newMatch(final Object... parameters) {
    return Energy_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_actualPropertySet INSTANCE = new Energy_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
