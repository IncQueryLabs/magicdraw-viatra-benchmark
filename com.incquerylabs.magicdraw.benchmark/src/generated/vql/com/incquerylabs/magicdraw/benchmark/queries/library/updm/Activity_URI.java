...
public final class Activity_URI extends BaseGeneratedEMFQuerySpecification<Activity_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Activity_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Activity_URI";
    }
     ...
     * 
     */
    public static Activity_URI.Match newMutableMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Activity_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Activity_URI pattern,
  ...
  public static class Matcher extends BaseMatcher<Activity_URI.Match> {
     ...
     * 
     */
    public Collection<Activity_URI.Match> getAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Activity_URI.Match> streamAllMatches(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Activity_URI.Match> getOneArbitraryMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final LiteralString pValuespec, final Consumer<? super Activity_URI.Match> processor) {
     ...
     * 
     */
    public Activity_URI.Match newMatch(final Element pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Activity_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Activity_URI.Match partialMatch) {
    ...
    protected Activity_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Activity_URI.Match.newMatch((Element) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    protected Activity_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Activity_URI.Match.newMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    protected Activity_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Activity_URI.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Activity_URI.Match newMatch(final Object... parameters) {
    return Activity_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
