...
public final class OperationalAgent extends BaseGeneratedEMFQuerySpecification<OperationalAgent.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalAgent.Match.parameterNames;
    }
    ...
    @Override
    public OperationalAgent.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalAgent.Match)) {
          OperationalAgent.Match other = (OperationalAgent.Match) obj;
    ...
    @Override
    public OperationalAgent specification() {
      return OperationalAgent.instance();
    }
     ...
     * 
     */
    public static OperationalAgent.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalAgent.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalAgent.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalAgent.Match {
    ...
    private static final class Immutable extends OperationalAgent.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent pattern,
   ...
   * 
   * @see Match
   * @see OperationalAgent
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalAgent.Match> {
    /**
     ...
     * 
     */
    public static OperationalAgent.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalAgent.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalAgent.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalAgent.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalAgent.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalAgent.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalAgent.Match> processor) {
     ...
     * 
     */
    public OperationalAgent.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalAgent.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalAgent.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalAgent.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalAgent.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalAgent.Match partialMatch) {
    ...
    @Override
    protected OperationalAgent.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalAgent.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalAgent.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalAgent.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalAgent.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalAgent.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalAgent.Matcher> querySpecification() {
      return OperationalAgent.instance();
    }
  }
  
  private OperationalAgent() {
   ...
   * 
   */
  public static OperationalAgent instance() {
    try{
  ...
  @Override
  protected OperationalAgent.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalAgent.Matcher.on(engine);
  }
  
  @Override
  public OperationalAgent.Matcher instantiate() {
    return OperationalAgent.Matcher.create();
  }
  
  @Override
  public OperationalAgent.Match newEmptyMatch() {
    return OperationalAgent.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalAgent.Match newMatch(final Object... parameters) {
    return OperationalAgent.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalAgent} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalAgent#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalAgent INSTANCE = new OperationalAgent();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalAgent.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalAgent")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalAgent");
