...
public final class OperationalArchitecture_conformsTo extends BaseGeneratedEMFQuerySpecification<OperationalArchitecture_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalArchitecture_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public OperationalArchitecture_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalArchitecture_conformsTo.Match)) {
          OperationalArchitecture_conformsTo.Match other = (OperationalArchitecture_conformsTo.Match) obj;
    ...
    @Override
    public OperationalArchitecture_conformsTo specification() {
      return OperationalArchitecture_conformsTo.instance();
    }
     ...
     * 
     */
    public static OperationalArchitecture_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalArchitecture_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalArchitecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalArchitecture_conformsTo.Match {
    ...
    private static final class Immutable extends OperationalArchitecture_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalArchitecture_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see OperationalArchitecture_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalArchitecture_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static OperationalArchitecture_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalArchitecture_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalArchitecture_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalArchitecture_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalArchitecture_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalArchitecture_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalArchitecture_conformsTo.Match> processor) {
     ...
     * 
     */
    public OperationalArchitecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalArchitecture_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalArchitecture_conformsTo.Match partialMatch) {
    ...
    @Override
    protected OperationalArchitecture_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalArchitecture_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalArchitecture_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalArchitecture_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalArchitecture_conformsTo.Matcher> querySpecification() {
      return OperationalArchitecture_conformsTo.instance();
    }
  }
  
  private OperationalArchitecture_conformsTo() {
   ...
   * 
   */
  public static OperationalArchitecture_conformsTo instance() {
    try{
  ...
  @Override
  protected OperationalArchitecture_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalArchitecture_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public OperationalArchitecture_conformsTo.Matcher instantiate() {
    return OperationalArchitecture_conformsTo.Matcher.create();
  }
  
  @Override
  public OperationalArchitecture_conformsTo.Match newEmptyMatch() {
    return OperationalArchitecture_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalArchitecture_conformsTo.Match newMatch(final Object... parameters) {
    return OperationalArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalArchitecture_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalArchitecture_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalArchitecture_conformsTo INSTANCE = new OperationalArchitecture_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalArchitecture_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
