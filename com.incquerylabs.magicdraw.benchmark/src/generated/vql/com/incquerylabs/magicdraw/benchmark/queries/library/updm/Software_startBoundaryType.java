...
public final class Software_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Software_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Software_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_startBoundaryType.Match)) {
          Software_startBoundaryType.Match other = (Software_startBoundaryType.Match) obj;
    ...
    @Override
    public Software_startBoundaryType specification() {
      return Software_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Software_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_startBoundaryType.Match {
    ...
    private static final class Immutable extends Software_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Software_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Software_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Software_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Software_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Software_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Software_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Software_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Software_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_startBoundaryType.Matcher> querySpecification() {
      return Software_startBoundaryType.instance();
    }
  }
  
  private Software_startBoundaryType() {
   ...
   * 
   */
  public static Software_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Software_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Software_startBoundaryType.Matcher instantiate() {
    return Software_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Software_startBoundaryType.Match newEmptyMatch() {
    return Software_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Software_startBoundaryType.Match newMatch(final Object... parameters) {
    return Software_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_startBoundaryType INSTANCE = new Software_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
