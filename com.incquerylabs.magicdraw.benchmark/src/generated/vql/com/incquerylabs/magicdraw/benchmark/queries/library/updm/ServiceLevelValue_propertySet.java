...
public final class ServiceLevelValue_propertySet extends BaseGeneratedEMFQuerySpecification<ServiceLevelValue_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceLevelValue_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceLevelValue_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceLevelValue_propertySet.Match)) {
          ServiceLevelValue_propertySet.Match other = (ServiceLevelValue_propertySet.Match) obj;
    ...
    @Override
    public ServiceLevelValue_propertySet specification() {
      return ServiceLevelValue_propertySet.instance();
    }
     ...
     * 
     */
    public static ServiceLevelValue_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceLevelValue_propertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceLevelValue_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceLevelValue_propertySet.Match {
    ...
    private static final class Immutable extends ServiceLevelValue_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ServiceLevelValue_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceLevelValue_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ServiceLevelValue_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceLevelValue_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceLevelValue_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceLevelValue_propertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceLevelValue_propertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceLevelValue_propertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ServiceLevelValue_propertySet.Match> processor) {
     ...
     * 
     */
    public ServiceLevelValue_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ServiceLevelValue_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ServiceLevelValue_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ServiceLevelValue_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceLevelValue_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceLevelValue_propertySet.Match partialMatch) {
    ...
    @Override
    protected ServiceLevelValue_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceLevelValue_propertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceLevelValue_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceLevelValue_propertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceLevelValue_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceLevelValue_propertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceLevelValue_propertySet.Matcher> querySpecification() {
      return ServiceLevelValue_propertySet.instance();
    }
  }
  
  private ServiceLevelValue_propertySet() {
   ...
   * 
   */
  public static ServiceLevelValue_propertySet instance() {
    try{
  ...
  @Override
  protected ServiceLevelValue_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceLevelValue_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ServiceLevelValue_propertySet.Matcher instantiate() {
    return ServiceLevelValue_propertySet.Matcher.create();
  }
  
  @Override
  public ServiceLevelValue_propertySet.Match newEmptyMatch() {
    return ServiceLevelValue_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceLevelValue_propertySet.Match newMatch(final Object... parameters) {
    return ServiceLevelValue_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceLevelValue_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceLevelValue_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceLevelValue_propertySet INSTANCE = new ServiceLevelValue_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceLevelValue_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
