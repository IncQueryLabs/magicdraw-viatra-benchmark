...
public final class SecurityControl_RefinedBy extends BaseGeneratedEMFQuerySpecification<SecurityControl_RefinedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_RefinedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_RefinedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_RefinedBy.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_RefinedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_RefinedBy.Match)) {
          SecurityControl_RefinedBy.Match other = (SecurityControl_RefinedBy.Match) obj;
    ...
    @Override
    public SecurityControl_RefinedBy specification() {
      return SecurityControl_RefinedBy.instance();
    }
     ...
     * 
     */
    public static SecurityControl_RefinedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_RefinedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static SecurityControl_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControl_RefinedBy.Match {
    ...
    private static final class Immutable extends SecurityControl_RefinedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_RefinedBy pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_RefinedBy
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_RefinedBy.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_RefinedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_RefinedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_RefinedBy.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_RefinedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<SecurityControl_RefinedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<SecurityControl_RefinedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super SecurityControl_RefinedBy.Match> processor) {
     ...
     * 
     */
    public SecurityControl_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return SecurityControl_RefinedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final SecurityControl_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final SecurityControl_RefinedBy.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_RefinedBy.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControl_RefinedBy.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_RefinedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_RefinedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_RefinedBy.Matcher> querySpecification() {
      return SecurityControl_RefinedBy.instance();
    }
  }
  
  private SecurityControl_RefinedBy() {
   ...
   * 
   */
  public static SecurityControl_RefinedBy instance() {
    try{
  ...
  @Override
  protected SecurityControl_RefinedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_RefinedBy.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_RefinedBy.Matcher instantiate() {
    return SecurityControl_RefinedBy.Matcher.create();
  }
  
  @Override
  public SecurityControl_RefinedBy.Match newEmptyMatch() {
    return SecurityControl_RefinedBy.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_RefinedBy.Match newMatch(final Object... parameters) {
    return SecurityControl_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_RefinedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_RefinedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_RefinedBy INSTANCE = new SecurityControl_RefinedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_RefinedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
