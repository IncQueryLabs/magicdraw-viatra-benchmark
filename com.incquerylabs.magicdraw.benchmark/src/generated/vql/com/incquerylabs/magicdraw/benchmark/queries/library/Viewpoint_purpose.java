...
public final class Viewpoint_purpose extends BaseGeneratedEMFQuerySpecification<Viewpoint_purpose.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Viewpoint_purpose.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public static Viewpoint_purpose.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<Viewpoint_purpose.Match> {
     ...
     * 
     */
    public Collection<Viewpoint_purpose.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Stream<Viewpoint_purpose.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Optional<Viewpoint_purpose.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue, final Consumer<? super Viewpoint_purpose.Match> processor) {
     ...
     * 
     */
    public Viewpoint_purpose.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
      return Viewpoint_purpose.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final Viewpoint_purpose.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final Viewpoint_purpose.Match partialMatch) {
    ...
    protected Viewpoint_purpose.Match tupleToMatch(final Tuple t) {
      try {
          return Viewpoint_purpose.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected Viewpoint_purpose.Match arrayToMatch(final Object[] match) {
      try {
          return Viewpoint_purpose.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Viewpoint_purpose.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Viewpoint_purpose.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Viewpoint_purpose.Match newMatch(final Object... parameters) {
    return Viewpoint_purpose.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.String) parameters[1]);
  }
