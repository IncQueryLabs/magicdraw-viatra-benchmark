...
public final class EnhancedSecurityControl_URI extends BaseGeneratedEMFQuerySpecification<EnhancedSecurityControl_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnhancedSecurityControl_URI.Match.parameterNames;
    }
    ...
    @Override
    public EnhancedSecurityControl_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnhancedSecurityControl_URI.Match)) {
          EnhancedSecurityControl_URI.Match other = (EnhancedSecurityControl_URI.Match) obj;
    ...
    @Override
    public EnhancedSecurityControl_URI specification() {
      return EnhancedSecurityControl_URI.instance();
    }
     ...
     * 
     */
    public static EnhancedSecurityControl_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnhancedSecurityControl_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnhancedSecurityControl_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnhancedSecurityControl_URI.Match {
    ...
    private static final class Immutable extends EnhancedSecurityControl_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_URI pattern,
   ...
   * 
   * @see Match
   * @see EnhancedSecurityControl_URI
   * 
   */
  public static class Matcher extends BaseMatcher<EnhancedSecurityControl_URI.Match> {
    /**
     ...
     * 
     */
    public static EnhancedSecurityControl_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnhancedSecurityControl_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnhancedSecurityControl_URI.Matcher.class);
     ...
     * 
     */
    public Collection<EnhancedSecurityControl_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnhancedSecurityControl_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnhancedSecurityControl_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EnhancedSecurityControl_URI.Match> processor) {
     ...
     * 
     */
    public EnhancedSecurityControl_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EnhancedSecurityControl_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnhancedSecurityControl_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnhancedSecurityControl_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnhancedSecurityControl_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnhancedSecurityControl_URI.Match partialMatch) {
    ...
    @Override
    protected EnhancedSecurityControl_URI.Match tupleToMatch(final Tuple t) {
      try {
          return EnhancedSecurityControl_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnhancedSecurityControl_URI.Match arrayToMatch(final Object[] match) {
      try {
          return EnhancedSecurityControl_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnhancedSecurityControl_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnhancedSecurityControl_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnhancedSecurityControl_URI.Matcher> querySpecification() {
      return EnhancedSecurityControl_URI.instance();
    }
  }
  
  private EnhancedSecurityControl_URI() {
   ...
   * 
   */
  public static EnhancedSecurityControl_URI instance() {
    try{
  ...
  @Override
  protected EnhancedSecurityControl_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnhancedSecurityControl_URI.Matcher.on(engine);
  }
  
  @Override
  public EnhancedSecurityControl_URI.Matcher instantiate() {
    return EnhancedSecurityControl_URI.Matcher.create();
  }
  
  @Override
  public EnhancedSecurityControl_URI.Match newEmptyMatch() {
    return EnhancedSecurityControl_URI.Match.newEmptyMatch();
  }
  
  @Override
  public EnhancedSecurityControl_URI.Match newMatch(final Object... parameters) {
    return EnhancedSecurityControl_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnhancedSecurityControl_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnhancedSecurityControl_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnhancedSecurityControl_URI INSTANCE = new EnhancedSecurityControl_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnhancedSecurityControl_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
