...
public final class PhysicalResource_isEncapsulated extends BaseGeneratedEMFQuerySpecification<PhysicalResource_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_isEncapsulated.Match)) {
          PhysicalResource_isEncapsulated.Match other = (PhysicalResource_isEncapsulated.Match) obj;
    ...
    @Override
    public PhysicalResource_isEncapsulated specification() {
      return PhysicalResource_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static PhysicalResource_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends PhysicalResource_isEncapsulated.Match {
    ...
    private static final class Immutable extends PhysicalResource_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<PhysicalResource_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<PhysicalResource_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super PhysicalResource_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return PhysicalResource_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final PhysicalResource_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final PhysicalResource_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected PhysicalResource_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_isEncapsulated.Matcher> querySpecification() {
      return PhysicalResource_isEncapsulated.instance();
    }
  }
  
  private PhysicalResource_isEncapsulated() {
   ...
   * 
   */
  public static PhysicalResource_isEncapsulated instance() {
    try{
  ...
  @Override
  protected PhysicalResource_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_isEncapsulated.Matcher instantiate() {
    return PhysicalResource_isEncapsulated.Matcher.create();
  }
  
  @Override
  public PhysicalResource_isEncapsulated.Match newEmptyMatch() {
    return PhysicalResource_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_isEncapsulated.Match newMatch(final Object... parameters) {
    return PhysicalResource_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_isEncapsulated INSTANCE = new PhysicalResource_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
