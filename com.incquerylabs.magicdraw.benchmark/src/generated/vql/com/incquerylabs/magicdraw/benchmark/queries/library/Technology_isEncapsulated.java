...
public final class Technology_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Technology_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Technology_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Technology_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Technology_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Technology_isEncapsulated.Match)) {
          Technology_isEncapsulated.Match other = (Technology_isEncapsulated.Match) obj;
    ...
    @Override
    public Technology_isEncapsulated specification() {
      return Technology_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Technology_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Technology_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Technology_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Technology_isEncapsulated.Match {
    ...
    private static final class Immutable extends Technology_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Technology_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Technology_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Technology_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Technology_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Technology_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Technology_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Technology_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Technology_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Technology_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Technology_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Technology_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Technology_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Technology_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Technology_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Technology_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Technology_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Technology_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Technology_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Technology_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Technology_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Technology_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Technology_isEncapsulated.Matcher> querySpecification() {
      return Technology_isEncapsulated.instance();
    }
  }
  
  private Technology_isEncapsulated() {
   ...
   * 
   */
  public static Technology_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Technology_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Technology_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Technology_isEncapsulated.Matcher instantiate() {
    return Technology_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Technology_isEncapsulated.Match newEmptyMatch() {
    return Technology_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Technology_isEncapsulated.Match newMatch(final Object... parameters) {
    return Technology_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Technology_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Technology_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Technology_isEncapsulated INSTANCE = new Technology_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Technology_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
