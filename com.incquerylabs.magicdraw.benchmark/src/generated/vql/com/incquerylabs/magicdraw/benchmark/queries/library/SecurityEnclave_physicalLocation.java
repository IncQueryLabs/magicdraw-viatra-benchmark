...
public final class SecurityEnclave_physicalLocation extends BaseGeneratedEMFQuerySpecification<SecurityEnclave_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave_physicalLocation.Match)) {
          SecurityEnclave_physicalLocation.Match other = (SecurityEnclave_physicalLocation.Match) obj;
    ...
    @Override
    public SecurityEnclave_physicalLocation specification() {
      return SecurityEnclave_physicalLocation.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityEnclave_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityEnclave_physicalLocation.Match {
    ...
    private static final class Immutable extends SecurityEnclave_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see SecurityEnclave_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityEnclave_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityEnclave_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityEnclave_physicalLocation.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityEnclave_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityEnclave_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityEnclave_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityEnclave_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave_physicalLocation.Matcher> querySpecification() {
      return SecurityEnclave_physicalLocation.instance();
    }
  }
  
  private SecurityEnclave_physicalLocation() {
   ...
   * 
   */
  public static SecurityEnclave_physicalLocation instance() {
    try{
  ...
  @Override
  protected SecurityEnclave_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave_physicalLocation.Matcher instantiate() {
    return SecurityEnclave_physicalLocation.Matcher.create();
  }
  
  @Override
  public SecurityEnclave_physicalLocation.Match newEmptyMatch() {
    return SecurityEnclave_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave_physicalLocation.Match newMatch(final Object... parameters) {
    return SecurityEnclave_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave_physicalLocation INSTANCE = new SecurityEnclave_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
