...
public final class OperationalRole_measurementSet extends BaseGeneratedEMFQuerySpecification<OperationalRole_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalRole_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public OperationalRole_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalRole_measurementSet.Match)) {
          OperationalRole_measurementSet.Match other = (OperationalRole_measurementSet.Match) obj;
    ...
    @Override
    public OperationalRole_measurementSet specification() {
      return OperationalRole_measurementSet.instance();
    }
     ...
     * 
     */
    public static OperationalRole_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalRole_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalRole_measurementSet.Match {
    ...
    private static final class Immutable extends OperationalRole_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see OperationalRole_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalRole_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static OperationalRole_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalRole_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalRole_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalRole_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalRole_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalRole_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super OperationalRole_measurementSet.Match> processor) {
     ...
     * 
     */
    public OperationalRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return OperationalRole_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalRole_measurementSet.Match partialMatch) {
    ...
    @Override
    protected OperationalRole_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalRole_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalRole_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalRole_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalRole_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalRole_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalRole_measurementSet.Matcher> querySpecification() {
      return OperationalRole_measurementSet.instance();
    }
  }
  
  private OperationalRole_measurementSet() {
   ...
   * 
   */
  public static OperationalRole_measurementSet instance() {
    try{
  ...
  @Override
  protected OperationalRole_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalRole_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public OperationalRole_measurementSet.Matcher instantiate() {
    return OperationalRole_measurementSet.Matcher.create();
  }
  
  @Override
  public OperationalRole_measurementSet.Match newEmptyMatch() {
    return OperationalRole_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalRole_measurementSet.Match newMatch(final Object... parameters) {
    return OperationalRole_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalRole_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalRole_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalRole_measurementSet INSTANCE = new OperationalRole_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalRole_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
