...
public final class SwimLaneDiagram extends BaseGeneratedEMFQuerySpecification<SwimLaneDiagram.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static SwimLaneDiagram.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static SwimLaneDiagram.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<SwimLaneDiagram.Match> {
     ...
     * 
     */
    public Collection<SwimLaneDiagram.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<SwimLaneDiagram.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<SwimLaneDiagram.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super SwimLaneDiagram.Match> processor) {
     ...
     * 
     */
    public SwimLaneDiagram.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return SwimLaneDiagram.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final SwimLaneDiagram.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final SwimLaneDiagram.Match partialMatch) {
    ...
    protected SwimLaneDiagram.Match tupleToMatch(final Tuple t) {
      try {
          return SwimLaneDiagram.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected SwimLaneDiagram.Match arrayToMatch(final Object[] match) {
      try {
          return SwimLaneDiagram.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected SwimLaneDiagram.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SwimLaneDiagram.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public SwimLaneDiagram.Match newMatch(final Object... parameters) {
    return SwimLaneDiagram.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
