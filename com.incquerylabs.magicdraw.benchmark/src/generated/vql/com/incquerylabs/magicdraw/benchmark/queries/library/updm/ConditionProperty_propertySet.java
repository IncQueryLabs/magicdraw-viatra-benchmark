...
public final class ConditionProperty_propertySet extends BaseGeneratedEMFQuerySpecification<ConditionProperty_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionProperty_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ConditionProperty_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionProperty_propertySet.Match)) {
          ConditionProperty_propertySet.Match other = (ConditionProperty_propertySet.Match) obj;
    ...
    @Override
    public ConditionProperty_propertySet specification() {
      return ConditionProperty_propertySet.instance();
    }
     ...
     * 
     */
    public static ConditionProperty_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionProperty_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConditionProperty_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConditionProperty_propertySet.Match {
    ...
    private static final class Immutable extends ConditionProperty_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ConditionProperty_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionProperty_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ConditionProperty_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionProperty_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionProperty_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionProperty_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConditionProperty_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConditionProperty_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConditionProperty_propertySet.Match> processor) {
     ...
     * 
     */
    public ConditionProperty_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ConditionProperty_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConditionProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConditionProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConditionProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConditionProperty_propertySet.Match partialMatch) {
    ...
    @Override
    protected ConditionProperty_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionProperty_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConditionProperty_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionProperty_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionProperty_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionProperty_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionProperty_propertySet.Matcher> querySpecification() {
      return ConditionProperty_propertySet.instance();
    }
  }
  
  private ConditionProperty_propertySet() {
   ...
   * 
   */
  public static ConditionProperty_propertySet instance() {
    try{
  ...
  @Override
  protected ConditionProperty_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionProperty_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ConditionProperty_propertySet.Matcher instantiate() {
    return ConditionProperty_propertySet.Matcher.create();
  }
  
  @Override
  public ConditionProperty_propertySet.Match newEmptyMatch() {
    return ConditionProperty_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionProperty_propertySet.Match newMatch(final Object... parameters) {
    return ConditionProperty_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionProperty_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionProperty_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionProperty_propertySet INSTANCE = new ConditionProperty_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionProperty_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
