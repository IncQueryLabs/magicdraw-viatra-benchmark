...
public final class ActualMeasurement_propertySet extends BaseGeneratedEMFQuerySpecification<ActualMeasurement_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualMeasurement_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ActualMeasurement_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualMeasurement_propertySet.Match)) {
          ActualMeasurement_propertySet.Match other = (ActualMeasurement_propertySet.Match) obj;
    ...
    @Override
    public ActualMeasurement_propertySet specification() {
      return ActualMeasurement_propertySet.instance();
    }
     ...
     * 
     */
    public static ActualMeasurement_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualMeasurement_propertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualMeasurement_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualMeasurement_propertySet.Match {
    ...
    private static final class Immutable extends ActualMeasurement_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ActualMeasurement_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ActualMeasurement_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ActualMeasurement_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualMeasurement_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualMeasurement_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ActualMeasurement_propertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualMeasurement_propertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualMeasurement_propertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualMeasurement_propertySet.Match> processor) {
     ...
     * 
     */
    public ActualMeasurement_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualMeasurement_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualMeasurement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualMeasurement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualMeasurement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualMeasurement_propertySet.Match partialMatch) {
    ...
    @Override
    protected ActualMeasurement_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ActualMeasurement_propertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualMeasurement_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ActualMeasurement_propertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualMeasurement_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualMeasurement_propertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualMeasurement_propertySet.Matcher> querySpecification() {
      return ActualMeasurement_propertySet.instance();
    }
  }
  
  private ActualMeasurement_propertySet() {
   ...
   * 
   */
  public static ActualMeasurement_propertySet instance() {
    try{
  ...
  @Override
  protected ActualMeasurement_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualMeasurement_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ActualMeasurement_propertySet.Matcher instantiate() {
    return ActualMeasurement_propertySet.Matcher.create();
  }
  
  @Override
  public ActualMeasurement_propertySet.Match newEmptyMatch() {
    return ActualMeasurement_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ActualMeasurement_propertySet.Match newMatch(final Object... parameters) {
    return ActualMeasurement_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualMeasurement_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualMeasurement_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualMeasurement_propertySet INSTANCE = new ActualMeasurement_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualMeasurement_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
