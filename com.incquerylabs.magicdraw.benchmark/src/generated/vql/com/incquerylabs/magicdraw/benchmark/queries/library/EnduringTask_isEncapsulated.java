...
import com.incquerylabs.magicdraw.benchmark.queries.library.EnduringTask;
...
public final class EnduringTask_isEncapsulated extends BaseGeneratedEMFQuerySpecification<EnduringTask_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnduringTask_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnduringTask_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnduringTask_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public EnduringTask_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnduringTask_isEncapsulated.Match)) {
          EnduringTask_isEncapsulated.Match other = (EnduringTask_isEncapsulated.Match) obj;
    ...
    @Override
    public EnduringTask_isEncapsulated specification() {
      return EnduringTask_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static EnduringTask_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnduringTask_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static EnduringTask_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnduringTask_isEncapsulated.Match {
    ...
    private static final class Immutable extends EnduringTask_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnduringTask_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see EnduringTask_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<EnduringTask_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static EnduringTask_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnduringTask_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnduringTask_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<EnduringTask_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<EnduringTask_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<EnduringTask_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super EnduringTask_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public EnduringTask_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return EnduringTask_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnduringTask_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnduringTask_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final EnduringTask_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final EnduringTask_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected EnduringTask_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return EnduringTask_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnduringTask_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return EnduringTask_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnduringTask_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnduringTask_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnduringTask_isEncapsulated.Matcher> querySpecification() {
      return EnduringTask_isEncapsulated.instance();
    }
  }
  
  private EnduringTask_isEncapsulated() {
   ...
   * 
   */
  public static EnduringTask_isEncapsulated instance() {
    try{
  ...
  @Override
  protected EnduringTask_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnduringTask_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public EnduringTask_isEncapsulated.Matcher instantiate() {
    return EnduringTask_isEncapsulated.Matcher.create();
  }
  
  @Override
  public EnduringTask_isEncapsulated.Match newEmptyMatch() {
    return EnduringTask_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public EnduringTask_isEncapsulated.Match newMatch(final Object... parameters) {
    return EnduringTask_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnduringTask_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnduringTask_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnduringTask_isEncapsulated INSTANCE = new EnduringTask_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnduringTask_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
