...
public final class ServiceLevelValue_startDate extends BaseGeneratedEMFQuerySpecification<ServiceLevelValue_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceLevelValue_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ServiceLevelValue_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceLevelValue_startDate.Match)) {
          ServiceLevelValue_startDate.Match other = (ServiceLevelValue_startDate.Match) obj;
    ...
    @Override
    public ServiceLevelValue_startDate specification() {
      return ServiceLevelValue_startDate.instance();
    }
     ...
     * 
     */
    public static ServiceLevelValue_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceLevelValue_startDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceLevelValue_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceLevelValue_startDate.Match {
    ...
    private static final class Immutable extends ServiceLevelValue_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_startDate pattern,
   ...
   * 
   * @see Match
   * @see ServiceLevelValue_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceLevelValue_startDate.Match> {
    /**
     ...
     * 
     */
    public static ServiceLevelValue_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceLevelValue_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceLevelValue_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceLevelValue_startDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceLevelValue_startDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceLevelValue_startDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ServiceLevelValue_startDate.Match> processor) {
     ...
     * 
     */
    public ServiceLevelValue_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ServiceLevelValue_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ServiceLevelValue_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ServiceLevelValue_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceLevelValue_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceLevelValue_startDate.Match partialMatch) {
    ...
    @Override
    protected ServiceLevelValue_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceLevelValue_startDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceLevelValue_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceLevelValue_startDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceLevelValue_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceLevelValue_startDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceLevelValue_startDate.Matcher> querySpecification() {
      return ServiceLevelValue_startDate.instance();
    }
  }
  
  private ServiceLevelValue_startDate() {
   ...
   * 
   */
  public static ServiceLevelValue_startDate instance() {
    try{
  ...
  @Override
  protected ServiceLevelValue_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceLevelValue_startDate.Matcher.on(engine);
  }
  
  @Override
  public ServiceLevelValue_startDate.Matcher instantiate() {
    return ServiceLevelValue_startDate.Matcher.create();
  }
  
  @Override
  public ServiceLevelValue_startDate.Match newEmptyMatch() {
    return ServiceLevelValue_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceLevelValue_startDate.Match newMatch(final Object... parameters) {
    return ServiceLevelValue_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceLevelValue_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceLevelValue_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceLevelValue_startDate INSTANCE = new ServiceLevelValue_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceLevelValue_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
