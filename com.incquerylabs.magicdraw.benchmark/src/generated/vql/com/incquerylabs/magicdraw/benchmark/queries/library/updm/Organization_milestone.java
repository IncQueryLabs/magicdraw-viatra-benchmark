...
public final class Organization_milestone extends BaseGeneratedEMFQuerySpecification<Organization_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_milestone.Match.parameterNames;
    }
    ...
    @Override
    public Organization_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_milestone.Match)) {
          Organization_milestone.Match other = (Organization_milestone.Match) obj;
    ...
    @Override
    public Organization_milestone specification() {
      return Organization_milestone.instance();
    }
     ...
     * 
     */
    public static Organization_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_milestone.Match {
    ...
    private static final class Immutable extends Organization_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_milestone pattern,
   ...
   * 
   * @see Match
   * @see Organization_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_milestone.Match> {
    /**
     ...
     * 
     */
    public static Organization_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_milestone.Match> processor) {
     ...
     * 
     */
    public Organization_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_milestone.Match partialMatch) {
    ...
    @Override
    protected Organization_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_milestone.Matcher> querySpecification() {
      return Organization_milestone.instance();
    }
  }
  
  private Organization_milestone() {
   ...
   * 
   */
  public static Organization_milestone instance() {
    try{
  ...
  @Override
  protected Organization_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_milestone.Matcher.on(engine);
  }
  
  @Override
  public Organization_milestone.Matcher instantiate() {
    return Organization_milestone.Matcher.create();
  }
  
  @Override
  public Organization_milestone.Match newEmptyMatch() {
    return Organization_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_milestone.Match newMatch(final Object... parameters) {
    return Organization_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_milestone INSTANCE = new Organization_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
