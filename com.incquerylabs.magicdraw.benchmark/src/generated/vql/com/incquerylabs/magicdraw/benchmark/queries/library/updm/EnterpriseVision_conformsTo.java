...
public final class EnterpriseVision_conformsTo extends BaseGeneratedEMFQuerySpecification<EnterpriseVision_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseVision_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseVision_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseVision_conformsTo.Match)) {
          EnterpriseVision_conformsTo.Match other = (EnterpriseVision_conformsTo.Match) obj;
    ...
    @Override
    public EnterpriseVision_conformsTo specification() {
      return EnterpriseVision_conformsTo.instance();
    }
     ...
     * 
     */
    public static EnterpriseVision_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseVision_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseVision_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseVision_conformsTo.Match {
    ...
    private static final class Immutable extends EnterpriseVision_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseVision_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseVision_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseVision_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseVision_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseVision_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseVision_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseVision_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseVision_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseVision_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseVision_conformsTo.Match> processor) {
     ...
     * 
     */
    public EnterpriseVision_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseVision_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseVision_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseVision_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseVision_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseVision_conformsTo.Match partialMatch) {
    ...
    @Override
    protected EnterpriseVision_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseVision_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseVision_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseVision_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseVision_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseVision_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseVision_conformsTo.Matcher> querySpecification() {
      return EnterpriseVision_conformsTo.instance();
    }
  }
  
  private EnterpriseVision_conformsTo() {
   ...
   * 
   */
  public static EnterpriseVision_conformsTo instance() {
    try{
  ...
  @Override
  protected EnterpriseVision_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseVision_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseVision_conformsTo.Matcher instantiate() {
    return EnterpriseVision_conformsTo.Matcher.create();
  }
  
  @Override
  public EnterpriseVision_conformsTo.Match newEmptyMatch() {
    return EnterpriseVision_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseVision_conformsTo.Match newMatch(final Object... parameters) {
    return EnterpriseVision_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseVision_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseVision_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseVision_conformsTo INSTANCE = new EnterpriseVision_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseVision_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
