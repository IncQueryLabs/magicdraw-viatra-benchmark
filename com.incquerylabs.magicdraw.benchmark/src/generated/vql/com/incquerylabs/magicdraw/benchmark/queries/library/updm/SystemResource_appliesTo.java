...
public final class SystemResource_appliesTo extends BaseGeneratedEMFQuerySpecification<SystemResource_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_appliesTo.Match)) {
          SystemResource_appliesTo.Match other = (SystemResource_appliesTo.Match) obj;
    ...
    @Override
    public SystemResource_appliesTo specification() {
      return SystemResource_appliesTo.instance();
    }
     ...
     * 
     */
    public static SystemResource_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_appliesTo.Match {
    ...
    private static final class Immutable extends SystemResource_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_appliesTo.Match> processor) {
     ...
     * 
     */
    public SystemResource_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_appliesTo.Match partialMatch) {
    ...
    @Override
    protected SystemResource_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_appliesTo.Matcher> querySpecification() {
      return SystemResource_appliesTo.instance();
    }
  }
  
  private SystemResource_appliesTo() {
   ...
   * 
   */
  public static SystemResource_appliesTo instance() {
    try{
  ...
  @Override
  protected SystemResource_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_appliesTo.Matcher instantiate() {
    return SystemResource_appliesTo.Matcher.create();
  }
  
  @Override
  public SystemResource_appliesTo.Match newEmptyMatch() {
    return SystemResource_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_appliesTo.Match newMatch(final Object... parameters) {
    return SystemResource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_appliesTo INSTANCE = new SystemResource_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
