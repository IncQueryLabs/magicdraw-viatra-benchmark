...
public final class ResourceRole_propertySet extends BaseGeneratedEMFQuerySpecification<ResourceRole_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_propertySet.Match)) {
          ResourceRole_propertySet.Match other = (ResourceRole_propertySet.Match) obj;
    ...
    @Override
    public ResourceRole_propertySet specification() {
      return ResourceRole_propertySet.instance();
    }
     ...
     * 
     */
    public static ResourceRole_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_propertySet.Match {
    ...
    private static final class Immutable extends ResourceRole_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_propertySet.Match> processor) {
     ...
     * 
     */
    public ResourceRole_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_propertySet.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_propertySet.Matcher> querySpecification() {
      return ResourceRole_propertySet.instance();
    }
  }
  
  private ResourceRole_propertySet() {
   ...
   * 
   */
  public static ResourceRole_propertySet instance() {
    try{
  ...
  @Override
  protected ResourceRole_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_propertySet.Matcher instantiate() {
    return ResourceRole_propertySet.Matcher.create();
  }
  
  @Override
  public ResourceRole_propertySet.Match newEmptyMatch() {
    return ResourceRole_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_propertySet.Match newMatch(final Object... parameters) {
    return ResourceRole_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_propertySet INSTANCE = new ResourceRole_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
