...
public final class ActualMeasurement_conformsTo extends BaseGeneratedEMFQuerySpecification<ActualMeasurement_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualMeasurement_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ActualMeasurement_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualMeasurement_conformsTo.Match)) {
          ActualMeasurement_conformsTo.Match other = (ActualMeasurement_conformsTo.Match) obj;
    ...
    @Override
    public ActualMeasurement_conformsTo specification() {
      return ActualMeasurement_conformsTo.instance();
    }
     ...
     * 
     */
    public static ActualMeasurement_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualMeasurement_conformsTo.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualMeasurement_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualMeasurement_conformsTo.Match {
    ...
    private static final class Immutable extends ActualMeasurement_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ActualMeasurement_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ActualMeasurement_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ActualMeasurement_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualMeasurement_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualMeasurement_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ActualMeasurement_conformsTo.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualMeasurement_conformsTo.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualMeasurement_conformsTo.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualMeasurement_conformsTo.Match> processor) {
     ...
     * 
     */
    public ActualMeasurement_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualMeasurement_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualMeasurement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualMeasurement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualMeasurement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualMeasurement_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ActualMeasurement_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ActualMeasurement_conformsTo.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualMeasurement_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ActualMeasurement_conformsTo.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualMeasurement_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualMeasurement_conformsTo.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualMeasurement_conformsTo.Matcher> querySpecification() {
      return ActualMeasurement_conformsTo.instance();
    }
  }
  
  private ActualMeasurement_conformsTo() {
   ...
   * 
   */
  public static ActualMeasurement_conformsTo instance() {
    try{
  ...
  @Override
  protected ActualMeasurement_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualMeasurement_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ActualMeasurement_conformsTo.Matcher instantiate() {
    return ActualMeasurement_conformsTo.Matcher.create();
  }
  
  @Override
  public ActualMeasurement_conformsTo.Match newEmptyMatch() {
    return ActualMeasurement_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ActualMeasurement_conformsTo.Match newMatch(final Object... parameters) {
    return ActualMeasurement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualMeasurement_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualMeasurement_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualMeasurement_conformsTo INSTANCE = new ActualMeasurement_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualMeasurement_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
