...
public final class PhysicalResource_appliesTo extends BaseGeneratedEMFQuerySpecification<PhysicalResource_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_appliesTo.Match)) {
          PhysicalResource_appliesTo.Match other = (PhysicalResource_appliesTo.Match) obj;
    ...
    @Override
    public PhysicalResource_appliesTo specification() {
      return PhysicalResource_appliesTo.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_appliesTo.Match {
    ...
    private static final class Immutable extends PhysicalResource_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_appliesTo.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_appliesTo.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_appliesTo.Matcher> querySpecification() {
      return PhysicalResource_appliesTo.instance();
    }
  }
  
  private PhysicalResource_appliesTo() {
   ...
   * 
   */
  public static PhysicalResource_appliesTo instance() {
    try{
  ...
  @Override
  protected PhysicalResource_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_appliesTo.Matcher instantiate() {
    return PhysicalResource_appliesTo.Matcher.create();
  }
  
  @Override
  public PhysicalResource_appliesTo.Match newEmptyMatch() {
    return PhysicalResource_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_appliesTo.Match newMatch(final Object... parameters) {
    return PhysicalResource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_appliesTo INSTANCE = new PhysicalResource_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
