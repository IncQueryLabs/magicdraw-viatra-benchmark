...
public final class OrganizationalResource_milestone extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_milestone.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_milestone.Match)) {
          OrganizationalResource_milestone.Match other = (OrganizationalResource_milestone.Match) obj;
    ...
    @Override
    public OrganizationalResource_milestone specification() {
      return OrganizationalResource_milestone.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_milestone.Match {
    ...
    private static final class Immutable extends OrganizationalResource_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_milestone pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_milestone.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_milestone.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_milestone.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_milestone.Matcher> querySpecification() {
      return OrganizationalResource_milestone.instance();
    }
  }
  
  private OrganizationalResource_milestone() {
   ...
   * 
   */
  public static OrganizationalResource_milestone instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_milestone.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_milestone.Matcher instantiate() {
    return OrganizationalResource_milestone.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_milestone.Match newEmptyMatch() {
    return OrganizationalResource_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_milestone.Match newMatch(final Object... parameters) {
    return OrganizationalResource_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_milestone INSTANCE = new OrganizationalResource_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
