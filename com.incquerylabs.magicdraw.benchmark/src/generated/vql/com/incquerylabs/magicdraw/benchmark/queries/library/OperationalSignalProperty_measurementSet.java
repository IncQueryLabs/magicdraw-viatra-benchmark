...
public final class OperationalSignalProperty_measurementSet extends BaseGeneratedEMFQuerySpecification<OperationalSignalProperty_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalSignalProperty_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalSignalProperty_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalSignalProperty_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public OperationalSignalProperty_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalSignalProperty_measurementSet.Match)) {
          OperationalSignalProperty_measurementSet.Match other = (OperationalSignalProperty_measurementSet.Match) obj;
    ...
    @Override
    public OperationalSignalProperty_measurementSet specification() {
      return OperationalSignalProperty_measurementSet.instance();
    }
     ...
     * 
     */
    public static OperationalSignalProperty_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalSignalProperty_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalSignalProperty_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalSignalProperty_measurementSet.Match {
    ...
    private static final class Immutable extends OperationalSignalProperty_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalSignalProperty_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see OperationalSignalProperty_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalSignalProperty_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static OperationalSignalProperty_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalSignalProperty_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalSignalProperty_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalSignalProperty_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalSignalProperty_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalSignalProperty_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super OperationalSignalProperty_measurementSet.Match> processor) {
     ...
     * 
     */
    public OperationalSignalProperty_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return OperationalSignalProperty_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalSignalProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalSignalProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalSignalProperty_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalSignalProperty_measurementSet.Match partialMatch) {
    ...
    @Override
    protected OperationalSignalProperty_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalSignalProperty_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalSignalProperty_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalSignalProperty_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalSignalProperty_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalSignalProperty_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalSignalProperty_measurementSet.Matcher> querySpecification() {
      return OperationalSignalProperty_measurementSet.instance();
    }
  }
  
  private OperationalSignalProperty_measurementSet() {
   ...
   * 
   */
  public static OperationalSignalProperty_measurementSet instance() {
    try{
  ...
  @Override
  protected OperationalSignalProperty_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalSignalProperty_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public OperationalSignalProperty_measurementSet.Matcher instantiate() {
    return OperationalSignalProperty_measurementSet.Matcher.create();
  }
  
  @Override
  public OperationalSignalProperty_measurementSet.Match newEmptyMatch() {
    return OperationalSignalProperty_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalSignalProperty_measurementSet.Match newMatch(final Object... parameters) {
    return OperationalSignalProperty_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalSignalProperty_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalSignalProperty_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalSignalProperty_measurementSet INSTANCE = new OperationalSignalProperty_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalSignalProperty_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
