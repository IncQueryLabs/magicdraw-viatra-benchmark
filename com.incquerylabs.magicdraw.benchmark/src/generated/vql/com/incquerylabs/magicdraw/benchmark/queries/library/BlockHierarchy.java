...
public final class BlockHierarchy extends BaseGeneratedEMFQuerySpecification<BlockHierarchy.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static BlockHierarchy.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static BlockHierarchy.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<BlockHierarchy.Match> {
     ...
     * 
     */
    public Collection<BlockHierarchy.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<BlockHierarchy.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<BlockHierarchy.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super BlockHierarchy.Match> processor) {
     ...
     * 
     */
    public BlockHierarchy.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return BlockHierarchy.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final BlockHierarchy.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final BlockHierarchy.Match partialMatch) {
    ...
    protected BlockHierarchy.Match tupleToMatch(final Tuple t) {
      try {
          return BlockHierarchy.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected BlockHierarchy.Match arrayToMatch(final Object[] match) {
      try {
          return BlockHierarchy.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected BlockHierarchy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BlockHierarchy.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public BlockHierarchy.Match newMatch(final Object... parameters) {
    return BlockHierarchy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
