...
public final class ExchangeElement_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<ExchangeElement_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_requiredEnvironment.Match)) {
          ExchangeElement_requiredEnvironment.Match other = (ExchangeElement_requiredEnvironment.Match) obj;
    ...
    @Override
    public ExchangeElement_requiredEnvironment specification() {
      return ExchangeElement_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_requiredEnvironment.Match {
    ...
    private static final class Immutable extends ExchangeElement_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_requiredEnvironment.Matcher> querySpecification() {
      return ExchangeElement_requiredEnvironment.instance();
    }
  }
  
  private ExchangeElement_requiredEnvironment() {
   ...
   * 
   */
  public static ExchangeElement_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected ExchangeElement_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_requiredEnvironment.Matcher instantiate() {
    return ExchangeElement_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public ExchangeElement_requiredEnvironment.Match newEmptyMatch() {
    return ExchangeElement_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_requiredEnvironment.Match newMatch(final Object... parameters) {
    return ExchangeElement_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_requiredEnvironment INSTANCE = new ExchangeElement_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
