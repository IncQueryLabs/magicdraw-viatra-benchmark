...
public final class ExternalType_conformsTo extends BaseGeneratedEMFQuerySpecification<ExternalType_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalType_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ExternalType_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalType_conformsTo.Match)) {
          ExternalType_conformsTo.Match other = (ExternalType_conformsTo.Match) obj;
    ...
    @Override
    public ExternalType_conformsTo specification() {
      return ExternalType_conformsTo.instance();
    }
     ...
     * 
     */
    public static ExternalType_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalType_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalType_conformsTo.Match {
    ...
    private static final class Immutable extends ExternalType_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ExternalType_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalType_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ExternalType_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalType_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalType_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalType_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalType_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalType_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalType_conformsTo.Match> processor) {
     ...
     * 
     */
    public ExternalType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalType_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalType_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ExternalType_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalType_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalType_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalType_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalType_conformsTo.Matcher> querySpecification() {
      return ExternalType_conformsTo.instance();
    }
  }
  
  private ExternalType_conformsTo() {
   ...
   * 
   */
  public static ExternalType_conformsTo instance() {
    try{
  ...
  @Override
  protected ExternalType_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalType_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ExternalType_conformsTo.Matcher instantiate() {
    return ExternalType_conformsTo.Matcher.create();
  }
  
  @Override
  public ExternalType_conformsTo.Match newEmptyMatch() {
    return ExternalType_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalType_conformsTo.Match newMatch(final Object... parameters) {
    return ExternalType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalType_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalType_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalType_conformsTo INSTANCE = new ExternalType_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalType_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
