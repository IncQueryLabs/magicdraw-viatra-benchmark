...
public final class NamesOfDependencyEndpoints extends BaseGeneratedEMFQuerySpecification<NamesOfDependencyEndpoints.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public Object get(final String parameterName) {
      ...
      if ("sourceName".equals(parameterName)) return this.fSourceName;
      if ("target".equals(parameterName)) return this.fTarget;
      if ("targetName".equals(parameterName)) return this.fTargetName;
      return null;
    }
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.NamesOfDependencyEndpoints (visibility: PUBLIC, simpleName: NamesOfDependencyEndpoints, identifier: com.incquerylabs.magicdraw.benchmark.queries.NamesOfDependencyEndpoints, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
