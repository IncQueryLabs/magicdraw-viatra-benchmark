...
public final class InterfaceRequirement_Text extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_Text.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceRequirement_Text.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceRequirement_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceRequirement_Text.Match)) {
          InterfaceRequirement_Text.Match other = (InterfaceRequirement_Text.Match) obj;
    ...
    @Override
    public InterfaceRequirement_Text specification() {
     ...
     * 
     */
    public static InterfaceRequirement_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceRequirement_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static InterfaceRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends InterfaceRequirement_Text.Match {
    ...
    private static final class Immutable extends InterfaceRequirement_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_Text pattern,
   ...
   * 
   * @see Match
   * @see InterfaceRequirement_Text
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceRequirement_Text.Match> {
    /**
     ...
     * 
     */
    public static InterfaceRequirement_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceRequirement_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceRequirement_Text.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceRequirement_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<InterfaceRequirement_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<InterfaceRequirement_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super InterfaceRequirement_Text.Match> processor) {
     ...
     * 
     */
    public InterfaceRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return InterfaceRequirement_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InterfaceRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InterfaceRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final InterfaceRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final InterfaceRequirement_Text.Match partialMatch) {
    ...
    @Override
    protected InterfaceRequirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected InterfaceRequirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceRequirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceRequirement_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceRequirement_Text.Matcher> querySpecification() {
      return InterfaceRequirement_Text.instance();
    }
  }
  
  private InterfaceRequirement_Text() {
   ...
   * 
   */
  public static InterfaceRequirement_Text instance() {
    try{
  ...
  @Override
  protected InterfaceRequirement_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceRequirement_Text.Matcher.on(engine);
  }
  
  @Override
  public InterfaceRequirement_Text.Matcher instantiate() {
    return InterfaceRequirement_Text.Matcher.create();
  }
  
  @Override
  public InterfaceRequirement_Text.Match newEmptyMatch() {
    return InterfaceRequirement_Text.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceRequirement_Text.Match newMatch(final Object... parameters) {
    return InterfaceRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceRequirement_Text} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceRequirement_Text#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceRequirement_Text INSTANCE = new InterfaceRequirement_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceRequirement_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
