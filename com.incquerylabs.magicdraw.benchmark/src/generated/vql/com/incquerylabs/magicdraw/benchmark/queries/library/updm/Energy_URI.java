...
public final class Energy_URI extends BaseGeneratedEMFQuerySpecification<Energy_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_URI.Match.parameterNames;
    }
    ...
    @Override
    public Energy_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_URI.Match)) {
          Energy_URI.Match other = (Energy_URI.Match) obj;
    ...
    @Override
    public Energy_URI specification() {
      return Energy_URI.instance();
    }
     ...
     * 
     */
    public static Energy_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Energy_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Energy_URI.Match {
    ...
    private static final class Immutable extends Energy_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_URI.Match> {
    /**
     ...
     * 
     */
    public static Energy_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Energy_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Energy_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Energy_URI.Match> processor) {
     ...
     * 
     */
    public Energy_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Energy_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Energy_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Energy_URI.Match partialMatch) {
    ...
    @Override
    protected Energy_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Energy_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_URI.Matcher> querySpecification() {
      return Energy_URI.instance();
    }
  }
   ...
   * 
   */
  public static Energy_URI instance() {
    try{
  ...
  @Override
  protected Energy_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_URI.Matcher.on(engine);
  }
  
  @Override
  public Energy_URI.Matcher instantiate() {
    return Energy_URI.Matcher.create();
  }
  
  @Override
  public Energy_URI.Match newEmptyMatch() {
    return Energy_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_URI.Match newMatch(final Object... parameters) {
    return Energy_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_URI INSTANCE = new Energy_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
