...
public final class Command extends BaseGeneratedEMFQuerySpecification<Command.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Command pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Command";
    }
    
    @Override
    public List<String> parameterNames() {
      return Command.Match.parameterNames;
    }
    ...
    @Override
    public Command.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Command.Match)) {
          Command.Match other = (Command.Match) obj;
     ...
     * 
     */
    public static Command.Match newEmptyMatch() {
     ...
     * 
     */
    public static Command.Match newMutableMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Command.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Command.Match {
    ...
    private static final class Immutable extends Command.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Command pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Command.Match> {
    /**
     ...
     * 
     */
    public static Command.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Command.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Command.Matcher.class);
     ...
     * 
     */
    public Collection<Command.Match> getAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Command.Match> streamAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Command.Match> getOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Command.Match> processor) {
     ...
     * 
     */
    public Command.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Command.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Command.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Command.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Command.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Command.Match partialMatch) {
    ...
    @Override
    protected Command.Match tupleToMatch(final Tuple t) {
      try {
          return Command.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Command.Match arrayToMatch(final Object[] match) {
      try {
          return Command.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Command.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Command.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Command.Matcher> querySpecification() {
      return Command.instance();
    }
  }
  ...
  @Override
  protected Command.Matcher instantiate(final ViatraQueryEngine engine) {
    return Command.Matcher.on(engine);
  }
  
  @Override
  public Command.Matcher instantiate() {
    return Command.Matcher.create();
  }
  
  @Override
  public Command.Match newEmptyMatch() {
    return Command.Match.newEmptyMatch();
  }
  
  @Override
  public Command.Match newMatch(final Object... parameters) {
    return Command.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Command} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Command#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Command.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Command")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Command");
