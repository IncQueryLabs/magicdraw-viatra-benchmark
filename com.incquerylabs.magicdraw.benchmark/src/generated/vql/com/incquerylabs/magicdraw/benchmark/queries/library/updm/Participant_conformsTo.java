...
public final class Participant_conformsTo extends BaseGeneratedEMFQuerySpecification<Participant_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Participant_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_conformsTo.Match)) {
          Participant_conformsTo.Match other = (Participant_conformsTo.Match) obj;
    ...
    @Override
    public Participant_conformsTo specification() {
      return Participant_conformsTo.instance();
    }
     ...
     * 
     */
    public static Participant_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Participant_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Participant_conformsTo.Match {
    ...
    private static final class Immutable extends Participant_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Participant_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Participant_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Participant_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Participant_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Participant_conformsTo.Match> processor) {
     ...
     * 
     */
    public Participant_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Participant_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Participant_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Participant_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Participant_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Participant_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_conformsTo.Matcher> querySpecification() {
      return Participant_conformsTo.instance();
    }
  }
  
  private Participant_conformsTo() {
   ...
   * 
   */
  public static Participant_conformsTo instance() {
    try{
  ...
  @Override
  protected Participant_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Participant_conformsTo.Matcher instantiate() {
    return Participant_conformsTo.Matcher.create();
  }
  
  @Override
  public Participant_conformsTo.Match newEmptyMatch() {
    return Participant_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_conformsTo.Match newMatch(final Object... parameters) {
    return Participant_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_conformsTo INSTANCE = new Participant_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
