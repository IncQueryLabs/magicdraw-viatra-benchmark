...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole;
...
public final class ProjectMilestoneRole_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ProjectMilestoneRole_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestoneRole_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestoneRole_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestoneRole_actualPropertySet.Match)) {
          ProjectMilestoneRole_actualPropertySet.Match other = (ProjectMilestoneRole_actualPropertySet.Match) obj;
    ...
    @Override
    public ProjectMilestoneRole_actualPropertySet specification() {
      return ProjectMilestoneRole_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ProjectMilestoneRole_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestoneRole_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestoneRole_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestoneRole_actualPropertySet.Match {
    ...
    private static final class Immutable extends ProjectMilestoneRole_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestoneRole_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestoneRole_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestoneRole_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestoneRole_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestoneRole_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestoneRole_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestoneRole_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestoneRole_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestoneRole_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectMilestoneRole_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ProjectMilestoneRole_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectMilestoneRole_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectMilestoneRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectMilestoneRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestoneRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestoneRole_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestoneRole_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestoneRole_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestoneRole_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestoneRole_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestoneRole_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestoneRole_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestoneRole_actualPropertySet.Matcher> querySpecification() {
      return ProjectMilestoneRole_actualPropertySet.instance();
    }
  }
  
  private ProjectMilestoneRole_actualPropertySet() {
   ...
   * 
   */
  public static ProjectMilestoneRole_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ProjectMilestoneRole_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestoneRole_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestoneRole_actualPropertySet.Matcher instantiate() {
    return ProjectMilestoneRole_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ProjectMilestoneRole_actualPropertySet.Match newEmptyMatch() {
    return ProjectMilestoneRole_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestoneRole_actualPropertySet.Match newMatch(final Object... parameters) {
    return ProjectMilestoneRole_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestoneRole_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestoneRole_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestoneRole_actualPropertySet INSTANCE = new ProjectMilestoneRole_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestoneRole_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
