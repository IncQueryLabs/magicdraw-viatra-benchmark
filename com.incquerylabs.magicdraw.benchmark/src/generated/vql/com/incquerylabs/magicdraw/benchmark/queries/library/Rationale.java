...
public final class Rationale extends BaseGeneratedEMFQuerySpecification<Rationale.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Rationale pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Rationale";
    }
     ...
     * 
     */
    public static Rationale.Match newMutableMatch(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Rationale.Match newMatch(final Comment pElement, final Stereotype pStereotype) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Rationale pattern,
  ...
  public static class Matcher extends BaseMatcher<Rationale.Match> {
     ...
     * 
     */
    public Collection<Rationale.Match> getAllMatches(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Rationale.Match> streamAllMatches(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Rationale.Match> getOneArbitraryMatch(final Comment pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final Stereotype pStereotype, final Consumer<? super Rationale.Match> processor) {
     ...
     * 
     */
    public Rationale.Match newMatch(final Comment pElement, final Stereotype pStereotype) {
      return Rationale.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Rationale.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Rationale.Match partialMatch) {
    ...
    protected Rationale.Match tupleToMatch(final Tuple t) {
      try {
          return Rationale.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected Rationale.Match arrayToMatch(final Object[] match) {
      try {
          return Rationale.Match.newMatch((Comment) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected Rationale.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rationale.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Rationale.Match newMatch(final Object... parameters) {
    return Rationale.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Rationale} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Rationale#instance()}.
   * 
