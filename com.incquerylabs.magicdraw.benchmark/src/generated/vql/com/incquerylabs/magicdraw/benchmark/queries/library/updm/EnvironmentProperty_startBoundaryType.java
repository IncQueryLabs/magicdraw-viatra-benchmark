...
public final class EnvironmentProperty_startBoundaryType extends BaseGeneratedEMFQuerySpecification<EnvironmentProperty_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnvironmentProperty_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EnvironmentProperty_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnvironmentProperty_startBoundaryType.Match)) {
          EnvironmentProperty_startBoundaryType.Match other = (EnvironmentProperty_startBoundaryType.Match) obj;
    ...
    @Override
    public EnvironmentProperty_startBoundaryType specification() {
      return EnvironmentProperty_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static EnvironmentProperty_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnvironmentProperty_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EnvironmentProperty_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnvironmentProperty_startBoundaryType.Match {
    ...
    private static final class Immutable extends EnvironmentProperty_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EnvironmentProperty_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EnvironmentProperty_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EnvironmentProperty_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnvironmentProperty_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnvironmentProperty_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EnvironmentProperty_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnvironmentProperty_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnvironmentProperty_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EnvironmentProperty_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public EnvironmentProperty_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return EnvironmentProperty_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EnvironmentProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EnvironmentProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnvironmentProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnvironmentProperty_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EnvironmentProperty_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EnvironmentProperty_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnvironmentProperty_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EnvironmentProperty_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnvironmentProperty_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnvironmentProperty_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnvironmentProperty_startBoundaryType.Matcher> querySpecification() {
      return EnvironmentProperty_startBoundaryType.instance();
    }
  }
  
  private EnvironmentProperty_startBoundaryType() {
   ...
   * 
   */
  public static EnvironmentProperty_startBoundaryType instance() {
    try{
  ...
  @Override
  protected EnvironmentProperty_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnvironmentProperty_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EnvironmentProperty_startBoundaryType.Matcher instantiate() {
    return EnvironmentProperty_startBoundaryType.Matcher.create();
  }
  
  @Override
  public EnvironmentProperty_startBoundaryType.Match newEmptyMatch() {
    return EnvironmentProperty_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EnvironmentProperty_startBoundaryType.Match newMatch(final Object... parameters) {
    return EnvironmentProperty_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnvironmentProperty_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnvironmentProperty_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnvironmentProperty_startBoundaryType INSTANCE = new EnvironmentProperty_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnvironmentProperty_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
