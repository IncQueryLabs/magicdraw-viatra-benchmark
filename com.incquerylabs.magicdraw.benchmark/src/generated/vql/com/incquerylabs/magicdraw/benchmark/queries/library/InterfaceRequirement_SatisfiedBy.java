...
public final class InterfaceRequirement_SatisfiedBy extends BaseGeneratedEMFQuerySpecification<InterfaceRequirement_SatisfiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_SatisfiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_SatisfiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return InterfaceRequirement_SatisfiedBy.Match.parameterNames;
    }
    ...
    @Override
    public InterfaceRequirement_SatisfiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof InterfaceRequirement_SatisfiedBy.Match)) {
          InterfaceRequirement_SatisfiedBy.Match other = (InterfaceRequirement_SatisfiedBy.Match) obj;
    ...
    @Override
    public InterfaceRequirement_SatisfiedBy specification() {
     ...
     * 
     */
    public static InterfaceRequirement_SatisfiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static InterfaceRequirement_SatisfiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static InterfaceRequirement_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends InterfaceRequirement_SatisfiedBy.Match {
    ...
    private static final class Immutable extends InterfaceRequirement_SatisfiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.interfaceRequirement_SatisfiedBy pattern,
   ...
   * 
   * @see Match
   * @see InterfaceRequirement_SatisfiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<InterfaceRequirement_SatisfiedBy.Match> {
    /**
     ...
     * 
     */
    public static InterfaceRequirement_SatisfiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static InterfaceRequirement_SatisfiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(InterfaceRequirement_SatisfiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<InterfaceRequirement_SatisfiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<InterfaceRequirement_SatisfiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<InterfaceRequirement_SatisfiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super InterfaceRequirement_SatisfiedBy.Match> processor) {
     ...
     * 
     */
    public InterfaceRequirement_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return InterfaceRequirement_SatisfiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final InterfaceRequirement_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final InterfaceRequirement_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final InterfaceRequirement_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final InterfaceRequirement_SatisfiedBy.Match partialMatch) {
    ...
    @Override
    protected InterfaceRequirement_SatisfiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return InterfaceRequirement_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected InterfaceRequirement_SatisfiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return InterfaceRequirement_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected InterfaceRequirement_SatisfiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return InterfaceRequirement_SatisfiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<InterfaceRequirement_SatisfiedBy.Matcher> querySpecification() {
      return InterfaceRequirement_SatisfiedBy.instance();
    }
  }
  
  private InterfaceRequirement_SatisfiedBy() {
   ...
   * 
   */
  public static InterfaceRequirement_SatisfiedBy instance() {
    try{
  ...
  @Override
  protected InterfaceRequirement_SatisfiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return InterfaceRequirement_SatisfiedBy.Matcher.on(engine);
  }
  
  @Override
  public InterfaceRequirement_SatisfiedBy.Matcher instantiate() {
    return InterfaceRequirement_SatisfiedBy.Matcher.create();
  }
  
  @Override
  public InterfaceRequirement_SatisfiedBy.Match newEmptyMatch() {
    return InterfaceRequirement_SatisfiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public InterfaceRequirement_SatisfiedBy.Match newMatch(final Object... parameters) {
    return InterfaceRequirement_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link InterfaceRequirement_SatisfiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceRequirement_SatisfiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final InterfaceRequirement_SatisfiedBy INSTANCE = new InterfaceRequirement_SatisfiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final InterfaceRequirement_SatisfiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
