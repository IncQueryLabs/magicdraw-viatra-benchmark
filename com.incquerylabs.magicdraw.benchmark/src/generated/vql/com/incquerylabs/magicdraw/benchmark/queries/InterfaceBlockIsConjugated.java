...
public final class InterfaceBlockIsConjugated extends BaseGeneratedEMFQuerySpecification<InterfaceBlockIsConjugated.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link InterfaceBlockIsConjugated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link InterfaceBlockIsConjugated#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_port, var__virtual_2_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Port", "isConjugated")));
