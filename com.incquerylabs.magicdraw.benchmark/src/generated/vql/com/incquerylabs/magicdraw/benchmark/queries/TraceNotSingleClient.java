...
public final class TraceNotSingleClient extends BaseGeneratedEMFQuerySpecification<TraceNotSingleClient.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.traceNotSingleClient pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.traceNotSingleClient";
    }
    
    @Override
    public List<String> parameterNames() {
      return TraceNotSingleClient.Match.parameterNames;
    }
    ...
    @Override
    public TraceNotSingleClient.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TraceNotSingleClient.Match)) {
          TraceNotSingleClient.Match other = (TraceNotSingleClient.Match) obj;
    ...
    @Override
    public TraceNotSingleClient specification() {
     ...
     * 
     */
    public static TraceNotSingleClient.Match newEmptyMatch() {
     ...
     * 
     */
    public static TraceNotSingleClient.Match newMutableMatch(final Abstraction pTrace) {
     ...
     * 
     */
    public static TraceNotSingleClient.Match newMatch(final Abstraction pTrace) {
      return new Immutable(pTrace);
    }
    
    private static final class Mutable extends TraceNotSingleClient.Match {
    ...
    private static final class Immutable extends TraceNotSingleClient.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.traceNotSingleClient pattern,
   ...
   * 
   * @see Match
   * @see TraceNotSingleClient
   * 
   */
  public static class Matcher extends BaseMatcher<TraceNotSingleClient.Match> {
    /**
     ...
     * 
     */
    public static TraceNotSingleClient.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TraceNotSingleClient.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_TRACE = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TraceNotSingleClient.Matcher.class);
     ...
     * 
     */
    public Collection<TraceNotSingleClient.Match> getAllMatches(final Abstraction pTrace) {
     ...
     * 
     */
    public Stream<TraceNotSingleClient.Match> streamAllMatches(final Abstraction pTrace) {
     ...
     * 
     */
    public Optional<TraceNotSingleClient.Match> getOneArbitraryMatch(final Abstraction pTrace) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pTrace, final Consumer<? super TraceNotSingleClient.Match> processor) {
     ...
     * 
     */
    public TraceNotSingleClient.Match newMatch(final Abstraction pTrace) {
      return TraceNotSingleClient.Match.newMatch(pTrace);
    }
    ...
    @Override
    protected TraceNotSingleClient.Match tupleToMatch(final Tuple t) {
      try {
          return TraceNotSingleClient.Match.newMatch((Abstraction) t.get(POSITION_TRACE));
    ...
    @Override
    protected TraceNotSingleClient.Match arrayToMatch(final Object[] match) {
      try {
          return TraceNotSingleClient.Match.newMatch((Abstraction) match[POSITION_TRACE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TraceNotSingleClient.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TraceNotSingleClient.Match.newMutableMatch((Abstraction) match[POSITION_TRACE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TraceNotSingleClient.Matcher> querySpecification() {
      return TraceNotSingleClient.instance();
    }
  }
  
  private TraceNotSingleClient() {
   ...
   * 
   */
  public static TraceNotSingleClient instance() {
    try{
  ...
  @Override
  protected TraceNotSingleClient.Matcher instantiate(final ViatraQueryEngine engine) {
    return TraceNotSingleClient.Matcher.on(engine);
  }
  
  @Override
  public TraceNotSingleClient.Matcher instantiate() {
    return TraceNotSingleClient.Matcher.create();
  }
  
  @Override
  public TraceNotSingleClient.Match newEmptyMatch() {
    return TraceNotSingleClient.Match.newEmptyMatch();
  }
  
  @Override
  public TraceNotSingleClient.Match newMatch(final Object... parameters) {
    return TraceNotSingleClient.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0]);
  }
  ...
  private static class LazyHolder {
    private static final TraceNotSingleClient INSTANCE = new TraceNotSingleClient();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TraceNotSingleClient.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    private final PParameter parameter_trace = new PParameter("trace", "com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Abstraction")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_trace), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Abstraction")));
          body.setSymbolicParameters(Arrays.<ExportedParameter>asList(
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern traceNotSingleClient";
              }
