...
public final class RefineNotSingleClient extends BaseGeneratedEMFQuerySpecification<RefineNotSingleClient.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.refineNotSingleClient pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.refineNotSingleClient";
    }
    
    @Override
    public List<String> parameterNames() {
      return RefineNotSingleClient.Match.parameterNames;
    }
    ...
    @Override
    public RefineNotSingleClient.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RefineNotSingleClient.Match)) {
          RefineNotSingleClient.Match other = (RefineNotSingleClient.Match) obj;
    ...
    @Override
    public RefineNotSingleClient specification() {
     ...
     * 
     */
    public static RefineNotSingleClient.Match newEmptyMatch() {
     ...
     * 
     */
    public static RefineNotSingleClient.Match newMutableMatch(final Abstraction pAbstraction) {
     ...
     * 
     */
    public static RefineNotSingleClient.Match newMatch(final Abstraction pAbstraction) {
      return new Immutable(pAbstraction);
    }
    
    private static final class Mutable extends RefineNotSingleClient.Match {
    ...
    private static final class Immutable extends RefineNotSingleClient.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.refineNotSingleClient pattern,
   ...
   * 
   * @see Match
   * @see RefineNotSingleClient
   * 
   */
  public static class Matcher extends BaseMatcher<RefineNotSingleClient.Match> {
    /**
     ...
     * 
     */
    public static RefineNotSingleClient.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RefineNotSingleClient.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_ABSTRACTION = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RefineNotSingleClient.Matcher.class);
     ...
     * 
     */
    public Collection<RefineNotSingleClient.Match> getAllMatches(final Abstraction pAbstraction) {
     ...
     * 
     */
    public Stream<RefineNotSingleClient.Match> streamAllMatches(final Abstraction pAbstraction) {
     ...
     * 
     */
    public Optional<RefineNotSingleClient.Match> getOneArbitraryMatch(final Abstraction pAbstraction) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pAbstraction, final Consumer<? super RefineNotSingleClient.Match> processor) {
     ...
     * 
     */
    public RefineNotSingleClient.Match newMatch(final Abstraction pAbstraction) {
      return RefineNotSingleClient.Match.newMatch(pAbstraction);
    }
    ...
    @Override
    protected RefineNotSingleClient.Match tupleToMatch(final Tuple t) {
      try {
          return RefineNotSingleClient.Match.newMatch((Abstraction) t.get(POSITION_ABSTRACTION));
    ...
    @Override
    protected RefineNotSingleClient.Match arrayToMatch(final Object[] match) {
      try {
          return RefineNotSingleClient.Match.newMatch((Abstraction) match[POSITION_ABSTRACTION]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RefineNotSingleClient.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RefineNotSingleClient.Match.newMutableMatch((Abstraction) match[POSITION_ABSTRACTION]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RefineNotSingleClient.Matcher> querySpecification() {
      return RefineNotSingleClient.instance();
    }
  }
  
  private RefineNotSingleClient() {
   ...
   * 
   */
  public static RefineNotSingleClient instance() {
    try{
  ...
  @Override
  protected RefineNotSingleClient.Matcher instantiate(final ViatraQueryEngine engine) {
    return RefineNotSingleClient.Matcher.on(engine);
  }
  
  @Override
  public RefineNotSingleClient.Matcher instantiate() {
    return RefineNotSingleClient.Matcher.create();
  }
  
  @Override
  public RefineNotSingleClient.Match newEmptyMatch() {
    return RefineNotSingleClient.Match.newEmptyMatch();
  }
  
  @Override
  public RefineNotSingleClient.Match newMatch(final Object... parameters) {
    return RefineNotSingleClient.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.RefineNotSingleClient (visibility: PUBLIC, simpleName: RefineNotSingleClient, identifier: com.incquerylabs.magicdraw.benchmark.queries.RefineNotSingleClient, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class LazyHolder {
    private static final RefineNotSingleClient INSTANCE = new RefineNotSingleClient();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RefineNotSingleClient.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    private class EmbeddedQuery318181152 extends BaseGeneratedEMFPQuery {
      ...
      public EmbeddedQuery318181152() {
        super(PVisibility.EMBEDDED);
      }
      
      @Override
      public String getFullyQualifiedName() {
        return GeneratedPQuery.this.getFullyQualifiedName() + "$318181152";
      }
      ...
      public Set<PBody> doGetContainedBodies() {
        ...
        new TypeConstraint(body, Tuples.flatTupleOf(var_p0, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "Dependency", "client")));
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	clients == count Abstraction.client(abstraction, _)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new PatternMatchCounter(body, Tuples.flatTupleOf(var_abstraction, var___1_), new RefineNotSingleClient.GeneratedPQuery.EmbeddedQuery318181152(), var__virtual_0_);
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern refineNotSingleClient";
              }
