...
public final class ServiceInterface_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ServiceInterface_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInterface_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInterface_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInterface_endBoundaryType.Match)) {
          ServiceInterface_endBoundaryType.Match other = (ServiceInterface_endBoundaryType.Match) obj;
    ...
    @Override
    public ServiceInterface_endBoundaryType specification() {
      return ServiceInterface_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ServiceInterface_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInterface_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceInterface_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceInterface_endBoundaryType.Match {
    ...
    private static final class Immutable extends ServiceInterface_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ServiceInterface_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInterface_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ServiceInterface_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInterface_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInterface_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInterface_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceInterface_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceInterface_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceInterface_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ServiceInterface_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceInterface_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceInterface_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceInterface_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceInterface_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceInterface_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ServiceInterface_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInterface_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceInterface_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInterface_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInterface_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInterface_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInterface_endBoundaryType.Matcher> querySpecification() {
      return ServiceInterface_endBoundaryType.instance();
    }
  }
  
  private ServiceInterface_endBoundaryType() {
   ...
   * 
   */
  public static ServiceInterface_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ServiceInterface_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInterface_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ServiceInterface_endBoundaryType.Matcher instantiate() {
    return ServiceInterface_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ServiceInterface_endBoundaryType.Match newEmptyMatch() {
    return ServiceInterface_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInterface_endBoundaryType.Match newMatch(final Object... parameters) {
    return ServiceInterface_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInterface_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInterface_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInterface_endBoundaryType INSTANCE = new ServiceInterface_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInterface_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
