...
public final class Organization_stakeholderConcern extends BaseGeneratedEMFQuerySpecification<Organization_stakeholderConcern.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_stakeholderConcern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Organization_stakeholderConcern";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_stakeholderConcern.Match.parameterNames;
    }
    ...
    @Override
    public Organization_stakeholderConcern.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_stakeholderConcern.Match)) {
          Organization_stakeholderConcern.Match other = (Organization_stakeholderConcern.Match) obj;
    ...
    @Override
    public Organization_stakeholderConcern specification() {
      return Organization_stakeholderConcern.instance();
    }
     ...
     * 
     */
    public static Organization_stakeholderConcern.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_stakeholderConcern.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_stakeholderConcern.Match {
    ...
    private static final class Immutable extends Organization_stakeholderConcern.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Organization_stakeholderConcern pattern,
   ...
   * 
   * @see Match
   * @see Organization_stakeholderConcern
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_stakeholderConcern.Match> {
    /**
     ...
     * 
     */
    public static Organization_stakeholderConcern.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_stakeholderConcern.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_stakeholderConcern.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_stakeholderConcern.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_stakeholderConcern.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_stakeholderConcern.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_stakeholderConcern.Match> processor) {
     ...
     * 
     */
    public Organization_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_stakeholderConcern.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_stakeholderConcern.Match partialMatch) {
    ...
    @Override
    protected Organization_stakeholderConcern.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_stakeholderConcern.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_stakeholderConcern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_stakeholderConcern.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_stakeholderConcern.Matcher> querySpecification() {
      return Organization_stakeholderConcern.instance();
    }
  }
  
  private Organization_stakeholderConcern() {
   ...
   * 
   */
  public static Organization_stakeholderConcern instance() {
    try{
  ...
  @Override
  protected Organization_stakeholderConcern.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_stakeholderConcern.Matcher.on(engine);
  }
  
  @Override
  public Organization_stakeholderConcern.Matcher instantiate() {
    return Organization_stakeholderConcern.Matcher.create();
  }
  
  @Override
  public Organization_stakeholderConcern.Match newEmptyMatch() {
    return Organization_stakeholderConcern.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_stakeholderConcern.Match newMatch(final Object... parameters) {
    return Organization_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_stakeholderConcern} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_stakeholderConcern#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_stakeholderConcern INSTANCE = new Organization_stakeholderConcern();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_stakeholderConcern.GeneratedPQuery INSTANCE = new GeneratedPQuery();
