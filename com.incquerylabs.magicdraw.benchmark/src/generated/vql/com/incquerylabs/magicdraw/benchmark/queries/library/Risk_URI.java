...
public final class Risk_URI extends BaseGeneratedEMFQuerySpecification<Risk_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Risk_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Risk_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Risk_URI.Match.parameterNames;
    }
    ...
    @Override
    public Risk_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Risk_URI.Match)) {
          Risk_URI.Match other = (Risk_URI.Match) obj;
    ...
    @Override
    public Risk_URI specification() {
      return Risk_URI.instance();
    }
     ...
     * 
     */
    public static Risk_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Risk_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Risk_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Risk_URI.Match {
    ...
    private static final class Immutable extends Risk_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Risk_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Risk_URI.Match> {
    /**
     ...
     * 
     */
    public static Risk_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Risk_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Risk_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Risk_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Risk_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Risk_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Risk_URI.Match> processor) {
     ...
     * 
     */
    public Risk_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Risk_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Risk_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Risk_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Risk_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Risk_URI.Match partialMatch) {
    ...
    @Override
    protected Risk_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Risk_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Risk_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Risk_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Risk_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Risk_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Risk_URI.Matcher> querySpecification() {
      return Risk_URI.instance();
    }
  }
   ...
   * 
   */
  public static Risk_URI instance() {
    try{
  ...
  @Override
  protected Risk_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Risk_URI.Matcher.on(engine);
  }
  
  @Override
  public Risk_URI.Matcher instantiate() {
    return Risk_URI.Matcher.create();
  }
  
  @Override
  public Risk_URI.Match newEmptyMatch() {
    return Risk_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Risk_URI.Match newMatch(final Object... parameters) {
    return Risk_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Risk_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Risk_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Risk_URI INSTANCE = new Risk_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Risk_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
