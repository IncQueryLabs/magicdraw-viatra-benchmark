...
public final class OwnsRiskInContext_targetContext extends BaseGeneratedEMFQuerySpecification<OwnsRiskInContext_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRiskInContext_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRiskInContext_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRiskInContext_targetContext.Match)) {
          OwnsRiskInContext_targetContext.Match other = (OwnsRiskInContext_targetContext.Match) obj;
    ...
    @Override
    public OwnsRiskInContext_targetContext specification() {
      return OwnsRiskInContext_targetContext.instance();
    }
     ...
     * 
     */
    public static OwnsRiskInContext_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRiskInContext_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static OwnsRiskInContext_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsRiskInContext_targetContext.Match {
    ...
    private static final class Immutable extends OwnsRiskInContext_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_targetContext pattern,
   ...
   * 
   * @see Match
   * @see OwnsRiskInContext_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRiskInContext_targetContext.Match> {
    /**
     ...
     * 
     */
    public static OwnsRiskInContext_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRiskInContext_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRiskInContext_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRiskInContext_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<OwnsRiskInContext_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<OwnsRiskInContext_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super OwnsRiskInContext_targetContext.Match> processor) {
     ...
     * 
     */
    public OwnsRiskInContext_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return OwnsRiskInContext_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRiskInContext_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRiskInContext_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final OwnsRiskInContext_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final OwnsRiskInContext_targetContext.Match partialMatch) {
    ...
    @Override
    protected OwnsRiskInContext_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRiskInContext_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsRiskInContext_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRiskInContext_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRiskInContext_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRiskInContext_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRiskInContext_targetContext.Matcher> querySpecification() {
      return OwnsRiskInContext_targetContext.instance();
    }
  }
  
  private OwnsRiskInContext_targetContext() {
   ...
   * 
   */
  public static OwnsRiskInContext_targetContext instance() {
    try{
  ...
  @Override
  protected OwnsRiskInContext_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRiskInContext_targetContext.Matcher.on(engine);
  }
  
  @Override
  public OwnsRiskInContext_targetContext.Matcher instantiate() {
    return OwnsRiskInContext_targetContext.Matcher.create();
  }
  
  @Override
  public OwnsRiskInContext_targetContext.Match newEmptyMatch() {
    return OwnsRiskInContext_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRiskInContext_targetContext.Match newMatch(final Object... parameters) {
    return OwnsRiskInContext_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRiskInContext_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRiskInContext_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRiskInContext_targetContext INSTANCE = new OwnsRiskInContext_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRiskInContext_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
