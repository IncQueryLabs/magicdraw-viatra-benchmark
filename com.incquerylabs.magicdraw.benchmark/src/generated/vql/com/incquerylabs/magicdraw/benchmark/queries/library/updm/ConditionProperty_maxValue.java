...
public final class ConditionProperty_maxValue extends BaseGeneratedEMFQuerySpecification<ConditionProperty_maxValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_maxValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_maxValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionProperty_maxValue.Match.parameterNames;
    }
    ...
    @Override
    public ConditionProperty_maxValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionProperty_maxValue.Match)) {
          ConditionProperty_maxValue.Match other = (ConditionProperty_maxValue.Match) obj;
    ...
    @Override
    public ConditionProperty_maxValue specification() {
      return ConditionProperty_maxValue.instance();
    }
     ...
     * 
     */
    public static ConditionProperty_maxValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionProperty_maxValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ConditionProperty_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ConditionProperty_maxValue.Match {
    ...
    private static final class Immutable extends ConditionProperty_maxValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_maxValue pattern,
   ...
   * 
   * @see Match
   * @see ConditionProperty_maxValue
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionProperty_maxValue.Match> {
    /**
     ...
     * 
     */
    public static ConditionProperty_maxValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionProperty_maxValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionProperty_maxValue.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionProperty_maxValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ConditionProperty_maxValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ConditionProperty_maxValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ConditionProperty_maxValue.Match> processor) {
     ...
     * 
     */
    public ConditionProperty_maxValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ConditionProperty_maxValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConditionProperty_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConditionProperty_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ConditionProperty_maxValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ConditionProperty_maxValue.Match partialMatch) {
    ...
    @Override
    protected ConditionProperty_maxValue.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionProperty_maxValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ConditionProperty_maxValue.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionProperty_maxValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionProperty_maxValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionProperty_maxValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionProperty_maxValue.Matcher> querySpecification() {
      return ConditionProperty_maxValue.instance();
    }
  }
  
  private ConditionProperty_maxValue() {
   ...
   * 
   */
  public static ConditionProperty_maxValue instance() {
    try{
  ...
  @Override
  protected ConditionProperty_maxValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionProperty_maxValue.Matcher.on(engine);
  }
  
  @Override
  public ConditionProperty_maxValue.Matcher instantiate() {
    return ConditionProperty_maxValue.Matcher.create();
  }
  
  @Override
  public ConditionProperty_maxValue.Match newEmptyMatch() {
    return ConditionProperty_maxValue.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionProperty_maxValue.Match newMatch(final Object... parameters) {
    return ConditionProperty_maxValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionProperty_maxValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionProperty_maxValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionProperty_maxValue INSTANCE = new ConditionProperty_maxValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionProperty_maxValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
