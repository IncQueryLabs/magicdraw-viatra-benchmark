...
public final class ConditionProperty_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ConditionProperty_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionProperty_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ConditionProperty_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionProperty_endBoundaryType.Match)) {
          ConditionProperty_endBoundaryType.Match other = (ConditionProperty_endBoundaryType.Match) obj;
    ...
    @Override
    public ConditionProperty_endBoundaryType specification() {
      return ConditionProperty_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ConditionProperty_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionProperty_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConditionProperty_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConditionProperty_endBoundaryType.Match {
    ...
    private static final class Immutable extends ConditionProperty_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ConditionProperty_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionProperty_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ConditionProperty_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionProperty_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionProperty_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionProperty_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConditionProperty_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConditionProperty_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConditionProperty_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ConditionProperty_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ConditionProperty_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConditionProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConditionProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConditionProperty_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConditionProperty_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ConditionProperty_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionProperty_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConditionProperty_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionProperty_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionProperty_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionProperty_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionProperty_endBoundaryType.Matcher> querySpecification() {
      return ConditionProperty_endBoundaryType.instance();
    }
  }
  
  private ConditionProperty_endBoundaryType() {
   ...
   * 
   */
  public static ConditionProperty_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ConditionProperty_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionProperty_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ConditionProperty_endBoundaryType.Matcher instantiate() {
    return ConditionProperty_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ConditionProperty_endBoundaryType.Match newEmptyMatch() {
    return ConditionProperty_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionProperty_endBoundaryType.Match newMatch(final Object... parameters) {
    return ConditionProperty_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionProperty_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionProperty_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionProperty_endBoundaryType INSTANCE = new ConditionProperty_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionProperty_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
