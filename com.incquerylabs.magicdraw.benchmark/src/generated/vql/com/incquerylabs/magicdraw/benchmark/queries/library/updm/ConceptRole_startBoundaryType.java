...
public final class ConceptRole_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ConceptRole_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptRole_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ConceptRole_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptRole_startBoundaryType.Match)) {
          ConceptRole_startBoundaryType.Match other = (ConceptRole_startBoundaryType.Match) obj;
    ...
    @Override
    public ConceptRole_startBoundaryType specification() {
      return ConceptRole_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ConceptRole_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptRole_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConceptRole_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConceptRole_startBoundaryType.Match {
    ...
    private static final class Immutable extends ConceptRole_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ConceptRole_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptRole_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ConceptRole_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptRole_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptRole_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptRole_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConceptRole_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConceptRole_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConceptRole_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ConceptRole_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ConceptRole_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConceptRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConceptRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConceptRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConceptRole_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ConceptRole_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptRole_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConceptRole_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptRole_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptRole_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptRole_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptRole_startBoundaryType.Matcher> querySpecification() {
      return ConceptRole_startBoundaryType.instance();
    }
  }
  
  private ConceptRole_startBoundaryType() {
   ...
   * 
   */
  public static ConceptRole_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ConceptRole_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptRole_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ConceptRole_startBoundaryType.Matcher instantiate() {
    return ConceptRole_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ConceptRole_startBoundaryType.Match newEmptyMatch() {
    return ConceptRole_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptRole_startBoundaryType.Match newMatch(final Object... parameters) {
    return ConceptRole_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptRole_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptRole_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptRole_startBoundaryType INSTANCE = new ConceptRole_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptRole_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
