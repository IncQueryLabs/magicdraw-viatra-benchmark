...
public final class PhysicalArchitecture_actsUpon extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_actsUpon.Match)) {
          PhysicalArchitecture_actsUpon.Match other = (PhysicalArchitecture_actsUpon.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_actsUpon specification() {
      return PhysicalArchitecture_actsUpon.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_actsUpon.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_actsUpon.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_actsUpon.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_actsUpon.Matcher> querySpecification() {
      return PhysicalArchitecture_actsUpon.instance();
    }
  }
  
  private PhysicalArchitecture_actsUpon() {
   ...
   * 
   */
  public static PhysicalArchitecture_actsUpon instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_actsUpon.Matcher instantiate() {
    return PhysicalArchitecture_actsUpon.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_actsUpon.Match newEmptyMatch() {
    return PhysicalArchitecture_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_actsUpon.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_actsUpon INSTANCE = new PhysicalArchitecture_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
