...
public final class UsabilityRequirement_Master extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.usabilityRequirement_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.usabilityRequirement_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return UsabilityRequirement_Master.Match.parameterNames;
    }
    ...
    @Override
    public UsabilityRequirement_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof UsabilityRequirement_Master.Match)) {
          UsabilityRequirement_Master.Match other = (UsabilityRequirement_Master.Match) obj;
    ...
    @Override
    public UsabilityRequirement_Master specification() {
     ...
     * 
     */
    public static UsabilityRequirement_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static UsabilityRequirement_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static UsabilityRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends UsabilityRequirement_Master.Match {
    ...
    private static final class Immutable extends UsabilityRequirement_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.usabilityRequirement_Master pattern,
   ...
   * 
   * @see Match
   * @see UsabilityRequirement_Master
   * 
   */
  public static class Matcher extends BaseMatcher<UsabilityRequirement_Master.Match> {
    /**
     ...
     * 
     */
    public static UsabilityRequirement_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static UsabilityRequirement_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(UsabilityRequirement_Master.Matcher.class);
     ...
     * 
     */
    public Collection<UsabilityRequirement_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<UsabilityRequirement_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<UsabilityRequirement_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super UsabilityRequirement_Master.Match> processor) {
     ...
     * 
     */
    public UsabilityRequirement_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return UsabilityRequirement_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final UsabilityRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final UsabilityRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final UsabilityRequirement_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final UsabilityRequirement_Master.Match partialMatch) {
    ...
    @Override
    protected UsabilityRequirement_Master.Match tupleToMatch(final Tuple t) {
      try {
          return UsabilityRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected UsabilityRequirement_Master.Match arrayToMatch(final Object[] match) {
      try {
          return UsabilityRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected UsabilityRequirement_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return UsabilityRequirement_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<UsabilityRequirement_Master.Matcher> querySpecification() {
      return UsabilityRequirement_Master.instance();
    }
  }
  
  private UsabilityRequirement_Master() {
   ...
   * 
   */
  public static UsabilityRequirement_Master instance() {
    try{
  ...
  @Override
  protected UsabilityRequirement_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return UsabilityRequirement_Master.Matcher.on(engine);
  }
  
  @Override
  public UsabilityRequirement_Master.Matcher instantiate() {
    return UsabilityRequirement_Master.Matcher.create();
  }
  
  @Override
  public UsabilityRequirement_Master.Match newEmptyMatch() {
    return UsabilityRequirement_Master.Match.newEmptyMatch();
  }
  
  @Override
  public UsabilityRequirement_Master.Match newMatch(final Object... parameters) {
    return UsabilityRequirement_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link UsabilityRequirement_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link UsabilityRequirement_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final UsabilityRequirement_Master INSTANCE = new UsabilityRequirement_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final UsabilityRequirement_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
