 ...
 *         pattern Software(Element : Diagram, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "Software");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Software extends BaseGeneratedEMFQuerySpecification<Software.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Software pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Software";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software.Match.parameterNames;
    }
    ...
    @Override
    public Software.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software.Match)) {
          Software.Match other = (Software.Match) obj;
     ...
     * 
     */
    public static Software.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Software.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Software pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Software.Match> {
    /**
     ...
     * 
     */
    public static Software.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software.Matcher.class);
     ...
     * 
     */
    public Collection<Software.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Software.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Software.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super Software.Match> processor) {
     ...
     * 
     */
    public Software.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return Software.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Software.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Software.Match partialMatch) {
    ...
    protected Software.Match tupleToMatch(final Tuple t) {
      try {
          return Software.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected Software.Match arrayToMatch(final Object[] match) {
      try {
          return Software.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected Software.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software.Matcher> querySpecification() {
      return Software.instance();
    }
  }
  ...
  @Override
  protected Software.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software.Matcher.on(engine);
  }
  
  @Override
  public Software.Matcher instantiate() {
    return Software.Matcher.create();
  }
  
  @Override
  public Software.Match newEmptyMatch() {
    return Software.Match.newEmptyMatch();
  }
  
  @Override
  public Software.Match newMatch(final Object... parameters) {
    return Software.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software INSTANCE = new Software();
