...
public final class ActualOrganizationRole_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ActualOrganizationRole_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualOrganizationRole_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ActualOrganizationRole_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualOrganizationRole_endBoundaryType.Match)) {
          ActualOrganizationRole_endBoundaryType.Match other = (ActualOrganizationRole_endBoundaryType.Match) obj;
    ...
    @Override
    public ActualOrganizationRole_endBoundaryType specification() {
      return ActualOrganizationRole_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ActualOrganizationRole_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualOrganizationRole_endBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualOrganizationRole_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualOrganizationRole_endBoundaryType.Match {
    ...
    private static final class Immutable extends ActualOrganizationRole_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ActualOrganizationRole_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ActualOrganizationRole_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ActualOrganizationRole_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualOrganizationRole_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualOrganizationRole_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ActualOrganizationRole_endBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualOrganizationRole_endBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualOrganizationRole_endBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualOrganizationRole_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ActualOrganizationRole_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualOrganizationRole_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualOrganizationRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualOrganizationRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualOrganizationRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualOrganizationRole_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ActualOrganizationRole_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ActualOrganizationRole_endBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualOrganizationRole_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ActualOrganizationRole_endBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualOrganizationRole_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualOrganizationRole_endBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualOrganizationRole_endBoundaryType.Matcher> querySpecification() {
      return ActualOrganizationRole_endBoundaryType.instance();
    }
  }
  
  private ActualOrganizationRole_endBoundaryType() {
   ...
   * 
   */
  public static ActualOrganizationRole_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ActualOrganizationRole_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualOrganizationRole_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ActualOrganizationRole_endBoundaryType.Matcher instantiate() {
    return ActualOrganizationRole_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ActualOrganizationRole_endBoundaryType.Match newEmptyMatch() {
    return ActualOrganizationRole_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ActualOrganizationRole_endBoundaryType.Match newMatch(final Object... parameters) {
    return ActualOrganizationRole_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualOrganizationRole_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualOrganizationRole_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualOrganizationRole_endBoundaryType INSTANCE = new ActualOrganizationRole_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualOrganizationRole_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
