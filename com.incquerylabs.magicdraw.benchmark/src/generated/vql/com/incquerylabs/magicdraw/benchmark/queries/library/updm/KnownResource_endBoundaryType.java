...
public final class KnownResource_endBoundaryType extends BaseGeneratedEMFQuerySpecification<KnownResource_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_endBoundaryType.Match)) {
          KnownResource_endBoundaryType.Match other = (KnownResource_endBoundaryType.Match) obj;
    ...
    @Override
    public KnownResource_endBoundaryType specification() {
      return KnownResource_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static KnownResource_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_endBoundaryType.Match {
    ...
    private static final class Immutable extends KnownResource_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super KnownResource_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public KnownResource_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return KnownResource_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final KnownResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final KnownResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected KnownResource_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_endBoundaryType.Matcher> querySpecification() {
      return KnownResource_endBoundaryType.instance();
    }
  }
  
  private KnownResource_endBoundaryType() {
   ...
   * 
   */
  public static KnownResource_endBoundaryType instance() {
    try{
  ...
  @Override
  protected KnownResource_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_endBoundaryType.Matcher instantiate() {
    return KnownResource_endBoundaryType.Matcher.create();
  }
  
  @Override
  public KnownResource_endBoundaryType.Match newEmptyMatch() {
    return KnownResource_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_endBoundaryType.Match newMatch(final Object... parameters) {
    return KnownResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_endBoundaryType INSTANCE = new KnownResource_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
