...
public final class ResourceInteractionItem extends BaseGeneratedEMFQuerySpecification<ResourceInteractionItem.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceInteractionItem pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceInteractionItem";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceInteractionItem.Match.parameterNames;
    }
    ...
    @Override
    public ResourceInteractionItem.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceInteractionItem.Match)) {
          ResourceInteractionItem.Match other = (ResourceInteractionItem.Match) obj;
    ...
    @Override
    public ResourceInteractionItem specification() {
      return ResourceInteractionItem.instance();
    }
     ...
     * 
     */
    public static ResourceInteractionItem.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceInteractionItem.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResourceInteractionItem.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResourceInteractionItem.Match {
    ...
    private static final class Immutable extends ResourceInteractionItem.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceInteractionItem pattern,
   ...
   * 
   * @see Match
   * @see ResourceInteractionItem
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceInteractionItem.Match> {
    /**
     ...
     * 
     */
    public static ResourceInteractionItem.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceInteractionItem.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceInteractionItem.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceInteractionItem.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResourceInteractionItem.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResourceInteractionItem.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResourceInteractionItem.Match> processor) {
     ...
     * 
     */
    public ResourceInteractionItem.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResourceInteractionItem.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final ResourceInteractionItem.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final ResourceInteractionItem.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResourceInteractionItem.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResourceInteractionItem.Match partialMatch) {
    ...
    @Override
    protected ResourceInteractionItem.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceInteractionItem.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResourceInteractionItem.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceInteractionItem.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceInteractionItem.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceInteractionItem.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceInteractionItem.Matcher> querySpecification() {
      return ResourceInteractionItem.instance();
    }
  }
  
  private ResourceInteractionItem() {
   ...
   * 
   */
  public static ResourceInteractionItem instance() {
    try{
  ...
  @Override
  protected ResourceInteractionItem.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceInteractionItem.Matcher.on(engine);
  }
  
  @Override
  public ResourceInteractionItem.Matcher instantiate() {
    return ResourceInteractionItem.Matcher.create();
  }
  
  @Override
  public ResourceInteractionItem.Match newEmptyMatch() {
    return ResourceInteractionItem.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceInteractionItem.Match newMatch(final Object... parameters) {
    return ResourceInteractionItem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceInteractionItem} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceInteractionItem#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceInteractionItem INSTANCE = new ResourceInteractionItem();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceInteractionItem.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ResourceInteractionItem");
