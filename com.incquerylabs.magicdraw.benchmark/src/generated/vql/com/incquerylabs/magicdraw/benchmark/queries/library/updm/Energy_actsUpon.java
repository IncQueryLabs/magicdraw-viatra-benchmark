...
public final class Energy_actsUpon extends BaseGeneratedEMFQuerySpecification<Energy_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public Energy_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_actsUpon.Match)) {
          Energy_actsUpon.Match other = (Energy_actsUpon.Match) obj;
    ...
    @Override
    public Energy_actsUpon specification() {
      return Energy_actsUpon.instance();
    }
     ...
     * 
     */
    public static Energy_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_actsUpon.Match {
    ...
    private static final class Immutable extends Energy_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_actsUpon pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static Energy_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_actsUpon.Match> processor) {
     ...
     * 
     */
    public Energy_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_actsUpon.Match partialMatch) {
    ...
    @Override
    protected Energy_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_actsUpon.Matcher> querySpecification() {
      return Energy_actsUpon.instance();
    }
  }
  
  private Energy_actsUpon() {
   ...
   * 
   */
  public static Energy_actsUpon instance() {
    try{
  ...
  @Override
  protected Energy_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public Energy_actsUpon.Matcher instantiate() {
    return Energy_actsUpon.Matcher.create();
  }
  
  @Override
  public Energy_actsUpon.Match newEmptyMatch() {
    return Energy_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_actsUpon.Match newMatch(final Object... parameters) {
    return Energy_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_actsUpon INSTANCE = new Energy_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
