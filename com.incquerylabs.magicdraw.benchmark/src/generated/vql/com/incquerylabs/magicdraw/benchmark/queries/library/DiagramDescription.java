...
public final class DiagramDescription extends BaseGeneratedEMFQuerySpecification<DiagramDescription.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static DiagramDescription.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static DiagramDescription.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<DiagramDescription.Match> {
     ...
     * 
     */
    public Collection<DiagramDescription.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<DiagramDescription.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<DiagramDescription.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super DiagramDescription.Match> processor) {
     ...
     * 
     */
    public DiagramDescription.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return DiagramDescription.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final DiagramDescription.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final DiagramDescription.Match partialMatch) {
    ...
    protected DiagramDescription.Match tupleToMatch(final Tuple t) {
      try {
          return DiagramDescription.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected DiagramDescription.Match arrayToMatch(final Object[] match) {
      try {
          return DiagramDescription.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected DiagramDescription.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DiagramDescription.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public DiagramDescription.Match newMatch(final Object... parameters) {
    return DiagramDescription.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
