 ...
 *         pattern ConstraintProperty(Element : Property, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "ConstraintProperty");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class ConstraintProperty extends BaseGeneratedEMFQuerySpecification<ConstraintProperty.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ConstraintProperty.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ConstraintProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<ConstraintProperty.Match> {
     ...
     * 
     */
    public Collection<ConstraintProperty.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ConstraintProperty.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ConstraintProperty.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super ConstraintProperty.Match> processor) {
     ...
     * 
     */
    public ConstraintProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return ConstraintProperty.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ConstraintProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ConstraintProperty.Match partialMatch) {
    ...
    protected ConstraintProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ConstraintProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ConstraintProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ConstraintProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ConstraintProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConstraintProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ConstraintProperty.Match newMatch(final Object... parameters) {
    return ConstraintProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
