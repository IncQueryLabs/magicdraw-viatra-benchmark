...
public final class Organization_appliesTo extends BaseGeneratedEMFQuerySpecification<Organization_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Organization_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_appliesTo.Match)) {
          Organization_appliesTo.Match other = (Organization_appliesTo.Match) obj;
    ...
    @Override
    public Organization_appliesTo specification() {
      return Organization_appliesTo.instance();
    }
     ...
     * 
     */
    public static Organization_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_appliesTo.Match {
    ...
    private static final class Immutable extends Organization_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Organization_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Organization_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_appliesTo.Match> processor) {
     ...
     * 
     */
    public Organization_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Organization_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_appliesTo.Matcher> querySpecification() {
      return Organization_appliesTo.instance();
    }
  }
  
  private Organization_appliesTo() {
   ...
   * 
   */
  public static Organization_appliesTo instance() {
    try{
  ...
  @Override
  protected Organization_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Organization_appliesTo.Matcher instantiate() {
    return Organization_appliesTo.Matcher.create();
  }
  
  @Override
  public Organization_appliesTo.Match newEmptyMatch() {
    return Organization_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_appliesTo.Match newMatch(final Object... parameters) {
    return Organization_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_appliesTo INSTANCE = new Organization_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
