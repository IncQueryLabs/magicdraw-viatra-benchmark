...
public final class EnterprisePhase_fulfills extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_fulfills.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_fulfills pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_fulfills";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_fulfills.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_fulfills.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_fulfills.Match)) {
          EnterprisePhase_fulfills.Match other = (EnterprisePhase_fulfills.Match) obj;
    ...
    @Override
    public EnterprisePhase_fulfills specification() {
      return EnterprisePhase_fulfills.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_fulfills.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_fulfills.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_fulfills.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_fulfills.Match {
    ...
    private static final class Immutable extends EnterprisePhase_fulfills.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_fulfills pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_fulfills
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_fulfills.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_fulfills.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_fulfills.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_fulfills.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_fulfills.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_fulfills.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_fulfills.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_fulfills.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_fulfills.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_fulfills.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_fulfills.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_fulfills.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_fulfills.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_fulfills.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_fulfills.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_fulfills.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_fulfills.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_fulfills.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_fulfills.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_fulfills.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_fulfills.Matcher> querySpecification() {
      return EnterprisePhase_fulfills.instance();
    }
  }
  
  private EnterprisePhase_fulfills() {
   ...
   * 
   */
  public static EnterprisePhase_fulfills instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_fulfills.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_fulfills.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_fulfills.Matcher instantiate() {
    return EnterprisePhase_fulfills.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_fulfills.Match newEmptyMatch() {
    return EnterprisePhase_fulfills.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_fulfills.Match newMatch(final Object... parameters) {
    return EnterprisePhase_fulfills.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_fulfills} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_fulfills#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_fulfills INSTANCE = new EnterprisePhase_fulfills();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_fulfills.GeneratedPQuery INSTANCE = new GeneratedPQuery();
