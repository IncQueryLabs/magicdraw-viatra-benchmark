 ...
 *         pattern AbstractReferenceProperty(Element : Property, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "AbstractReferenceProperty");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class AbstractReferenceProperty extends BaseGeneratedEMFQuerySpecification<AbstractReferenceProperty.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static AbstractReferenceProperty.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static AbstractReferenceProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<AbstractReferenceProperty.Match> {
     ...
     * 
     */
    public Collection<AbstractReferenceProperty.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<AbstractReferenceProperty.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<AbstractReferenceProperty.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super AbstractReferenceProperty.Match> processor) {
     ...
     * 
     */
    public AbstractReferenceProperty.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return AbstractReferenceProperty.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final AbstractReferenceProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final AbstractReferenceProperty.Match partialMatch) {
    ...
    protected AbstractReferenceProperty.Match tupleToMatch(final Tuple t) {
      try {
          return AbstractReferenceProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected AbstractReferenceProperty.Match arrayToMatch(final Object[] match) {
      try {
          return AbstractReferenceProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected AbstractReferenceProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AbstractReferenceProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public AbstractReferenceProperty.Match newMatch(final Object... parameters) {
    return AbstractReferenceProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
