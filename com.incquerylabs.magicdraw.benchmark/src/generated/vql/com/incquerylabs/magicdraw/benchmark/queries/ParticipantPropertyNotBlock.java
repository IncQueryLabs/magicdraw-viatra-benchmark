...
public final class ParticipantPropertyNotBlock extends BaseGeneratedEMFQuerySpecification<ParticipantPropertyNotBlock.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.participantPropertyNotBlock pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.participantPropertyNotBlock";
    }
    
    @Override
    public List<String> parameterNames() {
      return ParticipantPropertyNotBlock.Match.parameterNames;
    }
    ...
    @Override
    public ParticipantPropertyNotBlock.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ParticipantPropertyNotBlock.Match)) {
          ParticipantPropertyNotBlock.Match other = (ParticipantPropertyNotBlock.Match) obj;
    ...
    @Override
    public ParticipantPropertyNotBlock specification() {
     ...
     * 
     */
    public static ParticipantPropertyNotBlock.Match newEmptyMatch() {
     ...
     * 
     */
    public static ParticipantPropertyNotBlock.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass, final Property pProperty) {
     ...
     * 
     */
    public static ParticipantPropertyNotBlock.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass, final Property pProperty) {
      return new Immutable(pClass, pProperty);
    }
    
    private static final class Mutable extends ParticipantPropertyNotBlock.Match {
    ...
    private static final class Immutable extends ParticipantPropertyNotBlock.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.participantPropertyNotBlock pattern,
   ...
   * 
   * @see Match
   * @see ParticipantPropertyNotBlock
   * 
   */
  public static class Matcher extends BaseMatcher<ParticipantPropertyNotBlock.Match> {
    /**
     ...
     * 
     */
    public static ParticipantPropertyNotBlock.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ParticipantPropertyNotBlock.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ParticipantPropertyNotBlock.Matcher.class);
     ...
     * 
     */
    public Collection<ParticipantPropertyNotBlock.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass, final Property pProperty) {
     ...
     * 
     */
    public Stream<ParticipantPropertyNotBlock.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass, final Property pProperty) {
     ...
     * 
     */
    public Optional<ParticipantPropertyNotBlock.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass, final Property pProperty) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass, final Property pProperty, final Consumer<? super ParticipantPropertyNotBlock.Match> processor) {
     ...
     * 
     */
    public ParticipantPropertyNotBlock.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pClass, final Property pProperty) {
      return ParticipantPropertyNotBlock.Match.newMatch(pClass, pProperty);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfclass(final ParticipantPropertyNotBlock.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfclass(final ParticipantPropertyNotBlock.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfproperty(final ParticipantPropertyNotBlock.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfproperty(final ParticipantPropertyNotBlock.Match partialMatch) {
    ...
    @Override
    protected ParticipantPropertyNotBlock.Match tupleToMatch(final Tuple t) {
      try {
          return ParticipantPropertyNotBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_CLASS), (Property) t.get(POSITION_PROPERTY));
    ...
    @Override
    protected ParticipantPropertyNotBlock.Match arrayToMatch(final Object[] match) {
      try {
          return ParticipantPropertyNotBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_CLASS], (Property) match[POSITION_PROPERTY]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ParticipantPropertyNotBlock.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ParticipantPropertyNotBlock.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_CLASS], (Property) match[POSITION_PROPERTY]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ParticipantPropertyNotBlock.Matcher> querySpecification() {
      return ParticipantPropertyNotBlock.instance();
    }
  }
  
  private ParticipantPropertyNotBlock() {
   ...
   * 
   */
  public static ParticipantPropertyNotBlock instance() {
    try{
  ...
  @Override
  protected ParticipantPropertyNotBlock.Matcher instantiate(final ViatraQueryEngine engine) {
    return ParticipantPropertyNotBlock.Matcher.on(engine);
  }
  
  @Override
  public ParticipantPropertyNotBlock.Matcher instantiate() {
    return ParticipantPropertyNotBlock.Matcher.create();
  }
  
  @Override
  public ParticipantPropertyNotBlock.Match newEmptyMatch() {
    return ParticipantPropertyNotBlock.Match.newEmptyMatch();
  }
  
  @Override
  public ParticipantPropertyNotBlock.Match newMatch(final Object... parameters) {
    return ParticipantPropertyNotBlock.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  ...
  private static class LazyHolder {
    private static final ParticipantPropertyNotBlock INSTANCE = new ParticipantPropertyNotBlock();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ParticipantPropertyNotBlock.GeneratedPQuery INSTANCE = new GeneratedPQuery();
