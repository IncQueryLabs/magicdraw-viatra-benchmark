...
public final class Standard_currentStatus extends BaseGeneratedEMFQuerySpecification<Standard_currentStatus.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_currentStatus pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_currentStatus";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_currentStatus.Match.parameterNames;
    }
    ...
    @Override
    public Standard_currentStatus.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_currentStatus.Match)) {
          Standard_currentStatus.Match other = (Standard_currentStatus.Match) obj;
    ...
    @Override
    public Standard_currentStatus specification() {
      return Standard_currentStatus.instance();
    }
     ...
     * 
     */
    public static Standard_currentStatus.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_currentStatus.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Standard_currentStatus.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Standard_currentStatus.Match {
    ...
    private static final class Immutable extends Standard_currentStatus.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_currentStatus pattern,
   ...
   * 
   * @see Match
   * @see Standard_currentStatus
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_currentStatus.Match> {
    /**
     ...
     * 
     */
    public static Standard_currentStatus.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_currentStatus.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_currentStatus.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_currentStatus.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Standard_currentStatus.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Standard_currentStatus.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Standard_currentStatus.Match> processor) {
     ...
     * 
     */
    public Standard_currentStatus.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Standard_currentStatus.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Standard_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Standard_currentStatus.Match partialMatch) {
    ...
    @Override
    protected Standard_currentStatus.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Standard_currentStatus.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_currentStatus.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_currentStatus.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_currentStatus.Matcher> querySpecification() {
      return Standard_currentStatus.instance();
    }
  }
  
  private Standard_currentStatus() {
   ...
   * 
   */
  public static Standard_currentStatus instance() {
    try{
  ...
  @Override
  protected Standard_currentStatus.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_currentStatus.Matcher.on(engine);
  }
  
  @Override
  public Standard_currentStatus.Matcher instantiate() {
    return Standard_currentStatus.Matcher.create();
  }
  
  @Override
  public Standard_currentStatus.Match newEmptyMatch() {
    return Standard_currentStatus.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_currentStatus.Match newMatch(final Object... parameters) {
    return Standard_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_currentStatus} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_currentStatus#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_currentStatus INSTANCE = new Standard_currentStatus();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_currentStatus.GeneratedPQuery INSTANCE = new GeneratedPQuery();
