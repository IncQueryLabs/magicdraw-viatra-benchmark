...
public final class Responsibility_appliesTo extends BaseGeneratedEMFQuerySpecification<Responsibility_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_appliesTo.Match)) {
          Responsibility_appliesTo.Match other = (Responsibility_appliesTo.Match) obj;
    ...
    @Override
    public Responsibility_appliesTo specification() {
      return Responsibility_appliesTo.instance();
    }
     ...
     * 
     */
    public static Responsibility_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_appliesTo.Match {
    ...
    private static final class Immutable extends Responsibility_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_appliesTo.Match> processor) {
     ...
     * 
     */
    public Responsibility_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Responsibility_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_appliesTo.Matcher> querySpecification() {
      return Responsibility_appliesTo.instance();
    }
  }
  
  private Responsibility_appliesTo() {
   ...
   * 
   */
  public static Responsibility_appliesTo instance() {
    try{
  ...
  @Override
  protected Responsibility_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_appliesTo.Matcher instantiate() {
    return Responsibility_appliesTo.Matcher.create();
  }
  
  @Override
  public Responsibility_appliesTo.Match newEmptyMatch() {
    return Responsibility_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_appliesTo.Match newMatch(final Object... parameters) {
    return Responsibility_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_appliesTo INSTANCE = new Responsibility_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
