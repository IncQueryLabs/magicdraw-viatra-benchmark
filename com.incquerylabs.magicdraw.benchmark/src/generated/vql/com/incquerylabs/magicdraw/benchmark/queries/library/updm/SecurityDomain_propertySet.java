...
public final class SecurityDomain_propertySet extends BaseGeneratedEMFQuerySpecification<SecurityDomain_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_propertySet.Match)) {
          SecurityDomain_propertySet.Match other = (SecurityDomain_propertySet.Match) obj;
    ...
    @Override
    public SecurityDomain_propertySet specification() {
      return SecurityDomain_propertySet.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityDomain_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_propertySet.Match {
    ...
    private static final class Immutable extends SecurityDomain_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_propertySet pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_propertySet.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityDomain_propertySet.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityDomain_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityDomain_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityDomain_propertySet.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_propertySet.Matcher> querySpecification() {
      return SecurityDomain_propertySet.instance();
    }
  }
  
  private SecurityDomain_propertySet() {
   ...
   * 
   */
  public static SecurityDomain_propertySet instance() {
    try{
  ...
  @Override
  protected SecurityDomain_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_propertySet.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_propertySet.Matcher instantiate() {
    return SecurityDomain_propertySet.Matcher.create();
  }
  
  @Override
  public SecurityDomain_propertySet.Match newEmptyMatch() {
    return SecurityDomain_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_propertySet.Match newMatch(final Object... parameters) {
    return SecurityDomain_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_propertySet INSTANCE = new SecurityDomain_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
