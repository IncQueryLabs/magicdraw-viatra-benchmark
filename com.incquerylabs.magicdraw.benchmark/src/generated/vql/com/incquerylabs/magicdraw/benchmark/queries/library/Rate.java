...
public final class Rate extends BaseGeneratedEMFQuerySpecification<Rate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Rate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Rate";
    }
    
    @Override
    public List<String> parameterNames() {
      return Rate.Match.parameterNames;
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Rate.Match)) {
          Rate.Match other = (Rate.Match) obj;
     ...
     * 
     */
    public static Rate.Match newEmptyMatch() {
     ...
     * 
     */
    public static Rate.Match newMutableMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Rate.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Rate.Match {
    ...
    private static final class Immutable extends Rate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Rate pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Rate.Match> {
    /**
     ...
     * 
     */
    public static Rate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Rate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Rate.Matcher.class);
     ...
     * 
     */
    public Collection<Rate.Match> getAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Rate.Match> streamAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Rate.Match> getOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype, final Consumer<? super Rate.Match> processor) {
     ...
     * 
     */
    public Rate.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
      return Rate.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfElement(final Rate.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfElement(final Rate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Rate.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Rate.Match partialMatch) {
    ...
    @Override
    protected Rate.Match tupleToMatch(final Tuple t) {
      try {
          return Rate.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Rate.Match arrayToMatch(final Object[] match) {
      try {
          return Rate.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Rate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rate.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Rate.Matcher> querySpecification() {
      return Rate.instance();
    }
  }
  ...
  @Override
  protected Rate.Matcher instantiate(final ViatraQueryEngine engine) {
    return Rate.Matcher.on(engine);
  }
  
  @Override
  public Rate.Matcher instantiate() {
    return Rate.Matcher.create();
  }
  
  @Override
  public Rate.Match newEmptyMatch() {
    return Rate.Match.newEmptyMatch();
  }
  
  @Override
  public Rate.Match newMatch(final Object... parameters) {
    return Rate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Rate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Rate#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Rate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Rate");
