...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability;
...
public final class Capability_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Capability_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Capability_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Capability_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Capability_actualPropertySet.Match)) {
          Capability_actualPropertySet.Match other = (Capability_actualPropertySet.Match) obj;
    ...
    @Override
    public Capability_actualPropertySet specification() {
      return Capability_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Capability_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Capability_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Capability_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Capability_actualPropertySet.Match {
    ...
    private static final class Immutable extends Capability_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Capability_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Capability_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Capability_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Capability_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Capability_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Capability_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Capability_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Capability_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Capability_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Capability_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Capability_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Capability_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Capability_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Capability_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Capability_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Capability_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Capability_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Capability_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Capability_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Capability_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Capability_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Capability_actualPropertySet.Matcher> querySpecification() {
      return Capability_actualPropertySet.instance();
    }
  }
  
  private Capability_actualPropertySet() {
   ...
   * 
   */
  public static Capability_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Capability_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Capability_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Capability_actualPropertySet.Matcher instantiate() {
    return Capability_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Capability_actualPropertySet.Match newEmptyMatch() {
    return Capability_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Capability_actualPropertySet.Match newMatch(final Object... parameters) {
    return Capability_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Capability_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Capability_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Capability_actualPropertySet INSTANCE = new Capability_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Capability_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Capability(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Capability.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
