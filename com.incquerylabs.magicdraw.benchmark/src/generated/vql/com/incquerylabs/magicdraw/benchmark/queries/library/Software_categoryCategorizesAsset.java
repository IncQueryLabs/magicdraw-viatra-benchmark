...
public final class Software_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<Software_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Software_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public Software_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_categoryCategorizesAsset.Match)) {
          Software_categoryCategorizesAsset.Match other = (Software_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public Software_categoryCategorizesAsset specification() {
      return Software_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static Software_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends Software_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Software_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see Software_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<Software_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static Software_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<Software_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public Software_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected Software_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return Software_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return Software_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_categoryCategorizesAsset.Matcher> querySpecification() {
      return Software_categoryCategorizesAsset.instance();
    }
  }
  
  private Software_categoryCategorizesAsset() {
   ...
   * 
   */
  public static Software_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected Software_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public Software_categoryCategorizesAsset.Matcher instantiate() {
    return Software_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public Software_categoryCategorizesAsset.Match newEmptyMatch() {
    return Software_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public Software_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return Software_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_categoryCategorizesAsset INSTANCE = new Software_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
