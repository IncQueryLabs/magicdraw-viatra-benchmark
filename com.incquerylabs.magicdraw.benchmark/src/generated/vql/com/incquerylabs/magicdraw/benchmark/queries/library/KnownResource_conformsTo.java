...
public final class KnownResource_conformsTo extends BaseGeneratedEMFQuerySpecification<KnownResource_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_conformsTo.Match)) {
          KnownResource_conformsTo.Match other = (KnownResource_conformsTo.Match) obj;
    ...
    @Override
    public KnownResource_conformsTo specification() {
      return KnownResource_conformsTo.instance();
    }
     ...
     * 
     */
    public static KnownResource_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_conformsTo.Match {
    ...
    private static final class Immutable extends KnownResource_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super KnownResource_conformsTo.Match> processor) {
     ...
     * 
     */
    public KnownResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return KnownResource_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final KnownResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final KnownResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_conformsTo.Match partialMatch) {
    ...
    @Override
    protected KnownResource_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_conformsTo.Matcher> querySpecification() {
      return KnownResource_conformsTo.instance();
    }
  }
  
  private KnownResource_conformsTo() {
   ...
   * 
   */
  public static KnownResource_conformsTo instance() {
    try{
  ...
  @Override
  protected KnownResource_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_conformsTo.Matcher instantiate() {
    return KnownResource_conformsTo.Matcher.create();
  }
  
  @Override
  public KnownResource_conformsTo.Match newEmptyMatch() {
    return KnownResource_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_conformsTo.Match newMatch(final Object... parameters) {
    return KnownResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_conformsTo INSTANCE = new KnownResource_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
