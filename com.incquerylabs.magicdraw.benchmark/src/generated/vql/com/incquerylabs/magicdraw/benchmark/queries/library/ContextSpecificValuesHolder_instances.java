 ...
 *         	find contextSpecificValuesHolder(Element, stereotype);
 *         	find taggedValue(Element, stereotype, "instances", taggedValue);
...
public final class ContextSpecificValuesHolder_instances extends BaseGeneratedEMFQuerySpecification<ContextSpecificValuesHolder_instances.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.contextSpecificValuesHolder_instances pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.contextSpecificValuesHolder_instances";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.contextSpecificValuesHolder_instances pattern,
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find contextSpecificValuesHolder(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), ContextSpecificValuesHolder.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "instances", taggedValue)
