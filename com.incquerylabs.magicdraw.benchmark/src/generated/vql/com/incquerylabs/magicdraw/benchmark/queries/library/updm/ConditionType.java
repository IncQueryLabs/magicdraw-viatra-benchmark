...
public final class ConditionType extends BaseGeneratedEMFQuerySpecification<ConditionType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionType.Match.parameterNames;
    }
    ...
    @Override
    public ConditionType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionType.Match)) {
          ConditionType.Match other = (ConditionType.Match) obj;
    ...
    @Override
    public ConditionType specification() {
      return ConditionType.instance();
    }
     ...
     * 
     */
    public static ConditionType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionType.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ConditionType.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ConditionType.Match {
    ...
    private static final class Immutable extends ConditionType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionType pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionType.Match> {
    /**
     ...
     * 
     */
    public static ConditionType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionType.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionType.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ConditionType.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ConditionType.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ConditionType.Match> processor) {
     ...
     * 
     */
    public ConditionType.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ConditionType.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final ConditionType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final ConditionType.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ConditionType.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ConditionType.Match partialMatch) {
    ...
    @Override
    protected ConditionType.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionType.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ConditionType.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionType.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionType.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionType.Matcher> querySpecification() {
      return ConditionType.instance();
    }
  }
   ...
   * 
   */
  public static ConditionType instance() {
    try{
  ...
  @Override
  protected ConditionType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionType.Matcher.on(engine);
  }
  
  @Override
  public ConditionType.Matcher instantiate() {
    return ConditionType.Matcher.create();
  }
  
  @Override
  public ConditionType.Match newEmptyMatch() {
    return ConditionType.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionType.Match newMatch(final Object... parameters) {
    return ConditionType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionType INSTANCE = new ConditionType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ConditionType");
