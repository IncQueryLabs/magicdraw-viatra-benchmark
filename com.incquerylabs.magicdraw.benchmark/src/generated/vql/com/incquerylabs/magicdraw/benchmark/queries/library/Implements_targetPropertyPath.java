...
public final class Implements_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Implements_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Implements_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Implements_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Implements_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Implements_targetPropertyPath.Match)) {
          Implements_targetPropertyPath.Match other = (Implements_targetPropertyPath.Match) obj;
    ...
    @Override
    public Implements_targetPropertyPath specification() {
      return Implements_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static Implements_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Implements_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Implements_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Implements_targetPropertyPath.Match {
    ...
    private static final class Immutable extends Implements_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Implements_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Implements_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Implements_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Implements_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Implements_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Implements_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Implements_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Implements_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Implements_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Implements_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public Implements_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Implements_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Implements_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Implements_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Implements_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Implements_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected Implements_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Implements_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Implements_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Implements_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Implements_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Implements_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Implements_targetPropertyPath.Matcher> querySpecification() {
      return Implements_targetPropertyPath.instance();
    }
  }
  
  private Implements_targetPropertyPath() {
   ...
   * 
   */
  public static Implements_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected Implements_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Implements_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Implements_targetPropertyPath.Matcher instantiate() {
    return Implements_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public Implements_targetPropertyPath.Match newEmptyMatch() {
    return Implements_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Implements_targetPropertyPath.Match newMatch(final Object... parameters) {
    return Implements_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Implements_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Implements_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Implements_targetPropertyPath INSTANCE = new Implements_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Implements_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
