...
public final class PhysicalArchitecture extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture.Match)) {
          PhysicalArchitecture.Match other = (PhysicalArchitecture.Match) obj;
    ...
    @Override
    public PhysicalArchitecture specification() {
      return PhysicalArchitecture.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static PhysicalArchitecture.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends PhysicalArchitecture.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super PhysicalArchitecture.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return PhysicalArchitecture.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final PhysicalArchitecture.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final PhysicalArchitecture.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected PhysicalArchitecture.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture.Matcher> querySpecification() {
      return PhysicalArchitecture.instance();
    }
  }
  ...
  @Override
  protected PhysicalArchitecture.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture.Matcher instantiate() {
    return PhysicalArchitecture.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture.Match newEmptyMatch() {
    return PhysicalArchitecture.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture INSTANCE = new PhysicalArchitecture();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "PhysicalArchitecture");
