...
public final class Control_propertySet extends BaseGeneratedEMFQuerySpecification<Control_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Control_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Control_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Control_propertySet.Match)) {
          Control_propertySet.Match other = (Control_propertySet.Match) obj;
    ...
    @Override
    public Control_propertySet specification() {
      return Control_propertySet.instance();
    }
     ...
     * 
     */
    public static Control_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Control_propertySet.Match newMutableMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public static Control_propertySet.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Control_propertySet.Match {
    ...
    private static final class Immutable extends Control_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Control_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Control_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Control_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Control_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Control_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Control_propertySet.Match> getAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Control_propertySet.Match> streamAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Control_propertySet.Match> getOneArbitraryMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final Element pValue, final Consumer<? super Control_propertySet.Match> processor) {
     ...
     * 
     */
    public Control_propertySet.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return Control_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Control_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Control_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Control_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Control_propertySet.Match partialMatch) {
    ...
    @Override
    protected Control_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Control_propertySet.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Control_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Control_propertySet.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Control_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Control_propertySet.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Control_propertySet.Matcher> querySpecification() {
      return Control_propertySet.instance();
    }
  }
  
  private Control_propertySet() {
   ...
   * 
   */
  public static Control_propertySet instance() {
    try{
  ...
  @Override
  protected Control_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Control_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Control_propertySet.Matcher instantiate() {
    return Control_propertySet.Matcher.create();
  }
  
  @Override
  public Control_propertySet.Match newEmptyMatch() {
    return Control_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Control_propertySet.Match newMatch(final Object... parameters) {
    return Control_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Control_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Control_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Control_propertySet INSTANCE = new Control_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Control_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
