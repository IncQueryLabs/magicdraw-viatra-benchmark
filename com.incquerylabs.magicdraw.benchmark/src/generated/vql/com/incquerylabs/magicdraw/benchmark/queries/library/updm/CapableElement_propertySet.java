...
public final class CapableElement_propertySet extends BaseGeneratedEMFQuerySpecification<CapableElement_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapableElement_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public CapableElement_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapableElement_propertySet.Match)) {
          CapableElement_propertySet.Match other = (CapableElement_propertySet.Match) obj;
    ...
    @Override
    public CapableElement_propertySet specification() {
      return CapableElement_propertySet.instance();
    }
     ...
     * 
     */
    public static CapableElement_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapableElement_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapableElement_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapableElement_propertySet.Match {
    ...
    private static final class Immutable extends CapableElement_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_propertySet pattern,
   ...
   * 
   * @see Match
   * @see CapableElement_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<CapableElement_propertySet.Match> {
    /**
     ...
     * 
     */
    public static CapableElement_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapableElement_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapableElement_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<CapableElement_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapableElement_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapableElement_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapableElement_propertySet.Match> processor) {
     ...
     * 
     */
    public CapableElement_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapableElement_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapableElement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapableElement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapableElement_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapableElement_propertySet.Match partialMatch) {
    ...
    @Override
    protected CapableElement_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return CapableElement_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapableElement_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return CapableElement_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapableElement_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapableElement_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapableElement_propertySet.Matcher> querySpecification() {
      return CapableElement_propertySet.instance();
    }
  }
  
  private CapableElement_propertySet() {
   ...
   * 
   */
  public static CapableElement_propertySet instance() {
    try{
  ...
  @Override
  protected CapableElement_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapableElement_propertySet.Matcher.on(engine);
  }
  
  @Override
  public CapableElement_propertySet.Matcher instantiate() {
    return CapableElement_propertySet.Matcher.create();
  }
  
  @Override
  public CapableElement_propertySet.Match newEmptyMatch() {
    return CapableElement_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public CapableElement_propertySet.Match newMatch(final Object... parameters) {
    return CapableElement_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapableElement_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapableElement_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapableElement_propertySet INSTANCE = new CapableElement_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapableElement_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
