...
public final class PhysicalResource_actualPropertySet extends BaseGeneratedEMFQuerySpecification<PhysicalResource_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_actualPropertySet.Match)) {
          PhysicalResource_actualPropertySet.Match other = (PhysicalResource_actualPropertySet.Match) obj;
    ...
    @Override
    public PhysicalResource_actualPropertySet specification() {
      return PhysicalResource_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_actualPropertySet.Match {
    ...
    private static final class Immutable extends PhysicalResource_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_actualPropertySet.Matcher> querySpecification() {
      return PhysicalResource_actualPropertySet.instance();
    }
  }
  
  private PhysicalResource_actualPropertySet() {
   ...
   * 
   */
  public static PhysicalResource_actualPropertySet instance() {
    try{
  ...
  @Override
  protected PhysicalResource_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_actualPropertySet.Matcher instantiate() {
    return PhysicalResource_actualPropertySet.Matcher.create();
  }
  
  @Override
  public PhysicalResource_actualPropertySet.Match newEmptyMatch() {
    return PhysicalResource_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_actualPropertySet.Match newMatch(final Object... parameters) {
    return PhysicalResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_actualPropertySet INSTANCE = new PhysicalResource_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
