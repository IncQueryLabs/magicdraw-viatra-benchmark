...
public final class LogicalArchitecture_actualPropertySet extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_actualPropertySet.Match)) {
          LogicalArchitecture_actualPropertySet.Match other = (LogicalArchitecture_actualPropertySet.Match) obj;
    ...
    @Override
    public LogicalArchitecture_actualPropertySet specification() {
      return LogicalArchitecture_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static LogicalArchitecture_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends LogicalArchitecture_actualPropertySet.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super LogicalArchitecture_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return LogicalArchitecture_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final LogicalArchitecture_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final LogicalArchitecture_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected LogicalArchitecture_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_actualPropertySet.Matcher> querySpecification() {
      return LogicalArchitecture_actualPropertySet.instance();
    }
  }
  
  private LogicalArchitecture_actualPropertySet() {
   ...
   * 
   */
  public static LogicalArchitecture_actualPropertySet instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_actualPropertySet.Matcher instantiate() {
    return LogicalArchitecture_actualPropertySet.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_actualPropertySet.Match newEmptyMatch() {
    return LogicalArchitecture_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_actualPropertySet.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_actualPropertySet INSTANCE = new LogicalArchitecture_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
