...
public final class PersonType_conformsTo extends BaseGeneratedEMFQuerySpecification<PersonType_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_conformsTo.Match)) {
          PersonType_conformsTo.Match other = (PersonType_conformsTo.Match) obj;
    ...
    @Override
    public PersonType_conformsTo specification() {
      return PersonType_conformsTo.instance();
    }
     ...
     * 
     */
    public static PersonType_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_conformsTo.Match {
    ...
    private static final class Immutable extends PersonType_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see PersonType_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static PersonType_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_conformsTo.Match> processor) {
     ...
     * 
     */
    public PersonType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_conformsTo.Match partialMatch) {
    ...
    @Override
    protected PersonType_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_conformsTo.Matcher> querySpecification() {
      return PersonType_conformsTo.instance();
    }
  }
  
  private PersonType_conformsTo() {
   ...
   * 
   */
  public static PersonType_conformsTo instance() {
    try{
  ...
  @Override
  protected PersonType_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public PersonType_conformsTo.Matcher instantiate() {
    return PersonType_conformsTo.Matcher.create();
  }
  
  @Override
  public PersonType_conformsTo.Match newEmptyMatch() {
    return PersonType_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_conformsTo.Match newMatch(final Object... parameters) {
    return PersonType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_conformsTo INSTANCE = new PersonType_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
