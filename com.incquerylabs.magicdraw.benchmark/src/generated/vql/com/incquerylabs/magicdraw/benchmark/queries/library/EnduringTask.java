...
public final class EnduringTask extends BaseGeneratedEMFQuerySpecification<EnduringTask.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnduringTask pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnduringTask";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnduringTask.Match.parameterNames;
    }
    ...
    @Override
    public EnduringTask.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnduringTask.Match)) {
          EnduringTask.Match other = (EnduringTask.Match) obj;
    ...
    @Override
    public EnduringTask specification() {
      return EnduringTask.instance();
    }
     ...
     * 
     */
    public static EnduringTask.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnduringTask.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static EnduringTask.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends EnduringTask.Match {
    ...
    private static final class Immutable extends EnduringTask.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnduringTask pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<EnduringTask.Match> {
    /**
     ...
     * 
     */
    public static EnduringTask.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnduringTask.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnduringTask.Matcher.class);
     ...
     * 
     */
    public Collection<EnduringTask.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<EnduringTask.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<EnduringTask.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super EnduringTask.Match> processor) {
     ...
     * 
     */
    public EnduringTask.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return EnduringTask.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnduringTask.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnduringTask.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final EnduringTask.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final EnduringTask.Match partialMatch) {
    ...
    @Override
    protected EnduringTask.Match tupleToMatch(final Tuple t) {
      try {
          return EnduringTask.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected EnduringTask.Match arrayToMatch(final Object[] match) {
      try {
          return EnduringTask.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnduringTask.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnduringTask.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnduringTask.Matcher> querySpecification() {
      return EnduringTask.instance();
    }
  }
  
  private EnduringTask() {
   ...
   * 
   */
  public static EnduringTask instance() {
    try{
  ...
  @Override
  protected EnduringTask.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnduringTask.Matcher.on(engine);
  }
  
  @Override
  public EnduringTask.Matcher instantiate() {
    return EnduringTask.Matcher.create();
  }
  
  @Override
  public EnduringTask.Match newEmptyMatch() {
    return EnduringTask.Match.newEmptyMatch();
  }
  
  @Override
  public EnduringTask.Match newMatch(final Object... parameters) {
    return EnduringTask.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnduringTask} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnduringTask#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnduringTask INSTANCE = new EnduringTask();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnduringTask.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "EnduringTask")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "EnduringTask");
