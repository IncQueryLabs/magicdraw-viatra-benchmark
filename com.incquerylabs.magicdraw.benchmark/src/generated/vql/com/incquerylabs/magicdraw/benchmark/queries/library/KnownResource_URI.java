...
public final class KnownResource_URI extends BaseGeneratedEMFQuerySpecification<KnownResource_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_URI.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_URI.Match)) {
          KnownResource_URI.Match other = (KnownResource_URI.Match) obj;
    ...
    @Override
    public KnownResource_URI specification() {
      return KnownResource_URI.instance();
    }
     ...
     * 
     */
    public static KnownResource_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static KnownResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends KnownResource_URI.Match {
    ...
    private static final class Immutable extends KnownResource_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_URI pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_URI
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_URI.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_URI.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<KnownResource_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<KnownResource_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super KnownResource_URI.Match> processor) {
     ...
     * 
     */
    public KnownResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return KnownResource_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final KnownResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final KnownResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final KnownResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final KnownResource_URI.Match partialMatch) {
    ...
    @Override
    protected KnownResource_URI.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected KnownResource_URI.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_URI.Matcher> querySpecification() {
      return KnownResource_URI.instance();
    }
  }
  
  private KnownResource_URI() {
   ...
   * 
   */
  public static KnownResource_URI instance() {
    try{
  ...
  @Override
  protected KnownResource_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_URI.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_URI.Matcher instantiate() {
    return KnownResource_URI.Matcher.create();
  }
  
  @Override
  public KnownResource_URI.Match newEmptyMatch() {
    return KnownResource_URI.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_URI.Match newMatch(final Object... parameters) {
    return KnownResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_URI INSTANCE = new KnownResource_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
