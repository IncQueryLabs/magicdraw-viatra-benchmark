...
public final class TechnicalStandard extends BaseGeneratedEMFQuerySpecification<TechnicalStandard.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard.Match)) {
          TechnicalStandard.Match other = (TechnicalStandard.Match) obj;
    ...
    @Override
    public TechnicalStandard specification() {
      return TechnicalStandard.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static TechnicalStandard.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends TechnicalStandard.Match {
    ...
    private static final class Immutable extends TechnicalStandard.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<TechnicalStandard.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<TechnicalStandard.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super TechnicalStandard.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return TechnicalStandard.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final TechnicalStandard.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final TechnicalStandard.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected TechnicalStandard.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard.Matcher> querySpecification() {
      return TechnicalStandard.instance();
    }
  }
  
  private TechnicalStandard() {
   ...
   * 
   */
  public static TechnicalStandard instance() {
    try{
  ...
  @Override
  protected TechnicalStandard.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard.Matcher instantiate() {
    return TechnicalStandard.Matcher.create();
  }
  
  @Override
  public TechnicalStandard.Match newEmptyMatch() {
    return TechnicalStandard.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard.Match newMatch(final Object... parameters) {
    return TechnicalStandard.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard INSTANCE = new TechnicalStandard();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "TechnicalStandard");
