...
public final class OwnsRiskInContext_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<OwnsRiskInContext_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRiskInContext_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRiskInContext_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRiskInContext_targetPropertyPath.Match)) {
          OwnsRiskInContext_targetPropertyPath.Match other = (OwnsRiskInContext_targetPropertyPath.Match) obj;
    ...
    @Override
    public OwnsRiskInContext_targetPropertyPath specification() {
      return OwnsRiskInContext_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static OwnsRiskInContext_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRiskInContext_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static OwnsRiskInContext_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsRiskInContext_targetPropertyPath.Match {
    ...
    private static final class Immutable extends OwnsRiskInContext_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see OwnsRiskInContext_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRiskInContext_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static OwnsRiskInContext_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRiskInContext_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRiskInContext_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRiskInContext_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<OwnsRiskInContext_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<OwnsRiskInContext_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super OwnsRiskInContext_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public OwnsRiskInContext_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return OwnsRiskInContext_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRiskInContext_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRiskInContext_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final OwnsRiskInContext_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final OwnsRiskInContext_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected OwnsRiskInContext_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRiskInContext_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsRiskInContext_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRiskInContext_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRiskInContext_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRiskInContext_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRiskInContext_targetPropertyPath.Matcher> querySpecification() {
      return OwnsRiskInContext_targetPropertyPath.instance();
    }
  }
  
  private OwnsRiskInContext_targetPropertyPath() {
   ...
   * 
   */
  public static OwnsRiskInContext_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected OwnsRiskInContext_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRiskInContext_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public OwnsRiskInContext_targetPropertyPath.Matcher instantiate() {
    return OwnsRiskInContext_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public OwnsRiskInContext_targetPropertyPath.Match newEmptyMatch() {
    return OwnsRiskInContext_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRiskInContext_targetPropertyPath.Match newMatch(final Object... parameters) {
    return OwnsRiskInContext_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRiskInContext_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRiskInContext_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRiskInContext_targetPropertyPath INSTANCE = new OwnsRiskInContext_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRiskInContext_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
