...
public final class EnterpriseGoal_RefinedBy extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_RefinedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_RefinedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_RefinedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_RefinedBy.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_RefinedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_RefinedBy.Match)) {
          EnterpriseGoal_RefinedBy.Match other = (EnterpriseGoal_RefinedBy.Match) obj;
    ...
    @Override
    public EnterpriseGoal_RefinedBy specification() {
      return EnterpriseGoal_RefinedBy.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_RefinedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_RefinedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_RefinedBy.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_RefinedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_RefinedBy pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_RefinedBy
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_RefinedBy.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_RefinedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_RefinedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_RefinedBy.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_RefinedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_RefinedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_RefinedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super EnterpriseGoal_RefinedBy.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_RefinedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return EnterpriseGoal_RefinedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final EnterpriseGoal_RefinedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final EnterpriseGoal_RefinedBy.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_RefinedBy.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_RefinedBy.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_RefinedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_RefinedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_RefinedBy.Matcher> querySpecification() {
      return EnterpriseGoal_RefinedBy.instance();
    }
  }
  
  private EnterpriseGoal_RefinedBy() {
   ...
   * 
   */
  public static EnterpriseGoal_RefinedBy instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_RefinedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_RefinedBy.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_RefinedBy.Matcher instantiate() {
    return EnterpriseGoal_RefinedBy.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_RefinedBy.Match newEmptyMatch() {
    return EnterpriseGoal_RefinedBy.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_RefinedBy.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_RefinedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_RefinedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_RefinedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_RefinedBy INSTANCE = new EnterpriseGoal_RefinedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_RefinedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
