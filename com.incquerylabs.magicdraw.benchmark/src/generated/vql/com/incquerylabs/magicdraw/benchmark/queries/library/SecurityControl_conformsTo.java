...
public final class SecurityControl_conformsTo extends BaseGeneratedEMFQuerySpecification<SecurityControl_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_conformsTo.Match)) {
          SecurityControl_conformsTo.Match other = (SecurityControl_conformsTo.Match) obj;
    ...
    @Override
    public SecurityControl_conformsTo specification() {
      return SecurityControl_conformsTo.instance();
    }
     ...
     * 
     */
    public static SecurityControl_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityControl_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControl_conformsTo.Match {
    ...
    private static final class Immutable extends SecurityControl_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityControl_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityControl_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityControl_conformsTo.Match> processor) {
     ...
     * 
     */
    public SecurityControl_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityControl_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityControl_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityControl_conformsTo.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControl_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_conformsTo.Matcher> querySpecification() {
      return SecurityControl_conformsTo.instance();
    }
  }
  
  private SecurityControl_conformsTo() {
   ...
   * 
   */
  public static SecurityControl_conformsTo instance() {
    try{
  ...
  @Override
  protected SecurityControl_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_conformsTo.Matcher instantiate() {
    return SecurityControl_conformsTo.Matcher.create();
  }
  
  @Override
  public SecurityControl_conformsTo.Match newEmptyMatch() {
    return SecurityControl_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_conformsTo.Match newMatch(final Object... parameters) {
    return SecurityControl_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_conformsTo INSTANCE = new SecurityControl_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
