...
public final class ProjectTheme_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectTheme_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectTheme_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectTheme_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectTheme_startBoundaryType.Match)) {
          ProjectTheme_startBoundaryType.Match other = (ProjectTheme_startBoundaryType.Match) obj;
    ...
    @Override
    public ProjectTheme_startBoundaryType specification() {
      return ProjectTheme_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectTheme_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectTheme_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectTheme_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectTheme_startBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectTheme_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectTheme_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectTheme_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectTheme_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectTheme_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectTheme_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectTheme_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectTheme_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectTheme_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectTheme_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectTheme_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectTheme_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectTheme_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectTheme_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectTheme_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectTheme_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectTheme_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectTheme_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectTheme_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectTheme_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectTheme_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectTheme_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectTheme_startBoundaryType.Matcher> querySpecification() {
      return ProjectTheme_startBoundaryType.instance();
    }
  }
  
  private ProjectTheme_startBoundaryType() {
   ...
   * 
   */
  public static ProjectTheme_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectTheme_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectTheme_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectTheme_startBoundaryType.Matcher instantiate() {
    return ProjectTheme_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectTheme_startBoundaryType.Match newEmptyMatch() {
    return ProjectTheme_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectTheme_startBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectTheme_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectTheme_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectTheme_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectTheme_startBoundaryType INSTANCE = new ProjectTheme_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectTheme_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
