...
public final class ActualLocation_endDate extends BaseGeneratedEMFQuerySpecification<ActualLocation_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualLocation_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualLocation_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualLocation_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualLocation_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualLocation_endDate.Match)) {
          ActualLocation_endDate.Match other = (ActualLocation_endDate.Match) obj;
    ...
    @Override
    public ActualLocation_endDate specification() {
      return ActualLocation_endDate.instance();
    }
     ...
     * 
     */
    public static ActualLocation_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualLocation_endDate.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public static ActualLocation_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualLocation_endDate.Match {
    ...
    private static final class Immutable extends ActualLocation_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualLocation_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualLocation_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualLocation_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualLocation_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualLocation_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualLocation_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualLocation_endDate.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Stream<ActualLocation_endDate.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Optional<ActualLocation_endDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue, final Consumer<? super ActualLocation_endDate.Match> processor) {
     ...
     * 
     */
    public ActualLocation_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return ActualLocation_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualLocation_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualLocation_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvalue(final ActualLocation_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvalue(final ActualLocation_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualLocation_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualLocation_endDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualLocation_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualLocation_endDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualLocation_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualLocation_endDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualLocation_endDate.Matcher> querySpecification() {
      return ActualLocation_endDate.instance();
    }
  }
  
  private ActualLocation_endDate() {
   ...
   * 
   */
  public static ActualLocation_endDate instance() {
    try{
  ...
  @Override
  protected ActualLocation_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualLocation_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualLocation_endDate.Matcher instantiate() {
    return ActualLocation_endDate.Matcher.create();
  }
  
  @Override
  public ActualLocation_endDate.Match newEmptyMatch() {
    return ActualLocation_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualLocation_endDate.Match newMatch(final Object... parameters) {
    return ActualLocation_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualLocation_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualLocation_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualLocation_endDate INSTANCE = new ActualLocation_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualLocation_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
