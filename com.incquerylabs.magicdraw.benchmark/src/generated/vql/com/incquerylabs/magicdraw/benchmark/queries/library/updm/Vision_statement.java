...
public final class Vision_statement extends BaseGeneratedEMFQuerySpecification<Vision_statement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_statement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_statement";
    }
    
    @Override
    public List<String> parameterNames() {
      return Vision_statement.Match.parameterNames;
    }
    ...
    @Override
    public Vision_statement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Vision_statement.Match)) {
          Vision_statement.Match other = (Vision_statement.Match) obj;
    ...
    @Override
    public Vision_statement specification() {
      return Vision_statement.instance();
    }
     ...
     * 
     */
    public static Vision_statement.Match newEmptyMatch() {
     ...
     * 
     */
    public static Vision_statement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Vision_statement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Vision_statement.Match {
    ...
    private static final class Immutable extends Vision_statement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_statement pattern,
   ...
   * 
   * @see Match
   * @see Vision_statement
   * 
   */
  public static class Matcher extends BaseMatcher<Vision_statement.Match> {
    /**
     ...
     * 
     */
    public static Vision_statement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Vision_statement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Vision_statement.Matcher.class);
     ...
     * 
     */
    public Collection<Vision_statement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Vision_statement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Vision_statement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Vision_statement.Match> processor) {
     ...
     * 
     */
    public Vision_statement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Vision_statement.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Vision_statement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Vision_statement.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Vision_statement.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Vision_statement.Match partialMatch) {
    ...
    @Override
    protected Vision_statement.Match tupleToMatch(final Tuple t) {
      try {
          return Vision_statement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Vision_statement.Match arrayToMatch(final Object[] match) {
      try {
          return Vision_statement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Vision_statement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Vision_statement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Vision_statement.Matcher> querySpecification() {
      return Vision_statement.instance();
    }
  }
  
  private Vision_statement() {
   ...
   * 
   */
  public static Vision_statement instance() {
    try{
  ...
  @Override
  protected Vision_statement.Matcher instantiate(final ViatraQueryEngine engine) {
    return Vision_statement.Matcher.on(engine);
  }
  
  @Override
  public Vision_statement.Matcher instantiate() {
    return Vision_statement.Matcher.create();
  }
  
  @Override
  public Vision_statement.Match newEmptyMatch() {
    return Vision_statement.Match.newEmptyMatch();
  }
  
  @Override
  public Vision_statement.Match newMatch(final Object... parameters) {
    return Vision_statement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Vision_statement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Vision_statement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Vision_statement INSTANCE = new Vision_statement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Vision_statement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
