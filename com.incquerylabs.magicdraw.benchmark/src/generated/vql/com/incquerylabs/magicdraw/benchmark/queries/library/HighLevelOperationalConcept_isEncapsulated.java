...
import com.incquerylabs.magicdraw.benchmark.queries.library.HighLevelOperationalConcept;
...
public final class HighLevelOperationalConcept_isEncapsulated extends BaseGeneratedEMFQuerySpecification<HighLevelOperationalConcept_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.HighLevelOperationalConcept_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.HighLevelOperationalConcept_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return HighLevelOperationalConcept_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public HighLevelOperationalConcept_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof HighLevelOperationalConcept_isEncapsulated.Match)) {
          HighLevelOperationalConcept_isEncapsulated.Match other = (HighLevelOperationalConcept_isEncapsulated.Match) obj;
    ...
    @Override
    public HighLevelOperationalConcept_isEncapsulated specification() {
      return HighLevelOperationalConcept_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static HighLevelOperationalConcept_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static HighLevelOperationalConcept_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends HighLevelOperationalConcept_isEncapsulated.Match {
    ...
    private static final class Immutable extends HighLevelOperationalConcept_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.HighLevelOperationalConcept_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see HighLevelOperationalConcept_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<HighLevelOperationalConcept_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static HighLevelOperationalConcept_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(HighLevelOperationalConcept_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<HighLevelOperationalConcept_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<HighLevelOperationalConcept_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<HighLevelOperationalConcept_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super HighLevelOperationalConcept_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public HighLevelOperationalConcept_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return HighLevelOperationalConcept_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final HighLevelOperationalConcept_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final HighLevelOperationalConcept_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final HighLevelOperationalConcept_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final HighLevelOperationalConcept_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected HighLevelOperationalConcept_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return HighLevelOperationalConcept_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected HighLevelOperationalConcept_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return HighLevelOperationalConcept_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected HighLevelOperationalConcept_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return HighLevelOperationalConcept_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<HighLevelOperationalConcept_isEncapsulated.Matcher> querySpecification() {
      return HighLevelOperationalConcept_isEncapsulated.instance();
    }
  }
  
  private HighLevelOperationalConcept_isEncapsulated() {
   ...
   * 
   */
  public static HighLevelOperationalConcept_isEncapsulated instance() {
    try{
  ...
  @Override
  protected HighLevelOperationalConcept_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return HighLevelOperationalConcept_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public HighLevelOperationalConcept_isEncapsulated.Matcher instantiate() {
    return HighLevelOperationalConcept_isEncapsulated.Matcher.create();
  }
  
  @Override
  public HighLevelOperationalConcept_isEncapsulated.Match newEmptyMatch() {
    return HighLevelOperationalConcept_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public HighLevelOperationalConcept_isEncapsulated.Match newMatch(final Object... parameters) {
    return HighLevelOperationalConcept_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link HighLevelOperationalConcept_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link HighLevelOperationalConcept_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final HighLevelOperationalConcept_isEncapsulated INSTANCE = new HighLevelOperationalConcept_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final HighLevelOperationalConcept_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
