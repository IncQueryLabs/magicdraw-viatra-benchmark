...
public final class ServicePort extends BaseGeneratedEMFQuerySpecification<ServicePort.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServicePort pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServicePort";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServicePort.Match.parameterNames;
    }
    ...
    @Override
    public ServicePort.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServicePort.Match)) {
          ServicePort.Match other = (ServicePort.Match) obj;
    ...
    @Override
    public ServicePort specification() {
     ...
     * 
     */
    public static ServicePort.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServicePort.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ServicePort.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ServicePort.Match {
    ...
    private static final class Immutable extends ServicePort.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServicePort pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ServicePort.Match> {
    /**
     ...
     * 
     */
    public static ServicePort.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServicePort.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServicePort.Matcher.class);
     ...
     * 
     */
    public Collection<ServicePort.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ServicePort.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ServicePort.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ServicePort.Match> processor) {
     ...
     * 
     */
    public ServicePort.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ServicePort.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final ServicePort.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final ServicePort.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ServicePort.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ServicePort.Match partialMatch) {
    ...
    @Override
    protected ServicePort.Match tupleToMatch(final Tuple t) {
      try {
          return ServicePort.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ServicePort.Match arrayToMatch(final Object[] match) {
      try {
          return ServicePort.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServicePort.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServicePort.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServicePort.Matcher> querySpecification() {
      return ServicePort.instance();
    }
  }
  ...
  @Override
  protected ServicePort.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServicePort.Matcher.on(engine);
  }
  
  @Override
  public ServicePort.Matcher instantiate() {
    return ServicePort.Matcher.create();
  }
  
  @Override
  public ServicePort.Match newEmptyMatch() {
    return ServicePort.Match.newEmptyMatch();
  }
  
  @Override
  public ServicePort.Match newMatch(final Object... parameters) {
    return ServicePort.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ServicePort");
