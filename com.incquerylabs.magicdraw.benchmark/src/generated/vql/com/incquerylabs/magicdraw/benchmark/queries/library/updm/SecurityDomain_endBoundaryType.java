...
public final class SecurityDomain_endBoundaryType extends BaseGeneratedEMFQuerySpecification<SecurityDomain_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_endBoundaryType.Match)) {
          SecurityDomain_endBoundaryType.Match other = (SecurityDomain_endBoundaryType.Match) obj;
    ...
    @Override
    public SecurityDomain_endBoundaryType specification() {
      return SecurityDomain_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityDomain_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_endBoundaryType.Match {
    ...
    private static final class Immutable extends SecurityDomain_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityDomain_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityDomain_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityDomain_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityDomain_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_endBoundaryType.Matcher> querySpecification() {
      return SecurityDomain_endBoundaryType.instance();
    }
  }
  
  private SecurityDomain_endBoundaryType() {
   ...
   * 
   */
  public static SecurityDomain_endBoundaryType instance() {
    try{
  ...
  @Override
  protected SecurityDomain_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_endBoundaryType.Matcher instantiate() {
    return SecurityDomain_endBoundaryType.Matcher.create();
  }
  
  @Override
  public SecurityDomain_endBoundaryType.Match newEmptyMatch() {
    return SecurityDomain_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_endBoundaryType.Match newMatch(final Object... parameters) {
    return SecurityDomain_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_endBoundaryType INSTANCE = new SecurityDomain_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
