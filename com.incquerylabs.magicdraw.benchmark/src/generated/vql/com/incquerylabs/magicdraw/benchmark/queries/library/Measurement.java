...
public final class Measurement extends BaseGeneratedEMFQuerySpecification<Measurement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Measurement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Measurement";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measurement.Match.parameterNames;
    }
    ...
    @Override
    public Measurement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measurement.Match)) {
          Measurement.Match other = (Measurement.Match) obj;
    ...
    @Override
    public Measurement specification() {
     ...
     * 
     */
    public static Measurement.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measurement.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Measurement.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Measurement.Match {
    ...
    private static final class Immutable extends Measurement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Measurement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Measurement.Match> {
    /**
     ...
     * 
     */
    public static Measurement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measurement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measurement.Matcher.class);
     ...
     * 
     */
    public Collection<Measurement.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Measurement.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Measurement.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Measurement.Match> processor) {
     ...
     * 
     */
    public Measurement.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Measurement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Measurement.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Measurement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Measurement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Measurement.Match partialMatch) {
    ...
    @Override
    protected Measurement.Match tupleToMatch(final Tuple t) {
      try {
          return Measurement.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Measurement.Match arrayToMatch(final Object[] match) {
      try {
          return Measurement.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measurement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measurement.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measurement.Matcher> querySpecification() {
      return Measurement.instance();
    }
  }
  ...
  @Override
  protected Measurement.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measurement.Matcher.on(engine);
  }
  
  @Override
  public Measurement.Matcher instantiate() {
    return Measurement.Matcher.create();
  }
  
  @Override
  public Measurement.Match newEmptyMatch() {
    return Measurement.Match.newEmptyMatch();
  }
  
  @Override
  public Measurement.Match newMatch(final Object... parameters) {
    return Measurement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measurement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measurement#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measurement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Measurement")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Measurement");
