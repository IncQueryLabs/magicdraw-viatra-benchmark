...
public final class CircularDependencies extends BaseGeneratedEMFQuerySpecification<CircularDependencies.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.circularDependencies pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private static List<String> parameterNames = makeImmutableList("dependency");
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.circularDependencies";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.circularDependencies pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<CircularDependencies.Match> {
    /**
     ...
     * 
     */
    public Collection<CircularDependencies.Match> getAllMatches(final Dependency pDependency) {
     ...
     * 
     */
    public Stream<CircularDependencies.Match> streamAllMatches(final Dependency pDependency) {
     ...
     * 
     */
    public Optional<CircularDependencies.Match> getOneArbitraryMatch(final Dependency pDependency) {
     ...
     * 
     */
    protected Stream<Dependency> rawStreamAllValuesOfdependency(final Object[] parameters) {
     ...
     * 
     */
    public Set<Dependency> getAllValuesOfdependency() {
     ...
     * 
     */
    public Stream<Dependency> streamAllValuesOfdependency() {
     ...
     * 
     */
    public static IQuerySpecification<CircularDependencies.Matcher> querySpecification() {
      return CircularDependencies.instance();
    }
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_dependency = new PParameter("dependency", "com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Dependency", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency")), PParameterDirection.INOUT);
    
    private final List<PParameter> parameters = Arrays.asList(parameter_dependency);
