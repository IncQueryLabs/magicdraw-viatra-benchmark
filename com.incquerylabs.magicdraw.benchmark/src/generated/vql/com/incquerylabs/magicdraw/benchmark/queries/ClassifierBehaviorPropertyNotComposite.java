...
public final class ClassifierBehaviorPropertyNotComposite extends BaseGeneratedEMFQuerySpecification<ClassifierBehaviorPropertyNotComposite.Matcher> {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private class EmbeddedQuery470153766 extends BaseGeneratedEMFPQuery {
      ...
      public EmbeddedQuery470153766() {
        super(PVisibility.EMBEDDED);
      }
      
      @Override
      public String getFullyQualifiedName() {
        return GeneratedPQuery.this.getFullyQualifiedName() + "$470153766";
      }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new NegativePatternCall(body, Tuples.flatTupleOf(var_property, var__virtual_0_), new ClassifierBehaviorPropertyNotComposite.GeneratedPQuery.EmbeddedQuery470153766());
          bodies.add(body);
      }
      return bodies;
    }
