...
public final class Mission_conformsTo extends BaseGeneratedEMFQuerySpecification<Mission_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Mission_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Mission_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Mission_conformsTo.Match)) {
          Mission_conformsTo.Match other = (Mission_conformsTo.Match) obj;
    ...
    @Override
    public Mission_conformsTo specification() {
      return Mission_conformsTo.instance();
    }
     ...
     * 
     */
    public static Mission_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Mission_conformsTo.Match newMutableMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public static Mission_conformsTo.Match newMatch(final Activity pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Mission_conformsTo.Match {
    ...
    private static final class Immutable extends Mission_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Mission_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Mission_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Mission_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Mission_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Mission_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Mission_conformsTo.Match> getAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Mission_conformsTo.Match> streamAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Mission_conformsTo.Match> getOneArbitraryMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final Element pValue, final Consumer<? super Mission_conformsTo.Match> processor) {
     ...
     * 
     */
    public Mission_conformsTo.Match newMatch(final Activity pElement, final Element pValue) {
      return Mission_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Mission_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Mission_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Mission_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Mission_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Mission_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Mission_conformsTo.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Mission_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Mission_conformsTo.Match.newMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Mission_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Mission_conformsTo.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Mission_conformsTo.Matcher> querySpecification() {
      return Mission_conformsTo.instance();
    }
  }
  
  private Mission_conformsTo() {
   ...
   * 
   */
  public static Mission_conformsTo instance() {
    try{
  ...
  @Override
  protected Mission_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Mission_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Mission_conformsTo.Matcher instantiate() {
    return Mission_conformsTo.Matcher.create();
  }
  
  @Override
  public Mission_conformsTo.Match newEmptyMatch() {
    return Mission_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Mission_conformsTo.Match newMatch(final Object... parameters) {
    return Mission_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Mission_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Mission_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Mission_conformsTo INSTANCE = new Mission_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Mission_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
