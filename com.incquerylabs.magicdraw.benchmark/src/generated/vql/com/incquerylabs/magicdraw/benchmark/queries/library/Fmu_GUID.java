 ...
 *         pattern fmu_GUID(Element : Element, Value: java String) {
 *         	find fmu(Element, stereotype);
 *         	find taggedValue(Element, stereotype, "GUID", taggedValue);
...
public final class Fmu_GUID extends BaseGeneratedEMFQuerySpecification<Fmu_GUID.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Fmu_GUID.Match newMutableMatch(final Element pElement, final String pValue) {
     ...
     * 
     */
    public static Fmu_GUID.Match newMatch(final Element pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<Fmu_GUID.Match> {
     ...
     * 
     */
    public Collection<Fmu_GUID.Match> getAllMatches(final Element pElement, final String pValue) {
     ...
     * 
     */
    public Stream<Fmu_GUID.Match> streamAllMatches(final Element pElement, final String pValue) {
     ...
     * 
     */
    public Optional<Fmu_GUID.Match> getOneArbitraryMatch(final Element pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final String pValue, final Consumer<? super Fmu_GUID.Match> processor) {
     ...
     * 
     */
    public Fmu_GUID.Match newMatch(final Element pElement, final String pValue) {
      return Fmu_GUID.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final Fmu_GUID.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final Fmu_GUID.Match partialMatch) {
    ...
    protected Fmu_GUID.Match tupleToMatch(final Tuple t) {
      try {
          return Fmu_GUID.Match.newMatch((Element) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected Fmu_GUID.Match arrayToMatch(final Object[] match) {
      try {
          return Fmu_GUID.Match.newMatch((Element) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Fmu_GUID.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Fmu_GUID.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Fmu_GUID.Match newMatch(final Object... parameters) {
    return Fmu_GUID.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (java.lang.String) parameters[1]);
  }
