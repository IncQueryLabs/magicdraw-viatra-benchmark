 ...
 *         	find slotValue(domainStereotypeInstance, "GUID", valuespec);
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Fmu_GUID extends BaseGeneratedEMFQuerySpecification<Fmu_GUID.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.fmu_GUID pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.fmu_GUID";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.fmu_GUID pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Fmu_GUID} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Fmu_GUID#instance()}.
   * 
