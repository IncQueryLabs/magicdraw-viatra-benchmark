...
public final class FunctionalRequirement extends BaseGeneratedEMFQuerySpecification<FunctionalRequirement.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static FunctionalRequirement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static FunctionalRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<FunctionalRequirement.Match> {
     ...
     * 
     */
    public Collection<FunctionalRequirement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<FunctionalRequirement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<FunctionalRequirement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype, final Consumer<? super FunctionalRequirement.Match> processor) {
     ...
     * 
     */
    public FunctionalRequirement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
      return FunctionalRequirement.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final FunctionalRequirement.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final FunctionalRequirement.Match partialMatch) {
    ...
    protected FunctionalRequirement.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected FunctionalRequirement.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected FunctionalRequirement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalRequirement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public FunctionalRequirement.Match newMatch(final Object... parameters) {
    return FunctionalRequirement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
