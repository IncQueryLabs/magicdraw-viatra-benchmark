...
public final class ServiceAccess_affectedFunctions extends BaseGeneratedEMFQuerySpecification<ServiceAccess_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_affectedFunctions.Match)) {
          ServiceAccess_affectedFunctions.Match other = (ServiceAccess_affectedFunctions.Match) obj;
    ...
    @Override
    public ServiceAccess_affectedFunctions specification() {
      return ServiceAccess_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_affectedFunctions.Match {
    ...
    private static final class Immutable extends ServiceAccess_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_affectedFunctions.Matcher> querySpecification() {
      return ServiceAccess_affectedFunctions.instance();
    }
  }
  
  private ServiceAccess_affectedFunctions() {
   ...
   * 
   */
  public static ServiceAccess_affectedFunctions instance() {
    try{
  ...
  @Override
  protected ServiceAccess_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_affectedFunctions.Matcher instantiate() {
    return ServiceAccess_affectedFunctions.Matcher.create();
  }
  
  @Override
  public ServiceAccess_affectedFunctions.Match newEmptyMatch() {
    return ServiceAccess_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_affectedFunctions.Match newMatch(final Object... parameters) {
    return ServiceAccess_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_affectedFunctions INSTANCE = new ServiceAccess_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
