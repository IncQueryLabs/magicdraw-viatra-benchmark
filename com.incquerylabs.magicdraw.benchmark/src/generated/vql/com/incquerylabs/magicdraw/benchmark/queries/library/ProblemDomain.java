...
public final class ProblemDomain extends BaseGeneratedEMFQuerySpecification<ProblemDomain.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain.Match)) {
          ProblemDomain.Match other = (ProblemDomain.Match) obj;
    ...
    @Override
    public ProblemDomain specification() {
      return ProblemDomain.instance();
    }
     ...
     * 
     */
    public static ProblemDomain.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProblemDomain.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProblemDomain.Match {
    ...
    private static final class Immutable extends ProblemDomain.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProblemDomain.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProblemDomain.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProblemDomain.Match> processor) {
     ...
     * 
     */
    public ProblemDomain.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProblemDomain.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProblemDomain.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProblemDomain.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProblemDomain.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain.Matcher> querySpecification() {
      return ProblemDomain.instance();
    }
  }
   ...
   * 
   */
  public static ProblemDomain instance() {
    try{
  ...
  @Override
  protected ProblemDomain.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain.Matcher instantiate() {
    return ProblemDomain.Matcher.create();
  }
  
  @Override
  public ProblemDomain.Match newEmptyMatch() {
    return ProblemDomain.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain.Match newMatch(final Object... parameters) {
    return ProblemDomain.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain INSTANCE = new ProblemDomain();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ProblemDomain")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ProblemDomain");
