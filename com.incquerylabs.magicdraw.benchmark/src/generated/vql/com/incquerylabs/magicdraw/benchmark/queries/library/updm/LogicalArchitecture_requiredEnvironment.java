...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture;
...
public final class LogicalArchitecture_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_requiredEnvironment.Match)) {
          LogicalArchitecture_requiredEnvironment.Match other = (LogicalArchitecture_requiredEnvironment.Match) obj;
    ...
    @Override
    public LogicalArchitecture_requiredEnvironment specification() {
      return LogicalArchitecture_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static LogicalArchitecture_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends LogicalArchitecture_requiredEnvironment.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super LogicalArchitecture_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return LogicalArchitecture_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final LogicalArchitecture_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final LogicalArchitecture_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected LogicalArchitecture_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_requiredEnvironment.Matcher> querySpecification() {
      return LogicalArchitecture_requiredEnvironment.instance();
    }
  }
  
  private LogicalArchitecture_requiredEnvironment() {
   ...
   * 
   */
  public static LogicalArchitecture_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_requiredEnvironment.Matcher instantiate() {
    return LogicalArchitecture_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_requiredEnvironment.Match newEmptyMatch() {
    return LogicalArchitecture_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_requiredEnvironment.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_requiredEnvironment INSTANCE = new LogicalArchitecture_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find LogicalArchitecture(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), LogicalArchitecture.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
