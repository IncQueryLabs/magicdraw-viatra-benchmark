...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain;
...
public final class ProblemDomain_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ProblemDomain_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_actualPropertySet.Match)) {
          ProblemDomain_actualPropertySet.Match other = (ProblemDomain_actualPropertySet.Match) obj;
    ...
    @Override
    public ProblemDomain_actualPropertySet specification() {
      return ProblemDomain_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_actualPropertySet.Match {
    ...
    private static final class Immutable extends ProblemDomain_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_actualPropertySet.Matcher> querySpecification() {
      return ProblemDomain_actualPropertySet.instance();
    }
  }
  
  private ProblemDomain_actualPropertySet() {
   ...
   * 
   */
  public static ProblemDomain_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ProblemDomain_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_actualPropertySet.Matcher instantiate() {
    return ProblemDomain_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ProblemDomain_actualPropertySet.Match newEmptyMatch() {
    return ProblemDomain_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_actualPropertySet.Match newMatch(final Object... parameters) {
    return ProblemDomain_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_actualPropertySet INSTANCE = new ProblemDomain_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
