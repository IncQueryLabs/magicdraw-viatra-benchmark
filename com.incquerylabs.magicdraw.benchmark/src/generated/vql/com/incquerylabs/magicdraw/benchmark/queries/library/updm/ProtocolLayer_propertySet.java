...
public final class ProtocolLayer_propertySet extends BaseGeneratedEMFQuerySpecification<ProtocolLayer_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolLayer_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolLayer_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolLayer_propertySet.Match)) {
          ProtocolLayer_propertySet.Match other = (ProtocolLayer_propertySet.Match) obj;
    ...
    @Override
    public ProtocolLayer_propertySet specification() {
      return ProtocolLayer_propertySet.instance();
    }
     ...
     * 
     */
    public static ProtocolLayer_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolLayer_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolLayer_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolLayer_propertySet.Match {
    ...
    private static final class Immutable extends ProtocolLayer_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProtocolLayer_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ProtocolLayer_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolLayer_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ProtocolLayer_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolLayer_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolLayer_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolLayer_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolLayer_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolLayer_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProtocolLayer_propertySet.Match> processor) {
     ...
     * 
     */
    public ProtocolLayer_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ProtocolLayer_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProtocolLayer_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProtocolLayer_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolLayer_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolLayer_propertySet.Match partialMatch) {
    ...
    @Override
    protected ProtocolLayer_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolLayer_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolLayer_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolLayer_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolLayer_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolLayer_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolLayer_propertySet.Matcher> querySpecification() {
      return ProtocolLayer_propertySet.instance();
    }
  }
  
  private ProtocolLayer_propertySet() {
   ...
   * 
   */
  public static ProtocolLayer_propertySet instance() {
    try{
  ...
  @Override
  protected ProtocolLayer_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolLayer_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ProtocolLayer_propertySet.Matcher instantiate() {
    return ProtocolLayer_propertySet.Matcher.create();
  }
  
  @Override
  public ProtocolLayer_propertySet.Match newEmptyMatch() {
    return ProtocolLayer_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolLayer_propertySet.Match newMatch(final Object... parameters) {
    return ProtocolLayer_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolLayer_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolLayer_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolLayer_propertySet INSTANCE = new ProtocolLayer_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolLayer_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
