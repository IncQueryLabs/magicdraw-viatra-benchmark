...
public final class ProjectTheme_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ProjectTheme_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectTheme_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectTheme_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectTheme_actualPropertySet.Match)) {
          ProjectTheme_actualPropertySet.Match other = (ProjectTheme_actualPropertySet.Match) obj;
    ...
    @Override
    public ProjectTheme_actualPropertySet specification() {
      return ProjectTheme_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ProjectTheme_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectTheme_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectTheme_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectTheme_actualPropertySet.Match {
    ...
    private static final class Immutable extends ProjectTheme_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectTheme_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectTheme_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectTheme_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectTheme_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectTheme_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectTheme_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectTheme_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectTheme_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectTheme_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ProjectTheme_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectTheme_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectTheme_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectTheme_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectTheme_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectTheme_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectTheme_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectTheme_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectTheme_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectTheme_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectTheme_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectTheme_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectTheme_actualPropertySet.Matcher> querySpecification() {
      return ProjectTheme_actualPropertySet.instance();
    }
  }
  
  private ProjectTheme_actualPropertySet() {
   ...
   * 
   */
  public static ProjectTheme_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ProjectTheme_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectTheme_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectTheme_actualPropertySet.Matcher instantiate() {
    return ProjectTheme_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ProjectTheme_actualPropertySet.Match newEmptyMatch() {
    return ProjectTheme_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectTheme_actualPropertySet.Match newMatch(final Object... parameters) {
    return ProjectTheme_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectTheme_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectTheme_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectTheme_actualPropertySet INSTANCE = new ProjectTheme_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectTheme_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
