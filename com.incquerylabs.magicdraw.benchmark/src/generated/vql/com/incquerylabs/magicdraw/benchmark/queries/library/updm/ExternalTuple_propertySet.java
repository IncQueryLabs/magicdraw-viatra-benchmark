...
public final class ExternalTuple_propertySet extends BaseGeneratedEMFQuerySpecification<ExternalTuple_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTuple_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTuple_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTuple_propertySet.Match)) {
          ExternalTuple_propertySet.Match other = (ExternalTuple_propertySet.Match) obj;
    ...
    @Override
    public ExternalTuple_propertySet specification() {
      return ExternalTuple_propertySet.instance();
    }
     ...
     * 
     */
    public static ExternalTuple_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTuple_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTuple_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTuple_propertySet.Match {
    ...
    private static final class Immutable extends ExternalTuple_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ExternalTuple_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTuple_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ExternalTuple_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTuple_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTuple_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTuple_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTuple_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTuple_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTuple_propertySet.Match> processor) {
     ...
     * 
     */
    public ExternalTuple_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTuple_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTuple_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTuple_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTuple_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTuple_propertySet.Match partialMatch) {
    ...
    @Override
    protected ExternalTuple_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTuple_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTuple_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTuple_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTuple_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTuple_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTuple_propertySet.Matcher> querySpecification() {
      return ExternalTuple_propertySet.instance();
    }
  }
  
  private ExternalTuple_propertySet() {
   ...
   * 
   */
  public static ExternalTuple_propertySet instance() {
    try{
  ...
  @Override
  protected ExternalTuple_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTuple_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ExternalTuple_propertySet.Matcher instantiate() {
    return ExternalTuple_propertySet.Matcher.create();
  }
  
  @Override
  public ExternalTuple_propertySet.Match newEmptyMatch() {
    return ExternalTuple_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTuple_propertySet.Match newMatch(final Object... parameters) {
    return ExternalTuple_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTuple_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTuple_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTuple_propertySet INSTANCE = new ExternalTuple_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTuple_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
