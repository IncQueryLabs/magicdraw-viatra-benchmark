...
public final class KnownResource_startBoundaryType extends BaseGeneratedEMFQuerySpecification<KnownResource_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_startBoundaryType.Match)) {
          KnownResource_startBoundaryType.Match other = (KnownResource_startBoundaryType.Match) obj;
    ...
    @Override
    public KnownResource_startBoundaryType specification() {
      return KnownResource_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static KnownResource_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_startBoundaryType.Match {
    ...
    private static final class Immutable extends KnownResource_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super KnownResource_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public KnownResource_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return KnownResource_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final KnownResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final KnownResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected KnownResource_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_startBoundaryType.Matcher> querySpecification() {
      return KnownResource_startBoundaryType.instance();
    }
  }
  
  private KnownResource_startBoundaryType() {
   ...
   * 
   */
  public static KnownResource_startBoundaryType instance() {
    try{
  ...
  @Override
  protected KnownResource_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_startBoundaryType.Matcher instantiate() {
    return KnownResource_startBoundaryType.Matcher.create();
  }
  
  @Override
  public KnownResource_startBoundaryType.Match newEmptyMatch() {
    return KnownResource_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_startBoundaryType.Match newMatch(final Object... parameters) {
    return KnownResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_startBoundaryType INSTANCE = new KnownResource_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
