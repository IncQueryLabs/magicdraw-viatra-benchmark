...
public final class Responsibility_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<Responsibility_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_categoryCategorizesAsset.Match)) {
          Responsibility_categoryCategorizesAsset.Match other = (Responsibility_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public Responsibility_categoryCategorizesAsset specification() {
      return Responsibility_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static Responsibility_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends Responsibility_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public Responsibility_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected Responsibility_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_categoryCategorizesAsset.Matcher> querySpecification() {
      return Responsibility_categoryCategorizesAsset.instance();
    }
  }
  
  private Responsibility_categoryCategorizesAsset() {
   ...
   * 
   */
  public static Responsibility_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected Responsibility_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_categoryCategorizesAsset.Matcher instantiate() {
    return Responsibility_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public Responsibility_categoryCategorizesAsset.Match newEmptyMatch() {
    return Responsibility_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return Responsibility_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_categoryCategorizesAsset INSTANCE = new Responsibility_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
