...
public final class SubjectOfOperationalStateMachine extends BaseGeneratedEMFQuerySpecification<SubjectOfOperationalStateMachine.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SubjectOfOperationalStateMachine pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SubjectOfOperationalStateMachine";
    }
    
    @Override
    public List<String> parameterNames() {
      return SubjectOfOperationalStateMachine.Match.parameterNames;
    }
    ...
    @Override
    public SubjectOfOperationalStateMachine.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SubjectOfOperationalStateMachine.Match)) {
          SubjectOfOperationalStateMachine.Match other = (SubjectOfOperationalStateMachine.Match) obj;
    ...
    @Override
    public SubjectOfOperationalStateMachine specification() {
      return SubjectOfOperationalStateMachine.instance();
    }
     ...
     * 
     */
    public static SubjectOfOperationalStateMachine.Match newEmptyMatch() {
     ...
     * 
     */
    public static SubjectOfOperationalStateMachine.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SubjectOfOperationalStateMachine.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SubjectOfOperationalStateMachine.Match {
    ...
    private static final class Immutable extends SubjectOfOperationalStateMachine.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SubjectOfOperationalStateMachine pattern,
   ...
   * 
   * @see Match
   * @see SubjectOfOperationalStateMachine
   * 
   */
  public static class Matcher extends BaseMatcher<SubjectOfOperationalStateMachine.Match> {
    /**
     ...
     * 
     */
    public static SubjectOfOperationalStateMachine.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SubjectOfOperationalStateMachine.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SubjectOfOperationalStateMachine.Matcher.class);
     ...
     * 
     */
    public Collection<SubjectOfOperationalStateMachine.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SubjectOfOperationalStateMachine.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SubjectOfOperationalStateMachine.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SubjectOfOperationalStateMachine.Match> processor) {
     ...
     * 
     */
    public SubjectOfOperationalStateMachine.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SubjectOfOperationalStateMachine.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final SubjectOfOperationalStateMachine.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final SubjectOfOperationalStateMachine.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SubjectOfOperationalStateMachine.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SubjectOfOperationalStateMachine.Match partialMatch) {
    ...
    @Override
    protected SubjectOfOperationalStateMachine.Match tupleToMatch(final Tuple t) {
      try {
          return SubjectOfOperationalStateMachine.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SubjectOfOperationalStateMachine.Match arrayToMatch(final Object[] match) {
      try {
          return SubjectOfOperationalStateMachine.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SubjectOfOperationalStateMachine.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SubjectOfOperationalStateMachine.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SubjectOfOperationalStateMachine.Matcher> querySpecification() {
      return SubjectOfOperationalStateMachine.instance();
    }
  }
  
  private SubjectOfOperationalStateMachine() {
   ...
   * 
   */
  public static SubjectOfOperationalStateMachine instance() {
    try{
  ...
  @Override
  protected SubjectOfOperationalStateMachine.Matcher instantiate(final ViatraQueryEngine engine) {
    return SubjectOfOperationalStateMachine.Matcher.on(engine);
  }
  
  @Override
  public SubjectOfOperationalStateMachine.Matcher instantiate() {
    return SubjectOfOperationalStateMachine.Matcher.create();
  }
  
  @Override
  public SubjectOfOperationalStateMachine.Match newEmptyMatch() {
    return SubjectOfOperationalStateMachine.Match.newEmptyMatch();
  }
  
  @Override
  public SubjectOfOperationalStateMachine.Match newMatch(final Object... parameters) {
    return SubjectOfOperationalStateMachine.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SubjectOfOperationalStateMachine} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SubjectOfOperationalStateMachine#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SubjectOfOperationalStateMachine INSTANCE = new SubjectOfOperationalStateMachine();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SubjectOfOperationalStateMachine.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "SubjectOfOperationalStateMachine");
