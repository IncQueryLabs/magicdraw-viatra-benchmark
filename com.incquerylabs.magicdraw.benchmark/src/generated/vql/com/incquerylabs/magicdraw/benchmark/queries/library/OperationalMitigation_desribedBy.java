...
public final class OperationalMitigation_desribedBy extends BaseGeneratedEMFQuerySpecification<OperationalMitigation_desribedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_desribedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_desribedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalMitigation_desribedBy.Match.parameterNames;
    }
    ...
    @Override
    public OperationalMitigation_desribedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalMitigation_desribedBy.Match)) {
          OperationalMitigation_desribedBy.Match other = (OperationalMitigation_desribedBy.Match) obj;
    ...
    @Override
    public OperationalMitigation_desribedBy specification() {
      return OperationalMitigation_desribedBy.instance();
    }
     ...
     * 
     */
    public static OperationalMitigation_desribedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalMitigation_desribedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalMitigation_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalMitigation_desribedBy.Match {
    ...
    private static final class Immutable extends OperationalMitigation_desribedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_desribedBy pattern,
   ...
   * 
   * @see Match
   * @see OperationalMitigation_desribedBy
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalMitigation_desribedBy.Match> {
    /**
     ...
     * 
     */
    public static OperationalMitigation_desribedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalMitigation_desribedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalMitigation_desribedBy.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalMitigation_desribedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalMitigation_desribedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalMitigation_desribedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalMitigation_desribedBy.Match> processor) {
     ...
     * 
     */
    public OperationalMitigation_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalMitigation_desribedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalMitigation_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalMitigation_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalMitigation_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalMitigation_desribedBy.Match partialMatch) {
    ...
    @Override
    protected OperationalMitigation_desribedBy.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalMitigation_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalMitigation_desribedBy.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalMitigation_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalMitigation_desribedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalMitigation_desribedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalMitigation_desribedBy.Matcher> querySpecification() {
      return OperationalMitigation_desribedBy.instance();
    }
  }
  
  private OperationalMitigation_desribedBy() {
   ...
   * 
   */
  public static OperationalMitigation_desribedBy instance() {
    try{
  ...
  @Override
  protected OperationalMitigation_desribedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalMitigation_desribedBy.Matcher.on(engine);
  }
  
  @Override
  public OperationalMitigation_desribedBy.Matcher instantiate() {
    return OperationalMitigation_desribedBy.Matcher.create();
  }
  
  @Override
  public OperationalMitigation_desribedBy.Match newEmptyMatch() {
    return OperationalMitigation_desribedBy.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalMitigation_desribedBy.Match newMatch(final Object... parameters) {
    return OperationalMitigation_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalMitigation_desribedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalMitigation_desribedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalMitigation_desribedBy INSTANCE = new OperationalMitigation_desribedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalMitigation_desribedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
