...
public final class Node_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Node_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Node_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_actualPropertySet.Match)) {
          Node_actualPropertySet.Match other = (Node_actualPropertySet.Match) obj;
    ...
    @Override
    public Node_actualPropertySet specification() {
      return Node_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Node_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Node_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_actualPropertySet.Match {
    ...
    private static final class Immutable extends Node_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Node_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Node_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Node_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Node_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Node_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Node_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Node_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Node_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Node_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Node_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Node_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Node_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Node_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Node_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_actualPropertySet.Matcher> querySpecification() {
      return Node_actualPropertySet.instance();
    }
  }
  
  private Node_actualPropertySet() {
   ...
   * 
   */
  public static Node_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Node_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Node_actualPropertySet.Matcher instantiate() {
    return Node_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Node_actualPropertySet.Match newEmptyMatch() {
    return Node_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Node_actualPropertySet.Match newMatch(final Object... parameters) {
    return Node_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_actualPropertySet INSTANCE = new Node_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
