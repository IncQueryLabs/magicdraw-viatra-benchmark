...
public final class WholeLifeEnterprise_URI extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_URI.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_URI.Match)) {
          WholeLifeEnterprise_URI.Match other = (WholeLifeEnterprise_URI.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_URI specification() {
      return WholeLifeEnterprise_URI.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static WholeLifeEnterprise_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_URI.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_URI pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_URI
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_URI.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_URI.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super WholeLifeEnterprise_URI.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return WholeLifeEnterprise_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final WholeLifeEnterprise_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final WholeLifeEnterprise_URI.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_URI.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected WholeLifeEnterprise_URI.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_URI.Matcher> querySpecification() {
      return WholeLifeEnterprise_URI.instance();
    }
  }
  
  private WholeLifeEnterprise_URI() {
   ...
   * 
   */
  public static WholeLifeEnterprise_URI instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_URI.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_URI.Matcher instantiate() {
    return WholeLifeEnterprise_URI.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_URI.Match newEmptyMatch() {
    return WholeLifeEnterprise_URI.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_URI.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_URI INSTANCE = new WholeLifeEnterprise_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
