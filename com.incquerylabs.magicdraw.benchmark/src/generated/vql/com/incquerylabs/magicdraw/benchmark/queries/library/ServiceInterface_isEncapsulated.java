...
import com.incquerylabs.magicdraw.benchmark.queries.library.ServiceInterface;
...
public final class ServiceInterface_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ServiceInterface_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceInterface_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ServiceInterface_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInterface_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInterface_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInterface_isEncapsulated.Match)) {
          ServiceInterface_isEncapsulated.Match other = (ServiceInterface_isEncapsulated.Match) obj;
    ...
    @Override
    public ServiceInterface_isEncapsulated specification() {
      return ServiceInterface_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static ServiceInterface_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInterface_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ServiceInterface_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ServiceInterface_isEncapsulated.Match {
    ...
    private static final class Immutable extends ServiceInterface_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceInterface_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see ServiceInterface_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInterface_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static ServiceInterface_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInterface_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInterface_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInterface_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ServiceInterface_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ServiceInterface_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ServiceInterface_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ServiceInterface_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ServiceInterface_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceInterface_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceInterface_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ServiceInterface_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ServiceInterface_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected ServiceInterface_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInterface_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ServiceInterface_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInterface_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInterface_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInterface_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInterface_isEncapsulated.Matcher> querySpecification() {
      return ServiceInterface_isEncapsulated.instance();
    }
  }
  
  private ServiceInterface_isEncapsulated() {
   ...
   * 
   */
  public static ServiceInterface_isEncapsulated instance() {
    try{
  ...
  @Override
  protected ServiceInterface_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInterface_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public ServiceInterface_isEncapsulated.Matcher instantiate() {
    return ServiceInterface_isEncapsulated.Matcher.create();
  }
  
  @Override
  public ServiceInterface_isEncapsulated.Match newEmptyMatch() {
    return ServiceInterface_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInterface_isEncapsulated.Match newMatch(final Object... parameters) {
    return ServiceInterface_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInterface_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInterface_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInterface_isEncapsulated INSTANCE = new ServiceInterface_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInterface_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
