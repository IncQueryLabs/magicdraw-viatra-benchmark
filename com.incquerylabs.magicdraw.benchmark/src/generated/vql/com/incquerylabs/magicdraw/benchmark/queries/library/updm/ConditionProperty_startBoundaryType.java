...
public final class ConditionProperty_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ConditionProperty_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionProperty_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ConditionProperty_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionProperty_startBoundaryType.Match)) {
          ConditionProperty_startBoundaryType.Match other = (ConditionProperty_startBoundaryType.Match) obj;
    ...
    @Override
    public ConditionProperty_startBoundaryType specification() {
      return ConditionProperty_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ConditionProperty_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionProperty_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConditionProperty_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConditionProperty_startBoundaryType.Match {
    ...
    private static final class Immutable extends ConditionProperty_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ConditionProperty_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionProperty_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ConditionProperty_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionProperty_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionProperty_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionProperty_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConditionProperty_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConditionProperty_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConditionProperty_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ConditionProperty_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ConditionProperty_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConditionProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConditionProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConditionProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConditionProperty_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ConditionProperty_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionProperty_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConditionProperty_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionProperty_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionProperty_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionProperty_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionProperty_startBoundaryType.Matcher> querySpecification() {
      return ConditionProperty_startBoundaryType.instance();
    }
  }
  
  private ConditionProperty_startBoundaryType() {
   ...
   * 
   */
  public static ConditionProperty_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ConditionProperty_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionProperty_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ConditionProperty_startBoundaryType.Matcher instantiate() {
    return ConditionProperty_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ConditionProperty_startBoundaryType.Match newEmptyMatch() {
    return ConditionProperty_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionProperty_startBoundaryType.Match newMatch(final Object... parameters) {
    return ConditionProperty_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionProperty_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionProperty_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionProperty_startBoundaryType INSTANCE = new ConditionProperty_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionProperty_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
