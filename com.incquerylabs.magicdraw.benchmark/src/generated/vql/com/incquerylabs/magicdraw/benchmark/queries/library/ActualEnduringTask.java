...
public final class ActualEnduringTask extends BaseGeneratedEMFQuerySpecification<ActualEnduringTask.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnduringTask pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnduringTask";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualEnduringTask.Match.parameterNames;
    }
    ...
    @Override
    public ActualEnduringTask.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualEnduringTask.Match)) {
          ActualEnduringTask.Match other = (ActualEnduringTask.Match) obj;
    ...
    @Override
    public ActualEnduringTask specification() {
      return ActualEnduringTask.instance();
    }
     ...
     * 
     */
    public static ActualEnduringTask.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualEnduringTask.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualEnduringTask.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualEnduringTask.Match {
    ...
    private static final class Immutable extends ActualEnduringTask.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnduringTask pattern,
   ...
   * 
   * @see Match
   * @see ActualEnduringTask
   * 
   */
  public static class Matcher extends BaseMatcher<ActualEnduringTask.Match> {
    /**
     ...
     * 
     */
    public static ActualEnduringTask.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualEnduringTask.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualEnduringTask.Matcher.class);
     ...
     * 
     */
    public Collection<ActualEnduringTask.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualEnduringTask.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualEnduringTask.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualEnduringTask.Match> processor) {
     ...
     * 
     */
    public ActualEnduringTask.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualEnduringTask.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualEnduringTask.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualEnduringTask.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualEnduringTask.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualEnduringTask.Match partialMatch) {
    ...
    @Override
    protected ActualEnduringTask.Match tupleToMatch(final Tuple t) {
      try {
          return ActualEnduringTask.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualEnduringTask.Match arrayToMatch(final Object[] match) {
      try {
          return ActualEnduringTask.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualEnduringTask.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualEnduringTask.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualEnduringTask.Matcher> querySpecification() {
      return ActualEnduringTask.instance();
    }
  }
  
  private ActualEnduringTask() {
   ...
   * 
   */
  public static ActualEnduringTask instance() {
    try{
  ...
  @Override
  protected ActualEnduringTask.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualEnduringTask.Matcher.on(engine);
  }
  
  @Override
  public ActualEnduringTask.Matcher instantiate() {
    return ActualEnduringTask.Matcher.create();
  }
  
  @Override
  public ActualEnduringTask.Match newEmptyMatch() {
    return ActualEnduringTask.Match.newEmptyMatch();
  }
  
  @Override
  public ActualEnduringTask.Match newMatch(final Object... parameters) {
    return ActualEnduringTask.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualEnduringTask} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualEnduringTask#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualEnduringTask INSTANCE = new ActualEnduringTask();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualEnduringTask.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualEnduringTask")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualEnduringTask");
