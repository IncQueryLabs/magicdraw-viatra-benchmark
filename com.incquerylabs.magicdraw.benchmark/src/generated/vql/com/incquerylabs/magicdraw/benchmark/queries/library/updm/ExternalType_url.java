...
public final class ExternalType_url extends BaseGeneratedEMFQuerySpecification<ExternalType_url.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_url pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_url";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalType_url.Match.parameterNames;
    }
    ...
    @Override
    public ExternalType_url.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalType_url.Match)) {
          ExternalType_url.Match other = (ExternalType_url.Match) obj;
    ...
    @Override
    public ExternalType_url specification() {
      return ExternalType_url.instance();
    }
     ...
     * 
     */
    public static ExternalType_url.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalType_url.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ExternalType_url.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ExternalType_url.Match {
    ...
    private static final class Immutable extends ExternalType_url.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_url pattern,
   ...
   * 
   * @see Match
   * @see ExternalType_url
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalType_url.Match> {
    /**
     ...
     * 
     */
    public static ExternalType_url.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalType_url.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalType_url.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalType_url.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ExternalType_url.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ExternalType_url.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ExternalType_url.Match> processor) {
     ...
     * 
     */
    public ExternalType_url.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ExternalType_url.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalType_url.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalType_url.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ExternalType_url.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ExternalType_url.Match partialMatch) {
    ...
    @Override
    protected ExternalType_url.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalType_url.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ExternalType_url.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalType_url.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalType_url.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalType_url.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalType_url.Matcher> querySpecification() {
      return ExternalType_url.instance();
    }
  }
  
  private ExternalType_url() {
   ...
   * 
   */
  public static ExternalType_url instance() {
    try{
  ...
  @Override
  protected ExternalType_url.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalType_url.Matcher.on(engine);
  }
  
  @Override
  public ExternalType_url.Matcher instantiate() {
    return ExternalType_url.Matcher.create();
  }
  
  @Override
  public ExternalType_url.Match newEmptyMatch() {
    return ExternalType_url.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalType_url.Match newMatch(final Object... parameters) {
    return ExternalType_url.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalType_url} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalType_url#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalType_url INSTANCE = new ExternalType_url();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalType_url.GeneratedPQuery INSTANCE = new GeneratedPQuery();
