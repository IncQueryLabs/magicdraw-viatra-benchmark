...
public final class ProjectStatus_conformsTo extends BaseGeneratedEMFQuerySpecification<ProjectStatus_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectStatus_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ProjectStatus_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectStatus_conformsTo.Match)) {
          ProjectStatus_conformsTo.Match other = (ProjectStatus_conformsTo.Match) obj;
    ...
    @Override
    public ProjectStatus_conformsTo specification() {
      return ProjectStatus_conformsTo.instance();
    }
     ...
     * 
     */
    public static ProjectStatus_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectStatus_conformsTo.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectStatus_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectStatus_conformsTo.Match {
    ...
    private static final class Immutable extends ProjectStatus_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ProjectStatus_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectStatus_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ProjectStatus_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectStatus_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectStatus_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectStatus_conformsTo.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectStatus_conformsTo.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectStatus_conformsTo.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ProjectStatus_conformsTo.Match> processor) {
     ...
     * 
     */
    public ProjectStatus_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return ProjectStatus_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ProjectStatus_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ProjectStatus_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectStatus_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectStatus_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ProjectStatus_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectStatus_conformsTo.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectStatus_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectStatus_conformsTo.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectStatus_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectStatus_conformsTo.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectStatus_conformsTo.Matcher> querySpecification() {
      return ProjectStatus_conformsTo.instance();
    }
  }
  
  private ProjectStatus_conformsTo() {
   ...
   * 
   */
  public static ProjectStatus_conformsTo instance() {
    try{
  ...
  @Override
  protected ProjectStatus_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectStatus_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ProjectStatus_conformsTo.Matcher instantiate() {
    return ProjectStatus_conformsTo.Matcher.create();
  }
  
  @Override
  public ProjectStatus_conformsTo.Match newEmptyMatch() {
    return ProjectStatus_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectStatus_conformsTo.Match newMatch(final Object... parameters) {
    return ProjectStatus_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectStatus_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectStatus_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectStatus_conformsTo INSTANCE = new ProjectStatus_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectStatus_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
