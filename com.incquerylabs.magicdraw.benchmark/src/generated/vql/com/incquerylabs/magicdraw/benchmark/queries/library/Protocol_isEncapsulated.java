...
public final class Protocol_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Protocol_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Protocol_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Protocol_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_isEncapsulated.Match)) {
          Protocol_isEncapsulated.Match other = (Protocol_isEncapsulated.Match) obj;
    ...
    @Override
    public Protocol_isEncapsulated specification() {
      return Protocol_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Protocol_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Protocol_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Protocol_isEncapsulated.Match {
    ...
    private static final class Immutable extends Protocol_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Protocol_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Protocol_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Protocol_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Protocol_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Protocol_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Protocol_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Protocol_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Protocol_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Protocol_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Protocol_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Protocol_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Protocol_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_isEncapsulated.Matcher> querySpecification() {
      return Protocol_isEncapsulated.instance();
    }
  }
  
  private Protocol_isEncapsulated() {
   ...
   * 
   */
  public static Protocol_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Protocol_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Protocol_isEncapsulated.Matcher instantiate() {
    return Protocol_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Protocol_isEncapsulated.Match newEmptyMatch() {
    return Protocol_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_isEncapsulated.Match newMatch(final Object... parameters) {
    return Protocol_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_isEncapsulated INSTANCE = new Protocol_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
