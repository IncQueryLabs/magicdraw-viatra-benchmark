...
public final class Control_conformsTo extends BaseGeneratedEMFQuerySpecification<Control_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Control_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Control_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Control_conformsTo.Match)) {
          Control_conformsTo.Match other = (Control_conformsTo.Match) obj;
    ...
    @Override
    public Control_conformsTo specification() {
      return Control_conformsTo.instance();
    }
     ...
     * 
     */
    public static Control_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Control_conformsTo.Match newMutableMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public static Control_conformsTo.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Control_conformsTo.Match {
    ...
    private static final class Immutable extends Control_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Control_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Control_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Control_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Control_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Control_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Control_conformsTo.Match> getAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Control_conformsTo.Match> streamAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Control_conformsTo.Match> getOneArbitraryMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final Element pValue, final Consumer<? super Control_conformsTo.Match> processor) {
     ...
     * 
     */
    public Control_conformsTo.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return Control_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Control_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Control_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Control_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Control_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Control_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Control_conformsTo.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Control_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Control_conformsTo.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Control_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Control_conformsTo.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Control_conformsTo.Matcher> querySpecification() {
      return Control_conformsTo.instance();
    }
  }
  
  private Control_conformsTo() {
   ...
   * 
   */
  public static Control_conformsTo instance() {
    try{
  ...
  @Override
  protected Control_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Control_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Control_conformsTo.Matcher instantiate() {
    return Control_conformsTo.Matcher.create();
  }
  
  @Override
  public Control_conformsTo.Match newEmptyMatch() {
    return Control_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Control_conformsTo.Match newMatch(final Object... parameters) {
    return Control_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Control_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Control_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Control_conformsTo INSTANCE = new Control_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Control_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
