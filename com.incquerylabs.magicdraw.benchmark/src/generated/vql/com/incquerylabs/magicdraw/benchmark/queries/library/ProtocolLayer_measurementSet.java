...
public final class ProtocolLayer_measurementSet extends BaseGeneratedEMFQuerySpecification<ProtocolLayer_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolLayer_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolLayer_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolLayer_measurementSet.Match)) {
          ProtocolLayer_measurementSet.Match other = (ProtocolLayer_measurementSet.Match) obj;
    ...
    @Override
    public ProtocolLayer_measurementSet specification() {
      return ProtocolLayer_measurementSet.instance();
    }
     ...
     * 
     */
    public static ProtocolLayer_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolLayer_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolLayer_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolLayer_measurementSet.Match {
    ...
    private static final class Immutable extends ProtocolLayer_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolLayer_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see ProtocolLayer_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolLayer_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static ProtocolLayer_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolLayer_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolLayer_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolLayer_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolLayer_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolLayer_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProtocolLayer_measurementSet.Match> processor) {
     ...
     * 
     */
    public ProtocolLayer_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ProtocolLayer_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProtocolLayer_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProtocolLayer_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolLayer_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolLayer_measurementSet.Match partialMatch) {
    ...
    @Override
    protected ProtocolLayer_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolLayer_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolLayer_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolLayer_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolLayer_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolLayer_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolLayer_measurementSet.Matcher> querySpecification() {
      return ProtocolLayer_measurementSet.instance();
    }
  }
  
  private ProtocolLayer_measurementSet() {
   ...
   * 
   */
  public static ProtocolLayer_measurementSet instance() {
    try{
  ...
  @Override
  protected ProtocolLayer_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolLayer_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public ProtocolLayer_measurementSet.Matcher instantiate() {
    return ProtocolLayer_measurementSet.Matcher.create();
  }
  
  @Override
  public ProtocolLayer_measurementSet.Match newEmptyMatch() {
    return ProtocolLayer_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolLayer_measurementSet.Match newMatch(final Object... parameters) {
    return ProtocolLayer_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolLayer_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolLayer_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolLayer_measurementSet INSTANCE = new ProtocolLayer_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolLayer_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
