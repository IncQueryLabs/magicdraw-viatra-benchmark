...
public final class IsCapableToPerform extends BaseGeneratedEMFQuerySpecification<IsCapableToPerform.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform";
    }
    
    @Override
    public List<String> parameterNames() {
      return IsCapableToPerform.Match.parameterNames;
    }
    ...
    @Override
    public IsCapableToPerform.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof IsCapableToPerform.Match)) {
          IsCapableToPerform.Match other = (IsCapableToPerform.Match) obj;
    ...
    @Override
    public IsCapableToPerform specification() {
      return IsCapableToPerform.instance();
    }
     ...
     * 
     */
    public static IsCapableToPerform.Match newEmptyMatch() {
     ...
     * 
     */
    public static IsCapableToPerform.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static IsCapableToPerform.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends IsCapableToPerform.Match {
    ...
    private static final class Immutable extends IsCapableToPerform.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform pattern,
   ...
   * 
   * @see Match
   * @see IsCapableToPerform
   * 
   */
  public static class Matcher extends BaseMatcher<IsCapableToPerform.Match> {
    /**
     ...
     * 
     */
    public static IsCapableToPerform.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static IsCapableToPerform.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(IsCapableToPerform.Matcher.class);
     ...
     * 
     */
    public Collection<IsCapableToPerform.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<IsCapableToPerform.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<IsCapableToPerform.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super IsCapableToPerform.Match> processor) {
     ...
     * 
     */
    public IsCapableToPerform.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return IsCapableToPerform.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final IsCapableToPerform.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final IsCapableToPerform.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final IsCapableToPerform.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final IsCapableToPerform.Match partialMatch) {
    ...
    @Override
    protected IsCapableToPerform.Match tupleToMatch(final Tuple t) {
      try {
          return IsCapableToPerform.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected IsCapableToPerform.Match arrayToMatch(final Object[] match) {
      try {
          return IsCapableToPerform.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected IsCapableToPerform.Match arrayToMatchMutable(final Object[] match) {
      try {
          return IsCapableToPerform.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<IsCapableToPerform.Matcher> querySpecification() {
      return IsCapableToPerform.instance();
    }
  }
  
  private IsCapableToPerform() {
   ...
   * 
   */
  public static IsCapableToPerform instance() {
    try{
  ...
  @Override
  protected IsCapableToPerform.Matcher instantiate(final ViatraQueryEngine engine) {
    return IsCapableToPerform.Matcher.on(engine);
  }
  
  @Override
  public IsCapableToPerform.Matcher instantiate() {
    return IsCapableToPerform.Matcher.create();
  }
  
  @Override
  public IsCapableToPerform.Match newEmptyMatch() {
    return IsCapableToPerform.Match.newEmptyMatch();
  }
  
  @Override
  public IsCapableToPerform.Match newMatch(final Object... parameters) {
    return IsCapableToPerform.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link IsCapableToPerform} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link IsCapableToPerform#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final IsCapableToPerform INSTANCE = new IsCapableToPerform();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final IsCapableToPerform.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "IsCapableToPerform")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "IsCapableToPerform");
