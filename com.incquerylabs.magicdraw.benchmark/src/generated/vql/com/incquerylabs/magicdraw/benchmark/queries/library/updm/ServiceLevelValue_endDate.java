...
public final class ServiceLevelValue_endDate extends BaseGeneratedEMFQuerySpecification<ServiceLevelValue_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceLevelValue_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ServiceLevelValue_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceLevelValue_endDate.Match)) {
          ServiceLevelValue_endDate.Match other = (ServiceLevelValue_endDate.Match) obj;
    ...
    @Override
    public ServiceLevelValue_endDate specification() {
      return ServiceLevelValue_endDate.instance();
    }
     ...
     * 
     */
    public static ServiceLevelValue_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceLevelValue_endDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceLevelValue_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceLevelValue_endDate.Match {
    ...
    private static final class Immutable extends ServiceLevelValue_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_endDate pattern,
   ...
   * 
   * @see Match
   * @see ServiceLevelValue_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceLevelValue_endDate.Match> {
    /**
     ...
     * 
     */
    public static ServiceLevelValue_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceLevelValue_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceLevelValue_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceLevelValue_endDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceLevelValue_endDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceLevelValue_endDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ServiceLevelValue_endDate.Match> processor) {
     ...
     * 
     */
    public ServiceLevelValue_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ServiceLevelValue_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ServiceLevelValue_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ServiceLevelValue_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceLevelValue_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceLevelValue_endDate.Match partialMatch) {
    ...
    @Override
    protected ServiceLevelValue_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceLevelValue_endDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceLevelValue_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceLevelValue_endDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceLevelValue_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceLevelValue_endDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceLevelValue_endDate.Matcher> querySpecification() {
      return ServiceLevelValue_endDate.instance();
    }
  }
  
  private ServiceLevelValue_endDate() {
   ...
   * 
   */
  public static ServiceLevelValue_endDate instance() {
    try{
  ...
  @Override
  protected ServiceLevelValue_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceLevelValue_endDate.Matcher.on(engine);
  }
  
  @Override
  public ServiceLevelValue_endDate.Matcher instantiate() {
    return ServiceLevelValue_endDate.Matcher.create();
  }
  
  @Override
  public ServiceLevelValue_endDate.Match newEmptyMatch() {
    return ServiceLevelValue_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceLevelValue_endDate.Match newMatch(final Object... parameters) {
    return ServiceLevelValue_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceLevelValue_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceLevelValue_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceLevelValue_endDate INSTANCE = new ServiceLevelValue_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceLevelValue_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
