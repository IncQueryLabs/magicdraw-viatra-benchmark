...
public final class OperationalRole_physicalLocation extends BaseGeneratedEMFQuerySpecification<OperationalRole_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalRole_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public OperationalRole_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalRole_physicalLocation.Match)) {
          OperationalRole_physicalLocation.Match other = (OperationalRole_physicalLocation.Match) obj;
    ...
    @Override
    public OperationalRole_physicalLocation specification() {
      return OperationalRole_physicalLocation.instance();
    }
     ...
     * 
     */
    public static OperationalRole_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalRole_physicalLocation.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalRole_physicalLocation.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalRole_physicalLocation.Match {
    ...
    private static final class Immutable extends OperationalRole_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see OperationalRole_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalRole_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static OperationalRole_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalRole_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalRole_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalRole_physicalLocation.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalRole_physicalLocation.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalRole_physicalLocation.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super OperationalRole_physicalLocation.Match> processor) {
     ...
     * 
     */
    public OperationalRole_physicalLocation.Match newMatch(final Property pElement, final Element pValue) {
      return OperationalRole_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalRole_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalRole_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalRole_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalRole_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected OperationalRole_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalRole_physicalLocation.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalRole_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalRole_physicalLocation.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalRole_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalRole_physicalLocation.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalRole_physicalLocation.Matcher> querySpecification() {
      return OperationalRole_physicalLocation.instance();
    }
  }
  
  private OperationalRole_physicalLocation() {
   ...
   * 
   */
  public static OperationalRole_physicalLocation instance() {
    try{
  ...
  @Override
  protected OperationalRole_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalRole_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public OperationalRole_physicalLocation.Matcher instantiate() {
    return OperationalRole_physicalLocation.Matcher.create();
  }
  
  @Override
  public OperationalRole_physicalLocation.Match newEmptyMatch() {
    return OperationalRole_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalRole_physicalLocation.Match newMatch(final Object... parameters) {
    return OperationalRole_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalRole_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalRole_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalRole_physicalLocation INSTANCE = new OperationalRole_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalRole_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
