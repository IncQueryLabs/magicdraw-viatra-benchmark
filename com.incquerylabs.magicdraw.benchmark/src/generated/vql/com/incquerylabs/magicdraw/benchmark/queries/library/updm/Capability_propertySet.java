...
public final class Capability_propertySet extends BaseGeneratedEMFQuerySpecification<Capability_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Capability_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Capability_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Capability_propertySet.Match)) {
          Capability_propertySet.Match other = (Capability_propertySet.Match) obj;
    ...
    @Override
    public Capability_propertySet specification() {
      return Capability_propertySet.instance();
    }
     ...
     * 
     */
    public static Capability_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Capability_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Capability_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Capability_propertySet.Match {
    ...
    private static final class Immutable extends Capability_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Capability_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Capability_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Capability_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Capability_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Capability_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Capability_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Capability_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Capability_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Capability_propertySet.Match> processor) {
     ...
     * 
     */
    public Capability_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Capability_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Capability_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Capability_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Capability_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Capability_propertySet.Match partialMatch) {
    ...
    @Override
    protected Capability_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Capability_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Capability_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Capability_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Capability_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Capability_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Capability_propertySet.Matcher> querySpecification() {
      return Capability_propertySet.instance();
    }
  }
  
  private Capability_propertySet() {
   ...
   * 
   */
  public static Capability_propertySet instance() {
    try{
  ...
  @Override
  protected Capability_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Capability_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Capability_propertySet.Matcher instantiate() {
    return Capability_propertySet.Matcher.create();
  }
  
  @Override
  public Capability_propertySet.Match newEmptyMatch() {
    return Capability_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Capability_propertySet.Match newMatch(final Object... parameters) {
    return Capability_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Capability_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Capability_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Capability_propertySet INSTANCE = new Capability_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Capability_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
