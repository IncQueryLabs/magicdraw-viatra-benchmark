...
public final class Person_URI extends BaseGeneratedEMFQuerySpecification<Person_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_URI.Match.parameterNames;
    }
    ...
    @Override
    public Person_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_URI.Match)) {
          Person_URI.Match other = (Person_URI.Match) obj;
    ...
    @Override
    public Person_URI specification() {
      return Person_URI.instance();
    }
     ...
     * 
     */
    public static Person_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Person_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Person_URI.Match {
    ...
    private static final class Immutable extends Person_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Person_URI.Match> {
    /**
     ...
     * 
     */
    public static Person_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Person_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Person_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Person_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Person_URI.Match> processor) {
     ...
     * 
     */
    public Person_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Person_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Person_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Person_URI.Match partialMatch) {
    ...
    @Override
    protected Person_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Person_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Person_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Person_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_URI.Matcher> querySpecification() {
      return Person_URI.instance();
    }
  }
   ...
   * 
   */
  public static Person_URI instance() {
    try{
  ...
  @Override
  protected Person_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_URI.Matcher.on(engine);
  }
  
  @Override
  public Person_URI.Matcher instantiate() {
    return Person_URI.Matcher.create();
  }
  
  @Override
  public Person_URI.Match newEmptyMatch() {
    return Person_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Person_URI.Match newMatch(final Object... parameters) {
    return Person_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_URI INSTANCE = new Person_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
