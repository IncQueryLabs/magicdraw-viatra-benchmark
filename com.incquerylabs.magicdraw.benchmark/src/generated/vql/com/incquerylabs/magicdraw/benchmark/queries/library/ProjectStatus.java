...
public final class ProjectStatus extends BaseGeneratedEMFQuerySpecification<ProjectStatus.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectStatus.Match.parameterNames;
    }
    ...
    @Override
    public ProjectStatus.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectStatus.Match)) {
          ProjectStatus.Match other = (ProjectStatus.Match) obj;
    ...
    @Override
    public ProjectStatus specification() {
     ...
     * 
     */
    public static ProjectStatus.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectStatus.Match newMutableMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProjectStatus.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProjectStatus.Match {
    ...
    private static final class Immutable extends ProjectStatus.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectStatus.Match> {
    /**
     ...
     * 
     */
    public static ProjectStatus.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectStatus.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectStatus.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectStatus.Match> getAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProjectStatus.Match> streamAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProjectStatus.Match> getOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProjectStatus.Match> processor) {
     ...
     * 
     */
    public ProjectStatus.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProjectStatus.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ProjectStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ProjectStatus.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProjectStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProjectStatus.Match partialMatch) {
    ...
    @Override
    protected ProjectStatus.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectStatus.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProjectStatus.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectStatus.Match.newMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectStatus.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectStatus.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectStatus.Matcher> querySpecification() {
      return ProjectStatus.instance();
    }
  }
   ...
   * 
   */
  public static ProjectStatus instance() {
    try{
  ...
  @Override
  protected ProjectStatus.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectStatus.Matcher.on(engine);
  }
  
  @Override
  public ProjectStatus.Matcher instantiate() {
    return ProjectStatus.Matcher.create();
  }
  
  @Override
  public ProjectStatus.Match newEmptyMatch() {
    return ProjectStatus.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectStatus.Match newMatch(final Object... parameters) {
    return ProjectStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectStatus} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectStatus#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectStatus INSTANCE = new ProjectStatus();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectStatus.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ProjectStatus")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ProjectStatus");
