...
public final class ProjectRole_physicalLocation extends BaseGeneratedEMFQuerySpecification<ProjectRole_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectRole_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public ProjectRole_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectRole_physicalLocation.Match)) {
          ProjectRole_physicalLocation.Match other = (ProjectRole_physicalLocation.Match) obj;
    ...
    @Override
    public ProjectRole_physicalLocation specification() {
      return ProjectRole_physicalLocation.instance();
    }
     ...
     * 
     */
    public static ProjectRole_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectRole_physicalLocation.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectRole_physicalLocation.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectRole_physicalLocation.Match {
    ...
    private static final class Immutable extends ProjectRole_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see ProjectRole_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectRole_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static ProjectRole_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectRole_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectRole_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectRole_physicalLocation.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectRole_physicalLocation.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectRole_physicalLocation.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectRole_physicalLocation.Match> processor) {
     ...
     * 
     */
    public ProjectRole_physicalLocation.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectRole_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectRole_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectRole_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectRole_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectRole_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected ProjectRole_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectRole_physicalLocation.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectRole_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectRole_physicalLocation.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectRole_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectRole_physicalLocation.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectRole_physicalLocation.Matcher> querySpecification() {
      return ProjectRole_physicalLocation.instance();
    }
  }
  
  private ProjectRole_physicalLocation() {
   ...
   * 
   */
  public static ProjectRole_physicalLocation instance() {
    try{
  ...
  @Override
  protected ProjectRole_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectRole_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public ProjectRole_physicalLocation.Matcher instantiate() {
    return ProjectRole_physicalLocation.Matcher.create();
  }
  
  @Override
  public ProjectRole_physicalLocation.Match newEmptyMatch() {
    return ProjectRole_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectRole_physicalLocation.Match newMatch(final Object... parameters) {
    return ProjectRole_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectRole_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectRole_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectRole_physicalLocation INSTANCE = new ProjectRole_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectRole_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
