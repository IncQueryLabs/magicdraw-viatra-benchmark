...
public final class CapabilityConfiguration_desribedBy extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_desribedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration_desribedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration_desribedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_desribedBy.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_desribedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_desribedBy.Match)) {
          CapabilityConfiguration_desribedBy.Match other = (CapabilityConfiguration_desribedBy.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_desribedBy specification() {
      return CapabilityConfiguration_desribedBy.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_desribedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_desribedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_desribedBy.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_desribedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration_desribedBy pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_desribedBy
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_desribedBy.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_desribedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_desribedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_desribedBy.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_desribedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_desribedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_desribedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_desribedBy.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_desribedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_desribedBy.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_desribedBy.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_desribedBy.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_desribedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_desribedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_desribedBy.Matcher> querySpecification() {
      return CapabilityConfiguration_desribedBy.instance();
    }
  }
  
  private CapabilityConfiguration_desribedBy() {
   ...
   * 
   */
  public static CapabilityConfiguration_desribedBy instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_desribedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_desribedBy.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_desribedBy.Matcher instantiate() {
    return CapabilityConfiguration_desribedBy.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_desribedBy.Match newEmptyMatch() {
    return CapabilityConfiguration_desribedBy.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_desribedBy.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_desribedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_desribedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_desribedBy INSTANCE = new CapabilityConfiguration_desribedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_desribedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
