...
public final class Responsibility_function extends BaseGeneratedEMFQuerySpecification<Responsibility_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_function.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_function.Match)) {
          Responsibility_function.Match other = (Responsibility_function.Match) obj;
    ...
    @Override
    public Responsibility_function specification() {
      return Responsibility_function.instance();
    }
     ...
     * 
     */
    public static Responsibility_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_function.Match {
    ...
    private static final class Immutable extends Responsibility_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_function pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_function
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_function.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_function.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_function.Match> processor) {
     ...
     * 
     */
    public Responsibility_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_function.Match partialMatch) {
    ...
    @Override
    protected Responsibility_function.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_function.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_function.Matcher> querySpecification() {
      return Responsibility_function.instance();
    }
  }
  
  private Responsibility_function() {
   ...
   * 
   */
  public static Responsibility_function instance() {
    try{
  ...
  @Override
  protected Responsibility_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_function.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_function.Matcher instantiate() {
    return Responsibility_function.Matcher.create();
  }
  
  @Override
  public Responsibility_function.Match newEmptyMatch() {
    return Responsibility_function.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_function.Match newMatch(final Object... parameters) {
    return Responsibility_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_function INSTANCE = new Responsibility_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
