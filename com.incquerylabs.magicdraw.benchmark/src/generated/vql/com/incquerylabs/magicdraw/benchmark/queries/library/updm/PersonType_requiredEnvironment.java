...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType;
...
public final class PersonType_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<PersonType_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_requiredEnvironment.Match)) {
          PersonType_requiredEnvironment.Match other = (PersonType_requiredEnvironment.Match) obj;
    ...
    @Override
    public PersonType_requiredEnvironment specification() {
      return PersonType_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static PersonType_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_requiredEnvironment.Match {
    ...
    private static final class Immutable extends PersonType_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see PersonType_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static PersonType_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public PersonType_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected PersonType_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_requiredEnvironment.Matcher> querySpecification() {
      return PersonType_requiredEnvironment.instance();
    }
  }
  
  private PersonType_requiredEnvironment() {
   ...
   * 
   */
  public static PersonType_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected PersonType_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public PersonType_requiredEnvironment.Matcher instantiate() {
    return PersonType_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public PersonType_requiredEnvironment.Match newEmptyMatch() {
    return PersonType_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_requiredEnvironment.Match newMatch(final Object... parameters) {
    return PersonType_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_requiredEnvironment INSTANCE = new PersonType_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find PersonType(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), PersonType.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
