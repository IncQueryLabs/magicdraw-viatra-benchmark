...
public final class FieldedCapability extends BaseGeneratedEMFQuerySpecification<FieldedCapability.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FieldedCapability pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FieldedCapability";
    }
    
    @Override
    public List<String> parameterNames() {
      return FieldedCapability.Match.parameterNames;
    }
    ...
    @Override
    public FieldedCapability.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FieldedCapability.Match)) {
          FieldedCapability.Match other = (FieldedCapability.Match) obj;
    ...
    @Override
    public FieldedCapability specification() {
      return FieldedCapability.instance();
    }
     ...
     * 
     */
    public static FieldedCapability.Match newEmptyMatch() {
     ...
     * 
     */
    public static FieldedCapability.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FieldedCapability.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends FieldedCapability.Match {
    ...
    private static final class Immutable extends FieldedCapability.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FieldedCapability pattern,
   ...
   * 
   * @see Match
   * @see FieldedCapability
   * 
   */
  public static class Matcher extends BaseMatcher<FieldedCapability.Match> {
    /**
     ...
     * 
     */
    public static FieldedCapability.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FieldedCapability.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FieldedCapability.Matcher.class);
     ...
     * 
     */
    public Collection<FieldedCapability.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FieldedCapability.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FieldedCapability.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FieldedCapability.Match> processor) {
     ...
     * 
     */
    public FieldedCapability.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FieldedCapability.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final FieldedCapability.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final FieldedCapability.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FieldedCapability.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FieldedCapability.Match partialMatch) {
    ...
    @Override
    protected FieldedCapability.Match tupleToMatch(final Tuple t) {
      try {
          return FieldedCapability.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected FieldedCapability.Match arrayToMatch(final Object[] match) {
      try {
          return FieldedCapability.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FieldedCapability.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FieldedCapability.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FieldedCapability.Matcher> querySpecification() {
      return FieldedCapability.instance();
    }
  }
  
  private FieldedCapability() {
   ...
   * 
   */
  public static FieldedCapability instance() {
    try{
  ...
  @Override
  protected FieldedCapability.Matcher instantiate(final ViatraQueryEngine engine) {
    return FieldedCapability.Matcher.on(engine);
  }
  
  @Override
  public FieldedCapability.Matcher instantiate() {
    return FieldedCapability.Matcher.create();
  }
  
  @Override
  public FieldedCapability.Match newEmptyMatch() {
    return FieldedCapability.Match.newEmptyMatch();
  }
  
  @Override
  public FieldedCapability.Match newMatch(final Object... parameters) {
    return FieldedCapability.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FieldedCapability} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FieldedCapability#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FieldedCapability INSTANCE = new FieldedCapability();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FieldedCapability.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "FieldedCapability")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "FieldedCapability");
