...
public final class ExternalType_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ExternalType_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalType_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ExternalType_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalType_endBoundaryType.Match)) {
          ExternalType_endBoundaryType.Match other = (ExternalType_endBoundaryType.Match) obj;
    ...
    @Override
    public ExternalType_endBoundaryType specification() {
      return ExternalType_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ExternalType_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalType_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalType_endBoundaryType.Match {
    ...
    private static final class Immutable extends ExternalType_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ExternalType_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalType_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ExternalType_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalType_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalType_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalType_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalType_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalType_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalType_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ExternalType_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalType_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalType_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalType_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ExternalType_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalType_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalType_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalType_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalType_endBoundaryType.Matcher> querySpecification() {
      return ExternalType_endBoundaryType.instance();
    }
  }
  
  private ExternalType_endBoundaryType() {
   ...
   * 
   */
  public static ExternalType_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ExternalType_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalType_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ExternalType_endBoundaryType.Matcher instantiate() {
    return ExternalType_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ExternalType_endBoundaryType.Match newEmptyMatch() {
    return ExternalType_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalType_endBoundaryType.Match newMatch(final Object... parameters) {
    return ExternalType_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalType_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalType_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalType_endBoundaryType INSTANCE = new ExternalType_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalType_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
