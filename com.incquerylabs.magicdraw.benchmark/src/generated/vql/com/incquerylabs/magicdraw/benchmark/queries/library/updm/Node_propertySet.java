...
public final class Node_propertySet extends BaseGeneratedEMFQuerySpecification<Node_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Node_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_propertySet.Match)) {
          Node_propertySet.Match other = (Node_propertySet.Match) obj;
    ...
    @Override
    public Node_propertySet specification() {
      return Node_propertySet.instance();
    }
     ...
     * 
     */
    public static Node_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Node_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_propertySet.Match {
    ...
    private static final class Immutable extends Node_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Node_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Node_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Node_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Node_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Node_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Node_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Node_propertySet.Match> processor) {
     ...
     * 
     */
    public Node_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Node_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Node_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Node_propertySet.Match partialMatch) {
    ...
    @Override
    protected Node_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Node_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Node_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_propertySet.Matcher> querySpecification() {
      return Node_propertySet.instance();
    }
  }
  
  private Node_propertySet() {
   ...
   * 
   */
  public static Node_propertySet instance() {
    try{
  ...
  @Override
  protected Node_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Node_propertySet.Matcher instantiate() {
    return Node_propertySet.Matcher.create();
  }
  
  @Override
  public Node_propertySet.Match newEmptyMatch() {
    return Node_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Node_propertySet.Match newMatch(final Object... parameters) {
    return Node_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_propertySet INSTANCE = new Node_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
