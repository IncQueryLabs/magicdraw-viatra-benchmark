...
public final class Desirer extends BaseGeneratedEMFQuerySpecification<Desirer.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Desirer pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Desirer";
    }
    
    @Override
    public List<String> parameterNames() {
      return Desirer.Match.parameterNames;
    }
    ...
    @Override
    public Desirer.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Desirer.Match)) {
          Desirer.Match other = (Desirer.Match) obj;
    ...
    @Override
    public Desirer specification() {
      return Desirer.instance();
    }
     ...
     * 
     */
    public static Desirer.Match newEmptyMatch() {
     ...
     * 
     */
    public static Desirer.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Desirer.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Desirer.Match {
    ...
    private static final class Immutable extends Desirer.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Desirer pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Desirer.Match> {
    /**
     ...
     * 
     */
    public static Desirer.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Desirer.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Desirer.Matcher.class);
     ...
     * 
     */
    public Collection<Desirer.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Desirer.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Desirer.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Desirer.Match> processor) {
     ...
     * 
     */
    public Desirer.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Desirer.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Desirer.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Desirer.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Desirer.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Desirer.Match partialMatch) {
    ...
    @Override
    protected Desirer.Match tupleToMatch(final Tuple t) {
      try {
          return Desirer.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Desirer.Match arrayToMatch(final Object[] match) {
      try {
          return Desirer.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Desirer.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Desirer.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Desirer.Matcher> querySpecification() {
      return Desirer.instance();
    }
  }
   ...
   * 
   */
  public static Desirer instance() {
    try{
  ...
  @Override
  protected Desirer.Matcher instantiate(final ViatraQueryEngine engine) {
    return Desirer.Matcher.on(engine);
  }
  
  @Override
  public Desirer.Matcher instantiate() {
    return Desirer.Matcher.create();
  }
  
  @Override
  public Desirer.Match newEmptyMatch() {
    return Desirer.Match.newEmptyMatch();
  }
  
  @Override
  public Desirer.Match newMatch(final Object... parameters) {
    return Desirer.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Desirer} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Desirer#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Desirer INSTANCE = new Desirer();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Desirer.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Desirer")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Desirer");
