...
public final class Exchange extends BaseGeneratedEMFQuerySpecification<Exchange.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Exchange pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Exchange";
    }
    
    @Override
    public List<String> parameterNames() {
      return Exchange.Match.parameterNames;
    }
    ...
    @Override
    public Exchange.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Exchange.Match)) {
          Exchange.Match other = (Exchange.Match) obj;
     ...
     * 
     */
    public static Exchange.Match newEmptyMatch() {
     ...
     * 
     */
    public static Exchange.Match newMutableMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Exchange.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Exchange.Match {
    ...
    private static final class Immutable extends Exchange.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Exchange pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Exchange.Match> {
    /**
     ...
     * 
     */
    public static Exchange.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Exchange.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Exchange.Matcher.class);
     ...
     * 
     */
    public Collection<Exchange.Match> getAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Exchange.Match> streamAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Exchange.Match> getOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Exchange.Match> processor) {
     ...
     * 
     */
    public Exchange.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Exchange.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Exchange.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Exchange.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Exchange.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Exchange.Match partialMatch) {
    ...
    @Override
    protected Exchange.Match tupleToMatch(final Tuple t) {
      try {
          return Exchange.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Exchange.Match arrayToMatch(final Object[] match) {
      try {
          return Exchange.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Exchange.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Exchange.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Exchange.Matcher> querySpecification() {
      return Exchange.instance();
    }
  }
  ...
  @Override
  protected Exchange.Matcher instantiate(final ViatraQueryEngine engine) {
    return Exchange.Matcher.on(engine);
  }
  
  @Override
  public Exchange.Matcher instantiate() {
    return Exchange.Matcher.create();
  }
  
  @Override
  public Exchange.Match newEmptyMatch() {
    return Exchange.Match.newEmptyMatch();
  }
  
  @Override
  public Exchange.Match newMatch(final Object... parameters) {
    return Exchange.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Exchange} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Exchange#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Exchange.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Exchange")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Exchange");
