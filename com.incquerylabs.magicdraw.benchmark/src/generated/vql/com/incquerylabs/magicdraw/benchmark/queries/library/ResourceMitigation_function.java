...
public final class ResourceMitigation_function extends BaseGeneratedEMFQuerySpecification<ResourceMitigation_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceMitigation_function.Match.parameterNames;
    }
    ...
    @Override
    public ResourceMitigation_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceMitigation_function.Match)) {
          ResourceMitigation_function.Match other = (ResourceMitigation_function.Match) obj;
    ...
    @Override
    public ResourceMitigation_function specification() {
      return ResourceMitigation_function.instance();
    }
     ...
     * 
     */
    public static ResourceMitigation_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceMitigation_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceMitigation_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceMitigation_function.Match {
    ...
    private static final class Immutable extends ResourceMitigation_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_function pattern,
   ...
   * 
   * @see Match
   * @see ResourceMitigation_function
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceMitigation_function.Match> {
    /**
     ...
     * 
     */
    public static ResourceMitigation_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceMitigation_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceMitigation_function.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceMitigation_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceMitigation_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceMitigation_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceMitigation_function.Match> processor) {
     ...
     * 
     */
    public ResourceMitigation_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceMitigation_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceMitigation_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceMitigation_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceMitigation_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceMitigation_function.Match partialMatch) {
    ...
    @Override
    protected ResourceMitigation_function.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceMitigation_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceMitigation_function.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceMitigation_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceMitigation_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceMitigation_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceMitigation_function.Matcher> querySpecification() {
      return ResourceMitigation_function.instance();
    }
  }
  
  private ResourceMitigation_function() {
   ...
   * 
   */
  public static ResourceMitigation_function instance() {
    try{
  ...
  @Override
  protected ResourceMitigation_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceMitigation_function.Matcher.on(engine);
  }
  
  @Override
  public ResourceMitigation_function.Matcher instantiate() {
    return ResourceMitigation_function.Matcher.create();
  }
  
  @Override
  public ResourceMitigation_function.Match newEmptyMatch() {
    return ResourceMitigation_function.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceMitigation_function.Match newMatch(final Object... parameters) {
    return ResourceMitigation_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceMitigation_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceMitigation_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceMitigation_function INSTANCE = new ResourceMitigation_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceMitigation_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
