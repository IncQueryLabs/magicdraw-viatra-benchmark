...
public final class EntityAttribute_endBoundaryType extends BaseGeneratedEMFQuerySpecification<EntityAttribute_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityAttribute_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EntityAttribute_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityAttribute_endBoundaryType.Match)) {
          EntityAttribute_endBoundaryType.Match other = (EntityAttribute_endBoundaryType.Match) obj;
    ...
    @Override
    public EntityAttribute_endBoundaryType specification() {
      return EntityAttribute_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static EntityAttribute_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityAttribute_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityAttribute_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityAttribute_endBoundaryType.Match {
    ...
    private static final class Immutable extends EntityAttribute_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EntityAttribute_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EntityAttribute_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EntityAttribute_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityAttribute_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityAttribute_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EntityAttribute_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityAttribute_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityAttribute_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EntityAttribute_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public EntityAttribute_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return EntityAttribute_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EntityAttribute_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EntityAttribute_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityAttribute_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityAttribute_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EntityAttribute_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EntityAttribute_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityAttribute_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EntityAttribute_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityAttribute_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityAttribute_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityAttribute_endBoundaryType.Matcher> querySpecification() {
      return EntityAttribute_endBoundaryType.instance();
    }
  }
  
  private EntityAttribute_endBoundaryType() {
   ...
   * 
   */
  public static EntityAttribute_endBoundaryType instance() {
    try{
  ...
  @Override
  protected EntityAttribute_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityAttribute_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EntityAttribute_endBoundaryType.Matcher instantiate() {
    return EntityAttribute_endBoundaryType.Matcher.create();
  }
  
  @Override
  public EntityAttribute_endBoundaryType.Match newEmptyMatch() {
    return EntityAttribute_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EntityAttribute_endBoundaryType.Match newMatch(final Object... parameters) {
    return EntityAttribute_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityAttribute_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityAttribute_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityAttribute_endBoundaryType INSTANCE = new EntityAttribute_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityAttribute_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
