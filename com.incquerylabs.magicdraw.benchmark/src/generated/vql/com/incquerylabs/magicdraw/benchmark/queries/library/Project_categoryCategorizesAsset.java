...
public final class Project_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<Project_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Project_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public Project_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_categoryCategorizesAsset.Match)) {
          Project_categoryCategorizesAsset.Match other = (Project_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public Project_categoryCategorizesAsset specification() {
      return Project_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static Project_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Project_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Project_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends Project_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see Project_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<Project_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static Project_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<Project_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Project_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Project_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Project_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public Project_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Project_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Project_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Project_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Project_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Project_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected Project_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return Project_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Project_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return Project_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_categoryCategorizesAsset.Matcher> querySpecification() {
      return Project_categoryCategorizesAsset.instance();
    }
  }
  
  private Project_categoryCategorizesAsset() {
   ...
   * 
   */
  public static Project_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected Project_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public Project_categoryCategorizesAsset.Matcher instantiate() {
    return Project_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public Project_categoryCategorizesAsset.Match newEmptyMatch() {
    return Project_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public Project_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return Project_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_categoryCategorizesAsset INSTANCE = new Project_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
