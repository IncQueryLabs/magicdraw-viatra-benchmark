...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration;
...
public final class VersionOfConfiguration_actualPropertySet extends BaseGeneratedEMFQuerySpecification<VersionOfConfiguration_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionOfConfiguration_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public VersionOfConfiguration_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionOfConfiguration_actualPropertySet.Match)) {
          VersionOfConfiguration_actualPropertySet.Match other = (VersionOfConfiguration_actualPropertySet.Match) obj;
    ...
    @Override
    public VersionOfConfiguration_actualPropertySet specification() {
      return VersionOfConfiguration_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static VersionOfConfiguration_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionOfConfiguration_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static VersionOfConfiguration_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends VersionOfConfiguration_actualPropertySet.Match {
    ...
    private static final class Immutable extends VersionOfConfiguration_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see VersionOfConfiguration_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<VersionOfConfiguration_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static VersionOfConfiguration_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionOfConfiguration_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionOfConfiguration_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<VersionOfConfiguration_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<VersionOfConfiguration_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<VersionOfConfiguration_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super VersionOfConfiguration_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public VersionOfConfiguration_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return VersionOfConfiguration_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final VersionOfConfiguration_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final VersionOfConfiguration_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final VersionOfConfiguration_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final VersionOfConfiguration_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected VersionOfConfiguration_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return VersionOfConfiguration_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected VersionOfConfiguration_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return VersionOfConfiguration_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionOfConfiguration_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionOfConfiguration_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionOfConfiguration_actualPropertySet.Matcher> querySpecification() {
      return VersionOfConfiguration_actualPropertySet.instance();
    }
  }
  
  private VersionOfConfiguration_actualPropertySet() {
   ...
   * 
   */
  public static VersionOfConfiguration_actualPropertySet instance() {
    try{
  ...
  @Override
  protected VersionOfConfiguration_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionOfConfiguration_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public VersionOfConfiguration_actualPropertySet.Matcher instantiate() {
    return VersionOfConfiguration_actualPropertySet.Matcher.create();
  }
  
  @Override
  public VersionOfConfiguration_actualPropertySet.Match newEmptyMatch() {
    return VersionOfConfiguration_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public VersionOfConfiguration_actualPropertySet.Match newMatch(final Object... parameters) {
    return VersionOfConfiguration_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionOfConfiguration_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionOfConfiguration_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionOfConfiguration_actualPropertySet INSTANCE = new VersionOfConfiguration_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionOfConfiguration_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
