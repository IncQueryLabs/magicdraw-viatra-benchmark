...
public final class ActualPost extends BaseGeneratedEMFQuerySpecification<ActualPost.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPost pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualPost";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualPost.Match.parameterNames;
    }
    ...
    @Override
    public ActualPost.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualPost.Match)) {
          ActualPost.Match other = (ActualPost.Match) obj;
    ...
    @Override
    public ActualPost specification() {
      return ActualPost.instance();
    }
     ...
     * 
     */
    public static ActualPost.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualPost.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualPost.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualPost.Match {
    ...
    private static final class Immutable extends ActualPost.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPost pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualPost.Match> {
    /**
     ...
     * 
     */
    public static ActualPost.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualPost.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualPost.Matcher.class);
     ...
     * 
     */
    public Collection<ActualPost.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualPost.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualPost.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualPost.Match> processor) {
     ...
     * 
     */
    public ActualPost.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualPost.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualPost.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualPost.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualPost.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualPost.Match partialMatch) {
    ...
    @Override
    protected ActualPost.Match tupleToMatch(final Tuple t) {
      try {
          return ActualPost.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualPost.Match arrayToMatch(final Object[] match) {
      try {
          return ActualPost.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualPost.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualPost.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualPost.Matcher> querySpecification() {
      return ActualPost.instance();
    }
  }
   ...
   * 
   */
  public static ActualPost instance() {
    try{
  ...
  @Override
  protected ActualPost.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualPost.Matcher.on(engine);
  }
  
  @Override
  public ActualPost.Matcher instantiate() {
    return ActualPost.Matcher.create();
  }
  
  @Override
  public ActualPost.Match newEmptyMatch() {
    return ActualPost.Match.newEmptyMatch();
  }
  
  @Override
  public ActualPost.Match newMatch(final Object... parameters) {
    return ActualPost.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualPost} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualPost#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualPost INSTANCE = new ActualPost();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualPost.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualPost")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualPost");
