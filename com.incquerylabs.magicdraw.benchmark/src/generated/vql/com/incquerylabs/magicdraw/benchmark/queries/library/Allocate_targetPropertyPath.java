...
public final class Allocate_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Allocate_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Allocate_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Allocate_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Allocate_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Allocate_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Allocate_targetPropertyPath.Match)) {
          Allocate_targetPropertyPath.Match other = (Allocate_targetPropertyPath.Match) obj;
    ...
    @Override
    public Allocate_targetPropertyPath specification() {
     ...
     * 
     */
    public static Allocate_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Allocate_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Allocate_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Allocate_targetPropertyPath.Match {
    ...
    private static final class Immutable extends Allocate_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Allocate_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Allocate_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Allocate_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Allocate_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Allocate_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Allocate_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Allocate_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Allocate_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Allocate_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Allocate_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public Allocate_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Allocate_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfElement(final Allocate_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfElement(final Allocate_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfValue(final Allocate_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfValue(final Allocate_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected Allocate_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Allocate_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Allocate_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Allocate_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Allocate_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Allocate_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Allocate_targetPropertyPath.Matcher> querySpecification() {
      return Allocate_targetPropertyPath.instance();
    }
  }
  
  private Allocate_targetPropertyPath() {
   ...
   * 
   */
  public static Allocate_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected Allocate_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Allocate_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Allocate_targetPropertyPath.Matcher instantiate() {
    return Allocate_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public Allocate_targetPropertyPath.Match newEmptyMatch() {
    return Allocate_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Allocate_targetPropertyPath.Match newMatch(final Object... parameters) {
    return Allocate_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Allocate_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Allocate_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Allocate_targetPropertyPath INSTANCE = new Allocate_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Allocate_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Allocate(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), Allocate.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "targetPropertyPath", taggedValue)
