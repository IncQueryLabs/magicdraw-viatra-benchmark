...
public final class StructuralPart_conformsTo extends BaseGeneratedEMFQuerySpecification<StructuralPart_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return StructuralPart_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public StructuralPart_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StructuralPart_conformsTo.Match)) {
          StructuralPart_conformsTo.Match other = (StructuralPart_conformsTo.Match) obj;
    ...
    @Override
    public StructuralPart_conformsTo specification() {
      return StructuralPart_conformsTo.instance();
    }
     ...
     * 
     */
    public static StructuralPart_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static StructuralPart_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static StructuralPart_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends StructuralPart_conformsTo.Match {
    ...
    private static final class Immutable extends StructuralPart_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see StructuralPart_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<StructuralPart_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static StructuralPart_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StructuralPart_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StructuralPart_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<StructuralPart_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<StructuralPart_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<StructuralPart_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super StructuralPart_conformsTo.Match> processor) {
     ...
     * 
     */
    public StructuralPart_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return StructuralPart_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final StructuralPart_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final StructuralPart_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final StructuralPart_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final StructuralPart_conformsTo.Match partialMatch) {
    ...
    @Override
    protected StructuralPart_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return StructuralPart_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected StructuralPart_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return StructuralPart_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StructuralPart_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StructuralPart_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StructuralPart_conformsTo.Matcher> querySpecification() {
      return StructuralPart_conformsTo.instance();
    }
  }
  
  private StructuralPart_conformsTo() {
   ...
   * 
   */
  public static StructuralPart_conformsTo instance() {
    try{
  ...
  @Override
  protected StructuralPart_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return StructuralPart_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public StructuralPart_conformsTo.Matcher instantiate() {
    return StructuralPart_conformsTo.Matcher.create();
  }
  
  @Override
  public StructuralPart_conformsTo.Match newEmptyMatch() {
    return StructuralPart_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public StructuralPart_conformsTo.Match newMatch(final Object... parameters) {
    return StructuralPart_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StructuralPart_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StructuralPart_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StructuralPart_conformsTo INSTANCE = new StructuralPart_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StructuralPart_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
