...
public final class EnterpriseGoal_DerivedFrom extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_DerivedFrom.Match)) {
          EnterpriseGoal_DerivedFrom.Match other = (EnterpriseGoal_DerivedFrom.Match) obj;
    ...
    @Override
    public EnterpriseGoal_DerivedFrom specification() {
      return EnterpriseGoal_DerivedFrom.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_DerivedFrom.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseGoal_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseGoal_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseGoal_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseGoal_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_DerivedFrom.Matcher> querySpecification() {
      return EnterpriseGoal_DerivedFrom.instance();
    }
  }
  
  private EnterpriseGoal_DerivedFrom() {
   ...
   * 
   */
  public static EnterpriseGoal_DerivedFrom instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_DerivedFrom.Matcher instantiate() {
    return EnterpriseGoal_DerivedFrom.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_DerivedFrom.Match newEmptyMatch() {
    return EnterpriseGoal_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_DerivedFrom.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_DerivedFrom} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_DerivedFrom#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_DerivedFrom INSTANCE = new EnterpriseGoal_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
