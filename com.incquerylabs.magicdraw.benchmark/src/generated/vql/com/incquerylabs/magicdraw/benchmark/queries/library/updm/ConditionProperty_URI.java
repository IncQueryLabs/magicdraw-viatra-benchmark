...
public final class ConditionProperty_URI extends BaseGeneratedEMFQuerySpecification<ConditionProperty_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionProperty_URI.Match.parameterNames;
    }
    ...
    @Override
    public ConditionProperty_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionProperty_URI.Match)) {
          ConditionProperty_URI.Match other = (ConditionProperty_URI.Match) obj;
    ...
    @Override
    public ConditionProperty_URI specification() {
      return ConditionProperty_URI.instance();
    }
     ...
     * 
     */
    public static ConditionProperty_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionProperty_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ConditionProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ConditionProperty_URI.Match {
    ...
    private static final class Immutable extends ConditionProperty_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_URI pattern,
   ...
   * 
   * @see Match
   * @see ConditionProperty_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionProperty_URI.Match> {
    /**
     ...
     * 
     */
    public static ConditionProperty_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionProperty_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionProperty_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionProperty_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ConditionProperty_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ConditionProperty_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ConditionProperty_URI.Match> processor) {
     ...
     * 
     */
    public ConditionProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ConditionProperty_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConditionProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConditionProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ConditionProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ConditionProperty_URI.Match partialMatch) {
    ...
    @Override
    protected ConditionProperty_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionProperty_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ConditionProperty_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionProperty_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionProperty_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionProperty_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionProperty_URI.Matcher> querySpecification() {
      return ConditionProperty_URI.instance();
    }
  }
  
  private ConditionProperty_URI() {
   ...
   * 
   */
  public static ConditionProperty_URI instance() {
    try{
  ...
  @Override
  protected ConditionProperty_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionProperty_URI.Matcher.on(engine);
  }
  
  @Override
  public ConditionProperty_URI.Matcher instantiate() {
    return ConditionProperty_URI.Matcher.create();
  }
  
  @Override
  public ConditionProperty_URI.Match newEmptyMatch() {
    return ConditionProperty_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionProperty_URI.Match newMatch(final Object... parameters) {
    return ConditionProperty_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionProperty_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionProperty_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionProperty_URI INSTANCE = new ConditionProperty_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionProperty_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
