...
public final class DirectedFeature extends BaseGeneratedEMFQuerySpecification<DirectedFeature.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Feature pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static DirectedFeature.Match newMutableMatch(final Feature pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static DirectedFeature.Match newMatch(final Feature pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends DirectedFeature.Match {
      Mutable(final Feature pElement, final Stereotype pStereotype) {
    ...
    private static final class Immutable extends DirectedFeature.Match {
      Immutable(final Feature pElement, final Stereotype pStereotype) {
        super(pElement, pStereotype);
      }
  ...
  public static class Matcher extends BaseMatcher<DirectedFeature.Match> {
     ...
     * 
     */
    public Collection<DirectedFeature.Match> getAllMatches(final Feature pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<DirectedFeature.Match> streamAllMatches(final Feature pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<DirectedFeature.Match> getOneArbitraryMatch(final Feature pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean hasMatch(final Feature pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public int countMatches(final Feature pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Feature pElement, final Stereotype pStereotype, final Consumer<? super DirectedFeature.Match> processor) {
     ...
     * 
     */
    public DirectedFeature.Match newMatch(final Feature pElement, final Stereotype pStereotype) {
      return DirectedFeature.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Feature> streamAllValuesOfElement(final Stereotype pStereotype) {
     ...
     * 
     */
    public Set<Feature> getAllValuesOfElement(final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final DirectedFeature.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Feature pElement) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final DirectedFeature.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Feature pElement) {
    ...
    protected DirectedFeature.Match tupleToMatch(final Tuple t) {
      try {
          return DirectedFeature.Match.newMatch((Feature) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected DirectedFeature.Match arrayToMatch(final Object[] match) {
      try {
          return DirectedFeature.Match.newMatch((Feature) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected DirectedFeature.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DirectedFeature.Match.newMutableMatch((Feature) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public DirectedFeature.Match newMatch(final Object... parameters) {
    return DirectedFeature.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Feature) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
