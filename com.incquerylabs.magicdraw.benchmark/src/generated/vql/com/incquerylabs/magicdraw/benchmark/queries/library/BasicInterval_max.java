...
public final class BasicInterval_max extends BaseGeneratedEMFQuerySpecification<BasicInterval_max.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static BasicInterval_max.Match newMutableMatch(final Property pElement, final Double pValue) {
     ...
     * 
     */
    public static BasicInterval_max.Match newMatch(final Property pElement, final Double pValue) {
  ...
  public static class Matcher extends BaseMatcher<BasicInterval_max.Match> {
     ...
     * 
     */
    public Collection<BasicInterval_max.Match> getAllMatches(final Property pElement, final Double pValue) {
     ...
     * 
     */
    public Stream<BasicInterval_max.Match> streamAllMatches(final Property pElement, final Double pValue) {
     ...
     * 
     */
    public Optional<BasicInterval_max.Match> getOneArbitraryMatch(final Property pElement, final Double pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Double pValue, final Consumer<? super BasicInterval_max.Match> processor) {
     ...
     * 
     */
    public BasicInterval_max.Match newMatch(final Property pElement, final Double pValue) {
      return BasicInterval_max.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Double> streamAllValuesOfValue(final BasicInterval_max.Match partialMatch) {
     ...
     * 
     */
    public Set<Double> getAllValuesOfValue(final BasicInterval_max.Match partialMatch) {
    ...
    protected BasicInterval_max.Match tupleToMatch(final Tuple t) {
      try {
          return BasicInterval_max.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Double) t.get(POSITION_VALUE));
    ...
    protected BasicInterval_max.Match arrayToMatch(final Object[] match) {
      try {
          return BasicInterval_max.Match.newMatch((Property) match[POSITION_ELEMENT], (Double) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected BasicInterval_max.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BasicInterval_max.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Double) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public BasicInterval_max.Match newMatch(final Object... parameters) {
    return BasicInterval_max.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (java.lang.Double) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find BasicInterval(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), BasicInterval.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "max", taggedValue)
