...
public final class CapabilityProperty_startBoundaryType extends BaseGeneratedEMFQuerySpecification<CapabilityProperty_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty_startBoundaryType.Match)) {
          CapabilityProperty_startBoundaryType.Match other = (CapabilityProperty_startBoundaryType.Match) obj;
    ...
    @Override
    public CapabilityProperty_startBoundaryType specification() {
      return CapabilityProperty_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityProperty_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityProperty_startBoundaryType.Match {
    ...
    private static final class Immutable extends CapabilityProperty_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityProperty_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityProperty_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityProperty_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super CapabilityProperty_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return CapabilityProperty_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityProperty_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityProperty_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty_startBoundaryType.Matcher> querySpecification() {
      return CapabilityProperty_startBoundaryType.instance();
    }
  }
  
  private CapabilityProperty_startBoundaryType() {
   ...
   * 
   */
  public static CapabilityProperty_startBoundaryType instance() {
    try{
  ...
  @Override
  protected CapabilityProperty_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty_startBoundaryType.Matcher instantiate() {
    return CapabilityProperty_startBoundaryType.Matcher.create();
  }
  
  @Override
  public CapabilityProperty_startBoundaryType.Match newEmptyMatch() {
    return CapabilityProperty_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty_startBoundaryType.Match newMatch(final Object... parameters) {
    return CapabilityProperty_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty_startBoundaryType INSTANCE = new CapabilityProperty_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
