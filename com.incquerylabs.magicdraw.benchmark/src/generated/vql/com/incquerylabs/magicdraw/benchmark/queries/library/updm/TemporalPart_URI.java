...
public final class TemporalPart_URI extends BaseGeneratedEMFQuerySpecification<TemporalPart_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return TemporalPart_URI.Match.parameterNames;
    }
    ...
    @Override
    public TemporalPart_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TemporalPart_URI.Match)) {
          TemporalPart_URI.Match other = (TemporalPart_URI.Match) obj;
    ...
    @Override
    public TemporalPart_URI specification() {
      return TemporalPart_URI.instance();
    }
     ...
     * 
     */
    public static TemporalPart_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static TemporalPart_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static TemporalPart_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends TemporalPart_URI.Match {
    ...
    private static final class Immutable extends TemporalPart_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_URI pattern,
   ...
   * 
   * @see Match
   * @see TemporalPart_URI
   * 
   */
  public static class Matcher extends BaseMatcher<TemporalPart_URI.Match> {
    /**
     ...
     * 
     */
    public static TemporalPart_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TemporalPart_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TemporalPart_URI.Matcher.class);
     ...
     * 
     */
    public Collection<TemporalPart_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<TemporalPart_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<TemporalPart_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super TemporalPart_URI.Match> processor) {
     ...
     * 
     */
    public TemporalPart_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return TemporalPart_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TemporalPart_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TemporalPart_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final TemporalPart_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final TemporalPart_URI.Match partialMatch) {
    ...
    @Override
    protected TemporalPart_URI.Match tupleToMatch(final Tuple t) {
      try {
          return TemporalPart_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected TemporalPart_URI.Match arrayToMatch(final Object[] match) {
      try {
          return TemporalPart_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TemporalPart_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TemporalPart_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TemporalPart_URI.Matcher> querySpecification() {
      return TemporalPart_URI.instance();
    }
  }
  
  private TemporalPart_URI() {
   ...
   * 
   */
  public static TemporalPart_URI instance() {
    try{
  ...
  @Override
  protected TemporalPart_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return TemporalPart_URI.Matcher.on(engine);
  }
  
  @Override
  public TemporalPart_URI.Matcher instantiate() {
    return TemporalPart_URI.Matcher.create();
  }
  
  @Override
  public TemporalPart_URI.Match newEmptyMatch() {
    return TemporalPart_URI.Match.newEmptyMatch();
  }
  
  @Override
  public TemporalPart_URI.Match newMatch(final Object... parameters) {
    return TemporalPart_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TemporalPart_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TemporalPart_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TemporalPart_URI INSTANCE = new TemporalPart_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TemporalPart_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
