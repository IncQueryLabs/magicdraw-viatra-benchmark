...
public final class OperationalParameter extends BaseGeneratedEMFQuerySpecification<OperationalParameter.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalParameter pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalParameter";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalParameter.Match.parameterNames;
    }
    ...
    @Override
    public OperationalParameter.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalParameter.Match)) {
          OperationalParameter.Match other = (OperationalParameter.Match) obj;
    ...
    @Override
    public OperationalParameter specification() {
      return OperationalParameter.instance();
    }
     ...
     * 
     */
    public static OperationalParameter.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalParameter.Match newMutableMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalParameter.Match newMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalParameter.Match {
      Mutable(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    private static final class Immutable extends OperationalParameter.Match {
      Immutable(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
        super(pElement, pDomainStereotypeInstance);
      }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalParameter pattern,
   ...
   * 
   * @see Match
   * @see OperationalParameter
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalParameter.Match> {
    /**
     ...
     * 
     */
    public static OperationalParameter.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalParameter.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalParameter.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalParameter.Match> getAllMatches(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalParameter.Match> streamAllMatches(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalParameter.Match> getOneArbitraryMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean hasMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public int countMatches(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalParameter.Match> processor) {
     ...
     * 
     */
    public OperationalParameter.Match newMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalParameter.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Parameter> streamAllValuesOfelement(final OperationalParameter.Match partialMatch) {
     ...
     * 
     */
    public Stream<Parameter> streamAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Set<Parameter> getAllValuesOfelement(final OperationalParameter.Match partialMatch) {
     ...
     * 
     */
    public Set<Parameter> getAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalParameter.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Parameter pElement) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalParameter.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Parameter pElement) {
      return rawStreamAllValuesOfdomainStereotypeInstance(new Object[]{pElement, null}).collect(Collectors.toSet());
    }
    
    @Override
    protected OperationalParameter.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalParameter.Match.newMatch((Parameter) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalParameter.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalParameter.Match.newMatch((Parameter) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalParameter.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalParameter.Match.newMutableMatch((Parameter) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalParameter.Matcher> querySpecification() {
      return OperationalParameter.instance();
    }
  }
  
  private OperationalParameter() {
   ...
   * 
   */
  public static OperationalParameter instance() {
    try{
  ...
  @Override
  protected OperationalParameter.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalParameter.Matcher.on(engine);
  }
  
  @Override
  public OperationalParameter.Matcher instantiate() {
    return OperationalParameter.Matcher.create();
  }
  
  @Override
  public OperationalParameter.Match newEmptyMatch() {
    return OperationalParameter.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalParameter.Match newMatch(final Object... parameters) {
    return OperationalParameter.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalParameter} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalParameter#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalParameter INSTANCE = new OperationalParameter();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalParameter.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalParameter")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalParameter");
