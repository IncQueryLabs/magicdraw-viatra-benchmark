...
public final class EnterpriseGoal_VerifiedBy extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_VerifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_VerifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_VerifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_VerifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_VerifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_VerifiedBy.Match)) {
          EnterpriseGoal_VerifiedBy.Match other = (EnterpriseGoal_VerifiedBy.Match) obj;
    ...
    @Override
    public EnterpriseGoal_VerifiedBy specification() {
      return EnterpriseGoal_VerifiedBy.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_VerifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_VerifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_VerifiedBy.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_VerifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_VerifiedBy pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_VerifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_VerifiedBy.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_VerifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_VerifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_VerifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_VerifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_VerifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_VerifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super EnterpriseGoal_VerifiedBy.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return EnterpriseGoal_VerifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final EnterpriseGoal_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final EnterpriseGoal_VerifiedBy.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_VerifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_VerifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_VerifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_VerifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_VerifiedBy.Matcher> querySpecification() {
      return EnterpriseGoal_VerifiedBy.instance();
    }
  }
  
  private EnterpriseGoal_VerifiedBy() {
   ...
   * 
   */
  public static EnterpriseGoal_VerifiedBy instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_VerifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_VerifiedBy.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_VerifiedBy.Matcher instantiate() {
    return EnterpriseGoal_VerifiedBy.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_VerifiedBy.Match newEmptyMatch() {
    return EnterpriseGoal_VerifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_VerifiedBy.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_VerifiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_VerifiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_VerifiedBy INSTANCE = new EnterpriseGoal_VerifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_VerifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
