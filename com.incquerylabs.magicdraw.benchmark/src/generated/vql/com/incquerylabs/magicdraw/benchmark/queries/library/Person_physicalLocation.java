...
public final class Person_physicalLocation extends BaseGeneratedEMFQuerySpecification<Person_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Person_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Person_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_physicalLocation.Match)) {
          Person_physicalLocation.Match other = (Person_physicalLocation.Match) obj;
    ...
    @Override
    public Person_physicalLocation specification() {
      return Person_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Person_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Person_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Person_physicalLocation.Match {
    ...
    private static final class Immutable extends Person_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Person_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Person_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Person_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Person_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Person_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Person_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Person_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Person_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Person_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Person_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Person_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Person_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Person_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Person_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Person_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_physicalLocation.Matcher> querySpecification() {
      return Person_physicalLocation.instance();
    }
  }
  
  private Person_physicalLocation() {
   ...
   * 
   */
  public static Person_physicalLocation instance() {
    try{
  ...
  @Override
  protected Person_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Person_physicalLocation.Matcher instantiate() {
    return Person_physicalLocation.Matcher.create();
  }
  
  @Override
  public Person_physicalLocation.Match newEmptyMatch() {
    return Person_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Person_physicalLocation.Match newMatch(final Object... parameters) {
    return Person_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_physicalLocation INSTANCE = new Person_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
