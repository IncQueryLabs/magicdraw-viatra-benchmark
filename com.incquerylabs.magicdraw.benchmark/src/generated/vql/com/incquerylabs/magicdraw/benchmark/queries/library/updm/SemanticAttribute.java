...
public final class SemanticAttribute extends BaseGeneratedEMFQuerySpecification<SemanticAttribute.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SemanticAttribute pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SemanticAttribute";
    }
    
    @Override
    public List<String> parameterNames() {
      return SemanticAttribute.Match.parameterNames;
    }
    ...
    @Override
    public SemanticAttribute.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SemanticAttribute.Match)) {
          SemanticAttribute.Match other = (SemanticAttribute.Match) obj;
    ...
    @Override
    public SemanticAttribute specification() {
      return SemanticAttribute.instance();
    }
     ...
     * 
     */
    public static SemanticAttribute.Match newEmptyMatch() {
     ...
     * 
     */
    public static SemanticAttribute.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SemanticAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SemanticAttribute.Match {
    ...
    private static final class Immutable extends SemanticAttribute.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SemanticAttribute pattern,
   ...
   * 
   * @see Match
   * @see SemanticAttribute
   * 
   */
  public static class Matcher extends BaseMatcher<SemanticAttribute.Match> {
    /**
     ...
     * 
     */
    public static SemanticAttribute.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SemanticAttribute.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SemanticAttribute.Matcher.class);
     ...
     * 
     */
    public Collection<SemanticAttribute.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SemanticAttribute.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SemanticAttribute.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SemanticAttribute.Match> processor) {
     ...
     * 
     */
    public SemanticAttribute.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SemanticAttribute.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final SemanticAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final SemanticAttribute.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SemanticAttribute.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SemanticAttribute.Match partialMatch) {
    ...
    @Override
    protected SemanticAttribute.Match tupleToMatch(final Tuple t) {
      try {
          return SemanticAttribute.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SemanticAttribute.Match arrayToMatch(final Object[] match) {
      try {
          return SemanticAttribute.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SemanticAttribute.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SemanticAttribute.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SemanticAttribute.Matcher> querySpecification() {
      return SemanticAttribute.instance();
    }
  }
  
  private SemanticAttribute() {
   ...
   * 
   */
  public static SemanticAttribute instance() {
    try{
  ...
  @Override
  protected SemanticAttribute.Matcher instantiate(final ViatraQueryEngine engine) {
    return SemanticAttribute.Matcher.on(engine);
  }
  
  @Override
  public SemanticAttribute.Matcher instantiate() {
    return SemanticAttribute.Matcher.create();
  }
  
  @Override
  public SemanticAttribute.Match newEmptyMatch() {
    return SemanticAttribute.Match.newEmptyMatch();
  }
  
  @Override
  public SemanticAttribute.Match newMatch(final Object... parameters) {
    return SemanticAttribute.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SemanticAttribute} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SemanticAttribute#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SemanticAttribute INSTANCE = new SemanticAttribute();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SemanticAttribute.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "SemanticAttribute");
