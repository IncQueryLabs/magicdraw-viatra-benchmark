...
public final class Process extends BaseGeneratedEMFQuerySpecification<Process.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process";
    }
    
    @Override
    public List<String> parameterNames() {
      return Process.Match.parameterNames;
    }
    ...
    @Override
    public Process.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Process.Match)) {
          Process.Match other = (Process.Match) obj;
     ...
     * 
     */
    public static Process.Match newEmptyMatch() {
     ...
     * 
     */
    public static Process.Match newMutableMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Process.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Process.Match {
    ...
    private static final class Immutable extends Process.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Process pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Process.Match> {
    /**
     ...
     * 
     */
    public static Process.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Process.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Process.Matcher.class);
     ...
     * 
     */
    public Collection<Process.Match> getAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Process.Match> streamAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Process.Match> getOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Process.Match> processor) {
     ...
     * 
     */
    public Process.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Process.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Process.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Process.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Process.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Process.Match partialMatch) {
    ...
    @Override
    protected Process.Match tupleToMatch(final Tuple t) {
      try {
          return Process.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Process.Match arrayToMatch(final Object[] match) {
      try {
          return Process.Match.newMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Process.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Process.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Process.Matcher> querySpecification() {
      return Process.instance();
    }
  }
  ...
  @Override
  protected Process.Matcher instantiate(final ViatraQueryEngine engine) {
    return Process.Matcher.on(engine);
  }
  
  @Override
  public Process.Matcher instantiate() {
    return Process.Matcher.create();
  }
  
  @Override
  public Process.Match newEmptyMatch() {
    return Process.Match.newEmptyMatch();
  }
  
  @Override
  public Process.Match newMatch(final Object... parameters) {
    return Process.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Process} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Process#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Process INSTANCE = new Process();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Process.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Process");
