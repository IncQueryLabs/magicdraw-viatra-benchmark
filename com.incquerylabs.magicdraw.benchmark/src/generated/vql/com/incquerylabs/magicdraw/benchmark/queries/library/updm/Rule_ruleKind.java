...
public final class Rule_ruleKind extends BaseGeneratedEMFQuerySpecification<Rule_ruleKind.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_ruleKind pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Element pElement, final EnumerationLiteral pValue) {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_ruleKind";
    }
     ...
     * 
     */
    public static Rule_ruleKind.Match newMutableMatch(final Element pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public static Rule_ruleKind.Match newMatch(final Element pElement, final EnumerationLiteral pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Rule_ruleKind.Match {
      Mutable(final Element pElement, final EnumerationLiteral pValue) {
    ...
    private static final class Immutable extends Rule_ruleKind.Match {
      Immutable(final Element pElement, final EnumerationLiteral pValue) {
        super(pElement, pValue);
      }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_ruleKind pattern,
  ...
  public static class Matcher extends BaseMatcher<Rule_ruleKind.Match> {
     ...
     * 
     */
    public Collection<Rule_ruleKind.Match> getAllMatches(final Element pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public Stream<Rule_ruleKind.Match> streamAllMatches(final Element pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public Optional<Rule_ruleKind.Match> getOneArbitraryMatch(final Element pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public boolean hasMatch(final Element pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public int countMatches(final Element pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final EnumerationLiteral pValue, final Consumer<? super Rule_ruleKind.Match> processor) {
     ...
     * 
     */
    public Rule_ruleKind.Match newMatch(final Element pElement, final EnumerationLiteral pValue) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Rule_ruleKind.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final EnumerationLiteral pValue) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Rule_ruleKind.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final EnumerationLiteral pValue) {
     ...
     * 
     */
    public Stream<EnumerationLiteral> streamAllValuesOfvalue(final Element pElement) {
     ...
     * 
     */
    public Set<EnumerationLiteral> getAllValuesOfvalue(final Element pElement) {
    ...
    protected Rule_ruleKind.Match tupleToMatch(final Tuple t) {
      try {
          return Rule_ruleKind.Match.newMatch((Element) t.get(POSITION_ELEMENT), (EnumerationLiteral) t.get(POSITION_VALUE));
    ...
    protected Rule_ruleKind.Match arrayToMatch(final Object[] match) {
      try {
          return Rule_ruleKind.Match.newMatch((Element) match[POSITION_ELEMENT], (EnumerationLiteral) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Rule_ruleKind.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rule_ruleKind.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (EnumerationLiteral) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Rule_ruleKind.Match newMatch(final Object... parameters) {
    return Rule_ruleKind.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.EnumerationLiteral) parameters[1]);
  }
