...
public final class Technology_function extends BaseGeneratedEMFQuerySpecification<Technology_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Technology_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return Technology_function.Match.parameterNames;
    }
    ...
    @Override
    public Technology_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Technology_function.Match)) {
          Technology_function.Match other = (Technology_function.Match) obj;
    ...
    @Override
    public Technology_function specification() {
      return Technology_function.instance();
    }
     ...
     * 
     */
    public static Technology_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static Technology_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Technology_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Technology_function.Match {
    ...
    private static final class Immutable extends Technology_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_function pattern,
   ...
   * 
   * @see Match
   * @see Technology_function
   * 
   */
  public static class Matcher extends BaseMatcher<Technology_function.Match> {
    /**
     ...
     * 
     */
    public static Technology_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Technology_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Technology_function.Matcher.class);
     ...
     * 
     */
    public Collection<Technology_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Technology_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Technology_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Technology_function.Match> processor) {
     ...
     * 
     */
    public Technology_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Technology_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Technology_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Technology_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Technology_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Technology_function.Match partialMatch) {
    ...
    @Override
    protected Technology_function.Match tupleToMatch(final Tuple t) {
      try {
          return Technology_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Technology_function.Match arrayToMatch(final Object[] match) {
      try {
          return Technology_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Technology_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Technology_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Technology_function.Matcher> querySpecification() {
      return Technology_function.instance();
    }
  }
  
  private Technology_function() {
   ...
   * 
   */
  public static Technology_function instance() {
    try{
  ...
  @Override
  protected Technology_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return Technology_function.Matcher.on(engine);
  }
  
  @Override
  public Technology_function.Matcher instantiate() {
    return Technology_function.Matcher.create();
  }
  
  @Override
  public Technology_function.Match newEmptyMatch() {
    return Technology_function.Match.newEmptyMatch();
  }
  
  @Override
  public Technology_function.Match newMatch(final Object... parameters) {
    return Technology_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Technology_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Technology_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Technology_function INSTANCE = new Technology_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Technology_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
