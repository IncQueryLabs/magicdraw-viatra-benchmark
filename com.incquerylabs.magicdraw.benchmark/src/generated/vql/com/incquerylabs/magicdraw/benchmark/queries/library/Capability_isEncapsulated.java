...
import com.incquerylabs.magicdraw.benchmark.queries.library.Capability;
...
public final class Capability_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Capability_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Capability_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Capability_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Capability_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Capability_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Capability_isEncapsulated.Match)) {
          Capability_isEncapsulated.Match other = (Capability_isEncapsulated.Match) obj;
    ...
    @Override
    public Capability_isEncapsulated specification() {
      return Capability_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Capability_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Capability_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Capability_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Capability_isEncapsulated.Match {
    ...
    private static final class Immutable extends Capability_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Capability_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Capability_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Capability_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Capability_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Capability_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Capability_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Capability_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Capability_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Capability_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Capability_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Capability_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Capability_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Capability_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Capability_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Capability_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Capability_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Capability_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Capability_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Capability_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Capability_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Capability_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Capability_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Capability_isEncapsulated.Matcher> querySpecification() {
      return Capability_isEncapsulated.instance();
    }
  }
  
  private Capability_isEncapsulated() {
   ...
   * 
   */
  public static Capability_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Capability_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Capability_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Capability_isEncapsulated.Matcher instantiate() {
    return Capability_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Capability_isEncapsulated.Match newEmptyMatch() {
    return Capability_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Capability_isEncapsulated.Match newMatch(final Object... parameters) {
    return Capability_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Capability_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Capability_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Capability_isEncapsulated INSTANCE = new Capability_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Capability_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
