...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface;
...
public final class ServiceInterface_serviceInteraction extends BaseGeneratedEMFQuerySpecification<ServiceInterface_serviceInteraction.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_serviceInteraction pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_serviceInteraction";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInterface_serviceInteraction.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInterface_serviceInteraction.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInterface_serviceInteraction.Match)) {
          ServiceInterface_serviceInteraction.Match other = (ServiceInterface_serviceInteraction.Match) obj;
    ...
    @Override
    public ServiceInterface_serviceInteraction specification() {
      return ServiceInterface_serviceInteraction.instance();
    }
     ...
     * 
     */
    public static ServiceInterface_serviceInteraction.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInterface_serviceInteraction.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceInterface_serviceInteraction.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceInterface_serviceInteraction.Match {
    ...
    private static final class Immutable extends ServiceInterface_serviceInteraction.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_serviceInteraction pattern,
   ...
   * 
   * @see Match
   * @see ServiceInterface_serviceInteraction
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInterface_serviceInteraction.Match> {
    /**
     ...
     * 
     */
    public static ServiceInterface_serviceInteraction.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInterface_serviceInteraction.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInterface_serviceInteraction.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInterface_serviceInteraction.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceInterface_serviceInteraction.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceInterface_serviceInteraction.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceInterface_serviceInteraction.Match> processor) {
     ...
     * 
     */
    public ServiceInterface_serviceInteraction.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceInterface_serviceInteraction.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceInterface_serviceInteraction.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceInterface_serviceInteraction.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceInterface_serviceInteraction.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceInterface_serviceInteraction.Match partialMatch) {
    ...
    @Override
    protected ServiceInterface_serviceInteraction.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInterface_serviceInteraction.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceInterface_serviceInteraction.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInterface_serviceInteraction.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInterface_serviceInteraction.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInterface_serviceInteraction.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInterface_serviceInteraction.Matcher> querySpecification() {
      return ServiceInterface_serviceInteraction.instance();
    }
  }
  
  private ServiceInterface_serviceInteraction() {
   ...
   * 
   */
  public static ServiceInterface_serviceInteraction instance() {
    try{
  ...
  @Override
  protected ServiceInterface_serviceInteraction.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInterface_serviceInteraction.Matcher.on(engine);
  }
  
  @Override
  public ServiceInterface_serviceInteraction.Matcher instantiate() {
    return ServiceInterface_serviceInteraction.Matcher.create();
  }
  
  @Override
  public ServiceInterface_serviceInteraction.Match newEmptyMatch() {
    return ServiceInterface_serviceInteraction.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInterface_serviceInteraction.Match newMatch(final Object... parameters) {
    return ServiceInterface_serviceInteraction.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInterface_serviceInteraction} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInterface_serviceInteraction#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInterface_serviceInteraction INSTANCE = new ServiceInterface_serviceInteraction();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInterface_serviceInteraction.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ServiceInterface(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ServiceInterface.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "serviceInteraction", valuespec)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "serviceInteraction");
