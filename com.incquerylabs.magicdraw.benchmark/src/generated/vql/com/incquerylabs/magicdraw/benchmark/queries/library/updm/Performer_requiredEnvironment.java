...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer;
...
public final class Performer_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Performer_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Performer_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_requiredEnvironment.Match)) {
          Performer_requiredEnvironment.Match other = (Performer_requiredEnvironment.Match) obj;
    ...
    @Override
    public Performer_requiredEnvironment specification() {
      return Performer_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Performer_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Performer_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Performer_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Performer_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Performer_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Performer_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_requiredEnvironment.Matcher> querySpecification() {
      return Performer_requiredEnvironment.instance();
    }
  }
  
  private Performer_requiredEnvironment() {
   ...
   * 
   */
  public static Performer_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Performer_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Performer_requiredEnvironment.Matcher instantiate() {
    return Performer_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Performer_requiredEnvironment.Match newEmptyMatch() {
    return Performer_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Performer_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_requiredEnvironment INSTANCE = new Performer_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Performer(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Performer.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
