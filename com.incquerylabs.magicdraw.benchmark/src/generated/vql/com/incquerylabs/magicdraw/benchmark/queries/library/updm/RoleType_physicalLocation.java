...
public final class RoleType_physicalLocation extends BaseGeneratedEMFQuerySpecification<RoleType_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_physicalLocation.Match)) {
          RoleType_physicalLocation.Match other = (RoleType_physicalLocation.Match) obj;
    ...
    @Override
    public RoleType_physicalLocation specification() {
      return RoleType_physicalLocation.instance();
    }
     ...
     * 
     */
    public static RoleType_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_physicalLocation.Match {
    ...
    private static final class Immutable extends RoleType_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see RoleType_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static RoleType_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_physicalLocation.Match> processor) {
     ...
     * 
     */
    public RoleType_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected RoleType_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_physicalLocation.Matcher> querySpecification() {
      return RoleType_physicalLocation.instance();
    }
  }
  
  private RoleType_physicalLocation() {
   ...
   * 
   */
  public static RoleType_physicalLocation instance() {
    try{
  ...
  @Override
  protected RoleType_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public RoleType_physicalLocation.Matcher instantiate() {
    return RoleType_physicalLocation.Matcher.create();
  }
  
  @Override
  public RoleType_physicalLocation.Match newEmptyMatch() {
    return RoleType_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_physicalLocation.Match newMatch(final Object... parameters) {
    return RoleType_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_physicalLocation INSTANCE = new RoleType_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
