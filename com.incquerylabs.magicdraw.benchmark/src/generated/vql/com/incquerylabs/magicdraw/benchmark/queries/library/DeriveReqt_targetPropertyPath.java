...
public final class DeriveReqt_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<DeriveReqt_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DeriveReqt_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DeriveReqt_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return DeriveReqt_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public DeriveReqt_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DeriveReqt_targetPropertyPath.Match)) {
          DeriveReqt_targetPropertyPath.Match other = (DeriveReqt_targetPropertyPath.Match) obj;
    ...
    @Override
    public DeriveReqt_targetPropertyPath specification() {
     ...
     * 
     */
    public static DeriveReqt_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static DeriveReqt_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static DeriveReqt_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DeriveReqt_targetPropertyPath.Match {
    ...
    private static final class Immutable extends DeriveReqt_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DeriveReqt_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see DeriveReqt_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<DeriveReqt_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static DeriveReqt_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DeriveReqt_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DeriveReqt_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<DeriveReqt_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<DeriveReqt_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<DeriveReqt_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super DeriveReqt_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public DeriveReqt_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return DeriveReqt_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfElement(final DeriveReqt_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfElement(final DeriveReqt_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfValue(final DeriveReqt_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfValue(final DeriveReqt_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected DeriveReqt_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return DeriveReqt_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected DeriveReqt_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return DeriveReqt_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DeriveReqt_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeriveReqt_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DeriveReqt_targetPropertyPath.Matcher> querySpecification() {
      return DeriveReqt_targetPropertyPath.instance();
    }
  }
  
  private DeriveReqt_targetPropertyPath() {
   ...
   * 
   */
  public static DeriveReqt_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected DeriveReqt_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return DeriveReqt_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public DeriveReqt_targetPropertyPath.Matcher instantiate() {
    return DeriveReqt_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public DeriveReqt_targetPropertyPath.Match newEmptyMatch() {
    return DeriveReqt_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public DeriveReqt_targetPropertyPath.Match newMatch(final Object... parameters) {
    return DeriveReqt_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DeriveReqt_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DeriveReqt_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DeriveReqt_targetPropertyPath INSTANCE = new DeriveReqt_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DeriveReqt_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find DeriveReqt(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), DeriveReqt.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "targetPropertyPath", taggedValue)
