 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "additional_stereotypes", "Unit");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Unit extends BaseGeneratedEMFQuerySpecification<Unit.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Unit pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Unit";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Unit pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Unit} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Unit#instance()}.
   * 
