 ...
 *         pattern Unit(Element : PackageableElement, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "Unit");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Unit extends BaseGeneratedEMFQuerySpecification<Unit.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Unit.Match newMutableMatch(final PackageableElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Unit.Match newMatch(final PackageableElement pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<Unit.Match> {
     ...
     * 
     */
    public Collection<Unit.Match> getAllMatches(final PackageableElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Unit.Match> streamAllMatches(final PackageableElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Unit.Match> getOneArbitraryMatch(final PackageableElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final Stereotype pStereotype, final Consumer<? super Unit.Match> processor) {
     ...
     * 
     */
    public Unit.Match newMatch(final PackageableElement pElement, final Stereotype pStereotype) {
      return Unit.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Unit.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Unit.Match partialMatch) {
    ...
    protected Unit.Match tupleToMatch(final Tuple t) {
      try {
          return Unit.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected Unit.Match arrayToMatch(final Object[] match) {
      try {
          return Unit.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected Unit.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Unit.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Unit.Match newMatch(final Object... parameters) {
    return Unit.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
