...
public final class EnhancedSecurityControl_conformsTo extends BaseGeneratedEMFQuerySpecification<EnhancedSecurityControl_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnhancedSecurityControl_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public EnhancedSecurityControl_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnhancedSecurityControl_conformsTo.Match)) {
          EnhancedSecurityControl_conformsTo.Match other = (EnhancedSecurityControl_conformsTo.Match) obj;
    ...
    @Override
    public EnhancedSecurityControl_conformsTo specification() {
      return EnhancedSecurityControl_conformsTo.instance();
    }
     ...
     * 
     */
    public static EnhancedSecurityControl_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnhancedSecurityControl_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnhancedSecurityControl_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnhancedSecurityControl_conformsTo.Match {
    ...
    private static final class Immutable extends EnhancedSecurityControl_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see EnhancedSecurityControl_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<EnhancedSecurityControl_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static EnhancedSecurityControl_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnhancedSecurityControl_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnhancedSecurityControl_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<EnhancedSecurityControl_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnhancedSecurityControl_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnhancedSecurityControl_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnhancedSecurityControl_conformsTo.Match> processor) {
     ...
     * 
     */
    public EnhancedSecurityControl_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnhancedSecurityControl_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnhancedSecurityControl_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnhancedSecurityControl_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnhancedSecurityControl_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnhancedSecurityControl_conformsTo.Match partialMatch) {
    ...
    @Override
    protected EnhancedSecurityControl_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return EnhancedSecurityControl_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnhancedSecurityControl_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return EnhancedSecurityControl_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnhancedSecurityControl_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnhancedSecurityControl_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnhancedSecurityControl_conformsTo.Matcher> querySpecification() {
      return EnhancedSecurityControl_conformsTo.instance();
    }
  }
  
  private EnhancedSecurityControl_conformsTo() {
   ...
   * 
   */
  public static EnhancedSecurityControl_conformsTo instance() {
    try{
  ...
  @Override
  protected EnhancedSecurityControl_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnhancedSecurityControl_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public EnhancedSecurityControl_conformsTo.Matcher instantiate() {
    return EnhancedSecurityControl_conformsTo.Matcher.create();
  }
  
  @Override
  public EnhancedSecurityControl_conformsTo.Match newEmptyMatch() {
    return EnhancedSecurityControl_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public EnhancedSecurityControl_conformsTo.Match newMatch(final Object... parameters) {
    return EnhancedSecurityControl_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnhancedSecurityControl_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnhancedSecurityControl_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnhancedSecurityControl_conformsTo INSTANCE = new EnhancedSecurityControl_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnhancedSecurityControl_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
