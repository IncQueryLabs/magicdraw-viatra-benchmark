...
public final class ServiceAccess_conformsTo extends BaseGeneratedEMFQuerySpecification<ServiceAccess_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_conformsTo.Match)) {
          ServiceAccess_conformsTo.Match other = (ServiceAccess_conformsTo.Match) obj;
    ...
    @Override
    public ServiceAccess_conformsTo specification() {
      return ServiceAccess_conformsTo.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_conformsTo.Match {
    ...
    private static final class Immutable extends ServiceAccess_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_conformsTo.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_conformsTo.Matcher> querySpecification() {
      return ServiceAccess_conformsTo.instance();
    }
  }
  
  private ServiceAccess_conformsTo() {
   ...
   * 
   */
  public static ServiceAccess_conformsTo instance() {
    try{
  ...
  @Override
  protected ServiceAccess_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_conformsTo.Matcher instantiate() {
    return ServiceAccess_conformsTo.Matcher.create();
  }
  
  @Override
  public ServiceAccess_conformsTo.Match newEmptyMatch() {
    return ServiceAccess_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_conformsTo.Match newMatch(final Object... parameters) {
    return ServiceAccess_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_conformsTo INSTANCE = new ServiceAccess_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
