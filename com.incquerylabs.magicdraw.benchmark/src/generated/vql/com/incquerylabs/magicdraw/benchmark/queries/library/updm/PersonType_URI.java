...
public final class PersonType_URI extends BaseGeneratedEMFQuerySpecification<PersonType_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_URI.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_URI.Match)) {
          PersonType_URI.Match other = (PersonType_URI.Match) obj;
    ...
    @Override
    public PersonType_URI specification() {
      return PersonType_URI.instance();
    }
     ...
     * 
     */
    public static PersonType_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static PersonType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends PersonType_URI.Match {
    ...
    private static final class Immutable extends PersonType_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_URI.Match> {
    /**
     ...
     * 
     */
    public static PersonType_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_URI.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<PersonType_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<PersonType_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super PersonType_URI.Match> processor) {
     ...
     * 
     */
    public PersonType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return PersonType_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final PersonType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final PersonType_URI.Match partialMatch) {
    ...
    @Override
    protected PersonType_URI.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected PersonType_URI.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_URI.Matcher> querySpecification() {
      return PersonType_URI.instance();
    }
  }
  
  private PersonType_URI() {
   ...
   * 
   */
  public static PersonType_URI instance() {
    try{
  ...
  @Override
  protected PersonType_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_URI.Matcher.on(engine);
  }
  
  @Override
  public PersonType_URI.Matcher instantiate() {
    return PersonType_URI.Matcher.create();
  }
  
  @Override
  public PersonType_URI.Match newEmptyMatch() {
    return PersonType_URI.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_URI.Match newMatch(final Object... parameters) {
    return PersonType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_URI INSTANCE = new PersonType_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
