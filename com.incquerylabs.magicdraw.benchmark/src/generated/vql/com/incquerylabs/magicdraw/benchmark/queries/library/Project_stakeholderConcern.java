...
public final class Project_stakeholderConcern extends BaseGeneratedEMFQuerySpecification<Project_stakeholderConcern.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_stakeholderConcern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Project_stakeholderConcern";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_stakeholderConcern.Match.parameterNames;
    }
    ...
    @Override
    public Project_stakeholderConcern.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_stakeholderConcern.Match)) {
          Project_stakeholderConcern.Match other = (Project_stakeholderConcern.Match) obj;
    ...
    @Override
    public Project_stakeholderConcern specification() {
      return Project_stakeholderConcern.instance();
    }
     ...
     * 
     */
    public static Project_stakeholderConcern.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_stakeholderConcern.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Project_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Project_stakeholderConcern.Match {
    ...
    private static final class Immutable extends Project_stakeholderConcern.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_stakeholderConcern pattern,
   ...
   * 
   * @see Match
   * @see Project_stakeholderConcern
   * 
   */
  public static class Matcher extends BaseMatcher<Project_stakeholderConcern.Match> {
    /**
     ...
     * 
     */
    public static Project_stakeholderConcern.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_stakeholderConcern.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_stakeholderConcern.Matcher.class);
     ...
     * 
     */
    public Collection<Project_stakeholderConcern.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Project_stakeholderConcern.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Project_stakeholderConcern.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Project_stakeholderConcern.Match> processor) {
     ...
     * 
     */
    public Project_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Project_stakeholderConcern.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Project_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Project_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Project_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Project_stakeholderConcern.Match partialMatch) {
    ...
    @Override
    protected Project_stakeholderConcern.Match tupleToMatch(final Tuple t) {
      try {
          return Project_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Project_stakeholderConcern.Match arrayToMatch(final Object[] match) {
      try {
          return Project_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_stakeholderConcern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_stakeholderConcern.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_stakeholderConcern.Matcher> querySpecification() {
      return Project_stakeholderConcern.instance();
    }
  }
  
  private Project_stakeholderConcern() {
   ...
   * 
   */
  public static Project_stakeholderConcern instance() {
    try{
  ...
  @Override
  protected Project_stakeholderConcern.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_stakeholderConcern.Matcher.on(engine);
  }
  
  @Override
  public Project_stakeholderConcern.Matcher instantiate() {
    return Project_stakeholderConcern.Matcher.create();
  }
  
  @Override
  public Project_stakeholderConcern.Match newEmptyMatch() {
    return Project_stakeholderConcern.Match.newEmptyMatch();
  }
  
  @Override
  public Project_stakeholderConcern.Match newMatch(final Object... parameters) {
    return Project_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_stakeholderConcern} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_stakeholderConcern#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_stakeholderConcern INSTANCE = new Project_stakeholderConcern();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_stakeholderConcern.GeneratedPQuery INSTANCE = new GeneratedPQuery();
