...
public final class ServiceInterface_propertySet extends BaseGeneratedEMFQuerySpecification<ServiceInterface_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInterface_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInterface_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInterface_propertySet.Match)) {
          ServiceInterface_propertySet.Match other = (ServiceInterface_propertySet.Match) obj;
    ...
    @Override
    public ServiceInterface_propertySet specification() {
      return ServiceInterface_propertySet.instance();
    }
     ...
     * 
     */
    public static ServiceInterface_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInterface_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceInterface_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceInterface_propertySet.Match {
    ...
    private static final class Immutable extends ServiceInterface_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ServiceInterface_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInterface_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ServiceInterface_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInterface_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInterface_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInterface_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceInterface_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceInterface_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceInterface_propertySet.Match> processor) {
     ...
     * 
     */
    public ServiceInterface_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceInterface_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceInterface_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceInterface_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceInterface_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceInterface_propertySet.Match partialMatch) {
    ...
    @Override
    protected ServiceInterface_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInterface_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceInterface_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInterface_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInterface_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInterface_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInterface_propertySet.Matcher> querySpecification() {
      return ServiceInterface_propertySet.instance();
    }
  }
  
  private ServiceInterface_propertySet() {
   ...
   * 
   */
  public static ServiceInterface_propertySet instance() {
    try{
  ...
  @Override
  protected ServiceInterface_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInterface_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ServiceInterface_propertySet.Matcher instantiate() {
    return ServiceInterface_propertySet.Matcher.create();
  }
  
  @Override
  public ServiceInterface_propertySet.Match newEmptyMatch() {
    return ServiceInterface_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInterface_propertySet.Match newMatch(final Object... parameters) {
    return ServiceInterface_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInterface_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInterface_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInterface_propertySet INSTANCE = new ServiceInterface_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInterface_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
