...
public final class ServiceLevelValueSet extends BaseGeneratedEMFQuerySpecification<ServiceLevelValueSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValueSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValueSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceLevelValueSet.Match.parameterNames;
    }
    ...
    @Override
    public ServiceLevelValueSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceLevelValueSet.Match)) {
          ServiceLevelValueSet.Match other = (ServiceLevelValueSet.Match) obj;
    ...
    @Override
    public ServiceLevelValueSet specification() {
      return ServiceLevelValueSet.instance();
    }
     ...
     * 
     */
    public static ServiceLevelValueSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceLevelValueSet.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ServiceLevelValueSet.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ServiceLevelValueSet.Match {
    ...
    private static final class Immutable extends ServiceLevelValueSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValueSet pattern,
   ...
   * 
   * @see Match
   * @see ServiceLevelValueSet
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceLevelValueSet.Match> {
    /**
     ...
     * 
     */
    public static ServiceLevelValueSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceLevelValueSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceLevelValueSet.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceLevelValueSet.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ServiceLevelValueSet.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ServiceLevelValueSet.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ServiceLevelValueSet.Match> processor) {
     ...
     * 
     */
    public ServiceLevelValueSet.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ServiceLevelValueSet.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ServiceLevelValueSet.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ServiceLevelValueSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ServiceLevelValueSet.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ServiceLevelValueSet.Match partialMatch) {
    ...
    @Override
    protected ServiceLevelValueSet.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceLevelValueSet.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ServiceLevelValueSet.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceLevelValueSet.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceLevelValueSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceLevelValueSet.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceLevelValueSet.Matcher> querySpecification() {
      return ServiceLevelValueSet.instance();
    }
  }
  
  private ServiceLevelValueSet() {
   ...
   * 
   */
  public static ServiceLevelValueSet instance() {
    try{
  ...
  @Override
  protected ServiceLevelValueSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceLevelValueSet.Matcher.on(engine);
  }
  
  @Override
  public ServiceLevelValueSet.Matcher instantiate() {
    return ServiceLevelValueSet.Matcher.create();
  }
  
  @Override
  public ServiceLevelValueSet.Match newEmptyMatch() {
    return ServiceLevelValueSet.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceLevelValueSet.Match newMatch(final Object... parameters) {
    return ServiceLevelValueSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceLevelValueSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceLevelValueSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceLevelValueSet INSTANCE = new ServiceLevelValueSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceLevelValueSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ServiceLevelValueSet");
