...
public final class ExternalType_URI extends BaseGeneratedEMFQuerySpecification<ExternalType_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalType_URI.Match.parameterNames;
    }
    ...
    @Override
    public ExternalType_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalType_URI.Match)) {
          ExternalType_URI.Match other = (ExternalType_URI.Match) obj;
    ...
    @Override
    public ExternalType_URI specification() {
      return ExternalType_URI.instance();
    }
     ...
     * 
     */
    public static ExternalType_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalType_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ExternalType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ExternalType_URI.Match {
    ...
    private static final class Immutable extends ExternalType_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_URI pattern,
   ...
   * 
   * @see Match
   * @see ExternalType_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalType_URI.Match> {
    /**
     ...
     * 
     */
    public static ExternalType_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalType_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalType_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalType_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ExternalType_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ExternalType_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ExternalType_URI.Match> processor) {
     ...
     * 
     */
    public ExternalType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ExternalType_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalType_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ExternalType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ExternalType_URI.Match partialMatch) {
    ...
    @Override
    protected ExternalType_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ExternalType_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalType_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalType_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalType_URI.Matcher> querySpecification() {
      return ExternalType_URI.instance();
    }
  }
  
  private ExternalType_URI() {
   ...
   * 
   */
  public static ExternalType_URI instance() {
    try{
  ...
  @Override
  protected ExternalType_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalType_URI.Matcher.on(engine);
  }
  
  @Override
  public ExternalType_URI.Matcher instantiate() {
    return ExternalType_URI.Matcher.create();
  }
  
  @Override
  public ExternalType_URI.Match newEmptyMatch() {
    return ExternalType_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalType_URI.Match newMatch(final Object... parameters) {
    return ExternalType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalType_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalType_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalType_URI INSTANCE = new ExternalType_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalType_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
