 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "ProxyPort");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class ProxyPort extends BaseGeneratedEMFQuerySpecification<ProxyPort.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProxyPort pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProxyPort";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProxyPort pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link ProxyPort} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProxyPort#instance()}.
   * 
