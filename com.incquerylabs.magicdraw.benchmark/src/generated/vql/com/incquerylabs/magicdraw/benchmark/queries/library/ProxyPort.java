...
public final class ProxyPort extends BaseGeneratedEMFQuerySpecification<ProxyPort.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ProxyPort.Match newMutableMatch(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ProxyPort.Match newMatch(final Port pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<ProxyPort.Match> {
     ...
     * 
     */
    public Collection<ProxyPort.Match> getAllMatches(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ProxyPort.Match> streamAllMatches(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ProxyPort.Match> getOneArbitraryMatch(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final Stereotype pStereotype, final Consumer<? super ProxyPort.Match> processor) {
     ...
     * 
     */
    public ProxyPort.Match newMatch(final Port pElement, final Stereotype pStereotype) {
      return ProxyPort.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ProxyPort.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ProxyPort.Match partialMatch) {
    ...
    protected ProxyPort.Match tupleToMatch(final Tuple t) {
      try {
          return ProxyPort.Match.newMatch((Port) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ProxyPort.Match arrayToMatch(final Object[] match) {
      try {
          return ProxyPort.Match.newMatch((Port) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ProxyPort.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProxyPort.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ProxyPort.Match newMatch(final Object... parameters) {
    return ProxyPort.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
