...
public final class Vision_conformsTo extends BaseGeneratedEMFQuerySpecification<Vision_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Vision_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Vision_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Vision_conformsTo.Match)) {
          Vision_conformsTo.Match other = (Vision_conformsTo.Match) obj;
    ...
    @Override
    public Vision_conformsTo specification() {
      return Vision_conformsTo.instance();
    }
     ...
     * 
     */
    public static Vision_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Vision_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Vision_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Vision_conformsTo.Match {
    ...
    private static final class Immutable extends Vision_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Vision_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Vision_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Vision_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Vision_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Vision_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Vision_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Vision_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Vision_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Vision_conformsTo.Match> processor) {
     ...
     * 
     */
    public Vision_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Vision_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Vision_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Vision_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Vision_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Vision_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Vision_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Vision_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Vision_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Vision_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Vision_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Vision_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Vision_conformsTo.Matcher> querySpecification() {
      return Vision_conformsTo.instance();
    }
  }
  
  private Vision_conformsTo() {
   ...
   * 
   */
  public static Vision_conformsTo instance() {
    try{
  ...
  @Override
  protected Vision_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Vision_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Vision_conformsTo.Matcher instantiate() {
    return Vision_conformsTo.Matcher.create();
  }
  
  @Override
  public Vision_conformsTo.Match newEmptyMatch() {
    return Vision_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Vision_conformsTo.Match newMatch(final Object... parameters) {
    return Vision_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Vision_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Vision_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Vision_conformsTo INSTANCE = new Vision_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Vision_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
