...
public final class NodePort_URI extends BaseGeneratedEMFQuerySpecification<NodePort_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodePort_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodePort_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodePort_URI.Match.parameterNames;
    }
    ...
    @Override
    public NodePort_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodePort_URI.Match)) {
          NodePort_URI.Match other = (NodePort_URI.Match) obj;
    ...
    @Override
    public NodePort_URI specification() {
      return NodePort_URI.instance();
    }
     ...
     * 
     */
    public static NodePort_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodePort_URI.Match newMutableMatch(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static NodePort_URI.Match newMatch(final Port pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends NodePort_URI.Match {
    ...
    private static final class Immutable extends NodePort_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodePort_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<NodePort_URI.Match> {
    /**
     ...
     * 
     */
    public static NodePort_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodePort_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodePort_URI.Matcher.class);
     ...
     * 
     */
    public Collection<NodePort_URI.Match> getAllMatches(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<NodePort_URI.Match> streamAllMatches(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<NodePort_URI.Match> getOneArbitraryMatch(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final LiteralString pValuespec, final Consumer<? super NodePort_URI.Match> processor) {
     ...
     * 
     */
    public NodePort_URI.Match newMatch(final Port pElement, final LiteralString pValuespec) {
      return NodePort_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final NodePort_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final NodePort_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final NodePort_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final NodePort_URI.Match partialMatch) {
    ...
    @Override
    protected NodePort_URI.Match tupleToMatch(final Tuple t) {
      try {
          return NodePort_URI.Match.newMatch((Port) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected NodePort_URI.Match arrayToMatch(final Object[] match) {
      try {
          return NodePort_URI.Match.newMatch((Port) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodePort_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodePort_URI.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodePort_URI.Matcher> querySpecification() {
      return NodePort_URI.instance();
    }
  }
  
  private NodePort_URI() {
   ...
   * 
   */
  public static NodePort_URI instance() {
    try{
  ...
  @Override
  protected NodePort_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodePort_URI.Matcher.on(engine);
  }
  
  @Override
  public NodePort_URI.Matcher instantiate() {
    return NodePort_URI.Matcher.create();
  }
  
  @Override
  public NodePort_URI.Match newEmptyMatch() {
    return NodePort_URI.Match.newEmptyMatch();
  }
  
  @Override
  public NodePort_URI.Match newMatch(final Object... parameters) {
    return NodePort_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodePort_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodePort_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodePort_URI INSTANCE = new NodePort_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodePort_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
