...
public final class ResourceArtifact_conformsTo extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_conformsTo.Match)) {
          ResourceArtifact_conformsTo.Match other = (ResourceArtifact_conformsTo.Match) obj;
    ...
    @Override
    public ResourceArtifact_conformsTo specification() {
      return ResourceArtifact_conformsTo.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_conformsTo.Match {
    ...
    private static final class Immutable extends ResourceArtifact_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_conformsTo.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_conformsTo.Matcher> querySpecification() {
      return ResourceArtifact_conformsTo.instance();
    }
  }
  
  private ResourceArtifact_conformsTo() {
   ...
   * 
   */
  public static ResourceArtifact_conformsTo instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_conformsTo.Matcher instantiate() {
    return ResourceArtifact_conformsTo.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_conformsTo.Match newEmptyMatch() {
    return ResourceArtifact_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_conformsTo.Match newMatch(final Object... parameters) {
    return ResourceArtifact_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_conformsTo INSTANCE = new ResourceArtifact_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
