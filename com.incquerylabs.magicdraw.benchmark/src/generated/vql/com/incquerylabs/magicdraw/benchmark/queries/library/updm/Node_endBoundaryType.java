...
public final class Node_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Node_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Node_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_endBoundaryType.Match)) {
          Node_endBoundaryType.Match other = (Node_endBoundaryType.Match) obj;
    ...
    @Override
    public Node_endBoundaryType specification() {
      return Node_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Node_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Node_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_endBoundaryType.Match {
    ...
    private static final class Immutable extends Node_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Node_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Node_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Node_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Node_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Node_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Node_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Node_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Node_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Node_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Node_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Node_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Node_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Node_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Node_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_endBoundaryType.Matcher> querySpecification() {
      return Node_endBoundaryType.instance();
    }
  }
  
  private Node_endBoundaryType() {
   ...
   * 
   */
  public static Node_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Node_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Node_endBoundaryType.Matcher instantiate() {
    return Node_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Node_endBoundaryType.Match newEmptyMatch() {
    return Node_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Node_endBoundaryType.Match newMatch(final Object... parameters) {
    return Node_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_endBoundaryType INSTANCE = new Node_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
