...
public final class ProtocolStack_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ProtocolStack_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolStack_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolStack_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolStack_isEncapsulated.Match)) {
          ProtocolStack_isEncapsulated.Match other = (ProtocolStack_isEncapsulated.Match) obj;
    ...
    @Override
    public ProtocolStack_isEncapsulated specification() {
      return ProtocolStack_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static ProtocolStack_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolStack_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ProtocolStack_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProtocolStack_isEncapsulated.Match {
    ...
    private static final class Immutable extends ProtocolStack_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see ProtocolStack_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolStack_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static ProtocolStack_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolStack_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolStack_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolStack_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ProtocolStack_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ProtocolStack_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ProtocolStack_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ProtocolStack_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ProtocolStack_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProtocolStack_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProtocolStack_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ProtocolStack_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ProtocolStack_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected ProtocolStack_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolStack_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProtocolStack_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolStack_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolStack_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolStack_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolStack_isEncapsulated.Matcher> querySpecification() {
      return ProtocolStack_isEncapsulated.instance();
    }
  }
  
  private ProtocolStack_isEncapsulated() {
   ...
   * 
   */
  public static ProtocolStack_isEncapsulated instance() {
    try{
  ...
  @Override
  protected ProtocolStack_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolStack_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public ProtocolStack_isEncapsulated.Matcher instantiate() {
    return ProtocolStack_isEncapsulated.Matcher.create();
  }
  
  @Override
  public ProtocolStack_isEncapsulated.Match newEmptyMatch() {
    return ProtocolStack_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolStack_isEncapsulated.Match newMatch(final Object... parameters) {
    return ProtocolStack_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolStack_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolStack_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolStack_isEncapsulated INSTANCE = new ProtocolStack_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolStack_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
