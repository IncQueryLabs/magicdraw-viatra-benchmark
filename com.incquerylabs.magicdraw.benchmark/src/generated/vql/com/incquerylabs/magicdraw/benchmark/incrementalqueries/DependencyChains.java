...
public final class DependencyChains extends BaseGeneratedEMFQuerySpecification<DependencyChains.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.dependencyChains pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.dependencyChains";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.dependencyChains pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<DependencyChains.Match> {
    /**
     ...
     * 
     */
    public Collection<DependencyChains.Match> getAllMatches(final Dependency pSource, final Dependency pTarget) {
     ...
     * 
     */
    public Stream<DependencyChains.Match> streamAllMatches(final Dependency pSource, final Dependency pTarget) {
     ...
     * 
     */
    public Optional<DependencyChains.Match> getOneArbitraryMatch(final Dependency pSource, final Dependency pTarget) {
     ...
     * 
     */
    public Stream<Dependency> streamAllValuesOfsource(final DependencyChains.Match partialMatch) {
     ...
     * 
     */
    public Set<Dependency> getAllValuesOfsource(final DependencyChains.Match partialMatch) {
     ...
     * 
     */
    public Stream<Dependency> streamAllValuesOftarget(final DependencyChains.Match partialMatch) {
     ...
     * 
     */
    public Set<Dependency> getAllValuesOftarget(final DependencyChains.Match partialMatch) {
     ...
     * 
     */
    public static IQuerySpecification<DependencyChains.Matcher> querySpecification() {
      return DependencyChains.instance();
    }
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_source = new PParameter("source", "com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Dependency", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency")), PParameterDirection.INOUT);
    
    private final PParameter parameter_target = new PParameter("target", "com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Dependency", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_source), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency")));
          new TypeConstraint(body, Tuples.flatTupleOf(var_target), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_source, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency", "supplier")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_target, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency", "client")));
