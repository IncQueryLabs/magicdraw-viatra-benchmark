...
public final class CapabilityConfiguration_startBoundaryType extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_startBoundaryType.Match)) {
          CapabilityConfiguration_startBoundaryType.Match other = (CapabilityConfiguration_startBoundaryType.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_startBoundaryType specification() {
      return CapabilityConfiguration_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_startBoundaryType.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_startBoundaryType.Matcher> querySpecification() {
      return CapabilityConfiguration_startBoundaryType.instance();
    }
  }
  
  private CapabilityConfiguration_startBoundaryType() {
   ...
   * 
   */
  public static CapabilityConfiguration_startBoundaryType instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_startBoundaryType.Matcher instantiate() {
    return CapabilityConfiguration_startBoundaryType.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_startBoundaryType.Match newEmptyMatch() {
    return CapabilityConfiguration_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_startBoundaryType.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_startBoundaryType INSTANCE = new CapabilityConfiguration_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
