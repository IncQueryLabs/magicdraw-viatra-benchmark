...
public final class SecurityControl_Id extends BaseGeneratedEMFQuerySpecification<SecurityControl_Id.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Id pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Id";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_Id.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_Id.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_Id.Match)) {
          SecurityControl_Id.Match other = (SecurityControl_Id.Match) obj;
    ...
    @Override
    public SecurityControl_Id specification() {
      return SecurityControl_Id.instance();
    }
     ...
     * 
     */
    public static SecurityControl_Id.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_Id.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SecurityControl_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityControl_Id.Match {
    ...
    private static final class Immutable extends SecurityControl_Id.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Id pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_Id
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_Id.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_Id.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_Id.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_Id.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_Id.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SecurityControl_Id.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SecurityControl_Id.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super SecurityControl_Id.Match> processor) {
     ...
     * 
     */
    public SecurityControl_Id.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return SecurityControl_Id.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_Id.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SecurityControl_Id.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SecurityControl_Id.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_Id.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityControl_Id.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_Id.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_Id.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_Id.Matcher> querySpecification() {
      return SecurityControl_Id.instance();
    }
  }
  
  private SecurityControl_Id() {
   ...
   * 
   */
  public static SecurityControl_Id instance() {
    try{
  ...
  @Override
  protected SecurityControl_Id.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_Id.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_Id.Matcher instantiate() {
    return SecurityControl_Id.Matcher.create();
  }
  
  @Override
  public SecurityControl_Id.Match newEmptyMatch() {
    return SecurityControl_Id.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_Id.Match newMatch(final Object... parameters) {
    return SecurityControl_Id.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_Id} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_Id#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_Id INSTANCE = new SecurityControl_Id();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_Id.GeneratedPQuery INSTANCE = new GeneratedPQuery();
