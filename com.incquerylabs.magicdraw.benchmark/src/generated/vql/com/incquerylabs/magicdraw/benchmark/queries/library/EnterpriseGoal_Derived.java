...
public final class EnterpriseGoal_Derived extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_Derived.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_Derived.Match)) {
          EnterpriseGoal_Derived.Match other = (EnterpriseGoal_Derived.Match) obj;
    ...
    @Override
    public EnterpriseGoal_Derived specification() {
      return EnterpriseGoal_Derived.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_Derived.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Derived pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_Derived.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseGoal_Derived.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseGoal_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseGoal_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseGoal_Derived.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_Derived.Matcher> querySpecification() {
      return EnterpriseGoal_Derived.instance();
    }
  }
  
  private EnterpriseGoal_Derived() {
   ...
   * 
   */
  public static EnterpriseGoal_Derived instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_Derived.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_Derived.Matcher instantiate() {
    return EnterpriseGoal_Derived.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_Derived.Match newEmptyMatch() {
    return EnterpriseGoal_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_Derived.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_Derived INSTANCE = new EnterpriseGoal_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
