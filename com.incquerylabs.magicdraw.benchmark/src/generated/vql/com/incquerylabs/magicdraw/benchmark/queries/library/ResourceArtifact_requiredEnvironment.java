...
public final class ResourceArtifact_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_requiredEnvironment.Match)) {
          ResourceArtifact_requiredEnvironment.Match other = (ResourceArtifact_requiredEnvironment.Match) obj;
    ...
    @Override
    public ResourceArtifact_requiredEnvironment specification() {
      return ResourceArtifact_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_requiredEnvironment.Match {
    ...
    private static final class Immutable extends ResourceArtifact_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArtifact_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_requiredEnvironment.Matcher> querySpecification() {
      return ResourceArtifact_requiredEnvironment.instance();
    }
  }
  
  private ResourceArtifact_requiredEnvironment() {
   ...
   * 
   */
  public static ResourceArtifact_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_requiredEnvironment.Matcher instantiate() {
    return ResourceArtifact_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_requiredEnvironment.Match newEmptyMatch() {
    return ResourceArtifact_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_requiredEnvironment.Match newMatch(final Object... parameters) {
    return ResourceArtifact_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_requiredEnvironment INSTANCE = new ResourceArtifact_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
