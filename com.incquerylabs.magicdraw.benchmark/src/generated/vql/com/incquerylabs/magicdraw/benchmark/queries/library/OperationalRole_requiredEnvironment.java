...
public final class OperationalRole_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<OperationalRole_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalRole_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public OperationalRole_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalRole_requiredEnvironment.Match)) {
          OperationalRole_requiredEnvironment.Match other = (OperationalRole_requiredEnvironment.Match) obj;
    ...
    @Override
    public OperationalRole_requiredEnvironment specification() {
      return OperationalRole_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static OperationalRole_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalRole_requiredEnvironment.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalRole_requiredEnvironment.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalRole_requiredEnvironment.Match {
    ...
    private static final class Immutable extends OperationalRole_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see OperationalRole_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalRole_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static OperationalRole_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalRole_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalRole_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalRole_requiredEnvironment.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalRole_requiredEnvironment.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalRole_requiredEnvironment.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super OperationalRole_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public OperationalRole_requiredEnvironment.Match newMatch(final Property pElement, final Element pValue) {
      return OperationalRole_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalRole_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalRole_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalRole_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalRole_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected OperationalRole_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalRole_requiredEnvironment.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalRole_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalRole_requiredEnvironment.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalRole_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalRole_requiredEnvironment.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalRole_requiredEnvironment.Matcher> querySpecification() {
      return OperationalRole_requiredEnvironment.instance();
    }
  }
  
  private OperationalRole_requiredEnvironment() {
   ...
   * 
   */
  public static OperationalRole_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected OperationalRole_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalRole_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public OperationalRole_requiredEnvironment.Matcher instantiate() {
    return OperationalRole_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public OperationalRole_requiredEnvironment.Match newEmptyMatch() {
    return OperationalRole_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalRole_requiredEnvironment.Match newMatch(final Object... parameters) {
    return OperationalRole_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalRole_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalRole_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalRole_requiredEnvironment INSTANCE = new OperationalRole_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalRole_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
