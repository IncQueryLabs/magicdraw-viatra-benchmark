...
public final class ProjectType_propertySet extends BaseGeneratedEMFQuerySpecification<ProjectType_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectType_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectType_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectType_propertySet.Match)) {
          ProjectType_propertySet.Match other = (ProjectType_propertySet.Match) obj;
    ...
    @Override
    public ProjectType_propertySet specification() {
      return ProjectType_propertySet.instance();
    }
     ...
     * 
     */
    public static ProjectType_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectType_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectType_propertySet.Match {
    ...
    private static final class Immutable extends ProjectType_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectType_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectType_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectType_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectType_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectType_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectType_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectType_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectType_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectType_propertySet.Match> processor) {
     ...
     * 
     */
    public ProjectType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectType_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectType_propertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectType_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectType_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectType_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectType_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectType_propertySet.Matcher> querySpecification() {
      return ProjectType_propertySet.instance();
    }
  }
  
  private ProjectType_propertySet() {
   ...
   * 
   */
  public static ProjectType_propertySet instance() {
    try{
  ...
  @Override
  protected ProjectType_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectType_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectType_propertySet.Matcher instantiate() {
    return ProjectType_propertySet.Matcher.create();
  }
  
  @Override
  public ProjectType_propertySet.Match newEmptyMatch() {
    return ProjectType_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectType_propertySet.Match newMatch(final Object... parameters) {
    return ProjectType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectType_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectType_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectType_propertySet INSTANCE = new ProjectType_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectType_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
