...
public final class RoleType_milestone extends BaseGeneratedEMFQuerySpecification<RoleType_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_milestone.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_milestone.Match)) {
          RoleType_milestone.Match other = (RoleType_milestone.Match) obj;
    ...
    @Override
    public RoleType_milestone specification() {
      return RoleType_milestone.instance();
    }
     ...
     * 
     */
    public static RoleType_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_milestone.Match {
    ...
    private static final class Immutable extends RoleType_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_milestone pattern,
   ...
   * 
   * @see Match
   * @see RoleType_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_milestone.Match> {
    /**
     ...
     * 
     */
    public static RoleType_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_milestone.Match> processor) {
     ...
     * 
     */
    public RoleType_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_milestone.Match partialMatch) {
    ...
    @Override
    protected RoleType_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_milestone.Matcher> querySpecification() {
      return RoleType_milestone.instance();
    }
  }
  
  private RoleType_milestone() {
   ...
   * 
   */
  public static RoleType_milestone instance() {
    try{
  ...
  @Override
  protected RoleType_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_milestone.Matcher.on(engine);
  }
  
  @Override
  public RoleType_milestone.Matcher instantiate() {
    return RoleType_milestone.Matcher.create();
  }
  
  @Override
  public RoleType_milestone.Match newEmptyMatch() {
    return RoleType_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_milestone.Match newMatch(final Object... parameters) {
    return RoleType_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_milestone INSTANCE = new RoleType_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
