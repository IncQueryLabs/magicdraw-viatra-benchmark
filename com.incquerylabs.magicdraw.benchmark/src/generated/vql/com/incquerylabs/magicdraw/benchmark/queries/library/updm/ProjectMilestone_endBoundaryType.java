...
public final class ProjectMilestone_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectMilestone_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestone_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestone_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestone_endBoundaryType.Match)) {
          ProjectMilestone_endBoundaryType.Match other = (ProjectMilestone_endBoundaryType.Match) obj;
    ...
    @Override
    public ProjectMilestone_endBoundaryType specification() {
      return ProjectMilestone_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectMilestone_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestone_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestone_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestone_endBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectMilestone_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestone_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestone_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestone_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestone_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestone_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestone_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestone_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestone_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectMilestone_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectMilestone_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectMilestone_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectMilestone_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectMilestone_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestone_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestone_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestone_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestone_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestone_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestone_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestone_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestone_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestone_endBoundaryType.Matcher> querySpecification() {
      return ProjectMilestone_endBoundaryType.instance();
    }
  }
  
  private ProjectMilestone_endBoundaryType() {
   ...
   * 
   */
  public static ProjectMilestone_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectMilestone_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestone_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestone_endBoundaryType.Matcher instantiate() {
    return ProjectMilestone_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectMilestone_endBoundaryType.Match newEmptyMatch() {
    return ProjectMilestone_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestone_endBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectMilestone_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestone_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestone_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestone_endBoundaryType INSTANCE = new ProjectMilestone_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestone_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
