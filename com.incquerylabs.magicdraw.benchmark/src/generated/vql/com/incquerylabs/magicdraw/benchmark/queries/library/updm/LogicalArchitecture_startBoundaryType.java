...
public final class LogicalArchitecture_startBoundaryType extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_startBoundaryType.Match)) {
          LogicalArchitecture_startBoundaryType.Match other = (LogicalArchitecture_startBoundaryType.Match) obj;
    ...
    @Override
    public LogicalArchitecture_startBoundaryType specification() {
      return LogicalArchitecture_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static LogicalArchitecture_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends LogicalArchitecture_startBoundaryType.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super LogicalArchitecture_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return LogicalArchitecture_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final LogicalArchitecture_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final LogicalArchitecture_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected LogicalArchitecture_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_startBoundaryType.Matcher> querySpecification() {
      return LogicalArchitecture_startBoundaryType.instance();
    }
  }
  
  private LogicalArchitecture_startBoundaryType() {
   ...
   * 
   */
  public static LogicalArchitecture_startBoundaryType instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_startBoundaryType.Matcher instantiate() {
    return LogicalArchitecture_startBoundaryType.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_startBoundaryType.Match newEmptyMatch() {
    return LogicalArchitecture_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_startBoundaryType.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_startBoundaryType INSTANCE = new LogicalArchitecture_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
