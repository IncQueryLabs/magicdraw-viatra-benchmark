...
public final class System_propertySet extends BaseGeneratedEMFQuerySpecification<System_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public System_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_propertySet.Match)) {
          System_propertySet.Match other = (System_propertySet.Match) obj;
    ...
    @Override
    public System_propertySet specification() {
      return System_propertySet.instance();
    }
     ...
     * 
     */
    public static System_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_propertySet.Match {
    ...
    private static final class Immutable extends System_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_propertySet pattern,
   ...
   * 
   * @see Match
   * @see System_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<System_propertySet.Match> {
    /**
     ...
     * 
     */
    public static System_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<System_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_propertySet.Match> processor) {
     ...
     * 
     */
    public System_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_propertySet.Match partialMatch) {
    ...
    @Override
    protected System_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return System_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return System_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_propertySet.Matcher> querySpecification() {
      return System_propertySet.instance();
    }
  }
  
  private System_propertySet() {
   ...
   * 
   */
  public static System_propertySet instance() {
    try{
  ...
  @Override
  protected System_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_propertySet.Matcher.on(engine);
  }
  
  @Override
  public System_propertySet.Matcher instantiate() {
    return System_propertySet.Matcher.create();
  }
  
  @Override
  public System_propertySet.Match newEmptyMatch() {
    return System_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public System_propertySet.Match newMatch(final Object... parameters) {
    return System_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_propertySet INSTANCE = new System_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
