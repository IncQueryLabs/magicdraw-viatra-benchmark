...
public final class NodeRole_endBoundaryType extends BaseGeneratedEMFQuerySpecification<NodeRole_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeRole_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public NodeRole_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeRole_endBoundaryType.Match)) {
          NodeRole_endBoundaryType.Match other = (NodeRole_endBoundaryType.Match) obj;
    ...
    @Override
    public NodeRole_endBoundaryType specification() {
      return NodeRole_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static NodeRole_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeRole_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeRole_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeRole_endBoundaryType.Match {
    ...
    private static final class Immutable extends NodeRole_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see NodeRole_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<NodeRole_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static NodeRole_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeRole_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeRole_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<NodeRole_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeRole_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeRole_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super NodeRole_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public NodeRole_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return NodeRole_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final NodeRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final NodeRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeRole_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeRole_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected NodeRole_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return NodeRole_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeRole_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return NodeRole_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeRole_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeRole_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeRole_endBoundaryType.Matcher> querySpecification() {
      return NodeRole_endBoundaryType.instance();
    }
  }
  
  private NodeRole_endBoundaryType() {
   ...
   * 
   */
  public static NodeRole_endBoundaryType instance() {
    try{
  ...
  @Override
  protected NodeRole_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeRole_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public NodeRole_endBoundaryType.Matcher instantiate() {
    return NodeRole_endBoundaryType.Matcher.create();
  }
  
  @Override
  public NodeRole_endBoundaryType.Match newEmptyMatch() {
    return NodeRole_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public NodeRole_endBoundaryType.Match newMatch(final Object... parameters) {
    return NodeRole_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeRole_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeRole_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeRole_endBoundaryType INSTANCE = new NodeRole_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeRole_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
