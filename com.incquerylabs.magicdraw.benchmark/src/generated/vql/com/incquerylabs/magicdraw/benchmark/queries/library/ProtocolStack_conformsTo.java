...
import com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack;
...
public final class ProtocolStack_conformsTo extends BaseGeneratedEMFQuerySpecification<ProtocolStack_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolStack_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolStack_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolStack_conformsTo.Match)) {
          ProtocolStack_conformsTo.Match other = (ProtocolStack_conformsTo.Match) obj;
    ...
    @Override
    public ProtocolStack_conformsTo specification() {
      return ProtocolStack_conformsTo.instance();
    }
     ...
     * 
     */
    public static ProtocolStack_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolStack_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static ProtocolStack_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolStack_conformsTo.Match {
    ...
    private static final class Immutable extends ProtocolStack_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ProtocolStack_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolStack_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ProtocolStack_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolStack_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolStack_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolStack_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<ProtocolStack_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<ProtocolStack_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super ProtocolStack_conformsTo.Match> processor) {
     ...
     * 
     */
    public ProtocolStack_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return ProtocolStack_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProtocolStack_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProtocolStack_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfvalue(final ProtocolStack_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfvalue(final ProtocolStack_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ProtocolStack_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolStack_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolStack_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolStack_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolStack_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolStack_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolStack_conformsTo.Matcher> querySpecification() {
      return ProtocolStack_conformsTo.instance();
    }
  }
  
  private ProtocolStack_conformsTo() {
   ...
   * 
   */
  public static ProtocolStack_conformsTo instance() {
    try{
  ...
  @Override
  protected ProtocolStack_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolStack_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ProtocolStack_conformsTo.Matcher instantiate() {
    return ProtocolStack_conformsTo.Matcher.create();
  }
  
  @Override
  public ProtocolStack_conformsTo.Match newEmptyMatch() {
    return ProtocolStack_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolStack_conformsTo.Match newMatch(final Object... parameters) {
    return ProtocolStack_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolStack_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolStack_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolStack_conformsTo INSTANCE = new ProtocolStack_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolStack_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ProtocolStack(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ProtocolStack.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "conformsTo", valuespec)
