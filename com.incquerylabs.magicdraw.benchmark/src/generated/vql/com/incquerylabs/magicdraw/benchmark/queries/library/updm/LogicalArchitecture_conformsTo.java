...
public final class LogicalArchitecture_conformsTo extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_conformsTo.Match)) {
          LogicalArchitecture_conformsTo.Match other = (LogicalArchitecture_conformsTo.Match) obj;
    ...
    @Override
    public LogicalArchitecture_conformsTo specification() {
      return LogicalArchitecture_conformsTo.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static LogicalArchitecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends LogicalArchitecture_conformsTo.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super LogicalArchitecture_conformsTo.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return LogicalArchitecture_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final LogicalArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final LogicalArchitecture_conformsTo.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected LogicalArchitecture_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_conformsTo.Matcher> querySpecification() {
      return LogicalArchitecture_conformsTo.instance();
    }
  }
  
  private LogicalArchitecture_conformsTo() {
   ...
   * 
   */
  public static LogicalArchitecture_conformsTo instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_conformsTo.Matcher instantiate() {
    return LogicalArchitecture_conformsTo.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_conformsTo.Match newEmptyMatch() {
    return LogicalArchitecture_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_conformsTo.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_conformsTo INSTANCE = new LogicalArchitecture_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
