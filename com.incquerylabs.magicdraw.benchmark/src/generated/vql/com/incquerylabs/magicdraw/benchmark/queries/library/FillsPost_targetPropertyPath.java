...
public final class FillsPost_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<FillsPost_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return FillsPost_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public FillsPost_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FillsPost_targetPropertyPath.Match)) {
          FillsPost_targetPropertyPath.Match other = (FillsPost_targetPropertyPath.Match) obj;
    ...
    @Override
    public FillsPost_targetPropertyPath specification() {
      return FillsPost_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static FillsPost_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static FillsPost_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static FillsPost_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FillsPost_targetPropertyPath.Match {
    ...
    private static final class Immutable extends FillsPost_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see FillsPost_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<FillsPost_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static FillsPost_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FillsPost_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FillsPost_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<FillsPost_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<FillsPost_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<FillsPost_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super FillsPost_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public FillsPost_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return FillsPost_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final FillsPost_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final FillsPost_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final FillsPost_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final FillsPost_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected FillsPost_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return FillsPost_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected FillsPost_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return FillsPost_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FillsPost_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FillsPost_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FillsPost_targetPropertyPath.Matcher> querySpecification() {
      return FillsPost_targetPropertyPath.instance();
    }
  }
  
  private FillsPost_targetPropertyPath() {
   ...
   * 
   */
  public static FillsPost_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected FillsPost_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return FillsPost_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public FillsPost_targetPropertyPath.Matcher instantiate() {
    return FillsPost_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public FillsPost_targetPropertyPath.Match newEmptyMatch() {
    return FillsPost_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public FillsPost_targetPropertyPath.Match newMatch(final Object... parameters) {
    return FillsPost_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FillsPost_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FillsPost_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FillsPost_targetPropertyPath INSTANCE = new FillsPost_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FillsPost_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
