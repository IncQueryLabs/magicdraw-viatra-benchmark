...
public final class EnvironmentProperty_conformsTo extends BaseGeneratedEMFQuerySpecification<EnvironmentProperty_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnvironmentProperty_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public EnvironmentProperty_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnvironmentProperty_conformsTo.Match)) {
          EnvironmentProperty_conformsTo.Match other = (EnvironmentProperty_conformsTo.Match) obj;
    ...
    @Override
    public EnvironmentProperty_conformsTo specification() {
      return EnvironmentProperty_conformsTo.instance();
    }
     ...
     * 
     */
    public static EnvironmentProperty_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnvironmentProperty_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EnvironmentProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnvironmentProperty_conformsTo.Match {
    ...
    private static final class Immutable extends EnvironmentProperty_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see EnvironmentProperty_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<EnvironmentProperty_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static EnvironmentProperty_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnvironmentProperty_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnvironmentProperty_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<EnvironmentProperty_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnvironmentProperty_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnvironmentProperty_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EnvironmentProperty_conformsTo.Match> processor) {
     ...
     * 
     */
    public EnvironmentProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return EnvironmentProperty_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EnvironmentProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EnvironmentProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnvironmentProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnvironmentProperty_conformsTo.Match partialMatch) {
    ...
    @Override
    protected EnvironmentProperty_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return EnvironmentProperty_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnvironmentProperty_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return EnvironmentProperty_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnvironmentProperty_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnvironmentProperty_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnvironmentProperty_conformsTo.Matcher> querySpecification() {
      return EnvironmentProperty_conformsTo.instance();
    }
  }
  
  private EnvironmentProperty_conformsTo() {
   ...
   * 
   */
  public static EnvironmentProperty_conformsTo instance() {
    try{
  ...
  @Override
  protected EnvironmentProperty_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnvironmentProperty_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public EnvironmentProperty_conformsTo.Matcher instantiate() {
    return EnvironmentProperty_conformsTo.Matcher.create();
  }
  
  @Override
  public EnvironmentProperty_conformsTo.Match newEmptyMatch() {
    return EnvironmentProperty_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public EnvironmentProperty_conformsTo.Match newMatch(final Object... parameters) {
    return EnvironmentProperty_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnvironmentProperty_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnvironmentProperty_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnvironmentProperty_conformsTo INSTANCE = new EnvironmentProperty_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnvironmentProperty_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
