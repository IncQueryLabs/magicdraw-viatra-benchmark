...
public final class ResourceExchangeItem extends BaseGeneratedEMFQuerySpecification<ResourceExchangeItem.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceExchangeItem pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceExchangeItem";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceExchangeItem.Match.parameterNames;
    }
    ...
    @Override
    public ResourceExchangeItem.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceExchangeItem.Match)) {
          ResourceExchangeItem.Match other = (ResourceExchangeItem.Match) obj;
    ...
    @Override
    public ResourceExchangeItem specification() {
      return ResourceExchangeItem.instance();
    }
     ...
     * 
     */
    public static ResourceExchangeItem.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceExchangeItem.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResourceExchangeItem.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResourceExchangeItem.Match {
    ...
    private static final class Immutable extends ResourceExchangeItem.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceExchangeItem pattern,
   ...
   * 
   * @see Match
   * @see ResourceExchangeItem
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceExchangeItem.Match> {
    /**
     ...
     * 
     */
    public static ResourceExchangeItem.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceExchangeItem.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceExchangeItem.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceExchangeItem.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResourceExchangeItem.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResourceExchangeItem.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResourceExchangeItem.Match> processor) {
     ...
     * 
     */
    public ResourceExchangeItem.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResourceExchangeItem.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final ResourceExchangeItem.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final ResourceExchangeItem.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResourceExchangeItem.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResourceExchangeItem.Match partialMatch) {
    ...
    @Override
    protected ResourceExchangeItem.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceExchangeItem.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResourceExchangeItem.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceExchangeItem.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceExchangeItem.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceExchangeItem.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceExchangeItem.Matcher> querySpecification() {
      return ResourceExchangeItem.instance();
    }
  }
  
  private ResourceExchangeItem() {
   ...
   * 
   */
  public static ResourceExchangeItem instance() {
    try{
  ...
  @Override
  protected ResourceExchangeItem.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceExchangeItem.Matcher.on(engine);
  }
  
  @Override
  public ResourceExchangeItem.Matcher instantiate() {
    return ResourceExchangeItem.Matcher.create();
  }
  
  @Override
  public ResourceExchangeItem.Match newEmptyMatch() {
    return ResourceExchangeItem.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceExchangeItem.Match newMatch(final Object... parameters) {
    return ResourceExchangeItem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceExchangeItem} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceExchangeItem#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceExchangeItem INSTANCE = new ResourceExchangeItem();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceExchangeItem.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ResourceExchangeItem")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ResourceExchangeItem");
