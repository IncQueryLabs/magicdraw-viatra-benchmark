...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple;
...
public final class ExternalTuple_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ExternalTuple_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTuple_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTuple_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTuple_actualPropertySet.Match)) {
          ExternalTuple_actualPropertySet.Match other = (ExternalTuple_actualPropertySet.Match) obj;
    ...
    @Override
    public ExternalTuple_actualPropertySet specification() {
      return ExternalTuple_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ExternalTuple_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTuple_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTuple_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTuple_actualPropertySet.Match {
    ...
    private static final class Immutable extends ExternalTuple_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ExternalTuple_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTuple_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ExternalTuple_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTuple_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTuple_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTuple_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTuple_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTuple_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTuple_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ExternalTuple_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTuple_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTuple_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTuple_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTuple_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTuple_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ExternalTuple_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTuple_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTuple_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTuple_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTuple_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTuple_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTuple_actualPropertySet.Matcher> querySpecification() {
      return ExternalTuple_actualPropertySet.instance();
    }
  }
  
  private ExternalTuple_actualPropertySet() {
   ...
   * 
   */
  public static ExternalTuple_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ExternalTuple_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTuple_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ExternalTuple_actualPropertySet.Matcher instantiate() {
    return ExternalTuple_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ExternalTuple_actualPropertySet.Match newEmptyMatch() {
    return ExternalTuple_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTuple_actualPropertySet.Match newMatch(final Object... parameters) {
    return ExternalTuple_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTuple_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTuple_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTuple_actualPropertySet INSTANCE = new ExternalTuple_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTuple_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ExternalTuple(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ExternalTuple.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
