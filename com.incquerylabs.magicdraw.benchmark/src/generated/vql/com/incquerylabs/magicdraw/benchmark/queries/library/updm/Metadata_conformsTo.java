...
public final class Metadata_conformsTo extends BaseGeneratedEMFQuerySpecification<Metadata_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Metadata_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Metadata_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Metadata_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Metadata_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Metadata_conformsTo.Match)) {
          Metadata_conformsTo.Match other = (Metadata_conformsTo.Match) obj;
    ...
    @Override
    public Metadata_conformsTo specification() {
      return Metadata_conformsTo.instance();
    }
     ...
     * 
     */
    public static Metadata_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Metadata_conformsTo.Match newMutableMatch(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public static Metadata_conformsTo.Match newMatch(final Comment pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Metadata_conformsTo.Match {
    ...
    private static final class Immutable extends Metadata_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Metadata_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Metadata_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Metadata_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Metadata_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Metadata_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Metadata_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Metadata_conformsTo.Match> getAllMatches(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Metadata_conformsTo.Match> streamAllMatches(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Metadata_conformsTo.Match> getOneArbitraryMatch(final Comment pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final Element pValue, final Consumer<? super Metadata_conformsTo.Match> processor) {
     ...
     * 
     */
    public Metadata_conformsTo.Match newMatch(final Comment pElement, final Element pValue) {
      return Metadata_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Metadata_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Metadata_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Metadata_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Metadata_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Metadata_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Metadata_conformsTo.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Metadata_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Metadata_conformsTo.Match.newMatch((Comment) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Metadata_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Metadata_conformsTo.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Metadata_conformsTo.Matcher> querySpecification() {
      return Metadata_conformsTo.instance();
    }
  }
  
  private Metadata_conformsTo() {
   ...
   * 
   */
  public static Metadata_conformsTo instance() {
    try{
  ...
  @Override
  protected Metadata_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Metadata_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Metadata_conformsTo.Matcher instantiate() {
    return Metadata_conformsTo.Matcher.create();
  }
  
  @Override
  public Metadata_conformsTo.Match newEmptyMatch() {
    return Metadata_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Metadata_conformsTo.Match newMatch(final Object... parameters) {
    return Metadata_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Metadata_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Metadata_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Metadata_conformsTo INSTANCE = new Metadata_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Metadata_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
