...
public final class EnterpriseGoal_SatisfiedBy extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_SatisfiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_SatisfiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_SatisfiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_SatisfiedBy.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_SatisfiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_SatisfiedBy.Match)) {
          EnterpriseGoal_SatisfiedBy.Match other = (EnterpriseGoal_SatisfiedBy.Match) obj;
    ...
    @Override
    public EnterpriseGoal_SatisfiedBy specification() {
      return EnterpriseGoal_SatisfiedBy.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_SatisfiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_SatisfiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_SatisfiedBy.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_SatisfiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_SatisfiedBy pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_SatisfiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_SatisfiedBy.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_SatisfiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_SatisfiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_SatisfiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_SatisfiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_SatisfiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_SatisfiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super EnterpriseGoal_SatisfiedBy.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_SatisfiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return EnterpriseGoal_SatisfiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final EnterpriseGoal_SatisfiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final EnterpriseGoal_SatisfiedBy.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_SatisfiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_SatisfiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_SatisfiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_SatisfiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_SatisfiedBy.Matcher> querySpecification() {
      return EnterpriseGoal_SatisfiedBy.instance();
    }
  }
  
  private EnterpriseGoal_SatisfiedBy() {
   ...
   * 
   */
  public static EnterpriseGoal_SatisfiedBy instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_SatisfiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_SatisfiedBy.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_SatisfiedBy.Matcher instantiate() {
    return EnterpriseGoal_SatisfiedBy.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_SatisfiedBy.Match newEmptyMatch() {
    return EnterpriseGoal_SatisfiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_SatisfiedBy.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_SatisfiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_SatisfiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_SatisfiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_SatisfiedBy INSTANCE = new EnterpriseGoal_SatisfiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_SatisfiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
