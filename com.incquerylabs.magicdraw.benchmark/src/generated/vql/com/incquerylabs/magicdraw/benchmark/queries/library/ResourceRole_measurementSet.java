...
public final class ResourceRole_measurementSet extends BaseGeneratedEMFQuerySpecification<ResourceRole_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_measurementSet.Match)) {
          ResourceRole_measurementSet.Match other = (ResourceRole_measurementSet.Match) obj;
    ...
    @Override
    public ResourceRole_measurementSet specification() {
      return ResourceRole_measurementSet.instance();
    }
     ...
     * 
     */
    public static ResourceRole_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_measurementSet.Match {
    ...
    private static final class Immutable extends ResourceRole_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_measurementSet.Match> processor) {
     ...
     * 
     */
    public ResourceRole_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_measurementSet.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_measurementSet.Matcher> querySpecification() {
      return ResourceRole_measurementSet.instance();
    }
  }
  
  private ResourceRole_measurementSet() {
   ...
   * 
   */
  public static ResourceRole_measurementSet instance() {
    try{
  ...
  @Override
  protected ResourceRole_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_measurementSet.Matcher instantiate() {
    return ResourceRole_measurementSet.Matcher.create();
  }
  
  @Override
  public ResourceRole_measurementSet.Match newEmptyMatch() {
    return ResourceRole_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_measurementSet.Match newMatch(final Object... parameters) {
    return ResourceRole_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_measurementSet INSTANCE = new ResourceRole_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
