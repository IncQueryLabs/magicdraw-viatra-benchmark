...
public final class BusinessRequirement_Derived extends BaseGeneratedEMFQuerySpecification<BusinessRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.businessRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.businessRequirement_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return BusinessRequirement_Derived.Match.parameterNames;
    }
    ...
    @Override
    public BusinessRequirement_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BusinessRequirement_Derived.Match)) {
          BusinessRequirement_Derived.Match other = (BusinessRequirement_Derived.Match) obj;
    ...
    @Override
    public BusinessRequirement_Derived specification() {
     ...
     * 
     */
    public static BusinessRequirement_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static BusinessRequirement_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static BusinessRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends BusinessRequirement_Derived.Match {
    ...
    private static final class Immutable extends BusinessRequirement_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.businessRequirement_Derived pattern,
   ...
   * 
   * @see Match
   * @see BusinessRequirement_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<BusinessRequirement_Derived.Match> {
    /**
     ...
     * 
     */
    public static BusinessRequirement_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BusinessRequirement_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BusinessRequirement_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<BusinessRequirement_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<BusinessRequirement_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<BusinessRequirement_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super BusinessRequirement_Derived.Match> processor) {
     ...
     * 
     */
    public BusinessRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return BusinessRequirement_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final BusinessRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final BusinessRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final BusinessRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final BusinessRequirement_Derived.Match partialMatch) {
    ...
    @Override
    protected BusinessRequirement_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return BusinessRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected BusinessRequirement_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return BusinessRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BusinessRequirement_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BusinessRequirement_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BusinessRequirement_Derived.Matcher> querySpecification() {
      return BusinessRequirement_Derived.instance();
    }
  }
  
  private BusinessRequirement_Derived() {
   ...
   * 
   */
  public static BusinessRequirement_Derived instance() {
    try{
  ...
  @Override
  protected BusinessRequirement_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return BusinessRequirement_Derived.Matcher.on(engine);
  }
  
  @Override
  public BusinessRequirement_Derived.Matcher instantiate() {
    return BusinessRequirement_Derived.Matcher.create();
  }
  
  @Override
  public BusinessRequirement_Derived.Match newEmptyMatch() {
    return BusinessRequirement_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public BusinessRequirement_Derived.Match newMatch(final Object... parameters) {
    return BusinessRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link BusinessRequirement_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link BusinessRequirement_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BusinessRequirement_Derived INSTANCE = new BusinessRequirement_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BusinessRequirement_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
