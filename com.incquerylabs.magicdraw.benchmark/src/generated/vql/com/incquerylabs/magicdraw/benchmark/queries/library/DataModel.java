...
public final class DataModel extends BaseGeneratedEMFQuerySpecification<DataModel.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DataModel pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DataModel";
    }
    
    @Override
    public List<String> parameterNames() {
      return DataModel.Match.parameterNames;
    }
    ...
    @Override
    public DataModel.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DataModel.Match)) {
          DataModel.Match other = (DataModel.Match) obj;
    ...
    @Override
    public DataModel specification() {
     ...
     * 
     */
    public static DataModel.Match newEmptyMatch() {
     ...
     * 
     */
    public static DataModel.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static DataModel.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends DataModel.Match {
    ...
    private static final class Immutable extends DataModel.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DataModel pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<DataModel.Match> {
    /**
     ...
     * 
     */
    public static DataModel.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DataModel.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DataModel.Matcher.class);
     ...
     * 
     */
    public Collection<DataModel.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<DataModel.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<DataModel.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super DataModel.Match> processor) {
     ...
     * 
     */
    public DataModel.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return DataModel.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package> streamAllValuesOfelement(final DataModel.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package> getAllValuesOfelement(final DataModel.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final DataModel.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final DataModel.Match partialMatch) {
    ...
    @Override
    protected DataModel.Match tupleToMatch(final Tuple t) {
      try {
          return DataModel.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected DataModel.Match arrayToMatch(final Object[] match) {
      try {
          return DataModel.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DataModel.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DataModel.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DataModel.Matcher> querySpecification() {
      return DataModel.instance();
    }
  }
  ...
  @Override
  protected DataModel.Matcher instantiate(final ViatraQueryEngine engine) {
    return DataModel.Matcher.on(engine);
  }
  
  @Override
  public DataModel.Matcher instantiate() {
    return DataModel.Matcher.create();
  }
  
  @Override
  public DataModel.Match newEmptyMatch() {
    return DataModel.Match.newEmptyMatch();
  }
  
  @Override
  public DataModel.Match newMatch(final Object... parameters) {
    return DataModel.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataModel} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataModel#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DataModel.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "DataModel")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "DataModel");
