...
public final class RequiresCompetence_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<RequiresCompetence_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return RequiresCompetence_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public RequiresCompetence_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RequiresCompetence_sourcePropertyPath.Match)) {
          RequiresCompetence_sourcePropertyPath.Match other = (RequiresCompetence_sourcePropertyPath.Match) obj;
    ...
    @Override
    public RequiresCompetence_sourcePropertyPath specification() {
      return RequiresCompetence_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static RequiresCompetence_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static RequiresCompetence_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static RequiresCompetence_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RequiresCompetence_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends RequiresCompetence_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see RequiresCompetence_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<RequiresCompetence_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static RequiresCompetence_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RequiresCompetence_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RequiresCompetence_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<RequiresCompetence_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<RequiresCompetence_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<RequiresCompetence_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super RequiresCompetence_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public RequiresCompetence_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return RequiresCompetence_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final RequiresCompetence_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final RequiresCompetence_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final RequiresCompetence_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final RequiresCompetence_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected RequiresCompetence_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return RequiresCompetence_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected RequiresCompetence_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return RequiresCompetence_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RequiresCompetence_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RequiresCompetence_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RequiresCompetence_sourcePropertyPath.Matcher> querySpecification() {
      return RequiresCompetence_sourcePropertyPath.instance();
    }
  }
  
  private RequiresCompetence_sourcePropertyPath() {
   ...
   * 
   */
  public static RequiresCompetence_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected RequiresCompetence_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return RequiresCompetence_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public RequiresCompetence_sourcePropertyPath.Matcher instantiate() {
    return RequiresCompetence_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public RequiresCompetence_sourcePropertyPath.Match newEmptyMatch() {
    return RequiresCompetence_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public RequiresCompetence_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return RequiresCompetence_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RequiresCompetence_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RequiresCompetence_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RequiresCompetence_sourcePropertyPath INSTANCE = new RequiresCompetence_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RequiresCompetence_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
