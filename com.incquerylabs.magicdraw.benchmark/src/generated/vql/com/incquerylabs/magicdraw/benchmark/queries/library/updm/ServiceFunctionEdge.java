...
public final class ServiceFunctionEdge extends BaseGeneratedEMFQuerySpecification<ServiceFunctionEdge.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceFunctionEdge pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceFunctionEdge";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceFunctionEdge.Match.parameterNames;
    }
    ...
    @Override
    public ServiceFunctionEdge.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceFunctionEdge.Match)) {
          ServiceFunctionEdge.Match other = (ServiceFunctionEdge.Match) obj;
    ...
    @Override
    public ServiceFunctionEdge specification() {
      return ServiceFunctionEdge.instance();
    }
     ...
     * 
     */
    public static ServiceFunctionEdge.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceFunctionEdge.Match newMutableMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ServiceFunctionEdge.Match newMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ServiceFunctionEdge.Match {
    ...
    private static final class Immutable extends ServiceFunctionEdge.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceFunctionEdge pattern,
   ...
   * 
   * @see Match
   * @see ServiceFunctionEdge
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceFunctionEdge.Match> {
    /**
     ...
     * 
     */
    public static ServiceFunctionEdge.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceFunctionEdge.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceFunctionEdge.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceFunctionEdge.Match> getAllMatches(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ServiceFunctionEdge.Match> streamAllMatches(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ServiceFunctionEdge.Match> getOneArbitraryMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ServiceFunctionEdge.Match> processor) {
     ...
     * 
     */
    public ServiceFunctionEdge.Match newMatch(final ActivityEdge pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ServiceFunctionEdge.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<ActivityEdge> streamAllValuesOfelement(final ServiceFunctionEdge.Match partialMatch) {
     ...
     * 
     */
    public Set<ActivityEdge> getAllValuesOfelement(final ServiceFunctionEdge.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ServiceFunctionEdge.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ServiceFunctionEdge.Match partialMatch) {
    ...
    @Override
    protected ServiceFunctionEdge.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceFunctionEdge.Match.newMatch((ActivityEdge) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ServiceFunctionEdge.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceFunctionEdge.Match.newMatch((ActivityEdge) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceFunctionEdge.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceFunctionEdge.Match.newMutableMatch((ActivityEdge) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceFunctionEdge.Matcher> querySpecification() {
      return ServiceFunctionEdge.instance();
    }
  }
  
  private ServiceFunctionEdge() {
   ...
   * 
   */
  public static ServiceFunctionEdge instance() {
    try{
  ...
  @Override
  protected ServiceFunctionEdge.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceFunctionEdge.Matcher.on(engine);
  }
  
  @Override
  public ServiceFunctionEdge.Matcher instantiate() {
    return ServiceFunctionEdge.Matcher.create();
  }
  
  @Override
  public ServiceFunctionEdge.Match newEmptyMatch() {
    return ServiceFunctionEdge.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceFunctionEdge.Match newMatch(final Object... parameters) {
    return ServiceFunctionEdge.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ActivityEdge) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceFunctionEdge} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceFunctionEdge#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceFunctionEdge INSTANCE = new ServiceFunctionEdge();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceFunctionEdge.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ServiceFunctionEdge");
