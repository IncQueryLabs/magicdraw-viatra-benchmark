...
public final class DesignConstraint_Master extends BaseGeneratedEMFQuerySpecification<DesignConstraint_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint_Master.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint_Master.Match)) {
          DesignConstraint_Master.Match other = (DesignConstraint_Master.Match) obj;
    ...
    @Override
    public DesignConstraint_Master specification() {
     ...
     * 
     */
    public static DesignConstraint_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static DesignConstraint_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DesignConstraint_Master.Match {
    ...
    private static final class Immutable extends DesignConstraint_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_Master pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint_Master
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint_Master.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint_Master.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<DesignConstraint_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<DesignConstraint_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super DesignConstraint_Master.Match> processor) {
     ...
     * 
     */
    public DesignConstraint_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return DesignConstraint_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final DesignConstraint_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final DesignConstraint_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final DesignConstraint_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final DesignConstraint_Master.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint_Master.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected DesignConstraint_Master.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint_Master.Matcher> querySpecification() {
      return DesignConstraint_Master.instance();
    }
  }
  
  private DesignConstraint_Master() {
   ...
   * 
   */
  public static DesignConstraint_Master instance() {
    try{
  ...
  @Override
  protected DesignConstraint_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint_Master.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint_Master.Matcher instantiate() {
    return DesignConstraint_Master.Matcher.create();
  }
  
  @Override
  public DesignConstraint_Master.Match newEmptyMatch() {
    return DesignConstraint_Master.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint_Master.Match newMatch(final Object... parameters) {
    return DesignConstraint_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DesignConstraint_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DesignConstraint_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesignConstraint_Master INSTANCE = new DesignConstraint_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
