...
public final class DeployedMilestone extends BaseGeneratedEMFQuerySpecification<DeployedMilestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.DeployedMilestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.DeployedMilestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return DeployedMilestone.Match.parameterNames;
    }
    ...
    @Override
    public DeployedMilestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DeployedMilestone.Match)) {
          DeployedMilestone.Match other = (DeployedMilestone.Match) obj;
    ...
    @Override
    public DeployedMilestone specification() {
      return DeployedMilestone.instance();
    }
     ...
     * 
     */
    public static DeployedMilestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static DeployedMilestone.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static DeployedMilestone.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends DeployedMilestone.Match {
    ...
    private static final class Immutable extends DeployedMilestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.DeployedMilestone pattern,
   ...
   * 
   * @see Match
   * @see DeployedMilestone
   * 
   */
  public static class Matcher extends BaseMatcher<DeployedMilestone.Match> {
    /**
     ...
     * 
     */
    public static DeployedMilestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DeployedMilestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DeployedMilestone.Matcher.class);
     ...
     * 
     */
    public Collection<DeployedMilestone.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<DeployedMilestone.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<DeployedMilestone.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super DeployedMilestone.Match> processor) {
     ...
     * 
     */
    public DeployedMilestone.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return DeployedMilestone.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final DeployedMilestone.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final DeployedMilestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final DeployedMilestone.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final DeployedMilestone.Match partialMatch) {
    ...
    @Override
    protected DeployedMilestone.Match tupleToMatch(final Tuple t) {
      try {
          return DeployedMilestone.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected DeployedMilestone.Match arrayToMatch(final Object[] match) {
      try {
          return DeployedMilestone.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DeployedMilestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DeployedMilestone.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DeployedMilestone.Matcher> querySpecification() {
      return DeployedMilestone.instance();
    }
  }
  
  private DeployedMilestone() {
   ...
   * 
   */
  public static DeployedMilestone instance() {
    try{
  ...
  @Override
  protected DeployedMilestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return DeployedMilestone.Matcher.on(engine);
  }
  
  @Override
  public DeployedMilestone.Matcher instantiate() {
    return DeployedMilestone.Matcher.create();
  }
  
  @Override
  public DeployedMilestone.Match newEmptyMatch() {
    return DeployedMilestone.Match.newEmptyMatch();
  }
  
  @Override
  public DeployedMilestone.Match newMatch(final Object... parameters) {
    return DeployedMilestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DeployedMilestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DeployedMilestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DeployedMilestone INSTANCE = new DeployedMilestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DeployedMilestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "DeployedMilestone");
