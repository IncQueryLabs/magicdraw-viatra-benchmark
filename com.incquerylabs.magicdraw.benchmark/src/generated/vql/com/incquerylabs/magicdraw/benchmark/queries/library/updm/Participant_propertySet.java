...
public final class Participant_propertySet extends BaseGeneratedEMFQuerySpecification<Participant_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Participant_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_propertySet.Match)) {
          Participant_propertySet.Match other = (Participant_propertySet.Match) obj;
    ...
    @Override
    public Participant_propertySet specification() {
      return Participant_propertySet.instance();
    }
     ...
     * 
     */
    public static Participant_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Participant_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Participant_propertySet.Match {
    ...
    private static final class Immutable extends Participant_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Participant_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Participant_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Participant_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Participant_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Participant_propertySet.Match> processor) {
     ...
     * 
     */
    public Participant_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Participant_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Participant_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Participant_propertySet.Match partialMatch) {
    ...
    @Override
    protected Participant_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Participant_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_propertySet.Matcher> querySpecification() {
      return Participant_propertySet.instance();
    }
  }
  
  private Participant_propertySet() {
   ...
   * 
   */
  public static Participant_propertySet instance() {
    try{
  ...
  @Override
  protected Participant_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Participant_propertySet.Matcher instantiate() {
    return Participant_propertySet.Matcher.create();
  }
  
  @Override
  public Participant_propertySet.Match newEmptyMatch() {
    return Participant_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_propertySet.Match newMatch(final Object... parameters) {
    return Participant_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_propertySet INSTANCE = new Participant_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
