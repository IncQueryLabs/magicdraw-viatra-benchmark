...
public final class EnterprisePhase_goals extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_goals.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_goals pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_goals";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_goals.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_goals.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_goals.Match)) {
          EnterprisePhase_goals.Match other = (EnterprisePhase_goals.Match) obj;
    ...
    @Override
    public EnterprisePhase_goals specification() {
      return EnterprisePhase_goals.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_goals.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_goals.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static EnterprisePhase_goals.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_goals.Match {
    ...
    private static final class Immutable extends EnterprisePhase_goals.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_goals pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_goals
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_goals.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_goals.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_goals.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_goals.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_goals.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_goals.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_goals.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super EnterprisePhase_goals.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_goals.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return EnterprisePhase_goals.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_goals.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_goals.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfvalue(final EnterprisePhase_goals.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfvalue(final EnterprisePhase_goals.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_goals.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_goals.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_goals.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_goals.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_goals.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_goals.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_goals.Matcher> querySpecification() {
      return EnterprisePhase_goals.instance();
    }
  }
  
  private EnterprisePhase_goals() {
   ...
   * 
   */
  public static EnterprisePhase_goals instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_goals.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_goals.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_goals.Matcher instantiate() {
    return EnterprisePhase_goals.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_goals.Match newEmptyMatch() {
    return EnterprisePhase_goals.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_goals.Match newMatch(final Object... parameters) {
    return EnterprisePhase_goals.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_goals} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_goals#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_goals INSTANCE = new EnterprisePhase_goals();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_goals.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "goals");
