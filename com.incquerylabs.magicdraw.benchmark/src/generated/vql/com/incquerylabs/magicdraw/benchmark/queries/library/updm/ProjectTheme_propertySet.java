...
public final class ProjectTheme_propertySet extends BaseGeneratedEMFQuerySpecification<ProjectTheme_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectTheme_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectTheme_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectTheme_propertySet.Match)) {
          ProjectTheme_propertySet.Match other = (ProjectTheme_propertySet.Match) obj;
    ...
    @Override
    public ProjectTheme_propertySet specification() {
      return ProjectTheme_propertySet.instance();
    }
     ...
     * 
     */
    public static ProjectTheme_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectTheme_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectTheme_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectTheme_propertySet.Match {
    ...
    private static final class Immutable extends ProjectTheme_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectTheme_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectTheme_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectTheme_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectTheme_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectTheme_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectTheme_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectTheme_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectTheme_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectTheme_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectTheme_propertySet.Match> processor) {
     ...
     * 
     */
    public ProjectTheme_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectTheme_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectTheme_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectTheme_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectTheme_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectTheme_propertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectTheme_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectTheme_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectTheme_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectTheme_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectTheme_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectTheme_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectTheme_propertySet.Matcher> querySpecification() {
      return ProjectTheme_propertySet.instance();
    }
  }
  
  private ProjectTheme_propertySet() {
   ...
   * 
   */
  public static ProjectTheme_propertySet instance() {
    try{
  ...
  @Override
  protected ProjectTheme_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectTheme_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectTheme_propertySet.Matcher instantiate() {
    return ProjectTheme_propertySet.Matcher.create();
  }
  
  @Override
  public ProjectTheme_propertySet.Match newEmptyMatch() {
    return ProjectTheme_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectTheme_propertySet.Match newMatch(final Object... parameters) {
    return ProjectTheme_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectTheme_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectTheme_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectTheme_propertySet INSTANCE = new ProjectTheme_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectTheme_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
