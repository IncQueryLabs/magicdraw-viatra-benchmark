...
public final class ExchangeElement_appliesTo extends BaseGeneratedEMFQuerySpecification<ExchangeElement_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_appliesTo.Match)) {
          ExchangeElement_appliesTo.Match other = (ExchangeElement_appliesTo.Match) obj;
    ...
    @Override
    public ExchangeElement_appliesTo specification() {
      return ExchangeElement_appliesTo.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_appliesTo.Match {
    ...
    private static final class Immutable extends ExchangeElement_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_appliesTo.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_appliesTo.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_appliesTo.Matcher> querySpecification() {
      return ExchangeElement_appliesTo.instance();
    }
  }
  
  private ExchangeElement_appliesTo() {
   ...
   * 
   */
  public static ExchangeElement_appliesTo instance() {
    try{
  ...
  @Override
  protected ExchangeElement_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_appliesTo.Matcher instantiate() {
    return ExchangeElement_appliesTo.Matcher.create();
  }
  
  @Override
  public ExchangeElement_appliesTo.Match newEmptyMatch() {
    return ExchangeElement_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_appliesTo.Match newMatch(final Object... parameters) {
    return ExchangeElement_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_appliesTo INSTANCE = new ExchangeElement_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
