...
public final class ActualOrganizationRole_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ActualOrganizationRole_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualOrganizationRole_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ActualOrganizationRole_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualOrganizationRole_startBoundaryType.Match)) {
          ActualOrganizationRole_startBoundaryType.Match other = (ActualOrganizationRole_startBoundaryType.Match) obj;
    ...
    @Override
    public ActualOrganizationRole_startBoundaryType specification() {
      return ActualOrganizationRole_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ActualOrganizationRole_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualOrganizationRole_startBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualOrganizationRole_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualOrganizationRole_startBoundaryType.Match {
    ...
    private static final class Immutable extends ActualOrganizationRole_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualOrganizationRole_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ActualOrganizationRole_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ActualOrganizationRole_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ActualOrganizationRole_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualOrganizationRole_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualOrganizationRole_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ActualOrganizationRole_startBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualOrganizationRole_startBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualOrganizationRole_startBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualOrganizationRole_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ActualOrganizationRole_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualOrganizationRole_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualOrganizationRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualOrganizationRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualOrganizationRole_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualOrganizationRole_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ActualOrganizationRole_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ActualOrganizationRole_startBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualOrganizationRole_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ActualOrganizationRole_startBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualOrganizationRole_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualOrganizationRole_startBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualOrganizationRole_startBoundaryType.Matcher> querySpecification() {
      return ActualOrganizationRole_startBoundaryType.instance();
    }
  }
  
  private ActualOrganizationRole_startBoundaryType() {
   ...
   * 
   */
  public static ActualOrganizationRole_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ActualOrganizationRole_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualOrganizationRole_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ActualOrganizationRole_startBoundaryType.Matcher instantiate() {
    return ActualOrganizationRole_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ActualOrganizationRole_startBoundaryType.Match newEmptyMatch() {
    return ActualOrganizationRole_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ActualOrganizationRole_startBoundaryType.Match newMatch(final Object... parameters) {
    return ActualOrganizationRole_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualOrganizationRole_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualOrganizationRole_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualOrganizationRole_startBoundaryType INSTANCE = new ActualOrganizationRole_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualOrganizationRole_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
