...
public final class EntityAttribute_startBoundaryType extends BaseGeneratedEMFQuerySpecification<EntityAttribute_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityAttribute_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EntityAttribute_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityAttribute_startBoundaryType.Match)) {
          EntityAttribute_startBoundaryType.Match other = (EntityAttribute_startBoundaryType.Match) obj;
    ...
    @Override
    public EntityAttribute_startBoundaryType specification() {
      return EntityAttribute_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static EntityAttribute_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityAttribute_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityAttribute_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityAttribute_startBoundaryType.Match {
    ...
    private static final class Immutable extends EntityAttribute_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EntityAttribute_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EntityAttribute_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EntityAttribute_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityAttribute_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityAttribute_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EntityAttribute_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityAttribute_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityAttribute_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EntityAttribute_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public EntityAttribute_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return EntityAttribute_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EntityAttribute_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EntityAttribute_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityAttribute_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityAttribute_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EntityAttribute_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EntityAttribute_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityAttribute_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EntityAttribute_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityAttribute_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityAttribute_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityAttribute_startBoundaryType.Matcher> querySpecification() {
      return EntityAttribute_startBoundaryType.instance();
    }
  }
  
  private EntityAttribute_startBoundaryType() {
   ...
   * 
   */
  public static EntityAttribute_startBoundaryType instance() {
    try{
  ...
  @Override
  protected EntityAttribute_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityAttribute_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EntityAttribute_startBoundaryType.Matcher instantiate() {
    return EntityAttribute_startBoundaryType.Matcher.create();
  }
  
  @Override
  public EntityAttribute_startBoundaryType.Match newEmptyMatch() {
    return EntityAttribute_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EntityAttribute_startBoundaryType.Match newMatch(final Object... parameters) {
    return EntityAttribute_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityAttribute_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityAttribute_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityAttribute_startBoundaryType INSTANCE = new EntityAttribute_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityAttribute_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
