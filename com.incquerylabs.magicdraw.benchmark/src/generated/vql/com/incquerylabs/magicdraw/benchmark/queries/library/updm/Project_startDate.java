...
public final class Project_startDate extends BaseGeneratedEMFQuerySpecification<Project_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_startDate.Match.parameterNames;
    }
    ...
    @Override
    public Project_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_startDate.Match)) {
          Project_startDate.Match other = (Project_startDate.Match) obj;
    ...
    @Override
    public Project_startDate specification() {
      return Project_startDate.instance();
    }
     ...
     * 
     */
    public static Project_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_startDate.Match newMutableMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public static Project_startDate.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Project_startDate.Match {
    ...
    private static final class Immutable extends Project_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_startDate pattern,
   ...
   * 
   * @see Match
   * @see Project_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<Project_startDate.Match> {
    /**
     ...
     * 
     */
    public static Project_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<Project_startDate.Match> getAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Project_startDate.Match> streamAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Project_startDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue, final Consumer<? super Project_startDate.Match> processor) {
     ...
     * 
     */
    public Project_startDate.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return Project_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Project_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Project_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Project_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Project_startDate.Match partialMatch) {
    ...
    @Override
    protected Project_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return Project_startDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Project_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return Project_startDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_startDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_startDate.Matcher> querySpecification() {
      return Project_startDate.instance();
    }
  }
   ...
   * 
   */
  public static Project_startDate instance() {
    try{
  ...
  @Override
  protected Project_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_startDate.Matcher.on(engine);
  }
  
  @Override
  public Project_startDate.Matcher instantiate() {
    return Project_startDate.Matcher.create();
  }
  
  @Override
  public Project_startDate.Match newEmptyMatch() {
    return Project_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public Project_startDate.Match newMatch(final Object... parameters) {
    return Project_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_startDate INSTANCE = new Project_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
