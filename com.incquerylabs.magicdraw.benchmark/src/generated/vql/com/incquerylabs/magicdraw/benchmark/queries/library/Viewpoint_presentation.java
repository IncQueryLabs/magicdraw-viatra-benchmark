...
public final class Viewpoint_presentation extends BaseGeneratedEMFQuerySpecification<Viewpoint_presentation.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Viewpoint_presentation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public static Viewpoint_presentation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<Viewpoint_presentation.Match> {
     ...
     * 
     */
    public Collection<Viewpoint_presentation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Stream<Viewpoint_presentation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Optional<Viewpoint_presentation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue, final Consumer<? super Viewpoint_presentation.Match> processor) {
     ...
     * 
     */
    public Viewpoint_presentation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
      return Viewpoint_presentation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final Viewpoint_presentation.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final Viewpoint_presentation.Match partialMatch) {
    ...
    protected Viewpoint_presentation.Match tupleToMatch(final Tuple t) {
      try {
          return Viewpoint_presentation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected Viewpoint_presentation.Match arrayToMatch(final Object[] match) {
      try {
          return Viewpoint_presentation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Viewpoint_presentation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Viewpoint_presentation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Viewpoint_presentation.Match newMatch(final Object... parameters) {
    return Viewpoint_presentation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.String) parameters[1]);
  }
