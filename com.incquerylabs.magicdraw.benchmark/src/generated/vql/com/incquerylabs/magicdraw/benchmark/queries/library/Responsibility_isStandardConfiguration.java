...
import com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility;
...
public final class Responsibility_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<Responsibility_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_isStandardConfiguration.Match)) {
          Responsibility_isStandardConfiguration.Match other = (Responsibility_isStandardConfiguration.Match) obj;
    ...
    @Override
    public Responsibility_isStandardConfiguration specification() {
      return Responsibility_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static Responsibility_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Responsibility_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Responsibility_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends Responsibility_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Responsibility_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Responsibility_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Responsibility_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public Responsibility_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Responsibility_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Responsibility_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Responsibility_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected Responsibility_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Responsibility_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_isStandardConfiguration.Matcher> querySpecification() {
      return Responsibility_isStandardConfiguration.instance();
    }
  }
  
  private Responsibility_isStandardConfiguration() {
   ...
   * 
   */
  public static Responsibility_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected Responsibility_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_isStandardConfiguration.Matcher instantiate() {
    return Responsibility_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public Responsibility_isStandardConfiguration.Match newEmptyMatch() {
    return Responsibility_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return Responsibility_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_isStandardConfiguration INSTANCE = new Responsibility_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Responsibility(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Responsibility.instance().getInternalQueryRepresentation());
