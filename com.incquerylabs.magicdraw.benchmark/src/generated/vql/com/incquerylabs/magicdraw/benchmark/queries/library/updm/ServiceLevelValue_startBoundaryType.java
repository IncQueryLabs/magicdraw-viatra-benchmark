...
public final class ServiceLevelValue_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ServiceLevelValue_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceLevelValue_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ServiceLevelValue_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceLevelValue_startBoundaryType.Match)) {
          ServiceLevelValue_startBoundaryType.Match other = (ServiceLevelValue_startBoundaryType.Match) obj;
    ...
    @Override
    public ServiceLevelValue_startBoundaryType specification() {
      return ServiceLevelValue_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ServiceLevelValue_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceLevelValue_startBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceLevelValue_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceLevelValue_startBoundaryType.Match {
    ...
    private static final class Immutable extends ServiceLevelValue_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ServiceLevelValue_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceLevelValue_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ServiceLevelValue_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceLevelValue_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceLevelValue_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceLevelValue_startBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceLevelValue_startBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceLevelValue_startBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ServiceLevelValue_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ServiceLevelValue_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ServiceLevelValue_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ServiceLevelValue_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ServiceLevelValue_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceLevelValue_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceLevelValue_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ServiceLevelValue_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceLevelValue_startBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceLevelValue_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceLevelValue_startBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceLevelValue_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceLevelValue_startBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceLevelValue_startBoundaryType.Matcher> querySpecification() {
      return ServiceLevelValue_startBoundaryType.instance();
    }
  }
  
  private ServiceLevelValue_startBoundaryType() {
   ...
   * 
   */
  public static ServiceLevelValue_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ServiceLevelValue_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceLevelValue_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ServiceLevelValue_startBoundaryType.Matcher instantiate() {
    return ServiceLevelValue_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ServiceLevelValue_startBoundaryType.Match newEmptyMatch() {
    return ServiceLevelValue_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceLevelValue_startBoundaryType.Match newMatch(final Object... parameters) {
    return ServiceLevelValue_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceLevelValue_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceLevelValue_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceLevelValue_startBoundaryType INSTANCE = new ServiceLevelValue_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceLevelValue_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
