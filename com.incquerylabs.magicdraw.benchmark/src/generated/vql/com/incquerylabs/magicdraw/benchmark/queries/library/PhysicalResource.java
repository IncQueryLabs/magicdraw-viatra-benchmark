...
public final class PhysicalResource extends BaseGeneratedEMFQuerySpecification<PhysicalResource.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource.Match)) {
          PhysicalResource.Match other = (PhysicalResource.Match) obj;
    ...
    @Override
    public PhysicalResource specification() {
      return PhysicalResource.instance();
    }
     ...
     * 
     */
    public static PhysicalResource.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static PhysicalResource.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends PhysicalResource.Match {
    ...
    private static final class Immutable extends PhysicalResource.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<PhysicalResource.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<PhysicalResource.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super PhysicalResource.Match> processor) {
     ...
     * 
     */
    public PhysicalResource.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return PhysicalResource.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final PhysicalResource.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final PhysicalResource.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected PhysicalResource.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource.Matcher> querySpecification() {
      return PhysicalResource.instance();
    }
  }
   ...
   * 
   */
  public static PhysicalResource instance() {
    try{
  ...
  @Override
  protected PhysicalResource.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource.Matcher instantiate() {
    return PhysicalResource.Matcher.create();
  }
  
  @Override
  public PhysicalResource.Match newEmptyMatch() {
    return PhysicalResource.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource.Match newMatch(final Object... parameters) {
    return PhysicalResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource INSTANCE = new PhysicalResource();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "PhysicalResource")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "PhysicalResource");
