...
public final class Provider extends BaseGeneratedEMFQuerySpecification<Provider.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Provider pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Provider";
    }
    
    @Override
    public List<String> parameterNames() {
      return Provider.Match.parameterNames;
    }
    ...
    @Override
    public Provider.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Provider.Match)) {
          Provider.Match other = (Provider.Match) obj;
     ...
     * 
     */
    public static Provider.Match newEmptyMatch() {
     ...
     * 
     */
    public static Provider.Match newMutableMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Provider.Match newMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Provider.Match {
    ...
    private static final class Immutable extends Provider.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Provider pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Provider.Match> {
    /**
     ...
     * 
     */
    public static Provider.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Provider.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Provider.Matcher.class);
     ...
     * 
     */
    public Collection<Provider.Match> getAllMatches(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Provider.Match> streamAllMatches(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Provider.Match> getOneArbitraryMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Provider.Match> processor) {
     ...
     * 
     */
    public Provider.Match newMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Provider.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfelement(final Provider.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfelement(final Provider.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Provider.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Provider.Match partialMatch) {
    ...
    @Override
    protected Provider.Match tupleToMatch(final Tuple t) {
      try {
          return Provider.Match.newMatch((Classifier) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Provider.Match arrayToMatch(final Object[] match) {
      try {
          return Provider.Match.newMatch((Classifier) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Provider.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Provider.Match.newMutableMatch((Classifier) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Provider.Matcher> querySpecification() {
      return Provider.instance();
    }
  }
  ...
  @Override
  protected Provider.Matcher instantiate(final ViatraQueryEngine engine) {
    return Provider.Matcher.on(engine);
  }
  
  @Override
  public Provider.Matcher instantiate() {
    return Provider.Matcher.create();
  }
  
  @Override
  public Provider.Match newEmptyMatch() {
    return Provider.Match.newEmptyMatch();
  }
  
  @Override
  public Provider.Match newMatch(final Object... parameters) {
    return Provider.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Provider} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Provider#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Provider.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Provider");
