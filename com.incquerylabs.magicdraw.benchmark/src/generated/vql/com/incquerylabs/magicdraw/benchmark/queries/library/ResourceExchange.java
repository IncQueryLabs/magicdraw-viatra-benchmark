...
public final class ResourceExchange extends BaseGeneratedEMFQuerySpecification<ResourceExchange.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceExchange pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceExchange";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceExchange.Match.parameterNames;
    }
    ...
    @Override
    public ResourceExchange.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceExchange.Match)) {
          ResourceExchange.Match other = (ResourceExchange.Match) obj;
    ...
    @Override
    public ResourceExchange specification() {
      return ResourceExchange.instance();
    }
     ...
     * 
     */
    public static ResourceExchange.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceExchange.Match newMutableMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResourceExchange.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResourceExchange.Match {
    ...
    private static final class Immutable extends ResourceExchange.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceExchange pattern,
   ...
   * 
   * @see Match
   * @see ResourceExchange
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceExchange.Match> {
    /**
     ...
     * 
     */
    public static ResourceExchange.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceExchange.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceExchange.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceExchange.Match> getAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResourceExchange.Match> streamAllMatches(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResourceExchange.Match> getOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResourceExchange.Match> processor) {
     ...
     * 
     */
    public ResourceExchange.Match newMatch(final InformationFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResourceExchange.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final ResourceExchange.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final ResourceExchange.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResourceExchange.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResourceExchange.Match partialMatch) {
    ...
    @Override
    protected ResourceExchange.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceExchange.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResourceExchange.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceExchange.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceExchange.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceExchange.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceExchange.Matcher> querySpecification() {
      return ResourceExchange.instance();
    }
  }
   ...
   * 
   */
  public static ResourceExchange instance() {
    try{
  ...
  @Override
  protected ResourceExchange.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceExchange.Matcher.on(engine);
  }
  
  @Override
  public ResourceExchange.Matcher instantiate() {
    return ResourceExchange.Matcher.create();
  }
  
  @Override
  public ResourceExchange.Match newEmptyMatch() {
    return ResourceExchange.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceExchange.Match newMatch(final Object... parameters) {
    return ResourceExchange.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceExchange} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceExchange#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceExchange INSTANCE = new ResourceExchange();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceExchange.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ResourceExchange")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ResourceExchange");
