...
public final class Responsibility_physicalLocation extends BaseGeneratedEMFQuerySpecification<Responsibility_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_physicalLocation.Match)) {
          Responsibility_physicalLocation.Match other = (Responsibility_physicalLocation.Match) obj;
    ...
    @Override
    public Responsibility_physicalLocation specification() {
      return Responsibility_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Responsibility_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_physicalLocation.Match {
    ...
    private static final class Immutable extends Responsibility_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Responsibility_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Responsibility_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_physicalLocation.Matcher> querySpecification() {
      return Responsibility_physicalLocation.instance();
    }
  }
  
  private Responsibility_physicalLocation() {
   ...
   * 
   */
  public static Responsibility_physicalLocation instance() {
    try{
  ...
  @Override
  protected Responsibility_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_physicalLocation.Matcher instantiate() {
    return Responsibility_physicalLocation.Matcher.create();
  }
  
  @Override
  public Responsibility_physicalLocation.Match newEmptyMatch() {
    return Responsibility_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_physicalLocation.Match newMatch(final Object... parameters) {
    return Responsibility_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_physicalLocation INSTANCE = new Responsibility_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
