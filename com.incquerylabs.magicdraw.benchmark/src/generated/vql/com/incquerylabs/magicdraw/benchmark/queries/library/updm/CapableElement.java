...
public final class CapableElement extends BaseGeneratedEMFQuerySpecification<CapableElement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapableElement.Match.parameterNames;
    }
    ...
    @Override
    public CapableElement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapableElement.Match)) {
          CapableElement.Match other = (CapableElement.Match) obj;
    ...
    @Override
    public CapableElement specification() {
      return CapableElement.instance();
    }
     ...
     * 
     */
    public static CapableElement.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapableElement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static CapableElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends CapableElement.Match {
    ...
    private static final class Immutable extends CapableElement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<CapableElement.Match> {
    /**
     ...
     * 
     */
    public static CapableElement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapableElement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapableElement.Matcher.class);
     ...
     * 
     */
    public Collection<CapableElement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<CapableElement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<CapableElement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super CapableElement.Match> processor) {
     ...
     * 
     */
    public CapableElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return CapableElement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapableElement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapableElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final CapableElement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final CapableElement.Match partialMatch) {
    ...
    @Override
    protected CapableElement.Match tupleToMatch(final Tuple t) {
      try {
          return CapableElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected CapableElement.Match arrayToMatch(final Object[] match) {
      try {
          return CapableElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapableElement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapableElement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapableElement.Matcher> querySpecification() {
      return CapableElement.instance();
    }
  }
  
  private CapableElement() {
   ...
   * 
   */
  public static CapableElement instance() {
    try{
  ...
  @Override
  protected CapableElement.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapableElement.Matcher.on(engine);
  }
  
  @Override
  public CapableElement.Matcher instantiate() {
    return CapableElement.Matcher.create();
  }
  
  @Override
  public CapableElement.Match newEmptyMatch() {
    return CapableElement.Match.newEmptyMatch();
  }
  
  @Override
  public CapableElement.Match newMatch(final Object... parameters) {
    return CapableElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapableElement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapableElement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapableElement INSTANCE = new CapableElement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapableElement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "CapableElement");
