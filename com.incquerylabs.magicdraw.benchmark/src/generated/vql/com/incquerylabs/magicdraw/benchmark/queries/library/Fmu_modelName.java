 ...
 *         pattern fmu_modelName(Element : Element, Value: java String) {
 *         	find fmu(Element, stereotype);
 *         	find taggedValue(Element, stereotype, "modelName", taggedValue);
...
public final class Fmu_modelName extends BaseGeneratedEMFQuerySpecification<Fmu_modelName.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Fmu_modelName.Match newMutableMatch(final Element pElement, final String pValue) {
     ...
     * 
     */
    public static Fmu_modelName.Match newMatch(final Element pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<Fmu_modelName.Match> {
     ...
     * 
     */
    public Collection<Fmu_modelName.Match> getAllMatches(final Element pElement, final String pValue) {
     ...
     * 
     */
    public Stream<Fmu_modelName.Match> streamAllMatches(final Element pElement, final String pValue) {
     ...
     * 
     */
    public Optional<Fmu_modelName.Match> getOneArbitraryMatch(final Element pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final String pValue, final Consumer<? super Fmu_modelName.Match> processor) {
     ...
     * 
     */
    public Fmu_modelName.Match newMatch(final Element pElement, final String pValue) {
      return Fmu_modelName.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final Fmu_modelName.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final Fmu_modelName.Match partialMatch) {
    ...
    protected Fmu_modelName.Match tupleToMatch(final Tuple t) {
      try {
          return Fmu_modelName.Match.newMatch((Element) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected Fmu_modelName.Match arrayToMatch(final Object[] match) {
      try {
          return Fmu_modelName.Match.newMatch((Element) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Fmu_modelName.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Fmu_modelName.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Fmu_modelName.Match newMatch(final Object... parameters) {
    return Fmu_modelName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (java.lang.String) parameters[1]);
  }
