 ...
 *         	find slotValue(domainStereotypeInstance, "modelName", valuespec);
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Fmu_modelName extends BaseGeneratedEMFQuerySpecification<Fmu_modelName.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.fmu_modelName pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.fmu_modelName";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.fmu_modelName pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Fmu_modelName} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Fmu_modelName#instance()}.
   * 
