...
public final class ResourcePerformer_milestone extends BaseGeneratedEMFQuerySpecification<ResourcePerformer_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourcePerformer_milestone.Match.parameterNames;
    }
    ...
    @Override
    public ResourcePerformer_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourcePerformer_milestone.Match)) {
          ResourcePerformer_milestone.Match other = (ResourcePerformer_milestone.Match) obj;
    ...
    @Override
    public ResourcePerformer_milestone specification() {
      return ResourcePerformer_milestone.instance();
    }
     ...
     * 
     */
    public static ResourcePerformer_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourcePerformer_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourcePerformer_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourcePerformer_milestone.Match {
    ...
    private static final class Immutable extends ResourcePerformer_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourcePerformer_milestone pattern,
   ...
   * 
   * @see Match
   * @see ResourcePerformer_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<ResourcePerformer_milestone.Match> {
    /**
     ...
     * 
     */
    public static ResourcePerformer_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourcePerformer_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourcePerformer_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<ResourcePerformer_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourcePerformer_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourcePerformer_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourcePerformer_milestone.Match> processor) {
     ...
     * 
     */
    public ResourcePerformer_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourcePerformer_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourcePerformer_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourcePerformer_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourcePerformer_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourcePerformer_milestone.Match partialMatch) {
    ...
    @Override
    protected ResourcePerformer_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return ResourcePerformer_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourcePerformer_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return ResourcePerformer_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourcePerformer_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourcePerformer_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourcePerformer_milestone.Matcher> querySpecification() {
      return ResourcePerformer_milestone.instance();
    }
  }
  
  private ResourcePerformer_milestone() {
   ...
   * 
   */
  public static ResourcePerformer_milestone instance() {
    try{
  ...
  @Override
  protected ResourcePerformer_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourcePerformer_milestone.Matcher.on(engine);
  }
  
  @Override
  public ResourcePerformer_milestone.Matcher instantiate() {
    return ResourcePerformer_milestone.Matcher.create();
  }
  
  @Override
  public ResourcePerformer_milestone.Match newEmptyMatch() {
    return ResourcePerformer_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public ResourcePerformer_milestone.Match newMatch(final Object... parameters) {
    return ResourcePerformer_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourcePerformer_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourcePerformer_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourcePerformer_milestone INSTANCE = new ResourcePerformer_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourcePerformer_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
