...
public final class Measure extends BaseGeneratedEMFQuerySpecification<Measure.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measure pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measure";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measure.Match.parameterNames;
    }
    ...
    @Override
    public Measure.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measure.Match)) {
          Measure.Match other = (Measure.Match) obj;
     ...
     * 
     */
    public static Measure.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measure.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Measure.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Measure.Match {
    ...
    private static final class Immutable extends Measure.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measure pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Measure.Match> {
    /**
     ...
     * 
     */
    public static Measure.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measure.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measure.Matcher.class);
     ...
     * 
     */
    public Collection<Measure.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Measure.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Measure.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Measure.Match> processor) {
     ...
     * 
     */
    public Measure.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Measure.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Measure.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Measure.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Measure.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Measure.Match partialMatch) {
    ...
    @Override
    protected Measure.Match tupleToMatch(final Tuple t) {
      try {
          return Measure.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Measure.Match arrayToMatch(final Object[] match) {
      try {
          return Measure.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measure.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measure.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measure.Matcher> querySpecification() {
      return Measure.instance();
    }
  }
   ...
   * 
   */
  public static Measure instance() {
    try{
  ...
  @Override
  protected Measure.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measure.Matcher.on(engine);
  }
  
  @Override
  public Measure.Matcher instantiate() {
    return Measure.Matcher.create();
  }
  
  @Override
  public Measure.Match newEmptyMatch() {
    return Measure.Match.newEmptyMatch();
  }
  
  @Override
  public Measure.Match newMatch(final Object... parameters) {
    return Measure.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measure} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measure#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Measure INSTANCE = new Measure();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measure.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Measure");
