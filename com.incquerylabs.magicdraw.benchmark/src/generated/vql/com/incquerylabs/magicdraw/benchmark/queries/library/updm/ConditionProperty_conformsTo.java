...
public final class ConditionProperty_conformsTo extends BaseGeneratedEMFQuerySpecification<ConditionProperty_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionProperty_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ConditionProperty_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionProperty_conformsTo.Match)) {
          ConditionProperty_conformsTo.Match other = (ConditionProperty_conformsTo.Match) obj;
    ...
    @Override
    public ConditionProperty_conformsTo specification() {
      return ConditionProperty_conformsTo.instance();
    }
     ...
     * 
     */
    public static ConditionProperty_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionProperty_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConditionProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConditionProperty_conformsTo.Match {
    ...
    private static final class Immutable extends ConditionProperty_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ConditionProperty_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionProperty_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ConditionProperty_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionProperty_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionProperty_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionProperty_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConditionProperty_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConditionProperty_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConditionProperty_conformsTo.Match> processor) {
     ...
     * 
     */
    public ConditionProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ConditionProperty_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConditionProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConditionProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConditionProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConditionProperty_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ConditionProperty_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionProperty_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConditionProperty_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionProperty_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionProperty_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionProperty_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionProperty_conformsTo.Matcher> querySpecification() {
      return ConditionProperty_conformsTo.instance();
    }
  }
  
  private ConditionProperty_conformsTo() {
   ...
   * 
   */
  public static ConditionProperty_conformsTo instance() {
    try{
  ...
  @Override
  protected ConditionProperty_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionProperty_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ConditionProperty_conformsTo.Matcher instantiate() {
    return ConditionProperty_conformsTo.Matcher.create();
  }
  
  @Override
  public ConditionProperty_conformsTo.Match newEmptyMatch() {
    return ConditionProperty_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionProperty_conformsTo.Match newMatch(final Object... parameters) {
    return ConditionProperty_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionProperty_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionProperty_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionProperty_conformsTo INSTANCE = new ConditionProperty_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionProperty_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
