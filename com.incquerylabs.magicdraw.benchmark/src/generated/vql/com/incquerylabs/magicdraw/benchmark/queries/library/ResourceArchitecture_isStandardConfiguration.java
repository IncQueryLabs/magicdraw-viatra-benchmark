...
public final class ResourceArchitecture_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<ResourceArchitecture_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArchitecture_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArchitecture_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArchitecture_isStandardConfiguration.Match)) {
          ResourceArchitecture_isStandardConfiguration.Match other = (ResourceArchitecture_isStandardConfiguration.Match) obj;
    ...
    @Override
    public ResourceArchitecture_isStandardConfiguration specification() {
      return ResourceArchitecture_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static ResourceArchitecture_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArchitecture_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ResourceArchitecture_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourceArchitecture_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends ResourceArchitecture_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see ResourceArchitecture_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArchitecture_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static ResourceArchitecture_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArchitecture_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArchitecture_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArchitecture_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ResourceArchitecture_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ResourceArchitecture_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ResourceArchitecture_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public ResourceArchitecture_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ResourceArchitecture_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArchitecture_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArchitecture_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ResourceArchitecture_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ResourceArchitecture_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected ResourceArchitecture_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArchitecture_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourceArchitecture_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArchitecture_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArchitecture_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArchitecture_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArchitecture_isStandardConfiguration.Matcher> querySpecification() {
      return ResourceArchitecture_isStandardConfiguration.instance();
    }
  }
  
  private ResourceArchitecture_isStandardConfiguration() {
   ...
   * 
   */
  public static ResourceArchitecture_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected ResourceArchitecture_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArchitecture_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public ResourceArchitecture_isStandardConfiguration.Matcher instantiate() {
    return ResourceArchitecture_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public ResourceArchitecture_isStandardConfiguration.Match newEmptyMatch() {
    return ResourceArchitecture_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArchitecture_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return ResourceArchitecture_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArchitecture_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArchitecture_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArchitecture_isStandardConfiguration INSTANCE = new ResourceArchitecture_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArchitecture_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
