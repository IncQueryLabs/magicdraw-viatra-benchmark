...
public final class Software_propertySet extends BaseGeneratedEMFQuerySpecification<Software_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Software_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_propertySet.Match)) {
          Software_propertySet.Match other = (Software_propertySet.Match) obj;
    ...
    @Override
    public Software_propertySet specification() {
      return Software_propertySet.instance();
    }
     ...
     * 
     */
    public static Software_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_propertySet.Match {
    ...
    private static final class Immutable extends Software_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Software_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Software_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Software_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Software_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_propertySet.Match> processor) {
     ...
     * 
     */
    public Software_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_propertySet.Match partialMatch) {
    ...
    @Override
    protected Software_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Software_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Software_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_propertySet.Matcher> querySpecification() {
      return Software_propertySet.instance();
    }
  }
  
  private Software_propertySet() {
   ...
   * 
   */
  public static Software_propertySet instance() {
    try{
  ...
  @Override
  protected Software_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Software_propertySet.Matcher instantiate() {
    return Software_propertySet.Matcher.create();
  }
  
  @Override
  public Software_propertySet.Match newEmptyMatch() {
    return Software_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Software_propertySet.Match newMatch(final Object... parameters) {
    return Software_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_propertySet INSTANCE = new Software_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
