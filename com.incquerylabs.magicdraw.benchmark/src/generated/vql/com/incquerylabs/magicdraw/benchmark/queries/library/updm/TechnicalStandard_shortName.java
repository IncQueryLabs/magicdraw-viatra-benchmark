...
public final class TechnicalStandard_shortName extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_shortName.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_shortName pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_shortName";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_shortName.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_shortName.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_shortName.Match)) {
          TechnicalStandard_shortName.Match other = (TechnicalStandard_shortName.Match) obj;
    ...
    @Override
    public TechnicalStandard_shortName specification() {
      return TechnicalStandard_shortName.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_shortName.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_shortName.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static TechnicalStandard_shortName.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends TechnicalStandard_shortName.Match {
    ...
    private static final class Immutable extends TechnicalStandard_shortName.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_shortName pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_shortName
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_shortName.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_shortName.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_shortName.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_shortName.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_shortName.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<TechnicalStandard_shortName.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<TechnicalStandard_shortName.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super TechnicalStandard_shortName.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_shortName.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return TechnicalStandard_shortName.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_shortName.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_shortName.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final TechnicalStandard_shortName.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final TechnicalStandard_shortName.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_shortName.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected TechnicalStandard_shortName.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_shortName.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_shortName.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_shortName.Matcher> querySpecification() {
      return TechnicalStandard_shortName.instance();
    }
  }
  
  private TechnicalStandard_shortName() {
   ...
   * 
   */
  public static TechnicalStandard_shortName instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_shortName.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_shortName.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_shortName.Matcher instantiate() {
    return TechnicalStandard_shortName.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_shortName.Match newEmptyMatch() {
    return TechnicalStandard_shortName.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_shortName.Match newMatch(final Object... parameters) {
    return TechnicalStandard_shortName.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_shortName} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_shortName#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_shortName INSTANCE = new TechnicalStandard_shortName();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_shortName.GeneratedPQuery INSTANCE = new GeneratedPQuery();
