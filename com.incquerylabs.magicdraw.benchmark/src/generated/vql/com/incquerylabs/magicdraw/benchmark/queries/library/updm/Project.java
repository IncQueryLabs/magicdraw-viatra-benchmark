...
public final class Project extends BaseGeneratedEMFQuerySpecification<Project.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project.Match.parameterNames;
    }
    ...
    @Override
    public Project.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project.Match)) {
          Project.Match other = (Project.Match) obj;
     ...
     * 
     */
    public static Project.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Project.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Project.Match {
    ...
    private static final class Immutable extends Project.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Project.Match> {
    /**
     ...
     * 
     */
    public static Project.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project.Matcher.class);
     ...
     * 
     */
    public Collection<Project.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Project.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Project.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Project.Match> processor) {
     ...
     * 
     */
    public Project.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Project.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Project.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Project.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Project.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Project.Match partialMatch) {
    ...
    @Override
    protected Project.Match tupleToMatch(final Tuple t) {
      try {
          return Project.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Project.Match arrayToMatch(final Object[] match) {
      try {
          return Project.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project.Matcher> querySpecification() {
      return Project.instance();
    }
  }
  ...
  @Override
  protected Project.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project.Matcher.on(engine);
  }
  
  @Override
  public Project.Matcher instantiate() {
    return Project.Matcher.create();
  }
  
  @Override
  public Project.Match newEmptyMatch() {
    return Project.Match.newEmptyMatch();
  }
  
  @Override
  public Project.Match newMatch(final Object... parameters) {
    return Project.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Project");
