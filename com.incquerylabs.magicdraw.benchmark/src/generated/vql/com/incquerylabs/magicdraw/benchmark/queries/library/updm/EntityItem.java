...
public final class EntityItem extends BaseGeneratedEMFQuerySpecification<EntityItem.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityItem.Match.parameterNames;
    }
    ...
    @Override
    public EntityItem.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityItem.Match)) {
          EntityItem.Match other = (EntityItem.Match) obj;
    ...
    @Override
    public EntityItem specification() {
      return EntityItem.instance();
    }
     ...
     * 
     */
    public static EntityItem.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityItem.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static EntityItem.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends EntityItem.Match {
    ...
    private static final class Immutable extends EntityItem.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<EntityItem.Match> {
    /**
     ...
     * 
     */
    public static EntityItem.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityItem.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityItem.Matcher.class);
     ...
     * 
     */
    public Collection<EntityItem.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<EntityItem.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<EntityItem.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super EntityItem.Match> processor) {
     ...
     * 
     */
    public EntityItem.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return EntityItem.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EntityItem.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EntityItem.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final EntityItem.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final EntityItem.Match partialMatch) {
    ...
    @Override
    protected EntityItem.Match tupleToMatch(final Tuple t) {
      try {
          return EntityItem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected EntityItem.Match arrayToMatch(final Object[] match) {
      try {
          return EntityItem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityItem.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityItem.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityItem.Matcher> querySpecification() {
      return EntityItem.instance();
    }
  }
   ...
   * 
   */
  public static EntityItem instance() {
    try{
  ...
  @Override
  protected EntityItem.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityItem.Matcher.on(engine);
  }
  
  @Override
  public EntityItem.Matcher instantiate() {
    return EntityItem.Matcher.create();
  }
  
  @Override
  public EntityItem.Match newEmptyMatch() {
    return EntityItem.Match.newEmptyMatch();
  }
  
  @Override
  public EntityItem.Match newMatch(final Object... parameters) {
    return EntityItem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityItem} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityItem#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityItem INSTANCE = new EntityItem();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityItem.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "EntityItem");
