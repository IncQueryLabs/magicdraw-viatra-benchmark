...
public final class ExchangeElement_actsUpon extends BaseGeneratedEMFQuerySpecification<ExchangeElement_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_actsUpon.Match)) {
          ExchangeElement_actsUpon.Match other = (ExchangeElement_actsUpon.Match) obj;
    ...
    @Override
    public ExchangeElement_actsUpon specification() {
      return ExchangeElement_actsUpon.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_actsUpon.Match {
    ...
    private static final class Immutable extends ExchangeElement_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_actsUpon.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_actsUpon.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_actsUpon.Matcher> querySpecification() {
      return ExchangeElement_actsUpon.instance();
    }
  }
  
  private ExchangeElement_actsUpon() {
   ...
   * 
   */
  public static ExchangeElement_actsUpon instance() {
    try{
  ...
  @Override
  protected ExchangeElement_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_actsUpon.Matcher instantiate() {
    return ExchangeElement_actsUpon.Matcher.create();
  }
  
  @Override
  public ExchangeElement_actsUpon.Match newEmptyMatch() {
    return ExchangeElement_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_actsUpon.Match newMatch(final Object... parameters) {
    return ExchangeElement_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_actsUpon INSTANCE = new ExchangeElement_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
