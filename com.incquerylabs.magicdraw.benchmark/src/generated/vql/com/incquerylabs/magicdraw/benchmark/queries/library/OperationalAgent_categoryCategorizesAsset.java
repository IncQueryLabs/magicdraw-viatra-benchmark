...
public final class OperationalAgent_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<OperationalAgent_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalAgent_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public OperationalAgent_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalAgent_categoryCategorizesAsset.Match)) {
          OperationalAgent_categoryCategorizesAsset.Match other = (OperationalAgent_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public OperationalAgent_categoryCategorizesAsset specification() {
      return OperationalAgent_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static OperationalAgent_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalAgent_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalAgent_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalAgent_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends OperationalAgent_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see OperationalAgent_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalAgent_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static OperationalAgent_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalAgent_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalAgent_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalAgent_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalAgent_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalAgent_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalAgent_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public OperationalAgent_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalAgent_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalAgent_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalAgent_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalAgent_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalAgent_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected OperationalAgent_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalAgent_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalAgent_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalAgent_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalAgent_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalAgent_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalAgent_categoryCategorizesAsset.Matcher> querySpecification() {
      return OperationalAgent_categoryCategorizesAsset.instance();
    }
  }
  
  private OperationalAgent_categoryCategorizesAsset() {
   ...
   * 
   */
  public static OperationalAgent_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected OperationalAgent_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalAgent_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public OperationalAgent_categoryCategorizesAsset.Matcher instantiate() {
    return OperationalAgent_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public OperationalAgent_categoryCategorizesAsset.Match newEmptyMatch() {
    return OperationalAgent_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalAgent_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return OperationalAgent_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalAgent_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalAgent_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalAgent_categoryCategorizesAsset INSTANCE = new OperationalAgent_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalAgent_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find OperationalAgent(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), OperationalAgent.instance().getInternalQueryRepresentation());
