...
public final class ActualProperty_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ActualProperty_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProperty_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ActualProperty_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProperty_startBoundaryType.Match)) {
          ActualProperty_startBoundaryType.Match other = (ActualProperty_startBoundaryType.Match) obj;
    ...
    @Override
    public ActualProperty_startBoundaryType specification() {
      return ActualProperty_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ActualProperty_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProperty_startBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProperty_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProperty_startBoundaryType.Match {
    ...
    private static final class Immutable extends ActualProperty_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ActualProperty_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProperty_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ActualProperty_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProperty_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProperty_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProperty_startBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProperty_startBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProperty_startBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProperty_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ActualProperty_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProperty_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProperty_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProperty_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ActualProperty_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProperty_startBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProperty_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProperty_startBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProperty_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProperty_startBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProperty_startBoundaryType.Matcher> querySpecification() {
      return ActualProperty_startBoundaryType.instance();
    }
  }
  
  private ActualProperty_startBoundaryType() {
   ...
   * 
   */
  public static ActualProperty_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ActualProperty_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProperty_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ActualProperty_startBoundaryType.Matcher instantiate() {
    return ActualProperty_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ActualProperty_startBoundaryType.Match newEmptyMatch() {
    return ActualProperty_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProperty_startBoundaryType.Match newMatch(final Object... parameters) {
    return ActualProperty_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProperty_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProperty_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProperty_startBoundaryType INSTANCE = new ActualProperty_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProperty_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
