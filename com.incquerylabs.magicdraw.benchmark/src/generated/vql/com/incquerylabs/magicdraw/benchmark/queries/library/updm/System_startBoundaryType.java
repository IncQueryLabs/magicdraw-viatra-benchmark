...
public final class System_startBoundaryType extends BaseGeneratedEMFQuerySpecification<System_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public System_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_startBoundaryType.Match)) {
          System_startBoundaryType.Match other = (System_startBoundaryType.Match) obj;
    ...
    @Override
    public System_startBoundaryType specification() {
      return System_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static System_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_startBoundaryType.Match {
    ...
    private static final class Immutable extends System_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see System_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<System_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static System_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<System_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public System_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected System_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return System_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return System_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_startBoundaryType.Matcher> querySpecification() {
      return System_startBoundaryType.instance();
    }
  }
  
  private System_startBoundaryType() {
   ...
   * 
   */
  public static System_startBoundaryType instance() {
    try{
  ...
  @Override
  protected System_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public System_startBoundaryType.Matcher instantiate() {
    return System_startBoundaryType.Matcher.create();
  }
  
  @Override
  public System_startBoundaryType.Match newEmptyMatch() {
    return System_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public System_startBoundaryType.Match newMatch(final Object... parameters) {
    return System_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_startBoundaryType INSTANCE = new System_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
