...
public final class Person_propertySet extends BaseGeneratedEMFQuerySpecification<Person_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Person_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_propertySet.Match)) {
          Person_propertySet.Match other = (Person_propertySet.Match) obj;
    ...
    @Override
    public Person_propertySet specification() {
      return Person_propertySet.instance();
    }
     ...
     * 
     */
    public static Person_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Person_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Person_propertySet.Match {
    ...
    private static final class Immutable extends Person_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Person_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Person_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Person_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Person_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Person_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Person_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Person_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Person_propertySet.Match> processor) {
     ...
     * 
     */
    public Person_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Person_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Person_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Person_propertySet.Match partialMatch) {
    ...
    @Override
    protected Person_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Person_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Person_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Person_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_propertySet.Matcher> querySpecification() {
      return Person_propertySet.instance();
    }
  }
  
  private Person_propertySet() {
   ...
   * 
   */
  public static Person_propertySet instance() {
    try{
  ...
  @Override
  protected Person_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Person_propertySet.Matcher instantiate() {
    return Person_propertySet.Matcher.create();
  }
  
  @Override
  public Person_propertySet.Match newEmptyMatch() {
    return Person_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Person_propertySet.Match newMatch(final Object... parameters) {
    return Person_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_propertySet INSTANCE = new Person_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
