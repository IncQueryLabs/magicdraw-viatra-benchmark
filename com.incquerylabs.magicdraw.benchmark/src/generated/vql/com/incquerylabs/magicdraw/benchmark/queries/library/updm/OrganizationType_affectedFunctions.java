...
public final class OrganizationType_affectedFunctions extends BaseGeneratedEMFQuerySpecification<OrganizationType_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_affectedFunctions.Match)) {
          OrganizationType_affectedFunctions.Match other = (OrganizationType_affectedFunctions.Match) obj;
    ...
    @Override
    public OrganizationType_affectedFunctions specification() {
      return OrganizationType_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static OrganizationType_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_affectedFunctions.Match {
    ...
    private static final class Immutable extends OrganizationType_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public OrganizationType_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_affectedFunctions.Matcher> querySpecification() {
      return OrganizationType_affectedFunctions.instance();
    }
  }
  
  private OrganizationType_affectedFunctions() {
   ...
   * 
   */
  public static OrganizationType_affectedFunctions instance() {
    try{
  ...
  @Override
  protected OrganizationType_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_affectedFunctions.Matcher instantiate() {
    return OrganizationType_affectedFunctions.Matcher.create();
  }
  
  @Override
  public OrganizationType_affectedFunctions.Match newEmptyMatch() {
    return OrganizationType_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_affectedFunctions.Match newMatch(final Object... parameters) {
    return OrganizationType_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_affectedFunctions INSTANCE = new OrganizationType_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
