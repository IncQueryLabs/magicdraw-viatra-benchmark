...
public final class ProjectMilestone_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectMilestone_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestone_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestone_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestone_startBoundaryType.Match)) {
          ProjectMilestone_startBoundaryType.Match other = (ProjectMilestone_startBoundaryType.Match) obj;
    ...
    @Override
    public ProjectMilestone_startBoundaryType specification() {
      return ProjectMilestone_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectMilestone_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestone_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestone_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestone_startBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectMilestone_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestone_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestone_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestone_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestone_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestone_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestone_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestone_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestone_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectMilestone_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectMilestone_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectMilestone_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectMilestone_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectMilestone_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestone_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestone_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestone_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestone_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestone_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestone_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestone_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestone_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestone_startBoundaryType.Matcher> querySpecification() {
      return ProjectMilestone_startBoundaryType.instance();
    }
  }
  
  private ProjectMilestone_startBoundaryType() {
   ...
   * 
   */
  public static ProjectMilestone_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectMilestone_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestone_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestone_startBoundaryType.Matcher instantiate() {
    return ProjectMilestone_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectMilestone_startBoundaryType.Match newEmptyMatch() {
    return ProjectMilestone_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestone_startBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectMilestone_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestone_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestone_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestone_startBoundaryType INSTANCE = new ProjectMilestone_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestone_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
