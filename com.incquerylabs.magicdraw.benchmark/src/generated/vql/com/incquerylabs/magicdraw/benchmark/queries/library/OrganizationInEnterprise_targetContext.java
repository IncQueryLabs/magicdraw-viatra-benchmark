...
public final class OrganizationInEnterprise_targetContext extends BaseGeneratedEMFQuerySpecification<OrganizationInEnterprise_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationInEnterprise_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationInEnterprise_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationInEnterprise_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationInEnterprise_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationInEnterprise_targetContext.Match)) {
          OrganizationInEnterprise_targetContext.Match other = (OrganizationInEnterprise_targetContext.Match) obj;
    ...
    @Override
    public OrganizationInEnterprise_targetContext specification() {
      return OrganizationInEnterprise_targetContext.instance();
    }
     ...
     * 
     */
    public static OrganizationInEnterprise_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationInEnterprise_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static OrganizationInEnterprise_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationInEnterprise_targetContext.Match {
    ...
    private static final class Immutable extends OrganizationInEnterprise_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationInEnterprise_targetContext pattern,
   ...
   * 
   * @see Match
   * @see OrganizationInEnterprise_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationInEnterprise_targetContext.Match> {
    /**
     ...
     * 
     */
    public static OrganizationInEnterprise_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationInEnterprise_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationInEnterprise_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationInEnterprise_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<OrganizationInEnterprise_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<OrganizationInEnterprise_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super OrganizationInEnterprise_targetContext.Match> processor) {
     ...
     * 
     */
    public OrganizationInEnterprise_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return OrganizationInEnterprise_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OrganizationInEnterprise_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OrganizationInEnterprise_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final OrganizationInEnterprise_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final OrganizationInEnterprise_targetContext.Match partialMatch) {
    ...
    @Override
    protected OrganizationInEnterprise_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationInEnterprise_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationInEnterprise_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationInEnterprise_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationInEnterprise_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationInEnterprise_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationInEnterprise_targetContext.Matcher> querySpecification() {
      return OrganizationInEnterprise_targetContext.instance();
    }
  }
  
  private OrganizationInEnterprise_targetContext() {
   ...
   * 
   */
  public static OrganizationInEnterprise_targetContext instance() {
    try{
  ...
  @Override
  protected OrganizationInEnterprise_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationInEnterprise_targetContext.Matcher.on(engine);
  }
  
  @Override
  public OrganizationInEnterprise_targetContext.Matcher instantiate() {
    return OrganizationInEnterprise_targetContext.Matcher.create();
  }
  
  @Override
  public OrganizationInEnterprise_targetContext.Match newEmptyMatch() {
    return OrganizationInEnterprise_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationInEnterprise_targetContext.Match newMatch(final Object... parameters) {
    return OrganizationInEnterprise_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationInEnterprise_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationInEnterprise_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationInEnterprise_targetContext INSTANCE = new OrganizationInEnterprise_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationInEnterprise_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
