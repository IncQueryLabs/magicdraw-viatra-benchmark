...
public final class Function_propertySet extends BaseGeneratedEMFQuerySpecification<Function_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Function_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Function_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Function_propertySet.Match)) {
          Function_propertySet.Match other = (Function_propertySet.Match) obj;
    ...
    @Override
    public Function_propertySet specification() {
      return Function_propertySet.instance();
    }
     ...
     * 
     */
    public static Function_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Function_propertySet.Match newMutableMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public static Function_propertySet.Match newMatch(final Activity pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Function_propertySet.Match {
    ...
    private static final class Immutable extends Function_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Function_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Function_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Function_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Function_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Function_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Function_propertySet.Match> getAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Function_propertySet.Match> streamAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Function_propertySet.Match> getOneArbitraryMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final Element pValue, final Consumer<? super Function_propertySet.Match> processor) {
     ...
     * 
     */
    public Function_propertySet.Match newMatch(final Activity pElement, final Element pValue) {
      return Function_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Function_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Function_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Function_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Function_propertySet.Match partialMatch) {
    ...
    @Override
    protected Function_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Function_propertySet.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Function_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Function_propertySet.Match.newMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Function_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Function_propertySet.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Function_propertySet.Matcher> querySpecification() {
      return Function_propertySet.instance();
    }
  }
  
  private Function_propertySet() {
   ...
   * 
   */
  public static Function_propertySet instance() {
    try{
  ...
  @Override
  protected Function_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Function_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Function_propertySet.Matcher instantiate() {
    return Function_propertySet.Matcher.create();
  }
  
  @Override
  public Function_propertySet.Match newEmptyMatch() {
    return Function_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Function_propertySet.Match newMatch(final Object... parameters) {
    return Function_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Function_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Function_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Function_propertySet INSTANCE = new Function_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Function_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
