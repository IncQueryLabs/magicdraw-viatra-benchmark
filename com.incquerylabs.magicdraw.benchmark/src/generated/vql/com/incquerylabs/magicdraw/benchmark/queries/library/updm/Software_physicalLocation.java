...
public final class Software_physicalLocation extends BaseGeneratedEMFQuerySpecification<Software_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Software_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Software_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Software_physicalLocation.Match)) {
          Software_physicalLocation.Match other = (Software_physicalLocation.Match) obj;
    ...
    @Override
    public Software_physicalLocation specification() {
      return Software_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Software_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Software_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Software_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Software_physicalLocation.Match {
    ...
    private static final class Immutable extends Software_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Software_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Software_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Software_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Software_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Software_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Software_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Software_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Software_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Software_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Software_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Software_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Software_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Software_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Software_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Software_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Software_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Software_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Software_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Software_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Software_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Software_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Software_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Software_physicalLocation.Matcher> querySpecification() {
      return Software_physicalLocation.instance();
    }
  }
  
  private Software_physicalLocation() {
   ...
   * 
   */
  public static Software_physicalLocation instance() {
    try{
  ...
  @Override
  protected Software_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Software_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Software_physicalLocation.Matcher instantiate() {
    return Software_physicalLocation.Matcher.create();
  }
  
  @Override
  public Software_physicalLocation.Match newEmptyMatch() {
    return Software_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Software_physicalLocation.Match newMatch(final Object... parameters) {
    return Software_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Software_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Software_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Software_physicalLocation INSTANCE = new Software_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Software_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
