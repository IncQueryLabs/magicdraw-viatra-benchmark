...
public final class PerformsInContext_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<PerformsInContext_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformsInContext_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public PerformsInContext_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformsInContext_sourcePropertyPath.Match)) {
          PerformsInContext_sourcePropertyPath.Match other = (PerformsInContext_sourcePropertyPath.Match) obj;
    ...
    @Override
    public PerformsInContext_sourcePropertyPath specification() {
      return PerformsInContext_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static PerformsInContext_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformsInContext_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static PerformsInContext_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PerformsInContext_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends PerformsInContext_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see PerformsInContext_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<PerformsInContext_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static PerformsInContext_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformsInContext_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformsInContext_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<PerformsInContext_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<PerformsInContext_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<PerformsInContext_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super PerformsInContext_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public PerformsInContext_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return PerformsInContext_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final PerformsInContext_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final PerformsInContext_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final PerformsInContext_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final PerformsInContext_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected PerformsInContext_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return PerformsInContext_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected PerformsInContext_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return PerformsInContext_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformsInContext_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformsInContext_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformsInContext_sourcePropertyPath.Matcher> querySpecification() {
      return PerformsInContext_sourcePropertyPath.instance();
    }
  }
  
  private PerformsInContext_sourcePropertyPath() {
   ...
   * 
   */
  public static PerformsInContext_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected PerformsInContext_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformsInContext_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public PerformsInContext_sourcePropertyPath.Matcher instantiate() {
    return PerformsInContext_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public PerformsInContext_sourcePropertyPath.Match newEmptyMatch() {
    return PerformsInContext_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public PerformsInContext_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return PerformsInContext_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PerformsInContext_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PerformsInContext_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformsInContext_sourcePropertyPath INSTANCE = new PerformsInContext_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformsInContext_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
