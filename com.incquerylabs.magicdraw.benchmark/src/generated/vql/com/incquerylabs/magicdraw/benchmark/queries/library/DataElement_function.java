...
public final class DataElement_function extends BaseGeneratedEMFQuerySpecification<DataElement_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return DataElement_function.Match.parameterNames;
    }
    ...
    @Override
    public DataElement_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DataElement_function.Match)) {
          DataElement_function.Match other = (DataElement_function.Match) obj;
    ...
    @Override
    public DataElement_function specification() {
      return DataElement_function.instance();
    }
     ...
     * 
     */
    public static DataElement_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static DataElement_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static DataElement_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DataElement_function.Match {
    ...
    private static final class Immutable extends DataElement_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_function pattern,
   ...
   * 
   * @see Match
   * @see DataElement_function
   * 
   */
  public static class Matcher extends BaseMatcher<DataElement_function.Match> {
    /**
     ...
     * 
     */
    public static DataElement_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DataElement_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DataElement_function.Matcher.class);
     ...
     * 
     */
    public Collection<DataElement_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<DataElement_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<DataElement_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super DataElement_function.Match> processor) {
     ...
     * 
     */
    public DataElement_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return DataElement_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DataElement_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DataElement_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final DataElement_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final DataElement_function.Match partialMatch) {
    ...
    @Override
    protected DataElement_function.Match tupleToMatch(final Tuple t) {
      try {
          return DataElement_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected DataElement_function.Match arrayToMatch(final Object[] match) {
      try {
          return DataElement_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DataElement_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DataElement_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DataElement_function.Matcher> querySpecification() {
      return DataElement_function.instance();
    }
  }
  
  private DataElement_function() {
   ...
   * 
   */
  public static DataElement_function instance() {
    try{
  ...
  @Override
  protected DataElement_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return DataElement_function.Matcher.on(engine);
  }
  
  @Override
  public DataElement_function.Matcher instantiate() {
    return DataElement_function.Matcher.create();
  }
  
  @Override
  public DataElement_function.Match newEmptyMatch() {
    return DataElement_function.Match.newEmptyMatch();
  }
  
  @Override
  public DataElement_function.Match newMatch(final Object... parameters) {
    return DataElement_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataElement_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataElement_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DataElement_function INSTANCE = new DataElement_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DataElement_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
