...
public final class OrganizationalResource extends BaseGeneratedEMFQuerySpecification<OrganizationalResource.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource.Match)) {
          OrganizationalResource.Match other = (OrganizationalResource.Match) obj;
    ...
    @Override
    public OrganizationalResource specification() {
      return OrganizationalResource.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OrganizationalResource.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OrganizationalResource.Match {
    ...
    private static final class Immutable extends OrganizationalResource.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OrganizationalResource.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OrganizationalResource.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OrganizationalResource.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OrganizationalResource.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OrganizationalResource.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OrganizationalResource.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OrganizationalResource.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource.Matcher> querySpecification() {
      return OrganizationalResource.instance();
    }
  }
  
  private OrganizationalResource() {
   ...
   * 
   */
  public static OrganizationalResource instance() {
    try{
  ...
  @Override
  protected OrganizationalResource.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource.Matcher instantiate() {
    return OrganizationalResource.Matcher.create();
  }
  
  @Override
  public OrganizationalResource.Match newEmptyMatch() {
    return OrganizationalResource.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource.Match newMatch(final Object... parameters) {
    return OrganizationalResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource INSTANCE = new OrganizationalResource();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OrganizationalResource")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OrganizationalResource");
