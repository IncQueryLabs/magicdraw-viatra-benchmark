...
public final class Post_affectedFunctions extends BaseGeneratedEMFQuerySpecification<Post_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public Post_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_affectedFunctions.Match)) {
          Post_affectedFunctions.Match other = (Post_affectedFunctions.Match) obj;
    ...
    @Override
    public Post_affectedFunctions specification() {
      return Post_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static Post_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_affectedFunctions.Match {
    ...
    private static final class Immutable extends Post_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see Post_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<Post_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static Post_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<Post_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public Post_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected Post_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return Post_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return Post_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_affectedFunctions.Matcher> querySpecification() {
      return Post_affectedFunctions.instance();
    }
  }
  
  private Post_affectedFunctions() {
   ...
   * 
   */
  public static Post_affectedFunctions instance() {
    try{
  ...
  @Override
  protected Post_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public Post_affectedFunctions.Matcher instantiate() {
    return Post_affectedFunctions.Matcher.create();
  }
  
  @Override
  public Post_affectedFunctions.Match newEmptyMatch() {
    return Post_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public Post_affectedFunctions.Match newMatch(final Object... parameters) {
    return Post_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_affectedFunctions INSTANCE = new Post_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
