...
public final class EnterpriseGoal_Text extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_Text.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_Text.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_Text.Match)) {
          EnterpriseGoal_Text.Match other = (EnterpriseGoal_Text.Match) obj;
    ...
    @Override
    public EnterpriseGoal_Text specification() {
      return EnterpriseGoal_Text.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnterpriseGoal_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnterpriseGoal_Text.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Text pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_Text
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_Text.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_Text.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EnterpriseGoal_Text.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EnterpriseGoal_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnterpriseGoal_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnterpriseGoal_Text.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_Text.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnterpriseGoal_Text.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_Text.Matcher> querySpecification() {
      return EnterpriseGoal_Text.instance();
    }
  }
  
  private EnterpriseGoal_Text() {
   ...
   * 
   */
  public static EnterpriseGoal_Text instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_Text.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_Text.Matcher instantiate() {
    return EnterpriseGoal_Text.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_Text.Match newEmptyMatch() {
    return EnterpriseGoal_Text.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_Text.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_Text} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_Text#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_Text INSTANCE = new EnterpriseGoal_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
