...
public final class RoleType_propertySet extends BaseGeneratedEMFQuerySpecification<RoleType_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_propertySet.Match)) {
          RoleType_propertySet.Match other = (RoleType_propertySet.Match) obj;
    ...
    @Override
    public RoleType_propertySet specification() {
      return RoleType_propertySet.instance();
    }
     ...
     * 
     */
    public static RoleType_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_propertySet.Match {
    ...
    private static final class Immutable extends RoleType_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_propertySet pattern,
   ...
   * 
   * @see Match
   * @see RoleType_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_propertySet.Match> {
    /**
     ...
     * 
     */
    public static RoleType_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_propertySet.Match> processor) {
     ...
     * 
     */
    public RoleType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_propertySet.Match partialMatch) {
    ...
    @Override
    protected RoleType_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_propertySet.Matcher> querySpecification() {
      return RoleType_propertySet.instance();
    }
  }
  
  private RoleType_propertySet() {
   ...
   * 
   */
  public static RoleType_propertySet instance() {
    try{
  ...
  @Override
  protected RoleType_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_propertySet.Matcher.on(engine);
  }
  
  @Override
  public RoleType_propertySet.Matcher instantiate() {
    return RoleType_propertySet.Matcher.create();
  }
  
  @Override
  public RoleType_propertySet.Match newEmptyMatch() {
    return RoleType_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_propertySet.Match newMatch(final Object... parameters) {
    return RoleType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_propertySet INSTANCE = new RoleType_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
