...
public final class RoleType_conformsTo extends BaseGeneratedEMFQuerySpecification<RoleType_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_conformsTo.Match)) {
          RoleType_conformsTo.Match other = (RoleType_conformsTo.Match) obj;
    ...
    @Override
    public RoleType_conformsTo specification() {
      return RoleType_conformsTo.instance();
    }
     ...
     * 
     */
    public static RoleType_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_conformsTo.Match {
    ...
    private static final class Immutable extends RoleType_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see RoleType_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static RoleType_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_conformsTo.Match> processor) {
     ...
     * 
     */
    public RoleType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_conformsTo.Match partialMatch) {
    ...
    @Override
    protected RoleType_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_conformsTo.Matcher> querySpecification() {
      return RoleType_conformsTo.instance();
    }
  }
  
  private RoleType_conformsTo() {
   ...
   * 
   */
  public static RoleType_conformsTo instance() {
    try{
  ...
  @Override
  protected RoleType_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public RoleType_conformsTo.Matcher instantiate() {
    return RoleType_conformsTo.Matcher.create();
  }
  
  @Override
  public RoleType_conformsTo.Match newEmptyMatch() {
    return RoleType_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_conformsTo.Match newMatch(final Object... parameters) {
    return RoleType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_conformsTo INSTANCE = new RoleType_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
