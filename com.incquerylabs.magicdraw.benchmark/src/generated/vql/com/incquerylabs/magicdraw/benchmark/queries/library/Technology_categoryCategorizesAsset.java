...
public final class Technology_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<Technology_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Technology_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Technology_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public Technology_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Technology_categoryCategorizesAsset.Match)) {
          Technology_categoryCategorizesAsset.Match other = (Technology_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public Technology_categoryCategorizesAsset specification() {
      return Technology_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static Technology_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Technology_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Technology_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Technology_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends Technology_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Technology_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see Technology_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<Technology_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static Technology_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Technology_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Technology_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<Technology_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Technology_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Technology_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Technology_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public Technology_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Technology_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Technology_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Technology_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Technology_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Technology_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected Technology_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return Technology_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Technology_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return Technology_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Technology_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Technology_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Technology_categoryCategorizesAsset.Matcher> querySpecification() {
      return Technology_categoryCategorizesAsset.instance();
    }
  }
  
  private Technology_categoryCategorizesAsset() {
   ...
   * 
   */
  public static Technology_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected Technology_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Technology_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public Technology_categoryCategorizesAsset.Matcher instantiate() {
    return Technology_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public Technology_categoryCategorizesAsset.Match newEmptyMatch() {
    return Technology_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public Technology_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return Technology_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Technology_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Technology_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Technology_categoryCategorizesAsset INSTANCE = new Technology_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Technology_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
