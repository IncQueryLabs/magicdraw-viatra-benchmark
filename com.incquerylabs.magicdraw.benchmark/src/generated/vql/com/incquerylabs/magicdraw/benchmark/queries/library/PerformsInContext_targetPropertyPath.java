...
public final class PerformsInContext_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<PerformsInContext_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformsInContext_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public PerformsInContext_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformsInContext_targetPropertyPath.Match)) {
          PerformsInContext_targetPropertyPath.Match other = (PerformsInContext_targetPropertyPath.Match) obj;
    ...
    @Override
    public PerformsInContext_targetPropertyPath specification() {
      return PerformsInContext_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static PerformsInContext_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformsInContext_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static PerformsInContext_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PerformsInContext_targetPropertyPath.Match {
    ...
    private static final class Immutable extends PerformsInContext_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see PerformsInContext_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<PerformsInContext_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static PerformsInContext_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformsInContext_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformsInContext_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<PerformsInContext_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<PerformsInContext_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<PerformsInContext_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super PerformsInContext_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public PerformsInContext_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return PerformsInContext_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final PerformsInContext_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final PerformsInContext_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final PerformsInContext_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final PerformsInContext_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected PerformsInContext_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return PerformsInContext_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected PerformsInContext_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return PerformsInContext_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformsInContext_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformsInContext_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformsInContext_targetPropertyPath.Matcher> querySpecification() {
      return PerformsInContext_targetPropertyPath.instance();
    }
  }
  
  private PerformsInContext_targetPropertyPath() {
   ...
   * 
   */
  public static PerformsInContext_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected PerformsInContext_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformsInContext_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public PerformsInContext_targetPropertyPath.Matcher instantiate() {
    return PerformsInContext_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public PerformsInContext_targetPropertyPath.Match newEmptyMatch() {
    return PerformsInContext_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public PerformsInContext_targetPropertyPath.Match newMatch(final Object... parameters) {
    return PerformsInContext_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PerformsInContext_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PerformsInContext_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformsInContext_targetPropertyPath INSTANCE = new PerformsInContext_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformsInContext_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
