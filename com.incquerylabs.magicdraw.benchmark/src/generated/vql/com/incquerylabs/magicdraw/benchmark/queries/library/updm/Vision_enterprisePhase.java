...
public final class Vision_enterprisePhase extends BaseGeneratedEMFQuerySpecification<Vision_enterprisePhase.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_enterprisePhase pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_enterprisePhase";
    }
    
    @Override
    public List<String> parameterNames() {
      return Vision_enterprisePhase.Match.parameterNames;
    }
    ...
    @Override
    public Vision_enterprisePhase.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Vision_enterprisePhase.Match)) {
          Vision_enterprisePhase.Match other = (Vision_enterprisePhase.Match) obj;
    ...
    @Override
    public Vision_enterprisePhase specification() {
      return Vision_enterprisePhase.instance();
    }
     ...
     * 
     */
    public static Vision_enterprisePhase.Match newEmptyMatch() {
     ...
     * 
     */
    public static Vision_enterprisePhase.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Vision_enterprisePhase.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Vision_enterprisePhase.Match {
    ...
    private static final class Immutable extends Vision_enterprisePhase.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_enterprisePhase pattern,
   ...
   * 
   * @see Match
   * @see Vision_enterprisePhase
   * 
   */
  public static class Matcher extends BaseMatcher<Vision_enterprisePhase.Match> {
    /**
     ...
     * 
     */
    public static Vision_enterprisePhase.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Vision_enterprisePhase.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Vision_enterprisePhase.Matcher.class);
     ...
     * 
     */
    public Collection<Vision_enterprisePhase.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Vision_enterprisePhase.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Vision_enterprisePhase.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Vision_enterprisePhase.Match> processor) {
     ...
     * 
     */
    public Vision_enterprisePhase.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Vision_enterprisePhase.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Vision_enterprisePhase.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Vision_enterprisePhase.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Vision_enterprisePhase.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Vision_enterprisePhase.Match partialMatch) {
    ...
    @Override
    protected Vision_enterprisePhase.Match tupleToMatch(final Tuple t) {
      try {
          return Vision_enterprisePhase.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Vision_enterprisePhase.Match arrayToMatch(final Object[] match) {
      try {
          return Vision_enterprisePhase.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Vision_enterprisePhase.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Vision_enterprisePhase.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Vision_enterprisePhase.Matcher> querySpecification() {
      return Vision_enterprisePhase.instance();
    }
  }
  
  private Vision_enterprisePhase() {
   ...
   * 
   */
  public static Vision_enterprisePhase instance() {
    try{
  ...
  @Override
  protected Vision_enterprisePhase.Matcher instantiate(final ViatraQueryEngine engine) {
    return Vision_enterprisePhase.Matcher.on(engine);
  }
  
  @Override
  public Vision_enterprisePhase.Matcher instantiate() {
    return Vision_enterprisePhase.Matcher.create();
  }
  
  @Override
  public Vision_enterprisePhase.Match newEmptyMatch() {
    return Vision_enterprisePhase.Match.newEmptyMatch();
  }
  
  @Override
  public Vision_enterprisePhase.Match newMatch(final Object... parameters) {
    return Vision_enterprisePhase.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Vision_enterprisePhase} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Vision_enterprisePhase#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Vision_enterprisePhase INSTANCE = new Vision_enterprisePhase();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Vision_enterprisePhase.GeneratedPQuery INSTANCE = new GeneratedPQuery();
