...
public final class Energy_propertySet extends BaseGeneratedEMFQuerySpecification<Energy_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Energy_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_propertySet.Match)) {
          Energy_propertySet.Match other = (Energy_propertySet.Match) obj;
    ...
    @Override
    public Energy_propertySet specification() {
      return Energy_propertySet.instance();
    }
     ...
     * 
     */
    public static Energy_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_propertySet.Match {
    ...
    private static final class Immutable extends Energy_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Energy_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Energy_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_propertySet.Match> processor) {
     ...
     * 
     */
    public Energy_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_propertySet.Match partialMatch) {
    ...
    @Override
    protected Energy_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_propertySet.Matcher> querySpecification() {
      return Energy_propertySet.instance();
    }
  }
  
  private Energy_propertySet() {
   ...
   * 
   */
  public static Energy_propertySet instance() {
    try{
  ...
  @Override
  protected Energy_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Energy_propertySet.Matcher instantiate() {
    return Energy_propertySet.Matcher.create();
  }
  
  @Override
  public Energy_propertySet.Match newEmptyMatch() {
    return Energy_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_propertySet.Match newMatch(final Object... parameters) {
    return Energy_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_propertySet INSTANCE = new Energy_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
