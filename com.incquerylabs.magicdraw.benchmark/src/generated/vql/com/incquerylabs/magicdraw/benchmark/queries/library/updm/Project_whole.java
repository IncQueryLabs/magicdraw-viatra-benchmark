...
public final class Project_whole extends BaseGeneratedEMFQuerySpecification<Project_whole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_whole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_whole";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_whole.Match.parameterNames;
    }
    ...
    @Override
    public Project_whole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_whole.Match)) {
          Project_whole.Match other = (Project_whole.Match) obj;
    ...
    @Override
    public Project_whole specification() {
      return Project_whole.instance();
    }
     ...
     * 
     */
    public static Project_whole.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_whole.Match newMutableMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public static Project_whole.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Project_whole.Match {
    ...
    private static final class Immutable extends Project_whole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_whole pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Project_whole.Match> {
    /**
     ...
     * 
     */
    public static Project_whole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_whole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_whole.Matcher.class);
     ...
     * 
     */
    public Collection<Project_whole.Match> getAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Project_whole.Match> streamAllMatches(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Project_whole.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final Element pValue, final Consumer<? super Project_whole.Match> processor) {
     ...
     * 
     */
    public Project_whole.Match newMatch(final InstanceSpecification pElement, final Element pValue) {
      return Project_whole.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Project_whole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Project_whole.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Project_whole.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Project_whole.Match partialMatch) {
    ...
    @Override
    protected Project_whole.Match tupleToMatch(final Tuple t) {
      try {
          return Project_whole.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Project_whole.Match arrayToMatch(final Object[] match) {
      try {
          return Project_whole.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_whole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_whole.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_whole.Matcher> querySpecification() {
      return Project_whole.instance();
    }
  }
  
  private Project_whole() {
   ...
   * 
   */
  public static Project_whole instance() {
    try{
  ...
  @Override
  protected Project_whole.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_whole.Matcher.on(engine);
  }
  
  @Override
  public Project_whole.Matcher instantiate() {
    return Project_whole.Matcher.create();
  }
  
  @Override
  public Project_whole.Match newEmptyMatch() {
    return Project_whole.Match.newEmptyMatch();
  }
  
  @Override
  public Project_whole.Match newMatch(final Object... parameters) {
    return Project_whole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_whole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_whole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_whole INSTANCE = new Project_whole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_whole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
