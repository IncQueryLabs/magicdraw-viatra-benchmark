...
public final class EnterprisePhase_visions extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_visions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_visions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_visions";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_visions.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_visions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_visions.Match)) {
          EnterprisePhase_visions.Match other = (EnterprisePhase_visions.Match) obj;
    ...
    @Override
    public EnterprisePhase_visions specification() {
      return EnterprisePhase_visions.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_visions.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_visions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static EnterprisePhase_visions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_visions.Match {
    ...
    private static final class Immutable extends EnterprisePhase_visions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_visions pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_visions
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_visions.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_visions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_visions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_visions.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_visions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_visions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_visions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super EnterprisePhase_visions.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_visions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return EnterprisePhase_visions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_visions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_visions.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfvalue(final EnterprisePhase_visions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfvalue(final EnterprisePhase_visions.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_visions.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_visions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_visions.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_visions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_visions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_visions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_visions.Matcher> querySpecification() {
      return EnterprisePhase_visions.instance();
    }
  }
  
  private EnterprisePhase_visions() {
   ...
   * 
   */
  public static EnterprisePhase_visions instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_visions.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_visions.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_visions.Matcher instantiate() {
    return EnterprisePhase_visions.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_visions.Match newEmptyMatch() {
    return EnterprisePhase_visions.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_visions.Match newMatch(final Object... parameters) {
    return EnterprisePhase_visions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_visions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_visions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_visions INSTANCE = new EnterprisePhase_visions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_visions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "visions");
