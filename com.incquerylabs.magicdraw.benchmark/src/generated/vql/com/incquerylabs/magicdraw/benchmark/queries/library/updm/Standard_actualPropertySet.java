...
public final class Standard_actualPropertySet extends BaseGeneratedEMFQuerySpecification<Standard_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public Standard_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_actualPropertySet.Match)) {
          Standard_actualPropertySet.Match other = (Standard_actualPropertySet.Match) obj;
    ...
    @Override
    public Standard_actualPropertySet specification() {
      return Standard_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static Standard_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Standard_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Standard_actualPropertySet.Match {
    ...
    private static final class Immutable extends Standard_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see Standard_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static Standard_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Standard_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Standard_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Standard_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public Standard_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Standard_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Standard_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Standard_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected Standard_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Standard_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_actualPropertySet.Matcher> querySpecification() {
      return Standard_actualPropertySet.instance();
    }
  }
  
  private Standard_actualPropertySet() {
   ...
   * 
   */
  public static Standard_actualPropertySet instance() {
    try{
  ...
  @Override
  protected Standard_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public Standard_actualPropertySet.Matcher instantiate() {
    return Standard_actualPropertySet.Matcher.create();
  }
  
  @Override
  public Standard_actualPropertySet.Match newEmptyMatch() {
    return Standard_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_actualPropertySet.Match newMatch(final Object... parameters) {
    return Standard_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_actualPropertySet INSTANCE = new Standard_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
