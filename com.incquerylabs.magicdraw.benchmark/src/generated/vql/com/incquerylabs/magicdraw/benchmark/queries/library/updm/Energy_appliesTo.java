...
public final class Energy_appliesTo extends BaseGeneratedEMFQuerySpecification<Energy_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Energy_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_appliesTo.Match)) {
          Energy_appliesTo.Match other = (Energy_appliesTo.Match) obj;
    ...
    @Override
    public Energy_appliesTo specification() {
      return Energy_appliesTo.instance();
    }
     ...
     * 
     */
    public static Energy_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_appliesTo.Match {
    ...
    private static final class Immutable extends Energy_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Energy_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Energy_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_appliesTo.Match> processor) {
     ...
     * 
     */
    public Energy_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Energy_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_appliesTo.Matcher> querySpecification() {
      return Energy_appliesTo.instance();
    }
  }
  
  private Energy_appliesTo() {
   ...
   * 
   */
  public static Energy_appliesTo instance() {
    try{
  ...
  @Override
  protected Energy_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Energy_appliesTo.Matcher instantiate() {
    return Energy_appliesTo.Matcher.create();
  }
  
  @Override
  public Energy_appliesTo.Match newEmptyMatch() {
    return Energy_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_appliesTo.Match newMatch(final Object... parameters) {
    return Energy_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_appliesTo INSTANCE = new Energy_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
