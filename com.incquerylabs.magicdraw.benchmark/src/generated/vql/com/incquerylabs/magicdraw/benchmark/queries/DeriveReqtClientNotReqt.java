...
public final class DeriveReqtClientNotReqt extends BaseGeneratedEMFQuerySpecification<DeriveReqtClientNotReqt.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link DeriveReqtClientNotReqt} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DeriveReqtClientNotReqt#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private final PParameter parameter_deriveReqt = new PParameter("deriveReqt", "com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction", new EClassTransitiveInstancesKey((EClass)getClassifierLiteralSafe("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Abstraction")), PParameterDirection.INOUT);
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_deriveReqt), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Abstraction")));
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_deriveReqt, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency", "client")));
