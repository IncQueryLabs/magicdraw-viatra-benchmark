...
public final class Node_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Node_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Node_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_startBoundaryType.Match)) {
          Node_startBoundaryType.Match other = (Node_startBoundaryType.Match) obj;
    ...
    @Override
    public Node_startBoundaryType specification() {
      return Node_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Node_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Node_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_startBoundaryType.Match {
    ...
    private static final class Immutable extends Node_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Node_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Node_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Node_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Node_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Node_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Node_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Node_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Node_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Node_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Node_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Node_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Node_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Node_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Node_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_startBoundaryType.Matcher> querySpecification() {
      return Node_startBoundaryType.instance();
    }
  }
  
  private Node_startBoundaryType() {
   ...
   * 
   */
  public static Node_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Node_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Node_startBoundaryType.Matcher instantiate() {
    return Node_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Node_startBoundaryType.Match newEmptyMatch() {
    return Node_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Node_startBoundaryType.Match newMatch(final Object... parameters) {
    return Node_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_startBoundaryType INSTANCE = new Node_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
