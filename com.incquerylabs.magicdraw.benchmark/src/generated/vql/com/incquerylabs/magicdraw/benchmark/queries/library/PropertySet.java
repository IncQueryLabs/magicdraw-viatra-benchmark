...
public final class PropertySet extends BaseGeneratedEMFQuerySpecification<PropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return PropertySet.Match.parameterNames;
    }
    ...
    @Override
    public PropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PropertySet.Match)) {
          PropertySet.Match other = (PropertySet.Match) obj;
    ...
    @Override
    public PropertySet specification() {
     ...
     * 
     */
    public static PropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static PropertySet.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static PropertySet.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends PropertySet.Match {
    ...
    private static final class Immutable extends PropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PropertySet pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<PropertySet.Match> {
    /**
     ...
     * 
     */
    public static PropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<PropertySet.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<PropertySet.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<PropertySet.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super PropertySet.Match> processor) {
     ...
     * 
     */
    public PropertySet.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return PropertySet.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final PropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final PropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final PropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final PropertySet.Match partialMatch) {
    ...
    @Override
    protected PropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return PropertySet.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected PropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return PropertySet.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PropertySet.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PropertySet.Matcher> querySpecification() {
      return PropertySet.instance();
    }
  }
  ...
  @Override
  protected PropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return PropertySet.Matcher.on(engine);
  }
  
  @Override
  public PropertySet.Matcher instantiate() {
    return PropertySet.Matcher.create();
  }
  
  @Override
  public PropertySet.Match newEmptyMatch() {
    return PropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public PropertySet.Match newMatch(final Object... parameters) {
    return PropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PropertySet INSTANCE = new PropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "PropertySet")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "PropertySet");
