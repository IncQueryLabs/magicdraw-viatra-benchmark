...
public final class Performer_URI extends BaseGeneratedEMFQuerySpecification<Performer_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_URI.Match.parameterNames;
    }
    ...
    @Override
    public Performer_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_URI.Match)) {
          Performer_URI.Match other = (Performer_URI.Match) obj;
    ...
    @Override
    public Performer_URI specification() {
      return Performer_URI.instance();
    }
     ...
     * 
     */
    public static Performer_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Performer_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Performer_URI.Match {
    ...
    private static final class Immutable extends Performer_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_URI.Match> {
    /**
     ...
     * 
     */
    public static Performer_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Performer_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Performer_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Performer_URI.Match> processor) {
     ...
     * 
     */
    public Performer_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Performer_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Performer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Performer_URI.Match partialMatch) {
    ...
    @Override
    protected Performer_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Performer_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_URI.Matcher> querySpecification() {
      return Performer_URI.instance();
    }
  }
  
  private Performer_URI() {
   ...
   * 
   */
  public static Performer_URI instance() {
    try{
  ...
  @Override
  protected Performer_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_URI.Matcher.on(engine);
  }
  
  @Override
  public Performer_URI.Matcher instantiate() {
    return Performer_URI.Matcher.create();
  }
  
  @Override
  public Performer_URI.Match newEmptyMatch() {
    return Performer_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_URI.Match newMatch(final Object... parameters) {
    return Performer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_URI INSTANCE = new Performer_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
