...
public final class Copy extends BaseGeneratedEMFQuerySpecification<Copy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Copy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Copy";
    }
     ...
     * 
     */
    public static Copy.Match newMutableMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Copy.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Copy pattern,
  ...
  public static class Matcher extends BaseMatcher<Copy.Match> {
     ...
     * 
     */
    public Collection<Copy.Match> getAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Copy.Match> streamAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Copy.Match> getOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype, final Consumer<? super Copy.Match> processor) {
     ...
     * 
     */
    public Copy.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return Copy.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Copy.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Copy.Match partialMatch) {
    ...
    protected Copy.Match tupleToMatch(final Tuple t) {
      try {
          return Copy.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected Copy.Match arrayToMatch(final Object[] match) {
      try {
          return Copy.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected Copy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Copy.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Copy.Match newMatch(final Object... parameters) {
    return Copy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Copy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Copy#instance()}.
   * 
