...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType;
...
public final class ProjectType_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ProjectType_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectType_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectType_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectType_actualPropertySet.Match)) {
          ProjectType_actualPropertySet.Match other = (ProjectType_actualPropertySet.Match) obj;
    ...
    @Override
    public ProjectType_actualPropertySet specification() {
      return ProjectType_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ProjectType_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectType_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectType_actualPropertySet.Match {
    ...
    private static final class Immutable extends ProjectType_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectType_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectType_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectType_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectType_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectType_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectType_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectType_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectType_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectType_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectType_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ProjectType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectType_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectType_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectType_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectType_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectType_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectType_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectType_actualPropertySet.Matcher> querySpecification() {
      return ProjectType_actualPropertySet.instance();
    }
  }
  
  private ProjectType_actualPropertySet() {
   ...
   * 
   */
  public static ProjectType_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ProjectType_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectType_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectType_actualPropertySet.Matcher instantiate() {
    return ProjectType_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ProjectType_actualPropertySet.Match newEmptyMatch() {
    return ProjectType_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectType_actualPropertySet.Match newMatch(final Object... parameters) {
    return ProjectType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectType_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectType_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectType_actualPropertySet INSTANCE = new ProjectType_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectType_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ProjectType(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ProjectType.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
