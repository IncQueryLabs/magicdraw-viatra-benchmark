...
public final class Architecture_URI extends BaseGeneratedEMFQuerySpecification<Architecture_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Architecture_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Architecture_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Architecture_URI.Match.parameterNames;
    }
    ...
    @Override
    public Architecture_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Architecture_URI.Match)) {
          Architecture_URI.Match other = (Architecture_URI.Match) obj;
    ...
    @Override
    public Architecture_URI specification() {
      return Architecture_URI.instance();
    }
     ...
     * 
     */
    public static Architecture_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Architecture_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Architecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Architecture_URI.Match {
    ...
    private static final class Immutable extends Architecture_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Architecture_URI pattern,
   ...
   * 
   * @see Match
   * @see Architecture_URI
   * 
   */
  public static class Matcher extends BaseMatcher<Architecture_URI.Match> {
    /**
     ...
     * 
     */
    public static Architecture_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Architecture_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Architecture_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Architecture_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Architecture_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Architecture_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Architecture_URI.Match> processor) {
     ...
     * 
     */
    public Architecture_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Architecture_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Architecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Architecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Architecture_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Architecture_URI.Match partialMatch) {
    ...
    @Override
    protected Architecture_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Architecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Architecture_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Architecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Architecture_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Architecture_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Architecture_URI.Matcher> querySpecification() {
      return Architecture_URI.instance();
    }
  }
  
  private Architecture_URI() {
   ...
   * 
   */
  public static Architecture_URI instance() {
    try{
  ...
  @Override
  protected Architecture_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Architecture_URI.Matcher.on(engine);
  }
  
  @Override
  public Architecture_URI.Matcher instantiate() {
    return Architecture_URI.Matcher.create();
  }
  
  @Override
  public Architecture_URI.Match newEmptyMatch() {
    return Architecture_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Architecture_URI.Match newMatch(final Object... parameters) {
    return Architecture_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Architecture_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Architecture_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Architecture_URI INSTANCE = new Architecture_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Architecture_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
