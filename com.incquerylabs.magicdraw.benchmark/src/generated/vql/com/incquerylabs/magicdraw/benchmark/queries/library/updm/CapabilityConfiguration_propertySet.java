...
public final class CapabilityConfiguration_propertySet extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_propertySet.Match)) {
          CapabilityConfiguration_propertySet.Match other = (CapabilityConfiguration_propertySet.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_propertySet specification() {
      return CapabilityConfiguration_propertySet.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_propertySet.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_propertySet pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_propertySet.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_propertySet.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_propertySet.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_propertySet.Matcher> querySpecification() {
      return CapabilityConfiguration_propertySet.instance();
    }
  }
  
  private CapabilityConfiguration_propertySet() {
   ...
   * 
   */
  public static CapabilityConfiguration_propertySet instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_propertySet.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_propertySet.Matcher instantiate() {
    return CapabilityConfiguration_propertySet.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_propertySet.Match newEmptyMatch() {
    return CapabilityConfiguration_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_propertySet.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_propertySet INSTANCE = new CapabilityConfiguration_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
