...
public final class Project_physicalLocation extends BaseGeneratedEMFQuerySpecification<Project_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Project_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public Project_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_physicalLocation.Match)) {
          Project_physicalLocation.Match other = (Project_physicalLocation.Match) obj;
    ...
    @Override
    public Project_physicalLocation specification() {
      return Project_physicalLocation.instance();
    }
     ...
     * 
     */
    public static Project_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Project_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Project_physicalLocation.Match {
    ...
    private static final class Immutable extends Project_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Project_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see Project_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<Project_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static Project_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<Project_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Project_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Project_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Project_physicalLocation.Match> processor) {
     ...
     * 
     */
    public Project_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Project_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Project_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Project_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Project_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Project_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected Project_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return Project_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Project_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return Project_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_physicalLocation.Matcher> querySpecification() {
      return Project_physicalLocation.instance();
    }
  }
  
  private Project_physicalLocation() {
   ...
   * 
   */
  public static Project_physicalLocation instance() {
    try{
  ...
  @Override
  protected Project_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public Project_physicalLocation.Matcher instantiate() {
    return Project_physicalLocation.Matcher.create();
  }
  
  @Override
  public Project_physicalLocation.Match newEmptyMatch() {
    return Project_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public Project_physicalLocation.Match newMatch(final Object... parameters) {
    return Project_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_physicalLocation INSTANCE = new Project_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
