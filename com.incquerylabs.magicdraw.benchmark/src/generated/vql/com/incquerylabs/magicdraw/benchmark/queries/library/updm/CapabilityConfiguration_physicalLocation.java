...
public final class CapabilityConfiguration_physicalLocation extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_physicalLocation.Match)) {
          CapabilityConfiguration_physicalLocation.Match other = (CapabilityConfiguration_physicalLocation.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_physicalLocation specification() {
      return CapabilityConfiguration_physicalLocation.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_physicalLocation.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_physicalLocation.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_physicalLocation.Matcher> querySpecification() {
      return CapabilityConfiguration_physicalLocation.instance();
    }
  }
  
  private CapabilityConfiguration_physicalLocation() {
   ...
   * 
   */
  public static CapabilityConfiguration_physicalLocation instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_physicalLocation.Matcher instantiate() {
    return CapabilityConfiguration_physicalLocation.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_physicalLocation.Match newEmptyMatch() {
    return CapabilityConfiguration_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_physicalLocation.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_physicalLocation INSTANCE = new CapabilityConfiguration_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
