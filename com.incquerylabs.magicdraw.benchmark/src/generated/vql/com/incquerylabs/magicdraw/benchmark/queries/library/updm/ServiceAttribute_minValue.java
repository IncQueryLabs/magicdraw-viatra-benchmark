...
public final class ServiceAttribute_minValue extends BaseGeneratedEMFQuerySpecification<ServiceAttribute_minValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_minValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_minValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAttribute_minValue.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAttribute_minValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAttribute_minValue.Match)) {
          ServiceAttribute_minValue.Match other = (ServiceAttribute_minValue.Match) obj;
    ...
    @Override
    public ServiceAttribute_minValue specification() {
      return ServiceAttribute_minValue.instance();
    }
     ...
     * 
     */
    public static ServiceAttribute_minValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAttribute_minValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ServiceAttribute_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ServiceAttribute_minValue.Match {
    ...
    private static final class Immutable extends ServiceAttribute_minValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_minValue pattern,
   ...
   * 
   * @see Match
   * @see ServiceAttribute_minValue
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAttribute_minValue.Match> {
    /**
     ...
     * 
     */
    public static ServiceAttribute_minValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAttribute_minValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAttribute_minValue.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAttribute_minValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ServiceAttribute_minValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ServiceAttribute_minValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ServiceAttribute_minValue.Match> processor) {
     ...
     * 
     */
    public ServiceAttribute_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ServiceAttribute_minValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceAttribute_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceAttribute_minValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ServiceAttribute_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ServiceAttribute_minValue.Match partialMatch) {
    ...
    @Override
    protected ServiceAttribute_minValue.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAttribute_minValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ServiceAttribute_minValue.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAttribute_minValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAttribute_minValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAttribute_minValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAttribute_minValue.Matcher> querySpecification() {
      return ServiceAttribute_minValue.instance();
    }
  }
  
  private ServiceAttribute_minValue() {
   ...
   * 
   */
  public static ServiceAttribute_minValue instance() {
    try{
  ...
  @Override
  protected ServiceAttribute_minValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAttribute_minValue.Matcher.on(engine);
  }
  
  @Override
  public ServiceAttribute_minValue.Matcher instantiate() {
    return ServiceAttribute_minValue.Matcher.create();
  }
  
  @Override
  public ServiceAttribute_minValue.Match newEmptyMatch() {
    return ServiceAttribute_minValue.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAttribute_minValue.Match newMatch(final Object... parameters) {
    return ServiceAttribute_minValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAttribute_minValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAttribute_minValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAttribute_minValue INSTANCE = new ServiceAttribute_minValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAttribute_minValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
