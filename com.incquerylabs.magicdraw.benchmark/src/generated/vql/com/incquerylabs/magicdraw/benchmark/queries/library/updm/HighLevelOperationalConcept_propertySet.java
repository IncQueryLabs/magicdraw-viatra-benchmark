...
public final class HighLevelOperationalConcept_propertySet extends BaseGeneratedEMFQuerySpecification<HighLevelOperationalConcept_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return HighLevelOperationalConcept_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public HighLevelOperationalConcept_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof HighLevelOperationalConcept_propertySet.Match)) {
          HighLevelOperationalConcept_propertySet.Match other = (HighLevelOperationalConcept_propertySet.Match) obj;
    ...
    @Override
    public HighLevelOperationalConcept_propertySet specification() {
      return HighLevelOperationalConcept_propertySet.instance();
    }
     ...
     * 
     */
    public static HighLevelOperationalConcept_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static HighLevelOperationalConcept_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends HighLevelOperationalConcept_propertySet.Match {
    ...
    private static final class Immutable extends HighLevelOperationalConcept_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_propertySet pattern,
   ...
   * 
   * @see Match
   * @see HighLevelOperationalConcept_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<HighLevelOperationalConcept_propertySet.Match> {
    /**
     ...
     * 
     */
    public static HighLevelOperationalConcept_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(HighLevelOperationalConcept_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<HighLevelOperationalConcept_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<HighLevelOperationalConcept_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<HighLevelOperationalConcept_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super HighLevelOperationalConcept_propertySet.Match> processor) {
     ...
     * 
     */
    public HighLevelOperationalConcept_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return HighLevelOperationalConcept_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final HighLevelOperationalConcept_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final HighLevelOperationalConcept_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final HighLevelOperationalConcept_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final HighLevelOperationalConcept_propertySet.Match partialMatch) {
    ...
    @Override
    protected HighLevelOperationalConcept_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return HighLevelOperationalConcept_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected HighLevelOperationalConcept_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return HighLevelOperationalConcept_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected HighLevelOperationalConcept_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return HighLevelOperationalConcept_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<HighLevelOperationalConcept_propertySet.Matcher> querySpecification() {
      return HighLevelOperationalConcept_propertySet.instance();
    }
  }
  
  private HighLevelOperationalConcept_propertySet() {
   ...
   * 
   */
  public static HighLevelOperationalConcept_propertySet instance() {
    try{
  ...
  @Override
  protected HighLevelOperationalConcept_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return HighLevelOperationalConcept_propertySet.Matcher.on(engine);
  }
  
  @Override
  public HighLevelOperationalConcept_propertySet.Matcher instantiate() {
    return HighLevelOperationalConcept_propertySet.Matcher.create();
  }
  
  @Override
  public HighLevelOperationalConcept_propertySet.Match newEmptyMatch() {
    return HighLevelOperationalConcept_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public HighLevelOperationalConcept_propertySet.Match newMatch(final Object... parameters) {
    return HighLevelOperationalConcept_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link HighLevelOperationalConcept_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link HighLevelOperationalConcept_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final HighLevelOperationalConcept_propertySet INSTANCE = new HighLevelOperationalConcept_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final HighLevelOperationalConcept_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
