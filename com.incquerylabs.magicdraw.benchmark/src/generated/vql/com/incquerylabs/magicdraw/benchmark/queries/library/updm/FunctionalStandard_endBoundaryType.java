...
public final class FunctionalStandard_endBoundaryType extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_endBoundaryType.Match)) {
          FunctionalStandard_endBoundaryType.Match other = (FunctionalStandard_endBoundaryType.Match) obj;
    ...
    @Override
    public FunctionalStandard_endBoundaryType specification() {
      return FunctionalStandard_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static FunctionalStandard_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalStandard_endBoundaryType.Match {
    ...
    private static final class Immutable extends FunctionalStandard_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FunctionalStandard_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FunctionalStandard_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super FunctionalStandard_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return FunctionalStandard_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final FunctionalStandard_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final FunctionalStandard_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalStandard_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_endBoundaryType.Matcher> querySpecification() {
      return FunctionalStandard_endBoundaryType.instance();
    }
  }
  
  private FunctionalStandard_endBoundaryType() {
   ...
   * 
   */
  public static FunctionalStandard_endBoundaryType instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_endBoundaryType.Matcher instantiate() {
    return FunctionalStandard_endBoundaryType.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_endBoundaryType.Match newEmptyMatch() {
    return FunctionalStandard_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_endBoundaryType.Match newMatch(final Object... parameters) {
    return FunctionalStandard_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_endBoundaryType INSTANCE = new FunctionalStandard_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
