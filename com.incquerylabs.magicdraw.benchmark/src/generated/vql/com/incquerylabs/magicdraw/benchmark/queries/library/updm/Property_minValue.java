...
public final class Property_minValue extends BaseGeneratedEMFQuerySpecification<Property_minValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_minValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_minValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return Property_minValue.Match.parameterNames;
    }
    ...
    @Override
    public Property_minValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Property_minValue.Match)) {
          Property_minValue.Match other = (Property_minValue.Match) obj;
    ...
    @Override
    public Property_minValue specification() {
      return Property_minValue.instance();
    }
     ...
     * 
     */
    public static Property_minValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static Property_minValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Property_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Property_minValue.Match {
    ...
    private static final class Immutable extends Property_minValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_minValue pattern,
   ...
   * 
   * @see Match
   * @see Property_minValue
   * 
   */
  public static class Matcher extends BaseMatcher<Property_minValue.Match> {
    /**
     ...
     * 
     */
    public static Property_minValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Property_minValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Property_minValue.Matcher.class);
     ...
     * 
     */
    public Collection<Property_minValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Property_minValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Property_minValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super Property_minValue.Match> processor) {
     ...
     * 
     */
    public Property_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return Property_minValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Property_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Property_minValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Property_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Property_minValue.Match partialMatch) {
    ...
    @Override
    protected Property_minValue.Match tupleToMatch(final Tuple t) {
      try {
          return Property_minValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Property_minValue.Match arrayToMatch(final Object[] match) {
      try {
          return Property_minValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Property_minValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Property_minValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Property_minValue.Matcher> querySpecification() {
      return Property_minValue.instance();
    }
  }
  
  private Property_minValue() {
   ...
   * 
   */
  public static Property_minValue instance() {
    try{
  ...
  @Override
  protected Property_minValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return Property_minValue.Matcher.on(engine);
  }
  
  @Override
  public Property_minValue.Matcher instantiate() {
    return Property_minValue.Matcher.create();
  }
  
  @Override
  public Property_minValue.Match newEmptyMatch() {
    return Property_minValue.Match.newEmptyMatch();
  }
  
  @Override
  public Property_minValue.Match newMatch(final Object... parameters) {
    return Property_minValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Property_minValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Property_minValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Property_minValue INSTANCE = new Property_minValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Property_minValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
