...
public final class OperationalPerformer_isEncapsulated extends BaseGeneratedEMFQuerySpecification<OperationalPerformer_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalPerformer_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public OperationalPerformer_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalPerformer_isEncapsulated.Match)) {
          OperationalPerformer_isEncapsulated.Match other = (OperationalPerformer_isEncapsulated.Match) obj;
    ...
    @Override
    public OperationalPerformer_isEncapsulated specification() {
      return OperationalPerformer_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static OperationalPerformer_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalPerformer_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static OperationalPerformer_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalPerformer_isEncapsulated.Match {
    ...
    private static final class Immutable extends OperationalPerformer_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see OperationalPerformer_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalPerformer_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static OperationalPerformer_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalPerformer_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalPerformer_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalPerformer_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<OperationalPerformer_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<OperationalPerformer_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super OperationalPerformer_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public OperationalPerformer_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return OperationalPerformer_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalPerformer_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalPerformer_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final OperationalPerformer_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final OperationalPerformer_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected OperationalPerformer_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalPerformer_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalPerformer_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalPerformer_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalPerformer_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalPerformer_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalPerformer_isEncapsulated.Matcher> querySpecification() {
      return OperationalPerformer_isEncapsulated.instance();
    }
  }
  
  private OperationalPerformer_isEncapsulated() {
   ...
   * 
   */
  public static OperationalPerformer_isEncapsulated instance() {
    try{
  ...
  @Override
  protected OperationalPerformer_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalPerformer_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public OperationalPerformer_isEncapsulated.Matcher instantiate() {
    return OperationalPerformer_isEncapsulated.Matcher.create();
  }
  
  @Override
  public OperationalPerformer_isEncapsulated.Match newEmptyMatch() {
    return OperationalPerformer_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalPerformer_isEncapsulated.Match newMatch(final Object... parameters) {
    return OperationalPerformer_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalPerformer_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalPerformer_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalPerformer_isEncapsulated INSTANCE = new OperationalPerformer_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalPerformer_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
