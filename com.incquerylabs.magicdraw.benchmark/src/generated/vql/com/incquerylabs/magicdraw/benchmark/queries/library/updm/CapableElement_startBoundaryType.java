...
public final class CapableElement_startBoundaryType extends BaseGeneratedEMFQuerySpecification<CapableElement_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapableElement_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public CapableElement_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapableElement_startBoundaryType.Match)) {
          CapableElement_startBoundaryType.Match other = (CapableElement_startBoundaryType.Match) obj;
    ...
    @Override
    public CapableElement_startBoundaryType specification() {
      return CapableElement_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static CapableElement_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapableElement_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapableElement_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapableElement_startBoundaryType.Match {
    ...
    private static final class Immutable extends CapableElement_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see CapableElement_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<CapableElement_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static CapableElement_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapableElement_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapableElement_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<CapableElement_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapableElement_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapableElement_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapableElement_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public CapableElement_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapableElement_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapableElement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapableElement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapableElement_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapableElement_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected CapableElement_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return CapableElement_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapableElement_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return CapableElement_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapableElement_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapableElement_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapableElement_startBoundaryType.Matcher> querySpecification() {
      return CapableElement_startBoundaryType.instance();
    }
  }
  
  private CapableElement_startBoundaryType() {
   ...
   * 
   */
  public static CapableElement_startBoundaryType instance() {
    try{
  ...
  @Override
  protected CapableElement_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapableElement_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public CapableElement_startBoundaryType.Matcher instantiate() {
    return CapableElement_startBoundaryType.Matcher.create();
  }
  
  @Override
  public CapableElement_startBoundaryType.Match newEmptyMatch() {
    return CapableElement_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public CapableElement_startBoundaryType.Match newMatch(final Object... parameters) {
    return CapableElement_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapableElement_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapableElement_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapableElement_startBoundaryType INSTANCE = new CapableElement_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapableElement_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
