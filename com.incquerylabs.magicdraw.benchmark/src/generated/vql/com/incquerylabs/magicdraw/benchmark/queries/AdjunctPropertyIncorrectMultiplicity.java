...
public final class AdjunctPropertyIncorrectMultiplicity extends BaseGeneratedEMFQuerySpecification<AdjunctPropertyIncorrectMultiplicity.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.AdjunctPropertyIncorrectMultiplicity (visibility: PUBLIC, simpleName: AdjunctPropertyIncorrectMultiplicity, identifier: com.incquerylabs.magicdraw.benchmark.queries.AdjunctPropertyIncorrectMultiplicity, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	ObjectNode(principal)
          new TypeConstraint(body, Tuples.flatTupleOf(var_principal), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "ObjectNode")));
          // 	Property.lowerValue(property, lower)
          new TypeConstraint(body, Tuples.flatTupleOf(var_property), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "Property")));
