...
public final class Skill_propertySet extends BaseGeneratedEMFQuerySpecification<Skill_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Skill_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Skill_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Skill_propertySet.Match)) {
          Skill_propertySet.Match other = (Skill_propertySet.Match) obj;
    ...
    @Override
    public Skill_propertySet specification() {
      return Skill_propertySet.instance();
    }
     ...
     * 
     */
    public static Skill_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Skill_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Skill_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Skill_propertySet.Match {
    ...
    private static final class Immutable extends Skill_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Skill_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Skill_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Skill_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Skill_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Skill_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Skill_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Skill_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Skill_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Skill_propertySet.Match> processor) {
     ...
     * 
     */
    public Skill_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Skill_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Skill_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Skill_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Skill_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Skill_propertySet.Match partialMatch) {
    ...
    @Override
    protected Skill_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Skill_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Skill_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Skill_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Skill_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Skill_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Skill_propertySet.Matcher> querySpecification() {
      return Skill_propertySet.instance();
    }
  }
  
  private Skill_propertySet() {
   ...
   * 
   */
  public static Skill_propertySet instance() {
    try{
  ...
  @Override
  protected Skill_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Skill_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Skill_propertySet.Matcher instantiate() {
    return Skill_propertySet.Matcher.create();
  }
  
  @Override
  public Skill_propertySet.Match newEmptyMatch() {
    return Skill_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Skill_propertySet.Match newMatch(final Object... parameters) {
    return Skill_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Skill_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Skill_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Skill_propertySet INSTANCE = new Skill_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Skill_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
