...
import com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification;
...
public final class ServiceSpecification_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ServiceSpecification_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceSpecification_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public ServiceSpecification_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceSpecification_isEncapsulated.Match)) {
          ServiceSpecification_isEncapsulated.Match other = (ServiceSpecification_isEncapsulated.Match) obj;
    ...
    @Override
    public ServiceSpecification_isEncapsulated specification() {
      return ServiceSpecification_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static ServiceSpecification_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceSpecification_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ServiceSpecification_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ServiceSpecification_isEncapsulated.Match {
    ...
    private static final class Immutable extends ServiceSpecification_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see ServiceSpecification_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceSpecification_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static ServiceSpecification_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceSpecification_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceSpecification_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceSpecification_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ServiceSpecification_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ServiceSpecification_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ServiceSpecification_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ServiceSpecification_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ServiceSpecification_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceSpecification_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceSpecification_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ServiceSpecification_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ServiceSpecification_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected ServiceSpecification_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceSpecification_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ServiceSpecification_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceSpecification_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceSpecification_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceSpecification_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceSpecification_isEncapsulated.Matcher> querySpecification() {
      return ServiceSpecification_isEncapsulated.instance();
    }
  }
  
  private ServiceSpecification_isEncapsulated() {
   ...
   * 
   */
  public static ServiceSpecification_isEncapsulated instance() {
    try{
  ...
  @Override
  protected ServiceSpecification_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceSpecification_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public ServiceSpecification_isEncapsulated.Matcher instantiate() {
    return ServiceSpecification_isEncapsulated.Matcher.create();
  }
  
  @Override
  public ServiceSpecification_isEncapsulated.Match newEmptyMatch() {
    return ServiceSpecification_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceSpecification_isEncapsulated.Match newMatch(final Object... parameters) {
    return ServiceSpecification_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceSpecification_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceSpecification_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceSpecification_isEncapsulated INSTANCE = new ServiceSpecification_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceSpecification_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ServiceSpecification(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ServiceSpecification.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
