...
public final class OrganizationalResource_appliesTo extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_appliesTo.Match)) {
          OrganizationalResource_appliesTo.Match other = (OrganizationalResource_appliesTo.Match) obj;
    ...
    @Override
    public OrganizationalResource_appliesTo specification() {
      return OrganizationalResource_appliesTo.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_appliesTo.Match {
    ...
    private static final class Immutable extends OrganizationalResource_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_appliesTo.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_appliesTo.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_appliesTo.Matcher> querySpecification() {
      return OrganizationalResource_appliesTo.instance();
    }
  }
  
  private OrganizationalResource_appliesTo() {
   ...
   * 
   */
  public static OrganizationalResource_appliesTo instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_appliesTo.Matcher instantiate() {
    return OrganizationalResource_appliesTo.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_appliesTo.Match newEmptyMatch() {
    return OrganizationalResource_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_appliesTo.Match newMatch(final Object... parameters) {
    return OrganizationalResource_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_appliesTo INSTANCE = new OrganizationalResource_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
