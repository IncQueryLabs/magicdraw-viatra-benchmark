...
public final class System_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<System_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.System_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.System_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public System_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_categoryCategorizesAsset.Match)) {
          System_categoryCategorizesAsset.Match other = (System_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public System_categoryCategorizesAsset specification() {
      return System_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static System_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends System_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.System_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see System_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<System_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static System_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<System_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public System_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected System_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return System_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return System_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_categoryCategorizesAsset.Matcher> querySpecification() {
      return System_categoryCategorizesAsset.instance();
    }
  }
  
  private System_categoryCategorizesAsset() {
   ...
   * 
   */
  public static System_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected System_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public System_categoryCategorizesAsset.Matcher instantiate() {
    return System_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public System_categoryCategorizesAsset.Match newEmptyMatch() {
    return System_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public System_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return System_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_categoryCategorizesAsset INSTANCE = new System_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
