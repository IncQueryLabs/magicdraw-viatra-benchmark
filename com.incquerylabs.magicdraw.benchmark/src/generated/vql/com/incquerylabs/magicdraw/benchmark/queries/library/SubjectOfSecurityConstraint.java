...
public final class SubjectOfSecurityConstraint extends BaseGeneratedEMFQuerySpecification<SubjectOfSecurityConstraint.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfSecurityConstraint pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfSecurityConstraint";
    }
    
    @Override
    public List<String> parameterNames() {
      return SubjectOfSecurityConstraint.Match.parameterNames;
    }
    ...
    @Override
    public SubjectOfSecurityConstraint.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SubjectOfSecurityConstraint.Match)) {
          SubjectOfSecurityConstraint.Match other = (SubjectOfSecurityConstraint.Match) obj;
    ...
    @Override
    public SubjectOfSecurityConstraint specification() {
      return SubjectOfSecurityConstraint.instance();
    }
     ...
     * 
     */
    public static SubjectOfSecurityConstraint.Match newEmptyMatch() {
     ...
     * 
     */
    public static SubjectOfSecurityConstraint.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SubjectOfSecurityConstraint.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SubjectOfSecurityConstraint.Match {
    ...
    private static final class Immutable extends SubjectOfSecurityConstraint.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfSecurityConstraint pattern,
   ...
   * 
   * @see Match
   * @see SubjectOfSecurityConstraint
   * 
   */
  public static class Matcher extends BaseMatcher<SubjectOfSecurityConstraint.Match> {
    /**
     ...
     * 
     */
    public static SubjectOfSecurityConstraint.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SubjectOfSecurityConstraint.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SubjectOfSecurityConstraint.Matcher.class);
     ...
     * 
     */
    public Collection<SubjectOfSecurityConstraint.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SubjectOfSecurityConstraint.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SubjectOfSecurityConstraint.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SubjectOfSecurityConstraint.Match> processor) {
     ...
     * 
     */
    public SubjectOfSecurityConstraint.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SubjectOfSecurityConstraint.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final SubjectOfSecurityConstraint.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final SubjectOfSecurityConstraint.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SubjectOfSecurityConstraint.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SubjectOfSecurityConstraint.Match partialMatch) {
    ...
    @Override
    protected SubjectOfSecurityConstraint.Match tupleToMatch(final Tuple t) {
      try {
          return SubjectOfSecurityConstraint.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SubjectOfSecurityConstraint.Match arrayToMatch(final Object[] match) {
      try {
          return SubjectOfSecurityConstraint.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SubjectOfSecurityConstraint.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SubjectOfSecurityConstraint.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SubjectOfSecurityConstraint.Matcher> querySpecification() {
      return SubjectOfSecurityConstraint.instance();
    }
  }
  
  private SubjectOfSecurityConstraint() {
   ...
   * 
   */
  public static SubjectOfSecurityConstraint instance() {
    try{
  ...
  @Override
  protected SubjectOfSecurityConstraint.Matcher instantiate(final ViatraQueryEngine engine) {
    return SubjectOfSecurityConstraint.Matcher.on(engine);
  }
  
  @Override
  public SubjectOfSecurityConstraint.Matcher instantiate() {
    return SubjectOfSecurityConstraint.Matcher.create();
  }
  
  @Override
  public SubjectOfSecurityConstraint.Match newEmptyMatch() {
    return SubjectOfSecurityConstraint.Match.newEmptyMatch();
  }
  
  @Override
  public SubjectOfSecurityConstraint.Match newMatch(final Object... parameters) {
    return SubjectOfSecurityConstraint.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SubjectOfSecurityConstraint} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SubjectOfSecurityConstraint#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SubjectOfSecurityConstraint INSTANCE = new SubjectOfSecurityConstraint();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SubjectOfSecurityConstraint.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "SubjectOfSecurityConstraint")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "SubjectOfSecurityConstraint");
