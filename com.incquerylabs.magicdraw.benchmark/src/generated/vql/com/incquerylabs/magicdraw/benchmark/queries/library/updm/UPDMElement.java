...
public final class UPDMElement extends BaseGeneratedEMFQuerySpecification<UPDMElement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.UPDMElement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.UPDMElement";
    }
    
    @Override
    public List<String> parameterNames() {
      return UPDMElement.Match.parameterNames;
    }
    ...
    @Override
    public UPDMElement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof UPDMElement.Match)) {
          UPDMElement.Match other = (UPDMElement.Match) obj;
    ...
    @Override
    public UPDMElement specification() {
      return UPDMElement.instance();
    }
     ...
     * 
     */
    public static UPDMElement.Match newEmptyMatch() {
     ...
     * 
     */
    public static UPDMElement.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static UPDMElement.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends UPDMElement.Match {
    ...
    private static final class Immutable extends UPDMElement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.UPDMElement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<UPDMElement.Match> {
    /**
     ...
     * 
     */
    public static UPDMElement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static UPDMElement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(UPDMElement.Matcher.class);
     ...
     * 
     */
    public Collection<UPDMElement.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<UPDMElement.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<UPDMElement.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super UPDMElement.Match> processor) {
     ...
     * 
     */
    public UPDMElement.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return UPDMElement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final UPDMElement.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final UPDMElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final UPDMElement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final UPDMElement.Match partialMatch) {
    ...
    @Override
    protected UPDMElement.Match tupleToMatch(final Tuple t) {
      try {
          return UPDMElement.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected UPDMElement.Match arrayToMatch(final Object[] match) {
      try {
          return UPDMElement.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected UPDMElement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return UPDMElement.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<UPDMElement.Matcher> querySpecification() {
      return UPDMElement.instance();
    }
  }
   ...
   * 
   */
  public static UPDMElement instance() {
    try{
  ...
  @Override
  protected UPDMElement.Matcher instantiate(final ViatraQueryEngine engine) {
    return UPDMElement.Matcher.on(engine);
  }
  
  @Override
  public UPDMElement.Matcher instantiate() {
    return UPDMElement.Matcher.create();
  }
  
  @Override
  public UPDMElement.Match newEmptyMatch() {
    return UPDMElement.Match.newEmptyMatch();
  }
  
  @Override
  public UPDMElement.Match newMatch(final Object... parameters) {
    return UPDMElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link UPDMElement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link UPDMElement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final UPDMElement INSTANCE = new UPDMElement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final UPDMElement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "UPDMElement");
