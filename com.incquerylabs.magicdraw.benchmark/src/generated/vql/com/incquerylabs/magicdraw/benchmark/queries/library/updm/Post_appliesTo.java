...
public final class Post_appliesTo extends BaseGeneratedEMFQuerySpecification<Post_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Post_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_appliesTo.Match)) {
          Post_appliesTo.Match other = (Post_appliesTo.Match) obj;
    ...
    @Override
    public Post_appliesTo specification() {
      return Post_appliesTo.instance();
    }
     ...
     * 
     */
    public static Post_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_appliesTo.Match {
    ...
    private static final class Immutable extends Post_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_appliesTo pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Post_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Post_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Post_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_appliesTo.Match> processor) {
     ...
     * 
     */
    public Post_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Post_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Post_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Post_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_appliesTo.Matcher> querySpecification() {
      return Post_appliesTo.instance();
    }
  }
  
  private Post_appliesTo() {
   ...
   * 
   */
  public static Post_appliesTo instance() {
    try{
  ...
  @Override
  protected Post_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Post_appliesTo.Matcher instantiate() {
    return Post_appliesTo.Matcher.create();
  }
  
  @Override
  public Post_appliesTo.Match newEmptyMatch() {
    return Post_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Post_appliesTo.Match newMatch(final Object... parameters) {
    return Post_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_appliesTo INSTANCE = new Post_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
