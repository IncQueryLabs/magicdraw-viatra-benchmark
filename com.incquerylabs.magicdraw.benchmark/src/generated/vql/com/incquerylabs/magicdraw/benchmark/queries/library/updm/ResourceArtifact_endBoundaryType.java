...
public final class ResourceArtifact_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_endBoundaryType.Match)) {
          ResourceArtifact_endBoundaryType.Match other = (ResourceArtifact_endBoundaryType.Match) obj;
    ...
    @Override
    public ResourceArtifact_endBoundaryType specification() {
      return ResourceArtifact_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_endBoundaryType.Match {
    ...
    private static final class Immutable extends ResourceArtifact_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_endBoundaryType.Matcher> querySpecification() {
      return ResourceArtifact_endBoundaryType.instance();
    }
  }
  
  private ResourceArtifact_endBoundaryType() {
   ...
   * 
   */
  public static ResourceArtifact_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_endBoundaryType.Matcher instantiate() {
    return ResourceArtifact_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_endBoundaryType.Match newEmptyMatch() {
    return ResourceArtifact_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_endBoundaryType.Match newMatch(final Object... parameters) {
    return ResourceArtifact_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_endBoundaryType INSTANCE = new ResourceArtifact_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
