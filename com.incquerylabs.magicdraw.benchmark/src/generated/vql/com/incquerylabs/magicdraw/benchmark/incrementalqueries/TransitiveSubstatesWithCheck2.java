...
public final class TransitiveSubstatesWithCheck2 extends BaseGeneratedEMFQuerySpecification<TransitiveSubstatesWithCheck2.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.transitiveSubstatesWithCheck2 pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.transitiveSubstatesWithCheck2";
    }
    
    @Override
    public List<String> parameterNames() {
      return TransitiveSubstatesWithCheck2.Match.parameterNames;
    }
    ...
    @Override
    public TransitiveSubstatesWithCheck2.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TransitiveSubstatesWithCheck2.Match)) {
          TransitiveSubstatesWithCheck2.Match other = (TransitiveSubstatesWithCheck2.Match) obj;
    ...
    @Override
    public TransitiveSubstatesWithCheck2 specification() {
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck2.Match newEmptyMatch() {
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck2.Match newMutableMatch(final State pState, final State pTransitiveSubstate) {
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck2.Match newMatch(final State pState, final State pTransitiveSubstate) {
      return new Immutable(pState, pTransitiveSubstate);
    }
    
    private static final class Mutable extends TransitiveSubstatesWithCheck2.Match {
    ...
    private static final class Immutable extends TransitiveSubstatesWithCheck2.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.transitiveSubstatesWithCheck2 pattern,
   ...
   * 
   * @see Match
   * @see TransitiveSubstatesWithCheck2
   * 
   */
  public static class Matcher extends BaseMatcher<TransitiveSubstatesWithCheck2.Match> {
    /**
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck2.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck2.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TransitiveSubstatesWithCheck2.Matcher.class);
     ...
     * 
     */
    public Collection<TransitiveSubstatesWithCheck2.Match> getAllMatches(final State pState, final State pTransitiveSubstate) {
     ...
     * 
     */
    public Stream<TransitiveSubstatesWithCheck2.Match> streamAllMatches(final State pState, final State pTransitiveSubstate) {
     ...
     * 
     */
    public Optional<TransitiveSubstatesWithCheck2.Match> getOneArbitraryMatch(final State pState, final State pTransitiveSubstate) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final State pState, final State pTransitiveSubstate, final Consumer<? super TransitiveSubstatesWithCheck2.Match> processor) {
     ...
     * 
     */
    public TransitiveSubstatesWithCheck2.Match newMatch(final State pState, final State pTransitiveSubstate) {
      return TransitiveSubstatesWithCheck2.Match.newMatch(pState, pTransitiveSubstate);
    }
     ...
     * 
     */
    public Stream<State> streamAllValuesOfstate(final TransitiveSubstatesWithCheck2.Match partialMatch) {
     ...
     * 
     */
    public Set<State> getAllValuesOfstate(final TransitiveSubstatesWithCheck2.Match partialMatch) {
     ...
     * 
     */
    public Stream<State> streamAllValuesOftransitiveSubstate(final TransitiveSubstatesWithCheck2.Match partialMatch) {
     ...
     * 
     */
    public Set<State> getAllValuesOftransitiveSubstate(final TransitiveSubstatesWithCheck2.Match partialMatch) {
    ...
    @Override
    protected TransitiveSubstatesWithCheck2.Match tupleToMatch(final Tuple t) {
      try {
          return TransitiveSubstatesWithCheck2.Match.newMatch((State) t.get(POSITION_STATE), (State) t.get(POSITION_TRANSITIVESUBSTATE));
    ...
    @Override
    protected TransitiveSubstatesWithCheck2.Match arrayToMatch(final Object[] match) {
      try {
          return TransitiveSubstatesWithCheck2.Match.newMatch((State) match[POSITION_STATE], (State) match[POSITION_TRANSITIVESUBSTATE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TransitiveSubstatesWithCheck2.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TransitiveSubstatesWithCheck2.Match.newMutableMatch((State) match[POSITION_STATE], (State) match[POSITION_TRANSITIVESUBSTATE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TransitiveSubstatesWithCheck2.Matcher> querySpecification() {
      return TransitiveSubstatesWithCheck2.instance();
    }
  }
  
  private TransitiveSubstatesWithCheck2() {
   ...
   * 
   */
  public static TransitiveSubstatesWithCheck2 instance() {
    try{
  ...
  @Override
  protected TransitiveSubstatesWithCheck2.Matcher instantiate(final ViatraQueryEngine engine) {
    return TransitiveSubstatesWithCheck2.Matcher.on(engine);
  }
  
  @Override
  public TransitiveSubstatesWithCheck2.Matcher instantiate() {
    return TransitiveSubstatesWithCheck2.Matcher.create();
  }
  
  @Override
  public TransitiveSubstatesWithCheck2.Match newEmptyMatch() {
    return TransitiveSubstatesWithCheck2.Match.newEmptyMatch();
  }
  
  @Override
  public TransitiveSubstatesWithCheck2.Match newMatch(final Object... parameters) {
    return TransitiveSubstatesWithCheck2.Match.newMatch((com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.State) parameters[0], (com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.State) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.incrementalqueries.TransitiveSubstatesWithCheck2 (visibility: PUBLIC, simpleName: TransitiveSubstatesWithCheck2, identifier: com.incquerylabs.magicdraw.benchmark.incrementalqueries.TransitiveSubstatesWithCheck2, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.incrementalqueries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class LazyHolder {
    private static final TransitiveSubstatesWithCheck2 INSTANCE = new TransitiveSubstatesWithCheck2();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TransitiveSubstatesWithCheck2.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern transitiveSubstatesWithCheck2";
              }
