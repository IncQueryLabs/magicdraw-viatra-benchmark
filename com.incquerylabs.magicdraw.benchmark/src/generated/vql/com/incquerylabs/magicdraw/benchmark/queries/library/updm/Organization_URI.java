...
public final class Organization_URI extends BaseGeneratedEMFQuerySpecification<Organization_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_URI.Match.parameterNames;
    }
    ...
    @Override
    public Organization_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_URI.Match)) {
          Organization_URI.Match other = (Organization_URI.Match) obj;
    ...
    @Override
    public Organization_URI specification() {
      return Organization_URI.instance();
    }
     ...
     * 
     */
    public static Organization_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Organization_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Organization_URI.Match {
    ...
    private static final class Immutable extends Organization_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_URI pattern,
   ...
   * 
   * @see Match
   * @see Organization_URI
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_URI.Match> {
    /**
     ...
     * 
     */
    public static Organization_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Organization_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Organization_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Organization_URI.Match> processor) {
     ...
     * 
     */
    public Organization_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Organization_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Organization_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Organization_URI.Match partialMatch) {
    ...
    @Override
    protected Organization_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Organization_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_URI.Matcher> querySpecification() {
      return Organization_URI.instance();
    }
  }
   ...
   * 
   */
  public static Organization_URI instance() {
    try{
  ...
  @Override
  protected Organization_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_URI.Matcher.on(engine);
  }
  
  @Override
  public Organization_URI.Matcher instantiate() {
    return Organization_URI.Matcher.create();
  }
  
  @Override
  public Organization_URI.Match newEmptyMatch() {
    return Organization_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_URI.Match newMatch(final Object... parameters) {
    return Organization_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_URI INSTANCE = new Organization_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
