...
public final class Consumer extends BaseGeneratedEMFQuerySpecification<Consumer.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Consumer pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Consumer";
    }
    
    @Override
    public List<String> parameterNames() {
      return Consumer.Match.parameterNames;
    }
    ...
    @Override
    public Consumer.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Consumer.Match)) {
          Consumer.Match other = (Consumer.Match) obj;
     ...
     * 
     */
    public static Consumer.Match newEmptyMatch() {
     ...
     * 
     */
    public static Consumer.Match newMutableMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Consumer.Match newMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Consumer.Match {
    ...
    private static final class Immutable extends Consumer.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Consumer pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Consumer.Match> {
    /**
     ...
     * 
     */
    public static Consumer.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Consumer.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Consumer.Matcher.class);
     ...
     * 
     */
    public Collection<Consumer.Match> getAllMatches(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Consumer.Match> streamAllMatches(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Consumer.Match> getOneArbitraryMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance, final java.util.function.Consumer<? super Consumer.Match> processor) {
     ...
     * 
     */
    public Consumer.Match newMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Consumer.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfelement(final Consumer.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfelement(final Consumer.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Consumer.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Consumer.Match partialMatch) {
    ...
    @Override
    protected Consumer.Match tupleToMatch(final Tuple t) {
      try {
          return Consumer.Match.newMatch((Classifier) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Consumer.Match arrayToMatch(final Object[] match) {
      try {
          return Consumer.Match.newMatch((Classifier) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Consumer.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Consumer.Match.newMutableMatch((Classifier) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Consumer.Matcher> querySpecification() {
      return Consumer.instance();
    }
  }
  ...
  @Override
  protected Consumer.Matcher instantiate(final ViatraQueryEngine engine) {
    return Consumer.Matcher.on(engine);
  }
  
  @Override
  public Consumer.Matcher instantiate() {
    return Consumer.Matcher.create();
  }
  
  @Override
  public Consumer.Match newEmptyMatch() {
    return Consumer.Match.newEmptyMatch();
  }
  
  @Override
  public Consumer.Match newMatch(final Object... parameters) {
    return Consumer.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Consumer} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Consumer#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Consumer.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Consumer");
