...
public final class OperationalAgent_conformsTo extends BaseGeneratedEMFQuerySpecification<OperationalAgent_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalAgent_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public OperationalAgent_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalAgent_conformsTo.Match)) {
          OperationalAgent_conformsTo.Match other = (OperationalAgent_conformsTo.Match) obj;
    ...
    @Override
    public OperationalAgent_conformsTo specification() {
      return OperationalAgent_conformsTo.instance();
    }
     ...
     * 
     */
    public static OperationalAgent_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalAgent_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalAgent_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalAgent_conformsTo.Match {
    ...
    private static final class Immutable extends OperationalAgent_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see OperationalAgent_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalAgent_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static OperationalAgent_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalAgent_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalAgent_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalAgent_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalAgent_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalAgent_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalAgent_conformsTo.Match> processor) {
     ...
     * 
     */
    public OperationalAgent_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalAgent_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalAgent_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalAgent_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalAgent_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalAgent_conformsTo.Match partialMatch) {
    ...
    @Override
    protected OperationalAgent_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalAgent_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalAgent_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalAgent_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalAgent_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalAgent_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalAgent_conformsTo.Matcher> querySpecification() {
      return OperationalAgent_conformsTo.instance();
    }
  }
  
  private OperationalAgent_conformsTo() {
   ...
   * 
   */
  public static OperationalAgent_conformsTo instance() {
    try{
  ...
  @Override
  protected OperationalAgent_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalAgent_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public OperationalAgent_conformsTo.Matcher instantiate() {
    return OperationalAgent_conformsTo.Matcher.create();
  }
  
  @Override
  public OperationalAgent_conformsTo.Match newEmptyMatch() {
    return OperationalAgent_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalAgent_conformsTo.Match newMatch(final Object... parameters) {
    return OperationalAgent_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalAgent_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalAgent_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalAgent_conformsTo INSTANCE = new OperationalAgent_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalAgent_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
