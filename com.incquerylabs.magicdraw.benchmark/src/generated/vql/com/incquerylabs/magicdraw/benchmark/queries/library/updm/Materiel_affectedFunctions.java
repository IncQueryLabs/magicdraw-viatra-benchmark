...
public final class Materiel_affectedFunctions extends BaseGeneratedEMFQuerySpecification<Materiel_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_affectedFunctions.Match)) {
          Materiel_affectedFunctions.Match other = (Materiel_affectedFunctions.Match) obj;
    ...
    @Override
    public Materiel_affectedFunctions specification() {
      return Materiel_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static Materiel_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Materiel_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Materiel_affectedFunctions.Match {
    ...
    private static final class Immutable extends Materiel_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see Materiel_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static Materiel_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Materiel_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Materiel_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Materiel_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public Materiel_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Materiel_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Materiel_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Materiel_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected Materiel_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Materiel_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_affectedFunctions.Matcher> querySpecification() {
      return Materiel_affectedFunctions.instance();
    }
  }
  
  private Materiel_affectedFunctions() {
   ...
   * 
   */
  public static Materiel_affectedFunctions instance() {
    try{
  ...
  @Override
  protected Materiel_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public Materiel_affectedFunctions.Matcher instantiate() {
    return Materiel_affectedFunctions.Matcher.create();
  }
  
  @Override
  public Materiel_affectedFunctions.Match newEmptyMatch() {
    return Materiel_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_affectedFunctions.Match newMatch(final Object... parameters) {
    return Materiel_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_affectedFunctions INSTANCE = new Materiel_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
