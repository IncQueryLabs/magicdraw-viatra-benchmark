...
public final class Blocks extends BaseGeneratedEMFQuerySpecification<Blocks.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.Blocks (visibility: PUBLIC, simpleName: Blocks, identifier: com.incquerylabs.magicdraw.benchmark.queries.Blocks, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
