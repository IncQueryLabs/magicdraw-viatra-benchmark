...
public final class ItemFlowAssociationHasItemProperty extends BaseGeneratedEMFQuerySpecification<ItemFlowAssociationHasItemProperty.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.itemFlowAssociationHasItemProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.itemFlowAssociationHasItemProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return ItemFlowAssociationHasItemProperty.Match.parameterNames;
    }
    ...
    @Override
    public ItemFlowAssociationHasItemProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ItemFlowAssociationHasItemProperty.Match)) {
          ItemFlowAssociationHasItemProperty.Match other = (ItemFlowAssociationHasItemProperty.Match) obj;
    ...
    @Override
    public ItemFlowAssociationHasItemProperty specification() {
     ...
     * 
     */
    public static ItemFlowAssociationHasItemProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static ItemFlowAssociationHasItemProperty.Match newMutableMatch(final InformationFlow pItemFlow) {
     ...
     * 
     */
    public static ItemFlowAssociationHasItemProperty.Match newMatch(final InformationFlow pItemFlow) {
      return new Immutable(pItemFlow);
    }
    
    private static final class Mutable extends ItemFlowAssociationHasItemProperty.Match {
    ...
    private static final class Immutable extends ItemFlowAssociationHasItemProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.itemFlowAssociationHasItemProperty pattern,
   ...
   * 
   * @see Match
   * @see ItemFlowAssociationHasItemProperty
   * 
   */
  public static class Matcher extends BaseMatcher<ItemFlowAssociationHasItemProperty.Match> {
    /**
     ...
     * 
     */
    public static ItemFlowAssociationHasItemProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ItemFlowAssociationHasItemProperty.Matcher create() {
      return new Matcher();
    }
    
    private static final int POSITION_ITEMFLOW = 0;
    
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ItemFlowAssociationHasItemProperty.Matcher.class);
     ...
     * 
     */
    public Collection<ItemFlowAssociationHasItemProperty.Match> getAllMatches(final InformationFlow pItemFlow) {
     ...
     * 
     */
    public Stream<ItemFlowAssociationHasItemProperty.Match> streamAllMatches(final InformationFlow pItemFlow) {
     ...
     * 
     */
    public Optional<ItemFlowAssociationHasItemProperty.Match> getOneArbitraryMatch(final InformationFlow pItemFlow) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pItemFlow, final Consumer<? super ItemFlowAssociationHasItemProperty.Match> processor) {
     ...
     * 
     */
    public ItemFlowAssociationHasItemProperty.Match newMatch(final InformationFlow pItemFlow) {
      return ItemFlowAssociationHasItemProperty.Match.newMatch(pItemFlow);
    }
    ...
    @Override
    protected ItemFlowAssociationHasItemProperty.Match tupleToMatch(final Tuple t) {
      try {
          return ItemFlowAssociationHasItemProperty.Match.newMatch((InformationFlow) t.get(POSITION_ITEMFLOW));
    ...
    @Override
    protected ItemFlowAssociationHasItemProperty.Match arrayToMatch(final Object[] match) {
      try {
          return ItemFlowAssociationHasItemProperty.Match.newMatch((InformationFlow) match[POSITION_ITEMFLOW]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ItemFlowAssociationHasItemProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ItemFlowAssociationHasItemProperty.Match.newMutableMatch((InformationFlow) match[POSITION_ITEMFLOW]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ItemFlowAssociationHasItemProperty.Matcher> querySpecification() {
      return ItemFlowAssociationHasItemProperty.instance();
    }
  }
  
  private ItemFlowAssociationHasItemProperty() {
   ...
   * 
   */
  public static ItemFlowAssociationHasItemProperty instance() {
    try{
  ...
  @Override
  protected ItemFlowAssociationHasItemProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return ItemFlowAssociationHasItemProperty.Matcher.on(engine);
  }
  
  @Override
  public ItemFlowAssociationHasItemProperty.Matcher instantiate() {
    return ItemFlowAssociationHasItemProperty.Matcher.create();
  }
  
  @Override
  public ItemFlowAssociationHasItemProperty.Match newEmptyMatch() {
    return ItemFlowAssociationHasItemProperty.Match.newEmptyMatch();
  }
  
  @Override
  public ItemFlowAssociationHasItemProperty.Match newMatch(final Object... parameters) {
    return ItemFlowAssociationHasItemProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.ItemFlowAssociationHasItemProperty (visibility: PUBLIC, simpleName: ItemFlowAssociationHasItemProperty, identifier: com.incquerylabs.magicdraw.benchmark.queries.ItemFlowAssociationHasItemProperty, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class LazyHolder {
    private static final ItemFlowAssociationHasItemProperty INSTANCE = new ItemFlowAssociationHasItemProperty();
