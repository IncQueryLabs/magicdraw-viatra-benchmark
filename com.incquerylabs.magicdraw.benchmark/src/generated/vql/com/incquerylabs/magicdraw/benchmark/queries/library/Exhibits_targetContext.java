...
public final class Exhibits_targetContext extends BaseGeneratedEMFQuerySpecification<Exhibits_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Exhibits_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Exhibits_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Exhibits_targetContext.Match)) {
          Exhibits_targetContext.Match other = (Exhibits_targetContext.Match) obj;
    ...
    @Override
    public Exhibits_targetContext specification() {
      return Exhibits_targetContext.instance();
    }
     ...
     * 
     */
    public static Exhibits_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Exhibits_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Exhibits_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Exhibits_targetContext.Match {
    ...
    private static final class Immutable extends Exhibits_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Exhibits_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Exhibits_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Exhibits_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Exhibits_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Exhibits_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Exhibits_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Exhibits_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Exhibits_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Exhibits_targetContext.Match> processor) {
     ...
     * 
     */
    public Exhibits_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Exhibits_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Exhibits_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Exhibits_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Exhibits_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Exhibits_targetContext.Match partialMatch) {
    ...
    @Override
    protected Exhibits_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Exhibits_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Exhibits_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Exhibits_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Exhibits_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Exhibits_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Exhibits_targetContext.Matcher> querySpecification() {
      return Exhibits_targetContext.instance();
    }
  }
  
  private Exhibits_targetContext() {
   ...
   * 
   */
  public static Exhibits_targetContext instance() {
    try{
  ...
  @Override
  protected Exhibits_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Exhibits_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Exhibits_targetContext.Matcher instantiate() {
    return Exhibits_targetContext.Matcher.create();
  }
  
  @Override
  public Exhibits_targetContext.Match newEmptyMatch() {
    return Exhibits_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Exhibits_targetContext.Match newMatch(final Object... parameters) {
    return Exhibits_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Exhibits_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Exhibits_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Exhibits_targetContext INSTANCE = new Exhibits_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Exhibits_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
