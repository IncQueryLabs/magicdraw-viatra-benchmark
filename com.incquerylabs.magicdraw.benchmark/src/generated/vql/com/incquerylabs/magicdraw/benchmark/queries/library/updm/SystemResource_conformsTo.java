...
public final class SystemResource_conformsTo extends BaseGeneratedEMFQuerySpecification<SystemResource_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_conformsTo.Match)) {
          SystemResource_conformsTo.Match other = (SystemResource_conformsTo.Match) obj;
    ...
    @Override
    public SystemResource_conformsTo specification() {
      return SystemResource_conformsTo.instance();
    }
     ...
     * 
     */
    public static SystemResource_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_conformsTo.Match {
    ...
    private static final class Immutable extends SystemResource_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_conformsTo.Match> processor) {
     ...
     * 
     */
    public SystemResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_conformsTo.Match partialMatch) {
    ...
    @Override
    protected SystemResource_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_conformsTo.Matcher> querySpecification() {
      return SystemResource_conformsTo.instance();
    }
  }
  
  private SystemResource_conformsTo() {
   ...
   * 
   */
  public static SystemResource_conformsTo instance() {
    try{
  ...
  @Override
  protected SystemResource_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_conformsTo.Matcher instantiate() {
    return SystemResource_conformsTo.Matcher.create();
  }
  
  @Override
  public SystemResource_conformsTo.Match newEmptyMatch() {
    return SystemResource_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_conformsTo.Match newMatch(final Object... parameters) {
    return SystemResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_conformsTo INSTANCE = new SystemResource_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
