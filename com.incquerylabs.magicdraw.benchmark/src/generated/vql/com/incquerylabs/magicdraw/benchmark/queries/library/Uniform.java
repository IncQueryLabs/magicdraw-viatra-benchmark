 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "Uniform");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Uniform extends BaseGeneratedEMFQuerySpecification<Uniform.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Uniform pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Uniform";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Uniform pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Uniform} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Uniform#instance()}.
   * 
