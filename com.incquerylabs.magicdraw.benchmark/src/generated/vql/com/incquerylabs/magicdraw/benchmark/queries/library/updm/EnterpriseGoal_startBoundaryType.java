...
public final class EnterpriseGoal_startBoundaryType extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_startBoundaryType.Match)) {
          EnterpriseGoal_startBoundaryType.Match other = (EnterpriseGoal_startBoundaryType.Match) obj;
    ...
    @Override
    public EnterpriseGoal_startBoundaryType specification() {
      return EnterpriseGoal_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_startBoundaryType.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseGoal_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseGoal_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseGoal_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseGoal_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_startBoundaryType.Matcher> querySpecification() {
      return EnterpriseGoal_startBoundaryType.instance();
    }
  }
  
  private EnterpriseGoal_startBoundaryType() {
   ...
   * 
   */
  public static EnterpriseGoal_startBoundaryType instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_startBoundaryType.Matcher instantiate() {
    return EnterpriseGoal_startBoundaryType.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_startBoundaryType.Match newEmptyMatch() {
    return EnterpriseGoal_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_startBoundaryType.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_startBoundaryType INSTANCE = new EnterpriseGoal_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
