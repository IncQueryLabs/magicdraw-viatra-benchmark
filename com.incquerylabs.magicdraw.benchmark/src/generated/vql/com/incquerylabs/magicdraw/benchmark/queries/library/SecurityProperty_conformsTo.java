...
public final class SecurityProperty_conformsTo extends BaseGeneratedEMFQuerySpecification<SecurityProperty_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityProperty_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public SecurityProperty_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityProperty_conformsTo.Match)) {
          SecurityProperty_conformsTo.Match other = (SecurityProperty_conformsTo.Match) obj;
    ...
    @Override
    public SecurityProperty_conformsTo specification() {
      return SecurityProperty_conformsTo.instance();
    }
     ...
     * 
     */
    public static SecurityProperty_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityProperty_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityProperty_conformsTo.Match {
    ...
    private static final class Immutable extends SecurityProperty_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see SecurityProperty_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityProperty_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static SecurityProperty_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityProperty_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityProperty_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityProperty_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityProperty_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityProperty_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super SecurityProperty_conformsTo.Match> processor) {
     ...
     * 
     */
    public SecurityProperty_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return SecurityProperty_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final SecurityProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final SecurityProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityProperty_conformsTo.Match partialMatch) {
    ...
    @Override
    protected SecurityProperty_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityProperty_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityProperty_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityProperty_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityProperty_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityProperty_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityProperty_conformsTo.Matcher> querySpecification() {
      return SecurityProperty_conformsTo.instance();
    }
  }
  
  private SecurityProperty_conformsTo() {
   ...
   * 
   */
  public static SecurityProperty_conformsTo instance() {
    try{
  ...
  @Override
  protected SecurityProperty_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityProperty_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public SecurityProperty_conformsTo.Matcher instantiate() {
    return SecurityProperty_conformsTo.Matcher.create();
  }
  
  @Override
  public SecurityProperty_conformsTo.Match newEmptyMatch() {
    return SecurityProperty_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityProperty_conformsTo.Match newMatch(final Object... parameters) {
    return SecurityProperty_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityProperty_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityProperty_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityProperty_conformsTo INSTANCE = new SecurityProperty_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityProperty_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
