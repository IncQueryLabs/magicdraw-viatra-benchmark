...
public final class CapabilityConfiguration_actsUpon extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_actsUpon.Match)) {
          CapabilityConfiguration_actsUpon.Match other = (CapabilityConfiguration_actsUpon.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_actsUpon specification() {
      return CapabilityConfiguration_actsUpon.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_actsUpon.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_actsUpon.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_actsUpon.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_actsUpon.Matcher> querySpecification() {
      return CapabilityConfiguration_actsUpon.instance();
    }
  }
  
  private CapabilityConfiguration_actsUpon() {
   ...
   * 
   */
  public static CapabilityConfiguration_actsUpon instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_actsUpon.Matcher instantiate() {
    return CapabilityConfiguration_actsUpon.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_actsUpon.Match newEmptyMatch() {
    return CapabilityConfiguration_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_actsUpon.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_actsUpon INSTANCE = new CapabilityConfiguration_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
