...
public final class ExternalTuple extends BaseGeneratedEMFQuerySpecification<ExternalTuple.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTuple.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTuple.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTuple.Match)) {
          ExternalTuple.Match other = (ExternalTuple.Match) obj;
    ...
    @Override
    public ExternalTuple specification() {
      return ExternalTuple.instance();
    }
     ...
     * 
     */
    public static ExternalTuple.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTuple.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ExternalTuple.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ExternalTuple.Match {
    ...
    private static final class Immutable extends ExternalTuple.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTuple.Match> {
    /**
     ...
     * 
     */
    public static ExternalTuple.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTuple.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTuple.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTuple.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ExternalTuple.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ExternalTuple.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ExternalTuple.Match> processor) {
     ...
     * 
     */
    public ExternalTuple.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ExternalTuple.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTuple.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTuple.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ExternalTuple.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ExternalTuple.Match partialMatch) {
    ...
    @Override
    protected ExternalTuple.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTuple.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ExternalTuple.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTuple.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTuple.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTuple.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTuple.Matcher> querySpecification() {
      return ExternalTuple.instance();
    }
  }
  
  private ExternalTuple() {
   ...
   * 
   */
  public static ExternalTuple instance() {
    try{
  ...
  @Override
  protected ExternalTuple.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTuple.Matcher.on(engine);
  }
  
  @Override
  public ExternalTuple.Matcher instantiate() {
    return ExternalTuple.Matcher.create();
  }
  
  @Override
  public ExternalTuple.Match newEmptyMatch() {
    return ExternalTuple.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTuple.Match newMatch(final Object... parameters) {
    return ExternalTuple.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTuple} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTuple#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTuple INSTANCE = new ExternalTuple();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTuple.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ExternalTuple");
