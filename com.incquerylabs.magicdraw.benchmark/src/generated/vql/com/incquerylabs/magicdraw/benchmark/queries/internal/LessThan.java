 ...
 *         <code><pre>
 *         private pattern
 *         lessThan(op1 : LiteralUnlimitedNatural, op2 : LiteralUnlimitedNatural) {
...
public final class LessThan extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private LessThan() {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.internal.LessThan (visibility: PUBLIC, simpleName: LessThan, identifier: com.incquerylabs.magicdraw.benchmark.queries.internal.LessThan, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LessThan.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.lessThan";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public String getShortDescription() {
                  return "Expression evaluation from pattern lessThan";
              }
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public Object evaluateExpression(IValueProvider provider) throws Exception {
                  ...
                  return evaluateExpression_1_2(value1, value2);
              }
          },  null); 
          bodies.add(body);
      }
      {
          ...
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public Object evaluateExpression(IValueProvider provider) throws Exception {
                  Integer value1 = (Integer) provider.getValue("value1");
                  return evaluateExpression_2_1(value1);
              }
          },  null); 
          // 	check(value2 == - 1)
          new ExpressionEvaluation(body, new IExpressionEvaluator() {
              ...
              public Object evaluateExpression(IValueProvider provider) throws Exception {
                  Integer value2 = (Integer) provider.getValue("value2");
                  return evaluateExpression_2_2(value2);
              }
          },  null); 
          bodies.add(body);
      }
  ...
  private static boolean evaluateExpression_1_2(final Integer value1, final Integer value2) {
    boolean _lessThan = (value1.compareTo(value2) < 0);
    return _lessThan;
  }
  
  private static boolean evaluateExpression_2_1(final Integer value1) {
    return ((value1).intValue() >= 0);
  }
  
  private static boolean evaluateExpression_2_2(final Integer value2) {
    return ((value2).intValue() == (-1));
  }
}
