...
public final class ResourceParameter extends BaseGeneratedEMFQuerySpecification<ResourceParameter.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceParameter pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceParameter";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceParameter.Match.parameterNames;
    }
    ...
    @Override
    public ResourceParameter.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceParameter.Match)) {
          ResourceParameter.Match other = (ResourceParameter.Match) obj;
    ...
    @Override
    public ResourceParameter specification() {
      return ResourceParameter.instance();
    }
     ...
     * 
     */
    public static ResourceParameter.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceParameter.Match newMutableMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResourceParameter.Match newMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResourceParameter.Match {
    ...
    private static final class Immutable extends ResourceParameter.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceParameter pattern,
   ...
   * 
   * @see Match
   * @see ResourceParameter
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceParameter.Match> {
    /**
     ...
     * 
     */
    public static ResourceParameter.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceParameter.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceParameter.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceParameter.Match> getAllMatches(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResourceParameter.Match> streamAllMatches(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResourceParameter.Match> getOneArbitraryMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResourceParameter.Match> processor) {
     ...
     * 
     */
    public ResourceParameter.Match newMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResourceParameter.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Parameter> streamAllValuesOfelement(final ResourceParameter.Match partialMatch) {
     ...
     * 
     */
    public Set<Parameter> getAllValuesOfelement(final ResourceParameter.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResourceParameter.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResourceParameter.Match partialMatch) {
    ...
    @Override
    protected ResourceParameter.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceParameter.Match.newMatch((Parameter) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResourceParameter.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceParameter.Match.newMatch((Parameter) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceParameter.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceParameter.Match.newMutableMatch((Parameter) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceParameter.Matcher> querySpecification() {
      return ResourceParameter.instance();
    }
  }
   ...
   * 
   */
  public static ResourceParameter instance() {
    try{
  ...
  @Override
  protected ResourceParameter.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceParameter.Matcher.on(engine);
  }
  
  @Override
  public ResourceParameter.Matcher instantiate() {
    return ResourceParameter.Matcher.create();
  }
  
  @Override
  public ResourceParameter.Match newEmptyMatch() {
    return ResourceParameter.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceParameter.Match newMatch(final Object... parameters) {
    return ResourceParameter.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceParameter} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceParameter#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceParameter INSTANCE = new ResourceParameter();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceParameter.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ResourceParameter")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ResourceParameter");
