...
public final class TechnicalStandard_propertySet extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_propertySet.Match)) {
          TechnicalStandard_propertySet.Match other = (TechnicalStandard_propertySet.Match) obj;
    ...
    @Override
    public TechnicalStandard_propertySet specification() {
      return TechnicalStandard_propertySet.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static TechnicalStandard_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TechnicalStandard_propertySet.Match {
    ...
    private static final class Immutable extends TechnicalStandard_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_propertySet pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_propertySet.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TechnicalStandard_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TechnicalStandard_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super TechnicalStandard_propertySet.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return TechnicalStandard_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TechnicalStandard_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TechnicalStandard_propertySet.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TechnicalStandard_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_propertySet.Matcher> querySpecification() {
      return TechnicalStandard_propertySet.instance();
    }
  }
  
  private TechnicalStandard_propertySet() {
   ...
   * 
   */
  public static TechnicalStandard_propertySet instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_propertySet.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_propertySet.Matcher instantiate() {
    return TechnicalStandard_propertySet.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_propertySet.Match newEmptyMatch() {
    return TechnicalStandard_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_propertySet.Match newMatch(final Object... parameters) {
    return TechnicalStandard_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_propertySet INSTANCE = new TechnicalStandard_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
