...
public final class FunctionalStandard_retiredDate extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_retiredDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_retiredDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_retiredDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_retiredDate.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_retiredDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_retiredDate.Match)) {
          FunctionalStandard_retiredDate.Match other = (FunctionalStandard_retiredDate.Match) obj;
    ...
    @Override
    public FunctionalStandard_retiredDate specification() {
      return FunctionalStandard_retiredDate.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_retiredDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_retiredDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static FunctionalStandard_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalStandard_retiredDate.Match {
    ...
    private static final class Immutable extends FunctionalStandard_retiredDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_retiredDate pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_retiredDate
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_retiredDate.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_retiredDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_retiredDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_retiredDate.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_retiredDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FunctionalStandard_retiredDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FunctionalStandard_retiredDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super FunctionalStandard_retiredDate.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return FunctionalStandard_retiredDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final FunctionalStandard_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final FunctionalStandard_retiredDate.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_retiredDate.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalStandard_retiredDate.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_retiredDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_retiredDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_retiredDate.Matcher> querySpecification() {
      return FunctionalStandard_retiredDate.instance();
    }
  }
  
  private FunctionalStandard_retiredDate() {
   ...
   * 
   */
  public static FunctionalStandard_retiredDate instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_retiredDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_retiredDate.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_retiredDate.Matcher instantiate() {
    return FunctionalStandard_retiredDate.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_retiredDate.Match newEmptyMatch() {
    return FunctionalStandard_retiredDate.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_retiredDate.Match newMatch(final Object... parameters) {
    return FunctionalStandard_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_retiredDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_retiredDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_retiredDate INSTANCE = new FunctionalStandard_retiredDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_retiredDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "retiredDate");
