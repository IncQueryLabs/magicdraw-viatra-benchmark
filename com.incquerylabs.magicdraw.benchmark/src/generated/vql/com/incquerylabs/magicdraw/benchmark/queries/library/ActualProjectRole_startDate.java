...
public final class ActualProjectRole_startDate extends BaseGeneratedEMFQuerySpecification<ActualProjectRole_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectRole_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectRole_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectRole_startDate.Match)) {
          ActualProjectRole_startDate.Match other = (ActualProjectRole_startDate.Match) obj;
    ...
    @Override
    public ActualProjectRole_startDate specification() {
      return ActualProjectRole_startDate.instance();
    }
     ...
     * 
     */
    public static ActualProjectRole_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectRole_startDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProjectRole_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProjectRole_startDate.Match {
    ...
    private static final class Immutable extends ActualProjectRole_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole_startDate pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectRole_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectRole_startDate.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectRole_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectRole_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectRole_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectRole_startDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProjectRole_startDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProjectRole_startDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProjectRole_startDate.Match> processor) {
     ...
     * 
     */
    public ActualProjectRole_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProjectRole_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProjectRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProjectRole_startDate.Match partialMatch) {
    ...
    @Override
    protected ActualProjectRole_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectRole_startDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProjectRole_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectRole_startDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectRole_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectRole_startDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectRole_startDate.Matcher> querySpecification() {
      return ActualProjectRole_startDate.instance();
    }
  }
  
  private ActualProjectRole_startDate() {
   ...
   * 
   */
  public static ActualProjectRole_startDate instance() {
    try{
  ...
  @Override
  protected ActualProjectRole_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectRole_startDate.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectRole_startDate.Matcher instantiate() {
    return ActualProjectRole_startDate.Matcher.create();
  }
  
  @Override
  public ActualProjectRole_startDate.Match newEmptyMatch() {
    return ActualProjectRole_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectRole_startDate.Match newMatch(final Object... parameters) {
    return ActualProjectRole_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectRole_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectRole_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectRole_startDate INSTANCE = new ActualProjectRole_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectRole_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
