...
public final class OperationalPerformer_URI extends BaseGeneratedEMFQuerySpecification<OperationalPerformer_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalPerformer_URI.Match.parameterNames;
    }
    ...
    @Override
    public OperationalPerformer_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalPerformer_URI.Match)) {
          OperationalPerformer_URI.Match other = (OperationalPerformer_URI.Match) obj;
    ...
    @Override
    public OperationalPerformer_URI specification() {
      return OperationalPerformer_URI.instance();
    }
     ...
     * 
     */
    public static OperationalPerformer_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalPerformer_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static OperationalPerformer_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalPerformer_URI.Match {
    ...
    private static final class Immutable extends OperationalPerformer_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_URI pattern,
   ...
   * 
   * @see Match
   * @see OperationalPerformer_URI
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalPerformer_URI.Match> {
    /**
     ...
     * 
     */
    public static OperationalPerformer_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalPerformer_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalPerformer_URI.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalPerformer_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<OperationalPerformer_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<OperationalPerformer_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super OperationalPerformer_URI.Match> processor) {
     ...
     * 
     */
    public OperationalPerformer_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return OperationalPerformer_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalPerformer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalPerformer_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final OperationalPerformer_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final OperationalPerformer_URI.Match partialMatch) {
    ...
    @Override
    protected OperationalPerformer_URI.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalPerformer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalPerformer_URI.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalPerformer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalPerformer_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalPerformer_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalPerformer_URI.Matcher> querySpecification() {
      return OperationalPerformer_URI.instance();
    }
  }
  
  private OperationalPerformer_URI() {
   ...
   * 
   */
  public static OperationalPerformer_URI instance() {
    try{
  ...
  @Override
  protected OperationalPerformer_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalPerformer_URI.Matcher.on(engine);
  }
  
  @Override
  public OperationalPerformer_URI.Matcher instantiate() {
    return OperationalPerformer_URI.Matcher.create();
  }
  
  @Override
  public OperationalPerformer_URI.Match newEmptyMatch() {
    return OperationalPerformer_URI.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalPerformer_URI.Match newMatch(final Object... parameters) {
    return OperationalPerformer_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalPerformer_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalPerformer_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalPerformer_URI INSTANCE = new OperationalPerformer_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalPerformer_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
