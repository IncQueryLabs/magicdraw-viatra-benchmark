...
public final class AllocateNotSingleClient extends BaseGeneratedEMFQuerySpecification<AllocateNotSingleClient.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.AllocateNotSingleClient (visibility: PUBLIC, simpleName: AllocateNotSingleClient, identifier: com.incquerylabs.magicdraw.benchmark.queries.AllocateNotSingleClient, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    private class EmbeddedQuery909539440 extends BaseGeneratedEMFPQuery {
      ...
      public EmbeddedQuery909539440() {
        super(PVisibility.EMBEDDED);
      }
      
      @Override
      public String getFullyQualifiedName() {
        return GeneratedPQuery.this.getFullyQualifiedName() + "$909539440";
      }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	clients == count Abstraction.client(abstraction, _)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new PatternMatchCounter(body, Tuples.flatTupleOf(var_abstraction, var___1_), new AllocateNotSingleClient.GeneratedPQuery.EmbeddedQuery909539440(), var__virtual_0_);
