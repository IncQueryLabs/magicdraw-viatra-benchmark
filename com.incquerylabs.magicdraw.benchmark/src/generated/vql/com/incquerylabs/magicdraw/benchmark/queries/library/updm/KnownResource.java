...
public final class KnownResource extends BaseGeneratedEMFQuerySpecification<KnownResource.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource.Match)) {
          KnownResource.Match other = (KnownResource.Match) obj;
    ...
    @Override
    public KnownResource specification() {
      return KnownResource.instance();
    }
     ...
     * 
     */
    public static KnownResource.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static KnownResource.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends KnownResource.Match {
    ...
    private static final class Immutable extends KnownResource.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource.Match> {
    /**
     ...
     * 
     */
    public static KnownResource.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<KnownResource.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<KnownResource.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super KnownResource.Match> processor) {
     ...
     * 
     */
    public KnownResource.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return KnownResource.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final KnownResource.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final KnownResource.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final KnownResource.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final KnownResource.Match partialMatch) {
    ...
    @Override
    protected KnownResource.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected KnownResource.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource.Matcher> querySpecification() {
      return KnownResource.instance();
    }
  }
   ...
   * 
   */
  public static KnownResource instance() {
    try{
  ...
  @Override
  protected KnownResource.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource.Matcher.on(engine);
  }
  
  @Override
  public KnownResource.Matcher instantiate() {
    return KnownResource.Matcher.create();
  }
  
  @Override
  public KnownResource.Match newEmptyMatch() {
    return KnownResource.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource.Match newMatch(final Object... parameters) {
    return KnownResource.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource INSTANCE = new KnownResource();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "KnownResource");
