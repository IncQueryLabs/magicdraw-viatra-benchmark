...
public final class Function extends BaseGeneratedEMFQuerySpecification<Function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Function";
    }
    
    @Override
    public List<String> parameterNames() {
      return Function.Match.parameterNames;
    }
    ...
    @Override
    public Function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Function.Match)) {
          Function.Match other = (Function.Match) obj;
     ...
     * 
     */
    public static Function.Match newEmptyMatch() {
     ...
     * 
     */
    public static Function.Match newMutableMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Function.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Function.Match {
    ...
    private static final class Immutable extends Function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Function pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Function.Match> {
    /**
     ...
     * 
     */
    public static Function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Function.Matcher.class);
     ...
     * 
     */
    public Collection<Function.Match> getAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Function.Match> streamAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Function.Match> getOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Function.Match> processor) {
     ...
     * 
     */
    public Function.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Function.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Function.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Function.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Function.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Function.Match partialMatch) {
    ...
    @Override
    protected Function.Match tupleToMatch(final Tuple t) {
      try {
          return Function.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Function.Match arrayToMatch(final Object[] match) {
      try {
          return Function.Match.newMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Function.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Function.Matcher> querySpecification() {
      return Function.instance();
    }
  }
  ...
  @Override
  protected Function.Matcher instantiate(final ViatraQueryEngine engine) {
    return Function.Matcher.on(engine);
  }
  
  @Override
  public Function.Matcher instantiate() {
    return Function.Matcher.create();
  }
  
  @Override
  public Function.Match newEmptyMatch() {
    return Function.Match.newEmptyMatch();
  }
  
  @Override
  public Function.Match newMatch(final Object... parameters) {
    return Function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Function#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Function")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Function");
