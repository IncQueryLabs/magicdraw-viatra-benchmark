...
public final class SecurityControlFamily_DerivedFrom extends BaseGeneratedEMFQuerySpecification<SecurityControlFamily_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControlFamily_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControlFamily_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControlFamily_DerivedFrom.Match)) {
          SecurityControlFamily_DerivedFrom.Match other = (SecurityControlFamily_DerivedFrom.Match) obj;
    ...
    @Override
    public SecurityControlFamily_DerivedFrom specification() {
      return SecurityControlFamily_DerivedFrom.instance();
    }
     ...
     * 
     */
    public static SecurityControlFamily_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControlFamily_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityControlFamily_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControlFamily_DerivedFrom.Match {
    ...
    private static final class Immutable extends SecurityControlFamily_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see SecurityControlFamily_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControlFamily_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static SecurityControlFamily_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControlFamily_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControlFamily_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControlFamily_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityControlFamily_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityControlFamily_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityControlFamily_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public SecurityControlFamily_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityControlFamily_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControlFamily_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControlFamily_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityControlFamily_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityControlFamily_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected SecurityControlFamily_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControlFamily_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControlFamily_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControlFamily_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControlFamily_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControlFamily_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControlFamily_DerivedFrom.Matcher> querySpecification() {
      return SecurityControlFamily_DerivedFrom.instance();
    }
  }
  
  private SecurityControlFamily_DerivedFrom() {
   ...
   * 
   */
  public static SecurityControlFamily_DerivedFrom instance() {
    try{
  ...
  @Override
  protected SecurityControlFamily_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControlFamily_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public SecurityControlFamily_DerivedFrom.Matcher instantiate() {
    return SecurityControlFamily_DerivedFrom.Matcher.create();
  }
  
  @Override
  public SecurityControlFamily_DerivedFrom.Match newEmptyMatch() {
    return SecurityControlFamily_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControlFamily_DerivedFrom.Match newMatch(final Object... parameters) {
    return SecurityControlFamily_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControlFamily_DerivedFrom} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControlFamily_DerivedFrom#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControlFamily_DerivedFrom INSTANCE = new SecurityControlFamily_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControlFamily_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
