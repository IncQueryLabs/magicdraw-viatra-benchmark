...
public final class ResourceArchitecture_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<ResourceArchitecture_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArchitecture_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArchitecture_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArchitecture_requiredEnvironment.Match)) {
          ResourceArchitecture_requiredEnvironment.Match other = (ResourceArchitecture_requiredEnvironment.Match) obj;
    ...
    @Override
    public ResourceArchitecture_requiredEnvironment specification() {
      return ResourceArchitecture_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static ResourceArchitecture_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArchitecture_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArchitecture_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArchitecture_requiredEnvironment.Match {
    ...
    private static final class Immutable extends ResourceArchitecture_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ResourceArchitecture_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArchitecture_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ResourceArchitecture_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArchitecture_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArchitecture_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArchitecture_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArchitecture_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArchitecture_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArchitecture_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public ResourceArchitecture_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArchitecture_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArchitecture_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArchitecture_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArchitecture_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArchitecture_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected ResourceArchitecture_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArchitecture_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArchitecture_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArchitecture_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArchitecture_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArchitecture_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArchitecture_requiredEnvironment.Matcher> querySpecification() {
      return ResourceArchitecture_requiredEnvironment.instance();
    }
  }
  
  private ResourceArchitecture_requiredEnvironment() {
   ...
   * 
   */
  public static ResourceArchitecture_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected ResourceArchitecture_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArchitecture_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ResourceArchitecture_requiredEnvironment.Matcher instantiate() {
    return ResourceArchitecture_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public ResourceArchitecture_requiredEnvironment.Match newEmptyMatch() {
    return ResourceArchitecture_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArchitecture_requiredEnvironment.Match newMatch(final Object... parameters) {
    return ResourceArchitecture_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArchitecture_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArchitecture_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArchitecture_requiredEnvironment INSTANCE = new ResourceArchitecture_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArchitecture_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
