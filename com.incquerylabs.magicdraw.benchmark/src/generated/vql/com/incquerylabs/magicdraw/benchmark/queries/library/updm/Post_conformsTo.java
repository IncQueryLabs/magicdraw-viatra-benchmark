...
public final class Post_conformsTo extends BaseGeneratedEMFQuerySpecification<Post_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Post_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_conformsTo.Match)) {
          Post_conformsTo.Match other = (Post_conformsTo.Match) obj;
    ...
    @Override
    public Post_conformsTo specification() {
      return Post_conformsTo.instance();
    }
     ...
     * 
     */
    public static Post_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_conformsTo.Match {
    ...
    private static final class Immutable extends Post_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Post_conformsTo pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Post_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Post_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Post_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_conformsTo.Match> processor) {
     ...
     * 
     */
    public Post_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Post_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Post_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Post_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_conformsTo.Matcher> querySpecification() {
      return Post_conformsTo.instance();
    }
  }
  
  private Post_conformsTo() {
   ...
   * 
   */
  public static Post_conformsTo instance() {
    try{
  ...
  @Override
  protected Post_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Post_conformsTo.Matcher instantiate() {
    return Post_conformsTo.Matcher.create();
  }
  
  @Override
  public Post_conformsTo.Match newEmptyMatch() {
    return Post_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Post_conformsTo.Match newMatch(final Object... parameters) {
    return Post_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_conformsTo INSTANCE = new Post_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
