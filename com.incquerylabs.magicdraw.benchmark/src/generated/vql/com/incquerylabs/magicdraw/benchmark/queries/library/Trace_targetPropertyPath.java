...
public final class Trace_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Trace_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Trace_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Trace_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Trace_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Trace_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Trace_targetPropertyPath.Match)) {
          Trace_targetPropertyPath.Match other = (Trace_targetPropertyPath.Match) obj;
    ...
    @Override
    public Trace_targetPropertyPath specification() {
     ...
     * 
     */
    public static Trace_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Trace_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Trace_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Trace_targetPropertyPath.Match {
    ...
    private static final class Immutable extends Trace_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Trace_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Trace_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Trace_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Trace_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Trace_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Trace_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Trace_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Trace_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Trace_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Trace_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public Trace_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Trace_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Trace_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Trace_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Trace_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Trace_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected Trace_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Trace_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Trace_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Trace_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Trace_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Trace_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Trace_targetPropertyPath.Matcher> querySpecification() {
      return Trace_targetPropertyPath.instance();
    }
  }
  
  private Trace_targetPropertyPath() {
   ...
   * 
   */
  public static Trace_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected Trace_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Trace_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Trace_targetPropertyPath.Matcher instantiate() {
    return Trace_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public Trace_targetPropertyPath.Match newEmptyMatch() {
    return Trace_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Trace_targetPropertyPath.Match newMatch(final Object... parameters) {
    return Trace_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Trace_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Trace_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Trace_targetPropertyPath INSTANCE = new Trace_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Trace_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
