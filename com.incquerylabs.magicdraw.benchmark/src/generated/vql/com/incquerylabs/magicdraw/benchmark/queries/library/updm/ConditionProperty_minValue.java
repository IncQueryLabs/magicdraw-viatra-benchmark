...
public final class ConditionProperty_minValue extends BaseGeneratedEMFQuerySpecification<ConditionProperty_minValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_minValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_minValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConditionProperty_minValue.Match.parameterNames;
    }
    ...
    @Override
    public ConditionProperty_minValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConditionProperty_minValue.Match)) {
          ConditionProperty_minValue.Match other = (ConditionProperty_minValue.Match) obj;
    ...
    @Override
    public ConditionProperty_minValue specification() {
      return ConditionProperty_minValue.instance();
    }
     ...
     * 
     */
    public static ConditionProperty_minValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConditionProperty_minValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ConditionProperty_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ConditionProperty_minValue.Match {
    ...
    private static final class Immutable extends ConditionProperty_minValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConditionProperty_minValue pattern,
   ...
   * 
   * @see Match
   * @see ConditionProperty_minValue
   * 
   */
  public static class Matcher extends BaseMatcher<ConditionProperty_minValue.Match> {
    /**
     ...
     * 
     */
    public static ConditionProperty_minValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConditionProperty_minValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConditionProperty_minValue.Matcher.class);
     ...
     * 
     */
    public Collection<ConditionProperty_minValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ConditionProperty_minValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ConditionProperty_minValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ConditionProperty_minValue.Match> processor) {
     ...
     * 
     */
    public ConditionProperty_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ConditionProperty_minValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConditionProperty_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConditionProperty_minValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ConditionProperty_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ConditionProperty_minValue.Match partialMatch) {
    ...
    @Override
    protected ConditionProperty_minValue.Match tupleToMatch(final Tuple t) {
      try {
          return ConditionProperty_minValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ConditionProperty_minValue.Match arrayToMatch(final Object[] match) {
      try {
          return ConditionProperty_minValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConditionProperty_minValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConditionProperty_minValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConditionProperty_minValue.Matcher> querySpecification() {
      return ConditionProperty_minValue.instance();
    }
  }
  
  private ConditionProperty_minValue() {
   ...
   * 
   */
  public static ConditionProperty_minValue instance() {
    try{
  ...
  @Override
  protected ConditionProperty_minValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConditionProperty_minValue.Matcher.on(engine);
  }
  
  @Override
  public ConditionProperty_minValue.Matcher instantiate() {
    return ConditionProperty_minValue.Matcher.create();
  }
  
  @Override
  public ConditionProperty_minValue.Match newEmptyMatch() {
    return ConditionProperty_minValue.Match.newEmptyMatch();
  }
  
  @Override
  public ConditionProperty_minValue.Match newMatch(final Object... parameters) {
    return ConditionProperty_minValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConditionProperty_minValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConditionProperty_minValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConditionProperty_minValue INSTANCE = new ConditionProperty_minValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConditionProperty_minValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
