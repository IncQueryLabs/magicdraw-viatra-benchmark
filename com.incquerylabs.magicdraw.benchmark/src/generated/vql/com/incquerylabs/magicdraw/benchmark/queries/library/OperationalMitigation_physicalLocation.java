...
public final class OperationalMitigation_physicalLocation extends BaseGeneratedEMFQuerySpecification<OperationalMitigation_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalMitigation_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public OperationalMitigation_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalMitigation_physicalLocation.Match)) {
          OperationalMitigation_physicalLocation.Match other = (OperationalMitigation_physicalLocation.Match) obj;
    ...
    @Override
    public OperationalMitigation_physicalLocation specification() {
      return OperationalMitigation_physicalLocation.instance();
    }
     ...
     * 
     */
    public static OperationalMitigation_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalMitigation_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalMitigation_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalMitigation_physicalLocation.Match {
    ...
    private static final class Immutable extends OperationalMitigation_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalMitigation_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see OperationalMitigation_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalMitigation_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static OperationalMitigation_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalMitigation_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalMitigation_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalMitigation_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalMitigation_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalMitigation_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalMitigation_physicalLocation.Match> processor) {
     ...
     * 
     */
    public OperationalMitigation_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalMitigation_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalMitigation_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalMitigation_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalMitigation_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalMitigation_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected OperationalMitigation_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalMitigation_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalMitigation_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalMitigation_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalMitigation_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalMitigation_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalMitigation_physicalLocation.Matcher> querySpecification() {
      return OperationalMitigation_physicalLocation.instance();
    }
  }
  
  private OperationalMitigation_physicalLocation() {
   ...
   * 
   */
  public static OperationalMitigation_physicalLocation instance() {
    try{
  ...
  @Override
  protected OperationalMitigation_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalMitigation_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public OperationalMitigation_physicalLocation.Matcher instantiate() {
    return OperationalMitigation_physicalLocation.Matcher.create();
  }
  
  @Override
  public OperationalMitigation_physicalLocation.Match newEmptyMatch() {
    return OperationalMitigation_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalMitigation_physicalLocation.Match newMatch(final Object... parameters) {
    return OperationalMitigation_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalMitigation_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalMitigation_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalMitigation_physicalLocation INSTANCE = new OperationalMitigation_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalMitigation_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
