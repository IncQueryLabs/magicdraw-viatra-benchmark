...
public final class AssociationBlockOfConnector extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private AssociationBlockOfConnector() {
   ...
   * 
   */
  public static AssociationBlockOfConnector instance() {
    try{
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.internal.AssociationBlockOfConnector (visibility: PUBLIC, simpleName: AssociationBlockOfConnector, identifier: com.incquerylabs.magicdraw.benchmark.queries.internal.AssociationBlockOfConnector, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class LazyHolder {
    private static final AssociationBlockOfConnector INSTANCE = new AssociationBlockOfConnector();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final AssociationBlockOfConnector.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public String getFullyQualifiedName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.associationBlockOfConnector";
    }
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	Association(type)
          new TypeConstraint(body, Tuples.flatTupleOf(var_type), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "Association")));
          // 	find sysml.Block(type, _)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_type, var___0_), Block.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
