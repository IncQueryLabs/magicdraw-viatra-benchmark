...
public final class AssociationBlockOfConnector extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  ...
  /**
   * Inner class allowing the singleton instance of {@link AssociationBlockOfConnector} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link AssociationBlockOfConnector#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	Association(type)
          new TypeConstraint(body, Tuples.flatTupleOf(var_type), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Association")));
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.Block(type, _)
