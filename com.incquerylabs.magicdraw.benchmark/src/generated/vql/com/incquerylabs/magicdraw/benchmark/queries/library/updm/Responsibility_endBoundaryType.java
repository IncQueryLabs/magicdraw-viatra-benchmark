...
public final class Responsibility_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Responsibility_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_endBoundaryType.Match)) {
          Responsibility_endBoundaryType.Match other = (Responsibility_endBoundaryType.Match) obj;
    ...
    @Override
    public Responsibility_endBoundaryType specification() {
      return Responsibility_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Responsibility_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_endBoundaryType.Match {
    ...
    private static final class Immutable extends Responsibility_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Responsibility_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Responsibility_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_endBoundaryType.Matcher> querySpecification() {
      return Responsibility_endBoundaryType.instance();
    }
  }
  
  private Responsibility_endBoundaryType() {
   ...
   * 
   */
  public static Responsibility_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Responsibility_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_endBoundaryType.Matcher instantiate() {
    return Responsibility_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Responsibility_endBoundaryType.Match newEmptyMatch() {
    return Responsibility_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_endBoundaryType.Match newMatch(final Object... parameters) {
    return Responsibility_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_endBoundaryType INSTANCE = new Responsibility_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
