...
public final class CapableElement_endBoundaryType extends BaseGeneratedEMFQuerySpecification<CapableElement_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapableElement_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public CapableElement_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapableElement_endBoundaryType.Match)) {
          CapableElement_endBoundaryType.Match other = (CapableElement_endBoundaryType.Match) obj;
    ...
    @Override
    public CapableElement_endBoundaryType specification() {
      return CapableElement_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static CapableElement_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapableElement_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapableElement_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapableElement_endBoundaryType.Match {
    ...
    private static final class Immutable extends CapableElement_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see CapableElement_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<CapableElement_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static CapableElement_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapableElement_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapableElement_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<CapableElement_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapableElement_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapableElement_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapableElement_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public CapableElement_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapableElement_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapableElement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapableElement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapableElement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapableElement_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected CapableElement_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return CapableElement_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapableElement_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return CapableElement_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapableElement_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapableElement_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapableElement_endBoundaryType.Matcher> querySpecification() {
      return CapableElement_endBoundaryType.instance();
    }
  }
  
  private CapableElement_endBoundaryType() {
   ...
   * 
   */
  public static CapableElement_endBoundaryType instance() {
    try{
  ...
  @Override
  protected CapableElement_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapableElement_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public CapableElement_endBoundaryType.Matcher instantiate() {
    return CapableElement_endBoundaryType.Matcher.create();
  }
  
  @Override
  public CapableElement_endBoundaryType.Match newEmptyMatch() {
    return CapableElement_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public CapableElement_endBoundaryType.Match newMatch(final Object... parameters) {
    return CapableElement_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapableElement_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapableElement_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapableElement_endBoundaryType INSTANCE = new CapableElement_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapableElement_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
