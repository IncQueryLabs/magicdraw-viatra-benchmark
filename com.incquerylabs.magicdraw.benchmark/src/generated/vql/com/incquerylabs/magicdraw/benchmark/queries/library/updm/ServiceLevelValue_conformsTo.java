...
public final class ServiceLevelValue_conformsTo extends BaseGeneratedEMFQuerySpecification<ServiceLevelValue_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceLevelValue_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ServiceLevelValue_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceLevelValue_conformsTo.Match)) {
          ServiceLevelValue_conformsTo.Match other = (ServiceLevelValue_conformsTo.Match) obj;
    ...
    @Override
    public ServiceLevelValue_conformsTo specification() {
      return ServiceLevelValue_conformsTo.instance();
    }
     ...
     * 
     */
    public static ServiceLevelValue_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceLevelValue_conformsTo.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceLevelValue_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceLevelValue_conformsTo.Match {
    ...
    private static final class Immutable extends ServiceLevelValue_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceLevelValue_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ServiceLevelValue_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceLevelValue_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ServiceLevelValue_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceLevelValue_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceLevelValue_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceLevelValue_conformsTo.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceLevelValue_conformsTo.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceLevelValue_conformsTo.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ServiceLevelValue_conformsTo.Match> processor) {
     ...
     * 
     */
    public ServiceLevelValue_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return ServiceLevelValue_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ServiceLevelValue_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ServiceLevelValue_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceLevelValue_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceLevelValue_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ServiceLevelValue_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceLevelValue_conformsTo.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceLevelValue_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceLevelValue_conformsTo.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceLevelValue_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceLevelValue_conformsTo.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceLevelValue_conformsTo.Matcher> querySpecification() {
      return ServiceLevelValue_conformsTo.instance();
    }
  }
  
  private ServiceLevelValue_conformsTo() {
   ...
   * 
   */
  public static ServiceLevelValue_conformsTo instance() {
    try{
  ...
  @Override
  protected ServiceLevelValue_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceLevelValue_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ServiceLevelValue_conformsTo.Matcher instantiate() {
    return ServiceLevelValue_conformsTo.Matcher.create();
  }
  
  @Override
  public ServiceLevelValue_conformsTo.Match newEmptyMatch() {
    return ServiceLevelValue_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceLevelValue_conformsTo.Match newMatch(final Object... parameters) {
    return ServiceLevelValue_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceLevelValue_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceLevelValue_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceLevelValue_conformsTo INSTANCE = new ServiceLevelValue_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceLevelValue_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
