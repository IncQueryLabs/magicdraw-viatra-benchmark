...
public final class CapabilityForTask_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<CapabilityForTask_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityForTask_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityForTask_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityForTask_targetPropertyPath.Match)) {
          CapabilityForTask_targetPropertyPath.Match other = (CapabilityForTask_targetPropertyPath.Match) obj;
    ...
    @Override
    public CapabilityForTask_targetPropertyPath specification() {
      return CapabilityForTask_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static CapabilityForTask_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityForTask_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static CapabilityForTask_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityForTask_targetPropertyPath.Match {
    ...
    private static final class Immutable extends CapabilityForTask_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityForTask_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see CapabilityForTask_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityForTask_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static CapabilityForTask_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityForTask_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityForTask_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityForTask_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<CapabilityForTask_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<CapabilityForTask_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super CapabilityForTask_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public CapabilityForTask_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return CapabilityForTask_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CapabilityForTask_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CapabilityForTask_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final CapabilityForTask_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final CapabilityForTask_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected CapabilityForTask_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityForTask_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityForTask_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityForTask_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityForTask_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityForTask_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityForTask_targetPropertyPath.Matcher> querySpecification() {
      return CapabilityForTask_targetPropertyPath.instance();
    }
  }
  
  private CapabilityForTask_targetPropertyPath() {
   ...
   * 
   */
  public static CapabilityForTask_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected CapabilityForTask_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityForTask_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public CapabilityForTask_targetPropertyPath.Matcher instantiate() {
    return CapabilityForTask_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public CapabilityForTask_targetPropertyPath.Match newEmptyMatch() {
    return CapabilityForTask_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityForTask_targetPropertyPath.Match newMatch(final Object... parameters) {
    return CapabilityForTask_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityForTask_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityForTask_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityForTask_targetPropertyPath INSTANCE = new CapabilityForTask_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityForTask_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
