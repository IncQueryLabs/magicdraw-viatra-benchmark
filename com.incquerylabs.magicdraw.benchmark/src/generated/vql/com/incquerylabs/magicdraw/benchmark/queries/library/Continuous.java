...
public final class Continuous extends BaseGeneratedEMFQuerySpecification<Continuous.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Continuous pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Continuous";
    }
    
    @Override
    public List<String> parameterNames() {
      return Continuous.Match.parameterNames;
    }
    ...
    @Override
    public Continuous.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Continuous.Match)) {
          Continuous.Match other = (Continuous.Match) obj;
    ...
    @Override
    public Continuous specification() {
     ...
     * 
     */
    public static Continuous.Match newEmptyMatch() {
     ...
     * 
     */
    public static Continuous.Match newMutableMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Continuous.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Continuous.Match {
    ...
    private static final class Immutable extends Continuous.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Continuous pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Continuous.Match> {
    /**
     ...
     * 
     */
    public static Continuous.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Continuous.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Continuous.Matcher.class);
     ...
     * 
     */
    public Collection<Continuous.Match> getAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Continuous.Match> streamAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Continuous.Match> getOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype, final Consumer<? super Continuous.Match> processor) {
     ...
     * 
     */
    public Continuous.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
      return Continuous.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfElement(final Continuous.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfElement(final Continuous.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Continuous.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Continuous.Match partialMatch) {
    ...
    @Override
    protected Continuous.Match tupleToMatch(final Tuple t) {
      try {
          return Continuous.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Continuous.Match arrayToMatch(final Object[] match) {
      try {
          return Continuous.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Continuous.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Continuous.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Continuous.Matcher> querySpecification() {
      return Continuous.instance();
    }
  }
  ...
  @Override
  protected Continuous.Matcher instantiate(final ViatraQueryEngine engine) {
    return Continuous.Matcher.on(engine);
  }
  
  @Override
  public Continuous.Matcher instantiate() {
    return Continuous.Matcher.create();
  }
  
  @Override
  public Continuous.Match newEmptyMatch() {
    return Continuous.Match.newEmptyMatch();
  }
  
  @Override
  public Continuous.Match newMatch(final Object... parameters) {
    return Continuous.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Continuous} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Continuous#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Continuous INSTANCE = new Continuous();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Continuous.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Continuous");
