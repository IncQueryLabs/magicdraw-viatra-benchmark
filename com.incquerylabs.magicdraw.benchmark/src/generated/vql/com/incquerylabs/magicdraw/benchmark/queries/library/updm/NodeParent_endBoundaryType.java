...
public final class NodeParent_endBoundaryType extends BaseGeneratedEMFQuerySpecification<NodeParent_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_endBoundaryType.Match)) {
          NodeParent_endBoundaryType.Match other = (NodeParent_endBoundaryType.Match) obj;
    ...
    @Override
    public NodeParent_endBoundaryType specification() {
      return NodeParent_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static NodeParent_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeParent_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeParent_endBoundaryType.Match {
    ...
    private static final class Immutable extends NodeParent_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see NodeParent_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeParent_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeParent_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NodeParent_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public NodeParent_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NodeParent_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeParent_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeParent_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected NodeParent_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeParent_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_endBoundaryType.Matcher> querySpecification() {
      return NodeParent_endBoundaryType.instance();
    }
  }
  
  private NodeParent_endBoundaryType() {
   ...
   * 
   */
  public static NodeParent_endBoundaryType instance() {
    try{
  ...
  @Override
  protected NodeParent_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_endBoundaryType.Matcher instantiate() {
    return NodeParent_endBoundaryType.Matcher.create();
  }
  
  @Override
  public NodeParent_endBoundaryType.Match newEmptyMatch() {
    return NodeParent_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_endBoundaryType.Match newMatch(final Object... parameters) {
    return NodeParent_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_endBoundaryType INSTANCE = new NodeParent_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
