...
public final class WholeLifeEnterprise extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeEnterprise pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeEnterprise";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise.Match)) {
          WholeLifeEnterprise.Match other = (WholeLifeEnterprise.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise specification() {
      return WholeLifeEnterprise.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static WholeLifeEnterprise.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends WholeLifeEnterprise.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeEnterprise pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super WholeLifeEnterprise.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return WholeLifeEnterprise.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final WholeLifeEnterprise.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final WholeLifeEnterprise.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected WholeLifeEnterprise.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise.Matcher> querySpecification() {
      return WholeLifeEnterprise.instance();
    }
  }
  
  private WholeLifeEnterprise() {
   ...
   * 
   */
  public static WholeLifeEnterprise instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise.Matcher instantiate() {
    return WholeLifeEnterprise.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise.Match newEmptyMatch() {
    return WholeLifeEnterprise.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise INSTANCE = new WholeLifeEnterprise();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "WholeLifeEnterprise")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "WholeLifeEnterprise");
