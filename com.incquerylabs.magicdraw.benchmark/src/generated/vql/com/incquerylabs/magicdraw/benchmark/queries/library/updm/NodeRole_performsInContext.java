...
public final class NodeRole_performsInContext extends BaseGeneratedEMFQuerySpecification<NodeRole_performsInContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_performsInContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_performsInContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeRole_performsInContext.Match.parameterNames;
    }
    ...
    @Override
    public NodeRole_performsInContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeRole_performsInContext.Match)) {
          NodeRole_performsInContext.Match other = (NodeRole_performsInContext.Match) obj;
    ...
    @Override
    public NodeRole_performsInContext specification() {
      return NodeRole_performsInContext.instance();
    }
     ...
     * 
     */
    public static NodeRole_performsInContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeRole_performsInContext.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeRole_performsInContext.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeRole_performsInContext.Match {
    ...
    private static final class Immutable extends NodeRole_performsInContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_performsInContext pattern,
   ...
   * 
   * @see Match
   * @see NodeRole_performsInContext
   * 
   */
  public static class Matcher extends BaseMatcher<NodeRole_performsInContext.Match> {
    /**
     ...
     * 
     */
    public static NodeRole_performsInContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeRole_performsInContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeRole_performsInContext.Matcher.class);
     ...
     * 
     */
    public Collection<NodeRole_performsInContext.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeRole_performsInContext.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeRole_performsInContext.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super NodeRole_performsInContext.Match> processor) {
     ...
     * 
     */
    public NodeRole_performsInContext.Match newMatch(final Property pElement, final Element pValue) {
      return NodeRole_performsInContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final NodeRole_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final NodeRole_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeRole_performsInContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeRole_performsInContext.Match partialMatch) {
    ...
    @Override
    protected NodeRole_performsInContext.Match tupleToMatch(final Tuple t) {
      try {
          return NodeRole_performsInContext.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeRole_performsInContext.Match arrayToMatch(final Object[] match) {
      try {
          return NodeRole_performsInContext.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeRole_performsInContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeRole_performsInContext.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeRole_performsInContext.Matcher> querySpecification() {
      return NodeRole_performsInContext.instance();
    }
  }
  
  private NodeRole_performsInContext() {
   ...
   * 
   */
  public static NodeRole_performsInContext instance() {
    try{
  ...
  @Override
  protected NodeRole_performsInContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeRole_performsInContext.Matcher.on(engine);
  }
  
  @Override
  public NodeRole_performsInContext.Matcher instantiate() {
    return NodeRole_performsInContext.Matcher.create();
  }
  
  @Override
  public NodeRole_performsInContext.Match newEmptyMatch() {
    return NodeRole_performsInContext.Match.newEmptyMatch();
  }
  
  @Override
  public NodeRole_performsInContext.Match newMatch(final Object... parameters) {
    return NodeRole_performsInContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeRole_performsInContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeRole_performsInContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeRole_performsInContext INSTANCE = new NodeRole_performsInContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeRole_performsInContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find NodeRole(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), NodeRole.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "performsInContext", valuespec)
