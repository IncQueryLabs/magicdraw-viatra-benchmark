...
public final class Asset_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Asset_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Asset_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Asset_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Asset_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Asset_isEncapsulated.Match)) {
          Asset_isEncapsulated.Match other = (Asset_isEncapsulated.Match) obj;
    ...
    @Override
    public Asset_isEncapsulated specification() {
      return Asset_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Asset_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Asset_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Asset_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Asset_isEncapsulated.Match {
    ...
    private static final class Immutable extends Asset_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Asset_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Asset_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Asset_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Asset_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Asset_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Asset_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Asset_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Asset_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Asset_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Asset_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Asset_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Asset_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Asset_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Asset_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Asset_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Asset_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Asset_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Asset_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Asset_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Asset_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Asset_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Asset_isEncapsulated.Matcher> querySpecification() {
      return Asset_isEncapsulated.instance();
    }
  }
  
  private Asset_isEncapsulated() {
   ...
   * 
   */
  public static Asset_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Asset_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Asset_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Asset_isEncapsulated.Matcher instantiate() {
    return Asset_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Asset_isEncapsulated.Match newEmptyMatch() {
    return Asset_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Asset_isEncapsulated.Match newMatch(final Object... parameters) {
    return Asset_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Asset_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Asset_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Asset_isEncapsulated INSTANCE = new Asset_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Asset_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
