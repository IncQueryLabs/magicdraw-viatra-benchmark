 ...
 *         pattern QuantityKind_symbol(Element : PackageableElement, Value: java String) {
...
public final class QuantityKind_symbol extends BaseGeneratedEMFQuerySpecification<QuantityKind_symbol.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static QuantityKind_symbol.Match newMutableMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public static QuantityKind_symbol.Match newMatch(final PackageableElement pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<QuantityKind_symbol.Match> {
     ...
     * 
     */
    public Collection<QuantityKind_symbol.Match> getAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Stream<QuantityKind_symbol.Match> streamAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Optional<QuantityKind_symbol.Match> getOneArbitraryMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final String pValue, final Consumer<? super QuantityKind_symbol.Match> processor) {
     ...
     * 
     */
    public QuantityKind_symbol.Match newMatch(final PackageableElement pElement, final String pValue) {
      return QuantityKind_symbol.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final QuantityKind_symbol.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final QuantityKind_symbol.Match partialMatch) {
    ...
    protected QuantityKind_symbol.Match tupleToMatch(final Tuple t) {
      try {
          return QuantityKind_symbol.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected QuantityKind_symbol.Match arrayToMatch(final Object[] match) {
      try {
          return QuantityKind_symbol.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected QuantityKind_symbol.Match arrayToMatchMutable(final Object[] match) {
      try {
          return QuantityKind_symbol.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public QuantityKind_symbol.Match newMatch(final Object... parameters) {
    return QuantityKind_symbol.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (java.lang.String) parameters[1]);
  }
