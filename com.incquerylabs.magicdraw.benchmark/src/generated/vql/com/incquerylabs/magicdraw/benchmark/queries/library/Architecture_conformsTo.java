...
public final class Architecture_conformsTo extends BaseGeneratedEMFQuerySpecification<Architecture_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Architecture_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Architecture_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Architecture_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Architecture_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Architecture_conformsTo.Match)) {
          Architecture_conformsTo.Match other = (Architecture_conformsTo.Match) obj;
    ...
    @Override
    public Architecture_conformsTo specification() {
      return Architecture_conformsTo.instance();
    }
     ...
     * 
     */
    public static Architecture_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Architecture_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Architecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Architecture_conformsTo.Match {
    ...
    private static final class Immutable extends Architecture_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Architecture_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Architecture_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Architecture_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Architecture_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Architecture_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Architecture_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Architecture_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Architecture_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Architecture_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Architecture_conformsTo.Match> processor) {
     ...
     * 
     */
    public Architecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Architecture_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Architecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Architecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Architecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Architecture_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Architecture_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Architecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Architecture_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Architecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Architecture_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Architecture_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Architecture_conformsTo.Matcher> querySpecification() {
      return Architecture_conformsTo.instance();
    }
  }
  
  private Architecture_conformsTo() {
   ...
   * 
   */
  public static Architecture_conformsTo instance() {
    try{
  ...
  @Override
  protected Architecture_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Architecture_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Architecture_conformsTo.Matcher instantiate() {
    return Architecture_conformsTo.Matcher.create();
  }
  
  @Override
  public Architecture_conformsTo.Match newEmptyMatch() {
    return Architecture_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Architecture_conformsTo.Match newMatch(final Object... parameters) {
    return Architecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Architecture_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Architecture_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Architecture_conformsTo INSTANCE = new Architecture_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Architecture_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
