...
public final class Mission extends BaseGeneratedEMFQuerySpecification<Mission.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission";
    }
    
    @Override
    public List<String> parameterNames() {
      return Mission.Match.parameterNames;
    }
    ...
    @Override
    public Mission.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Mission.Match)) {
          Mission.Match other = (Mission.Match) obj;
     ...
     * 
     */
    public static Mission.Match newEmptyMatch() {
     ...
     * 
     */
    public static Mission.Match newMutableMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Mission.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Mission.Match {
    ...
    private static final class Immutable extends Mission.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Mission pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Mission.Match> {
    /**
     ...
     * 
     */
    public static Mission.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Mission.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Mission.Matcher.class);
     ...
     * 
     */
    public Collection<Mission.Match> getAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Mission.Match> streamAllMatches(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Mission.Match> getOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Mission.Match> processor) {
     ...
     * 
     */
    public Mission.Match newMatch(final Activity pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Mission.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Mission.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Mission.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Mission.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Mission.Match partialMatch) {
    ...
    @Override
    protected Mission.Match tupleToMatch(final Tuple t) {
      try {
          return Mission.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Mission.Match arrayToMatch(final Object[] match) {
      try {
          return Mission.Match.newMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Mission.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Mission.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Mission.Matcher> querySpecification() {
      return Mission.instance();
    }
  }
  ...
  @Override
  protected Mission.Matcher instantiate(final ViatraQueryEngine engine) {
    return Mission.Matcher.on(engine);
  }
  
  @Override
  public Mission.Matcher instantiate() {
    return Mission.Matcher.create();
  }
  
  @Override
  public Mission.Match newEmptyMatch() {
    return Mission.Match.newEmptyMatch();
  }
  
  @Override
  public Mission.Match newMatch(final Object... parameters) {
    return Mission.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Mission} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Mission#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Mission.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Mission");
