...
public final class Function_subject extends BaseGeneratedEMFQuerySpecification<Function_subject.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_subject pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_subject";
    }
    
    @Override
    public List<String> parameterNames() {
      return Function_subject.Match.parameterNames;
    }
    ...
    @Override
    public Function_subject.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Function_subject.Match)) {
          Function_subject.Match other = (Function_subject.Match) obj;
    ...
    @Override
    public Function_subject specification() {
      return Function_subject.instance();
    }
     ...
     * 
     */
    public static Function_subject.Match newEmptyMatch() {
     ...
     * 
     */
    public static Function_subject.Match newMutableMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public static Function_subject.Match newMatch(final Activity pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Function_subject.Match {
    ...
    private static final class Immutable extends Function_subject.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Function_subject pattern,
   ...
   * 
   * @see Match
   * @see Function_subject
   * 
   */
  public static class Matcher extends BaseMatcher<Function_subject.Match> {
    /**
     ...
     * 
     */
    public static Function_subject.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Function_subject.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Function_subject.Matcher.class);
     ...
     * 
     */
    public Collection<Function_subject.Match> getAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Function_subject.Match> streamAllMatches(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Function_subject.Match> getOneArbitraryMatch(final Activity pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Activity pElement, final Element pValue, final Consumer<? super Function_subject.Match> processor) {
     ...
     * 
     */
    public Function_subject.Match newMatch(final Activity pElement, final Element pValue) {
      return Function_subject.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Activity> streamAllValuesOfelement(final Function_subject.Match partialMatch) {
     ...
     * 
     */
    public Set<Activity> getAllValuesOfelement(final Function_subject.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Function_subject.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Function_subject.Match partialMatch) {
    ...
    @Override
    protected Function_subject.Match tupleToMatch(final Tuple t) {
      try {
          return Function_subject.Match.newMatch((Activity) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Function_subject.Match arrayToMatch(final Object[] match) {
      try {
          return Function_subject.Match.newMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Function_subject.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Function_subject.Match.newMutableMatch((Activity) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Function_subject.Matcher> querySpecification() {
      return Function_subject.instance();
    }
  }
  
  private Function_subject() {
   ...
   * 
   */
  public static Function_subject instance() {
    try{
  ...
  @Override
  protected Function_subject.Matcher instantiate(final ViatraQueryEngine engine) {
    return Function_subject.Matcher.on(engine);
  }
  
  @Override
  public Function_subject.Matcher instantiate() {
    return Function_subject.Matcher.create();
  }
  
  @Override
  public Function_subject.Match newEmptyMatch() {
    return Function_subject.Match.newEmptyMatch();
  }
  
  @Override
  public Function_subject.Match newMatch(final Object... parameters) {
    return Function_subject.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdfundamentalactivities.Activity) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Function_subject} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Function_subject#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Function_subject INSTANCE = new Function_subject();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Function_subject.GeneratedPQuery INSTANCE = new GeneratedPQuery();
