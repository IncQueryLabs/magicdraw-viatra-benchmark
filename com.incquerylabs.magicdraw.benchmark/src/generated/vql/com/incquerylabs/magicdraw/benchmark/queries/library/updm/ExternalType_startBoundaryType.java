...
public final class ExternalType_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ExternalType_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalType_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ExternalType_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalType_startBoundaryType.Match)) {
          ExternalType_startBoundaryType.Match other = (ExternalType_startBoundaryType.Match) obj;
    ...
    @Override
    public ExternalType_startBoundaryType specification() {
      return ExternalType_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ExternalType_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalType_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalType_startBoundaryType.Match {
    ...
    private static final class Immutable extends ExternalType_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ExternalType_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalType_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ExternalType_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalType_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalType_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalType_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalType_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalType_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalType_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ExternalType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalType_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalType_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ExternalType_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalType_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalType_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalType_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalType_startBoundaryType.Matcher> querySpecification() {
      return ExternalType_startBoundaryType.instance();
    }
  }
  
  private ExternalType_startBoundaryType() {
   ...
   * 
   */
  public static ExternalType_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ExternalType_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalType_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ExternalType_startBoundaryType.Matcher instantiate() {
    return ExternalType_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ExternalType_startBoundaryType.Match newEmptyMatch() {
    return ExternalType_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalType_startBoundaryType.Match newMatch(final Object... parameters) {
    return ExternalType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalType_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalType_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalType_startBoundaryType INSTANCE = new ExternalType_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalType_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
