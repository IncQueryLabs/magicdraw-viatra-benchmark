...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture;
...
public final class PhysicalArchitecture_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<PhysicalArchitecture_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalArchitecture_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalArchitecture_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalArchitecture_requiredEnvironment.Match)) {
          PhysicalArchitecture_requiredEnvironment.Match other = (PhysicalArchitecture_requiredEnvironment.Match) obj;
    ...
    @Override
    public PhysicalArchitecture_requiredEnvironment specification() {
      return PhysicalArchitecture_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static PhysicalArchitecture_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalArchitecture_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalArchitecture_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalArchitecture_requiredEnvironment.Match {
    ...
    private static final class Immutable extends PhysicalArchitecture_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalArchitecture_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see PhysicalArchitecture_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalArchitecture_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static PhysicalArchitecture_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalArchitecture_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalArchitecture_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalArchitecture_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalArchitecture_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalArchitecture_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalArchitecture_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public PhysicalArchitecture_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalArchitecture_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalArchitecture_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalArchitecture_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalArchitecture_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalArchitecture_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected PhysicalArchitecture_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalArchitecture_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalArchitecture_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalArchitecture_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalArchitecture_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalArchitecture_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalArchitecture_requiredEnvironment.Matcher> querySpecification() {
      return PhysicalArchitecture_requiredEnvironment.instance();
    }
  }
  
  private PhysicalArchitecture_requiredEnvironment() {
   ...
   * 
   */
  public static PhysicalArchitecture_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected PhysicalArchitecture_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalArchitecture_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public PhysicalArchitecture_requiredEnvironment.Matcher instantiate() {
    return PhysicalArchitecture_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public PhysicalArchitecture_requiredEnvironment.Match newEmptyMatch() {
    return PhysicalArchitecture_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalArchitecture_requiredEnvironment.Match newMatch(final Object... parameters) {
    return PhysicalArchitecture_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalArchitecture_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalArchitecture_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalArchitecture_requiredEnvironment INSTANCE = new PhysicalArchitecture_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalArchitecture_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find PhysicalArchitecture(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), PhysicalArchitecture.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
