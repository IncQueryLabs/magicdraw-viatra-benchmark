...
public final class BusinessRequirement_VerifiedBy extends BaseGeneratedEMFQuerySpecification<BusinessRequirement_VerifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.businessRequirement_VerifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.businessRequirement_VerifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return BusinessRequirement_VerifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public BusinessRequirement_VerifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BusinessRequirement_VerifiedBy.Match)) {
          BusinessRequirement_VerifiedBy.Match other = (BusinessRequirement_VerifiedBy.Match) obj;
    ...
    @Override
    public BusinessRequirement_VerifiedBy specification() {
     ...
     * 
     */
    public static BusinessRequirement_VerifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static BusinessRequirement_VerifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static BusinessRequirement_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends BusinessRequirement_VerifiedBy.Match {
    ...
    private static final class Immutable extends BusinessRequirement_VerifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.businessRequirement_VerifiedBy pattern,
   ...
   * 
   * @see Match
   * @see BusinessRequirement_VerifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<BusinessRequirement_VerifiedBy.Match> {
    /**
     ...
     * 
     */
    public static BusinessRequirement_VerifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BusinessRequirement_VerifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BusinessRequirement_VerifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<BusinessRequirement_VerifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<BusinessRequirement_VerifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<BusinessRequirement_VerifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super BusinessRequirement_VerifiedBy.Match> processor) {
     ...
     * 
     */
    public BusinessRequirement_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return BusinessRequirement_VerifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final BusinessRequirement_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final BusinessRequirement_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final BusinessRequirement_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final BusinessRequirement_VerifiedBy.Match partialMatch) {
    ...
    @Override
    protected BusinessRequirement_VerifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return BusinessRequirement_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected BusinessRequirement_VerifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return BusinessRequirement_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BusinessRequirement_VerifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BusinessRequirement_VerifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BusinessRequirement_VerifiedBy.Matcher> querySpecification() {
      return BusinessRequirement_VerifiedBy.instance();
    }
  }
  
  private BusinessRequirement_VerifiedBy() {
   ...
   * 
   */
  public static BusinessRequirement_VerifiedBy instance() {
    try{
  ...
  @Override
  protected BusinessRequirement_VerifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return BusinessRequirement_VerifiedBy.Matcher.on(engine);
  }
  
  @Override
  public BusinessRequirement_VerifiedBy.Matcher instantiate() {
    return BusinessRequirement_VerifiedBy.Matcher.create();
  }
  
  @Override
  public BusinessRequirement_VerifiedBy.Match newEmptyMatch() {
    return BusinessRequirement_VerifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public BusinessRequirement_VerifiedBy.Match newMatch(final Object... parameters) {
    return BusinessRequirement_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link BusinessRequirement_VerifiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link BusinessRequirement_VerifiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BusinessRequirement_VerifiedBy INSTANCE = new BusinessRequirement_VerifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BusinessRequirement_VerifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
