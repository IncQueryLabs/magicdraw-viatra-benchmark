...
public final class ActualOrganization extends BaseGeneratedEMFQuerySpecification<ActualOrganization.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualOrganization pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualOrganization";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualOrganization.Match.parameterNames;
    }
    ...
    @Override
    public ActualOrganization.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualOrganization.Match)) {
          ActualOrganization.Match other = (ActualOrganization.Match) obj;
    ...
    @Override
    public ActualOrganization specification() {
      return ActualOrganization.instance();
    }
     ...
     * 
     */
    public static ActualOrganization.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualOrganization.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualOrganization.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualOrganization.Match {
    ...
    private static final class Immutable extends ActualOrganization.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualOrganization pattern,
   ...
   * 
   * @see Match
   * @see ActualOrganization
   * 
   */
  public static class Matcher extends BaseMatcher<ActualOrganization.Match> {
    /**
     ...
     * 
     */
    public static ActualOrganization.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualOrganization.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualOrganization.Matcher.class);
     ...
     * 
     */
    public Collection<ActualOrganization.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualOrganization.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualOrganization.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualOrganization.Match> processor) {
     ...
     * 
     */
    public ActualOrganization.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualOrganization.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualOrganization.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualOrganization.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualOrganization.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualOrganization.Match partialMatch) {
    ...
    @Override
    protected ActualOrganization.Match tupleToMatch(final Tuple t) {
      try {
          return ActualOrganization.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualOrganization.Match arrayToMatch(final Object[] match) {
      try {
          return ActualOrganization.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualOrganization.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualOrganization.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualOrganization.Matcher> querySpecification() {
      return ActualOrganization.instance();
    }
  }
   ...
   * 
   */
  public static ActualOrganization instance() {
    try{
  ...
  @Override
  protected ActualOrganization.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualOrganization.Matcher.on(engine);
  }
  
  @Override
  public ActualOrganization.Matcher instantiate() {
    return ActualOrganization.Matcher.create();
  }
  
  @Override
  public ActualOrganization.Match newEmptyMatch() {
    return ActualOrganization.Match.newEmptyMatch();
  }
  
  @Override
  public ActualOrganization.Match newMatch(final Object... parameters) {
    return ActualOrganization.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualOrganization} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualOrganization#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualOrganization INSTANCE = new ActualOrganization();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualOrganization.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualOrganization")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualOrganization");
