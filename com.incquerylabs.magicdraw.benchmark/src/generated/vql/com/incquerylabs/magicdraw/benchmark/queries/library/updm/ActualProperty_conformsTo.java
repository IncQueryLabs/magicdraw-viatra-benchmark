...
public final class ActualProperty_conformsTo extends BaseGeneratedEMFQuerySpecification<ActualProperty_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProperty_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ActualProperty_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProperty_conformsTo.Match)) {
          ActualProperty_conformsTo.Match other = (ActualProperty_conformsTo.Match) obj;
    ...
    @Override
    public ActualProperty_conformsTo specification() {
      return ActualProperty_conformsTo.instance();
    }
     ...
     * 
     */
    public static ActualProperty_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProperty_conformsTo.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProperty_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProperty_conformsTo.Match {
    ...
    private static final class Immutable extends ActualProperty_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProperty_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ActualProperty_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProperty_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ActualProperty_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProperty_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProperty_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProperty_conformsTo.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProperty_conformsTo.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProperty_conformsTo.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProperty_conformsTo.Match> processor) {
     ...
     * 
     */
    public ActualProperty_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProperty_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProperty_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProperty_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ActualProperty_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProperty_conformsTo.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProperty_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProperty_conformsTo.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProperty_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProperty_conformsTo.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProperty_conformsTo.Matcher> querySpecification() {
      return ActualProperty_conformsTo.instance();
    }
  }
  
  private ActualProperty_conformsTo() {
   ...
   * 
   */
  public static ActualProperty_conformsTo instance() {
    try{
  ...
  @Override
  protected ActualProperty_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProperty_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ActualProperty_conformsTo.Matcher instantiate() {
    return ActualProperty_conformsTo.Matcher.create();
  }
  
  @Override
  public ActualProperty_conformsTo.Match newEmptyMatch() {
    return ActualProperty_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProperty_conformsTo.Match newMatch(final Object... parameters) {
    return ActualProperty_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProperty_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProperty_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProperty_conformsTo INSTANCE = new ActualProperty_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProperty_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
