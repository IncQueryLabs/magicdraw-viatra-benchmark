...
public final class PhysicalResource_actsUpon extends BaseGeneratedEMFQuerySpecification<PhysicalResource_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_actsUpon.Match)) {
          PhysicalResource_actsUpon.Match other = (PhysicalResource_actsUpon.Match) obj;
    ...
    @Override
    public PhysicalResource_actsUpon specification() {
      return PhysicalResource_actsUpon.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_actsUpon.Match {
    ...
    private static final class Immutable extends PhysicalResource_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_actsUpon.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_actsUpon.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_actsUpon.Matcher> querySpecification() {
      return PhysicalResource_actsUpon.instance();
    }
  }
  
  private PhysicalResource_actsUpon() {
   ...
   * 
   */
  public static PhysicalResource_actsUpon instance() {
    try{
  ...
  @Override
  protected PhysicalResource_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_actsUpon.Matcher instantiate() {
    return PhysicalResource_actsUpon.Matcher.create();
  }
  
  @Override
  public PhysicalResource_actsUpon.Match newEmptyMatch() {
    return PhysicalResource_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_actsUpon.Match newMatch(final Object... parameters) {
    return PhysicalResource_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_actsUpon INSTANCE = new PhysicalResource_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
