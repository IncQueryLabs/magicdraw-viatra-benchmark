...
public final class BoundReference_upper extends BaseGeneratedEMFQuerySpecification<BoundReference_upper.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static BoundReference_upper.Match newMutableMatch(final Property pElement, final Integer pValue) {
     ...
     * 
     */
    public static BoundReference_upper.Match newMatch(final Property pElement, final Integer pValue) {
  ...
  public static class Matcher extends BaseMatcher<BoundReference_upper.Match> {
     ...
     * 
     */
    public Collection<BoundReference_upper.Match> getAllMatches(final Property pElement, final Integer pValue) {
     ...
     * 
     */
    public Stream<BoundReference_upper.Match> streamAllMatches(final Property pElement, final Integer pValue) {
     ...
     * 
     */
    public Optional<BoundReference_upper.Match> getOneArbitraryMatch(final Property pElement, final Integer pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Integer pValue, final Consumer<? super BoundReference_upper.Match> processor) {
     ...
     * 
     */
    public BoundReference_upper.Match newMatch(final Property pElement, final Integer pValue) {
      return BoundReference_upper.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Integer> streamAllValuesOfValue(final BoundReference_upper.Match partialMatch) {
     ...
     * 
     */
    public Set<Integer> getAllValuesOfValue(final BoundReference_upper.Match partialMatch) {
    ...
    protected BoundReference_upper.Match tupleToMatch(final Tuple t) {
      try {
          return BoundReference_upper.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Integer) t.get(POSITION_VALUE));
    ...
    protected BoundReference_upper.Match arrayToMatch(final Object[] match) {
      try {
          return BoundReference_upper.Match.newMatch((Property) match[POSITION_ELEMENT], (Integer) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected BoundReference_upper.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BoundReference_upper.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Integer) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public BoundReference_upper.Match newMatch(final Object... parameters) {
    return BoundReference_upper.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (java.lang.Integer) parameters[1]);
  }
