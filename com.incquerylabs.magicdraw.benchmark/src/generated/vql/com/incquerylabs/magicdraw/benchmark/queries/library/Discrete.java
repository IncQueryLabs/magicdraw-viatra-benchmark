...
public final class Discrete extends BaseGeneratedEMFQuerySpecification<Discrete.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Discrete pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Discrete";
    }
     ...
     * 
     */
    public static Discrete.Match newMutableMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Discrete.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Discrete pattern,
  ...
  public static class Matcher extends BaseMatcher<Discrete.Match> {
     ...
     * 
     */
    public Collection<Discrete.Match> getAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Discrete.Match> streamAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Discrete.Match> getOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype, final Consumer<? super Discrete.Match> processor) {
     ...
     * 
     */
    public Discrete.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
      return Discrete.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Discrete.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Discrete.Match partialMatch) {
    ...
    protected Discrete.Match tupleToMatch(final Tuple t) {
      try {
          return Discrete.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected Discrete.Match arrayToMatch(final Object[] match) {
      try {
          return Discrete.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected Discrete.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Discrete.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Discrete.Match newMatch(final Object... parameters) {
    return Discrete.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Discrete} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Discrete#instance()}.
   * 
