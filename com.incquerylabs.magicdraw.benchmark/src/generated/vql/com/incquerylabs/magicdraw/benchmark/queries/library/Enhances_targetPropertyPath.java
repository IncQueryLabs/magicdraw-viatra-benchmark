...
public final class Enhances_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Enhances_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Enhances_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Enhances_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Enhances_targetPropertyPath.Match)) {
          Enhances_targetPropertyPath.Match other = (Enhances_targetPropertyPath.Match) obj;
    ...
    @Override
    public Enhances_targetPropertyPath specification() {
      return Enhances_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static Enhances_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Enhances_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Enhances_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Enhances_targetPropertyPath.Match {
    ...
    private static final class Immutable extends Enhances_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Enhances_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Enhances_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Enhances_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Enhances_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Enhances_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Enhances_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Enhances_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Enhances_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Enhances_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Enhances_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public Enhances_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Enhances_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Enhances_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Enhances_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Enhances_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Enhances_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected Enhances_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Enhances_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Enhances_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Enhances_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Enhances_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Enhances_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Enhances_targetPropertyPath.Matcher> querySpecification() {
      return Enhances_targetPropertyPath.instance();
    }
  }
  
  private Enhances_targetPropertyPath() {
   ...
   * 
   */
  public static Enhances_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected Enhances_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Enhances_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Enhances_targetPropertyPath.Matcher instantiate() {
    return Enhances_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public Enhances_targetPropertyPath.Match newEmptyMatch() {
    return Enhances_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Enhances_targetPropertyPath.Match newMatch(final Object... parameters) {
    return Enhances_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Enhances_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Enhances_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Enhances_targetPropertyPath INSTANCE = new Enhances_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Enhances_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
