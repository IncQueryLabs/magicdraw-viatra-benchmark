...
public final class TechnicalStandard_actualPropertySet extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_actualPropertySet.Match)) {
          TechnicalStandard_actualPropertySet.Match other = (TechnicalStandard_actualPropertySet.Match) obj;
    ...
    @Override
    public TechnicalStandard_actualPropertySet specification() {
      return TechnicalStandard_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static TechnicalStandard_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TechnicalStandard_actualPropertySet.Match {
    ...
    private static final class Immutable extends TechnicalStandard_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TechnicalStandard_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TechnicalStandard_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super TechnicalStandard_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return TechnicalStandard_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TechnicalStandard_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TechnicalStandard_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TechnicalStandard_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_actualPropertySet.Matcher> querySpecification() {
      return TechnicalStandard_actualPropertySet.instance();
    }
  }
  
  private TechnicalStandard_actualPropertySet() {
   ...
   * 
   */
  public static TechnicalStandard_actualPropertySet instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_actualPropertySet.Matcher instantiate() {
    return TechnicalStandard_actualPropertySet.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_actualPropertySet.Match newEmptyMatch() {
    return TechnicalStandard_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_actualPropertySet.Match newMatch(final Object... parameters) {
    return TechnicalStandard_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_actualPropertySet INSTANCE = new TechnicalStandard_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
