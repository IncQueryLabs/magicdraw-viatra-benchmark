...
public final class ResourceRole_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<ResourceRole_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_requiredEnvironment.Match)) {
          ResourceRole_requiredEnvironment.Match other = (ResourceRole_requiredEnvironment.Match) obj;
    ...
    @Override
    public ResourceRole_requiredEnvironment specification() {
      return ResourceRole_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static ResourceRole_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_requiredEnvironment.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_requiredEnvironment.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_requiredEnvironment.Match {
    ...
    private static final class Immutable extends ResourceRole_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_requiredEnvironment.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_requiredEnvironment.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_requiredEnvironment.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public ResourceRole_requiredEnvironment.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_requiredEnvironment.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_requiredEnvironment.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_requiredEnvironment.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_requiredEnvironment.Matcher> querySpecification() {
      return ResourceRole_requiredEnvironment.instance();
    }
  }
  
  private ResourceRole_requiredEnvironment() {
   ...
   * 
   */
  public static ResourceRole_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected ResourceRole_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_requiredEnvironment.Matcher instantiate() {
    return ResourceRole_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public ResourceRole_requiredEnvironment.Match newEmptyMatch() {
    return ResourceRole_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_requiredEnvironment.Match newMatch(final Object... parameters) {
    return ResourceRole_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_requiredEnvironment INSTANCE = new ResourceRole_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
