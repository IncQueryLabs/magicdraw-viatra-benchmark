...
public final class WholeLifeConfiguration_propertySet extends BaseGeneratedEMFQuerySpecification<WholeLifeConfiguration_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeConfiguration_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeConfiguration_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeConfiguration_propertySet.Match)) {
          WholeLifeConfiguration_propertySet.Match other = (WholeLifeConfiguration_propertySet.Match) obj;
    ...
    @Override
    public WholeLifeConfiguration_propertySet specification() {
      return WholeLifeConfiguration_propertySet.instance();
    }
     ...
     * 
     */
    public static WholeLifeConfiguration_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeConfiguration_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeConfiguration_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeConfiguration_propertySet.Match {
    ...
    private static final class Immutable extends WholeLifeConfiguration_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeConfiguration_propertySet pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeConfiguration_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeConfiguration_propertySet.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeConfiguration_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeConfiguration_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeConfiguration_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeConfiguration_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeConfiguration_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeConfiguration_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeConfiguration_propertySet.Match> processor) {
     ...
     * 
     */
    public WholeLifeConfiguration_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeConfiguration_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeConfiguration_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeConfiguration_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeConfiguration_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeConfiguration_propertySet.Match partialMatch) {
    ...
    @Override
    protected WholeLifeConfiguration_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeConfiguration_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeConfiguration_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeConfiguration_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeConfiguration_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeConfiguration_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeConfiguration_propertySet.Matcher> querySpecification() {
      return WholeLifeConfiguration_propertySet.instance();
    }
  }
  
  private WholeLifeConfiguration_propertySet() {
   ...
   * 
   */
  public static WholeLifeConfiguration_propertySet instance() {
    try{
  ...
  @Override
  protected WholeLifeConfiguration_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeConfiguration_propertySet.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeConfiguration_propertySet.Matcher instantiate() {
    return WholeLifeConfiguration_propertySet.Matcher.create();
  }
  
  @Override
  public WholeLifeConfiguration_propertySet.Match newEmptyMatch() {
    return WholeLifeConfiguration_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeConfiguration_propertySet.Match newMatch(final Object... parameters) {
    return WholeLifeConfiguration_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeConfiguration_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeConfiguration_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeConfiguration_propertySet INSTANCE = new WholeLifeConfiguration_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeConfiguration_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
