...
public final class View_viewPoint_1 extends BaseGeneratedEMFQuerySpecification<View_viewPoint_1.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.View_viewPoint_1 pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.View_viewPoint_1";
    }
    
    @Override
    public List<String> parameterNames() {
      return View_viewPoint_1.Match.parameterNames;
    }
    ...
    @Override
    public View_viewPoint_1.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof View_viewPoint_1.Match)) {
          View_viewPoint_1.Match other = (View_viewPoint_1.Match) obj;
    ...
    @Override
    public View_viewPoint_1 specification() {
      return View_viewPoint_1.instance();
    }
     ...
     * 
     */
    public static View_viewPoint_1.Match newEmptyMatch() {
     ...
     * 
     */
    public static View_viewPoint_1.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static View_viewPoint_1.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends View_viewPoint_1.Match {
    ...
    private static final class Immutable extends View_viewPoint_1.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.View_viewPoint_1 pattern,
   ...
   * 
   * @see Match
   * @see View_viewPoint_1
   * 
   */
  public static class Matcher extends BaseMatcher<View_viewPoint_1.Match> {
    /**
     ...
     * 
     */
    public static View_viewPoint_1.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static View_viewPoint_1.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(View_viewPoint_1.Matcher.class);
     ...
     * 
     */
    public Collection<View_viewPoint_1.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<View_viewPoint_1.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<View_viewPoint_1.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super View_viewPoint_1.Match> processor) {
     ...
     * 
     */
    public View_viewPoint_1.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return View_viewPoint_1.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final View_viewPoint_1.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final View_viewPoint_1.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final View_viewPoint_1.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final View_viewPoint_1.Match partialMatch) {
    ...
    @Override
    protected View_viewPoint_1.Match tupleToMatch(final Tuple t) {
      try {
          return View_viewPoint_1.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected View_viewPoint_1.Match arrayToMatch(final Object[] match) {
      try {
          return View_viewPoint_1.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected View_viewPoint_1.Match arrayToMatchMutable(final Object[] match) {
      try {
          return View_viewPoint_1.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<View_viewPoint_1.Matcher> querySpecification() {
      return View_viewPoint_1.instance();
    }
  }
  
  private View_viewPoint_1() {
   ...
   * 
   */
  public static View_viewPoint_1 instance() {
    try{
  ...
  @Override
  protected View_viewPoint_1.Matcher instantiate(final ViatraQueryEngine engine) {
    return View_viewPoint_1.Matcher.on(engine);
  }
  
  @Override
  public View_viewPoint_1.Matcher instantiate() {
    return View_viewPoint_1.Matcher.create();
  }
  
  @Override
  public View_viewPoint_1.Match newEmptyMatch() {
    return View_viewPoint_1.Match.newEmptyMatch();
  }
  
  @Override
  public View_viewPoint_1.Match newMatch(final Object... parameters) {
    return View_viewPoint_1.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link View_viewPoint_1} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link View_viewPoint_1#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final View_viewPoint_1 INSTANCE = new View_viewPoint_1();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final View_viewPoint_1.GeneratedPQuery INSTANCE = new GeneratedPQuery();
