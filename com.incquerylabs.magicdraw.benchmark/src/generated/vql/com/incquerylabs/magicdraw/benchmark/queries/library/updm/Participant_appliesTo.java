...
public final class Participant_appliesTo extends BaseGeneratedEMFQuerySpecification<Participant_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Participant_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_appliesTo.Match)) {
          Participant_appliesTo.Match other = (Participant_appliesTo.Match) obj;
    ...
    @Override
    public Participant_appliesTo specification() {
      return Participant_appliesTo.instance();
    }
     ...
     * 
     */
    public static Participant_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Participant_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Participant_appliesTo.Match {
    ...
    private static final class Immutable extends Participant_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Participant_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Participant_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Participant_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Participant_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Participant_appliesTo.Match> processor) {
     ...
     * 
     */
    public Participant_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Participant_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Participant_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Participant_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Participant_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Participant_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_appliesTo.Matcher> querySpecification() {
      return Participant_appliesTo.instance();
    }
  }
  
  private Participant_appliesTo() {
   ...
   * 
   */
  public static Participant_appliesTo instance() {
    try{
  ...
  @Override
  protected Participant_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Participant_appliesTo.Matcher instantiate() {
    return Participant_appliesTo.Matcher.create();
  }
  
  @Override
  public Participant_appliesTo.Match newEmptyMatch() {
    return Participant_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_appliesTo.Match newMatch(final Object... parameters) {
    return Participant_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_appliesTo INSTANCE = new Participant_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
