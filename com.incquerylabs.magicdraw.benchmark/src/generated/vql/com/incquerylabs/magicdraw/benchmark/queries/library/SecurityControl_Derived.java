...
public final class SecurityControl_Derived extends BaseGeneratedEMFQuerySpecification<SecurityControl_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_Derived.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_Derived.Match)) {
          SecurityControl_Derived.Match other = (SecurityControl_Derived.Match) obj;
    ...
    @Override
    public SecurityControl_Derived specification() {
      return SecurityControl_Derived.instance();
    }
     ...
     * 
     */
    public static SecurityControl_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityControl_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControl_Derived.Match {
    ...
    private static final class Immutable extends SecurityControl_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_Derived pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_Derived.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityControl_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityControl_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityControl_Derived.Match> processor) {
     ...
     * 
     */
    public SecurityControl_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityControl_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityControl_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityControl_Derived.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControl_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_Derived.Matcher> querySpecification() {
      return SecurityControl_Derived.instance();
    }
  }
  
  private SecurityControl_Derived() {
   ...
   * 
   */
  public static SecurityControl_Derived instance() {
    try{
  ...
  @Override
  protected SecurityControl_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_Derived.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_Derived.Matcher instantiate() {
    return SecurityControl_Derived.Matcher.create();
  }
  
  @Override
  public SecurityControl_Derived.Match newEmptyMatch() {
    return SecurityControl_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_Derived.Match newMatch(final Object... parameters) {
    return SecurityControl_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_Derived INSTANCE = new SecurityControl_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
