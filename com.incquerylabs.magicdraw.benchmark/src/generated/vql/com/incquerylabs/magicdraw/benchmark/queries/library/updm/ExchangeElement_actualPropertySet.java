...
public final class ExchangeElement_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ExchangeElement_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_actualPropertySet.Match)) {
          ExchangeElement_actualPropertySet.Match other = (ExchangeElement_actualPropertySet.Match) obj;
    ...
    @Override
    public ExchangeElement_actualPropertySet specification() {
      return ExchangeElement_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_actualPropertySet.Match {
    ...
    private static final class Immutable extends ExchangeElement_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_actualPropertySet.Matcher> querySpecification() {
      return ExchangeElement_actualPropertySet.instance();
    }
  }
  
  private ExchangeElement_actualPropertySet() {
   ...
   * 
   */
  public static ExchangeElement_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ExchangeElement_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_actualPropertySet.Matcher instantiate() {
    return ExchangeElement_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ExchangeElement_actualPropertySet.Match newEmptyMatch() {
    return ExchangeElement_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_actualPropertySet.Match newMatch(final Object... parameters) {
    return ExchangeElement_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_actualPropertySet INSTANCE = new ExchangeElement_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
