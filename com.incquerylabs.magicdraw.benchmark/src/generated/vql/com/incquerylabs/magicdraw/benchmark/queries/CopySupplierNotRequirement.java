...
public final class CopySupplierNotRequirement extends BaseGeneratedEMFQuerySpecification<CopySupplierNotRequirement.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link CopySupplierNotRequirement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CopySupplierNotRequirement#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_copy, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Dependency", "supplier")));
