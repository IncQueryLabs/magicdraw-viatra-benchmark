...
import com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeEnterprise;
...
public final class WholeLifeEnterprise_isEncapsulated extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeEnterprise_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeEnterprise_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_isEncapsulated.Match)) {
          WholeLifeEnterprise_isEncapsulated.Match other = (WholeLifeEnterprise_isEncapsulated.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_isEncapsulated specification() {
      return WholeLifeEnterprise_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static WholeLifeEnterprise_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_isEncapsulated.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.WholeLifeEnterprise_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super WholeLifeEnterprise_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return WholeLifeEnterprise_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final WholeLifeEnterprise_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final WholeLifeEnterprise_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected WholeLifeEnterprise_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_isEncapsulated.Matcher> querySpecification() {
      return WholeLifeEnterprise_isEncapsulated.instance();
    }
  }
  
  private WholeLifeEnterprise_isEncapsulated() {
   ...
   * 
   */
  public static WholeLifeEnterprise_isEncapsulated instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_isEncapsulated.Matcher instantiate() {
    return WholeLifeEnterprise_isEncapsulated.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_isEncapsulated.Match newEmptyMatch() {
    return WholeLifeEnterprise_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_isEncapsulated.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_isEncapsulated INSTANCE = new WholeLifeEnterprise_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
