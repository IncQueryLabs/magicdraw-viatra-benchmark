...
public final class NaturalResource_URI extends BaseGeneratedEMFQuerySpecification<NaturalResource_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return NaturalResource_URI.Match.parameterNames;
    }
    ...
    @Override
    public NaturalResource_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NaturalResource_URI.Match)) {
          NaturalResource_URI.Match other = (NaturalResource_URI.Match) obj;
    ...
    @Override
    public NaturalResource_URI specification() {
      return NaturalResource_URI.instance();
    }
     ...
     * 
     */
    public static NaturalResource_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static NaturalResource_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static NaturalResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends NaturalResource_URI.Match {
    ...
    private static final class Immutable extends NaturalResource_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_URI pattern,
   ...
   * 
   * @see Match
   * @see NaturalResource_URI
   * 
   */
  public static class Matcher extends BaseMatcher<NaturalResource_URI.Match> {
    /**
     ...
     * 
     */
    public static NaturalResource_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NaturalResource_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NaturalResource_URI.Matcher.class);
     ...
     * 
     */
    public Collection<NaturalResource_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<NaturalResource_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<NaturalResource_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super NaturalResource_URI.Match> processor) {
     ...
     * 
     */
    public NaturalResource_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return NaturalResource_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NaturalResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NaturalResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final NaturalResource_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final NaturalResource_URI.Match partialMatch) {
    ...
    @Override
    protected NaturalResource_URI.Match tupleToMatch(final Tuple t) {
      try {
          return NaturalResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected NaturalResource_URI.Match arrayToMatch(final Object[] match) {
      try {
          return NaturalResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NaturalResource_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NaturalResource_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NaturalResource_URI.Matcher> querySpecification() {
      return NaturalResource_URI.instance();
    }
  }
  
  private NaturalResource_URI() {
   ...
   * 
   */
  public static NaturalResource_URI instance() {
    try{
  ...
  @Override
  protected NaturalResource_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return NaturalResource_URI.Matcher.on(engine);
  }
  
  @Override
  public NaturalResource_URI.Matcher instantiate() {
    return NaturalResource_URI.Matcher.create();
  }
  
  @Override
  public NaturalResource_URI.Match newEmptyMatch() {
    return NaturalResource_URI.Match.newEmptyMatch();
  }
  
  @Override
  public NaturalResource_URI.Match newMatch(final Object... parameters) {
    return NaturalResource_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NaturalResource_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NaturalResource_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NaturalResource_URI INSTANCE = new NaturalResource_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NaturalResource_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
