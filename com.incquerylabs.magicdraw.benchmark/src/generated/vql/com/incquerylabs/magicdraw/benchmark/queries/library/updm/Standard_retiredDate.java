...
public final class Standard_retiredDate extends BaseGeneratedEMFQuerySpecification<Standard_retiredDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_retiredDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_retiredDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_retiredDate.Match.parameterNames;
    }
    ...
    @Override
    public Standard_retiredDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_retiredDate.Match)) {
          Standard_retiredDate.Match other = (Standard_retiredDate.Match) obj;
    ...
    @Override
    public Standard_retiredDate specification() {
      return Standard_retiredDate.instance();
    }
     ...
     * 
     */
    public static Standard_retiredDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_retiredDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Standard_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Standard_retiredDate.Match {
    ...
    private static final class Immutable extends Standard_retiredDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_retiredDate pattern,
   ...
   * 
   * @see Match
   * @see Standard_retiredDate
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_retiredDate.Match> {
    /**
     ...
     * 
     */
    public static Standard_retiredDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_retiredDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_retiredDate.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_retiredDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Standard_retiredDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Standard_retiredDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Standard_retiredDate.Match> processor) {
     ...
     * 
     */
    public Standard_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Standard_retiredDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Standard_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Standard_retiredDate.Match partialMatch) {
    ...
    @Override
    protected Standard_retiredDate.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Standard_retiredDate.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_retiredDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_retiredDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_retiredDate.Matcher> querySpecification() {
      return Standard_retiredDate.instance();
    }
  }
  
  private Standard_retiredDate() {
   ...
   * 
   */
  public static Standard_retiredDate instance() {
    try{
  ...
  @Override
  protected Standard_retiredDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_retiredDate.Matcher.on(engine);
  }
  
  @Override
  public Standard_retiredDate.Matcher instantiate() {
    return Standard_retiredDate.Matcher.create();
  }
  
  @Override
  public Standard_retiredDate.Match newEmptyMatch() {
    return Standard_retiredDate.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_retiredDate.Match newMatch(final Object... parameters) {
    return Standard_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_retiredDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_retiredDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_retiredDate INSTANCE = new Standard_retiredDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_retiredDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
