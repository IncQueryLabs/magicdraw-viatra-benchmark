...
public final class EnterprisePhase_endBoundaryType extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_endBoundaryType.Match)) {
          EnterprisePhase_endBoundaryType.Match other = (EnterprisePhase_endBoundaryType.Match) obj;
    ...
    @Override
    public EnterprisePhase_endBoundaryType specification() {
      return EnterprisePhase_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_endBoundaryType.Match {
    ...
    private static final class Immutable extends EnterprisePhase_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_endBoundaryType.Matcher> querySpecification() {
      return EnterprisePhase_endBoundaryType.instance();
    }
  }
  
  private EnterprisePhase_endBoundaryType() {
   ...
   * 
   */
  public static EnterprisePhase_endBoundaryType instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_endBoundaryType.Matcher instantiate() {
    return EnterprisePhase_endBoundaryType.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_endBoundaryType.Match newEmptyMatch() {
    return EnterprisePhase_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_endBoundaryType.Match newMatch(final Object... parameters) {
    return EnterprisePhase_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_endBoundaryType INSTANCE = new EnterprisePhase_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
