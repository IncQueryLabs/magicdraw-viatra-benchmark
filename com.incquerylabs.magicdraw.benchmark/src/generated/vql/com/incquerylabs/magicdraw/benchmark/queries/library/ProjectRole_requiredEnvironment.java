...
public final class ProjectRole_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<ProjectRole_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectRole_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ProjectRole_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectRole_requiredEnvironment.Match)) {
          ProjectRole_requiredEnvironment.Match other = (ProjectRole_requiredEnvironment.Match) obj;
    ...
    @Override
    public ProjectRole_requiredEnvironment specification() {
      return ProjectRole_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static ProjectRole_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectRole_requiredEnvironment.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectRole_requiredEnvironment.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectRole_requiredEnvironment.Match {
    ...
    private static final class Immutable extends ProjectRole_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectRole_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ProjectRole_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectRole_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ProjectRole_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectRole_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectRole_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectRole_requiredEnvironment.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectRole_requiredEnvironment.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectRole_requiredEnvironment.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectRole_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public ProjectRole_requiredEnvironment.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectRole_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectRole_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectRole_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectRole_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectRole_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected ProjectRole_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectRole_requiredEnvironment.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectRole_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectRole_requiredEnvironment.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectRole_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectRole_requiredEnvironment.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectRole_requiredEnvironment.Matcher> querySpecification() {
      return ProjectRole_requiredEnvironment.instance();
    }
  }
  
  private ProjectRole_requiredEnvironment() {
   ...
   * 
   */
  public static ProjectRole_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected ProjectRole_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectRole_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ProjectRole_requiredEnvironment.Matcher instantiate() {
    return ProjectRole_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public ProjectRole_requiredEnvironment.Match newEmptyMatch() {
    return ProjectRole_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectRole_requiredEnvironment.Match newMatch(final Object... parameters) {
    return ProjectRole_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectRole_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectRole_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectRole_requiredEnvironment INSTANCE = new ProjectRole_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectRole_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
