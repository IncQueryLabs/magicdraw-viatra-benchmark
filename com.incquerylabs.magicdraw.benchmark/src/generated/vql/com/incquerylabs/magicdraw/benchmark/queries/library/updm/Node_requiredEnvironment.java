...
public final class Node_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Node_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Node_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_requiredEnvironment.Match)) {
          Node_requiredEnvironment.Match other = (Node_requiredEnvironment.Match) obj;
    ...
    @Override
    public Node_requiredEnvironment specification() {
      return Node_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Node_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Node_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Node_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Node_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Node_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Node_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Node_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Node_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Node_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Node_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Node_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Node_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Node_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Node_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Node_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Node_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Node_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_requiredEnvironment.Matcher> querySpecification() {
      return Node_requiredEnvironment.instance();
    }
  }
  
  private Node_requiredEnvironment() {
   ...
   * 
   */
  public static Node_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Node_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Node_requiredEnvironment.Matcher instantiate() {
    return Node_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Node_requiredEnvironment.Match newEmptyMatch() {
    return Node_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Node_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Node_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_requiredEnvironment INSTANCE = new Node_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
