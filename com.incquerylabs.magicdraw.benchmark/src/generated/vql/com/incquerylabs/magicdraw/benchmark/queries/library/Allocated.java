...
public final class Allocated extends BaseGeneratedEMFQuerySpecification<Allocated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Allocated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Allocated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Allocated.Match.parameterNames;
    }
    ...
    @Override
    public Allocated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Allocated.Match)) {
          Allocated.Match other = (Allocated.Match) obj;
    ...
    @Override
    public Allocated specification() {
     ...
     * 
     */
    public static Allocated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Allocated.Match newMutableMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Allocated.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Allocated.Match {
    ...
    private static final class Immutable extends Allocated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Allocated pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Allocated.Match> {
    /**
     ...
     * 
     */
    public static Allocated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Allocated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Allocated.Matcher.class);
     ...
     * 
     */
    public Collection<Allocated.Match> getAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Allocated.Match> streamAllMatches(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Allocated.Match> getOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final NamedElement pElement, final Stereotype pStereotype, final Consumer<? super Allocated.Match> processor) {
     ...
     * 
     */
    public Allocated.Match newMatch(final NamedElement pElement, final Stereotype pStereotype) {
      return Allocated.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfElement(final Allocated.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfElement(final Allocated.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Allocated.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Allocated.Match partialMatch) {
    ...
    @Override
    protected Allocated.Match tupleToMatch(final Tuple t) {
      try {
          return Allocated.Match.newMatch((NamedElement) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Allocated.Match arrayToMatch(final Object[] match) {
      try {
          return Allocated.Match.newMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Allocated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Allocated.Match.newMutableMatch((NamedElement) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Allocated.Matcher> querySpecification() {
      return Allocated.instance();
    }
  }
  ...
  @Override
  protected Allocated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Allocated.Matcher.on(engine);
  }
  
  @Override
  public Allocated.Matcher instantiate() {
    return Allocated.Matcher.create();
  }
  
  @Override
  public Allocated.Match newEmptyMatch() {
    return Allocated.Match.newEmptyMatch();
  }
  
  @Override
  public Allocated.Match newMatch(final Object... parameters) {
    return Allocated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Allocated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Allocated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Allocated INSTANCE = new Allocated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Allocated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Allocated");
