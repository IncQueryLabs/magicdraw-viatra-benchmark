...
public final class VisionStatement extends BaseGeneratedEMFQuerySpecification<VisionStatement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.VisionStatement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.VisionStatement";
    }
    
    @Override
    public List<String> parameterNames() {
      return VisionStatement.Match.parameterNames;
    }
    ...
    @Override
    public VisionStatement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VisionStatement.Match)) {
          VisionStatement.Match other = (VisionStatement.Match) obj;
    ...
    @Override
    public VisionStatement specification() {
      return VisionStatement.instance();
    }
     ...
     * 
     */
    public static VisionStatement.Match newEmptyMatch() {
     ...
     * 
     */
    public static VisionStatement.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static VisionStatement.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends VisionStatement.Match {
    ...
    private static final class Immutable extends VisionStatement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.VisionStatement pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<VisionStatement.Match> {
    /**
     ...
     * 
     */
    public static VisionStatement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VisionStatement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VisionStatement.Matcher.class);
     ...
     * 
     */
    public Collection<VisionStatement.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<VisionStatement.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<VisionStatement.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super VisionStatement.Match> processor) {
     ...
     * 
     */
    public VisionStatement.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return VisionStatement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final VisionStatement.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final VisionStatement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final VisionStatement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final VisionStatement.Match partialMatch) {
    ...
    @Override
    protected VisionStatement.Match tupleToMatch(final Tuple t) {
      try {
          return VisionStatement.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected VisionStatement.Match arrayToMatch(final Object[] match) {
      try {
          return VisionStatement.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VisionStatement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VisionStatement.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VisionStatement.Matcher> querySpecification() {
      return VisionStatement.instance();
    }
  }
   ...
   * 
   */
  public static VisionStatement instance() {
    try{
  ...
  @Override
  protected VisionStatement.Matcher instantiate(final ViatraQueryEngine engine) {
    return VisionStatement.Matcher.on(engine);
  }
  
  @Override
  public VisionStatement.Matcher instantiate() {
    return VisionStatement.Matcher.create();
  }
  
  @Override
  public VisionStatement.Match newEmptyMatch() {
    return VisionStatement.Match.newEmptyMatch();
  }
  
  @Override
  public VisionStatement.Match newMatch(final Object... parameters) {
    return VisionStatement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VisionStatement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VisionStatement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VisionStatement INSTANCE = new VisionStatement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VisionStatement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "VisionStatement")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "VisionStatement");
