...
public final class System_physicalLocation extends BaseGeneratedEMFQuerySpecification<System_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public System_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_physicalLocation.Match)) {
          System_physicalLocation.Match other = (System_physicalLocation.Match) obj;
    ...
    @Override
    public System_physicalLocation specification() {
      return System_physicalLocation.instance();
    }
     ...
     * 
     */
    public static System_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_physicalLocation.Match {
    ...
    private static final class Immutable extends System_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see System_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<System_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static System_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<System_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_physicalLocation.Match> processor) {
     ...
     * 
     */
    public System_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected System_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return System_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return System_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_physicalLocation.Matcher> querySpecification() {
      return System_physicalLocation.instance();
    }
  }
  
  private System_physicalLocation() {
   ...
   * 
   */
  public static System_physicalLocation instance() {
    try{
  ...
  @Override
  protected System_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public System_physicalLocation.Matcher instantiate() {
    return System_physicalLocation.Matcher.create();
  }
  
  @Override
  public System_physicalLocation.Match newEmptyMatch() {
    return System_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public System_physicalLocation.Match newMatch(final Object... parameters) {
    return System_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_physicalLocation INSTANCE = new System_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
