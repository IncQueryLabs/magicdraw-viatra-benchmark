...
public final class DesignConstraint_Derived extends BaseGeneratedEMFQuerySpecification<DesignConstraint_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint_Derived.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint_Derived.Match)) {
          DesignConstraint_Derived.Match other = (DesignConstraint_Derived.Match) obj;
    ...
    @Override
    public DesignConstraint_Derived specification() {
     ...
     * 
     */
    public static DesignConstraint_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static DesignConstraint_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DesignConstraint_Derived.Match {
    ...
    private static final class Immutable extends DesignConstraint_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_Derived pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint_Derived.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<DesignConstraint_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<DesignConstraint_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super DesignConstraint_Derived.Match> processor) {
     ...
     * 
     */
    public DesignConstraint_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return DesignConstraint_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final DesignConstraint_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final DesignConstraint_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final DesignConstraint_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final DesignConstraint_Derived.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected DesignConstraint_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint_Derived.Matcher> querySpecification() {
      return DesignConstraint_Derived.instance();
    }
  }
  
  private DesignConstraint_Derived() {
   ...
   * 
   */
  public static DesignConstraint_Derived instance() {
    try{
  ...
  @Override
  protected DesignConstraint_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint_Derived.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint_Derived.Matcher instantiate() {
    return DesignConstraint_Derived.Matcher.create();
  }
  
  @Override
  public DesignConstraint_Derived.Match newEmptyMatch() {
    return DesignConstraint_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint_Derived.Match newMatch(final Object... parameters) {
    return DesignConstraint_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DesignConstraint_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DesignConstraint_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesignConstraint_Derived INSTANCE = new DesignConstraint_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
