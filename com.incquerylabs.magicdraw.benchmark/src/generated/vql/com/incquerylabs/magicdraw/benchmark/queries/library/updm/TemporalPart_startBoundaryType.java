...
public final class TemporalPart_startBoundaryType extends BaseGeneratedEMFQuerySpecification<TemporalPart_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return TemporalPart_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public TemporalPart_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TemporalPart_startBoundaryType.Match)) {
          TemporalPart_startBoundaryType.Match other = (TemporalPart_startBoundaryType.Match) obj;
    ...
    @Override
    public TemporalPart_startBoundaryType specification() {
      return TemporalPart_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static TemporalPart_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static TemporalPart_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static TemporalPart_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TemporalPart_startBoundaryType.Match {
    ...
    private static final class Immutable extends TemporalPart_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see TemporalPart_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<TemporalPart_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static TemporalPart_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TemporalPart_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TemporalPart_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<TemporalPart_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TemporalPart_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TemporalPart_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super TemporalPart_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public TemporalPart_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return TemporalPart_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TemporalPart_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TemporalPart_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TemporalPart_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TemporalPart_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected TemporalPart_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return TemporalPart_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TemporalPart_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return TemporalPart_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TemporalPart_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TemporalPart_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TemporalPart_startBoundaryType.Matcher> querySpecification() {
      return TemporalPart_startBoundaryType.instance();
    }
  }
  
  private TemporalPart_startBoundaryType() {
   ...
   * 
   */
  public static TemporalPart_startBoundaryType instance() {
    try{
  ...
  @Override
  protected TemporalPart_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return TemporalPart_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public TemporalPart_startBoundaryType.Matcher instantiate() {
    return TemporalPart_startBoundaryType.Matcher.create();
  }
  
  @Override
  public TemporalPart_startBoundaryType.Match newEmptyMatch() {
    return TemporalPart_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public TemporalPart_startBoundaryType.Match newMatch(final Object... parameters) {
    return TemporalPart_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TemporalPart_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TemporalPart_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TemporalPart_startBoundaryType INSTANCE = new TemporalPart_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TemporalPart_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
