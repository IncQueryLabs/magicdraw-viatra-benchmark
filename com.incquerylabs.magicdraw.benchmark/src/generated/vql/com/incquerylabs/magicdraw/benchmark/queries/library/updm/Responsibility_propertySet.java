...
public final class Responsibility_propertySet extends BaseGeneratedEMFQuerySpecification<Responsibility_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_propertySet.Match)) {
          Responsibility_propertySet.Match other = (Responsibility_propertySet.Match) obj;
    ...
    @Override
    public Responsibility_propertySet specification() {
      return Responsibility_propertySet.instance();
    }
     ...
     * 
     */
    public static Responsibility_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_propertySet.Match {
    ...
    private static final class Immutable extends Responsibility_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_propertySet.Match> processor) {
     ...
     * 
     */
    public Responsibility_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_propertySet.Match partialMatch) {
    ...
    @Override
    protected Responsibility_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_propertySet.Matcher> querySpecification() {
      return Responsibility_propertySet.instance();
    }
  }
  
  private Responsibility_propertySet() {
   ...
   * 
   */
  public static Responsibility_propertySet instance() {
    try{
  ...
  @Override
  protected Responsibility_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_propertySet.Matcher instantiate() {
    return Responsibility_propertySet.Matcher.create();
  }
  
  @Override
  public Responsibility_propertySet.Match newEmptyMatch() {
    return Responsibility_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_propertySet.Match newMatch(final Object... parameters) {
    return Responsibility_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_propertySet INSTANCE = new Responsibility_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
