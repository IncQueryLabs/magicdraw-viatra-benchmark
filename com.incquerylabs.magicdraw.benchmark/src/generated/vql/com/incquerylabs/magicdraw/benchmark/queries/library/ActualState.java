...
public final class ActualState extends BaseGeneratedEMFQuerySpecification<ActualState.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualState pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualState";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualState.Match.parameterNames;
    }
    ...
    @Override
    public ActualState.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualState.Match)) {
          ActualState.Match other = (ActualState.Match) obj;
    ...
    @Override
    public ActualState specification() {
     ...
     * 
     */
    public static ActualState.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualState.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualState.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualState.Match {
    ...
    private static final class Immutable extends ActualState.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualState pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualState.Match> {
    /**
     ...
     * 
     */
    public static ActualState.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualState.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualState.Matcher.class);
     ...
     * 
     */
    public Collection<ActualState.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualState.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualState.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualState.Match> processor) {
     ...
     * 
     */
    public ActualState.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualState.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final ActualState.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final ActualState.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualState.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualState.Match partialMatch) {
    ...
    @Override
    protected ActualState.Match tupleToMatch(final Tuple t) {
      try {
          return ActualState.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualState.Match arrayToMatch(final Object[] match) {
      try {
          return ActualState.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualState.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualState.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualState.Matcher> querySpecification() {
      return ActualState.instance();
    }
  }
   ...
   * 
   */
  public static ActualState instance() {
    try{
  ...
  @Override
  protected ActualState.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualState.Matcher.on(engine);
  }
  
  @Override
  public ActualState.Matcher instantiate() {
    return ActualState.Matcher.create();
  }
  
  @Override
  public ActualState.Match newEmptyMatch() {
    return ActualState.Match.newEmptyMatch();
  }
  
  @Override
  public ActualState.Match newMatch(final Object... parameters) {
    return ActualState.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualState} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualState#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualState INSTANCE = new ActualState();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualState.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualState")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualState");
