...
public final class Skill_conformsTo extends BaseGeneratedEMFQuerySpecification<Skill_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Skill_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Skill_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Skill_conformsTo.Match)) {
          Skill_conformsTo.Match other = (Skill_conformsTo.Match) obj;
    ...
    @Override
    public Skill_conformsTo specification() {
      return Skill_conformsTo.instance();
    }
     ...
     * 
     */
    public static Skill_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Skill_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Skill_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Skill_conformsTo.Match {
    ...
    private static final class Immutable extends Skill_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Skill_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Skill_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Skill_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Skill_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Skill_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Skill_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Skill_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Skill_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Skill_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Skill_conformsTo.Match> processor) {
     ...
     * 
     */
    public Skill_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Skill_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Skill_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Skill_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Skill_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Skill_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Skill_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Skill_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Skill_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Skill_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Skill_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Skill_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Skill_conformsTo.Matcher> querySpecification() {
      return Skill_conformsTo.instance();
    }
  }
  
  private Skill_conformsTo() {
   ...
   * 
   */
  public static Skill_conformsTo instance() {
    try{
  ...
  @Override
  protected Skill_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Skill_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Skill_conformsTo.Matcher instantiate() {
    return Skill_conformsTo.Matcher.create();
  }
  
  @Override
  public Skill_conformsTo.Match newEmptyMatch() {
    return Skill_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Skill_conformsTo.Match newMatch(final Object... parameters) {
    return Skill_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Skill_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Skill_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Skill_conformsTo INSTANCE = new Skill_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Skill_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
