 ...
 *         pattern Pattern(Element : Element, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "Pattern");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Pattern extends BaseGeneratedEMFQuerySpecification<Pattern.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Pattern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Pattern";
    }
    
    @Override
    public List<String> parameterNames() {
      return Pattern.Match.parameterNames;
    }
    ...
    @Override
    public Pattern.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Pattern.Match)) {
          Pattern.Match other = (Pattern.Match) obj;
     ...
     * 
     */
    public static Pattern.Match newEmptyMatch() {
     ...
     * 
     */
    public static Pattern.Match newMutableMatch(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Pattern.Match newMatch(final Element pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Pattern.Match {
    ...
    private static final class Immutable extends Pattern.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Pattern pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Pattern.Match> {
    /**
     ...
     * 
     */
    public static Pattern.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Pattern.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Pattern.Matcher.class);
     ...
     * 
     */
    public Collection<Pattern.Match> getAllMatches(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Pattern.Match> streamAllMatches(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Pattern.Match> getOneArbitraryMatch(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final Stereotype pStereotype, final Consumer<? super Pattern.Match> processor) {
     ...
     * 
     */
    public Pattern.Match newMatch(final Element pElement, final Stereotype pStereotype) {
      return Pattern.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfElement(final Pattern.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfElement(final Pattern.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Pattern.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Pattern.Match partialMatch) {
    ...
    @Override
    protected Pattern.Match tupleToMatch(final Tuple t) {
      try {
          return Pattern.Match.newMatch((Element) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Pattern.Match arrayToMatch(final Object[] match) {
      try {
          return Pattern.Match.newMatch((Element) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Pattern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Pattern.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Pattern.Matcher> querySpecification() {
      return Pattern.instance();
    }
  }
  ...
  @Override
  protected Pattern.Matcher instantiate(final ViatraQueryEngine engine) {
    return Pattern.Matcher.on(engine);
  }
  
  @Override
  public Pattern.Matcher instantiate() {
    return Pattern.Matcher.create();
  }
  
  @Override
  public Pattern.Match newEmptyMatch() {
    return Pattern.Match.newEmptyMatch();
  }
  
  @Override
  public Pattern.Match newMatch(final Object... parameters) {
    return Pattern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Pattern.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Pattern");
