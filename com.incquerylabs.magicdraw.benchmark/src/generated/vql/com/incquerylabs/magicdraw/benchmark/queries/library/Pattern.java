 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "additional_stereotypes", "Pattern");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Pattern extends BaseGeneratedEMFQuerySpecification<Pattern.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Pattern.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Pattern.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
  ...
  public static class Matcher extends BaseMatcher<Pattern.Match> {
     ...
     * 
     */
    public Collection<Pattern.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Pattern.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Pattern.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Pattern.Match> processor) {
     ...
     * 
     */
    public Pattern.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Pattern.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Pattern.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Pattern.Match partialMatch) {
    ...
    protected Pattern.Match tupleToMatch(final Tuple t) {
      try {
          return Pattern.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    protected Pattern.Match arrayToMatch(final Object[] match) {
      try {
          return Pattern.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    protected Pattern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Pattern.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Pattern.Match newMatch(final Object... parameters) {
    return Pattern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
