...
public final class ProjectStatus_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectStatus_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectStatus_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectStatus_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectStatus_startBoundaryType.Match)) {
          ProjectStatus_startBoundaryType.Match other = (ProjectStatus_startBoundaryType.Match) obj;
    ...
    @Override
    public ProjectStatus_startBoundaryType specification() {
      return ProjectStatus_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectStatus_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectStatus_startBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectStatus_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectStatus_startBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectStatus_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectStatus_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectStatus_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectStatus_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectStatus_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectStatus_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectStatus_startBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectStatus_startBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectStatus_startBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ProjectStatus_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectStatus_startBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ProjectStatus_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ProjectStatus_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ProjectStatus_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectStatus_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectStatus_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectStatus_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectStatus_startBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectStatus_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectStatus_startBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectStatus_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectStatus_startBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectStatus_startBoundaryType.Matcher> querySpecification() {
      return ProjectStatus_startBoundaryType.instance();
    }
  }
  
  private ProjectStatus_startBoundaryType() {
   ...
   * 
   */
  public static ProjectStatus_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectStatus_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectStatus_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectStatus_startBoundaryType.Matcher instantiate() {
    return ProjectStatus_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectStatus_startBoundaryType.Match newEmptyMatch() {
    return ProjectStatus_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectStatus_startBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectStatus_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectStatus_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectStatus_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectStatus_startBoundaryType INSTANCE = new ProjectStatus_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectStatus_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
