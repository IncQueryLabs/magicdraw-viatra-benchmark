...
public final class Alias extends BaseGeneratedEMFQuerySpecification<Alias.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Alias pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Alias";
    }
    
    @Override
    public List<String> parameterNames() {
      return Alias.Match.parameterNames;
    }
    ...
    @Override
    public Alias.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Alias.Match)) {
          Alias.Match other = (Alias.Match) obj;
     ...
     * 
     */
    public static Alias.Match newEmptyMatch() {
     ...
     * 
     */
    public static Alias.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Alias.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Alias.Match {
    ...
    private static final class Immutable extends Alias.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Alias pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Alias.Match> {
    /**
     ...
     * 
     */
    public static Alias.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Alias.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Alias.Matcher.class);
     ...
     * 
     */
    public Collection<Alias.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Alias.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Alias.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Alias.Match> processor) {
     ...
     * 
     */
    public Alias.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Alias.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Alias.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Alias.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Alias.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Alias.Match partialMatch) {
    ...
    @Override
    protected Alias.Match tupleToMatch(final Tuple t) {
      try {
          return Alias.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Alias.Match arrayToMatch(final Object[] match) {
      try {
          return Alias.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Alias.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Alias.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Alias.Matcher> querySpecification() {
      return Alias.instance();
    }
  }
  ...
  @Override
  protected Alias.Matcher instantiate(final ViatraQueryEngine engine) {
    return Alias.Matcher.on(engine);
  }
  
  @Override
  public Alias.Matcher instantiate() {
    return Alias.Matcher.create();
  }
  
  @Override
  public Alias.Match newEmptyMatch() {
    return Alias.Match.newEmptyMatch();
  }
  
  @Override
  public Alias.Match newMatch(final Object... parameters) {
    return Alias.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Alias} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Alias#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Alias.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Alias")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Alias");
