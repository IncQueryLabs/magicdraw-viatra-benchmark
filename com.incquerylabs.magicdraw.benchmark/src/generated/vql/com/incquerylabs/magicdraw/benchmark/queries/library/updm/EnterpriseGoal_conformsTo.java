...
public final class EnterpriseGoal_conformsTo extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_conformsTo.Match)) {
          EnterpriseGoal_conformsTo.Match other = (EnterpriseGoal_conformsTo.Match) obj;
    ...
    @Override
    public EnterpriseGoal_conformsTo specification() {
      return EnterpriseGoal_conformsTo.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_conformsTo.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseGoal_conformsTo.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseGoal_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseGoal_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseGoal_conformsTo.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_conformsTo.Matcher> querySpecification() {
      return EnterpriseGoal_conformsTo.instance();
    }
  }
  
  private EnterpriseGoal_conformsTo() {
   ...
   * 
   */
  public static EnterpriseGoal_conformsTo instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_conformsTo.Matcher instantiate() {
    return EnterpriseGoal_conformsTo.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_conformsTo.Match newEmptyMatch() {
    return EnterpriseGoal_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_conformsTo.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_conformsTo INSTANCE = new EnterpriseGoal_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
