...
public final class CapabilityConfiguration_appliesTo extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_appliesTo.Match)) {
          CapabilityConfiguration_appliesTo.Match other = (CapabilityConfiguration_appliesTo.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_appliesTo specification() {
      return CapabilityConfiguration_appliesTo.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_appliesTo.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_appliesTo.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_appliesTo.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_appliesTo.Matcher> querySpecification() {
      return CapabilityConfiguration_appliesTo.instance();
    }
  }
  
  private CapabilityConfiguration_appliesTo() {
   ...
   * 
   */
  public static CapabilityConfiguration_appliesTo instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_appliesTo.Matcher instantiate() {
    return CapabilityConfiguration_appliesTo.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_appliesTo.Match newEmptyMatch() {
    return CapabilityConfiguration_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_appliesTo.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_appliesTo INSTANCE = new CapabilityConfiguration_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
