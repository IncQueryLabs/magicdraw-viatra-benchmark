...
public final class ConformGeneralNotViewpoint extends BaseGeneratedEMFQuerySpecification<ConformGeneralNotViewpoint.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public Object get(final String parameterName) {
      switch(parameterName) {
          case "conform": return this.fConform;
          default: return null;
      }
    }
  ...
  /**
   * Inner class allowing the singleton instance of {@link ConformGeneralNotViewpoint} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConformGeneralNotViewpoint#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new TypeConstraint(body, Tuples.flatTupleOf(var_conform, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1.1", "Generalization", "general")));
