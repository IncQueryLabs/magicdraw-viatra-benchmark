...
public final class ServiceSpecificationRole_conformsTo extends BaseGeneratedEMFQuerySpecification<ServiceSpecificationRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecificationRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecificationRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceSpecificationRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ServiceSpecificationRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceSpecificationRole_conformsTo.Match)) {
          ServiceSpecificationRole_conformsTo.Match other = (ServiceSpecificationRole_conformsTo.Match) obj;
    ...
    @Override
    public ServiceSpecificationRole_conformsTo specification() {
      return ServiceSpecificationRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static ServiceSpecificationRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceSpecificationRole_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceSpecificationRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceSpecificationRole_conformsTo.Match {
    ...
    private static final class Immutable extends ServiceSpecificationRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecificationRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ServiceSpecificationRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceSpecificationRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ServiceSpecificationRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceSpecificationRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceSpecificationRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceSpecificationRole_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceSpecificationRole_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceSpecificationRole_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ServiceSpecificationRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public ServiceSpecificationRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ServiceSpecificationRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceSpecificationRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceSpecificationRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceSpecificationRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceSpecificationRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ServiceSpecificationRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceSpecificationRole_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceSpecificationRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceSpecificationRole_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceSpecificationRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceSpecificationRole_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceSpecificationRole_conformsTo.Matcher> querySpecification() {
      return ServiceSpecificationRole_conformsTo.instance();
    }
  }
  
  private ServiceSpecificationRole_conformsTo() {
   ...
   * 
   */
  public static ServiceSpecificationRole_conformsTo instance() {
    try{
  ...
  @Override
  protected ServiceSpecificationRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceSpecificationRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ServiceSpecificationRole_conformsTo.Matcher instantiate() {
    return ServiceSpecificationRole_conformsTo.Matcher.create();
  }
  
  @Override
  public ServiceSpecificationRole_conformsTo.Match newEmptyMatch() {
    return ServiceSpecificationRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceSpecificationRole_conformsTo.Match newMatch(final Object... parameters) {
    return ServiceSpecificationRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceSpecificationRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceSpecificationRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceSpecificationRole_conformsTo INSTANCE = new ServiceSpecificationRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceSpecificationRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
