...
public final class SecurityEnclave_URI extends BaseGeneratedEMFQuerySpecification<SecurityEnclave_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave_URI.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave_URI.Match)) {
          SecurityEnclave_URI.Match other = (SecurityEnclave_URI.Match) obj;
    ...
    @Override
    public SecurityEnclave_URI specification() {
      return SecurityEnclave_URI.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SecurityEnclave_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityEnclave_URI.Match {
    ...
    private static final class Immutable extends SecurityEnclave_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_URI pattern,
   ...
   * 
   * @see Match
   * @see SecurityEnclave_URI
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave_URI.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave_URI.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SecurityEnclave_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SecurityEnclave_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super SecurityEnclave_URI.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return SecurityEnclave_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SecurityEnclave_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SecurityEnclave_URI.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave_URI.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityEnclave_URI.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave_URI.Matcher> querySpecification() {
      return SecurityEnclave_URI.instance();
    }
  }
  
  private SecurityEnclave_URI() {
   ...
   * 
   */
  public static SecurityEnclave_URI instance() {
    try{
  ...
  @Override
  protected SecurityEnclave_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave_URI.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave_URI.Matcher instantiate() {
    return SecurityEnclave_URI.Matcher.create();
  }
  
  @Override
  public SecurityEnclave_URI.Match newEmptyMatch() {
    return SecurityEnclave_URI.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave_URI.Match newMatch(final Object... parameters) {
    return SecurityEnclave_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave_URI INSTANCE = new SecurityEnclave_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
