...
public final class DeriveReqt_sourceContext extends BaseGeneratedEMFQuerySpecification<DeriveReqt_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DeriveReqt_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DeriveReqt_sourceContext";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DeriveReqt_sourceContext pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link DeriveReqt_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DeriveReqt_sourceContext#instance()}.
   * 
