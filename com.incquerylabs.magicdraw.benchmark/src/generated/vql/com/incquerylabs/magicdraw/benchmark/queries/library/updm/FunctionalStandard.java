...
public final class FunctionalStandard extends BaseGeneratedEMFQuerySpecification<FunctionalStandard.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard.Match)) {
          FunctionalStandard.Match other = (FunctionalStandard.Match) obj;
    ...
    @Override
    public FunctionalStandard specification() {
      return FunctionalStandard.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static FunctionalStandard.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends FunctionalStandard.Match {
    ...
    private static final class Immutable extends FunctionalStandard.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<FunctionalStandard.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<FunctionalStandard.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super FunctionalStandard.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return FunctionalStandard.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final FunctionalStandard.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final FunctionalStandard.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected FunctionalStandard.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard.Matcher> querySpecification() {
      return FunctionalStandard.instance();
    }
  }
  
  private FunctionalStandard() {
   ...
   * 
   */
  public static FunctionalStandard instance() {
    try{
  ...
  @Override
  protected FunctionalStandard.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard.Matcher instantiate() {
    return FunctionalStandard.Matcher.create();
  }
  
  @Override
  public FunctionalStandard.Match newEmptyMatch() {
    return FunctionalStandard.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard.Match newMatch(final Object... parameters) {
    return FunctionalStandard.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard INSTANCE = new FunctionalStandard();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "FunctionalStandard");
