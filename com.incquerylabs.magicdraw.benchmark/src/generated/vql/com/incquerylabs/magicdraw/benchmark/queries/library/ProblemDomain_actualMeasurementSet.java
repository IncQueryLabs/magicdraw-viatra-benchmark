...
import com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain;
...
public final class ProblemDomain_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<ProblemDomain_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_actualMeasurementSet.Match)) {
          ProblemDomain_actualMeasurementSet.Match other = (ProblemDomain_actualMeasurementSet.Match) obj;
    ...
    @Override
    public ProblemDomain_actualMeasurementSet specification() {
      return ProblemDomain_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends ProblemDomain_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_actualMeasurementSet.Matcher> querySpecification() {
      return ProblemDomain_actualMeasurementSet.instance();
    }
  }
  
  private ProblemDomain_actualMeasurementSet() {
   ...
   * 
   */
  public static ProblemDomain_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected ProblemDomain_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_actualMeasurementSet.Matcher instantiate() {
    return ProblemDomain_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public ProblemDomain_actualMeasurementSet.Match newEmptyMatch() {
    return ProblemDomain_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return ProblemDomain_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_actualMeasurementSet INSTANCE = new ProblemDomain_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ProblemDomain(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ProblemDomain.instance().getInternalQueryRepresentation());
