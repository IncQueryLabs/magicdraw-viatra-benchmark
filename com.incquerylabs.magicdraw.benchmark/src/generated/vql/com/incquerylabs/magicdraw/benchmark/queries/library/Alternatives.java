 ...
 * <p>Original source:
 *         <code><pre>
 *         //Pattern that queries elements with the stereotype 'alternatives' or other stereotypes generalizing it.
 *         pattern alternatives(Element : Property, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "alternatives");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Alternatives extends BaseGeneratedEMFQuerySpecification<Alternatives.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.alternatives pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.alternatives";
    }
    
    @Override
    public List<String> parameterNames() {
      return Alternatives.Match.parameterNames;
    }
    ...
    @Override
    public Alternatives.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Alternatives.Match)) {
          Alternatives.Match other = (Alternatives.Match) obj;
    ...
    @Override
    public Alternatives specification() {
     ...
     * 
     */
    public static Alternatives.Match newEmptyMatch() {
     ...
     * 
     */
    public static Alternatives.Match newMutableMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Alternatives.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Alternatives.Match {
    ...
    private static final class Immutable extends Alternatives.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.alternatives pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Alternatives.Match> {
    /**
     ...
     * 
     */
    public static Alternatives.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Alternatives.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Alternatives.Matcher.class);
     ...
     * 
     */
    public Collection<Alternatives.Match> getAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Alternatives.Match> streamAllMatches(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Alternatives.Match> getOneArbitraryMatch(final Property pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Stereotype pStereotype, final Consumer<? super Alternatives.Match> processor) {
     ...
     * 
     */
    public Alternatives.Match newMatch(final Property pElement, final Stereotype pStereotype) {
      return Alternatives.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfElement(final Alternatives.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfElement(final Alternatives.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Alternatives.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Alternatives.Match partialMatch) {
    ...
    @Override
    protected Alternatives.Match tupleToMatch(final Tuple t) {
      try {
          return Alternatives.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Alternatives.Match arrayToMatch(final Object[] match) {
      try {
          return Alternatives.Match.newMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Alternatives.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Alternatives.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Alternatives.Matcher> querySpecification() {
      return Alternatives.instance();
    }
  }
   ...
   * 
   */
  public static Alternatives instance() {
    try{
  ...
  @Override
  protected Alternatives.Matcher instantiate(final ViatraQueryEngine engine) {
    return Alternatives.Matcher.on(engine);
  }
  
  @Override
  public Alternatives.Matcher instantiate() {
    return Alternatives.Matcher.create();
  }
  
  @Override
  public Alternatives.Match newEmptyMatch() {
    return Alternatives.Match.newEmptyMatch();
  }
  
  @Override
  public Alternatives.Match newMatch(final Object... parameters) {
    return Alternatives.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Alternatives} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Alternatives#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Alternatives INSTANCE = new Alternatives();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Alternatives.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "alternatives");
