...
public final class OrganizationalResource_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_requiredEnvironment.Match)) {
          OrganizationalResource_requiredEnvironment.Match other = (OrganizationalResource_requiredEnvironment.Match) obj;
    ...
    @Override
    public OrganizationalResource_requiredEnvironment specification() {
      return OrganizationalResource_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_requiredEnvironment.Match {
    ...
    private static final class Immutable extends OrganizationalResource_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_requiredEnvironment.Matcher> querySpecification() {
      return OrganizationalResource_requiredEnvironment.instance();
    }
  }
  
  private OrganizationalResource_requiredEnvironment() {
   ...
   * 
   */
  public static OrganizationalResource_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_requiredEnvironment.Matcher instantiate() {
    return OrganizationalResource_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_requiredEnvironment.Match newEmptyMatch() {
    return OrganizationalResource_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_requiredEnvironment.Match newMatch(final Object... parameters) {
    return OrganizationalResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_requiredEnvironment INSTANCE = new OrganizationalResource_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
