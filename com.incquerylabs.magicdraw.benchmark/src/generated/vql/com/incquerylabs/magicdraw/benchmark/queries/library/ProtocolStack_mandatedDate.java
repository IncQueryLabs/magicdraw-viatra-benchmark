...
public final class ProtocolStack_mandatedDate extends BaseGeneratedEMFQuerySpecification<ProtocolStack_mandatedDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_mandatedDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_mandatedDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolStack_mandatedDate.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolStack_mandatedDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolStack_mandatedDate.Match)) {
          ProtocolStack_mandatedDate.Match other = (ProtocolStack_mandatedDate.Match) obj;
    ...
    @Override
    public ProtocolStack_mandatedDate specification() {
      return ProtocolStack_mandatedDate.instance();
    }
     ...
     * 
     */
    public static ProtocolStack_mandatedDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolStack_mandatedDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProtocolStack_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProtocolStack_mandatedDate.Match {
    ...
    private static final class Immutable extends ProtocolStack_mandatedDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack_mandatedDate pattern,
   ...
   * 
   * @see Match
   * @see ProtocolStack_mandatedDate
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolStack_mandatedDate.Match> {
    /**
     ...
     * 
     */
    public static ProtocolStack_mandatedDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolStack_mandatedDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolStack_mandatedDate.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolStack_mandatedDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProtocolStack_mandatedDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProtocolStack_mandatedDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProtocolStack_mandatedDate.Match> processor) {
     ...
     * 
     */
    public ProtocolStack_mandatedDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProtocolStack_mandatedDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProtocolStack_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProtocolStack_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProtocolStack_mandatedDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProtocolStack_mandatedDate.Match partialMatch) {
    ...
    @Override
    protected ProtocolStack_mandatedDate.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolStack_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProtocolStack_mandatedDate.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolStack_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolStack_mandatedDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolStack_mandatedDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolStack_mandatedDate.Matcher> querySpecification() {
      return ProtocolStack_mandatedDate.instance();
    }
  }
  
  private ProtocolStack_mandatedDate() {
   ...
   * 
   */
  public static ProtocolStack_mandatedDate instance() {
    try{
  ...
  @Override
  protected ProtocolStack_mandatedDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolStack_mandatedDate.Matcher.on(engine);
  }
  
  @Override
  public ProtocolStack_mandatedDate.Matcher instantiate() {
    return ProtocolStack_mandatedDate.Matcher.create();
  }
  
  @Override
  public ProtocolStack_mandatedDate.Match newEmptyMatch() {
    return ProtocolStack_mandatedDate.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolStack_mandatedDate.Match newMatch(final Object... parameters) {
    return ProtocolStack_mandatedDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolStack_mandatedDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolStack_mandatedDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolStack_mandatedDate INSTANCE = new ProtocolStack_mandatedDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolStack_mandatedDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
