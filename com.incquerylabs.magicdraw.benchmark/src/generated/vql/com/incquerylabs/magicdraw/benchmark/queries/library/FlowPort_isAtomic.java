...
public final class FlowPort_isAtomic extends BaseGeneratedEMFQuerySpecification<FlowPort_isAtomic.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FlowPort_isAtomic pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FlowPort_isAtomic";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FlowPort_isAtomic pattern,
