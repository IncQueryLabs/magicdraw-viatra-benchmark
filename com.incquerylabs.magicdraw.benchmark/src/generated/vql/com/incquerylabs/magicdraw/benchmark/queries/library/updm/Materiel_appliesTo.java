...
public final class Materiel_appliesTo extends BaseGeneratedEMFQuerySpecification<Materiel_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_appliesTo.Match)) {
          Materiel_appliesTo.Match other = (Materiel_appliesTo.Match) obj;
    ...
    @Override
    public Materiel_appliesTo specification() {
      return Materiel_appliesTo.instance();
    }
     ...
     * 
     */
    public static Materiel_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Materiel_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Materiel_appliesTo.Match {
    ...
    private static final class Immutable extends Materiel_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Materiel_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Materiel_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Materiel_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Materiel_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Materiel_appliesTo.Match> processor) {
     ...
     * 
     */
    public Materiel_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Materiel_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Materiel_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Materiel_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Materiel_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Materiel_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_appliesTo.Matcher> querySpecification() {
      return Materiel_appliesTo.instance();
    }
  }
  
  private Materiel_appliesTo() {
   ...
   * 
   */
  public static Materiel_appliesTo instance() {
    try{
  ...
  @Override
  protected Materiel_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Materiel_appliesTo.Matcher instantiate() {
    return Materiel_appliesTo.Matcher.create();
  }
  
  @Override
  public Materiel_appliesTo.Match newEmptyMatch() {
    return Materiel_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_appliesTo.Match newMatch(final Object... parameters) {
    return Materiel_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_appliesTo INSTANCE = new Materiel_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
