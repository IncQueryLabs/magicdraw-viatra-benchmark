...
public final class MessageType extends BaseGeneratedEMFQuerySpecification<MessageType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.MessageType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.MessageType";
    }
    
    @Override
    public List<String> parameterNames() {
      return MessageType.Match.parameterNames;
    }
    ...
    @Override
    public MessageType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof MessageType.Match)) {
          MessageType.Match other = (MessageType.Match) obj;
    ...
    @Override
    public MessageType specification() {
     ...
     * 
     */
    public static MessageType.Match newEmptyMatch() {
     ...
     * 
     */
    public static MessageType.Match newMutableMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static MessageType.Match newMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends MessageType.Match {
    ...
    private static final class Immutable extends MessageType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.MessageType pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<MessageType.Match> {
    /**
     ...
     * 
     */
    public static MessageType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static MessageType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MessageType.Matcher.class);
     ...
     * 
     */
    public Collection<MessageType.Match> getAllMatches(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<MessageType.Match> streamAllMatches(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<MessageType.Match> getOneArbitraryMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super MessageType.Match> processor) {
     ...
     * 
     */
    public MessageType.Match newMatch(final Classifier pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return MessageType.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfelement(final MessageType.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfelement(final MessageType.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final MessageType.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final MessageType.Match partialMatch) {
    ...
    @Override
    protected MessageType.Match tupleToMatch(final Tuple t) {
      try {
          return MessageType.Match.newMatch((Classifier) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected MessageType.Match arrayToMatch(final Object[] match) {
      try {
          return MessageType.Match.newMatch((Classifier) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected MessageType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return MessageType.Match.newMutableMatch((Classifier) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<MessageType.Matcher> querySpecification() {
      return MessageType.instance();
    }
  }
  ...
  @Override
  protected MessageType.Matcher instantiate(final ViatraQueryEngine engine) {
    return MessageType.Matcher.on(engine);
  }
  
  @Override
  public MessageType.Matcher instantiate() {
    return MessageType.Matcher.create();
  }
  
  @Override
  public MessageType.Match newEmptyMatch() {
    return MessageType.Match.newEmptyMatch();
  }
  
  @Override
  public MessageType.Match newMatch(final Object... parameters) {
    return MessageType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MessageType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link MessageType#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final MessageType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "MessageType");
