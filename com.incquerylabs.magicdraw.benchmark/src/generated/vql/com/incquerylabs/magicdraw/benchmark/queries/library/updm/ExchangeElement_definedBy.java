...
public final class ExchangeElement_definedBy extends BaseGeneratedEMFQuerySpecification<ExchangeElement_definedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_definedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_definedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_definedBy.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_definedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_definedBy.Match)) {
          ExchangeElement_definedBy.Match other = (ExchangeElement_definedBy.Match) obj;
    ...
    @Override
    public ExchangeElement_definedBy specification() {
      return ExchangeElement_definedBy.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_definedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_definedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_definedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_definedBy.Match {
    ...
    private static final class Immutable extends ExchangeElement_definedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_definedBy pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_definedBy
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_definedBy.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_definedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_definedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_definedBy.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_definedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_definedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_definedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_definedBy.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_definedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_definedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_definedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_definedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_definedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_definedBy.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_definedBy.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_definedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_definedBy.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_definedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_definedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_definedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_definedBy.Matcher> querySpecification() {
      return ExchangeElement_definedBy.instance();
    }
  }
  
  private ExchangeElement_definedBy() {
   ...
   * 
   */
  public static ExchangeElement_definedBy instance() {
    try{
  ...
  @Override
  protected ExchangeElement_definedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_definedBy.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_definedBy.Matcher instantiate() {
    return ExchangeElement_definedBy.Matcher.create();
  }
  
  @Override
  public ExchangeElement_definedBy.Match newEmptyMatch() {
    return ExchangeElement_definedBy.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_definedBy.Match newMatch(final Object... parameters) {
    return ExchangeElement_definedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_definedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_definedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_definedBy INSTANCE = new ExchangeElement_definedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_definedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "definedBy");
