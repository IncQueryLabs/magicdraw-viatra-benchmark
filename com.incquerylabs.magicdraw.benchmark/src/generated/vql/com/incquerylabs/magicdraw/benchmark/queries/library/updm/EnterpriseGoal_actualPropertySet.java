...
public final class EnterpriseGoal_actualPropertySet extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_actualPropertySet.Match)) {
          EnterpriseGoal_actualPropertySet.Match other = (EnterpriseGoal_actualPropertySet.Match) obj;
    ...
    @Override
    public EnterpriseGoal_actualPropertySet specification() {
      return EnterpriseGoal_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_actualPropertySet.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseGoal_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseGoal_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseGoal_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseGoal_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_actualPropertySet.Matcher> querySpecification() {
      return EnterpriseGoal_actualPropertySet.instance();
    }
  }
  
  private EnterpriseGoal_actualPropertySet() {
   ...
   * 
   */
  public static EnterpriseGoal_actualPropertySet instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_actualPropertySet.Matcher instantiate() {
    return EnterpriseGoal_actualPropertySet.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_actualPropertySet.Match newEmptyMatch() {
    return EnterpriseGoal_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_actualPropertySet.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_actualPropertySet INSTANCE = new EnterpriseGoal_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
