...
public final class External_isEncapsulated extends BaseGeneratedEMFQuerySpecification<External_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.External_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.External_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return External_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public External_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof External_isEncapsulated.Match)) {
          External_isEncapsulated.Match other = (External_isEncapsulated.Match) obj;
    ...
    @Override
    public External_isEncapsulated specification() {
     ...
     * 
     */
    public static External_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static External_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static External_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends External_isEncapsulated.Match {
    ...
    private static final class Immutable extends External_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.External_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see External_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<External_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static External_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static External_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(External_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<External_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<External_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<External_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super External_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public External_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return External_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final External_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final External_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final External_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final External_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected External_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return External_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected External_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return External_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected External_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return External_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<External_isEncapsulated.Matcher> querySpecification() {
      return External_isEncapsulated.instance();
    }
  }
  
  private External_isEncapsulated() {
   ...
   * 
   */
  public static External_isEncapsulated instance() {
    try{
  ...
  @Override
  protected External_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return External_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public External_isEncapsulated.Matcher instantiate() {
    return External_isEncapsulated.Matcher.create();
  }
  
  @Override
  public External_isEncapsulated.Match newEmptyMatch() {
    return External_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public External_isEncapsulated.Match newMatch(final Object... parameters) {
    return External_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  ...
  private static class LazyHolder {
    private static final External_isEncapsulated INSTANCE = new External_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final External_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find External(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), External.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
