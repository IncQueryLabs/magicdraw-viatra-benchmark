...
public final class External_isEncapsulated extends BaseGeneratedEMFQuerySpecification<External_isEncapsulated.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static External_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public static External_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
  ...
  public static class Matcher extends BaseMatcher<External_isEncapsulated.Match> {
     ...
     * 
     */
    public Collection<External_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public Stream<External_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public Optional<External_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue, final Consumer<? super External_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public External_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
      return External_isEncapsulated.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Boolean> streamAllValuesOfValue(final External_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfValue(final External_isEncapsulated.Match partialMatch) {
    ...
    protected External_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return External_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Boolean) t.get(POSITION_VALUE));
    ...
    protected External_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return External_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Boolean) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected External_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return External_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Boolean) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public External_isEncapsulated.Match newMatch(final Object... parameters) {
    return External_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.Boolean) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find External(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), External.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "isEncapsulated", taggedValue)
