...
public final class OperationalInterface extends BaseGeneratedEMFQuerySpecification<OperationalInterface.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalInterface.Match.parameterNames;
    }
    ...
    @Override
    public OperationalInterface.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalInterface.Match)) {
          OperationalInterface.Match other = (OperationalInterface.Match) obj;
    ...
    @Override
    public OperationalInterface specification() {
      return OperationalInterface.instance();
    }
     ...
     * 
     */
    public static OperationalInterface.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalInterface.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalInterface.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalInterface.Match {
    ...
    private static final class Immutable extends OperationalInterface.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface pattern,
   ...
   * 
   * @see Match
   * @see OperationalInterface
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalInterface.Match> {
    /**
     ...
     * 
     */
    public static OperationalInterface.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalInterface.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalInterface.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalInterface.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalInterface.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalInterface.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalInterface.Match> processor) {
     ...
     * 
     */
    public OperationalInterface.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalInterface.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalInterface.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalInterface.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalInterface.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalInterface.Match partialMatch) {
    ...
    @Override
    protected OperationalInterface.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalInterface.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalInterface.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalInterface.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalInterface.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalInterface.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalInterface.Matcher> querySpecification() {
      return OperationalInterface.instance();
    }
  }
   ...
   * 
   */
  public static OperationalInterface instance() {
    try{
  ...
  @Override
  protected OperationalInterface.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalInterface.Matcher.on(engine);
  }
  
  @Override
  public OperationalInterface.Matcher instantiate() {
    return OperationalInterface.Matcher.create();
  }
  
  @Override
  public OperationalInterface.Match newEmptyMatch() {
    return OperationalInterface.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalInterface.Match newMatch(final Object... parameters) {
    return OperationalInterface.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalInterface} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalInterface#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalInterface INSTANCE = new OperationalInterface();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalInterface.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalInterface")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalInterface");
