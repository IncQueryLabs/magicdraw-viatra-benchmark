...
public final class VersionedElement_conformsTo extends BaseGeneratedEMFQuerySpecification<VersionedElement_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.VersionedElement_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.VersionedElement_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionedElement_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public VersionedElement_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionedElement_conformsTo.Match)) {
          VersionedElement_conformsTo.Match other = (VersionedElement_conformsTo.Match) obj;
    ...
    @Override
    public VersionedElement_conformsTo specification() {
      return VersionedElement_conformsTo.instance();
    }
     ...
     * 
     */
    public static VersionedElement_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionedElement_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static VersionedElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends VersionedElement_conformsTo.Match {
    ...
    private static final class Immutable extends VersionedElement_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.VersionedElement_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see VersionedElement_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<VersionedElement_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static VersionedElement_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionedElement_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionedElement_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<VersionedElement_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<VersionedElement_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<VersionedElement_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super VersionedElement_conformsTo.Match> processor) {
     ...
     * 
     */
    public VersionedElement_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return VersionedElement_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final VersionedElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final VersionedElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final VersionedElement_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final VersionedElement_conformsTo.Match partialMatch) {
    ...
    @Override
    protected VersionedElement_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return VersionedElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected VersionedElement_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return VersionedElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionedElement_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionedElement_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionedElement_conformsTo.Matcher> querySpecification() {
      return VersionedElement_conformsTo.instance();
    }
  }
  
  private VersionedElement_conformsTo() {
   ...
   * 
   */
  public static VersionedElement_conformsTo instance() {
    try{
  ...
  @Override
  protected VersionedElement_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionedElement_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public VersionedElement_conformsTo.Matcher instantiate() {
    return VersionedElement_conformsTo.Matcher.create();
  }
  
  @Override
  public VersionedElement_conformsTo.Match newEmptyMatch() {
    return VersionedElement_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public VersionedElement_conformsTo.Match newMatch(final Object... parameters) {
    return VersionedElement_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionedElement_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionedElement_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionedElement_conformsTo INSTANCE = new VersionedElement_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionedElement_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
