...
public final class ActualProjectMilestoneRole_propertySet extends BaseGeneratedEMFQuerySpecification<ActualProjectMilestoneRole_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProjectMilestoneRole_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProjectMilestoneRole_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectMilestoneRole_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectMilestoneRole_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectMilestoneRole_propertySet.Match)) {
          ActualProjectMilestoneRole_propertySet.Match other = (ActualProjectMilestoneRole_propertySet.Match) obj;
    ...
    @Override
    public ActualProjectMilestoneRole_propertySet specification() {
      return ActualProjectMilestoneRole_propertySet.instance();
    }
     ...
     * 
     */
    public static ActualProjectMilestoneRole_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_propertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProjectMilestoneRole_propertySet.Match {
    ...
    private static final class Immutable extends ActualProjectMilestoneRole_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProjectMilestoneRole_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectMilestoneRole_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectMilestoneRole_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectMilestoneRole_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectMilestoneRole_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectMilestoneRole_propertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProjectMilestoneRole_propertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProjectMilestoneRole_propertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProjectMilestoneRole_propertySet.Match> processor) {
     ...
     * 
     */
    public ActualProjectMilestoneRole_propertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProjectMilestoneRole_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectMilestoneRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectMilestoneRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProjectMilestoneRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProjectMilestoneRole_propertySet.Match partialMatch) {
    ...
    @Override
    protected ActualProjectMilestoneRole_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectMilestoneRole_propertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProjectMilestoneRole_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_propertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectMilestoneRole_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_propertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectMilestoneRole_propertySet.Matcher> querySpecification() {
      return ActualProjectMilestoneRole_propertySet.instance();
    }
  }
  
  private ActualProjectMilestoneRole_propertySet() {
   ...
   * 
   */
  public static ActualProjectMilestoneRole_propertySet instance() {
    try{
  ...
  @Override
  protected ActualProjectMilestoneRole_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectMilestoneRole_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectMilestoneRole_propertySet.Matcher instantiate() {
    return ActualProjectMilestoneRole_propertySet.Matcher.create();
  }
  
  @Override
  public ActualProjectMilestoneRole_propertySet.Match newEmptyMatch() {
    return ActualProjectMilestoneRole_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectMilestoneRole_propertySet.Match newMatch(final Object... parameters) {
    return ActualProjectMilestoneRole_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectMilestoneRole_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectMilestoneRole_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectMilestoneRole_propertySet INSTANCE = new ActualProjectMilestoneRole_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectMilestoneRole_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
