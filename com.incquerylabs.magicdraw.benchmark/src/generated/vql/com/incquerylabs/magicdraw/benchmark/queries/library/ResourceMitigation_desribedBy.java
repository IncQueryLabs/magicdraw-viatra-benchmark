...
public final class ResourceMitigation_desribedBy extends BaseGeneratedEMFQuerySpecification<ResourceMitigation_desribedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_desribedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_desribedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceMitigation_desribedBy.Match.parameterNames;
    }
    ...
    @Override
    public ResourceMitigation_desribedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceMitigation_desribedBy.Match)) {
          ResourceMitigation_desribedBy.Match other = (ResourceMitigation_desribedBy.Match) obj;
    ...
    @Override
    public ResourceMitigation_desribedBy specification() {
      return ResourceMitigation_desribedBy.instance();
    }
     ...
     * 
     */
    public static ResourceMitigation_desribedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceMitigation_desribedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceMitigation_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceMitigation_desribedBy.Match {
    ...
    private static final class Immutable extends ResourceMitigation_desribedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_desribedBy pattern,
   ...
   * 
   * @see Match
   * @see ResourceMitigation_desribedBy
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceMitigation_desribedBy.Match> {
    /**
     ...
     * 
     */
    public static ResourceMitigation_desribedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceMitigation_desribedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceMitigation_desribedBy.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceMitigation_desribedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceMitigation_desribedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceMitigation_desribedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceMitigation_desribedBy.Match> processor) {
     ...
     * 
     */
    public ResourceMitigation_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceMitigation_desribedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceMitigation_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceMitigation_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceMitigation_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceMitigation_desribedBy.Match partialMatch) {
    ...
    @Override
    protected ResourceMitigation_desribedBy.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceMitigation_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceMitigation_desribedBy.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceMitigation_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceMitigation_desribedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceMitigation_desribedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceMitigation_desribedBy.Matcher> querySpecification() {
      return ResourceMitigation_desribedBy.instance();
    }
  }
  
  private ResourceMitigation_desribedBy() {
   ...
   * 
   */
  public static ResourceMitigation_desribedBy instance() {
    try{
  ...
  @Override
  protected ResourceMitigation_desribedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceMitigation_desribedBy.Matcher.on(engine);
  }
  
  @Override
  public ResourceMitigation_desribedBy.Matcher instantiate() {
    return ResourceMitigation_desribedBy.Matcher.create();
  }
  
  @Override
  public ResourceMitigation_desribedBy.Match newEmptyMatch() {
    return ResourceMitigation_desribedBy.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceMitigation_desribedBy.Match newMatch(final Object... parameters) {
    return ResourceMitigation_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceMitigation_desribedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceMitigation_desribedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceMitigation_desribedBy INSTANCE = new ResourceMitigation_desribedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceMitigation_desribedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
