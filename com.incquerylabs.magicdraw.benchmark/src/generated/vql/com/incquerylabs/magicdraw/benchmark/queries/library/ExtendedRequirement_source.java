...
public final class ExtendedRequirement_source extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_source.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static ExtendedRequirement_source.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public static ExtendedRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<ExtendedRequirement_source.Match> {
     ...
     * 
     */
    public Collection<ExtendedRequirement_source.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Stream<ExtendedRequirement_source.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Optional<ExtendedRequirement_source.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue, final Consumer<? super ExtendedRequirement_source.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement_source.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
      return ExtendedRequirement_source.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final ExtendedRequirement_source.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final ExtendedRequirement_source.Match partialMatch) {
    ...
    protected ExtendedRequirement_source.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected ExtendedRequirement_source.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected ExtendedRequirement_source.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement_source.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ExtendedRequirement_source.Match newMatch(final Object... parameters) {
    return ExtendedRequirement_source.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.String) parameters[1]);
  }
