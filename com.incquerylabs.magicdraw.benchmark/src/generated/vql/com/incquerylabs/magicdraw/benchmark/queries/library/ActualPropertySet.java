...
public final class ActualPropertySet extends BaseGeneratedEMFQuerySpecification<ActualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ActualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualPropertySet.Match)) {
          ActualPropertySet.Match other = (ActualPropertySet.Match) obj;
    ...
    @Override
    public ActualPropertySet specification() {
      return ActualPropertySet.instance();
    }
     ...
     * 
     */
    public static ActualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualPropertySet.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualPropertySet.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualPropertySet.Match {
    ...
    private static final class Immutable extends ActualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ActualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ActualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ActualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ActualPropertySet.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualPropertySet.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualPropertySet.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualPropertySet.Match> processor) {
     ...
     * 
     */
    public ActualPropertySet.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualPropertySet.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ActualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ActualPropertySet.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ActualPropertySet.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualPropertySet.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualPropertySet.Matcher> querySpecification() {
      return ActualPropertySet.instance();
    }
  }
  
  private ActualPropertySet() {
   ...
   * 
   */
  public static ActualPropertySet instance() {
    try{
  ...
  @Override
  protected ActualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ActualPropertySet.Matcher instantiate() {
    return ActualPropertySet.Matcher.create();
  }
  
  @Override
  public ActualPropertySet.Match newEmptyMatch() {
    return ActualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ActualPropertySet.Match newMatch(final Object... parameters) {
    return ActualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualPropertySet INSTANCE = new ActualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualPropertySet")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualPropertySet");
