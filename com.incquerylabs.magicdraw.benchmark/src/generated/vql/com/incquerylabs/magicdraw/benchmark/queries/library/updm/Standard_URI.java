...
public final class Standard_URI extends BaseGeneratedEMFQuerySpecification<Standard_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_URI.Match.parameterNames;
    }
    ...
    @Override
    public Standard_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_URI.Match)) {
          Standard_URI.Match other = (Standard_URI.Match) obj;
    ...
    @Override
    public Standard_URI specification() {
      return Standard_URI.instance();
    }
     ...
     * 
     */
    public static Standard_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Standard_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Standard_URI.Match {
    ...
    private static final class Immutable extends Standard_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_URI.Match> {
    /**
     ...
     * 
     */
    public static Standard_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Standard_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Standard_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Standard_URI.Match> processor) {
     ...
     * 
     */
    public Standard_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Standard_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Standard_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Standard_URI.Match partialMatch) {
    ...
    @Override
    protected Standard_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Standard_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_URI.Matcher> querySpecification() {
      return Standard_URI.instance();
    }
  }
  
  private Standard_URI() {
   ...
   * 
   */
  public static Standard_URI instance() {
    try{
  ...
  @Override
  protected Standard_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_URI.Matcher.on(engine);
  }
  
  @Override
  public Standard_URI.Matcher instantiate() {
    return Standard_URI.Matcher.create();
  }
  
  @Override
  public Standard_URI.Match newEmptyMatch() {
    return Standard_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_URI.Match newMatch(final Object... parameters) {
    return Standard_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_URI INSTANCE = new Standard_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
