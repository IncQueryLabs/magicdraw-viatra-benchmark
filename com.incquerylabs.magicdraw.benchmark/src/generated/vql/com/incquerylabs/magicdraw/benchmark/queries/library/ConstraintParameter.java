 ...
 *         pattern ConstraintParameter(Element : Port, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "ConstraintParameter");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class ConstraintParameter extends BaseGeneratedEMFQuerySpecification<ConstraintParameter.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ConstraintParameter pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ConstraintParameter";
    }
     ...
     * 
     */
    public static ConstraintParameter.Match newMutableMatch(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static ConstraintParameter.Match newMatch(final Port pElement, final Stereotype pStereotype) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ConstraintParameter pattern,
  ...
  public static class Matcher extends BaseMatcher<ConstraintParameter.Match> {
     ...
     * 
     */
    public Collection<ConstraintParameter.Match> getAllMatches(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<ConstraintParameter.Match> streamAllMatches(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<ConstraintParameter.Match> getOneArbitraryMatch(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final Stereotype pStereotype, final Consumer<? super ConstraintParameter.Match> processor) {
     ...
     * 
     */
    public ConstraintParameter.Match newMatch(final Port pElement, final Stereotype pStereotype) {
      return ConstraintParameter.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final ConstraintParameter.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final ConstraintParameter.Match partialMatch) {
    ...
    protected ConstraintParameter.Match tupleToMatch(final Tuple t) {
      try {
          return ConstraintParameter.Match.newMatch((Port) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected ConstraintParameter.Match arrayToMatch(final Object[] match) {
      try {
          return ConstraintParameter.Match.newMatch((Port) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected ConstraintParameter.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConstraintParameter.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ConstraintParameter.Match newMatch(final Object... parameters) {
    return ConstraintParameter.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConstraintParameter} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConstraintParameter#instance()}.
   * 
