...
public final class OperationalControlFlow extends BaseGeneratedEMFQuerySpecification<OperationalControlFlow.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalControlFlow pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalControlFlow";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalControlFlow.Match.parameterNames;
    }
    ...
    @Override
    public OperationalControlFlow.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalControlFlow.Match)) {
          OperationalControlFlow.Match other = (OperationalControlFlow.Match) obj;
    ...
    @Override
    public OperationalControlFlow specification() {
      return OperationalControlFlow.instance();
    }
     ...
     * 
     */
    public static OperationalControlFlow.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalControlFlow.Match newMutableMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalControlFlow.Match newMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalControlFlow.Match {
      Mutable(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    private static final class Immutable extends OperationalControlFlow.Match {
      Immutable(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
        super(pElement, pDomainStereotypeInstance);
      }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalControlFlow pattern,
   ...
   * 
   * @see Match
   * @see OperationalControlFlow
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalControlFlow.Match> {
    /**
     ...
     * 
     */
    public static OperationalControlFlow.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalControlFlow.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalControlFlow.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalControlFlow.Match> getAllMatches(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalControlFlow.Match> streamAllMatches(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalControlFlow.Match> getOneArbitraryMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean hasMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public int countMatches(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalControlFlow.Match> processor) {
     ...
     * 
     */
    public OperationalControlFlow.Match newMatch(final ControlFlow pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalControlFlow.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<ControlFlow> streamAllValuesOfelement(final OperationalControlFlow.Match partialMatch) {
     ...
     * 
     */
    public Stream<ControlFlow> streamAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Set<ControlFlow> getAllValuesOfelement(final OperationalControlFlow.Match partialMatch) {
     ...
     * 
     */
    public Set<ControlFlow> getAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalControlFlow.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ControlFlow pElement) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalControlFlow.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ControlFlow pElement) {
      return rawStreamAllValuesOfdomainStereotypeInstance(new Object[]{pElement, null}).collect(Collectors.toSet());
    }
    
    @Override
    protected OperationalControlFlow.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalControlFlow.Match.newMatch((ControlFlow) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalControlFlow.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalControlFlow.Match.newMatch((ControlFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalControlFlow.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalControlFlow.Match.newMutableMatch((ControlFlow) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalControlFlow.Matcher> querySpecification() {
      return OperationalControlFlow.instance();
    }
  }
  
  private OperationalControlFlow() {
   ...
   * 
   */
  public static OperationalControlFlow instance() {
    try{
  ...
  @Override
  protected OperationalControlFlow.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalControlFlow.Matcher.on(engine);
  }
  
  @Override
  public OperationalControlFlow.Matcher instantiate() {
    return OperationalControlFlow.Matcher.create();
  }
  
  @Override
  public OperationalControlFlow.Match newEmptyMatch() {
    return OperationalControlFlow.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalControlFlow.Match newMatch(final Object... parameters) {
    return OperationalControlFlow.Match.newMatch((com.nomagic.uml2.ext.magicdraw.activities.mdbasicactivities.ControlFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalControlFlow} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalControlFlow#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalControlFlow INSTANCE = new OperationalControlFlow();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalControlFlow.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalControlFlow")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalControlFlow");
