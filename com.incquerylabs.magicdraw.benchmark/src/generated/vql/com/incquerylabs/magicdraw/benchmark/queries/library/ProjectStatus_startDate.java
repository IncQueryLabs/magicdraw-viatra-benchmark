...
public final class ProjectStatus_startDate extends BaseGeneratedEMFQuerySpecification<ProjectStatus_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectStatus_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ProjectStatus_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectStatus_startDate.Match)) {
          ProjectStatus_startDate.Match other = (ProjectStatus_startDate.Match) obj;
    ...
    @Override
    public ProjectStatus_startDate specification() {
      return ProjectStatus_startDate.instance();
    }
     ...
     * 
     */
    public static ProjectStatus_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectStatus_startDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectStatus_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectStatus_startDate.Match {
    ...
    private static final class Immutable extends ProjectStatus_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectStatus_startDate pattern,
   ...
   * 
   * @see Match
   * @see ProjectStatus_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectStatus_startDate.Match> {
    /**
     ...
     * 
     */
    public static ProjectStatus_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectStatus_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectStatus_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectStatus_startDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectStatus_startDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectStatus_startDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ProjectStatus_startDate.Match> processor) {
     ...
     * 
     */
    public ProjectStatus_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ProjectStatus_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ProjectStatus_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ProjectStatus_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectStatus_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectStatus_startDate.Match partialMatch) {
    ...
    @Override
    protected ProjectStatus_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectStatus_startDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectStatus_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectStatus_startDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectStatus_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectStatus_startDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectStatus_startDate.Matcher> querySpecification() {
      return ProjectStatus_startDate.instance();
    }
  }
  
  private ProjectStatus_startDate() {
   ...
   * 
   */
  public static ProjectStatus_startDate instance() {
    try{
  ...
  @Override
  protected ProjectStatus_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectStatus_startDate.Matcher.on(engine);
  }
  
  @Override
  public ProjectStatus_startDate.Matcher instantiate() {
    return ProjectStatus_startDate.Matcher.create();
  }
  
  @Override
  public ProjectStatus_startDate.Match newEmptyMatch() {
    return ProjectStatus_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectStatus_startDate.Match newMatch(final Object... parameters) {
    return ProjectStatus_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectStatus_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectStatus_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectStatus_startDate INSTANCE = new ProjectStatus_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectStatus_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
