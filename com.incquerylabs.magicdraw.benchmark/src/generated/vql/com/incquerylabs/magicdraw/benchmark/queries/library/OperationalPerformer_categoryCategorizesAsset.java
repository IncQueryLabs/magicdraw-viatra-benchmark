...
public final class OperationalPerformer_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<OperationalPerformer_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalPerformer_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public OperationalPerformer_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalPerformer_categoryCategorizesAsset.Match)) {
          OperationalPerformer_categoryCategorizesAsset.Match other = (OperationalPerformer_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public OperationalPerformer_categoryCategorizesAsset specification() {
      return OperationalPerformer_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static OperationalPerformer_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalPerformer_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalPerformer_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalPerformer_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends OperationalPerformer_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalPerformer_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see OperationalPerformer_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalPerformer_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static OperationalPerformer_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalPerformer_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalPerformer_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalPerformer_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalPerformer_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalPerformer_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalPerformer_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public OperationalPerformer_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalPerformer_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalPerformer_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalPerformer_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalPerformer_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalPerformer_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected OperationalPerformer_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalPerformer_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalPerformer_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalPerformer_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalPerformer_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalPerformer_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalPerformer_categoryCategorizesAsset.Matcher> querySpecification() {
      return OperationalPerformer_categoryCategorizesAsset.instance();
    }
  }
  
  private OperationalPerformer_categoryCategorizesAsset() {
   ...
   * 
   */
  public static OperationalPerformer_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected OperationalPerformer_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalPerformer_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public OperationalPerformer_categoryCategorizesAsset.Matcher instantiate() {
    return OperationalPerformer_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public OperationalPerformer_categoryCategorizesAsset.Match newEmptyMatch() {
    return OperationalPerformer_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalPerformer_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return OperationalPerformer_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalPerformer_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalPerformer_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalPerformer_categoryCategorizesAsset INSTANCE = new OperationalPerformer_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalPerformer_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find OperationalPerformer(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), OperationalPerformer.instance().getInternalQueryRepresentation());
