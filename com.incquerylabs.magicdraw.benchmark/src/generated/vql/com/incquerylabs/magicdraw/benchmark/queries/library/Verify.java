...
public final class Verify extends BaseGeneratedEMFQuerySpecification<Verify.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Verify pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Verify";
    }
    
    @Override
    public List<String> parameterNames() {
      return Verify.Match.parameterNames;
    }
    ...
    @Override
    public Verify.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Verify.Match)) {
          Verify.Match other = (Verify.Match) obj;
     ...
     * 
     */
    public static Verify.Match newEmptyMatch() {
     ...
     * 
     */
    public static Verify.Match newMutableMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Verify.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Verify.Match {
    ...
    private static final class Immutable extends Verify.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Verify pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Verify.Match> {
    /**
     ...
     * 
     */
    public static Verify.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Verify.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Verify.Matcher.class);
     ...
     * 
     */
    public Collection<Verify.Match> getAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Verify.Match> streamAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Verify.Match> getOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype, final Consumer<? super Verify.Match> processor) {
     ...
     * 
     */
    public Verify.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return Verify.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfElement(final Verify.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfElement(final Verify.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Verify.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Verify.Match partialMatch) {
    ...
    @Override
    protected Verify.Match tupleToMatch(final Tuple t) {
      try {
          return Verify.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Verify.Match arrayToMatch(final Object[] match) {
      try {
          return Verify.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Verify.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Verify.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Verify.Matcher> querySpecification() {
      return Verify.instance();
    }
  }
  ...
  @Override
  protected Verify.Matcher instantiate(final ViatraQueryEngine engine) {
    return Verify.Matcher.on(engine);
  }
  
  @Override
  public Verify.Matcher instantiate() {
    return Verify.Matcher.create();
  }
  
  @Override
  public Verify.Match newEmptyMatch() {
    return Verify.Match.newEmptyMatch();
  }
  
  @Override
  public Verify.Match newMatch(final Object... parameters) {
    return Verify.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Verify} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Verify#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Verify.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Verify");
