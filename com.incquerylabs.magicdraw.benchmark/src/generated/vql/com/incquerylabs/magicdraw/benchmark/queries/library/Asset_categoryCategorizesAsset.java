...
import com.incquerylabs.magicdraw.benchmark.queries.library.Asset;
...
public final class Asset_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<Asset_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Asset_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return Asset_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public Asset_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Asset_categoryCategorizesAsset.Match)) {
          Asset_categoryCategorizesAsset.Match other = (Asset_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public Asset_categoryCategorizesAsset specification() {
      return Asset_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static Asset_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static Asset_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Asset_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Asset_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends Asset_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see Asset_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<Asset_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static Asset_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Asset_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Asset_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<Asset_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Asset_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Asset_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Asset_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public Asset_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Asset_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Asset_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Asset_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Asset_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Asset_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected Asset_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return Asset_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Asset_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return Asset_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Asset_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Asset_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Asset_categoryCategorizesAsset.Matcher> querySpecification() {
      return Asset_categoryCategorizesAsset.instance();
    }
  }
  
  private Asset_categoryCategorizesAsset() {
   ...
   * 
   */
  public static Asset_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected Asset_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return Asset_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public Asset_categoryCategorizesAsset.Matcher instantiate() {
    return Asset_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public Asset_categoryCategorizesAsset.Match newEmptyMatch() {
    return Asset_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public Asset_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return Asset_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Asset_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Asset_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Asset_categoryCategorizesAsset INSTANCE = new Asset_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Asset_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Asset(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Asset.instance().getInternalQueryRepresentation());
