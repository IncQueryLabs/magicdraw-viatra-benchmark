...
public final class SecurityControlFamily_Master extends BaseGeneratedEMFQuerySpecification<SecurityControlFamily_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControlFamily_Master.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControlFamily_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControlFamily_Master.Match)) {
          SecurityControlFamily_Master.Match other = (SecurityControlFamily_Master.Match) obj;
    ...
    @Override
    public SecurityControlFamily_Master specification() {
      return SecurityControlFamily_Master.instance();
    }
     ...
     * 
     */
    public static SecurityControlFamily_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControlFamily_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityControlFamily_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControlFamily_Master.Match {
    ...
    private static final class Immutable extends SecurityControlFamily_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Master pattern,
   ...
   * 
   * @see Match
   * @see SecurityControlFamily_Master
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControlFamily_Master.Match> {
    /**
     ...
     * 
     */
    public static SecurityControlFamily_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControlFamily_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControlFamily_Master.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControlFamily_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityControlFamily_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityControlFamily_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityControlFamily_Master.Match> processor) {
     ...
     * 
     */
    public SecurityControlFamily_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityControlFamily_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControlFamily_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControlFamily_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityControlFamily_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityControlFamily_Master.Match partialMatch) {
    ...
    @Override
    protected SecurityControlFamily_Master.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControlFamily_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControlFamily_Master.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControlFamily_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControlFamily_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControlFamily_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControlFamily_Master.Matcher> querySpecification() {
      return SecurityControlFamily_Master.instance();
    }
  }
  
  private SecurityControlFamily_Master() {
   ...
   * 
   */
  public static SecurityControlFamily_Master instance() {
    try{
  ...
  @Override
  protected SecurityControlFamily_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControlFamily_Master.Matcher.on(engine);
  }
  
  @Override
  public SecurityControlFamily_Master.Matcher instantiate() {
    return SecurityControlFamily_Master.Matcher.create();
  }
  
  @Override
  public SecurityControlFamily_Master.Match newEmptyMatch() {
    return SecurityControlFamily_Master.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControlFamily_Master.Match newMatch(final Object... parameters) {
    return SecurityControlFamily_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControlFamily_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControlFamily_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControlFamily_Master INSTANCE = new SecurityControlFamily_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControlFamily_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
