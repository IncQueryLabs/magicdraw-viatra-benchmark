...
public final class ServiceParameter extends BaseGeneratedEMFQuerySpecification<ServiceParameter.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceParameter pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ServiceParameter";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceParameter.Match.parameterNames;
    }
    ...
    @Override
    public ServiceParameter.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceParameter.Match)) {
          ServiceParameter.Match other = (ServiceParameter.Match) obj;
    ...
    @Override
    public ServiceParameter specification() {
      return ServiceParameter.instance();
    }
     ...
     * 
     */
    public static ServiceParameter.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceParameter.Match newMutableMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ServiceParameter.Match newMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ServiceParameter.Match {
    ...
    private static final class Immutable extends ServiceParameter.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceParameter pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceParameter.Match> {
    /**
     ...
     * 
     */
    public static ServiceParameter.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceParameter.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceParameter.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceParameter.Match> getAllMatches(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ServiceParameter.Match> streamAllMatches(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ServiceParameter.Match> getOneArbitraryMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ServiceParameter.Match> processor) {
     ...
     * 
     */
    public ServiceParameter.Match newMatch(final Parameter pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ServiceParameter.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Parameter> streamAllValuesOfelement(final ServiceParameter.Match partialMatch) {
     ...
     * 
     */
    public Set<Parameter> getAllValuesOfelement(final ServiceParameter.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ServiceParameter.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ServiceParameter.Match partialMatch) {
    ...
    @Override
    protected ServiceParameter.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceParameter.Match.newMatch((Parameter) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ServiceParameter.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceParameter.Match.newMatch((Parameter) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceParameter.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceParameter.Match.newMutableMatch((Parameter) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceParameter.Matcher> querySpecification() {
      return ServiceParameter.instance();
    }
  }
   ...
   * 
   */
  public static ServiceParameter instance() {
    try{
  ...
  @Override
  protected ServiceParameter.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceParameter.Matcher.on(engine);
  }
  
  @Override
  public ServiceParameter.Matcher instantiate() {
    return ServiceParameter.Matcher.create();
  }
  
  @Override
  public ServiceParameter.Match newEmptyMatch() {
    return ServiceParameter.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceParameter.Match newMatch(final Object... parameters) {
    return ServiceParameter.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Parameter) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceParameter} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceParameter#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceParameter INSTANCE = new ServiceParameter();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceParameter.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ServiceParameter")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ServiceParameter");
