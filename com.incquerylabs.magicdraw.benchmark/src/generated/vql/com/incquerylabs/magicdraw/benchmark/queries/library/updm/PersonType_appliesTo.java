...
public final class PersonType_appliesTo extends BaseGeneratedEMFQuerySpecification<PersonType_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_appliesTo.Match)) {
          PersonType_appliesTo.Match other = (PersonType_appliesTo.Match) obj;
    ...
    @Override
    public PersonType_appliesTo specification() {
      return PersonType_appliesTo.instance();
    }
     ...
     * 
     */
    public static PersonType_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_appliesTo.Match {
    ...
    private static final class Immutable extends PersonType_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see PersonType_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static PersonType_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_appliesTo.Match> processor) {
     ...
     * 
     */
    public PersonType_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_appliesTo.Match partialMatch) {
    ...
    @Override
    protected PersonType_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_appliesTo.Matcher> querySpecification() {
      return PersonType_appliesTo.instance();
    }
  }
  
  private PersonType_appliesTo() {
   ...
   * 
   */
  public static PersonType_appliesTo instance() {
    try{
  ...
  @Override
  protected PersonType_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public PersonType_appliesTo.Matcher instantiate() {
    return PersonType_appliesTo.Matcher.create();
  }
  
  @Override
  public PersonType_appliesTo.Match newEmptyMatch() {
    return PersonType_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_appliesTo.Match newMatch(final Object... parameters) {
    return PersonType_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_appliesTo INSTANCE = new PersonType_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
