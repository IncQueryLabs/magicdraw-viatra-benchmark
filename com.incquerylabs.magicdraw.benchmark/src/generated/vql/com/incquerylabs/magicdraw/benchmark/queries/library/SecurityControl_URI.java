...
public final class SecurityControl_URI extends BaseGeneratedEMFQuerySpecification<SecurityControl_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_URI.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_URI.Match)) {
          SecurityControl_URI.Match other = (SecurityControl_URI.Match) obj;
    ...
    @Override
    public SecurityControl_URI specification() {
      return SecurityControl_URI.instance();
    }
     ...
     * 
     */
    public static SecurityControl_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SecurityControl_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityControl_URI.Match {
    ...
    private static final class Immutable extends SecurityControl_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_URI pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_URI
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_URI.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_URI.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SecurityControl_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SecurityControl_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super SecurityControl_URI.Match> processor) {
     ...
     * 
     */
    public SecurityControl_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return SecurityControl_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SecurityControl_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SecurityControl_URI.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_URI.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityControl_URI.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_URI.Matcher> querySpecification() {
      return SecurityControl_URI.instance();
    }
  }
  
  private SecurityControl_URI() {
   ...
   * 
   */
  public static SecurityControl_URI instance() {
    try{
  ...
  @Override
  protected SecurityControl_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_URI.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_URI.Matcher instantiate() {
    return SecurityControl_URI.Matcher.create();
  }
  
  @Override
  public SecurityControl_URI.Match newEmptyMatch() {
    return SecurityControl_URI.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_URI.Match newMatch(final Object... parameters) {
    return SecurityControl_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_URI INSTANCE = new SecurityControl_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
