...
public final class StructuralPart extends BaseGeneratedEMFQuerySpecification<StructuralPart.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart";
    }
    
    @Override
    public List<String> parameterNames() {
      return StructuralPart.Match.parameterNames;
    }
    ...
    @Override
    public StructuralPart.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StructuralPart.Match)) {
          StructuralPart.Match other = (StructuralPart.Match) obj;
    ...
    @Override
    public StructuralPart specification() {
      return StructuralPart.instance();
    }
     ...
     * 
     */
    public static StructuralPart.Match newEmptyMatch() {
     ...
     * 
     */
    public static StructuralPart.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static StructuralPart.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends StructuralPart.Match {
    ...
    private static final class Immutable extends StructuralPart.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<StructuralPart.Match> {
    /**
     ...
     * 
     */
    public static StructuralPart.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StructuralPart.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StructuralPart.Matcher.class);
     ...
     * 
     */
    public Collection<StructuralPart.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<StructuralPart.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<StructuralPart.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super StructuralPart.Match> processor) {
     ...
     * 
     */
    public StructuralPart.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return StructuralPart.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final StructuralPart.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final StructuralPart.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final StructuralPart.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final StructuralPart.Match partialMatch) {
    ...
    @Override
    protected StructuralPart.Match tupleToMatch(final Tuple t) {
      try {
          return StructuralPart.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected StructuralPart.Match arrayToMatch(final Object[] match) {
      try {
          return StructuralPart.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StructuralPart.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StructuralPart.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StructuralPart.Matcher> querySpecification() {
      return StructuralPart.instance();
    }
  }
   ...
   * 
   */
  public static StructuralPart instance() {
    try{
  ...
  @Override
  protected StructuralPart.Matcher instantiate(final ViatraQueryEngine engine) {
    return StructuralPart.Matcher.on(engine);
  }
  
  @Override
  public StructuralPart.Matcher instantiate() {
    return StructuralPart.Matcher.create();
  }
  
  @Override
  public StructuralPart.Match newEmptyMatch() {
    return StructuralPart.Match.newEmptyMatch();
  }
  
  @Override
  public StructuralPart.Match newMatch(final Object... parameters) {
    return StructuralPart.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StructuralPart} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StructuralPart#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StructuralPart INSTANCE = new StructuralPart();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StructuralPart.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "StructuralPart")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "StructuralPart");
