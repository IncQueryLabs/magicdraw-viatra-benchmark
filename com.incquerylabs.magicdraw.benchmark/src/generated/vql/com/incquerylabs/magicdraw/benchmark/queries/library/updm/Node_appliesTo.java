...
public final class Node_appliesTo extends BaseGeneratedEMFQuerySpecification<Node_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Node_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_appliesTo.Match)) {
          Node_appliesTo.Match other = (Node_appliesTo.Match) obj;
    ...
    @Override
    public Node_appliesTo specification() {
      return Node_appliesTo.instance();
    }
     ...
     * 
     */
    public static Node_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Node_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_appliesTo.Match {
    ...
    private static final class Immutable extends Node_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_appliesTo pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Node_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Node_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Node_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Node_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Node_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Node_appliesTo.Match> processor) {
     ...
     * 
     */
    public Node_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Node_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Node_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Node_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Node_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Node_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Node_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_appliesTo.Matcher> querySpecification() {
      return Node_appliesTo.instance();
    }
  }
  
  private Node_appliesTo() {
   ...
   * 
   */
  public static Node_appliesTo instance() {
    try{
  ...
  @Override
  protected Node_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Node_appliesTo.Matcher instantiate() {
    return Node_appliesTo.Matcher.create();
  }
  
  @Override
  public Node_appliesTo.Match newEmptyMatch() {
    return Node_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Node_appliesTo.Match newMatch(final Object... parameters) {
    return Node_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_appliesTo INSTANCE = new Node_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
