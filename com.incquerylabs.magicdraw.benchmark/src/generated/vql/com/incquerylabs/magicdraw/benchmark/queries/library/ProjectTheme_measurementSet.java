...
public final class ProjectTheme_measurementSet extends BaseGeneratedEMFQuerySpecification<ProjectTheme_measurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme_measurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme_measurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectTheme_measurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectTheme_measurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectTheme_measurementSet.Match)) {
          ProjectTheme_measurementSet.Match other = (ProjectTheme_measurementSet.Match) obj;
    ...
    @Override
    public ProjectTheme_measurementSet specification() {
      return ProjectTheme_measurementSet.instance();
    }
     ...
     * 
     */
    public static ProjectTheme_measurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectTheme_measurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectTheme_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectTheme_measurementSet.Match {
    ...
    private static final class Immutable extends ProjectTheme_measurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectTheme_measurementSet pattern,
   ...
   * 
   * @see Match
   * @see ProjectTheme_measurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectTheme_measurementSet.Match> {
    /**
     ...
     * 
     */
    public static ProjectTheme_measurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectTheme_measurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectTheme_measurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectTheme_measurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectTheme_measurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectTheme_measurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProjectTheme_measurementSet.Match> processor) {
     ...
     * 
     */
    public ProjectTheme_measurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ProjectTheme_measurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectTheme_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectTheme_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectTheme_measurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectTheme_measurementSet.Match partialMatch) {
    ...
    @Override
    protected ProjectTheme_measurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectTheme_measurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectTheme_measurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectTheme_measurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectTheme_measurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectTheme_measurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectTheme_measurementSet.Matcher> querySpecification() {
      return ProjectTheme_measurementSet.instance();
    }
  }
  
  private ProjectTheme_measurementSet() {
   ...
   * 
   */
  public static ProjectTheme_measurementSet instance() {
    try{
  ...
  @Override
  protected ProjectTheme_measurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectTheme_measurementSet.Matcher.on(engine);
  }
  
  @Override
  public ProjectTheme_measurementSet.Matcher instantiate() {
    return ProjectTheme_measurementSet.Matcher.create();
  }
  
  @Override
  public ProjectTheme_measurementSet.Match newEmptyMatch() {
    return ProjectTheme_measurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectTheme_measurementSet.Match newMatch(final Object... parameters) {
    return ProjectTheme_measurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectTheme_measurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectTheme_measurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectTheme_measurementSet INSTANCE = new ProjectTheme_measurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectTheme_measurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
