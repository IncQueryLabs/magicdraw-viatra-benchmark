...
public final class OperationalEventTrace extends BaseGeneratedEMFQuerySpecification<OperationalEventTrace.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OperationalEventTrace pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OperationalEventTrace";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalEventTrace.Match.parameterNames;
    }
    ...
    @Override
    public OperationalEventTrace.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalEventTrace.Match)) {
          OperationalEventTrace.Match other = (OperationalEventTrace.Match) obj;
    ...
    @Override
    public OperationalEventTrace specification() {
      return OperationalEventTrace.instance();
    }
     ...
     * 
     */
    public static OperationalEventTrace.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalEventTrace.Match newMutableMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalEventTrace.Match newMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalEventTrace.Match {
      Mutable(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
    ...
    private static final class Immutable extends OperationalEventTrace.Match {
      Immutable(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
        super(pElement, pDomainStereotypeInstance);
      }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OperationalEventTrace pattern,
   ...
   * 
   * @see Match
   * @see OperationalEventTrace
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalEventTrace.Match> {
    /**
     ...
     * 
     */
    public static OperationalEventTrace.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalEventTrace.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalEventTrace.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalEventTrace.Match> getAllMatches(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalEventTrace.Match> streamAllMatches(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalEventTrace.Match> getOneArbitraryMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean hasMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public int countMatches(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalEventTrace.Match> processor) {
     ...
     * 
     */
    public OperationalEventTrace.Match newMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalEventTrace.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Interaction> streamAllValuesOfelement(final OperationalEventTrace.Match partialMatch) {
     ...
     * 
     */
    public Stream<Interaction> streamAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Set<Interaction> getAllValuesOfelement(final OperationalEventTrace.Match partialMatch) {
     ...
     * 
     */
    public Set<Interaction> getAllValuesOfelement(final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalEventTrace.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Interaction pElement) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalEventTrace.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Interaction pElement) {
      return rawStreamAllValuesOfdomainStereotypeInstance(new Object[]{pElement, null}).collect(Collectors.toSet());
    }
    
    @Override
    protected OperationalEventTrace.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalEventTrace.Match.newMatch((Interaction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalEventTrace.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalEventTrace.Match.newMatch((Interaction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalEventTrace.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalEventTrace.Match.newMutableMatch((Interaction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalEventTrace.Matcher> querySpecification() {
      return OperationalEventTrace.instance();
    }
  }
  
  private OperationalEventTrace() {
   ...
   * 
   */
  public static OperationalEventTrace instance() {
    try{
  ...
  @Override
  protected OperationalEventTrace.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalEventTrace.Matcher.on(engine);
  }
  
  @Override
  public OperationalEventTrace.Matcher instantiate() {
    return OperationalEventTrace.Matcher.create();
  }
  
  @Override
  public OperationalEventTrace.Match newEmptyMatch() {
    return OperationalEventTrace.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalEventTrace.Match newMatch(final Object... parameters) {
    return OperationalEventTrace.Match.newMatch((com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.Interaction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalEventTrace} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalEventTrace#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalEventTrace INSTANCE = new OperationalEventTrace();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalEventTrace.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "OperationalEventTrace");
