 ...
 *         pattern Analysis(Element : Element, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "Analysis");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Analysis extends BaseGeneratedEMFQuerySpecification<Analysis.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Analysis pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Analysis";
    }
    
    @Override
    public List<String> parameterNames() {
      return Analysis.Match.parameterNames;
    }
    ...
    @Override
    public Analysis.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Analysis.Match)) {
          Analysis.Match other = (Analysis.Match) obj;
     ...
     * 
     */
    public static Analysis.Match newEmptyMatch() {
     ...
     * 
     */
    public static Analysis.Match newMutableMatch(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Analysis.Match newMatch(final Element pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Analysis.Match {
    ...
    private static final class Immutable extends Analysis.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Analysis pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Analysis.Match> {
    /**
     ...
     * 
     */
    public static Analysis.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Analysis.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Analysis.Matcher.class);
     ...
     * 
     */
    public Collection<Analysis.Match> getAllMatches(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Analysis.Match> streamAllMatches(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Analysis.Match> getOneArbitraryMatch(final Element pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final Stereotype pStereotype, final Consumer<? super Analysis.Match> processor) {
     ...
     * 
     */
    public Analysis.Match newMatch(final Element pElement, final Stereotype pStereotype) {
      return Analysis.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfElement(final Analysis.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfElement(final Analysis.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Analysis.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Analysis.Match partialMatch) {
    ...
    @Override
    protected Analysis.Match tupleToMatch(final Tuple t) {
      try {
          return Analysis.Match.newMatch((Element) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Analysis.Match arrayToMatch(final Object[] match) {
      try {
          return Analysis.Match.newMatch((Element) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Analysis.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Analysis.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Analysis.Matcher> querySpecification() {
      return Analysis.instance();
    }
  }
  ...
  @Override
  protected Analysis.Matcher instantiate(final ViatraQueryEngine engine) {
    return Analysis.Matcher.on(engine);
  }
  
  @Override
  public Analysis.Matcher instantiate() {
    return Analysis.Matcher.create();
  }
  
  @Override
  public Analysis.Match newEmptyMatch() {
    return Analysis.Match.newEmptyMatch();
  }
  
  @Override
  public Analysis.Match newMatch(final Object... parameters) {
    return Analysis.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Analysis} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Analysis#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Analysis.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Analysis");
