...
public final class EnterpriseGoal_TracedTo extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_TracedTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_TracedTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_TracedTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_TracedTo.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_TracedTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_TracedTo.Match)) {
          EnterpriseGoal_TracedTo.Match other = (EnterpriseGoal_TracedTo.Match) obj;
    ...
    @Override
    public EnterpriseGoal_TracedTo specification() {
      return EnterpriseGoal_TracedTo.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_TracedTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_TracedTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_TracedTo.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_TracedTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_TracedTo pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_TracedTo
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_TracedTo.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_TracedTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_TracedTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_TracedTo.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_TracedTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_TracedTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_TracedTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super EnterpriseGoal_TracedTo.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return EnterpriseGoal_TracedTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final EnterpriseGoal_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final EnterpriseGoal_TracedTo.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_TracedTo.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_TracedTo.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_TracedTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_TracedTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_TracedTo.Matcher> querySpecification() {
      return EnterpriseGoal_TracedTo.instance();
    }
  }
  
  private EnterpriseGoal_TracedTo() {
   ...
   * 
   */
  public static EnterpriseGoal_TracedTo instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_TracedTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_TracedTo.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_TracedTo.Matcher instantiate() {
    return EnterpriseGoal_TracedTo.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_TracedTo.Match newEmptyMatch() {
    return EnterpriseGoal_TracedTo.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_TracedTo.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_TracedTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_TracedTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_TracedTo INSTANCE = new EnterpriseGoal_TracedTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_TracedTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
