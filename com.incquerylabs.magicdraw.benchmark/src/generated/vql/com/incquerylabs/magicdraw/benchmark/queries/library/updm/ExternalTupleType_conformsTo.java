...
public final class ExternalTupleType_conformsTo extends BaseGeneratedEMFQuerySpecification<ExternalTupleType_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTupleType_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTupleType_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTupleType_conformsTo.Match)) {
          ExternalTupleType_conformsTo.Match other = (ExternalTupleType_conformsTo.Match) obj;
    ...
    @Override
    public ExternalTupleType_conformsTo specification() {
      return ExternalTupleType_conformsTo.instance();
    }
     ...
     * 
     */
    public static ExternalTupleType_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTupleType_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTupleType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTupleType_conformsTo.Match {
    ...
    private static final class Immutable extends ExternalTupleType_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ExternalTupleType_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTupleType_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ExternalTupleType_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTupleType_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTupleType_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTupleType_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTupleType_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTupleType_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTupleType_conformsTo.Match> processor) {
     ...
     * 
     */
    public ExternalTupleType_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTupleType_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTupleType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTupleType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTupleType_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTupleType_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ExternalTupleType_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTupleType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTupleType_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTupleType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTupleType_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTupleType_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTupleType_conformsTo.Matcher> querySpecification() {
      return ExternalTupleType_conformsTo.instance();
    }
  }
  
  private ExternalTupleType_conformsTo() {
   ...
   * 
   */
  public static ExternalTupleType_conformsTo instance() {
    try{
  ...
  @Override
  protected ExternalTupleType_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTupleType_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ExternalTupleType_conformsTo.Matcher instantiate() {
    return ExternalTupleType_conformsTo.Matcher.create();
  }
  
  @Override
  public ExternalTupleType_conformsTo.Match newEmptyMatch() {
    return ExternalTupleType_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTupleType_conformsTo.Match newMatch(final Object... parameters) {
    return ExternalTupleType_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTupleType_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTupleType_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTupleType_conformsTo INSTANCE = new ExternalTupleType_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTupleType_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
