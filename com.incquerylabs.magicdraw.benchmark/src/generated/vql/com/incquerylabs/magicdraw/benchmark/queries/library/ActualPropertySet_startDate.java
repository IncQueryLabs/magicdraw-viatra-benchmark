...
public final class ActualPropertySet_startDate extends BaseGeneratedEMFQuerySpecification<ActualPropertySet_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPropertySet_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualPropertySet_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualPropertySet_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualPropertySet_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualPropertySet_startDate.Match)) {
          ActualPropertySet_startDate.Match other = (ActualPropertySet_startDate.Match) obj;
    ...
    @Override
    public ActualPropertySet_startDate specification() {
      return ActualPropertySet_startDate.instance();
    }
     ...
     * 
     */
    public static ActualPropertySet_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualPropertySet_startDate.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public static ActualPropertySet_startDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualPropertySet_startDate.Match {
    ...
    private static final class Immutable extends ActualPropertySet_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPropertySet_startDate pattern,
   ...
   * 
   * @see Match
   * @see ActualPropertySet_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualPropertySet_startDate.Match> {
    /**
     ...
     * 
     */
    public static ActualPropertySet_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualPropertySet_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualPropertySet_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualPropertySet_startDate.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Stream<ActualPropertySet_startDate.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Optional<ActualPropertySet_startDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue, final Consumer<? super ActualPropertySet_startDate.Match> processor) {
     ...
     * 
     */
    public ActualPropertySet_startDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return ActualPropertySet_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualPropertySet_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualPropertySet_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvalue(final ActualPropertySet_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvalue(final ActualPropertySet_startDate.Match partialMatch) {
    ...
    @Override
    protected ActualPropertySet_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualPropertySet_startDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualPropertySet_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualPropertySet_startDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualPropertySet_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualPropertySet_startDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualPropertySet_startDate.Matcher> querySpecification() {
      return ActualPropertySet_startDate.instance();
    }
  }
  
  private ActualPropertySet_startDate() {
   ...
   * 
   */
  public static ActualPropertySet_startDate instance() {
    try{
  ...
  @Override
  protected ActualPropertySet_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualPropertySet_startDate.Matcher.on(engine);
  }
  
  @Override
  public ActualPropertySet_startDate.Matcher instantiate() {
    return ActualPropertySet_startDate.Matcher.create();
  }
  
  @Override
  public ActualPropertySet_startDate.Match newEmptyMatch() {
    return ActualPropertySet_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualPropertySet_startDate.Match newMatch(final Object... parameters) {
    return ActualPropertySet_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualPropertySet_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualPropertySet_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualPropertySet_startDate INSTANCE = new ActualPropertySet_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualPropertySet_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
