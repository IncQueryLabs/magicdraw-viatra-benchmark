...
import com.incquerylabs.magicdraw.benchmark.queries.library.Post;
...
public final class Post_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<Post_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Post_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public Post_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_isStandardConfiguration.Match)) {
          Post_isStandardConfiguration.Match other = (Post_isStandardConfiguration.Match) obj;
    ...
    @Override
    public Post_isStandardConfiguration specification() {
      return Post_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static Post_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Post_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Post_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends Post_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see Post_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<Post_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static Post_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<Post_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Post_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Post_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Post_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public Post_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Post_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Post_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Post_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected Post_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return Post_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Post_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return Post_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_isStandardConfiguration.Matcher> querySpecification() {
      return Post_isStandardConfiguration.instance();
    }
  }
  
  private Post_isStandardConfiguration() {
   ...
   * 
   */
  public static Post_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected Post_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public Post_isStandardConfiguration.Matcher instantiate() {
    return Post_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public Post_isStandardConfiguration.Match newEmptyMatch() {
    return Post_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public Post_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return Post_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_isStandardConfiguration INSTANCE = new Post_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Post(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Post.instance().getInternalQueryRepresentation());
