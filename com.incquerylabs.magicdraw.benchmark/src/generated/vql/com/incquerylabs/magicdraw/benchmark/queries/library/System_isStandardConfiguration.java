...
public final class System_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<System_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.System_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.System_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public System_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_isStandardConfiguration.Match)) {
          System_isStandardConfiguration.Match other = (System_isStandardConfiguration.Match) obj;
    ...
    @Override
    public System_isStandardConfiguration specification() {
      return System_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static System_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static System_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends System_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends System_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.System_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see System_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<System_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static System_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<System_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<System_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<System_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super System_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public System_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return System_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final System_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final System_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected System_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return System_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected System_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return System_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_isStandardConfiguration.Matcher> querySpecification() {
      return System_isStandardConfiguration.instance();
    }
  }
  
  private System_isStandardConfiguration() {
   ...
   * 
   */
  public static System_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected System_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public System_isStandardConfiguration.Matcher instantiate() {
    return System_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public System_isStandardConfiguration.Match newEmptyMatch() {
    return System_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public System_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return System_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_isStandardConfiguration INSTANCE = new System_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find System(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), com.incquerylabs.magicdraw.benchmark.queries.library.System.instance().getInternalQueryRepresentation());
