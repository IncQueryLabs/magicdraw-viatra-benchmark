...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType;
...
public final class ExternalType_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ExternalType_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalType_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ExternalType_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalType_actualPropertySet.Match)) {
          ExternalType_actualPropertySet.Match other = (ExternalType_actualPropertySet.Match) obj;
    ...
    @Override
    public ExternalType_actualPropertySet specification() {
      return ExternalType_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ExternalType_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalType_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalType_actualPropertySet.Match {
    ...
    private static final class Immutable extends ExternalType_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalType_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ExternalType_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalType_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ExternalType_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalType_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalType_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalType_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalType_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalType_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalType_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ExternalType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalType_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalType_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ExternalType_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalType_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalType_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalType_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalType_actualPropertySet.Matcher> querySpecification() {
      return ExternalType_actualPropertySet.instance();
    }
  }
  
  private ExternalType_actualPropertySet() {
   ...
   * 
   */
  public static ExternalType_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ExternalType_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalType_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ExternalType_actualPropertySet.Matcher instantiate() {
    return ExternalType_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ExternalType_actualPropertySet.Match newEmptyMatch() {
    return ExternalType_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalType_actualPropertySet.Match newMatch(final Object... parameters) {
    return ExternalType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalType_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalType_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalType_actualPropertySet INSTANCE = new ExternalType_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalType_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ExternalType(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ExternalType.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
