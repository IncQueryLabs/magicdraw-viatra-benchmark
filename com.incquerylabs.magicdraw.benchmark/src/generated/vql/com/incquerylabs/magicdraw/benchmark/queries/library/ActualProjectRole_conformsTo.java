...
public final class ActualProjectRole_conformsTo extends BaseGeneratedEMFQuerySpecification<ActualProjectRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectRole_conformsTo.Match)) {
          ActualProjectRole_conformsTo.Match other = (ActualProjectRole_conformsTo.Match) obj;
    ...
    @Override
    public ActualProjectRole_conformsTo specification() {
      return ActualProjectRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static ActualProjectRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectRole_conformsTo.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProjectRole_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProjectRole_conformsTo.Match {
    ...
    private static final class Immutable extends ActualProjectRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectRole_conformsTo.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProjectRole_conformsTo.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProjectRole_conformsTo.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProjectRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public ActualProjectRole_conformsTo.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProjectRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProjectRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProjectRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ActualProjectRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectRole_conformsTo.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProjectRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectRole_conformsTo.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectRole_conformsTo.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectRole_conformsTo.Matcher> querySpecification() {
      return ActualProjectRole_conformsTo.instance();
    }
  }
  
  private ActualProjectRole_conformsTo() {
   ...
   * 
   */
  public static ActualProjectRole_conformsTo instance() {
    try{
  ...
  @Override
  protected ActualProjectRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectRole_conformsTo.Matcher instantiate() {
    return ActualProjectRole_conformsTo.Matcher.create();
  }
  
  @Override
  public ActualProjectRole_conformsTo.Match newEmptyMatch() {
    return ActualProjectRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectRole_conformsTo.Match newMatch(final Object... parameters) {
    return ActualProjectRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectRole_conformsTo INSTANCE = new ActualProjectRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
