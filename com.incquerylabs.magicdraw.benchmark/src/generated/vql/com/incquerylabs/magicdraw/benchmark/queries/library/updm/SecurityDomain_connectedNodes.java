...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain;
...
public final class SecurityDomain_connectedNodes extends BaseGeneratedEMFQuerySpecification<SecurityDomain_connectedNodes.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_connectedNodes pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_connectedNodes";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_connectedNodes.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_connectedNodes.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_connectedNodes.Match)) {
          SecurityDomain_connectedNodes.Match other = (SecurityDomain_connectedNodes.Match) obj;
    ...
    @Override
    public SecurityDomain_connectedNodes specification() {
      return SecurityDomain_connectedNodes.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_connectedNodes.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_connectedNodes.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static SecurityDomain_connectedNodes.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_connectedNodes.Match {
    ...
    private static final class Immutable extends SecurityDomain_connectedNodes.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_connectedNodes pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_connectedNodes
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_connectedNodes.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_connectedNodes.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_connectedNodes.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_connectedNodes.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_connectedNodes.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_connectedNodes.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_connectedNodes.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super SecurityDomain_connectedNodes.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_connectedNodes.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return SecurityDomain_connectedNodes.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_connectedNodes.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_connectedNodes.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfvalue(final SecurityDomain_connectedNodes.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfvalue(final SecurityDomain_connectedNodes.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_connectedNodes.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_connectedNodes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_connectedNodes.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_connectedNodes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_connectedNodes.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_connectedNodes.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_connectedNodes.Matcher> querySpecification() {
      return SecurityDomain_connectedNodes.instance();
    }
  }
  
  private SecurityDomain_connectedNodes() {
   ...
   * 
   */
  public static SecurityDomain_connectedNodes instance() {
    try{
  ...
  @Override
  protected SecurityDomain_connectedNodes.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_connectedNodes.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_connectedNodes.Matcher instantiate() {
    return SecurityDomain_connectedNodes.Matcher.create();
  }
  
  @Override
  public SecurityDomain_connectedNodes.Match newEmptyMatch() {
    return SecurityDomain_connectedNodes.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_connectedNodes.Match newMatch(final Object... parameters) {
    return SecurityDomain_connectedNodes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_connectedNodes} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_connectedNodes#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_connectedNodes INSTANCE = new SecurityDomain_connectedNodes();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_connectedNodes.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find SecurityDomain(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), SecurityDomain.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "connectedNodes", valuespec)
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "connectedNodes");
