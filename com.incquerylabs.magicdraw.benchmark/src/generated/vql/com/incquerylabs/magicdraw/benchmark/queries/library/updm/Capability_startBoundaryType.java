...
public final class Capability_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Capability_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Capability_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Capability_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Capability_startBoundaryType.Match)) {
          Capability_startBoundaryType.Match other = (Capability_startBoundaryType.Match) obj;
    ...
    @Override
    public Capability_startBoundaryType specification() {
      return Capability_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Capability_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Capability_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Capability_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Capability_startBoundaryType.Match {
    ...
    private static final class Immutable extends Capability_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Capability_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Capability_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Capability_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Capability_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Capability_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Capability_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Capability_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Capability_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Capability_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Capability_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Capability_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Capability_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Capability_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Capability_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Capability_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Capability_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Capability_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Capability_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Capability_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Capability_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Capability_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Capability_startBoundaryType.Matcher> querySpecification() {
      return Capability_startBoundaryType.instance();
    }
  }
  
  private Capability_startBoundaryType() {
   ...
   * 
   */
  public static Capability_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Capability_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Capability_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Capability_startBoundaryType.Matcher instantiate() {
    return Capability_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Capability_startBoundaryType.Match newEmptyMatch() {
    return Capability_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Capability_startBoundaryType.Match newMatch(final Object... parameters) {
    return Capability_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Capability_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Capability_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Capability_startBoundaryType INSTANCE = new Capability_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Capability_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
