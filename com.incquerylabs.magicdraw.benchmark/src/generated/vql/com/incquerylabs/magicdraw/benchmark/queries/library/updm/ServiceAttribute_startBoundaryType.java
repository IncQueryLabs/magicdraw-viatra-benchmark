...
public final class ServiceAttribute_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ServiceAttribute_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAttribute_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAttribute_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAttribute_startBoundaryType.Match)) {
          ServiceAttribute_startBoundaryType.Match other = (ServiceAttribute_startBoundaryType.Match) obj;
    ...
    @Override
    public ServiceAttribute_startBoundaryType specification() {
      return ServiceAttribute_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ServiceAttribute_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAttribute_startBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAttribute_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAttribute_startBoundaryType.Match {
    ...
    private static final class Immutable extends ServiceAttribute_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAttribute_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ServiceAttribute_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAttribute_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ServiceAttribute_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAttribute_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAttribute_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAttribute_startBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAttribute_startBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAttribute_startBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ServiceAttribute_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ServiceAttribute_startBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return ServiceAttribute_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ServiceAttribute_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ServiceAttribute_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAttribute_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAttribute_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ServiceAttribute_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAttribute_startBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAttribute_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAttribute_startBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAttribute_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAttribute_startBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAttribute_startBoundaryType.Matcher> querySpecification() {
      return ServiceAttribute_startBoundaryType.instance();
    }
  }
  
  private ServiceAttribute_startBoundaryType() {
   ...
   * 
   */
  public static ServiceAttribute_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ServiceAttribute_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAttribute_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ServiceAttribute_startBoundaryType.Matcher instantiate() {
    return ServiceAttribute_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ServiceAttribute_startBoundaryType.Match newEmptyMatch() {
    return ServiceAttribute_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAttribute_startBoundaryType.Match newMatch(final Object... parameters) {
    return ServiceAttribute_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAttribute_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAttribute_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAttribute_startBoundaryType INSTANCE = new ServiceAttribute_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAttribute_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
