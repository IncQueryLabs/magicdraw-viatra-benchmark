...
public final class IsCapableToPerform_targetContext extends BaseGeneratedEMFQuerySpecification<IsCapableToPerform_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return IsCapableToPerform_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public IsCapableToPerform_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof IsCapableToPerform_targetContext.Match)) {
          IsCapableToPerform_targetContext.Match other = (IsCapableToPerform_targetContext.Match) obj;
    ...
    @Override
    public IsCapableToPerform_targetContext specification() {
      return IsCapableToPerform_targetContext.instance();
    }
     ...
     * 
     */
    public static IsCapableToPerform_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static IsCapableToPerform_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static IsCapableToPerform_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends IsCapableToPerform_targetContext.Match {
    ...
    private static final class Immutable extends IsCapableToPerform_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_targetContext pattern,
   ...
   * 
   * @see Match
   * @see IsCapableToPerform_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<IsCapableToPerform_targetContext.Match> {
    /**
     ...
     * 
     */
    public static IsCapableToPerform_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static IsCapableToPerform_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(IsCapableToPerform_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<IsCapableToPerform_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<IsCapableToPerform_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<IsCapableToPerform_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super IsCapableToPerform_targetContext.Match> processor) {
     ...
     * 
     */
    public IsCapableToPerform_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return IsCapableToPerform_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final IsCapableToPerform_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final IsCapableToPerform_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final IsCapableToPerform_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final IsCapableToPerform_targetContext.Match partialMatch) {
    ...
    @Override
    protected IsCapableToPerform_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return IsCapableToPerform_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected IsCapableToPerform_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return IsCapableToPerform_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected IsCapableToPerform_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return IsCapableToPerform_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<IsCapableToPerform_targetContext.Matcher> querySpecification() {
      return IsCapableToPerform_targetContext.instance();
    }
  }
  
  private IsCapableToPerform_targetContext() {
   ...
   * 
   */
  public static IsCapableToPerform_targetContext instance() {
    try{
  ...
  @Override
  protected IsCapableToPerform_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return IsCapableToPerform_targetContext.Matcher.on(engine);
  }
  
  @Override
  public IsCapableToPerform_targetContext.Matcher instantiate() {
    return IsCapableToPerform_targetContext.Matcher.create();
  }
  
  @Override
  public IsCapableToPerform_targetContext.Match newEmptyMatch() {
    return IsCapableToPerform_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public IsCapableToPerform_targetContext.Match newMatch(final Object... parameters) {
    return IsCapableToPerform_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link IsCapableToPerform_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link IsCapableToPerform_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final IsCapableToPerform_targetContext INSTANCE = new IsCapableToPerform_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final IsCapableToPerform_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
