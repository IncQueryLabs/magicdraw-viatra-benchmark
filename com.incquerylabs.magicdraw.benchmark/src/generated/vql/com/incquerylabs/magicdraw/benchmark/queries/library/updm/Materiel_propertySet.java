...
public final class Materiel_propertySet extends BaseGeneratedEMFQuerySpecification<Materiel_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_propertySet.Match)) {
          Materiel_propertySet.Match other = (Materiel_propertySet.Match) obj;
    ...
    @Override
    public Materiel_propertySet specification() {
      return Materiel_propertySet.instance();
    }
     ...
     * 
     */
    public static Materiel_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Materiel_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Materiel_propertySet.Match {
    ...
    private static final class Immutable extends Materiel_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Materiel_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Materiel_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Materiel_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Materiel_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Materiel_propertySet.Match> processor) {
     ...
     * 
     */
    public Materiel_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Materiel_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Materiel_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Materiel_propertySet.Match partialMatch) {
    ...
    @Override
    protected Materiel_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Materiel_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_propertySet.Matcher> querySpecification() {
      return Materiel_propertySet.instance();
    }
  }
  
  private Materiel_propertySet() {
   ...
   * 
   */
  public static Materiel_propertySet instance() {
    try{
  ...
  @Override
  protected Materiel_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Materiel_propertySet.Matcher instantiate() {
    return Materiel_propertySet.Matcher.create();
  }
  
  @Override
  public Materiel_propertySet.Match newEmptyMatch() {
    return Materiel_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_propertySet.Match newMatch(final Object... parameters) {
    return Materiel_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_propertySet INSTANCE = new Materiel_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
