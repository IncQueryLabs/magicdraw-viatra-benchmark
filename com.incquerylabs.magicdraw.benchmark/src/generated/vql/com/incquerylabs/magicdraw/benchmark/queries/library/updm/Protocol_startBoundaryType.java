...
public final class Protocol_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Protocol_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_startBoundaryType.Match)) {
          Protocol_startBoundaryType.Match other = (Protocol_startBoundaryType.Match) obj;
    ...
    @Override
    public Protocol_startBoundaryType specification() {
      return Protocol_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Protocol_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Protocol_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Protocol_startBoundaryType.Match {
    ...
    private static final class Immutable extends Protocol_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Protocol_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Protocol_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Protocol_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Protocol_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Protocol_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Protocol_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Protocol_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Protocol_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Protocol_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Protocol_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Protocol_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_startBoundaryType.Matcher> querySpecification() {
      return Protocol_startBoundaryType.instance();
    }
  }
  
  private Protocol_startBoundaryType() {
   ...
   * 
   */
  public static Protocol_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Protocol_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Protocol_startBoundaryType.Matcher instantiate() {
    return Protocol_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Protocol_startBoundaryType.Match newEmptyMatch() {
    return Protocol_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_startBoundaryType.Match newMatch(final Object... parameters) {
    return Protocol_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_startBoundaryType INSTANCE = new Protocol_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
