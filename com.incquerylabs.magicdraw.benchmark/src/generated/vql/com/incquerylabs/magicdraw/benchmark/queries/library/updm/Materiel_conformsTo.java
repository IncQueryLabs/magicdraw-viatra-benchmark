...
public final class Materiel_conformsTo extends BaseGeneratedEMFQuerySpecification<Materiel_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_conformsTo.Match)) {
          Materiel_conformsTo.Match other = (Materiel_conformsTo.Match) obj;
    ...
    @Override
    public Materiel_conformsTo specification() {
      return Materiel_conformsTo.instance();
    }
     ...
     * 
     */
    public static Materiel_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Materiel_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Materiel_conformsTo.Match {
    ...
    private static final class Immutable extends Materiel_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Materiel_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Materiel_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Materiel_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Materiel_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Materiel_conformsTo.Match> processor) {
     ...
     * 
     */
    public Materiel_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Materiel_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Materiel_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Materiel_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Materiel_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Materiel_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_conformsTo.Matcher> querySpecification() {
      return Materiel_conformsTo.instance();
    }
  }
  
  private Materiel_conformsTo() {
   ...
   * 
   */
  public static Materiel_conformsTo instance() {
    try{
  ...
  @Override
  protected Materiel_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Materiel_conformsTo.Matcher instantiate() {
    return Materiel_conformsTo.Matcher.create();
  }
  
  @Override
  public Materiel_conformsTo.Match newEmptyMatch() {
    return Materiel_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_conformsTo.Match newMatch(final Object... parameters) {
    return Materiel_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_conformsTo INSTANCE = new Materiel_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
