...
public final class ResourceMitigation_URI extends BaseGeneratedEMFQuerySpecification<ResourceMitigation_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceMitigation_URI.Match.parameterNames;
    }
    ...
    @Override
    public ResourceMitigation_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceMitigation_URI.Match)) {
          ResourceMitigation_URI.Match other = (ResourceMitigation_URI.Match) obj;
    ...
    @Override
    public ResourceMitigation_URI specification() {
      return ResourceMitigation_URI.instance();
    }
     ...
     * 
     */
    public static ResourceMitigation_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceMitigation_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ResourceMitigation_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourceMitigation_URI.Match {
    ...
    private static final class Immutable extends ResourceMitigation_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_URI pattern,
   ...
   * 
   * @see Match
   * @see ResourceMitigation_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceMitigation_URI.Match> {
    /**
     ...
     * 
     */
    public static ResourceMitigation_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceMitigation_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceMitigation_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceMitigation_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ResourceMitigation_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ResourceMitigation_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ResourceMitigation_URI.Match> processor) {
     ...
     * 
     */
    public ResourceMitigation_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ResourceMitigation_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceMitigation_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceMitigation_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ResourceMitigation_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ResourceMitigation_URI.Match partialMatch) {
    ...
    @Override
    protected ResourceMitigation_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceMitigation_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourceMitigation_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceMitigation_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceMitigation_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceMitigation_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceMitigation_URI.Matcher> querySpecification() {
      return ResourceMitigation_URI.instance();
    }
  }
  
  private ResourceMitigation_URI() {
   ...
   * 
   */
  public static ResourceMitigation_URI instance() {
    try{
  ...
  @Override
  protected ResourceMitigation_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceMitigation_URI.Matcher.on(engine);
  }
  
  @Override
  public ResourceMitigation_URI.Matcher instantiate() {
    return ResourceMitigation_URI.Matcher.create();
  }
  
  @Override
  public ResourceMitigation_URI.Match newEmptyMatch() {
    return ResourceMitigation_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceMitigation_URI.Match newMatch(final Object... parameters) {
    return ResourceMitigation_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceMitigation_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceMitigation_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceMitigation_URI INSTANCE = new ResourceMitigation_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceMitigation_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
