 ...
 *         pattern BlackBoxICDTable(Element : Diagram, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "BlackBoxICDTable");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class BlackBoxICDTable extends BaseGeneratedEMFQuerySpecification<BlackBoxICDTable.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static BlackBoxICDTable.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static BlackBoxICDTable.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<BlackBoxICDTable.Match> {
     ...
     * 
     */
    public Collection<BlackBoxICDTable.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<BlackBoxICDTable.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<BlackBoxICDTable.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super BlackBoxICDTable.Match> processor) {
     ...
     * 
     */
    public BlackBoxICDTable.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return BlackBoxICDTable.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final BlackBoxICDTable.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final BlackBoxICDTable.Match partialMatch) {
    ...
    protected BlackBoxICDTable.Match tupleToMatch(final Tuple t) {
      try {
          return BlackBoxICDTable.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected BlackBoxICDTable.Match arrayToMatch(final Object[] match) {
      try {
          return BlackBoxICDTable.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected BlackBoxICDTable.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BlackBoxICDTable.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public BlackBoxICDTable.Match newMatch(final Object... parameters) {
    return BlackBoxICDTable.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
