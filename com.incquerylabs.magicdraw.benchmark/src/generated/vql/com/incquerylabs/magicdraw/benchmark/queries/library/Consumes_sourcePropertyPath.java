...
public final class Consumes_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<Consumes_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Consumes_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Consumes_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Consumes_sourcePropertyPath.Match)) {
          Consumes_sourcePropertyPath.Match other = (Consumes_sourcePropertyPath.Match) obj;
    ...
    @Override
    public Consumes_sourcePropertyPath specification() {
      return Consumes_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static Consumes_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Consumes_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Consumes_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Consumes_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends Consumes_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Consumes_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Consumes_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Consumes_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Consumes_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Consumes_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Consumes_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Consumes_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Consumes_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Consumes_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public Consumes_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Consumes_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Consumes_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Consumes_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Consumes_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Consumes_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected Consumes_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Consumes_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Consumes_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Consumes_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Consumes_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Consumes_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Consumes_sourcePropertyPath.Matcher> querySpecification() {
      return Consumes_sourcePropertyPath.instance();
    }
  }
  
  private Consumes_sourcePropertyPath() {
   ...
   * 
   */
  public static Consumes_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected Consumes_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Consumes_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Consumes_sourcePropertyPath.Matcher instantiate() {
    return Consumes_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public Consumes_sourcePropertyPath.Match newEmptyMatch() {
    return Consumes_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Consumes_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return Consumes_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Consumes_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Consumes_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Consumes_sourcePropertyPath INSTANCE = new Consumes_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Consumes_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
