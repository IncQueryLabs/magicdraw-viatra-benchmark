...
public final class Measurement_minValue extends BaseGeneratedEMFQuerySpecification<Measurement_minValue.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_minValue pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_minValue";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measurement_minValue.Match.parameterNames;
    }
    ...
    @Override
    public Measurement_minValue.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measurement_minValue.Match)) {
          Measurement_minValue.Match other = (Measurement_minValue.Match) obj;
    ...
    @Override
    public Measurement_minValue specification() {
      return Measurement_minValue.instance();
    }
     ...
     * 
     */
    public static Measurement_minValue.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measurement_minValue.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Measurement_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Measurement_minValue.Match {
    ...
    private static final class Immutable extends Measurement_minValue.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_minValue pattern,
   ...
   * 
   * @see Match
   * @see Measurement_minValue
   * 
   */
  public static class Matcher extends BaseMatcher<Measurement_minValue.Match> {
    /**
     ...
     * 
     */
    public static Measurement_minValue.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measurement_minValue.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measurement_minValue.Matcher.class);
     ...
     * 
     */
    public Collection<Measurement_minValue.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Measurement_minValue.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Measurement_minValue.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super Measurement_minValue.Match> processor) {
     ...
     * 
     */
    public Measurement_minValue.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return Measurement_minValue.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Measurement_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Measurement_minValue.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Measurement_minValue.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Measurement_minValue.Match partialMatch) {
    ...
    @Override
    protected Measurement_minValue.Match tupleToMatch(final Tuple t) {
      try {
          return Measurement_minValue.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Measurement_minValue.Match arrayToMatch(final Object[] match) {
      try {
          return Measurement_minValue.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measurement_minValue.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measurement_minValue.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measurement_minValue.Matcher> querySpecification() {
      return Measurement_minValue.instance();
    }
  }
  
  private Measurement_minValue() {
   ...
   * 
   */
  public static Measurement_minValue instance() {
    try{
  ...
  @Override
  protected Measurement_minValue.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measurement_minValue.Matcher.on(engine);
  }
  
  @Override
  public Measurement_minValue.Matcher instantiate() {
    return Measurement_minValue.Matcher.create();
  }
  
  @Override
  public Measurement_minValue.Match newEmptyMatch() {
    return Measurement_minValue.Match.newEmptyMatch();
  }
  
  @Override
  public Measurement_minValue.Match newMatch(final Object... parameters) {
    return Measurement_minValue.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measurement_minValue} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measurement_minValue#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Measurement_minValue INSTANCE = new Measurement_minValue();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measurement_minValue.GeneratedPQuery INSTANCE = new GeneratedPQuery();
