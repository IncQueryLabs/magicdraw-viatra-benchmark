...
public final class WholeLifeEnterprise_conformsTo extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_conformsTo.Match)) {
          WholeLifeEnterprise_conformsTo.Match other = (WholeLifeEnterprise_conformsTo.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_conformsTo specification() {
      return WholeLifeEnterprise_conformsTo.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_conformsTo.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_conformsTo.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_conformsTo.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_conformsTo.Matcher> querySpecification() {
      return WholeLifeEnterprise_conformsTo.instance();
    }
  }
  
  private WholeLifeEnterprise_conformsTo() {
   ...
   * 
   */
  public static WholeLifeEnterprise_conformsTo instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_conformsTo.Matcher instantiate() {
    return WholeLifeEnterprise_conformsTo.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_conformsTo.Match newEmptyMatch() {
    return WholeLifeEnterprise_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_conformsTo.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_conformsTo INSTANCE = new WholeLifeEnterprise_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
