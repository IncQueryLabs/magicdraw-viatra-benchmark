...
public final class Definition extends BaseGeneratedEMFQuerySpecification<Definition.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Definition pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Definition";
    }
    
    @Override
    public List<String> parameterNames() {
      return Definition.Match.parameterNames;
    }
    ...
    @Override
    public Definition.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Definition.Match)) {
          Definition.Match other = (Definition.Match) obj;
    ...
    @Override
    public Definition specification() {
     ...
     * 
     */
    public static Definition.Match newEmptyMatch() {
     ...
     * 
     */
    public static Definition.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Definition.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Definition.Match {
    ...
    private static final class Immutable extends Definition.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Definition pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Definition.Match> {
    /**
     ...
     * 
     */
    public static Definition.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Definition.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Definition.Matcher.class);
     ...
     * 
     */
    public Collection<Definition.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Definition.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Definition.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Definition.Match> processor) {
     ...
     * 
     */
    public Definition.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Definition.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Definition.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Definition.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Definition.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Definition.Match partialMatch) {
    ...
    @Override
    protected Definition.Match tupleToMatch(final Tuple t) {
      try {
          return Definition.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Definition.Match arrayToMatch(final Object[] match) {
      try {
          return Definition.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Definition.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Definition.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Definition.Matcher> querySpecification() {
      return Definition.instance();
    }
  }
  ...
  @Override
  protected Definition.Matcher instantiate(final ViatraQueryEngine engine) {
    return Definition.Matcher.on(engine);
  }
  
  @Override
  public Definition.Matcher instantiate() {
    return Definition.Matcher.create();
  }
  
  @Override
  public Definition.Match newEmptyMatch() {
    return Definition.Match.newEmptyMatch();
  }
  
  @Override
  public Definition.Match newMatch(final Object... parameters) {
    return Definition.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Definition} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Definition#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Definition.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Definition")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Definition");
