...
public final class ExternalTuple_conformsTo extends BaseGeneratedEMFQuerySpecification<ExternalTuple_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTuple_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTuple_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTuple_conformsTo.Match)) {
          ExternalTuple_conformsTo.Match other = (ExternalTuple_conformsTo.Match) obj;
    ...
    @Override
    public ExternalTuple_conformsTo specification() {
      return ExternalTuple_conformsTo.instance();
    }
     ...
     * 
     */
    public static ExternalTuple_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTuple_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTuple_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTuple_conformsTo.Match {
    ...
    private static final class Immutable extends ExternalTuple_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTuple_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ExternalTuple_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTuple_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ExternalTuple_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTuple_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTuple_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTuple_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTuple_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTuple_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTuple_conformsTo.Match> processor) {
     ...
     * 
     */
    public ExternalTuple_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTuple_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTuple_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTuple_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTuple_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTuple_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ExternalTuple_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTuple_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTuple_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTuple_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTuple_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTuple_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTuple_conformsTo.Matcher> querySpecification() {
      return ExternalTuple_conformsTo.instance();
    }
  }
  
  private ExternalTuple_conformsTo() {
   ...
   * 
   */
  public static ExternalTuple_conformsTo instance() {
    try{
  ...
  @Override
  protected ExternalTuple_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTuple_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ExternalTuple_conformsTo.Matcher instantiate() {
    return ExternalTuple_conformsTo.Matcher.create();
  }
  
  @Override
  public ExternalTuple_conformsTo.Match newEmptyMatch() {
    return ExternalTuple_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTuple_conformsTo.Match newMatch(final Object... parameters) {
    return ExternalTuple_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTuple_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTuple_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTuple_conformsTo INSTANCE = new ExternalTuple_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTuple_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
