...
public final class ResourceMitigation_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<ResourceMitigation_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceMitigation_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ResourceMitigation_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceMitigation_requiredEnvironment.Match)) {
          ResourceMitigation_requiredEnvironment.Match other = (ResourceMitigation_requiredEnvironment.Match) obj;
    ...
    @Override
    public ResourceMitigation_requiredEnvironment specification() {
      return ResourceMitigation_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static ResourceMitigation_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceMitigation_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceMitigation_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceMitigation_requiredEnvironment.Match {
    ...
    private static final class Immutable extends ResourceMitigation_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceMitigation_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ResourceMitigation_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceMitigation_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ResourceMitigation_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceMitigation_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceMitigation_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceMitigation_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceMitigation_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceMitigation_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceMitigation_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public ResourceMitigation_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceMitigation_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceMitigation_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceMitigation_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceMitigation_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceMitigation_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected ResourceMitigation_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceMitigation_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceMitigation_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceMitigation_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceMitigation_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceMitigation_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceMitigation_requiredEnvironment.Matcher> querySpecification() {
      return ResourceMitigation_requiredEnvironment.instance();
    }
  }
  
  private ResourceMitigation_requiredEnvironment() {
   ...
   * 
   */
  public static ResourceMitigation_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected ResourceMitigation_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceMitigation_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ResourceMitigation_requiredEnvironment.Matcher instantiate() {
    return ResourceMitigation_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public ResourceMitigation_requiredEnvironment.Match newEmptyMatch() {
    return ResourceMitigation_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceMitigation_requiredEnvironment.Match newMatch(final Object... parameters) {
    return ResourceMitigation_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceMitigation_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceMitigation_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceMitigation_requiredEnvironment INSTANCE = new ResourceMitigation_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceMitigation_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
