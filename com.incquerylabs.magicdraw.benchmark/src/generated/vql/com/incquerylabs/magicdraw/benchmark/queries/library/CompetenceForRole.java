...
public final class CompetenceForRole extends BaseGeneratedEMFQuerySpecification<CompetenceForRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceForRole.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceForRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceForRole.Match)) {
          CompetenceForRole.Match other = (CompetenceForRole.Match) obj;
    ...
    @Override
    public CompetenceForRole specification() {
      return CompetenceForRole.instance();
    }
     ...
     * 
     */
    public static CompetenceForRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceForRole.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static CompetenceForRole.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends CompetenceForRole.Match {
    ...
    private static final class Immutable extends CompetenceForRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole pattern,
   ...
   * 
   * @see Match
   * @see CompetenceForRole
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceForRole.Match> {
    /**
     ...
     * 
     */
    public static CompetenceForRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceForRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceForRole.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceForRole.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<CompetenceForRole.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<CompetenceForRole.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super CompetenceForRole.Match> processor) {
     ...
     * 
     */
    public CompetenceForRole.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return CompetenceForRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceForRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceForRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final CompetenceForRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final CompetenceForRole.Match partialMatch) {
    ...
    @Override
    protected CompetenceForRole.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceForRole.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected CompetenceForRole.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceForRole.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceForRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceForRole.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceForRole.Matcher> querySpecification() {
      return CompetenceForRole.instance();
    }
  }
  
  private CompetenceForRole() {
   ...
   * 
   */
  public static CompetenceForRole instance() {
    try{
  ...
  @Override
  protected CompetenceForRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceForRole.Matcher.on(engine);
  }
  
  @Override
  public CompetenceForRole.Matcher instantiate() {
    return CompetenceForRole.Matcher.create();
  }
  
  @Override
  public CompetenceForRole.Match newEmptyMatch() {
    return CompetenceForRole.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceForRole.Match newMatch(final Object... parameters) {
    return CompetenceForRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceForRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceForRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceForRole INSTANCE = new CompetenceForRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceForRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "CompetenceForRole")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "CompetenceForRole");
