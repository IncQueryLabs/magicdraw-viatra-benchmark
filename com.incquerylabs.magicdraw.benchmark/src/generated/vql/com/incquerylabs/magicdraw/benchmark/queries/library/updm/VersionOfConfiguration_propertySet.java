...
public final class VersionOfConfiguration_propertySet extends BaseGeneratedEMFQuerySpecification<VersionOfConfiguration_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionOfConfiguration_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public VersionOfConfiguration_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionOfConfiguration_propertySet.Match)) {
          VersionOfConfiguration_propertySet.Match other = (VersionOfConfiguration_propertySet.Match) obj;
    ...
    @Override
    public VersionOfConfiguration_propertySet specification() {
      return VersionOfConfiguration_propertySet.instance();
    }
     ...
     * 
     */
    public static VersionOfConfiguration_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionOfConfiguration_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static VersionOfConfiguration_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends VersionOfConfiguration_propertySet.Match {
    ...
    private static final class Immutable extends VersionOfConfiguration_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_propertySet pattern,
   ...
   * 
   * @see Match
   * @see VersionOfConfiguration_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<VersionOfConfiguration_propertySet.Match> {
    /**
     ...
     * 
     */
    public static VersionOfConfiguration_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionOfConfiguration_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionOfConfiguration_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<VersionOfConfiguration_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<VersionOfConfiguration_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<VersionOfConfiguration_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super VersionOfConfiguration_propertySet.Match> processor) {
     ...
     * 
     */
    public VersionOfConfiguration_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return VersionOfConfiguration_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final VersionOfConfiguration_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final VersionOfConfiguration_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final VersionOfConfiguration_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final VersionOfConfiguration_propertySet.Match partialMatch) {
    ...
    @Override
    protected VersionOfConfiguration_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return VersionOfConfiguration_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected VersionOfConfiguration_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return VersionOfConfiguration_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionOfConfiguration_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionOfConfiguration_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionOfConfiguration_propertySet.Matcher> querySpecification() {
      return VersionOfConfiguration_propertySet.instance();
    }
  }
  
  private VersionOfConfiguration_propertySet() {
   ...
   * 
   */
  public static VersionOfConfiguration_propertySet instance() {
    try{
  ...
  @Override
  protected VersionOfConfiguration_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionOfConfiguration_propertySet.Matcher.on(engine);
  }
  
  @Override
  public VersionOfConfiguration_propertySet.Matcher instantiate() {
    return VersionOfConfiguration_propertySet.Matcher.create();
  }
  
  @Override
  public VersionOfConfiguration_propertySet.Match newEmptyMatch() {
    return VersionOfConfiguration_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public VersionOfConfiguration_propertySet.Match newMatch(final Object... parameters) {
    return VersionOfConfiguration_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionOfConfiguration_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionOfConfiguration_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionOfConfiguration_propertySet INSTANCE = new VersionOfConfiguration_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionOfConfiguration_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
