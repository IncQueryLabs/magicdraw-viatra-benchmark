...
public final class Command_propertySet extends BaseGeneratedEMFQuerySpecification<Command_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Command_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Command_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Command_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Command_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Command_propertySet.Match)) {
          Command_propertySet.Match other = (Command_propertySet.Match) obj;
    ...
    @Override
    public Command_propertySet specification() {
      return Command_propertySet.instance();
    }
     ...
     * 
     */
    public static Command_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Command_propertySet.Match newMutableMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public static Command_propertySet.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Command_propertySet.Match {
    ...
    private static final class Immutable extends Command_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Command_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Command_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Command_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Command_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Command_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Command_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Command_propertySet.Match> getAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Command_propertySet.Match> streamAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Command_propertySet.Match> getOneArbitraryMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final Element pValue, final Consumer<? super Command_propertySet.Match> processor) {
     ...
     * 
     */
    public Command_propertySet.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return Command_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Command_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Command_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Command_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Command_propertySet.Match partialMatch) {
    ...
    @Override
    protected Command_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Command_propertySet.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Command_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Command_propertySet.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Command_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Command_propertySet.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Command_propertySet.Matcher> querySpecification() {
      return Command_propertySet.instance();
    }
  }
  
  private Command_propertySet() {
   ...
   * 
   */
  public static Command_propertySet instance() {
    try{
  ...
  @Override
  protected Command_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Command_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Command_propertySet.Matcher instantiate() {
    return Command_propertySet.Matcher.create();
  }
  
  @Override
  public Command_propertySet.Match newEmptyMatch() {
    return Command_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Command_propertySet.Match newMatch(final Object... parameters) {
    return Command_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Command_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Command_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Command_propertySet INSTANCE = new Command_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Command_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
