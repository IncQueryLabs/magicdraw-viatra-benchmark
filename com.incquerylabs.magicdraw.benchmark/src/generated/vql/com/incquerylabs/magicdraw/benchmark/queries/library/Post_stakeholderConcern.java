...
public final class Post_stakeholderConcern extends BaseGeneratedEMFQuerySpecification<Post_stakeholderConcern.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_stakeholderConcern pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Post_stakeholderConcern";
    }
    
    @Override
    public List<String> parameterNames() {
      return Post_stakeholderConcern.Match.parameterNames;
    }
    ...
    @Override
    public Post_stakeholderConcern.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Post_stakeholderConcern.Match)) {
          Post_stakeholderConcern.Match other = (Post_stakeholderConcern.Match) obj;
    ...
    @Override
    public Post_stakeholderConcern specification() {
      return Post_stakeholderConcern.instance();
    }
     ...
     * 
     */
    public static Post_stakeholderConcern.Match newEmptyMatch() {
     ...
     * 
     */
    public static Post_stakeholderConcern.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Post_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Post_stakeholderConcern.Match {
    ...
    private static final class Immutable extends Post_stakeholderConcern.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Post_stakeholderConcern pattern,
   ...
   * 
   * @see Match
   * @see Post_stakeholderConcern
   * 
   */
  public static class Matcher extends BaseMatcher<Post_stakeholderConcern.Match> {
    /**
     ...
     * 
     */
    public static Post_stakeholderConcern.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Post_stakeholderConcern.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Post_stakeholderConcern.Matcher.class);
     ...
     * 
     */
    public Collection<Post_stakeholderConcern.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Post_stakeholderConcern.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Post_stakeholderConcern.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Post_stakeholderConcern.Match> processor) {
     ...
     * 
     */
    public Post_stakeholderConcern.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Post_stakeholderConcern.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Post_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Post_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Post_stakeholderConcern.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Post_stakeholderConcern.Match partialMatch) {
    ...
    @Override
    protected Post_stakeholderConcern.Match tupleToMatch(final Tuple t) {
      try {
          return Post_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Post_stakeholderConcern.Match arrayToMatch(final Object[] match) {
      try {
          return Post_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Post_stakeholderConcern.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Post_stakeholderConcern.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Post_stakeholderConcern.Matcher> querySpecification() {
      return Post_stakeholderConcern.instance();
    }
  }
  
  private Post_stakeholderConcern() {
   ...
   * 
   */
  public static Post_stakeholderConcern instance() {
    try{
  ...
  @Override
  protected Post_stakeholderConcern.Matcher instantiate(final ViatraQueryEngine engine) {
    return Post_stakeholderConcern.Matcher.on(engine);
  }
  
  @Override
  public Post_stakeholderConcern.Matcher instantiate() {
    return Post_stakeholderConcern.Matcher.create();
  }
  
  @Override
  public Post_stakeholderConcern.Match newEmptyMatch() {
    return Post_stakeholderConcern.Match.newEmptyMatch();
  }
  
  @Override
  public Post_stakeholderConcern.Match newMatch(final Object... parameters) {
    return Post_stakeholderConcern.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Post_stakeholderConcern} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Post_stakeholderConcern#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Post_stakeholderConcern INSTANCE = new Post_stakeholderConcern();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Post_stakeholderConcern.GeneratedPQuery INSTANCE = new GeneratedPQuery();
