...
public final class Consumes_targetContext extends BaseGeneratedEMFQuerySpecification<Consumes_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Consumes_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Consumes_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Consumes_targetContext.Match)) {
          Consumes_targetContext.Match other = (Consumes_targetContext.Match) obj;
    ...
    @Override
    public Consumes_targetContext specification() {
      return Consumes_targetContext.instance();
    }
     ...
     * 
     */
    public static Consumes_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Consumes_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Consumes_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Consumes_targetContext.Match {
    ...
    private static final class Immutable extends Consumes_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Consumes_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Consumes_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Consumes_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Consumes_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Consumes_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Consumes_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Consumes_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Consumes_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Consumes_targetContext.Match> processor) {
     ...
     * 
     */
    public Consumes_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Consumes_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Consumes_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Consumes_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Consumes_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Consumes_targetContext.Match partialMatch) {
    ...
    @Override
    protected Consumes_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Consumes_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Consumes_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Consumes_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Consumes_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Consumes_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Consumes_targetContext.Matcher> querySpecification() {
      return Consumes_targetContext.instance();
    }
  }
  
  private Consumes_targetContext() {
   ...
   * 
   */
  public static Consumes_targetContext instance() {
    try{
  ...
  @Override
  protected Consumes_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Consumes_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Consumes_targetContext.Matcher instantiate() {
    return Consumes_targetContext.Matcher.create();
  }
  
  @Override
  public Consumes_targetContext.Match newEmptyMatch() {
    return Consumes_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Consumes_targetContext.Match newMatch(final Object... parameters) {
    return Consumes_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Consumes_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Consumes_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Consumes_targetContext INSTANCE = new Consumes_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Consumes_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
