...
public final class OrganizationalResource_function extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_function.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_function.Match)) {
          OrganizationalResource_function.Match other = (OrganizationalResource_function.Match) obj;
    ...
    @Override
    public OrganizationalResource_function specification() {
      return OrganizationalResource_function.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_function.Match {
    ...
    private static final class Immutable extends OrganizationalResource_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationalResource_function pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_function
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_function.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_function.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_function.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_function.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_function.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_function.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_function.Matcher> querySpecification() {
      return OrganizationalResource_function.instance();
    }
  }
  
  private OrganizationalResource_function() {
   ...
   * 
   */
  public static OrganizationalResource_function instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_function.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_function.Matcher instantiate() {
    return OrganizationalResource_function.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_function.Match newEmptyMatch() {
    return OrganizationalResource_function.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_function.Match newMatch(final Object... parameters) {
    return OrganizationalResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_function INSTANCE = new OrganizationalResource_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
