...
public final class Metadata_URI extends BaseGeneratedEMFQuerySpecification<Metadata_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Metadata_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Metadata_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Metadata_URI.Match.parameterNames;
    }
    ...
    @Override
    public Metadata_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Metadata_URI.Match)) {
          Metadata_URI.Match other = (Metadata_URI.Match) obj;
    ...
    @Override
    public Metadata_URI specification() {
      return Metadata_URI.instance();
    }
     ...
     * 
     */
    public static Metadata_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Metadata_URI.Match newMutableMatch(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Metadata_URI.Match newMatch(final Comment pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Metadata_URI.Match {
    ...
    private static final class Immutable extends Metadata_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Metadata_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Metadata_URI.Match> {
    /**
     ...
     * 
     */
    public static Metadata_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Metadata_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Metadata_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Metadata_URI.Match> getAllMatches(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Metadata_URI.Match> streamAllMatches(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Metadata_URI.Match> getOneArbitraryMatch(final Comment pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final LiteralString pValuespec, final Consumer<? super Metadata_URI.Match> processor) {
     ...
     * 
     */
    public Metadata_URI.Match newMatch(final Comment pElement, final LiteralString pValuespec) {
      return Metadata_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Metadata_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Metadata_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Metadata_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Metadata_URI.Match partialMatch) {
    ...
    @Override
    protected Metadata_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Metadata_URI.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Metadata_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Metadata_URI.Match.newMatch((Comment) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Metadata_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Metadata_URI.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Metadata_URI.Matcher> querySpecification() {
      return Metadata_URI.instance();
    }
  }
   ...
   * 
   */
  public static Metadata_URI instance() {
    try{
  ...
  @Override
  protected Metadata_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Metadata_URI.Matcher.on(engine);
  }
  
  @Override
  public Metadata_URI.Matcher instantiate() {
    return Metadata_URI.Matcher.create();
  }
  
  @Override
  public Metadata_URI.Match newEmptyMatch() {
    return Metadata_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Metadata_URI.Match newMatch(final Object... parameters) {
    return Metadata_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Metadata_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Metadata_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Metadata_URI INSTANCE = new Metadata_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Metadata_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
