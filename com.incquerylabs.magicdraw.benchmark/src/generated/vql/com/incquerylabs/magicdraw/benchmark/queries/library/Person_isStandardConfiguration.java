...
import com.incquerylabs.magicdraw.benchmark.queries.library.Person;
...
public final class Person_isStandardConfiguration extends BaseGeneratedEMFQuerySpecification<Person_isStandardConfiguration.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_isStandardConfiguration pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Person_isStandardConfiguration";
    }
    
    @Override
    public List<String> parameterNames() {
      return Person_isStandardConfiguration.Match.parameterNames;
    }
    ...
    @Override
    public Person_isStandardConfiguration.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Person_isStandardConfiguration.Match)) {
          Person_isStandardConfiguration.Match other = (Person_isStandardConfiguration.Match) obj;
    ...
    @Override
    public Person_isStandardConfiguration specification() {
      return Person_isStandardConfiguration.instance();
    }
     ...
     * 
     */
    public static Person_isStandardConfiguration.Match newEmptyMatch() {
     ...
     * 
     */
    public static Person_isStandardConfiguration.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Person_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Person_isStandardConfiguration.Match {
    ...
    private static final class Immutable extends Person_isStandardConfiguration.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Person_isStandardConfiguration pattern,
   ...
   * 
   * @see Match
   * @see Person_isStandardConfiguration
   * 
   */
  public static class Matcher extends BaseMatcher<Person_isStandardConfiguration.Match> {
    /**
     ...
     * 
     */
    public static Person_isStandardConfiguration.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Person_isStandardConfiguration.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Person_isStandardConfiguration.Matcher.class);
     ...
     * 
     */
    public Collection<Person_isStandardConfiguration.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Person_isStandardConfiguration.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Person_isStandardConfiguration.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Person_isStandardConfiguration.Match> processor) {
     ...
     * 
     */
    public Person_isStandardConfiguration.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Person_isStandardConfiguration.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Person_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Person_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Person_isStandardConfiguration.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Person_isStandardConfiguration.Match partialMatch) {
    ...
    @Override
    protected Person_isStandardConfiguration.Match tupleToMatch(final Tuple t) {
      try {
          return Person_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Person_isStandardConfiguration.Match arrayToMatch(final Object[] match) {
      try {
          return Person_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Person_isStandardConfiguration.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Person_isStandardConfiguration.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Person_isStandardConfiguration.Matcher> querySpecification() {
      return Person_isStandardConfiguration.instance();
    }
  }
  
  private Person_isStandardConfiguration() {
   ...
   * 
   */
  public static Person_isStandardConfiguration instance() {
    try{
  ...
  @Override
  protected Person_isStandardConfiguration.Matcher instantiate(final ViatraQueryEngine engine) {
    return Person_isStandardConfiguration.Matcher.on(engine);
  }
  
  @Override
  public Person_isStandardConfiguration.Matcher instantiate() {
    return Person_isStandardConfiguration.Matcher.create();
  }
  
  @Override
  public Person_isStandardConfiguration.Match newEmptyMatch() {
    return Person_isStandardConfiguration.Match.newEmptyMatch();
  }
  
  @Override
  public Person_isStandardConfiguration.Match newMatch(final Object... parameters) {
    return Person_isStandardConfiguration.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Person_isStandardConfiguration} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Person_isStandardConfiguration#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Person_isStandardConfiguration INSTANCE = new Person_isStandardConfiguration();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Person_isStandardConfiguration.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Person(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Person.instance().getInternalQueryRepresentation());
