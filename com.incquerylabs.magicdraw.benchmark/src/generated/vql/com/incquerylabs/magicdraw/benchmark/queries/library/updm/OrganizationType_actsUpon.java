...
public final class OrganizationType_actsUpon extends BaseGeneratedEMFQuerySpecification<OrganizationType_actsUpon.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_actsUpon pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_actsUpon";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_actsUpon.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_actsUpon.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_actsUpon.Match)) {
          OrganizationType_actsUpon.Match other = (OrganizationType_actsUpon.Match) obj;
    ...
    @Override
    public OrganizationType_actsUpon specification() {
      return OrganizationType_actsUpon.instance();
    }
     ...
     * 
     */
    public static OrganizationType_actsUpon.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_actsUpon.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_actsUpon.Match {
    ...
    private static final class Immutable extends OrganizationType_actsUpon.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_actsUpon pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_actsUpon
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_actsUpon.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_actsUpon.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_actsUpon.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_actsUpon.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_actsUpon.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_actsUpon.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_actsUpon.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_actsUpon.Match> processor) {
     ...
     * 
     */
    public OrganizationType_actsUpon.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_actsUpon.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_actsUpon.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_actsUpon.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_actsUpon.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_actsUpon.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_actsUpon.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_actsUpon.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_actsUpon.Matcher> querySpecification() {
      return OrganizationType_actsUpon.instance();
    }
  }
  
  private OrganizationType_actsUpon() {
   ...
   * 
   */
  public static OrganizationType_actsUpon instance() {
    try{
  ...
  @Override
  protected OrganizationType_actsUpon.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_actsUpon.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_actsUpon.Matcher instantiate() {
    return OrganizationType_actsUpon.Matcher.create();
  }
  
  @Override
  public OrganizationType_actsUpon.Match newEmptyMatch() {
    return OrganizationType_actsUpon.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_actsUpon.Match newMatch(final Object... parameters) {
    return OrganizationType_actsUpon.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_actsUpon} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_actsUpon#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_actsUpon INSTANCE = new OrganizationType_actsUpon();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_actsUpon.GeneratedPQuery INSTANCE = new GeneratedPQuery();
