...
public final class Protocol_conformsTo extends BaseGeneratedEMFQuerySpecification<Protocol_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Protocol_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Protocol_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Protocol_conformsTo.Match)) {
          Protocol_conformsTo.Match other = (Protocol_conformsTo.Match) obj;
    ...
    @Override
    public Protocol_conformsTo specification() {
      return Protocol_conformsTo.instance();
    }
     ...
     * 
     */
    public static Protocol_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Protocol_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static Protocol_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Protocol_conformsTo.Match {
    ...
    private static final class Immutable extends Protocol_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Protocol_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Protocol_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Protocol_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Protocol_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Protocol_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Protocol_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Protocol_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<Protocol_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<Protocol_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super Protocol_conformsTo.Match> processor) {
     ...
     * 
     */
    public Protocol_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return Protocol_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Protocol_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Protocol_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfvalue(final Protocol_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfvalue(final Protocol_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Protocol_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Protocol_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    @Override
    protected Protocol_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Protocol_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Protocol_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Protocol_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Protocol_conformsTo.Matcher> querySpecification() {
      return Protocol_conformsTo.instance();
    }
  }
  
  private Protocol_conformsTo() {
   ...
   * 
   */
  public static Protocol_conformsTo instance() {
    try{
  ...
  @Override
  protected Protocol_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Protocol_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Protocol_conformsTo.Matcher instantiate() {
    return Protocol_conformsTo.Matcher.create();
  }
  
  @Override
  public Protocol_conformsTo.Match newEmptyMatch() {
    return Protocol_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Protocol_conformsTo.Match newMatch(final Object... parameters) {
    return Protocol_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Protocol_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Protocol_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Protocol_conformsTo INSTANCE = new Protocol_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Protocol_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
