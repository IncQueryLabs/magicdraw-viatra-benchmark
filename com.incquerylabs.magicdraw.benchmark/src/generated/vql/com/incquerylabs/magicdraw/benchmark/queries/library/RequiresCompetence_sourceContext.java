...
public final class RequiresCompetence_sourceContext extends BaseGeneratedEMFQuerySpecification<RequiresCompetence_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return RequiresCompetence_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public RequiresCompetence_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RequiresCompetence_sourceContext.Match)) {
          RequiresCompetence_sourceContext.Match other = (RequiresCompetence_sourceContext.Match) obj;
    ...
    @Override
    public RequiresCompetence_sourceContext specification() {
      return RequiresCompetence_sourceContext.instance();
    }
     ...
     * 
     */
    public static RequiresCompetence_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static RequiresCompetence_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static RequiresCompetence_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RequiresCompetence_sourceContext.Match {
    ...
    private static final class Immutable extends RequiresCompetence_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see RequiresCompetence_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<RequiresCompetence_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static RequiresCompetence_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RequiresCompetence_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RequiresCompetence_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<RequiresCompetence_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<RequiresCompetence_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<RequiresCompetence_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super RequiresCompetence_sourceContext.Match> processor) {
     ...
     * 
     */
    public RequiresCompetence_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return RequiresCompetence_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final RequiresCompetence_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final RequiresCompetence_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final RequiresCompetence_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final RequiresCompetence_sourceContext.Match partialMatch) {
    ...
    @Override
    protected RequiresCompetence_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return RequiresCompetence_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected RequiresCompetence_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return RequiresCompetence_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RequiresCompetence_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RequiresCompetence_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RequiresCompetence_sourceContext.Matcher> querySpecification() {
      return RequiresCompetence_sourceContext.instance();
    }
  }
  
  private RequiresCompetence_sourceContext() {
   ...
   * 
   */
  public static RequiresCompetence_sourceContext instance() {
    try{
  ...
  @Override
  protected RequiresCompetence_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return RequiresCompetence_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public RequiresCompetence_sourceContext.Matcher instantiate() {
    return RequiresCompetence_sourceContext.Matcher.create();
  }
  
  @Override
  public RequiresCompetence_sourceContext.Match newEmptyMatch() {
    return RequiresCompetence_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public RequiresCompetence_sourceContext.Match newMatch(final Object... parameters) {
    return RequiresCompetence_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RequiresCompetence_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RequiresCompetence_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RequiresCompetence_sourceContext INSTANCE = new RequiresCompetence_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RequiresCompetence_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
