...
public final class Responsibility_milestone extends BaseGeneratedEMFQuerySpecification<Responsibility_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_milestone.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_milestone.Match)) {
          Responsibility_milestone.Match other = (Responsibility_milestone.Match) obj;
    ...
    @Override
    public Responsibility_milestone specification() {
      return Responsibility_milestone.instance();
    }
     ...
     * 
     */
    public static Responsibility_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_milestone.Match {
    ...
    private static final class Immutable extends Responsibility_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_milestone pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_milestone.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_milestone.Match> processor) {
     ...
     * 
     */
    public Responsibility_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_milestone.Match partialMatch) {
    ...
    @Override
    protected Responsibility_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_milestone.Matcher> querySpecification() {
      return Responsibility_milestone.instance();
    }
  }
  
  private Responsibility_milestone() {
   ...
   * 
   */
  public static Responsibility_milestone instance() {
    try{
  ...
  @Override
  protected Responsibility_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_milestone.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_milestone.Matcher instantiate() {
    return Responsibility_milestone.Matcher.create();
  }
  
  @Override
  public Responsibility_milestone.Match newEmptyMatch() {
    return Responsibility_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_milestone.Match newMatch(final Object... parameters) {
    return Responsibility_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_milestone INSTANCE = new Responsibility_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
