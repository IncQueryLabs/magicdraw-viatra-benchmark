...
public final class ActualResourceRole_endDate extends BaseGeneratedEMFQuerySpecification<ActualResourceRole_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualResourceRole_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualResourceRole_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualResourceRole_endDate.Match)) {
          ActualResourceRole_endDate.Match other = (ActualResourceRole_endDate.Match) obj;
    ...
    @Override
    public ActualResourceRole_endDate specification() {
      return ActualResourceRole_endDate.instance();
    }
     ...
     * 
     */
    public static ActualResourceRole_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualResourceRole_endDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualResourceRole_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualResourceRole_endDate.Match {
    ...
    private static final class Immutable extends ActualResourceRole_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualResourceRole_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualResourceRole_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualResourceRole_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualResourceRole_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualResourceRole_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualResourceRole_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualResourceRole_endDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualResourceRole_endDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualResourceRole_endDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualResourceRole_endDate.Match> processor) {
     ...
     * 
     */
    public ActualResourceRole_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualResourceRole_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualResourceRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualResourceRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualResourceRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualResourceRole_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualResourceRole_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualResourceRole_endDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualResourceRole_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualResourceRole_endDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualResourceRole_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualResourceRole_endDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualResourceRole_endDate.Matcher> querySpecification() {
      return ActualResourceRole_endDate.instance();
    }
  }
  
  private ActualResourceRole_endDate() {
   ...
   * 
   */
  public static ActualResourceRole_endDate instance() {
    try{
  ...
  @Override
  protected ActualResourceRole_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualResourceRole_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualResourceRole_endDate.Matcher instantiate() {
    return ActualResourceRole_endDate.Matcher.create();
  }
  
  @Override
  public ActualResourceRole_endDate.Match newEmptyMatch() {
    return ActualResourceRole_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualResourceRole_endDate.Match newMatch(final Object... parameters) {
    return ActualResourceRole_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualResourceRole_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualResourceRole_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualResourceRole_endDate INSTANCE = new ActualResourceRole_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualResourceRole_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
