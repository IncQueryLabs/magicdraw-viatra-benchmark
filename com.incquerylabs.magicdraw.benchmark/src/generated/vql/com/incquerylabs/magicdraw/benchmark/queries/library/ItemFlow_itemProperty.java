 ...
 *         	find slotValue(domainStereotypeInstance, "itemProperty", valuespec);
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ItemFlow(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ItemFlow.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "itemProperty", valuespec)
