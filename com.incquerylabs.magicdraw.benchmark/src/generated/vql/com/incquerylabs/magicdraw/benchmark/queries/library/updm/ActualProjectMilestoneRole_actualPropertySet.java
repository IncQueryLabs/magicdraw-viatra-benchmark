...
public final class ActualProjectMilestoneRole_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ActualProjectMilestoneRole_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProjectMilestoneRole_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProjectMilestoneRole_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectMilestoneRole_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectMilestoneRole_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectMilestoneRole_actualPropertySet.Match)) {
          ActualProjectMilestoneRole_actualPropertySet.Match other = (ActualProjectMilestoneRole_actualPropertySet.Match) obj;
    ...
    @Override
    public ActualProjectMilestoneRole_actualPropertySet specification() {
      return ActualProjectMilestoneRole_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ActualProjectMilestoneRole_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_actualPropertySet.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_actualPropertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProjectMilestoneRole_actualPropertySet.Match {
    ...
    private static final class Immutable extends ActualProjectMilestoneRole_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProjectMilestoneRole_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectMilestoneRole_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectMilestoneRole_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectMilestoneRole_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectMilestoneRole_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectMilestoneRole_actualPropertySet.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProjectMilestoneRole_actualPropertySet.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProjectMilestoneRole_actualPropertySet.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProjectMilestoneRole_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ActualProjectMilestoneRole_actualPropertySet.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProjectMilestoneRole_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectMilestoneRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectMilestoneRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProjectMilestoneRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProjectMilestoneRole_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ActualProjectMilestoneRole_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectMilestoneRole_actualPropertySet.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProjectMilestoneRole_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_actualPropertySet.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectMilestoneRole_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_actualPropertySet.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectMilestoneRole_actualPropertySet.Matcher> querySpecification() {
      return ActualProjectMilestoneRole_actualPropertySet.instance();
    }
  }
  
  private ActualProjectMilestoneRole_actualPropertySet() {
   ...
   * 
   */
  public static ActualProjectMilestoneRole_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ActualProjectMilestoneRole_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectMilestoneRole_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectMilestoneRole_actualPropertySet.Matcher instantiate() {
    return ActualProjectMilestoneRole_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ActualProjectMilestoneRole_actualPropertySet.Match newEmptyMatch() {
    return ActualProjectMilestoneRole_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectMilestoneRole_actualPropertySet.Match newMatch(final Object... parameters) {
    return ActualProjectMilestoneRole_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectMilestoneRole_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectMilestoneRole_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectMilestoneRole_actualPropertySet INSTANCE = new ActualProjectMilestoneRole_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectMilestoneRole_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
