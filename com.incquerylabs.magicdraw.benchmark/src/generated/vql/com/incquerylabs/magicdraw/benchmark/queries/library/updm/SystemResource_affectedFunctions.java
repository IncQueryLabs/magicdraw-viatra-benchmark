...
public final class SystemResource_affectedFunctions extends BaseGeneratedEMFQuerySpecification<SystemResource_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_affectedFunctions.Match)) {
          SystemResource_affectedFunctions.Match other = (SystemResource_affectedFunctions.Match) obj;
    ...
    @Override
    public SystemResource_affectedFunctions specification() {
      return SystemResource_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static SystemResource_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_affectedFunctions.Match {
    ...
    private static final class Immutable extends SystemResource_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public SystemResource_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected SystemResource_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_affectedFunctions.Matcher> querySpecification() {
      return SystemResource_affectedFunctions.instance();
    }
  }
  
  private SystemResource_affectedFunctions() {
   ...
   * 
   */
  public static SystemResource_affectedFunctions instance() {
    try{
  ...
  @Override
  protected SystemResource_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_affectedFunctions.Matcher instantiate() {
    return SystemResource_affectedFunctions.Matcher.create();
  }
  
  @Override
  public SystemResource_affectedFunctions.Match newEmptyMatch() {
    return SystemResource_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_affectedFunctions.Match newMatch(final Object... parameters) {
    return SystemResource_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_affectedFunctions INSTANCE = new SystemResource_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
