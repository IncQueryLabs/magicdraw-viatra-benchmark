...
public final class ResourceRole extends BaseGeneratedEMFQuerySpecification<ResourceRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole.Match)) {
          ResourceRole.Match other = (ResourceRole.Match) obj;
    ...
    @Override
    public ResourceRole specification() {
     ...
     * 
     */
    public static ResourceRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResourceRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResourceRole.Match {
    ...
    private static final class Immutable extends ResourceRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResourceRole.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResourceRole.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResourceRole.Match> processor) {
     ...
     * 
     */
    public ResourceRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResourceRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResourceRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResourceRole.Match partialMatch) {
    ...
    @Override
    protected ResourceRole.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResourceRole.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole.Matcher> querySpecification() {
      return ResourceRole.instance();
    }
  }
   ...
   * 
   */
  public static ResourceRole instance() {
    try{
  ...
  @Override
  protected ResourceRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole.Matcher instantiate() {
    return ResourceRole.Matcher.create();
  }
  
  @Override
  public ResourceRole.Match newEmptyMatch() {
    return ResourceRole.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole.Match newMatch(final Object... parameters) {
    return ResourceRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole INSTANCE = new ResourceRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ResourceRole")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ResourceRole");
