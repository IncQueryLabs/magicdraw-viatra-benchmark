...
public final class KnownResource_actualPropertySet extends BaseGeneratedEMFQuerySpecification<KnownResource_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_actualPropertySet.Match)) {
          KnownResource_actualPropertySet.Match other = (KnownResource_actualPropertySet.Match) obj;
    ...
    @Override
    public KnownResource_actualPropertySet specification() {
      return KnownResource_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static KnownResource_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_actualPropertySet.Match {
    ...
    private static final class Immutable extends KnownResource_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.KnownResource_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super KnownResource_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public KnownResource_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return KnownResource_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final KnownResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final KnownResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected KnownResource_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_actualPropertySet.Matcher> querySpecification() {
      return KnownResource_actualPropertySet.instance();
    }
  }
  
  private KnownResource_actualPropertySet() {
   ...
   * 
   */
  public static KnownResource_actualPropertySet instance() {
    try{
  ...
  @Override
  protected KnownResource_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_actualPropertySet.Matcher instantiate() {
    return KnownResource_actualPropertySet.Matcher.create();
  }
  
  @Override
  public KnownResource_actualPropertySet.Match newEmptyMatch() {
    return KnownResource_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_actualPropertySet.Match newMatch(final Object... parameters) {
    return KnownResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_actualPropertySet INSTANCE = new KnownResource_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
