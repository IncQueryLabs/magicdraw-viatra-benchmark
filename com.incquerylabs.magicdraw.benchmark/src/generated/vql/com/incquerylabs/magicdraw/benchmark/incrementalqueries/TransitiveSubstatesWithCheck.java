...
public final class TransitiveSubstatesWithCheck extends BaseGeneratedEMFQuerySpecification<TransitiveSubstatesWithCheck.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.transitiveSubstatesWithCheck pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.incrementalqueries.transitiveSubstatesWithCheck";
    }
    
    @Override
    public List<String> parameterNames() {
      return TransitiveSubstatesWithCheck.Match.parameterNames;
    }
    ...
    @Override
    public TransitiveSubstatesWithCheck.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TransitiveSubstatesWithCheck.Match)) {
          TransitiveSubstatesWithCheck.Match other = (TransitiveSubstatesWithCheck.Match) obj;
    ...
    @Override
    public TransitiveSubstatesWithCheck specification() {
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck.Match newEmptyMatch() {
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck.Match newMutableMatch(final State pState, final State pTransitiveSubstate) {
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck.Match newMatch(final State pState, final State pTransitiveSubstate) {
      return new Immutable(pState, pTransitiveSubstate);
    }
    
    private static final class Mutable extends TransitiveSubstatesWithCheck.Match {
    ...
    private static final class Immutable extends TransitiveSubstatesWithCheck.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.incrementalqueries.transitiveSubstatesWithCheck pattern,
   ...
   * 
   * @see Match
   * @see TransitiveSubstatesWithCheck
   * 
   */
  public static class Matcher extends BaseMatcher<TransitiveSubstatesWithCheck.Match> {
    /**
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TransitiveSubstatesWithCheck.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TransitiveSubstatesWithCheck.Matcher.class);
     ...
     * 
     */
    public Collection<TransitiveSubstatesWithCheck.Match> getAllMatches(final State pState, final State pTransitiveSubstate) {
     ...
     * 
     */
    public Stream<TransitiveSubstatesWithCheck.Match> streamAllMatches(final State pState, final State pTransitiveSubstate) {
     ...
     * 
     */
    public Optional<TransitiveSubstatesWithCheck.Match> getOneArbitraryMatch(final State pState, final State pTransitiveSubstate) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final State pState, final State pTransitiveSubstate, final Consumer<? super TransitiveSubstatesWithCheck.Match> processor) {
     ...
     * 
     */
    public TransitiveSubstatesWithCheck.Match newMatch(final State pState, final State pTransitiveSubstate) {
      return TransitiveSubstatesWithCheck.Match.newMatch(pState, pTransitiveSubstate);
    }
     ...
     * 
     */
    public Stream<State> streamAllValuesOfstate(final TransitiveSubstatesWithCheck.Match partialMatch) {
     ...
     * 
     */
    public Set<State> getAllValuesOfstate(final TransitiveSubstatesWithCheck.Match partialMatch) {
     ...
     * 
     */
    public Stream<State> streamAllValuesOftransitiveSubstate(final TransitiveSubstatesWithCheck.Match partialMatch) {
     ...
     * 
     */
    public Set<State> getAllValuesOftransitiveSubstate(final TransitiveSubstatesWithCheck.Match partialMatch) {
    ...
    @Override
    protected TransitiveSubstatesWithCheck.Match tupleToMatch(final Tuple t) {
      try {
          return TransitiveSubstatesWithCheck.Match.newMatch((State) t.get(POSITION_STATE), (State) t.get(POSITION_TRANSITIVESUBSTATE));
    ...
    @Override
    protected TransitiveSubstatesWithCheck.Match arrayToMatch(final Object[] match) {
      try {
          return TransitiveSubstatesWithCheck.Match.newMatch((State) match[POSITION_STATE], (State) match[POSITION_TRANSITIVESUBSTATE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TransitiveSubstatesWithCheck.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TransitiveSubstatesWithCheck.Match.newMutableMatch((State) match[POSITION_STATE], (State) match[POSITION_TRANSITIVESUBSTATE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TransitiveSubstatesWithCheck.Matcher> querySpecification() {
      return TransitiveSubstatesWithCheck.instance();
    }
  }
  
  private TransitiveSubstatesWithCheck() {
   ...
   * 
   */
  public static TransitiveSubstatesWithCheck instance() {
    try{
  ...
  @Override
  protected TransitiveSubstatesWithCheck.Matcher instantiate(final ViatraQueryEngine engine) {
    return TransitiveSubstatesWithCheck.Matcher.on(engine);
  }
  
  @Override
  public TransitiveSubstatesWithCheck.Matcher instantiate() {
    return TransitiveSubstatesWithCheck.Matcher.create();
  }
  
  @Override
  public TransitiveSubstatesWithCheck.Match newEmptyMatch() {
    return TransitiveSubstatesWithCheck.Match.newEmptyMatch();
  }
  
  @Override
  public TransitiveSubstatesWithCheck.Match newMatch(final Object... parameters) {
    return TransitiveSubstatesWithCheck.Match.newMatch((com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.State) parameters[0], (com.nomagic.uml2.ext.magicdraw.statemachines.mdbehaviorstatemachines.State) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.incrementalqueries.TransitiveSubstatesWithCheck (visibility: PUBLIC, simpleName: TransitiveSubstatesWithCheck, identifier: com.incquerylabs.magicdraw.benchmark.incrementalqueries.TransitiveSubstatesWithCheck, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.incrementalqueries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class LazyHolder {
    private static final TransitiveSubstatesWithCheck INSTANCE = new TransitiveSubstatesWithCheck();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TransitiveSubstatesWithCheck.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find statesWithShortNames(state)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_state), StatesWithShortNames.instance().getInternalQueryRepresentation());
          // 	find parentState+(transitiveSubstate, state)
