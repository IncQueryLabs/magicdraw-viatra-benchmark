...
public final class KnownResource_function extends BaseGeneratedEMFQuerySpecification<KnownResource_function.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_function pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_function";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_function.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_function.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_function.Match)) {
          KnownResource_function.Match other = (KnownResource_function.Match) obj;
    ...
    @Override
    public KnownResource_function specification() {
      return KnownResource_function.instance();
    }
     ...
     * 
     */
    public static KnownResource_function.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_function.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_function.Match {
    ...
    private static final class Immutable extends KnownResource_function.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_function pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_function
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_function.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_function.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_function.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_function.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_function.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_function.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_function.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super KnownResource_function.Match> processor) {
     ...
     * 
     */
    public KnownResource_function.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return KnownResource_function.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final KnownResource_function.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final KnownResource_function.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_function.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_function.Match partialMatch) {
    ...
    @Override
    protected KnownResource_function.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_function.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_function.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_function.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_function.Matcher> querySpecification() {
      return KnownResource_function.instance();
    }
  }
  
  private KnownResource_function() {
   ...
   * 
   */
  public static KnownResource_function instance() {
    try{
  ...
  @Override
  protected KnownResource_function.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_function.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_function.Matcher instantiate() {
    return KnownResource_function.Matcher.create();
  }
  
  @Override
  public KnownResource_function.Match newEmptyMatch() {
    return KnownResource_function.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_function.Match newMatch(final Object... parameters) {
    return KnownResource_function.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_function} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_function#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_function INSTANCE = new KnownResource_function();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_function.GeneratedPQuery INSTANCE = new GeneratedPQuery();
