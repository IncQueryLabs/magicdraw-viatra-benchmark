...
public final class ActualEnvironment_endDate extends BaseGeneratedEMFQuerySpecification<ActualEnvironment_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnvironment_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnvironment_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualEnvironment_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualEnvironment_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualEnvironment_endDate.Match)) {
          ActualEnvironment_endDate.Match other = (ActualEnvironment_endDate.Match) obj;
    ...
    @Override
    public ActualEnvironment_endDate specification() {
      return ActualEnvironment_endDate.instance();
    }
     ...
     * 
     */
    public static ActualEnvironment_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualEnvironment_endDate.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public static ActualEnvironment_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualEnvironment_endDate.Match {
    ...
    private static final class Immutable extends ActualEnvironment_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualEnvironment_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualEnvironment_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualEnvironment_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualEnvironment_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualEnvironment_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualEnvironment_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualEnvironment_endDate.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Stream<ActualEnvironment_endDate.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Optional<ActualEnvironment_endDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue, final Consumer<? super ActualEnvironment_endDate.Match> processor) {
     ...
     * 
     */
    public ActualEnvironment_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return ActualEnvironment_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualEnvironment_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualEnvironment_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvalue(final ActualEnvironment_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvalue(final ActualEnvironment_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualEnvironment_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualEnvironment_endDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualEnvironment_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualEnvironment_endDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualEnvironment_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualEnvironment_endDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualEnvironment_endDate.Matcher> querySpecification() {
      return ActualEnvironment_endDate.instance();
    }
  }
  
  private ActualEnvironment_endDate() {
   ...
   * 
   */
  public static ActualEnvironment_endDate instance() {
    try{
  ...
  @Override
  protected ActualEnvironment_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualEnvironment_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualEnvironment_endDate.Matcher instantiate() {
    return ActualEnvironment_endDate.Matcher.create();
  }
  
  @Override
  public ActualEnvironment_endDate.Match newEmptyMatch() {
    return ActualEnvironment_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualEnvironment_endDate.Match newMatch(final Object... parameters) {
    return ActualEnvironment_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualEnvironment_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualEnvironment_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualEnvironment_endDate INSTANCE = new ActualEnvironment_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualEnvironment_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
