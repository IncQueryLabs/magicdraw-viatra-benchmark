...
public final class OperationalRole extends BaseGeneratedEMFQuerySpecification<OperationalRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalRole.Match.parameterNames;
    }
    ...
    @Override
    public OperationalRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalRole.Match)) {
          OperationalRole.Match other = (OperationalRole.Match) obj;
    ...
    @Override
    public OperationalRole specification() {
      return OperationalRole.instance();
    }
     ...
     * 
     */
    public static OperationalRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalRole.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalRole.Match {
    ...
    private static final class Immutable extends OperationalRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalRole.Match> {
    /**
     ...
     * 
     */
    public static OperationalRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalRole.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalRole.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalRole.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalRole.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalRole.Match> processor) {
     ...
     * 
     */
    public OperationalRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalRole.Match partialMatch) {
    ...
    @Override
    protected OperationalRole.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalRole.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalRole.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalRole.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalRole.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalRole.Matcher> querySpecification() {
      return OperationalRole.instance();
    }
  }
  
  private OperationalRole() {
   ...
   * 
   */
  public static OperationalRole instance() {
    try{
  ...
  @Override
  protected OperationalRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalRole.Matcher.on(engine);
  }
  
  @Override
  public OperationalRole.Matcher instantiate() {
    return OperationalRole.Matcher.create();
  }
  
  @Override
  public OperationalRole.Match newEmptyMatch() {
    return OperationalRole.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalRole.Match newMatch(final Object... parameters) {
    return OperationalRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalRole INSTANCE = new OperationalRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalRole")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalRole");
