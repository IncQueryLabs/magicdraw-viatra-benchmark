...
public final class TechnicalStandard_URI extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_URI.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_URI.Match)) {
          TechnicalStandard_URI.Match other = (TechnicalStandard_URI.Match) obj;
    ...
    @Override
    public TechnicalStandard_URI specification() {
      return TechnicalStandard_URI.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static TechnicalStandard_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends TechnicalStandard_URI.Match {
    ...
    private static final class Immutable extends TechnicalStandard_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_URI pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_URI
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_URI.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_URI.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<TechnicalStandard_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<TechnicalStandard_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super TechnicalStandard_URI.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return TechnicalStandard_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final TechnicalStandard_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final TechnicalStandard_URI.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_URI.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected TechnicalStandard_URI.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_URI.Matcher> querySpecification() {
      return TechnicalStandard_URI.instance();
    }
  }
  
  private TechnicalStandard_URI() {
   ...
   * 
   */
  public static TechnicalStandard_URI instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_URI.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_URI.Matcher instantiate() {
    return TechnicalStandard_URI.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_URI.Match newEmptyMatch() {
    return TechnicalStandard_URI.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_URI.Match newMatch(final Object... parameters) {
    return TechnicalStandard_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_URI INSTANCE = new TechnicalStandard_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
