...
public final class OrganizationType_appliesTo extends BaseGeneratedEMFQuerySpecification<OrganizationType_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_appliesTo.Match)) {
          OrganizationType_appliesTo.Match other = (OrganizationType_appliesTo.Match) obj;
    ...
    @Override
    public OrganizationType_appliesTo specification() {
      return OrganizationType_appliesTo.instance();
    }
     ...
     * 
     */
    public static OrganizationType_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_appliesTo.Match {
    ...
    private static final class Immutable extends OrganizationType_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_appliesTo.Match> processor) {
     ...
     * 
     */
    public OrganizationType_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_appliesTo.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_appliesTo.Matcher> querySpecification() {
      return OrganizationType_appliesTo.instance();
    }
  }
  
  private OrganizationType_appliesTo() {
   ...
   * 
   */
  public static OrganizationType_appliesTo instance() {
    try{
  ...
  @Override
  protected OrganizationType_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_appliesTo.Matcher instantiate() {
    return OrganizationType_appliesTo.Matcher.create();
  }
  
  @Override
  public OrganizationType_appliesTo.Match newEmptyMatch() {
    return OrganizationType_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_appliesTo.Match newMatch(final Object... parameters) {
    return OrganizationType_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_appliesTo INSTANCE = new OrganizationType_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
