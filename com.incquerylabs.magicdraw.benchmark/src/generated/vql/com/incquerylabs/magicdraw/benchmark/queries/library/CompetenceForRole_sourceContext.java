...
public final class CompetenceForRole_sourceContext extends BaseGeneratedEMFQuerySpecification<CompetenceForRole_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceForRole_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceForRole_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceForRole_sourceContext.Match)) {
          CompetenceForRole_sourceContext.Match other = (CompetenceForRole_sourceContext.Match) obj;
    ...
    @Override
    public CompetenceForRole_sourceContext specification() {
      return CompetenceForRole_sourceContext.instance();
    }
     ...
     * 
     */
    public static CompetenceForRole_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceForRole_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static CompetenceForRole_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CompetenceForRole_sourceContext.Match {
    ...
    private static final class Immutable extends CompetenceForRole_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see CompetenceForRole_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceForRole_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static CompetenceForRole_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceForRole_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceForRole_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceForRole_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<CompetenceForRole_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<CompetenceForRole_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super CompetenceForRole_sourceContext.Match> processor) {
     ...
     * 
     */
    public CompetenceForRole_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return CompetenceForRole_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceForRole_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceForRole_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final CompetenceForRole_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final CompetenceForRole_sourceContext.Match partialMatch) {
    ...
    @Override
    protected CompetenceForRole_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceForRole_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected CompetenceForRole_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceForRole_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceForRole_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceForRole_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceForRole_sourceContext.Matcher> querySpecification() {
      return CompetenceForRole_sourceContext.instance();
    }
  }
  
  private CompetenceForRole_sourceContext() {
   ...
   * 
   */
  public static CompetenceForRole_sourceContext instance() {
    try{
  ...
  @Override
  protected CompetenceForRole_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceForRole_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public CompetenceForRole_sourceContext.Matcher instantiate() {
    return CompetenceForRole_sourceContext.Matcher.create();
  }
  
  @Override
  public CompetenceForRole_sourceContext.Match newEmptyMatch() {
    return CompetenceForRole_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceForRole_sourceContext.Match newMatch(final Object... parameters) {
    return CompetenceForRole_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceForRole_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceForRole_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceForRole_sourceContext INSTANCE = new CompetenceForRole_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceForRole_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
