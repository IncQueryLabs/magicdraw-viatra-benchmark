...
public final class EnterprisePhase_conformsTo extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_conformsTo.Match)) {
          EnterprisePhase_conformsTo.Match other = (EnterprisePhase_conformsTo.Match) obj;
    ...
    @Override
    public EnterprisePhase_conformsTo specification() {
      return EnterprisePhase_conformsTo.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_conformsTo.Match {
    ...
    private static final class Immutable extends EnterprisePhase_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_conformsTo.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_conformsTo.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_conformsTo.Matcher> querySpecification() {
      return EnterprisePhase_conformsTo.instance();
    }
  }
  
  private EnterprisePhase_conformsTo() {
   ...
   * 
   */
  public static EnterprisePhase_conformsTo instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_conformsTo.Matcher instantiate() {
    return EnterprisePhase_conformsTo.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_conformsTo.Match newEmptyMatch() {
    return EnterprisePhase_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_conformsTo.Match newMatch(final Object... parameters) {
    return EnterprisePhase_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_conformsTo INSTANCE = new EnterprisePhase_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
