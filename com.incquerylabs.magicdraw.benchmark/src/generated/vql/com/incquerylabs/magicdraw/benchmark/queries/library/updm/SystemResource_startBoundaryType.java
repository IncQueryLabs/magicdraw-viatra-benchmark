...
public final class SystemResource_startBoundaryType extends BaseGeneratedEMFQuerySpecification<SystemResource_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_startBoundaryType.Match)) {
          SystemResource_startBoundaryType.Match other = (SystemResource_startBoundaryType.Match) obj;
    ...
    @Override
    public SystemResource_startBoundaryType specification() {
      return SystemResource_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static SystemResource_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_startBoundaryType.Match {
    ...
    private static final class Immutable extends SystemResource_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public SystemResource_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected SystemResource_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_startBoundaryType.Matcher> querySpecification() {
      return SystemResource_startBoundaryType.instance();
    }
  }
  
  private SystemResource_startBoundaryType() {
   ...
   * 
   */
  public static SystemResource_startBoundaryType instance() {
    try{
  ...
  @Override
  protected SystemResource_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_startBoundaryType.Matcher instantiate() {
    return SystemResource_startBoundaryType.Matcher.create();
  }
  
  @Override
  public SystemResource_startBoundaryType.Match newEmptyMatch() {
    return SystemResource_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_startBoundaryType.Match newMatch(final Object... parameters) {
    return SystemResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_startBoundaryType INSTANCE = new SystemResource_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
