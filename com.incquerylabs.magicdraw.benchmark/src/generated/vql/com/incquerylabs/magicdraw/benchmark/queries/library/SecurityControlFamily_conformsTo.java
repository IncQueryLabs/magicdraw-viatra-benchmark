...
public final class SecurityControlFamily_conformsTo extends BaseGeneratedEMFQuerySpecification<SecurityControlFamily_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControlFamily_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControlFamily_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControlFamily_conformsTo.Match)) {
          SecurityControlFamily_conformsTo.Match other = (SecurityControlFamily_conformsTo.Match) obj;
    ...
    @Override
    public SecurityControlFamily_conformsTo specification() {
      return SecurityControlFamily_conformsTo.instance();
    }
     ...
     * 
     */
    public static SecurityControlFamily_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControlFamily_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityControlFamily_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControlFamily_conformsTo.Match {
    ...
    private static final class Immutable extends SecurityControlFamily_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see SecurityControlFamily_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControlFamily_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static SecurityControlFamily_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControlFamily_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControlFamily_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControlFamily_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityControlFamily_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityControlFamily_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityControlFamily_conformsTo.Match> processor) {
     ...
     * 
     */
    public SecurityControlFamily_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityControlFamily_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControlFamily_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControlFamily_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityControlFamily_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityControlFamily_conformsTo.Match partialMatch) {
    ...
    @Override
    protected SecurityControlFamily_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControlFamily_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControlFamily_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControlFamily_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControlFamily_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControlFamily_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControlFamily_conformsTo.Matcher> querySpecification() {
      return SecurityControlFamily_conformsTo.instance();
    }
  }
  
  private SecurityControlFamily_conformsTo() {
   ...
   * 
   */
  public static SecurityControlFamily_conformsTo instance() {
    try{
  ...
  @Override
  protected SecurityControlFamily_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControlFamily_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public SecurityControlFamily_conformsTo.Matcher instantiate() {
    return SecurityControlFamily_conformsTo.Matcher.create();
  }
  
  @Override
  public SecurityControlFamily_conformsTo.Match newEmptyMatch() {
    return SecurityControlFamily_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControlFamily_conformsTo.Match newMatch(final Object... parameters) {
    return SecurityControlFamily_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControlFamily_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControlFamily_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControlFamily_conformsTo INSTANCE = new SecurityControlFamily_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControlFamily_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
