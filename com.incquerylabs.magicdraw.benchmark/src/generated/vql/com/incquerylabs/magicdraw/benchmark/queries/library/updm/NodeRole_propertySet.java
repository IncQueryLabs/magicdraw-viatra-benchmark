...
public final class NodeRole_propertySet extends BaseGeneratedEMFQuerySpecification<NodeRole_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeRole_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public NodeRole_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeRole_propertySet.Match)) {
          NodeRole_propertySet.Match other = (NodeRole_propertySet.Match) obj;
    ...
    @Override
    public NodeRole_propertySet specification() {
      return NodeRole_propertySet.instance();
    }
     ...
     * 
     */
    public static NodeRole_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeRole_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeRole_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeRole_propertySet.Match {
    ...
    private static final class Immutable extends NodeRole_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_propertySet pattern,
   ...
   * 
   * @see Match
   * @see NodeRole_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<NodeRole_propertySet.Match> {
    /**
     ...
     * 
     */
    public static NodeRole_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeRole_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeRole_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<NodeRole_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeRole_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeRole_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super NodeRole_propertySet.Match> processor) {
     ...
     * 
     */
    public NodeRole_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return NodeRole_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final NodeRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final NodeRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeRole_propertySet.Match partialMatch) {
    ...
    @Override
    protected NodeRole_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return NodeRole_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeRole_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return NodeRole_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeRole_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeRole_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeRole_propertySet.Matcher> querySpecification() {
      return NodeRole_propertySet.instance();
    }
  }
  
  private NodeRole_propertySet() {
   ...
   * 
   */
  public static NodeRole_propertySet instance() {
    try{
  ...
  @Override
  protected NodeRole_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeRole_propertySet.Matcher.on(engine);
  }
  
  @Override
  public NodeRole_propertySet.Matcher instantiate() {
    return NodeRole_propertySet.Matcher.create();
  }
  
  @Override
  public NodeRole_propertySet.Match newEmptyMatch() {
    return NodeRole_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public NodeRole_propertySet.Match newMatch(final Object... parameters) {
    return NodeRole_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeRole_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeRole_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeRole_propertySet INSTANCE = new NodeRole_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeRole_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
