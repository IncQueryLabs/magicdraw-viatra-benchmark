...
public final class PersonType_physicalLocation extends BaseGeneratedEMFQuerySpecification<PersonType_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_physicalLocation.Match)) {
          PersonType_physicalLocation.Match other = (PersonType_physicalLocation.Match) obj;
    ...
    @Override
    public PersonType_physicalLocation specification() {
      return PersonType_physicalLocation.instance();
    }
     ...
     * 
     */
    public static PersonType_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_physicalLocation.Match {
    ...
    private static final class Immutable extends PersonType_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see PersonType_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static PersonType_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_physicalLocation.Match> processor) {
     ...
     * 
     */
    public PersonType_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected PersonType_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_physicalLocation.Matcher> querySpecification() {
      return PersonType_physicalLocation.instance();
    }
  }
  
  private PersonType_physicalLocation() {
   ...
   * 
   */
  public static PersonType_physicalLocation instance() {
    try{
  ...
  @Override
  protected PersonType_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public PersonType_physicalLocation.Matcher instantiate() {
    return PersonType_physicalLocation.Matcher.create();
  }
  
  @Override
  public PersonType_physicalLocation.Match newEmptyMatch() {
    return PersonType_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_physicalLocation.Match newMatch(final Object... parameters) {
    return PersonType_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_physicalLocation INSTANCE = new PersonType_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
