...
public final class OwnsRisk_targetContext extends BaseGeneratedEMFQuerySpecification<OwnsRisk_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRisk_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRisk_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRisk_targetContext.Match)) {
          OwnsRisk_targetContext.Match other = (OwnsRisk_targetContext.Match) obj;
    ...
    @Override
    public OwnsRisk_targetContext specification() {
      return OwnsRisk_targetContext.instance();
    }
     ...
     * 
     */
    public static OwnsRisk_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRisk_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static OwnsRisk_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsRisk_targetContext.Match {
    ...
    private static final class Immutable extends OwnsRisk_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRisk_targetContext pattern,
   ...
   * 
   * @see Match
   * @see OwnsRisk_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRisk_targetContext.Match> {
    /**
     ...
     * 
     */
    public static OwnsRisk_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRisk_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRisk_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRisk_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<OwnsRisk_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<OwnsRisk_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super OwnsRisk_targetContext.Match> processor) {
     ...
     * 
     */
    public OwnsRisk_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return OwnsRisk_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRisk_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRisk_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final OwnsRisk_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final OwnsRisk_targetContext.Match partialMatch) {
    ...
    @Override
    protected OwnsRisk_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRisk_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsRisk_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRisk_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRisk_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRisk_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRisk_targetContext.Matcher> querySpecification() {
      return OwnsRisk_targetContext.instance();
    }
  }
  
  private OwnsRisk_targetContext() {
   ...
   * 
   */
  public static OwnsRisk_targetContext instance() {
    try{
  ...
  @Override
  protected OwnsRisk_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRisk_targetContext.Matcher.on(engine);
  }
  
  @Override
  public OwnsRisk_targetContext.Matcher instantiate() {
    return OwnsRisk_targetContext.Matcher.create();
  }
  
  @Override
  public OwnsRisk_targetContext.Match newEmptyMatch() {
    return OwnsRisk_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRisk_targetContext.Match newMatch(final Object... parameters) {
    return OwnsRisk_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRisk_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRisk_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRisk_targetContext INSTANCE = new OwnsRisk_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRisk_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
