...
public final class ActualProjectRole extends BaseGeneratedEMFQuerySpecification<ActualProjectRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectRole.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectRole.Match)) {
          ActualProjectRole.Match other = (ActualProjectRole.Match) obj;
    ...
    @Override
    public ActualProjectRole specification() {
      return ActualProjectRole.instance();
    }
     ...
     * 
     */
    public static ActualProjectRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectRole.Match newMutableMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualProjectRole.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualProjectRole.Match {
    ...
    private static final class Immutable extends ActualProjectRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectRole pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectRole
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectRole.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectRole.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectRole.Match> getAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualProjectRole.Match> streamAllMatches(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualProjectRole.Match> getOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualProjectRole.Match> processor) {
     ...
     * 
     */
    public ActualProjectRole.Match newMatch(final Slot pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualProjectRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualProjectRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualProjectRole.Match partialMatch) {
    ...
    @Override
    protected ActualProjectRole.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectRole.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualProjectRole.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectRole.Match.newMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectRole.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectRole.Matcher> querySpecification() {
      return ActualProjectRole.instance();
    }
  }
  
  private ActualProjectRole() {
   ...
   * 
   */
  public static ActualProjectRole instance() {
    try{
  ...
  @Override
  protected ActualProjectRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectRole.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectRole.Matcher instantiate() {
    return ActualProjectRole.Matcher.create();
  }
  
  @Override
  public ActualProjectRole.Match newEmptyMatch() {
    return ActualProjectRole.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectRole.Match newMatch(final Object... parameters) {
    return ActualProjectRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectRole INSTANCE = new ActualProjectRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualProjectRole")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualProjectRole");
