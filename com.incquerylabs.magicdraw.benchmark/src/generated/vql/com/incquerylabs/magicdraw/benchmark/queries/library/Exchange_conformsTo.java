...
public final class Exchange_conformsTo extends BaseGeneratedEMFQuerySpecification<Exchange_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Exchange_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Exchange_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Exchange_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Exchange_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Exchange_conformsTo.Match)) {
          Exchange_conformsTo.Match other = (Exchange_conformsTo.Match) obj;
    ...
    @Override
    public Exchange_conformsTo specification() {
      return Exchange_conformsTo.instance();
    }
     ...
     * 
     */
    public static Exchange_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Exchange_conformsTo.Match newMutableMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public static Exchange_conformsTo.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Exchange_conformsTo.Match {
    ...
    private static final class Immutable extends Exchange_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Exchange_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Exchange_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Exchange_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Exchange_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Exchange_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Exchange_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Exchange_conformsTo.Match> getAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Exchange_conformsTo.Match> streamAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Exchange_conformsTo.Match> getOneArbitraryMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final Element pValue, final Consumer<? super Exchange_conformsTo.Match> processor) {
     ...
     * 
     */
    public Exchange_conformsTo.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return Exchange_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Exchange_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Exchange_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Exchange_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Exchange_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Exchange_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Exchange_conformsTo.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Exchange_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Exchange_conformsTo.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Exchange_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Exchange_conformsTo.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Exchange_conformsTo.Matcher> querySpecification() {
      return Exchange_conformsTo.instance();
    }
  }
  
  private Exchange_conformsTo() {
   ...
   * 
   */
  public static Exchange_conformsTo instance() {
    try{
  ...
  @Override
  protected Exchange_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Exchange_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Exchange_conformsTo.Matcher instantiate() {
    return Exchange_conformsTo.Matcher.create();
  }
  
  @Override
  public Exchange_conformsTo.Match newEmptyMatch() {
    return Exchange_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Exchange_conformsTo.Match newMatch(final Object... parameters) {
    return Exchange_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Exchange_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Exchange_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Exchange_conformsTo INSTANCE = new Exchange_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Exchange_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
