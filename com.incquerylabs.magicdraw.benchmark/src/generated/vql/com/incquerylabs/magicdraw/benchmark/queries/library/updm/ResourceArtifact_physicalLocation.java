...
public final class ResourceArtifact_physicalLocation extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_physicalLocation.Match)) {
          ResourceArtifact_physicalLocation.Match other = (ResourceArtifact_physicalLocation.Match) obj;
    ...
    @Override
    public ResourceArtifact_physicalLocation specification() {
      return ResourceArtifact_physicalLocation.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_physicalLocation.Match {
    ...
    private static final class Immutable extends ResourceArtifact_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_physicalLocation.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_physicalLocation.Matcher> querySpecification() {
      return ResourceArtifact_physicalLocation.instance();
    }
  }
  
  private ResourceArtifact_physicalLocation() {
   ...
   * 
   */
  public static ResourceArtifact_physicalLocation instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_physicalLocation.Matcher instantiate() {
    return ResourceArtifact_physicalLocation.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_physicalLocation.Match newEmptyMatch() {
    return ResourceArtifact_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_physicalLocation.Match newMatch(final Object... parameters) {
    return ResourceArtifact_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_physicalLocation INSTANCE = new ResourceArtifact_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
