...
public final class StructuralPart_URI extends BaseGeneratedEMFQuerySpecification<StructuralPart_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return StructuralPart_URI.Match.parameterNames;
    }
    ...
    @Override
    public StructuralPart_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StructuralPart_URI.Match)) {
          StructuralPart_URI.Match other = (StructuralPart_URI.Match) obj;
    ...
    @Override
    public StructuralPart_URI specification() {
      return StructuralPart_URI.instance();
    }
     ...
     * 
     */
    public static StructuralPart_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static StructuralPart_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static StructuralPart_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends StructuralPart_URI.Match {
    ...
    private static final class Immutable extends StructuralPart_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.StructuralPart_URI pattern,
   ...
   * 
   * @see Match
   * @see StructuralPart_URI
   * 
   */
  public static class Matcher extends BaseMatcher<StructuralPart_URI.Match> {
    /**
     ...
     * 
     */
    public static StructuralPart_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StructuralPart_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StructuralPart_URI.Matcher.class);
     ...
     * 
     */
    public Collection<StructuralPart_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<StructuralPart_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<StructuralPart_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super StructuralPart_URI.Match> processor) {
     ...
     * 
     */
    public StructuralPart_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return StructuralPart_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final StructuralPart_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final StructuralPart_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final StructuralPart_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final StructuralPart_URI.Match partialMatch) {
    ...
    @Override
    protected StructuralPart_URI.Match tupleToMatch(final Tuple t) {
      try {
          return StructuralPart_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected StructuralPart_URI.Match arrayToMatch(final Object[] match) {
      try {
          return StructuralPart_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StructuralPart_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StructuralPart_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StructuralPart_URI.Matcher> querySpecification() {
      return StructuralPart_URI.instance();
    }
  }
  
  private StructuralPart_URI() {
   ...
   * 
   */
  public static StructuralPart_URI instance() {
    try{
  ...
  @Override
  protected StructuralPart_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return StructuralPart_URI.Matcher.on(engine);
  }
  
  @Override
  public StructuralPart_URI.Matcher instantiate() {
    return StructuralPart_URI.Matcher.create();
  }
  
  @Override
  public StructuralPart_URI.Match newEmptyMatch() {
    return StructuralPart_URI.Match.newEmptyMatch();
  }
  
  @Override
  public StructuralPart_URI.Match newMatch(final Object... parameters) {
    return StructuralPart_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StructuralPart_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StructuralPart_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StructuralPart_URI INSTANCE = new StructuralPart_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StructuralPart_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
