...
public final class Participant_URI extends BaseGeneratedEMFQuerySpecification<Participant_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_URI.Match.parameterNames;
    }
    ...
    @Override
    public Participant_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_URI.Match)) {
          Participant_URI.Match other = (Participant_URI.Match) obj;
    ...
    @Override
    public Participant_URI specification() {
      return Participant_URI.instance();
    }
     ...
     * 
     */
    public static Participant_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Participant_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Participant_URI.Match {
    ...
    private static final class Immutable extends Participant_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_URI.Match> {
    /**
     ...
     * 
     */
    public static Participant_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Participant_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Participant_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Participant_URI.Match> processor) {
     ...
     * 
     */
    public Participant_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Participant_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Participant_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Participant_URI.Match partialMatch) {
    ...
    @Override
    protected Participant_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Participant_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_URI.Matcher> querySpecification() {
      return Participant_URI.instance();
    }
  }
  
  private Participant_URI() {
   ...
   * 
   */
  public static Participant_URI instance() {
    try{
  ...
  @Override
  protected Participant_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_URI.Matcher.on(engine);
  }
  
  @Override
  public Participant_URI.Matcher instantiate() {
    return Participant_URI.Matcher.create();
  }
  
  @Override
  public Participant_URI.Match newEmptyMatch() {
    return Participant_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_URI.Match newMatch(final Object... parameters) {
    return Participant_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_URI INSTANCE = new Participant_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
