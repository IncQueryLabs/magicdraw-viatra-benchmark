...
public final class ActualService extends BaseGeneratedEMFQuerySpecification<ActualService.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualService pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualService";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualService.Match.parameterNames;
    }
    ...
    @Override
    public ActualService.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualService.Match)) {
          ActualService.Match other = (ActualService.Match) obj;
    ...
    @Override
    public ActualService specification() {
      return ActualService.instance();
    }
     ...
     * 
     */
    public static ActualService.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualService.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ActualService.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ActualService.Match {
    ...
    private static final class Immutable extends ActualService.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualService pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ActualService.Match> {
    /**
     ...
     * 
     */
    public static ActualService.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualService.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualService.Matcher.class);
     ...
     * 
     */
    public Collection<ActualService.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ActualService.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ActualService.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ActualService.Match> processor) {
     ...
     * 
     */
    public ActualService.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ActualService.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualService.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualService.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ActualService.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ActualService.Match partialMatch) {
    ...
    @Override
    protected ActualService.Match tupleToMatch(final Tuple t) {
      try {
          return ActualService.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ActualService.Match arrayToMatch(final Object[] match) {
      try {
          return ActualService.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualService.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualService.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualService.Matcher> querySpecification() {
      return ActualService.instance();
    }
  }
   ...
   * 
   */
  public static ActualService instance() {
    try{
  ...
  @Override
  protected ActualService.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualService.Matcher.on(engine);
  }
  
  @Override
  public ActualService.Matcher instantiate() {
    return ActualService.Matcher.create();
  }
  
  @Override
  public ActualService.Match newEmptyMatch() {
    return ActualService.Match.newEmptyMatch();
  }
  
  @Override
  public ActualService.Match newMatch(final Object... parameters) {
    return ActualService.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualService} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualService#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualService INSTANCE = new ActualService();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualService.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ActualService")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ActualService");
