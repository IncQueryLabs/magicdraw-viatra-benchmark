...
public final class FillsPost_targetContext extends BaseGeneratedEMFQuerySpecification<FillsPost_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return FillsPost_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public FillsPost_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FillsPost_targetContext.Match)) {
          FillsPost_targetContext.Match other = (FillsPost_targetContext.Match) obj;
    ...
    @Override
    public FillsPost_targetContext specification() {
      return FillsPost_targetContext.instance();
    }
     ...
     * 
     */
    public static FillsPost_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static FillsPost_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static FillsPost_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FillsPost_targetContext.Match {
    ...
    private static final class Immutable extends FillsPost_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FillsPost_targetContext pattern,
   ...
   * 
   * @see Match
   * @see FillsPost_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<FillsPost_targetContext.Match> {
    /**
     ...
     * 
     */
    public static FillsPost_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FillsPost_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FillsPost_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<FillsPost_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<FillsPost_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<FillsPost_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super FillsPost_targetContext.Match> processor) {
     ...
     * 
     */
    public FillsPost_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return FillsPost_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final FillsPost_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final FillsPost_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final FillsPost_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final FillsPost_targetContext.Match partialMatch) {
    ...
    @Override
    protected FillsPost_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return FillsPost_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected FillsPost_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return FillsPost_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FillsPost_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FillsPost_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FillsPost_targetContext.Matcher> querySpecification() {
      return FillsPost_targetContext.instance();
    }
  }
  
  private FillsPost_targetContext() {
   ...
   * 
   */
  public static FillsPost_targetContext instance() {
    try{
  ...
  @Override
  protected FillsPost_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return FillsPost_targetContext.Matcher.on(engine);
  }
  
  @Override
  public FillsPost_targetContext.Matcher instantiate() {
    return FillsPost_targetContext.Matcher.create();
  }
  
  @Override
  public FillsPost_targetContext.Match newEmptyMatch() {
    return FillsPost_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public FillsPost_targetContext.Match newMatch(final Object... parameters) {
    return FillsPost_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FillsPost_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FillsPost_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FillsPost_targetContext INSTANCE = new FillsPost_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FillsPost_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
