...
public final class DesignConstraint_TracedTo extends BaseGeneratedEMFQuerySpecification<DesignConstraint_TracedTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_TracedTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_TracedTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return DesignConstraint_TracedTo.Match.parameterNames;
    }
    ...
    @Override
    public DesignConstraint_TracedTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DesignConstraint_TracedTo.Match)) {
          DesignConstraint_TracedTo.Match other = (DesignConstraint_TracedTo.Match) obj;
    ...
    @Override
    public DesignConstraint_TracedTo specification() {
     ...
     * 
     */
    public static DesignConstraint_TracedTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static DesignConstraint_TracedTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static DesignConstraint_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends DesignConstraint_TracedTo.Match {
    ...
    private static final class Immutable extends DesignConstraint_TracedTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.designConstraint_TracedTo pattern,
   ...
   * 
   * @see Match
   * @see DesignConstraint_TracedTo
   * 
   */
  public static class Matcher extends BaseMatcher<DesignConstraint_TracedTo.Match> {
    /**
     ...
     * 
     */
    public static DesignConstraint_TracedTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DesignConstraint_TracedTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DesignConstraint_TracedTo.Matcher.class);
     ...
     * 
     */
    public Collection<DesignConstraint_TracedTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<DesignConstraint_TracedTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<DesignConstraint_TracedTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super DesignConstraint_TracedTo.Match> processor) {
     ...
     * 
     */
    public DesignConstraint_TracedTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return DesignConstraint_TracedTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DesignConstraint_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DesignConstraint_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final DesignConstraint_TracedTo.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final DesignConstraint_TracedTo.Match partialMatch) {
    ...
    @Override
    protected DesignConstraint_TracedTo.Match tupleToMatch(final Tuple t) {
      try {
          return DesignConstraint_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected DesignConstraint_TracedTo.Match arrayToMatch(final Object[] match) {
      try {
          return DesignConstraint_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DesignConstraint_TracedTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DesignConstraint_TracedTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DesignConstraint_TracedTo.Matcher> querySpecification() {
      return DesignConstraint_TracedTo.instance();
    }
  }
  
  private DesignConstraint_TracedTo() {
   ...
   * 
   */
  public static DesignConstraint_TracedTo instance() {
    try{
  ...
  @Override
  protected DesignConstraint_TracedTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return DesignConstraint_TracedTo.Matcher.on(engine);
  }
  
  @Override
  public DesignConstraint_TracedTo.Matcher instantiate() {
    return DesignConstraint_TracedTo.Matcher.create();
  }
  
  @Override
  public DesignConstraint_TracedTo.Match newEmptyMatch() {
    return DesignConstraint_TracedTo.Match.newEmptyMatch();
  }
  
  @Override
  public DesignConstraint_TracedTo.Match newMatch(final Object... parameters) {
    return DesignConstraint_TracedTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DesignConstraint_TracedTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DesignConstraint_TracedTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DesignConstraint_TracedTo INSTANCE = new DesignConstraint_TracedTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DesignConstraint_TracedTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
