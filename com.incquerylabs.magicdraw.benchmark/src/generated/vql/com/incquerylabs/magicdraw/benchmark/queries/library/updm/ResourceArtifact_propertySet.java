...
public final class ResourceArtifact_propertySet extends BaseGeneratedEMFQuerySpecification<ResourceArtifact_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArtifact_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArtifact_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArtifact_propertySet.Match)) {
          ResourceArtifact_propertySet.Match other = (ResourceArtifact_propertySet.Match) obj;
    ...
    @Override
    public ResourceArtifact_propertySet specification() {
      return ResourceArtifact_propertySet.instance();
    }
     ...
     * 
     */
    public static ResourceArtifact_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArtifact_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArtifact_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArtifact_propertySet.Match {
    ...
    private static final class Immutable extends ResourceArtifact_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceArtifact_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ResourceArtifact_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArtifact_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ResourceArtifact_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArtifact_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArtifact_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArtifact_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArtifact_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArtifact_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArtifact_propertySet.Match> processor) {
     ...
     * 
     */
    public ResourceArtifact_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArtifact_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArtifact_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArtifact_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArtifact_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArtifact_propertySet.Match partialMatch) {
    ...
    @Override
    protected ResourceArtifact_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArtifact_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArtifact_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArtifact_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArtifact_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArtifact_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArtifact_propertySet.Matcher> querySpecification() {
      return ResourceArtifact_propertySet.instance();
    }
  }
  
  private ResourceArtifact_propertySet() {
   ...
   * 
   */
  public static ResourceArtifact_propertySet instance() {
    try{
  ...
  @Override
  protected ResourceArtifact_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArtifact_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ResourceArtifact_propertySet.Matcher instantiate() {
    return ResourceArtifact_propertySet.Matcher.create();
  }
  
  @Override
  public ResourceArtifact_propertySet.Match newEmptyMatch() {
    return ResourceArtifact_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArtifact_propertySet.Match newMatch(final Object... parameters) {
    return ResourceArtifact_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArtifact_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArtifact_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArtifact_propertySet INSTANCE = new ResourceArtifact_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArtifact_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
