...
public final class WholeLifeEnterprise_goals extends BaseGeneratedEMFQuerySpecification<WholeLifeEnterprise_goals.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_goals pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_goals";
    }
    
    @Override
    public List<String> parameterNames() {
      return WholeLifeEnterprise_goals.Match.parameterNames;
    }
    ...
    @Override
    public WholeLifeEnterprise_goals.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof WholeLifeEnterprise_goals.Match)) {
          WholeLifeEnterprise_goals.Match other = (WholeLifeEnterprise_goals.Match) obj;
    ...
    @Override
    public WholeLifeEnterprise_goals specification() {
      return WholeLifeEnterprise_goals.instance();
    }
     ...
     * 
     */
    public static WholeLifeEnterprise_goals.Match newEmptyMatch() {
     ...
     * 
     */
    public static WholeLifeEnterprise_goals.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static WholeLifeEnterprise_goals.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends WholeLifeEnterprise_goals.Match {
    ...
    private static final class Immutable extends WholeLifeEnterprise_goals.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.WholeLifeEnterprise_goals pattern,
   ...
   * 
   * @see Match
   * @see WholeLifeEnterprise_goals
   * 
   */
  public static class Matcher extends BaseMatcher<WholeLifeEnterprise_goals.Match> {
    /**
     ...
     * 
     */
    public static WholeLifeEnterprise_goals.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static WholeLifeEnterprise_goals.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WholeLifeEnterprise_goals.Matcher.class);
     ...
     * 
     */
    public Collection<WholeLifeEnterprise_goals.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<WholeLifeEnterprise_goals.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<WholeLifeEnterprise_goals.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super WholeLifeEnterprise_goals.Match> processor) {
     ...
     * 
     */
    public WholeLifeEnterprise_goals.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return WholeLifeEnterprise_goals.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final WholeLifeEnterprise_goals.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final WholeLifeEnterprise_goals.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final WholeLifeEnterprise_goals.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final WholeLifeEnterprise_goals.Match partialMatch) {
    ...
    @Override
    protected WholeLifeEnterprise_goals.Match tupleToMatch(final Tuple t) {
      try {
          return WholeLifeEnterprise_goals.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected WholeLifeEnterprise_goals.Match arrayToMatch(final Object[] match) {
      try {
          return WholeLifeEnterprise_goals.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected WholeLifeEnterprise_goals.Match arrayToMatchMutable(final Object[] match) {
      try {
          return WholeLifeEnterprise_goals.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<WholeLifeEnterprise_goals.Matcher> querySpecification() {
      return WholeLifeEnterprise_goals.instance();
    }
  }
  
  private WholeLifeEnterprise_goals() {
   ...
   * 
   */
  public static WholeLifeEnterprise_goals instance() {
    try{
  ...
  @Override
  protected WholeLifeEnterprise_goals.Matcher instantiate(final ViatraQueryEngine engine) {
    return WholeLifeEnterprise_goals.Matcher.on(engine);
  }
  
  @Override
  public WholeLifeEnterprise_goals.Matcher instantiate() {
    return WholeLifeEnterprise_goals.Matcher.create();
  }
  
  @Override
  public WholeLifeEnterprise_goals.Match newEmptyMatch() {
    return WholeLifeEnterprise_goals.Match.newEmptyMatch();
  }
  
  @Override
  public WholeLifeEnterprise_goals.Match newMatch(final Object... parameters) {
    return WholeLifeEnterprise_goals.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WholeLifeEnterprise_goals} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link WholeLifeEnterprise_goals#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final WholeLifeEnterprise_goals INSTANCE = new WholeLifeEnterprise_goals();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final WholeLifeEnterprise_goals.GeneratedPQuery INSTANCE = new GeneratedPQuery();
