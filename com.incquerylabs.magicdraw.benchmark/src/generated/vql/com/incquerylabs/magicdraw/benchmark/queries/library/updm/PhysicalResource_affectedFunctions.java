...
public final class PhysicalResource_affectedFunctions extends BaseGeneratedEMFQuerySpecification<PhysicalResource_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_affectedFunctions.Match)) {
          PhysicalResource_affectedFunctions.Match other = (PhysicalResource_affectedFunctions.Match) obj;
    ...
    @Override
    public PhysicalResource_affectedFunctions specification() {
      return PhysicalResource_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_affectedFunctions.Match {
    ...
    private static final class Immutable extends PhysicalResource_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_affectedFunctions.Matcher> querySpecification() {
      return PhysicalResource_affectedFunctions.instance();
    }
  }
  
  private PhysicalResource_affectedFunctions() {
   ...
   * 
   */
  public static PhysicalResource_affectedFunctions instance() {
    try{
  ...
  @Override
  protected PhysicalResource_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_affectedFunctions.Matcher instantiate() {
    return PhysicalResource_affectedFunctions.Matcher.create();
  }
  
  @Override
  public PhysicalResource_affectedFunctions.Match newEmptyMatch() {
    return PhysicalResource_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_affectedFunctions.Match newMatch(final Object... parameters) {
    return PhysicalResource_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_affectedFunctions INSTANCE = new PhysicalResource_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
