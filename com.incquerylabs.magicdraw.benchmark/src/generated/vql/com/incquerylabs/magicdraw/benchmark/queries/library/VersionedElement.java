...
public final class VersionedElement extends BaseGeneratedEMFQuerySpecification<VersionedElement.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.VersionedElement pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.VersionedElement";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionedElement.Match.parameterNames;
    }
    ...
    @Override
    public VersionedElement.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionedElement.Match)) {
          VersionedElement.Match other = (VersionedElement.Match) obj;
    ...
    @Override
    public VersionedElement specification() {
      return VersionedElement.instance();
    }
     ...
     * 
     */
    public static VersionedElement.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionedElement.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static VersionedElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends VersionedElement.Match {
    ...
    private static final class Immutable extends VersionedElement.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.VersionedElement pattern,
   ...
   * 
   * @see Match
   * @see VersionedElement
   * 
   */
  public static class Matcher extends BaseMatcher<VersionedElement.Match> {
    /**
     ...
     * 
     */
    public static VersionedElement.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionedElement.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionedElement.Matcher.class);
     ...
     * 
     */
    public Collection<VersionedElement.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<VersionedElement.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<VersionedElement.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super VersionedElement.Match> processor) {
     ...
     * 
     */
    public VersionedElement.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return VersionedElement.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final VersionedElement.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final VersionedElement.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final VersionedElement.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final VersionedElement.Match partialMatch) {
    ...
    @Override
    protected VersionedElement.Match tupleToMatch(final Tuple t) {
      try {
          return VersionedElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected VersionedElement.Match arrayToMatch(final Object[] match) {
      try {
          return VersionedElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionedElement.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionedElement.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionedElement.Matcher> querySpecification() {
      return VersionedElement.instance();
    }
  }
  
  private VersionedElement() {
   ...
   * 
   */
  public static VersionedElement instance() {
    try{
  ...
  @Override
  protected VersionedElement.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionedElement.Matcher.on(engine);
  }
  
  @Override
  public VersionedElement.Matcher instantiate() {
    return VersionedElement.Matcher.create();
  }
  
  @Override
  public VersionedElement.Match newEmptyMatch() {
    return VersionedElement.Match.newEmptyMatch();
  }
  
  @Override
  public VersionedElement.Match newMatch(final Object... parameters) {
    return VersionedElement.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionedElement} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionedElement#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionedElement INSTANCE = new VersionedElement();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionedElement.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "VersionedElement")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "VersionedElement");
