...
public final class Trace extends BaseGeneratedEMFQuerySpecification<Trace.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Trace pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Trace";
    }
     ...
     * 
     */
    public static Trace.Match newMutableMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Trace.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Trace pattern,
  ...
  public static class Matcher extends BaseMatcher<Trace.Match> {
     ...
     * 
     */
    public Collection<Trace.Match> getAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Trace.Match> streamAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Trace.Match> getOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype, final Consumer<? super Trace.Match> processor) {
     ...
     * 
     */
    public Trace.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return Trace.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Trace.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Trace.Match partialMatch) {
    ...
    protected Trace.Match tupleToMatch(final Tuple t) {
      try {
          return Trace.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected Trace.Match arrayToMatch(final Object[] match) {
      try {
          return Trace.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected Trace.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Trace.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Trace.Match newMatch(final Object... parameters) {
    return Trace.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
