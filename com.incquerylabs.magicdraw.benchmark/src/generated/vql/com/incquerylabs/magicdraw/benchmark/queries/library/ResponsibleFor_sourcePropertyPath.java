...
public final class ResponsibleFor_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<ResponsibleFor_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResponsibleFor_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public ResponsibleFor_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResponsibleFor_sourcePropertyPath.Match)) {
          ResponsibleFor_sourcePropertyPath.Match other = (ResponsibleFor_sourcePropertyPath.Match) obj;
    ...
    @Override
    public ResponsibleFor_sourcePropertyPath specification() {
      return ResponsibleFor_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static ResponsibleFor_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResponsibleFor_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static ResponsibleFor_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResponsibleFor_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends ResponsibleFor_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see ResponsibleFor_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<ResponsibleFor_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static ResponsibleFor_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResponsibleFor_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResponsibleFor_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<ResponsibleFor_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<ResponsibleFor_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<ResponsibleFor_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super ResponsibleFor_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public ResponsibleFor_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return ResponsibleFor_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final ResponsibleFor_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final ResponsibleFor_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final ResponsibleFor_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final ResponsibleFor_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected ResponsibleFor_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return ResponsibleFor_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResponsibleFor_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return ResponsibleFor_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResponsibleFor_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResponsibleFor_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResponsibleFor_sourcePropertyPath.Matcher> querySpecification() {
      return ResponsibleFor_sourcePropertyPath.instance();
    }
  }
  
  private ResponsibleFor_sourcePropertyPath() {
   ...
   * 
   */
  public static ResponsibleFor_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected ResponsibleFor_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResponsibleFor_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public ResponsibleFor_sourcePropertyPath.Matcher instantiate() {
    return ResponsibleFor_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public ResponsibleFor_sourcePropertyPath.Match newEmptyMatch() {
    return ResponsibleFor_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public ResponsibleFor_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return ResponsibleFor_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResponsibleFor_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResponsibleFor_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResponsibleFor_sourcePropertyPath INSTANCE = new ResponsibleFor_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResponsibleFor_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
