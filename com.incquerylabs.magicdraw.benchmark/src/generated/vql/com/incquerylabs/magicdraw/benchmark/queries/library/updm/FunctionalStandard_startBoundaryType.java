...
public final class FunctionalStandard_startBoundaryType extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_startBoundaryType.Match)) {
          FunctionalStandard_startBoundaryType.Match other = (FunctionalStandard_startBoundaryType.Match) obj;
    ...
    @Override
    public FunctionalStandard_startBoundaryType specification() {
      return FunctionalStandard_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static FunctionalStandard_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends FunctionalStandard_startBoundaryType.Match {
    ...
    private static final class Immutable extends FunctionalStandard_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<FunctionalStandard_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<FunctionalStandard_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super FunctionalStandard_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return FunctionalStandard_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final FunctionalStandard_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final FunctionalStandard_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected FunctionalStandard_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_startBoundaryType.Matcher> querySpecification() {
      return FunctionalStandard_startBoundaryType.instance();
    }
  }
  
  private FunctionalStandard_startBoundaryType() {
   ...
   * 
   */
  public static FunctionalStandard_startBoundaryType instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_startBoundaryType.Matcher instantiate() {
    return FunctionalStandard_startBoundaryType.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_startBoundaryType.Match newEmptyMatch() {
    return FunctionalStandard_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_startBoundaryType.Match newMatch(final Object... parameters) {
    return FunctionalStandard_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_startBoundaryType INSTANCE = new FunctionalStandard_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
