...
public final class CapabilityConfiguration_isEncapsulated extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_isEncapsulated.Match)) {
          CapabilityConfiguration_isEncapsulated.Match other = (CapabilityConfiguration_isEncapsulated.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_isEncapsulated specification() {
      return CapabilityConfiguration_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static CapabilityConfiguration_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends CapabilityConfiguration_isEncapsulated.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityConfiguration_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super CapabilityConfiguration_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return CapabilityConfiguration_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final CapabilityConfiguration_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final CapabilityConfiguration_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected CapabilityConfiguration_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_isEncapsulated.Matcher> querySpecification() {
      return CapabilityConfiguration_isEncapsulated.instance();
    }
  }
  
  private CapabilityConfiguration_isEncapsulated() {
   ...
   * 
   */
  public static CapabilityConfiguration_isEncapsulated instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_isEncapsulated.Matcher instantiate() {
    return CapabilityConfiguration_isEncapsulated.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_isEncapsulated.Match newEmptyMatch() {
    return CapabilityConfiguration_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_isEncapsulated.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_isEncapsulated INSTANCE = new CapabilityConfiguration_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
