...
public final class Viewpoint extends BaseGeneratedEMFQuerySpecification<Viewpoint.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Viewpoint pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Viewpoint";
    }
    
    @Override
    public List<String> parameterNames() {
      return Viewpoint.Match.parameterNames;
    }
    ...
    @Override
    public Viewpoint.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Viewpoint.Match)) {
          Viewpoint.Match other = (Viewpoint.Match) obj;
    ...
    @Override
    public Viewpoint specification() {
     ...
     * 
     */
    public static Viewpoint.Match newEmptyMatch() {
     ...
     * 
     */
    public static Viewpoint.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Viewpoint.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Viewpoint.Match {
    ...
    private static final class Immutable extends Viewpoint.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Viewpoint pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Viewpoint.Match> {
    /**
     ...
     * 
     */
    public static Viewpoint.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Viewpoint.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Viewpoint.Matcher.class);
     ...
     * 
     */
    public Collection<Viewpoint.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Viewpoint.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Viewpoint.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Viewpoint.Match> processor) {
     ...
     * 
     */
    public Viewpoint.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Viewpoint.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package> streamAllValuesOfelement(final Viewpoint.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package> getAllValuesOfelement(final Viewpoint.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Viewpoint.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Viewpoint.Match partialMatch) {
    ...
    @Override
    protected Viewpoint.Match tupleToMatch(final Tuple t) {
      try {
          return Viewpoint.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Viewpoint.Match arrayToMatch(final Object[] match) {
      try {
          return Viewpoint.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Viewpoint.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Viewpoint.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Viewpoint.Matcher> querySpecification() {
      return Viewpoint.instance();
    }
  }
  ...
  @Override
  protected Viewpoint.Matcher instantiate(final ViatraQueryEngine engine) {
    return Viewpoint.Matcher.on(engine);
  }
  
  @Override
  public Viewpoint.Matcher instantiate() {
    return Viewpoint.Matcher.create();
  }
  
  @Override
  public Viewpoint.Match newEmptyMatch() {
    return Viewpoint.Match.newEmptyMatch();
  }
  
  @Override
  public Viewpoint.Match newMatch(final Object... parameters) {
    return Viewpoint.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Package) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Viewpoint} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Viewpoint#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Viewpoint.GeneratedPQuery INSTANCE = new GeneratedPQuery();
