...
public final class Request_propertySet extends BaseGeneratedEMFQuerySpecification<Request_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Request_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Request_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Request_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Request_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Request_propertySet.Match)) {
          Request_propertySet.Match other = (Request_propertySet.Match) obj;
    ...
    @Override
    public Request_propertySet specification() {
      return Request_propertySet.instance();
    }
     ...
     * 
     */
    public static Request_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Request_propertySet.Match newMutableMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public static Request_propertySet.Match newMatch(final Port pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Request_propertySet.Match {
    ...
    private static final class Immutable extends Request_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Request_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Request_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Request_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Request_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Request_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Request_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Request_propertySet.Match> getAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Request_propertySet.Match> streamAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Request_propertySet.Match> getOneArbitraryMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final Element pValue, final Consumer<? super Request_propertySet.Match> processor) {
     ...
     * 
     */
    public Request_propertySet.Match newMatch(final Port pElement, final Element pValue) {
      return Request_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Request_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Request_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Request_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Request_propertySet.Match partialMatch) {
    ...
    @Override
    protected Request_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Request_propertySet.Match.newMatch((Port) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Request_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Request_propertySet.Match.newMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Request_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Request_propertySet.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Request_propertySet.Matcher> querySpecification() {
      return Request_propertySet.instance();
    }
  }
  
  private Request_propertySet() {
   ...
   * 
   */
  public static Request_propertySet instance() {
    try{
  ...
  @Override
  protected Request_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Request_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Request_propertySet.Matcher instantiate() {
    return Request_propertySet.Matcher.create();
  }
  
  @Override
  public Request_propertySet.Match newEmptyMatch() {
    return Request_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Request_propertySet.Match newMatch(final Object... parameters) {
    return Request_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Request_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Request_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Request_propertySet INSTANCE = new Request_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Request_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
