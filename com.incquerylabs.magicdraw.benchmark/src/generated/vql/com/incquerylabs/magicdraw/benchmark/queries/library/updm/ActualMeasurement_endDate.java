...
public final class ActualMeasurement_endDate extends BaseGeneratedEMFQuerySpecification<ActualMeasurement_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_endDate";
    }
     ...
     * 
     */
    public static ActualMeasurement_endDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualMeasurement_endDate.Match newMatch(final Slot pElement, final Element pValue) {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualMeasurement_endDate pattern,
  ...
  public static class Matcher extends BaseMatcher<ActualMeasurement_endDate.Match> {
     ...
     * 
     */
    public Collection<ActualMeasurement_endDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualMeasurement_endDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualMeasurement_endDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualMeasurement_endDate.Match> processor) {
     ...
     * 
     */
    public ActualMeasurement_endDate.Match newMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualMeasurement_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualMeasurement_endDate.Match partialMatch) {
    ...
    protected ActualMeasurement_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualMeasurement_endDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    protected ActualMeasurement_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualMeasurement_endDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected ActualMeasurement_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualMeasurement_endDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public ActualMeasurement_endDate.Match newMatch(final Object... parameters) {
    return ActualMeasurement_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
