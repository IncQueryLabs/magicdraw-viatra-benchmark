...
public final class SystemResource_endBoundaryType extends BaseGeneratedEMFQuerySpecification<SystemResource_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_endBoundaryType.Match)) {
          SystemResource_endBoundaryType.Match other = (SystemResource_endBoundaryType.Match) obj;
    ...
    @Override
    public SystemResource_endBoundaryType specification() {
      return SystemResource_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static SystemResource_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_endBoundaryType.Match {
    ...
    private static final class Immutable extends SystemResource_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public SystemResource_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected SystemResource_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_endBoundaryType.Matcher> querySpecification() {
      return SystemResource_endBoundaryType.instance();
    }
  }
  
  private SystemResource_endBoundaryType() {
   ...
   * 
   */
  public static SystemResource_endBoundaryType instance() {
    try{
  ...
  @Override
  protected SystemResource_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_endBoundaryType.Matcher instantiate() {
    return SystemResource_endBoundaryType.Matcher.create();
  }
  
  @Override
  public SystemResource_endBoundaryType.Match newEmptyMatch() {
    return SystemResource_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_endBoundaryType.Match newMatch(final Object... parameters) {
    return SystemResource_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_endBoundaryType INSTANCE = new SystemResource_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
