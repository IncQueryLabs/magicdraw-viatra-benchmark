...
public final class System_milestone extends BaseGeneratedEMFQuerySpecification<System_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_milestone.Match.parameterNames;
    }
    ...
    @Override
    public System_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_milestone.Match)) {
          System_milestone.Match other = (System_milestone.Match) obj;
    ...
    @Override
    public System_milestone specification() {
      return System_milestone.instance();
    }
     ...
     * 
     */
    public static System_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_milestone.Match {
    ...
    private static final class Immutable extends System_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_milestone pattern,
   ...
   * 
   * @see Match
   * @see System_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<System_milestone.Match> {
    /**
     ...
     * 
     */
    public static System_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<System_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_milestone.Match> processor) {
     ...
     * 
     */
    public System_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_milestone.Match partialMatch) {
    ...
    @Override
    protected System_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return System_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return System_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_milestone.Matcher> querySpecification() {
      return System_milestone.instance();
    }
  }
  
  private System_milestone() {
   ...
   * 
   */
  public static System_milestone instance() {
    try{
  ...
  @Override
  protected System_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_milestone.Matcher.on(engine);
  }
  
  @Override
  public System_milestone.Matcher instantiate() {
    return System_milestone.Matcher.create();
  }
  
  @Override
  public System_milestone.Match newEmptyMatch() {
    return System_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public System_milestone.Match newMatch(final Object... parameters) {
    return System_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_milestone INSTANCE = new System_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
