 ...
 *         pattern Mechanical(Element : Diagram, Stereotype : Stereotype) {
 *         	find stereotypedElement(Element, Stereotype, "additional_stereotypes", "Mechanical");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Mechanical extends BaseGeneratedEMFQuerySpecification<Mechanical.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Mechanical.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Mechanical.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<Mechanical.Match> {
     ...
     * 
     */
    public Collection<Mechanical.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Mechanical.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Mechanical.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super Mechanical.Match> processor) {
     ...
     * 
     */
    public Mechanical.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return Mechanical.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Mechanical.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Mechanical.Match partialMatch) {
    ...
    protected Mechanical.Match tupleToMatch(final Tuple t) {
      try {
          return Mechanical.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected Mechanical.Match arrayToMatch(final Object[] match) {
      try {
          return Mechanical.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected Mechanical.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Mechanical.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Mechanical.Match newMatch(final Object... parameters) {
    return Mechanical.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
