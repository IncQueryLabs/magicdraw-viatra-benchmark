...
public final class IsCapableToPerform_sourceContext extends BaseGeneratedEMFQuerySpecification<IsCapableToPerform_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return IsCapableToPerform_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public IsCapableToPerform_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof IsCapableToPerform_sourceContext.Match)) {
          IsCapableToPerform_sourceContext.Match other = (IsCapableToPerform_sourceContext.Match) obj;
    ...
    @Override
    public IsCapableToPerform_sourceContext specification() {
      return IsCapableToPerform_sourceContext.instance();
    }
     ...
     * 
     */
    public static IsCapableToPerform_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static IsCapableToPerform_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static IsCapableToPerform_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends IsCapableToPerform_sourceContext.Match {
    ...
    private static final class Immutable extends IsCapableToPerform_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see IsCapableToPerform_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<IsCapableToPerform_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static IsCapableToPerform_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static IsCapableToPerform_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(IsCapableToPerform_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<IsCapableToPerform_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<IsCapableToPerform_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<IsCapableToPerform_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super IsCapableToPerform_sourceContext.Match> processor) {
     ...
     * 
     */
    public IsCapableToPerform_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return IsCapableToPerform_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final IsCapableToPerform_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final IsCapableToPerform_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final IsCapableToPerform_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final IsCapableToPerform_sourceContext.Match partialMatch) {
    ...
    @Override
    protected IsCapableToPerform_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return IsCapableToPerform_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected IsCapableToPerform_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return IsCapableToPerform_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected IsCapableToPerform_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return IsCapableToPerform_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<IsCapableToPerform_sourceContext.Matcher> querySpecification() {
      return IsCapableToPerform_sourceContext.instance();
    }
  }
  
  private IsCapableToPerform_sourceContext() {
   ...
   * 
   */
  public static IsCapableToPerform_sourceContext instance() {
    try{
  ...
  @Override
  protected IsCapableToPerform_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return IsCapableToPerform_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public IsCapableToPerform_sourceContext.Matcher instantiate() {
    return IsCapableToPerform_sourceContext.Matcher.create();
  }
  
  @Override
  public IsCapableToPerform_sourceContext.Match newEmptyMatch() {
    return IsCapableToPerform_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public IsCapableToPerform_sourceContext.Match newMatch(final Object... parameters) {
    return IsCapableToPerform_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link IsCapableToPerform_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link IsCapableToPerform_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final IsCapableToPerform_sourceContext INSTANCE = new IsCapableToPerform_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final IsCapableToPerform_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
