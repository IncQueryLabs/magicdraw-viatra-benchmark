...
public final class TemporalPart extends BaseGeneratedEMFQuerySpecification<TemporalPart.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart";
    }
    
    @Override
    public List<String> parameterNames() {
      return TemporalPart.Match.parameterNames;
    }
    ...
    @Override
    public TemporalPart.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TemporalPart.Match)) {
          TemporalPart.Match other = (TemporalPart.Match) obj;
    ...
    @Override
    public TemporalPart specification() {
      return TemporalPart.instance();
    }
     ...
     * 
     */
    public static TemporalPart.Match newEmptyMatch() {
     ...
     * 
     */
    public static TemporalPart.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static TemporalPart.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends TemporalPart.Match {
    ...
    private static final class Immutable extends TemporalPart.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.TemporalPart pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<TemporalPart.Match> {
    /**
     ...
     * 
     */
    public static TemporalPart.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TemporalPart.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TemporalPart.Matcher.class);
     ...
     * 
     */
    public Collection<TemporalPart.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<TemporalPart.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<TemporalPart.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super TemporalPart.Match> processor) {
     ...
     * 
     */
    public TemporalPart.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return TemporalPart.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TemporalPart.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TemporalPart.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final TemporalPart.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final TemporalPart.Match partialMatch) {
    ...
    @Override
    protected TemporalPart.Match tupleToMatch(final Tuple t) {
      try {
          return TemporalPart.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected TemporalPart.Match arrayToMatch(final Object[] match) {
      try {
          return TemporalPart.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TemporalPart.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TemporalPart.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TemporalPart.Matcher> querySpecification() {
      return TemporalPart.instance();
    }
  }
   ...
   * 
   */
  public static TemporalPart instance() {
    try{
  ...
  @Override
  protected TemporalPart.Matcher instantiate(final ViatraQueryEngine engine) {
    return TemporalPart.Matcher.on(engine);
  }
  
  @Override
  public TemporalPart.Matcher instantiate() {
    return TemporalPart.Matcher.create();
  }
  
  @Override
  public TemporalPart.Match newEmptyMatch() {
    return TemporalPart.Match.newEmptyMatch();
  }
  
  @Override
  public TemporalPart.Match newMatch(final Object... parameters) {
    return TemporalPart.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TemporalPart} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TemporalPart#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TemporalPart INSTANCE = new TemporalPart();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TemporalPart.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "TemporalPart")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "TemporalPart");
