...
public final class Satisfy extends BaseGeneratedEMFQuerySpecification<Satisfy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Satisfy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Satisfy";
    }
    
    @Override
    public List<String> parameterNames() {
      return Satisfy.Match.parameterNames;
    }
    ...
    @Override
    public Satisfy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Satisfy.Match)) {
          Satisfy.Match other = (Satisfy.Match) obj;
     ...
     * 
     */
    public static Satisfy.Match newEmptyMatch() {
     ...
     * 
     */
    public static Satisfy.Match newMutableMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Satisfy.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return new Immutable(pElement, pStereotype);
    }
    
    private static final class Mutable extends Satisfy.Match {
    ...
    private static final class Immutable extends Satisfy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Satisfy pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Satisfy.Match> {
    /**
     ...
     * 
     */
    public static Satisfy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Satisfy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Satisfy.Matcher.class);
     ...
     * 
     */
    public Collection<Satisfy.Match> getAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Satisfy.Match> streamAllMatches(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Satisfy.Match> getOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Stereotype pStereotype, final Consumer<? super Satisfy.Match> processor) {
     ...
     * 
     */
    public Satisfy.Match newMatch(final Abstraction pElement, final Stereotype pStereotype) {
      return Satisfy.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfElement(final Satisfy.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfElement(final Satisfy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Satisfy.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Satisfy.Match partialMatch) {
    ...
    @Override
    protected Satisfy.Match tupleToMatch(final Tuple t) {
      try {
          return Satisfy.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    @Override
    protected Satisfy.Match arrayToMatch(final Object[] match) {
      try {
          return Satisfy.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Satisfy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Satisfy.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Satisfy.Matcher> querySpecification() {
      return Satisfy.instance();
    }
  }
   ...
   * 
   */
  public static Satisfy instance() {
    try{
  ...
  @Override
  protected Satisfy.Matcher instantiate(final ViatraQueryEngine engine) {
    return Satisfy.Matcher.on(engine);
  }
  
  @Override
  public Satisfy.Matcher instantiate() {
    return Satisfy.Matcher.create();
  }
  
  @Override
  public Satisfy.Match newEmptyMatch() {
    return Satisfy.Match.newEmptyMatch();
  }
  
  @Override
  public Satisfy.Match newMatch(final Object... parameters) {
    return Satisfy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Satisfy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Satisfy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Satisfy INSTANCE = new Satisfy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Satisfy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Satisfy");
