...
import com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart;
...
public final class StructuralPart_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<StructuralPart_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return StructuralPart_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public StructuralPart_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof StructuralPart_actualMeasurementSet.Match)) {
          StructuralPart_actualMeasurementSet.Match other = (StructuralPart_actualMeasurementSet.Match) obj;
    ...
    @Override
    public StructuralPart_actualMeasurementSet specification() {
      return StructuralPart_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static StructuralPart_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static StructuralPart_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static StructuralPart_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends StructuralPart_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends StructuralPart_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.StructuralPart_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see StructuralPart_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<StructuralPart_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static StructuralPart_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static StructuralPart_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(StructuralPart_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<StructuralPart_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<StructuralPart_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<StructuralPart_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super StructuralPart_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public StructuralPart_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return StructuralPart_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final StructuralPart_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final StructuralPart_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final StructuralPart_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final StructuralPart_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected StructuralPart_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return StructuralPart_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected StructuralPart_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return StructuralPart_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected StructuralPart_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return StructuralPart_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<StructuralPart_actualMeasurementSet.Matcher> querySpecification() {
      return StructuralPart_actualMeasurementSet.instance();
    }
  }
  
  private StructuralPart_actualMeasurementSet() {
   ...
   * 
   */
  public static StructuralPart_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected StructuralPart_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return StructuralPart_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public StructuralPart_actualMeasurementSet.Matcher instantiate() {
    return StructuralPart_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public StructuralPart_actualMeasurementSet.Match newEmptyMatch() {
    return StructuralPart_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public StructuralPart_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return StructuralPart_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link StructuralPart_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link StructuralPart_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final StructuralPart_actualMeasurementSet INSTANCE = new StructuralPart_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final StructuralPart_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find StructuralPart(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), StructuralPart.instance().getInternalQueryRepresentation());
