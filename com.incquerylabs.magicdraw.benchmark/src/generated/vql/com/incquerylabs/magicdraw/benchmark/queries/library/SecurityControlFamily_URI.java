...
public final class SecurityControlFamily_URI extends BaseGeneratedEMFQuerySpecification<SecurityControlFamily_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControlFamily_URI.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControlFamily_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControlFamily_URI.Match)) {
          SecurityControlFamily_URI.Match other = (SecurityControlFamily_URI.Match) obj;
    ...
    @Override
    public SecurityControlFamily_URI specification() {
      return SecurityControlFamily_URI.instance();
    }
     ...
     * 
     */
    public static SecurityControlFamily_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControlFamily_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SecurityControlFamily_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityControlFamily_URI.Match {
    ...
    private static final class Immutable extends SecurityControlFamily_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_URI pattern,
   ...
   * 
   * @see Match
   * @see SecurityControlFamily_URI
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControlFamily_URI.Match> {
    /**
     ...
     * 
     */
    public static SecurityControlFamily_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControlFamily_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControlFamily_URI.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControlFamily_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SecurityControlFamily_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SecurityControlFamily_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super SecurityControlFamily_URI.Match> processor) {
     ...
     * 
     */
    public SecurityControlFamily_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return SecurityControlFamily_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControlFamily_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControlFamily_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SecurityControlFamily_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SecurityControlFamily_URI.Match partialMatch) {
    ...
    @Override
    protected SecurityControlFamily_URI.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControlFamily_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityControlFamily_URI.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControlFamily_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControlFamily_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControlFamily_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControlFamily_URI.Matcher> querySpecification() {
      return SecurityControlFamily_URI.instance();
    }
  }
  
  private SecurityControlFamily_URI() {
   ...
   * 
   */
  public static SecurityControlFamily_URI instance() {
    try{
  ...
  @Override
  protected SecurityControlFamily_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControlFamily_URI.Matcher.on(engine);
  }
  
  @Override
  public SecurityControlFamily_URI.Matcher instantiate() {
    return SecurityControlFamily_URI.Matcher.create();
  }
  
  @Override
  public SecurityControlFamily_URI.Match newEmptyMatch() {
    return SecurityControlFamily_URI.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControlFamily_URI.Match newMatch(final Object... parameters) {
    return SecurityControlFamily_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControlFamily_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControlFamily_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControlFamily_URI INSTANCE = new SecurityControlFamily_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControlFamily_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
