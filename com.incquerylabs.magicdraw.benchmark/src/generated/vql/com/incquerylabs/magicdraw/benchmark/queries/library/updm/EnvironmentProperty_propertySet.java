...
public final class EnvironmentProperty_propertySet extends BaseGeneratedEMFQuerySpecification<EnvironmentProperty_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnvironmentProperty_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public EnvironmentProperty_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnvironmentProperty_propertySet.Match)) {
          EnvironmentProperty_propertySet.Match other = (EnvironmentProperty_propertySet.Match) obj;
    ...
    @Override
    public EnvironmentProperty_propertySet specification() {
      return EnvironmentProperty_propertySet.instance();
    }
     ...
     * 
     */
    public static EnvironmentProperty_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnvironmentProperty_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EnvironmentProperty_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnvironmentProperty_propertySet.Match {
    ...
    private static final class Immutable extends EnvironmentProperty_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnvironmentProperty_propertySet pattern,
   ...
   * 
   * @see Match
   * @see EnvironmentProperty_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EnvironmentProperty_propertySet.Match> {
    /**
     ...
     * 
     */
    public static EnvironmentProperty_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnvironmentProperty_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnvironmentProperty_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EnvironmentProperty_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnvironmentProperty_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnvironmentProperty_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EnvironmentProperty_propertySet.Match> processor) {
     ...
     * 
     */
    public EnvironmentProperty_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return EnvironmentProperty_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EnvironmentProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EnvironmentProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnvironmentProperty_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnvironmentProperty_propertySet.Match partialMatch) {
    ...
    @Override
    protected EnvironmentProperty_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EnvironmentProperty_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnvironmentProperty_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EnvironmentProperty_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnvironmentProperty_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnvironmentProperty_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnvironmentProperty_propertySet.Matcher> querySpecification() {
      return EnvironmentProperty_propertySet.instance();
    }
  }
  
  private EnvironmentProperty_propertySet() {
   ...
   * 
   */
  public static EnvironmentProperty_propertySet instance() {
    try{
  ...
  @Override
  protected EnvironmentProperty_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnvironmentProperty_propertySet.Matcher.on(engine);
  }
  
  @Override
  public EnvironmentProperty_propertySet.Matcher instantiate() {
    return EnvironmentProperty_propertySet.Matcher.create();
  }
  
  @Override
  public EnvironmentProperty_propertySet.Match newEmptyMatch() {
    return EnvironmentProperty_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EnvironmentProperty_propertySet.Match newMatch(final Object... parameters) {
    return EnvironmentProperty_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnvironmentProperty_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnvironmentProperty_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnvironmentProperty_propertySet INSTANCE = new EnvironmentProperty_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnvironmentProperty_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
