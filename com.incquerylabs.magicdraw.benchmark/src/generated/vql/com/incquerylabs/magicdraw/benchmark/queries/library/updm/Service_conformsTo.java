...
public final class Service_conformsTo extends BaseGeneratedEMFQuerySpecification<Service_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Service_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Service_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Service_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Service_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Service_conformsTo.Match)) {
          Service_conformsTo.Match other = (Service_conformsTo.Match) obj;
    ...
    @Override
    public Service_conformsTo specification() {
      return Service_conformsTo.instance();
    }
     ...
     * 
     */
    public static Service_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Service_conformsTo.Match newMutableMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public static Service_conformsTo.Match newMatch(final Port pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Service_conformsTo.Match {
    ...
    private static final class Immutable extends Service_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Service_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Service_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Service_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Service_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Service_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Service_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Service_conformsTo.Match> getAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Service_conformsTo.Match> streamAllMatches(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Service_conformsTo.Match> getOneArbitraryMatch(final Port pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final Element pValue, final Consumer<? super Service_conformsTo.Match> processor) {
     ...
     * 
     */
    public Service_conformsTo.Match newMatch(final Port pElement, final Element pValue) {
      return Service_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Service_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Service_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Service_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Service_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Service_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Service_conformsTo.Match.newMatch((Port) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Service_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Service_conformsTo.Match.newMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Service_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Service_conformsTo.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Service_conformsTo.Matcher> querySpecification() {
      return Service_conformsTo.instance();
    }
  }
  
  private Service_conformsTo() {
   ...
   * 
   */
  public static Service_conformsTo instance() {
    try{
  ...
  @Override
  protected Service_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Service_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Service_conformsTo.Matcher instantiate() {
    return Service_conformsTo.Matcher.create();
  }
  
  @Override
  public Service_conformsTo.Match newEmptyMatch() {
    return Service_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Service_conformsTo.Match newMatch(final Object... parameters) {
    return Service_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Service_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Service_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Service_conformsTo INSTANCE = new Service_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Service_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
