...
public final class TechnicalStandard_currentStatus extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_currentStatus.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_currentStatus pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_currentStatus";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_currentStatus.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_currentStatus.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_currentStatus.Match)) {
          TechnicalStandard_currentStatus.Match other = (TechnicalStandard_currentStatus.Match) obj;
    ...
    @Override
    public TechnicalStandard_currentStatus specification() {
      return TechnicalStandard_currentStatus.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_currentStatus.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_currentStatus.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static TechnicalStandard_currentStatus.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends TechnicalStandard_currentStatus.Match {
    ...
    private static final class Immutable extends TechnicalStandard_currentStatus.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_currentStatus pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_currentStatus
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_currentStatus.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_currentStatus.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_currentStatus.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_currentStatus.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_currentStatus.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<TechnicalStandard_currentStatus.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<TechnicalStandard_currentStatus.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super TechnicalStandard_currentStatus.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_currentStatus.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return TechnicalStandard_currentStatus.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final TechnicalStandard_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final TechnicalStandard_currentStatus.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_currentStatus.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected TechnicalStandard_currentStatus.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_currentStatus.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_currentStatus.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_currentStatus.Matcher> querySpecification() {
      return TechnicalStandard_currentStatus.instance();
    }
  }
  
  private TechnicalStandard_currentStatus() {
   ...
   * 
   */
  public static TechnicalStandard_currentStatus instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_currentStatus.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_currentStatus.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_currentStatus.Matcher instantiate() {
    return TechnicalStandard_currentStatus.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_currentStatus.Match newEmptyMatch() {
    return TechnicalStandard_currentStatus.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_currentStatus.Match newMatch(final Object... parameters) {
    return TechnicalStandard_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_currentStatus} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_currentStatus#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_currentStatus INSTANCE = new TechnicalStandard_currentStatus();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_currentStatus.GeneratedPQuery INSTANCE = new GeneratedPQuery();
