...
public final class ResourceArchitecture_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<ResourceArchitecture_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArchitecture_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArchitecture_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArchitecture_categoryCategorizesAsset.Match)) {
          ResourceArchitecture_categoryCategorizesAsset.Match other = (ResourceArchitecture_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public ResourceArchitecture_categoryCategorizesAsset specification() {
      return ResourceArchitecture_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static ResourceArchitecture_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArchitecture_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArchitecture_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArchitecture_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends ResourceArchitecture_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see ResourceArchitecture_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArchitecture_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static ResourceArchitecture_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArchitecture_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArchitecture_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArchitecture_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArchitecture_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArchitecture_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArchitecture_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public ResourceArchitecture_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArchitecture_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArchitecture_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArchitecture_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArchitecture_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArchitecture_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected ResourceArchitecture_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArchitecture_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArchitecture_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArchitecture_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArchitecture_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArchitecture_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArchitecture_categoryCategorizesAsset.Matcher> querySpecification() {
      return ResourceArchitecture_categoryCategorizesAsset.instance();
    }
  }
  
  private ResourceArchitecture_categoryCategorizesAsset() {
   ...
   * 
   */
  public static ResourceArchitecture_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected ResourceArchitecture_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArchitecture_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public ResourceArchitecture_categoryCategorizesAsset.Matcher instantiate() {
    return ResourceArchitecture_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public ResourceArchitecture_categoryCategorizesAsset.Match newEmptyMatch() {
    return ResourceArchitecture_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArchitecture_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return ResourceArchitecture_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArchitecture_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArchitecture_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArchitecture_categoryCategorizesAsset INSTANCE = new ResourceArchitecture_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArchitecture_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
