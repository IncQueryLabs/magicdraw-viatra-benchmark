...
public final class EnhancedSecurityControl extends BaseGeneratedEMFQuerySpecification<EnhancedSecurityControl.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnhancedSecurityControl.Match.parameterNames;
    }
    ...
    @Override
    public EnhancedSecurityControl.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnhancedSecurityControl.Match)) {
          EnhancedSecurityControl.Match other = (EnhancedSecurityControl.Match) obj;
    ...
    @Override
    public EnhancedSecurityControl specification() {
      return EnhancedSecurityControl.instance();
    }
     ...
     * 
     */
    public static EnhancedSecurityControl.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnhancedSecurityControl.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static EnhancedSecurityControl.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends EnhancedSecurityControl.Match {
    ...
    private static final class Immutable extends EnhancedSecurityControl.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl pattern,
   ...
   * 
   * @see Match
   * @see EnhancedSecurityControl
   * 
   */
  public static class Matcher extends BaseMatcher<EnhancedSecurityControl.Match> {
    /**
     ...
     * 
     */
    public static EnhancedSecurityControl.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnhancedSecurityControl.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnhancedSecurityControl.Matcher.class);
     ...
     * 
     */
    public Collection<EnhancedSecurityControl.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<EnhancedSecurityControl.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<EnhancedSecurityControl.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super EnhancedSecurityControl.Match> processor) {
     ...
     * 
     */
    public EnhancedSecurityControl.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return EnhancedSecurityControl.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnhancedSecurityControl.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnhancedSecurityControl.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final EnhancedSecurityControl.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final EnhancedSecurityControl.Match partialMatch) {
    ...
    @Override
    protected EnhancedSecurityControl.Match tupleToMatch(final Tuple t) {
      try {
          return EnhancedSecurityControl.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected EnhancedSecurityControl.Match arrayToMatch(final Object[] match) {
      try {
          return EnhancedSecurityControl.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnhancedSecurityControl.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnhancedSecurityControl.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnhancedSecurityControl.Matcher> querySpecification() {
      return EnhancedSecurityControl.instance();
    }
  }
  
  private EnhancedSecurityControl() {
   ...
   * 
   */
  public static EnhancedSecurityControl instance() {
    try{
  ...
  @Override
  protected EnhancedSecurityControl.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnhancedSecurityControl.Matcher.on(engine);
  }
  
  @Override
  public EnhancedSecurityControl.Matcher instantiate() {
    return EnhancedSecurityControl.Matcher.create();
  }
  
  @Override
  public EnhancedSecurityControl.Match newEmptyMatch() {
    return EnhancedSecurityControl.Match.newEmptyMatch();
  }
  
  @Override
  public EnhancedSecurityControl.Match newMatch(final Object... parameters) {
    return EnhancedSecurityControl.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnhancedSecurityControl} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnhancedSecurityControl#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnhancedSecurityControl INSTANCE = new EnhancedSecurityControl();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnhancedSecurityControl.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "EnhancedSecurityControl")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "EnhancedSecurityControl");
