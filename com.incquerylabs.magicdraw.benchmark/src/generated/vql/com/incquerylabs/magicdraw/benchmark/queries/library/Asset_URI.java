...
public final class Asset_URI extends BaseGeneratedEMFQuerySpecification<Asset_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Asset_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Asset_URI.Match.parameterNames;
    }
    ...
    @Override
    public Asset_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Asset_URI.Match)) {
          Asset_URI.Match other = (Asset_URI.Match) obj;
    ...
    @Override
    public Asset_URI specification() {
      return Asset_URI.instance();
    }
     ...
     * 
     */
    public static Asset_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Asset_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Asset_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Asset_URI.Match {
    ...
    private static final class Immutable extends Asset_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Asset_URI.Match> {
    /**
     ...
     * 
     */
    public static Asset_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Asset_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Asset_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Asset_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Asset_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Asset_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Asset_URI.Match> processor) {
     ...
     * 
     */
    public Asset_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Asset_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Asset_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Asset_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Asset_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Asset_URI.Match partialMatch) {
    ...
    @Override
    protected Asset_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Asset_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Asset_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Asset_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Asset_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Asset_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Asset_URI.Matcher> querySpecification() {
      return Asset_URI.instance();
    }
  }
   ...
   * 
   */
  public static Asset_URI instance() {
    try{
  ...
  @Override
  protected Asset_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Asset_URI.Matcher.on(engine);
  }
  
  @Override
  public Asset_URI.Matcher instantiate() {
    return Asset_URI.Matcher.create();
  }
  
  @Override
  public Asset_URI.Match newEmptyMatch() {
    return Asset_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Asset_URI.Match newMatch(final Object... parameters) {
    return Asset_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Asset_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Asset_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Asset_URI INSTANCE = new Asset_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Asset_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
