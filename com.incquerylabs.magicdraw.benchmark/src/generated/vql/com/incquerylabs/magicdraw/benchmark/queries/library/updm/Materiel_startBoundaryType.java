...
public final class Materiel_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Materiel_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Materiel_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Materiel_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Materiel_startBoundaryType.Match)) {
          Materiel_startBoundaryType.Match other = (Materiel_startBoundaryType.Match) obj;
    ...
    @Override
    public Materiel_startBoundaryType specification() {
      return Materiel_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Materiel_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Materiel_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Materiel_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Materiel_startBoundaryType.Match {
    ...
    private static final class Immutable extends Materiel_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Materiel_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Materiel_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Materiel_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Materiel_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Materiel_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Materiel_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Materiel_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Materiel_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Materiel_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Materiel_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Materiel_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Materiel_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Materiel_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Materiel_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Materiel_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Materiel_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Materiel_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Materiel_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Materiel_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Materiel_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Materiel_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Materiel_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Materiel_startBoundaryType.Matcher> querySpecification() {
      return Materiel_startBoundaryType.instance();
    }
  }
  
  private Materiel_startBoundaryType() {
   ...
   * 
   */
  public static Materiel_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Materiel_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Materiel_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Materiel_startBoundaryType.Matcher instantiate() {
    return Materiel_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Materiel_startBoundaryType.Match newEmptyMatch() {
    return Materiel_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Materiel_startBoundaryType.Match newMatch(final Object... parameters) {
    return Materiel_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Materiel_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Materiel_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Materiel_startBoundaryType INSTANCE = new Materiel_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Materiel_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
