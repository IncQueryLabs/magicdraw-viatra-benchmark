...
public final class ResourceSignalProperty_URI extends BaseGeneratedEMFQuerySpecification<ResourceSignalProperty_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceSignalProperty_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceSignalProperty_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceSignalProperty_URI.Match.parameterNames;
    }
    ...
    @Override
    public ResourceSignalProperty_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceSignalProperty_URI.Match)) {
          ResourceSignalProperty_URI.Match other = (ResourceSignalProperty_URI.Match) obj;
    ...
    @Override
    public ResourceSignalProperty_URI specification() {
      return ResourceSignalProperty_URI.instance();
    }
     ...
     * 
     */
    public static ResourceSignalProperty_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceSignalProperty_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ResourceSignalProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourceSignalProperty_URI.Match {
    ...
    private static final class Immutable extends ResourceSignalProperty_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceSignalProperty_URI pattern,
   ...
   * 
   * @see Match
   * @see ResourceSignalProperty_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceSignalProperty_URI.Match> {
    /**
     ...
     * 
     */
    public static ResourceSignalProperty_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceSignalProperty_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceSignalProperty_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceSignalProperty_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ResourceSignalProperty_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ResourceSignalProperty_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ResourceSignalProperty_URI.Match> processor) {
     ...
     * 
     */
    public ResourceSignalProperty_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ResourceSignalProperty_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceSignalProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceSignalProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ResourceSignalProperty_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ResourceSignalProperty_URI.Match partialMatch) {
    ...
    @Override
    protected ResourceSignalProperty_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceSignalProperty_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourceSignalProperty_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceSignalProperty_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceSignalProperty_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceSignalProperty_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceSignalProperty_URI.Matcher> querySpecification() {
      return ResourceSignalProperty_URI.instance();
    }
  }
  
  private ResourceSignalProperty_URI() {
   ...
   * 
   */
  public static ResourceSignalProperty_URI instance() {
    try{
  ...
  @Override
  protected ResourceSignalProperty_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceSignalProperty_URI.Matcher.on(engine);
  }
  
  @Override
  public ResourceSignalProperty_URI.Matcher instantiate() {
    return ResourceSignalProperty_URI.Matcher.create();
  }
  
  @Override
  public ResourceSignalProperty_URI.Match newEmptyMatch() {
    return ResourceSignalProperty_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceSignalProperty_URI.Match newMatch(final Object... parameters) {
    return ResourceSignalProperty_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceSignalProperty_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceSignalProperty_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceSignalProperty_URI INSTANCE = new ResourceSignalProperty_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceSignalProperty_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
