...
public final class Asset_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<Asset_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Asset_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Asset_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public Asset_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Asset_requiredEnvironment.Match)) {
          Asset_requiredEnvironment.Match other = (Asset_requiredEnvironment.Match) obj;
    ...
    @Override
    public Asset_requiredEnvironment specification() {
      return Asset_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static Asset_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Asset_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Asset_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Asset_requiredEnvironment.Match {
    ...
    private static final class Immutable extends Asset_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Asset_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see Asset_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<Asset_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static Asset_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Asset_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Asset_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<Asset_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Asset_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Asset_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Asset_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public Asset_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Asset_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Asset_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Asset_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Asset_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Asset_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected Asset_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return Asset_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Asset_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return Asset_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Asset_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Asset_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Asset_requiredEnvironment.Matcher> querySpecification() {
      return Asset_requiredEnvironment.instance();
    }
  }
  
  private Asset_requiredEnvironment() {
   ...
   * 
   */
  public static Asset_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected Asset_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Asset_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public Asset_requiredEnvironment.Matcher instantiate() {
    return Asset_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public Asset_requiredEnvironment.Match newEmptyMatch() {
    return Asset_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public Asset_requiredEnvironment.Match newMatch(final Object... parameters) {
    return Asset_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Asset_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Asset_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Asset_requiredEnvironment INSTANCE = new Asset_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Asset_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
