...
public final class SystemResource_actualPropertySet extends BaseGeneratedEMFQuerySpecification<SystemResource_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_actualPropertySet.Match)) {
          SystemResource_actualPropertySet.Match other = (SystemResource_actualPropertySet.Match) obj;
    ...
    @Override
    public SystemResource_actualPropertySet specification() {
      return SystemResource_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static SystemResource_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_actualPropertySet.Match {
    ...
    private static final class Immutable extends SystemResource_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public SystemResource_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected SystemResource_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_actualPropertySet.Matcher> querySpecification() {
      return SystemResource_actualPropertySet.instance();
    }
  }
  
  private SystemResource_actualPropertySet() {
   ...
   * 
   */
  public static SystemResource_actualPropertySet instance() {
    try{
  ...
  @Override
  protected SystemResource_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_actualPropertySet.Matcher instantiate() {
    return SystemResource_actualPropertySet.Matcher.create();
  }
  
  @Override
  public SystemResource_actualPropertySet.Match newEmptyMatch() {
    return SystemResource_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_actualPropertySet.Match newMatch(final Object... parameters) {
    return SystemResource_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_actualPropertySet INSTANCE = new SystemResource_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
