...
public final class ActualProjectMilestoneRole_startDate extends BaseGeneratedEMFQuerySpecification<ActualProjectMilestoneRole_startDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectMilestoneRole_startDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectMilestoneRole_startDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectMilestoneRole_startDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectMilestoneRole_startDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectMilestoneRole_startDate.Match)) {
          ActualProjectMilestoneRole_startDate.Match other = (ActualProjectMilestoneRole_startDate.Match) obj;
    ...
    @Override
    public ActualProjectMilestoneRole_startDate specification() {
      return ActualProjectMilestoneRole_startDate.instance();
    }
     ...
     * 
     */
    public static ActualProjectMilestoneRole_startDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_startDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProjectMilestoneRole_startDate.Match {
    ...
    private static final class Immutable extends ActualProjectMilestoneRole_startDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectMilestoneRole_startDate pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectMilestoneRole_startDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectMilestoneRole_startDate.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectMilestoneRole_startDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_startDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectMilestoneRole_startDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectMilestoneRole_startDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProjectMilestoneRole_startDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProjectMilestoneRole_startDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProjectMilestoneRole_startDate.Match> processor) {
     ...
     * 
     */
    public ActualProjectMilestoneRole_startDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProjectMilestoneRole_startDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectMilestoneRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectMilestoneRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProjectMilestoneRole_startDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProjectMilestoneRole_startDate.Match partialMatch) {
    ...
    @Override
    protected ActualProjectMilestoneRole_startDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectMilestoneRole_startDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProjectMilestoneRole_startDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_startDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectMilestoneRole_startDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_startDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectMilestoneRole_startDate.Matcher> querySpecification() {
      return ActualProjectMilestoneRole_startDate.instance();
    }
  }
  
  private ActualProjectMilestoneRole_startDate() {
   ...
   * 
   */
  public static ActualProjectMilestoneRole_startDate instance() {
    try{
  ...
  @Override
  protected ActualProjectMilestoneRole_startDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectMilestoneRole_startDate.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectMilestoneRole_startDate.Matcher instantiate() {
    return ActualProjectMilestoneRole_startDate.Matcher.create();
  }
  
  @Override
  public ActualProjectMilestoneRole_startDate.Match newEmptyMatch() {
    return ActualProjectMilestoneRole_startDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectMilestoneRole_startDate.Match newMatch(final Object... parameters) {
    return ActualProjectMilestoneRole_startDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectMilestoneRole_startDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectMilestoneRole_startDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectMilestoneRole_startDate INSTANCE = new ActualProjectMilestoneRole_startDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectMilestoneRole_startDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
