...
public final class ResourceArchitecture_desribedBy extends BaseGeneratedEMFQuerySpecification<ResourceArchitecture_desribedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_desribedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_desribedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArchitecture_desribedBy.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArchitecture_desribedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArchitecture_desribedBy.Match)) {
          ResourceArchitecture_desribedBy.Match other = (ResourceArchitecture_desribedBy.Match) obj;
    ...
    @Override
    public ResourceArchitecture_desribedBy specification() {
      return ResourceArchitecture_desribedBy.instance();
    }
     ...
     * 
     */
    public static ResourceArchitecture_desribedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArchitecture_desribedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArchitecture_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArchitecture_desribedBy.Match {
    ...
    private static final class Immutable extends ResourceArchitecture_desribedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_desribedBy pattern,
   ...
   * 
   * @see Match
   * @see ResourceArchitecture_desribedBy
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArchitecture_desribedBy.Match> {
    /**
     ...
     * 
     */
    public static ResourceArchitecture_desribedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArchitecture_desribedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArchitecture_desribedBy.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArchitecture_desribedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArchitecture_desribedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArchitecture_desribedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArchitecture_desribedBy.Match> processor) {
     ...
     * 
     */
    public ResourceArchitecture_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArchitecture_desribedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArchitecture_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArchitecture_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArchitecture_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArchitecture_desribedBy.Match partialMatch) {
    ...
    @Override
    protected ResourceArchitecture_desribedBy.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArchitecture_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArchitecture_desribedBy.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArchitecture_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArchitecture_desribedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArchitecture_desribedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArchitecture_desribedBy.Matcher> querySpecification() {
      return ResourceArchitecture_desribedBy.instance();
    }
  }
  
  private ResourceArchitecture_desribedBy() {
   ...
   * 
   */
  public static ResourceArchitecture_desribedBy instance() {
    try{
  ...
  @Override
  protected ResourceArchitecture_desribedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArchitecture_desribedBy.Matcher.on(engine);
  }
  
  @Override
  public ResourceArchitecture_desribedBy.Matcher instantiate() {
    return ResourceArchitecture_desribedBy.Matcher.create();
  }
  
  @Override
  public ResourceArchitecture_desribedBy.Match newEmptyMatch() {
    return ResourceArchitecture_desribedBy.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArchitecture_desribedBy.Match newMatch(final Object... parameters) {
    return ResourceArchitecture_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArchitecture_desribedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArchitecture_desribedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArchitecture_desribedBy INSTANCE = new ResourceArchitecture_desribedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArchitecture_desribedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
