...
public final class ActualPropertySet_endDate extends BaseGeneratedEMFQuerySpecification<ActualPropertySet_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPropertySet_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualPropertySet_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualPropertySet_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualPropertySet_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualPropertySet_endDate.Match)) {
          ActualPropertySet_endDate.Match other = (ActualPropertySet_endDate.Match) obj;
    ...
    @Override
    public ActualPropertySet_endDate specification() {
      return ActualPropertySet_endDate.instance();
    }
     ...
     * 
     */
    public static ActualPropertySet_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualPropertySet_endDate.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public static ActualPropertySet_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualPropertySet_endDate.Match {
    ...
    private static final class Immutable extends ActualPropertySet_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualPropertySet_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualPropertySet_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualPropertySet_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualPropertySet_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualPropertySet_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualPropertySet_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualPropertySet_endDate.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Stream<ActualPropertySet_endDate.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public Optional<ActualPropertySet_endDate.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValue, final Consumer<? super ActualPropertySet_endDate.Match> processor) {
     ...
     * 
     */
    public ActualPropertySet_endDate.Match newMatch(final InstanceSpecification pElement, final LiteralString pValue) {
      return ActualPropertySet_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualPropertySet_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualPropertySet_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvalue(final ActualPropertySet_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvalue(final ActualPropertySet_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualPropertySet_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualPropertySet_endDate.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualPropertySet_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualPropertySet_endDate.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualPropertySet_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualPropertySet_endDate.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualPropertySet_endDate.Matcher> querySpecification() {
      return ActualPropertySet_endDate.instance();
    }
  }
  
  private ActualPropertySet_endDate() {
   ...
   * 
   */
  public static ActualPropertySet_endDate instance() {
    try{
  ...
  @Override
  protected ActualPropertySet_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualPropertySet_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualPropertySet_endDate.Matcher instantiate() {
    return ActualPropertySet_endDate.Matcher.create();
  }
  
  @Override
  public ActualPropertySet_endDate.Match newEmptyMatch() {
    return ActualPropertySet_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualPropertySet_endDate.Match newMatch(final Object... parameters) {
    return ActualPropertySet_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualPropertySet_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualPropertySet_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualPropertySet_endDate INSTANCE = new ActualPropertySet_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualPropertySet_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
