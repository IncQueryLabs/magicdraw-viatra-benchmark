...
public final class BasicInterval_min extends BaseGeneratedEMFQuerySpecification<BasicInterval_min.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static BasicInterval_min.Match newMutableMatch(final Property pElement, final Double pValue) {
     ...
     * 
     */
    public static BasicInterval_min.Match newMatch(final Property pElement, final Double pValue) {
  ...
  public static class Matcher extends BaseMatcher<BasicInterval_min.Match> {
     ...
     * 
     */
    public Collection<BasicInterval_min.Match> getAllMatches(final Property pElement, final Double pValue) {
     ...
     * 
     */
    public Stream<BasicInterval_min.Match> streamAllMatches(final Property pElement, final Double pValue) {
     ...
     * 
     */
    public Optional<BasicInterval_min.Match> getOneArbitraryMatch(final Property pElement, final Double pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Double pValue, final Consumer<? super BasicInterval_min.Match> processor) {
     ...
     * 
     */
    public BasicInterval_min.Match newMatch(final Property pElement, final Double pValue) {
      return BasicInterval_min.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Double> streamAllValuesOfValue(final BasicInterval_min.Match partialMatch) {
     ...
     * 
     */
    public Set<Double> getAllValuesOfValue(final BasicInterval_min.Match partialMatch) {
    ...
    protected BasicInterval_min.Match tupleToMatch(final Tuple t) {
      try {
          return BasicInterval_min.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Double) t.get(POSITION_VALUE));
    ...
    protected BasicInterval_min.Match arrayToMatch(final Object[] match) {
      try {
          return BasicInterval_min.Match.newMatch((Property) match[POSITION_ELEMENT], (Double) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected BasicInterval_min.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BasicInterval_min.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Double) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public BasicInterval_min.Match newMatch(final Object... parameters) {
    return BasicInterval_min.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (java.lang.Double) parameters[1]);
  }
