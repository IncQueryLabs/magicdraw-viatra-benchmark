...
public final class ResponsibleFor_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<ResponsibleFor_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResponsibleFor_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public ResponsibleFor_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResponsibleFor_targetPropertyPath.Match)) {
          ResponsibleFor_targetPropertyPath.Match other = (ResponsibleFor_targetPropertyPath.Match) obj;
    ...
    @Override
    public ResponsibleFor_targetPropertyPath specification() {
      return ResponsibleFor_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static ResponsibleFor_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResponsibleFor_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static ResponsibleFor_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResponsibleFor_targetPropertyPath.Match {
    ...
    private static final class Immutable extends ResponsibleFor_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResponsibleFor_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see ResponsibleFor_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<ResponsibleFor_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static ResponsibleFor_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResponsibleFor_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResponsibleFor_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<ResponsibleFor_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<ResponsibleFor_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<ResponsibleFor_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super ResponsibleFor_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public ResponsibleFor_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return ResponsibleFor_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final ResponsibleFor_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final ResponsibleFor_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final ResponsibleFor_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final ResponsibleFor_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected ResponsibleFor_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return ResponsibleFor_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResponsibleFor_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return ResponsibleFor_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResponsibleFor_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResponsibleFor_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResponsibleFor_targetPropertyPath.Matcher> querySpecification() {
      return ResponsibleFor_targetPropertyPath.instance();
    }
  }
  
  private ResponsibleFor_targetPropertyPath() {
   ...
   * 
   */
  public static ResponsibleFor_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected ResponsibleFor_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResponsibleFor_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public ResponsibleFor_targetPropertyPath.Matcher instantiate() {
    return ResponsibleFor_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public ResponsibleFor_targetPropertyPath.Match newEmptyMatch() {
    return ResponsibleFor_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public ResponsibleFor_targetPropertyPath.Match newMatch(final Object... parameters) {
    return ResponsibleFor_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResponsibleFor_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResponsibleFor_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResponsibleFor_targetPropertyPath INSTANCE = new ResponsibleFor_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResponsibleFor_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
