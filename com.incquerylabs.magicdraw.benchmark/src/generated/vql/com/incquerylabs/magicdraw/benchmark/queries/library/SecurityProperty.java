...
public final class SecurityProperty extends BaseGeneratedEMFQuerySpecification<SecurityProperty.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityProperty.Match.parameterNames;
    }
    ...
    @Override
    public SecurityProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityProperty.Match)) {
          SecurityProperty.Match other = (SecurityProperty.Match) obj;
    ...
    @Override
    public SecurityProperty specification() {
      return SecurityProperty.instance();
    }
     ...
     * 
     */
    public static SecurityProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SecurityProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SecurityProperty.Match {
    ...
    private static final class Immutable extends SecurityProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityProperty pattern,
   ...
   * 
   * @see Match
   * @see SecurityProperty
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityProperty.Match> {
    /**
     ...
     * 
     */
    public static SecurityProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityProperty.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SecurityProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SecurityProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SecurityProperty.Match> processor) {
     ...
     * 
     */
    public SecurityProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SecurityProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final SecurityProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final SecurityProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SecurityProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SecurityProperty.Match partialMatch) {
    ...
    @Override
    protected SecurityProperty.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SecurityProperty.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityProperty.Matcher> querySpecification() {
      return SecurityProperty.instance();
    }
  }
  
  private SecurityProperty() {
   ...
   * 
   */
  public static SecurityProperty instance() {
    try{
  ...
  @Override
  protected SecurityProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityProperty.Matcher.on(engine);
  }
  
  @Override
  public SecurityProperty.Matcher instantiate() {
    return SecurityProperty.Matcher.create();
  }
  
  @Override
  public SecurityProperty.Match newEmptyMatch() {
    return SecurityProperty.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityProperty.Match newMatch(final Object... parameters) {
    return SecurityProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityProperty} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityProperty#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityProperty INSTANCE = new SecurityProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "SecurityProperty")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "SecurityProperty");
