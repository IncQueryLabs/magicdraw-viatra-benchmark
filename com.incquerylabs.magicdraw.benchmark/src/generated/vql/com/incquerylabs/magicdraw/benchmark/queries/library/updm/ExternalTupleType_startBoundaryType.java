...
public final class ExternalTupleType_startBoundaryType extends BaseGeneratedEMFQuerySpecification<ExternalTupleType_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTupleType_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTupleType_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTupleType_startBoundaryType.Match)) {
          ExternalTupleType_startBoundaryType.Match other = (ExternalTupleType_startBoundaryType.Match) obj;
    ...
    @Override
    public ExternalTupleType_startBoundaryType specification() {
      return ExternalTupleType_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static ExternalTupleType_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTupleType_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExternalTupleType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExternalTupleType_startBoundaryType.Match {
    ...
    private static final class Immutable extends ExternalTupleType_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ExternalTupleType_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTupleType_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ExternalTupleType_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTupleType_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTupleType_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTupleType_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExternalTupleType_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExternalTupleType_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExternalTupleType_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public ExternalTupleType_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExternalTupleType_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTupleType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTupleType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExternalTupleType_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExternalTupleType_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ExternalTupleType_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTupleType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExternalTupleType_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTupleType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTupleType_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTupleType_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTupleType_startBoundaryType.Matcher> querySpecification() {
      return ExternalTupleType_startBoundaryType.instance();
    }
  }
  
  private ExternalTupleType_startBoundaryType() {
   ...
   * 
   */
  public static ExternalTupleType_startBoundaryType instance() {
    try{
  ...
  @Override
  protected ExternalTupleType_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTupleType_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ExternalTupleType_startBoundaryType.Matcher instantiate() {
    return ExternalTupleType_startBoundaryType.Matcher.create();
  }
  
  @Override
  public ExternalTupleType_startBoundaryType.Match newEmptyMatch() {
    return ExternalTupleType_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTupleType_startBoundaryType.Match newMatch(final Object... parameters) {
    return ExternalTupleType_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTupleType_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTupleType_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTupleType_startBoundaryType INSTANCE = new ExternalTupleType_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTupleType_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
