...
public final class ServiceInterface_URI extends BaseGeneratedEMFQuerySpecification<ServiceInterface_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceInterface_URI.Match.parameterNames;
    }
    ...
    @Override
    public ServiceInterface_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceInterface_URI.Match)) {
          ServiceInterface_URI.Match other = (ServiceInterface_URI.Match) obj;
    ...
    @Override
    public ServiceInterface_URI specification() {
      return ServiceInterface_URI.instance();
    }
     ...
     * 
     */
    public static ServiceInterface_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceInterface_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ServiceInterface_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ServiceInterface_URI.Match {
    ...
    private static final class Immutable extends ServiceInterface_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceInterface_URI pattern,
   ...
   * 
   * @see Match
   * @see ServiceInterface_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceInterface_URI.Match> {
    /**
     ...
     * 
     */
    public static ServiceInterface_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceInterface_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceInterface_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceInterface_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ServiceInterface_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ServiceInterface_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ServiceInterface_URI.Match> processor) {
     ...
     * 
     */
    public ServiceInterface_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ServiceInterface_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceInterface_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceInterface_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ServiceInterface_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ServiceInterface_URI.Match partialMatch) {
    ...
    @Override
    protected ServiceInterface_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceInterface_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ServiceInterface_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceInterface_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceInterface_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceInterface_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceInterface_URI.Matcher> querySpecification() {
      return ServiceInterface_URI.instance();
    }
  }
  
  private ServiceInterface_URI() {
   ...
   * 
   */
  public static ServiceInterface_URI instance() {
    try{
  ...
  @Override
  protected ServiceInterface_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceInterface_URI.Matcher.on(engine);
  }
  
  @Override
  public ServiceInterface_URI.Matcher instantiate() {
    return ServiceInterface_URI.Matcher.create();
  }
  
  @Override
  public ServiceInterface_URI.Match newEmptyMatch() {
    return ServiceInterface_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceInterface_URI.Match newMatch(final Object... parameters) {
    return ServiceInterface_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceInterface_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceInterface_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceInterface_URI INSTANCE = new ServiceInterface_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceInterface_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
