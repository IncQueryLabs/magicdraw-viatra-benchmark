...
public final class Standard_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Standard_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Standard_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_endBoundaryType.Match)) {
          Standard_endBoundaryType.Match other = (Standard_endBoundaryType.Match) obj;
    ...
    @Override
    public Standard_endBoundaryType specification() {
      return Standard_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Standard_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Standard_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Standard_endBoundaryType.Match {
    ...
    private static final class Immutable extends Standard_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Standard_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Standard_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Standard_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Standard_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Standard_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Standard_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Standard_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Standard_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Standard_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Standard_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Standard_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_endBoundaryType.Matcher> querySpecification() {
      return Standard_endBoundaryType.instance();
    }
  }
  
  private Standard_endBoundaryType() {
   ...
   * 
   */
  public static Standard_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Standard_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Standard_endBoundaryType.Matcher instantiate() {
    return Standard_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Standard_endBoundaryType.Match newEmptyMatch() {
    return Standard_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_endBoundaryType.Match newMatch(final Object... parameters) {
    return Standard_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_endBoundaryType INSTANCE = new Standard_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
