...
public final class PhysicalResource_conformsTo extends BaseGeneratedEMFQuerySpecification<PhysicalResource_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_conformsTo.Match)) {
          PhysicalResource_conformsTo.Match other = (PhysicalResource_conformsTo.Match) obj;
    ...
    @Override
    public PhysicalResource_conformsTo specification() {
      return PhysicalResource_conformsTo.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_conformsTo.Match {
    ...
    private static final class Immutable extends PhysicalResource_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_conformsTo.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_conformsTo.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_conformsTo.Matcher> querySpecification() {
      return PhysicalResource_conformsTo.instance();
    }
  }
  
  private PhysicalResource_conformsTo() {
   ...
   * 
   */
  public static PhysicalResource_conformsTo instance() {
    try{
  ...
  @Override
  protected PhysicalResource_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_conformsTo.Matcher instantiate() {
    return PhysicalResource_conformsTo.Matcher.create();
  }
  
  @Override
  public PhysicalResource_conformsTo.Match newEmptyMatch() {
    return PhysicalResource_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_conformsTo.Match newMatch(final Object... parameters) {
    return PhysicalResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_conformsTo INSTANCE = new PhysicalResource_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
