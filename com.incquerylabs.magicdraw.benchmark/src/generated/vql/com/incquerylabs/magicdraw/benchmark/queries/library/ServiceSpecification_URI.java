...
public final class ServiceSpecification_URI extends BaseGeneratedEMFQuerySpecification<ServiceSpecification_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceSpecification_URI.Match.parameterNames;
    }
    ...
    @Override
    public ServiceSpecification_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceSpecification_URI.Match)) {
          ServiceSpecification_URI.Match other = (ServiceSpecification_URI.Match) obj;
    ...
    @Override
    public ServiceSpecification_URI specification() {
      return ServiceSpecification_URI.instance();
    }
     ...
     * 
     */
    public static ServiceSpecification_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceSpecification_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ServiceSpecification_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ServiceSpecification_URI.Match {
    ...
    private static final class Immutable extends ServiceSpecification_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ServiceSpecification_URI pattern,
   ...
   * 
   * @see Match
   * @see ServiceSpecification_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceSpecification_URI.Match> {
    /**
     ...
     * 
     */
    public static ServiceSpecification_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceSpecification_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceSpecification_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceSpecification_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ServiceSpecification_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ServiceSpecification_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ServiceSpecification_URI.Match> processor) {
     ...
     * 
     */
    public ServiceSpecification_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ServiceSpecification_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceSpecification_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceSpecification_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ServiceSpecification_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ServiceSpecification_URI.Match partialMatch) {
    ...
    @Override
    protected ServiceSpecification_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceSpecification_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ServiceSpecification_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceSpecification_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceSpecification_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceSpecification_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceSpecification_URI.Matcher> querySpecification() {
      return ServiceSpecification_URI.instance();
    }
  }
  
  private ServiceSpecification_URI() {
   ...
   * 
   */
  public static ServiceSpecification_URI instance() {
    try{
  ...
  @Override
  protected ServiceSpecification_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceSpecification_URI.Matcher.on(engine);
  }
  
  @Override
  public ServiceSpecification_URI.Matcher instantiate() {
    return ServiceSpecification_URI.Matcher.create();
  }
  
  @Override
  public ServiceSpecification_URI.Match newEmptyMatch() {
    return ServiceSpecification_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceSpecification_URI.Match newMatch(final Object... parameters) {
    return ServiceSpecification_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceSpecification_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceSpecification_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceSpecification_URI INSTANCE = new ServiceSpecification_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceSpecification_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
