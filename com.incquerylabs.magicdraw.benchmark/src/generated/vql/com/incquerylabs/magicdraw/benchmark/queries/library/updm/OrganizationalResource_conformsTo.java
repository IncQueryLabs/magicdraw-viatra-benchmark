...
public final class OrganizationalResource_conformsTo extends BaseGeneratedEMFQuerySpecification<OrganizationalResource_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationalResource_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationalResource_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationalResource_conformsTo.Match)) {
          OrganizationalResource_conformsTo.Match other = (OrganizationalResource_conformsTo.Match) obj;
    ...
    @Override
    public OrganizationalResource_conformsTo specification() {
      return OrganizationalResource_conformsTo.instance();
    }
     ...
     * 
     */
    public static OrganizationalResource_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationalResource_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationalResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationalResource_conformsTo.Match {
    ...
    private static final class Immutable extends OrganizationalResource_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationalResource_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see OrganizationalResource_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationalResource_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static OrganizationalResource_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationalResource_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationalResource_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationalResource_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationalResource_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationalResource_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationalResource_conformsTo.Match> processor) {
     ...
     * 
     */
    public OrganizationalResource_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationalResource_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationalResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationalResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationalResource_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationalResource_conformsTo.Match partialMatch) {
    ...
    @Override
    protected OrganizationalResource_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationalResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationalResource_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationalResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationalResource_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationalResource_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationalResource_conformsTo.Matcher> querySpecification() {
      return OrganizationalResource_conformsTo.instance();
    }
  }
  
  private OrganizationalResource_conformsTo() {
   ...
   * 
   */
  public static OrganizationalResource_conformsTo instance() {
    try{
  ...
  @Override
  protected OrganizationalResource_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationalResource_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public OrganizationalResource_conformsTo.Matcher instantiate() {
    return OrganizationalResource_conformsTo.Matcher.create();
  }
  
  @Override
  public OrganizationalResource_conformsTo.Match newEmptyMatch() {
    return OrganizationalResource_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationalResource_conformsTo.Match newMatch(final Object... parameters) {
    return OrganizationalResource_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationalResource_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationalResource_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationalResource_conformsTo INSTANCE = new OrganizationalResource_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationalResource_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
