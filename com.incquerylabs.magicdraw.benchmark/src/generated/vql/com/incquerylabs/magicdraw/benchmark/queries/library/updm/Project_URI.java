...
public final class Project_URI extends BaseGeneratedEMFQuerySpecification<Project_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Project_URI.Match.parameterNames;
    }
    ...
    @Override
    public Project_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Project_URI.Match)) {
          Project_URI.Match other = (Project_URI.Match) obj;
    ...
    @Override
    public Project_URI specification() {
      return Project_URI.instance();
    }
     ...
     * 
     */
    public static Project_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Project_URI.Match newMutableMatch(final InstanceSpecification pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Project_URI.Match newMatch(final InstanceSpecification pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Project_URI.Match {
    ...
    private static final class Immutable extends Project_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Project_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Project_URI.Match> {
    /**
     ...
     * 
     */
    public static Project_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Project_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Project_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Project_URI.Match> getAllMatches(final InstanceSpecification pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Project_URI.Match> streamAllMatches(final InstanceSpecification pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Project_URI.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final LiteralString pValuespec, final Consumer<? super Project_URI.Match> processor) {
     ...
     * 
     */
    public Project_URI.Match newMatch(final InstanceSpecification pElement, final LiteralString pValuespec) {
      return Project_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final Project_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final Project_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Project_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Project_URI.Match partialMatch) {
    ...
    @Override
    protected Project_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Project_URI.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Project_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Project_URI.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Project_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Project_URI.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Project_URI.Matcher> querySpecification() {
      return Project_URI.instance();
    }
  }
   ...
   * 
   */
  public static Project_URI instance() {
    try{
  ...
  @Override
  protected Project_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Project_URI.Matcher.on(engine);
  }
  
  @Override
  public Project_URI.Matcher instantiate() {
    return Project_URI.Matcher.create();
  }
  
  @Override
  public Project_URI.Match newEmptyMatch() {
    return Project_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Project_URI.Match newMatch(final Object... parameters) {
    return Project_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Project_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Project_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Project_URI INSTANCE = new Project_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Project_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
