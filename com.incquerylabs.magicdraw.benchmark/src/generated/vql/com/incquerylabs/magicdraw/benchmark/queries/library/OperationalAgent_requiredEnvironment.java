...
public final class OperationalAgent_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<OperationalAgent_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalAgent_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public OperationalAgent_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalAgent_requiredEnvironment.Match)) {
          OperationalAgent_requiredEnvironment.Match other = (OperationalAgent_requiredEnvironment.Match) obj;
    ...
    @Override
    public OperationalAgent_requiredEnvironment specification() {
      return OperationalAgent_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static OperationalAgent_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalAgent_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalAgent_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalAgent_requiredEnvironment.Match {
    ...
    private static final class Immutable extends OperationalAgent_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see OperationalAgent_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalAgent_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static OperationalAgent_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalAgent_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalAgent_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalAgent_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalAgent_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalAgent_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalAgent_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public OperationalAgent_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalAgent_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalAgent_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalAgent_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalAgent_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalAgent_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected OperationalAgent_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalAgent_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalAgent_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalAgent_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalAgent_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalAgent_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalAgent_requiredEnvironment.Matcher> querySpecification() {
      return OperationalAgent_requiredEnvironment.instance();
    }
  }
  
  private OperationalAgent_requiredEnvironment() {
   ...
   * 
   */
  public static OperationalAgent_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected OperationalAgent_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalAgent_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public OperationalAgent_requiredEnvironment.Matcher instantiate() {
    return OperationalAgent_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public OperationalAgent_requiredEnvironment.Match newEmptyMatch() {
    return OperationalAgent_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalAgent_requiredEnvironment.Match newMatch(final Object... parameters) {
    return OperationalAgent_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalAgent_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalAgent_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalAgent_requiredEnvironment INSTANCE = new OperationalAgent_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalAgent_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
