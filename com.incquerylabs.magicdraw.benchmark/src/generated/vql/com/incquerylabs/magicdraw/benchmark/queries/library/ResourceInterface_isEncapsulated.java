...
import com.incquerylabs.magicdraw.benchmark.queries.library.ResourceInterface;
...
public final class ResourceInterface_isEncapsulated extends BaseGeneratedEMFQuerySpecification<ResourceInterface_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceInterface_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceInterface_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceInterface_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public ResourceInterface_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceInterface_isEncapsulated.Match)) {
          ResourceInterface_isEncapsulated.Match other = (ResourceInterface_isEncapsulated.Match) obj;
    ...
    @Override
    public ResourceInterface_isEncapsulated specification() {
      return ResourceInterface_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static ResourceInterface_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceInterface_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static ResourceInterface_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ResourceInterface_isEncapsulated.Match {
    ...
    private static final class Immutable extends ResourceInterface_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceInterface_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see ResourceInterface_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceInterface_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static ResourceInterface_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceInterface_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceInterface_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceInterface_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<ResourceInterface_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<ResourceInterface_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super ResourceInterface_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public ResourceInterface_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return ResourceInterface_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceInterface_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceInterface_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final ResourceInterface_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final ResourceInterface_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected ResourceInterface_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceInterface_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ResourceInterface_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceInterface_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceInterface_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceInterface_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceInterface_isEncapsulated.Matcher> querySpecification() {
      return ResourceInterface_isEncapsulated.instance();
    }
  }
  
  private ResourceInterface_isEncapsulated() {
   ...
   * 
   */
  public static ResourceInterface_isEncapsulated instance() {
    try{
  ...
  @Override
  protected ResourceInterface_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceInterface_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public ResourceInterface_isEncapsulated.Matcher instantiate() {
    return ResourceInterface_isEncapsulated.Matcher.create();
  }
  
  @Override
  public ResourceInterface_isEncapsulated.Match newEmptyMatch() {
    return ResourceInterface_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceInterface_isEncapsulated.Match newMatch(final Object... parameters) {
    return ResourceInterface_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceInterface_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceInterface_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceInterface_isEncapsulated INSTANCE = new ResourceInterface_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceInterface_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
