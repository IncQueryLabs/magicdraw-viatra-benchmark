...
public final class ResourceRole_conformsTo extends BaseGeneratedEMFQuerySpecification<ResourceRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_conformsTo.Match)) {
          ResourceRole_conformsTo.Match other = (ResourceRole_conformsTo.Match) obj;
    ...
    @Override
    public ResourceRole_conformsTo specification() {
      return ResourceRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static ResourceRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_conformsTo.Match {
    ...
    private static final class Immutable extends ResourceRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public ResourceRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_conformsTo.Matcher> querySpecification() {
      return ResourceRole_conformsTo.instance();
    }
  }
  
  private ResourceRole_conformsTo() {
   ...
   * 
   */
  public static ResourceRole_conformsTo instance() {
    try{
  ...
  @Override
  protected ResourceRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_conformsTo.Matcher instantiate() {
    return ResourceRole_conformsTo.Matcher.create();
  }
  
  @Override
  public ResourceRole_conformsTo.Match newEmptyMatch() {
    return ResourceRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_conformsTo.Match newMatch(final Object... parameters) {
    return ResourceRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_conformsTo INSTANCE = new ResourceRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
