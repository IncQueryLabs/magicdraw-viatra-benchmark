...
public final class ExtendedRequirement_DerivedFrom extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtendedRequirement_DerivedFrom.Match)) {
          ExtendedRequirement_DerivedFrom.Match other = (ExtendedRequirement_DerivedFrom.Match) obj;
    ...
    @Override
    public ExtendedRequirement_DerivedFrom specification() {
     ...
     * 
     */
    public static ExtendedRequirement_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtendedRequirement_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExtendedRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExtendedRequirement_DerivedFrom.Match {
    ...
    private static final class Immutable extends ExtendedRequirement_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtendedRequirement_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<ExtendedRequirement_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExtendedRequirement_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExtendedRequirement_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExtendedRequirement_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExtendedRequirement_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final ExtendedRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final ExtendedRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final ExtendedRequirement_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final ExtendedRequirement_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected ExtendedRequirement_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExtendedRequirement_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExtendedRequirement_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement_DerivedFrom.Matcher> querySpecification() {
      return ExtendedRequirement_DerivedFrom.instance();
    }
  }
  
  private ExtendedRequirement_DerivedFrom() {
   ...
   * 
   */
  public static ExtendedRequirement_DerivedFrom instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement_DerivedFrom.Matcher instantiate() {
    return ExtendedRequirement_DerivedFrom.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement_DerivedFrom.Match newEmptyMatch() {
    return ExtendedRequirement_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public ExtendedRequirement_DerivedFrom.Match newMatch(final Object... parameters) {
    return ExtendedRequirement_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExtendedRequirement_DerivedFrom} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExtendedRequirement_DerivedFrom#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement_DerivedFrom INSTANCE = new ExtendedRequirement_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExtendedRequirement_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
