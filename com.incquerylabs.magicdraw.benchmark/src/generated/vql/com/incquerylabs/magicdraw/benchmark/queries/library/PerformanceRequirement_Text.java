...
public final class PerformanceRequirement_Text extends BaseGeneratedEMFQuerySpecification<PerformanceRequirement_Text.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static PerformanceRequirement_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public static PerformanceRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<PerformanceRequirement_Text.Match> {
     ...
     * 
     */
    public Collection<PerformanceRequirement_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Stream<PerformanceRequirement_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public Optional<PerformanceRequirement_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue, final Consumer<? super PerformanceRequirement_Text.Match> processor) {
     ...
     * 
     */
    public PerformanceRequirement_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final String pValue) {
      return PerformanceRequirement_Text.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final PerformanceRequirement_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final PerformanceRequirement_Text.Match partialMatch) {
    ...
    protected PerformanceRequirement_Text.Match tupleToMatch(final Tuple t) {
      try {
          return PerformanceRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected PerformanceRequirement_Text.Match arrayToMatch(final Object[] match) {
      try {
          return PerformanceRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected PerformanceRequirement_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformanceRequirement_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public PerformanceRequirement_Text.Match newMatch(final Object... parameters) {
    return PerformanceRequirement_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.String) parameters[1]);
  }
