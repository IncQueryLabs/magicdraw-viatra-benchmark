...
public final class OwnsRiskInContext_sourceContext extends BaseGeneratedEMFQuerySpecification<OwnsRiskInContext_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return OwnsRiskInContext_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public OwnsRiskInContext_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OwnsRiskInContext_sourceContext.Match)) {
          OwnsRiskInContext_sourceContext.Match other = (OwnsRiskInContext_sourceContext.Match) obj;
    ...
    @Override
    public OwnsRiskInContext_sourceContext specification() {
      return OwnsRiskInContext_sourceContext.instance();
    }
     ...
     * 
     */
    public static OwnsRiskInContext_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static OwnsRiskInContext_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static OwnsRiskInContext_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OwnsRiskInContext_sourceContext.Match {
    ...
    private static final class Immutable extends OwnsRiskInContext_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OwnsRiskInContext_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see OwnsRiskInContext_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<OwnsRiskInContext_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static OwnsRiskInContext_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OwnsRiskInContext_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OwnsRiskInContext_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<OwnsRiskInContext_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<OwnsRiskInContext_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<OwnsRiskInContext_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super OwnsRiskInContext_sourceContext.Match> processor) {
     ...
     * 
     */
    public OwnsRiskInContext_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return OwnsRiskInContext_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OwnsRiskInContext_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OwnsRiskInContext_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final OwnsRiskInContext_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final OwnsRiskInContext_sourceContext.Match partialMatch) {
    ...
    @Override
    protected OwnsRiskInContext_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return OwnsRiskInContext_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected OwnsRiskInContext_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return OwnsRiskInContext_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OwnsRiskInContext_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OwnsRiskInContext_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OwnsRiskInContext_sourceContext.Matcher> querySpecification() {
      return OwnsRiskInContext_sourceContext.instance();
    }
  }
  
  private OwnsRiskInContext_sourceContext() {
   ...
   * 
   */
  public static OwnsRiskInContext_sourceContext instance() {
    try{
  ...
  @Override
  protected OwnsRiskInContext_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return OwnsRiskInContext_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public OwnsRiskInContext_sourceContext.Matcher instantiate() {
    return OwnsRiskInContext_sourceContext.Matcher.create();
  }
  
  @Override
  public OwnsRiskInContext_sourceContext.Match newEmptyMatch() {
    return OwnsRiskInContext_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public OwnsRiskInContext_sourceContext.Match newMatch(final Object... parameters) {
    return OwnsRiskInContext_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OwnsRiskInContext_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OwnsRiskInContext_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OwnsRiskInContext_sourceContext INSTANCE = new OwnsRiskInContext_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OwnsRiskInContext_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
