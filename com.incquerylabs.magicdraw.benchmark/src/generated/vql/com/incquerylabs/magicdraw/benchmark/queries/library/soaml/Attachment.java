...
public final class Attachment extends BaseGeneratedEMFQuerySpecification<Attachment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Attachment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Attachment";
    }
    
    @Override
    public List<String> parameterNames() {
      return Attachment.Match.parameterNames;
    }
    ...
    @Override
    public Attachment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Attachment.Match)) {
          Attachment.Match other = (Attachment.Match) obj;
    ...
    @Override
    public Attachment specification() {
     ...
     * 
     */
    public static Attachment.Match newEmptyMatch() {
     ...
     * 
     */
    public static Attachment.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Attachment.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Attachment.Match {
    ...
    private static final class Immutable extends Attachment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.soaml.Attachment pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Attachment.Match> {
    /**
     ...
     * 
     */
    public static Attachment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Attachment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Attachment.Matcher.class);
     ...
     * 
     */
    public Collection<Attachment.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Attachment.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Attachment.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Attachment.Match> processor) {
     ...
     * 
     */
    public Attachment.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Attachment.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Attachment.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Attachment.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Attachment.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Attachment.Match partialMatch) {
    ...
    @Override
    protected Attachment.Match tupleToMatch(final Tuple t) {
      try {
          return Attachment.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Attachment.Match arrayToMatch(final Object[] match) {
      try {
          return Attachment.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Attachment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Attachment.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Attachment.Matcher> querySpecification() {
      return Attachment.instance();
    }
  }
  ...
  @Override
  protected Attachment.Matcher instantiate(final ViatraQueryEngine engine) {
    return Attachment.Matcher.on(engine);
  }
  
  @Override
  public Attachment.Matcher instantiate() {
    return Attachment.Matcher.create();
  }
  
  @Override
  public Attachment.Match newEmptyMatch() {
    return Attachment.Match.newEmptyMatch();
  }
  
  @Override
  public Attachment.Match newMatch(final Object... parameters) {
    return Attachment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Attachment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Attachment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Attachment INSTANCE = new Attachment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Attachment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "Attachment");
