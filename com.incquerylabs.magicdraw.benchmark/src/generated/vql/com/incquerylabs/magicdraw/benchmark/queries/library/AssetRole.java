...
public final class AssetRole extends BaseGeneratedEMFQuerySpecification<AssetRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.AssetRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.AssetRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return AssetRole.Match.parameterNames;
    }
    ...
    @Override
    public AssetRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof AssetRole.Match)) {
          AssetRole.Match other = (AssetRole.Match) obj;
    ...
    @Override
    public AssetRole specification() {
      return AssetRole.instance();
    }
     ...
     * 
     */
    public static AssetRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static AssetRole.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static AssetRole.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends AssetRole.Match {
    ...
    private static final class Immutable extends AssetRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.AssetRole pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<AssetRole.Match> {
    /**
     ...
     * 
     */
    public static AssetRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static AssetRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(AssetRole.Matcher.class);
     ...
     * 
     */
    public Collection<AssetRole.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<AssetRole.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<AssetRole.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super AssetRole.Match> processor) {
     ...
     * 
     */
    public AssetRole.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return AssetRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final AssetRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final AssetRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final AssetRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final AssetRole.Match partialMatch) {
    ...
    @Override
    protected AssetRole.Match tupleToMatch(final Tuple t) {
      try {
          return AssetRole.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected AssetRole.Match arrayToMatch(final Object[] match) {
      try {
          return AssetRole.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected AssetRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return AssetRole.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<AssetRole.Matcher> querySpecification() {
      return AssetRole.instance();
    }
  }
   ...
   * 
   */
  public static AssetRole instance() {
    try{
  ...
  @Override
  protected AssetRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return AssetRole.Matcher.on(engine);
  }
  
  @Override
  public AssetRole.Matcher instantiate() {
    return AssetRole.Matcher.create();
  }
  
  @Override
  public AssetRole.Match newEmptyMatch() {
    return AssetRole.Match.newEmptyMatch();
  }
  
  @Override
  public AssetRole.Match newMatch(final Object... parameters) {
    return AssetRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link AssetRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link AssetRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final AssetRole INSTANCE = new AssetRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final AssetRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "AssetRole")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "AssetRole");
