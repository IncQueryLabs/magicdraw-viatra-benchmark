...
public final class Standard_ratifiedBy extends BaseGeneratedEMFQuerySpecification<Standard_ratifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_ratifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_ratifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_ratifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public Standard_ratifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_ratifiedBy.Match)) {
          Standard_ratifiedBy.Match other = (Standard_ratifiedBy.Match) obj;
    ...
    @Override
    public Standard_ratifiedBy specification() {
      return Standard_ratifiedBy.instance();
    }
     ...
     * 
     */
    public static Standard_ratifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_ratifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Standard_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Standard_ratifiedBy.Match {
    ...
    private static final class Immutable extends Standard_ratifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Standard_ratifiedBy pattern,
   ...
   * 
   * @see Match
   * @see Standard_ratifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_ratifiedBy.Match> {
    /**
     ...
     * 
     */
    public static Standard_ratifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_ratifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_ratifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_ratifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Standard_ratifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Standard_ratifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Standard_ratifiedBy.Match> processor) {
     ...
     * 
     */
    public Standard_ratifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Standard_ratifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Standard_ratifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Standard_ratifiedBy.Match partialMatch) {
    ...
    @Override
    protected Standard_ratifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Standard_ratifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_ratifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_ratifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_ratifiedBy.Matcher> querySpecification() {
      return Standard_ratifiedBy.instance();
    }
  }
  
  private Standard_ratifiedBy() {
   ...
   * 
   */
  public static Standard_ratifiedBy instance() {
    try{
  ...
  @Override
  protected Standard_ratifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_ratifiedBy.Matcher.on(engine);
  }
  
  @Override
  public Standard_ratifiedBy.Matcher instantiate() {
    return Standard_ratifiedBy.Matcher.create();
  }
  
  @Override
  public Standard_ratifiedBy.Match newEmptyMatch() {
    return Standard_ratifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_ratifiedBy.Match newMatch(final Object... parameters) {
    return Standard_ratifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_ratifiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_ratifiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_ratifiedBy INSTANCE = new Standard_ratifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_ratifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
