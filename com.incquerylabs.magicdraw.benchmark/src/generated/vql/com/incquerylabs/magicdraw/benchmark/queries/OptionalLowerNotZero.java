...
public final class OptionalLowerNotZero extends BaseGeneratedEMFQuerySpecification<OptionalLowerNotZero.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link OptionalLowerNotZero} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OptionalLowerNotZero#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.Optional(parameter, _)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_parameter, var___0_), com.incquerylabs.magicdraw.benchmark.queries.library.Optional.instance().getInternalQueryRepresentation());
          // 	Parameter.lowerValue(parameter, lower)
          new TypeConstraint(body, Tuples.flatTupleOf(var_parameter), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://www.nomagic.com/magicdraw/UML/2.5.1", "Parameter")));
