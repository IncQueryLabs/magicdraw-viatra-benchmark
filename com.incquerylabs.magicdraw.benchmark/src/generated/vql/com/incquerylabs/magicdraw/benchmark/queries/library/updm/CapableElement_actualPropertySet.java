...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement;
...
public final class CapableElement_actualPropertySet extends BaseGeneratedEMFQuerySpecification<CapableElement_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapableElement_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public CapableElement_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapableElement_actualPropertySet.Match)) {
          CapableElement_actualPropertySet.Match other = (CapableElement_actualPropertySet.Match) obj;
    ...
    @Override
    public CapableElement_actualPropertySet specification() {
      return CapableElement_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static CapableElement_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapableElement_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapableElement_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapableElement_actualPropertySet.Match {
    ...
    private static final class Immutable extends CapableElement_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapableElement_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see CapableElement_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<CapableElement_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static CapableElement_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapableElement_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapableElement_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<CapableElement_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapableElement_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapableElement_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapableElement_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public CapableElement_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapableElement_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapableElement_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapableElement_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapableElement_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapableElement_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected CapableElement_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return CapableElement_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapableElement_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return CapableElement_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapableElement_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapableElement_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapableElement_actualPropertySet.Matcher> querySpecification() {
      return CapableElement_actualPropertySet.instance();
    }
  }
  
  private CapableElement_actualPropertySet() {
   ...
   * 
   */
  public static CapableElement_actualPropertySet instance() {
    try{
  ...
  @Override
  protected CapableElement_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapableElement_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public CapableElement_actualPropertySet.Matcher instantiate() {
    return CapableElement_actualPropertySet.Matcher.create();
  }
  
  @Override
  public CapableElement_actualPropertySet.Match newEmptyMatch() {
    return CapableElement_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public CapableElement_actualPropertySet.Match newMatch(final Object... parameters) {
    return CapableElement_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapableElement_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapableElement_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapableElement_actualPropertySet INSTANCE = new CapableElement_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapableElement_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find CapableElement(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), CapableElement.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
