...
public final class Classes extends BaseGeneratedEMFQuerySpecification<Classes.Matcher> {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.magicdraw.benchmark.queries.Classes (visibility: PUBLIC, simpleName: Classes, identifier: com.incquerylabs.magicdraw.benchmark.queries.Classes, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.magicdraw.benchmark.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
