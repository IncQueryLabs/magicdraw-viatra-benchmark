...
public final class ExtendedRequirement_Derived extends BaseGeneratedEMFQuerySpecification<ExtendedRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExtendedRequirement_Derived.Match.parameterNames;
    }
    ...
    @Override
    public ExtendedRequirement_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExtendedRequirement_Derived.Match)) {
          ExtendedRequirement_Derived.Match other = (ExtendedRequirement_Derived.Match) obj;
    ...
    @Override
    public ExtendedRequirement_Derived specification() {
     ...
     * 
     */
    public static ExtendedRequirement_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExtendedRequirement_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExtendedRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExtendedRequirement_Derived.Match {
    ...
    private static final class Immutable extends ExtendedRequirement_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.extendedRequirement_Derived pattern,
   ...
   * 
   * @see Match
   * @see ExtendedRequirement_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<ExtendedRequirement_Derived.Match> {
    /**
     ...
     * 
     */
    public static ExtendedRequirement_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExtendedRequirement_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExtendedRequirement_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<ExtendedRequirement_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExtendedRequirement_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExtendedRequirement_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExtendedRequirement_Derived.Match> processor) {
     ...
     * 
     */
    public ExtendedRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExtendedRequirement_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final ExtendedRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final ExtendedRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final ExtendedRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final ExtendedRequirement_Derived.Match partialMatch) {
    ...
    @Override
    protected ExtendedRequirement_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return ExtendedRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExtendedRequirement_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return ExtendedRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExtendedRequirement_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExtendedRequirement_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExtendedRequirement_Derived.Matcher> querySpecification() {
      return ExtendedRequirement_Derived.instance();
    }
  }
  
  private ExtendedRequirement_Derived() {
   ...
   * 
   */
  public static ExtendedRequirement_Derived instance() {
    try{
  ...
  @Override
  protected ExtendedRequirement_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExtendedRequirement_Derived.Matcher.on(engine);
  }
  
  @Override
  public ExtendedRequirement_Derived.Matcher instantiate() {
    return ExtendedRequirement_Derived.Matcher.create();
  }
  
  @Override
  public ExtendedRequirement_Derived.Match newEmptyMatch() {
    return ExtendedRequirement_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public ExtendedRequirement_Derived.Match newMatch(final Object... parameters) {
    return ExtendedRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExtendedRequirement_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExtendedRequirement_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExtendedRequirement_Derived INSTANCE = new ExtendedRequirement_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExtendedRequirement_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
