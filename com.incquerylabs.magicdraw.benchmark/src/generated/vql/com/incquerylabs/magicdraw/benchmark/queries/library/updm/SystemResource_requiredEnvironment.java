...
public final class SystemResource_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<SystemResource_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return SystemResource_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public SystemResource_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SystemResource_requiredEnvironment.Match)) {
          SystemResource_requiredEnvironment.Match other = (SystemResource_requiredEnvironment.Match) obj;
    ...
    @Override
    public SystemResource_requiredEnvironment specification() {
      return SystemResource_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static SystemResource_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static SystemResource_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SystemResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SystemResource_requiredEnvironment.Match {
    ...
    private static final class Immutable extends SystemResource_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SystemResource_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see SystemResource_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<SystemResource_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static SystemResource_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SystemResource_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SystemResource_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<SystemResource_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SystemResource_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SystemResource_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SystemResource_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public SystemResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SystemResource_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SystemResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SystemResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SystemResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SystemResource_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected SystemResource_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return SystemResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SystemResource_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return SystemResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SystemResource_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SystemResource_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SystemResource_requiredEnvironment.Matcher> querySpecification() {
      return SystemResource_requiredEnvironment.instance();
    }
  }
  
  private SystemResource_requiredEnvironment() {
   ...
   * 
   */
  public static SystemResource_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected SystemResource_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return SystemResource_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public SystemResource_requiredEnvironment.Matcher instantiate() {
    return SystemResource_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public SystemResource_requiredEnvironment.Match newEmptyMatch() {
    return SystemResource_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public SystemResource_requiredEnvironment.Match newMatch(final Object... parameters) {
    return SystemResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SystemResource_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SystemResource_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SystemResource_requiredEnvironment INSTANCE = new SystemResource_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SystemResource_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find SystemResource(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), SystemResource.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
