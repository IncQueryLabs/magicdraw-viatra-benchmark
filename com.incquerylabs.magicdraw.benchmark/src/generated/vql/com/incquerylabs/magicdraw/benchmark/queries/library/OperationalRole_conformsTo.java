...
public final class OperationalRole_conformsTo extends BaseGeneratedEMFQuerySpecification<OperationalRole_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalRole_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public OperationalRole_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalRole_conformsTo.Match)) {
          OperationalRole_conformsTo.Match other = (OperationalRole_conformsTo.Match) obj;
    ...
    @Override
    public OperationalRole_conformsTo specification() {
      return OperationalRole_conformsTo.instance();
    }
     ...
     * 
     */
    public static OperationalRole_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalRole_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalRole_conformsTo.Match {
    ...
    private static final class Immutable extends OperationalRole_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalRole_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see OperationalRole_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalRole_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static OperationalRole_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalRole_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalRole_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalRole_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalRole_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalRole_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super OperationalRole_conformsTo.Match> processor) {
     ...
     * 
     */
    public OperationalRole_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return OperationalRole_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final OperationalRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final OperationalRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalRole_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalRole_conformsTo.Match partialMatch) {
    ...
    @Override
    protected OperationalRole_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalRole_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalRole_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalRole_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalRole_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalRole_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalRole_conformsTo.Matcher> querySpecification() {
      return OperationalRole_conformsTo.instance();
    }
  }
  
  private OperationalRole_conformsTo() {
   ...
   * 
   */
  public static OperationalRole_conformsTo instance() {
    try{
  ...
  @Override
  protected OperationalRole_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalRole_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public OperationalRole_conformsTo.Matcher instantiate() {
    return OperationalRole_conformsTo.Matcher.create();
  }
  
  @Override
  public OperationalRole_conformsTo.Match newEmptyMatch() {
    return OperationalRole_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalRole_conformsTo.Match newMatch(final Object... parameters) {
    return OperationalRole_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalRole_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalRole_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalRole_conformsTo INSTANCE = new OperationalRole_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalRole_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
