...
public final class Measurement_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Measurement_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Measurement_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Measurement_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Measurement_endBoundaryType.Match)) {
          Measurement_endBoundaryType.Match other = (Measurement_endBoundaryType.Match) obj;
    ...
    @Override
    public Measurement_endBoundaryType specification() {
      return Measurement_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Measurement_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Measurement_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static Measurement_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Measurement_endBoundaryType.Match {
    ...
    private static final class Immutable extends Measurement_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Measurement_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Measurement_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Measurement_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Measurement_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Measurement_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Measurement_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Measurement_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Measurement_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Measurement_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super Measurement_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Measurement_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return Measurement_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Measurement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Measurement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Measurement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Measurement_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Measurement_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Measurement_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Measurement_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Measurement_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Measurement_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Measurement_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Measurement_endBoundaryType.Matcher> querySpecification() {
      return Measurement_endBoundaryType.instance();
    }
  }
  
  private Measurement_endBoundaryType() {
   ...
   * 
   */
  public static Measurement_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Measurement_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Measurement_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Measurement_endBoundaryType.Matcher instantiate() {
    return Measurement_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Measurement_endBoundaryType.Match newEmptyMatch() {
    return Measurement_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Measurement_endBoundaryType.Match newMatch(final Object... parameters) {
    return Measurement_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Measurement_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Measurement_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Measurement_endBoundaryType INSTANCE = new Measurement_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Measurement_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
