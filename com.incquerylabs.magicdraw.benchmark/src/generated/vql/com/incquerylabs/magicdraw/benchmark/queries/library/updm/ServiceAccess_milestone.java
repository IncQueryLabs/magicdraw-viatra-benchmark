...
public final class ServiceAccess_milestone extends BaseGeneratedEMFQuerySpecification<ServiceAccess_milestone.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_milestone pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_milestone";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceAccess_milestone.Match.parameterNames;
    }
    ...
    @Override
    public ServiceAccess_milestone.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceAccess_milestone.Match)) {
          ServiceAccess_milestone.Match other = (ServiceAccess_milestone.Match) obj;
    ...
    @Override
    public ServiceAccess_milestone specification() {
      return ServiceAccess_milestone.instance();
    }
     ...
     * 
     */
    public static ServiceAccess_milestone.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceAccess_milestone.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ServiceAccess_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ServiceAccess_milestone.Match {
    ...
    private static final class Immutable extends ServiceAccess_milestone.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceAccess_milestone pattern,
   ...
   * 
   * @see Match
   * @see ServiceAccess_milestone
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceAccess_milestone.Match> {
    /**
     ...
     * 
     */
    public static ServiceAccess_milestone.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceAccess_milestone.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceAccess_milestone.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceAccess_milestone.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ServiceAccess_milestone.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ServiceAccess_milestone.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ServiceAccess_milestone.Match> processor) {
     ...
     * 
     */
    public ServiceAccess_milestone.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ServiceAccess_milestone.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ServiceAccess_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ServiceAccess_milestone.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ServiceAccess_milestone.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ServiceAccess_milestone.Match partialMatch) {
    ...
    @Override
    protected ServiceAccess_milestone.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceAccess_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ServiceAccess_milestone.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceAccess_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceAccess_milestone.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceAccess_milestone.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceAccess_milestone.Matcher> querySpecification() {
      return ServiceAccess_milestone.instance();
    }
  }
  
  private ServiceAccess_milestone() {
   ...
   * 
   */
  public static ServiceAccess_milestone instance() {
    try{
  ...
  @Override
  protected ServiceAccess_milestone.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceAccess_milestone.Matcher.on(engine);
  }
  
  @Override
  public ServiceAccess_milestone.Matcher instantiate() {
    return ServiceAccess_milestone.Matcher.create();
  }
  
  @Override
  public ServiceAccess_milestone.Match newEmptyMatch() {
    return ServiceAccess_milestone.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceAccess_milestone.Match newMatch(final Object... parameters) {
    return ServiceAccess_milestone.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceAccess_milestone} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceAccess_milestone#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceAccess_milestone INSTANCE = new ServiceAccess_milestone();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceAccess_milestone.GeneratedPQuery INSTANCE = new GeneratedPQuery();
