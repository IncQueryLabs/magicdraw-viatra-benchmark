...
public final class Energy_conformsTo extends BaseGeneratedEMFQuerySpecification<Energy_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public Energy_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_conformsTo.Match)) {
          Energy_conformsTo.Match other = (Energy_conformsTo.Match) obj;
    ...
    @Override
    public Energy_conformsTo specification() {
      return Energy_conformsTo.instance();
    }
     ...
     * 
     */
    public static Energy_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_conformsTo.Match {
    ...
    private static final class Immutable extends Energy_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see Energy_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static Energy_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_conformsTo.Match> processor) {
     ...
     * 
     */
    public Energy_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_conformsTo.Match partialMatch) {
    ...
    @Override
    protected Energy_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_conformsTo.Matcher> querySpecification() {
      return Energy_conformsTo.instance();
    }
  }
  
  private Energy_conformsTo() {
   ...
   * 
   */
  public static Energy_conformsTo instance() {
    try{
  ...
  @Override
  protected Energy_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public Energy_conformsTo.Matcher instantiate() {
    return Energy_conformsTo.Matcher.create();
  }
  
  @Override
  public Energy_conformsTo.Match newEmptyMatch() {
    return Energy_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_conformsTo.Match newMatch(final Object... parameters) {
    return Energy_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_conformsTo INSTANCE = new Energy_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
