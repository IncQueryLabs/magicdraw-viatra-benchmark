...
public final class Exchange_URI extends BaseGeneratedEMFQuerySpecification<Exchange_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Exchange_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Exchange_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Exchange_URI.Match.parameterNames;
    }
    ...
    @Override
    public Exchange_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Exchange_URI.Match)) {
          Exchange_URI.Match other = (Exchange_URI.Match) obj;
    ...
    @Override
    public Exchange_URI specification() {
      return Exchange_URI.instance();
    }
     ...
     * 
     */
    public static Exchange_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Exchange_URI.Match newMutableMatch(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Exchange_URI.Match newMatch(final InformationFlow pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Exchange_URI.Match {
    ...
    private static final class Immutable extends Exchange_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Exchange_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Exchange_URI.Match> {
    /**
     ...
     * 
     */
    public static Exchange_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Exchange_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Exchange_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Exchange_URI.Match> getAllMatches(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Exchange_URI.Match> streamAllMatches(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Exchange_URI.Match> getOneArbitraryMatch(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final LiteralString pValuespec, final Consumer<? super Exchange_URI.Match> processor) {
     ...
     * 
     */
    public Exchange_URI.Match newMatch(final InformationFlow pElement, final LiteralString pValuespec) {
      return Exchange_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Exchange_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Exchange_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Exchange_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Exchange_URI.Match partialMatch) {
    ...
    @Override
    protected Exchange_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Exchange_URI.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Exchange_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Exchange_URI.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Exchange_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Exchange_URI.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Exchange_URI.Matcher> querySpecification() {
      return Exchange_URI.instance();
    }
  }
  
  private Exchange_URI() {
   ...
   * 
   */
  public static Exchange_URI instance() {
    try{
  ...
  @Override
  protected Exchange_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Exchange_URI.Matcher.on(engine);
  }
  
  @Override
  public Exchange_URI.Matcher instantiate() {
    return Exchange_URI.Matcher.create();
  }
  
  @Override
  public Exchange_URI.Match newEmptyMatch() {
    return Exchange_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Exchange_URI.Match newMatch(final Object... parameters) {
    return Exchange_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Exchange_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Exchange_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Exchange_URI INSTANCE = new Exchange_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Exchange_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
