...
public final class Node_URI extends BaseGeneratedEMFQuerySpecification<Node_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_URI.Match.parameterNames;
    }
    ...
    @Override
    public Node_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_URI.Match)) {
          Node_URI.Match other = (Node_URI.Match) obj;
    ...
    @Override
    public Node_URI specification() {
      return Node_URI.instance();
    }
     ...
     * 
     */
    public static Node_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Node_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Node_URI.Match {
    ...
    private static final class Immutable extends Node_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Node_URI.Match> {
    /**
     ...
     * 
     */
    public static Node_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Node_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Node_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Node_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Node_URI.Match> processor) {
     ...
     * 
     */
    public Node_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Node_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Node_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Node_URI.Match partialMatch) {
    ...
    @Override
    protected Node_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Node_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Node_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Node_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_URI.Matcher> querySpecification() {
      return Node_URI.instance();
    }
  }
   ...
   * 
   */
  public static Node_URI instance() {
    try{
  ...
  @Override
  protected Node_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_URI.Matcher.on(engine);
  }
  
  @Override
  public Node_URI.Matcher instantiate() {
    return Node_URI.Matcher.create();
  }
  
  @Override
  public Node_URI.Match newEmptyMatch() {
    return Node_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Node_URI.Match newMatch(final Object... parameters) {
    return Node_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_URI INSTANCE = new Node_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
