...
public final class EnterpriseGoal_Master extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_Master.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Master pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Master";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_Master.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_Master.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_Master.Match)) {
          EnterpriseGoal_Master.Match other = (EnterpriseGoal_Master.Match) obj;
    ...
    @Override
    public EnterpriseGoal_Master specification() {
      return EnterpriseGoal_Master.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_Master.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_Master.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterpriseGoal_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterpriseGoal_Master.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_Master.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterpriseGoal_Master pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_Master
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_Master.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_Master.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_Master.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_Master.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_Master.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_Master.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_Master.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterpriseGoal_Master.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_Master.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterpriseGoal_Master.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_Master.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterpriseGoal_Master.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterpriseGoal_Master.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_Master.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterpriseGoal_Master.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_Master.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_Master.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_Master.Matcher> querySpecification() {
      return EnterpriseGoal_Master.instance();
    }
  }
  
  private EnterpriseGoal_Master() {
   ...
   * 
   */
  public static EnterpriseGoal_Master instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_Master.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_Master.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_Master.Matcher instantiate() {
    return EnterpriseGoal_Master.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_Master.Match newEmptyMatch() {
    return EnterpriseGoal_Master.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_Master.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_Master.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_Master} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_Master#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_Master INSTANCE = new EnterpriseGoal_Master();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_Master.GeneratedPQuery INSTANCE = new GeneratedPQuery();
