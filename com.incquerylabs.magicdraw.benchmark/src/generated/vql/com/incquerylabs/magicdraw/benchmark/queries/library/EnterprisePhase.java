...
public final class EnterprisePhase extends BaseGeneratedEMFQuerySpecification<EnterprisePhase.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterprisePhase pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnterprisePhase";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase.Match)) {
          EnterprisePhase.Match other = (EnterprisePhase.Match) obj;
    ...
    @Override
    public EnterprisePhase specification() {
      return EnterprisePhase.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static EnterprisePhase.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends EnterprisePhase.Match {
    ...
    private static final class Immutable extends EnterprisePhase.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnterprisePhase pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<EnterprisePhase.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<EnterprisePhase.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super EnterprisePhase.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return EnterprisePhase.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final EnterprisePhase.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final EnterprisePhase.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected EnterprisePhase.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase.Matcher> querySpecification() {
      return EnterprisePhase.instance();
    }
  }
  
  private EnterprisePhase() {
   ...
   * 
   */
  public static EnterprisePhase instance() {
    try{
  ...
  @Override
  protected EnterprisePhase.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase.Matcher instantiate() {
    return EnterprisePhase.Matcher.create();
  }
  
  @Override
  public EnterprisePhase.Match newEmptyMatch() {
    return EnterprisePhase.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase.Match newMatch(final Object... parameters) {
    return EnterprisePhase.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase INSTANCE = new EnterprisePhase();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "EnterprisePhase")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "EnterprisePhase");
