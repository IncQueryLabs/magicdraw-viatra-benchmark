...
public final class ProblemDomain_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<ProblemDomain_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_requiredEnvironment.Match)) {
          ProblemDomain_requiredEnvironment.Match other = (ProblemDomain_requiredEnvironment.Match) obj;
    ...
    @Override
    public ProblemDomain_requiredEnvironment specification() {
      return ProblemDomain_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_requiredEnvironment.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_requiredEnvironment.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_requiredEnvironment.Match {
    ...
    private static final class Immutable extends ProblemDomain_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_requiredEnvironment.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_requiredEnvironment.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_requiredEnvironment.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_requiredEnvironment.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_requiredEnvironment.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_requiredEnvironment.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_requiredEnvironment.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_requiredEnvironment.Matcher> querySpecification() {
      return ProblemDomain_requiredEnvironment.instance();
    }
  }
  
  private ProblemDomain_requiredEnvironment() {
   ...
   * 
   */
  public static ProblemDomain_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected ProblemDomain_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_requiredEnvironment.Matcher instantiate() {
    return ProblemDomain_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public ProblemDomain_requiredEnvironment.Match newEmptyMatch() {
    return ProblemDomain_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_requiredEnvironment.Match newMatch(final Object... parameters) {
    return ProblemDomain_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_requiredEnvironment INSTANCE = new ProblemDomain_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
