...
public final class HighLevelOperationalConcept_startBoundaryType extends BaseGeneratedEMFQuerySpecification<HighLevelOperationalConcept_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return HighLevelOperationalConcept_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public HighLevelOperationalConcept_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof HighLevelOperationalConcept_startBoundaryType.Match)) {
          HighLevelOperationalConcept_startBoundaryType.Match other = (HighLevelOperationalConcept_startBoundaryType.Match) obj;
    ...
    @Override
    public HighLevelOperationalConcept_startBoundaryType specification() {
      return HighLevelOperationalConcept_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static HighLevelOperationalConcept_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static HighLevelOperationalConcept_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends HighLevelOperationalConcept_startBoundaryType.Match {
    ...
    private static final class Immutable extends HighLevelOperationalConcept_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see HighLevelOperationalConcept_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<HighLevelOperationalConcept_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static HighLevelOperationalConcept_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(HighLevelOperationalConcept_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<HighLevelOperationalConcept_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<HighLevelOperationalConcept_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<HighLevelOperationalConcept_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super HighLevelOperationalConcept_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public HighLevelOperationalConcept_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return HighLevelOperationalConcept_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final HighLevelOperationalConcept_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final HighLevelOperationalConcept_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final HighLevelOperationalConcept_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final HighLevelOperationalConcept_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected HighLevelOperationalConcept_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return HighLevelOperationalConcept_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected HighLevelOperationalConcept_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return HighLevelOperationalConcept_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected HighLevelOperationalConcept_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return HighLevelOperationalConcept_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<HighLevelOperationalConcept_startBoundaryType.Matcher> querySpecification() {
      return HighLevelOperationalConcept_startBoundaryType.instance();
    }
  }
  
  private HighLevelOperationalConcept_startBoundaryType() {
   ...
   * 
   */
  public static HighLevelOperationalConcept_startBoundaryType instance() {
    try{
  ...
  @Override
  protected HighLevelOperationalConcept_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return HighLevelOperationalConcept_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public HighLevelOperationalConcept_startBoundaryType.Matcher instantiate() {
    return HighLevelOperationalConcept_startBoundaryType.Matcher.create();
  }
  
  @Override
  public HighLevelOperationalConcept_startBoundaryType.Match newEmptyMatch() {
    return HighLevelOperationalConcept_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public HighLevelOperationalConcept_startBoundaryType.Match newMatch(final Object... parameters) {
    return HighLevelOperationalConcept_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link HighLevelOperationalConcept_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link HighLevelOperationalConcept_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final HighLevelOperationalConcept_startBoundaryType INSTANCE = new HighLevelOperationalConcept_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final HighLevelOperationalConcept_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
