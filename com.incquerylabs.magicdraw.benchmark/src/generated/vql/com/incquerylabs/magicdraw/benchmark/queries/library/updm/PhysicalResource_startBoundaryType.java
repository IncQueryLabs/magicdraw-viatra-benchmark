...
public final class PhysicalResource_startBoundaryType extends BaseGeneratedEMFQuerySpecification<PhysicalResource_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_startBoundaryType.Match)) {
          PhysicalResource_startBoundaryType.Match other = (PhysicalResource_startBoundaryType.Match) obj;
    ...
    @Override
    public PhysicalResource_startBoundaryType specification() {
      return PhysicalResource_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_startBoundaryType.Match {
    ...
    private static final class Immutable extends PhysicalResource_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PhysicalResource_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_startBoundaryType.Matcher> querySpecification() {
      return PhysicalResource_startBoundaryType.instance();
    }
  }
  
  private PhysicalResource_startBoundaryType() {
   ...
   * 
   */
  public static PhysicalResource_startBoundaryType instance() {
    try{
  ...
  @Override
  protected PhysicalResource_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_startBoundaryType.Matcher instantiate() {
    return PhysicalResource_startBoundaryType.Matcher.create();
  }
  
  @Override
  public PhysicalResource_startBoundaryType.Match newEmptyMatch() {
    return PhysicalResource_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_startBoundaryType.Match newMatch(final Object... parameters) {
    return PhysicalResource_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_startBoundaryType INSTANCE = new PhysicalResource_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
