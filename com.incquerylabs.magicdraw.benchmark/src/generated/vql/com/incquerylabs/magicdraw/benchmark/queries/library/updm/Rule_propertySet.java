...
public final class Rule_propertySet extends BaseGeneratedEMFQuerySpecification<Rule_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return Rule_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public Rule_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Rule_propertySet.Match)) {
          Rule_propertySet.Match other = (Rule_propertySet.Match) obj;
    ...
    @Override
    public Rule_propertySet specification() {
      return Rule_propertySet.instance();
    }
     ...
     * 
     */
    public static Rule_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static Rule_propertySet.Match newMutableMatch(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public static Rule_propertySet.Match newMatch(final Element pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Rule_propertySet.Match {
    ...
    private static final class Immutable extends Rule_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Rule_propertySet pattern,
   ...
   * 
   * @see Match
   * @see Rule_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<Rule_propertySet.Match> {
    /**
     ...
     * 
     */
    public static Rule_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Rule_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Rule_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<Rule_propertySet.Match> getAllMatches(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Rule_propertySet.Match> streamAllMatches(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Rule_propertySet.Match> getOneArbitraryMatch(final Element pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final Element pValue, final Consumer<? super Rule_propertySet.Match> processor) {
     ...
     * 
     */
    public Rule_propertySet.Match newMatch(final Element pElement, final Element pValue) {
      return Rule_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final Rule_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final Rule_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Rule_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Rule_propertySet.Match partialMatch) {
    ...
    @Override
    protected Rule_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return Rule_propertySet.Match.newMatch((Element) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Rule_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return Rule_propertySet.Match.newMatch((Element) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Rule_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Rule_propertySet.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Rule_propertySet.Matcher> querySpecification() {
      return Rule_propertySet.instance();
    }
  }
  
  private Rule_propertySet() {
   ...
   * 
   */
  public static Rule_propertySet instance() {
    try{
  ...
  @Override
  protected Rule_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return Rule_propertySet.Matcher.on(engine);
  }
  
  @Override
  public Rule_propertySet.Matcher instantiate() {
    return Rule_propertySet.Matcher.create();
  }
  
  @Override
  public Rule_propertySet.Match newEmptyMatch() {
    return Rule_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public Rule_propertySet.Match newMatch(final Object... parameters) {
    return Rule_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Rule_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Rule_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Rule_propertySet INSTANCE = new Rule_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Rule_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
