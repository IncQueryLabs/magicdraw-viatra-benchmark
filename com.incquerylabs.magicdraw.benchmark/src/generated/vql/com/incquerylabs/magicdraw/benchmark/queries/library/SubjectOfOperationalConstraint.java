...
public final class SubjectOfOperationalConstraint extends BaseGeneratedEMFQuerySpecification<SubjectOfOperationalConstraint.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfOperationalConstraint pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfOperationalConstraint";
    }
    
    @Override
    public List<String> parameterNames() {
      return SubjectOfOperationalConstraint.Match.parameterNames;
    }
    ...
    @Override
    public SubjectOfOperationalConstraint.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SubjectOfOperationalConstraint.Match)) {
          SubjectOfOperationalConstraint.Match other = (SubjectOfOperationalConstraint.Match) obj;
    ...
    @Override
    public SubjectOfOperationalConstraint specification() {
      return SubjectOfOperationalConstraint.instance();
    }
     ...
     * 
     */
    public static SubjectOfOperationalConstraint.Match newEmptyMatch() {
     ...
     * 
     */
    public static SubjectOfOperationalConstraint.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SubjectOfOperationalConstraint.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SubjectOfOperationalConstraint.Match {
    ...
    private static final class Immutable extends SubjectOfOperationalConstraint.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SubjectOfOperationalConstraint pattern,
   ...
   * 
   * @see Match
   * @see SubjectOfOperationalConstraint
   * 
   */
  public static class Matcher extends BaseMatcher<SubjectOfOperationalConstraint.Match> {
    /**
     ...
     * 
     */
    public static SubjectOfOperationalConstraint.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SubjectOfOperationalConstraint.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SubjectOfOperationalConstraint.Matcher.class);
     ...
     * 
     */
    public Collection<SubjectOfOperationalConstraint.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SubjectOfOperationalConstraint.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SubjectOfOperationalConstraint.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SubjectOfOperationalConstraint.Match> processor) {
     ...
     * 
     */
    public SubjectOfOperationalConstraint.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SubjectOfOperationalConstraint.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final SubjectOfOperationalConstraint.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final SubjectOfOperationalConstraint.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SubjectOfOperationalConstraint.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SubjectOfOperationalConstraint.Match partialMatch) {
    ...
    @Override
    protected SubjectOfOperationalConstraint.Match tupleToMatch(final Tuple t) {
      try {
          return SubjectOfOperationalConstraint.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SubjectOfOperationalConstraint.Match arrayToMatch(final Object[] match) {
      try {
          return SubjectOfOperationalConstraint.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SubjectOfOperationalConstraint.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SubjectOfOperationalConstraint.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SubjectOfOperationalConstraint.Matcher> querySpecification() {
      return SubjectOfOperationalConstraint.instance();
    }
  }
  
  private SubjectOfOperationalConstraint() {
   ...
   * 
   */
  public static SubjectOfOperationalConstraint instance() {
    try{
  ...
  @Override
  protected SubjectOfOperationalConstraint.Matcher instantiate(final ViatraQueryEngine engine) {
    return SubjectOfOperationalConstraint.Matcher.on(engine);
  }
  
  @Override
  public SubjectOfOperationalConstraint.Matcher instantiate() {
    return SubjectOfOperationalConstraint.Matcher.create();
  }
  
  @Override
  public SubjectOfOperationalConstraint.Match newEmptyMatch() {
    return SubjectOfOperationalConstraint.Match.newEmptyMatch();
  }
  
  @Override
  public SubjectOfOperationalConstraint.Match newMatch(final Object... parameters) {
    return SubjectOfOperationalConstraint.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SubjectOfOperationalConstraint} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SubjectOfOperationalConstraint#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SubjectOfOperationalConstraint INSTANCE = new SubjectOfOperationalConstraint();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SubjectOfOperationalConstraint.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "SubjectOfOperationalConstraint")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "SubjectOfOperationalConstraint");
