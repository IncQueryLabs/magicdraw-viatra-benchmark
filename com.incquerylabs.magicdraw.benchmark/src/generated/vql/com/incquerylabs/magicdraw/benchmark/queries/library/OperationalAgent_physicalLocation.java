...
public final class OperationalAgent_physicalLocation extends BaseGeneratedEMFQuerySpecification<OperationalAgent_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalAgent_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public OperationalAgent_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalAgent_physicalLocation.Match)) {
          OperationalAgent_physicalLocation.Match other = (OperationalAgent_physicalLocation.Match) obj;
    ...
    @Override
    public OperationalAgent_physicalLocation specification() {
      return OperationalAgent_physicalLocation.instance();
    }
     ...
     * 
     */
    public static OperationalAgent_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalAgent_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OperationalAgent_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OperationalAgent_physicalLocation.Match {
    ...
    private static final class Immutable extends OperationalAgent_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalAgent_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see OperationalAgent_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalAgent_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static OperationalAgent_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalAgent_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalAgent_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalAgent_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OperationalAgent_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OperationalAgent_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OperationalAgent_physicalLocation.Match> processor) {
     ...
     * 
     */
    public OperationalAgent_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OperationalAgent_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalAgent_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalAgent_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OperationalAgent_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OperationalAgent_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected OperationalAgent_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalAgent_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OperationalAgent_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalAgent_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalAgent_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalAgent_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalAgent_physicalLocation.Matcher> querySpecification() {
      return OperationalAgent_physicalLocation.instance();
    }
  }
  
  private OperationalAgent_physicalLocation() {
   ...
   * 
   */
  public static OperationalAgent_physicalLocation instance() {
    try{
  ...
  @Override
  protected OperationalAgent_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalAgent_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public OperationalAgent_physicalLocation.Matcher instantiate() {
    return OperationalAgent_physicalLocation.Matcher.create();
  }
  
  @Override
  public OperationalAgent_physicalLocation.Match newEmptyMatch() {
    return OperationalAgent_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalAgent_physicalLocation.Match newMatch(final Object... parameters) {
    return OperationalAgent_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalAgent_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalAgent_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalAgent_physicalLocation INSTANCE = new OperationalAgent_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalAgent_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
