...
public final class OrganizationType_physicalLocation extends BaseGeneratedEMFQuerySpecification<OrganizationType_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_physicalLocation.Match)) {
          OrganizationType_physicalLocation.Match other = (OrganizationType_physicalLocation.Match) obj;
    ...
    @Override
    public OrganizationType_physicalLocation specification() {
      return OrganizationType_physicalLocation.instance();
    }
     ...
     * 
     */
    public static OrganizationType_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_physicalLocation.Match {
    ...
    private static final class Immutable extends OrganizationType_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_physicalLocation.Match> processor) {
     ...
     * 
     */
    public OrganizationType_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_physicalLocation.Matcher> querySpecification() {
      return OrganizationType_physicalLocation.instance();
    }
  }
  
  private OrganizationType_physicalLocation() {
   ...
   * 
   */
  public static OrganizationType_physicalLocation instance() {
    try{
  ...
  @Override
  protected OrganizationType_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_physicalLocation.Matcher instantiate() {
    return OrganizationType_physicalLocation.Matcher.create();
  }
  
  @Override
  public OrganizationType_physicalLocation.Match newEmptyMatch() {
    return OrganizationType_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_physicalLocation.Match newMatch(final Object... parameters) {
    return OrganizationType_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_physicalLocation INSTANCE = new OrganizationType_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
