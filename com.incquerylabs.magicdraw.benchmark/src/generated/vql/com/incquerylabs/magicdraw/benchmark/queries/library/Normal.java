 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "Normal");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Normal extends BaseGeneratedEMFQuerySpecification<Normal.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Normal pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Normal";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Normal pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Normal} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Normal#instance()}.
   * 
