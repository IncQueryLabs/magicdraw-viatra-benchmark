...
public final class ServiceFeature extends BaseGeneratedEMFQuerySpecification<ServiceFeature.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceFeature pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceFeature";
    }
    
    @Override
    public List<String> parameterNames() {
      return ServiceFeature.Match.parameterNames;
    }
    ...
    @Override
    public ServiceFeature.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ServiceFeature.Match)) {
          ServiceFeature.Match other = (ServiceFeature.Match) obj;
    ...
    @Override
    public ServiceFeature specification() {
      return ServiceFeature.instance();
    }
     ...
     * 
     */
    public static ServiceFeature.Match newEmptyMatch() {
     ...
     * 
     */
    public static ServiceFeature.Match newMutableMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ServiceFeature.Match newMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ServiceFeature.Match {
    ...
    private static final class Immutable extends ServiceFeature.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ServiceFeature pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ServiceFeature.Match> {
    /**
     ...
     * 
     */
    public static ServiceFeature.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ServiceFeature.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ServiceFeature.Matcher.class);
     ...
     * 
     */
    public Collection<ServiceFeature.Match> getAllMatches(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ServiceFeature.Match> streamAllMatches(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ServiceFeature.Match> getOneArbitraryMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ServiceFeature.Match> processor) {
     ...
     * 
     */
    public ServiceFeature.Match newMatch(final Feature pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ServiceFeature.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Feature> streamAllValuesOfelement(final ServiceFeature.Match partialMatch) {
     ...
     * 
     */
    public Set<Feature> getAllValuesOfelement(final ServiceFeature.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ServiceFeature.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ServiceFeature.Match partialMatch) {
    ...
    @Override
    protected ServiceFeature.Match tupleToMatch(final Tuple t) {
      try {
          return ServiceFeature.Match.newMatch((Feature) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ServiceFeature.Match arrayToMatch(final Object[] match) {
      try {
          return ServiceFeature.Match.newMatch((Feature) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ServiceFeature.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ServiceFeature.Match.newMutableMatch((Feature) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ServiceFeature.Matcher> querySpecification() {
      return ServiceFeature.instance();
    }
  }
   ...
   * 
   */
  public static ServiceFeature instance() {
    try{
  ...
  @Override
  protected ServiceFeature.Matcher instantiate(final ViatraQueryEngine engine) {
    return ServiceFeature.Matcher.on(engine);
  }
  
  @Override
  public ServiceFeature.Matcher instantiate() {
    return ServiceFeature.Matcher.create();
  }
  
  @Override
  public ServiceFeature.Match newEmptyMatch() {
    return ServiceFeature.Match.newEmptyMatch();
  }
  
  @Override
  public ServiceFeature.Match newMatch(final Object... parameters) {
    return ServiceFeature.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Feature) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ServiceFeature} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ServiceFeature#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ServiceFeature INSTANCE = new ServiceFeature();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ServiceFeature.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ServiceFeature");
