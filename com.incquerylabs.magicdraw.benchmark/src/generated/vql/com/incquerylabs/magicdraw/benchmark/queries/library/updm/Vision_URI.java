...
public final class Vision_URI extends BaseGeneratedEMFQuerySpecification<Vision_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Vision_URI.Match.parameterNames;
    }
    ...
    @Override
    public Vision_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Vision_URI.Match)) {
          Vision_URI.Match other = (Vision_URI.Match) obj;
    ...
    @Override
    public Vision_URI specification() {
      return Vision_URI.instance();
    }
     ...
     * 
     */
    public static Vision_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Vision_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Vision_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Vision_URI.Match {
    ...
    private static final class Immutable extends Vision_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Vision_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Vision_URI.Match> {
    /**
     ...
     * 
     */
    public static Vision_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Vision_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Vision_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Vision_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Vision_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Vision_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Vision_URI.Match> processor) {
     ...
     * 
     */
    public Vision_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Vision_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Vision_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Vision_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Vision_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Vision_URI.Match partialMatch) {
    ...
    @Override
    protected Vision_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Vision_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Vision_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Vision_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Vision_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Vision_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Vision_URI.Matcher> querySpecification() {
      return Vision_URI.instance();
    }
  }
   ...
   * 
   */
  public static Vision_URI instance() {
    try{
  ...
  @Override
  protected Vision_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Vision_URI.Matcher.on(engine);
  }
  
  @Override
  public Vision_URI.Matcher instantiate() {
    return Vision_URI.Matcher.create();
  }
  
  @Override
  public Vision_URI.Match newEmptyMatch() {
    return Vision_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Vision_URI.Match newMatch(final Object... parameters) {
    return Vision_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Vision_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Vision_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Vision_URI INSTANCE = new Vision_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Vision_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
