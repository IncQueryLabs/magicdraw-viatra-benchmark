...
public final class Risk_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Risk_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Risk_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Risk_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Risk_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Risk_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Risk_isEncapsulated.Match)) {
          Risk_isEncapsulated.Match other = (Risk_isEncapsulated.Match) obj;
    ...
    @Override
    public Risk_isEncapsulated specification() {
      return Risk_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Risk_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Risk_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Risk_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Risk_isEncapsulated.Match {
    ...
    private static final class Immutable extends Risk_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Risk_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Risk_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Risk_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Risk_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Risk_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Risk_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Risk_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Risk_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Risk_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Risk_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Risk_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Risk_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Risk_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Risk_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Risk_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Risk_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Risk_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Risk_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Risk_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Risk_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Risk_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Risk_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Risk_isEncapsulated.Matcher> querySpecification() {
      return Risk_isEncapsulated.instance();
    }
  }
  
  private Risk_isEncapsulated() {
   ...
   * 
   */
  public static Risk_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Risk_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Risk_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Risk_isEncapsulated.Matcher instantiate() {
    return Risk_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Risk_isEncapsulated.Match newEmptyMatch() {
    return Risk_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Risk_isEncapsulated.Match newMatch(final Object... parameters) {
    return Risk_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Risk_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Risk_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Risk_isEncapsulated INSTANCE = new Risk_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Risk_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Risk(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Risk.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
