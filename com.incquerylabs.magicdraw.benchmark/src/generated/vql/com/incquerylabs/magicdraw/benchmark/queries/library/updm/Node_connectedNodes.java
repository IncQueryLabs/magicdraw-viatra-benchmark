...
public final class Node_connectedNodes extends BaseGeneratedEMFQuerySpecification<Node_connectedNodes.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_connectedNodes pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_connectedNodes";
    }
    
    @Override
    public List<String> parameterNames() {
      return Node_connectedNodes.Match.parameterNames;
    }
    ...
    @Override
    public Node_connectedNodes.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Node_connectedNodes.Match)) {
          Node_connectedNodes.Match other = (Node_connectedNodes.Match) obj;
    ...
    @Override
    public Node_connectedNodes specification() {
      return Node_connectedNodes.instance();
    }
     ...
     * 
     */
    public static Node_connectedNodes.Match newEmptyMatch() {
     ...
     * 
     */
    public static Node_connectedNodes.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public static Node_connectedNodes.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Node_connectedNodes.Match {
    ...
    private static final class Immutable extends Node_connectedNodes.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Node_connectedNodes pattern,
   ...
   * 
   * @see Match
   * @see Node_connectedNodes
   * 
   */
  public static class Matcher extends BaseMatcher<Node_connectedNodes.Match> {
    /**
     ...
     * 
     */
    public static Node_connectedNodes.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Node_connectedNodes.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Node_connectedNodes.Matcher.class);
     ...
     * 
     */
    public Collection<Node_connectedNodes.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Stream<Node_connectedNodes.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public Optional<Node_connectedNodes.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue, final Consumer<? super Node_connectedNodes.Match> processor) {
     ...
     * 
     */
    public Node_connectedNodes.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pValue) {
      return Node_connectedNodes.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Node_connectedNodes.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Node_connectedNodes.Match partialMatch) {
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfvalue(final Node_connectedNodes.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfvalue(final Node_connectedNodes.Match partialMatch) {
    ...
    @Override
    protected Node_connectedNodes.Match tupleToMatch(final Tuple t) {
      try {
          return Node_connectedNodes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_VALUE));
    ...
    @Override
    protected Node_connectedNodes.Match arrayToMatch(final Object[] match) {
      try {
          return Node_connectedNodes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Node_connectedNodes.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Node_connectedNodes.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Node_connectedNodes.Matcher> querySpecification() {
      return Node_connectedNodes.instance();
    }
  }
  
  private Node_connectedNodes() {
   ...
   * 
   */
  public static Node_connectedNodes instance() {
    try{
  ...
  @Override
  protected Node_connectedNodes.Matcher instantiate(final ViatraQueryEngine engine) {
    return Node_connectedNodes.Matcher.on(engine);
  }
  
  @Override
  public Node_connectedNodes.Matcher instantiate() {
    return Node_connectedNodes.Matcher.create();
  }
  
  @Override
  public Node_connectedNodes.Match newEmptyMatch() {
    return Node_connectedNodes.Match.newEmptyMatch();
  }
  
  @Override
  public Node_connectedNodes.Match newMatch(final Object... parameters) {
    return Node_connectedNodes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Node_connectedNodes} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Node_connectedNodes#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Node_connectedNodes INSTANCE = new Node_connectedNodes();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Node_connectedNodes.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Node(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Node.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "connectedNodes", valuespec)
