...
public final class ProblemDomain_propertySet extends BaseGeneratedEMFQuerySpecification<ProblemDomain_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_propertySet.Match)) {
          ProblemDomain_propertySet.Match other = (ProblemDomain_propertySet.Match) obj;
    ...
    @Override
    public ProblemDomain_propertySet specification() {
      return ProblemDomain_propertySet.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_propertySet.Match {
    ...
    private static final class Immutable extends ProblemDomain_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_propertySet.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_propertySet.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_propertySet.Matcher> querySpecification() {
      return ProblemDomain_propertySet.instance();
    }
  }
  
  private ProblemDomain_propertySet() {
   ...
   * 
   */
  public static ProblemDomain_propertySet instance() {
    try{
  ...
  @Override
  protected ProblemDomain_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_propertySet.Matcher instantiate() {
    return ProblemDomain_propertySet.Matcher.create();
  }
  
  @Override
  public ProblemDomain_propertySet.Match newEmptyMatch() {
    return ProblemDomain_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_propertySet.Match newMatch(final Object... parameters) {
    return ProblemDomain_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_propertySet INSTANCE = new ProblemDomain_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
