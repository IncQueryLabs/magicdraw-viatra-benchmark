...
public final class Information extends BaseGeneratedEMFQuerySpecification<Information.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Information pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Information";
    }
    
    @Override
    public List<String> parameterNames() {
      return Information.Match.parameterNames;
    }
    ...
    @Override
    public Information.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Information.Match)) {
          Information.Match other = (Information.Match) obj;
     ...
     * 
     */
    public static Information.Match newEmptyMatch() {
     ...
     * 
     */
    public static Information.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Information.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Information.Match {
    ...
    private static final class Immutable extends Information.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Information pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Information.Match> {
    /**
     ...
     * 
     */
    public static Information.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Information.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Information.Matcher.class);
     ...
     * 
     */
    public Collection<Information.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Information.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Information.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Information.Match> processor) {
     ...
     * 
     */
    public Information.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Information.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final Information.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final Information.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Information.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Information.Match partialMatch) {
    ...
    @Override
    protected Information.Match tupleToMatch(final Tuple t) {
      try {
          return Information.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Information.Match arrayToMatch(final Object[] match) {
      try {
          return Information.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Information.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Information.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Information.Matcher> querySpecification() {
      return Information.instance();
    }
  }
  ...
  @Override
  protected Information.Matcher instantiate(final ViatraQueryEngine engine) {
    return Information.Matcher.on(engine);
  }
  
  @Override
  public Information.Matcher instantiate() {
    return Information.Matcher.create();
  }
  
  @Override
  public Information.Match newEmptyMatch() {
    return Information.Match.newEmptyMatch();
  }
  
  @Override
  public Information.Match newMatch(final Object... parameters) {
    return Information.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Information} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Information#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Information.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Information")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Information");
