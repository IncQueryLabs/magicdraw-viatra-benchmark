...
public final class System_endBoundaryType extends BaseGeneratedEMFQuerySpecification<System_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return System_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public System_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof System_endBoundaryType.Match)) {
          System_endBoundaryType.Match other = (System_endBoundaryType.Match) obj;
    ...
    @Override
    public System_endBoundaryType specification() {
      return System_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static System_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static System_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static System_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends System_endBoundaryType.Match {
    ...
    private static final class Immutable extends System_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.System_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see System_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<System_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static System_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static System_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(System_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<System_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<System_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<System_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super System_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public System_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return System_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final System_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final System_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final System_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final System_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected System_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return System_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected System_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return System_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected System_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return System_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<System_endBoundaryType.Matcher> querySpecification() {
      return System_endBoundaryType.instance();
    }
  }
  
  private System_endBoundaryType() {
   ...
   * 
   */
  public static System_endBoundaryType instance() {
    try{
  ...
  @Override
  protected System_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return System_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public System_endBoundaryType.Matcher instantiate() {
    return System_endBoundaryType.Matcher.create();
  }
  
  @Override
  public System_endBoundaryType.Match newEmptyMatch() {
    return System_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public System_endBoundaryType.Match newMatch(final Object... parameters) {
    return System_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link System_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link System_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final System_endBoundaryType INSTANCE = new System_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final System_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
