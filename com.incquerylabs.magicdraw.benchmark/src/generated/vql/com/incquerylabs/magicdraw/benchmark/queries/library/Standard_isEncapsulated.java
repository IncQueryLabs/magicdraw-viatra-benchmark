...
public final class Standard_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Standard_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Standard_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Standard_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Standard_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Standard_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Standard_isEncapsulated.Match)) {
          Standard_isEncapsulated.Match other = (Standard_isEncapsulated.Match) obj;
    ...
    @Override
    public Standard_isEncapsulated specification() {
      return Standard_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Standard_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Standard_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Standard_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Standard_isEncapsulated.Match {
    ...
    private static final class Immutable extends Standard_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Standard_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Standard_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Standard_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Standard_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Standard_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Standard_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Standard_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Standard_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Standard_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Standard_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Standard_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Standard_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Standard_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Standard_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Standard_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Standard_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Standard_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Standard_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Standard_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Standard_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Standard_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Standard_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Standard_isEncapsulated.Matcher> querySpecification() {
      return Standard_isEncapsulated.instance();
    }
  }
  
  private Standard_isEncapsulated() {
   ...
   * 
   */
  public static Standard_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Standard_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Standard_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Standard_isEncapsulated.Matcher instantiate() {
    return Standard_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Standard_isEncapsulated.Match newEmptyMatch() {
    return Standard_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Standard_isEncapsulated.Match newMatch(final Object... parameters) {
    return Standard_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Standard_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Standard_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Standard_isEncapsulated INSTANCE = new Standard_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Standard_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
