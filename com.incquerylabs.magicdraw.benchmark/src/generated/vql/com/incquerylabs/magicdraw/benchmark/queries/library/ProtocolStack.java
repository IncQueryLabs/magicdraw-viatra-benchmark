...
public final class ProtocolStack extends BaseGeneratedEMFQuerySpecification<ProtocolStack.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProtocolStack.Match.parameterNames;
    }
    ...
    @Override
    public ProtocolStack.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProtocolStack.Match)) {
          ProtocolStack.Match other = (ProtocolStack.Match) obj;
    ...
    @Override
    public ProtocolStack specification() {
      return ProtocolStack.instance();
    }
     ...
     * 
     */
    public static ProtocolStack.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProtocolStack.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProtocolStack.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProtocolStack.Match {
    ...
    private static final class Immutable extends ProtocolStack.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProtocolStack pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ProtocolStack.Match> {
    /**
     ...
     * 
     */
    public static ProtocolStack.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProtocolStack.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProtocolStack.Matcher.class);
     ...
     * 
     */
    public Collection<ProtocolStack.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProtocolStack.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProtocolStack.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProtocolStack.Match> processor) {
     ...
     * 
     */
    public ProtocolStack.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProtocolStack.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProtocolStack.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProtocolStack.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProtocolStack.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProtocolStack.Match partialMatch) {
    ...
    @Override
    protected ProtocolStack.Match tupleToMatch(final Tuple t) {
      try {
          return ProtocolStack.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProtocolStack.Match arrayToMatch(final Object[] match) {
      try {
          return ProtocolStack.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProtocolStack.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProtocolStack.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProtocolStack.Matcher> querySpecification() {
      return ProtocolStack.instance();
    }
  }
   ...
   * 
   */
  public static ProtocolStack instance() {
    try{
  ...
  @Override
  protected ProtocolStack.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProtocolStack.Matcher.on(engine);
  }
  
  @Override
  public ProtocolStack.Matcher instantiate() {
    return ProtocolStack.Matcher.create();
  }
  
  @Override
  public ProtocolStack.Match newEmptyMatch() {
    return ProtocolStack.Match.newEmptyMatch();
  }
  
  @Override
  public ProtocolStack.Match newMatch(final Object... parameters) {
    return ProtocolStack.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProtocolStack} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProtocolStack#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProtocolStack INSTANCE = new ProtocolStack();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProtocolStack.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ProtocolStack")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ProtocolStack");
