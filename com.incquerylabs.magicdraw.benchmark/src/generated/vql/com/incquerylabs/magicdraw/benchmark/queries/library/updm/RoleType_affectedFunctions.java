...
public final class RoleType_affectedFunctions extends BaseGeneratedEMFQuerySpecification<RoleType_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return RoleType_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public RoleType_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RoleType_affectedFunctions.Match)) {
          RoleType_affectedFunctions.Match other = (RoleType_affectedFunctions.Match) obj;
    ...
    @Override
    public RoleType_affectedFunctions specification() {
      return RoleType_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static RoleType_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static RoleType_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static RoleType_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RoleType_affectedFunctions.Match {
    ...
    private static final class Immutable extends RoleType_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.RoleType_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see RoleType_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<RoleType_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static RoleType_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RoleType_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RoleType_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<RoleType_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<RoleType_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<RoleType_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super RoleType_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public RoleType_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return RoleType_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final RoleType_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final RoleType_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final RoleType_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final RoleType_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected RoleType_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return RoleType_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected RoleType_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return RoleType_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RoleType_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RoleType_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RoleType_affectedFunctions.Matcher> querySpecification() {
      return RoleType_affectedFunctions.instance();
    }
  }
  
  private RoleType_affectedFunctions() {
   ...
   * 
   */
  public static RoleType_affectedFunctions instance() {
    try{
  ...
  @Override
  protected RoleType_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return RoleType_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public RoleType_affectedFunctions.Matcher instantiate() {
    return RoleType_affectedFunctions.Matcher.create();
  }
  
  @Override
  public RoleType_affectedFunctions.Match newEmptyMatch() {
    return RoleType_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public RoleType_affectedFunctions.Match newMatch(final Object... parameters) {
    return RoleType_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RoleType_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RoleType_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RoleType_affectedFunctions INSTANCE = new RoleType_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RoleType_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
