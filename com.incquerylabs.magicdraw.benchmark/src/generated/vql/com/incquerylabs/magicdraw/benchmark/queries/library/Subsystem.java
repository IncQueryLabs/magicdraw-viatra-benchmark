...
public final class Subsystem extends BaseGeneratedEMFQuerySpecification<Subsystem.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Subsystem.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static Subsystem.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<Subsystem.Match> {
     ...
     * 
     */
    public Collection<Subsystem.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<Subsystem.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<Subsystem.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype, final Consumer<? super Subsystem.Match> processor) {
     ...
     * 
     */
    public Subsystem.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Stereotype pStereotype) {
      return Subsystem.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final Subsystem.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final Subsystem.Match partialMatch) {
    ...
    protected Subsystem.Match tupleToMatch(final Tuple t) {
      try {
          return Subsystem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected Subsystem.Match arrayToMatch(final Object[] match) {
      try {
          return Subsystem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected Subsystem.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Subsystem.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Subsystem.Match newMatch(final Object... parameters) {
    return Subsystem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
