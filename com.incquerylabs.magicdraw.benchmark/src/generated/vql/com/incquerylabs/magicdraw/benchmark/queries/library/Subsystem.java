 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "Subsystem");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Subsystem extends BaseGeneratedEMFQuerySpecification<Subsystem.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Subsystem pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Subsystem";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Subsystem pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Subsystem} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Subsystem#instance()}.
   * 
