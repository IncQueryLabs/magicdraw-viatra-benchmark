...
public final class IndividualPersonRole extends BaseGeneratedEMFQuerySpecification<IndividualPersonRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.IndividualPersonRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.IndividualPersonRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return IndividualPersonRole.Match.parameterNames;
    }
    ...
    @Override
    public IndividualPersonRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof IndividualPersonRole.Match)) {
          IndividualPersonRole.Match other = (IndividualPersonRole.Match) obj;
    ...
    @Override
    public IndividualPersonRole specification() {
      return IndividualPersonRole.instance();
    }
     ...
     * 
     */
    public static IndividualPersonRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static IndividualPersonRole.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static IndividualPersonRole.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends IndividualPersonRole.Match {
    ...
    private static final class Immutable extends IndividualPersonRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.IndividualPersonRole pattern,
   ...
   * 
   * @see Match
   * @see IndividualPersonRole
   * 
   */
  public static class Matcher extends BaseMatcher<IndividualPersonRole.Match> {
    /**
     ...
     * 
     */
    public static IndividualPersonRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static IndividualPersonRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(IndividualPersonRole.Matcher.class);
     ...
     * 
     */
    public Collection<IndividualPersonRole.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<IndividualPersonRole.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<IndividualPersonRole.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super IndividualPersonRole.Match> processor) {
     ...
     * 
     */
    public IndividualPersonRole.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return IndividualPersonRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final IndividualPersonRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final IndividualPersonRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final IndividualPersonRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final IndividualPersonRole.Match partialMatch) {
    ...
    @Override
    protected IndividualPersonRole.Match tupleToMatch(final Tuple t) {
      try {
          return IndividualPersonRole.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected IndividualPersonRole.Match arrayToMatch(final Object[] match) {
      try {
          return IndividualPersonRole.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected IndividualPersonRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return IndividualPersonRole.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<IndividualPersonRole.Matcher> querySpecification() {
      return IndividualPersonRole.instance();
    }
  }
  
  private IndividualPersonRole() {
   ...
   * 
   */
  public static IndividualPersonRole instance() {
    try{
  ...
  @Override
  protected IndividualPersonRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return IndividualPersonRole.Matcher.on(engine);
  }
  
  @Override
  public IndividualPersonRole.Matcher instantiate() {
    return IndividualPersonRole.Matcher.create();
  }
  
  @Override
  public IndividualPersonRole.Match newEmptyMatch() {
    return IndividualPersonRole.Match.newEmptyMatch();
  }
  
  @Override
  public IndividualPersonRole.Match newMatch(final Object... parameters) {
    return IndividualPersonRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link IndividualPersonRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link IndividualPersonRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final IndividualPersonRole INSTANCE = new IndividualPersonRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final IndividualPersonRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "IndividualPersonRole");
