...
public final class LogicalArchitecture_propertySet extends BaseGeneratedEMFQuerySpecification<LogicalArchitecture_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return LogicalArchitecture_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public LogicalArchitecture_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LogicalArchitecture_propertySet.Match)) {
          LogicalArchitecture_propertySet.Match other = (LogicalArchitecture_propertySet.Match) obj;
    ...
    @Override
    public LogicalArchitecture_propertySet specification() {
      return LogicalArchitecture_propertySet.instance();
    }
     ...
     * 
     */
    public static LogicalArchitecture_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static LogicalArchitecture_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static LogicalArchitecture_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends LogicalArchitecture_propertySet.Match {
    ...
    private static final class Immutable extends LogicalArchitecture_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.LogicalArchitecture_propertySet pattern,
   ...
   * 
   * @see Match
   * @see LogicalArchitecture_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<LogicalArchitecture_propertySet.Match> {
    /**
     ...
     * 
     */
    public static LogicalArchitecture_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LogicalArchitecture_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LogicalArchitecture_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<LogicalArchitecture_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<LogicalArchitecture_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<LogicalArchitecture_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super LogicalArchitecture_propertySet.Match> processor) {
     ...
     * 
     */
    public LogicalArchitecture_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return LogicalArchitecture_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final LogicalArchitecture_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final LogicalArchitecture_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final LogicalArchitecture_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final LogicalArchitecture_propertySet.Match partialMatch) {
    ...
    @Override
    protected LogicalArchitecture_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return LogicalArchitecture_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected LogicalArchitecture_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return LogicalArchitecture_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LogicalArchitecture_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LogicalArchitecture_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LogicalArchitecture_propertySet.Matcher> querySpecification() {
      return LogicalArchitecture_propertySet.instance();
    }
  }
  
  private LogicalArchitecture_propertySet() {
   ...
   * 
   */
  public static LogicalArchitecture_propertySet instance() {
    try{
  ...
  @Override
  protected LogicalArchitecture_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return LogicalArchitecture_propertySet.Matcher.on(engine);
  }
  
  @Override
  public LogicalArchitecture_propertySet.Matcher instantiate() {
    return LogicalArchitecture_propertySet.Matcher.create();
  }
  
  @Override
  public LogicalArchitecture_propertySet.Match newEmptyMatch() {
    return LogicalArchitecture_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public LogicalArchitecture_propertySet.Match newMatch(final Object... parameters) {
    return LogicalArchitecture_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LogicalArchitecture_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LogicalArchitecture_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LogicalArchitecture_propertySet INSTANCE = new LogicalArchitecture_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LogicalArchitecture_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
