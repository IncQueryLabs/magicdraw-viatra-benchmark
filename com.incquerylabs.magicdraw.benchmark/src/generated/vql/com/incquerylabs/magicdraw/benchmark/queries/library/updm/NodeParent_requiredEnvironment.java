...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent;
...
public final class NodeParent_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<NodeParent_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeParent_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public NodeParent_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeParent_requiredEnvironment.Match)) {
          NodeParent_requiredEnvironment.Match other = (NodeParent_requiredEnvironment.Match) obj;
    ...
    @Override
    public NodeParent_requiredEnvironment specification() {
      return NodeParent_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static NodeParent_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeParent_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NodeParent_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NodeParent_requiredEnvironment.Match {
    ...
    private static final class Immutable extends NodeParent_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeParent_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see NodeParent_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<NodeParent_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static NodeParent_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeParent_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeParent_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<NodeParent_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NodeParent_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NodeParent_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NodeParent_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public NodeParent_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NodeParent_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NodeParent_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NodeParent_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NodeParent_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NodeParent_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected NodeParent_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return NodeParent_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NodeParent_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return NodeParent_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeParent_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeParent_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeParent_requiredEnvironment.Matcher> querySpecification() {
      return NodeParent_requiredEnvironment.instance();
    }
  }
  
  private NodeParent_requiredEnvironment() {
   ...
   * 
   */
  public static NodeParent_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected NodeParent_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeParent_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public NodeParent_requiredEnvironment.Matcher instantiate() {
    return NodeParent_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public NodeParent_requiredEnvironment.Match newEmptyMatch() {
    return NodeParent_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public NodeParent_requiredEnvironment.Match newMatch(final Object... parameters) {
    return NodeParent_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeParent_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeParent_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeParent_requiredEnvironment INSTANCE = new NodeParent_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeParent_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find NodeParent(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), NodeParent.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "requiredEnvironment", valuespec)
