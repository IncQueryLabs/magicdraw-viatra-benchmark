...
public final class DiagramUsage extends BaseGeneratedEMFQuerySpecification<DiagramUsage.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static DiagramUsage.Match newMutableMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static DiagramUsage.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<DiagramUsage.Match> {
     ...
     * 
     */
    public Collection<DiagramUsage.Match> getAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<DiagramUsage.Match> streamAllMatches(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<DiagramUsage.Match> getOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Diagram pElement, final Stereotype pStereotype, final Consumer<? super DiagramUsage.Match> processor) {
     ...
     * 
     */
    public DiagramUsage.Match newMatch(final Diagram pElement, final Stereotype pStereotype) {
      return DiagramUsage.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final DiagramUsage.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final DiagramUsage.Match partialMatch) {
    ...
    protected DiagramUsage.Match tupleToMatch(final Tuple t) {
      try {
          return DiagramUsage.Match.newMatch((Diagram) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected DiagramUsage.Match arrayToMatch(final Object[] match) {
      try {
          return DiagramUsage.Match.newMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected DiagramUsage.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DiagramUsage.Match.newMutableMatch((Diagram) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public DiagramUsage.Match newMatch(final Object... parameters) {
    return DiagramUsage.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Diagram) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
