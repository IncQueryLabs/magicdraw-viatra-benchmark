...
import com.incquerylabs.magicdraw.benchmark.queries.library.Concern;
...
public final class Concern_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Concern_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Concern_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Concern_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Concern_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Concern_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Concern_isEncapsulated.Match)) {
          Concern_isEncapsulated.Match other = (Concern_isEncapsulated.Match) obj;
    ...
    @Override
    public Concern_isEncapsulated specification() {
      return Concern_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Concern_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Concern_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Concern_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Concern_isEncapsulated.Match {
    ...
    private static final class Immutable extends Concern_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Concern_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Concern_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Concern_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Concern_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Concern_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Concern_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Concern_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Concern_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Concern_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Concern_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Concern_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Concern_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Concern_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Concern_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Concern_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Concern_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Concern_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Concern_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Concern_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Concern_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Concern_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Concern_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Concern_isEncapsulated.Matcher> querySpecification() {
      return Concern_isEncapsulated.instance();
    }
  }
  
  private Concern_isEncapsulated() {
   ...
   * 
   */
  public static Concern_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Concern_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Concern_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Concern_isEncapsulated.Matcher instantiate() {
    return Concern_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Concern_isEncapsulated.Match newEmptyMatch() {
    return Concern_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Concern_isEncapsulated.Match newMatch(final Object... parameters) {
    return Concern_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Concern_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Concern_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Concern_isEncapsulated INSTANCE = new Concern_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Concern_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Concern(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Concern.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
