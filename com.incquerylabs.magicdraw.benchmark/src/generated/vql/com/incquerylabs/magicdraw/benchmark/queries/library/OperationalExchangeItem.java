...
public final class OperationalExchangeItem extends BaseGeneratedEMFQuerySpecification<OperationalExchangeItem.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalExchangeItem pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalExchangeItem";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalExchangeItem.Match.parameterNames;
    }
    ...
    @Override
    public OperationalExchangeItem.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalExchangeItem.Match)) {
          OperationalExchangeItem.Match other = (OperationalExchangeItem.Match) obj;
    ...
    @Override
    public OperationalExchangeItem specification() {
      return OperationalExchangeItem.instance();
    }
     ...
     * 
     */
    public static OperationalExchangeItem.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalExchangeItem.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static OperationalExchangeItem.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends OperationalExchangeItem.Match {
    ...
    private static final class Immutable extends OperationalExchangeItem.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalExchangeItem pattern,
   ...
   * 
   * @see Match
   * @see OperationalExchangeItem
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalExchangeItem.Match> {
    /**
     ...
     * 
     */
    public static OperationalExchangeItem.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalExchangeItem.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalExchangeItem.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalExchangeItem.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<OperationalExchangeItem.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<OperationalExchangeItem.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super OperationalExchangeItem.Match> processor) {
     ...
     * 
     */
    public OperationalExchangeItem.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return OperationalExchangeItem.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final OperationalExchangeItem.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final OperationalExchangeItem.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final OperationalExchangeItem.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final OperationalExchangeItem.Match partialMatch) {
    ...
    @Override
    protected OperationalExchangeItem.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalExchangeItem.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected OperationalExchangeItem.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalExchangeItem.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalExchangeItem.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalExchangeItem.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalExchangeItem.Matcher> querySpecification() {
      return OperationalExchangeItem.instance();
    }
  }
  
  private OperationalExchangeItem() {
   ...
   * 
   */
  public static OperationalExchangeItem instance() {
    try{
  ...
  @Override
  protected OperationalExchangeItem.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalExchangeItem.Matcher.on(engine);
  }
  
  @Override
  public OperationalExchangeItem.Matcher instantiate() {
    return OperationalExchangeItem.Matcher.create();
  }
  
  @Override
  public OperationalExchangeItem.Match newEmptyMatch() {
    return OperationalExchangeItem.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalExchangeItem.Match newMatch(final Object... parameters) {
    return OperationalExchangeItem.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalExchangeItem} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalExchangeItem#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalExchangeItem INSTANCE = new OperationalExchangeItem();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalExchangeItem.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "OperationalExchangeItem")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "OperationalExchangeItem");
