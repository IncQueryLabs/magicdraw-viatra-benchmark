...
public final class TechnicalStandard_retiredDate extends BaseGeneratedEMFQuerySpecification<TechnicalStandard_retiredDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_retiredDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_retiredDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return TechnicalStandard_retiredDate.Match.parameterNames;
    }
    ...
    @Override
    public TechnicalStandard_retiredDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TechnicalStandard_retiredDate.Match)) {
          TechnicalStandard_retiredDate.Match other = (TechnicalStandard_retiredDate.Match) obj;
    ...
    @Override
    public TechnicalStandard_retiredDate specification() {
      return TechnicalStandard_retiredDate.instance();
    }
     ...
     * 
     */
    public static TechnicalStandard_retiredDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static TechnicalStandard_retiredDate.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static TechnicalStandard_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TechnicalStandard_retiredDate.Match {
    ...
    private static final class Immutable extends TechnicalStandard_retiredDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TechnicalStandard_retiredDate pattern,
   ...
   * 
   * @see Match
   * @see TechnicalStandard_retiredDate
   * 
   */
  public static class Matcher extends BaseMatcher<TechnicalStandard_retiredDate.Match> {
    /**
     ...
     * 
     */
    public static TechnicalStandard_retiredDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TechnicalStandard_retiredDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TechnicalStandard_retiredDate.Matcher.class);
     ...
     * 
     */
    public Collection<TechnicalStandard_retiredDate.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TechnicalStandard_retiredDate.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TechnicalStandard_retiredDate.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super TechnicalStandard_retiredDate.Match> processor) {
     ...
     * 
     */
    public TechnicalStandard_retiredDate.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return TechnicalStandard_retiredDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final TechnicalStandard_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final TechnicalStandard_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TechnicalStandard_retiredDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TechnicalStandard_retiredDate.Match partialMatch) {
    ...
    @Override
    protected TechnicalStandard_retiredDate.Match tupleToMatch(final Tuple t) {
      try {
          return TechnicalStandard_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TechnicalStandard_retiredDate.Match arrayToMatch(final Object[] match) {
      try {
          return TechnicalStandard_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TechnicalStandard_retiredDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TechnicalStandard_retiredDate.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TechnicalStandard_retiredDate.Matcher> querySpecification() {
      return TechnicalStandard_retiredDate.instance();
    }
  }
  
  private TechnicalStandard_retiredDate() {
   ...
   * 
   */
  public static TechnicalStandard_retiredDate instance() {
    try{
  ...
  @Override
  protected TechnicalStandard_retiredDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return TechnicalStandard_retiredDate.Matcher.on(engine);
  }
  
  @Override
  public TechnicalStandard_retiredDate.Matcher instantiate() {
    return TechnicalStandard_retiredDate.Matcher.create();
  }
  
  @Override
  public TechnicalStandard_retiredDate.Match newEmptyMatch() {
    return TechnicalStandard_retiredDate.Match.newEmptyMatch();
  }
  
  @Override
  public TechnicalStandard_retiredDate.Match newMatch(final Object... parameters) {
    return TechnicalStandard_retiredDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TechnicalStandard_retiredDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TechnicalStandard_retiredDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TechnicalStandard_retiredDate INSTANCE = new TechnicalStandard_retiredDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TechnicalStandard_retiredDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
