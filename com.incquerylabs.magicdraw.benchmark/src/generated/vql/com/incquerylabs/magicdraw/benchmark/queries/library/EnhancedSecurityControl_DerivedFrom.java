...
public final class EnhancedSecurityControl_DerivedFrom extends BaseGeneratedEMFQuerySpecification<EnhancedSecurityControl_DerivedFrom.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_DerivedFrom pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_DerivedFrom";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnhancedSecurityControl_DerivedFrom.Match.parameterNames;
    }
    ...
    @Override
    public EnhancedSecurityControl_DerivedFrom.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnhancedSecurityControl_DerivedFrom.Match)) {
          EnhancedSecurityControl_DerivedFrom.Match other = (EnhancedSecurityControl_DerivedFrom.Match) obj;
    ...
    @Override
    public EnhancedSecurityControl_DerivedFrom specification() {
      return EnhancedSecurityControl_DerivedFrom.instance();
    }
     ...
     * 
     */
    public static EnhancedSecurityControl_DerivedFrom.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnhancedSecurityControl_DerivedFrom.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnhancedSecurityControl_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnhancedSecurityControl_DerivedFrom.Match {
    ...
    private static final class Immutable extends EnhancedSecurityControl_DerivedFrom.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.EnhancedSecurityControl_DerivedFrom pattern,
   ...
   * 
   * @see Match
   * @see EnhancedSecurityControl_DerivedFrom
   * 
   */
  public static class Matcher extends BaseMatcher<EnhancedSecurityControl_DerivedFrom.Match> {
    /**
     ...
     * 
     */
    public static EnhancedSecurityControl_DerivedFrom.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnhancedSecurityControl_DerivedFrom.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnhancedSecurityControl_DerivedFrom.Matcher.class);
     ...
     * 
     */
    public Collection<EnhancedSecurityControl_DerivedFrom.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnhancedSecurityControl_DerivedFrom.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnhancedSecurityControl_DerivedFrom.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnhancedSecurityControl_DerivedFrom.Match> processor) {
     ...
     * 
     */
    public EnhancedSecurityControl_DerivedFrom.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnhancedSecurityControl_DerivedFrom.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnhancedSecurityControl_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnhancedSecurityControl_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnhancedSecurityControl_DerivedFrom.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnhancedSecurityControl_DerivedFrom.Match partialMatch) {
    ...
    @Override
    protected EnhancedSecurityControl_DerivedFrom.Match tupleToMatch(final Tuple t) {
      try {
          return EnhancedSecurityControl_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnhancedSecurityControl_DerivedFrom.Match arrayToMatch(final Object[] match) {
      try {
          return EnhancedSecurityControl_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnhancedSecurityControl_DerivedFrom.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnhancedSecurityControl_DerivedFrom.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnhancedSecurityControl_DerivedFrom.Matcher> querySpecification() {
      return EnhancedSecurityControl_DerivedFrom.instance();
    }
  }
  
  private EnhancedSecurityControl_DerivedFrom() {
   ...
   * 
   */
  public static EnhancedSecurityControl_DerivedFrom instance() {
    try{
  ...
  @Override
  protected EnhancedSecurityControl_DerivedFrom.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnhancedSecurityControl_DerivedFrom.Matcher.on(engine);
  }
  
  @Override
  public EnhancedSecurityControl_DerivedFrom.Matcher instantiate() {
    return EnhancedSecurityControl_DerivedFrom.Matcher.create();
  }
  
  @Override
  public EnhancedSecurityControl_DerivedFrom.Match newEmptyMatch() {
    return EnhancedSecurityControl_DerivedFrom.Match.newEmptyMatch();
  }
  
  @Override
  public EnhancedSecurityControl_DerivedFrom.Match newMatch(final Object... parameters) {
    return EnhancedSecurityControl_DerivedFrom.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnhancedSecurityControl_DerivedFrom} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnhancedSecurityControl_DerivedFrom#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnhancedSecurityControl_DerivedFrom INSTANCE = new EnhancedSecurityControl_DerivedFrom();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnhancedSecurityControl_DerivedFrom.GeneratedPQuery INSTANCE = new GeneratedPQuery();
