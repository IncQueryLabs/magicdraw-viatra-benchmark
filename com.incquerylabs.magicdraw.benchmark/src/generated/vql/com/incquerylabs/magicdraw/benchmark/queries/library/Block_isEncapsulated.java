...
public final class Block_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Block_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Block_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Block_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Block_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Block_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Block_isEncapsulated.Match)) {
          Block_isEncapsulated.Match other = (Block_isEncapsulated.Match) obj;
    ...
    @Override
    public Block_isEncapsulated specification() {
     ...
     * 
     */
    public static Block_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Block_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Block_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Block_isEncapsulated.Match {
    ...
    private static final class Immutable extends Block_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Block_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Block_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Block_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Block_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Block_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Block_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Block_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Block_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Block_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Block_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Block_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Block_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Block_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Block_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Block_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Block_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Block_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Block_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Block_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Block_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Block_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Block_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Block_isEncapsulated.Matcher> querySpecification() {
      return Block_isEncapsulated.instance();
    }
  }
  
  private Block_isEncapsulated() {
   ...
   * 
   */
  public static Block_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Block_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Block_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Block_isEncapsulated.Matcher instantiate() {
    return Block_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Block_isEncapsulated.Match newEmptyMatch() {
    return Block_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Block_isEncapsulated.Match newMatch(final Object... parameters) {
    return Block_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Block_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Block_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Block_isEncapsulated INSTANCE = new Block_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Block_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Block(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), Block.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
