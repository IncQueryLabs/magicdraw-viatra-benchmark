...
public final class Block_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Block_isEncapsulated.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Block_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public static Block_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
  ...
  public static class Matcher extends BaseMatcher<Block_isEncapsulated.Match> {
     ...
     * 
     */
    public Collection<Block_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public Stream<Block_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public Optional<Block_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue, final Consumer<? super Block_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Block_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Boolean pValue) {
      return Block_isEncapsulated.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Boolean> streamAllValuesOfValue(final Block_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<Boolean> getAllValuesOfValue(final Block_isEncapsulated.Match partialMatch) {
    ...
    protected Block_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Block_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Boolean) t.get(POSITION_VALUE));
    ...
    protected Block_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Block_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Boolean) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected Block_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Block_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Boolean) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Block_isEncapsulated.Match newMatch(final Object... parameters) {
    return Block_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (java.lang.Boolean) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find Block(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), Block.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "isEncapsulated", taggedValue)
