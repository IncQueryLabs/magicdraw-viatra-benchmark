...
public final class ResourceArchitecture_conformsTo extends BaseGeneratedEMFQuerySpecification<ResourceArchitecture_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceArchitecture_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public ResourceArchitecture_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceArchitecture_conformsTo.Match)) {
          ResourceArchitecture_conformsTo.Match other = (ResourceArchitecture_conformsTo.Match) obj;
    ...
    @Override
    public ResourceArchitecture_conformsTo specification() {
      return ResourceArchitecture_conformsTo.instance();
    }
     ...
     * 
     */
    public static ResourceArchitecture_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceArchitecture_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceArchitecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceArchitecture_conformsTo.Match {
    ...
    private static final class Immutable extends ResourceArchitecture_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceArchitecture_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see ResourceArchitecture_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceArchitecture_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static ResourceArchitecture_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceArchitecture_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceArchitecture_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceArchitecture_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceArchitecture_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceArchitecture_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ResourceArchitecture_conformsTo.Match> processor) {
     ...
     * 
     */
    public ResourceArchitecture_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ResourceArchitecture_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ResourceArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ResourceArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceArchitecture_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceArchitecture_conformsTo.Match partialMatch) {
    ...
    @Override
    protected ResourceArchitecture_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceArchitecture_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceArchitecture_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceArchitecture_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceArchitecture_conformsTo.Matcher> querySpecification() {
      return ResourceArchitecture_conformsTo.instance();
    }
  }
  
  private ResourceArchitecture_conformsTo() {
   ...
   * 
   */
  public static ResourceArchitecture_conformsTo instance() {
    try{
  ...
  @Override
  protected ResourceArchitecture_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceArchitecture_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public ResourceArchitecture_conformsTo.Matcher instantiate() {
    return ResourceArchitecture_conformsTo.Matcher.create();
  }
  
  @Override
  public ResourceArchitecture_conformsTo.Match newEmptyMatch() {
    return ResourceArchitecture_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceArchitecture_conformsTo.Match newMatch(final Object... parameters) {
    return ResourceArchitecture_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceArchitecture_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceArchitecture_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceArchitecture_conformsTo INSTANCE = new ResourceArchitecture_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceArchitecture_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
