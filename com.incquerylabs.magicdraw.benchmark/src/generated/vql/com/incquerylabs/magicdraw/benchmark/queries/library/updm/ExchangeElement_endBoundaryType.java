...
public final class ExchangeElement_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ExchangeElement_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExchangeElement_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ExchangeElement_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExchangeElement_endBoundaryType.Match)) {
          ExchangeElement_endBoundaryType.Match other = (ExchangeElement_endBoundaryType.Match) obj;
    ...
    @Override
    public ExchangeElement_endBoundaryType specification() {
      return ExchangeElement_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ExchangeElement_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExchangeElement_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ExchangeElement_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ExchangeElement_endBoundaryType.Match {
    ...
    private static final class Immutable extends ExchangeElement_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExchangeElement_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ExchangeElement_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ExchangeElement_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ExchangeElement_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExchangeElement_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExchangeElement_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ExchangeElement_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ExchangeElement_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ExchangeElement_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ExchangeElement_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ExchangeElement_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ExchangeElement_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExchangeElement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExchangeElement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ExchangeElement_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ExchangeElement_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ExchangeElement_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ExchangeElement_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ExchangeElement_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ExchangeElement_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExchangeElement_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExchangeElement_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExchangeElement_endBoundaryType.Matcher> querySpecification() {
      return ExchangeElement_endBoundaryType.instance();
    }
  }
  
  private ExchangeElement_endBoundaryType() {
   ...
   * 
   */
  public static ExchangeElement_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ExchangeElement_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExchangeElement_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ExchangeElement_endBoundaryType.Matcher instantiate() {
    return ExchangeElement_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ExchangeElement_endBoundaryType.Match newEmptyMatch() {
    return ExchangeElement_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ExchangeElement_endBoundaryType.Match newMatch(final Object... parameters) {
    return ExchangeElement_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExchangeElement_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExchangeElement_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExchangeElement_endBoundaryType INSTANCE = new ExchangeElement_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExchangeElement_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
