...
public final class ProblemDomain_physicalLocation extends BaseGeneratedEMFQuerySpecification<ProblemDomain_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_physicalLocation.Match)) {
          ProblemDomain_physicalLocation.Match other = (ProblemDomain_physicalLocation.Match) obj;
    ...
    @Override
    public ProblemDomain_physicalLocation specification() {
      return ProblemDomain_physicalLocation.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_physicalLocation.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ProblemDomain_physicalLocation.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProblemDomain_physicalLocation.Match {
    ...
    private static final class Immutable extends ProblemDomain_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProblemDomain_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_physicalLocation.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProblemDomain_physicalLocation.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProblemDomain_physicalLocation.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ProblemDomain_physicalLocation.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_physicalLocation.Match newMatch(final Property pElement, final Element pValue) {
      return ProblemDomain_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProblemDomain_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProblemDomain_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_physicalLocation.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProblemDomain_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_physicalLocation.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_physicalLocation.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_physicalLocation.Matcher> querySpecification() {
      return ProblemDomain_physicalLocation.instance();
    }
  }
  
  private ProblemDomain_physicalLocation() {
   ...
   * 
   */
  public static ProblemDomain_physicalLocation instance() {
    try{
  ...
  @Override
  protected ProblemDomain_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_physicalLocation.Matcher instantiate() {
    return ProblemDomain_physicalLocation.Matcher.create();
  }
  
  @Override
  public ProblemDomain_physicalLocation.Match newEmptyMatch() {
    return ProblemDomain_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_physicalLocation.Match newMatch(final Object... parameters) {
    return ProblemDomain_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_physicalLocation INSTANCE = new ProblemDomain_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
