 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "additional_stereotypes", "Optical");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class Optical extends BaseGeneratedEMFQuerySpecification<Optical.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Optical pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Optical";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Optical pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link Optical} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Optical#instance()}.
   * 
