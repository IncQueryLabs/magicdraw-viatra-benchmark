 ...
 *         pattern QuantityKind_description(Element : PackageableElement, Value: java String) {
 *         	find QuantityKind(Element, stereotype);
...
public final class QuantityKind_description extends BaseGeneratedEMFQuerySpecification<QuantityKind_description.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static QuantityKind_description.Match newMutableMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public static QuantityKind_description.Match newMatch(final PackageableElement pElement, final String pValue) {
  ...
  public static class Matcher extends BaseMatcher<QuantityKind_description.Match> {
     ...
     * 
     */
    public Collection<QuantityKind_description.Match> getAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Stream<QuantityKind_description.Match> streamAllMatches(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public Optional<QuantityKind_description.Match> getOneArbitraryMatch(final PackageableElement pElement, final String pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final PackageableElement pElement, final String pValue, final Consumer<? super QuantityKind_description.Match> processor) {
     ...
     * 
     */
    public QuantityKind_description.Match newMatch(final PackageableElement pElement, final String pValue) {
      return QuantityKind_description.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<String> streamAllValuesOfValue(final QuantityKind_description.Match partialMatch) {
     ...
     * 
     */
    public Set<String> getAllValuesOfValue(final QuantityKind_description.Match partialMatch) {
    ...
    protected QuantityKind_description.Match tupleToMatch(final Tuple t) {
      try {
          return QuantityKind_description.Match.newMatch((PackageableElement) t.get(POSITION_ELEMENT), (String) t.get(POSITION_VALUE));
    ...
    protected QuantityKind_description.Match arrayToMatch(final Object[] match) {
      try {
          return QuantityKind_description.Match.newMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    protected QuantityKind_description.Match arrayToMatchMutable(final Object[] match) {
      try {
          return QuantityKind_description.Match.newMutableMatch((PackageableElement) match[POSITION_ELEMENT], (String) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public QuantityKind_description.Match newMatch(final Object... parameters) {
    return QuantityKind_description.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.PackageableElement) parameters[0], (java.lang.String) parameters[1]);
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find QuantityKind(Element, stereotype)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_Element, var_stereotype), QuantityKind.instance().getInternalQueryRepresentation());
          // 	find taggedValue(Element, stereotype, "description", taggedValue)
