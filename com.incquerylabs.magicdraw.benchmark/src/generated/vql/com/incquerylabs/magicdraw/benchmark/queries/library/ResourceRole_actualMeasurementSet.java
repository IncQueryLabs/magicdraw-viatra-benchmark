...
public final class ResourceRole_actualMeasurementSet extends BaseGeneratedEMFQuerySpecification<ResourceRole_actualMeasurementSet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_actualMeasurementSet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_actualMeasurementSet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_actualMeasurementSet.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_actualMeasurementSet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_actualMeasurementSet.Match)) {
          ResourceRole_actualMeasurementSet.Match other = (ResourceRole_actualMeasurementSet.Match) obj;
    ...
    @Override
    public ResourceRole_actualMeasurementSet specification() {
      return ResourceRole_actualMeasurementSet.instance();
    }
     ...
     * 
     */
    public static ResourceRole_actualMeasurementSet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_actualMeasurementSet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_actualMeasurementSet.Match {
    ...
    private static final class Immutable extends ResourceRole_actualMeasurementSet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ResourceRole_actualMeasurementSet pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_actualMeasurementSet
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_actualMeasurementSet.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_actualMeasurementSet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_actualMeasurementSet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_actualMeasurementSet.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_actualMeasurementSet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_actualMeasurementSet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_actualMeasurementSet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_actualMeasurementSet.Match> processor) {
     ...
     * 
     */
    public ResourceRole_actualMeasurementSet.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_actualMeasurementSet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_actualMeasurementSet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_actualMeasurementSet.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_actualMeasurementSet.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_actualMeasurementSet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_actualMeasurementSet.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_actualMeasurementSet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_actualMeasurementSet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_actualMeasurementSet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_actualMeasurementSet.Matcher> querySpecification() {
      return ResourceRole_actualMeasurementSet.instance();
    }
  }
  
  private ResourceRole_actualMeasurementSet() {
   ...
   * 
   */
  public static ResourceRole_actualMeasurementSet instance() {
    try{
  ...
  @Override
  protected ResourceRole_actualMeasurementSet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_actualMeasurementSet.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_actualMeasurementSet.Matcher instantiate() {
    return ResourceRole_actualMeasurementSet.Matcher.create();
  }
  
  @Override
  public ResourceRole_actualMeasurementSet.Match newEmptyMatch() {
    return ResourceRole_actualMeasurementSet.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_actualMeasurementSet.Match newMatch(final Object... parameters) {
    return ResourceRole_actualMeasurementSet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_actualMeasurementSet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_actualMeasurementSet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_actualMeasurementSet INSTANCE = new ResourceRole_actualMeasurementSet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_actualMeasurementSet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
