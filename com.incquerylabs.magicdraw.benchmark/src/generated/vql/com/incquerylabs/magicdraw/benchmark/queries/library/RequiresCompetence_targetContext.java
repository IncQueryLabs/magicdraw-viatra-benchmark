...
public final class RequiresCompetence_targetContext extends BaseGeneratedEMFQuerySpecification<RequiresCompetence_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return RequiresCompetence_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public RequiresCompetence_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof RequiresCompetence_targetContext.Match)) {
          RequiresCompetence_targetContext.Match other = (RequiresCompetence_targetContext.Match) obj;
    ...
    @Override
    public RequiresCompetence_targetContext specification() {
      return RequiresCompetence_targetContext.instance();
    }
     ...
     * 
     */
    public static RequiresCompetence_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static RequiresCompetence_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static RequiresCompetence_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends RequiresCompetence_targetContext.Match {
    ...
    private static final class Immutable extends RequiresCompetence_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.RequiresCompetence_targetContext pattern,
   ...
   * 
   * @see Match
   * @see RequiresCompetence_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<RequiresCompetence_targetContext.Match> {
    /**
     ...
     * 
     */
    public static RequiresCompetence_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static RequiresCompetence_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(RequiresCompetence_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<RequiresCompetence_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<RequiresCompetence_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<RequiresCompetence_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super RequiresCompetence_targetContext.Match> processor) {
     ...
     * 
     */
    public RequiresCompetence_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return RequiresCompetence_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final RequiresCompetence_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final RequiresCompetence_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final RequiresCompetence_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final RequiresCompetence_targetContext.Match partialMatch) {
    ...
    @Override
    protected RequiresCompetence_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return RequiresCompetence_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected RequiresCompetence_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return RequiresCompetence_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected RequiresCompetence_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return RequiresCompetence_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<RequiresCompetence_targetContext.Matcher> querySpecification() {
      return RequiresCompetence_targetContext.instance();
    }
  }
  
  private RequiresCompetence_targetContext() {
   ...
   * 
   */
  public static RequiresCompetence_targetContext instance() {
    try{
  ...
  @Override
  protected RequiresCompetence_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return RequiresCompetence_targetContext.Matcher.on(engine);
  }
  
  @Override
  public RequiresCompetence_targetContext.Matcher instantiate() {
    return RequiresCompetence_targetContext.Matcher.create();
  }
  
  @Override
  public RequiresCompetence_targetContext.Match newEmptyMatch() {
    return RequiresCompetence_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public RequiresCompetence_targetContext.Match newMatch(final Object... parameters) {
    return RequiresCompetence_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link RequiresCompetence_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link RequiresCompetence_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final RequiresCompetence_targetContext INSTANCE = new RequiresCompetence_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final RequiresCompetence_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
