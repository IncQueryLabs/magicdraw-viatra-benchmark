...
public final class Responsibility_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Responsibility_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_startBoundaryType.Match)) {
          Responsibility_startBoundaryType.Match other = (Responsibility_startBoundaryType.Match) obj;
    ...
    @Override
    public Responsibility_startBoundaryType specification() {
      return Responsibility_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Responsibility_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_startBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Responsibility_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Responsibility_startBoundaryType.Match {
    ...
    private static final class Immutable extends Responsibility_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Responsibility_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_startBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Responsibility_startBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Responsibility_startBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Responsibility_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Responsibility_startBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Responsibility_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Responsibility_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Responsibility_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Responsibility_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Responsibility_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_startBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_startBoundaryType.Matcher> querySpecification() {
      return Responsibility_startBoundaryType.instance();
    }
  }
  
  private Responsibility_startBoundaryType() {
   ...
   * 
   */
  public static Responsibility_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Responsibility_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_startBoundaryType.Matcher instantiate() {
    return Responsibility_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Responsibility_startBoundaryType.Match newEmptyMatch() {
    return Responsibility_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_startBoundaryType.Match newMatch(final Object... parameters) {
    return Responsibility_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_startBoundaryType INSTANCE = new Responsibility_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
