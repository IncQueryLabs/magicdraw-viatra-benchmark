...
public final class CompetenceForRole_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<CompetenceForRole_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return CompetenceForRole_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public CompetenceForRole_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CompetenceForRole_targetPropertyPath.Match)) {
          CompetenceForRole_targetPropertyPath.Match other = (CompetenceForRole_targetPropertyPath.Match) obj;
    ...
    @Override
    public CompetenceForRole_targetPropertyPath specification() {
      return CompetenceForRole_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static CompetenceForRole_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static CompetenceForRole_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static CompetenceForRole_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CompetenceForRole_targetPropertyPath.Match {
    ...
    private static final class Immutable extends CompetenceForRole_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CompetenceForRole_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see CompetenceForRole_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<CompetenceForRole_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static CompetenceForRole_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CompetenceForRole_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CompetenceForRole_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<CompetenceForRole_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<CompetenceForRole_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<CompetenceForRole_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super CompetenceForRole_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public CompetenceForRole_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return CompetenceForRole_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final CompetenceForRole_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final CompetenceForRole_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final CompetenceForRole_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final CompetenceForRole_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected CompetenceForRole_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return CompetenceForRole_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected CompetenceForRole_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return CompetenceForRole_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CompetenceForRole_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CompetenceForRole_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CompetenceForRole_targetPropertyPath.Matcher> querySpecification() {
      return CompetenceForRole_targetPropertyPath.instance();
    }
  }
  
  private CompetenceForRole_targetPropertyPath() {
   ...
   * 
   */
  public static CompetenceForRole_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected CompetenceForRole_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return CompetenceForRole_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public CompetenceForRole_targetPropertyPath.Matcher instantiate() {
    return CompetenceForRole_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public CompetenceForRole_targetPropertyPath.Match newEmptyMatch() {
    return CompetenceForRole_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public CompetenceForRole_targetPropertyPath.Match newMatch(final Object... parameters) {
    return CompetenceForRole_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CompetenceForRole_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CompetenceForRole_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CompetenceForRole_targetPropertyPath INSTANCE = new CompetenceForRole_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CompetenceForRole_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
