...
public final class ResourceRole_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ResourceRole_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceRole_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ResourceRole_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceRole_actualPropertySet.Match)) {
          ResourceRole_actualPropertySet.Match other = (ResourceRole_actualPropertySet.Match) obj;
    ...
    @Override
    public ResourceRole_actualPropertySet specification() {
      return ResourceRole_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ResourceRole_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceRole_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ResourceRole_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ResourceRole_actualPropertySet.Match {
    ...
    private static final class Immutable extends ResourceRole_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceRole_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ResourceRole_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceRole_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ResourceRole_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceRole_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceRole_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceRole_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ResourceRole_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ResourceRole_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ResourceRole_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ResourceRole_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ResourceRole_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ResourceRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ResourceRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ResourceRole_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ResourceRole_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ResourceRole_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceRole_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ResourceRole_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceRole_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceRole_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceRole_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceRole_actualPropertySet.Matcher> querySpecification() {
      return ResourceRole_actualPropertySet.instance();
    }
  }
  
  private ResourceRole_actualPropertySet() {
   ...
   * 
   */
  public static ResourceRole_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ResourceRole_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceRole_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ResourceRole_actualPropertySet.Matcher instantiate() {
    return ResourceRole_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ResourceRole_actualPropertySet.Match newEmptyMatch() {
    return ResourceRole_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceRole_actualPropertySet.Match newMatch(final Object... parameters) {
    return ResourceRole_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceRole_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceRole_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceRole_actualPropertySet INSTANCE = new ResourceRole_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceRole_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
