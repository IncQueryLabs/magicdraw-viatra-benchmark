...
public final class SecurityEnclave_desribedBy extends BaseGeneratedEMFQuerySpecification<SecurityEnclave_desribedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_desribedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_desribedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave_desribedBy.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave_desribedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave_desribedBy.Match)) {
          SecurityEnclave_desribedBy.Match other = (SecurityEnclave_desribedBy.Match) obj;
    ...
    @Override
    public SecurityEnclave_desribedBy specification() {
      return SecurityEnclave_desribedBy.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave_desribedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave_desribedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityEnclave_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityEnclave_desribedBy.Match {
    ...
    private static final class Immutable extends SecurityEnclave_desribedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave_desribedBy pattern,
   ...
   * 
   * @see Match
   * @see SecurityEnclave_desribedBy
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave_desribedBy.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave_desribedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave_desribedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave_desribedBy.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave_desribedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityEnclave_desribedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityEnclave_desribedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityEnclave_desribedBy.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave_desribedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityEnclave_desribedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityEnclave_desribedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityEnclave_desribedBy.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave_desribedBy.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityEnclave_desribedBy.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave_desribedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave_desribedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave_desribedBy.Matcher> querySpecification() {
      return SecurityEnclave_desribedBy.instance();
    }
  }
  
  private SecurityEnclave_desribedBy() {
   ...
   * 
   */
  public static SecurityEnclave_desribedBy instance() {
    try{
  ...
  @Override
  protected SecurityEnclave_desribedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave_desribedBy.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave_desribedBy.Matcher instantiate() {
    return SecurityEnclave_desribedBy.Matcher.create();
  }
  
  @Override
  public SecurityEnclave_desribedBy.Match newEmptyMatch() {
    return SecurityEnclave_desribedBy.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave_desribedBy.Match newMatch(final Object... parameters) {
    return SecurityEnclave_desribedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave_desribedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave_desribedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave_desribedBy INSTANCE = new SecurityEnclave_desribedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave_desribedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
