...
public final class CapabilityConfiguration_affectedFunctions extends BaseGeneratedEMFQuerySpecification<CapabilityConfiguration_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityConfiguration_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityConfiguration_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityConfiguration_affectedFunctions.Match)) {
          CapabilityConfiguration_affectedFunctions.Match other = (CapabilityConfiguration_affectedFunctions.Match) obj;
    ...
    @Override
    public CapabilityConfiguration_affectedFunctions specification() {
      return CapabilityConfiguration_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static CapabilityConfiguration_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityConfiguration_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static CapabilityConfiguration_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends CapabilityConfiguration_affectedFunctions.Match {
    ...
    private static final class Immutable extends CapabilityConfiguration_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.CapabilityConfiguration_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see CapabilityConfiguration_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityConfiguration_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static CapabilityConfiguration_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityConfiguration_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityConfiguration_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityConfiguration_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<CapabilityConfiguration_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<CapabilityConfiguration_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super CapabilityConfiguration_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public CapabilityConfiguration_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return CapabilityConfiguration_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final CapabilityConfiguration_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final CapabilityConfiguration_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final CapabilityConfiguration_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final CapabilityConfiguration_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected CapabilityConfiguration_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityConfiguration_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected CapabilityConfiguration_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityConfiguration_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityConfiguration_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityConfiguration_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityConfiguration_affectedFunctions.Matcher> querySpecification() {
      return CapabilityConfiguration_affectedFunctions.instance();
    }
  }
  
  private CapabilityConfiguration_affectedFunctions() {
   ...
   * 
   */
  public static CapabilityConfiguration_affectedFunctions instance() {
    try{
  ...
  @Override
  protected CapabilityConfiguration_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityConfiguration_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public CapabilityConfiguration_affectedFunctions.Matcher instantiate() {
    return CapabilityConfiguration_affectedFunctions.Matcher.create();
  }
  
  @Override
  public CapabilityConfiguration_affectedFunctions.Match newEmptyMatch() {
    return CapabilityConfiguration_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityConfiguration_affectedFunctions.Match newMatch(final Object... parameters) {
    return CapabilityConfiguration_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityConfiguration_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityConfiguration_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityConfiguration_affectedFunctions INSTANCE = new CapabilityConfiguration_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityConfiguration_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
