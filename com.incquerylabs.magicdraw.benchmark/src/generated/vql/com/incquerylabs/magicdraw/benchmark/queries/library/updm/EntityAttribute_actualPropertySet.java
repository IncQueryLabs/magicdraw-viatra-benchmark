...
public final class EntityAttribute_actualPropertySet extends BaseGeneratedEMFQuerySpecification<EntityAttribute_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityAttribute_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public EntityAttribute_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityAttribute_actualPropertySet.Match)) {
          EntityAttribute_actualPropertySet.Match other = (EntityAttribute_actualPropertySet.Match) obj;
    ...
    @Override
    public EntityAttribute_actualPropertySet specification() {
      return EntityAttribute_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static EntityAttribute_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityAttribute_actualPropertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityAttribute_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityAttribute_actualPropertySet.Match {
    ...
    private static final class Immutable extends EntityAttribute_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see EntityAttribute_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EntityAttribute_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static EntityAttribute_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityAttribute_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityAttribute_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EntityAttribute_actualPropertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityAttribute_actualPropertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityAttribute_actualPropertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EntityAttribute_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public EntityAttribute_actualPropertySet.Match newMatch(final Property pElement, final Element pValue) {
      return EntityAttribute_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EntityAttribute_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EntityAttribute_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityAttribute_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityAttribute_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected EntityAttribute_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EntityAttribute_actualPropertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityAttribute_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EntityAttribute_actualPropertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityAttribute_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityAttribute_actualPropertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityAttribute_actualPropertySet.Matcher> querySpecification() {
      return EntityAttribute_actualPropertySet.instance();
    }
  }
  
  private EntityAttribute_actualPropertySet() {
   ...
   * 
   */
  public static EntityAttribute_actualPropertySet instance() {
    try{
  ...
  @Override
  protected EntityAttribute_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityAttribute_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public EntityAttribute_actualPropertySet.Matcher instantiate() {
    return EntityAttribute_actualPropertySet.Matcher.create();
  }
  
  @Override
  public EntityAttribute_actualPropertySet.Match newEmptyMatch() {
    return EntityAttribute_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EntityAttribute_actualPropertySet.Match newMatch(final Object... parameters) {
    return EntityAttribute_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityAttribute_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityAttribute_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityAttribute_actualPropertySet INSTANCE = new EntityAttribute_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityAttribute_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find EntityAttribute(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), EntityAttribute.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
