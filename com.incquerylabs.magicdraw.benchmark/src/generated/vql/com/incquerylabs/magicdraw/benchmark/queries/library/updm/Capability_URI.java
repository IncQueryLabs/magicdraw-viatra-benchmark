...
public final class Capability_URI extends BaseGeneratedEMFQuerySpecification<Capability_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Capability_URI.Match.parameterNames;
    }
    ...
    @Override
    public Capability_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Capability_URI.Match)) {
          Capability_URI.Match other = (Capability_URI.Match) obj;
    ...
    @Override
    public Capability_URI specification() {
      return Capability_URI.instance();
    }
     ...
     * 
     */
    public static Capability_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Capability_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Capability_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Capability_URI.Match {
    ...
    private static final class Immutable extends Capability_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Capability_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Capability_URI.Match> {
    /**
     ...
     * 
     */
    public static Capability_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Capability_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Capability_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Capability_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Capability_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Capability_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super Capability_URI.Match> processor) {
     ...
     * 
     */
    public Capability_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return Capability_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Capability_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Capability_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Capability_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Capability_URI.Match partialMatch) {
    ...
    @Override
    protected Capability_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Capability_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Capability_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Capability_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Capability_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Capability_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Capability_URI.Matcher> querySpecification() {
      return Capability_URI.instance();
    }
  }
  
  private Capability_URI() {
   ...
   * 
   */
  public static Capability_URI instance() {
    try{
  ...
  @Override
  protected Capability_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Capability_URI.Matcher.on(engine);
  }
  
  @Override
  public Capability_URI.Matcher instantiate() {
    return Capability_URI.Matcher.create();
  }
  
  @Override
  public Capability_URI.Match newEmptyMatch() {
    return Capability_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Capability_URI.Match newMatch(final Object... parameters) {
    return Capability_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Capability_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Capability_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Capability_URI INSTANCE = new Capability_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Capability_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
