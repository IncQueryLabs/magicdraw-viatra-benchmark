...
public final class ResourceEventTrace extends BaseGeneratedEMFQuerySpecification<ResourceEventTrace.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceEventTrace pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceEventTrace";
    }
    
    @Override
    public List<String> parameterNames() {
      return ResourceEventTrace.Match.parameterNames;
    }
    ...
    @Override
    public ResourceEventTrace.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ResourceEventTrace.Match)) {
          ResourceEventTrace.Match other = (ResourceEventTrace.Match) obj;
    ...
    @Override
    public ResourceEventTrace specification() {
      return ResourceEventTrace.instance();
    }
     ...
     * 
     */
    public static ResourceEventTrace.Match newEmptyMatch() {
     ...
     * 
     */
    public static ResourceEventTrace.Match newMutableMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ResourceEventTrace.Match newMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ResourceEventTrace.Match {
    ...
    private static final class Immutable extends ResourceEventTrace.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ResourceEventTrace pattern,
   ...
   * 
   * @see Match
   * @see ResourceEventTrace
   * 
   */
  public static class Matcher extends BaseMatcher<ResourceEventTrace.Match> {
    /**
     ...
     * 
     */
    public static ResourceEventTrace.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ResourceEventTrace.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ResourceEventTrace.Matcher.class);
     ...
     * 
     */
    public Collection<ResourceEventTrace.Match> getAllMatches(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ResourceEventTrace.Match> streamAllMatches(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ResourceEventTrace.Match> getOneArbitraryMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ResourceEventTrace.Match> processor) {
     ...
     * 
     */
    public ResourceEventTrace.Match newMatch(final Interaction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ResourceEventTrace.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Interaction> streamAllValuesOfelement(final ResourceEventTrace.Match partialMatch) {
     ...
     * 
     */
    public Set<Interaction> getAllValuesOfelement(final ResourceEventTrace.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ResourceEventTrace.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ResourceEventTrace.Match partialMatch) {
    ...
    @Override
    protected ResourceEventTrace.Match tupleToMatch(final Tuple t) {
      try {
          return ResourceEventTrace.Match.newMatch((Interaction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ResourceEventTrace.Match arrayToMatch(final Object[] match) {
      try {
          return ResourceEventTrace.Match.newMatch((Interaction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ResourceEventTrace.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ResourceEventTrace.Match.newMutableMatch((Interaction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ResourceEventTrace.Matcher> querySpecification() {
      return ResourceEventTrace.instance();
    }
  }
  
  private ResourceEventTrace() {
   ...
   * 
   */
  public static ResourceEventTrace instance() {
    try{
  ...
  @Override
  protected ResourceEventTrace.Matcher instantiate(final ViatraQueryEngine engine) {
    return ResourceEventTrace.Matcher.on(engine);
  }
  
  @Override
  public ResourceEventTrace.Matcher instantiate() {
    return ResourceEventTrace.Matcher.create();
  }
  
  @Override
  public ResourceEventTrace.Match newEmptyMatch() {
    return ResourceEventTrace.Match.newEmptyMatch();
  }
  
  @Override
  public ResourceEventTrace.Match newMatch(final Object... parameters) {
    return ResourceEventTrace.Match.newMatch((com.nomagic.uml2.ext.magicdraw.interactions.mdbasicinteractions.Interaction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ResourceEventTrace} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ResourceEventTrace#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ResourceEventTrace INSTANCE = new ResourceEventTrace();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ResourceEventTrace.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_1_, "ResourceEventTrace");
