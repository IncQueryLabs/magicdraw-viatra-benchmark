...
public final class EnterpriseGoal_URI extends BaseGeneratedEMFQuerySpecification<EnterpriseGoal_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterpriseGoal_URI.Match.parameterNames;
    }
    ...
    @Override
    public EnterpriseGoal_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterpriseGoal_URI.Match)) {
          EnterpriseGoal_URI.Match other = (EnterpriseGoal_URI.Match) obj;
    ...
    @Override
    public EnterpriseGoal_URI specification() {
      return EnterpriseGoal_URI.instance();
    }
     ...
     * 
     */
    public static EnterpriseGoal_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterpriseGoal_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static EnterpriseGoal_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends EnterpriseGoal_URI.Match {
    ...
    private static final class Immutable extends EnterpriseGoal_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterpriseGoal_URI pattern,
   ...
   * 
   * @see Match
   * @see EnterpriseGoal_URI
   * 
   */
  public static class Matcher extends BaseMatcher<EnterpriseGoal_URI.Match> {
    /**
     ...
     * 
     */
    public static EnterpriseGoal_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterpriseGoal_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterpriseGoal_URI.Matcher.class);
     ...
     * 
     */
    public Collection<EnterpriseGoal_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<EnterpriseGoal_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<EnterpriseGoal_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super EnterpriseGoal_URI.Match> processor) {
     ...
     * 
     */
    public EnterpriseGoal_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return EnterpriseGoal_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterpriseGoal_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterpriseGoal_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final EnterpriseGoal_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final EnterpriseGoal_URI.Match partialMatch) {
    ...
    @Override
    protected EnterpriseGoal_URI.Match tupleToMatch(final Tuple t) {
      try {
          return EnterpriseGoal_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected EnterpriseGoal_URI.Match arrayToMatch(final Object[] match) {
      try {
          return EnterpriseGoal_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterpriseGoal_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterpriseGoal_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterpriseGoal_URI.Matcher> querySpecification() {
      return EnterpriseGoal_URI.instance();
    }
  }
  
  private EnterpriseGoal_URI() {
   ...
   * 
   */
  public static EnterpriseGoal_URI instance() {
    try{
  ...
  @Override
  protected EnterpriseGoal_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterpriseGoal_URI.Matcher.on(engine);
  }
  
  @Override
  public EnterpriseGoal_URI.Matcher instantiate() {
    return EnterpriseGoal_URI.Matcher.create();
  }
  
  @Override
  public EnterpriseGoal_URI.Match newEmptyMatch() {
    return EnterpriseGoal_URI.Match.newEmptyMatch();
  }
  
  @Override
  public EnterpriseGoal_URI.Match newMatch(final Object... parameters) {
    return EnterpriseGoal_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterpriseGoal_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterpriseGoal_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterpriseGoal_URI INSTANCE = new EnterpriseGoal_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterpriseGoal_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
