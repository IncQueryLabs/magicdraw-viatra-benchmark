...
public final class Exhibits_targetPropertyPath extends BaseGeneratedEMFQuerySpecification<Exhibits_targetPropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_targetPropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_targetPropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return Exhibits_targetPropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public Exhibits_targetPropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Exhibits_targetPropertyPath.Match)) {
          Exhibits_targetPropertyPath.Match other = (Exhibits_targetPropertyPath.Match) obj;
    ...
    @Override
    public Exhibits_targetPropertyPath specification() {
      return Exhibits_targetPropertyPath.instance();
    }
     ...
     * 
     */
    public static Exhibits_targetPropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static Exhibits_targetPropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static Exhibits_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Exhibits_targetPropertyPath.Match {
    ...
    private static final class Immutable extends Exhibits_targetPropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Exhibits_targetPropertyPath pattern,
   ...
   * 
   * @see Match
   * @see Exhibits_targetPropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<Exhibits_targetPropertyPath.Match> {
    /**
     ...
     * 
     */
    public static Exhibits_targetPropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Exhibits_targetPropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Exhibits_targetPropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<Exhibits_targetPropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<Exhibits_targetPropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<Exhibits_targetPropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super Exhibits_targetPropertyPath.Match> processor) {
     ...
     * 
     */
    public Exhibits_targetPropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return Exhibits_targetPropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Exhibits_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Exhibits_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final Exhibits_targetPropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final Exhibits_targetPropertyPath.Match partialMatch) {
    ...
    @Override
    protected Exhibits_targetPropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return Exhibits_targetPropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected Exhibits_targetPropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return Exhibits_targetPropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Exhibits_targetPropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Exhibits_targetPropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Exhibits_targetPropertyPath.Matcher> querySpecification() {
      return Exhibits_targetPropertyPath.instance();
    }
  }
  
  private Exhibits_targetPropertyPath() {
   ...
   * 
   */
  public static Exhibits_targetPropertyPath instance() {
    try{
  ...
  @Override
  protected Exhibits_targetPropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return Exhibits_targetPropertyPath.Matcher.on(engine);
  }
  
  @Override
  public Exhibits_targetPropertyPath.Matcher instantiate() {
    return Exhibits_targetPropertyPath.Matcher.create();
  }
  
  @Override
  public Exhibits_targetPropertyPath.Match newEmptyMatch() {
    return Exhibits_targetPropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public Exhibits_targetPropertyPath.Match newMatch(final Object... parameters) {
    return Exhibits_targetPropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Exhibits_targetPropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Exhibits_targetPropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Exhibits_targetPropertyPath INSTANCE = new Exhibits_targetPropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Exhibits_targetPropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
