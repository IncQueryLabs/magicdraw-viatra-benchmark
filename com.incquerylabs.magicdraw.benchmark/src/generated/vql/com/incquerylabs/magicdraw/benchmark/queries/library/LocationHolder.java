...
public final class LocationHolder extends BaseGeneratedEMFQuerySpecification<LocationHolder.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.LocationHolder pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.LocationHolder";
    }
    
    @Override
    public List<String> parameterNames() {
      return LocationHolder.Match.parameterNames;
    }
    ...
    @Override
    public LocationHolder.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof LocationHolder.Match)) {
          LocationHolder.Match other = (LocationHolder.Match) obj;
    ...
    @Override
    public LocationHolder specification() {
     ...
     * 
     */
    public static LocationHolder.Match newEmptyMatch() {
     ...
     * 
     */
    public static LocationHolder.Match newMutableMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static LocationHolder.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends LocationHolder.Match {
    ...
    private static final class Immutable extends LocationHolder.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.LocationHolder pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<LocationHolder.Match> {
    /**
     ...
     * 
     */
    public static LocationHolder.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static LocationHolder.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(LocationHolder.Matcher.class);
     ...
     * 
     */
    public Collection<LocationHolder.Match> getAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<LocationHolder.Match> streamAllMatches(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<LocationHolder.Match> getOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super LocationHolder.Match> processor) {
     ...
     * 
     */
    public LocationHolder.Match newMatch(final Element pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return LocationHolder.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfelement(final LocationHolder.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfelement(final LocationHolder.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final LocationHolder.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final LocationHolder.Match partialMatch) {
    ...
    @Override
    protected LocationHolder.Match tupleToMatch(final Tuple t) {
      try {
          return LocationHolder.Match.newMatch((Element) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected LocationHolder.Match arrayToMatch(final Object[] match) {
      try {
          return LocationHolder.Match.newMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected LocationHolder.Match arrayToMatchMutable(final Object[] match) {
      try {
          return LocationHolder.Match.newMutableMatch((Element) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<LocationHolder.Matcher> querySpecification() {
      return LocationHolder.instance();
    }
  }
  ...
  @Override
  protected LocationHolder.Matcher instantiate(final ViatraQueryEngine engine) {
    return LocationHolder.Matcher.on(engine);
  }
  
  @Override
  public LocationHolder.Matcher instantiate() {
    return LocationHolder.Matcher.create();
  }
  
  @Override
  public LocationHolder.Match newEmptyMatch() {
    return LocationHolder.Match.newEmptyMatch();
  }
  
  @Override
  public LocationHolder.Match newMatch(final Object... parameters) {
    return LocationHolder.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link LocationHolder} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link LocationHolder#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final LocationHolder INSTANCE = new LocationHolder();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final LocationHolder.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "LocationHolder")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "LocationHolder");
