...
public final class SecurityControl_VerifiedBy extends BaseGeneratedEMFQuerySpecification<SecurityControl_VerifiedBy.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_VerifiedBy pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_VerifiedBy";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControl_VerifiedBy.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControl_VerifiedBy.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControl_VerifiedBy.Match)) {
          SecurityControl_VerifiedBy.Match other = (SecurityControl_VerifiedBy.Match) obj;
    ...
    @Override
    public SecurityControl_VerifiedBy specification() {
      return SecurityControl_VerifiedBy.instance();
    }
     ...
     * 
     */
    public static SecurityControl_VerifiedBy.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControl_VerifiedBy.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public static SecurityControl_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityControl_VerifiedBy.Match {
    ...
    private static final class Immutable extends SecurityControl_VerifiedBy.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControl_VerifiedBy pattern,
   ...
   * 
   * @see Match
   * @see SecurityControl_VerifiedBy
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControl_VerifiedBy.Match> {
    /**
     ...
     * 
     */
    public static SecurityControl_VerifiedBy.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControl_VerifiedBy.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControl_VerifiedBy.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControl_VerifiedBy.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Stream<SecurityControl_VerifiedBy.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public Optional<SecurityControl_VerifiedBy.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue, final Consumer<? super SecurityControl_VerifiedBy.Match> processor) {
     ...
     * 
     */
    public SecurityControl_VerifiedBy.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final NamedElement pValue) {
      return SecurityControl_VerifiedBy.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControl_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControl_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Stream<NamedElement> streamAllValuesOfvalue(final SecurityControl_VerifiedBy.Match partialMatch) {
     ...
     * 
     */
    public Set<NamedElement> getAllValuesOfvalue(final SecurityControl_VerifiedBy.Match partialMatch) {
    ...
    @Override
    protected SecurityControl_VerifiedBy.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControl_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (NamedElement) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityControl_VerifiedBy.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControl_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControl_VerifiedBy.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControl_VerifiedBy.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (NamedElement) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControl_VerifiedBy.Matcher> querySpecification() {
      return SecurityControl_VerifiedBy.instance();
    }
  }
  
  private SecurityControl_VerifiedBy() {
   ...
   * 
   */
  public static SecurityControl_VerifiedBy instance() {
    try{
  ...
  @Override
  protected SecurityControl_VerifiedBy.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControl_VerifiedBy.Matcher.on(engine);
  }
  
  @Override
  public SecurityControl_VerifiedBy.Matcher instantiate() {
    return SecurityControl_VerifiedBy.Matcher.create();
  }
  
  @Override
  public SecurityControl_VerifiedBy.Match newEmptyMatch() {
    return SecurityControl_VerifiedBy.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControl_VerifiedBy.Match newMatch(final Object... parameters) {
    return SecurityControl_VerifiedBy.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.NamedElement) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControl_VerifiedBy} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControl_VerifiedBy#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControl_VerifiedBy INSTANCE = new SecurityControl_VerifiedBy();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControl_VerifiedBy.GeneratedPQuery INSTANCE = new GeneratedPQuery();
