...
public final class Energy_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Energy_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Energy_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Energy_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Energy_endBoundaryType.Match)) {
          Energy_endBoundaryType.Match other = (Energy_endBoundaryType.Match) obj;
    ...
    @Override
    public Energy_endBoundaryType specification() {
      return Energy_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Energy_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Energy_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Energy_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Energy_endBoundaryType.Match {
    ...
    private static final class Immutable extends Energy_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Energy_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Energy_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Energy_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Energy_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Energy_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Energy_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Energy_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Energy_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Energy_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Energy_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Energy_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Energy_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Energy_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Energy_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Energy_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Energy_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Energy_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Energy_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Energy_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Energy_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Energy_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Energy_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Energy_endBoundaryType.Matcher> querySpecification() {
      return Energy_endBoundaryType.instance();
    }
  }
  
  private Energy_endBoundaryType() {
   ...
   * 
   */
  public static Energy_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Energy_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Energy_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Energy_endBoundaryType.Matcher instantiate() {
    return Energy_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Energy_endBoundaryType.Match newEmptyMatch() {
    return Energy_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Energy_endBoundaryType.Match newMatch(final Object... parameters) {
    return Energy_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Energy_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Energy_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Energy_endBoundaryType INSTANCE = new Energy_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Energy_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
