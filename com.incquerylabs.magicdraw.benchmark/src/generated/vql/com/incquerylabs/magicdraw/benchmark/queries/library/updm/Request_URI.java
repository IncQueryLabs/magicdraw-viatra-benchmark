...
public final class Request_URI extends BaseGeneratedEMFQuerySpecification<Request_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Request_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Request_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Request_URI.Match.parameterNames;
    }
    ...
    @Override
    public Request_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Request_URI.Match)) {
          Request_URI.Match other = (Request_URI.Match) obj;
    ...
    @Override
    public Request_URI specification() {
      return Request_URI.instance();
    }
     ...
     * 
     */
    public static Request_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Request_URI.Match newMutableMatch(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Request_URI.Match newMatch(final Port pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Request_URI.Match {
    ...
    private static final class Immutable extends Request_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Request_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Request_URI.Match> {
    /**
     ...
     * 
     */
    public static Request_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Request_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Request_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Request_URI.Match> getAllMatches(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Request_URI.Match> streamAllMatches(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Request_URI.Match> getOneArbitraryMatch(final Port pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final LiteralString pValuespec, final Consumer<? super Request_URI.Match> processor) {
     ...
     * 
     */
    public Request_URI.Match newMatch(final Port pElement, final LiteralString pValuespec) {
      return Request_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Port> streamAllValuesOfelement(final Request_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Port> getAllValuesOfelement(final Request_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Request_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Request_URI.Match partialMatch) {
    ...
    @Override
    protected Request_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Request_URI.Match.newMatch((Port) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Request_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Request_URI.Match.newMatch((Port) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Request_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Request_URI.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Request_URI.Matcher> querySpecification() {
      return Request_URI.instance();
    }
  }
   ...
   * 
   */
  public static Request_URI instance() {
    try{
  ...
  @Override
  protected Request_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Request_URI.Matcher.on(engine);
  }
  
  @Override
  public Request_URI.Matcher instantiate() {
    return Request_URI.Matcher.create();
  }
  
  @Override
  public Request_URI.Match newEmptyMatch() {
    return Request_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Request_URI.Match newMatch(final Object... parameters) {
    return Request_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Request_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Request_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Request_URI INSTANCE = new Request_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Request_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
