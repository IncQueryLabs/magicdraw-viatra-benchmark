...
public final class PhysicalResource_requiredEnvironment extends BaseGeneratedEMFQuerySpecification<PhysicalResource_requiredEnvironment.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_requiredEnvironment pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_requiredEnvironment";
    }
    
    @Override
    public List<String> parameterNames() {
      return PhysicalResource_requiredEnvironment.Match.parameterNames;
    }
    ...
    @Override
    public PhysicalResource_requiredEnvironment.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PhysicalResource_requiredEnvironment.Match)) {
          PhysicalResource_requiredEnvironment.Match other = (PhysicalResource_requiredEnvironment.Match) obj;
    ...
    @Override
    public PhysicalResource_requiredEnvironment specification() {
      return PhysicalResource_requiredEnvironment.instance();
    }
     ...
     * 
     */
    public static PhysicalResource_requiredEnvironment.Match newEmptyMatch() {
     ...
     * 
     */
    public static PhysicalResource_requiredEnvironment.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PhysicalResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PhysicalResource_requiredEnvironment.Match {
    ...
    private static final class Immutable extends PhysicalResource_requiredEnvironment.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PhysicalResource_requiredEnvironment pattern,
   ...
   * 
   * @see Match
   * @see PhysicalResource_requiredEnvironment
   * 
   */
  public static class Matcher extends BaseMatcher<PhysicalResource_requiredEnvironment.Match> {
    /**
     ...
     * 
     */
    public static PhysicalResource_requiredEnvironment.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PhysicalResource_requiredEnvironment.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PhysicalResource_requiredEnvironment.Matcher.class);
     ...
     * 
     */
    public Collection<PhysicalResource_requiredEnvironment.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PhysicalResource_requiredEnvironment.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PhysicalResource_requiredEnvironment.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PhysicalResource_requiredEnvironment.Match> processor) {
     ...
     * 
     */
    public PhysicalResource_requiredEnvironment.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PhysicalResource_requiredEnvironment.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PhysicalResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PhysicalResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PhysicalResource_requiredEnvironment.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PhysicalResource_requiredEnvironment.Match partialMatch) {
    ...
    @Override
    protected PhysicalResource_requiredEnvironment.Match tupleToMatch(final Tuple t) {
      try {
          return PhysicalResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PhysicalResource_requiredEnvironment.Match arrayToMatch(final Object[] match) {
      try {
          return PhysicalResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PhysicalResource_requiredEnvironment.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PhysicalResource_requiredEnvironment.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PhysicalResource_requiredEnvironment.Matcher> querySpecification() {
      return PhysicalResource_requiredEnvironment.instance();
    }
  }
  
  private PhysicalResource_requiredEnvironment() {
   ...
   * 
   */
  public static PhysicalResource_requiredEnvironment instance() {
    try{
  ...
  @Override
  protected PhysicalResource_requiredEnvironment.Matcher instantiate(final ViatraQueryEngine engine) {
    return PhysicalResource_requiredEnvironment.Matcher.on(engine);
  }
  
  @Override
  public PhysicalResource_requiredEnvironment.Matcher instantiate() {
    return PhysicalResource_requiredEnvironment.Matcher.create();
  }
  
  @Override
  public PhysicalResource_requiredEnvironment.Match newEmptyMatch() {
    return PhysicalResource_requiredEnvironment.Match.newEmptyMatch();
  }
  
  @Override
  public PhysicalResource_requiredEnvironment.Match newMatch(final Object... parameters) {
    return PhysicalResource_requiredEnvironment.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PhysicalResource_requiredEnvironment} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PhysicalResource_requiredEnvironment#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PhysicalResource_requiredEnvironment INSTANCE = new PhysicalResource_requiredEnvironment();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PhysicalResource_requiredEnvironment.GeneratedPQuery INSTANCE = new GeneratedPQuery();
