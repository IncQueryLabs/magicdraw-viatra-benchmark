...
public final class ProjectStatus_endBoundaryType extends BaseGeneratedEMFQuerySpecification<ProjectStatus_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectStatus_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public ProjectStatus_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectStatus_endBoundaryType.Match)) {
          ProjectStatus_endBoundaryType.Match other = (ProjectStatus_endBoundaryType.Match) obj;
    ...
    @Override
    public ProjectStatus_endBoundaryType specification() {
      return ProjectStatus_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static ProjectStatus_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectStatus_endBoundaryType.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectStatus_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectStatus_endBoundaryType.Match {
    ...
    private static final class Immutable extends ProjectStatus_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectStatus_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see ProjectStatus_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectStatus_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static ProjectStatus_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectStatus_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectStatus_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectStatus_endBoundaryType.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectStatus_endBoundaryType.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectStatus_endBoundaryType.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ProjectStatus_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public ProjectStatus_endBoundaryType.Match newMatch(final Slot pElement, final Element pValue) {
      return ProjectStatus_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ProjectStatus_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ProjectStatus_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectStatus_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectStatus_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected ProjectStatus_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectStatus_endBoundaryType.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectStatus_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectStatus_endBoundaryType.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectStatus_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectStatus_endBoundaryType.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectStatus_endBoundaryType.Matcher> querySpecification() {
      return ProjectStatus_endBoundaryType.instance();
    }
  }
  
  private ProjectStatus_endBoundaryType() {
   ...
   * 
   */
  public static ProjectStatus_endBoundaryType instance() {
    try{
  ...
  @Override
  protected ProjectStatus_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectStatus_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public ProjectStatus_endBoundaryType.Matcher instantiate() {
    return ProjectStatus_endBoundaryType.Matcher.create();
  }
  
  @Override
  public ProjectStatus_endBoundaryType.Match newEmptyMatch() {
    return ProjectStatus_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectStatus_endBoundaryType.Match newMatch(final Object... parameters) {
    return ProjectStatus_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectStatus_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectStatus_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectStatus_endBoundaryType INSTANCE = new ProjectStatus_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectStatus_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
