...
public final class ProjectMilestoneRole extends BaseGeneratedEMFQuerySpecification<ProjectMilestoneRole.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestoneRole pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestoneRole";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestoneRole.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestoneRole.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestoneRole.Match)) {
          ProjectMilestoneRole.Match other = (ProjectMilestoneRole.Match) obj;
    ...
    @Override
    public ProjectMilestoneRole specification() {
      return ProjectMilestoneRole.instance();
    }
     ...
     * 
     */
    public static ProjectMilestoneRole.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestoneRole.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ProjectMilestoneRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ProjectMilestoneRole.Match {
    ...
    private static final class Immutable extends ProjectMilestoneRole.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ProjectMilestoneRole pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestoneRole
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestoneRole.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestoneRole.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestoneRole.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestoneRole.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestoneRole.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ProjectMilestoneRole.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ProjectMilestoneRole.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ProjectMilestoneRole.Match> processor) {
     ...
     * 
     */
    public ProjectMilestoneRole.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ProjectMilestoneRole.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProjectMilestoneRole.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProjectMilestoneRole.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ProjectMilestoneRole.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ProjectMilestoneRole.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestoneRole.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestoneRole.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ProjectMilestoneRole.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestoneRole.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestoneRole.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestoneRole.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestoneRole.Matcher> querySpecification() {
      return ProjectMilestoneRole.instance();
    }
  }
  
  private ProjectMilestoneRole() {
   ...
   * 
   */
  public static ProjectMilestoneRole instance() {
    try{
  ...
  @Override
  protected ProjectMilestoneRole.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestoneRole.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestoneRole.Matcher instantiate() {
    return ProjectMilestoneRole.Matcher.create();
  }
  
  @Override
  public ProjectMilestoneRole.Match newEmptyMatch() {
    return ProjectMilestoneRole.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestoneRole.Match newMatch(final Object... parameters) {
    return ProjectMilestoneRole.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestoneRole} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestoneRole#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestoneRole INSTANCE = new ProjectMilestoneRole();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestoneRole.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ProjectMilestoneRole")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ProjectMilestoneRole");
