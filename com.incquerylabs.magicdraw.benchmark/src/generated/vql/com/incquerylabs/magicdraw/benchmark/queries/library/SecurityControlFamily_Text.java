...
public final class SecurityControlFamily_Text extends BaseGeneratedEMFQuerySpecification<SecurityControlFamily_Text.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Text pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Text";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityControlFamily_Text.Match.parameterNames;
    }
    ...
    @Override
    public SecurityControlFamily_Text.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityControlFamily_Text.Match)) {
          SecurityControlFamily_Text.Match other = (SecurityControlFamily_Text.Match) obj;
    ...
    @Override
    public SecurityControlFamily_Text specification() {
      return SecurityControlFamily_Text.instance();
    }
     ...
     * 
     */
    public static SecurityControlFamily_Text.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityControlFamily_Text.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static SecurityControlFamily_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends SecurityControlFamily_Text.Match {
    ...
    private static final class Immutable extends SecurityControlFamily_Text.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityControlFamily_Text pattern,
   ...
   * 
   * @see Match
   * @see SecurityControlFamily_Text
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityControlFamily_Text.Match> {
    /**
     ...
     * 
     */
    public static SecurityControlFamily_Text.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityControlFamily_Text.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityControlFamily_Text.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityControlFamily_Text.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<SecurityControlFamily_Text.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<SecurityControlFamily_Text.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super SecurityControlFamily_Text.Match> processor) {
     ...
     * 
     */
    public SecurityControlFamily_Text.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return SecurityControlFamily_Text.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityControlFamily_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityControlFamily_Text.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final SecurityControlFamily_Text.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final SecurityControlFamily_Text.Match partialMatch) {
    ...
    @Override
    protected SecurityControlFamily_Text.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityControlFamily_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected SecurityControlFamily_Text.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityControlFamily_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityControlFamily_Text.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityControlFamily_Text.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityControlFamily_Text.Matcher> querySpecification() {
      return SecurityControlFamily_Text.instance();
    }
  }
  
  private SecurityControlFamily_Text() {
   ...
   * 
   */
  public static SecurityControlFamily_Text instance() {
    try{
  ...
  @Override
  protected SecurityControlFamily_Text.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityControlFamily_Text.Matcher.on(engine);
  }
  
  @Override
  public SecurityControlFamily_Text.Matcher instantiate() {
    return SecurityControlFamily_Text.Matcher.create();
  }
  
  @Override
  public SecurityControlFamily_Text.Match newEmptyMatch() {
    return SecurityControlFamily_Text.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityControlFamily_Text.Match newMatch(final Object... parameters) {
    return SecurityControlFamily_Text.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityControlFamily_Text} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityControlFamily_Text#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityControlFamily_Text INSTANCE = new SecurityControlFamily_Text();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityControlFamily_Text.GeneratedPQuery INSTANCE = new GeneratedPQuery();
