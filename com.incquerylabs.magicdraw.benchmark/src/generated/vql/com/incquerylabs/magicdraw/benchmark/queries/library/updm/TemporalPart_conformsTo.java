...
public final class TemporalPart_conformsTo extends BaseGeneratedEMFQuerySpecification<TemporalPart_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return TemporalPart_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public TemporalPart_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof TemporalPart_conformsTo.Match)) {
          TemporalPart_conformsTo.Match other = (TemporalPart_conformsTo.Match) obj;
    ...
    @Override
    public TemporalPart_conformsTo specification() {
      return TemporalPart_conformsTo.instance();
    }
     ...
     * 
     */
    public static TemporalPart_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static TemporalPart_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static TemporalPart_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends TemporalPart_conformsTo.Match {
    ...
    private static final class Immutable extends TemporalPart_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.TemporalPart_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see TemporalPart_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<TemporalPart_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static TemporalPart_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static TemporalPart_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(TemporalPart_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<TemporalPart_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<TemporalPart_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<TemporalPart_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super TemporalPart_conformsTo.Match> processor) {
     ...
     * 
     */
    public TemporalPart_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return TemporalPart_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final TemporalPart_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final TemporalPart_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final TemporalPart_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final TemporalPart_conformsTo.Match partialMatch) {
    ...
    @Override
    protected TemporalPart_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return TemporalPart_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected TemporalPart_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return TemporalPart_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected TemporalPart_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return TemporalPart_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<TemporalPart_conformsTo.Matcher> querySpecification() {
      return TemporalPart_conformsTo.instance();
    }
  }
  
  private TemporalPart_conformsTo() {
   ...
   * 
   */
  public static TemporalPart_conformsTo instance() {
    try{
  ...
  @Override
  protected TemporalPart_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return TemporalPart_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public TemporalPart_conformsTo.Matcher instantiate() {
    return TemporalPart_conformsTo.Matcher.create();
  }
  
  @Override
  public TemporalPart_conformsTo.Match newEmptyMatch() {
    return TemporalPart_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public TemporalPart_conformsTo.Match newMatch(final Object... parameters) {
    return TemporalPart_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TemporalPart_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link TemporalPart_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final TemporalPart_conformsTo INSTANCE = new TemporalPart_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final TemporalPart_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
