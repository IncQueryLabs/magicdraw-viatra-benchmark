...
public final class Participant_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Participant_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Participant_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Participant_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Participant_endBoundaryType.Match)) {
          Participant_endBoundaryType.Match other = (Participant_endBoundaryType.Match) obj;
    ...
    @Override
    public Participant_endBoundaryType specification() {
      return Participant_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Participant_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Participant_endBoundaryType.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Participant_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Participant_endBoundaryType.Match {
    ...
    private static final class Immutable extends Participant_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Participant_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Participant_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Participant_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Participant_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Participant_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Participant_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Participant_endBoundaryType.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Participant_endBoundaryType.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Participant_endBoundaryType.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Participant_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Participant_endBoundaryType.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Participant_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Participant_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Participant_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Participant_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Participant_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Participant_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Participant_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Participant_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Participant_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Participant_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Participant_endBoundaryType.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Participant_endBoundaryType.Matcher> querySpecification() {
      return Participant_endBoundaryType.instance();
    }
  }
  
  private Participant_endBoundaryType() {
   ...
   * 
   */
  public static Participant_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Participant_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Participant_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Participant_endBoundaryType.Matcher instantiate() {
    return Participant_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Participant_endBoundaryType.Match newEmptyMatch() {
    return Participant_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Participant_endBoundaryType.Match newMatch(final Object... parameters) {
    return Participant_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Participant_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Participant_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Participant_endBoundaryType INSTANCE = new Participant_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Participant_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
