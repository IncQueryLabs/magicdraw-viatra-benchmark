 ...
 *         	find stereotypedElement(element, domainStereotypeInstance, "SysML", "FullPort");
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class FullPort extends BaseGeneratedEMFQuerySpecification<FullPort.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.FullPort pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.FullPort";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.FullPort pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link FullPort} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FullPort#instance()}.
   * 
