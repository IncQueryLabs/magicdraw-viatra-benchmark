...
public final class FullPort extends BaseGeneratedEMFQuerySpecification<FullPort.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static FullPort.Match newMutableMatch(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public static FullPort.Match newMatch(final Port pElement, final Stereotype pStereotype) {
  ...
  public static class Matcher extends BaseMatcher<FullPort.Match> {
     ...
     * 
     */
    public Collection<FullPort.Match> getAllMatches(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Stream<FullPort.Match> streamAllMatches(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public Optional<FullPort.Match> getOneArbitraryMatch(final Port pElement, final Stereotype pStereotype) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Port pElement, final Stereotype pStereotype, final Consumer<? super FullPort.Match> processor) {
     ...
     * 
     */
    public FullPort.Match newMatch(final Port pElement, final Stereotype pStereotype) {
      return FullPort.Match.newMatch(pElement, pStereotype);
    }
     ...
     * 
     */
    public Stream<Stereotype> streamAllValuesOfStereotype(final FullPort.Match partialMatch) {
     ...
     * 
     */
    public Set<Stereotype> getAllValuesOfStereotype(final FullPort.Match partialMatch) {
    ...
    protected FullPort.Match tupleToMatch(final Tuple t) {
      try {
          return FullPort.Match.newMatch((Port) t.get(POSITION_ELEMENT), (Stereotype) t.get(POSITION_STEREOTYPE));
    ...
    protected FullPort.Match arrayToMatch(final Object[] match) {
      try {
          return FullPort.Match.newMatch((Port) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
    ...
    protected FullPort.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FullPort.Match.newMutableMatch((Port) match[POSITION_ELEMENT], (Stereotype) match[POSITION_STEREOTYPE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public FullPort.Match newMatch(final Object... parameters) {
    return FullPort.Match.newMatch((com.nomagic.uml2.ext.magicdraw.compositestructures.mdports.Port) parameters[0], (com.nomagic.uml2.ext.magicdraw.mdprofiles.Stereotype) parameters[1]);
  }
