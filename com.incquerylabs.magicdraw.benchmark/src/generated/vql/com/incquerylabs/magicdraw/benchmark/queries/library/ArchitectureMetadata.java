...
public final class ArchitectureMetadata extends BaseGeneratedEMFQuerySpecification<ArchitectureMetadata.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ArchitectureMetadata pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ArchitectureMetadata";
    }
    
    @Override
    public List<String> parameterNames() {
      return ArchitectureMetadata.Match.parameterNames;
    }
    ...
    @Override
    public ArchitectureMetadata.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ArchitectureMetadata.Match)) {
          ArchitectureMetadata.Match other = (ArchitectureMetadata.Match) obj;
    ...
    @Override
    public ArchitectureMetadata specification() {
      return ArchitectureMetadata.instance();
    }
     ...
     * 
     */
    public static ArchitectureMetadata.Match newEmptyMatch() {
     ...
     * 
     */
    public static ArchitectureMetadata.Match newMutableMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static ArchitectureMetadata.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends ArchitectureMetadata.Match {
    ...
    private static final class Immutable extends ArchitectureMetadata.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ArchitectureMetadata pattern,
   ...
   * 
   * @see Match
   * @see ArchitectureMetadata
   * 
   */
  public static class Matcher extends BaseMatcher<ArchitectureMetadata.Match> {
    /**
     ...
     * 
     */
    public static ArchitectureMetadata.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ArchitectureMetadata.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ArchitectureMetadata.Matcher.class);
     ...
     * 
     */
    public Collection<ArchitectureMetadata.Match> getAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<ArchitectureMetadata.Match> streamAllMatches(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<ArchitectureMetadata.Match> getOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super ArchitectureMetadata.Match> processor) {
     ...
     * 
     */
    public ArchitectureMetadata.Match newMatch(final Comment pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return ArchitectureMetadata.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Comment> streamAllValuesOfelement(final ArchitectureMetadata.Match partialMatch) {
     ...
     * 
     */
    public Set<Comment> getAllValuesOfelement(final ArchitectureMetadata.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final ArchitectureMetadata.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final ArchitectureMetadata.Match partialMatch) {
    ...
    @Override
    protected ArchitectureMetadata.Match tupleToMatch(final Tuple t) {
      try {
          return ArchitectureMetadata.Match.newMatch((Comment) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected ArchitectureMetadata.Match arrayToMatch(final Object[] match) {
      try {
          return ArchitectureMetadata.Match.newMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ArchitectureMetadata.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ArchitectureMetadata.Match.newMutableMatch((Comment) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ArchitectureMetadata.Matcher> querySpecification() {
      return ArchitectureMetadata.instance();
    }
  }
  
  private ArchitectureMetadata() {
   ...
   * 
   */
  public static ArchitectureMetadata instance() {
    try{
  ...
  @Override
  protected ArchitectureMetadata.Matcher instantiate(final ViatraQueryEngine engine) {
    return ArchitectureMetadata.Matcher.on(engine);
  }
  
  @Override
  public ArchitectureMetadata.Matcher instantiate() {
    return ArchitectureMetadata.Matcher.create();
  }
  
  @Override
  public ArchitectureMetadata.Match newEmptyMatch() {
    return ArchitectureMetadata.Match.newEmptyMatch();
  }
  
  @Override
  public ArchitectureMetadata.Match newMatch(final Object... parameters) {
    return ArchitectureMetadata.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Comment) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ArchitectureMetadata} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ArchitectureMetadata#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ArchitectureMetadata INSTANCE = new ArchitectureMetadata();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ArchitectureMetadata.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "ArchitectureMetadata")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "ArchitectureMetadata");
