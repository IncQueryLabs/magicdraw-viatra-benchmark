...
public final class PerformsInContext_targetContext extends BaseGeneratedEMFQuerySpecification<PerformsInContext_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return PerformsInContext_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public PerformsInContext_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PerformsInContext_targetContext.Match)) {
          PerformsInContext_targetContext.Match other = (PerformsInContext_targetContext.Match) obj;
    ...
    @Override
    public PerformsInContext_targetContext specification() {
      return PerformsInContext_targetContext.instance();
    }
     ...
     * 
     */
    public static PerformsInContext_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static PerformsInContext_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static PerformsInContext_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PerformsInContext_targetContext.Match {
    ...
    private static final class Immutable extends PerformsInContext_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.PerformsInContext_targetContext pattern,
   ...
   * 
   * @see Match
   * @see PerformsInContext_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<PerformsInContext_targetContext.Match> {
    /**
     ...
     * 
     */
    public static PerformsInContext_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PerformsInContext_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PerformsInContext_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<PerformsInContext_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<PerformsInContext_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<PerformsInContext_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super PerformsInContext_targetContext.Match> processor) {
     ...
     * 
     */
    public PerformsInContext_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return PerformsInContext_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final PerformsInContext_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final PerformsInContext_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final PerformsInContext_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final PerformsInContext_targetContext.Match partialMatch) {
    ...
    @Override
    protected PerformsInContext_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return PerformsInContext_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected PerformsInContext_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return PerformsInContext_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PerformsInContext_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PerformsInContext_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PerformsInContext_targetContext.Matcher> querySpecification() {
      return PerformsInContext_targetContext.instance();
    }
  }
  
  private PerformsInContext_targetContext() {
   ...
   * 
   */
  public static PerformsInContext_targetContext instance() {
    try{
  ...
  @Override
  protected PerformsInContext_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return PerformsInContext_targetContext.Matcher.on(engine);
  }
  
  @Override
  public PerformsInContext_targetContext.Matcher instantiate() {
    return PerformsInContext_targetContext.Matcher.create();
  }
  
  @Override
  public PerformsInContext_targetContext.Match newEmptyMatch() {
    return PerformsInContext_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public PerformsInContext_targetContext.Match newMatch(final Object... parameters) {
    return PerformsInContext_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PerformsInContext_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PerformsInContext_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PerformsInContext_targetContext INSTANCE = new PerformsInContext_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PerformsInContext_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
