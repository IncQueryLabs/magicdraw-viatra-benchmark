...
public final class FunctionalStandard_currentStatus extends BaseGeneratedEMFQuerySpecification<FunctionalStandard_currentStatus.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_currentStatus pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_currentStatus";
    }
    
    @Override
    public List<String> parameterNames() {
      return FunctionalStandard_currentStatus.Match.parameterNames;
    }
    ...
    @Override
    public FunctionalStandard_currentStatus.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof FunctionalStandard_currentStatus.Match)) {
          FunctionalStandard_currentStatus.Match other = (FunctionalStandard_currentStatus.Match) obj;
    ...
    @Override
    public FunctionalStandard_currentStatus specification() {
      return FunctionalStandard_currentStatus.instance();
    }
     ...
     * 
     */
    public static FunctionalStandard_currentStatus.Match newEmptyMatch() {
     ...
     * 
     */
    public static FunctionalStandard_currentStatus.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static FunctionalStandard_currentStatus.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends FunctionalStandard_currentStatus.Match {
    ...
    private static final class Immutable extends FunctionalStandard_currentStatus.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.FunctionalStandard_currentStatus pattern,
   ...
   * 
   * @see Match
   * @see FunctionalStandard_currentStatus
   * 
   */
  public static class Matcher extends BaseMatcher<FunctionalStandard_currentStatus.Match> {
    /**
     ...
     * 
     */
    public static FunctionalStandard_currentStatus.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static FunctionalStandard_currentStatus.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(FunctionalStandard_currentStatus.Matcher.class);
     ...
     * 
     */
    public Collection<FunctionalStandard_currentStatus.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<FunctionalStandard_currentStatus.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<FunctionalStandard_currentStatus.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super FunctionalStandard_currentStatus.Match> processor) {
     ...
     * 
     */
    public FunctionalStandard_currentStatus.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return FunctionalStandard_currentStatus.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final FunctionalStandard_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final FunctionalStandard_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final FunctionalStandard_currentStatus.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final FunctionalStandard_currentStatus.Match partialMatch) {
    ...
    @Override
    protected FunctionalStandard_currentStatus.Match tupleToMatch(final Tuple t) {
      try {
          return FunctionalStandard_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected FunctionalStandard_currentStatus.Match arrayToMatch(final Object[] match) {
      try {
          return FunctionalStandard_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected FunctionalStandard_currentStatus.Match arrayToMatchMutable(final Object[] match) {
      try {
          return FunctionalStandard_currentStatus.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<FunctionalStandard_currentStatus.Matcher> querySpecification() {
      return FunctionalStandard_currentStatus.instance();
    }
  }
  
  private FunctionalStandard_currentStatus() {
   ...
   * 
   */
  public static FunctionalStandard_currentStatus instance() {
    try{
  ...
  @Override
  protected FunctionalStandard_currentStatus.Matcher instantiate(final ViatraQueryEngine engine) {
    return FunctionalStandard_currentStatus.Matcher.on(engine);
  }
  
  @Override
  public FunctionalStandard_currentStatus.Matcher instantiate() {
    return FunctionalStandard_currentStatus.Matcher.create();
  }
  
  @Override
  public FunctionalStandard_currentStatus.Match newEmptyMatch() {
    return FunctionalStandard_currentStatus.Match.newEmptyMatch();
  }
  
  @Override
  public FunctionalStandard_currentStatus.Match newMatch(final Object... parameters) {
    return FunctionalStandard_currentStatus.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link FunctionalStandard_currentStatus} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link FunctionalStandard_currentStatus#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final FunctionalStandard_currentStatus INSTANCE = new FunctionalStandard_currentStatus();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final FunctionalStandard_currentStatus.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "currentStatus");
