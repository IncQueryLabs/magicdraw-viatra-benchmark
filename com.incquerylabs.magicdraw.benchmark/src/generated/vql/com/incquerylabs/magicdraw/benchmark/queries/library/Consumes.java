...
public final class Consumes extends BaseGeneratedEMFQuerySpecification<Consumes.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Consumes";
    }
    
    @Override
    public List<String> parameterNames() {
      return Consumes.Match.parameterNames;
    }
    ...
    @Override
    public Consumes.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Consumes.Match)) {
          Consumes.Match other = (Consumes.Match) obj;
    ...
    @Override
    public Consumes specification() {
      return Consumes.instance();
    }
     ...
     * 
     */
    public static Consumes.Match newEmptyMatch() {
     ...
     * 
     */
    public static Consumes.Match newMutableMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static Consumes.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends Consumes.Match {
    ...
    private static final class Immutable extends Consumes.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Consumes pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Consumes.Match> {
    /**
     ...
     * 
     */
    public static Consumes.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Consumes.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Consumes.Matcher.class);
     ...
     * 
     */
    public Collection<Consumes.Match> getAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<Consumes.Match> streamAllMatches(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<Consumes.Match> getOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super Consumes.Match> processor) {
     ...
     * 
     */
    public Consumes.Match newMatch(final Abstraction pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return Consumes.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Consumes.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Consumes.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final Consumes.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final Consumes.Match partialMatch) {
    ...
    @Override
    protected Consumes.Match tupleToMatch(final Tuple t) {
      try {
          return Consumes.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected Consumes.Match arrayToMatch(final Object[] match) {
      try {
          return Consumes.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Consumes.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Consumes.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Consumes.Matcher> querySpecification() {
      return Consumes.instance();
    }
  }
   ...
   * 
   */
  public static Consumes instance() {
    try{
  ...
  @Override
  protected Consumes.Matcher instantiate(final ViatraQueryEngine engine) {
    return Consumes.Matcher.on(engine);
  }
  
  @Override
  public Consumes.Matcher instantiate() {
    return Consumes.Matcher.create();
  }
  
  @Override
  public Consumes.Match newEmptyMatch() {
    return Consumes.Match.newEmptyMatch();
  }
  
  @Override
  public Consumes.Match newMatch(final Object... parameters) {
    return Consumes.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Consumes} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Consumes#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Consumes INSTANCE = new Consumes();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Consumes.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "Consumes")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "Consumes");
