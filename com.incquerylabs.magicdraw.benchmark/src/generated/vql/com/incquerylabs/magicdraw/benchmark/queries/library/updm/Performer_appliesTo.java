...
public final class Performer_appliesTo extends BaseGeneratedEMFQuerySpecification<Performer_appliesTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_appliesTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_appliesTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return Performer_appliesTo.Match.parameterNames;
    }
    ...
    @Override
    public Performer_appliesTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Performer_appliesTo.Match)) {
          Performer_appliesTo.Match other = (Performer_appliesTo.Match) obj;
    ...
    @Override
    public Performer_appliesTo specification() {
      return Performer_appliesTo.instance();
    }
     ...
     * 
     */
    public static Performer_appliesTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static Performer_appliesTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Performer_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Performer_appliesTo.Match {
    ...
    private static final class Immutable extends Performer_appliesTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Performer_appliesTo pattern,
   ...
   * 
   * @see Match
   * @see Performer_appliesTo
   * 
   */
  public static class Matcher extends BaseMatcher<Performer_appliesTo.Match> {
    /**
     ...
     * 
     */
    public static Performer_appliesTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Performer_appliesTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Performer_appliesTo.Matcher.class);
     ...
     * 
     */
    public Collection<Performer_appliesTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Performer_appliesTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Performer_appliesTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Performer_appliesTo.Match> processor) {
     ...
     * 
     */
    public Performer_appliesTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Performer_appliesTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Performer_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Performer_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Performer_appliesTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Performer_appliesTo.Match partialMatch) {
    ...
    @Override
    protected Performer_appliesTo.Match tupleToMatch(final Tuple t) {
      try {
          return Performer_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Performer_appliesTo.Match arrayToMatch(final Object[] match) {
      try {
          return Performer_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Performer_appliesTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Performer_appliesTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Performer_appliesTo.Matcher> querySpecification() {
      return Performer_appliesTo.instance();
    }
  }
  
  private Performer_appliesTo() {
   ...
   * 
   */
  public static Performer_appliesTo instance() {
    try{
  ...
  @Override
  protected Performer_appliesTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return Performer_appliesTo.Matcher.on(engine);
  }
  
  @Override
  public Performer_appliesTo.Matcher instantiate() {
    return Performer_appliesTo.Matcher.create();
  }
  
  @Override
  public Performer_appliesTo.Match newEmptyMatch() {
    return Performer_appliesTo.Match.newEmptyMatch();
  }
  
  @Override
  public Performer_appliesTo.Match newMatch(final Object... parameters) {
    return Performer_appliesTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Performer_appliesTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Performer_appliesTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Performer_appliesTo INSTANCE = new Performer_appliesTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Performer_appliesTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
